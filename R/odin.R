...
main_model <- function (above_500_by_group, alpha01, alpha02, alpha03, alpha04,
    ...
    infected_FSW_incoming, iota, kappa1, kappaa, kappab, kappac,
    M_comm, M_noncomm, mu, n_t_comm, n_t_noncomm, n_y_comm, n_y_noncomm,
    Nage, Ncat, nu, omega, pfFSW_t, pfFSW_y, phi2, phi3, phi4,
    phi5, prep_efficacious_t, prep_efficacious_y, prep_intervention_t,
    prep_intervention_y, PrEP_reinit_OnOff_t, PrEP_reinit_OnOff_y,
    PrEPOnOff, psia, psib, R, rate_leave_pro_FSW, rate_move_in,
    rate_move_out, rate_move_out_PrEP, replaceDeaths, rho, rho_intervention_t,
    ...
    user = list(above_500_by_group = above_500_by_group, alpha01 = alpha01,
        ...
        RR_test_CD4200 = RR_test_CD4200, S0_init = S0_init, S1a_init = S1a_init,
        S1b_init = S1b_init, S1c_init = S1c_init, S1d_init = S1d_init,
        sigma = sigma, TasP_testing = TasP_testing, tau_intervention_t = tau_intervention_t,
