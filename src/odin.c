...
SEXP main_model_output_order(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  int *tmp;
  SEXP state_len = PROTECT(allocVector(VECSXP, 154));
  SEXP state_names = PROTECT(allocVector(STRSXP, 154));
  ...
  SET_VECTOR_ELT(state_len, 75, ScalarInteger(main_model_p->dim_eP1a_effective));
  SET_STRING_ELT(state_names, 75, mkChar("eP1a_effective"));
  SET_VECTOR_ELT(state_len, 76, ScalarInteger(main_model_p->dim_eP1b_effective));
  SET_STRING_ELT(state_names, 76, mkChar("eP1b_effective"));
  SET_VECTOR_ELT(state_len, 77, ScalarInteger(main_model_p->dim_eP1c_effective));
  SET_STRING_ELT(state_names, 77, mkChar("eP1c_effective"));
  SET_VECTOR_ELT(state_len, 78, ScalarInteger(main_model_p->dim_tau));
  SET_STRING_ELT(state_names, 78, mkChar("tau"));
  SET_VECTOR_ELT(state_len, 79, ScalarInteger(main_model_p->dim_rho));
  SET_STRING_ELT(state_names, 79, mkChar("rho"));
  SET_VECTOR_ELT(state_len, 80, ScalarInteger(main_model_p->dim_iota));
  SET_STRING_ELT(state_names, 80, mkChar("iota"));
  SET_VECTOR_ELT(state_len, 81, ScalarInteger(main_model_p->dim_HIV_positive));
  SET_STRING_ELT(state_names, 81, mkChar("HIV_positive"));
  SET_VECTOR_ELT(state_len, 82, ScalarInteger(main_model_p->dim_Number_Susceptibles));
  SET_STRING_ELT(state_names, 82, mkChar("Number_Susceptibles"));
  SET_VECTOR_ELT(state_len, 83, ScalarInteger(main_model_p->dim_HIV_positive_Diagnosed_Off_ART));
  SET_STRING_ELT(state_names, 83, mkChar("HIV_positive_Diagnosed_Off_ART"));
  SET_VECTOR_ELT(state_len, 84, ScalarInteger(main_model_p->dim_Primary_Off_ART));
  SET_STRING_ELT(state_names, 84, mkChar("Primary_Off_ART"));
  SET_VECTOR_ELT(state_len, 85, ScalarInteger(main_model_p->dim_CD4_above_500_Off_ART));
  SET_STRING_ELT(state_names, 85, mkChar("CD4_above_500_Off_ART"));
  SET_VECTOR_ELT(state_len, 86, ScalarInteger(main_model_p->dim_CD4_350_500_Off_ART));
  SET_STRING_ELT(state_names, 86, mkChar("CD4_350_500_Off_ART"));
  SET_VECTOR_ELT(state_len, 87, ScalarInteger(main_model_p->dim_CD4_200_350_Off_ART));
  SET_STRING_ELT(state_names, 87, mkChar("CD4_200_350_Off_ART"));
  SET_VECTOR_ELT(state_len, 88, ScalarInteger(main_model_p->dim_CD4_below_200_Off_ART));
  SET_STRING_ELT(state_names, 88, mkChar("CD4_below_200_Off_ART"));
  SET_VECTOR_ELT(state_len, 89, ScalarInteger(main_model_p->dim_HIV_positive_On_ART));
  SET_STRING_ELT(state_names, 89, mkChar("HIV_positive_On_ART"));
  SET_VECTOR_ELT(state_len, 90, ScalarInteger(main_model_p->dim_Number_DALY_W1));
  SET_STRING_ELT(state_names, 90, mkChar("Number_DALY_W1"));
  SET_VECTOR_ELT(state_len, 91, ScalarInteger(main_model_p->dim_Number_DALY_W2));
  SET_STRING_ELT(state_names, 91, mkChar("Number_DALY_W2"));
  SET_VECTOR_ELT(state_len, 92, ScalarInteger(main_model_p->dim_Number_DALY_W3));
  SET_STRING_ELT(state_names, 92, mkChar("Number_DALY_W3"));
  SET_VECTOR_ELT(state_len, 93, ScalarInteger(main_model_p->dim_frac_F));
  SET_STRING_ELT(state_names, 93, mkChar("frac_F"));
  SET_VECTOR_ELT(state_len, 94, ScalarInteger(main_model_p->dim_frac_N_sexualpop));
  SET_STRING_ELT(state_names, 94, mkChar("frac_N_sexualpop"));
  SET_VECTOR_ELT(state_len, 95, ScalarInteger(main_model_p->dim_ART_coverage));
  SET_STRING_ELT(state_names, 95, mkChar("ART_coverage"));
  SET_VECTOR_ELT(state_len, 96, ScalarInteger(main_model_p->dim_infect_ART));
  SET_STRING_ELT(state_names, 96, mkChar("infect_ART"));
  SET_VECTOR_ELT(state_len, 97, ScalarInteger(main_model_p->dim_prep_offered));
  SET_STRING_ELT(state_names, 97, mkChar("prep_offered"));
  SET_VECTOR_ELT(state_len, 98, ScalarInteger(main_model_p->dim_omega));
  SET_STRING_ELT(state_names, 98, mkChar("omega"));
  SET_VECTOR_ELT(state_len, 99, ScalarInteger(main_model_p->dim_frac_N));
  SET_STRING_ELT(state_names, 99, mkChar("frac_N"));
  SET_VECTOR_ELT(state_len, 100, ScalarInteger(main_model_p->dim_mu));
  SET_STRING_ELT(state_names, 100, mkChar("mu"));
  SET_VECTOR_ELT(state_len, 101, ScalarInteger(main_model_p->dim_gamma01));
  SET_STRING_ELT(state_names, 101, mkChar("gamma01"));
  SET_VECTOR_ELT(state_len, 102, ScalarInteger(main_model_p->dim_gamma11));
  SET_STRING_ELT(state_names, 102, mkChar("gamma11"));
  SET_VECTOR_ELT(state_len, 103, ScalarInteger(main_model_p->dim_kappaa));
  SET_STRING_ELT(state_names, 103, mkChar("kappaa"));
  SET_VECTOR_ELT(state_len, 104, ScalarInteger(main_model_p->dim_kappab));
  SET_STRING_ELT(state_names, 104, mkChar("kappab"));
  SET_VECTOR_ELT(state_len, 105, ScalarInteger(main_model_p->dim_kappac));
  SET_STRING_ELT(state_names, 105, mkChar("kappac"));
  SET_VECTOR_ELT(state_len, 106, ScalarInteger(main_model_p->dim_kappa1));
  SET_STRING_ELT(state_names, 106, mkChar("kappa1"));
  SET_VECTOR_ELT(state_len, 107, ScalarInteger(main_model_p->dim_alpha01));
  SET_STRING_ELT(state_names, 107, mkChar("alpha01"));
  SET_VECTOR_ELT(state_len, 108, ScalarInteger(main_model_p->dim_alpha02));
  SET_STRING_ELT(state_names, 108, mkChar("alpha02"));
  SET_VECTOR_ELT(state_len, 109, ScalarInteger(main_model_p->dim_alpha05));
  SET_STRING_ELT(state_names, 109, mkChar("alpha05"));
  SET_VECTOR_ELT(state_len, 110, ScalarInteger(main_model_p->dim_alpha11));
  SET_STRING_ELT(state_names, 110, mkChar("alpha11"));
  SET_VECTOR_ELT(state_len, 111, ScalarInteger(main_model_p->dim_alpha22));
  SET_STRING_ELT(state_names, 111, mkChar("alpha22"));
  SET_VECTOR_ELT(state_len, 112, ScalarInteger(main_model_p->dim_alpha35));
  SET_STRING_ELT(state_names, 112, mkChar("alpha35"));
  SET_VECTOR_ELT(state_len, 113, ScalarInteger(main_model_p->dim_beta_comm));
  SET_STRING_ELT(state_names, 113, mkChar("beta_comm"));
  SET_VECTOR_ELT(state_len, 114, ScalarInteger(main_model_p->dim_beta_noncomm));
  SET_STRING_ELT(state_names, 114, mkChar("beta_noncomm"));
  SET_VECTOR_ELT(state_len, 115, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 115));
  tmp[0] = main_model_p->dim_p_comm_1;
  tmp[1] = main_model_p->dim_p_comm_2;
  SET_STRING_ELT(state_names, 115, mkChar("p_comm"));
  ...
  SET_STRING_ELT(state_names, 116, mkChar("p_noncomm"));
  SET_VECTOR_ELT(state_len, 117, ScalarInteger(main_model_p->dim_eP0));
  SET_STRING_ELT(state_names, 117, mkChar("eP0"));
  SET_VECTOR_ELT(state_len, 118, ScalarInteger(main_model_p->dim_eP1a));
  SET_STRING_ELT(state_names, 118, mkChar("eP1a"));
  SET_VECTOR_ELT(state_len, 119, ScalarInteger(main_model_p->dim_eP1b));
  SET_STRING_ELT(state_names, 119, mkChar("eP1b"));
  SET_VECTOR_ELT(state_len, 120, ScalarInteger(main_model_p->dim_eP1c));
  SET_STRING_ELT(state_names, 120, mkChar("eP1c"));
  SET_VECTOR_ELT(state_len, 121, ScalarInteger(main_model_p->dim_eP1d));
  SET_STRING_ELT(state_names, 121, mkChar("eP1d"));
  ...
  SET_STRING_ELT(state_names, 122, mkChar("fc_comm"));
  SET_VECTOR_ELT(state_len, 123, ScalarInteger(main_model_p->dim_fP_comm));
  SET_STRING_ELT(state_names, 123, mkChar("fP_comm"));
  ...
  SET_STRING_ELT(state_names, 124, mkChar("fc_noncomm"));
  SET_VECTOR_ELT(state_len, 125, ScalarInteger(main_model_p->dim_fP_noncomm));
  SET_STRING_ELT(state_names, 125, mkChar("fP_noncomm"));
  ...
  SET_STRING_ELT(state_names, 126, mkChar("n_comm"));
  ...
  SET_STRING_ELT(state_names, 127, mkChar("n_noncomm"));
  SET_VECTOR_ELT(state_len, 128, ScalarInteger(main_model_p->dim_N));
  SET_STRING_ELT(state_names, 128, mkChar("N"));
  SET_VECTOR_ELT(state_len, 129, ScalarInteger(main_model_p->dim_E0));
  SET_STRING_ELT(state_names, 129, mkChar("E0"));
  SET_VECTOR_ELT(state_len, 130, ScalarInteger(main_model_p->dim_E1a));
  SET_STRING_ELT(state_names, 130, mkChar("E1a"));
  SET_VECTOR_ELT(state_len, 131, ScalarInteger(main_model_p->dim_E1b));
  SET_STRING_ELT(state_names, 131, mkChar("E1b"));
  SET_VECTOR_ELT(state_len, 132, ScalarInteger(main_model_p->dim_E1c));
  SET_STRING_ELT(state_names, 132, mkChar("E1c"));
  SET_VECTOR_ELT(state_len, 133, ScalarInteger(main_model_p->dim_E1d));
  SET_STRING_ELT(state_names, 133, mkChar("E1d"));
  SET_VECTOR_ELT(state_len, 134, ScalarInteger(main_model_p->dim_alphaItot));
  SET_STRING_ELT(state_names, 134, mkChar("alphaItot"));
  SET_VECTOR_ELT(state_len, 135, ScalarInteger(main_model_p->dim_prev));
  SET_STRING_ELT(state_names, 135, mkChar("prev"));
  ...
  SET_STRING_ELT(state_names, 136, mkChar("lambda"));
  ...
  SET_STRING_ELT(state_names, 137, mkChar("lambda_0"));
  ...
  SET_STRING_ELT(state_names, 138, mkChar("lambda_1a"));
  ...
  SET_STRING_ELT(state_names, 139, mkChar("lambda_1b"));
  ...
  SET_STRING_ELT(state_names, 140, mkChar("lambda_1c"));
  ...
  SET_STRING_ELT(state_names, 141, mkChar("lambda_1d"));
  SET_VECTOR_ELT(state_len, 142, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_STRING_ELT(state_names, 142, mkChar("lambda_sum_0"));
  SET_VECTOR_ELT(state_len, 143, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_STRING_ELT(state_names, 143, mkChar("lambda_sum_1a"));
  SET_VECTOR_ELT(state_len, 144, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_STRING_ELT(state_names, 144, mkChar("lambda_sum_1b"));
  SET_VECTOR_ELT(state_len, 145, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_STRING_ELT(state_names, 145, mkChar("lambda_sum_1c"));
  SET_VECTOR_ELT(state_len, 146, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_STRING_ELT(state_names, 146, mkChar("lambda_sum_1d"));
  SET_VECTOR_ELT(state_len, 147, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_STRING_ELT(state_names, 147, mkChar("c_comm_balanced"));
  SET_VECTOR_ELT(state_len, 148, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_STRING_ELT(state_names, 148, mkChar("c_noncomm_balanced"));
  ...
  SET_STRING_ELT(state_names, 149, mkChar("theta"));
  ...
  SET_STRING_ELT(state_names, 150, mkChar("M_comm"));
  ...
  SET_STRING_ELT(state_names, 151, mkChar("M_noncomm"));
  ...
  SET_STRING_ELT(state_names, 152, mkChar("rate_move_in"));
  SET_VECTOR_ELT(state_len, 153, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_STRING_ELT(state_names, 153, mkChar("rate_move_out"));
  setAttrib(state_len, R_NamesSymbol, state_names);
  UNPROTECT(2);
  return state_len;
}
