...
typedef struct main_model_pars {
  ...
  int dim_cumuTesting;
  double *initial_cumuTesting;
  int offset_cumuTesting;
...
SEXP main_model_create(SEXP user, SEXP odin_use_dde) {
  ...
  main_model_p->initial_cumuTesting = NULL;
...
SEXP main_model_set_user(main_model_pars *main_model_p, SEXP user) {
  ...
  main_model_p->offset_output_infect_ART_y = 31;
  ...
  main_model_p->offset_output_infect_ART_t = 31 + main_model_p->dim_infect_ART_y;
  ...
  main_model_p->offset_cumuHIVDeaths = 0;
  ...
  main_model_p->offset_cumuARTinitiations = main_model_p->dim_cumuHIVDeaths;
  ...
  Free(main_model_p->initial_cumuTesting);
  main_model_p->dim_cumuTesting = main_model_p->Ncat;
  main_model_p->initial_cumuTesting = (double*) Calloc(main_model_p->dim_cumuTesting, double);
  main_model_p->offset_cumuTesting = main_model_p->offset_cumuARTREinitiations + main_model_p->dim_cumuARTREinitiations;
  for (int i = 0; i < main_model_p->dim_cumuTesting; ++i) {
    main_model_p->initial_cumuTesting[i] = 0;
  }
  ...
  main_model_p->offset_cumuAllDeaths = main_model_p->offset_cumuTesting + main_model_p->dim_cumuTesting;
...
SEXP main_model_initialise(SEXP main_model_ptr, SEXP t_ptr) {
  ...
  memcpy(REAL(state) + 0, main_model_p->initial_cumuHIVDeaths, main_model_p->dim_cumuHIVDeaths * sizeof(double));
  ...
  memcpy(REAL(state) + main_model_p->offset_cumuTesting, main_model_p->initial_cumuTesting, main_model_p->dim_cumuTesting * sizeof(double));
...
void main_model_deriv(main_model_pars *main_model_p, double t, double *state, double *dstatedt, double *output) {
  ...
  double *deriv_cumuHIVDeaths = dstatedt;
  ...
  double *deriv_cumuTesting = dstatedt + main_model_p->offset_cumuTesting;
  ...
  for (int i = 0; i < main_model_p->dim_cumuTesting; ++i) {
    deriv_cumuTesting[i] = (main_model_p->tau[i] + main_model_p->tau_intervention[i] * main_model_p->PrEPOnOff) * S0[i] + (main_model_p->tau[i] + main_model_p->tau_intervention[i] * main_model_p->PrEPOnOff) * I01[i] + main_model_p->test_rate_prep[i] * I11[i] + (main_model_p->tau[i] + main_model_p->tau_intervention[i] * main_model_p->PrEPOnOff) * I02[i] + (main_model_p->tau[i] + main_model_p->tau_intervention[i] * main_model_p->PrEPOnOff) * I03[i] + (main_model_p->tau[i] + main_model_p->tau_intervention[i] * main_model_p->PrEPOnOff) * I04[i] + (main_model_p->RR_test_CD4200 * main_model_p->tau[i] + main_model_p->tau_intervention[i] * main_model_p->PrEPOnOff) * I05[i];
  }
  for (int i = 0; i < main_model_p->dim_cumuAllDeaths; ++i) {
  ...
  if (output != NULL) {
    double *output_infect_ART_y = output + 31;
    ...
    output[1] = main_model_p->PrEPOnOff;
    output[2] = main_model_p->fPa;
    output[3] = main_model_p->fPb;
    output[4] = main_model_p->fPc;
    ...
    output[6] = Men_on_ART;
    output[7] = Women_on_ART;
    output[8] = ART_coverage_men;
    output[9] = ART_coverage_women;
    output[10] = ART_coverage_FSW;
    output[11] = ART_coverage_all;
    output[12] = main_model_p->Ncat;
    ...
    output[13] = main_model_p->nu;
    output[14] = main_model_p->Nage;
    output[15] = main_model_p->dur_FSW;
    ...
    output[17] = Ntot_inc_former_FSW_nonCot;
    double new_people = main_model_p->epsilon * Ntot;
    output[18] = new_people;
    ...
    output[21] = prev_men;
    output[22] = prev_women;
    output[23] = prev_cotonou;
    output[24] = Ntot;
    memcpy(output_N, main_model_p->N, main_model_p->dim_N * sizeof(double));
    output[25] = prev_FSW;
    output[26] = prev_client;
...
SEXP main_model_contents(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  SEXP state = PROTECT(allocVector(VECSXP, 699));
  ...
  SET_VECTOR_ELT(state, 172, ScalarInteger(main_model_p->dim_frac_F));
  SET_VECTOR_ELT(state, 173, allocVector(REALSXP, main_model_p->dim_frac_F));
  memcpy(REAL(VECTOR_ELT(state, 173)), main_model_p->frac_F, main_model_p->dim_frac_F * sizeof(double));
  SET_VECTOR_ELT(state, 174, ScalarInteger(main_model_p->offset_output_frac_F));
  SET_VECTOR_ELT(state, 175, ScalarInteger(main_model_p->dim_frac_N_sexualpop));
  SET_VECTOR_ELT(state, 176, allocVector(REALSXP, main_model_p->dim_frac_N_sexualpop));
  memcpy(REAL(VECTOR_ELT(state, 176)), main_model_p->frac_N_sexualpop, main_model_p->dim_frac_N_sexualpop * sizeof(double));
  SET_VECTOR_ELT(state, 177, ScalarInteger(main_model_p->offset_output_frac_N_sexualpop));
  SET_VECTOR_ELT(state, 178, ScalarInteger(main_model_p->dim_infect_ART));
  SET_VECTOR_ELT(state, 179, allocVector(REALSXP, main_model_p->dim_infect_ART));
  memcpy(REAL(VECTOR_ELT(state, 179)), main_model_p->infect_ART, main_model_p->dim_infect_ART * sizeof(double));
  SET_VECTOR_ELT(state, 180, ScalarInteger(main_model_p->offset_output_infect_ART));
  SET_VECTOR_ELT(state, 181, ScalarInteger(main_model_p->dim_prep_offered));
  SET_VECTOR_ELT(state, 182, allocVector(REALSXP, main_model_p->dim_prep_offered));
  memcpy(REAL(VECTOR_ELT(state, 182)), main_model_p->prep_offered, main_model_p->dim_prep_offered * sizeof(double));
  SET_VECTOR_ELT(state, 183, ScalarInteger(main_model_p->dim_omega));
  SET_VECTOR_ELT(state, 184, allocVector(REALSXP, main_model_p->dim_omega));
  memcpy(REAL(VECTOR_ELT(state, 184)), main_model_p->omega, main_model_p->dim_omega * sizeof(double));
  SET_VECTOR_ELT(state, 185, ScalarInteger(main_model_p->offset_output_omega));
  SET_VECTOR_ELT(state, 186, ScalarInteger(main_model_p->dim_frac_N));
  SET_VECTOR_ELT(state, 187, allocVector(REALSXP, main_model_p->dim_frac_N));
  memcpy(REAL(VECTOR_ELT(state, 187)), main_model_p->frac_N, main_model_p->dim_frac_N * sizeof(double));
  SET_VECTOR_ELT(state, 188, ScalarInteger(main_model_p->offset_output_frac_N));
  SET_VECTOR_ELT(state, 189, ScalarInteger(main_model_p->dim_mu));
  SET_VECTOR_ELT(state, 190, allocVector(REALSXP, main_model_p->dim_mu));
  memcpy(REAL(VECTOR_ELT(state, 190)), main_model_p->mu, main_model_p->dim_mu * sizeof(double));
  SET_VECTOR_ELT(state, 191, ScalarInteger(main_model_p->offset_output_mu));
  SET_VECTOR_ELT(state, 192, ScalarInteger(main_model_p->dim_gamma01));
  SET_VECTOR_ELT(state, 193, allocVector(REALSXP, main_model_p->dim_gamma01));
  memcpy(REAL(VECTOR_ELT(state, 193)), main_model_p->gamma01, main_model_p->dim_gamma01 * sizeof(double));
  SET_VECTOR_ELT(state, 194, ScalarInteger(main_model_p->offset_output_gamma01));
  SET_VECTOR_ELT(state, 195, ScalarInteger(main_model_p->dim_gamma02));
  SET_VECTOR_ELT(state, 196, allocVector(REALSXP, main_model_p->dim_gamma02));
  memcpy(REAL(VECTOR_ELT(state, 196)), main_model_p->gamma02, main_model_p->dim_gamma02 * sizeof(double));
  SET_VECTOR_ELT(state, 197, ScalarInteger(main_model_p->dim_gamma03));
  SET_VECTOR_ELT(state, 198, allocVector(REALSXP, main_model_p->dim_gamma03));
  memcpy(REAL(VECTOR_ELT(state, 198)), main_model_p->gamma03, main_model_p->dim_gamma03 * sizeof(double));
  SET_VECTOR_ELT(state, 199, ScalarInteger(main_model_p->dim_gamma04));
  SET_VECTOR_ELT(state, 200, allocVector(REALSXP, main_model_p->dim_gamma04));
  memcpy(REAL(VECTOR_ELT(state, 200)), main_model_p->gamma04, main_model_p->dim_gamma04 * sizeof(double));
  SET_VECTOR_ELT(state, 201, ScalarInteger(main_model_p->dim_gamma11));
  SET_VECTOR_ELT(state, 202, allocVector(REALSXP, main_model_p->dim_gamma11));
  memcpy(REAL(VECTOR_ELT(state, 202)), main_model_p->gamma11, main_model_p->dim_gamma11 * sizeof(double));
  SET_VECTOR_ELT(state, 203, ScalarInteger(main_model_p->offset_output_gamma11));
  SET_VECTOR_ELT(state, 204, ScalarInteger(main_model_p->dim_gamma22));
  SET_VECTOR_ELT(state, 205, allocVector(REALSXP, main_model_p->dim_gamma22));
  memcpy(REAL(VECTOR_ELT(state, 205)), main_model_p->gamma22, main_model_p->dim_gamma22 * sizeof(double));
  SET_VECTOR_ELT(state, 206, ScalarInteger(main_model_p->dim_gamma23));
  SET_VECTOR_ELT(state, 207, allocVector(REALSXP, main_model_p->dim_gamma23));
  memcpy(REAL(VECTOR_ELT(state, 207)), main_model_p->gamma23, main_model_p->dim_gamma23 * sizeof(double));
  SET_VECTOR_ELT(state, 208, ScalarInteger(main_model_p->dim_gamma24));
  SET_VECTOR_ELT(state, 209, allocVector(REALSXP, main_model_p->dim_gamma24));
  memcpy(REAL(VECTOR_ELT(state, 209)), main_model_p->gamma24, main_model_p->dim_gamma24 * sizeof(double));
  SET_VECTOR_ELT(state, 210, ScalarInteger(main_model_p->dim_gamma32));
  SET_VECTOR_ELT(state, 211, allocVector(REALSXP, main_model_p->dim_gamma32));
  memcpy(REAL(VECTOR_ELT(state, 211)), main_model_p->gamma32, main_model_p->dim_gamma32 * sizeof(double));
  SET_VECTOR_ELT(state, 212, ScalarInteger(main_model_p->dim_gamma33));
  SET_VECTOR_ELT(state, 213, allocVector(REALSXP, main_model_p->dim_gamma33));
  memcpy(REAL(VECTOR_ELT(state, 213)), main_model_p->gamma33, main_model_p->dim_gamma33 * sizeof(double));
  SET_VECTOR_ELT(state, 214, ScalarInteger(main_model_p->dim_gamma34));
  SET_VECTOR_ELT(state, 215, allocVector(REALSXP, main_model_p->dim_gamma34));
  memcpy(REAL(VECTOR_ELT(state, 215)), main_model_p->gamma34, main_model_p->dim_gamma34 * sizeof(double));
  SET_VECTOR_ELT(state, 216, ScalarInteger(main_model_p->dim_gamma42));
  SET_VECTOR_ELT(state, 217, allocVector(REALSXP, main_model_p->dim_gamma42));
  memcpy(REAL(VECTOR_ELT(state, 217)), main_model_p->gamma42, main_model_p->dim_gamma42 * sizeof(double));
  SET_VECTOR_ELT(state, 218, ScalarInteger(main_model_p->dim_gamma43));
  SET_VECTOR_ELT(state, 219, allocVector(REALSXP, main_model_p->dim_gamma43));
  memcpy(REAL(VECTOR_ELT(state, 219)), main_model_p->gamma43, main_model_p->dim_gamma43 * sizeof(double));
  SET_VECTOR_ELT(state, 220, ScalarInteger(main_model_p->dim_gamma44));
  SET_VECTOR_ELT(state, 221, allocVector(REALSXP, main_model_p->dim_gamma44));
  memcpy(REAL(VECTOR_ELT(state, 221)), main_model_p->gamma44, main_model_p->dim_gamma44 * sizeof(double));
  SET_VECTOR_ELT(state, 222, ScalarInteger(main_model_p->dim_phi2));
  SET_VECTOR_ELT(state, 223, allocVector(REALSXP, main_model_p->dim_phi2));
  memcpy(REAL(VECTOR_ELT(state, 223)), main_model_p->phi2, main_model_p->dim_phi2 * sizeof(double));
  SET_VECTOR_ELT(state, 224, ScalarInteger(main_model_p->dim_phi3));
  SET_VECTOR_ELT(state, 225, allocVector(REALSXP, main_model_p->dim_phi3));
  memcpy(REAL(VECTOR_ELT(state, 225)), main_model_p->phi3, main_model_p->dim_phi3 * sizeof(double));
  SET_VECTOR_ELT(state, 226, ScalarInteger(main_model_p->dim_phi4));
  SET_VECTOR_ELT(state, 227, allocVector(REALSXP, main_model_p->dim_phi4));
  memcpy(REAL(VECTOR_ELT(state, 227)), main_model_p->phi4, main_model_p->dim_phi4 * sizeof(double));
  SET_VECTOR_ELT(state, 228, ScalarInteger(main_model_p->dim_phi5));
  SET_VECTOR_ELT(state, 229, allocVector(REALSXP, main_model_p->dim_phi5));
  memcpy(REAL(VECTOR_ELT(state, 229)), main_model_p->phi5, main_model_p->dim_phi5 * sizeof(double));
  SET_VECTOR_ELT(state, 230, ScalarInteger(main_model_p->dim_psia));
  SET_VECTOR_ELT(state, 231, allocVector(REALSXP, main_model_p->dim_psia));
  memcpy(REAL(VECTOR_ELT(state, 231)), main_model_p->psia, main_model_p->dim_psia * sizeof(double));
  SET_VECTOR_ELT(state, 232, ScalarInteger(main_model_p->dim_psib));
  SET_VECTOR_ELT(state, 233, allocVector(REALSXP, main_model_p->dim_psib));
  memcpy(REAL(VECTOR_ELT(state, 233)), main_model_p->psib, main_model_p->dim_psib * sizeof(double));
  SET_VECTOR_ELT(state, 234, ScalarInteger(main_model_p->dim_kappaa));
  SET_VECTOR_ELT(state, 235, allocVector(REALSXP, main_model_p->dim_kappaa));
  memcpy(REAL(VECTOR_ELT(state, 235)), main_model_p->kappaa, main_model_p->dim_kappaa * sizeof(double));
  SET_VECTOR_ELT(state, 236, ScalarInteger(main_model_p->offset_output_kappaa));
  SET_VECTOR_ELT(state, 237, ScalarInteger(main_model_p->dim_kappab));
  SET_VECTOR_ELT(state, 238, allocVector(REALSXP, main_model_p->dim_kappab));
  memcpy(REAL(VECTOR_ELT(state, 238)), main_model_p->kappab, main_model_p->dim_kappab * sizeof(double));
  SET_VECTOR_ELT(state, 239, ScalarInteger(main_model_p->offset_output_kappab));
  SET_VECTOR_ELT(state, 240, ScalarInteger(main_model_p->dim_kappac));
  SET_VECTOR_ELT(state, 241, allocVector(REALSXP, main_model_p->dim_kappac));
  memcpy(REAL(VECTOR_ELT(state, 241)), main_model_p->kappac, main_model_p->dim_kappac * sizeof(double));
  SET_VECTOR_ELT(state, 242, ScalarInteger(main_model_p->offset_output_kappac));
  SET_VECTOR_ELT(state, 243, ScalarInteger(main_model_p->dim_kappa1));
  SET_VECTOR_ELT(state, 244, allocVector(REALSXP, main_model_p->dim_kappa1));
  memcpy(REAL(VECTOR_ELT(state, 244)), main_model_p->kappa1, main_model_p->dim_kappa1 * sizeof(double));
  SET_VECTOR_ELT(state, 245, ScalarInteger(main_model_p->offset_output_kappa1));
  SET_VECTOR_ELT(state, 246, ScalarInteger(main_model_p->dim_alpha01));
  SET_VECTOR_ELT(state, 247, allocVector(REALSXP, main_model_p->dim_alpha01));
  memcpy(REAL(VECTOR_ELT(state, 247)), main_model_p->alpha01, main_model_p->dim_alpha01 * sizeof(double));
  SET_VECTOR_ELT(state, 248, ScalarInteger(main_model_p->offset_output_alpha01));
  SET_VECTOR_ELT(state, 249, ScalarInteger(main_model_p->dim_alpha02));
  SET_VECTOR_ELT(state, 250, allocVector(REALSXP, main_model_p->dim_alpha02));
  memcpy(REAL(VECTOR_ELT(state, 250)), main_model_p->alpha02, main_model_p->dim_alpha02 * sizeof(double));
  SET_VECTOR_ELT(state, 251, ScalarInteger(main_model_p->offset_output_alpha02));
  SET_VECTOR_ELT(state, 252, ScalarInteger(main_model_p->dim_alpha03));
  SET_VECTOR_ELT(state, 253, allocVector(REALSXP, main_model_p->dim_alpha03));
  memcpy(REAL(VECTOR_ELT(state, 253)), main_model_p->alpha03, main_model_p->dim_alpha03 * sizeof(double));
  SET_VECTOR_ELT(state, 254, ScalarInteger(main_model_p->dim_alpha04));
  SET_VECTOR_ELT(state, 255, allocVector(REALSXP, main_model_p->dim_alpha04));
  memcpy(REAL(VECTOR_ELT(state, 255)), main_model_p->alpha04, main_model_p->dim_alpha04 * sizeof(double));
  SET_VECTOR_ELT(state, 256, ScalarInteger(main_model_p->dim_alpha05));
  SET_VECTOR_ELT(state, 257, allocVector(REALSXP, main_model_p->dim_alpha05));
  memcpy(REAL(VECTOR_ELT(state, 257)), main_model_p->alpha05, main_model_p->dim_alpha05 * sizeof(double));
  SET_VECTOR_ELT(state, 258, ScalarInteger(main_model_p->offset_output_alpha05));
  SET_VECTOR_ELT(state, 259, ScalarInteger(main_model_p->dim_alpha11));
  SET_VECTOR_ELT(state, 260, allocVector(REALSXP, main_model_p->dim_alpha11));
  memcpy(REAL(VECTOR_ELT(state, 260)), main_model_p->alpha11, main_model_p->dim_alpha11 * sizeof(double));
  SET_VECTOR_ELT(state, 261, ScalarInteger(main_model_p->offset_output_alpha11));
  SET_VECTOR_ELT(state, 262, ScalarInteger(main_model_p->dim_alpha22));
  SET_VECTOR_ELT(state, 263, allocVector(REALSXP, main_model_p->dim_alpha22));
  memcpy(REAL(VECTOR_ELT(state, 263)), main_model_p->alpha22, main_model_p->dim_alpha22 * sizeof(double));
  SET_VECTOR_ELT(state, 264, ScalarInteger(main_model_p->offset_output_alpha22));
  SET_VECTOR_ELT(state, 265, ScalarInteger(main_model_p->dim_alpha23));
  SET_VECTOR_ELT(state, 266, allocVector(REALSXP, main_model_p->dim_alpha23));
  memcpy(REAL(VECTOR_ELT(state, 266)), main_model_p->alpha23, main_model_p->dim_alpha23 * sizeof(double));
  SET_VECTOR_ELT(state, 267, ScalarInteger(main_model_p->dim_alpha24));
  SET_VECTOR_ELT(state, 268, allocVector(REALSXP, main_model_p->dim_alpha24));
  memcpy(REAL(VECTOR_ELT(state, 268)), main_model_p->alpha24, main_model_p->dim_alpha24 * sizeof(double));
  SET_VECTOR_ELT(state, 269, ScalarInteger(main_model_p->dim_alpha25));
  SET_VECTOR_ELT(state, 270, allocVector(REALSXP, main_model_p->dim_alpha25));
  memcpy(REAL(VECTOR_ELT(state, 270)), main_model_p->alpha25, main_model_p->dim_alpha25 * sizeof(double));
  SET_VECTOR_ELT(state, 271, ScalarInteger(main_model_p->dim_alpha32));
  SET_VECTOR_ELT(state, 272, allocVector(REALSXP, main_model_p->dim_alpha32));
  memcpy(REAL(VECTOR_ELT(state, 272)), main_model_p->alpha32, main_model_p->dim_alpha32 * sizeof(double));
  SET_VECTOR_ELT(state, 273, ScalarInteger(main_model_p->dim_alpha33));
  SET_VECTOR_ELT(state, 274, allocVector(REALSXP, main_model_p->dim_alpha33));
  memcpy(REAL(VECTOR_ELT(state, 274)), main_model_p->alpha33, main_model_p->dim_alpha33 * sizeof(double));
  SET_VECTOR_ELT(state, 275, ScalarInteger(main_model_p->dim_alpha34));
  SET_VECTOR_ELT(state, 276, allocVector(REALSXP, main_model_p->dim_alpha34));
  memcpy(REAL(VECTOR_ELT(state, 276)), main_model_p->alpha34, main_model_p->dim_alpha34 * sizeof(double));
  SET_VECTOR_ELT(state, 277, ScalarInteger(main_model_p->dim_alpha35));
  SET_VECTOR_ELT(state, 278, allocVector(REALSXP, main_model_p->dim_alpha35));
  memcpy(REAL(VECTOR_ELT(state, 278)), main_model_p->alpha35, main_model_p->dim_alpha35 * sizeof(double));
  SET_VECTOR_ELT(state, 279, ScalarInteger(main_model_p->offset_output_alpha35));
  SET_VECTOR_ELT(state, 280, ScalarInteger(main_model_p->dim_alpha42));
  SET_VECTOR_ELT(state, 281, allocVector(REALSXP, main_model_p->dim_alpha42));
  memcpy(REAL(VECTOR_ELT(state, 281)), main_model_p->alpha42, main_model_p->dim_alpha42 * sizeof(double));
  SET_VECTOR_ELT(state, 282, ScalarInteger(main_model_p->dim_alpha43));
  SET_VECTOR_ELT(state, 283, allocVector(REALSXP, main_model_p->dim_alpha43));
  memcpy(REAL(VECTOR_ELT(state, 283)), main_model_p->alpha43, main_model_p->dim_alpha43 * sizeof(double));
  SET_VECTOR_ELT(state, 284, ScalarInteger(main_model_p->dim_alpha44));
  SET_VECTOR_ELT(state, 285, allocVector(REALSXP, main_model_p->dim_alpha44));
  memcpy(REAL(VECTOR_ELT(state, 285)), main_model_p->alpha44, main_model_p->dim_alpha44 * sizeof(double));
  SET_VECTOR_ELT(state, 286, ScalarInteger(main_model_p->dim_alpha45));
  SET_VECTOR_ELT(state, 287, allocVector(REALSXP, main_model_p->dim_alpha45));
  memcpy(REAL(VECTOR_ELT(state, 287)), main_model_p->alpha45, main_model_p->dim_alpha45 * sizeof(double));
  SET_VECTOR_ELT(state, 288, ScalarInteger(main_model_p->dim_beta_comm));
  SET_VECTOR_ELT(state, 289, allocVector(REALSXP, main_model_p->dim_beta_comm));
  memcpy(REAL(VECTOR_ELT(state, 289)), main_model_p->beta_comm, main_model_p->dim_beta_comm * sizeof(double));
  SET_VECTOR_ELT(state, 290, ScalarInteger(main_model_p->offset_output_beta_comm));
  SET_VECTOR_ELT(state, 291, ScalarInteger(main_model_p->dim_beta_noncomm));
  SET_VECTOR_ELT(state, 292, allocVector(REALSXP, main_model_p->dim_beta_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 292)), main_model_p->beta_noncomm, main_model_p->dim_beta_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 293, ScalarInteger(main_model_p->offset_output_beta_noncomm));
  SET_VECTOR_ELT(state, 294, ScalarInteger(main_model_p->dim_p_comm));
  SET_VECTOR_ELT(state, 295, ScalarInteger(main_model_p->dim_p_comm_1));
  SET_VECTOR_ELT(state, 296, ScalarInteger(main_model_p->dim_p_comm_2));
  SET_VECTOR_ELT(state, 297, allocVector(REALSXP, main_model_p->dim_p_comm));
  memcpy(REAL(VECTOR_ELT(state, 297)), main_model_p->p_comm, main_model_p->dim_p_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 297), 2, main_model_p->dim_p_comm_1, main_model_p->dim_p_comm_2);
  SET_VECTOR_ELT(state, 298, ScalarInteger(main_model_p->offset_output_p_comm));
  SET_VECTOR_ELT(state, 299, ScalarInteger(main_model_p->dim_p_noncomm));
  SET_VECTOR_ELT(state, 300, ScalarInteger(main_model_p->dim_p_noncomm_1));
  SET_VECTOR_ELT(state, 301, ScalarInteger(main_model_p->dim_p_noncomm_2));
  SET_VECTOR_ELT(state, 302, allocVector(REALSXP, main_model_p->dim_p_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 302)), main_model_p->p_noncomm, main_model_p->dim_p_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 302), 2, main_model_p->dim_p_noncomm_1, main_model_p->dim_p_noncomm_2);
  SET_VECTOR_ELT(state, 303, ScalarInteger(main_model_p->offset_output_p_noncomm));
  SET_VECTOR_ELT(state, 304, ScalarInteger(main_model_p->dim_ec));
  SET_VECTOR_ELT(state, 305, allocVector(REALSXP, main_model_p->dim_ec));
  memcpy(REAL(VECTOR_ELT(state, 305)), main_model_p->ec, main_model_p->dim_ec * sizeof(double));
  SET_VECTOR_ELT(state, 306, ScalarInteger(main_model_p->dim_eP));
  SET_VECTOR_ELT(state, 307, allocVector(REALSXP, main_model_p->dim_eP));
  memcpy(REAL(VECTOR_ELT(state, 307)), main_model_p->eP, main_model_p->dim_eP * sizeof(double));
  SET_VECTOR_ELT(state, 308, ScalarInteger(main_model_p->dim_eP0));
  SET_VECTOR_ELT(state, 309, allocVector(REALSXP, main_model_p->dim_eP0));
  memcpy(REAL(VECTOR_ELT(state, 309)), main_model_p->eP0, main_model_p->dim_eP0 * sizeof(double));
  SET_VECTOR_ELT(state, 310, ScalarInteger(main_model_p->dim_eP1a));
  SET_VECTOR_ELT(state, 311, allocVector(REALSXP, main_model_p->dim_eP1a));
  memcpy(REAL(VECTOR_ELT(state, 311)), main_model_p->eP1a, main_model_p->dim_eP1a * sizeof(double));
  SET_VECTOR_ELT(state, 312, ScalarInteger(main_model_p->dim_eP1b));
  SET_VECTOR_ELT(state, 313, allocVector(REALSXP, main_model_p->dim_eP1b));
  memcpy(REAL(VECTOR_ELT(state, 313)), main_model_p->eP1b, main_model_p->dim_eP1b * sizeof(double));
  SET_VECTOR_ELT(state, 314, ScalarInteger(main_model_p->dim_eP1c));
  SET_VECTOR_ELT(state, 315, allocVector(REALSXP, main_model_p->dim_eP1c));
  memcpy(REAL(VECTOR_ELT(state, 315)), main_model_p->eP1c, main_model_p->dim_eP1c * sizeof(double));
  SET_VECTOR_ELT(state, 316, ScalarInteger(main_model_p->dim_eP1d));
  SET_VECTOR_ELT(state, 317, allocVector(REALSXP, main_model_p->dim_eP1d));
  memcpy(REAL(VECTOR_ELT(state, 317)), main_model_p->eP1d, main_model_p->dim_eP1d * sizeof(double));
  SET_VECTOR_ELT(state, 318, ScalarInteger(main_model_p->dim_fc_comm));
  SET_VECTOR_ELT(state, 319, ScalarInteger(main_model_p->dim_fc_comm_1));
  SET_VECTOR_ELT(state, 320, ScalarInteger(main_model_p->dim_fc_comm_2));
  SET_VECTOR_ELT(state, 321, allocVector(REALSXP, main_model_p->dim_fc_comm));
  memcpy(REAL(VECTOR_ELT(state, 321)), main_model_p->fc_comm, main_model_p->dim_fc_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 321), 2, main_model_p->dim_fc_comm_1, main_model_p->dim_fc_comm_2);
  SET_VECTOR_ELT(state, 322, ScalarInteger(main_model_p->offset_output_fc_comm));
  SET_VECTOR_ELT(state, 323, ScalarInteger(main_model_p->dim_fP_comm));
  SET_VECTOR_ELT(state, 324, allocVector(REALSXP, main_model_p->dim_fP_comm));
  memcpy(REAL(VECTOR_ELT(state, 324)), main_model_p->fP_comm, main_model_p->dim_fP_comm * sizeof(double));
  SET_VECTOR_ELT(state, 325, ScalarInteger(main_model_p->offset_output_fP_comm));
  SET_VECTOR_ELT(state, 326, ScalarInteger(main_model_p->dim_fc_noncomm));
  SET_VECTOR_ELT(state, 327, ScalarInteger(main_model_p->dim_fc_noncomm_1));
  SET_VECTOR_ELT(state, 328, ScalarInteger(main_model_p->dim_fc_noncomm_2));
  SET_VECTOR_ELT(state, 329, allocVector(REALSXP, main_model_p->dim_fc_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 329)), main_model_p->fc_noncomm, main_model_p->dim_fc_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 329), 2, main_model_p->dim_fc_noncomm_1, main_model_p->dim_fc_noncomm_2);
  SET_VECTOR_ELT(state, 330, ScalarInteger(main_model_p->offset_output_fc_noncomm));
  SET_VECTOR_ELT(state, 331, ScalarInteger(main_model_p->dim_fP_noncomm));
  SET_VECTOR_ELT(state, 332, allocVector(REALSXP, main_model_p->dim_fP_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 332)), main_model_p->fP_noncomm, main_model_p->dim_fP_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 333, ScalarInteger(main_model_p->offset_output_fP_noncomm));
  SET_VECTOR_ELT(state, 334, ScalarInteger(main_model_p->dim_n_comm));
  SET_VECTOR_ELT(state, 335, ScalarInteger(main_model_p->dim_n_comm_1));
  SET_VECTOR_ELT(state, 336, ScalarInteger(main_model_p->dim_n_comm_2));
  SET_VECTOR_ELT(state, 337, allocVector(REALSXP, main_model_p->dim_n_comm));
  memcpy(REAL(VECTOR_ELT(state, 337)), main_model_p->n_comm, main_model_p->dim_n_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 337), 2, main_model_p->dim_n_comm_1, main_model_p->dim_n_comm_2);
  SET_VECTOR_ELT(state, 338, ScalarInteger(main_model_p->offset_output_n_comm));
  SET_VECTOR_ELT(state, 339, ScalarInteger(main_model_p->dim_n_noncomm));
  SET_VECTOR_ELT(state, 340, ScalarInteger(main_model_p->dim_n_noncomm_1));
  SET_VECTOR_ELT(state, 341, ScalarInteger(main_model_p->dim_n_noncomm_2));
  SET_VECTOR_ELT(state, 342, allocVector(REALSXP, main_model_p->dim_n_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 342)), main_model_p->n_noncomm, main_model_p->dim_n_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 342), 2, main_model_p->dim_n_noncomm_1, main_model_p->dim_n_noncomm_2);
  SET_VECTOR_ELT(state, 343, ScalarInteger(main_model_p->offset_output_n_noncomm));
  SET_VECTOR_ELT(state, 344, ScalarInteger(main_model_p->dim_cumuHIVDeaths));
  SET_VECTOR_ELT(state, 345, allocVector(REALSXP, main_model_p->dim_cumuHIVDeaths));
  memcpy(REAL(VECTOR_ELT(state, 345)), main_model_p->initial_cumuHIVDeaths, main_model_p->dim_cumuHIVDeaths * sizeof(double));
  SET_VECTOR_ELT(state, 346, ScalarInteger(main_model_p->offset_cumuHIVDeaths));
  SET_VECTOR_ELT(state, 347, ScalarInteger(main_model_p->dim_cumuARTinitiations));
  SET_VECTOR_ELT(state, 348, allocVector(REALSXP, main_model_p->dim_cumuARTinitiations));
  memcpy(REAL(VECTOR_ELT(state, 348)), main_model_p->initial_cumuARTinitiations, main_model_p->dim_cumuARTinitiations * sizeof(double));
  SET_VECTOR_ELT(state, 349, ScalarInteger(main_model_p->offset_cumuARTinitiations));
  SET_VECTOR_ELT(state, 350, ScalarInteger(main_model_p->dim_cumuARTREinitiations));
  SET_VECTOR_ELT(state, 351, allocVector(REALSXP, main_model_p->dim_cumuARTREinitiations));
  memcpy(REAL(VECTOR_ELT(state, 351)), main_model_p->initial_cumuARTREinitiations, main_model_p->dim_cumuARTREinitiations * sizeof(double));
  SET_VECTOR_ELT(state, 352, ScalarInteger(main_model_p->offset_cumuARTREinitiations));
  SET_VECTOR_ELT(state, 353, ScalarInteger(main_model_p->dim_cumuTesting));
  SET_VECTOR_ELT(state, 354, allocVector(REALSXP, main_model_p->dim_cumuTesting));
  memcpy(REAL(VECTOR_ELT(state, 354)), main_model_p->initial_cumuTesting, main_model_p->dim_cumuTesting * sizeof(double));
  SET_VECTOR_ELT(state, 355, ScalarInteger(main_model_p->offset_cumuTesting));
  SET_VECTOR_ELT(state, 356, ScalarInteger(main_model_p->dim_cumuAllDeaths));
  SET_VECTOR_ELT(state, 357, allocVector(REALSXP, main_model_p->dim_cumuAllDeaths));
  memcpy(REAL(VECTOR_ELT(state, 357)), main_model_p->initial_cumuAllDeaths, main_model_p->dim_cumuAllDeaths * sizeof(double));
  SET_VECTOR_ELT(state, 358, ScalarInteger(main_model_p->offset_cumuAllDeaths));
  SET_VECTOR_ELT(state, 359, ScalarInteger(main_model_p->dim_cumuInf));
  SET_VECTOR_ELT(state, 360, allocVector(REALSXP, main_model_p->dim_cumuInf));
  memcpy(REAL(VECTOR_ELT(state, 360)), main_model_p->initial_cumuInf, main_model_p->dim_cumuInf * sizeof(double));
  SET_VECTOR_ELT(state, 361, ScalarInteger(main_model_p->offset_cumuInf));
  SET_VECTOR_ELT(state, 362, ScalarInteger(main_model_p->dim_OnPrEP));
  SET_VECTOR_ELT(state, 363, allocVector(REALSXP, main_model_p->dim_OnPrEP));
  memcpy(REAL(VECTOR_ELT(state, 363)), main_model_p->initial_OnPrEP, main_model_p->dim_OnPrEP * sizeof(double));
  SET_VECTOR_ELT(state, 364, ScalarInteger(main_model_p->offset_OnPrEP));
  SET_VECTOR_ELT(state, 365, ScalarInteger(main_model_p->dim_S0));
  SET_VECTOR_ELT(state, 366, allocVector(REALSXP, main_model_p->dim_S0));
  memcpy(REAL(VECTOR_ELT(state, 366)), main_model_p->initial_S0, main_model_p->dim_S0 * sizeof(double));
  SET_VECTOR_ELT(state, 367, ScalarInteger(main_model_p->offset_S0));
  SET_VECTOR_ELT(state, 368, ScalarInteger(main_model_p->dim_S1a));
  SET_VECTOR_ELT(state, 369, allocVector(REALSXP, main_model_p->dim_S1a));
  memcpy(REAL(VECTOR_ELT(state, 369)), main_model_p->initial_S1a, main_model_p->dim_S1a * sizeof(double));
  SET_VECTOR_ELT(state, 370, ScalarInteger(main_model_p->offset_S1a));
  SET_VECTOR_ELT(state, 371, ScalarInteger(main_model_p->dim_S1b));
  SET_VECTOR_ELT(state, 372, allocVector(REALSXP, main_model_p->dim_S1b));
  memcpy(REAL(VECTOR_ELT(state, 372)), main_model_p->initial_S1b, main_model_p->dim_S1b * sizeof(double));
  SET_VECTOR_ELT(state, 373, ScalarInteger(main_model_p->offset_S1b));
  SET_VECTOR_ELT(state, 374, ScalarInteger(main_model_p->dim_S1c));
  SET_VECTOR_ELT(state, 375, allocVector(REALSXP, main_model_p->dim_S1c));
  memcpy(REAL(VECTOR_ELT(state, 375)), main_model_p->initial_S1c, main_model_p->dim_S1c * sizeof(double));
  SET_VECTOR_ELT(state, 376, ScalarInteger(main_model_p->offset_S1c));
  SET_VECTOR_ELT(state, 377, ScalarInteger(main_model_p->dim_S1d));
  SET_VECTOR_ELT(state, 378, allocVector(REALSXP, main_model_p->dim_S1d));
  memcpy(REAL(VECTOR_ELT(state, 378)), main_model_p->initial_S1d, main_model_p->dim_S1d * sizeof(double));
  SET_VECTOR_ELT(state, 379, ScalarInteger(main_model_p->offset_S1d));
  SET_VECTOR_ELT(state, 380, ScalarInteger(main_model_p->dim_I01));
  SET_VECTOR_ELT(state, 381, allocVector(REALSXP, main_model_p->dim_I01));
  memcpy(REAL(VECTOR_ELT(state, 381)), main_model_p->initial_I01, main_model_p->dim_I01 * sizeof(double));
  SET_VECTOR_ELT(state, 382, ScalarInteger(main_model_p->offset_I01));
  SET_VECTOR_ELT(state, 383, ScalarInteger(main_model_p->dim_I11));
  SET_VECTOR_ELT(state, 384, allocVector(REALSXP, main_model_p->dim_I11));
  memcpy(REAL(VECTOR_ELT(state, 384)), main_model_p->initial_I11, main_model_p->dim_I11 * sizeof(double));
  SET_VECTOR_ELT(state, 385, ScalarInteger(main_model_p->offset_I11));
  SET_VECTOR_ELT(state, 386, ScalarInteger(main_model_p->dim_I02));
  SET_VECTOR_ELT(state, 387, allocVector(REALSXP, main_model_p->dim_I02));
  memcpy(REAL(VECTOR_ELT(state, 387)), main_model_p->initial_I02, main_model_p->dim_I02 * sizeof(double));
  SET_VECTOR_ELT(state, 388, ScalarInteger(main_model_p->offset_I02));
  SET_VECTOR_ELT(state, 389, ScalarInteger(main_model_p->dim_I03));
  SET_VECTOR_ELT(state, 390, allocVector(REALSXP, main_model_p->dim_I03));
  memcpy(REAL(VECTOR_ELT(state, 390)), main_model_p->initial_I03, main_model_p->dim_I03 * sizeof(double));
  SET_VECTOR_ELT(state, 391, ScalarInteger(main_model_p->offset_I03));
  SET_VECTOR_ELT(state, 392, ScalarInteger(main_model_p->dim_I04));
  SET_VECTOR_ELT(state, 393, allocVector(REALSXP, main_model_p->dim_I04));
  memcpy(REAL(VECTOR_ELT(state, 393)), main_model_p->initial_I04, main_model_p->dim_I04 * sizeof(double));
  SET_VECTOR_ELT(state, 394, ScalarInteger(main_model_p->offset_I04));
  SET_VECTOR_ELT(state, 395, ScalarInteger(main_model_p->dim_I05));
  SET_VECTOR_ELT(state, 396, allocVector(REALSXP, main_model_p->dim_I05));
  memcpy(REAL(VECTOR_ELT(state, 396)), main_model_p->initial_I05, main_model_p->dim_I05 * sizeof(double));
  SET_VECTOR_ELT(state, 397, ScalarInteger(main_model_p->offset_I05));
  SET_VECTOR_ELT(state, 398, ScalarInteger(main_model_p->dim_I22));
  SET_VECTOR_ELT(state, 399, allocVector(REALSXP, main_model_p->dim_I22));
  memcpy(REAL(VECTOR_ELT(state, 399)), main_model_p->initial_I22, main_model_p->dim_I22 * sizeof(double));
  SET_VECTOR_ELT(state, 400, ScalarInteger(main_model_p->offset_I22));
  SET_VECTOR_ELT(state, 401, ScalarInteger(main_model_p->dim_I23));
  SET_VECTOR_ELT(state, 402, allocVector(REALSXP, main_model_p->dim_I23));
  memcpy(REAL(VECTOR_ELT(state, 402)), main_model_p->initial_I23, main_model_p->dim_I23 * sizeof(double));
  SET_VECTOR_ELT(state, 403, ScalarInteger(main_model_p->offset_I23));
  SET_VECTOR_ELT(state, 404, ScalarInteger(main_model_p->dim_I24));
  SET_VECTOR_ELT(state, 405, allocVector(REALSXP, main_model_p->dim_I24));
  memcpy(REAL(VECTOR_ELT(state, 405)), main_model_p->initial_I24, main_model_p->dim_I24 * sizeof(double));
  SET_VECTOR_ELT(state, 406, ScalarInteger(main_model_p->offset_I24));
  SET_VECTOR_ELT(state, 407, ScalarInteger(main_model_p->dim_I25));
  SET_VECTOR_ELT(state, 408, allocVector(REALSXP, main_model_p->dim_I25));
  memcpy(REAL(VECTOR_ELT(state, 408)), main_model_p->initial_I25, main_model_p->dim_I25 * sizeof(double));
  SET_VECTOR_ELT(state, 409, ScalarInteger(main_model_p->offset_I25));
  SET_VECTOR_ELT(state, 410, ScalarInteger(main_model_p->dim_I32));
  SET_VECTOR_ELT(state, 411, allocVector(REALSXP, main_model_p->dim_I32));
  memcpy(REAL(VECTOR_ELT(state, 411)), main_model_p->initial_I32, main_model_p->dim_I32 * sizeof(double));
  SET_VECTOR_ELT(state, 412, ScalarInteger(main_model_p->offset_I32));
  SET_VECTOR_ELT(state, 413, ScalarInteger(main_model_p->dim_I33));
  SET_VECTOR_ELT(state, 414, allocVector(REALSXP, main_model_p->dim_I33));
  memcpy(REAL(VECTOR_ELT(state, 414)), main_model_p->initial_I33, main_model_p->dim_I33 * sizeof(double));
  SET_VECTOR_ELT(state, 415, ScalarInteger(main_model_p->offset_I33));
  SET_VECTOR_ELT(state, 416, ScalarInteger(main_model_p->dim_I34));
  SET_VECTOR_ELT(state, 417, allocVector(REALSXP, main_model_p->dim_I34));
  memcpy(REAL(VECTOR_ELT(state, 417)), main_model_p->initial_I34, main_model_p->dim_I34 * sizeof(double));
  SET_VECTOR_ELT(state, 418, ScalarInteger(main_model_p->offset_I34));
  SET_VECTOR_ELT(state, 419, ScalarInteger(main_model_p->dim_I35));
  SET_VECTOR_ELT(state, 420, allocVector(REALSXP, main_model_p->dim_I35));
  memcpy(REAL(VECTOR_ELT(state, 420)), main_model_p->initial_I35, main_model_p->dim_I35 * sizeof(double));
  SET_VECTOR_ELT(state, 421, ScalarInteger(main_model_p->offset_I35));
  SET_VECTOR_ELT(state, 422, ScalarInteger(main_model_p->dim_I42));
  SET_VECTOR_ELT(state, 423, allocVector(REALSXP, main_model_p->dim_I42));
  memcpy(REAL(VECTOR_ELT(state, 423)), main_model_p->initial_I42, main_model_p->dim_I42 * sizeof(double));
  SET_VECTOR_ELT(state, 424, ScalarInteger(main_model_p->offset_I42));
  SET_VECTOR_ELT(state, 425, ScalarInteger(main_model_p->dim_I43));
  SET_VECTOR_ELT(state, 426, allocVector(REALSXP, main_model_p->dim_I43));
  memcpy(REAL(VECTOR_ELT(state, 426)), main_model_p->initial_I43, main_model_p->dim_I43 * sizeof(double));
  SET_VECTOR_ELT(state, 427, ScalarInteger(main_model_p->offset_I43));
  SET_VECTOR_ELT(state, 428, ScalarInteger(main_model_p->dim_I44));
  SET_VECTOR_ELT(state, 429, allocVector(REALSXP, main_model_p->dim_I44));
  memcpy(REAL(VECTOR_ELT(state, 429)), main_model_p->initial_I44, main_model_p->dim_I44 * sizeof(double));
  SET_VECTOR_ELT(state, 430, ScalarInteger(main_model_p->offset_I44));
  SET_VECTOR_ELT(state, 431, ScalarInteger(main_model_p->dim_I45));
  SET_VECTOR_ELT(state, 432, allocVector(REALSXP, main_model_p->dim_I45));
  memcpy(REAL(VECTOR_ELT(state, 432)), main_model_p->initial_I45, main_model_p->dim_I45 * sizeof(double));
  SET_VECTOR_ELT(state, 433, ScalarInteger(main_model_p->offset_I45));
  SET_VECTOR_ELT(state, 434, ScalarInteger(main_model_p->dim_S0_init));
  SET_VECTOR_ELT(state, 435, allocVector(REALSXP, main_model_p->dim_S0_init));
  memcpy(REAL(VECTOR_ELT(state, 435)), main_model_p->S0_init, main_model_p->dim_S0_init * sizeof(double));
  SET_VECTOR_ELT(state, 436, ScalarInteger(main_model_p->dim_S1a_init));
  SET_VECTOR_ELT(state, 437, allocVector(REALSXP, main_model_p->dim_S1a_init));
  memcpy(REAL(VECTOR_ELT(state, 437)), main_model_p->S1a_init, main_model_p->dim_S1a_init * sizeof(double));
  SET_VECTOR_ELT(state, 438, ScalarInteger(main_model_p->dim_S1b_init));
  SET_VECTOR_ELT(state, 439, allocVector(REALSXP, main_model_p->dim_S1b_init));
  memcpy(REAL(VECTOR_ELT(state, 439)), main_model_p->S1b_init, main_model_p->dim_S1b_init * sizeof(double));
  SET_VECTOR_ELT(state, 440, ScalarInteger(main_model_p->dim_S1c_init));
  SET_VECTOR_ELT(state, 441, allocVector(REALSXP, main_model_p->dim_S1c_init));
  memcpy(REAL(VECTOR_ELT(state, 441)), main_model_p->S1c_init, main_model_p->dim_S1c_init * sizeof(double));
  SET_VECTOR_ELT(state, 442, ScalarInteger(main_model_p->dim_S1d_init));
  SET_VECTOR_ELT(state, 443, allocVector(REALSXP, main_model_p->dim_S1d_init));
  memcpy(REAL(VECTOR_ELT(state, 443)), main_model_p->S1d_init, main_model_p->dim_S1d_init * sizeof(double));
  SET_VECTOR_ELT(state, 444, ScalarInteger(main_model_p->dim_I01_init));
  SET_VECTOR_ELT(state, 445, allocVector(REALSXP, main_model_p->dim_I01_init));
  memcpy(REAL(VECTOR_ELT(state, 445)), main_model_p->I01_init, main_model_p->dim_I01_init * sizeof(double));
  SET_VECTOR_ELT(state, 446, ScalarInteger(main_model_p->dim_I11_init));
  SET_VECTOR_ELT(state, 447, allocVector(REALSXP, main_model_p->dim_I11_init));
  memcpy(REAL(VECTOR_ELT(state, 447)), main_model_p->I11_init, main_model_p->dim_I11_init * sizeof(double));
  SET_VECTOR_ELT(state, 448, ScalarInteger(main_model_p->dim_I02_init));
  SET_VECTOR_ELT(state, 449, allocVector(REALSXP, main_model_p->dim_I02_init));
  memcpy(REAL(VECTOR_ELT(state, 449)), main_model_p->I02_init, main_model_p->dim_I02_init * sizeof(double));
  SET_VECTOR_ELT(state, 450, ScalarInteger(main_model_p->dim_I03_init));
  SET_VECTOR_ELT(state, 451, allocVector(REALSXP, main_model_p->dim_I03_init));
  memcpy(REAL(VECTOR_ELT(state, 451)), main_model_p->I03_init, main_model_p->dim_I03_init * sizeof(double));
  SET_VECTOR_ELT(state, 452, ScalarInteger(main_model_p->dim_I04_init));
  SET_VECTOR_ELT(state, 453, allocVector(REALSXP, main_model_p->dim_I04_init));
  memcpy(REAL(VECTOR_ELT(state, 453)), main_model_p->I04_init, main_model_p->dim_I04_init * sizeof(double));
  SET_VECTOR_ELT(state, 454, ScalarInteger(main_model_p->dim_I05_init));
  SET_VECTOR_ELT(state, 455, allocVector(REALSXP, main_model_p->dim_I05_init));
  memcpy(REAL(VECTOR_ELT(state, 455)), main_model_p->I05_init, main_model_p->dim_I05_init * sizeof(double));
  SET_VECTOR_ELT(state, 456, ScalarInteger(main_model_p->dim_I22_init));
  SET_VECTOR_ELT(state, 457, allocVector(REALSXP, main_model_p->dim_I22_init));
  memcpy(REAL(VECTOR_ELT(state, 457)), main_model_p->I22_init, main_model_p->dim_I22_init * sizeof(double));
  SET_VECTOR_ELT(state, 458, ScalarInteger(main_model_p->dim_I23_init));
  SET_VECTOR_ELT(state, 459, allocVector(REALSXP, main_model_p->dim_I23_init));
  memcpy(REAL(VECTOR_ELT(state, 459)), main_model_p->I23_init, main_model_p->dim_I23_init * sizeof(double));
  SET_VECTOR_ELT(state, 460, ScalarInteger(main_model_p->dim_I24_init));
  SET_VECTOR_ELT(state, 461, allocVector(REALSXP, main_model_p->dim_I24_init));
  memcpy(REAL(VECTOR_ELT(state, 461)), main_model_p->I24_init, main_model_p->dim_I24_init * sizeof(double));
  SET_VECTOR_ELT(state, 462, ScalarInteger(main_model_p->dim_I25_init));
  SET_VECTOR_ELT(state, 463, allocVector(REALSXP, main_model_p->dim_I25_init));
  memcpy(REAL(VECTOR_ELT(state, 463)), main_model_p->I25_init, main_model_p->dim_I25_init * sizeof(double));
  SET_VECTOR_ELT(state, 464, ScalarInteger(main_model_p->dim_I32_init));
  SET_VECTOR_ELT(state, 465, allocVector(REALSXP, main_model_p->dim_I32_init));
  memcpy(REAL(VECTOR_ELT(state, 465)), main_model_p->I32_init, main_model_p->dim_I32_init * sizeof(double));
  SET_VECTOR_ELT(state, 466, ScalarInteger(main_model_p->dim_I33_init));
  SET_VECTOR_ELT(state, 467, allocVector(REALSXP, main_model_p->dim_I33_init));
  memcpy(REAL(VECTOR_ELT(state, 467)), main_model_p->I33_init, main_model_p->dim_I33_init * sizeof(double));
  SET_VECTOR_ELT(state, 468, ScalarInteger(main_model_p->dim_I34_init));
  SET_VECTOR_ELT(state, 469, allocVector(REALSXP, main_model_p->dim_I34_init));
  memcpy(REAL(VECTOR_ELT(state, 469)), main_model_p->I34_init, main_model_p->dim_I34_init * sizeof(double));
  SET_VECTOR_ELT(state, 470, ScalarInteger(main_model_p->dim_I35_init));
  SET_VECTOR_ELT(state, 471, allocVector(REALSXP, main_model_p->dim_I35_init));
  memcpy(REAL(VECTOR_ELT(state, 471)), main_model_p->I35_init, main_model_p->dim_I35_init * sizeof(double));
  SET_VECTOR_ELT(state, 472, ScalarInteger(main_model_p->dim_I42_init));
  SET_VECTOR_ELT(state, 473, allocVector(REALSXP, main_model_p->dim_I42_init));
  memcpy(REAL(VECTOR_ELT(state, 473)), main_model_p->I42_init, main_model_p->dim_I42_init * sizeof(double));
  SET_VECTOR_ELT(state, 474, ScalarInteger(main_model_p->dim_I43_init));
  SET_VECTOR_ELT(state, 475, allocVector(REALSXP, main_model_p->dim_I43_init));
  memcpy(REAL(VECTOR_ELT(state, 475)), main_model_p->I43_init, main_model_p->dim_I43_init * sizeof(double));
  SET_VECTOR_ELT(state, 476, ScalarInteger(main_model_p->dim_I44_init));
  SET_VECTOR_ELT(state, 477, allocVector(REALSXP, main_model_p->dim_I44_init));
  memcpy(REAL(VECTOR_ELT(state, 477)), main_model_p->I44_init, main_model_p->dim_I44_init * sizeof(double));
  SET_VECTOR_ELT(state, 478, ScalarInteger(main_model_p->dim_I45_init));
  SET_VECTOR_ELT(state, 479, allocVector(REALSXP, main_model_p->dim_I45_init));
  memcpy(REAL(VECTOR_ELT(state, 479)), main_model_p->I45_init, main_model_p->dim_I45_init * sizeof(double));
  SET_VECTOR_ELT(state, 480, ScalarInteger(main_model_p->dim_N));
  SET_VECTOR_ELT(state, 481, allocVector(REALSXP, main_model_p->dim_N));
  memcpy(REAL(VECTOR_ELT(state, 481)), main_model_p->N, main_model_p->dim_N * sizeof(double));
  SET_VECTOR_ELT(state, 482, ScalarInteger(main_model_p->offset_output_N));
  SET_VECTOR_ELT(state, 483, ScalarInteger(main_model_p->dim_E0));
  SET_VECTOR_ELT(state, 484, allocVector(REALSXP, main_model_p->dim_E0));
  memcpy(REAL(VECTOR_ELT(state, 484)), main_model_p->E0, main_model_p->dim_E0 * sizeof(double));
  SET_VECTOR_ELT(state, 485, ScalarInteger(main_model_p->offset_output_E0));
  SET_VECTOR_ELT(state, 486, ScalarInteger(main_model_p->dim_E1a));
  SET_VECTOR_ELT(state, 487, allocVector(REALSXP, main_model_p->dim_E1a));
  memcpy(REAL(VECTOR_ELT(state, 487)), main_model_p->E1a, main_model_p->dim_E1a * sizeof(double));
  SET_VECTOR_ELT(state, 488, ScalarInteger(main_model_p->offset_output_E1a));
  SET_VECTOR_ELT(state, 489, ScalarInteger(main_model_p->dim_E1b));
  SET_VECTOR_ELT(state, 490, allocVector(REALSXP, main_model_p->dim_E1b));
  memcpy(REAL(VECTOR_ELT(state, 490)), main_model_p->E1b, main_model_p->dim_E1b * sizeof(double));
  SET_VECTOR_ELT(state, 491, ScalarInteger(main_model_p->offset_output_E1b));
  SET_VECTOR_ELT(state, 492, ScalarInteger(main_model_p->dim_E1c));
  SET_VECTOR_ELT(state, 493, allocVector(REALSXP, main_model_p->dim_E1c));
  memcpy(REAL(VECTOR_ELT(state, 493)), main_model_p->E1c, main_model_p->dim_E1c * sizeof(double));
  SET_VECTOR_ELT(state, 494, ScalarInteger(main_model_p->offset_output_E1c));
  SET_VECTOR_ELT(state, 495, ScalarInteger(main_model_p->dim_E1d));
  SET_VECTOR_ELT(state, 496, allocVector(REALSXP, main_model_p->dim_E1d));
  memcpy(REAL(VECTOR_ELT(state, 496)), main_model_p->E1d, main_model_p->dim_E1d * sizeof(double));
  SET_VECTOR_ELT(state, 497, ScalarInteger(main_model_p->offset_output_E1d));
  SET_VECTOR_ELT(state, 498, ScalarInteger(main_model_p->dim_cumuInf_init));
  SET_VECTOR_ELT(state, 499, allocVector(REALSXP, main_model_p->dim_cumuInf_init));
  memcpy(REAL(VECTOR_ELT(state, 499)), main_model_p->cumuInf_init, main_model_p->dim_cumuInf_init * sizeof(double));
  SET_VECTOR_ELT(state, 500, ScalarInteger(main_model_p->dim_alphaItot));
  SET_VECTOR_ELT(state, 501, allocVector(REALSXP, main_model_p->dim_alphaItot));
  memcpy(REAL(VECTOR_ELT(state, 501)), main_model_p->alphaItot, main_model_p->dim_alphaItot * sizeof(double));
  SET_VECTOR_ELT(state, 502, ScalarInteger(main_model_p->offset_output_alphaItot));
  SET_VECTOR_ELT(state, 503, ScalarInteger(main_model_p->dim_prev));
  SET_VECTOR_ELT(state, 504, allocVector(REALSXP, main_model_p->dim_prev));
  memcpy(REAL(VECTOR_ELT(state, 504)), main_model_p->prev, main_model_p->dim_prev * sizeof(double));
  SET_VECTOR_ELT(state, 505, ScalarInteger(main_model_p->offset_output_prev));
  SET_VECTOR_ELT(state, 506, ScalarInteger(main_model_p->dim_lambda));
  SET_VECTOR_ELT(state, 507, ScalarInteger(main_model_p->dim_lambda_1));
  SET_VECTOR_ELT(state, 508, ScalarInteger(main_model_p->dim_lambda_2));
  SET_VECTOR_ELT(state, 509, allocVector(REALSXP, main_model_p->dim_lambda));
  memcpy(REAL(VECTOR_ELT(state, 509)), main_model_p->lambda, main_model_p->dim_lambda * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 509), 2, main_model_p->dim_lambda_1, main_model_p->dim_lambda_2);
  SET_VECTOR_ELT(state, 510, ScalarInteger(main_model_p->offset_output_lambda));
  SET_VECTOR_ELT(state, 511, ScalarInteger(main_model_p->dim_lambda_0));
  SET_VECTOR_ELT(state, 512, ScalarInteger(main_model_p->dim_lambda_0_1));
  SET_VECTOR_ELT(state, 513, ScalarInteger(main_model_p->dim_lambda_0_2));
  SET_VECTOR_ELT(state, 514, allocVector(REALSXP, main_model_p->dim_lambda_0));
  memcpy(REAL(VECTOR_ELT(state, 514)), main_model_p->lambda_0, main_model_p->dim_lambda_0 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 514), 2, main_model_p->dim_lambda_0_1, main_model_p->dim_lambda_0_2);
  SET_VECTOR_ELT(state, 515, ScalarInteger(main_model_p->offset_output_lambda_0));
  SET_VECTOR_ELT(state, 516, ScalarInteger(main_model_p->dim_lambda_1a));
  SET_VECTOR_ELT(state, 517, ScalarInteger(main_model_p->dim_lambda_1a_1));
  SET_VECTOR_ELT(state, 518, ScalarInteger(main_model_p->dim_lambda_1a_2));
  SET_VECTOR_ELT(state, 519, allocVector(REALSXP, main_model_p->dim_lambda_1a));
  memcpy(REAL(VECTOR_ELT(state, 519)), main_model_p->lambda_1a, main_model_p->dim_lambda_1a * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 519), 2, main_model_p->dim_lambda_1a_1, main_model_p->dim_lambda_1a_2);
  SET_VECTOR_ELT(state, 520, ScalarInteger(main_model_p->offset_output_lambda_1a));
  SET_VECTOR_ELT(state, 521, ScalarInteger(main_model_p->dim_lambda_1b));
  SET_VECTOR_ELT(state, 522, ScalarInteger(main_model_p->dim_lambda_1b_1));
  SET_VECTOR_ELT(state, 523, ScalarInteger(main_model_p->dim_lambda_1b_2));
  SET_VECTOR_ELT(state, 524, allocVector(REALSXP, main_model_p->dim_lambda_1b));
  memcpy(REAL(VECTOR_ELT(state, 524)), main_model_p->lambda_1b, main_model_p->dim_lambda_1b * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 524), 2, main_model_p->dim_lambda_1b_1, main_model_p->dim_lambda_1b_2);
  SET_VECTOR_ELT(state, 525, ScalarInteger(main_model_p->offset_output_lambda_1b));
  SET_VECTOR_ELT(state, 526, ScalarInteger(main_model_p->dim_lambda_1c));
  SET_VECTOR_ELT(state, 527, ScalarInteger(main_model_p->dim_lambda_1c_1));
  SET_VECTOR_ELT(state, 528, ScalarInteger(main_model_p->dim_lambda_1c_2));
  SET_VECTOR_ELT(state, 529, allocVector(REALSXP, main_model_p->dim_lambda_1c));
  memcpy(REAL(VECTOR_ELT(state, 529)), main_model_p->lambda_1c, main_model_p->dim_lambda_1c * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 529), 2, main_model_p->dim_lambda_1c_1, main_model_p->dim_lambda_1c_2);
  SET_VECTOR_ELT(state, 530, ScalarInteger(main_model_p->offset_output_lambda_1c));
  SET_VECTOR_ELT(state, 531, ScalarInteger(main_model_p->dim_lambda_1d));
  SET_VECTOR_ELT(state, 532, ScalarInteger(main_model_p->dim_lambda_1d_1));
  SET_VECTOR_ELT(state, 533, ScalarInteger(main_model_p->dim_lambda_1d_2));
  SET_VECTOR_ELT(state, 534, allocVector(REALSXP, main_model_p->dim_lambda_1d));
  memcpy(REAL(VECTOR_ELT(state, 534)), main_model_p->lambda_1d, main_model_p->dim_lambda_1d * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 534), 2, main_model_p->dim_lambda_1d_1, main_model_p->dim_lambda_1d_2);
  SET_VECTOR_ELT(state, 535, ScalarInteger(main_model_p->offset_output_lambda_1d));
  SET_VECTOR_ELT(state, 536, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_VECTOR_ELT(state, 537, allocVector(REALSXP, main_model_p->dim_lambda_sum_0));
  memcpy(REAL(VECTOR_ELT(state, 537)), main_model_p->lambda_sum_0, main_model_p->dim_lambda_sum_0 * sizeof(double));
  SET_VECTOR_ELT(state, 538, ScalarInteger(main_model_p->offset_output_lambda_sum_0));
  SET_VECTOR_ELT(state, 539, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_VECTOR_ELT(state, 540, allocVector(REALSXP, main_model_p->dim_lambda_sum_1a));
  memcpy(REAL(VECTOR_ELT(state, 540)), main_model_p->lambda_sum_1a, main_model_p->dim_lambda_sum_1a * sizeof(double));
  SET_VECTOR_ELT(state, 541, ScalarInteger(main_model_p->offset_output_lambda_sum_1a));
  SET_VECTOR_ELT(state, 542, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_VECTOR_ELT(state, 543, allocVector(REALSXP, main_model_p->dim_lambda_sum_1b));
  memcpy(REAL(VECTOR_ELT(state, 543)), main_model_p->lambda_sum_1b, main_model_p->dim_lambda_sum_1b * sizeof(double));
  SET_VECTOR_ELT(state, 544, ScalarInteger(main_model_p->offset_output_lambda_sum_1b));
  SET_VECTOR_ELT(state, 545, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_VECTOR_ELT(state, 546, allocVector(REALSXP, main_model_p->dim_lambda_sum_1c));
  memcpy(REAL(VECTOR_ELT(state, 546)), main_model_p->lambda_sum_1c, main_model_p->dim_lambda_sum_1c * sizeof(double));
  SET_VECTOR_ELT(state, 547, ScalarInteger(main_model_p->offset_output_lambda_sum_1c));
  SET_VECTOR_ELT(state, 548, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_VECTOR_ELT(state, 549, allocVector(REALSXP, main_model_p->dim_lambda_sum_1d));
  memcpy(REAL(VECTOR_ELT(state, 549)), main_model_p->lambda_sum_1d, main_model_p->dim_lambda_sum_1d * sizeof(double));
  SET_VECTOR_ELT(state, 550, ScalarInteger(main_model_p->offset_output_lambda_sum_1d));
  SET_VECTOR_ELT(state, 551, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_VECTOR_ELT(state, 552, allocVector(REALSXP, main_model_p->dim_c_comm_balanced));
  memcpy(REAL(VECTOR_ELT(state, 552)), main_model_p->c_comm_balanced, main_model_p->dim_c_comm_balanced * sizeof(double));
  SET_VECTOR_ELT(state, 553, ScalarInteger(main_model_p->offset_output_c_comm_balanced));
  SET_VECTOR_ELT(state, 554, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_VECTOR_ELT(state, 555, allocVector(REALSXP, main_model_p->dim_c_noncomm_balanced));
  memcpy(REAL(VECTOR_ELT(state, 555)), main_model_p->c_noncomm_balanced, main_model_p->dim_c_noncomm_balanced * sizeof(double));
  SET_VECTOR_ELT(state, 556, ScalarInteger(main_model_p->offset_output_c_noncomm_balanced));
  SET_VECTOR_ELT(state, 557, ScalarInteger(main_model_p->dim_theta));
  SET_VECTOR_ELT(state, 558, ScalarInteger(main_model_p->dim_theta_1));
  SET_VECTOR_ELT(state, 559, ScalarInteger(main_model_p->dim_theta_2));
  SET_VECTOR_ELT(state, 560, allocVector(REALSXP, main_model_p->dim_theta));
  memcpy(REAL(VECTOR_ELT(state, 560)), main_model_p->theta, main_model_p->dim_theta * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 560), 2, main_model_p->dim_theta_1, main_model_p->dim_theta_2);
  SET_VECTOR_ELT(state, 561, ScalarInteger(main_model_p->offset_output_theta));
  SET_VECTOR_ELT(state, 562, ScalarInteger(main_model_p->dim_OnPrEP_init));
  SET_VECTOR_ELT(state, 563, allocVector(REALSXP, main_model_p->dim_OnPrEP_init));
  memcpy(REAL(VECTOR_ELT(state, 563)), main_model_p->OnPrEP_init, main_model_p->dim_OnPrEP_init * sizeof(double));
  SET_VECTOR_ELT(state, 564, ScalarInteger(main_model_p->dim_M_comm));
  SET_VECTOR_ELT(state, 565, ScalarInteger(main_model_p->dim_M_comm_1));
  SET_VECTOR_ELT(state, 566, ScalarInteger(main_model_p->dim_M_comm_2));
  SET_VECTOR_ELT(state, 567, allocVector(REALSXP, main_model_p->dim_M_comm));
  memcpy(REAL(VECTOR_ELT(state, 567)), main_model_p->M_comm, main_model_p->dim_M_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 567), 2, main_model_p->dim_M_comm_1, main_model_p->dim_M_comm_2);
  SET_VECTOR_ELT(state, 568, ScalarInteger(main_model_p->offset_output_M_comm));
  SET_VECTOR_ELT(state, 569, ScalarInteger(main_model_p->dim_M_noncomm));
  SET_VECTOR_ELT(state, 570, ScalarInteger(main_model_p->dim_M_noncomm_1));
  SET_VECTOR_ELT(state, 571, ScalarInteger(main_model_p->dim_M_noncomm_2));
  SET_VECTOR_ELT(state, 572, allocVector(REALSXP, main_model_p->dim_M_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 572)), main_model_p->M_noncomm, main_model_p->dim_M_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 572), 2, main_model_p->dim_M_noncomm_1, main_model_p->dim_M_noncomm_2);
  SET_VECTOR_ELT(state, 573, ScalarInteger(main_model_p->offset_output_M_noncomm));
  SET_VECTOR_ELT(state, 574, ScalarInteger(main_model_p->dim_in_S0));
  SET_VECTOR_ELT(state, 575, ScalarInteger(main_model_p->dim_in_S0_1));
  SET_VECTOR_ELT(state, 576, ScalarInteger(main_model_p->dim_in_S0_2));
  SET_VECTOR_ELT(state, 577, allocVector(REALSXP, main_model_p->dim_in_S0));
  memcpy(REAL(VECTOR_ELT(state, 577)), main_model_p->in_S0, main_model_p->dim_in_S0 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 577), 2, main_model_p->dim_in_S0_1, main_model_p->dim_in_S0_2);
  SET_VECTOR_ELT(state, 578, ScalarInteger(main_model_p->dim_in_S1a));
  SET_VECTOR_ELT(state, 579, ScalarInteger(main_model_p->dim_in_S1a_1));
  SET_VECTOR_ELT(state, 580, ScalarInteger(main_model_p->dim_in_S1a_2));
  SET_VECTOR_ELT(state, 581, allocVector(REALSXP, main_model_p->dim_in_S1a));
  memcpy(REAL(VECTOR_ELT(state, 581)), main_model_p->in_S1a, main_model_p->dim_in_S1a * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 581), 2, main_model_p->dim_in_S1a_1, main_model_p->dim_in_S1a_2);
  SET_VECTOR_ELT(state, 582, ScalarInteger(main_model_p->dim_in_S1b));
  SET_VECTOR_ELT(state, 583, ScalarInteger(main_model_p->dim_in_S1b_1));
  SET_VECTOR_ELT(state, 584, ScalarInteger(main_model_p->dim_in_S1b_2));
  SET_VECTOR_ELT(state, 585, allocVector(REALSXP, main_model_p->dim_in_S1b));
  memcpy(REAL(VECTOR_ELT(state, 585)), main_model_p->in_S1b, main_model_p->dim_in_S1b * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 585), 2, main_model_p->dim_in_S1b_1, main_model_p->dim_in_S1b_2);
  SET_VECTOR_ELT(state, 586, ScalarInteger(main_model_p->dim_in_S1c));
  SET_VECTOR_ELT(state, 587, ScalarInteger(main_model_p->dim_in_S1c_1));
  SET_VECTOR_ELT(state, 588, ScalarInteger(main_model_p->dim_in_S1c_2));
  SET_VECTOR_ELT(state, 589, allocVector(REALSXP, main_model_p->dim_in_S1c));
  memcpy(REAL(VECTOR_ELT(state, 589)), main_model_p->in_S1c, main_model_p->dim_in_S1c * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 589), 2, main_model_p->dim_in_S1c_1, main_model_p->dim_in_S1c_2);
  SET_VECTOR_ELT(state, 590, ScalarInteger(main_model_p->dim_in_S1d));
  SET_VECTOR_ELT(state, 591, ScalarInteger(main_model_p->dim_in_S1d_1));
  SET_VECTOR_ELT(state, 592, ScalarInteger(main_model_p->dim_in_S1d_2));
  SET_VECTOR_ELT(state, 593, allocVector(REALSXP, main_model_p->dim_in_S1d));
  memcpy(REAL(VECTOR_ELT(state, 593)), main_model_p->in_S1d, main_model_p->dim_in_S1d * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 593), 2, main_model_p->dim_in_S1d_1, main_model_p->dim_in_S1d_2);
  SET_VECTOR_ELT(state, 594, ScalarInteger(main_model_p->dim_in_I01));
  SET_VECTOR_ELT(state, 595, ScalarInteger(main_model_p->dim_in_I01_1));
  SET_VECTOR_ELT(state, 596, ScalarInteger(main_model_p->dim_in_I01_2));
  SET_VECTOR_ELT(state, 597, allocVector(REALSXP, main_model_p->dim_in_I01));
  memcpy(REAL(VECTOR_ELT(state, 597)), main_model_p->in_I01, main_model_p->dim_in_I01 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 597), 2, main_model_p->dim_in_I01_1, main_model_p->dim_in_I01_2);
  SET_VECTOR_ELT(state, 598, ScalarInteger(main_model_p->dim_in_I11));
  SET_VECTOR_ELT(state, 599, ScalarInteger(main_model_p->dim_in_I11_1));
  SET_VECTOR_ELT(state, 600, ScalarInteger(main_model_p->dim_in_I11_2));
  SET_VECTOR_ELT(state, 601, allocVector(REALSXP, main_model_p->dim_in_I11));
  memcpy(REAL(VECTOR_ELT(state, 601)), main_model_p->in_I11, main_model_p->dim_in_I11 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 601), 2, main_model_p->dim_in_I11_1, main_model_p->dim_in_I11_2);
  SET_VECTOR_ELT(state, 602, ScalarInteger(main_model_p->dim_in_I02));
  SET_VECTOR_ELT(state, 603, ScalarInteger(main_model_p->dim_in_I02_1));
  SET_VECTOR_ELT(state, 604, ScalarInteger(main_model_p->dim_in_I02_2));
  SET_VECTOR_ELT(state, 605, allocVector(REALSXP, main_model_p->dim_in_I02));
  memcpy(REAL(VECTOR_ELT(state, 605)), main_model_p->in_I02, main_model_p->dim_in_I02 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 605), 2, main_model_p->dim_in_I02_1, main_model_p->dim_in_I02_2);
  SET_VECTOR_ELT(state, 606, ScalarInteger(main_model_p->dim_in_I03));
  SET_VECTOR_ELT(state, 607, ScalarInteger(main_model_p->dim_in_I03_1));
  SET_VECTOR_ELT(state, 608, ScalarInteger(main_model_p->dim_in_I03_2));
  SET_VECTOR_ELT(state, 609, allocVector(REALSXP, main_model_p->dim_in_I03));
  memcpy(REAL(VECTOR_ELT(state, 609)), main_model_p->in_I03, main_model_p->dim_in_I03 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 609), 2, main_model_p->dim_in_I03_1, main_model_p->dim_in_I03_2);
  SET_VECTOR_ELT(state, 610, ScalarInteger(main_model_p->dim_in_I04));
  SET_VECTOR_ELT(state, 611, ScalarInteger(main_model_p->dim_in_I04_1));
  SET_VECTOR_ELT(state, 612, ScalarInteger(main_model_p->dim_in_I04_2));
  SET_VECTOR_ELT(state, 613, allocVector(REALSXP, main_model_p->dim_in_I04));
  memcpy(REAL(VECTOR_ELT(state, 613)), main_model_p->in_I04, main_model_p->dim_in_I04 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 613), 2, main_model_p->dim_in_I04_1, main_model_p->dim_in_I04_2);
  SET_VECTOR_ELT(state, 614, ScalarInteger(main_model_p->dim_in_I05));
  SET_VECTOR_ELT(state, 615, ScalarInteger(main_model_p->dim_in_I05_1));
  SET_VECTOR_ELT(state, 616, ScalarInteger(main_model_p->dim_in_I05_2));
  SET_VECTOR_ELT(state, 617, allocVector(REALSXP, main_model_p->dim_in_I05));
  memcpy(REAL(VECTOR_ELT(state, 617)), main_model_p->in_I05, main_model_p->dim_in_I05 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 617), 2, main_model_p->dim_in_I05_1, main_model_p->dim_in_I05_2);
  SET_VECTOR_ELT(state, 618, ScalarInteger(main_model_p->dim_in_I22));
  SET_VECTOR_ELT(state, 619, ScalarInteger(main_model_p->dim_in_I22_1));
  SET_VECTOR_ELT(state, 620, ScalarInteger(main_model_p->dim_in_I22_2));
  SET_VECTOR_ELT(state, 621, allocVector(REALSXP, main_model_p->dim_in_I22));
  memcpy(REAL(VECTOR_ELT(state, 621)), main_model_p->in_I22, main_model_p->dim_in_I22 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 621), 2, main_model_p->dim_in_I22_1, main_model_p->dim_in_I22_2);
  SET_VECTOR_ELT(state, 622, ScalarInteger(main_model_p->dim_in_I23));
  SET_VECTOR_ELT(state, 623, ScalarInteger(main_model_p->dim_in_I23_1));
  SET_VECTOR_ELT(state, 624, ScalarInteger(main_model_p->dim_in_I23_2));
  SET_VECTOR_ELT(state, 625, allocVector(REALSXP, main_model_p->dim_in_I23));
  memcpy(REAL(VECTOR_ELT(state, 625)), main_model_p->in_I23, main_model_p->dim_in_I23 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 625), 2, main_model_p->dim_in_I23_1, main_model_p->dim_in_I23_2);
  SET_VECTOR_ELT(state, 626, ScalarInteger(main_model_p->dim_in_I24));
  SET_VECTOR_ELT(state, 627, ScalarInteger(main_model_p->dim_in_I24_1));
  SET_VECTOR_ELT(state, 628, ScalarInteger(main_model_p->dim_in_I24_2));
  SET_VECTOR_ELT(state, 629, allocVector(REALSXP, main_model_p->dim_in_I24));
  memcpy(REAL(VECTOR_ELT(state, 629)), main_model_p->in_I24, main_model_p->dim_in_I24 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 629), 2, main_model_p->dim_in_I24_1, main_model_p->dim_in_I24_2);
  SET_VECTOR_ELT(state, 630, ScalarInteger(main_model_p->dim_in_I25));
  SET_VECTOR_ELT(state, 631, ScalarInteger(main_model_p->dim_in_I25_1));
  SET_VECTOR_ELT(state, 632, ScalarInteger(main_model_p->dim_in_I25_2));
  SET_VECTOR_ELT(state, 633, allocVector(REALSXP, main_model_p->dim_in_I25));
  memcpy(REAL(VECTOR_ELT(state, 633)), main_model_p->in_I25, main_model_p->dim_in_I25 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 633), 2, main_model_p->dim_in_I25_1, main_model_p->dim_in_I25_2);
  SET_VECTOR_ELT(state, 634, ScalarInteger(main_model_p->dim_in_I32));
  SET_VECTOR_ELT(state, 635, ScalarInteger(main_model_p->dim_in_I32_1));
  SET_VECTOR_ELT(state, 636, ScalarInteger(main_model_p->dim_in_I32_2));
  SET_VECTOR_ELT(state, 637, allocVector(REALSXP, main_model_p->dim_in_I32));
  memcpy(REAL(VECTOR_ELT(state, 637)), main_model_p->in_I32, main_model_p->dim_in_I32 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 637), 2, main_model_p->dim_in_I32_1, main_model_p->dim_in_I32_2);
  SET_VECTOR_ELT(state, 638, ScalarInteger(main_model_p->dim_in_I33));
  SET_VECTOR_ELT(state, 639, ScalarInteger(main_model_p->dim_in_I33_1));
  SET_VECTOR_ELT(state, 640, ScalarInteger(main_model_p->dim_in_I33_2));
  SET_VECTOR_ELT(state, 641, allocVector(REALSXP, main_model_p->dim_in_I33));
  memcpy(REAL(VECTOR_ELT(state, 641)), main_model_p->in_I33, main_model_p->dim_in_I33 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 641), 2, main_model_p->dim_in_I33_1, main_model_p->dim_in_I33_2);
  SET_VECTOR_ELT(state, 642, ScalarInteger(main_model_p->dim_in_I34));
  SET_VECTOR_ELT(state, 643, ScalarInteger(main_model_p->dim_in_I34_1));
  SET_VECTOR_ELT(state, 644, ScalarInteger(main_model_p->dim_in_I34_2));
  SET_VECTOR_ELT(state, 645, allocVector(REALSXP, main_model_p->dim_in_I34));
  memcpy(REAL(VECTOR_ELT(state, 645)), main_model_p->in_I34, main_model_p->dim_in_I34 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 645), 2, main_model_p->dim_in_I34_1, main_model_p->dim_in_I34_2);
  SET_VECTOR_ELT(state, 646, ScalarInteger(main_model_p->dim_in_I35));
  SET_VECTOR_ELT(state, 647, ScalarInteger(main_model_p->dim_in_I35_1));
  SET_VECTOR_ELT(state, 648, ScalarInteger(main_model_p->dim_in_I35_2));
  SET_VECTOR_ELT(state, 649, allocVector(REALSXP, main_model_p->dim_in_I35));
  memcpy(REAL(VECTOR_ELT(state, 649)), main_model_p->in_I35, main_model_p->dim_in_I35 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 649), 2, main_model_p->dim_in_I35_1, main_model_p->dim_in_I35_2);
  SET_VECTOR_ELT(state, 650, ScalarInteger(main_model_p->dim_in_I42));
  SET_VECTOR_ELT(state, 651, ScalarInteger(main_model_p->dim_in_I42_1));
  SET_VECTOR_ELT(state, 652, ScalarInteger(main_model_p->dim_in_I42_2));
  SET_VECTOR_ELT(state, 653, allocVector(REALSXP, main_model_p->dim_in_I42));
  memcpy(REAL(VECTOR_ELT(state, 653)), main_model_p->in_I42, main_model_p->dim_in_I42 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 653), 2, main_model_p->dim_in_I42_1, main_model_p->dim_in_I42_2);
  SET_VECTOR_ELT(state, 654, ScalarInteger(main_model_p->dim_in_I43));
  SET_VECTOR_ELT(state, 655, ScalarInteger(main_model_p->dim_in_I43_1));
  SET_VECTOR_ELT(state, 656, ScalarInteger(main_model_p->dim_in_I43_2));
  SET_VECTOR_ELT(state, 657, allocVector(REALSXP, main_model_p->dim_in_I43));
  memcpy(REAL(VECTOR_ELT(state, 657)), main_model_p->in_I43, main_model_p->dim_in_I43 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 657), 2, main_model_p->dim_in_I43_1, main_model_p->dim_in_I43_2);
  SET_VECTOR_ELT(state, 658, ScalarInteger(main_model_p->dim_in_I44));
  SET_VECTOR_ELT(state, 659, ScalarInteger(main_model_p->dim_in_I44_1));
  SET_VECTOR_ELT(state, 660, ScalarInteger(main_model_p->dim_in_I44_2));
  SET_VECTOR_ELT(state, 661, allocVector(REALSXP, main_model_p->dim_in_I44));
  memcpy(REAL(VECTOR_ELT(state, 661)), main_model_p->in_I44, main_model_p->dim_in_I44 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 661), 2, main_model_p->dim_in_I44_1, main_model_p->dim_in_I44_2);
  SET_VECTOR_ELT(state, 662, ScalarInteger(main_model_p->dim_in_I45));
  SET_VECTOR_ELT(state, 663, ScalarInteger(main_model_p->dim_in_I45_1));
  SET_VECTOR_ELT(state, 664, ScalarInteger(main_model_p->dim_in_I45_2));
  SET_VECTOR_ELT(state, 665, allocVector(REALSXP, main_model_p->dim_in_I45));
  memcpy(REAL(VECTOR_ELT(state, 665)), main_model_p->in_I45, main_model_p->dim_in_I45 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 665), 2, main_model_p->dim_in_I45_1, main_model_p->dim_in_I45_2);
  SET_VECTOR_ELT(state, 666, ScalarInteger(main_model_p->dim_rate_move_in));
  SET_VECTOR_ELT(state, 667, ScalarInteger(main_model_p->dim_rate_move_in_1));
  SET_VECTOR_ELT(state, 668, ScalarInteger(main_model_p->dim_rate_move_in_2));
  SET_VECTOR_ELT(state, 669, allocVector(REALSXP, main_model_p->dim_rate_move_in));
  memcpy(REAL(VECTOR_ELT(state, 669)), main_model_p->rate_move_in, main_model_p->dim_rate_move_in * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 669), 2, main_model_p->dim_rate_move_in_1, main_model_p->dim_rate_move_in_2);
  SET_VECTOR_ELT(state, 670, ScalarInteger(main_model_p->offset_output_rate_move_in));
  SET_VECTOR_ELT(state, 671, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_VECTOR_ELT(state, 672, allocVector(REALSXP, main_model_p->dim_rate_move_out));
  memcpy(REAL(VECTOR_ELT(state, 672)), main_model_p->rate_move_out, main_model_p->dim_rate_move_out * sizeof(double));
  SET_VECTOR_ELT(state, 673, ScalarInteger(main_model_p->offset_output_rate_move_out));
  SET_VECTOR_ELT(state, 677, ScalarReal(main_model_p->ART_eligible_CD4_above_500));
  SET_VECTOR_ELT(state, 679, ScalarReal(main_model_p->ART_eligible_CD4_350_500));
  SET_VECTOR_ELT(state, 681, ScalarReal(main_model_p->ART_eligible_CD4_200_349));
  SET_VECTOR_ELT(state, 683, ScalarReal(main_model_p->ART_eligible_CD4_below_200));
  SET_VECTOR_ELT(state, 689, ScalarReal(main_model_p->epsilon));
  SET_VECTOR_ELT(state, 697, ScalarInteger(main_model_p->dim));
  SET_VECTOR_ELT(state, 698, ScalarInteger(main_model_p->dim_output));
  SEXP state_names = PROTECT(allocVector(STRSXP, 699));
  ...
  SET_STRING_ELT(state_names, 172, mkChar("dim_frac_F"));
  SET_STRING_ELT(state_names, 173, mkChar("frac_F"));
  SET_STRING_ELT(state_names, 174, mkChar("offset_output_frac_F"));
  SET_STRING_ELT(state_names, 175, mkChar("dim_frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 176, mkChar("frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 177, mkChar("offset_output_frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 178, mkChar("dim_infect_ART"));
  SET_STRING_ELT(state_names, 179, mkChar("infect_ART"));
  SET_STRING_ELT(state_names, 180, mkChar("offset_output_infect_ART"));
  SET_STRING_ELT(state_names, 181, mkChar("dim_prep_offered"));
  SET_STRING_ELT(state_names, 182, mkChar("prep_offered"));
  SET_STRING_ELT(state_names, 183, mkChar("dim_omega"));
  SET_STRING_ELT(state_names, 184, mkChar("omega"));
  SET_STRING_ELT(state_names, 185, mkChar("offset_output_omega"));
  SET_STRING_ELT(state_names, 186, mkChar("dim_frac_N"));
  SET_STRING_ELT(state_names, 187, mkChar("frac_N"));
  SET_STRING_ELT(state_names, 188, mkChar("offset_output_frac_N"));
  SET_STRING_ELT(state_names, 189, mkChar("dim_mu"));
  SET_STRING_ELT(state_names, 190, mkChar("mu"));
  SET_STRING_ELT(state_names, 191, mkChar("offset_output_mu"));
  SET_STRING_ELT(state_names, 192, mkChar("dim_gamma01"));
  SET_STRING_ELT(state_names, 193, mkChar("gamma01"));
  SET_STRING_ELT(state_names, 194, mkChar("offset_output_gamma01"));
  SET_STRING_ELT(state_names, 195, mkChar("dim_gamma02"));
  SET_STRING_ELT(state_names, 196, mkChar("gamma02"));
  SET_STRING_ELT(state_names, 197, mkChar("dim_gamma03"));
  SET_STRING_ELT(state_names, 198, mkChar("gamma03"));
  SET_STRING_ELT(state_names, 199, mkChar("dim_gamma04"));
  SET_STRING_ELT(state_names, 200, mkChar("gamma04"));
  SET_STRING_ELT(state_names, 201, mkChar("dim_gamma11"));
  SET_STRING_ELT(state_names, 202, mkChar("gamma11"));
  SET_STRING_ELT(state_names, 203, mkChar("offset_output_gamma11"));
  SET_STRING_ELT(state_names, 204, mkChar("dim_gamma22"));
  SET_STRING_ELT(state_names, 205, mkChar("gamma22"));
  SET_STRING_ELT(state_names, 206, mkChar("dim_gamma23"));
  SET_STRING_ELT(state_names, 207, mkChar("gamma23"));
  SET_STRING_ELT(state_names, 208, mkChar("dim_gamma24"));
  SET_STRING_ELT(state_names, 209, mkChar("gamma24"));
  SET_STRING_ELT(state_names, 210, mkChar("dim_gamma32"));
  SET_STRING_ELT(state_names, 211, mkChar("gamma32"));
  SET_STRING_ELT(state_names, 212, mkChar("dim_gamma33"));
  SET_STRING_ELT(state_names, 213, mkChar("gamma33"));
  SET_STRING_ELT(state_names, 214, mkChar("dim_gamma34"));
  SET_STRING_ELT(state_names, 215, mkChar("gamma34"));
  SET_STRING_ELT(state_names, 216, mkChar("dim_gamma42"));
  SET_STRING_ELT(state_names, 217, mkChar("gamma42"));
  SET_STRING_ELT(state_names, 218, mkChar("dim_gamma43"));
  SET_STRING_ELT(state_names, 219, mkChar("gamma43"));
  SET_STRING_ELT(state_names, 220, mkChar("dim_gamma44"));
  SET_STRING_ELT(state_names, 221, mkChar("gamma44"));
  SET_STRING_ELT(state_names, 222, mkChar("dim_phi2"));
  SET_STRING_ELT(state_names, 223, mkChar("phi2"));
  SET_STRING_ELT(state_names, 224, mkChar("dim_phi3"));
  SET_STRING_ELT(state_names, 225, mkChar("phi3"));
  SET_STRING_ELT(state_names, 226, mkChar("dim_phi4"));
  SET_STRING_ELT(state_names, 227, mkChar("phi4"));
  SET_STRING_ELT(state_names, 228, mkChar("dim_phi5"));
  SET_STRING_ELT(state_names, 229, mkChar("phi5"));
  SET_STRING_ELT(state_names, 230, mkChar("dim_psia"));
  SET_STRING_ELT(state_names, 231, mkChar("psia"));
  SET_STRING_ELT(state_names, 232, mkChar("dim_psib"));
  SET_STRING_ELT(state_names, 233, mkChar("psib"));
  SET_STRING_ELT(state_names, 234, mkChar("dim_kappaa"));
  SET_STRING_ELT(state_names, 235, mkChar("kappaa"));
  SET_STRING_ELT(state_names, 236, mkChar("offset_output_kappaa"));
  SET_STRING_ELT(state_names, 237, mkChar("dim_kappab"));
  SET_STRING_ELT(state_names, 238, mkChar("kappab"));
  SET_STRING_ELT(state_names, 239, mkChar("offset_output_kappab"));
  SET_STRING_ELT(state_names, 240, mkChar("dim_kappac"));
  SET_STRING_ELT(state_names, 241, mkChar("kappac"));
  SET_STRING_ELT(state_names, 242, mkChar("offset_output_kappac"));
  SET_STRING_ELT(state_names, 243, mkChar("dim_kappa1"));
  SET_STRING_ELT(state_names, 244, mkChar("kappa1"));
  SET_STRING_ELT(state_names, 245, mkChar("offset_output_kappa1"));
  SET_STRING_ELT(state_names, 246, mkChar("dim_alpha01"));
  SET_STRING_ELT(state_names, 247, mkChar("alpha01"));
  SET_STRING_ELT(state_names, 248, mkChar("offset_output_alpha01"));
  SET_STRING_ELT(state_names, 249, mkChar("dim_alpha02"));
  SET_STRING_ELT(state_names, 250, mkChar("alpha02"));
  SET_STRING_ELT(state_names, 251, mkChar("offset_output_alpha02"));
  SET_STRING_ELT(state_names, 252, mkChar("dim_alpha03"));
  SET_STRING_ELT(state_names, 253, mkChar("alpha03"));
  SET_STRING_ELT(state_names, 254, mkChar("dim_alpha04"));
  SET_STRING_ELT(state_names, 255, mkChar("alpha04"));
  SET_STRING_ELT(state_names, 256, mkChar("dim_alpha05"));
  SET_STRING_ELT(state_names, 257, mkChar("alpha05"));
  SET_STRING_ELT(state_names, 258, mkChar("offset_output_alpha05"));
  SET_STRING_ELT(state_names, 259, mkChar("dim_alpha11"));
  SET_STRING_ELT(state_names, 260, mkChar("alpha11"));
  SET_STRING_ELT(state_names, 261, mkChar("offset_output_alpha11"));
  SET_STRING_ELT(state_names, 262, mkChar("dim_alpha22"));
  SET_STRING_ELT(state_names, 263, mkChar("alpha22"));
  SET_STRING_ELT(state_names, 264, mkChar("offset_output_alpha22"));
  SET_STRING_ELT(state_names, 265, mkChar("dim_alpha23"));
  SET_STRING_ELT(state_names, 266, mkChar("alpha23"));
  SET_STRING_ELT(state_names, 267, mkChar("dim_alpha24"));
  SET_STRING_ELT(state_names, 268, mkChar("alpha24"));
  SET_STRING_ELT(state_names, 269, mkChar("dim_alpha25"));
  SET_STRING_ELT(state_names, 270, mkChar("alpha25"));
  SET_STRING_ELT(state_names, 271, mkChar("dim_alpha32"));
  SET_STRING_ELT(state_names, 272, mkChar("alpha32"));
  SET_STRING_ELT(state_names, 273, mkChar("dim_alpha33"));
  SET_STRING_ELT(state_names, 274, mkChar("alpha33"));
  SET_STRING_ELT(state_names, 275, mkChar("dim_alpha34"));
  SET_STRING_ELT(state_names, 276, mkChar("alpha34"));
  SET_STRING_ELT(state_names, 277, mkChar("dim_alpha35"));
  SET_STRING_ELT(state_names, 278, mkChar("alpha35"));
  SET_STRING_ELT(state_names, 279, mkChar("offset_output_alpha35"));
  SET_STRING_ELT(state_names, 280, mkChar("dim_alpha42"));
  SET_STRING_ELT(state_names, 281, mkChar("alpha42"));
  SET_STRING_ELT(state_names, 282, mkChar("dim_alpha43"));
  SET_STRING_ELT(state_names, 283, mkChar("alpha43"));
  SET_STRING_ELT(state_names, 284, mkChar("dim_alpha44"));
  SET_STRING_ELT(state_names, 285, mkChar("alpha44"));
  SET_STRING_ELT(state_names, 286, mkChar("dim_alpha45"));
  SET_STRING_ELT(state_names, 287, mkChar("alpha45"));
  SET_STRING_ELT(state_names, 288, mkChar("dim_beta_comm"));
  SET_STRING_ELT(state_names, 289, mkChar("beta_comm"));
  SET_STRING_ELT(state_names, 290, mkChar("offset_output_beta_comm"));
  SET_STRING_ELT(state_names, 291, mkChar("dim_beta_noncomm"));
  SET_STRING_ELT(state_names, 292, mkChar("beta_noncomm"));
  SET_STRING_ELT(state_names, 293, mkChar("offset_output_beta_noncomm"));
  SET_STRING_ELT(state_names, 294, mkChar("dim_p_comm"));
  SET_STRING_ELT(state_names, 295, mkChar("dim_p_comm_1"));
  SET_STRING_ELT(state_names, 296, mkChar("dim_p_comm_2"));
  SET_STRING_ELT(state_names, 297, mkChar("p_comm"));
  SET_STRING_ELT(state_names, 298, mkChar("offset_output_p_comm"));
  SET_STRING_ELT(state_names, 299, mkChar("dim_p_noncomm"));
  SET_STRING_ELT(state_names, 300, mkChar("dim_p_noncomm_1"));
  SET_STRING_ELT(state_names, 301, mkChar("dim_p_noncomm_2"));
  SET_STRING_ELT(state_names, 302, mkChar("p_noncomm"));
  SET_STRING_ELT(state_names, 303, mkChar("offset_output_p_noncomm"));
  SET_STRING_ELT(state_names, 304, mkChar("dim_ec"));
  SET_STRING_ELT(state_names, 305, mkChar("ec"));
  SET_STRING_ELT(state_names, 306, mkChar("dim_eP"));
  SET_STRING_ELT(state_names, 307, mkChar("eP"));
  SET_STRING_ELT(state_names, 308, mkChar("dim_eP0"));
  SET_STRING_ELT(state_names, 309, mkChar("eP0"));
  SET_STRING_ELT(state_names, 310, mkChar("dim_eP1a"));
  SET_STRING_ELT(state_names, 311, mkChar("eP1a"));
  SET_STRING_ELT(state_names, 312, mkChar("dim_eP1b"));
  SET_STRING_ELT(state_names, 313, mkChar("eP1b"));
  SET_STRING_ELT(state_names, 314, mkChar("dim_eP1c"));
  SET_STRING_ELT(state_names, 315, mkChar("eP1c"));
  SET_STRING_ELT(state_names, 316, mkChar("dim_eP1d"));
  SET_STRING_ELT(state_names, 317, mkChar("eP1d"));
  SET_STRING_ELT(state_names, 318, mkChar("dim_fc_comm"));
  SET_STRING_ELT(state_names, 319, mkChar("dim_fc_comm_1"));
  SET_STRING_ELT(state_names, 320, mkChar("dim_fc_comm_2"));
  SET_STRING_ELT(state_names, 321, mkChar("fc_comm"));
  SET_STRING_ELT(state_names, 322, mkChar("offset_output_fc_comm"));
  SET_STRING_ELT(state_names, 323, mkChar("dim_fP_comm"));
  SET_STRING_ELT(state_names, 324, mkChar("fP_comm"));
  SET_STRING_ELT(state_names, 325, mkChar("offset_output_fP_comm"));
  SET_STRING_ELT(state_names, 326, mkChar("dim_fc_noncomm"));
  SET_STRING_ELT(state_names, 327, mkChar("dim_fc_noncomm_1"));
  SET_STRING_ELT(state_names, 328, mkChar("dim_fc_noncomm_2"));
  SET_STRING_ELT(state_names, 329, mkChar("fc_noncomm"));
  SET_STRING_ELT(state_names, 330, mkChar("offset_output_fc_noncomm"));
  SET_STRING_ELT(state_names, 331, mkChar("dim_fP_noncomm"));
  SET_STRING_ELT(state_names, 332, mkChar("fP_noncomm"));
  SET_STRING_ELT(state_names, 333, mkChar("offset_output_fP_noncomm"));
  SET_STRING_ELT(state_names, 334, mkChar("dim_n_comm"));
  SET_STRING_ELT(state_names, 335, mkChar("dim_n_comm_1"));
  SET_STRING_ELT(state_names, 336, mkChar("dim_n_comm_2"));
  SET_STRING_ELT(state_names, 337, mkChar("n_comm"));
  SET_STRING_ELT(state_names, 338, mkChar("offset_output_n_comm"));
  SET_STRING_ELT(state_names, 339, mkChar("dim_n_noncomm"));
  SET_STRING_ELT(state_names, 340, mkChar("dim_n_noncomm_1"));
  SET_STRING_ELT(state_names, 341, mkChar("dim_n_noncomm_2"));
  SET_STRING_ELT(state_names, 342, mkChar("n_noncomm"));
  SET_STRING_ELT(state_names, 343, mkChar("offset_output_n_noncomm"));
  SET_STRING_ELT(state_names, 344, mkChar("dim_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 345, mkChar("initial_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 346, mkChar("offset_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 347, mkChar("dim_cumuARTinitiations"));
  SET_STRING_ELT(state_names, 348, mkChar("initial_cumuARTinitiations"));
  SET_STRING_ELT(state_names, 349, mkChar("offset_cumuARTinitiations"));
  SET_STRING_ELT(state_names, 350, mkChar("dim_cumuARTREinitiations"));
  SET_STRING_ELT(state_names, 351, mkChar("initial_cumuARTREinitiations"));
  SET_STRING_ELT(state_names, 352, mkChar("offset_cumuARTREinitiations"));
  SET_STRING_ELT(state_names, 353, mkChar("dim_cumuTesting"));
  SET_STRING_ELT(state_names, 354, mkChar("initial_cumuTesting"));
  SET_STRING_ELT(state_names, 355, mkChar("offset_cumuTesting"));
  SET_STRING_ELT(state_names, 356, mkChar("dim_cumuAllDeaths"));
  SET_STRING_ELT(state_names, 357, mkChar("initial_cumuAllDeaths"));
  SET_STRING_ELT(state_names, 358, mkChar("offset_cumuAllDeaths"));
  SET_STRING_ELT(state_names, 359, mkChar("dim_cumuInf"));
  SET_STRING_ELT(state_names, 360, mkChar("initial_cumuInf"));
  SET_STRING_ELT(state_names, 361, mkChar("offset_cumuInf"));
  SET_STRING_ELT(state_names, 362, mkChar("dim_OnPrEP"));
  SET_STRING_ELT(state_names, 363, mkChar("initial_OnPrEP"));
  SET_STRING_ELT(state_names, 364, mkChar("offset_OnPrEP"));
  SET_STRING_ELT(state_names, 365, mkChar("dim_S0"));
  SET_STRING_ELT(state_names, 366, mkChar("initial_S0"));
  SET_STRING_ELT(state_names, 367, mkChar("offset_S0"));
  SET_STRING_ELT(state_names, 368, mkChar("dim_S1a"));
  SET_STRING_ELT(state_names, 369, mkChar("initial_S1a"));
  SET_STRING_ELT(state_names, 370, mkChar("offset_S1a"));
  SET_STRING_ELT(state_names, 371, mkChar("dim_S1b"));
  SET_STRING_ELT(state_names, 372, mkChar("initial_S1b"));
  SET_STRING_ELT(state_names, 373, mkChar("offset_S1b"));
  SET_STRING_ELT(state_names, 374, mkChar("dim_S1c"));
  SET_STRING_ELT(state_names, 375, mkChar("initial_S1c"));
  SET_STRING_ELT(state_names, 376, mkChar("offset_S1c"));
  SET_STRING_ELT(state_names, 377, mkChar("dim_S1d"));
  SET_STRING_ELT(state_names, 378, mkChar("initial_S1d"));
  SET_STRING_ELT(state_names, 379, mkChar("offset_S1d"));
  SET_STRING_ELT(state_names, 380, mkChar("dim_I01"));
  SET_STRING_ELT(state_names, 381, mkChar("initial_I01"));
  SET_STRING_ELT(state_names, 382, mkChar("offset_I01"));
  SET_STRING_ELT(state_names, 383, mkChar("dim_I11"));
  SET_STRING_ELT(state_names, 384, mkChar("initial_I11"));
  SET_STRING_ELT(state_names, 385, mkChar("offset_I11"));
  SET_STRING_ELT(state_names, 386, mkChar("dim_I02"));
  SET_STRING_ELT(state_names, 387, mkChar("initial_I02"));
  SET_STRING_ELT(state_names, 388, mkChar("offset_I02"));
  SET_STRING_ELT(state_names, 389, mkChar("dim_I03"));
  SET_STRING_ELT(state_names, 390, mkChar("initial_I03"));
  SET_STRING_ELT(state_names, 391, mkChar("offset_I03"));
  SET_STRING_ELT(state_names, 392, mkChar("dim_I04"));
  SET_STRING_ELT(state_names, 393, mkChar("initial_I04"));
  SET_STRING_ELT(state_names, 394, mkChar("offset_I04"));
  SET_STRING_ELT(state_names, 395, mkChar("dim_I05"));
  SET_STRING_ELT(state_names, 396, mkChar("initial_I05"));
  SET_STRING_ELT(state_names, 397, mkChar("offset_I05"));
  SET_STRING_ELT(state_names, 398, mkChar("dim_I22"));
  SET_STRING_ELT(state_names, 399, mkChar("initial_I22"));
  SET_STRING_ELT(state_names, 400, mkChar("offset_I22"));
  SET_STRING_ELT(state_names, 401, mkChar("dim_I23"));
  SET_STRING_ELT(state_names, 402, mkChar("initial_I23"));
  SET_STRING_ELT(state_names, 403, mkChar("offset_I23"));
  SET_STRING_ELT(state_names, 404, mkChar("dim_I24"));
  SET_STRING_ELT(state_names, 405, mkChar("initial_I24"));
  SET_STRING_ELT(state_names, 406, mkChar("offset_I24"));
  SET_STRING_ELT(state_names, 407, mkChar("dim_I25"));
  SET_STRING_ELT(state_names, 408, mkChar("initial_I25"));
  SET_STRING_ELT(state_names, 409, mkChar("offset_I25"));
  SET_STRING_ELT(state_names, 410, mkChar("dim_I32"));
  SET_STRING_ELT(state_names, 411, mkChar("initial_I32"));
  SET_STRING_ELT(state_names, 412, mkChar("offset_I32"));
  SET_STRING_ELT(state_names, 413, mkChar("dim_I33"));
  SET_STRING_ELT(state_names, 414, mkChar("initial_I33"));
  SET_STRING_ELT(state_names, 415, mkChar("offset_I33"));
  SET_STRING_ELT(state_names, 416, mkChar("dim_I34"));
  SET_STRING_ELT(state_names, 417, mkChar("initial_I34"));
  SET_STRING_ELT(state_names, 418, mkChar("offset_I34"));
  SET_STRING_ELT(state_names, 419, mkChar("dim_I35"));
  SET_STRING_ELT(state_names, 420, mkChar("initial_I35"));
  SET_STRING_ELT(state_names, 421, mkChar("offset_I35"));
  SET_STRING_ELT(state_names, 422, mkChar("dim_I42"));
  SET_STRING_ELT(state_names, 423, mkChar("initial_I42"));
  SET_STRING_ELT(state_names, 424, mkChar("offset_I42"));
  SET_STRING_ELT(state_names, 425, mkChar("dim_I43"));
  SET_STRING_ELT(state_names, 426, mkChar("initial_I43"));
  SET_STRING_ELT(state_names, 427, mkChar("offset_I43"));
  SET_STRING_ELT(state_names, 428, mkChar("dim_I44"));
  SET_STRING_ELT(state_names, 429, mkChar("initial_I44"));
  SET_STRING_ELT(state_names, 430, mkChar("offset_I44"));
  SET_STRING_ELT(state_names, 431, mkChar("dim_I45"));
  SET_STRING_ELT(state_names, 432, mkChar("initial_I45"));
  SET_STRING_ELT(state_names, 433, mkChar("offset_I45"));
  SET_STRING_ELT(state_names, 434, mkChar("dim_S0_init"));
  SET_STRING_ELT(state_names, 435, mkChar("S0_init"));
  SET_STRING_ELT(state_names, 436, mkChar("dim_S1a_init"));
  SET_STRING_ELT(state_names, 437, mkChar("S1a_init"));
  SET_STRING_ELT(state_names, 438, mkChar("dim_S1b_init"));
  SET_STRING_ELT(state_names, 439, mkChar("S1b_init"));
  SET_STRING_ELT(state_names, 440, mkChar("dim_S1c_init"));
  SET_STRING_ELT(state_names, 441, mkChar("S1c_init"));
  SET_STRING_ELT(state_names, 442, mkChar("dim_S1d_init"));
  SET_STRING_ELT(state_names, 443, mkChar("S1d_init"));
  SET_STRING_ELT(state_names, 444, mkChar("dim_I01_init"));
  SET_STRING_ELT(state_names, 445, mkChar("I01_init"));
  SET_STRING_ELT(state_names, 446, mkChar("dim_I11_init"));
  SET_STRING_ELT(state_names, 447, mkChar("I11_init"));
  SET_STRING_ELT(state_names, 448, mkChar("dim_I02_init"));
  SET_STRING_ELT(state_names, 449, mkChar("I02_init"));
  SET_STRING_ELT(state_names, 450, mkChar("dim_I03_init"));
  SET_STRING_ELT(state_names, 451, mkChar("I03_init"));
  SET_STRING_ELT(state_names, 452, mkChar("dim_I04_init"));
  SET_STRING_ELT(state_names, 453, mkChar("I04_init"));
  SET_STRING_ELT(state_names, 454, mkChar("dim_I05_init"));
  SET_STRING_ELT(state_names, 455, mkChar("I05_init"));
  SET_STRING_ELT(state_names, 456, mkChar("dim_I22_init"));
  SET_STRING_ELT(state_names, 457, mkChar("I22_init"));
  SET_STRING_ELT(state_names, 458, mkChar("dim_I23_init"));
  SET_STRING_ELT(state_names, 459, mkChar("I23_init"));
  SET_STRING_ELT(state_names, 460, mkChar("dim_I24_init"));
  SET_STRING_ELT(state_names, 461, mkChar("I24_init"));
  SET_STRING_ELT(state_names, 462, mkChar("dim_I25_init"));
  SET_STRING_ELT(state_names, 463, mkChar("I25_init"));
  SET_STRING_ELT(state_names, 464, mkChar("dim_I32_init"));
  SET_STRING_ELT(state_names, 465, mkChar("I32_init"));
  SET_STRING_ELT(state_names, 466, mkChar("dim_I33_init"));
  SET_STRING_ELT(state_names, 467, mkChar("I33_init"));
  SET_STRING_ELT(state_names, 468, mkChar("dim_I34_init"));
  SET_STRING_ELT(state_names, 469, mkChar("I34_init"));
  SET_STRING_ELT(state_names, 470, mkChar("dim_I35_init"));
  SET_STRING_ELT(state_names, 471, mkChar("I35_init"));
  SET_STRING_ELT(state_names, 472, mkChar("dim_I42_init"));
  SET_STRING_ELT(state_names, 473, mkChar("I42_init"));
  SET_STRING_ELT(state_names, 474, mkChar("dim_I43_init"));
  SET_STRING_ELT(state_names, 475, mkChar("I43_init"));
  SET_STRING_ELT(state_names, 476, mkChar("dim_I44_init"));
  SET_STRING_ELT(state_names, 477, mkChar("I44_init"));
  SET_STRING_ELT(state_names, 478, mkChar("dim_I45_init"));
  SET_STRING_ELT(state_names, 479, mkChar("I45_init"));
  SET_STRING_ELT(state_names, 480, mkChar("dim_N"));
  SET_STRING_ELT(state_names, 481, mkChar("N"));
  SET_STRING_ELT(state_names, 482, mkChar("offset_output_N"));
  SET_STRING_ELT(state_names, 483, mkChar("dim_E0"));
  SET_STRING_ELT(state_names, 484, mkChar("E0"));
  SET_STRING_ELT(state_names, 485, mkChar("offset_output_E0"));
  SET_STRING_ELT(state_names, 486, mkChar("dim_E1a"));
  SET_STRING_ELT(state_names, 487, mkChar("E1a"));
  SET_STRING_ELT(state_names, 488, mkChar("offset_output_E1a"));
  SET_STRING_ELT(state_names, 489, mkChar("dim_E1b"));
  SET_STRING_ELT(state_names, 490, mkChar("E1b"));
  SET_STRING_ELT(state_names, 491, mkChar("offset_output_E1b"));
  SET_STRING_ELT(state_names, 492, mkChar("dim_E1c"));
  SET_STRING_ELT(state_names, 493, mkChar("E1c"));
  SET_STRING_ELT(state_names, 494, mkChar("offset_output_E1c"));
  SET_STRING_ELT(state_names, 495, mkChar("dim_E1d"));
  SET_STRING_ELT(state_names, 496, mkChar("E1d"));
  SET_STRING_ELT(state_names, 497, mkChar("offset_output_E1d"));
  SET_STRING_ELT(state_names, 498, mkChar("dim_cumuInf_init"));
  SET_STRING_ELT(state_names, 499, mkChar("cumuInf_init"));
  SET_STRING_ELT(state_names, 500, mkChar("dim_alphaItot"));
  SET_STRING_ELT(state_names, 501, mkChar("alphaItot"));
  SET_STRING_ELT(state_names, 502, mkChar("offset_output_alphaItot"));
  SET_STRING_ELT(state_names, 503, mkChar("dim_prev"));
  SET_STRING_ELT(state_names, 504, mkChar("prev"));
  SET_STRING_ELT(state_names, 505, mkChar("offset_output_prev"));
  SET_STRING_ELT(state_names, 506, mkChar("dim_lambda"));
  SET_STRING_ELT(state_names, 507, mkChar("dim_lambda_1"));
  SET_STRING_ELT(state_names, 508, mkChar("dim_lambda_2"));
  SET_STRING_ELT(state_names, 509, mkChar("lambda"));
  SET_STRING_ELT(state_names, 510, mkChar("offset_output_lambda"));
  SET_STRING_ELT(state_names, 511, mkChar("dim_lambda_0"));
  SET_STRING_ELT(state_names, 512, mkChar("dim_lambda_0_1"));
  SET_STRING_ELT(state_names, 513, mkChar("dim_lambda_0_2"));
  SET_STRING_ELT(state_names, 514, mkChar("lambda_0"));
  SET_STRING_ELT(state_names, 515, mkChar("offset_output_lambda_0"));
  SET_STRING_ELT(state_names, 516, mkChar("dim_lambda_1a"));
  SET_STRING_ELT(state_names, 517, mkChar("dim_lambda_1a_1"));
  SET_STRING_ELT(state_names, 518, mkChar("dim_lambda_1a_2"));
  SET_STRING_ELT(state_names, 519, mkChar("lambda_1a"));
  SET_STRING_ELT(state_names, 520, mkChar("offset_output_lambda_1a"));
  SET_STRING_ELT(state_names, 521, mkChar("dim_lambda_1b"));
  SET_STRING_ELT(state_names, 522, mkChar("dim_lambda_1b_1"));
  SET_STRING_ELT(state_names, 523, mkChar("dim_lambda_1b_2"));
  SET_STRING_ELT(state_names, 524, mkChar("lambda_1b"));
  SET_STRING_ELT(state_names, 525, mkChar("offset_output_lambda_1b"));
  SET_STRING_ELT(state_names, 526, mkChar("dim_lambda_1c"));
  SET_STRING_ELT(state_names, 527, mkChar("dim_lambda_1c_1"));
  SET_STRING_ELT(state_names, 528, mkChar("dim_lambda_1c_2"));
  SET_STRING_ELT(state_names, 529, mkChar("lambda_1c"));
  SET_STRING_ELT(state_names, 530, mkChar("offset_output_lambda_1c"));
  SET_STRING_ELT(state_names, 531, mkChar("dim_lambda_1d"));
  SET_STRING_ELT(state_names, 532, mkChar("dim_lambda_1d_1"));
  SET_STRING_ELT(state_names, 533, mkChar("dim_lambda_1d_2"));
  SET_STRING_ELT(state_names, 534, mkChar("lambda_1d"));
  SET_STRING_ELT(state_names, 535, mkChar("offset_output_lambda_1d"));
  SET_STRING_ELT(state_names, 536, mkChar("dim_lambda_sum_0"));
  SET_STRING_ELT(state_names, 537, mkChar("lambda_sum_0"));
  SET_STRING_ELT(state_names, 538, mkChar("offset_output_lambda_sum_0"));
  SET_STRING_ELT(state_names, 539, mkChar("dim_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 540, mkChar("lambda_sum_1a"));
  SET_STRING_ELT(state_names, 541, mkChar("offset_output_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 542, mkChar("dim_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 543, mkChar("lambda_sum_1b"));
  SET_STRING_ELT(state_names, 544, mkChar("offset_output_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 545, mkChar("dim_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 546, mkChar("lambda_sum_1c"));
  SET_STRING_ELT(state_names, 547, mkChar("offset_output_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 548, mkChar("dim_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 549, mkChar("lambda_sum_1d"));
  SET_STRING_ELT(state_names, 550, mkChar("offset_output_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 551, mkChar("dim_c_comm_balanced"));
  SET_STRING_ELT(state_names, 552, mkChar("c_comm_balanced"));
  SET_STRING_ELT(state_names, 553, mkChar("offset_output_c_comm_balanced"));
  SET_STRING_ELT(state_names, 554, mkChar("dim_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 555, mkChar("c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 556, mkChar("offset_output_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 557, mkChar("dim_theta"));
  SET_STRING_ELT(state_names, 558, mkChar("dim_theta_1"));
  SET_STRING_ELT(state_names, 559, mkChar("dim_theta_2"));
  SET_STRING_ELT(state_names, 560, mkChar("theta"));
  SET_STRING_ELT(state_names, 561, mkChar("offset_output_theta"));
  SET_STRING_ELT(state_names, 562, mkChar("dim_OnPrEP_init"));
  SET_STRING_ELT(state_names, 563, mkChar("OnPrEP_init"));
  SET_STRING_ELT(state_names, 564, mkChar("dim_M_comm"));
  SET_STRING_ELT(state_names, 565, mkChar("dim_M_comm_1"));
  SET_STRING_ELT(state_names, 566, mkChar("dim_M_comm_2"));
  SET_STRING_ELT(state_names, 567, mkChar("M_comm"));
  SET_STRING_ELT(state_names, 568, mkChar("offset_output_M_comm"));
  SET_STRING_ELT(state_names, 569, mkChar("dim_M_noncomm"));
  SET_STRING_ELT(state_names, 570, mkChar("dim_M_noncomm_1"));
  SET_STRING_ELT(state_names, 571, mkChar("dim_M_noncomm_2"));
  SET_STRING_ELT(state_names, 572, mkChar("M_noncomm"));
  SET_STRING_ELT(state_names, 573, mkChar("offset_output_M_noncomm"));
  SET_STRING_ELT(state_names, 574, mkChar("dim_in_S0"));
  SET_STRING_ELT(state_names, 575, mkChar("dim_in_S0_1"));
  SET_STRING_ELT(state_names, 576, mkChar("dim_in_S0_2"));
  SET_STRING_ELT(state_names, 577, mkChar("in_S0"));
  SET_STRING_ELT(state_names, 578, mkChar("dim_in_S1a"));
  SET_STRING_ELT(state_names, 579, mkChar("dim_in_S1a_1"));
  SET_STRING_ELT(state_names, 580, mkChar("dim_in_S1a_2"));
  SET_STRING_ELT(state_names, 581, mkChar("in_S1a"));
  SET_STRING_ELT(state_names, 582, mkChar("dim_in_S1b"));
  SET_STRING_ELT(state_names, 583, mkChar("dim_in_S1b_1"));
  SET_STRING_ELT(state_names, 584, mkChar("dim_in_S1b_2"));
  SET_STRING_ELT(state_names, 585, mkChar("in_S1b"));
  SET_STRING_ELT(state_names, 586, mkChar("dim_in_S1c"));
  SET_STRING_ELT(state_names, 587, mkChar("dim_in_S1c_1"));
  SET_STRING_ELT(state_names, 588, mkChar("dim_in_S1c_2"));
  SET_STRING_ELT(state_names, 589, mkChar("in_S1c"));
  SET_STRING_ELT(state_names, 590, mkChar("dim_in_S1d"));
  SET_STRING_ELT(state_names, 591, mkChar("dim_in_S1d_1"));
  SET_STRING_ELT(state_names, 592, mkChar("dim_in_S1d_2"));
  SET_STRING_ELT(state_names, 593, mkChar("in_S1d"));
  SET_STRING_ELT(state_names, 594, mkChar("dim_in_I01"));
  SET_STRING_ELT(state_names, 595, mkChar("dim_in_I01_1"));
  SET_STRING_ELT(state_names, 596, mkChar("dim_in_I01_2"));
  SET_STRING_ELT(state_names, 597, mkChar("in_I01"));
  SET_STRING_ELT(state_names, 598, mkChar("dim_in_I11"));
  SET_STRING_ELT(state_names, 599, mkChar("dim_in_I11_1"));
  SET_STRING_ELT(state_names, 600, mkChar("dim_in_I11_2"));
  SET_STRING_ELT(state_names, 601, mkChar("in_I11"));
  SET_STRING_ELT(state_names, 602, mkChar("dim_in_I02"));
  SET_STRING_ELT(state_names, 603, mkChar("dim_in_I02_1"));
  SET_STRING_ELT(state_names, 604, mkChar("dim_in_I02_2"));
  SET_STRING_ELT(state_names, 605, mkChar("in_I02"));
  SET_STRING_ELT(state_names, 606, mkChar("dim_in_I03"));
  SET_STRING_ELT(state_names, 607, mkChar("dim_in_I03_1"));
  SET_STRING_ELT(state_names, 608, mkChar("dim_in_I03_2"));
  SET_STRING_ELT(state_names, 609, mkChar("in_I03"));
  SET_STRING_ELT(state_names, 610, mkChar("dim_in_I04"));
  SET_STRING_ELT(state_names, 611, mkChar("dim_in_I04_1"));
  SET_STRING_ELT(state_names, 612, mkChar("dim_in_I04_2"));
  SET_STRING_ELT(state_names, 613, mkChar("in_I04"));
  SET_STRING_ELT(state_names, 614, mkChar("dim_in_I05"));
  SET_STRING_ELT(state_names, 615, mkChar("dim_in_I05_1"));
  SET_STRING_ELT(state_names, 616, mkChar("dim_in_I05_2"));
  SET_STRING_ELT(state_names, 617, mkChar("in_I05"));
  SET_STRING_ELT(state_names, 618, mkChar("dim_in_I22"));
  SET_STRING_ELT(state_names, 619, mkChar("dim_in_I22_1"));
  SET_STRING_ELT(state_names, 620, mkChar("dim_in_I22_2"));
  SET_STRING_ELT(state_names, 621, mkChar("in_I22"));
  SET_STRING_ELT(state_names, 622, mkChar("dim_in_I23"));
  SET_STRING_ELT(state_names, 623, mkChar("dim_in_I23_1"));
  SET_STRING_ELT(state_names, 624, mkChar("dim_in_I23_2"));
  SET_STRING_ELT(state_names, 625, mkChar("in_I23"));
  SET_STRING_ELT(state_names, 626, mkChar("dim_in_I24"));
  SET_STRING_ELT(state_names, 627, mkChar("dim_in_I24_1"));
  SET_STRING_ELT(state_names, 628, mkChar("dim_in_I24_2"));
  SET_STRING_ELT(state_names, 629, mkChar("in_I24"));
  SET_STRING_ELT(state_names, 630, mkChar("dim_in_I25"));
  SET_STRING_ELT(state_names, 631, mkChar("dim_in_I25_1"));
  SET_STRING_ELT(state_names, 632, mkChar("dim_in_I25_2"));
  SET_STRING_ELT(state_names, 633, mkChar("in_I25"));
  SET_STRING_ELT(state_names, 634, mkChar("dim_in_I32"));
  SET_STRING_ELT(state_names, 635, mkChar("dim_in_I32_1"));
  SET_STRING_ELT(state_names, 636, mkChar("dim_in_I32_2"));
  SET_STRING_ELT(state_names, 637, mkChar("in_I32"));
  SET_STRING_ELT(state_names, 638, mkChar("dim_in_I33"));
  SET_STRING_ELT(state_names, 639, mkChar("dim_in_I33_1"));
  SET_STRING_ELT(state_names, 640, mkChar("dim_in_I33_2"));
  SET_STRING_ELT(state_names, 641, mkChar("in_I33"));
  SET_STRING_ELT(state_names, 642, mkChar("dim_in_I34"));
  SET_STRING_ELT(state_names, 643, mkChar("dim_in_I34_1"));
  SET_STRING_ELT(state_names, 644, mkChar("dim_in_I34_2"));
  SET_STRING_ELT(state_names, 645, mkChar("in_I34"));
  SET_STRING_ELT(state_names, 646, mkChar("dim_in_I35"));
  SET_STRING_ELT(state_names, 647, mkChar("dim_in_I35_1"));
  SET_STRING_ELT(state_names, 648, mkChar("dim_in_I35_2"));
  SET_STRING_ELT(state_names, 649, mkChar("in_I35"));
  SET_STRING_ELT(state_names, 650, mkChar("dim_in_I42"));
  SET_STRING_ELT(state_names, 651, mkChar("dim_in_I42_1"));
  SET_STRING_ELT(state_names, 652, mkChar("dim_in_I42_2"));
  SET_STRING_ELT(state_names, 653, mkChar("in_I42"));
  SET_STRING_ELT(state_names, 654, mkChar("dim_in_I43"));
  SET_STRING_ELT(state_names, 655, mkChar("dim_in_I43_1"));
  SET_STRING_ELT(state_names, 656, mkChar("dim_in_I43_2"));
  SET_STRING_ELT(state_names, 657, mkChar("in_I43"));
  SET_STRING_ELT(state_names, 658, mkChar("dim_in_I44"));
  SET_STRING_ELT(state_names, 659, mkChar("dim_in_I44_1"));
  SET_STRING_ELT(state_names, 660, mkChar("dim_in_I44_2"));
  SET_STRING_ELT(state_names, 661, mkChar("in_I44"));
  SET_STRING_ELT(state_names, 662, mkChar("dim_in_I45"));
  SET_STRING_ELT(state_names, 663, mkChar("dim_in_I45_1"));
  SET_STRING_ELT(state_names, 664, mkChar("dim_in_I45_2"));
  SET_STRING_ELT(state_names, 665, mkChar("in_I45"));
  SET_STRING_ELT(state_names, 666, mkChar("dim_rate_move_in"));
  SET_STRING_ELT(state_names, 667, mkChar("dim_rate_move_in_1"));
  SET_STRING_ELT(state_names, 668, mkChar("dim_rate_move_in_2"));
  SET_STRING_ELT(state_names, 669, mkChar("rate_move_in"));
  SET_STRING_ELT(state_names, 670, mkChar("offset_output_rate_move_in"));
  SET_STRING_ELT(state_names, 671, mkChar("dim_rate_move_out"));
  SET_STRING_ELT(state_names, 672, mkChar("rate_move_out"));
  SET_STRING_ELT(state_names, 673, mkChar("offset_output_rate_move_out"));
  SET_STRING_ELT(state_names, 674, mkChar("interpolate_c_comm"));
  SET_STRING_ELT(state_names, 675, mkChar("interpolate_c_noncomm"));
  SET_STRING_ELT(state_names, 676, mkChar("interpolate_ART_eligible_CD4_above_500"));
  SET_STRING_ELT(state_names, 677, mkChar("ART_eligible_CD4_above_500"));
  SET_STRING_ELT(state_names, 678, mkChar("interpolate_ART_eligible_CD4_350_500"));
  SET_STRING_ELT(state_names, 679, mkChar("ART_eligible_CD4_350_500"));
  SET_STRING_ELT(state_names, 680, mkChar("interpolate_ART_eligible_CD4_200_349"));
  SET_STRING_ELT(state_names, 681, mkChar("ART_eligible_CD4_200_349"));
  SET_STRING_ELT(state_names, 682, mkChar("interpolate_ART_eligible_CD4_below_200"));
  SET_STRING_ELT(state_names, 683, mkChar("ART_eligible_CD4_below_200"));
  SET_STRING_ELT(state_names, 684, mkChar("interpolate_testing_prob"));
  SET_STRING_ELT(state_names, 685, mkChar("interpolate_tau_intervention"));
  SET_STRING_ELT(state_names, 686, mkChar("interpolate_rho_intervention"));
  SET_STRING_ELT(state_names, 687, mkChar("interpolate_infect_ART"));
  SET_STRING_ELT(state_names, 688, mkChar("interpolate_epsilon"));
  SET_STRING_ELT(state_names, 689, mkChar("epsilon"));
  SET_STRING_ELT(state_names, 690, mkChar("interpolate_prep_offered"));
  SET_STRING_ELT(state_names, 691, mkChar("interpolate_fc_comm"));
  SET_STRING_ELT(state_names, 692, mkChar("interpolate_fP_comm"));
  SET_STRING_ELT(state_names, 693, mkChar("interpolate_fc_noncomm"));
  SET_STRING_ELT(state_names, 694, mkChar("interpolate_fP_noncomm"));
  SET_STRING_ELT(state_names, 695, mkChar("interpolate_n_comm"));
  SET_STRING_ELT(state_names, 696, mkChar("interpolate_n_noncomm"));
  SET_STRING_ELT(state_names, 697, mkChar("dim"));
  SET_STRING_ELT(state_names, 698, mkChar("dim_output"));
...
SEXP main_model_variable_order(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  SEXP state_len = PROTECT(allocVector(VECSXP, 30));
  SEXP state_names = PROTECT(allocVector(STRSXP, 30));
  SET_VECTOR_ELT(state_len, 0, ScalarInteger(main_model_p->dim_cumuHIVDeaths));
  SET_STRING_ELT(state_names, 0, mkChar("cumuHIVDeaths"));
  SET_VECTOR_ELT(state_len, 1, ScalarInteger(main_model_p->dim_cumuARTinitiations));
  SET_STRING_ELT(state_names, 1, mkChar("cumuARTinitiations"));
  SET_VECTOR_ELT(state_len, 2, ScalarInteger(main_model_p->dim_cumuARTREinitiations));
  SET_STRING_ELT(state_names, 2, mkChar("cumuARTREinitiations"));
  SET_VECTOR_ELT(state_len, 3, ScalarInteger(main_model_p->dim_cumuTesting));
  SET_STRING_ELT(state_names, 3, mkChar("cumuTesting"));
  SET_VECTOR_ELT(state_len, 4, ScalarInteger(main_model_p->dim_cumuAllDeaths));
  SET_STRING_ELT(state_names, 4, mkChar("cumuAllDeaths"));
  SET_VECTOR_ELT(state_len, 5, ScalarInteger(main_model_p->dim_cumuInf));
  SET_STRING_ELT(state_names, 5, mkChar("cumuInf"));
  SET_VECTOR_ELT(state_len, 6, ScalarInteger(main_model_p->dim_OnPrEP));
  SET_STRING_ELT(state_names, 6, mkChar("OnPrEP"));
  SET_VECTOR_ELT(state_len, 7, ScalarInteger(main_model_p->dim_S0));
  SET_STRING_ELT(state_names, 7, mkChar("S0"));
  SET_VECTOR_ELT(state_len, 8, ScalarInteger(main_model_p->dim_S1a));
  SET_STRING_ELT(state_names, 8, mkChar("S1a"));
  SET_VECTOR_ELT(state_len, 9, ScalarInteger(main_model_p->dim_S1b));
  SET_STRING_ELT(state_names, 9, mkChar("S1b"));
  SET_VECTOR_ELT(state_len, 10, ScalarInteger(main_model_p->dim_S1c));
  SET_STRING_ELT(state_names, 10, mkChar("S1c"));
  SET_VECTOR_ELT(state_len, 11, ScalarInteger(main_model_p->dim_S1d));
  SET_STRING_ELT(state_names, 11, mkChar("S1d"));
  SET_VECTOR_ELT(state_len, 12, ScalarInteger(main_model_p->dim_I01));
  SET_STRING_ELT(state_names, 12, mkChar("I01"));
  SET_VECTOR_ELT(state_len, 13, ScalarInteger(main_model_p->dim_I11));
  SET_STRING_ELT(state_names, 13, mkChar("I11"));
  SET_VECTOR_ELT(state_len, 14, ScalarInteger(main_model_p->dim_I02));
  SET_STRING_ELT(state_names, 14, mkChar("I02"));
  SET_VECTOR_ELT(state_len, 15, ScalarInteger(main_model_p->dim_I03));
  SET_STRING_ELT(state_names, 15, mkChar("I03"));
  SET_VECTOR_ELT(state_len, 16, ScalarInteger(main_model_p->dim_I04));
  SET_STRING_ELT(state_names, 16, mkChar("I04"));
  SET_VECTOR_ELT(state_len, 17, ScalarInteger(main_model_p->dim_I05));
  SET_STRING_ELT(state_names, 17, mkChar("I05"));
  SET_VECTOR_ELT(state_len, 18, ScalarInteger(main_model_p->dim_I22));
  SET_STRING_ELT(state_names, 18, mkChar("I22"));
  SET_VECTOR_ELT(state_len, 19, ScalarInteger(main_model_p->dim_I23));
  SET_STRING_ELT(state_names, 19, mkChar("I23"));
  SET_VECTOR_ELT(state_len, 20, ScalarInteger(main_model_p->dim_I24));
  SET_STRING_ELT(state_names, 20, mkChar("I24"));
  SET_VECTOR_ELT(state_len, 21, ScalarInteger(main_model_p->dim_I25));
  SET_STRING_ELT(state_names, 21, mkChar("I25"));
  SET_VECTOR_ELT(state_len, 22, ScalarInteger(main_model_p->dim_I32));
  SET_STRING_ELT(state_names, 22, mkChar("I32"));
  SET_VECTOR_ELT(state_len, 23, ScalarInteger(main_model_p->dim_I33));
  SET_STRING_ELT(state_names, 23, mkChar("I33"));
  SET_VECTOR_ELT(state_len, 24, ScalarInteger(main_model_p->dim_I34));
  SET_STRING_ELT(state_names, 24, mkChar("I34"));
  SET_VECTOR_ELT(state_len, 25, ScalarInteger(main_model_p->dim_I35));
  SET_STRING_ELT(state_names, 25, mkChar("I35"));
  SET_VECTOR_ELT(state_len, 26, ScalarInteger(main_model_p->dim_I42));
  SET_STRING_ELT(state_names, 26, mkChar("I42"));
  SET_VECTOR_ELT(state_len, 27, ScalarInteger(main_model_p->dim_I43));
  SET_STRING_ELT(state_names, 27, mkChar("I43"));
  SET_VECTOR_ELT(state_len, 28, ScalarInteger(main_model_p->dim_I44));
  SET_STRING_ELT(state_names, 28, mkChar("I44"));
  SET_VECTOR_ELT(state_len, 29, ScalarInteger(main_model_p->dim_I45));
  SET_STRING_ELT(state_names, 29, mkChar("I45"));
...
SEXP main_model_output_order(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  int *tmp;
  SEXP state_len = PROTECT(allocVector(VECSXP, 98));
  SEXP state_names = PROTECT(allocVector(STRSXP, 98));
  ...
  SET_STRING_ELT(state_names, 1, mkChar("PrEPOnOff"));
  SET_VECTOR_ELT(state_len, 2, R_NilValue);
  SET_STRING_ELT(state_names, 2, mkChar("fPa"));
  SET_VECTOR_ELT(state_len, 3, R_NilValue);
  SET_STRING_ELT(state_names, 3, mkChar("fPb"));
  SET_VECTOR_ELT(state_len, 4, R_NilValue);
  SET_STRING_ELT(state_names, 4, mkChar("fPc"));
  SET_VECTOR_ELT(state_len, 5, R_NilValue);
  SET_STRING_ELT(state_names, 5, mkChar("cumuInftot"));
  SET_VECTOR_ELT(state_len, 6, R_NilValue);
  SET_STRING_ELT(state_names, 6, mkChar("Men_on_ART"));
  SET_VECTOR_ELT(state_len, 7, R_NilValue);
  SET_STRING_ELT(state_names, 7, mkChar("Women_on_ART"));
  SET_VECTOR_ELT(state_len, 8, R_NilValue);
  SET_STRING_ELT(state_names, 8, mkChar("ART_coverage_men"));
  SET_VECTOR_ELT(state_len, 9, R_NilValue);
  SET_STRING_ELT(state_names, 9, mkChar("ART_coverage_women"));
  SET_VECTOR_ELT(state_len, 10, R_NilValue);
  SET_STRING_ELT(state_names, 10, mkChar("ART_coverage_FSW"));
  SET_VECTOR_ELT(state_len, 11, R_NilValue);
  SET_STRING_ELT(state_names, 11, mkChar("ART_coverage_all"));
  SET_VECTOR_ELT(state_len, 12, R_NilValue);
  SET_STRING_ELT(state_names, 12, mkChar("Ncat"));
  SET_VECTOR_ELT(state_len, 13, R_NilValue);
  SET_STRING_ELT(state_names, 13, mkChar("nu"));
  SET_VECTOR_ELT(state_len, 14, R_NilValue);
  SET_STRING_ELT(state_names, 14, mkChar("Nage"));
  SET_VECTOR_ELT(state_len, 15, R_NilValue);
  SET_STRING_ELT(state_names, 15, mkChar("dur_FSW"));
  SET_VECTOR_ELT(state_len, 16, R_NilValue);
  SET_STRING_ELT(state_names, 16, mkChar("epsilon"));
  SET_VECTOR_ELT(state_len, 17, R_NilValue);
  SET_STRING_ELT(state_names, 17, mkChar("Ntot_inc_former_FSW_nonCot"));
  SET_VECTOR_ELT(state_len, 18, R_NilValue);
  SET_STRING_ELT(state_names, 18, mkChar("new_people"));
  SET_VECTOR_ELT(state_len, 19, R_NilValue);
  SET_STRING_ELT(state_names, 19, mkChar("frac_virgin"));
  SET_VECTOR_ELT(state_len, 20, R_NilValue);
  SET_STRING_ELT(state_names, 20, mkChar("prev_LowFSW"));
  SET_VECTOR_ELT(state_len, 21, R_NilValue);
  SET_STRING_ELT(state_names, 21, mkChar("prev_men"));
  SET_VECTOR_ELT(state_len, 22, R_NilValue);
  SET_STRING_ELT(state_names, 22, mkChar("prev_women"));
  SET_VECTOR_ELT(state_len, 23, R_NilValue);
  SET_STRING_ELT(state_names, 23, mkChar("prev_cotonou"));
  SET_VECTOR_ELT(state_len, 24, R_NilValue);
  SET_STRING_ELT(state_names, 24, mkChar("Ntot"));
  SET_VECTOR_ELT(state_len, 25, R_NilValue);
  SET_STRING_ELT(state_names, 25, mkChar("prev_FSW"));
  SET_VECTOR_ELT(state_len, 26, R_NilValue);
  SET_STRING_ELT(state_names, 26, mkChar("prev_client"));
  SET_VECTOR_ELT(state_len, 27, R_NilValue);
  SET_STRING_ELT(state_names, 27, mkChar("B_check_comm"));
  SET_VECTOR_ELT(state_len, 28, R_NilValue);
  SET_STRING_ELT(state_names, 28, mkChar("B_check_noncomm"));
  SET_VECTOR_ELT(state_len, 29, R_NilValue);
  SET_STRING_ELT(state_names, 29, mkChar("FSW_in"));
  SET_VECTOR_ELT(state_len, 30, R_NilValue);
  SET_STRING_ELT(state_names, 30, mkChar("FSW_out"));
  SET_VECTOR_ELT(state_len, 31, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 31));
  tmp[0] = main_model_p->dim_infect_ART_y_1;
  tmp[1] = main_model_p->dim_infect_ART_y_2;
  SET_STRING_ELT(state_names, 31, mkChar("infect_ART_y"));
  SET_VECTOR_ELT(state_len, 32, ScalarInteger(main_model_p->dim_infect_ART_t));
  SET_STRING_ELT(state_names, 32, mkChar("infect_ART_t"));
  SET_VECTOR_ELT(state_len, 33, ScalarInteger(main_model_p->dim_c_comm));
  SET_STRING_ELT(state_names, 33, mkChar("c_comm"));
  SET_VECTOR_ELT(state_len, 34, ScalarInteger(main_model_p->dim_c_noncomm));
  SET_STRING_ELT(state_names, 34, mkChar("c_noncomm"));
  SET_VECTOR_ELT(state_len, 35, ScalarInteger(main_model_p->dim_new_people_in_group));
  SET_STRING_ELT(state_names, 35, mkChar("new_people_in_group"));
  SET_VECTOR_ELT(state_len, 36, ScalarInteger(main_model_p->dim_new_people_in_group_FSW_only));
  SET_STRING_ELT(state_names, 36, mkChar("new_people_in_group_FSW_only"));
  SET_VECTOR_ELT(state_len, 37, ScalarInteger(main_model_p->dim_testing_prob));
  SET_STRING_ELT(state_names, 37, mkChar("testing_prob"));
  SET_VECTOR_ELT(state_len, 38, ScalarInteger(main_model_p->dim_tau_intervention));
  SET_STRING_ELT(state_names, 38, mkChar("tau_intervention"));
  SET_VECTOR_ELT(state_len, 39, ScalarInteger(main_model_p->dim_rho_intervention));
  SET_STRING_ELT(state_names, 39, mkChar("rho_intervention"));
  SET_VECTOR_ELT(state_len, 40, ScalarInteger(main_model_p->dim_zeta));
  SET_STRING_ELT(state_names, 40, mkChar("zeta"));
  SET_VECTOR_ELT(state_len, 41, ScalarInteger(main_model_p->dim_tau));
  SET_STRING_ELT(state_names, 41, mkChar("tau"));
  SET_VECTOR_ELT(state_len, 42, ScalarInteger(main_model_p->dim_rho));
  SET_STRING_ELT(state_names, 42, mkChar("rho"));
  SET_VECTOR_ELT(state_len, 43, ScalarInteger(main_model_p->dim_iota));
  SET_STRING_ELT(state_names, 43, mkChar("iota"));
  SET_VECTOR_ELT(state_len, 44, ScalarInteger(main_model_p->dim_frac_F));
  SET_STRING_ELT(state_names, 44, mkChar("frac_F"));
  SET_VECTOR_ELT(state_len, 45, ScalarInteger(main_model_p->dim_frac_N_sexualpop));
  SET_STRING_ELT(state_names, 45, mkChar("frac_N_sexualpop"));
  SET_VECTOR_ELT(state_len, 46, ScalarInteger(main_model_p->dim_infect_ART));
  SET_STRING_ELT(state_names, 46, mkChar("infect_ART"));
  SET_VECTOR_ELT(state_len, 47, ScalarInteger(main_model_p->dim_omega));
  SET_STRING_ELT(state_names, 47, mkChar("omega"));
  SET_VECTOR_ELT(state_len, 48, ScalarInteger(main_model_p->dim_frac_N));
  SET_STRING_ELT(state_names, 48, mkChar("frac_N"));
  SET_VECTOR_ELT(state_len, 49, ScalarInteger(main_model_p->dim_mu));
  SET_STRING_ELT(state_names, 49, mkChar("mu"));
  SET_VECTOR_ELT(state_len, 50, ScalarInteger(main_model_p->dim_gamma01));
  SET_STRING_ELT(state_names, 50, mkChar("gamma01"));
  SET_VECTOR_ELT(state_len, 51, ScalarInteger(main_model_p->dim_gamma11));
  SET_STRING_ELT(state_names, 51, mkChar("gamma11"));
  SET_VECTOR_ELT(state_len, 52, ScalarInteger(main_model_p->dim_kappaa));
  SET_STRING_ELT(state_names, 52, mkChar("kappaa"));
  SET_VECTOR_ELT(state_len, 53, ScalarInteger(main_model_p->dim_kappab));
  SET_STRING_ELT(state_names, 53, mkChar("kappab"));
  SET_VECTOR_ELT(state_len, 54, ScalarInteger(main_model_p->dim_kappac));
  SET_STRING_ELT(state_names, 54, mkChar("kappac"));
  SET_VECTOR_ELT(state_len, 55, ScalarInteger(main_model_p->dim_kappa1));
  SET_STRING_ELT(state_names, 55, mkChar("kappa1"));
  SET_VECTOR_ELT(state_len, 56, ScalarInteger(main_model_p->dim_alpha01));
  SET_STRING_ELT(state_names, 56, mkChar("alpha01"));
  SET_VECTOR_ELT(state_len, 57, ScalarInteger(main_model_p->dim_alpha02));
  SET_STRING_ELT(state_names, 57, mkChar("alpha02"));
  SET_VECTOR_ELT(state_len, 58, ScalarInteger(main_model_p->dim_alpha05));
  SET_STRING_ELT(state_names, 58, mkChar("alpha05"));
  SET_VECTOR_ELT(state_len, 59, ScalarInteger(main_model_p->dim_alpha11));
  SET_STRING_ELT(state_names, 59, mkChar("alpha11"));
  SET_VECTOR_ELT(state_len, 60, ScalarInteger(main_model_p->dim_alpha22));
  SET_STRING_ELT(state_names, 60, mkChar("alpha22"));
  SET_VECTOR_ELT(state_len, 61, ScalarInteger(main_model_p->dim_alpha35));
  SET_STRING_ELT(state_names, 61, mkChar("alpha35"));
  SET_VECTOR_ELT(state_len, 62, ScalarInteger(main_model_p->dim_beta_comm));
  SET_STRING_ELT(state_names, 62, mkChar("beta_comm"));
  SET_VECTOR_ELT(state_len, 63, ScalarInteger(main_model_p->dim_beta_noncomm));
  SET_STRING_ELT(state_names, 63, mkChar("beta_noncomm"));
  ...
  SET_STRING_ELT(state_names, 64, mkChar("p_comm"));
  ...
  SET_STRING_ELT(state_names, 65, mkChar("p_noncomm"));
  ...
  SET_STRING_ELT(state_names, 66, mkChar("fc_comm"));
  SET_VECTOR_ELT(state_len, 67, ScalarInteger(main_model_p->dim_fP_comm));
  SET_STRING_ELT(state_names, 67, mkChar("fP_comm"));
  ...
  SET_STRING_ELT(state_names, 68, mkChar("fc_noncomm"));
  SET_VECTOR_ELT(state_len, 69, ScalarInteger(main_model_p->dim_fP_noncomm));
  SET_STRING_ELT(state_names, 69, mkChar("fP_noncomm"));
  SET_VECTOR_ELT(state_len, 70, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 70));
  tmp[0] = main_model_p->dim_n_comm_1;
  tmp[1] = main_model_p->dim_n_comm_2;
  SET_STRING_ELT(state_names, 70, mkChar("n_comm"));
  SET_VECTOR_ELT(state_len, 71, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 71));
  tmp[0] = main_model_p->dim_n_noncomm_1;
  tmp[1] = main_model_p->dim_n_noncomm_2;
  SET_STRING_ELT(state_names, 71, mkChar("n_noncomm"));
  SET_VECTOR_ELT(state_len, 72, ScalarInteger(main_model_p->dim_N));
  SET_STRING_ELT(state_names, 72, mkChar("N"));
  SET_VECTOR_ELT(state_len, 73, ScalarInteger(main_model_p->dim_E0));
  SET_STRING_ELT(state_names, 73, mkChar("E0"));
  SET_VECTOR_ELT(state_len, 74, ScalarInteger(main_model_p->dim_E1a));
  SET_STRING_ELT(state_names, 74, mkChar("E1a"));
  SET_VECTOR_ELT(state_len, 75, ScalarInteger(main_model_p->dim_E1b));
  SET_STRING_ELT(state_names, 75, mkChar("E1b"));
  SET_VECTOR_ELT(state_len, 76, ScalarInteger(main_model_p->dim_E1c));
  SET_STRING_ELT(state_names, 76, mkChar("E1c"));
  SET_VECTOR_ELT(state_len, 77, ScalarInteger(main_model_p->dim_E1d));
  SET_STRING_ELT(state_names, 77, mkChar("E1d"));
  SET_VECTOR_ELT(state_len, 78, ScalarInteger(main_model_p->dim_alphaItot));
  SET_STRING_ELT(state_names, 78, mkChar("alphaItot"));
  SET_VECTOR_ELT(state_len, 79, ScalarInteger(main_model_p->dim_prev));
  SET_STRING_ELT(state_names, 79, mkChar("prev"));
  ...
  SET_STRING_ELT(state_names, 80, mkChar("lambda"));
  SET_VECTOR_ELT(state_len, 81, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 81));
  tmp[0] = main_model_p->dim_lambda_0_1;
  tmp[1] = main_model_p->dim_lambda_0_2;
  SET_STRING_ELT(state_names, 81, mkChar("lambda_0"));
  SET_VECTOR_ELT(state_len, 82, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 82));
  tmp[0] = main_model_p->dim_lambda_1a_1;
  tmp[1] = main_model_p->dim_lambda_1a_2;
  SET_STRING_ELT(state_names, 82, mkChar("lambda_1a"));
  SET_VECTOR_ELT(state_len, 83, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 83));
  tmp[0] = main_model_p->dim_lambda_1b_1;
  tmp[1] = main_model_p->dim_lambda_1b_2;
  SET_STRING_ELT(state_names, 83, mkChar("lambda_1b"));
  SET_VECTOR_ELT(state_len, 84, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 84));
  tmp[0] = main_model_p->dim_lambda_1c_1;
  tmp[1] = main_model_p->dim_lambda_1c_2;
  SET_STRING_ELT(state_names, 84, mkChar("lambda_1c"));
  SET_VECTOR_ELT(state_len, 85, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 85));
  tmp[0] = main_model_p->dim_lambda_1d_1;
  tmp[1] = main_model_p->dim_lambda_1d_2;
  SET_STRING_ELT(state_names, 85, mkChar("lambda_1d"));
  SET_VECTOR_ELT(state_len, 86, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_STRING_ELT(state_names, 86, mkChar("lambda_sum_0"));
  SET_VECTOR_ELT(state_len, 87, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_STRING_ELT(state_names, 87, mkChar("lambda_sum_1a"));
  SET_VECTOR_ELT(state_len, 88, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_STRING_ELT(state_names, 88, mkChar("lambda_sum_1b"));
  SET_VECTOR_ELT(state_len, 89, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_STRING_ELT(state_names, 89, mkChar("lambda_sum_1c"));
  SET_VECTOR_ELT(state_len, 90, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_STRING_ELT(state_names, 90, mkChar("lambda_sum_1d"));
  SET_VECTOR_ELT(state_len, 91, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_STRING_ELT(state_names, 91, mkChar("c_comm_balanced"));
  SET_VECTOR_ELT(state_len, 92, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_STRING_ELT(state_names, 92, mkChar("c_noncomm_balanced"));
  ...
  SET_STRING_ELT(state_names, 93, mkChar("theta"));
  ...
  SET_STRING_ELT(state_names, 94, mkChar("M_comm"));
  SET_VECTOR_ELT(state_len, 95, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 95));
  tmp[0] = main_model_p->dim_M_noncomm_1;
  tmp[1] = main_model_p->dim_M_noncomm_2;
  SET_STRING_ELT(state_names, 95, mkChar("M_noncomm"));
  ...
  SET_STRING_ELT(state_names, 96, mkChar("rate_move_in"));
  SET_VECTOR_ELT(state_len, 97, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_STRING_ELT(state_names, 97, mkChar("rate_move_out"));
  setAttrib(state_len, R_NamesSymbol, state_names);
  UNPROTECT(2);
  return state_len;
}
