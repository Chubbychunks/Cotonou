mkChar("I03_init"));
  SET_STRING_ELT(state_names, 433, mkChar("dim_I04_init"));
  SET_STRING_ELT(state_names, 434, mkChar("I04_init"));
  SET_STRING_ELT(state_names, 435, mkChar("dim_I05_init"));
  SET_STRING_ELT(state_names, 436, mkChar("I05_init"));
  SET_STRING_ELT(state_names, 437, mkChar("dim_I22_init"));
  SET_STRING_ELT(state_names, 438, mkChar("I22_init"));
  SET_STRING_ELT(state_names, 439, mkChar("dim_I23_init"));
  SET_STRING_ELT(state_names, 440, mkChar("I23_init"));
  SET_STRING_ELT(state_names, 441, mkChar("dim_I24_init"));
  SET_STRING_ELT(state_names, 442, mkChar("I24_init"));
  SET_STRING_ELT(state_names, 443, mkChar("dim_I25_init"));
  SET_STRING_ELT(state_names, 444, mkChar("I25_init"));
  SET_STRING_ELT(state_names, 445, mkChar("dim_I32_init"));
  SET_STRING_ELT(state_names, 446, mkChar("I32_init"));
  SET_STRING_ELT(state_names, 447, mkChar("dim_I33_init"));
  SET_STRING_ELT(state_names, 448, mkChar("I33_init"));
  SET_STRING_ELT(state_names, 449, mkChar("dim_I34_init"));
  SET_STRING_ELT(state_names, 450, mkChar("I34_init"));
  SET_STRING_ELT(state_names, 451, mkChar("dim_I35_init"));
  SET_STRING_ELT(state_names, 452, mkChar("I35_init"));
  SET_STRING_ELT(state_names, 453, mkChar("dim_I42_init"));
  SET_STRING_ELT(state_names, 454, mkChar("I42_init"));
  SET_STRING_ELT(state_names, 455, mkChar("dim_I43_init"));
  SET_STRING_ELT(state_names, 456, mkChar("I43_init"));
  SET_STRING_ELT(state_names, 457, mkChar("dim_I44_init"));
  SET_STRING_ELT(state_names, 458, mkChar("I44_init"));
  SET_STRING_ELT(state_names, 459, mkChar("dim_I45_init"));
  SET_STRING_ELT(state_names, 460, mkChar("I45_init"));
  SET_STRING_ELT(state_names, 461, mkChar("dim_N"));
  SET_STRING_ELT(state_names, 462, mkChar("N"));
  SET_STRING_ELT(state_names, 463, mkChar("offset_output_N"));
  SET_STRING_ELT(state_names, 464, mkChar("dim_E0"));
  SET_STRING_ELT(state_names, 465, mkChar("E0"));
  SET_STRING_ELT(state_names, 466, mkChar("offset_output_E0"));
  SET_STRING_ELT(state_names, 467, mkChar("dim_E1a"));
  SET_STRING_ELT(state_names, 468, mkChar("E1a"));
  SET_STRING_ELT(state_names, 469, mkChar("offset_output_E1a"));
  SET_STRING_ELT(state_names, 470, mkChar("dim_E1b"));
  SET_STRING_ELT(state_names, 471, mkChar("E1b"));
  SET_STRING_ELT(state_names, 472, mkChar("offset_output_E1b"));
  SET_STRING_ELT(state_names, 473, mkChar("dim_E1c"));
  SET_STRING_ELT(state_names, 474, mkChar("E1c"));
  SET_STRING_ELT(state_names, 475, mkChar("offset_output_E1c"));
  SET_STRING_ELT(state_names, 476, mkChar("dim_E1d"));
  SET_STRING_ELT(state_names, 477, mkChar("E1d"));
  SET_STRING_ELT(state_names, 478, mkChar("offset_output_E1d"));
  SET_STRING_ELT(state_names, 479, mkChar("dim_cumuInf_init"));
  SET_STRING_ELT(state_names, 480, mkChar("cumuInf_init"));
  SET_STRING_ELT(state_names, 481, mkChar("dim_alphaItot"));
  SET_STRING_ELT(state_names, 482, mkChar("alphaItot"));
  SET_STRING_ELT(state_names, 483, mkChar("offset_output_alphaItot"));
  SET_STRING_ELT(state_names, 484, mkChar("dim_prev"));
  SET_STRING_ELT(state_names, 485, mkChar("prev"));
  SET_STRING_ELT(state_names, 486, mkChar("offset_output_prev"));
  SET_STRING_ELT(state_names, 487, mkChar("dim_lambda"));
  SET_STRING_ELT(state_names, 488, mkChar("dim_lambda_1"));
  SET_STRING_ELT(state_names, 489, mkChar("dim_lambda_2"));
  SET_STRING_ELT(state_names, 490, mkChar("lambda"));
  SET_STRING_ELT(state_names, 491, mkChar("offset_output_lambda"));
  SET_STRING_ELT(state_names, 492, mkChar("dim_lambda_0"));
  SET_STRING_ELT(state_names, 493, mkChar("dim_lambda_0_1"));
  SET_STRING_ELT(state_names, 494, mkChar("dim_lambda_0_2"));
  SET_STRING_ELT(state_names, 495, mkChar("lambda_0"));
  SET_STRING_ELT(state_names, 496, mkChar("offset_output_lambda_0"));
  SET_STRING_ELT(state_names, 497, mkChar("dim_lambda_1a"));
  SET_STRING_ELT(state_names, 498, mkChar("dim_lambda_1a_1"));
  SET_STRING_ELT(state_names, 499, mkChar("dim_lambda_1a_2"));
  SET_STRING_ELT(state_names, 500, mkChar("lambda_1a"));
  SET_STRING_ELT(state_names, 501, mkChar("offset_output_lambda_1a"));
  SET_STRING_ELT(state_names, 502, mkChar("dim_lambda_1b"));
  SET_STRING_ELT(state_names, 503, mkChar("dim_lambda_1b_1"));
  SET_STRING_ELT(state_names, 504, mkChar("dim_lambda_1b_2"));
  SET_STRING_ELT(state_names, 505, mkChar("lambda_1b"));
  SET_STRING_ELT(state_names, 506, mkChar("offset_output_lambda_1b"));
  SET_STRING_ELT(state_names, 507, mkChar("dim_lambda_1c"));
  SET_STRING_ELT(state_names, 508, mkChar("dim_lambda_1c_1"));
  SET_STRING_ELT(state_names, 509, mkChar("dim_lambda_1c_2"));
  SET_STRING_ELT(state_names, 510, mkChar("lambda_1c"));
  SET_STRING_ELT(state_names, 511, mkChar("offset_output_lambda_1c"));
  SET_STRING_ELT(state_names, 512, mkChar("dim_lambda_1d"));
  SET_STRING_ELT(state_names, 513, mkChar("dim_lambda_1d_1"));
  SET_STRING_ELT(state_names, 514, mkChar("dim_lambda_1d_2"));
  SET_STRING_ELT(state_names, 515, mkChar("lambda_1d"));
  SET_STRING_ELT(state_names, 516, mkChar("offset_output_lambda_1d"));
  SET_STRING_ELT(state_names, 517, mkChar("dim_lambda_sum_0"));
  SET_STRING_ELT(state_names, 518, mkChar("lambda_sum_0"));
  SET_STRING_ELT(state_names, 519, mkChar("offset_output_lambda_sum_0"));
  SET_STRING_ELT(state_names, 520, mkChar("dim_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 521, mkChar("lambda_sum_1a"));
  SET_STRING_ELT(state_names, 522, mkChar("offset_output_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 523, mkChar("dim_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 524, mkChar("lambda_sum_1b"));
  SET_STRING_ELT(state_names, 525, mkChar("offset_output_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 526, mkChar("dim_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 527, mkChar("lambda_sum_1c"));
  SET_STRING_ELT(state_names, 528, mkChar("offset_output_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 529, mkChar("dim_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 530, mkChar("lambda_sum_1d"));
  SET_STRING_ELT(state_names, 531, mkChar("offset_output_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 532, mkChar("dim_c_comm_balanced"));
  SET_STRING_ELT(state_names, 533, mkChar("c_comm_balanced"));
  SET_STRING_ELT(state_names, 534, mkChar("offset_output_c_comm_balanced"));
  SET_STRING_ELT(state_names, 535, mkChar("dim_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 536, mkChar("c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 537, mkChar("offset_output_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 538, mkChar("dim_theta"));
  SET_STRING_ELT(state_names, 539, mkChar("dim_theta_1"));
  SET_STRING_ELT(state_names, 540, mkChar("dim_theta_2"));
  SET_STRING_ELT(state_names, 541, mkChar("theta"));
  SET_STRING_ELT(state_names, 542, mkChar("offset_output_theta"));
  SET_STRING_ELT(state_names, 543, mkChar("dim_OnPrEP_init"));
  SET_STRING_ELT(state_names, 544, mkChar("OnPrEP_init"));
  SET_STRING_ELT(state_names, 545, mkChar("dim_M_comm"));
  SET_STRING_ELT(state_names, 546, mkChar("dim_M_comm_1"));
  SET_STRING_ELT(state_names, 547, mkChar("dim_M_comm_2"));
  SET_STRING_ELT(state_names, 548, mkChar("M_comm"));
  SET_STRING_ELT(state_names, 549, mkChar("offset_output_M_comm"));
  SET_STRING_ELT(state_names, 550, mkChar("dim_M_noncomm"));
  SET_STRING_ELT(state_names, 551, mkChar("dim_M_noncomm_1"));
  SET_STRING_ELT(state_names, 552, mkChar("dim_M_noncomm_2"));
  SET_STRING_ELT(state_names, 553, mkChar("M_noncomm"));
  SET_STRING_ELT(state_names, 554, mkChar("offset_output_M_noncomm"));
  SET_STRING_ELT(state_names, 555, mkChar("dim_in_S0"));
  SET_STRING_ELT(state_names, 556, mkChar("dim_in_S0_1"));
  SET_STRING_ELT(state_names, 557, mkChar("dim_in_S0_2"));
  SET_STRING_ELT(state_names, 558, mkChar("in_S0"));
  SET_STRING_ELT(state_names, 559, mkChar("dim_in_S1a"));
  SET_STRING_ELT(state_names, 560, mkChar("dim_in_S1a_1"));
  SET_STRING_ELT(state_names, 561, mkChar("dim_in_S1a_2"));
  SET_STRING_ELT(state_names, 562, mkChar("in_S1a"));
  SET_STRING_ELT(state_names, 563, mkChar("dim_in_S1b"));
  SET_STRING_ELT(state_names, 564, mkChar("dim_in_S1b_1"));
  SET_STRING_ELT(state_names, 565, mkChar("dim_in_S1b_2"));
  SET_STRING_ELT(state_names, 566, mkChar("in_S1b"));
  SET_STRING_ELT(state_names, 567, mkChar("dim_in_S1c"));
  SET_STRING_ELT(state_names, 568, mkChar("dim_in_S1c_1"));
  SET_STRING_ELT(state_names, 569, mkChar("dim_in_S1c_2"));
  SET_STRING_ELT(state_names, 570, mkChar("in_S1c"));
  SET_STRING_ELT(state_names, 571, mkChar("dim_in_S1d"));
  SET_STRING_ELT(state_names, 572, mkChar("dim_in_S1d_1"));
  SET_STRING_ELT(state_names, 573, mkChar("dim_in_S1d_2"));
  SET_STRING_ELT(state_names, 574, mkChar("in_S1d"));
  SET_STRING_ELT(state_names, 575, mkChar("dim_in_I01"));
  SET_STRING_ELT(state_names, 576, mkChar("dim_in_I01_1"));
  SET_STRING_ELT(state_names, 577, mkChar("dim_in_I01_2"));
  SET_STRING_ELT(state_names, 578, mkChar("in_I01"));
  SET_STRING_ELT(state_names, 579, mkChar("dim_in_I11"));
  SET_STRING_ELT(state_names, 580, mkChar("dim_in_I11_1"));
  SET_STRING_ELT(state_names, 581, mkChar("dim_in_I11_2"));
  SET_STRING_ELT(state_names, 582, mkChar("in_I11"));
  SET_STRING_ELT(state_names, 583, mkChar("dim_in_I02"));
  SET_STRING_ELT(state_names, 584, mkChar("dim_in_I02_1"));
  SET_STRING_ELT(state_names, 585, mkChar("dim_in_I02_2"));
  SET_STRING_ELT(state_names, 586, mkChar("in_I02"));
  SET_STRING_ELT(state_names, 587, mkChar("dim_in_I03"));
  SET_STRING_ELT(state_names, 588, mkChar("dim_in_I03_1"));
  SET_STRING_ELT(state_names, 589, mkChar("dim_in_I03_2"));
  SET_STRING_ELT(state_names, 590, mkChar("in_I03"));
  SET_STRING_ELT(state_names, 591, mkChar("dim_in_I04"));
  SET_STRING_ELT(state_names, 592, mkChar("dim_in_I04_1"));
  SET_STRING_ELT(state_names, 593, mkChar("dim_in_I04_2"));
  SET_STRING_ELT(state_names, 594, mkChar("in_I04"));
  SET_STRING_ELT(state_names, 595, mkChar("dim_in_I05"));
  SET_STRING_ELT(state_names, 596, mkChar("dim_in_I05_1"));
  SET_STRING_ELT(state_names, 597, mkChar("dim_in_I05_2"));
  SET_STRING_ELT(state_names, 598, mkChar("in_I05"));
  SET_STRING_ELT(state_names, 599, mkChar("dim_in_I22"));
  SET_STRING_ELT(state_names, 600, mkChar("dim_in_I22_1"));
  SET_STRING_ELT(state_names, 601, mkChar("dim_in_I22_2"));
  SET_STRING_ELT(state_names, 602, mkChar("in_I22"));
  SET_STRING_ELT(state_names, 603, mkChar("dim_in_I23"));
  SET_STRING_ELT(state_names, 604, mkChar("dim_in_I23_1"));
  SET_STRING_ELT(state_names, 605, mkChar("dim_in_I23_2"));
  SET_STRING_ELT(state_names, 606, mkChar("in_I23"));
  SET_STRING_ELT(state_names, 607, mkChar("dim_in_I24"));
  SET_STRING_ELT(state_names, 608, mkChar("dim_in_I24_1"));
  SET_STRING_ELT(state_names, 609, mkChar("dim_in_I24_2"));
  SET_STRING_ELT(state_names, 610, mkChar("in_I24"));
  SET_STRING_ELT(state_names, 611, mkChar("dim_in_I25"));
  SET_STRING_ELT(state_names, 612, mkChar("dim_in_I25_1"));
  SET_STRING_ELT(state_names, 613, mkChar("dim_in_I25_2"));
  SET_STRING_ELT(state_names, 614, mkChar("in_I25"));
  SET_STRING_ELT(state_names, 615, mkChar("dim_in_I32"));
  SET_STRING_ELT(state_names, 616, mkChar("dim_in_I32_1"));
  SET_STRING_ELT(state_names, 617, mkChar("dim_in_I32_2"));
  SET_STRING_ELT(state_names, 618, mkChar("in_I32"));
  SET_STRING_ELT(state_names, 619, mkChar("dim_in_I33"));
  SET_STRING_ELT(state_names, 620, mkChar("dim_in_I33_1"));
  SET_STRING_ELT(state_names, 621, mkChar("dim_in_I33_2"));
  SET_STRING_ELT(state_names, 622, mkChar("in_I33"));
  SET_STRING_ELT(state_names, 623, mkChar("dim_in_I34"));
  SET_STRING_ELT(state_names, 624, mkChar("dim_in_I34_1"));
  SET_STRING_ELT(state_names, 625, mkChar("dim_in_I34_2"));
  SET_STRING_ELT(state_names, 626, mkChar("in_I34"));
  SET_STRING_ELT(state_names, 627, mkChar("dim_in_I35"));
  SET_STRING_ELT(state_names, 628, mkChar("dim_in_I35_1"));
  SET_STRING_ELT(state_names, 629, mkChar("dim_in_I35_2"));
  SET_STRING_ELT(state_names, 630, mkChar("in_I35"));
  SET_STRING_ELT(state_names, 631, mkChar("dim_in_I42"));
  SET_STRING_ELT(state_names, 632, mkChar("dim_in_I42_1"));
  SET_STRING_ELT(state_names, 633, mkChar("dim_in_I42_2"));
  SET_STRING_ELT(state_names, 634, mkChar("in_I42"));
  SET_STRING_ELT(state_names, 635, mkChar("dim_in_I43"));
  SET_STRING_ELT(state_names, 636, mkChar("dim_in_I43_1"));
  SET_STRING_ELT(state_names, 637, mkChar("dim_in_I43_2"));
  SET_STRING_ELT(state_names, 638, mkChar("in_I43"));
  SET_STRING_ELT(state_names, 639, mkChar("dim_in_I44"));
  SET_STRING_ELT(state_names, 640, mkChar("dim_in_I44_1"));
  SET_STRING_ELT(state_names, 641, mkChar("dim_in_I44_2"));
  SET_STRING_ELT(state_names, 642, mkChar("in_I44"));
  SET_STRING_ELT(state_names, 643, mkChar("dim_in_I45"));
  SET_STRING_ELT(state_names, 644, mkChar("dim_in_I45_1"));
  SET_STRING_ELT(state_names, 645, mkChar("dim_in_I45_2"));
  SET_STRING_ELT(state_names, 646, mkChar("in_I45"));
  SET_STRING_ELT(state_names, 647, mkChar("dim_rate_move_in"));
  SET_STRING_ELT(state_names, 648, mkChar("dim_rate_move_in_1"));
  SET_STRING_ELT(state_names, 649, mkChar("dim_rate_move_in_2"));
  SET_STRING_ELT(state_names, 650, mkChar("rate_move_in"));
  SET_STRING_ELT(state_names, 651, mkChar("offset_output_rate_move_in"));
  SET_STRING_ELT(state_names, 652, mkChar("dim_rate_move_out"));
  SET_STRING_ELT(state_names, 653, mkChar("rate_move_out"));
  SET_STRING_ELT(state_names, 654, mkChar("offset_output_rate_move_out"));
  SET_STRING_ELT(state_names, 655, mkChar("interpolate_c_comm"));
  SET_STRING_ELT(state_names, 656, mkChar("interpolate_c_noncomm"));
  SET_STRING_ELT(state_names, 657, mkChar("interpolate_ART_eligible_CD4_above_500"));
  SET_STRING_ELT(state_names, 658, mkChar("ART_eligible_CD4_above_500"));
  SET_STRING_ELT(state_names, 659, mkChar("interpolate_ART_eligible_CD4_350_500"));
  SET_STRING_ELT(state_names, 660, mkChar("ART_eligible_CD4_350_500"));
  SET_STRING_ELT(state_names, 661, mkChar("interpolate_ART_eligible_CD4_200_349"));
  SET_STRING_ELT(state_names, 662, mkChar("ART_eligible_CD4_200_349"));
  SET_STRING_ELT(state_names, 663, mkChar("interpolate_ART_eligible_CD4_below_200"));
  SET_STRING_ELT(state_names, 664, mkChar("ART_eligible_CD4_below_200"));
  SET_STRING_ELT(state_names, 665, mkChar("interpolate_testing_prob"));
  SET_STRING_ELT(state_names, 666, mkChar("interpolate_tau_intervention"));
  SET_STRING_ELT(state_names, 667, mkChar("interpolate_rho_intervention"));
  SET_STRING_ELT(state_names, 668, mkChar("interpolate_infect_ART"));
  SET_STRING_ELT(state_names, 669, mkChar("interpolate_epsilon"));
  SET_STRING_ELT(state_names, 670, mkChar("epsilon"));
  SET_STRING_ELT(state_names, 671, mkChar("interpolate_prep_intervention"));
  SET_STRING_ELT(state_names, 672, mkChar("interpolate_fc_comm"));
  SET_STRING_ELT(state_names, 673, mkChar("interpolate_fP_comm"));
  SET_STRING_ELT(state_names, 674, mkChar("interpolate_fc_noncomm"));
  SET_STRING_ELT(state_names, 675, mkChar("interpolate_fP_noncomm"));
  SET_STRING_ELT(state_names, 676, mkChar("interpolate_n_comm"));
  SET_STRING_ELT(state_names, 677, mkChar("interpolate_n_noncomm"));
  SET_STRING_ELT(state_names, 678, mkChar("dim"));
  SET_STRING_ELT(state_names, 679, mkChar("dim_output"));
...
SEXP main_model_output_order(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  int *tmp;
  SEXP state_len = PROTECT(allocVector(VECSXP, 94));
  SEXP state_names = PROTECT(allocVector(STRSXP, 94));
  ...
  SET_VECTOR_ELT(state_len, 34, ScalarInteger(main_model_p->dim_tau_intervention));
  SET_STRING_ELT(state_names, 34, mkChar("tau_intervention"));
  SET_VECTOR_ELT(state_len, 35, ScalarInteger(main_model_p->dim_rho_intervention));
  SET_STRING_ELT(state_names, 35, mkChar("rho_intervention"));
  SET_VECTOR_ELT(state_len, 36, ScalarInteger(main_model_p->dim_zeta));
  SET_STRING_ELT(state_names, 36, mkChar("zeta"));
  SET_VECTOR_ELT(state_len, 37, ScalarInteger(main_model_p->dim_tau));
  SET_STRING_ELT(state_names, 37, mkChar("tau"));
  SET_VECTOR_ELT(state_len, 38, ScalarInteger(main_model_p->dim_rho));
  SET_STRING_ELT(state_names, 38, mkChar("rho"));
  SET_VECTOR_ELT(state_len, 39, ScalarInteger(main_model_p->dim_iota));
  SET_STRING_ELT(state_names, 39, mkChar("iota"));
  SET_VECTOR_ELT(state_len, 40, ScalarInteger(main_model_p->dim_frac_F));
  SET_STRING_ELT(state_names, 40, mkChar("frac_F"));
  SET_VECTOR_ELT(state_len, 41, ScalarInteger(main_model_p->dim_frac_N_sexualpop));
  SET_STRING_ELT(state_names, 41, mkChar("frac_N_sexualpop"));
  SET_VECTOR_ELT(state_len, 42, ScalarInteger(main_model_p->dim_infect_ART));
  SET_STRING_ELT(state_names, 42, mkChar("infect_ART"));
  SET_VECTOR_ELT(state_len, 43, ScalarInteger(main_model_p->dim_omega));
  SET_STRING_ELT(state_names, 43, mkChar("omega"));
  SET_VECTOR_ELT(state_len, 44, ScalarInteger(main_model_p->dim_frac_N));
  SET_STRING_ELT(state_names, 44, mkChar("frac_N"));
  SET_VECTOR_ELT(state_len, 45, ScalarInteger(main_model_p->dim_mu));
  SET_STRING_ELT(state_names, 45, mkChar("mu"));
  SET_VECTOR_ELT(state_len, 46, ScalarInteger(main_model_p->dim_gamma01));
  SET_STRING_ELT(state_names, 46, mkChar("gamma01"));
  SET_VECTOR_ELT(state_len, 47, ScalarInteger(main_model_p->dim_gamma11));
  SET_STRING_ELT(state_names, 47, mkChar("gamma11"));
  SET_VECTOR_ELT(state_len, 48, ScalarInteger(main_model_p->dim_kappaa));
  SET_STRING_ELT(state_names, 48, mkChar("kappaa"));
  SET_VECTOR_ELT(state_len, 49, ScalarInteger(main_model_p->dim_kappab));
  SET_STRING_ELT(state_names, 49, mkChar("kappab"));
  SET_VECTOR_ELT(state_len, 50, ScalarInteger(main_model_p->dim_kappac));
  SET_STRING_ELT(state_names, 50, mkChar("kappac"));
  SET_VECTOR_ELT(state_len, 51, ScalarInteger(main_model_p->dim_kappa1));
  SET_STRING_ELT(state_names, 51, mkChar("kappa1"));
  SET_VECTOR_ELT(state_len, 52, ScalarInteger(main_model_p->dim_alpha01));
  SET_STRING_ELT(state_names, 52, mkChar("alpha01"));
  SET_VECTOR_ELT(state_len, 53, ScalarInteger(main_model_p->dim_alpha02));
  SET_STRING_ELT(state_names, 53, mkChar("alpha02"));
  SET_VECTOR_ELT(state_len, 54, ScalarInteger(main_model_p->dim_alpha05));
  SET_STRING_ELT(state_names, 54, mkChar("alpha05"));
  SET_VECTOR_ELT(state_len, 55, ScalarInteger(main_model_p->dim_alpha11));
  SET_STRING_ELT(state_names, 55, mkChar("alpha11"));
  SET_VECTOR_ELT(state_len, 56, ScalarInteger(main_model_p->dim_alpha22));
  SET_STRING_ELT(state_names, 56, mkChar("alpha22"));
  SET_VECTOR_ELT(state_len, 57, ScalarInteger(main_model_p->dim_alpha35));
  SET_STRING_ELT(state_names, 57, mkChar("alpha35"));
  SET_VECTOR_ELT(state_len, 58, ScalarInteger(main_model_p->dim_beta_comm));
  SET_STRING_ELT(state_names, 58, mkChar("beta_comm"));
  SET_VECTOR_ELT(state_len, 59, ScalarInteger(main_model_p->dim_beta_noncomm));
  SET_STRING_ELT(state_names, 59, mkChar("beta_noncomm"));
  ...
  SET_STRING_ELT(state_names, 60, mkChar("p_comm"));
  ...
  SET_STRING_ELT(state_names, 61, mkChar("p_noncomm"));
  ...
  SET_STRING_ELT(state_names, 62, mkChar("fc_comm"));
  SET_VECTOR_ELT(state_len, 63, ScalarInteger(main_model_p->dim_fP_comm));
  SET_STRING_ELT(state_names, 63, mkChar("fP_comm"));
  ...
  SET_STRING_ELT(state_names, 64, mkChar("fc_noncomm"));
  SET_VECTOR_ELT(state_len, 65, ScalarInteger(main_model_p->dim_fP_noncomm));
  SET_STRING_ELT(state_names, 65, mkChar("fP_noncomm"));
  ...
  SET_STRING_ELT(state_names, 66, mkChar("n_comm"));
  ...
  SET_STRING_ELT(state_names, 67, mkChar("n_noncomm"));
  SET_VECTOR_ELT(state_len, 68, ScalarInteger(main_model_p->dim_N));
  SET_STRING_ELT(state_names, 68, mkChar("N"));
  SET_VECTOR_ELT(state_len, 69, ScalarInteger(main_model_p->dim_E0));
  SET_STRING_ELT(state_names, 69, mkChar("E0"));
  SET_VECTOR_ELT(state_len, 70, ScalarInteger(main_model_p->dim_E1a));
  SET_STRING_ELT(state_names, 70, mkChar("E1a"));
  SET_VECTOR_ELT(state_len, 71, ScalarInteger(main_model_p->dim_E1b));
  SET_STRING_ELT(state_names, 71, mkChar("E1b"));
  SET_VECTOR_ELT(state_len, 72, ScalarInteger(main_model_p->dim_E1c));
  SET_STRING_ELT(state_names, 72, mkChar("E1c"));
  SET_VECTOR_ELT(state_len, 73, ScalarInteger(main_model_p->dim_E1d));
  SET_STRING_ELT(state_names, 73, mkChar("E1d"));
  SET_VECTOR_ELT(state_len, 74, ScalarInteger(main_model_p->dim_alphaItot));
  SET_STRING_ELT(state_names, 74, mkChar("alphaItot"));
  SET_VECTOR_ELT(state_len, 75, ScalarInteger(main_model_p->dim_prev));
  SET_STRING_ELT(state_names, 75, mkChar("prev"));
  ...
  SET_STRING_ELT(state_names, 76, mkChar("lambda"));
  ...
  SET_STRING_ELT(state_names, 77, mkChar("lambda_0"));
  ...
  SET_STRING_ELT(state_names, 78, mkChar("lambda_1a"));
  ...
  SET_STRING_ELT(state_names, 79, mkChar("lambda_1b"));
  ...
  SET_STRING_ELT(state_names, 80, mkChar("lambda_1c"));
  ...
  SET_STRING_ELT(state_names, 81, mkChar("lambda_1d"));
  SET_VECTOR_ELT(state_len, 82, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_STRING_ELT(state_names, 82, mkChar("lambda_sum_0"));
  SET_VECTOR_ELT(state_len, 83, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_STRING_ELT(state_names, 83, mkChar("lambda_sum_1a"));
  SET_VECTOR_ELT(state_len, 84, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_STRING_ELT(state_names, 84, mkChar("lambda_sum_1b"));
  SET_VECTOR_ELT(state_len, 85, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_STRING_ELT(state_names, 85, mkChar("lambda_sum_1c"));
  SET_VECTOR_ELT(state_len, 86, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_STRING_ELT(state_names, 86, mkChar("lambda_sum_1d"));
  SET_VECTOR_ELT(state_len, 87, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_STRING_ELT(state_names, 87, mkChar("c_comm_balanced"));
  SET_VECTOR_ELT(state_len, 88, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_STRING_ELT(state_names, 88, mkChar("c_noncomm_balanced"));
  ...
  SET_STRING_ELT(state_names, 89, mkChar("theta"));
  ...
  SET_STRING_ELT(state_names, 90, mkChar("M_comm"));
  ...
  SET_STRING_ELT(state_names, 91, mkChar("M_noncomm"));
  ...
  SET_STRING_ELT(state_names, 92, mkChar("rate_move_in"));
  SET_VECTOR_ELT(state_len, 93, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_STRING_ELT(state_names, 93, mkChar("rate_move_out"));
  setAttrib(state_len, R_NamesSymbol, state_names);
  UNPROTECT(2);
  return state_len;
}
