...
SEXP main_model_set_user(main_model_pars *main_model_p, SEXP user) {
  ...
  main_model_p->offset_output_infect_ART_y = 66;
  ...
  main_model_p->offset_output_infect_ART_t = 66 + main_model_p->dim_infect_ART_y;
...
void main_model_deriv(main_model_pars *main_model_p, double t, double *state, double *dstatedt, double *output) {
  ...
  if (output != NULL) {
    double *output_infect_ART_y = output + 66;
    ...
    output[1] = main_model_p->ART_eligible_CD4_above_500;
    output[2] = main_model_p->ART_eligible_CD4_350_500;
    output[3] = main_model_p->ART_eligible_CD4_200_349;
    output[4] = main_model_p->ART_eligible_CD4_below_200;
    ...
    output[5] = main_model_p->TasP_testing;
    ...
    output[6] = main_model_p->PrEPOnOff;
    output[7] = main_model_p->fPa;
    output[8] = main_model_p->fPb;
    output[9] = main_model_p->fPc;
    ...
    output[10] = main_model_p->W0;
    output[11] = main_model_p->W1;
    output[12] = main_model_p->W2;
    output[13] = main_model_p->W3;
    output[14] = main_model_p->cost_Initiation_of_ART_study_FSW;
    output[15] = main_model_p->cost_Initiation_of_ART_government_FSW;
    output[16] = main_model_p->cost_1_year_of_ART_study_FSW;
    output[17] = main_model_p->cost_1_year_of_ART_government_FSW;
    output[18] = main_model_p->cost_Initiation_ART_rest_of_population;
    output[19] = main_model_p->cost_1_year_of_ART_rest_of_population;
    output[20] = main_model_p->cost_FSW_initiation_ART_Patient_costs;
    output[21] = main_model_p->cost_FSW_1_year_ART_Patient_costs;
    output[22] = main_model_p->cost_Initiation_of_PrEP_study;
    output[23] = main_model_p->cost_1_year_PrEP_perfect_adherence_study;
    output[24] = main_model_p->cost_1_year_PrEP_intermediate_adherence_study;
    output[25] = main_model_p->cost_1_year_PrEP_non_adherence_study;
    output[26] = main_model_p->cost_Initiation_of_PrEP_government;
    output[27] = main_model_p->cost_1_year_PrEP_perfect_adherence_government;
    output[28] = main_model_p->cost_1_year_PrEP_intermediate_adherence_government;
    output[29] = main_model_p->cost_1_year_PrEP_non_adherence_government;
    output[30] = main_model_p->cost_PREP_initiation_Patient_costs;
    output[31] = main_model_p->cost_PREP_1_year_ART_Patient_costs;
    double cumuInftot = odin_sum1(cumuInf, 0, main_model_p->dim_cumuInf - 1);
    output[32] = cumuInftot;
    ...
    output[37] = pc_susceptible_FSW_On_PrEP;
    output[38] = pc_all_FSW_On_PrEP;
    double FSW_On_PrEP_all_cats = S1a[0] + S1b[0] + S1c[0];
    output[39] = FSW_On_PrEP_all_cats;
    output[40] = Men_on_ART;
    output[41] = Women_on_ART;
    output[42] = ART_coverage_men;
    output[43] = ART_coverage_women;
    output[44] = ART_coverage_FSW;
    output[45] = ART_coverage_all;
    output[46] = main_model_p->Ncat;
    ...
    output[47] = main_model_p->nu;
    output[48] = main_model_p->Nage;
    output[49] = main_model_p->dur_FSW;
    memcpy(output_infect_ART, main_model_p->infect_ART, main_model_p->dim_infect_ART * sizeof(double));
    output[50] = main_model_p->epsilon;
    ...
    output[51] = Ntot_inc_former_FSW_nonCot;
    double new_people = main_model_p->epsilon * Ntot;
    output[52] = new_people;
    ...
    output[55] = prev_men;
    output[56] = prev_women;
    output[57] = prev_cotonou;
    output[58] = Ntot;
    memcpy(output_N, main_model_p->N, main_model_p->dim_N * sizeof(double));
    output[59] = prev_FSW;
    output[60] = prev_client;
    ...
    output[63] = pc_of_FOI_on_clients_from_pro_FSW;
...
SEXP main_model_contents(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  SEXP state = PROTECT(allocVector(VECSXP, 864));
  ...
  SET_VECTOR_ELT(state, 2, ScalarInteger(main_model_p->dim_pfFSW_t));
  SET_VECTOR_ELT(state, 3, allocVector(REALSXP, main_model_p->dim_pfFSW_t));
  memcpy(REAL(VECTOR_ELT(state, 3)), main_model_p->pfFSW_t, main_model_p->dim_pfFSW_t * sizeof(double));
  SET_VECTOR_ELT(state, 4, ScalarInteger(main_model_p->dim_pfFSW_y));
  SET_VECTOR_ELT(state, 5, ScalarInteger(main_model_p->dim_pfFSW_y_1));
  SET_VECTOR_ELT(state, 6, ScalarInteger(main_model_p->dim_pfFSW_y_2));
  SET_VECTOR_ELT(state, 7, allocVector(REALSXP, main_model_p->dim_pfFSW_y));
  memcpy(REAL(VECTOR_ELT(state, 7)), main_model_p->pfFSW_y, main_model_p->dim_pfFSW_y * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 7), 2, main_model_p->dim_pfFSW_y_1, main_model_p->dim_pfFSW_y_2);
  SET_VECTOR_ELT(state, 8, ScalarReal(main_model_p->infected_FSW_incoming));
  SET_VECTOR_ELT(state, 9, ScalarReal(main_model_p->rate_leave_pro_FSW));
  SET_VECTOR_ELT(state, 10, ScalarReal(main_model_p->fraction_FSW_foreign));
  SET_VECTOR_ELT(state, 11, ScalarInteger(main_model_p->dim_c_t_comm));
  SET_VECTOR_ELT(state, 12, allocVector(REALSXP, main_model_p->dim_c_t_comm));
  memcpy(REAL(VECTOR_ELT(state, 12)), main_model_p->c_t_comm, main_model_p->dim_c_t_comm * sizeof(double));
  SET_VECTOR_ELT(state, 13, ScalarInteger(main_model_p->dim_c_t_noncomm));
  SET_VECTOR_ELT(state, 14, allocVector(REALSXP, main_model_p->dim_c_t_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 14)), main_model_p->c_t_noncomm, main_model_p->dim_c_t_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 15, ScalarInteger(main_model_p->dim_c_y_comm));
  SET_VECTOR_ELT(state, 16, ScalarInteger(main_model_p->dim_c_y_comm_1));
  SET_VECTOR_ELT(state, 17, ScalarInteger(main_model_p->dim_c_y_comm_2));
  SET_VECTOR_ELT(state, 18, allocVector(REALSXP, main_model_p->dim_c_y_comm));
  memcpy(REAL(VECTOR_ELT(state, 18)), main_model_p->c_y_comm, main_model_p->dim_c_y_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 18), 2, main_model_p->dim_c_y_comm_1, main_model_p->dim_c_y_comm_2);
  SET_VECTOR_ELT(state, 19, ScalarInteger(main_model_p->dim_c_y_noncomm));
  SET_VECTOR_ELT(state, 20, ScalarInteger(main_model_p->dim_c_y_noncomm_1));
  SET_VECTOR_ELT(state, 21, ScalarInteger(main_model_p->dim_c_y_noncomm_2));
  SET_VECTOR_ELT(state, 22, allocVector(REALSXP, main_model_p->dim_c_y_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 22)), main_model_p->c_y_noncomm, main_model_p->dim_c_y_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 22), 2, main_model_p->dim_c_y_noncomm_1, main_model_p->dim_c_y_noncomm_2);
  SET_VECTOR_ELT(state, 23, ScalarReal(main_model_p->who_believe_comm));
  SET_VECTOR_ELT(state, 24, ScalarInteger(main_model_p->dim_ART_eligible_CD4_above_500_t));
  SET_VECTOR_ELT(state, 25, allocVector(REALSXP, main_model_p->dim_ART_eligible_CD4_above_500_t));
  memcpy(REAL(VECTOR_ELT(state, 25)), main_model_p->ART_eligible_CD4_above_500_t, main_model_p->dim_ART_eligible_CD4_above_500_t * sizeof(double));
  SET_VECTOR_ELT(state, 26, ScalarInteger(main_model_p->dim_ART_eligible_CD4_350_500_t));
  SET_VECTOR_ELT(state, 27, allocVector(REALSXP, main_model_p->dim_ART_eligible_CD4_350_500_t));
  memcpy(REAL(VECTOR_ELT(state, 27)), main_model_p->ART_eligible_CD4_350_500_t, main_model_p->dim_ART_eligible_CD4_350_500_t * sizeof(double));
  SET_VECTOR_ELT(state, 28, ScalarInteger(main_model_p->dim_ART_eligible_CD4_200_349_t));
  SET_VECTOR_ELT(state, 29, allocVector(REALSXP, main_model_p->dim_ART_eligible_CD4_200_349_t));
  memcpy(REAL(VECTOR_ELT(state, 29)), main_model_p->ART_eligible_CD4_200_349_t, main_model_p->dim_ART_eligible_CD4_200_349_t * sizeof(double));
  SET_VECTOR_ELT(state, 30, ScalarInteger(main_model_p->dim_ART_eligible_CD4_below_200_t));
  SET_VECTOR_ELT(state, 31, allocVector(REALSXP, main_model_p->dim_ART_eligible_CD4_below_200_t));
  memcpy(REAL(VECTOR_ELT(state, 31)), main_model_p->ART_eligible_CD4_below_200_t, main_model_p->dim_ART_eligible_CD4_below_200_t * sizeof(double));
  SET_VECTOR_ELT(state, 32, ScalarInteger(main_model_p->dim_ART_eligible_CD4_above_500_y));
  SET_VECTOR_ELT(state, 33, allocVector(REALSXP, main_model_p->dim_ART_eligible_CD4_above_500_y));
  memcpy(REAL(VECTOR_ELT(state, 33)), main_model_p->ART_eligible_CD4_above_500_y, main_model_p->dim_ART_eligible_CD4_above_500_y * sizeof(double));
  SET_VECTOR_ELT(state, 34, ScalarInteger(main_model_p->dim_ART_eligible_CD4_350_500_y));
  SET_VECTOR_ELT(state, 35, allocVector(REALSXP, main_model_p->dim_ART_eligible_CD4_350_500_y));
  memcpy(REAL(VECTOR_ELT(state, 35)), main_model_p->ART_eligible_CD4_350_500_y, main_model_p->dim_ART_eligible_CD4_350_500_y * sizeof(double));
  SET_VECTOR_ELT(state, 36, ScalarInteger(main_model_p->dim_ART_eligible_CD4_200_349_y));
  SET_VECTOR_ELT(state, 37, allocVector(REALSXP, main_model_p->dim_ART_eligible_CD4_200_349_y));
  memcpy(REAL(VECTOR_ELT(state, 37)), main_model_p->ART_eligible_CD4_200_349_y, main_model_p->dim_ART_eligible_CD4_200_349_y * sizeof(double));
  SET_VECTOR_ELT(state, 38, ScalarInteger(main_model_p->dim_ART_eligible_CD4_below_200_y));
  SET_VECTOR_ELT(state, 39, allocVector(REALSXP, main_model_p->dim_ART_eligible_CD4_below_200_y));
  memcpy(REAL(VECTOR_ELT(state, 39)), main_model_p->ART_eligible_CD4_below_200_y, main_model_p->dim_ART_eligible_CD4_below_200_y * sizeof(double));
  SET_VECTOR_ELT(state, 40, ScalarInteger(main_model_p->dim_infect_ART_y));
  SET_VECTOR_ELT(state, 41, ScalarInteger(main_model_p->dim_infect_ART_y_1));
  SET_VECTOR_ELT(state, 42, ScalarInteger(main_model_p->dim_infect_ART_y_2));
  SET_VECTOR_ELT(state, 43, allocVector(REALSXP, main_model_p->dim_infect_ART_y));
  memcpy(REAL(VECTOR_ELT(state, 43)), main_model_p->infect_ART_y, main_model_p->dim_infect_ART_y * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 43), 2, main_model_p->dim_infect_ART_y_1, main_model_p->dim_infect_ART_y_2);
  SET_VECTOR_ELT(state, 44, ScalarInteger(main_model_p->offset_output_infect_ART_y));
  SET_VECTOR_ELT(state, 45, ScalarInteger(main_model_p->dim_infect_ART_t));
  SET_VECTOR_ELT(state, 46, allocVector(REALSXP, main_model_p->dim_infect_ART_t));
  memcpy(REAL(VECTOR_ELT(state, 46)), main_model_p->infect_ART_t, main_model_p->dim_infect_ART_t * sizeof(double));
  SET_VECTOR_ELT(state, 47, ScalarInteger(main_model_p->offset_output_infect_ART_t));
  SET_VECTOR_ELT(state, 48, ScalarInteger(main_model_p->dim_testing_prob_t));
  SET_VECTOR_ELT(state, 49, allocVector(REALSXP, main_model_p->dim_testing_prob_t));
  memcpy(REAL(VECTOR_ELT(state, 49)), main_model_p->testing_prob_t, main_model_p->dim_testing_prob_t * sizeof(double));
  SET_VECTOR_ELT(state, 50, ScalarInteger(main_model_p->dim_testing_prob_y));
  SET_VECTOR_ELT(state, 51, ScalarInteger(main_model_p->dim_testing_prob_y_1));
  SET_VECTOR_ELT(state, 52, ScalarInteger(main_model_p->dim_testing_prob_y_2));
  SET_VECTOR_ELT(state, 53, allocVector(REALSXP, main_model_p->dim_testing_prob_y));
  memcpy(REAL(VECTOR_ELT(state, 53)), main_model_p->testing_prob_y, main_model_p->dim_testing_prob_y * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 53), 2, main_model_p->dim_testing_prob_y_1, main_model_p->dim_testing_prob_y_2);
  SET_VECTOR_ELT(state, 54, ScalarReal(main_model_p->TasP_testing));
  SET_VECTOR_ELT(state, 55, ScalarInteger(main_model_p->dim_tau_intervention_t));
  SET_VECTOR_ELT(state, 56, allocVector(REALSXP, main_model_p->dim_tau_intervention_t));
  memcpy(REAL(VECTOR_ELT(state, 56)), main_model_p->tau_intervention_t, main_model_p->dim_tau_intervention_t * sizeof(double));
  SET_VECTOR_ELT(state, 57, ScalarInteger(main_model_p->dim_tau_intervention_y));
  SET_VECTOR_ELT(state, 58, ScalarInteger(main_model_p->dim_tau_intervention_y_1));
  SET_VECTOR_ELT(state, 59, ScalarInteger(main_model_p->dim_tau_intervention_y_2));
  SET_VECTOR_ELT(state, 60, allocVector(REALSXP, main_model_p->dim_tau_intervention_y));
  memcpy(REAL(VECTOR_ELT(state, 60)), main_model_p->tau_intervention_y, main_model_p->dim_tau_intervention_y * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 60), 2, main_model_p->dim_tau_intervention_y_1, main_model_p->dim_tau_intervention_y_2);
  SET_VECTOR_ELT(state, 61, ScalarInteger(main_model_p->dim_rho_intervention_t));
  SET_VECTOR_ELT(state, 62, allocVector(REALSXP, main_model_p->dim_rho_intervention_t));
  memcpy(REAL(VECTOR_ELT(state, 62)), main_model_p->rho_intervention_t, main_model_p->dim_rho_intervention_t * sizeof(double));
  SET_VECTOR_ELT(state, 63, ScalarInteger(main_model_p->dim_rho_intervention_y));
  SET_VECTOR_ELT(state, 64, ScalarInteger(main_model_p->dim_rho_intervention_y_1));
  SET_VECTOR_ELT(state, 65, ScalarInteger(main_model_p->dim_rho_intervention_y_2));
  SET_VECTOR_ELT(state, 66, allocVector(REALSXP, main_model_p->dim_rho_intervention_y));
  memcpy(REAL(VECTOR_ELT(state, 66)), main_model_p->rho_intervention_y, main_model_p->dim_rho_intervention_y * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 66), 2, main_model_p->dim_rho_intervention_y_1, main_model_p->dim_rho_intervention_y_2);
  SET_VECTOR_ELT(state, 67, ScalarReal(main_model_p->PrEPOnOff));
  SET_VECTOR_ELT(state, 68, ScalarReal(main_model_p->fPa));
  SET_VECTOR_ELT(state, 69, ScalarReal(main_model_p->fPb));
  SET_VECTOR_ELT(state, 70, ScalarReal(main_model_p->fPc));
  SET_VECTOR_ELT(state, 71, ScalarReal(main_model_p->RR_test_CD4200));
  SET_VECTOR_ELT(state, 72, ScalarInteger(main_model_p->dim_viral_supp_y));
  SET_VECTOR_ELT(state, 73, ScalarInteger(main_model_p->dim_viral_supp_y_1));
  SET_VECTOR_ELT(state, 74, ScalarInteger(main_model_p->dim_viral_supp_y_2));
  SET_VECTOR_ELT(state, 75, allocVector(REALSXP, main_model_p->dim_viral_supp_y));
  memcpy(REAL(VECTOR_ELT(state, 75)), main_model_p->viral_supp_y, main_model_p->dim_viral_supp_y * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 75), 2, main_model_p->dim_viral_supp_y_1, main_model_p->dim_viral_supp_y_2);
  SET_VECTOR_ELT(state, 76, ScalarInteger(main_model_p->offset_output_viral_supp_y));
  SET_VECTOR_ELT(state, 77, ScalarInteger(main_model_p->dim_viral_supp_t));
  SET_VECTOR_ELT(state, 78, allocVector(REALSXP, main_model_p->dim_viral_supp_t));
  memcpy(REAL(VECTOR_ELT(state, 78)), main_model_p->viral_supp_t, main_model_p->dim_viral_supp_t * sizeof(double));
  SET_VECTOR_ELT(state, 79, ScalarInteger(main_model_p->offset_output_viral_supp_t));
  SET_VECTOR_ELT(state, 80, ScalarReal(main_model_p->W0));
  SET_VECTOR_ELT(state, 81, ScalarReal(main_model_p->W1));
  SET_VECTOR_ELT(state, 82, ScalarReal(main_model_p->W2));
  SET_VECTOR_ELT(state, 83, ScalarReal(main_model_p->W3));
  SET_VECTOR_ELT(state, 84, ScalarReal(main_model_p->cost_Initiation_of_ART_study_FSW));
  SET_VECTOR_ELT(state, 85, ScalarReal(main_model_p->cost_Initiation_of_ART_government_FSW));
  SET_VECTOR_ELT(state, 86, ScalarReal(main_model_p->cost_1_year_of_ART_study_FSW));
  SET_VECTOR_ELT(state, 87, ScalarReal(main_model_p->cost_1_year_of_ART_government_FSW));
  SET_VECTOR_ELT(state, 88, ScalarReal(main_model_p->cost_Initiation_ART_rest_of_population));
  SET_VECTOR_ELT(state, 89, ScalarReal(main_model_p->cost_1_year_of_ART_rest_of_population));
  SET_VECTOR_ELT(state, 90, ScalarReal(main_model_p->cost_FSW_initiation_ART_Patient_costs));
  SET_VECTOR_ELT(state, 91, ScalarReal(main_model_p->cost_FSW_1_year_ART_Patient_costs));
  SET_VECTOR_ELT(state, 92, ScalarReal(main_model_p->cost_Initiation_of_PrEP_study));
  SET_VECTOR_ELT(state, 93, ScalarReal(main_model_p->cost_1_year_PrEP_perfect_adherence_study));
  SET_VECTOR_ELT(state, 94, ScalarReal(main_model_p->cost_1_year_PrEP_intermediate_adherence_study));
  SET_VECTOR_ELT(state, 95, ScalarReal(main_model_p->cost_1_year_PrEP_non_adherence_study));
  SET_VECTOR_ELT(state, 96, ScalarReal(main_model_p->cost_Initiation_of_PrEP_government));
  SET_VECTOR_ELT(state, 97, ScalarReal(main_model_p->cost_1_year_PrEP_perfect_adherence_government));
  SET_VECTOR_ELT(state, 98, ScalarReal(main_model_p->cost_1_year_PrEP_intermediate_adherence_government));
  SET_VECTOR_ELT(state, 99, ScalarReal(main_model_p->cost_1_year_PrEP_non_adherence_government));
  SET_VECTOR_ELT(state, 100, ScalarReal(main_model_p->cost_PREP_initiation_Patient_costs));
  SET_VECTOR_ELT(state, 101, ScalarReal(main_model_p->cost_PREP_1_year_ART_Patient_costs));
  SET_VECTOR_ELT(state, 102, ScalarInteger(main_model_p->Ncat));
  SET_VECTOR_ELT(state, 103, ScalarReal(main_model_p->Nage));
  SET_VECTOR_ELT(state, 104, ScalarReal(main_model_p->infect_acute));
  SET_VECTOR_ELT(state, 105, ScalarReal(main_model_p->infect_AIDS));
  SET_VECTOR_ELT(state, 106, ScalarReal(main_model_p->nu));
  SET_VECTOR_ELT(state, 107, ScalarReal(main_model_p->R));
  SET_VECTOR_ELT(state, 108, ScalarInteger(main_model_p->dim_epsilon_t));
  SET_VECTOR_ELT(state, 109, allocVector(REALSXP, main_model_p->dim_epsilon_t));
  memcpy(REAL(VECTOR_ELT(state, 109)), main_model_p->epsilon_t, main_model_p->dim_epsilon_t * sizeof(double));
  SET_VECTOR_ELT(state, 110, ScalarInteger(main_model_p->dim_epsilon_y));
  SET_VECTOR_ELT(state, 111, allocVector(REALSXP, main_model_p->dim_epsilon_y));
  memcpy(REAL(VECTOR_ELT(state, 111)), main_model_p->epsilon_y, main_model_p->dim_epsilon_y * sizeof(double));
  SET_VECTOR_ELT(state, 112, ScalarInteger(main_model_p->dim_fc_t_comm));
  SET_VECTOR_ELT(state, 113, allocVector(REALSXP, main_model_p->dim_fc_t_comm));
  memcpy(REAL(VECTOR_ELT(state, 113)), main_model_p->fc_t_comm, main_model_p->dim_fc_t_comm * sizeof(double));
  SET_VECTOR_ELT(state, 114, ScalarInteger(main_model_p->dim_fc_y_comm));
  SET_VECTOR_ELT(state, 115, ScalarInteger(main_model_p->dim_fc_y_comm_1));
  SET_VECTOR_ELT(state, 116, ScalarInteger(main_model_p->dim_fc_y_comm_2));
  SET_VECTOR_ELT(state, 117, ScalarInteger(main_model_p->dim_fc_y_comm_3));
  SET_VECTOR_ELT(state, 118, ScalarInteger(main_model_p->dim_fc_y_comm_12));
  SET_VECTOR_ELT(state, 119, allocVector(REALSXP, main_model_p->dim_fc_y_comm));
  memcpy(REAL(VECTOR_ELT(state, 119)), main_model_p->fc_y_comm, main_model_p->dim_fc_y_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 119), 3, main_model_p->dim_fc_y_comm_1, main_model_p->dim_fc_y_comm_2, main_model_p->dim_fc_y_comm_3);
  SET_VECTOR_ELT(state, 120, ScalarInteger(main_model_p->dim_fP_t_comm));
  SET_VECTOR_ELT(state, 121, allocVector(REALSXP, main_model_p->dim_fP_t_comm));
  memcpy(REAL(VECTOR_ELT(state, 121)), main_model_p->fP_t_comm, main_model_p->dim_fP_t_comm * sizeof(double));
  SET_VECTOR_ELT(state, 122, ScalarInteger(main_model_p->dim_fP_y_comm));
  SET_VECTOR_ELT(state, 123, ScalarInteger(main_model_p->dim_fP_y_comm_1));
  SET_VECTOR_ELT(state, 124, ScalarInteger(main_model_p->dim_fP_y_comm_2));
  SET_VECTOR_ELT(state, 125, allocVector(REALSXP, main_model_p->dim_fP_y_comm));
  memcpy(REAL(VECTOR_ELT(state, 125)), main_model_p->fP_y_comm, main_model_p->dim_fP_y_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 125), 2, main_model_p->dim_fP_y_comm_1, main_model_p->dim_fP_y_comm_2);
  SET_VECTOR_ELT(state, 126, ScalarInteger(main_model_p->dim_fc_t_noncomm));
  SET_VECTOR_ELT(state, 127, allocVector(REALSXP, main_model_p->dim_fc_t_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 127)), main_model_p->fc_t_noncomm, main_model_p->dim_fc_t_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 128, ScalarInteger(main_model_p->dim_fc_y_noncomm));
  SET_VECTOR_ELT(state, 129, ScalarInteger(main_model_p->dim_fc_y_noncomm_1));
  SET_VECTOR_ELT(state, 130, ScalarInteger(main_model_p->dim_fc_y_noncomm_2));
  SET_VECTOR_ELT(state, 131, ScalarInteger(main_model_p->dim_fc_y_noncomm_3));
  SET_VECTOR_ELT(state, 132, ScalarInteger(main_model_p->dim_fc_y_noncomm_12));
  SET_VECTOR_ELT(state, 133, allocVector(REALSXP, main_model_p->dim_fc_y_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 133)), main_model_p->fc_y_noncomm, main_model_p->dim_fc_y_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 133), 3, main_model_p->dim_fc_y_noncomm_1, main_model_p->dim_fc_y_noncomm_2, main_model_p->dim_fc_y_noncomm_3);
  SET_VECTOR_ELT(state, 134, ScalarInteger(main_model_p->dim_fP_t_noncomm));
  SET_VECTOR_ELT(state, 135, allocVector(REALSXP, main_model_p->dim_fP_t_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 135)), main_model_p->fP_t_noncomm, main_model_p->dim_fP_t_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 136, ScalarInteger(main_model_p->dim_fP_y_noncomm));
  SET_VECTOR_ELT(state, 137, ScalarInteger(main_model_p->dim_fP_y_noncomm_1));
  SET_VECTOR_ELT(state, 138, ScalarInteger(main_model_p->dim_fP_y_noncomm_2));
  SET_VECTOR_ELT(state, 139, allocVector(REALSXP, main_model_p->dim_fP_y_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 139)), main_model_p->fP_y_noncomm, main_model_p->dim_fP_y_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 139), 2, main_model_p->dim_fP_y_noncomm_1, main_model_p->dim_fP_y_noncomm_2);
  SET_VECTOR_ELT(state, 140, ScalarInteger(main_model_p->dim_n_t_comm));
  SET_VECTOR_ELT(state, 141, allocVector(REALSXP, main_model_p->dim_n_t_comm));
  memcpy(REAL(VECTOR_ELT(state, 141)), main_model_p->n_t_comm, main_model_p->dim_n_t_comm * sizeof(double));
  SET_VECTOR_ELT(state, 142, ScalarInteger(main_model_p->dim_n_y_comm));
  SET_VECTOR_ELT(state, 143, ScalarInteger(main_model_p->dim_n_y_comm_1));
  SET_VECTOR_ELT(state, 144, ScalarInteger(main_model_p->dim_n_y_comm_2));
  SET_VECTOR_ELT(state, 145, ScalarInteger(main_model_p->dim_n_y_comm_3));
  SET_VECTOR_ELT(state, 146, ScalarInteger(main_model_p->dim_n_y_comm_12));
  SET_VECTOR_ELT(state, 147, allocVector(REALSXP, main_model_p->dim_n_y_comm));
  memcpy(REAL(VECTOR_ELT(state, 147)), main_model_p->n_y_comm, main_model_p->dim_n_y_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 147), 3, main_model_p->dim_n_y_comm_1, main_model_p->dim_n_y_comm_2, main_model_p->dim_n_y_comm_3);
  SET_VECTOR_ELT(state, 148, ScalarInteger(main_model_p->dim_n_t_noncomm));
  SET_VECTOR_ELT(state, 149, allocVector(REALSXP, main_model_p->dim_n_t_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 149)), main_model_p->n_t_noncomm, main_model_p->dim_n_t_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 150, ScalarInteger(main_model_p->dim_n_y_noncomm));
  SET_VECTOR_ELT(state, 151, ScalarInteger(main_model_p->dim_n_y_noncomm_1));
  SET_VECTOR_ELT(state, 152, ScalarInteger(main_model_p->dim_n_y_noncomm_2));
  SET_VECTOR_ELT(state, 153, ScalarInteger(main_model_p->dim_n_y_noncomm_3));
  SET_VECTOR_ELT(state, 154, ScalarInteger(main_model_p->dim_n_y_noncomm_12));
  SET_VECTOR_ELT(state, 155, allocVector(REALSXP, main_model_p->dim_n_y_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 155)), main_model_p->n_y_noncomm, main_model_p->dim_n_y_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 155), 3, main_model_p->dim_n_y_noncomm_1, main_model_p->dim_n_y_noncomm_2, main_model_p->dim_n_y_noncomm_3);
  SET_VECTOR_ELT(state, 156, ScalarReal(main_model_p->dur_FSW));
  SET_VECTOR_ELT(state, 157, ScalarInteger(main_model_p->dim_prep_intervention_t));
  SET_VECTOR_ELT(state, 158, allocVector(REALSXP, main_model_p->dim_prep_intervention_t));
  memcpy(REAL(VECTOR_ELT(state, 158)), main_model_p->prep_intervention_t, main_model_p->dim_prep_intervention_t * sizeof(double));
  SET_VECTOR_ELT(state, 159, ScalarInteger(main_model_p->dim_prep_intervention_y));
  SET_VECTOR_ELT(state, 160, ScalarInteger(main_model_p->dim_prep_intervention_y_1));
  SET_VECTOR_ELT(state, 161, ScalarInteger(main_model_p->dim_prep_intervention_y_2));
  SET_VECTOR_ELT(state, 162, allocVector(REALSXP, main_model_p->dim_prep_intervention_y));
  memcpy(REAL(VECTOR_ELT(state, 162)), main_model_p->prep_intervention_y, main_model_p->dim_prep_intervention_y * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 162), 2, main_model_p->dim_prep_intervention_y_1, main_model_p->dim_prep_intervention_y_2);
  SET_VECTOR_ELT(state, 163, ScalarInteger(main_model_p->dim_gamma32_without_supp));
  SET_VECTOR_ELT(state, 164, allocVector(REALSXP, main_model_p->dim_gamma32_without_supp));
  memcpy(REAL(VECTOR_ELT(state, 164)), main_model_p->gamma32_without_supp, main_model_p->dim_gamma32_without_supp * sizeof(double));
  SET_VECTOR_ELT(state, 165, ScalarInteger(main_model_p->offset_output_gamma32_without_supp));
  SET_VECTOR_ELT(state, 166, ScalarInteger(main_model_p->dim_gamma33_without_supp));
  SET_VECTOR_ELT(state, 167, allocVector(REALSXP, main_model_p->dim_gamma33_without_supp));
  memcpy(REAL(VECTOR_ELT(state, 167)), main_model_p->gamma33_without_supp, main_model_p->dim_gamma33_without_supp * sizeof(double));
  SET_VECTOR_ELT(state, 168, ScalarInteger(main_model_p->offset_output_gamma33_without_supp));
  SET_VECTOR_ELT(state, 169, ScalarInteger(main_model_p->dim_gamma34_without_supp));
  SET_VECTOR_ELT(state, 170, allocVector(REALSXP, main_model_p->dim_gamma34_without_supp));
  memcpy(REAL(VECTOR_ELT(state, 170)), main_model_p->gamma34_without_supp, main_model_p->dim_gamma34_without_supp * sizeof(double));
  SET_VECTOR_ELT(state, 171, ScalarInteger(main_model_p->offset_output_gamma34_without_supp));
  SET_VECTOR_ELT(state, 172, ScalarInteger(main_model_p->dim_alpha33_without_supp));
  SET_VECTOR_ELT(state, 173, allocVector(REALSXP, main_model_p->dim_alpha33_without_supp));
  memcpy(REAL(VECTOR_ELT(state, 173)), main_model_p->alpha33_without_supp, main_model_p->dim_alpha33_without_supp * sizeof(double));
  SET_VECTOR_ELT(state, 174, ScalarInteger(main_model_p->offset_output_alpha33_without_supp));
  SET_VECTOR_ELT(state, 175, ScalarInteger(main_model_p->dim_alpha34_without_supp));
  SET_VECTOR_ELT(state, 176, allocVector(REALSXP, main_model_p->dim_alpha34_without_supp));
  memcpy(REAL(VECTOR_ELT(state, 176)), main_model_p->alpha34_without_supp, main_model_p->dim_alpha34_without_supp * sizeof(double));
  SET_VECTOR_ELT(state, 177, ScalarInteger(main_model_p->offset_output_alpha34_without_supp));
  SET_VECTOR_ELT(state, 178, ScalarInteger(main_model_p->dim_alpha35_without_supp));
  SET_VECTOR_ELT(state, 179, allocVector(REALSXP, main_model_p->dim_alpha35_without_supp));
  memcpy(REAL(VECTOR_ELT(state, 179)), main_model_p->alpha35_without_supp, main_model_p->dim_alpha35_without_supp * sizeof(double));
  SET_VECTOR_ELT(state, 180, ScalarInteger(main_model_p->offset_output_alpha35_without_supp));
  SET_VECTOR_ELT(state, 181, ScalarInteger(main_model_p->dim_c_comm));
  SET_VECTOR_ELT(state, 182, allocVector(REALSXP, main_model_p->dim_c_comm));
  memcpy(REAL(VECTOR_ELT(state, 182)), main_model_p->c_comm, main_model_p->dim_c_comm * sizeof(double));
  SET_VECTOR_ELT(state, 183, ScalarInteger(main_model_p->offset_output_c_comm));
  SET_VECTOR_ELT(state, 184, ScalarInteger(main_model_p->dim_c_noncomm));
  SET_VECTOR_ELT(state, 185, allocVector(REALSXP, main_model_p->dim_c_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 185)), main_model_p->c_noncomm, main_model_p->dim_c_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 186, ScalarInteger(main_model_p->offset_output_c_noncomm));
  SET_VECTOR_ELT(state, 187, ScalarInteger(main_model_p->dim_pfFSW));
  SET_VECTOR_ELT(state, 188, allocVector(REALSXP, main_model_p->dim_pfFSW));
  memcpy(REAL(VECTOR_ELT(state, 188)), main_model_p->pfFSW, main_model_p->dim_pfFSW * sizeof(double));
  SET_VECTOR_ELT(state, 189, ScalarInteger(main_model_p->offset_output_pfFSW));
  SET_VECTOR_ELT(state, 190, ScalarInteger(main_model_p->dim_new_acute_infected));
  SET_VECTOR_ELT(state, 191, allocVector(REALSXP, main_model_p->dim_new_acute_infected));
  memcpy(REAL(VECTOR_ELT(state, 191)), main_model_p->new_acute_infected, main_model_p->dim_new_acute_infected * sizeof(double));
  SET_VECTOR_ELT(state, 192, ScalarInteger(main_model_p->offset_output_new_acute_infected));
  SET_VECTOR_ELT(state, 193, ScalarInteger(main_model_p->dim_FSW_ONLY));
  SET_VECTOR_ELT(state, 194, allocVector(REALSXP, main_model_p->dim_FSW_ONLY));
  memcpy(REAL(VECTOR_ELT(state, 194)), main_model_p->FSW_ONLY, main_model_p->dim_FSW_ONLY * sizeof(double));
  SET_VECTOR_ELT(state, 195, ScalarInteger(main_model_p->dim_new_people_in_group));
  SET_VECTOR_ELT(state, 196, allocVector(REALSXP, main_model_p->dim_new_people_in_group));
  memcpy(REAL(VECTOR_ELT(state, 196)), main_model_p->new_people_in_group, main_model_p->dim_new_people_in_group * sizeof(double));
  SET_VECTOR_ELT(state, 197, ScalarInteger(main_model_p->offset_output_new_people_in_group));
  SET_VECTOR_ELT(state, 198, ScalarInteger(main_model_p->dim_new_people_in_group_FSW_only));
  SET_VECTOR_ELT(state, 199, allocVector(REALSXP, main_model_p->dim_new_people_in_group_FSW_only));
  memcpy(REAL(VECTOR_ELT(state, 199)), main_model_p->new_people_in_group_FSW_only, main_model_p->dim_new_people_in_group_FSW_only * sizeof(double));
  SET_VECTOR_ELT(state, 200, ScalarInteger(main_model_p->offset_output_new_people_in_group_FSW_only));
  SET_VECTOR_ELT(state, 201, ScalarInteger(main_model_p->dim_comm_partnerships_requested));
  SET_VECTOR_ELT(state, 202, ScalarInteger(main_model_p->dim_comm_partnerships_requested_1));
  SET_VECTOR_ELT(state, 203, ScalarInteger(main_model_p->dim_comm_partnerships_requested_2));
  SET_VECTOR_ELT(state, 204, allocVector(REALSXP, main_model_p->dim_comm_partnerships_requested));
  memcpy(REAL(VECTOR_ELT(state, 204)), main_model_p->comm_partnerships_requested, main_model_p->dim_comm_partnerships_requested * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 204), 2, main_model_p->dim_comm_partnerships_requested_1, main_model_p->dim_comm_partnerships_requested_2);
  SET_VECTOR_ELT(state, 205, ScalarInteger(main_model_p->dim_noncomm_partnerships_requested));
  SET_VECTOR_ELT(state, 206, ScalarInteger(main_model_p->dim_noncomm_partnerships_requested_1));
  SET_VECTOR_ELT(state, 207, ScalarInteger(main_model_p->dim_noncomm_partnerships_requested_2));
  SET_VECTOR_ELT(state, 208, allocVector(REALSXP, main_model_p->dim_noncomm_partnerships_requested));
  memcpy(REAL(VECTOR_ELT(state, 208)), main_model_p->noncomm_partnerships_requested, main_model_p->dim_noncomm_partnerships_requested * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 208), 2, main_model_p->dim_noncomm_partnerships_requested_1, main_model_p->dim_noncomm_partnerships_requested_2);
  SET_VECTOR_ELT(state, 209, ScalarInteger(main_model_p->dim_above_500_by_group));
  SET_VECTOR_ELT(state, 210, allocVector(REALSXP, main_model_p->dim_above_500_by_group));
  memcpy(REAL(VECTOR_ELT(state, 210)), main_model_p->above_500_by_group, main_model_p->dim_above_500_by_group * sizeof(double));
  SET_VECTOR_ELT(state, 211, ScalarInteger(main_model_p->offset_output_above_500_by_group));
  SET_VECTOR_ELT(state, 212, ScalarInteger(main_model_p->dim_testing_prob));
  SET_VECTOR_ELT(state, 213, allocVector(REALSXP, main_model_p->dim_testing_prob));
  memcpy(REAL(VECTOR_ELT(state, 213)), main_model_p->testing_prob, main_model_p->dim_testing_prob * sizeof(double));
  SET_VECTOR_ELT(state, 214, ScalarInteger(main_model_p->offset_output_testing_prob));
  SET_VECTOR_ELT(state, 215, ScalarInteger(main_model_p->dim_tau_intervention));
  SET_VECTOR_ELT(state, 216, allocVector(REALSXP, main_model_p->dim_tau_intervention));
  memcpy(REAL(VECTOR_ELT(state, 216)), main_model_p->tau_intervention, main_model_p->dim_tau_intervention * sizeof(double));
  SET_VECTOR_ELT(state, 217, ScalarInteger(main_model_p->offset_output_tau_intervention));
  SET_VECTOR_ELT(state, 218, ScalarInteger(main_model_p->dim_rho_intervention));
  SET_VECTOR_ELT(state, 219, allocVector(REALSXP, main_model_p->dim_rho_intervention));
  memcpy(REAL(VECTOR_ELT(state, 219)), main_model_p->rho_intervention, main_model_p->dim_rho_intervention * sizeof(double));
  SET_VECTOR_ELT(state, 220, ScalarInteger(main_model_p->offset_output_rho_intervention));
  SET_VECTOR_ELT(state, 221, ScalarInteger(main_model_p->dim_zeta));
  SET_VECTOR_ELT(state, 222, allocVector(REALSXP, main_model_p->dim_zeta));
  memcpy(REAL(VECTOR_ELT(state, 222)), main_model_p->zeta, main_model_p->dim_zeta * sizeof(double));
  SET_VECTOR_ELT(state, 223, ScalarInteger(main_model_p->offset_output_zeta));
  SET_VECTOR_ELT(state, 224, ScalarInteger(main_model_p->dim_sigma));
  SET_VECTOR_ELT(state, 225, allocVector(REALSXP, main_model_p->dim_sigma));
  memcpy(REAL(VECTOR_ELT(state, 225)), main_model_p->sigma, main_model_p->dim_sigma * sizeof(double));
  SET_VECTOR_ELT(state, 226, ScalarInteger(main_model_p->dim_eP1a_effective));
  SET_VECTOR_ELT(state, 227, allocVector(REALSXP, main_model_p->dim_eP1a_effective));
  memcpy(REAL(VECTOR_ELT(state, 227)), main_model_p->eP1a_effective, main_model_p->dim_eP1a_effective * sizeof(double));
  SET_VECTOR_ELT(state, 228, ScalarInteger(main_model_p->offset_output_eP1a_effective));
  SET_VECTOR_ELT(state, 229, ScalarInteger(main_model_p->dim_eP1b_effective));
  SET_VECTOR_ELT(state, 230, allocVector(REALSXP, main_model_p->dim_eP1b_effective));
  memcpy(REAL(VECTOR_ELT(state, 230)), main_model_p->eP1b_effective, main_model_p->dim_eP1b_effective * sizeof(double));
  SET_VECTOR_ELT(state, 231, ScalarInteger(main_model_p->offset_output_eP1b_effective));
  SET_VECTOR_ELT(state, 232, ScalarInteger(main_model_p->dim_eP1c_effective));
  SET_VECTOR_ELT(state, 233, allocVector(REALSXP, main_model_p->dim_eP1c_effective));
  memcpy(REAL(VECTOR_ELT(state, 233)), main_model_p->eP1c_effective, main_model_p->dim_eP1c_effective * sizeof(double));
  SET_VECTOR_ELT(state, 234, ScalarInteger(main_model_p->offset_output_eP1c_effective));
  SET_VECTOR_ELT(state, 235, ScalarInteger(main_model_p->dim_tau));
  SET_VECTOR_ELT(state, 236, allocVector(REALSXP, main_model_p->dim_tau));
  memcpy(REAL(VECTOR_ELT(state, 236)), main_model_p->tau, main_model_p->dim_tau * sizeof(double));
  SET_VECTOR_ELT(state, 237, ScalarInteger(main_model_p->offset_output_tau));
  SET_VECTOR_ELT(state, 238, ScalarInteger(main_model_p->dim_test_rate_prep));
  SET_VECTOR_ELT(state, 239, allocVector(REALSXP, main_model_p->dim_test_rate_prep));
  memcpy(REAL(VECTOR_ELT(state, 239)), main_model_p->test_rate_prep, main_model_p->dim_test_rate_prep * sizeof(double));
  SET_VECTOR_ELT(state, 240, ScalarInteger(main_model_p->dim_rho));
  SET_VECTOR_ELT(state, 241, allocVector(REALSXP, main_model_p->dim_rho));
  memcpy(REAL(VECTOR_ELT(state, 241)), main_model_p->rho, main_model_p->dim_rho * sizeof(double));
  SET_VECTOR_ELT(state, 242, ScalarInteger(main_model_p->offset_output_rho));
  SET_VECTOR_ELT(state, 243, ScalarInteger(main_model_p->dim_iota));
  SET_VECTOR_ELT(state, 244, allocVector(REALSXP, main_model_p->dim_iota));
  memcpy(REAL(VECTOR_ELT(state, 244)), main_model_p->iota, main_model_p->dim_iota * sizeof(double));
  SET_VECTOR_ELT(state, 245, ScalarInteger(main_model_p->offset_output_iota));
  SET_VECTOR_ELT(state, 246, ScalarInteger(main_model_p->dim_viral_supp));
  SET_VECTOR_ELT(state, 247, allocVector(REALSXP, main_model_p->dim_viral_supp));
  memcpy(REAL(VECTOR_ELT(state, 247)), main_model_p->viral_supp, main_model_p->dim_viral_supp * sizeof(double));
  SET_VECTOR_ELT(state, 248, ScalarInteger(main_model_p->offset_output_viral_supp));
  SET_VECTOR_ELT(state, 249, ScalarInteger(main_model_p->dim_HIV_positive));
  SET_VECTOR_ELT(state, 250, allocVector(REALSXP, main_model_p->dim_HIV_positive));
  memcpy(REAL(VECTOR_ELT(state, 250)), main_model_p->HIV_positive, main_model_p->dim_HIV_positive * sizeof(double));
  SET_VECTOR_ELT(state, 251, ScalarInteger(main_model_p->offset_output_HIV_positive));
  SET_VECTOR_ELT(state, 252, ScalarInteger(main_model_p->dim_Number_Susceptibles));
  SET_VECTOR_ELT(state, 253, allocVector(REALSXP, main_model_p->dim_Number_Susceptibles));
  memcpy(REAL(VECTOR_ELT(state, 253)), main_model_p->Number_Susceptibles, main_model_p->dim_Number_Susceptibles * sizeof(double));
  SET_VECTOR_ELT(state, 254, ScalarInteger(main_model_p->offset_output_Number_Susceptibles));
  SET_VECTOR_ELT(state, 255, ScalarInteger(main_model_p->dim_HIV_positive_Diagnosed_Off_ART));
  SET_VECTOR_ELT(state, 256, allocVector(REALSXP, main_model_p->dim_HIV_positive_Diagnosed_Off_ART));
  memcpy(REAL(VECTOR_ELT(state, 256)), main_model_p->HIV_positive_Diagnosed_Off_ART, main_model_p->dim_HIV_positive_Diagnosed_Off_ART * sizeof(double));
  SET_VECTOR_ELT(state, 257, ScalarInteger(main_model_p->offset_output_HIV_positive_Diagnosed_Off_ART));
  SET_VECTOR_ELT(state, 258, ScalarInteger(main_model_p->dim_Primary_Off_ART));
  SET_VECTOR_ELT(state, 259, allocVector(REALSXP, main_model_p->dim_Primary_Off_ART));
  memcpy(REAL(VECTOR_ELT(state, 259)), main_model_p->Primary_Off_ART, main_model_p->dim_Primary_Off_ART * sizeof(double));
  SET_VECTOR_ELT(state, 260, ScalarInteger(main_model_p->offset_output_Primary_Off_ART));
  SET_VECTOR_ELT(state, 261, ScalarInteger(main_model_p->dim_CD4_above_500_Off_ART));
  SET_VECTOR_ELT(state, 262, allocVector(REALSXP, main_model_p->dim_CD4_above_500_Off_ART));
  memcpy(REAL(VECTOR_ELT(state, 262)), main_model_p->CD4_above_500_Off_ART, main_model_p->dim_CD4_above_500_Off_ART * sizeof(double));
  SET_VECTOR_ELT(state, 263, ScalarInteger(main_model_p->offset_output_CD4_above_500_Off_ART));
  SET_VECTOR_ELT(state, 264, ScalarInteger(main_model_p->dim_CD4_350_500_Off_ART));
  SET_VECTOR_ELT(state, 265, allocVector(REALSXP, main_model_p->dim_CD4_350_500_Off_ART));
  memcpy(REAL(VECTOR_ELT(state, 265)), main_model_p->CD4_350_500_Off_ART, main_model_p->dim_CD4_350_500_Off_ART * sizeof(double));
  SET_VECTOR_ELT(state, 266, ScalarInteger(main_model_p->offset_output_CD4_350_500_Off_ART));
  SET_VECTOR_ELT(state, 267, ScalarInteger(main_model_p->dim_CD4_200_350_Off_ART));
  SET_VECTOR_ELT(state, 268, allocVector(REALSXP, main_model_p->dim_CD4_200_350_Off_ART));
  memcpy(REAL(VECTOR_ELT(state, 268)), main_model_p->CD4_200_350_Off_ART, main_model_p->dim_CD4_200_350_Off_ART * sizeof(double));
  SET_VECTOR_ELT(state, 269, ScalarInteger(main_model_p->offset_output_CD4_200_350_Off_ART));
  SET_VECTOR_ELT(state, 270, ScalarInteger(main_model_p->dim_CD4_below_200_Off_ART));
  SET_VECTOR_ELT(state, 271, allocVector(REALSXP, main_model_p->dim_CD4_below_200_Off_ART));
  memcpy(REAL(VECTOR_ELT(state, 271)), main_model_p->CD4_below_200_Off_ART, main_model_p->dim_CD4_below_200_Off_ART * sizeof(double));
  SET_VECTOR_ELT(state, 272, ScalarInteger(main_model_p->offset_output_CD4_below_200_Off_ART));
  SET_VECTOR_ELT(state, 273, ScalarInteger(main_model_p->dim_HIV_positive_On_ART));
  SET_VECTOR_ELT(state, 274, allocVector(REALSXP, main_model_p->dim_HIV_positive_On_ART));
  memcpy(REAL(VECTOR_ELT(state, 274)), main_model_p->HIV_positive_On_ART, main_model_p->dim_HIV_positive_On_ART * sizeof(double));
  SET_VECTOR_ELT(state, 275, ScalarInteger(main_model_p->offset_output_HIV_positive_On_ART));
  SET_VECTOR_ELT(state, 276, ScalarInteger(main_model_p->dim_Number_DALY_W1));
  SET_VECTOR_ELT(state, 277, allocVector(REALSXP, main_model_p->dim_Number_DALY_W1));
  memcpy(REAL(VECTOR_ELT(state, 277)), main_model_p->Number_DALY_W1, main_model_p->dim_Number_DALY_W1 * sizeof(double));
  SET_VECTOR_ELT(state, 278, ScalarInteger(main_model_p->offset_output_Number_DALY_W1));
  SET_VECTOR_ELT(state, 279, ScalarInteger(main_model_p->dim_Number_DALY_W2));
  SET_VECTOR_ELT(state, 280, allocVector(REALSXP, main_model_p->dim_Number_DALY_W2));
  memcpy(REAL(VECTOR_ELT(state, 280)), main_model_p->Number_DALY_W2, main_model_p->dim_Number_DALY_W2 * sizeof(double));
  SET_VECTOR_ELT(state, 281, ScalarInteger(main_model_p->offset_output_Number_DALY_W2));
  SET_VECTOR_ELT(state, 282, ScalarInteger(main_model_p->dim_Number_DALY_W3));
  SET_VECTOR_ELT(state, 283, allocVector(REALSXP, main_model_p->dim_Number_DALY_W3));
  memcpy(REAL(VECTOR_ELT(state, 283)), main_model_p->Number_DALY_W3, main_model_p->dim_Number_DALY_W3 * sizeof(double));
  SET_VECTOR_ELT(state, 284, ScalarInteger(main_model_p->offset_output_Number_DALY_W3));
  SET_VECTOR_ELT(state, 285, ScalarInteger(main_model_p->dim_cumuDeaths_On_ART));
  SET_VECTOR_ELT(state, 286, allocVector(REALSXP, main_model_p->dim_cumuDeaths_On_ART));
  memcpy(REAL(VECTOR_ELT(state, 286)), main_model_p->initial_cumuDeaths_On_ART, main_model_p->dim_cumuDeaths_On_ART * sizeof(double));
  SET_VECTOR_ELT(state, 287, ScalarInteger(main_model_p->offset_cumuDeaths_On_ART));
  SET_VECTOR_ELT(state, 288, ScalarInteger(main_model_p->dim_cumuARTinitiations_not_TasP));
  SET_VECTOR_ELT(state, 289, allocVector(REALSXP, main_model_p->dim_cumuARTinitiations_not_TasP));
  memcpy(REAL(VECTOR_ELT(state, 289)), main_model_p->initial_cumuARTinitiations_not_TasP, main_model_p->dim_cumuARTinitiations_not_TasP * sizeof(double));
  SET_VECTOR_ELT(state, 290, ScalarInteger(main_model_p->offset_cumuARTinitiations_not_TasP));
  SET_VECTOR_ELT(state, 291, ScalarInteger(main_model_p->dim_cumu_PrEP_dropouts));
  SET_VECTOR_ELT(state, 292, allocVector(REALSXP, main_model_p->dim_cumu_PrEP_dropouts));
  memcpy(REAL(VECTOR_ELT(state, 292)), main_model_p->initial_cumu_PrEP_dropouts, main_model_p->dim_cumu_PrEP_dropouts * sizeof(double));
  SET_VECTOR_ELT(state, 293, ScalarInteger(main_model_p->offset_cumu_PrEP_dropouts));
  SET_VECTOR_ELT(state, 294, ScalarInteger(main_model_p->dim_S0_infections));
  SET_VECTOR_ELT(state, 295, allocVector(REALSXP, main_model_p->dim_S0_infections));
  memcpy(REAL(VECTOR_ELT(state, 295)), main_model_p->initial_S0_infections, main_model_p->dim_S0_infections * sizeof(double));
  SET_VECTOR_ELT(state, 296, ScalarInteger(main_model_p->offset_S0_infections));
  SET_VECTOR_ELT(state, 297, ScalarInteger(main_model_p->dim_S1a_infections));
  SET_VECTOR_ELT(state, 298, allocVector(REALSXP, main_model_p->dim_S1a_infections));
  memcpy(REAL(VECTOR_ELT(state, 298)), main_model_p->initial_S1a_infections, main_model_p->dim_S1a_infections * sizeof(double));
  SET_VECTOR_ELT(state, 299, ScalarInteger(main_model_p->offset_S1a_infections));
  SET_VECTOR_ELT(state, 300, ScalarInteger(main_model_p->dim_S1b_infections));
  SET_VECTOR_ELT(state, 301, allocVector(REALSXP, main_model_p->dim_S1b_infections));
  memcpy(REAL(VECTOR_ELT(state, 301)), main_model_p->initial_S1b_infections, main_model_p->dim_S1b_infections * sizeof(double));
  SET_VECTOR_ELT(state, 302, ScalarInteger(main_model_p->offset_S1b_infections));
  SET_VECTOR_ELT(state, 303, ScalarInteger(main_model_p->dim_S1c_infections));
  SET_VECTOR_ELT(state, 304, allocVector(REALSXP, main_model_p->dim_S1c_infections));
  memcpy(REAL(VECTOR_ELT(state, 304)), main_model_p->initial_S1c_infections, main_model_p->dim_S1c_infections * sizeof(double));
  SET_VECTOR_ELT(state, 305, ScalarInteger(main_model_p->offset_S1c_infections));
  SET_VECTOR_ELT(state, 306, ScalarInteger(main_model_p->dim_S1d_infections));
  SET_VECTOR_ELT(state, 307, allocVector(REALSXP, main_model_p->dim_S1d_infections));
  memcpy(REAL(VECTOR_ELT(state, 307)), main_model_p->initial_S1d_infections, main_model_p->dim_S1d_infections * sizeof(double));
  SET_VECTOR_ELT(state, 308, ScalarInteger(main_model_p->offset_S1d_infections));
  SET_VECTOR_ELT(state, 309, ScalarInteger(main_model_p->dim_frac_F));
  SET_VECTOR_ELT(state, 310, allocVector(REALSXP, main_model_p->dim_frac_F));
  memcpy(REAL(VECTOR_ELT(state, 310)), main_model_p->frac_F, main_model_p->dim_frac_F * sizeof(double));
  SET_VECTOR_ELT(state, 311, ScalarInteger(main_model_p->offset_output_frac_F));
  SET_VECTOR_ELT(state, 312, ScalarInteger(main_model_p->dim_frac_N_sexualpop));
  SET_VECTOR_ELT(state, 313, allocVector(REALSXP, main_model_p->dim_frac_N_sexualpop));
  memcpy(REAL(VECTOR_ELT(state, 313)), main_model_p->frac_N_sexualpop, main_model_p->dim_frac_N_sexualpop * sizeof(double));
  SET_VECTOR_ELT(state, 314, ScalarInteger(main_model_p->offset_output_frac_N_sexualpop));
  SET_VECTOR_ELT(state, 315, ScalarInteger(main_model_p->dim_ART_coverage));
  SET_VECTOR_ELT(state, 316, allocVector(REALSXP, main_model_p->dim_ART_coverage));
  memcpy(REAL(VECTOR_ELT(state, 316)), main_model_p->ART_coverage, main_model_p->dim_ART_coverage * sizeof(double));
  SET_VECTOR_ELT(state, 317, ScalarInteger(main_model_p->offset_output_ART_coverage));
  SET_VECTOR_ELT(state, 318, ScalarInteger(main_model_p->dim_infect_ART));
  SET_VECTOR_ELT(state, 319, allocVector(REALSXP, main_model_p->dim_infect_ART));
  memcpy(REAL(VECTOR_ELT(state, 319)), main_model_p->infect_ART, main_model_p->dim_infect_ART * sizeof(double));
  SET_VECTOR_ELT(state, 320, ScalarInteger(main_model_p->offset_output_infect_ART));
  SET_VECTOR_ELT(state, 321, ScalarInteger(main_model_p->dim_prep_offered));
  SET_VECTOR_ELT(state, 322, allocVector(REALSXP, main_model_p->dim_prep_offered));
  memcpy(REAL(VECTOR_ELT(state, 322)), main_model_p->prep_offered, main_model_p->dim_prep_offered * sizeof(double));
  SET_VECTOR_ELT(state, 323, ScalarInteger(main_model_p->offset_output_prep_offered));
  SET_VECTOR_ELT(state, 324, ScalarInteger(main_model_p->dim_omega));
  SET_VECTOR_ELT(state, 325, allocVector(REALSXP, main_model_p->dim_omega));
  memcpy(REAL(VECTOR_ELT(state, 325)), main_model_p->omega, main_model_p->dim_omega * sizeof(double));
  SET_VECTOR_ELT(state, 326, ScalarInteger(main_model_p->offset_output_omega));
  SET_VECTOR_ELT(state, 327, ScalarInteger(main_model_p->dim_frac_N));
  SET_VECTOR_ELT(state, 328, allocVector(REALSXP, main_model_p->dim_frac_N));
  memcpy(REAL(VECTOR_ELT(state, 328)), main_model_p->frac_N, main_model_p->dim_frac_N * sizeof(double));
  SET_VECTOR_ELT(state, 329, ScalarInteger(main_model_p->offset_output_frac_N));
  SET_VECTOR_ELT(state, 330, ScalarInteger(main_model_p->dim_mu));
  SET_VECTOR_ELT(state, 331, allocVector(REALSXP, main_model_p->dim_mu));
  memcpy(REAL(VECTOR_ELT(state, 331)), main_model_p->mu, main_model_p->dim_mu * sizeof(double));
  SET_VECTOR_ELT(state, 332, ScalarInteger(main_model_p->offset_output_mu));
  SET_VECTOR_ELT(state, 333, ScalarInteger(main_model_p->dim_gamma01));
  SET_VECTOR_ELT(state, 334, allocVector(REALSXP, main_model_p->dim_gamma01));
  memcpy(REAL(VECTOR_ELT(state, 334)), main_model_p->gamma01, main_model_p->dim_gamma01 * sizeof(double));
  SET_VECTOR_ELT(state, 335, ScalarInteger(main_model_p->offset_output_gamma01));
  SET_VECTOR_ELT(state, 336, ScalarInteger(main_model_p->dim_gamma02));
  SET_VECTOR_ELT(state, 337, allocVector(REALSXP, main_model_p->dim_gamma02));
  memcpy(REAL(VECTOR_ELT(state, 337)), main_model_p->gamma02, main_model_p->dim_gamma02 * sizeof(double));
  SET_VECTOR_ELT(state, 338, ScalarInteger(main_model_p->dim_gamma03));
  SET_VECTOR_ELT(state, 339, allocVector(REALSXP, main_model_p->dim_gamma03));
  memcpy(REAL(VECTOR_ELT(state, 339)), main_model_p->gamma03, main_model_p->dim_gamma03 * sizeof(double));
  SET_VECTOR_ELT(state, 340, ScalarInteger(main_model_p->dim_gamma04));
  SET_VECTOR_ELT(state, 341, allocVector(REALSXP, main_model_p->dim_gamma04));
  memcpy(REAL(VECTOR_ELT(state, 341)), main_model_p->gamma04, main_model_p->dim_gamma04 * sizeof(double));
  SET_VECTOR_ELT(state, 342, ScalarInteger(main_model_p->dim_gamma11));
  SET_VECTOR_ELT(state, 343, allocVector(REALSXP, main_model_p->dim_gamma11));
  memcpy(REAL(VECTOR_ELT(state, 343)), main_model_p->gamma11, main_model_p->dim_gamma11 * sizeof(double));
  SET_VECTOR_ELT(state, 344, ScalarInteger(main_model_p->offset_output_gamma11));
  SET_VECTOR_ELT(state, 345, ScalarInteger(main_model_p->dim_gamma22));
  SET_VECTOR_ELT(state, 346, allocVector(REALSXP, main_model_p->dim_gamma22));
  memcpy(REAL(VECTOR_ELT(state, 346)), main_model_p->gamma22, main_model_p->dim_gamma22 * sizeof(double));
  SET_VECTOR_ELT(state, 347, ScalarInteger(main_model_p->dim_gamma23));
  SET_VECTOR_ELT(state, 348, allocVector(REALSXP, main_model_p->dim_gamma23));
  memcpy(REAL(VECTOR_ELT(state, 348)), main_model_p->gamma23, main_model_p->dim_gamma23 * sizeof(double));
  SET_VECTOR_ELT(state, 349, ScalarInteger(main_model_p->dim_gamma24));
  SET_VECTOR_ELT(state, 350, allocVector(REALSXP, main_model_p->dim_gamma24));
  memcpy(REAL(VECTOR_ELT(state, 350)), main_model_p->gamma24, main_model_p->dim_gamma24 * sizeof(double));
  SET_VECTOR_ELT(state, 351, ScalarInteger(main_model_p->dim_gamma32));
  SET_VECTOR_ELT(state, 352, allocVector(REALSXP, main_model_p->dim_gamma32));
  memcpy(REAL(VECTOR_ELT(state, 352)), main_model_p->gamma32, main_model_p->dim_gamma32 * sizeof(double));
  SET_VECTOR_ELT(state, 353, ScalarInteger(main_model_p->offset_output_gamma32));
  SET_VECTOR_ELT(state, 354, ScalarInteger(main_model_p->dim_gamma33));
  SET_VECTOR_ELT(state, 355, allocVector(REALSXP, main_model_p->dim_gamma33));
  memcpy(REAL(VECTOR_ELT(state, 355)), main_model_p->gamma33, main_model_p->dim_gamma33 * sizeof(double));
  SET_VECTOR_ELT(state, 356, ScalarInteger(main_model_p->offset_output_gamma33));
  SET_VECTOR_ELT(state, 357, ScalarInteger(main_model_p->dim_gamma34));
  SET_VECTOR_ELT(state, 358, allocVector(REALSXP, main_model_p->dim_gamma34));
  memcpy(REAL(VECTOR_ELT(state, 358)), main_model_p->gamma34, main_model_p->dim_gamma34 * sizeof(double));
  SET_VECTOR_ELT(state, 359, ScalarInteger(main_model_p->offset_output_gamma34));
  SET_VECTOR_ELT(state, 360, ScalarInteger(main_model_p->dim_gamma42));
  SET_VECTOR_ELT(state, 361, allocVector(REALSXP, main_model_p->dim_gamma42));
  memcpy(REAL(VECTOR_ELT(state, 361)), main_model_p->gamma42, main_model_p->dim_gamma42 * sizeof(double));
  SET_VECTOR_ELT(state, 362, ScalarInteger(main_model_p->dim_gamma43));
  SET_VECTOR_ELT(state, 363, allocVector(REALSXP, main_model_p->dim_gamma43));
  memcpy(REAL(VECTOR_ELT(state, 363)), main_model_p->gamma43, main_model_p->dim_gamma43 * sizeof(double));
  SET_VECTOR_ELT(state, 364, ScalarInteger(main_model_p->dim_gamma44));
  SET_VECTOR_ELT(state, 365, allocVector(REALSXP, main_model_p->dim_gamma44));
  memcpy(REAL(VECTOR_ELT(state, 365)), main_model_p->gamma44, main_model_p->dim_gamma44 * sizeof(double));
  SET_VECTOR_ELT(state, 366, ScalarInteger(main_model_p->dim_phi2));
  SET_VECTOR_ELT(state, 367, allocVector(REALSXP, main_model_p->dim_phi2));
  memcpy(REAL(VECTOR_ELT(state, 367)), main_model_p->phi2, main_model_p->dim_phi2 * sizeof(double));
  SET_VECTOR_ELT(state, 368, ScalarInteger(main_model_p->dim_phi3));
  SET_VECTOR_ELT(state, 369, allocVector(REALSXP, main_model_p->dim_phi3));
  memcpy(REAL(VECTOR_ELT(state, 369)), main_model_p->phi3, main_model_p->dim_phi3 * sizeof(double));
  SET_VECTOR_ELT(state, 370, ScalarInteger(main_model_p->dim_phi4));
  SET_VECTOR_ELT(state, 371, allocVector(REALSXP, main_model_p->dim_phi4));
  memcpy(REAL(VECTOR_ELT(state, 371)), main_model_p->phi4, main_model_p->dim_phi4 * sizeof(double));
  SET_VECTOR_ELT(state, 372, ScalarInteger(main_model_p->dim_phi5));
  SET_VECTOR_ELT(state, 373, allocVector(REALSXP, main_model_p->dim_phi5));
  memcpy(REAL(VECTOR_ELT(state, 373)), main_model_p->phi5, main_model_p->dim_phi5 * sizeof(double));
  SET_VECTOR_ELT(state, 374, ScalarInteger(main_model_p->dim_psia));
  SET_VECTOR_ELT(state, 375, allocVector(REALSXP, main_model_p->dim_psia));
  memcpy(REAL(VECTOR_ELT(state, 375)), main_model_p->psia, main_model_p->dim_psia * sizeof(double));
  SET_VECTOR_ELT(state, 376, ScalarInteger(main_model_p->dim_psib));
  SET_VECTOR_ELT(state, 377, allocVector(REALSXP, main_model_p->dim_psib));
  memcpy(REAL(VECTOR_ELT(state, 377)), main_model_p->psib, main_model_p->dim_psib * sizeof(double));
  SET_VECTOR_ELT(state, 378, ScalarInteger(main_model_p->dim_kappaa));
  SET_VECTOR_ELT(state, 379, allocVector(REALSXP, main_model_p->dim_kappaa));
  memcpy(REAL(VECTOR_ELT(state, 379)), main_model_p->kappaa, main_model_p->dim_kappaa * sizeof(double));
  SET_VECTOR_ELT(state, 380, ScalarInteger(main_model_p->offset_output_kappaa));
  SET_VECTOR_ELT(state, 381, ScalarInteger(main_model_p->dim_kappab));
  SET_VECTOR_ELT(state, 382, allocVector(REALSXP, main_model_p->dim_kappab));
  memcpy(REAL(VECTOR_ELT(state, 382)), main_model_p->kappab, main_model_p->dim_kappab * sizeof(double));
  SET_VECTOR_ELT(state, 383, ScalarInteger(main_model_p->offset_output_kappab));
  SET_VECTOR_ELT(state, 384, ScalarInteger(main_model_p->dim_kappac));
  SET_VECTOR_ELT(state, 385, allocVector(REALSXP, main_model_p->dim_kappac));
  memcpy(REAL(VECTOR_ELT(state, 385)), main_model_p->kappac, main_model_p->dim_kappac * sizeof(double));
  SET_VECTOR_ELT(state, 386, ScalarInteger(main_model_p->offset_output_kappac));
  SET_VECTOR_ELT(state, 387, ScalarInteger(main_model_p->dim_kappa1));
  SET_VECTOR_ELT(state, 388, allocVector(REALSXP, main_model_p->dim_kappa1));
  memcpy(REAL(VECTOR_ELT(state, 388)), main_model_p->kappa1, main_model_p->dim_kappa1 * sizeof(double));
  SET_VECTOR_ELT(state, 389, ScalarInteger(main_model_p->offset_output_kappa1));
  SET_VECTOR_ELT(state, 390, ScalarInteger(main_model_p->dim_alpha01));
  SET_VECTOR_ELT(state, 391, allocVector(REALSXP, main_model_p->dim_alpha01));
  memcpy(REAL(VECTOR_ELT(state, 391)), main_model_p->alpha01, main_model_p->dim_alpha01 * sizeof(double));
  SET_VECTOR_ELT(state, 392, ScalarInteger(main_model_p->offset_output_alpha01));
  SET_VECTOR_ELT(state, 393, ScalarInteger(main_model_p->dim_alpha02));
  SET_VECTOR_ELT(state, 394, allocVector(REALSXP, main_model_p->dim_alpha02));
  memcpy(REAL(VECTOR_ELT(state, 394)), main_model_p->alpha02, main_model_p->dim_alpha02 * sizeof(double));
  SET_VECTOR_ELT(state, 395, ScalarInteger(main_model_p->offset_output_alpha02));
  SET_VECTOR_ELT(state, 396, ScalarInteger(main_model_p->dim_alpha03));
  SET_VECTOR_ELT(state, 397, allocVector(REALSXP, main_model_p->dim_alpha03));
  memcpy(REAL(VECTOR_ELT(state, 397)), main_model_p->alpha03, main_model_p->dim_alpha03 * sizeof(double));
  SET_VECTOR_ELT(state, 398, ScalarInteger(main_model_p->dim_alpha04));
  SET_VECTOR_ELT(state, 399, allocVector(REALSXP, main_model_p->dim_alpha04));
  memcpy(REAL(VECTOR_ELT(state, 399)), main_model_p->alpha04, main_model_p->dim_alpha04 * sizeof(double));
  SET_VECTOR_ELT(state, 400, ScalarInteger(main_model_p->dim_alpha05));
  SET_VECTOR_ELT(state, 401, allocVector(REALSXP, main_model_p->dim_alpha05));
  memcpy(REAL(VECTOR_ELT(state, 401)), main_model_p->alpha05, main_model_p->dim_alpha05 * sizeof(double));
  SET_VECTOR_ELT(state, 402, ScalarInteger(main_model_p->offset_output_alpha05));
  SET_VECTOR_ELT(state, 403, ScalarInteger(main_model_p->dim_alpha11));
  SET_VECTOR_ELT(state, 404, allocVector(REALSXP, main_model_p->dim_alpha11));
  memcpy(REAL(VECTOR_ELT(state, 404)), main_model_p->alpha11, main_model_p->dim_alpha11 * sizeof(double));
  SET_VECTOR_ELT(state, 405, ScalarInteger(main_model_p->offset_output_alpha11));
  SET_VECTOR_ELT(state, 406, ScalarInteger(main_model_p->dim_alpha22));
  SET_VECTOR_ELT(state, 407, allocVector(REALSXP, main_model_p->dim_alpha22));
  memcpy(REAL(VECTOR_ELT(state, 407)), main_model_p->alpha22, main_model_p->dim_alpha22 * sizeof(double));
  SET_VECTOR_ELT(state, 408, ScalarInteger(main_model_p->offset_output_alpha22));
  SET_VECTOR_ELT(state, 409, ScalarInteger(main_model_p->dim_alpha23));
  SET_VECTOR_ELT(state, 410, allocVector(REALSXP, main_model_p->dim_alpha23));
  memcpy(REAL(VECTOR_ELT(state, 410)), main_model_p->alpha23, main_model_p->dim_alpha23 * sizeof(double));
  SET_VECTOR_ELT(state, 411, ScalarInteger(main_model_p->dim_alpha24));
  SET_VECTOR_ELT(state, 412, allocVector(REALSXP, main_model_p->dim_alpha24));
  memcpy(REAL(VECTOR_ELT(state, 412)), main_model_p->alpha24, main_model_p->dim_alpha24 * sizeof(double));
  SET_VECTOR_ELT(state, 413, ScalarInteger(main_model_p->dim_alpha25));
  SET_VECTOR_ELT(state, 414, allocVector(REALSXP, main_model_p->dim_alpha25));
  memcpy(REAL(VECTOR_ELT(state, 414)), main_model_p->alpha25, main_model_p->dim_alpha25 * sizeof(double));
  SET_VECTOR_ELT(state, 415, ScalarInteger(main_model_p->dim_alpha32));
  SET_VECTOR_ELT(state, 416, allocVector(REALSXP, main_model_p->dim_alpha32));
  memcpy(REAL(VECTOR_ELT(state, 416)), main_model_p->alpha32, main_model_p->dim_alpha32 * sizeof(double));
  SET_VECTOR_ELT(state, 417, ScalarInteger(main_model_p->dim_alpha33));
  SET_VECTOR_ELT(state, 418, allocVector(REALSXP, main_model_p->dim_alpha33));
  memcpy(REAL(VECTOR_ELT(state, 418)), main_model_p->alpha33, main_model_p->dim_alpha33 * sizeof(double));
  SET_VECTOR_ELT(state, 419, ScalarInteger(main_model_p->offset_output_alpha33));
  SET_VECTOR_ELT(state, 420, ScalarInteger(main_model_p->dim_alpha34));
  SET_VECTOR_ELT(state, 421, allocVector(REALSXP, main_model_p->dim_alpha34));
  memcpy(REAL(VECTOR_ELT(state, 421)), main_model_p->alpha34, main_model_p->dim_alpha34 * sizeof(double));
  SET_VECTOR_ELT(state, 422, ScalarInteger(main_model_p->offset_output_alpha34));
  SET_VECTOR_ELT(state, 423, ScalarInteger(main_model_p->dim_alpha35));
  SET_VECTOR_ELT(state, 424, allocVector(REALSXP, main_model_p->dim_alpha35));
  memcpy(REAL(VECTOR_ELT(state, 424)), main_model_p->alpha35, main_model_p->dim_alpha35 * sizeof(double));
  SET_VECTOR_ELT(state, 425, ScalarInteger(main_model_p->offset_output_alpha35));
  SET_VECTOR_ELT(state, 426, ScalarInteger(main_model_p->dim_alpha42));
  SET_VECTOR_ELT(state, 427, allocVector(REALSXP, main_model_p->dim_alpha42));
  memcpy(REAL(VECTOR_ELT(state, 427)), main_model_p->alpha42, main_model_p->dim_alpha42 * sizeof(double));
  SET_VECTOR_ELT(state, 428, ScalarInteger(main_model_p->dim_alpha43));
  SET_VECTOR_ELT(state, 429, allocVector(REALSXP, main_model_p->dim_alpha43));
  memcpy(REAL(VECTOR_ELT(state, 429)), main_model_p->alpha43, main_model_p->dim_alpha43 * sizeof(double));
  SET_VECTOR_ELT(state, 430, ScalarInteger(main_model_p->dim_alpha44));
  SET_VECTOR_ELT(state, 431, allocVector(REALSXP, main_model_p->dim_alpha44));
  memcpy(REAL(VECTOR_ELT(state, 431)), main_model_p->alpha44, main_model_p->dim_alpha44 * sizeof(double));
  SET_VECTOR_ELT(state, 432, ScalarInteger(main_model_p->dim_alpha45));
  SET_VECTOR_ELT(state, 433, allocVector(REALSXP, main_model_p->dim_alpha45));
  memcpy(REAL(VECTOR_ELT(state, 433)), main_model_p->alpha45, main_model_p->dim_alpha45 * sizeof(double));
  SET_VECTOR_ELT(state, 434, ScalarInteger(main_model_p->dim_beta_comm));
  SET_VECTOR_ELT(state, 435, allocVector(REALSXP, main_model_p->dim_beta_comm));
  memcpy(REAL(VECTOR_ELT(state, 435)), main_model_p->beta_comm, main_model_p->dim_beta_comm * sizeof(double));
  SET_VECTOR_ELT(state, 436, ScalarInteger(main_model_p->offset_output_beta_comm));
  SET_VECTOR_ELT(state, 437, ScalarInteger(main_model_p->dim_beta_noncomm));
  SET_VECTOR_ELT(state, 438, allocVector(REALSXP, main_model_p->dim_beta_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 438)), main_model_p->beta_noncomm, main_model_p->dim_beta_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 439, ScalarInteger(main_model_p->offset_output_beta_noncomm));
  SET_VECTOR_ELT(state, 440, ScalarInteger(main_model_p->dim_p_comm));
  SET_VECTOR_ELT(state, 441, ScalarInteger(main_model_p->dim_p_comm_1));
  SET_VECTOR_ELT(state, 442, ScalarInteger(main_model_p->dim_p_comm_2));
  SET_VECTOR_ELT(state, 443, allocVector(REALSXP, main_model_p->dim_p_comm));
  memcpy(REAL(VECTOR_ELT(state, 443)), main_model_p->p_comm, main_model_p->dim_p_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 443), 2, main_model_p->dim_p_comm_1, main_model_p->dim_p_comm_2);
  SET_VECTOR_ELT(state, 444, ScalarInteger(main_model_p->offset_output_p_comm));
  SET_VECTOR_ELT(state, 445, ScalarInteger(main_model_p->dim_p_noncomm));
  SET_VECTOR_ELT(state, 446, ScalarInteger(main_model_p->dim_p_noncomm_1));
  SET_VECTOR_ELT(state, 447, ScalarInteger(main_model_p->dim_p_noncomm_2));
  SET_VECTOR_ELT(state, 448, allocVector(REALSXP, main_model_p->dim_p_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 448)), main_model_p->p_noncomm, main_model_p->dim_p_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 448), 2, main_model_p->dim_p_noncomm_1, main_model_p->dim_p_noncomm_2);
  SET_VECTOR_ELT(state, 449, ScalarInteger(main_model_p->offset_output_p_noncomm));
  SET_VECTOR_ELT(state, 450, ScalarInteger(main_model_p->dim_ec));
  SET_VECTOR_ELT(state, 451, allocVector(REALSXP, main_model_p->dim_ec));
  memcpy(REAL(VECTOR_ELT(state, 451)), main_model_p->ec, main_model_p->dim_ec * sizeof(double));
  SET_VECTOR_ELT(state, 452, ScalarInteger(main_model_p->dim_eP));
  SET_VECTOR_ELT(state, 453, allocVector(REALSXP, main_model_p->dim_eP));
  memcpy(REAL(VECTOR_ELT(state, 453)), main_model_p->eP, main_model_p->dim_eP * sizeof(double));
  SET_VECTOR_ELT(state, 454, ScalarInteger(main_model_p->dim_eP0));
  SET_VECTOR_ELT(state, 455, allocVector(REALSXP, main_model_p->dim_eP0));
  memcpy(REAL(VECTOR_ELT(state, 455)), main_model_p->eP0, main_model_p->dim_eP0 * sizeof(double));
  SET_VECTOR_ELT(state, 456, ScalarInteger(main_model_p->offset_output_eP0));
  SET_VECTOR_ELT(state, 457, ScalarInteger(main_model_p->dim_eP1a));
  SET_VECTOR_ELT(state, 458, allocVector(REALSXP, main_model_p->dim_eP1a));
  memcpy(REAL(VECTOR_ELT(state, 458)), main_model_p->eP1a, main_model_p->dim_eP1a * sizeof(double));
  SET_VECTOR_ELT(state, 459, ScalarInteger(main_model_p->offset_output_eP1a));
  SET_VECTOR_ELT(state, 460, ScalarInteger(main_model_p->dim_eP1b));
  SET_VECTOR_ELT(state, 461, allocVector(REALSXP, main_model_p->dim_eP1b));
  memcpy(REAL(VECTOR_ELT(state, 461)), main_model_p->eP1b, main_model_p->dim_eP1b * sizeof(double));
  SET_VECTOR_ELT(state, 462, ScalarInteger(main_model_p->offset_output_eP1b));
  SET_VECTOR_ELT(state, 463, ScalarInteger(main_model_p->dim_eP1c));
  SET_VECTOR_ELT(state, 464, allocVector(REALSXP, main_model_p->dim_eP1c));
  memcpy(REAL(VECTOR_ELT(state, 464)), main_model_p->eP1c, main_model_p->dim_eP1c * sizeof(double));
  SET_VECTOR_ELT(state, 465, ScalarInteger(main_model_p->offset_output_eP1c));
  SET_VECTOR_ELT(state, 466, ScalarInteger(main_model_p->dim_eP1d));
  SET_VECTOR_ELT(state, 467, allocVector(REALSXP, main_model_p->dim_eP1d));
  memcpy(REAL(VECTOR_ELT(state, 467)), main_model_p->eP1d, main_model_p->dim_eP1d * sizeof(double));
  SET_VECTOR_ELT(state, 468, ScalarInteger(main_model_p->offset_output_eP1d));
  SET_VECTOR_ELT(state, 469, ScalarInteger(main_model_p->dim_fc_comm));
  SET_VECTOR_ELT(state, 470, ScalarInteger(main_model_p->dim_fc_comm_1));
  SET_VECTOR_ELT(state, 471, ScalarInteger(main_model_p->dim_fc_comm_2));
  SET_VECTOR_ELT(state, 472, allocVector(REALSXP, main_model_p->dim_fc_comm));
  memcpy(REAL(VECTOR_ELT(state, 472)), main_model_p->fc_comm, main_model_p->dim_fc_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 472), 2, main_model_p->dim_fc_comm_1, main_model_p->dim_fc_comm_2);
  SET_VECTOR_ELT(state, 473, ScalarInteger(main_model_p->offset_output_fc_comm));
  SET_VECTOR_ELT(state, 474, ScalarInteger(main_model_p->dim_fP_comm));
  SET_VECTOR_ELT(state, 475, allocVector(REALSXP, main_model_p->dim_fP_comm));
  memcpy(REAL(VECTOR_ELT(state, 475)), main_model_p->fP_comm, main_model_p->dim_fP_comm * sizeof(double));
  SET_VECTOR_ELT(state, 476, ScalarInteger(main_model_p->offset_output_fP_comm));
  SET_VECTOR_ELT(state, 477, ScalarInteger(main_model_p->dim_fc_noncomm));
  SET_VECTOR_ELT(state, 478, ScalarInteger(main_model_p->dim_fc_noncomm_1));
  SET_VECTOR_ELT(state, 479, ScalarInteger(main_model_p->dim_fc_noncomm_2));
  SET_VECTOR_ELT(state, 480, allocVector(REALSXP, main_model_p->dim_fc_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 480)), main_model_p->fc_noncomm, main_model_p->dim_fc_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 480), 2, main_model_p->dim_fc_noncomm_1, main_model_p->dim_fc_noncomm_2);
  SET_VECTOR_ELT(state, 481, ScalarInteger(main_model_p->offset_output_fc_noncomm));
  SET_VECTOR_ELT(state, 482, ScalarInteger(main_model_p->dim_fP_noncomm));
  SET_VECTOR_ELT(state, 483, allocVector(REALSXP, main_model_p->dim_fP_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 483)), main_model_p->fP_noncomm, main_model_p->dim_fP_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 484, ScalarInteger(main_model_p->offset_output_fP_noncomm));
  SET_VECTOR_ELT(state, 485, ScalarInteger(main_model_p->dim_n_comm));
  SET_VECTOR_ELT(state, 486, ScalarInteger(main_model_p->dim_n_comm_1));
  SET_VECTOR_ELT(state, 487, ScalarInteger(main_model_p->dim_n_comm_2));
  SET_VECTOR_ELT(state, 488, allocVector(REALSXP, main_model_p->dim_n_comm));
  memcpy(REAL(VECTOR_ELT(state, 488)), main_model_p->n_comm, main_model_p->dim_n_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 488), 2, main_model_p->dim_n_comm_1, main_model_p->dim_n_comm_2);
  SET_VECTOR_ELT(state, 489, ScalarInteger(main_model_p->offset_output_n_comm));
  SET_VECTOR_ELT(state, 490, ScalarInteger(main_model_p->dim_n_noncomm));
  SET_VECTOR_ELT(state, 491, ScalarInteger(main_model_p->dim_n_noncomm_1));
  SET_VECTOR_ELT(state, 492, ScalarInteger(main_model_p->dim_n_noncomm_2));
  SET_VECTOR_ELT(state, 493, allocVector(REALSXP, main_model_p->dim_n_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 493)), main_model_p->n_noncomm, main_model_p->dim_n_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 493), 2, main_model_p->dim_n_noncomm_1, main_model_p->dim_n_noncomm_2);
  SET_VECTOR_ELT(state, 494, ScalarInteger(main_model_p->offset_output_n_noncomm));
  SET_VECTOR_ELT(state, 495, ScalarInteger(main_model_p->dim_cumuHIVDeaths));
  SET_VECTOR_ELT(state, 496, allocVector(REALSXP, main_model_p->dim_cumuHIVDeaths));
  memcpy(REAL(VECTOR_ELT(state, 496)), main_model_p->initial_cumuHIVDeaths, main_model_p->dim_cumuHIVDeaths * sizeof(double));
  SET_VECTOR_ELT(state, 497, ScalarInteger(main_model_p->offset_cumuHIVDeaths));
  SET_VECTOR_ELT(state, 498, ScalarInteger(main_model_p->dim_cumuARTinitiations));
  SET_VECTOR_ELT(state, 499, allocVector(REALSXP, main_model_p->dim_cumuARTinitiations));
  memcpy(REAL(VECTOR_ELT(state, 499)), main_model_p->initial_cumuARTinitiations, main_model_p->dim_cumuARTinitiations * sizeof(double));
  SET_VECTOR_ELT(state, 500, ScalarInteger(main_model_p->offset_cumuARTinitiations));
  SET_VECTOR_ELT(state, 501, ScalarInteger(main_model_p->dim_TasPinitiations));
  SET_VECTOR_ELT(state, 502, allocVector(REALSXP, main_model_p->dim_TasPinitiations));
  memcpy(REAL(VECTOR_ELT(state, 502)), main_model_p->initial_TasPinitiations, main_model_p->dim_TasPinitiations * sizeof(double));
  SET_VECTOR_ELT(state, 503, ScalarInteger(main_model_p->offset_TasPinitiations));
  SET_VECTOR_ELT(state, 504, ScalarInteger(main_model_p->dim_cumuARTREinitiations));
  SET_VECTOR_ELT(state, 505, allocVector(REALSXP, main_model_p->dim_cumuARTREinitiations));
  memcpy(REAL(VECTOR_ELT(state, 505)), main_model_p->initial_cumuARTREinitiations, main_model_p->dim_cumuARTREinitiations * sizeof(double));
  SET_VECTOR_ELT(state, 506, ScalarInteger(main_model_p->offset_cumuARTREinitiations));
  SET_VECTOR_ELT(state, 507, ScalarInteger(main_model_p->dim_dropouts));
  SET_VECTOR_ELT(state, 508, allocVector(REALSXP, main_model_p->dim_dropouts));
  memcpy(REAL(VECTOR_ELT(state, 508)), main_model_p->initial_dropouts, main_model_p->dim_dropouts * sizeof(double));
  SET_VECTOR_ELT(state, 509, ScalarInteger(main_model_p->offset_dropouts));
  SET_VECTOR_ELT(state, 510, ScalarInteger(main_model_p->dim_cumuAllDeaths));
  SET_VECTOR_ELT(state, 511, allocVector(REALSXP, main_model_p->dim_cumuAllDeaths));
  memcpy(REAL(VECTOR_ELT(state, 511)), main_model_p->initial_cumuAllDeaths, main_model_p->dim_cumuAllDeaths * sizeof(double));
  SET_VECTOR_ELT(state, 512, ScalarInteger(main_model_p->offset_cumuAllDeaths));
  SET_VECTOR_ELT(state, 513, ScalarInteger(main_model_p->dim_cumuInf));
  SET_VECTOR_ELT(state, 514, allocVector(REALSXP, main_model_p->dim_cumuInf));
  memcpy(REAL(VECTOR_ELT(state, 514)), main_model_p->initial_cumuInf, main_model_p->dim_cumuInf * sizeof(double));
  SET_VECTOR_ELT(state, 515, ScalarInteger(main_model_p->offset_cumuInf));
  SET_VECTOR_ELT(state, 516, ScalarInteger(main_model_p->dim_PrEPinitiations));
  SET_VECTOR_ELT(state, 517, allocVector(REALSXP, main_model_p->dim_PrEPinitiations));
  memcpy(REAL(VECTOR_ELT(state, 517)), main_model_p->initial_PrEPinitiations, main_model_p->dim_PrEPinitiations * sizeof(double));
  SET_VECTOR_ELT(state, 518, ScalarInteger(main_model_p->offset_PrEPinitiations));
  SET_VECTOR_ELT(state, 519, ScalarInteger(main_model_p->dim_PrEPinitiations1a));
  SET_VECTOR_ELT(state, 520, allocVector(REALSXP, main_model_p->dim_PrEPinitiations1a));
  memcpy(REAL(VECTOR_ELT(state, 520)), main_model_p->initial_PrEPinitiations1a, main_model_p->dim_PrEPinitiations1a * sizeof(double));
  SET_VECTOR_ELT(state, 521, ScalarInteger(main_model_p->offset_PrEPinitiations1a));
  SET_VECTOR_ELT(state, 522, ScalarInteger(main_model_p->dim_PrEPinitiations1b));
  SET_VECTOR_ELT(state, 523, allocVector(REALSXP, main_model_p->dim_PrEPinitiations1b));
  memcpy(REAL(VECTOR_ELT(state, 523)), main_model_p->initial_PrEPinitiations1b, main_model_p->dim_PrEPinitiations1b * sizeof(double));
  SET_VECTOR_ELT(state, 524, ScalarInteger(main_model_p->offset_PrEPinitiations1b));
  SET_VECTOR_ELT(state, 525, ScalarInteger(main_model_p->dim_PrEPinitiations1c));
  SET_VECTOR_ELT(state, 526, allocVector(REALSXP, main_model_p->dim_PrEPinitiations1c));
  memcpy(REAL(VECTOR_ELT(state, 526)), main_model_p->initial_PrEPinitiations1c, main_model_p->dim_PrEPinitiations1c * sizeof(double));
  SET_VECTOR_ELT(state, 527, ScalarInteger(main_model_p->offset_PrEPinitiations1c));
  SET_VECTOR_ELT(state, 528, ScalarInteger(main_model_p->dim_S0));
  SET_VECTOR_ELT(state, 529, allocVector(REALSXP, main_model_p->dim_S0));
  memcpy(REAL(VECTOR_ELT(state, 529)), main_model_p->initial_S0, main_model_p->dim_S0 * sizeof(double));
  SET_VECTOR_ELT(state, 530, ScalarInteger(main_model_p->offset_S0));
  SET_VECTOR_ELT(state, 531, ScalarInteger(main_model_p->dim_S1a));
  SET_VECTOR_ELT(state, 532, allocVector(REALSXP, main_model_p->dim_S1a));
  memcpy(REAL(VECTOR_ELT(state, 532)), main_model_p->initial_S1a, main_model_p->dim_S1a * sizeof(double));
  SET_VECTOR_ELT(state, 533, ScalarInteger(main_model_p->offset_S1a));
  SET_VECTOR_ELT(state, 534, ScalarInteger(main_model_p->dim_S1b));
  SET_VECTOR_ELT(state, 535, allocVector(REALSXP, main_model_p->dim_S1b));
  memcpy(REAL(VECTOR_ELT(state, 535)), main_model_p->initial_S1b, main_model_p->dim_S1b * sizeof(double));
  SET_VECTOR_ELT(state, 536, ScalarInteger(main_model_p->offset_S1b));
  SET_VECTOR_ELT(state, 537, ScalarInteger(main_model_p->dim_S1c));
  SET_VECTOR_ELT(state, 538, allocVector(REALSXP, main_model_p->dim_S1c));
  memcpy(REAL(VECTOR_ELT(state, 538)), main_model_p->initial_S1c, main_model_p->dim_S1c * sizeof(double));
  SET_VECTOR_ELT(state, 539, ScalarInteger(main_model_p->offset_S1c));
  SET_VECTOR_ELT(state, 540, ScalarInteger(main_model_p->dim_S1d));
  SET_VECTOR_ELT(state, 541, allocVector(REALSXP, main_model_p->dim_S1d));
  memcpy(REAL(VECTOR_ELT(state, 541)), main_model_p->initial_S1d, main_model_p->dim_S1d * sizeof(double));
  SET_VECTOR_ELT(state, 542, ScalarInteger(main_model_p->offset_S1d));
  SET_VECTOR_ELT(state, 543, ScalarInteger(main_model_p->dim_I01));
  SET_VECTOR_ELT(state, 544, allocVector(REALSXP, main_model_p->dim_I01));
  memcpy(REAL(VECTOR_ELT(state, 544)), main_model_p->initial_I01, main_model_p->dim_I01 * sizeof(double));
  SET_VECTOR_ELT(state, 545, ScalarInteger(main_model_p->offset_I01));
  SET_VECTOR_ELT(state, 546, ScalarInteger(main_model_p->dim_I11));
  SET_VECTOR_ELT(state, 547, allocVector(REALSXP, main_model_p->dim_I11));
  memcpy(REAL(VECTOR_ELT(state, 547)), main_model_p->initial_I11, main_model_p->dim_I11 * sizeof(double));
  SET_VECTOR_ELT(state, 548, ScalarInteger(main_model_p->offset_I11));
  SET_VECTOR_ELT(state, 549, ScalarInteger(main_model_p->dim_I02));
  SET_VECTOR_ELT(state, 550, allocVector(REALSXP, main_model_p->dim_I02));
  memcpy(REAL(VECTOR_ELT(state, 550)), main_model_p->initial_I02, main_model_p->dim_I02 * sizeof(double));
  SET_VECTOR_ELT(state, 551, ScalarInteger(main_model_p->offset_I02));
  SET_VECTOR_ELT(state, 552, ScalarInteger(main_model_p->dim_I03));
  SET_VECTOR_ELT(state, 553, allocVector(REALSXP, main_model_p->dim_I03));
  memcpy(REAL(VECTOR_ELT(state, 553)), main_model_p->initial_I03, main_model_p->dim_I03 * sizeof(double));
  SET_VECTOR_ELT(state, 554, ScalarInteger(main_model_p->offset_I03));
  SET_VECTOR_ELT(state, 555, ScalarInteger(main_model_p->dim_I04));
  SET_VECTOR_ELT(state, 556, allocVector(REALSXP, main_model_p->dim_I04));
  memcpy(REAL(VECTOR_ELT(state, 556)), main_model_p->initial_I04, main_model_p->dim_I04 * sizeof(double));
  SET_VECTOR_ELT(state, 557, ScalarInteger(main_model_p->offset_I04));
  SET_VECTOR_ELT(state, 558, ScalarInteger(main_model_p->dim_I05));
  SET_VECTOR_ELT(state, 559, allocVector(REALSXP, main_model_p->dim_I05));
  memcpy(REAL(VECTOR_ELT(state, 559)), main_model_p->initial_I05, main_model_p->dim_I05 * sizeof(double));
  SET_VECTOR_ELT(state, 560, ScalarInteger(main_model_p->offset_I05));
  SET_VECTOR_ELT(state, 561, ScalarInteger(main_model_p->dim_I22));
  SET_VECTOR_ELT(state, 562, allocVector(REALSXP, main_model_p->dim_I22));
  memcpy(REAL(VECTOR_ELT(state, 562)), main_model_p->initial_I22, main_model_p->dim_I22 * sizeof(double));
  SET_VECTOR_ELT(state, 563, ScalarInteger(main_model_p->offset_I22));
  SET_VECTOR_ELT(state, 564, ScalarInteger(main_model_p->dim_I23));
  SET_VECTOR_ELT(state, 565, allocVector(REALSXP, main_model_p->dim_I23));
  memcpy(REAL(VECTOR_ELT(state, 565)), main_model_p->initial_I23, main_model_p->dim_I23 * sizeof(double));
  SET_VECTOR_ELT(state, 566, ScalarInteger(main_model_p->offset_I23));
  SET_VECTOR_ELT(state, 567, ScalarInteger(main_model_p->dim_I24));
  SET_VECTOR_ELT(state, 568, allocVector(REALSXP, main_model_p->dim_I24));
  memcpy(REAL(VECTOR_ELT(state, 568)), main_model_p->initial_I24, main_model_p->dim_I24 * sizeof(double));
  SET_VECTOR_ELT(state, 569, ScalarInteger(main_model_p->offset_I24));
  SET_VECTOR_ELT(state, 570, ScalarInteger(main_model_p->dim_I25));
  SET_VECTOR_ELT(state, 571, allocVector(REALSXP, main_model_p->dim_I25));
  memcpy(REAL(VECTOR_ELT(state, 571)), main_model_p->initial_I25, main_model_p->dim_I25 * sizeof(double));
  SET_VECTOR_ELT(state, 572, ScalarInteger(main_model_p->offset_I25));
  SET_VECTOR_ELT(state, 573, ScalarInteger(main_model_p->dim_I32));
  SET_VECTOR_ELT(state, 574, allocVector(REALSXP, main_model_p->dim_I32));
  memcpy(REAL(VECTOR_ELT(state, 574)), main_model_p->initial_I32, main_model_p->dim_I32 * sizeof(double));
  SET_VECTOR_ELT(state, 575, ScalarInteger(main_model_p->offset_I32));
  SET_VECTOR_ELT(state, 576, ScalarInteger(main_model_p->dim_I33));
  SET_VECTOR_ELT(state, 577, allocVector(REALSXP, main_model_p->dim_I33));
  memcpy(REAL(VECTOR_ELT(state, 577)), main_model_p->initial_I33, main_model_p->dim_I33 * sizeof(double));
  SET_VECTOR_ELT(state, 578, ScalarInteger(main_model_p->offset_I33));
  SET_VECTOR_ELT(state, 579, ScalarInteger(main_model_p->dim_I34));
  SET_VECTOR_ELT(state, 580, allocVector(REALSXP, main_model_p->dim_I34));
  memcpy(REAL(VECTOR_ELT(state, 580)), main_model_p->initial_I34, main_model_p->dim_I34 * sizeof(double));
  SET_VECTOR_ELT(state, 581, ScalarInteger(main_model_p->offset_I34));
  SET_VECTOR_ELT(state, 582, ScalarInteger(main_model_p->dim_I35));
  SET_VECTOR_ELT(state, 583, allocVector(REALSXP, main_model_p->dim_I35));
  memcpy(REAL(VECTOR_ELT(state, 583)), main_model_p->initial_I35, main_model_p->dim_I35 * sizeof(double));
  SET_VECTOR_ELT(state, 584, ScalarInteger(main_model_p->offset_I35));
  SET_VECTOR_ELT(state, 585, ScalarInteger(main_model_p->dim_I42));
  SET_VECTOR_ELT(state, 586, allocVector(REALSXP, main_model_p->dim_I42));
  memcpy(REAL(VECTOR_ELT(state, 586)), main_model_p->initial_I42, main_model_p->dim_I42 * sizeof(double));
  SET_VECTOR_ELT(state, 587, ScalarInteger(main_model_p->offset_I42));
  SET_VECTOR_ELT(state, 588, ScalarInteger(main_model_p->dim_I43));
  SET_VECTOR_ELT(state, 589, allocVector(REALSXP, main_model_p->dim_I43));
  memcpy(REAL(VECTOR_ELT(state, 589)), main_model_p->initial_I43, main_model_p->dim_I43 * sizeof(double));
  SET_VECTOR_ELT(state, 590, ScalarInteger(main_model_p->offset_I43));
  SET_VECTOR_ELT(state, 591, ScalarInteger(main_model_p->dim_I44));
  SET_VECTOR_ELT(state, 592, allocVector(REALSXP, main_model_p->dim_I44));
  memcpy(REAL(VECTOR_ELT(state, 592)), main_model_p->initial_I44, main_model_p->dim_I44 * sizeof(double));
  SET_VECTOR_ELT(state, 593, ScalarInteger(main_model_p->offset_I44));
  SET_VECTOR_ELT(state, 594, ScalarInteger(main_model_p->dim_I45));
  SET_VECTOR_ELT(state, 595, allocVector(REALSXP, main_model_p->dim_I45));
  memcpy(REAL(VECTOR_ELT(state, 595)), main_model_p->initial_I45, main_model_p->dim_I45 * sizeof(double));
  SET_VECTOR_ELT(state, 596, ScalarInteger(main_model_p->offset_I45));
  SET_VECTOR_ELT(state, 597, ScalarInteger(main_model_p->dim_S0_init));
  SET_VECTOR_ELT(state, 598, allocVector(REALSXP, main_model_p->dim_S0_init));
  memcpy(REAL(VECTOR_ELT(state, 598)), main_model_p->S0_init, main_model_p->dim_S0_init * sizeof(double));
  SET_VECTOR_ELT(state, 599, ScalarInteger(main_model_p->dim_S1a_init));
  SET_VECTOR_ELT(state, 600, allocVector(REALSXP, main_model_p->dim_S1a_init));
  memcpy(REAL(VECTOR_ELT(state, 600)), main_model_p->S1a_init, main_model_p->dim_S1a_init * sizeof(double));
  SET_VECTOR_ELT(state, 601, ScalarInteger(main_model_p->dim_S1b_init));
  SET_VECTOR_ELT(state, 602, allocVector(REALSXP, main_model_p->dim_S1b_init));
  memcpy(REAL(VECTOR_ELT(state, 602)), main_model_p->S1b_init, main_model_p->dim_S1b_init * sizeof(double));
  SET_VECTOR_ELT(state, 603, ScalarInteger(main_model_p->dim_S1c_init));
  SET_VECTOR_ELT(state, 604, allocVector(REALSXP, main_model_p->dim_S1c_init));
  memcpy(REAL(VECTOR_ELT(state, 604)), main_model_p->S1c_init, main_model_p->dim_S1c_init * sizeof(double));
  SET_VECTOR_ELT(state, 605, ScalarInteger(main_model_p->dim_S1d_init));
  SET_VECTOR_ELT(state, 606, allocVector(REALSXP, main_model_p->dim_S1d_init));
  memcpy(REAL(VECTOR_ELT(state, 606)), main_model_p->S1d_init, main_model_p->dim_S1d_init * sizeof(double));
  SET_VECTOR_ELT(state, 607, ScalarInteger(main_model_p->dim_I01_init));
  SET_VECTOR_ELT(state, 608, allocVector(REALSXP, main_model_p->dim_I01_init));
  memcpy(REAL(VECTOR_ELT(state, 608)), main_model_p->I01_init, main_model_p->dim_I01_init * sizeof(double));
  SET_VECTOR_ELT(state, 609, ScalarInteger(main_model_p->dim_I11_init));
  SET_VECTOR_ELT(state, 610, allocVector(REALSXP, main_model_p->dim_I11_init));
  memcpy(REAL(VECTOR_ELT(state, 610)), main_model_p->I11_init, main_model_p->dim_I11_init * sizeof(double));
  SET_VECTOR_ELT(state, 611, ScalarInteger(main_model_p->dim_I02_init));
  SET_VECTOR_ELT(state, 612, allocVector(REALSXP, main_model_p->dim_I02_init));
  memcpy(REAL(VECTOR_ELT(state, 612)), main_model_p->I02_init, main_model_p->dim_I02_init * sizeof(double));
  SET_VECTOR_ELT(state, 613, ScalarInteger(main_model_p->dim_I03_init));
  SET_VECTOR_ELT(state, 614, allocVector(REALSXP, main_model_p->dim_I03_init));
  memcpy(REAL(VECTOR_ELT(state, 614)), main_model_p->I03_init, main_model_p->dim_I03_init * sizeof(double));
  SET_VECTOR_ELT(state, 615, ScalarInteger(main_model_p->dim_I04_init));
  SET_VECTOR_ELT(state, 616, allocVector(REALSXP, main_model_p->dim_I04_init));
  memcpy(REAL(VECTOR_ELT(state, 616)), main_model_p->I04_init, main_model_p->dim_I04_init * sizeof(double));
  SET_VECTOR_ELT(state, 617, ScalarInteger(main_model_p->dim_I05_init));
  SET_VECTOR_ELT(state, 618, allocVector(REALSXP, main_model_p->dim_I05_init));
  memcpy(REAL(VECTOR_ELT(state, 618)), main_model_p->I05_init, main_model_p->dim_I05_init * sizeof(double));
  SET_VECTOR_ELT(state, 619, ScalarInteger(main_model_p->dim_I22_init));
  SET_VECTOR_ELT(state, 620, allocVector(REALSXP, main_model_p->dim_I22_init));
  memcpy(REAL(VECTOR_ELT(state, 620)), main_model_p->I22_init, main_model_p->dim_I22_init * sizeof(double));
  SET_VECTOR_ELT(state, 621, ScalarInteger(main_model_p->dim_I23_init));
  SET_VECTOR_ELT(state, 622, allocVector(REALSXP, main_model_p->dim_I23_init));
  memcpy(REAL(VECTOR_ELT(state, 622)), main_model_p->I23_init, main_model_p->dim_I23_init * sizeof(double));
  SET_VECTOR_ELT(state, 623, ScalarInteger(main_model_p->dim_I24_init));
  SET_VECTOR_ELT(state, 624, allocVector(REALSXP, main_model_p->dim_I24_init));
  memcpy(REAL(VECTOR_ELT(state, 624)), main_model_p->I24_init, main_model_p->dim_I24_init * sizeof(double));
  SET_VECTOR_ELT(state, 625, ScalarInteger(main_model_p->dim_I25_init));
  SET_VECTOR_ELT(state, 626, allocVector(REALSXP, main_model_p->dim_I25_init));
  memcpy(REAL(VECTOR_ELT(state, 626)), main_model_p->I25_init, main_model_p->dim_I25_init * sizeof(double));
  SET_VECTOR_ELT(state, 627, ScalarInteger(main_model_p->dim_I32_init));
  SET_VECTOR_ELT(state, 628, allocVector(REALSXP, main_model_p->dim_I32_init));
  memcpy(REAL(VECTOR_ELT(state, 628)), main_model_p->I32_init, main_model_p->dim_I32_init * sizeof(double));
  SET_VECTOR_ELT(state, 629, ScalarInteger(main_model_p->dim_I33_init));
  SET_VECTOR_ELT(state, 630, allocVector(REALSXP, main_model_p->dim_I33_init));
  memcpy(REAL(VECTOR_ELT(state, 630)), main_model_p->I33_init, main_model_p->dim_I33_init * sizeof(double));
  SET_VECTOR_ELT(state, 631, ScalarInteger(main_model_p->dim_I34_init));
  SET_VECTOR_ELT(state, 632, allocVector(REALSXP, main_model_p->dim_I34_init));
  memcpy(REAL(VECTOR_ELT(state, 632)), main_model_p->I34_init, main_model_p->dim_I34_init * sizeof(double));
  SET_VECTOR_ELT(state, 633, ScalarInteger(main_model_p->dim_I35_init));
  SET_VECTOR_ELT(state, 634, allocVector(REALSXP, main_model_p->dim_I35_init));
  memcpy(REAL(VECTOR_ELT(state, 634)), main_model_p->I35_init, main_model_p->dim_I35_init * sizeof(double));
  SET_VECTOR_ELT(state, 635, ScalarInteger(main_model_p->dim_I42_init));
  SET_VECTOR_ELT(state, 636, allocVector(REALSXP, main_model_p->dim_I42_init));
  memcpy(REAL(VECTOR_ELT(state, 636)), main_model_p->I42_init, main_model_p->dim_I42_init * sizeof(double));
  SET_VECTOR_ELT(state, 637, ScalarInteger(main_model_p->dim_I43_init));
  SET_VECTOR_ELT(state, 638, allocVector(REALSXP, main_model_p->dim_I43_init));
  memcpy(REAL(VECTOR_ELT(state, 638)), main_model_p->I43_init, main_model_p->dim_I43_init * sizeof(double));
  SET_VECTOR_ELT(state, 639, ScalarInteger(main_model_p->dim_I44_init));
  SET_VECTOR_ELT(state, 640, allocVector(REALSXP, main_model_p->dim_I44_init));
  memcpy(REAL(VECTOR_ELT(state, 640)), main_model_p->I44_init, main_model_p->dim_I44_init * sizeof(double));
  SET_VECTOR_ELT(state, 641, ScalarInteger(main_model_p->dim_I45_init));
  SET_VECTOR_ELT(state, 642, allocVector(REALSXP, main_model_p->dim_I45_init));
  memcpy(REAL(VECTOR_ELT(state, 642)), main_model_p->I45_init, main_model_p->dim_I45_init * sizeof(double));
  SET_VECTOR_ELT(state, 643, ScalarInteger(main_model_p->dim_N));
  SET_VECTOR_ELT(state, 644, allocVector(REALSXP, main_model_p->dim_N));
  memcpy(REAL(VECTOR_ELT(state, 644)), main_model_p->N, main_model_p->dim_N * sizeof(double));
  SET_VECTOR_ELT(state, 645, ScalarInteger(main_model_p->offset_output_N));
  SET_VECTOR_ELT(state, 646, ScalarInteger(main_model_p->dim_E0));
  SET_VECTOR_ELT(state, 647, allocVector(REALSXP, main_model_p->dim_E0));
  memcpy(REAL(VECTOR_ELT(state, 647)), main_model_p->E0, main_model_p->dim_E0 * sizeof(double));
  SET_VECTOR_ELT(state, 648, ScalarInteger(main_model_p->offset_output_E0));
  SET_VECTOR_ELT(state, 649, ScalarInteger(main_model_p->dim_E1a));
  SET_VECTOR_ELT(state, 650, allocVector(REALSXP, main_model_p->dim_E1a));
  memcpy(REAL(VECTOR_ELT(state, 650)), main_model_p->E1a, main_model_p->dim_E1a * sizeof(double));
  SET_VECTOR_ELT(state, 651, ScalarInteger(main_model_p->offset_output_E1a));
  SET_VECTOR_ELT(state, 652, ScalarInteger(main_model_p->dim_E1b));
  SET_VECTOR_ELT(state, 653, allocVector(REALSXP, main_model_p->dim_E1b));
  memcpy(REAL(VECTOR_ELT(state, 653)), main_model_p->E1b, main_model_p->dim_E1b * sizeof(double));
  SET_VECTOR_ELT(state, 654, ScalarInteger(main_model_p->offset_output_E1b));
  SET_VECTOR_ELT(state, 655, ScalarInteger(main_model_p->dim_E1c));
  SET_VECTOR_ELT(state, 656, allocVector(REALSXP, main_model_p->dim_E1c));
  memcpy(REAL(VECTOR_ELT(state, 656)), main_model_p->E1c, main_model_p->dim_E1c * sizeof(double));
  SET_VECTOR_ELT(state, 657, ScalarInteger(main_model_p->offset_output_E1c));
  SET_VECTOR_ELT(state, 658, ScalarInteger(main_model_p->dim_E1d));
  SET_VECTOR_ELT(state, 659, allocVector(REALSXP, main_model_p->dim_E1d));
  memcpy(REAL(VECTOR_ELT(state, 659)), main_model_p->E1d, main_model_p->dim_E1d * sizeof(double));
  SET_VECTOR_ELT(state, 660, ScalarInteger(main_model_p->offset_output_E1d));
  SET_VECTOR_ELT(state, 661, ScalarInteger(main_model_p->dim_cumuInf_init));
  SET_VECTOR_ELT(state, 662, allocVector(REALSXP, main_model_p->dim_cumuInf_init));
  memcpy(REAL(VECTOR_ELT(state, 662)), main_model_p->cumuInf_init, main_model_p->dim_cumuInf_init * sizeof(double));
  SET_VECTOR_ELT(state, 663, ScalarInteger(main_model_p->dim_alphaItot));
  SET_VECTOR_ELT(state, 664, allocVector(REALSXP, main_model_p->dim_alphaItot));
  memcpy(REAL(VECTOR_ELT(state, 664)), main_model_p->alphaItot, main_model_p->dim_alphaItot * sizeof(double));
  SET_VECTOR_ELT(state, 665, ScalarInteger(main_model_p->offset_output_alphaItot));
  SET_VECTOR_ELT(state, 666, ScalarInteger(main_model_p->dim_prev));
  SET_VECTOR_ELT(state, 667, allocVector(REALSXP, main_model_p->dim_prev));
  memcpy(REAL(VECTOR_ELT(state, 667)), main_model_p->prev, main_model_p->dim_prev * sizeof(double));
  SET_VECTOR_ELT(state, 668, ScalarInteger(main_model_p->offset_output_prev));
  SET_VECTOR_ELT(state, 669, ScalarInteger(main_model_p->dim_lambda));
  SET_VECTOR_ELT(state, 670, ScalarInteger(main_model_p->dim_lambda_1));
  SET_VECTOR_ELT(state, 671, ScalarInteger(main_model_p->dim_lambda_2));
  SET_VECTOR_ELT(state, 672, allocVector(REALSXP, main_model_p->dim_lambda));
  memcpy(REAL(VECTOR_ELT(state, 672)), main_model_p->lambda, main_model_p->dim_lambda * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 672), 2, main_model_p->dim_lambda_1, main_model_p->dim_lambda_2);
  SET_VECTOR_ELT(state, 673, ScalarInteger(main_model_p->offset_output_lambda));
  SET_VECTOR_ELT(state, 674, ScalarInteger(main_model_p->dim_lambda_0));
  SET_VECTOR_ELT(state, 675, ScalarInteger(main_model_p->dim_lambda_0_1));
  SET_VECTOR_ELT(state, 676, ScalarInteger(main_model_p->dim_lambda_0_2));
  SET_VECTOR_ELT(state, 677, allocVector(REALSXP, main_model_p->dim_lambda_0));
  memcpy(REAL(VECTOR_ELT(state, 677)), main_model_p->lambda_0, main_model_p->dim_lambda_0 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 677), 2, main_model_p->dim_lambda_0_1, main_model_p->dim_lambda_0_2);
  SET_VECTOR_ELT(state, 678, ScalarInteger(main_model_p->offset_output_lambda_0));
  SET_VECTOR_ELT(state, 679, ScalarInteger(main_model_p->dim_lambda_1a));
  SET_VECTOR_ELT(state, 680, ScalarInteger(main_model_p->dim_lambda_1a_1));
  SET_VECTOR_ELT(state, 681, ScalarInteger(main_model_p->dim_lambda_1a_2));
  SET_VECTOR_ELT(state, 682, allocVector(REALSXP, main_model_p->dim_lambda_1a));
  memcpy(REAL(VECTOR_ELT(state, 682)), main_model_p->lambda_1a, main_model_p->dim_lambda_1a * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 682), 2, main_model_p->dim_lambda_1a_1, main_model_p->dim_lambda_1a_2);
  SET_VECTOR_ELT(state, 683, ScalarInteger(main_model_p->offset_output_lambda_1a));
  SET_VECTOR_ELT(state, 684, ScalarInteger(main_model_p->dim_lambda_1b));
  SET_VECTOR_ELT(state, 685, ScalarInteger(main_model_p->dim_lambda_1b_1));
  SET_VECTOR_ELT(state, 686, ScalarInteger(main_model_p->dim_lambda_1b_2));
  SET_VECTOR_ELT(state, 687, allocVector(REALSXP, main_model_p->dim_lambda_1b));
  memcpy(REAL(VECTOR_ELT(state, 687)), main_model_p->lambda_1b, main_model_p->dim_lambda_1b * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 687), 2, main_model_p->dim_lambda_1b_1, main_model_p->dim_lambda_1b_2);
  SET_VECTOR_ELT(state, 688, ScalarInteger(main_model_p->offset_output_lambda_1b));
  SET_VECTOR_ELT(state, 689, ScalarInteger(main_model_p->dim_lambda_1c));
  SET_VECTOR_ELT(state, 690, ScalarInteger(main_model_p->dim_lambda_1c_1));
  SET_VECTOR_ELT(state, 691, ScalarInteger(main_model_p->dim_lambda_1c_2));
  SET_VECTOR_ELT(state, 692, allocVector(REALSXP, main_model_p->dim_lambda_1c));
  memcpy(REAL(VECTOR_ELT(state, 692)), main_model_p->lambda_1c, main_model_p->dim_lambda_1c * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 692), 2, main_model_p->dim_lambda_1c_1, main_model_p->dim_lambda_1c_2);
  SET_VECTOR_ELT(state, 693, ScalarInteger(main_model_p->offset_output_lambda_1c));
  SET_VECTOR_ELT(state, 694, ScalarInteger(main_model_p->dim_lambda_1d));
  SET_VECTOR_ELT(state, 695, ScalarInteger(main_model_p->dim_lambda_1d_1));
  SET_VECTOR_ELT(state, 696, ScalarInteger(main_model_p->dim_lambda_1d_2));
  SET_VECTOR_ELT(state, 697, allocVector(REALSXP, main_model_p->dim_lambda_1d));
  memcpy(REAL(VECTOR_ELT(state, 697)), main_model_p->lambda_1d, main_model_p->dim_lambda_1d * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 697), 2, main_model_p->dim_lambda_1d_1, main_model_p->dim_lambda_1d_2);
  SET_VECTOR_ELT(state, 698, ScalarInteger(main_model_p->offset_output_lambda_1d));
  SET_VECTOR_ELT(state, 699, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_VECTOR_ELT(state, 700, allocVector(REALSXP, main_model_p->dim_lambda_sum_0));
  memcpy(REAL(VECTOR_ELT(state, 700)), main_model_p->lambda_sum_0, main_model_p->dim_lambda_sum_0 * sizeof(double));
  SET_VECTOR_ELT(state, 701, ScalarInteger(main_model_p->offset_output_lambda_sum_0));
  SET_VECTOR_ELT(state, 702, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_VECTOR_ELT(state, 703, allocVector(REALSXP, main_model_p->dim_lambda_sum_1a));
  memcpy(REAL(VECTOR_ELT(state, 703)), main_model_p->lambda_sum_1a, main_model_p->dim_lambda_sum_1a * sizeof(double));
  SET_VECTOR_ELT(state, 704, ScalarInteger(main_model_p->offset_output_lambda_sum_1a));
  SET_VECTOR_ELT(state, 705, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_VECTOR_ELT(state, 706, allocVector(REALSXP, main_model_p->dim_lambda_sum_1b));
  memcpy(REAL(VECTOR_ELT(state, 706)), main_model_p->lambda_sum_1b, main_model_p->dim_lambda_sum_1b * sizeof(double));
  SET_VECTOR_ELT(state, 707, ScalarInteger(main_model_p->offset_output_lambda_sum_1b));
  SET_VECTOR_ELT(state, 708, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_VECTOR_ELT(state, 709, allocVector(REALSXP, main_model_p->dim_lambda_sum_1c));
  memcpy(REAL(VECTOR_ELT(state, 709)), main_model_p->lambda_sum_1c, main_model_p->dim_lambda_sum_1c * sizeof(double));
  SET_VECTOR_ELT(state, 710, ScalarInteger(main_model_p->offset_output_lambda_sum_1c));
  SET_VECTOR_ELT(state, 711, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_VECTOR_ELT(state, 712, allocVector(REALSXP, main_model_p->dim_lambda_sum_1d));
  memcpy(REAL(VECTOR_ELT(state, 712)), main_model_p->lambda_sum_1d, main_model_p->dim_lambda_sum_1d * sizeof(double));
  SET_VECTOR_ELT(state, 713, ScalarInteger(main_model_p->offset_output_lambda_sum_1d));
  SET_VECTOR_ELT(state, 714, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_VECTOR_ELT(state, 715, allocVector(REALSXP, main_model_p->dim_c_comm_balanced));
  memcpy(REAL(VECTOR_ELT(state, 715)), main_model_p->c_comm_balanced, main_model_p->dim_c_comm_balanced * sizeof(double));
  SET_VECTOR_ELT(state, 716, ScalarInteger(main_model_p->offset_output_c_comm_balanced));
  SET_VECTOR_ELT(state, 717, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_VECTOR_ELT(state, 718, allocVector(REALSXP, main_model_p->dim_c_noncomm_balanced));
  memcpy(REAL(VECTOR_ELT(state, 718)), main_model_p->c_noncomm_balanced, main_model_p->dim_c_noncomm_balanced * sizeof(double));
  SET_VECTOR_ELT(state, 719, ScalarInteger(main_model_p->offset_output_c_noncomm_balanced));
  SET_VECTOR_ELT(state, 720, ScalarInteger(main_model_p->dim_theta));
  SET_VECTOR_ELT(state, 721, ScalarInteger(main_model_p->dim_theta_1));
  SET_VECTOR_ELT(state, 722, ScalarInteger(main_model_p->dim_theta_2));
  SET_VECTOR_ELT(state, 723, allocVector(REALSXP, main_model_p->dim_theta));
  memcpy(REAL(VECTOR_ELT(state, 723)), main_model_p->theta, main_model_p->dim_theta * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 723), 2, main_model_p->dim_theta_1, main_model_p->dim_theta_2);
  SET_VECTOR_ELT(state, 724, ScalarInteger(main_model_p->offset_output_theta));
  SET_VECTOR_ELT(state, 725, ScalarInteger(main_model_p->dim_PrEPinitiations_init));
  SET_VECTOR_ELT(state, 726, allocVector(REALSXP, main_model_p->dim_PrEPinitiations_init));
  memcpy(REAL(VECTOR_ELT(state, 726)), main_model_p->PrEPinitiations_init, main_model_p->dim_PrEPinitiations_init * sizeof(double));
  SET_VECTOR_ELT(state, 727, ScalarInteger(main_model_p->dim_M_comm));
  SET_VECTOR_ELT(state, 728, ScalarInteger(main_model_p->dim_M_comm_1));
  SET_VECTOR_ELT(state, 729, ScalarInteger(main_model_p->dim_M_comm_2));
  SET_VECTOR_ELT(state, 730, allocVector(REALSXP, main_model_p->dim_M_comm));
  memcpy(REAL(VECTOR_ELT(state, 730)), main_model_p->M_comm, main_model_p->dim_M_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 730), 2, main_model_p->dim_M_comm_1, main_model_p->dim_M_comm_2);
  SET_VECTOR_ELT(state, 731, ScalarInteger(main_model_p->offset_output_M_comm));
  SET_VECTOR_ELT(state, 732, ScalarInteger(main_model_p->dim_M_noncomm));
  SET_VECTOR_ELT(state, 733, ScalarInteger(main_model_p->dim_M_noncomm_1));
  SET_VECTOR_ELT(state, 734, ScalarInteger(main_model_p->dim_M_noncomm_2));
  SET_VECTOR_ELT(state, 735, allocVector(REALSXP, main_model_p->dim_M_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 735)), main_model_p->M_noncomm, main_model_p->dim_M_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 735), 2, main_model_p->dim_M_noncomm_1, main_model_p->dim_M_noncomm_2);
  SET_VECTOR_ELT(state, 736, ScalarInteger(main_model_p->offset_output_M_noncomm));
  SET_VECTOR_ELT(state, 737, ScalarInteger(main_model_p->dim_in_S0));
  SET_VECTOR_ELT(state, 738, ScalarInteger(main_model_p->dim_in_S0_1));
  SET_VECTOR_ELT(state, 739, ScalarInteger(main_model_p->dim_in_S0_2));
  SET_VECTOR_ELT(state, 740, allocVector(REALSXP, main_model_p->dim_in_S0));
  memcpy(REAL(VECTOR_ELT(state, 740)), main_model_p->in_S0, main_model_p->dim_in_S0 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 740), 2, main_model_p->dim_in_S0_1, main_model_p->dim_in_S0_2);
  SET_VECTOR_ELT(state, 741, ScalarInteger(main_model_p->dim_in_S1a));
  SET_VECTOR_ELT(state, 742, ScalarInteger(main_model_p->dim_in_S1a_1));
  SET_VECTOR_ELT(state, 743, ScalarInteger(main_model_p->dim_in_S1a_2));
  SET_VECTOR_ELT(state, 744, allocVector(REALSXP, main_model_p->dim_in_S1a));
  memcpy(REAL(VECTOR_ELT(state, 744)), main_model_p->in_S1a, main_model_p->dim_in_S1a * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 744), 2, main_model_p->dim_in_S1a_1, main_model_p->dim_in_S1a_2);
  SET_VECTOR_ELT(state, 745, ScalarInteger(main_model_p->dim_in_S1b));
  SET_VECTOR_ELT(state, 746, ScalarInteger(main_model_p->dim_in_S1b_1));
  SET_VECTOR_ELT(state, 747, ScalarInteger(main_model_p->dim_in_S1b_2));
  SET_VECTOR_ELT(state, 748, allocVector(REALSXP, main_model_p->dim_in_S1b));
  memcpy(REAL(VECTOR_ELT(state, 748)), main_model_p->in_S1b, main_model_p->dim_in_S1b * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 748), 2, main_model_p->dim_in_S1b_1, main_model_p->dim_in_S1b_2);
  SET_VECTOR_ELT(state, 749, ScalarInteger(main_model_p->dim_in_S1c));
  SET_VECTOR_ELT(state, 750, ScalarInteger(main_model_p->dim_in_S1c_1));
  SET_VECTOR_ELT(state, 751, ScalarInteger(main_model_p->dim_in_S1c_2));
  SET_VECTOR_ELT(state, 752, allocVector(REALSXP, main_model_p->dim_in_S1c));
  memcpy(REAL(VECTOR_ELT(state, 752)), main_model_p->in_S1c, main_model_p->dim_in_S1c * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 752), 2, main_model_p->dim_in_S1c_1, main_model_p->dim_in_S1c_2);
  SET_VECTOR_ELT(state, 753, ScalarInteger(main_model_p->dim_in_S1d));
  SET_VECTOR_ELT(state, 754, ScalarInteger(main_model_p->dim_in_S1d_1));
  SET_VECTOR_ELT(state, 755, ScalarInteger(main_model_p->dim_in_S1d_2));
  SET_VECTOR_ELT(state, 756, allocVector(REALSXP, main_model_p->dim_in_S1d));
  memcpy(REAL(VECTOR_ELT(state, 756)), main_model_p->in_S1d, main_model_p->dim_in_S1d * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 756), 2, main_model_p->dim_in_S1d_1, main_model_p->dim_in_S1d_2);
  SET_VECTOR_ELT(state, 757, ScalarInteger(main_model_p->dim_in_I01));
  SET_VECTOR_ELT(state, 758, ScalarInteger(main_model_p->dim_in_I01_1));
  SET_VECTOR_ELT(state, 759, ScalarInteger(main_model_p->dim_in_I01_2));
  SET_VECTOR_ELT(state, 760, allocVector(REALSXP, main_model_p->dim_in_I01));
  memcpy(REAL(VECTOR_ELT(state, 760)), main_model_p->in_I01, main_model_p->dim_in_I01 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 760), 2, main_model_p->dim_in_I01_1, main_model_p->dim_in_I01_2);
  SET_VECTOR_ELT(state, 761, ScalarInteger(main_model_p->dim_in_I11));
  SET_VECTOR_ELT(state, 762, ScalarInteger(main_model_p->dim_in_I11_1));
  SET_VECTOR_ELT(state, 763, ScalarInteger(main_model_p->dim_in_I11_2));
  SET_VECTOR_ELT(state, 764, allocVector(REALSXP, main_model_p->dim_in_I11));
  memcpy(REAL(VECTOR_ELT(state, 764)), main_model_p->in_I11, main_model_p->dim_in_I11 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 764), 2, main_model_p->dim_in_I11_1, main_model_p->dim_in_I11_2);
  SET_VECTOR_ELT(state, 765, ScalarInteger(main_model_p->dim_in_I02));
  SET_VECTOR_ELT(state, 766, ScalarInteger(main_model_p->dim_in_I02_1));
  SET_VECTOR_ELT(state, 767, ScalarInteger(main_model_p->dim_in_I02_2));
  SET_VECTOR_ELT(state, 768, allocVector(REALSXP, main_model_p->dim_in_I02));
  memcpy(REAL(VECTOR_ELT(state, 768)), main_model_p->in_I02, main_model_p->dim_in_I02 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 768), 2, main_model_p->dim_in_I02_1, main_model_p->dim_in_I02_2);
  SET_VECTOR_ELT(state, 769, ScalarInteger(main_model_p->dim_in_I03));
  SET_VECTOR_ELT(state, 770, ScalarInteger(main_model_p->dim_in_I03_1));
  SET_VECTOR_ELT(state, 771, ScalarInteger(main_model_p->dim_in_I03_2));
  SET_VECTOR_ELT(state, 772, allocVector(REALSXP, main_model_p->dim_in_I03));
  memcpy(REAL(VECTOR_ELT(state, 772)), main_model_p->in_I03, main_model_p->dim_in_I03 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 772), 2, main_model_p->dim_in_I03_1, main_model_p->dim_in_I03_2);
  SET_VECTOR_ELT(state, 773, ScalarInteger(main_model_p->dim_in_I04));
  SET_VECTOR_ELT(state, 774, ScalarInteger(main_model_p->dim_in_I04_1));
  SET_VECTOR_ELT(state, 775, ScalarInteger(main_model_p->dim_in_I04_2));
  SET_VECTOR_ELT(state, 776, allocVector(REALSXP, main_model_p->dim_in_I04));
  memcpy(REAL(VECTOR_ELT(state, 776)), main_model_p->in_I04, main_model_p->dim_in_I04 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 776), 2, main_model_p->dim_in_I04_1, main_model_p->dim_in_I04_2);
  SET_VECTOR_ELT(state, 777, ScalarInteger(main_model_p->dim_in_I05));
  SET_VECTOR_ELT(state, 778, ScalarInteger(main_model_p->dim_in_I05_1));
  SET_VECTOR_ELT(state, 779, ScalarInteger(main_model_p->dim_in_I05_2));
  SET_VECTOR_ELT(state, 780, allocVector(REALSXP, main_model_p->dim_in_I05));
  memcpy(REAL(VECTOR_ELT(state, 780)), main_model_p->in_I05, main_model_p->dim_in_I05 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 780), 2, main_model_p->dim_in_I05_1, main_model_p->dim_in_I05_2);
  SET_VECTOR_ELT(state, 781, ScalarInteger(main_model_p->dim_in_I22));
  SET_VECTOR_ELT(state, 782, ScalarInteger(main_model_p->dim_in_I22_1));
  SET_VECTOR_ELT(state, 783, ScalarInteger(main_model_p->dim_in_I22_2));
  SET_VECTOR_ELT(state, 784, allocVector(REALSXP, main_model_p->dim_in_I22));
  memcpy(REAL(VECTOR_ELT(state, 784)), main_model_p->in_I22, main_model_p->dim_in_I22 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 784), 2, main_model_p->dim_in_I22_1, main_model_p->dim_in_I22_2);
  SET_VECTOR_ELT(state, 785, ScalarInteger(main_model_p->dim_in_I23));
  SET_VECTOR_ELT(state, 786, ScalarInteger(main_model_p->dim_in_I23_1));
  SET_VECTOR_ELT(state, 787, ScalarInteger(main_model_p->dim_in_I23_2));
  SET_VECTOR_ELT(state, 788, allocVector(REALSXP, main_model_p->dim_in_I23));
  memcpy(REAL(VECTOR_ELT(state, 788)), main_model_p->in_I23, main_model_p->dim_in_I23 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 788), 2, main_model_p->dim_in_I23_1, main_model_p->dim_in_I23_2);
  SET_VECTOR_ELT(state, 789, ScalarInteger(main_model_p->dim_in_I24));
  SET_VECTOR_ELT(state, 790, ScalarInteger(main_model_p->dim_in_I24_1));
  SET_VECTOR_ELT(state, 791, ScalarInteger(main_model_p->dim_in_I24_2));
  SET_VECTOR_ELT(state, 792, allocVector(REALSXP, main_model_p->dim_in_I24));
  memcpy(REAL(VECTOR_ELT(state, 792)), main_model_p->in_I24, main_model_p->dim_in_I24 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 792), 2, main_model_p->dim_in_I24_1, main_model_p->dim_in_I24_2);
  SET_VECTOR_ELT(state, 793, ScalarInteger(main_model_p->dim_in_I25));
  SET_VECTOR_ELT(state, 794, ScalarInteger(main_model_p->dim_in_I25_1));
  SET_VECTOR_ELT(state, 795, ScalarInteger(main_model_p->dim_in_I25_2));
  SET_VECTOR_ELT(state, 796, allocVector(REALSXP, main_model_p->dim_in_I25));
  memcpy(REAL(VECTOR_ELT(state, 796)), main_model_p->in_I25, main_model_p->dim_in_I25 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 796), 2, main_model_p->dim_in_I25_1, main_model_p->dim_in_I25_2);
  SET_VECTOR_ELT(state, 797, ScalarInteger(main_model_p->dim_in_I32));
  SET_VECTOR_ELT(state, 798, ScalarInteger(main_model_p->dim_in_I32_1));
  SET_VECTOR_ELT(state, 799, ScalarInteger(main_model_p->dim_in_I32_2));
  SET_VECTOR_ELT(state, 800, allocVector(REALSXP, main_model_p->dim_in_I32));
  memcpy(REAL(VECTOR_ELT(state, 800)), main_model_p->in_I32, main_model_p->dim_in_I32 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 800), 2, main_model_p->dim_in_I32_1, main_model_p->dim_in_I32_2);
  SET_VECTOR_ELT(state, 801, ScalarInteger(main_model_p->dim_in_I33));
  SET_VECTOR_ELT(state, 802, ScalarInteger(main_model_p->dim_in_I33_1));
  SET_VECTOR_ELT(state, 803, ScalarInteger(main_model_p->dim_in_I33_2));
  SET_VECTOR_ELT(state, 804, allocVector(REALSXP, main_model_p->dim_in_I33));
  memcpy(REAL(VECTOR_ELT(state, 804)), main_model_p->in_I33, main_model_p->dim_in_I33 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 804), 2, main_model_p->dim_in_I33_1, main_model_p->dim_in_I33_2);
  SET_VECTOR_ELT(state, 805, ScalarInteger(main_model_p->dim_in_I34));
  SET_VECTOR_ELT(state, 806, ScalarInteger(main_model_p->dim_in_I34_1));
  SET_VECTOR_ELT(state, 807, ScalarInteger(main_model_p->dim_in_I34_2));
  SET_VECTOR_ELT(state, 808, allocVector(REALSXP, main_model_p->dim_in_I34));
  memcpy(REAL(VECTOR_ELT(state, 808)), main_model_p->in_I34, main_model_p->dim_in_I34 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 808), 2, main_model_p->dim_in_I34_1, main_model_p->dim_in_I34_2);
  SET_VECTOR_ELT(state, 809, ScalarInteger(main_model_p->dim_in_I35));
  SET_VECTOR_ELT(state, 810, ScalarInteger(main_model_p->dim_in_I35_1));
  SET_VECTOR_ELT(state, 811, ScalarInteger(main_model_p->dim_in_I35_2));
  SET_VECTOR_ELT(state, 812, allocVector(REALSXP, main_model_p->dim_in_I35));
  memcpy(REAL(VECTOR_ELT(state, 812)), main_model_p->in_I35, main_model_p->dim_in_I35 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 812), 2, main_model_p->dim_in_I35_1, main_model_p->dim_in_I35_2);
  SET_VECTOR_ELT(state, 813, ScalarInteger(main_model_p->dim_in_I42));
  SET_VECTOR_ELT(state, 814, ScalarInteger(main_model_p->dim_in_I42_1));
  SET_VECTOR_ELT(state, 815, ScalarInteger(main_model_p->dim_in_I42_2));
  SET_VECTOR_ELT(state, 816, allocVector(REALSXP, main_model_p->dim_in_I42));
  memcpy(REAL(VECTOR_ELT(state, 816)), main_model_p->in_I42, main_model_p->dim_in_I42 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 816), 2, main_model_p->dim_in_I42_1, main_model_p->dim_in_I42_2);
  SET_VECTOR_ELT(state, 817, ScalarInteger(main_model_p->dim_in_I43));
  SET_VECTOR_ELT(state, 818, ScalarInteger(main_model_p->dim_in_I43_1));
  SET_VECTOR_ELT(state, 819, ScalarInteger(main_model_p->dim_in_I43_2));
  SET_VECTOR_ELT(state, 820, allocVector(REALSXP, main_model_p->dim_in_I43));
  memcpy(REAL(VECTOR_ELT(state, 820)), main_model_p->in_I43, main_model_p->dim_in_I43 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 820), 2, main_model_p->dim_in_I43_1, main_model_p->dim_in_I43_2);
  SET_VECTOR_ELT(state, 821, ScalarInteger(main_model_p->dim_in_I44));
  SET_VECTOR_ELT(state, 822, ScalarInteger(main_model_p->dim_in_I44_1));
  SET_VECTOR_ELT(state, 823, ScalarInteger(main_model_p->dim_in_I44_2));
  SET_VECTOR_ELT(state, 824, allocVector(REALSXP, main_model_p->dim_in_I44));
  memcpy(REAL(VECTOR_ELT(state, 824)), main_model_p->in_I44, main_model_p->dim_in_I44 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 824), 2, main_model_p->dim_in_I44_1, main_model_p->dim_in_I44_2);
  SET_VECTOR_ELT(state, 825, ScalarInteger(main_model_p->dim_in_I45));
  SET_VECTOR_ELT(state, 826, ScalarInteger(main_model_p->dim_in_I45_1));
  SET_VECTOR_ELT(state, 827, ScalarInteger(main_model_p->dim_in_I45_2));
  SET_VECTOR_ELT(state, 828, allocVector(REALSXP, main_model_p->dim_in_I45));
  memcpy(REAL(VECTOR_ELT(state, 828)), main_model_p->in_I45, main_model_p->dim_in_I45 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 828), 2, main_model_p->dim_in_I45_1, main_model_p->dim_in_I45_2);
  SET_VECTOR_ELT(state, 829, ScalarInteger(main_model_p->dim_rate_move_in));
  SET_VECTOR_ELT(state, 830, ScalarInteger(main_model_p->dim_rate_move_in_1));
  SET_VECTOR_ELT(state, 831, ScalarInteger(main_model_p->dim_rate_move_in_2));
  SET_VECTOR_ELT(state, 832, allocVector(REALSXP, main_model_p->dim_rate_move_in));
  memcpy(REAL(VECTOR_ELT(state, 832)), main_model_p->rate_move_in, main_model_p->dim_rate_move_in * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 832), 2, main_model_p->dim_rate_move_in_1, main_model_p->dim_rate_move_in_2);
  SET_VECTOR_ELT(state, 833, ScalarInteger(main_model_p->offset_output_rate_move_in));
  SET_VECTOR_ELT(state, 834, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_VECTOR_ELT(state, 835, allocVector(REALSXP, main_model_p->dim_rate_move_out));
  memcpy(REAL(VECTOR_ELT(state, 835)), main_model_p->rate_move_out, main_model_p->dim_rate_move_out * sizeof(double));
  SET_VECTOR_ELT(state, 836, ScalarInteger(main_model_p->offset_output_rate_move_out));
  SET_VECTOR_ELT(state, 841, ScalarReal(main_model_p->ART_eligible_CD4_above_500));
  SET_VECTOR_ELT(state, 843, ScalarReal(main_model_p->ART_eligible_CD4_350_500));
  SET_VECTOR_ELT(state, 845, ScalarReal(main_model_p->ART_eligible_CD4_200_349));
  SET_VECTOR_ELT(state, 847, ScalarReal(main_model_p->ART_eligible_CD4_below_200));
  SET_VECTOR_ELT(state, 854, ScalarReal(main_model_p->epsilon));
  SET_VECTOR_ELT(state, 862, ScalarInteger(main_model_p->dim));
  SET_VECTOR_ELT(state, 863, ScalarInteger(main_model_p->dim_output));
  SEXP state_names = PROTECT(allocVector(STRSXP, 864));
  SET_STRING_ELT(state_names, 0, mkChar("odin_use_dde"));
  SET_STRING_ELT(state_names, 1, mkChar("replaceDeaths"));
  SET_STRING_ELT(state_names, 2, mkChar("dim_pfFSW_t"));
  SET_STRING_ELT(state_names, 3, mkChar("pfFSW_t"));
  SET_STRING_ELT(state_names, 4, mkChar("dim_pfFSW_y"));
  SET_STRING_ELT(state_names, 5, mkChar("dim_pfFSW_y_1"));
  SET_STRING_ELT(state_names, 6, mkChar("dim_pfFSW_y_2"));
  SET_STRING_ELT(state_names, 7, mkChar("pfFSW_y"));
  SET_STRING_ELT(state_names, 8, mkChar("infected_FSW_incoming"));
  SET_STRING_ELT(state_names, 9, mkChar("rate_leave_pro_FSW"));
  SET_STRING_ELT(state_names, 10, mkChar("fraction_FSW_foreign"));
  SET_STRING_ELT(state_names, 11, mkChar("dim_c_t_comm"));
  SET_STRING_ELT(state_names, 12, mkChar("c_t_comm"));
  SET_STRING_ELT(state_names, 13, mkChar("dim_c_t_noncomm"));
  SET_STRING_ELT(state_names, 14, mkChar("c_t_noncomm"));
  SET_STRING_ELT(state_names, 15, mkChar("dim_c_y_comm"));
  SET_STRING_ELT(state_names, 16, mkChar("dim_c_y_comm_1"));
  SET_STRING_ELT(state_names, 17, mkChar("dim_c_y_comm_2"));
  SET_STRING_ELT(state_names, 18, mkChar("c_y_comm"));
  SET_STRING_ELT(state_names, 19, mkChar("dim_c_y_noncomm"));
  SET_STRING_ELT(state_names, 20, mkChar("dim_c_y_noncomm_1"));
  SET_STRING_ELT(state_names, 21, mkChar("dim_c_y_noncomm_2"));
  SET_STRING_ELT(state_names, 22, mkChar("c_y_noncomm"));
  SET_STRING_ELT(state_names, 23, mkChar("who_believe_comm"));
  SET_STRING_ELT(state_names, 24, mkChar("dim_ART_eligible_CD4_above_500_t"));
  SET_STRING_ELT(state_names, 25, mkChar("ART_eligible_CD4_above_500_t"));
  SET_STRING_ELT(state_names, 26, mkChar("dim_ART_eligible_CD4_350_500_t"));
  SET_STRING_ELT(state_names, 27, mkChar("ART_eligible_CD4_350_500_t"));
  SET_STRING_ELT(state_names, 28, mkChar("dim_ART_eligible_CD4_200_349_t"));
  SET_STRING_ELT(state_names, 29, mkChar("ART_eligible_CD4_200_349_t"));
  SET_STRING_ELT(state_names, 30, mkChar("dim_ART_eligible_CD4_below_200_t"));
  SET_STRING_ELT(state_names, 31, mkChar("ART_eligible_CD4_below_200_t"));
  SET_STRING_ELT(state_names, 32, mkChar("dim_ART_eligible_CD4_above_500_y"));
  SET_STRING_ELT(state_names, 33, mkChar("ART_eligible_CD4_above_500_y"));
  SET_STRING_ELT(state_names, 34, mkChar("dim_ART_eligible_CD4_350_500_y"));
  SET_STRING_ELT(state_names, 35, mkChar("ART_eligible_CD4_350_500_y"));
  SET_STRING_ELT(state_names, 36, mkChar("dim_ART_eligible_CD4_200_349_y"));
  SET_STRING_ELT(state_names, 37, mkChar("ART_eligible_CD4_200_349_y"));
  SET_STRING_ELT(state_names, 38, mkChar("dim_ART_eligible_CD4_below_200_y"));
  SET_STRING_ELT(state_names, 39, mkChar("ART_eligible_CD4_below_200_y"));
  SET_STRING_ELT(state_names, 40, mkChar("dim_infect_ART_y"));
  SET_STRING_ELT(state_names, 41, mkChar("dim_infect_ART_y_1"));
  SET_STRING_ELT(state_names, 42, mkChar("dim_infect_ART_y_2"));
  SET_STRING_ELT(state_names, 43, mkChar("infect_ART_y"));
  SET_STRING_ELT(state_names, 44, mkChar("offset_output_infect_ART_y"));
  SET_STRING_ELT(state_names, 45, mkChar("dim_infect_ART_t"));
  SET_STRING_ELT(state_names, 46, mkChar("infect_ART_t"));
  SET_STRING_ELT(state_names, 47, mkChar("offset_output_infect_ART_t"));
  SET_STRING_ELT(state_names, 48, mkChar("dim_testing_prob_t"));
  SET_STRING_ELT(state_names, 49, mkChar("testing_prob_t"));
  SET_STRING_ELT(state_names, 50, mkChar("dim_testing_prob_y"));
  SET_STRING_ELT(state_names, 51, mkChar("dim_testing_prob_y_1"));
  SET_STRING_ELT(state_names, 52, mkChar("dim_testing_prob_y_2"));
  SET_STRING_ELT(state_names, 53, mkChar("testing_prob_y"));
  SET_STRING_ELT(state_names, 54, mkChar("TasP_testing"));
  SET_STRING_ELT(state_names, 55, mkChar("dim_tau_intervention_t"));
  SET_STRING_ELT(state_names, 56, mkChar("tau_intervention_t"));
  SET_STRING_ELT(state_names, 57, mkChar("dim_tau_intervention_y"));
  SET_STRING_ELT(state_names, 58, mkChar("dim_tau_intervention_y_1"));
  SET_STRING_ELT(state_names, 59, mkChar("dim_tau_intervention_y_2"));
  SET_STRING_ELT(state_names, 60, mkChar("tau_intervention_y"));
  SET_STRING_ELT(state_names, 61, mkChar("dim_rho_intervention_t"));
  SET_STRING_ELT(state_names, 62, mkChar("rho_intervention_t"));
  SET_STRING_ELT(state_names, 63, mkChar("dim_rho_intervention_y"));
  SET_STRING_ELT(state_names, 64, mkChar("dim_rho_intervention_y_1"));
  SET_STRING_ELT(state_names, 65, mkChar("dim_rho_intervention_y_2"));
  SET_STRING_ELT(state_names, 66, mkChar("rho_intervention_y"));
  SET_STRING_ELT(state_names, 67, mkChar("PrEPOnOff"));
  SET_STRING_ELT(state_names, 68, mkChar("fPa"));
  SET_STRING_ELT(state_names, 69, mkChar("fPb"));
  SET_STRING_ELT(state_names, 70, mkChar("fPc"));
  SET_STRING_ELT(state_names, 71, mkChar("RR_test_CD4200"));
  SET_STRING_ELT(state_names, 72, mkChar("dim_viral_supp_y"));
  SET_STRING_ELT(state_names, 73, mkChar("dim_viral_supp_y_1"));
  SET_STRING_ELT(state_names, 74, mkChar("dim_viral_supp_y_2"));
  SET_STRING_ELT(state_names, 75, mkChar("viral_supp_y"));
  SET_STRING_ELT(state_names, 76, mkChar("offset_output_viral_supp_y"));
  SET_STRING_ELT(state_names, 77, mkChar("dim_viral_supp_t"));
  SET_STRING_ELT(state_names, 78, mkChar("viral_supp_t"));
  SET_STRING_ELT(state_names, 79, mkChar("offset_output_viral_supp_t"));
  SET_STRING_ELT(state_names, 80, mkChar("W0"));
  SET_STRING_ELT(state_names, 81, mkChar("W1"));
  SET_STRING_ELT(state_names, 82, mkChar("W2"));
  SET_STRING_ELT(state_names, 83, mkChar("W3"));
  SET_STRING_ELT(state_names, 84, mkChar("cost_Initiation_of_ART_study_FSW"));
  SET_STRING_ELT(state_names, 85, mkChar("cost_Initiation_of_ART_government_FSW"));
  SET_STRING_ELT(state_names, 86, mkChar("cost_1_year_of_ART_study_FSW"));
  SET_STRING_ELT(state_names, 87, mkChar("cost_1_year_of_ART_government_FSW"));
  SET_STRING_ELT(state_names, 88, mkChar("cost_Initiation_ART_rest_of_population"));
  SET_STRING_ELT(state_names, 89, mkChar("cost_1_year_of_ART_rest_of_population"));
  SET_STRING_ELT(state_names, 90, mkChar("cost_FSW_initiation_ART_Patient_costs"));
  SET_STRING_ELT(state_names, 91, mkChar("cost_FSW_1_year_ART_Patient_costs"));
  SET_STRING_ELT(state_names, 92, mkChar("cost_Initiation_of_PrEP_study"));
  SET_STRING_ELT(state_names, 93, mkChar("cost_1_year_PrEP_perfect_adherence_study"));
  SET_STRING_ELT(state_names, 94, mkChar("cost_1_year_PrEP_intermediate_adherence_study"));
  SET_STRING_ELT(state_names, 95, mkChar("cost_1_year_PrEP_non_adherence_study"));
  SET_STRING_ELT(state_names, 96, mkChar("cost_Initiation_of_PrEP_government"));
  SET_STRING_ELT(state_names, 97, mkChar("cost_1_year_PrEP_perfect_adherence_government"));
  SET_STRING_ELT(state_names, 98, mkChar("cost_1_year_PrEP_intermediate_adherence_government"));
  SET_STRING_ELT(state_names, 99, mkChar("cost_1_year_PrEP_non_adherence_government"));
  SET_STRING_ELT(state_names, 100, mkChar("cost_PREP_initiation_Patient_costs"));
  SET_STRING_ELT(state_names, 101, mkChar("cost_PREP_1_year_ART_Patient_costs"));
  SET_STRING_ELT(state_names, 102, mkChar("Ncat"));
  SET_STRING_ELT(state_names, 103, mkChar("Nage"));
  SET_STRING_ELT(state_names, 104, mkChar("infect_acute"));
  SET_STRING_ELT(state_names, 105, mkChar("infect_AIDS"));
  SET_STRING_ELT(state_names, 106, mkChar("nu"));
  SET_STRING_ELT(state_names, 107, mkChar("R"));
  SET_STRING_ELT(state_names, 108, mkChar("dim_epsilon_t"));
  SET_STRING_ELT(state_names, 109, mkChar("epsilon_t"));
  SET_STRING_ELT(state_names, 110, mkChar("dim_epsilon_y"));
  SET_STRING_ELT(state_names, 111, mkChar("epsilon_y"));
  SET_STRING_ELT(state_names, 112, mkChar("dim_fc_t_comm"));
  SET_STRING_ELT(state_names, 113, mkChar("fc_t_comm"));
  SET_STRING_ELT(state_names, 114, mkChar("dim_fc_y_comm"));
  SET_STRING_ELT(state_names, 115, mkChar("dim_fc_y_comm_1"));
  SET_STRING_ELT(state_names, 116, mkChar("dim_fc_y_comm_2"));
  SET_STRING_ELT(state_names, 117, mkChar("dim_fc_y_comm_3"));
  SET_STRING_ELT(state_names, 118, mkChar("dim_fc_y_comm_12"));
  SET_STRING_ELT(state_names, 119, mkChar("fc_y_comm"));
  SET_STRING_ELT(state_names, 120, mkChar("dim_fP_t_comm"));
  SET_STRING_ELT(state_names, 121, mkChar("fP_t_comm"));
  SET_STRING_ELT(state_names, 122, mkChar("dim_fP_y_comm"));
  SET_STRING_ELT(state_names, 123, mkChar("dim_fP_y_comm_1"));
  SET_STRING_ELT(state_names, 124, mkChar("dim_fP_y_comm_2"));
  SET_STRING_ELT(state_names, 125, mkChar("fP_y_comm"));
  SET_STRING_ELT(state_names, 126, mkChar("dim_fc_t_noncomm"));
  SET_STRING_ELT(state_names, 127, mkChar("fc_t_noncomm"));
  SET_STRING_ELT(state_names, 128, mkChar("dim_fc_y_noncomm"));
  SET_STRING_ELT(state_names, 129, mkChar("dim_fc_y_noncomm_1"));
  SET_STRING_ELT(state_names, 130, mkChar("dim_fc_y_noncomm_2"));
  SET_STRING_ELT(state_names, 131, mkChar("dim_fc_y_noncomm_3"));
  SET_STRING_ELT(state_names, 132, mkChar("dim_fc_y_noncomm_12"));
  SET_STRING_ELT(state_names, 133, mkChar("fc_y_noncomm"));
  SET_STRING_ELT(state_names, 134, mkChar("dim_fP_t_noncomm"));
  SET_STRING_ELT(state_names, 135, mkChar("fP_t_noncomm"));
  SET_STRING_ELT(state_names, 136, mkChar("dim_fP_y_noncomm"));
  SET_STRING_ELT(state_names, 137, mkChar("dim_fP_y_noncomm_1"));
  SET_STRING_ELT(state_names, 138, mkChar("dim_fP_y_noncomm_2"));
  SET_STRING_ELT(state_names, 139, mkChar("fP_y_noncomm"));
  SET_STRING_ELT(state_names, 140, mkChar("dim_n_t_comm"));
  SET_STRING_ELT(state_names, 141, mkChar("n_t_comm"));
  SET_STRING_ELT(state_names, 142, mkChar("dim_n_y_comm"));
  SET_STRING_ELT(state_names, 143, mkChar("dim_n_y_comm_1"));
  SET_STRING_ELT(state_names, 144, mkChar("dim_n_y_comm_2"));
  SET_STRING_ELT(state_names, 145, mkChar("dim_n_y_comm_3"));
  SET_STRING_ELT(state_names, 146, mkChar("dim_n_y_comm_12"));
  SET_STRING_ELT(state_names, 147, mkChar("n_y_comm"));
  SET_STRING_ELT(state_names, 148, mkChar("dim_n_t_noncomm"));
  SET_STRING_ELT(state_names, 149, mkChar("n_t_noncomm"));
  SET_STRING_ELT(state_names, 150, mkChar("dim_n_y_noncomm"));
  SET_STRING_ELT(state_names, 151, mkChar("dim_n_y_noncomm_1"));
  SET_STRING_ELT(state_names, 152, mkChar("dim_n_y_noncomm_2"));
  SET_STRING_ELT(state_names, 153, mkChar("dim_n_y_noncomm_3"));
  SET_STRING_ELT(state_names, 154, mkChar("dim_n_y_noncomm_12"));
  SET_STRING_ELT(state_names, 155, mkChar("n_y_noncomm"));
  SET_STRING_ELT(state_names, 156, mkChar("dur_FSW"));
  SET_STRING_ELT(state_names, 157, mkChar("dim_prep_intervention_t"));
  SET_STRING_ELT(state_names, 158, mkChar("prep_intervention_t"));
  SET_STRING_ELT(state_names, 159, mkChar("dim_prep_intervention_y"));
  SET_STRING_ELT(state_names, 160, mkChar("dim_prep_intervention_y_1"));
  SET_STRING_ELT(state_names, 161, mkChar("dim_prep_intervention_y_2"));
  SET_STRING_ELT(state_names, 162, mkChar("prep_intervention_y"));
  SET_STRING_ELT(state_names, 163, mkChar("dim_gamma32_without_supp"));
  SET_STRING_ELT(state_names, 164, mkChar("gamma32_without_supp"));
  SET_STRING_ELT(state_names, 165, mkChar("offset_output_gamma32_without_supp"));
  SET_STRING_ELT(state_names, 166, mkChar("dim_gamma33_without_supp"));
  SET_STRING_ELT(state_names, 167, mkChar("gamma33_without_supp"));
  SET_STRING_ELT(state_names, 168, mkChar("offset_output_gamma33_without_supp"));
  SET_STRING_ELT(state_names, 169, mkChar("dim_gamma34_without_supp"));
  SET_STRING_ELT(state_names, 170, mkChar("gamma34_without_supp"));
  SET_STRING_ELT(state_names, 171, mkChar("offset_output_gamma34_without_supp"));
  SET_STRING_ELT(state_names, 172, mkChar("dim_alpha33_without_supp"));
  SET_STRING_ELT(state_names, 173, mkChar("alpha33_without_supp"));
  SET_STRING_ELT(state_names, 174, mkChar("offset_output_alpha33_without_supp"));
  SET_STRING_ELT(state_names, 175, mkChar("dim_alpha34_without_supp"));
  SET_STRING_ELT(state_names, 176, mkChar("alpha34_without_supp"));
  SET_STRING_ELT(state_names, 177, mkChar("offset_output_alpha34_without_supp"));
  SET_STRING_ELT(state_names, 178, mkChar("dim_alpha35_without_supp"));
  SET_STRING_ELT(state_names, 179, mkChar("alpha35_without_supp"));
  SET_STRING_ELT(state_names, 180, mkChar("offset_output_alpha35_without_supp"));
  SET_STRING_ELT(state_names, 181, mkChar("dim_c_comm"));
  SET_STRING_ELT(state_names, 182, mkChar("c_comm"));
  SET_STRING_ELT(state_names, 183, mkChar("offset_output_c_comm"));
  SET_STRING_ELT(state_names, 184, mkChar("dim_c_noncomm"));
  SET_STRING_ELT(state_names, 185, mkChar("c_noncomm"));
  SET_STRING_ELT(state_names, 186, mkChar("offset_output_c_noncomm"));
  SET_STRING_ELT(state_names, 187, mkChar("dim_pfFSW"));
  SET_STRING_ELT(state_names, 188, mkChar("pfFSW"));
  SET_STRING_ELT(state_names, 189, mkChar("offset_output_pfFSW"));
  SET_STRING_ELT(state_names, 190, mkChar("dim_new_acute_infected"));
  SET_STRING_ELT(state_names, 191, mkChar("new_acute_infected"));
  SET_STRING_ELT(state_names, 192, mkChar("offset_output_new_acute_infected"));
  SET_STRING_ELT(state_names, 193, mkChar("dim_FSW_ONLY"));
  SET_STRING_ELT(state_names, 194, mkChar("FSW_ONLY"));
  SET_STRING_ELT(state_names, 195, mkChar("dim_new_people_in_group"));
  SET_STRING_ELT(state_names, 196, mkChar("new_people_in_group"));
  SET_STRING_ELT(state_names, 197, mkChar("offset_output_new_people_in_group"));
  SET_STRING_ELT(state_names, 198, mkChar("dim_new_people_in_group_FSW_only"));
  SET_STRING_ELT(state_names, 199, mkChar("new_people_in_group_FSW_only"));
  SET_STRING_ELT(state_names, 200, mkChar("offset_output_new_people_in_group_FSW_only"));
  SET_STRING_ELT(state_names, 201, mkChar("dim_comm_partnerships_requested"));
  SET_STRING_ELT(state_names, 202, mkChar("dim_comm_partnerships_requested_1"));
  SET_STRING_ELT(state_names, 203, mkChar("dim_comm_partnerships_requested_2"));
  SET_STRING_ELT(state_names, 204, mkChar("comm_partnerships_requested"));
  SET_STRING_ELT(state_names, 205, mkChar("dim_noncomm_partnerships_requested"));
  SET_STRING_ELT(state_names, 206, mkChar("dim_noncomm_partnerships_requested_1"));
  SET_STRING_ELT(state_names, 207, mkChar("dim_noncomm_partnerships_requested_2"));
  SET_STRING_ELT(state_names, 208, mkChar("noncomm_partnerships_requested"));
  SET_STRING_ELT(state_names, 209, mkChar("dim_above_500_by_group"));
  SET_STRING_ELT(state_names, 210, mkChar("above_500_by_group"));
  SET_STRING_ELT(state_names, 211, mkChar("offset_output_above_500_by_group"));
  SET_STRING_ELT(state_names, 212, mkChar("dim_testing_prob"));
  SET_STRING_ELT(state_names, 213, mkChar("testing_prob"));
  SET_STRING_ELT(state_names, 214, mkChar("offset_output_testing_prob"));
  SET_STRING_ELT(state_names, 215, mkChar("dim_tau_intervention"));
  SET_STRING_ELT(state_names, 216, mkChar("tau_intervention"));
  SET_STRING_ELT(state_names, 217, mkChar("offset_output_tau_intervention"));
  SET_STRING_ELT(state_names, 218, mkChar("dim_rho_intervention"));
  SET_STRING_ELT(state_names, 219, mkChar("rho_intervention"));
  SET_STRING_ELT(state_names, 220, mkChar("offset_output_rho_intervention"));
  SET_STRING_ELT(state_names, 221, mkChar("dim_zeta"));
  SET_STRING_ELT(state_names, 222, mkChar("zeta"));
  SET_STRING_ELT(state_names, 223, mkChar("offset_output_zeta"));
  SET_STRING_ELT(state_names, 224, mkChar("dim_sigma"));
  SET_STRING_ELT(state_names, 225, mkChar("sigma"));
  SET_STRING_ELT(state_names, 226, mkChar("dim_eP1a_effective"));
  SET_STRING_ELT(state_names, 227, mkChar("eP1a_effective"));
  SET_STRING_ELT(state_names, 228, mkChar("offset_output_eP1a_effective"));
  SET_STRING_ELT(state_names, 229, mkChar("dim_eP1b_effective"));
  SET_STRING_ELT(state_names, 230, mkChar("eP1b_effective"));
  SET_STRING_ELT(state_names, 231, mkChar("offset_output_eP1b_effective"));
  SET_STRING_ELT(state_names, 232, mkChar("dim_eP1c_effective"));
  SET_STRING_ELT(state_names, 233, mkChar("eP1c_effective"));
  SET_STRING_ELT(state_names, 234, mkChar("offset_output_eP1c_effective"));
  SET_STRING_ELT(state_names, 235, mkChar("dim_tau"));
  SET_STRING_ELT(state_names, 236, mkChar("tau"));
  SET_STRING_ELT(state_names, 237, mkChar("offset_output_tau"));
  SET_STRING_ELT(state_names, 238, mkChar("dim_test_rate_prep"));
  SET_STRING_ELT(state_names, 239, mkChar("test_rate_prep"));
  SET_STRING_ELT(state_names, 240, mkChar("dim_rho"));
  SET_STRING_ELT(state_names, 241, mkChar("rho"));
  SET_STRING_ELT(state_names, 242, mkChar("offset_output_rho"));
  SET_STRING_ELT(state_names, 243, mkChar("dim_iota"));
  SET_STRING_ELT(state_names, 244, mkChar("iota"));
  SET_STRING_ELT(state_names, 245, mkChar("offset_output_iota"));
  SET_STRING_ELT(state_names, 246, mkChar("dim_viral_supp"));
  SET_STRING_ELT(state_names, 247, mkChar("viral_supp"));
  SET_STRING_ELT(state_names, 248, mkChar("offset_output_viral_supp"));
  SET_STRING_ELT(state_names, 249, mkChar("dim_HIV_positive"));
  SET_STRING_ELT(state_names, 250, mkChar("HIV_positive"));
  SET_STRING_ELT(state_names, 251, mkChar("offset_output_HIV_positive"));
  SET_STRING_ELT(state_names, 252, mkChar("dim_Number_Susceptibles"));
  SET_STRING_ELT(state_names, 253, mkChar("Number_Susceptibles"));
  SET_STRING_ELT(state_names, 254, mkChar("offset_output_Number_Susceptibles"));
  SET_STRING_ELT(state_names, 255, mkChar("dim_HIV_positive_Diagnosed_Off_ART"));
  SET_STRING_ELT(state_names, 256, mkChar("HIV_positive_Diagnosed_Off_ART"));
  SET_STRING_ELT(state_names, 257, mkChar("offset_output_HIV_positive_Diagnosed_Off_ART"));
  SET_STRING_ELT(state_names, 258, mkChar("dim_Primary_Off_ART"));
  SET_STRING_ELT(state_names, 259, mkChar("Primary_Off_ART"));
  SET_STRING_ELT(state_names, 260, mkChar("offset_output_Primary_Off_ART"));
  SET_STRING_ELT(state_names, 261, mkChar("dim_CD4_above_500_Off_ART"));
  SET_STRING_ELT(state_names, 262, mkChar("CD4_above_500_Off_ART"));
  SET_STRING_ELT(state_names, 263, mkChar("offset_output_CD4_above_500_Off_ART"));
  SET_STRING_ELT(state_names, 264, mkChar("dim_CD4_350_500_Off_ART"));
  SET_STRING_ELT(state_names, 265, mkChar("CD4_350_500_Off_ART"));
  SET_STRING_ELT(state_names, 266, mkChar("offset_output_CD4_350_500_Off_ART"));
  SET_STRING_ELT(state_names, 267, mkChar("dim_CD4_200_350_Off_ART"));
  SET_STRING_ELT(state_names, 268, mkChar("CD4_200_350_Off_ART"));
  SET_STRING_ELT(state_names, 269, mkChar("offset_output_CD4_200_350_Off_ART"));
  SET_STRING_ELT(state_names, 270, mkChar("dim_CD4_below_200_Off_ART"));
  SET_STRING_ELT(state_names, 271, mkChar("CD4_below_200_Off_ART"));
  SET_STRING_ELT(state_names, 272, mkChar("offset_output_CD4_below_200_Off_ART"));
  SET_STRING_ELT(state_names, 273, mkChar("dim_HIV_positive_On_ART"));
  SET_STRING_ELT(state_names, 274, mkChar("HIV_positive_On_ART"));
  SET_STRING_ELT(state_names, 275, mkChar("offset_output_HIV_positive_On_ART"));
  SET_STRING_ELT(state_names, 276, mkChar("dim_Number_DALY_W1"));
  SET_STRING_ELT(state_names, 277, mkChar("Number_DALY_W1"));
  SET_STRING_ELT(state_names, 278, mkChar("offset_output_Number_DALY_W1"));
  SET_STRING_ELT(state_names, 279, mkChar("dim_Number_DALY_W2"));
  SET_STRING_ELT(state_names, 280, mkChar("Number_DALY_W2"));
  SET_STRING_ELT(state_names, 281, mkChar("offset_output_Number_DALY_W2"));
  SET_STRING_ELT(state_names, 282, mkChar("dim_Number_DALY_W3"));
  SET_STRING_ELT(state_names, 283, mkChar("Number_DALY_W3"));
  SET_STRING_ELT(state_names, 284, mkChar("offset_output_Number_DALY_W3"));
  SET_STRING_ELT(state_names, 285, mkChar("dim_cumuDeaths_On_ART"));
  SET_STRING_ELT(state_names, 286, mkChar("initial_cumuDeaths_On_ART"));
  SET_STRING_ELT(state_names, 287, mkChar("offset_cumuDeaths_On_ART"));
  SET_STRING_ELT(state_names, 288, mkChar("dim_cumuARTinitiations_not_TasP"));
  SET_STRING_ELT(state_names, 289, mkChar("initial_cumuARTinitiations_not_TasP"));
  SET_STRING_ELT(state_names, 290, mkChar("offset_cumuARTinitiations_not_TasP"));
  SET_STRING_ELT(state_names, 291, mkChar("dim_cumu_PrEP_dropouts"));
  SET_STRING_ELT(state_names, 292, mkChar("initial_cumu_PrEP_dropouts"));
  SET_STRING_ELT(state_names, 293, mkChar("offset_cumu_PrEP_dropouts"));
  SET_STRING_ELT(state_names, 294, mkChar("dim_S0_infections"));
  SET_STRING_ELT(state_names, 295, mkChar("initial_S0_infections"));
  SET_STRING_ELT(state_names, 296, mkChar("offset_S0_infections"));
  SET_STRING_ELT(state_names, 297, mkChar("dim_S1a_infections"));
  SET_STRING_ELT(state_names, 298, mkChar("initial_S1a_infections"));
  SET_STRING_ELT(state_names, 299, mkChar("offset_S1a_infections"));
  SET_STRING_ELT(state_names, 300, mkChar("dim_S1b_infections"));
  SET_STRING_ELT(state_names, 301, mkChar("initial_S1b_infections"));
  SET_STRING_ELT(state_names, 302, mkChar("offset_S1b_infections"));
  SET_STRING_ELT(state_names, 303, mkChar("dim_S1c_infections"));
  SET_STRING_ELT(state_names, 304, mkChar("initial_S1c_infections"));
  SET_STRING_ELT(state_names, 305, mkChar("offset_S1c_infections"));
  SET_STRING_ELT(state_names, 306, mkChar("dim_S1d_infections"));
  SET_STRING_ELT(state_names, 307, mkChar("initial_S1d_infections"));
  SET_STRING_ELT(state_names, 308, mkChar("offset_S1d_infections"));
  SET_STRING_ELT(state_names, 309, mkChar("dim_frac_F"));
  SET_STRING_ELT(state_names, 310, mkChar("frac_F"));
  SET_STRING_ELT(state_names, 311, mkChar("offset_output_frac_F"));
  SET_STRING_ELT(state_names, 312, mkChar("dim_frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 313, mkChar("frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 314, mkChar("offset_output_frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 315, mkChar("dim_ART_coverage"));
  SET_STRING_ELT(state_names, 316, mkChar("ART_coverage"));
  SET_STRING_ELT(state_names, 317, mkChar("offset_output_ART_coverage"));
  SET_STRING_ELT(state_names, 318, mkChar("dim_infect_ART"));
  SET_STRING_ELT(state_names, 319, mkChar("infect_ART"));
  SET_STRING_ELT(state_names, 320, mkChar("offset_output_infect_ART"));
  SET_STRING_ELT(state_names, 321, mkChar("dim_prep_offered"));
  SET_STRING_ELT(state_names, 322, mkChar("prep_offered"));
  SET_STRING_ELT(state_names, 323, mkChar("offset_output_prep_offered"));
  SET_STRING_ELT(state_names, 324, mkChar("dim_omega"));
  SET_STRING_ELT(state_names, 325, mkChar("omega"));
  SET_STRING_ELT(state_names, 326, mkChar("offset_output_omega"));
  SET_STRING_ELT(state_names, 327, mkChar("dim_frac_N"));
  SET_STRING_ELT(state_names, 328, mkChar("frac_N"));
  SET_STRING_ELT(state_names, 329, mkChar("offset_output_frac_N"));
  SET_STRING_ELT(state_names, 330, mkChar("dim_mu"));
  SET_STRING_ELT(state_names, 331, mkChar("mu"));
  SET_STRING_ELT(state_names, 332, mkChar("offset_output_mu"));
  SET_STRING_ELT(state_names, 333, mkChar("dim_gamma01"));
  SET_STRING_ELT(state_names, 334, mkChar("gamma01"));
  SET_STRING_ELT(state_names, 335, mkChar("offset_output_gamma01"));
  SET_STRING_ELT(state_names, 336, mkChar("dim_gamma02"));
  SET_STRING_ELT(state_names, 337, mkChar("gamma02"));
  SET_STRING_ELT(state_names, 338, mkChar("dim_gamma03"));
  SET_STRING_ELT(state_names, 339, mkChar("gamma03"));
  SET_STRING_ELT(state_names, 340, mkChar("dim_gamma04"));
  SET_STRING_ELT(state_names, 341, mkChar("gamma04"));
  SET_STRING_ELT(state_names, 342, mkChar("dim_gamma11"));
  SET_STRING_ELT(state_names, 343, mkChar("gamma11"));
  SET_STRING_ELT(state_names, 344, mkChar("offset_output_gamma11"));
  SET_STRING_ELT(state_names, 345, mkChar("dim_gamma22"));
  SET_STRING_ELT(state_names, 346, mkChar("gamma22"));
  SET_STRING_ELT(state_names, 347, mkChar("dim_gamma23"));
  SET_STRING_ELT(state_names, 348, mkChar("gamma23"));
  SET_STRING_ELT(state_names, 349, mkChar("dim_gamma24"));
  SET_STRING_ELT(state_names, 350, mkChar("gamma24"));
  SET_STRING_ELT(state_names, 351, mkChar("dim_gamma32"));
  SET_STRING_ELT(state_names, 352, mkChar("gamma32"));
  SET_STRING_ELT(state_names, 353, mkChar("offset_output_gamma32"));
  SET_STRING_ELT(state_names, 354, mkChar("dim_gamma33"));
  SET_STRING_ELT(state_names, 355, mkChar("gamma33"));
  SET_STRING_ELT(state_names, 356, mkChar("offset_output_gamma33"));
  SET_STRING_ELT(state_names, 357, mkChar("dim_gamma34"));
  SET_STRING_ELT(state_names, 358, mkChar("gamma34"));
  SET_STRING_ELT(state_names, 359, mkChar("offset_output_gamma34"));
  SET_STRING_ELT(state_names, 360, mkChar("dim_gamma42"));
  SET_STRING_ELT(state_names, 361, mkChar("gamma42"));
  SET_STRING_ELT(state_names, 362, mkChar("dim_gamma43"));
  SET_STRING_ELT(state_names, 363, mkChar("gamma43"));
  SET_STRING_ELT(state_names, 364, mkChar("dim_gamma44"));
  SET_STRING_ELT(state_names, 365, mkChar("gamma44"));
  SET_STRING_ELT(state_names, 366, mkChar("dim_phi2"));
  SET_STRING_ELT(state_names, 367, mkChar("phi2"));
  SET_STRING_ELT(state_names, 368, mkChar("dim_phi3"));
  SET_STRING_ELT(state_names, 369, mkChar("phi3"));
  SET_STRING_ELT(state_names, 370, mkChar("dim_phi4"));
  SET_STRING_ELT(state_names, 371, mkChar("phi4"));
  SET_STRING_ELT(state_names, 372, mkChar("dim_phi5"));
  SET_STRING_ELT(state_names, 373, mkChar("phi5"));
  SET_STRING_ELT(state_names, 374, mkChar("dim_psia"));
  SET_STRING_ELT(state_names, 375, mkChar("psia"));
  SET_STRING_ELT(state_names, 376, mkChar("dim_psib"));
  SET_STRING_ELT(state_names, 377, mkChar("psib"));
  SET_STRING_ELT(state_names, 378, mkChar("dim_kappaa"));
  SET_STRING_ELT(state_names, 379, mkChar("kappaa"));
  SET_STRING_ELT(state_names, 380, mkChar("offset_output_kappaa"));
  SET_STRING_ELT(state_names, 381, mkChar("dim_kappab"));
  SET_STRING_ELT(state_names, 382, mkChar("kappab"));
  SET_STRING_ELT(state_names, 383, mkChar("offset_output_kappab"));
  SET_STRING_ELT(state_names, 384, mkChar("dim_kappac"));
  SET_STRING_ELT(state_names, 385, mkChar("kappac"));
  SET_STRING_ELT(state_names, 386, mkChar("offset_output_kappac"));
  SET_STRING_ELT(state_names, 387, mkChar("dim_kappa1"));
  SET_STRING_ELT(state_names, 388, mkChar("kappa1"));
  SET_STRING_ELT(state_names, 389, mkChar("offset_output_kappa1"));
  SET_STRING_ELT(state_names, 390, mkChar("dim_alpha01"));
  SET_STRING_ELT(state_names, 391, mkChar("alpha01"));
  SET_STRING_ELT(state_names, 392, mkChar("offset_output_alpha01"));
  SET_STRING_ELT(state_names, 393, mkChar("dim_alpha02"));
  SET_STRING_ELT(state_names, 394, mkChar("alpha02"));
  SET_STRING_ELT(state_names, 395, mkChar("offset_output_alpha02"));
  SET_STRING_ELT(state_names, 396, mkChar("dim_alpha03"));
  SET_STRING_ELT(state_names, 397, mkChar("alpha03"));
  SET_STRING_ELT(state_names, 398, mkChar("dim_alpha04"));
  SET_STRING_ELT(state_names, 399, mkChar("alpha04"));
  SET_STRING_ELT(state_names, 400, mkChar("dim_alpha05"));
  SET_STRING_ELT(state_names, 401, mkChar("alpha05"));
  SET_STRING_ELT(state_names, 402, mkChar("offset_output_alpha05"));
  SET_STRING_ELT(state_names, 403, mkChar("dim_alpha11"));
  SET_STRING_ELT(state_names, 404, mkChar("alpha11"));
  SET_STRING_ELT(state_names, 405, mkChar("offset_output_alpha11"));
  SET_STRING_ELT(state_names, 406, mkChar("dim_alpha22"));
  SET_STRING_ELT(state_names, 407, mkChar("alpha22"));
  SET_STRING_ELT(state_names, 408, mkChar("offset_output_alpha22"));
  SET_STRING_ELT(state_names, 409, mkChar("dim_alpha23"));
  SET_STRING_ELT(state_names, 410, mkChar("alpha23"));
  SET_STRING_ELT(state_names, 411, mkChar("dim_alpha24"));
  SET_STRING_ELT(state_names, 412, mkChar("alpha24"));
  SET_STRING_ELT(state_names, 413, mkChar("dim_alpha25"));
  SET_STRING_ELT(state_names, 414, mkChar("alpha25"));
  SET_STRING_ELT(state_names, 415, mkChar("dim_alpha32"));
  SET_STRING_ELT(state_names, 416, mkChar("alpha32"));
  SET_STRING_ELT(state_names, 417, mkChar("dim_alpha33"));
  SET_STRING_ELT(state_names, 418, mkChar("alpha33"));
  SET_STRING_ELT(state_names, 419, mkChar("offset_output_alpha33"));
  SET_STRING_ELT(state_names, 420, mkChar("dim_alpha34"));
  SET_STRING_ELT(state_names, 421, mkChar("alpha34"));
  SET_STRING_ELT(state_names, 422, mkChar("offset_output_alpha34"));
  SET_STRING_ELT(state_names, 423, mkChar("dim_alpha35"));
  SET_STRING_ELT(state_names, 424, mkChar("alpha35"));
  SET_STRING_ELT(state_names, 425, mkChar("offset_output_alpha35"));
  SET_STRING_ELT(state_names, 426, mkChar("dim_alpha42"));
  SET_STRING_ELT(state_names, 427, mkChar("alpha42"));
  SET_STRING_ELT(state_names, 428, mkChar("dim_alpha43"));
  SET_STRING_ELT(state_names, 429, mkChar("alpha43"));
  SET_STRING_ELT(state_names, 430, mkChar("dim_alpha44"));
  SET_STRING_ELT(state_names, 431, mkChar("alpha44"));
  SET_STRING_ELT(state_names, 432, mkChar("dim_alpha45"));
  SET_STRING_ELT(state_names, 433, mkChar("alpha45"));
  SET_STRING_ELT(state_names, 434, mkChar("dim_beta_comm"));
  SET_STRING_ELT(state_names, 435, mkChar("beta_comm"));
  SET_STRING_ELT(state_names, 436, mkChar("offset_output_beta_comm"));
  SET_STRING_ELT(state_names, 437, mkChar("dim_beta_noncomm"));
  SET_STRING_ELT(state_names, 438, mkChar("beta_noncomm"));
  SET_STRING_ELT(state_names, 439, mkChar("offset_output_beta_noncomm"));
  SET_STRING_ELT(state_names, 440, mkChar("dim_p_comm"));
  SET_STRING_ELT(state_names, 441, mkChar("dim_p_comm_1"));
  SET_STRING_ELT(state_names, 442, mkChar("dim_p_comm_2"));
  SET_STRING_ELT(state_names, 443, mkChar("p_comm"));
  SET_STRING_ELT(state_names, 444, mkChar("offset_output_p_comm"));
  SET_STRING_ELT(state_names, 445, mkChar("dim_p_noncomm"));
  SET_STRING_ELT(state_names, 446, mkChar("dim_p_noncomm_1"));
  SET_STRING_ELT(state_names, 447, mkChar("dim_p_noncomm_2"));
  SET_STRING_ELT(state_names, 448, mkChar("p_noncomm"));
  SET_STRING_ELT(state_names, 449, mkChar("offset_output_p_noncomm"));
  SET_STRING_ELT(state_names, 450, mkChar("dim_ec"));
  SET_STRING_ELT(state_names, 451, mkChar("ec"));
  SET_STRING_ELT(state_names, 452, mkChar("dim_eP"));
  SET_STRING_ELT(state_names, 453, mkChar("eP"));
  SET_STRING_ELT(state_names, 454, mkChar("dim_eP0"));
  SET_STRING_ELT(state_names, 455, mkChar("eP0"));
  SET_STRING_ELT(state_names, 456, mkChar("offset_output_eP0"));
  SET_STRING_ELT(state_names, 457, mkChar("dim_eP1a"));
  SET_STRING_ELT(state_names, 458, mkChar("eP1a"));
  SET_STRING_ELT(state_names, 459, mkChar("offset_output_eP1a"));
  SET_STRING_ELT(state_names, 460, mkChar("dim_eP1b"));
  SET_STRING_ELT(state_names, 461, mkChar("eP1b"));
  SET_STRING_ELT(state_names, 462, mkChar("offset_output_eP1b"));
  SET_STRING_ELT(state_names, 463, mkChar("dim_eP1c"));
  SET_STRING_ELT(state_names, 464, mkChar("eP1c"));
  SET_STRING_ELT(state_names, 465, mkChar("offset_output_eP1c"));
  SET_STRING_ELT(state_names, 466, mkChar("dim_eP1d"));
  SET_STRING_ELT(state_names, 467, mkChar("eP1d"));
  SET_STRING_ELT(state_names, 468, mkChar("offset_output_eP1d"));
  SET_STRING_ELT(state_names, 469, mkChar("dim_fc_comm"));
  SET_STRING_ELT(state_names, 470, mkChar("dim_fc_comm_1"));
  SET_STRING_ELT(state_names, 471, mkChar("dim_fc_comm_2"));
  SET_STRING_ELT(state_names, 472, mkChar("fc_comm"));
  SET_STRING_ELT(state_names, 473, mkChar("offset_output_fc_comm"));
  SET_STRING_ELT(state_names, 474, mkChar("dim_fP_comm"));
  SET_STRING_ELT(state_names, 475, mkChar("fP_comm"));
  SET_STRING_ELT(state_names, 476, mkChar("offset_output_fP_comm"));
  SET_STRING_ELT(state_names, 477, mkChar("dim_fc_noncomm"));
  SET_STRING_ELT(state_names, 478, mkChar("dim_fc_noncomm_1"));
  SET_STRING_ELT(state_names, 479, mkChar("dim_fc_noncomm_2"));
  SET_STRING_ELT(state_names, 480, mkChar("fc_noncomm"));
  SET_STRING_ELT(state_names, 481, mkChar("offset_output_fc_noncomm"));
  SET_STRING_ELT(state_names, 482, mkChar("dim_fP_noncomm"));
  SET_STRING_ELT(state_names, 483, mkChar("fP_noncomm"));
  SET_STRING_ELT(state_names, 484, mkChar("offset_output_fP_noncomm"));
  SET_STRING_ELT(state_names, 485, mkChar("dim_n_comm"));
  SET_STRING_ELT(state_names, 486, mkChar("dim_n_comm_1"));
  SET_STRING_ELT(state_names, 487, mkChar("dim_n_comm_2"));
  SET_STRING_ELT(state_names, 488, mkChar("n_comm"));
  SET_STRING_ELT(state_names, 489, mkChar("offset_output_n_comm"));
  SET_STRING_ELT(state_names, 490, mkChar("dim_n_noncomm"));
  SET_STRING_ELT(state_names, 491, mkChar("dim_n_noncomm_1"));
  SET_STRING_ELT(state_names, 492, mkChar("dim_n_noncomm_2"));
  SET_STRING_ELT(state_names, 493, mkChar("n_noncomm"));
  SET_STRING_ELT(state_names, 494, mkChar("offset_output_n_noncomm"));
  SET_STRING_ELT(state_names, 495, mkChar("dim_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 496, mkChar("initial_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 497, mkChar("offset_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 498, mkChar("dim_cumuARTinitiations"));
  SET_STRING_ELT(state_names, 499, mkChar("initial_cumuARTinitiations"));
  SET_STRING_ELT(state_names, 500, mkChar("offset_cumuARTinitiations"));
  SET_STRING_ELT(state_names, 501, mkChar("dim_TasPinitiations"));
  SET_STRING_ELT(state_names, 502, mkChar("initial_TasPinitiations"));
  SET_STRING_ELT(state_names, 503, mkChar("offset_TasPinitiations"));
  SET_STRING_ELT(state_names, 504, mkChar("dim_cumuARTREinitiations"));
  SET_STRING_ELT(state_names, 505, mkChar("initial_cumuARTREinitiations"));
  SET_STRING_ELT(state_names, 506, mkChar("offset_cumuARTREinitiations"));
  SET_STRING_ELT(state_names, 507, mkChar("dim_dropouts"));
  SET_STRING_ELT(state_names, 508, mkChar("initial_dropouts"));
  SET_STRING_ELT(state_names, 509, mkChar("offset_dropouts"));
  SET_STRING_ELT(state_names, 510, mkChar("dim_cumuAllDeaths"));
  SET_STRING_ELT(state_names, 511, mkChar("initial_cumuAllDeaths"));
  SET_STRING_ELT(state_names, 512, mkChar("offset_cumuAllDeaths"));
  SET_STRING_ELT(state_names, 513, mkChar("dim_cumuInf"));
  SET_STRING_ELT(state_names, 514, mkChar("initial_cumuInf"));
  SET_STRING_ELT(state_names, 515, mkChar("offset_cumuInf"));
  SET_STRING_ELT(state_names, 516, mkChar("dim_PrEPinitiations"));
  SET_STRING_ELT(state_names, 517, mkChar("initial_PrEPinitiations"));
  SET_STRING_ELT(state_names, 518, mkChar("offset_PrEPinitiations"));
  SET_STRING_ELT(state_names, 519, mkChar("dim_PrEPinitiations1a"));
  SET_STRING_ELT(state_names, 520, mkChar("initial_PrEPinitiations1a"));
  SET_STRING_ELT(state_names, 521, mkChar("offset_PrEPinitiations1a"));
  SET_STRING_ELT(state_names, 522, mkChar("dim_PrEPinitiations1b"));
  SET_STRING_ELT(state_names, 523, mkChar("initial_PrEPinitiations1b"));
  SET_STRING_ELT(state_names, 524, mkChar("offset_PrEPinitiations1b"));
  SET_STRING_ELT(state_names, 525, mkChar("dim_PrEPinitiations1c"));
  SET_STRING_ELT(state_names, 526, mkChar("initial_PrEPinitiations1c"));
  SET_STRING_ELT(state_names, 527, mkChar("offset_PrEPinitiations1c"));
  SET_STRING_ELT(state_names, 528, mkChar("dim_S0"));
  SET_STRING_ELT(state_names, 529, mkChar("initial_S0"));
  SET_STRING_ELT(state_names, 530, mkChar("offset_S0"));
  SET_STRING_ELT(state_names, 531, mkChar("dim_S1a"));
  SET_STRING_ELT(state_names, 532, mkChar("initial_S1a"));
  SET_STRING_ELT(state_names, 533, mkChar("offset_S1a"));
  SET_STRING_ELT(state_names, 534, mkChar("dim_S1b"));
  SET_STRING_ELT(state_names, 535, mkChar("initial_S1b"));
  SET_STRING_ELT(state_names, 536, mkChar("offset_S1b"));
  SET_STRING_ELT(state_names, 537, mkChar("dim_S1c"));
  SET_STRING_ELT(state_names, 538, mkChar("initial_S1c"));
  SET_STRING_ELT(state_names, 539, mkChar("offset_S1c"));
  SET_STRING_ELT(state_names, 540, mkChar("dim_S1d"));
  SET_STRING_ELT(state_names, 541, mkChar("initial_S1d"));
  SET_STRING_ELT(state_names, 542, mkChar("offset_S1d"));
  SET_STRING_ELT(state_names, 543, mkChar("dim_I01"));
  SET_STRING_ELT(state_names, 544, mkChar("initial_I01"));
  SET_STRING_ELT(state_names, 545, mkChar("offset_I01"));
  SET_STRING_ELT(state_names, 546, mkChar("dim_I11"));
  SET_STRING_ELT(state_names, 547, mkChar("initial_I11"));
  SET_STRING_ELT(state_names, 548, mkChar("offset_I11"));
  SET_STRING_ELT(state_names, 549, mkChar("dim_I02"));
  SET_STRING_ELT(state_names, 550, mkChar("initial_I02"));
  SET_STRING_ELT(state_names, 551, mkChar("offset_I02"));
  SET_STRING_ELT(state_names, 552, mkChar("dim_I03"));
  SET_STRING_ELT(state_names, 553, mkChar("initial_I03"));
  SET_STRING_ELT(state_names, 554, mkChar("offset_I03"));
  SET_STRING_ELT(state_names, 555, mkChar("dim_I04"));
  SET_STRING_ELT(state_names, 556, mkChar("initial_I04"));
  SET_STRING_ELT(state_names, 557, mkChar("offset_I04"));
  SET_STRING_ELT(state_names, 558, mkChar("dim_I05"));
  SET_STRING_ELT(state_names, 559, mkChar("initial_I05"));
  SET_STRING_ELT(state_names, 560, mkChar("offset_I05"));
  SET_STRING_ELT(state_names, 561, mkChar("dim_I22"));
  SET_STRING_ELT(state_names, 562, mkChar("initial_I22"));
  SET_STRING_ELT(state_names, 563, mkChar("offset_I22"));
  SET_STRING_ELT(state_names, 564, mkChar("dim_I23"));
  SET_STRING_ELT(state_names, 565, mkChar("initial_I23"));
  SET_STRING_ELT(state_names, 566, mkChar("offset_I23"));
  SET_STRING_ELT(state_names, 567, mkChar("dim_I24"));
  SET_STRING_ELT(state_names, 568, mkChar("initial_I24"));
  SET_STRING_ELT(state_names, 569, mkChar("offset_I24"));
  SET_STRING_ELT(state_names, 570, mkChar("dim_I25"));
  SET_STRING_ELT(state_names, 571, mkChar("initial_I25"));
  SET_STRING_ELT(state_names, 572, mkChar("offset_I25"));
  SET_STRING_ELT(state_names, 573, mkChar("dim_I32"));
  SET_STRING_ELT(state_names, 574, mkChar("initial_I32"));
  SET_STRING_ELT(state_names, 575, mkChar("offset_I32"));
  SET_STRING_ELT(state_names, 576, mkChar("dim_I33"));
  SET_STRING_ELT(state_names, 577, mkChar("initial_I33"));
  SET_STRING_ELT(state_names, 578, mkChar("offset_I33"));
  SET_STRING_ELT(state_names, 579, mkChar("dim_I34"));
  SET_STRING_ELT(state_names, 580, mkChar("initial_I34"));
  SET_STRING_ELT(state_names, 581, mkChar("offset_I34"));
  SET_STRING_ELT(state_names, 582, mkChar("dim_I35"));
  SET_STRING_ELT(state_names, 583, mkChar("initial_I35"));
  SET_STRING_ELT(state_names, 584, mkChar("offset_I35"));
  SET_STRING_ELT(state_names, 585, mkChar("dim_I42"));
  SET_STRING_ELT(state_names, 586, mkChar("initial_I42"));
  SET_STRING_ELT(state_names, 587, mkChar("offset_I42"));
  SET_STRING_ELT(state_names, 588, mkChar("dim_I43"));
  SET_STRING_ELT(state_names, 589, mkChar("initial_I43"));
  SET_STRING_ELT(state_names, 590, mkChar("offset_I43"));
  SET_STRING_ELT(state_names, 591, mkChar("dim_I44"));
  SET_STRING_ELT(state_names, 592, mkChar("initial_I44"));
  SET_STRING_ELT(state_names, 593, mkChar("offset_I44"));
  SET_STRING_ELT(state_names, 594, mkChar("dim_I45"));
  SET_STRING_ELT(state_names, 595, mkChar("initial_I45"));
  SET_STRING_ELT(state_names, 596, mkChar("offset_I45"));
  SET_STRING_ELT(state_names, 597, mkChar("dim_S0_init"));
  SET_STRING_ELT(state_names, 598, mkChar("S0_init"));
  SET_STRING_ELT(state_names, 599, mkChar("dim_S1a_init"));
  SET_STRING_ELT(state_names, 600, mkChar("S1a_init"));
  SET_STRING_ELT(state_names, 601, mkChar("dim_S1b_init"));
  SET_STRING_ELT(state_names, 602, mkChar("S1b_init"));
  SET_STRING_ELT(state_names, 603, mkChar("dim_S1c_init"));
  SET_STRING_ELT(state_names, 604, mkChar("S1c_init"));
  SET_STRING_ELT(state_names, 605, mkChar("dim_S1d_init"));
  SET_STRING_ELT(state_names, 606, mkChar("S1d_init"));
  SET_STRING_ELT(state_names, 607, mkChar("dim_I01_init"));
  SET_STRING_ELT(state_names, 608, mkChar("I01_init"));
  SET_STRING_ELT(state_names, 609, mkChar("dim_I11_init"));
  SET_STRING_ELT(state_names, 610, mkChar("I11_init"));
  SET_STRING_ELT(state_names, 611, mkChar("dim_I02_init"));
  SET_STRING_ELT(state_names, 612, mkChar("I02_init"));
  SET_STRING_ELT(state_names, 613, mkChar("dim_I03_init"));
  SET_STRING_ELT(state_names, 614, mkChar("I03_init"));
  SET_STRING_ELT(state_names, 615, mkChar("dim_I04_init"));
  SET_STRING_ELT(state_names, 616, mkChar("I04_init"));
  SET_STRING_ELT(state_names, 617, mkChar("dim_I05_init"));
  SET_STRING_ELT(state_names, 618, mkChar("I05_init"));
  SET_STRING_ELT(state_names, 619, mkChar("dim_I22_init"));
  SET_STRING_ELT(state_names, 620, mkChar("I22_init"));
  SET_STRING_ELT(state_names, 621, mkChar("dim_I23_init"));
  SET_STRING_ELT(state_names, 622, mkChar("I23_init"));
  SET_STRING_ELT(state_names, 623, mkChar("dim_I24_init"));
  SET_STRING_ELT(state_names, 624, mkChar("I24_init"));
  SET_STRING_ELT(state_names, 625, mkChar("dim_I25_init"));
  SET_STRING_ELT(state_names, 626, mkChar("I25_init"));
  SET_STRING_ELT(state_names, 627, mkChar("dim_I32_init"));
  SET_STRING_ELT(state_names, 628, mkChar("I32_init"));
  SET_STRING_ELT(state_names, 629, mkChar("dim_I33_init"));
  SET_STRING_ELT(state_names, 630, mkChar("I33_init"));
  SET_STRING_ELT(state_names, 631, mkChar("dim_I34_init"));
  SET_STRING_ELT(state_names, 632, mkChar("I34_init"));
  SET_STRING_ELT(state_names, 633, mkChar("dim_I35_init"));
  SET_STRING_ELT(state_names, 634, mkChar("I35_init"));
  SET_STRING_ELT(state_names, 635, mkChar("dim_I42_init"));
  SET_STRING_ELT(state_names, 636, mkChar("I42_init"));
  SET_STRING_ELT(state_names, 637, mkChar("dim_I43_init"));
  SET_STRING_ELT(state_names, 638, mkChar("I43_init"));
  SET_STRING_ELT(state_names, 639, mkChar("dim_I44_init"));
  SET_STRING_ELT(state_names, 640, mkChar("I44_init"));
  SET_STRING_ELT(state_names, 641, mkChar("dim_I45_init"));
  SET_STRING_ELT(state_names, 642, mkChar("I45_init"));
  SET_STRING_ELT(state_names, 643, mkChar("dim_N"));
  SET_STRING_ELT(state_names, 644, mkChar("N"));
  SET_STRING_ELT(state_names, 645, mkChar("offset_output_N"));
  SET_STRING_ELT(state_names, 646, mkChar("dim_E0"));
  SET_STRING_ELT(state_names, 647, mkChar("E0"));
  SET_STRING_ELT(state_names, 648, mkChar("offset_output_E0"));
  SET_STRING_ELT(state_names, 649, mkChar("dim_E1a"));
  SET_STRING_ELT(state_names, 650, mkChar("E1a"));
  SET_STRING_ELT(state_names, 651, mkChar("offset_output_E1a"));
  SET_STRING_ELT(state_names, 652, mkChar("dim_E1b"));
  SET_STRING_ELT(state_names, 653, mkChar("E1b"));
  SET_STRING_ELT(state_names, 654, mkChar("offset_output_E1b"));
  SET_STRING_ELT(state_names, 655, mkChar("dim_E1c"));
  SET_STRING_ELT(state_names, 656, mkChar("E1c"));
  SET_STRING_ELT(state_names, 657, mkChar("offset_output_E1c"));
  SET_STRING_ELT(state_names, 658, mkChar("dim_E1d"));
  SET_STRING_ELT(state_names, 659, mkChar("E1d"));
  SET_STRING_ELT(state_names, 660, mkChar("offset_output_E1d"));
  SET_STRING_ELT(state_names, 661, mkChar("dim_cumuInf_init"));
  SET_STRING_ELT(state_names, 662, mkChar("cumuInf_init"));
  SET_STRING_ELT(state_names, 663, mkChar("dim_alphaItot"));
  SET_STRING_ELT(state_names, 664, mkChar("alphaItot"));
  SET_STRING_ELT(state_names, 665, mkChar("offset_output_alphaItot"));
  SET_STRING_ELT(state_names, 666, mkChar("dim_prev"));
  SET_STRING_ELT(state_names, 667, mkChar("prev"));
  SET_STRING_ELT(state_names, 668, mkChar("offset_output_prev"));
  SET_STRING_ELT(state_names, 669, mkChar("dim_lambda"));
  SET_STRING_ELT(state_names, 670, mkChar("dim_lambda_1"));
  SET_STRING_ELT(state_names, 671, mkChar("dim_lambda_2"));
  SET_STRING_ELT(state_names, 672, mkChar("lambda"));
  SET_STRING_ELT(state_names, 673, mkChar("offset_output_lambda"));
  SET_STRING_ELT(state_names, 674, mkChar("dim_lambda_0"));
  SET_STRING_ELT(state_names, 675, mkChar("dim_lambda_0_1"));
  SET_STRING_ELT(state_names, 676, mkChar("dim_lambda_0_2"));
  SET_STRING_ELT(state_names, 677, mkChar("lambda_0"));
  SET_STRING_ELT(state_names, 678, mkChar("offset_output_lambda_0"));
  SET_STRING_ELT(state_names, 679, mkChar("dim_lambda_1a"));
  SET_STRING_ELT(state_names, 680, mkChar("dim_lambda_1a_1"));
  SET_STRING_ELT(state_names, 681, mkChar("dim_lambda_1a_2"));
  SET_STRING_ELT(state_names, 682, mkChar("lambda_1a"));
  SET_STRING_ELT(state_names, 683, mkChar("offset_output_lambda_1a"));
  SET_STRING_ELT(state_names, 684, mkChar("dim_lambda_1b"));
  SET_STRING_ELT(state_names, 685, mkChar("dim_lambda_1b_1"));
  SET_STRING_ELT(state_names, 686, mkChar("dim_lambda_1b_2"));
  SET_STRING_ELT(state_names, 687, mkChar("lambda_1b"));
  SET_STRING_ELT(state_names, 688, mkChar("offset_output_lambda_1b"));
  SET_STRING_ELT(state_names, 689, mkChar("dim_lambda_1c"));
  SET_STRING_ELT(state_names, 690, mkChar("dim_lambda_1c_1"));
  SET_STRING_ELT(state_names, 691, mkChar("dim_lambda_1c_2"));
  SET_STRING_ELT(state_names, 692, mkChar("lambda_1c"));
  SET_STRING_ELT(state_names, 693, mkChar("offset_output_lambda_1c"));
  SET_STRING_ELT(state_names, 694, mkChar("dim_lambda_1d"));
  SET_STRING_ELT(state_names, 695, mkChar("dim_lambda_1d_1"));
  SET_STRING_ELT(state_names, 696, mkChar("dim_lambda_1d_2"));
  SET_STRING_ELT(state_names, 697, mkChar("lambda_1d"));
  SET_STRING_ELT(state_names, 698, mkChar("offset_output_lambda_1d"));
  SET_STRING_ELT(state_names, 699, mkChar("dim_lambda_sum_0"));
  SET_STRING_ELT(state_names, 700, mkChar("lambda_sum_0"));
  SET_STRING_ELT(state_names, 701, mkChar("offset_output_lambda_sum_0"));
  SET_STRING_ELT(state_names, 702, mkChar("dim_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 703, mkChar("lambda_sum_1a"));
  SET_STRING_ELT(state_names, 704, mkChar("offset_output_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 705, mkChar("dim_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 706, mkChar("lambda_sum_1b"));
  SET_STRING_ELT(state_names, 707, mkChar("offset_output_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 708, mkChar("dim_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 709, mkChar("lambda_sum_1c"));
  SET_STRING_ELT(state_names, 710, mkChar("offset_output_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 711, mkChar("dim_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 712, mkChar("lambda_sum_1d"));
  SET_STRING_ELT(state_names, 713, mkChar("offset_output_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 714, mkChar("dim_c_comm_balanced"));
  SET_STRING_ELT(state_names, 715, mkChar("c_comm_balanced"));
  SET_STRING_ELT(state_names, 716, mkChar("offset_output_c_comm_balanced"));
  SET_STRING_ELT(state_names, 717, mkChar("dim_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 718, mkChar("c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 719, mkChar("offset_output_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 720, mkChar("dim_theta"));
  SET_STRING_ELT(state_names, 721, mkChar("dim_theta_1"));
  SET_STRING_ELT(state_names, 722, mkChar("dim_theta_2"));
  SET_STRING_ELT(state_names, 723, mkChar("theta"));
  SET_STRING_ELT(state_names, 724, mkChar("offset_output_theta"));
  SET_STRING_ELT(state_names, 725, mkChar("dim_PrEPinitiations_init"));
  SET_STRING_ELT(state_names, 726, mkChar("PrEPinitiations_init"));
  SET_STRING_ELT(state_names, 727, mkChar("dim_M_comm"));
  SET_STRING_ELT(state_names, 728, mkChar("dim_M_comm_1"));
  SET_STRING_ELT(state_names, 729, mkChar("dim_M_comm_2"));
  SET_STRING_ELT(state_names, 730, mkChar("M_comm"));
  SET_STRING_ELT(state_names, 731, mkChar("offset_output_M_comm"));
  SET_STRING_ELT(state_names, 732, mkChar("dim_M_noncomm"));
  SET_STRING_ELT(state_names, 733, mkChar("dim_M_noncomm_1"));
  SET_STRING_ELT(state_names, 734, mkChar("dim_M_noncomm_2"));
  SET_STRING_ELT(state_names, 735, mkChar("M_noncomm"));
  SET_STRING_ELT(state_names, 736, mkChar("offset_output_M_noncomm"));
  SET_STRING_ELT(state_names, 737, mkChar("dim_in_S0"));
  SET_STRING_ELT(state_names, 738, mkChar("dim_in_S0_1"));
  SET_STRING_ELT(state_names, 739, mkChar("dim_in_S0_2"));
  SET_STRING_ELT(state_names, 740, mkChar("in_S0"));
  SET_STRING_ELT(state_names, 741, mkChar("dim_in_S1a"));
  SET_STRING_ELT(state_names, 742, mkChar("dim_in_S1a_1"));
  SET_STRING_ELT(state_names, 743, mkChar("dim_in_S1a_2"));
  SET_STRING_ELT(state_names, 744, mkChar("in_S1a"));
  SET_STRING_ELT(state_names, 745, mkChar("dim_in_S1b"));
  SET_STRING_ELT(state_names, 746, mkChar("dim_in_S1b_1"));
  SET_STRING_ELT(state_names, 747, mkChar("dim_in_S1b_2"));
  SET_STRING_ELT(state_names, 748, mkChar("in_S1b"));
  SET_STRING_ELT(state_names, 749, mkChar("dim_in_S1c"));
  SET_STRING_ELT(state_names, 750, mkChar("dim_in_S1c_1"));
  SET_STRING_ELT(state_names, 751, mkChar("dim_in_S1c_2"));
  SET_STRING_ELT(state_names, 752, mkChar("in_S1c"));
  SET_STRING_ELT(state_names, 753, mkChar("dim_in_S1d"));
  SET_STRING_ELT(state_names, 754, mkChar("dim_in_S1d_1"));
  SET_STRING_ELT(state_names, 755, mkChar("dim_in_S1d_2"));
  SET_STRING_ELT(state_names, 756, mkChar("in_S1d"));
  SET_STRING_ELT(state_names, 757, mkChar("dim_in_I01"));
  SET_STRING_ELT(state_names, 758, mkChar("dim_in_I01_1"));
  SET_STRING_ELT(state_names, 759, mkChar("dim_in_I01_2"));
  SET_STRING_ELT(state_names, 760, mkChar("in_I01"));
  SET_STRING_ELT(state_names, 761, mkChar("dim_in_I11"));
  SET_STRING_ELT(state_names, 762, mkChar("dim_in_I11_1"));
  SET_STRING_ELT(state_names, 763, mkChar("dim_in_I11_2"));
  SET_STRING_ELT(state_names, 764, mkChar("in_I11"));
  SET_STRING_ELT(state_names, 765, mkChar("dim_in_I02"));
  SET_STRING_ELT(state_names, 766, mkChar("dim_in_I02_1"));
  SET_STRING_ELT(state_names, 767, mkChar("dim_in_I02_2"));
  SET_STRING_ELT(state_names, 768, mkChar("in_I02"));
  SET_STRING_ELT(state_names, 769, mkChar("dim_in_I03"));
  SET_STRING_ELT(state_names, 770, mkChar("dim_in_I03_1"));
  SET_STRING_ELT(state_names, 771, mkChar("dim_in_I03_2"));
  SET_STRING_ELT(state_names, 772, mkChar("in_I03"));
  SET_STRING_ELT(state_names, 773, mkChar("dim_in_I04"));
  SET_STRING_ELT(state_names, 774, mkChar("dim_in_I04_1"));
  SET_STRING_ELT(state_names, 775, mkChar("dim_in_I04_2"));
  SET_STRING_ELT(state_names, 776, mkChar("in_I04"));
  SET_STRING_ELT(state_names, 777, mkChar("dim_in_I05"));
  SET_STRING_ELT(state_names, 778, mkChar("dim_in_I05_1"));
  SET_STRING_ELT(state_names, 779, mkChar("dim_in_I05_2"));
  SET_STRING_ELT(state_names, 780, mkChar("in_I05"));
  SET_STRING_ELT(state_names, 781, mkChar("dim_in_I22"));
  SET_STRING_ELT(state_names, 782, mkChar("dim_in_I22_1"));
  SET_STRING_ELT(state_names, 783, mkChar("dim_in_I22_2"));
  SET_STRING_ELT(state_names, 784, mkChar("in_I22"));
  SET_STRING_ELT(state_names, 785, mkChar("dim_in_I23"));
  SET_STRING_ELT(state_names, 786, mkChar("dim_in_I23_1"));
  SET_STRING_ELT(state_names, 787, mkChar("dim_in_I23_2"));
  SET_STRING_ELT(state_names, 788, mkChar("in_I23"));
  SET_STRING_ELT(state_names, 789, mkChar("dim_in_I24"));
  SET_STRING_ELT(state_names, 790, mkChar("dim_in_I24_1"));
  SET_STRING_ELT(state_names, 791, mkChar("dim_in_I24_2"));
  SET_STRING_ELT(state_names, 792, mkChar("in_I24"));
  SET_STRING_ELT(state_names, 793, mkChar("dim_in_I25"));
  SET_STRING_ELT(state_names, 794, mkChar("dim_in_I25_1"));
  SET_STRING_ELT(state_names, 795, mkChar("dim_in_I25_2"));
  SET_STRING_ELT(state_names, 796, mkChar("in_I25"));
  SET_STRING_ELT(state_names, 797, mkChar("dim_in_I32"));
  SET_STRING_ELT(state_names, 798, mkChar("dim_in_I32_1"));
  SET_STRING_ELT(state_names, 799, mkChar("dim_in_I32_2"));
  SET_STRING_ELT(state_names, 800, mkChar("in_I32"));
  SET_STRING_ELT(state_names, 801, mkChar("dim_in_I33"));
  SET_STRING_ELT(state_names, 802, mkChar("dim_in_I33_1"));
  SET_STRING_ELT(state_names, 803, mkChar("dim_in_I33_2"));
  SET_STRING_ELT(state_names, 804, mkChar("in_I33"));
  SET_STRING_ELT(state_names, 805, mkChar("dim_in_I34"));
  SET_STRING_ELT(state_names, 806, mkChar("dim_in_I34_1"));
  SET_STRING_ELT(state_names, 807, mkChar("dim_in_I34_2"));
  SET_STRING_ELT(state_names, 808, mkChar("in_I34"));
  SET_STRING_ELT(state_names, 809, mkChar("dim_in_I35"));
  SET_STRING_ELT(state_names, 810, mkChar("dim_in_I35_1"));
  SET_STRING_ELT(state_names, 811, mkChar("dim_in_I35_2"));
  SET_STRING_ELT(state_names, 812, mkChar("in_I35"));
  SET_STRING_ELT(state_names, 813, mkChar("dim_in_I42"));
  SET_STRING_ELT(state_names, 814, mkChar("dim_in_I42_1"));
  SET_STRING_ELT(state_names, 815, mkChar("dim_in_I42_2"));
  SET_STRING_ELT(state_names, 816, mkChar("in_I42"));
  SET_STRING_ELT(state_names, 817, mkChar("dim_in_I43"));
  SET_STRING_ELT(state_names, 818, mkChar("dim_in_I43_1"));
  SET_STRING_ELT(state_names, 819, mkChar("dim_in_I43_2"));
  SET_STRING_ELT(state_names, 820, mkChar("in_I43"));
  SET_STRING_ELT(state_names, 821, mkChar("dim_in_I44"));
  SET_STRING_ELT(state_names, 822, mkChar("dim_in_I44_1"));
  SET_STRING_ELT(state_names, 823, mkChar("dim_in_I44_2"));
  SET_STRING_ELT(state_names, 824, mkChar("in_I44"));
  SET_STRING_ELT(state_names, 825, mkChar("dim_in_I45"));
  SET_STRING_ELT(state_names, 826, mkChar("dim_in_I45_1"));
  SET_STRING_ELT(state_names, 827, mkChar("dim_in_I45_2"));
  SET_STRING_ELT(state_names, 828, mkChar("in_I45"));
  SET_STRING_ELT(state_names, 829, mkChar("dim_rate_move_in"));
  SET_STRING_ELT(state_names, 830, mkChar("dim_rate_move_in_1"));
  SET_STRING_ELT(state_names, 831, mkChar("dim_rate_move_in_2"));
  SET_STRING_ELT(state_names, 832, mkChar("rate_move_in"));
  SET_STRING_ELT(state_names, 833, mkChar("offset_output_rate_move_in"));
  SET_STRING_ELT(state_names, 834, mkChar("dim_rate_move_out"));
  SET_STRING_ELT(state_names, 835, mkChar("rate_move_out"));
  SET_STRING_ELT(state_names, 836, mkChar("offset_output_rate_move_out"));
  SET_STRING_ELT(state_names, 837, mkChar("interpolate_pfFSW"));
  SET_STRING_ELT(state_names, 838, mkChar("interpolate_c_comm"));
  SET_STRING_ELT(state_names, 839, mkChar("interpolate_c_noncomm"));
  SET_STRING_ELT(state_names, 840, mkChar("interpolate_ART_eligible_CD4_above_500"));
  SET_STRING_ELT(state_names, 841, mkChar("ART_eligible_CD4_above_500"));
  SET_STRING_ELT(state_names, 842, mkChar("interpolate_ART_eligible_CD4_350_500"));
  SET_STRING_ELT(state_names, 843, mkChar("ART_eligible_CD4_350_500"));
  SET_STRING_ELT(state_names, 844, mkChar("interpolate_ART_eligible_CD4_200_349"));
  SET_STRING_ELT(state_names, 845, mkChar("ART_eligible_CD4_200_349"));
  SET_STRING_ELT(state_names, 846, mkChar("interpolate_ART_eligible_CD4_below_200"));
  SET_STRING_ELT(state_names, 847, mkChar("ART_eligible_CD4_below_200"));
  SET_STRING_ELT(state_names, 848, mkChar("interpolate_testing_prob"));
  SET_STRING_ELT(state_names, 849, mkChar("interpolate_tau_intervention"));
  SET_STRING_ELT(state_names, 850, mkChar("interpolate_rho_intervention"));
  SET_STRING_ELT(state_names, 851, mkChar("interpolate_viral_supp"));
  SET_STRING_ELT(state_names, 852, mkChar("interpolate_infect_ART"));
  SET_STRING_ELT(state_names, 853, mkChar("interpolate_epsilon"));
  SET_STRING_ELT(state_names, 854, mkChar("epsilon"));
  SET_STRING_ELT(state_names, 855, mkChar("interpolate_prep_offered"));
  SET_STRING_ELT(state_names, 856, mkChar("interpolate_fc_comm"));
  SET_STRING_ELT(state_names, 857, mkChar("interpolate_fP_comm"));
  SET_STRING_ELT(state_names, 858, mkChar("interpolate_fc_noncomm"));
  SET_STRING_ELT(state_names, 859, mkChar("interpolate_fP_noncomm"));
  SET_STRING_ELT(state_names, 860, mkChar("interpolate_n_comm"));
  SET_STRING_ELT(state_names, 861, mkChar("interpolate_n_noncomm"));
  SET_STRING_ELT(state_names, 862, mkChar("dim"));
  SET_STRING_ELT(state_names, 863, mkChar("dim_output"));
...
SEXP main_model_output_order(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  int *tmp;
  SEXP state_len = PROTECT(allocVector(VECSXP, 172));
  SEXP state_names = PROTECT(allocVector(STRSXP, 172));
  ...
  SET_STRING_ELT(state_names, 1, mkChar("ART_eligible_CD4_above_500"));
  SET_VECTOR_ELT(state_len, 2, R_NilValue);
  SET_STRING_ELT(state_names, 2, mkChar("ART_eligible_CD4_350_500"));
  SET_VECTOR_ELT(state_len, 3, R_NilValue);
  SET_STRING_ELT(state_names, 3, mkChar("ART_eligible_CD4_200_349"));
  SET_VECTOR_ELT(state_len, 4, R_NilValue);
  SET_STRING_ELT(state_names, 4, mkChar("ART_eligible_CD4_below_200"));
  SET_VECTOR_ELT(state_len, 5, R_NilValue);
  SET_STRING_ELT(state_names, 5, mkChar("TasP_testing"));
  SET_VECTOR_ELT(state_len, 6, R_NilValue);
  SET_STRING_ELT(state_names, 6, mkChar("PrEPOnOff"));
  SET_VECTOR_ELT(state_len, 7, R_NilValue);
  SET_STRING_ELT(state_names, 7, mkChar("fPa"));
  SET_VECTOR_ELT(state_len, 8, R_NilValue);
  SET_STRING_ELT(state_names, 8, mkChar("fPb"));
  SET_VECTOR_ELT(state_len, 9, R_NilValue);
  SET_STRING_ELT(state_names, 9, mkChar("fPc"));
  SET_VECTOR_ELT(state_len, 10, R_NilValue);
  SET_STRING_ELT(state_names, 10, mkChar("W0"));
  SET_VECTOR_ELT(state_len, 11, R_NilValue);
  SET_STRING_ELT(state_names, 11, mkChar("W1"));
  SET_VECTOR_ELT(state_len, 12, R_NilValue);
  SET_STRING_ELT(state_names, 12, mkChar("W2"));
  SET_VECTOR_ELT(state_len, 13, R_NilValue);
  SET_STRING_ELT(state_names, 13, mkChar("W3"));
  SET_VECTOR_ELT(state_len, 14, R_NilValue);
  SET_STRING_ELT(state_names, 14, mkChar("cost_Initiation_of_ART_study_FSW"));
  SET_VECTOR_ELT(state_len, 15, R_NilValue);
  SET_STRING_ELT(state_names, 15, mkChar("cost_Initiation_of_ART_government_FSW"));
  SET_VECTOR_ELT(state_len, 16, R_NilValue);
  SET_STRING_ELT(state_names, 16, mkChar("cost_1_year_of_ART_study_FSW"));
  SET_VECTOR_ELT(state_len, 17, R_NilValue);
  SET_STRING_ELT(state_names, 17, mkChar("cost_1_year_of_ART_government_FSW"));
  SET_VECTOR_ELT(state_len, 18, R_NilValue);
  SET_STRING_ELT(state_names, 18, mkChar("cost_Initiation_ART_rest_of_population"));
  SET_VECTOR_ELT(state_len, 19, R_NilValue);
  SET_STRING_ELT(state_names, 19, mkChar("cost_1_year_of_ART_rest_of_population"));
  SET_VECTOR_ELT(state_len, 20, R_NilValue);
  SET_STRING_ELT(state_names, 20, mkChar("cost_FSW_initiation_ART_Patient_costs"));
  SET_VECTOR_ELT(state_len, 21, R_NilValue);
  SET_STRING_ELT(state_names, 21, mkChar("cost_FSW_1_year_ART_Patient_costs"));
  SET_VECTOR_ELT(state_len, 22, R_NilValue);
  SET_STRING_ELT(state_names, 22, mkChar("cost_Initiation_of_PrEP_study"));
  SET_VECTOR_ELT(state_len, 23, R_NilValue);
  SET_STRING_ELT(state_names, 23, mkChar("cost_1_year_PrEP_perfect_adherence_study"));
  SET_VECTOR_ELT(state_len, 24, R_NilValue);
  SET_STRING_ELT(state_names, 24, mkChar("cost_1_year_PrEP_intermediate_adherence_study"));
  SET_VECTOR_ELT(state_len, 25, R_NilValue);
  SET_STRING_ELT(state_names, 25, mkChar("cost_1_year_PrEP_non_adherence_study"));
  SET_VECTOR_ELT(state_len, 26, R_NilValue);
  SET_STRING_ELT(state_names, 26, mkChar("cost_Initiation_of_PrEP_government"));
  SET_VECTOR_ELT(state_len, 27, R_NilValue);
  SET_STRING_ELT(state_names, 27, mkChar("cost_1_year_PrEP_perfect_adherence_government"));
  SET_VECTOR_ELT(state_len, 28, R_NilValue);
  SET_STRING_ELT(state_names, 28, mkChar("cost_1_year_PrEP_intermediate_adherence_government"));
  SET_VECTOR_ELT(state_len, 29, R_NilValue);
  SET_STRING_ELT(state_names, 29, mkChar("cost_1_year_PrEP_non_adherence_government"));
  SET_VECTOR_ELT(state_len, 30, R_NilValue);
  SET_STRING_ELT(state_names, 30, mkChar("cost_PREP_initiation_Patient_costs"));
  SET_VECTOR_ELT(state_len, 31, R_NilValue);
  SET_STRING_ELT(state_names, 31, mkChar("cost_PREP_1_year_ART_Patient_costs"));
  SET_VECTOR_ELT(state_len, 32, R_NilValue);
  SET_STRING_ELT(state_names, 32, mkChar("cumuInftot"));
  SET_VECTOR_ELT(state_len, 33, R_NilValue);
  SET_STRING_ELT(state_names, 33, mkChar("ART_sex_ratio"));
  SET_VECTOR_ELT(state_len, 34, R_NilValue);
  SET_STRING_ELT(state_names, 34, mkChar("pc_S1a"));
  SET_VECTOR_ELT(state_len, 35, R_NilValue);
  SET_STRING_ELT(state_names, 35, mkChar("pc_S1b"));
  SET_VECTOR_ELT(state_len, 36, R_NilValue);
  SET_STRING_ELT(state_names, 36, mkChar("pc_S1c"));
  SET_VECTOR_ELT(state_len, 37, R_NilValue);
  SET_STRING_ELT(state_names, 37, mkChar("pc_susceptible_FSW_On_PrEP"));
  SET_VECTOR_ELT(state_len, 38, R_NilValue);
  SET_STRING_ELT(state_names, 38, mkChar("pc_all_FSW_On_PrEP"));
  SET_VECTOR_ELT(state_len, 39, R_NilValue);
  SET_STRING_ELT(state_names, 39, mkChar("FSW_On_PrEP_all_cats"));
  SET_VECTOR_ELT(state_len, 40, R_NilValue);
  SET_STRING_ELT(state_names, 40, mkChar("Men_on_ART"));
  SET_VECTOR_ELT(state_len, 41, R_NilValue);
  SET_STRING_ELT(state_names, 41, mkChar("Women_on_ART"));
  SET_VECTOR_ELT(state_len, 42, R_NilValue);
  SET_STRING_ELT(state_names, 42, mkChar("ART_coverage_men"));
  SET_VECTOR_ELT(state_len, 43, R_NilValue);
  SET_STRING_ELT(state_names, 43, mkChar("ART_coverage_women"));
  SET_VECTOR_ELT(state_len, 44, R_NilValue);
  SET_STRING_ELT(state_names, 44, mkChar("ART_coverage_FSW"));
  SET_VECTOR_ELT(state_len, 45, R_NilValue);
  SET_STRING_ELT(state_names, 45, mkChar("ART_coverage_all"));
  SET_VECTOR_ELT(state_len, 46, R_NilValue);
  SET_STRING_ELT(state_names, 46, mkChar("Ncat"));
  SET_VECTOR_ELT(state_len, 47, R_NilValue);
  SET_STRING_ELT(state_names, 47, mkChar("nu"));
  SET_VECTOR_ELT(state_len, 48, R_NilValue);
  SET_STRING_ELT(state_names, 48, mkChar("Nage"));
  SET_VECTOR_ELT(state_len, 49, R_NilValue);
  SET_STRING_ELT(state_names, 49, mkChar("dur_FSW"));
  SET_VECTOR_ELT(state_len, 50, R_NilValue);
  SET_STRING_ELT(state_names, 50, mkChar("epsilon"));
  SET_VECTOR_ELT(state_len, 51, R_NilValue);
  SET_STRING_ELT(state_names, 51, mkChar("Ntot_inc_former_FSW_nonCot"));
  SET_VECTOR_ELT(state_len, 52, R_NilValue);
  SET_STRING_ELT(state_names, 52, mkChar("new_people"));
  SET_VECTOR_ELT(state_len, 53, R_NilValue);
  SET_STRING_ELT(state_names, 53, mkChar("frac_virgin"));
  SET_VECTOR_ELT(state_len, 54, R_NilValue);
  SET_STRING_ELT(state_names, 54, mkChar("prev_LowFSW"));
  SET_VECTOR_ELT(state_len, 55, R_NilValue);
  SET_STRING_ELT(state_names, 55, mkChar("prev_men"));
  SET_VECTOR_ELT(state_len, 56, R_NilValue);
  SET_STRING_ELT(state_names, 56, mkChar("prev_women"));
  SET_VECTOR_ELT(state_len, 57, R_NilValue);
  SET_STRING_ELT(state_names, 57, mkChar("prev_cotonou"));
  SET_VECTOR_ELT(state_len, 58, R_NilValue);
  SET_STRING_ELT(state_names, 58, mkChar("Ntot"));
  SET_VECTOR_ELT(state_len, 59, R_NilValue);
  SET_STRING_ELT(state_names, 59, mkChar("prev_FSW"));
  SET_VECTOR_ELT(state_len, 60, R_NilValue);
  SET_STRING_ELT(state_names, 60, mkChar("prev_client"));
  SET_VECTOR_ELT(state_len, 61, R_NilValue);
  SET_STRING_ELT(state_names, 61, mkChar("B_check_comm"));
  SET_VECTOR_ELT(state_len, 62, R_NilValue);
  SET_STRING_ELT(state_names, 62, mkChar("B_check_noncomm"));
  SET_VECTOR_ELT(state_len, 63, R_NilValue);
  SET_STRING_ELT(state_names, 63, mkChar("pc_of_FOI_on_clients_from_pro_FSW"));
  SET_VECTOR_ELT(state_len, 64, R_NilValue);
  SET_STRING_ELT(state_names, 64, mkChar("FSW_in"));
  SET_VECTOR_ELT(state_len, 65, R_NilValue);
  SET_STRING_ELT(state_names, 65, mkChar("FSW_out"));
  SET_VECTOR_ELT(state_len, 66, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 66));
  tmp[0] = main_model_p->dim_infect_ART_y_1;
  tmp[1] = main_model_p->dim_infect_ART_y_2;
  SET_STRING_ELT(state_names, 66, mkChar("infect_ART_y"));
  SET_VECTOR_ELT(state_len, 67, ScalarInteger(main_model_p->dim_infect_ART_t));
  SET_STRING_ELT(state_names, 67, mkChar("infect_ART_t"));
  SET_VECTOR_ELT(state_len, 68, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 68));
  tmp[0] = main_model_p->dim_viral_supp_y_1;
  tmp[1] = main_model_p->dim_viral_supp_y_2;
  SET_STRING_ELT(state_names, 68, mkChar("viral_supp_y"));
  SET_VECTOR_ELT(state_len, 69, ScalarInteger(main_model_p->dim_viral_supp_t));
  SET_STRING_ELT(state_names, 69, mkChar("viral_supp_t"));
  SET_VECTOR_ELT(state_len, 70, ScalarInteger(main_model_p->dim_gamma32_without_supp));
  SET_STRING_ELT(state_names, 70, mkChar("gamma32_without_supp"));
  SET_VECTOR_ELT(state_len, 71, ScalarInteger(main_model_p->dim_gamma33_without_supp));
  SET_STRING_ELT(state_names, 71, mkChar("gamma33_without_supp"));
  SET_VECTOR_ELT(state_len, 72, ScalarInteger(main_model_p->dim_gamma34_without_supp));
  SET_STRING_ELT(state_names, 72, mkChar("gamma34_without_supp"));
  SET_VECTOR_ELT(state_len, 73, ScalarInteger(main_model_p->dim_alpha33_without_supp));
  SET_STRING_ELT(state_names, 73, mkChar("alpha33_without_supp"));
  SET_VECTOR_ELT(state_len, 74, ScalarInteger(main_model_p->dim_alpha34_without_supp));
  SET_STRING_ELT(state_names, 74, mkChar("alpha34_without_supp"));
  SET_VECTOR_ELT(state_len, 75, ScalarInteger(main_model_p->dim_alpha35_without_supp));
  SET_STRING_ELT(state_names, 75, mkChar("alpha35_without_supp"));
  SET_VECTOR_ELT(state_len, 76, ScalarInteger(main_model_p->dim_c_comm));
  SET_STRING_ELT(state_names, 76, mkChar("c_comm"));
  SET_VECTOR_ELT(state_len, 77, ScalarInteger(main_model_p->dim_c_noncomm));
  SET_STRING_ELT(state_names, 77, mkChar("c_noncomm"));
  SET_VECTOR_ELT(state_len, 78, ScalarInteger(main_model_p->dim_pfFSW));
  SET_STRING_ELT(state_names, 78, mkChar("pfFSW"));
  SET_VECTOR_ELT(state_len, 79, ScalarInteger(main_model_p->dim_new_acute_infected));
  SET_STRING_ELT(state_names, 79, mkChar("new_acute_infected"));
  SET_VECTOR_ELT(state_len, 80, ScalarInteger(main_model_p->dim_new_people_in_group));
  SET_STRING_ELT(state_names, 80, mkChar("new_people_in_group"));
  SET_VECTOR_ELT(state_len, 81, ScalarInteger(main_model_p->dim_new_people_in_group_FSW_only));
  SET_STRING_ELT(state_names, 81, mkChar("new_people_in_group_FSW_only"));
  SET_VECTOR_ELT(state_len, 82, ScalarInteger(main_model_p->dim_above_500_by_group));
  SET_STRING_ELT(state_names, 82, mkChar("above_500_by_group"));
  SET_VECTOR_ELT(state_len, 83, ScalarInteger(main_model_p->dim_testing_prob));
  SET_STRING_ELT(state_names, 83, mkChar("testing_prob"));
  SET_VECTOR_ELT(state_len, 84, ScalarInteger(main_model_p->dim_tau_intervention));
  SET_STRING_ELT(state_names, 84, mkChar("tau_intervention"));
  SET_VECTOR_ELT(state_len, 85, ScalarInteger(main_model_p->dim_rho_intervention));
  SET_STRING_ELT(state_names, 85, mkChar("rho_intervention"));
  SET_VECTOR_ELT(state_len, 86, ScalarInteger(main_model_p->dim_zeta));
  SET_STRING_ELT(state_names, 86, mkChar("zeta"));
  SET_VECTOR_ELT(state_len, 87, ScalarInteger(main_model_p->dim_eP1a_effective));
  SET_STRING_ELT(state_names, 87, mkChar("eP1a_effective"));
  SET_VECTOR_ELT(state_len, 88, ScalarInteger(main_model_p->dim_eP1b_effective));
  SET_STRING_ELT(state_names, 88, mkChar("eP1b_effective"));
  SET_VECTOR_ELT(state_len, 89, ScalarInteger(main_model_p->dim_eP1c_effective));
  SET_STRING_ELT(state_names, 89, mkChar("eP1c_effective"));
  SET_VECTOR_ELT(state_len, 90, ScalarInteger(main_model_p->dim_tau));
  SET_STRING_ELT(state_names, 90, mkChar("tau"));
  SET_VECTOR_ELT(state_len, 91, ScalarInteger(main_model_p->dim_rho));
  SET_STRING_ELT(state_names, 91, mkChar("rho"));
  SET_VECTOR_ELT(state_len, 92, ScalarInteger(main_model_p->dim_iota));
  SET_STRING_ELT(state_names, 92, mkChar("iota"));
  SET_VECTOR_ELT(state_len, 93, ScalarInteger(main_model_p->dim_viral_supp));
  SET_STRING_ELT(state_names, 93, mkChar("viral_supp"));
  SET_VECTOR_ELT(state_len, 94, ScalarInteger(main_model_p->dim_HIV_positive));
  SET_STRING_ELT(state_names, 94, mkChar("HIV_positive"));
  SET_VECTOR_ELT(state_len, 95, ScalarInteger(main_model_p->dim_Number_Susceptibles));
  SET_STRING_ELT(state_names, 95, mkChar("Number_Susceptibles"));
  SET_VECTOR_ELT(state_len, 96, ScalarInteger(main_model_p->dim_HIV_positive_Diagnosed_Off_ART));
  SET_STRING_ELT(state_names, 96, mkChar("HIV_positive_Diagnosed_Off_ART"));
  SET_VECTOR_ELT(state_len, 97, ScalarInteger(main_model_p->dim_Primary_Off_ART));
  SET_STRING_ELT(state_names, 97, mkChar("Primary_Off_ART"));
  SET_VECTOR_ELT(state_len, 98, ScalarInteger(main_model_p->dim_CD4_above_500_Off_ART));
  SET_STRING_ELT(state_names, 98, mkChar("CD4_above_500_Off_ART"));
  SET_VECTOR_ELT(state_len, 99, ScalarInteger(main_model_p->dim_CD4_350_500_Off_ART));
  SET_STRING_ELT(state_names, 99, mkChar("CD4_350_500_Off_ART"));
  SET_VECTOR_ELT(state_len, 100, ScalarInteger(main_model_p->dim_CD4_200_350_Off_ART));
  SET_STRING_ELT(state_names, 100, mkChar("CD4_200_350_Off_ART"));
  SET_VECTOR_ELT(state_len, 101, ScalarInteger(main_model_p->dim_CD4_below_200_Off_ART));
  SET_STRING_ELT(state_names, 101, mkChar("CD4_below_200_Off_ART"));
  SET_VECTOR_ELT(state_len, 102, ScalarInteger(main_model_p->dim_HIV_positive_On_ART));
  SET_STRING_ELT(state_names, 102, mkChar("HIV_positive_On_ART"));
  SET_VECTOR_ELT(state_len, 103, ScalarInteger(main_model_p->dim_Number_DALY_W1));
  SET_STRING_ELT(state_names, 103, mkChar("Number_DALY_W1"));
  SET_VECTOR_ELT(state_len, 104, ScalarInteger(main_model_p->dim_Number_DALY_W2));
  SET_STRING_ELT(state_names, 104, mkChar("Number_DALY_W2"));
  SET_VECTOR_ELT(state_len, 105, ScalarInteger(main_model_p->dim_Number_DALY_W3));
  SET_STRING_ELT(state_names, 105, mkChar("Number_DALY_W3"));
  SET_VECTOR_ELT(state_len, 106, ScalarInteger(main_model_p->dim_frac_F));
  SET_STRING_ELT(state_names, 106, mkChar("frac_F"));
  SET_VECTOR_ELT(state_len, 107, ScalarInteger(main_model_p->dim_frac_N_sexualpop));
  SET_STRING_ELT(state_names, 107, mkChar("frac_N_sexualpop"));
  SET_VECTOR_ELT(state_len, 108, ScalarInteger(main_model_p->dim_ART_coverage));
  SET_STRING_ELT(state_names, 108, mkChar("ART_coverage"));
  SET_VECTOR_ELT(state_len, 109, ScalarInteger(main_model_p->dim_infect_ART));
  SET_STRING_ELT(state_names, 109, mkChar("infect_ART"));
  SET_VECTOR_ELT(state_len, 110, ScalarInteger(main_model_p->dim_prep_offered));
  SET_STRING_ELT(state_names, 110, mkChar("prep_offered"));
  SET_VECTOR_ELT(state_len, 111, ScalarInteger(main_model_p->dim_omega));
  SET_STRING_ELT(state_names, 111, mkChar("omega"));
  SET_VECTOR_ELT(state_len, 112, ScalarInteger(main_model_p->dim_frac_N));
  SET_STRING_ELT(state_names, 112, mkChar("frac_N"));
  SET_VECTOR_ELT(state_len, 113, ScalarInteger(main_model_p->dim_mu));
  SET_STRING_ELT(state_names, 113, mkChar("mu"));
  SET_VECTOR_ELT(state_len, 114, ScalarInteger(main_model_p->dim_gamma01));
  SET_STRING_ELT(state_names, 114, mkChar("gamma01"));
  SET_VECTOR_ELT(state_len, 115, ScalarInteger(main_model_p->dim_gamma11));
  SET_STRING_ELT(state_names, 115, mkChar("gamma11"));
  SET_VECTOR_ELT(state_len, 116, ScalarInteger(main_model_p->dim_gamma32));
  SET_STRING_ELT(state_names, 116, mkChar("gamma32"));
  SET_VECTOR_ELT(state_len, 117, ScalarInteger(main_model_p->dim_gamma33));
  SET_STRING_ELT(state_names, 117, mkChar("gamma33"));
  SET_VECTOR_ELT(state_len, 118, ScalarInteger(main_model_p->dim_gamma34));
  SET_STRING_ELT(state_names, 118, mkChar("gamma34"));
  SET_VECTOR_ELT(state_len, 119, ScalarInteger(main_model_p->dim_kappaa));
  SET_STRING_ELT(state_names, 119, mkChar("kappaa"));
  SET_VECTOR_ELT(state_len, 120, ScalarInteger(main_model_p->dim_kappab));
  SET_STRING_ELT(state_names, 120, mkChar("kappab"));
  SET_VECTOR_ELT(state_len, 121, ScalarInteger(main_model_p->dim_kappac));
  SET_STRING_ELT(state_names, 121, mkChar("kappac"));
  SET_VECTOR_ELT(state_len, 122, ScalarInteger(main_model_p->dim_kappa1));
  SET_STRING_ELT(state_names, 122, mkChar("kappa1"));
  SET_VECTOR_ELT(state_len, 123, ScalarInteger(main_model_p->dim_alpha01));
  SET_STRING_ELT(state_names, 123, mkChar("alpha01"));
  SET_VECTOR_ELT(state_len, 124, ScalarInteger(main_model_p->dim_alpha02));
  SET_STRING_ELT(state_names, 124, mkChar("alpha02"));
  SET_VECTOR_ELT(state_len, 125, ScalarInteger(main_model_p->dim_alpha05));
  SET_STRING_ELT(state_names, 125, mkChar("alpha05"));
  SET_VECTOR_ELT(state_len, 126, ScalarInteger(main_model_p->dim_alpha11));
  SET_STRING_ELT(state_names, 126, mkChar("alpha11"));
  SET_VECTOR_ELT(state_len, 127, ScalarInteger(main_model_p->dim_alpha22));
  SET_STRING_ELT(state_names, 127, mkChar("alpha22"));
  SET_VECTOR_ELT(state_len, 128, ScalarInteger(main_model_p->dim_alpha33));
  SET_STRING_ELT(state_names, 128, mkChar("alpha33"));
  SET_VECTOR_ELT(state_len, 129, ScalarInteger(main_model_p->dim_alpha34));
  SET_STRING_ELT(state_names, 129, mkChar("alpha34"));
  SET_VECTOR_ELT(state_len, 130, ScalarInteger(main_model_p->dim_alpha35));
  SET_STRING_ELT(state_names, 130, mkChar("alpha35"));
  SET_VECTOR_ELT(state_len, 131, ScalarInteger(main_model_p->dim_beta_comm));
  SET_STRING_ELT(state_names, 131, mkChar("beta_comm"));
  SET_VECTOR_ELT(state_len, 132, ScalarInteger(main_model_p->dim_beta_noncomm));
  SET_STRING_ELT(state_names, 132, mkChar("beta_noncomm"));
  SET_VECTOR_ELT(state_len, 133, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 133));
  tmp[0] = main_model_p->dim_p_comm_1;
  tmp[1] = main_model_p->dim_p_comm_2;
  SET_STRING_ELT(state_names, 133, mkChar("p_comm"));
  ...
  SET_STRING_ELT(state_names, 134, mkChar("p_noncomm"));
  SET_VECTOR_ELT(state_len, 135, ScalarInteger(main_model_p->dim_eP0));
  SET_STRING_ELT(state_names, 135, mkChar("eP0"));
  SET_VECTOR_ELT(state_len, 136, ScalarInteger(main_model_p->dim_eP1a));
  SET_STRING_ELT(state_names, 136, mkChar("eP1a"));
  SET_VECTOR_ELT(state_len, 137, ScalarInteger(main_model_p->dim_eP1b));
  SET_STRING_ELT(state_names, 137, mkChar("eP1b"));
  SET_VECTOR_ELT(state_len, 138, ScalarInteger(main_model_p->dim_eP1c));
  SET_STRING_ELT(state_names, 138, mkChar("eP1c"));
  SET_VECTOR_ELT(state_len, 139, ScalarInteger(main_model_p->dim_eP1d));
  SET_STRING_ELT(state_names, 139, mkChar("eP1d"));
  ...
  SET_STRING_ELT(state_names, 140, mkChar("fc_comm"));
  SET_VECTOR_ELT(state_len, 141, ScalarInteger(main_model_p->dim_fP_comm));
  SET_STRING_ELT(state_names, 141, mkChar("fP_comm"));
  ...
  SET_STRING_ELT(state_names, 142, mkChar("fc_noncomm"));
  SET_VECTOR_ELT(state_len, 143, ScalarInteger(main_model_p->dim_fP_noncomm));
  SET_STRING_ELT(state_names, 143, mkChar("fP_noncomm"));
  SET_VECTOR_ELT(state_len, 144, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 144));
  tmp[0] = main_model_p->dim_n_comm_1;
  tmp[1] = main_model_p->dim_n_comm_2;
  SET_STRING_ELT(state_names, 144, mkChar("n_comm"));
  ...
  SET_STRING_ELT(state_names, 145, mkChar("n_noncomm"));
  SET_VECTOR_ELT(state_len, 146, ScalarInteger(main_model_p->dim_N));
  SET_STRING_ELT(state_names, 146, mkChar("N"));
  SET_VECTOR_ELT(state_len, 147, ScalarInteger(main_model_p->dim_E0));
  SET_STRING_ELT(state_names, 147, mkChar("E0"));
  SET_VECTOR_ELT(state_len, 148, ScalarInteger(main_model_p->dim_E1a));
  SET_STRING_ELT(state_names, 148, mkChar("E1a"));
  SET_VECTOR_ELT(state_len, 149, ScalarInteger(main_model_p->dim_E1b));
  SET_STRING_ELT(state_names, 149, mkChar("E1b"));
  SET_VECTOR_ELT(state_len, 150, ScalarInteger(main_model_p->dim_E1c));
  SET_STRING_ELT(state_names, 150, mkChar("E1c"));
  SET_VECTOR_ELT(state_len, 151, ScalarInteger(main_model_p->dim_E1d));
  SET_STRING_ELT(state_names, 151, mkChar("E1d"));
  SET_VECTOR_ELT(state_len, 152, ScalarInteger(main_model_p->dim_alphaItot));
  SET_STRING_ELT(state_names, 152, mkChar("alphaItot"));
  SET_VECTOR_ELT(state_len, 153, ScalarInteger(main_model_p->dim_prev));
  SET_STRING_ELT(state_names, 153, mkChar("prev"));
  ...
  SET_STRING_ELT(state_names, 154, mkChar("lambda"));
  ...
  SET_STRING_ELT(state_names, 155, mkChar("lambda_0"));
  ...
  SET_STRING_ELT(state_names, 156, mkChar("lambda_1a"));
  ...
  SET_STRING_ELT(state_names, 157, mkChar("lambda_1b"));
  ...
  SET_STRING_ELT(state_names, 158, mkChar("lambda_1c"));
  ...
  SET_STRING_ELT(state_names, 159, mkChar("lambda_1d"));
  SET_VECTOR_ELT(state_len, 160, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_STRING_ELT(state_names, 160, mkChar("lambda_sum_0"));
  SET_VECTOR_ELT(state_len, 161, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_STRING_ELT(state_names, 161, mkChar("lambda_sum_1a"));
  SET_VECTOR_ELT(state_len, 162, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_STRING_ELT(state_names, 162, mkChar("lambda_sum_1b"));
  SET_VECTOR_ELT(state_len, 163, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_STRING_ELT(state_names, 163, mkChar("lambda_sum_1c"));
  SET_VECTOR_ELT(state_len, 164, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_STRING_ELT(state_names, 164, mkChar("lambda_sum_1d"));
  SET_VECTOR_ELT(state_len, 165, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_STRING_ELT(state_names, 165, mkChar("c_comm_balanced"));
  SET_VECTOR_ELT(state_len, 166, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_STRING_ELT(state_names, 166, mkChar("c_noncomm_balanced"));
  ...
  SET_STRING_ELT(state_names, 167, mkChar("theta"));
  ...
  SET_STRING_ELT(state_names, 168, mkChar("M_comm"));
  ...
  SET_STRING_ELT(state_names, 169, mkChar("M_noncomm"));
  ...
  SET_STRING_ELT(state_names, 170, mkChar("rate_move_in"));
  SET_VECTOR_ELT(state_len, 171, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_STRING_ELT(state_names, 171, mkChar("rate_move_out"));
  setAttrib(state_len, R_NamesSymbol, state_names);
  UNPROTECT(2);
  return state_len;
}
