...
SEXP main_model_set_user(main_model_pars *main_model_p, SEXP user) {
  ...
  main_model_p->offset_output_infect_ART_y = 26;
  ...
  main_model_p->offset_output_infect_ART_t = 26 + main_model_p->dim_infect_ART_y;
...
void main_model_deriv(main_model_pars *main_model_p, double t, double *state, double *dstatedt, double *output) {
  ...
  if (output != NULL) {
    double *output_infect_ART_y = output + 26;
    ...
    output[6] = ART_coverage_men;
    output[7] = ART_coverage_women;
    output[8] = ART_coverage_FSW;
    output[9] = ART_coverage_all;
    output[10] = main_model_p->Ncat;
    ...
    output[11] = main_model_p->nu;
    output[12] = main_model_p->Nage;
    output[13] = main_model_p->dur_FSW;
    memcpy(output_infect_ART, main_model_p->infect_ART, main_model_p->dim_infect_ART * sizeof(double));
    output[14] = main_model_p->epsilon;
    ...
    output[15] = Ntot_inc_former_FSW_nonCot;
...
SEXP main_model_output_order(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  int *tmp;
  SEXP state_len = PROTECT(allocVector(VECSXP, 93));
  SEXP state_names = PROTECT(allocVector(STRSXP, 93));
  ...
  SET_STRING_ELT(state_names, 6, mkChar("ART_coverage_men"));
  SET_VECTOR_ELT(state_len, 7, R_NilValue);
  SET_STRING_ELT(state_names, 7, mkChar("ART_coverage_women"));
  SET_VECTOR_ELT(state_len, 8, R_NilValue);
  SET_STRING_ELT(state_names, 8, mkChar("ART_coverage_FSW"));
  SET_VECTOR_ELT(state_len, 9, R_NilValue);
  SET_STRING_ELT(state_names, 9, mkChar("ART_coverage_all"));
  SET_VECTOR_ELT(state_len, 10, R_NilValue);
  SET_STRING_ELT(state_names, 10, mkChar("Ncat"));
  SET_VECTOR_ELT(state_len, 11, R_NilValue);
  SET_STRING_ELT(state_names, 11, mkChar("nu"));
  SET_VECTOR_ELT(state_len, 12, R_NilValue);
  SET_STRING_ELT(state_names, 12, mkChar("Nage"));
  SET_VECTOR_ELT(state_len, 13, R_NilValue);
  SET_STRING_ELT(state_names, 13, mkChar("dur_FSW"));
  SET_VECTOR_ELT(state_len, 14, R_NilValue);
  SET_STRING_ELT(state_names, 14, mkChar("epsilon"));
  SET_VECTOR_ELT(state_len, 15, R_NilValue);
  SET_STRING_ELT(state_names, 15, mkChar("Ntot_inc_former_FSW_nonCot"));
  ...
  SET_STRING_ELT(state_names, 17, mkChar("frac_virgin"));
  SET_VECTOR_ELT(state_len, 18, R_NilValue);
  SET_STRING_ELT(state_names, 18, mkChar("prev_LowFSW"));
  SET_VECTOR_ELT(state_len, 19, R_NilValue);
  SET_STRING_ELT(state_names, 19, mkChar("prev_men"));
  SET_VECTOR_ELT(state_len, 20, R_NilValue);
  SET_STRING_ELT(state_names, 20, mkChar("prev_women"));
  SET_VECTOR_ELT(state_len, 21, R_NilValue);
  SET_STRING_ELT(state_names, 21, mkChar("Ntot"));
  SET_VECTOR_ELT(state_len, 22, R_NilValue);
  SET_STRING_ELT(state_names, 22, mkChar("prev_FSW"));
  SET_VECTOR_ELT(state_len, 23, R_NilValue);
  SET_STRING_ELT(state_names, 23, mkChar("prev_client"));
  SET_VECTOR_ELT(state_len, 24, R_NilValue);
  SET_STRING_ELT(state_names, 24, mkChar("B_check_comm"));
  SET_VECTOR_ELT(state_len, 25, R_NilValue);
  SET_STRING_ELT(state_names, 25, mkChar("B_check_noncomm"));
  SET_VECTOR_ELT(state_len, 26, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 26));
  tmp[0] = main_model_p->dim_infect_ART_y_1;
  tmp[1] = main_model_p->dim_infect_ART_y_2;
  SET_STRING_ELT(state_names, 26, mkChar("infect_ART_y"));
  SET_VECTOR_ELT(state_len, 27, ScalarInteger(main_model_p->dim_infect_ART_t));
  SET_STRING_ELT(state_names, 27, mkChar("infect_ART_t"));
  SET_VECTOR_ELT(state_len, 28, ScalarInteger(main_model_p->dim_c_comm));
  SET_STRING_ELT(state_names, 28, mkChar("c_comm"));
  SET_VECTOR_ELT(state_len, 29, ScalarInteger(main_model_p->dim_c_noncomm));
  SET_STRING_ELT(state_names, 29, mkChar("c_noncomm"));
  SET_VECTOR_ELT(state_len, 30, ScalarInteger(main_model_p->dim_new_people_in_group));
  SET_STRING_ELT(state_names, 30, mkChar("new_people_in_group"));
  SET_VECTOR_ELT(state_len, 31, ScalarInteger(main_model_p->dim_testing_prob));
  SET_STRING_ELT(state_names, 31, mkChar("testing_prob"));
  SET_VECTOR_ELT(state_len, 32, ScalarInteger(main_model_p->dim_zeta));
  SET_STRING_ELT(state_names, 32, mkChar("zeta"));
  SET_VECTOR_ELT(state_len, 33, ScalarInteger(main_model_p->dim_tau));
  SET_STRING_ELT(state_names, 33, mkChar("tau"));
  SET_VECTOR_ELT(state_len, 34, ScalarInteger(main_model_p->dim_rho));
  SET_STRING_ELT(state_names, 34, mkChar("rho"));
  SET_VECTOR_ELT(state_len, 35, ScalarInteger(main_model_p->dim_iota));
  SET_STRING_ELT(state_names, 35, mkChar("iota"));
  SET_VECTOR_ELT(state_len, 36, ScalarInteger(main_model_p->dim_frac_F));
  SET_STRING_ELT(state_names, 36, mkChar("frac_F"));
  SET_VECTOR_ELT(state_len, 37, ScalarInteger(main_model_p->dim_frac_N_sexualpop));
  SET_STRING_ELT(state_names, 37, mkChar("frac_N_sexualpop"));
  SET_VECTOR_ELT(state_len, 38, ScalarInteger(main_model_p->dim_infect_ART));
  SET_STRING_ELT(state_names, 38, mkChar("infect_ART"));
  SET_VECTOR_ELT(state_len, 39, ScalarInteger(main_model_p->dim_zetaa));
  SET_STRING_ELT(state_names, 39, mkChar("zetaa"));
  SET_VECTOR_ELT(state_len, 40, ScalarInteger(main_model_p->dim_zetab));
  SET_STRING_ELT(state_names, 40, mkChar("zetab"));
  SET_VECTOR_ELT(state_len, 41, ScalarInteger(main_model_p->dim_zetac));
  SET_STRING_ELT(state_names, 41, mkChar("zetac"));
  SET_VECTOR_ELT(state_len, 42, ScalarInteger(main_model_p->dim_omega));
  SET_STRING_ELT(state_names, 42, mkChar("omega"));
  SET_VECTOR_ELT(state_len, 43, ScalarInteger(main_model_p->dim_frac_N));
  SET_STRING_ELT(state_names, 43, mkChar("frac_N"));
  SET_VECTOR_ELT(state_len, 44, ScalarInteger(main_model_p->dim_mu));
  SET_STRING_ELT(state_names, 44, mkChar("mu"));
  SET_VECTOR_ELT(state_len, 45, ScalarInteger(main_model_p->dim_gamma01));
  SET_STRING_ELT(state_names, 45, mkChar("gamma01"));
  SET_VECTOR_ELT(state_len, 46, ScalarInteger(main_model_p->dim_gamma11));
  SET_STRING_ELT(state_names, 46, mkChar("gamma11"));
  SET_VECTOR_ELT(state_len, 47, ScalarInteger(main_model_p->dim_kappaa));
  SET_STRING_ELT(state_names, 47, mkChar("kappaa"));
  SET_VECTOR_ELT(state_len, 48, ScalarInteger(main_model_p->dim_kappab));
  SET_STRING_ELT(state_names, 48, mkChar("kappab"));
  SET_VECTOR_ELT(state_len, 49, ScalarInteger(main_model_p->dim_kappac));
  SET_STRING_ELT(state_names, 49, mkChar("kappac"));
  SET_VECTOR_ELT(state_len, 50, ScalarInteger(main_model_p->dim_kappa1));
  SET_STRING_ELT(state_names, 50, mkChar("kappa1"));
  SET_VECTOR_ELT(state_len, 51, ScalarInteger(main_model_p->dim_alpha01));
  SET_STRING_ELT(state_names, 51, mkChar("alpha01"));
  SET_VECTOR_ELT(state_len, 52, ScalarInteger(main_model_p->dim_alpha02));
  SET_STRING_ELT(state_names, 52, mkChar("alpha02"));
  SET_VECTOR_ELT(state_len, 53, ScalarInteger(main_model_p->dim_alpha05));
  SET_STRING_ELT(state_names, 53, mkChar("alpha05"));
  SET_VECTOR_ELT(state_len, 54, ScalarInteger(main_model_p->dim_alpha11));
  SET_STRING_ELT(state_names, 54, mkChar("alpha11"));
  SET_VECTOR_ELT(state_len, 55, ScalarInteger(main_model_p->dim_alpha22));
  SET_STRING_ELT(state_names, 55, mkChar("alpha22"));
  SET_VECTOR_ELT(state_len, 56, ScalarInteger(main_model_p->dim_alpha35));
  SET_STRING_ELT(state_names, 56, mkChar("alpha35"));
  SET_VECTOR_ELT(state_len, 57, ScalarInteger(main_model_p->dim_beta_comm));
  SET_STRING_ELT(state_names, 57, mkChar("beta_comm"));
  SET_VECTOR_ELT(state_len, 58, ScalarInteger(main_model_p->dim_beta_noncomm));
  SET_STRING_ELT(state_names, 58, mkChar("beta_noncomm"));
  SET_VECTOR_ELT(state_len, 59, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 59));
  tmp[0] = main_model_p->dim_p_comm_1;
  tmp[1] = main_model_p->dim_p_comm_2;
  SET_STRING_ELT(state_names, 59, mkChar("p_comm"));
  ...
  SET_STRING_ELT(state_names, 60, mkChar("p_noncomm"));
  ...
  SET_STRING_ELT(state_names, 61, mkChar("fc_comm"));
  SET_VECTOR_ELT(state_len, 62, ScalarInteger(main_model_p->dim_fP_comm));
  SET_STRING_ELT(state_names, 62, mkChar("fP_comm"));
  ...
  SET_STRING_ELT(state_names, 63, mkChar("fc_noncomm"));
  SET_VECTOR_ELT(state_len, 64, ScalarInteger(main_model_p->dim_fP_noncomm));
  SET_STRING_ELT(state_names, 64, mkChar("fP_noncomm"));
  ...
  SET_STRING_ELT(state_names, 65, mkChar("n_comm"));
  ...
  SET_STRING_ELT(state_names, 66, mkChar("n_noncomm"));
  SET_VECTOR_ELT(state_len, 67, ScalarInteger(main_model_p->dim_N));
  SET_STRING_ELT(state_names, 67, mkChar("N"));
  SET_VECTOR_ELT(state_len, 68, ScalarInteger(main_model_p->dim_E0));
  SET_STRING_ELT(state_names, 68, mkChar("E0"));
  SET_VECTOR_ELT(state_len, 69, ScalarInteger(main_model_p->dim_E1a));
  SET_STRING_ELT(state_names, 69, mkChar("E1a"));
  SET_VECTOR_ELT(state_len, 70, ScalarInteger(main_model_p->dim_E1b));
  SET_STRING_ELT(state_names, 70, mkChar("E1b"));
  SET_VECTOR_ELT(state_len, 71, ScalarInteger(main_model_p->dim_E1c));
  SET_STRING_ELT(state_names, 71, mkChar("E1c"));
  SET_VECTOR_ELT(state_len, 72, ScalarInteger(main_model_p->dim_E1d));
  SET_STRING_ELT(state_names, 72, mkChar("E1d"));
  SET_VECTOR_ELT(state_len, 73, ScalarInteger(main_model_p->dim_alphaItot));
  SET_STRING_ELT(state_names, 73, mkChar("alphaItot"));
  SET_VECTOR_ELT(state_len, 74, ScalarInteger(main_model_p->dim_prev));
  SET_STRING_ELT(state_names, 74, mkChar("prev"));
  ...
  SET_STRING_ELT(state_names, 75, mkChar("lambda"));
  ...
  SET_STRING_ELT(state_names, 76, mkChar("lambda_0"));
  ...
  SET_STRING_ELT(state_names, 77, mkChar("lambda_1a"));
  ...
  SET_STRING_ELT(state_names, 78, mkChar("lambda_1b"));
  ...
  SET_STRING_ELT(state_names, 79, mkChar("lambda_1c"));
  ...
  SET_STRING_ELT(state_names, 80, mkChar("lambda_1d"));
  SET_VECTOR_ELT(state_len, 81, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_STRING_ELT(state_names, 81, mkChar("lambda_sum_0"));
  SET_VECTOR_ELT(state_len, 82, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_STRING_ELT(state_names, 82, mkChar("lambda_sum_1a"));
  SET_VECTOR_ELT(state_len, 83, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_STRING_ELT(state_names, 83, mkChar("lambda_sum_1b"));
  SET_VECTOR_ELT(state_len, 84, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_STRING_ELT(state_names, 84, mkChar("lambda_sum_1c"));
  SET_VECTOR_ELT(state_len, 85, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_STRING_ELT(state_names, 85, mkChar("lambda_sum_1d"));
  SET_VECTOR_ELT(state_len, 86, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_STRING_ELT(state_names, 86, mkChar("c_comm_balanced"));
  SET_VECTOR_ELT(state_len, 87, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_STRING_ELT(state_names, 87, mkChar("c_noncomm_balanced"));
  SET_VECTOR_ELT(state_len, 88, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 88));
  tmp[0] = main_model_p->dim_theta_1;
  tmp[1] = main_model_p->dim_theta_2;
  SET_STRING_ELT(state_names, 88, mkChar("theta"));
  ...
  SET_STRING_ELT(state_names, 89, mkChar("M_comm"));
  ...
  SET_STRING_ELT(state_names, 90, mkChar("M_noncomm"));
  ...
  SET_STRING_ELT(state_names, 91, mkChar("rate_move_in"));
  SET_VECTOR_ELT(state_len, 92, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_STRING_ELT(state_names, 92, mkChar("rate_move_out"));
  setAttrib(state_len, R_NamesSymbol, state_names);
  UNPROTECT(2);
  return state_len;
}
