...
typedef struct main_model_pars {
  ...
  int offset_OnPrEP;
  int dim_OnPrEP1a;
  double *initial_OnPrEP1a;
  int offset_OnPrEP1a;
  int dim_OnPrEP1b;
  double *initial_OnPrEP1b;
  int offset_OnPrEP1b;
  int dim_OnPrEP1c;
  double *initial_OnPrEP1c;
  int offset_OnPrEP1c;
  int dim_S0;
  double *initial_S0;
  int offset_S0;
...
SEXP main_model_create(SEXP user, SEXP odin_use_dde) {
  ...
  main_model_p->initial_OnPrEP1a = NULL;
  main_model_p->initial_OnPrEP1b = NULL;
  main_model_p->initial_OnPrEP1c = NULL;
...
SEXP main_model_set_user(main_model_pars *main_model_p, SEXP user) {
  ...
  main_model_p->offset_output_infect_ART_y = 39;
  ...
  main_model_p->offset_output_infect_ART_t = 39 + main_model_p->dim_infect_ART_y;
  ...
  main_model_p->offset_S0_infections = 0;
  ...
  main_model_p->offset_S1a_infections = main_model_p->dim_S0_infections;
  ...
  main_model_p->offset_output_frac_F = main_model_p->offset_output_iota + main_model_p->dim_iota;
  ...
  main_model_p->offset_OnPrEP = main_model_p->offset_cumuInf + main_model_p->dim_cumuInf;
  Free(main_model_p->initial_OnPrEP1a);
  main_model_p->dim_OnPrEP1a = main_model_p->Ncat;
  main_model_p->initial_OnPrEP1a = (double*) Calloc(main_model_p->dim_OnPrEP1a, double);
  main_model_p->offset_OnPrEP1a = main_model_p->offset_OnPrEP + main_model_p->dim_OnPrEP;
  for (int i = 0; i < main_model_p->dim_OnPrEP1a; ++i) {
    main_model_p->initial_OnPrEP1a[i] = 0;
  }
  Free(main_model_p->initial_OnPrEP1b);
  main_model_p->dim_OnPrEP1b = main_model_p->Ncat;
  main_model_p->initial_OnPrEP1b = (double*) Calloc(main_model_p->dim_OnPrEP1b, double);
  main_model_p->offset_OnPrEP1b = main_model_p->offset_OnPrEP1a + main_model_p->dim_OnPrEP1a;
  for (int i = 0; i < main_model_p->dim_OnPrEP1b; ++i) {
    main_model_p->initial_OnPrEP1b[i] = 0;
  }
  Free(main_model_p->initial_OnPrEP1c);
  main_model_p->dim_OnPrEP1c = main_model_p->Ncat;
  main_model_p->initial_OnPrEP1c = (double*) Calloc(main_model_p->dim_OnPrEP1c, double);
  main_model_p->offset_OnPrEP1c = main_model_p->offset_OnPrEP1b + main_model_p->dim_OnPrEP1b;
  for (int i = 0; i < main_model_p->dim_OnPrEP1c; ++i) {
    main_model_p->initial_OnPrEP1c[i] = 0;
  }
  ...
  main_model_p->offset_S0 = main_model_p->offset_OnPrEP1c + main_model_p->dim_OnPrEP1c;
...
SEXP main_model_initialise(SEXP main_model_ptr, SEXP t_ptr) {
  ...
  memcpy(REAL(state) + 0, main_model_p->initial_S0_infections, main_model_p->dim_S0_infections * sizeof(double));
  ...
  memcpy(REAL(state) + main_model_p->offset_OnPrEP1a, main_model_p->initial_OnPrEP1a, main_model_p->dim_OnPrEP1a * sizeof(double));
  memcpy(REAL(state) + main_model_p->offset_OnPrEP1b, main_model_p->initial_OnPrEP1b, main_model_p->dim_OnPrEP1b * sizeof(double));
  memcpy(REAL(state) + main_model_p->offset_OnPrEP1c, main_model_p->initial_OnPrEP1c, main_model_p->dim_OnPrEP1c * sizeof(double));
...
void main_model_deriv(main_model_pars *main_model_p, double t, double *state, double *dstatedt, double *output) {
  ...
  double *deriv_S0_infections = dstatedt;
  ...
  double *deriv_OnPrEP1a = dstatedt + main_model_p->offset_OnPrEP1a;
  double *deriv_OnPrEP1b = dstatedt + main_model_p->offset_OnPrEP1b;
  double *deriv_OnPrEP1c = dstatedt + main_model_p->offset_OnPrEP1c;
  ...
  for (int i = 0; i < main_model_p->dim_OnPrEP; ++i) {
    deriv_OnPrEP[i] = main_model_p->zeta[i] * S0[i];
  }
  for (int i = 0; i < main_model_p->dim_OnPrEP1a; ++i) {
    deriv_OnPrEP1a[i] = main_model_p->zeta[i] * main_model_p->fPa * S0[i];
  }
  for (int i = 0; i < main_model_p->dim_OnPrEP1b; ++i) {
    deriv_OnPrEP1b[i] = main_model_p->zeta[i] * main_model_p->fPb * S0[i];
  }
  for (int i = 0; i < main_model_p->dim_OnPrEP1c; ++i) {
    deriv_OnPrEP1c[i] = main_model_p->zeta[i] * main_model_p->fPc * S0[i];
  }
  ...
  if (output != NULL) {
    double *output_infect_ART_y = output + 39;
    ...
    output[12] = pc_S1b;
    output[13] = pc_S1c;
    output[14] = Men_on_ART;
    output[15] = Women_on_ART;
    output[16] = ART_coverage_men;
    output[17] = ART_coverage_women;
    output[18] = ART_coverage_FSW;
    output[19] = ART_coverage_all;
    output[20] = main_model_p->Ncat;
    ...
    output[21] = main_model_p->nu;
    output[22] = main_model_p->Nage;
    output[23] = main_model_p->dur_FSW;
    memcpy(output_infect_ART, main_model_p->infect_ART, main_model_p->dim_infect_ART * sizeof(double));
    output[24] = main_model_p->epsilon;
    ...
    output[25] = Ntot_inc_former_FSW_nonCot;
    double new_people = main_model_p->epsilon * Ntot;
    output[26] = new_people;
    ...
    output[29] = prev_men;
    output[30] = prev_women;
    output[31] = prev_cotonou;
    output[32] = Ntot;
    memcpy(output_N, main_model_p->N, main_model_p->dim_N * sizeof(double));
    output[33] = prev_FSW;
    output[34] = prev_client;
...
SEXP main_model_contents(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  SEXP state = PROTECT(allocVector(VECSXP, 726));
  ...
  SET_VECTOR_ELT(state, 64, ScalarInteger(main_model_p->Ncat));
  SET_VECTOR_ELT(state, 65, ScalarReal(main_model_p->Nage));
  SET_VECTOR_ELT(state, 66, ScalarReal(main_model_p->infect_acute));
  SET_VECTOR_ELT(state, 67, ScalarReal(main_model_p->infect_AIDS));
  SET_VECTOR_ELT(state, 68, ScalarReal(main_model_p->nu));
  SET_VECTOR_ELT(state, 69, ScalarReal(main_model_p->R));
  SET_VECTOR_ELT(state, 70, ScalarInteger(main_model_p->dim_epsilon_t));
  SET_VECTOR_ELT(state, 71, allocVector(REALSXP, main_model_p->dim_epsilon_t));
  memcpy(REAL(VECTOR_ELT(state, 71)), main_model_p->epsilon_t, main_model_p->dim_epsilon_t * sizeof(double));
  SET_VECTOR_ELT(state, 72, ScalarInteger(main_model_p->dim_epsilon_y));
  SET_VECTOR_ELT(state, 73, allocVector(REALSXP, main_model_p->dim_epsilon_y));
  memcpy(REAL(VECTOR_ELT(state, 73)), main_model_p->epsilon_y, main_model_p->dim_epsilon_y * sizeof(double));
  SET_VECTOR_ELT(state, 74, ScalarInteger(main_model_p->dim_fc_t_comm));
  SET_VECTOR_ELT(state, 75, allocVector(REALSXP, main_model_p->dim_fc_t_comm));
  memcpy(REAL(VECTOR_ELT(state, 75)), main_model_p->fc_t_comm, main_model_p->dim_fc_t_comm * sizeof(double));
  SET_VECTOR_ELT(state, 76, ScalarInteger(main_model_p->dim_fc_y_comm));
  SET_VECTOR_ELT(state, 77, ScalarInteger(main_model_p->dim_fc_y_comm_1));
  SET_VECTOR_ELT(state, 78, ScalarInteger(main_model_p->dim_fc_y_comm_2));
  SET_VECTOR_ELT(state, 79, ScalarInteger(main_model_p->dim_fc_y_comm_3));
  SET_VECTOR_ELT(state, 80, ScalarInteger(main_model_p->dim_fc_y_comm_12));
  SET_VECTOR_ELT(state, 81, allocVector(REALSXP, main_model_p->dim_fc_y_comm));
  memcpy(REAL(VECTOR_ELT(state, 81)), main_model_p->fc_y_comm, main_model_p->dim_fc_y_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 81), 3, main_model_p->dim_fc_y_comm_1, main_model_p->dim_fc_y_comm_2, main_model_p->dim_fc_y_comm_3);
  SET_VECTOR_ELT(state, 82, ScalarInteger(main_model_p->dim_fP_t_comm));
  SET_VECTOR_ELT(state, 83, allocVector(REALSXP, main_model_p->dim_fP_t_comm));
  memcpy(REAL(VECTOR_ELT(state, 83)), main_model_p->fP_t_comm, main_model_p->dim_fP_t_comm * sizeof(double));
  SET_VECTOR_ELT(state, 84, ScalarInteger(main_model_p->dim_fP_y_comm));
  SET_VECTOR_ELT(state, 85, ScalarInteger(main_model_p->dim_fP_y_comm_1));
  SET_VECTOR_ELT(state, 86, ScalarInteger(main_model_p->dim_fP_y_comm_2));
  SET_VECTOR_ELT(state, 87, allocVector(REALSXP, main_model_p->dim_fP_y_comm));
  memcpy(REAL(VECTOR_ELT(state, 87)), main_model_p->fP_y_comm, main_model_p->dim_fP_y_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 87), 2, main_model_p->dim_fP_y_comm_1, main_model_p->dim_fP_y_comm_2);
  SET_VECTOR_ELT(state, 88, ScalarInteger(main_model_p->dim_fc_t_noncomm));
  SET_VECTOR_ELT(state, 89, allocVector(REALSXP, main_model_p->dim_fc_t_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 89)), main_model_p->fc_t_noncomm, main_model_p->dim_fc_t_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 90, ScalarInteger(main_model_p->dim_fc_y_noncomm));
  SET_VECTOR_ELT(state, 91, ScalarInteger(main_model_p->dim_fc_y_noncomm_1));
  SET_VECTOR_ELT(state, 92, ScalarInteger(main_model_p->dim_fc_y_noncomm_2));
  SET_VECTOR_ELT(state, 93, ScalarInteger(main_model_p->dim_fc_y_noncomm_3));
  SET_VECTOR_ELT(state, 94, ScalarInteger(main_model_p->dim_fc_y_noncomm_12));
  SET_VECTOR_ELT(state, 95, allocVector(REALSXP, main_model_p->dim_fc_y_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 95)), main_model_p->fc_y_noncomm, main_model_p->dim_fc_y_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 95), 3, main_model_p->dim_fc_y_noncomm_1, main_model_p->dim_fc_y_noncomm_2, main_model_p->dim_fc_y_noncomm_3);
  SET_VECTOR_ELT(state, 96, ScalarInteger(main_model_p->dim_fP_t_noncomm));
  SET_VECTOR_ELT(state, 97, allocVector(REALSXP, main_model_p->dim_fP_t_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 97)), main_model_p->fP_t_noncomm, main_model_p->dim_fP_t_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 98, ScalarInteger(main_model_p->dim_fP_y_noncomm));
  SET_VECTOR_ELT(state, 99, ScalarInteger(main_model_p->dim_fP_y_noncomm_1));
  SET_VECTOR_ELT(state, 100, ScalarInteger(main_model_p->dim_fP_y_noncomm_2));
  SET_VECTOR_ELT(state, 101, allocVector(REALSXP, main_model_p->dim_fP_y_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 101)), main_model_p->fP_y_noncomm, main_model_p->dim_fP_y_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 101), 2, main_model_p->dim_fP_y_noncomm_1, main_model_p->dim_fP_y_noncomm_2);
  SET_VECTOR_ELT(state, 102, ScalarInteger(main_model_p->dim_n_t_comm));
  SET_VECTOR_ELT(state, 103, allocVector(REALSXP, main_model_p->dim_n_t_comm));
  memcpy(REAL(VECTOR_ELT(state, 103)), main_model_p->n_t_comm, main_model_p->dim_n_t_comm * sizeof(double));
  SET_VECTOR_ELT(state, 104, ScalarInteger(main_model_p->dim_n_y_comm));
  SET_VECTOR_ELT(state, 105, ScalarInteger(main_model_p->dim_n_y_comm_1));
  SET_VECTOR_ELT(state, 106, ScalarInteger(main_model_p->dim_n_y_comm_2));
  SET_VECTOR_ELT(state, 107, ScalarInteger(main_model_p->dim_n_y_comm_3));
  SET_VECTOR_ELT(state, 108, ScalarInteger(main_model_p->dim_n_y_comm_12));
  SET_VECTOR_ELT(state, 109, allocVector(REALSXP, main_model_p->dim_n_y_comm));
  memcpy(REAL(VECTOR_ELT(state, 109)), main_model_p->n_y_comm, main_model_p->dim_n_y_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 109), 3, main_model_p->dim_n_y_comm_1, main_model_p->dim_n_y_comm_2, main_model_p->dim_n_y_comm_3);
  SET_VECTOR_ELT(state, 110, ScalarInteger(main_model_p->dim_n_t_noncomm));
  SET_VECTOR_ELT(state, 111, allocVector(REALSXP, main_model_p->dim_n_t_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 111)), main_model_p->n_t_noncomm, main_model_p->dim_n_t_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 112, ScalarInteger(main_model_p->dim_n_y_noncomm));
  SET_VECTOR_ELT(state, 113, ScalarInteger(main_model_p->dim_n_y_noncomm_1));
  SET_VECTOR_ELT(state, 114, ScalarInteger(main_model_p->dim_n_y_noncomm_2));
  SET_VECTOR_ELT(state, 115, ScalarInteger(main_model_p->dim_n_y_noncomm_3));
  SET_VECTOR_ELT(state, 116, ScalarInteger(main_model_p->dim_n_y_noncomm_12));
  SET_VECTOR_ELT(state, 117, allocVector(REALSXP, main_model_p->dim_n_y_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 117)), main_model_p->n_y_noncomm, main_model_p->dim_n_y_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 117), 3, main_model_p->dim_n_y_noncomm_1, main_model_p->dim_n_y_noncomm_2, main_model_p->dim_n_y_noncomm_3);
  SET_VECTOR_ELT(state, 118, ScalarReal(main_model_p->dur_FSW));
  SET_VECTOR_ELT(state, 119, ScalarInteger(main_model_p->dim_prep_intervention_t));
  SET_VECTOR_ELT(state, 120, allocVector(REALSXP, main_model_p->dim_prep_intervention_t));
  memcpy(REAL(VECTOR_ELT(state, 120)), main_model_p->prep_intervention_t, main_model_p->dim_prep_intervention_t * sizeof(double));
  SET_VECTOR_ELT(state, 121, ScalarInteger(main_model_p->dim_prep_intervention_y));
  SET_VECTOR_ELT(state, 122, ScalarInteger(main_model_p->dim_prep_intervention_y_1));
  SET_VECTOR_ELT(state, 123, ScalarInteger(main_model_p->dim_prep_intervention_y_2));
  SET_VECTOR_ELT(state, 124, allocVector(REALSXP, main_model_p->dim_prep_intervention_y));
  memcpy(REAL(VECTOR_ELT(state, 124)), main_model_p->prep_intervention_y, main_model_p->dim_prep_intervention_y * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 124), 2, main_model_p->dim_prep_intervention_y_1, main_model_p->dim_prep_intervention_y_2);
  SET_VECTOR_ELT(state, 125, ScalarInteger(main_model_p->dim_c_comm));
  SET_VECTOR_ELT(state, 126, allocVector(REALSXP, main_model_p->dim_c_comm));
  memcpy(REAL(VECTOR_ELT(state, 126)), main_model_p->c_comm, main_model_p->dim_c_comm * sizeof(double));
  SET_VECTOR_ELT(state, 127, ScalarInteger(main_model_p->offset_output_c_comm));
  SET_VECTOR_ELT(state, 128, ScalarInteger(main_model_p->dim_c_noncomm));
  SET_VECTOR_ELT(state, 129, allocVector(REALSXP, main_model_p->dim_c_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 129)), main_model_p->c_noncomm, main_model_p->dim_c_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 130, ScalarInteger(main_model_p->offset_output_c_noncomm));
  SET_VECTOR_ELT(state, 131, ScalarInteger(main_model_p->dim_FSW_ONLY));
  SET_VECTOR_ELT(state, 132, allocVector(REALSXP, main_model_p->dim_FSW_ONLY));
  memcpy(REAL(VECTOR_ELT(state, 132)), main_model_p->FSW_ONLY, main_model_p->dim_FSW_ONLY * sizeof(double));
  SET_VECTOR_ELT(state, 133, ScalarInteger(main_model_p->dim_new_people_in_group));
  SET_VECTOR_ELT(state, 134, allocVector(REALSXP, main_model_p->dim_new_people_in_group));
  memcpy(REAL(VECTOR_ELT(state, 134)), main_model_p->new_people_in_group, main_model_p->dim_new_people_in_group * sizeof(double));
  SET_VECTOR_ELT(state, 135, ScalarInteger(main_model_p->offset_output_new_people_in_group));
  SET_VECTOR_ELT(state, 136, ScalarInteger(main_model_p->dim_new_people_in_group_FSW_only));
  SET_VECTOR_ELT(state, 137, allocVector(REALSXP, main_model_p->dim_new_people_in_group_FSW_only));
  memcpy(REAL(VECTOR_ELT(state, 137)), main_model_p->new_people_in_group_FSW_only, main_model_p->dim_new_people_in_group_FSW_only * sizeof(double));
  SET_VECTOR_ELT(state, 138, ScalarInteger(main_model_p->offset_output_new_people_in_group_FSW_only));
  SET_VECTOR_ELT(state, 139, ScalarInteger(main_model_p->dim_comm_partnerships_requested));
  SET_VECTOR_ELT(state, 140, ScalarInteger(main_model_p->dim_comm_partnerships_requested_1));
  SET_VECTOR_ELT(state, 141, ScalarInteger(main_model_p->dim_comm_partnerships_requested_2));
  SET_VECTOR_ELT(state, 142, allocVector(REALSXP, main_model_p->dim_comm_partnerships_requested));
  memcpy(REAL(VECTOR_ELT(state, 142)), main_model_p->comm_partnerships_requested, main_model_p->dim_comm_partnerships_requested * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 142), 2, main_model_p->dim_comm_partnerships_requested_1, main_model_p->dim_comm_partnerships_requested_2);
  SET_VECTOR_ELT(state, 143, ScalarInteger(main_model_p->dim_noncomm_partnerships_requested));
  SET_VECTOR_ELT(state, 144, ScalarInteger(main_model_p->dim_noncomm_partnerships_requested_1));
  SET_VECTOR_ELT(state, 145, ScalarInteger(main_model_p->dim_noncomm_partnerships_requested_2));
  SET_VECTOR_ELT(state, 146, allocVector(REALSXP, main_model_p->dim_noncomm_partnerships_requested));
  memcpy(REAL(VECTOR_ELT(state, 146)), main_model_p->noncomm_partnerships_requested, main_model_p->dim_noncomm_partnerships_requested * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 146), 2, main_model_p->dim_noncomm_partnerships_requested_1, main_model_p->dim_noncomm_partnerships_requested_2);
  SET_VECTOR_ELT(state, 147, ScalarInteger(main_model_p->dim_testing_prob));
  SET_VECTOR_ELT(state, 148, allocVector(REALSXP, main_model_p->dim_testing_prob));
  memcpy(REAL(VECTOR_ELT(state, 148)), main_model_p->testing_prob, main_model_p->dim_testing_prob * sizeof(double));
  SET_VECTOR_ELT(state, 149, ScalarInteger(main_model_p->offset_output_testing_prob));
  SET_VECTOR_ELT(state, 150, ScalarInteger(main_model_p->dim_tau_intervention));
  SET_VECTOR_ELT(state, 151, allocVector(REALSXP, main_model_p->dim_tau_intervention));
  memcpy(REAL(VECTOR_ELT(state, 151)), main_model_p->tau_intervention, main_model_p->dim_tau_intervention * sizeof(double));
  SET_VECTOR_ELT(state, 152, ScalarInteger(main_model_p->offset_output_tau_intervention));
  SET_VECTOR_ELT(state, 153, ScalarInteger(main_model_p->dim_rho_intervention));
  SET_VECTOR_ELT(state, 154, allocVector(REALSXP, main_model_p->dim_rho_intervention));
  memcpy(REAL(VECTOR_ELT(state, 154)), main_model_p->rho_intervention, main_model_p->dim_rho_intervention * sizeof(double));
  SET_VECTOR_ELT(state, 155, ScalarInteger(main_model_p->offset_output_rho_intervention));
  SET_VECTOR_ELT(state, 156, ScalarInteger(main_model_p->dim_zeta));
  SET_VECTOR_ELT(state, 157, allocVector(REALSXP, main_model_p->dim_zeta));
  memcpy(REAL(VECTOR_ELT(state, 157)), main_model_p->zeta, main_model_p->dim_zeta * sizeof(double));
  SET_VECTOR_ELT(state, 158, ScalarInteger(main_model_p->offset_output_zeta));
  SET_VECTOR_ELT(state, 159, ScalarInteger(main_model_p->dim_sigma));
  SET_VECTOR_ELT(state, 160, allocVector(REALSXP, main_model_p->dim_sigma));
  memcpy(REAL(VECTOR_ELT(state, 160)), main_model_p->sigma, main_model_p->dim_sigma * sizeof(double));
  SET_VECTOR_ELT(state, 161, ScalarInteger(main_model_p->dim_tau));
  SET_VECTOR_ELT(state, 162, allocVector(REALSXP, main_model_p->dim_tau));
  memcpy(REAL(VECTOR_ELT(state, 162)), main_model_p->tau, main_model_p->dim_tau * sizeof(double));
  SET_VECTOR_ELT(state, 163, ScalarInteger(main_model_p->offset_output_tau));
  SET_VECTOR_ELT(state, 164, ScalarInteger(main_model_p->dim_test_rate_prep));
  SET_VECTOR_ELT(state, 165, allocVector(REALSXP, main_model_p->dim_test_rate_prep));
  memcpy(REAL(VECTOR_ELT(state, 165)), main_model_p->test_rate_prep, main_model_p->dim_test_rate_prep * sizeof(double));
  SET_VECTOR_ELT(state, 166, ScalarInteger(main_model_p->dim_rho));
  SET_VECTOR_ELT(state, 167, allocVector(REALSXP, main_model_p->dim_rho));
  memcpy(REAL(VECTOR_ELT(state, 167)), main_model_p->rho, main_model_p->dim_rho * sizeof(double));
  SET_VECTOR_ELT(state, 168, ScalarInteger(main_model_p->offset_output_rho));
  SET_VECTOR_ELT(state, 169, ScalarInteger(main_model_p->dim_iota));
  SET_VECTOR_ELT(state, 170, allocVector(REALSXP, main_model_p->dim_iota));
  memcpy(REAL(VECTOR_ELT(state, 170)), main_model_p->iota, main_model_p->dim_iota * sizeof(double));
  SET_VECTOR_ELT(state, 171, ScalarInteger(main_model_p->offset_output_iota));
  SET_VECTOR_ELT(state, 172, ScalarInteger(main_model_p->dim_S0_infections));
  SET_VECTOR_ELT(state, 173, allocVector(REALSXP, main_model_p->dim_S0_infections));
  memcpy(REAL(VECTOR_ELT(state, 173)), main_model_p->initial_S0_infections, main_model_p->dim_S0_infections * sizeof(double));
  SET_VECTOR_ELT(state, 174, ScalarInteger(main_model_p->offset_S0_infections));
  SET_VECTOR_ELT(state, 175, ScalarInteger(main_model_p->dim_S1a_infections));
  SET_VECTOR_ELT(state, 176, allocVector(REALSXP, main_model_p->dim_S1a_infections));
  memcpy(REAL(VECTOR_ELT(state, 176)), main_model_p->initial_S1a_infections, main_model_p->dim_S1a_infections * sizeof(double));
  SET_VECTOR_ELT(state, 177, ScalarInteger(main_model_p->offset_S1a_infections));
  SET_VECTOR_ELT(state, 178, ScalarInteger(main_model_p->dim_S1b_infections));
  SET_VECTOR_ELT(state, 179, allocVector(REALSXP, main_model_p->dim_S1b_infections));
  memcpy(REAL(VECTOR_ELT(state, 179)), main_model_p->initial_S1b_infections, main_model_p->dim_S1b_infections * sizeof(double));
  SET_VECTOR_ELT(state, 180, ScalarInteger(main_model_p->offset_S1b_infections));
  SET_VECTOR_ELT(state, 181, ScalarInteger(main_model_p->dim_S1c_infections));
  SET_VECTOR_ELT(state, 182, allocVector(REALSXP, main_model_p->dim_S1c_infections));
  memcpy(REAL(VECTOR_ELT(state, 182)), main_model_p->initial_S1c_infections, main_model_p->dim_S1c_infections * sizeof(double));
  SET_VECTOR_ELT(state, 183, ScalarInteger(main_model_p->offset_S1c_infections));
  SET_VECTOR_ELT(state, 184, ScalarInteger(main_model_p->dim_S1d_infections));
  SET_VECTOR_ELT(state, 185, allocVector(REALSXP, main_model_p->dim_S1d_infections));
  memcpy(REAL(VECTOR_ELT(state, 185)), main_model_p->initial_S1d_infections, main_model_p->dim_S1d_infections * sizeof(double));
  SET_VECTOR_ELT(state, 186, ScalarInteger(main_model_p->offset_S1d_infections));
  SET_VECTOR_ELT(state, 187, ScalarInteger(main_model_p->dim_frac_F));
  SET_VECTOR_ELT(state, 188, allocVector(REALSXP, main_model_p->dim_frac_F));
  memcpy(REAL(VECTOR_ELT(state, 188)), main_model_p->frac_F, main_model_p->dim_frac_F * sizeof(double));
  SET_VECTOR_ELT(state, 189, ScalarInteger(main_model_p->offset_output_frac_F));
  SET_VECTOR_ELT(state, 190, ScalarInteger(main_model_p->dim_frac_N_sexualpop));
  SET_VECTOR_ELT(state, 191, allocVector(REALSXP, main_model_p->dim_frac_N_sexualpop));
  memcpy(REAL(VECTOR_ELT(state, 191)), main_model_p->frac_N_sexualpop, main_model_p->dim_frac_N_sexualpop * sizeof(double));
  SET_VECTOR_ELT(state, 192, ScalarInteger(main_model_p->offset_output_frac_N_sexualpop));
  SET_VECTOR_ELT(state, 193, ScalarInteger(main_model_p->dim_ART_coverage));
  SET_VECTOR_ELT(state, 194, allocVector(REALSXP, main_model_p->dim_ART_coverage));
  memcpy(REAL(VECTOR_ELT(state, 194)), main_model_p->ART_coverage, main_model_p->dim_ART_coverage * sizeof(double));
  SET_VECTOR_ELT(state, 195, ScalarInteger(main_model_p->offset_output_ART_coverage));
  SET_VECTOR_ELT(state, 196, ScalarInteger(main_model_p->dim_infect_ART));
  SET_VECTOR_ELT(state, 197, allocVector(REALSXP, main_model_p->dim_infect_ART));
  memcpy(REAL(VECTOR_ELT(state, 197)), main_model_p->infect_ART, main_model_p->dim_infect_ART * sizeof(double));
  SET_VECTOR_ELT(state, 198, ScalarInteger(main_model_p->offset_output_infect_ART));
  SET_VECTOR_ELT(state, 199, ScalarInteger(main_model_p->dim_prep_offered));
  SET_VECTOR_ELT(state, 200, allocVector(REALSXP, main_model_p->dim_prep_offered));
  memcpy(REAL(VECTOR_ELT(state, 200)), main_model_p->prep_offered, main_model_p->dim_prep_offered * sizeof(double));
  SET_VECTOR_ELT(state, 201, ScalarInteger(main_model_p->dim_omega));
  SET_VECTOR_ELT(state, 202, allocVector(REALSXP, main_model_p->dim_omega));
  memcpy(REAL(VECTOR_ELT(state, 202)), main_model_p->omega, main_model_p->dim_omega * sizeof(double));
  SET_VECTOR_ELT(state, 203, ScalarInteger(main_model_p->offset_output_omega));
  SET_VECTOR_ELT(state, 204, ScalarInteger(main_model_p->dim_frac_N));
  SET_VECTOR_ELT(state, 205, allocVector(REALSXP, main_model_p->dim_frac_N));
  memcpy(REAL(VECTOR_ELT(state, 205)), main_model_p->frac_N, main_model_p->dim_frac_N * sizeof(double));
  SET_VECTOR_ELT(state, 206, ScalarInteger(main_model_p->offset_output_frac_N));
  SET_VECTOR_ELT(state, 207, ScalarInteger(main_model_p->dim_mu));
  SET_VECTOR_ELT(state, 208, allocVector(REALSXP, main_model_p->dim_mu));
  memcpy(REAL(VECTOR_ELT(state, 208)), main_model_p->mu, main_model_p->dim_mu * sizeof(double));
  SET_VECTOR_ELT(state, 209, ScalarInteger(main_model_p->offset_output_mu));
  SET_VECTOR_ELT(state, 210, ScalarInteger(main_model_p->dim_gamma01));
  SET_VECTOR_ELT(state, 211, allocVector(REALSXP, main_model_p->dim_gamma01));
  memcpy(REAL(VECTOR_ELT(state, 211)), main_model_p->gamma01, main_model_p->dim_gamma01 * sizeof(double));
  SET_VECTOR_ELT(state, 212, ScalarInteger(main_model_p->offset_output_gamma01));
  SET_VECTOR_ELT(state, 213, ScalarInteger(main_model_p->dim_gamma02));
  SET_VECTOR_ELT(state, 214, allocVector(REALSXP, main_model_p->dim_gamma02));
  memcpy(REAL(VECTOR_ELT(state, 214)), main_model_p->gamma02, main_model_p->dim_gamma02 * sizeof(double));
  SET_VECTOR_ELT(state, 215, ScalarInteger(main_model_p->dim_gamma03));
  SET_VECTOR_ELT(state, 216, allocVector(REALSXP, main_model_p->dim_gamma03));
  memcpy(REAL(VECTOR_ELT(state, 216)), main_model_p->gamma03, main_model_p->dim_gamma03 * sizeof(double));
  SET_VECTOR_ELT(state, 217, ScalarInteger(main_model_p->dim_gamma04));
  SET_VECTOR_ELT(state, 218, allocVector(REALSXP, main_model_p->dim_gamma04));
  memcpy(REAL(VECTOR_ELT(state, 218)), main_model_p->gamma04, main_model_p->dim_gamma04 * sizeof(double));
  SET_VECTOR_ELT(state, 219, ScalarInteger(main_model_p->dim_gamma11));
  SET_VECTOR_ELT(state, 220, allocVector(REALSXP, main_model_p->dim_gamma11));
  memcpy(REAL(VECTOR_ELT(state, 220)), main_model_p->gamma11, main_model_p->dim_gamma11 * sizeof(double));
  SET_VECTOR_ELT(state, 221, ScalarInteger(main_model_p->offset_output_gamma11));
  SET_VECTOR_ELT(state, 222, ScalarInteger(main_model_p->dim_gamma22));
  SET_VECTOR_ELT(state, 223, allocVector(REALSXP, main_model_p->dim_gamma22));
  memcpy(REAL(VECTOR_ELT(state, 223)), main_model_p->gamma22, main_model_p->dim_gamma22 * sizeof(double));
  SET_VECTOR_ELT(state, 224, ScalarInteger(main_model_p->dim_gamma23));
  SET_VECTOR_ELT(state, 225, allocVector(REALSXP, main_model_p->dim_gamma23));
  memcpy(REAL(VECTOR_ELT(state, 225)), main_model_p->gamma23, main_model_p->dim_gamma23 * sizeof(double));
  SET_VECTOR_ELT(state, 226, ScalarInteger(main_model_p->dim_gamma24));
  SET_VECTOR_ELT(state, 227, allocVector(REALSXP, main_model_p->dim_gamma24));
  memcpy(REAL(VECTOR_ELT(state, 227)), main_model_p->gamma24, main_model_p->dim_gamma24 * sizeof(double));
  SET_VECTOR_ELT(state, 228, ScalarInteger(main_model_p->dim_gamma32));
  SET_VECTOR_ELT(state, 229, allocVector(REALSXP, main_model_p->dim_gamma32));
  memcpy(REAL(VECTOR_ELT(state, 229)), main_model_p->gamma32, main_model_p->dim_gamma32 * sizeof(double));
  SET_VECTOR_ELT(state, 230, ScalarInteger(main_model_p->dim_gamma33));
  SET_VECTOR_ELT(state, 231, allocVector(REALSXP, main_model_p->dim_gamma33));
  memcpy(REAL(VECTOR_ELT(state, 231)), main_model_p->gamma33, main_model_p->dim_gamma33 * sizeof(double));
  SET_VECTOR_ELT(state, 232, ScalarInteger(main_model_p->dim_gamma34));
  SET_VECTOR_ELT(state, 233, allocVector(REALSXP, main_model_p->dim_gamma34));
  memcpy(REAL(VECTOR_ELT(state, 233)), main_model_p->gamma34, main_model_p->dim_gamma34 * sizeof(double));
  SET_VECTOR_ELT(state, 234, ScalarInteger(main_model_p->dim_gamma42));
  SET_VECTOR_ELT(state, 235, allocVector(REALSXP, main_model_p->dim_gamma42));
  memcpy(REAL(VECTOR_ELT(state, 235)), main_model_p->gamma42, main_model_p->dim_gamma42 * sizeof(double));
  SET_VECTOR_ELT(state, 236, ScalarInteger(main_model_p->dim_gamma43));
  SET_VECTOR_ELT(state, 237, allocVector(REALSXP, main_model_p->dim_gamma43));
  memcpy(REAL(VECTOR_ELT(state, 237)), main_model_p->gamma43, main_model_p->dim_gamma43 * sizeof(double));
  SET_VECTOR_ELT(state, 238, ScalarInteger(main_model_p->dim_gamma44));
  SET_VECTOR_ELT(state, 239, allocVector(REALSXP, main_model_p->dim_gamma44));
  memcpy(REAL(VECTOR_ELT(state, 239)), main_model_p->gamma44, main_model_p->dim_gamma44 * sizeof(double));
  SET_VECTOR_ELT(state, 240, ScalarInteger(main_model_p->dim_phi2));
  SET_VECTOR_ELT(state, 241, allocVector(REALSXP, main_model_p->dim_phi2));
  memcpy(REAL(VECTOR_ELT(state, 241)), main_model_p->phi2, main_model_p->dim_phi2 * sizeof(double));
  SET_VECTOR_ELT(state, 242, ScalarInteger(main_model_p->dim_phi3));
  SET_VECTOR_ELT(state, 243, allocVector(REALSXP, main_model_p->dim_phi3));
  memcpy(REAL(VECTOR_ELT(state, 243)), main_model_p->phi3, main_model_p->dim_phi3 * sizeof(double));
  SET_VECTOR_ELT(state, 244, ScalarInteger(main_model_p->dim_phi4));
  SET_VECTOR_ELT(state, 245, allocVector(REALSXP, main_model_p->dim_phi4));
  memcpy(REAL(VECTOR_ELT(state, 245)), main_model_p->phi4, main_model_p->dim_phi4 * sizeof(double));
  SET_VECTOR_ELT(state, 246, ScalarInteger(main_model_p->dim_phi5));
  SET_VECTOR_ELT(state, 247, allocVector(REALSXP, main_model_p->dim_phi5));
  memcpy(REAL(VECTOR_ELT(state, 247)), main_model_p->phi5, main_model_p->dim_phi5 * sizeof(double));
  SET_VECTOR_ELT(state, 248, ScalarInteger(main_model_p->dim_psia));
  SET_VECTOR_ELT(state, 249, allocVector(REALSXP, main_model_p->dim_psia));
  memcpy(REAL(VECTOR_ELT(state, 249)), main_model_p->psia, main_model_p->dim_psia * sizeof(double));
  SET_VECTOR_ELT(state, 250, ScalarInteger(main_model_p->dim_psib));
  SET_VECTOR_ELT(state, 251, allocVector(REALSXP, main_model_p->dim_psib));
  memcpy(REAL(VECTOR_ELT(state, 251)), main_model_p->psib, main_model_p->dim_psib * sizeof(double));
  SET_VECTOR_ELT(state, 252, ScalarInteger(main_model_p->dim_kappaa));
  SET_VECTOR_ELT(state, 253, allocVector(REALSXP, main_model_p->dim_kappaa));
  memcpy(REAL(VECTOR_ELT(state, 253)), main_model_p->kappaa, main_model_p->dim_kappaa * sizeof(double));
  SET_VECTOR_ELT(state, 254, ScalarInteger(main_model_p->offset_output_kappaa));
  SET_VECTOR_ELT(state, 255, ScalarInteger(main_model_p->dim_kappab));
  SET_VECTOR_ELT(state, 256, allocVector(REALSXP, main_model_p->dim_kappab));
  memcpy(REAL(VECTOR_ELT(state, 256)), main_model_p->kappab, main_model_p->dim_kappab * sizeof(double));
  SET_VECTOR_ELT(state, 257, ScalarInteger(main_model_p->offset_output_kappab));
  SET_VECTOR_ELT(state, 258, ScalarInteger(main_model_p->dim_kappac));
  SET_VECTOR_ELT(state, 259, allocVector(REALSXP, main_model_p->dim_kappac));
  memcpy(REAL(VECTOR_ELT(state, 259)), main_model_p->kappac, main_model_p->dim_kappac * sizeof(double));
  SET_VECTOR_ELT(state, 260, ScalarInteger(main_model_p->offset_output_kappac));
  SET_VECTOR_ELT(state, 261, ScalarInteger(main_model_p->dim_kappa1));
  SET_VECTOR_ELT(state, 262, allocVector(REALSXP, main_model_p->dim_kappa1));
  memcpy(REAL(VECTOR_ELT(state, 262)), main_model_p->kappa1, main_model_p->dim_kappa1 * sizeof(double));
  SET_VECTOR_ELT(state, 263, ScalarInteger(main_model_p->offset_output_kappa1));
  SET_VECTOR_ELT(state, 264, ScalarInteger(main_model_p->dim_alpha01));
  SET_VECTOR_ELT(state, 265, allocVector(REALSXP, main_model_p->dim_alpha01));
  memcpy(REAL(VECTOR_ELT(state, 265)), main_model_p->alpha01, main_model_p->dim_alpha01 * sizeof(double));
  SET_VECTOR_ELT(state, 266, ScalarInteger(main_model_p->offset_output_alpha01));
  SET_VECTOR_ELT(state, 267, ScalarInteger(main_model_p->dim_alpha02));
  SET_VECTOR_ELT(state, 268, allocVector(REALSXP, main_model_p->dim_alpha02));
  memcpy(REAL(VECTOR_ELT(state, 268)), main_model_p->alpha02, main_model_p->dim_alpha02 * sizeof(double));
  SET_VECTOR_ELT(state, 269, ScalarInteger(main_model_p->offset_output_alpha02));
  SET_VECTOR_ELT(state, 270, ScalarInteger(main_model_p->dim_alpha03));
  SET_VECTOR_ELT(state, 271, allocVector(REALSXP, main_model_p->dim_alpha03));
  memcpy(REAL(VECTOR_ELT(state, 271)), main_model_p->alpha03, main_model_p->dim_alpha03 * sizeof(double));
  SET_VECTOR_ELT(state, 272, ScalarInteger(main_model_p->dim_alpha04));
  SET_VECTOR_ELT(state, 273, allocVector(REALSXP, main_model_p->dim_alpha04));
  memcpy(REAL(VECTOR_ELT(state, 273)), main_model_p->alpha04, main_model_p->dim_alpha04 * sizeof(double));
  SET_VECTOR_ELT(state, 274, ScalarInteger(main_model_p->dim_alpha05));
  SET_VECTOR_ELT(state, 275, allocVector(REALSXP, main_model_p->dim_alpha05));
  memcpy(REAL(VECTOR_ELT(state, 275)), main_model_p->alpha05, main_model_p->dim_alpha05 * sizeof(double));
  SET_VECTOR_ELT(state, 276, ScalarInteger(main_model_p->offset_output_alpha05));
  SET_VECTOR_ELT(state, 277, ScalarInteger(main_model_p->dim_alpha11));
  SET_VECTOR_ELT(state, 278, allocVector(REALSXP, main_model_p->dim_alpha11));
  memcpy(REAL(VECTOR_ELT(state, 278)), main_model_p->alpha11, main_model_p->dim_alpha11 * sizeof(double));
  SET_VECTOR_ELT(state, 279, ScalarInteger(main_model_p->offset_output_alpha11));
  SET_VECTOR_ELT(state, 280, ScalarInteger(main_model_p->dim_alpha22));
  SET_VECTOR_ELT(state, 281, allocVector(REALSXP, main_model_p->dim_alpha22));
  memcpy(REAL(VECTOR_ELT(state, 281)), main_model_p->alpha22, main_model_p->dim_alpha22 * sizeof(double));
  SET_VECTOR_ELT(state, 282, ScalarInteger(main_model_p->offset_output_alpha22));
  SET_VECTOR_ELT(state, 283, ScalarInteger(main_model_p->dim_alpha23));
  SET_VECTOR_ELT(state, 284, allocVector(REALSXP, main_model_p->dim_alpha23));
  memcpy(REAL(VECTOR_ELT(state, 284)), main_model_p->alpha23, main_model_p->dim_alpha23 * sizeof(double));
  SET_VECTOR_ELT(state, 285, ScalarInteger(main_model_p->dim_alpha24));
  SET_VECTOR_ELT(state, 286, allocVector(REALSXP, main_model_p->dim_alpha24));
  memcpy(REAL(VECTOR_ELT(state, 286)), main_model_p->alpha24, main_model_p->dim_alpha24 * sizeof(double));
  SET_VECTOR_ELT(state, 287, ScalarInteger(main_model_p->dim_alpha25));
  SET_VECTOR_ELT(state, 288, allocVector(REALSXP, main_model_p->dim_alpha25));
  memcpy(REAL(VECTOR_ELT(state, 288)), main_model_p->alpha25, main_model_p->dim_alpha25 * sizeof(double));
  SET_VECTOR_ELT(state, 289, ScalarInteger(main_model_p->dim_alpha32));
  SET_VECTOR_ELT(state, 290, allocVector(REALSXP, main_model_p->dim_alpha32));
  memcpy(REAL(VECTOR_ELT(state, 290)), main_model_p->alpha32, main_model_p->dim_alpha32 * sizeof(double));
  SET_VECTOR_ELT(state, 291, ScalarInteger(main_model_p->dim_alpha33));
  SET_VECTOR_ELT(state, 292, allocVector(REALSXP, main_model_p->dim_alpha33));
  memcpy(REAL(VECTOR_ELT(state, 292)), main_model_p->alpha33, main_model_p->dim_alpha33 * sizeof(double));
  SET_VECTOR_ELT(state, 293, ScalarInteger(main_model_p->dim_alpha34));
  SET_VECTOR_ELT(state, 294, allocVector(REALSXP, main_model_p->dim_alpha34));
  memcpy(REAL(VECTOR_ELT(state, 294)), main_model_p->alpha34, main_model_p->dim_alpha34 * sizeof(double));
  SET_VECTOR_ELT(state, 295, ScalarInteger(main_model_p->dim_alpha35));
  SET_VECTOR_ELT(state, 296, allocVector(REALSXP, main_model_p->dim_alpha35));
  memcpy(REAL(VECTOR_ELT(state, 296)), main_model_p->alpha35, main_model_p->dim_alpha35 * sizeof(double));
  SET_VECTOR_ELT(state, 297, ScalarInteger(main_model_p->offset_output_alpha35));
  SET_VECTOR_ELT(state, 298, ScalarInteger(main_model_p->dim_alpha42));
  SET_VECTOR_ELT(state, 299, allocVector(REALSXP, main_model_p->dim_alpha42));
  memcpy(REAL(VECTOR_ELT(state, 299)), main_model_p->alpha42, main_model_p->dim_alpha42 * sizeof(double));
  SET_VECTOR_ELT(state, 300, ScalarInteger(main_model_p->dim_alpha43));
  SET_VECTOR_ELT(state, 301, allocVector(REALSXP, main_model_p->dim_alpha43));
  memcpy(REAL(VECTOR_ELT(state, 301)), main_model_p->alpha43, main_model_p->dim_alpha43 * sizeof(double));
  SET_VECTOR_ELT(state, 302, ScalarInteger(main_model_p->dim_alpha44));
  SET_VECTOR_ELT(state, 303, allocVector(REALSXP, main_model_p->dim_alpha44));
  memcpy(REAL(VECTOR_ELT(state, 303)), main_model_p->alpha44, main_model_p->dim_alpha44 * sizeof(double));
  SET_VECTOR_ELT(state, 304, ScalarInteger(main_model_p->dim_alpha45));
  SET_VECTOR_ELT(state, 305, allocVector(REALSXP, main_model_p->dim_alpha45));
  memcpy(REAL(VECTOR_ELT(state, 305)), main_model_p->alpha45, main_model_p->dim_alpha45 * sizeof(double));
  SET_VECTOR_ELT(state, 306, ScalarInteger(main_model_p->dim_beta_comm));
  SET_VECTOR_ELT(state, 307, allocVector(REALSXP, main_model_p->dim_beta_comm));
  memcpy(REAL(VECTOR_ELT(state, 307)), main_model_p->beta_comm, main_model_p->dim_beta_comm * sizeof(double));
  SET_VECTOR_ELT(state, 308, ScalarInteger(main_model_p->offset_output_beta_comm));
  SET_VECTOR_ELT(state, 309, ScalarInteger(main_model_p->dim_beta_noncomm));
  SET_VECTOR_ELT(state, 310, allocVector(REALSXP, main_model_p->dim_beta_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 310)), main_model_p->beta_noncomm, main_model_p->dim_beta_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 311, ScalarInteger(main_model_p->offset_output_beta_noncomm));
  SET_VECTOR_ELT(state, 312, ScalarInteger(main_model_p->dim_p_comm));
  SET_VECTOR_ELT(state, 313, ScalarInteger(main_model_p->dim_p_comm_1));
  SET_VECTOR_ELT(state, 314, ScalarInteger(main_model_p->dim_p_comm_2));
  SET_VECTOR_ELT(state, 315, allocVector(REALSXP, main_model_p->dim_p_comm));
  memcpy(REAL(VECTOR_ELT(state, 315)), main_model_p->p_comm, main_model_p->dim_p_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 315), 2, main_model_p->dim_p_comm_1, main_model_p->dim_p_comm_2);
  SET_VECTOR_ELT(state, 316, ScalarInteger(main_model_p->offset_output_p_comm));
  SET_VECTOR_ELT(state, 317, ScalarInteger(main_model_p->dim_p_noncomm));
  SET_VECTOR_ELT(state, 318, ScalarInteger(main_model_p->dim_p_noncomm_1));
  SET_VECTOR_ELT(state, 319, ScalarInteger(main_model_p->dim_p_noncomm_2));
  SET_VECTOR_ELT(state, 320, allocVector(REALSXP, main_model_p->dim_p_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 320)), main_model_p->p_noncomm, main_model_p->dim_p_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 320), 2, main_model_p->dim_p_noncomm_1, main_model_p->dim_p_noncomm_2);
  SET_VECTOR_ELT(state, 321, ScalarInteger(main_model_p->offset_output_p_noncomm));
  SET_VECTOR_ELT(state, 322, ScalarInteger(main_model_p->dim_ec));
  SET_VECTOR_ELT(state, 323, allocVector(REALSXP, main_model_p->dim_ec));
  memcpy(REAL(VECTOR_ELT(state, 323)), main_model_p->ec, main_model_p->dim_ec * sizeof(double));
  SET_VECTOR_ELT(state, 324, ScalarInteger(main_model_p->dim_eP));
  SET_VECTOR_ELT(state, 325, allocVector(REALSXP, main_model_p->dim_eP));
  memcpy(REAL(VECTOR_ELT(state, 325)), main_model_p->eP, main_model_p->dim_eP * sizeof(double));
  SET_VECTOR_ELT(state, 326, ScalarInteger(main_model_p->dim_eP0));
  SET_VECTOR_ELT(state, 327, allocVector(REALSXP, main_model_p->dim_eP0));
  memcpy(REAL(VECTOR_ELT(state, 327)), main_model_p->eP0, main_model_p->dim_eP0 * sizeof(double));
  SET_VECTOR_ELT(state, 328, ScalarInteger(main_model_p->dim_eP1a));
  SET_VECTOR_ELT(state, 329, allocVector(REALSXP, main_model_p->dim_eP1a));
  memcpy(REAL(VECTOR_ELT(state, 329)), main_model_p->eP1a, main_model_p->dim_eP1a * sizeof(double));
  SET_VECTOR_ELT(state, 330, ScalarInteger(main_model_p->dim_eP1b));
  SET_VECTOR_ELT(state, 331, allocVector(REALSXP, main_model_p->dim_eP1b));
  memcpy(REAL(VECTOR_ELT(state, 331)), main_model_p->eP1b, main_model_p->dim_eP1b * sizeof(double));
  SET_VECTOR_ELT(state, 332, ScalarInteger(main_model_p->dim_eP1c));
  SET_VECTOR_ELT(state, 333, allocVector(REALSXP, main_model_p->dim_eP1c));
  memcpy(REAL(VECTOR_ELT(state, 333)), main_model_p->eP1c, main_model_p->dim_eP1c * sizeof(double));
  SET_VECTOR_ELT(state, 334, ScalarInteger(main_model_p->dim_eP1d));
  SET_VECTOR_ELT(state, 335, allocVector(REALSXP, main_model_p->dim_eP1d));
  memcpy(REAL(VECTOR_ELT(state, 335)), main_model_p->eP1d, main_model_p->dim_eP1d * sizeof(double));
  SET_VECTOR_ELT(state, 336, ScalarInteger(main_model_p->dim_fc_comm));
  SET_VECTOR_ELT(state, 337, ScalarInteger(main_model_p->dim_fc_comm_1));
  SET_VECTOR_ELT(state, 338, ScalarInteger(main_model_p->dim_fc_comm_2));
  SET_VECTOR_ELT(state, 339, allocVector(REALSXP, main_model_p->dim_fc_comm));
  memcpy(REAL(VECTOR_ELT(state, 339)), main_model_p->fc_comm, main_model_p->dim_fc_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 339), 2, main_model_p->dim_fc_comm_1, main_model_p->dim_fc_comm_2);
  SET_VECTOR_ELT(state, 340, ScalarInteger(main_model_p->offset_output_fc_comm));
  SET_VECTOR_ELT(state, 341, ScalarInteger(main_model_p->dim_fP_comm));
  SET_VECTOR_ELT(state, 342, allocVector(REALSXP, main_model_p->dim_fP_comm));
  memcpy(REAL(VECTOR_ELT(state, 342)), main_model_p->fP_comm, main_model_p->dim_fP_comm * sizeof(double));
  SET_VECTOR_ELT(state, 343, ScalarInteger(main_model_p->offset_output_fP_comm));
  SET_VECTOR_ELT(state, 344, ScalarInteger(main_model_p->dim_fc_noncomm));
  SET_VECTOR_ELT(state, 345, ScalarInteger(main_model_p->dim_fc_noncomm_1));
  SET_VECTOR_ELT(state, 346, ScalarInteger(main_model_p->dim_fc_noncomm_2));
  SET_VECTOR_ELT(state, 347, allocVector(REALSXP, main_model_p->dim_fc_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 347)), main_model_p->fc_noncomm, main_model_p->dim_fc_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 347), 2, main_model_p->dim_fc_noncomm_1, main_model_p->dim_fc_noncomm_2);
  SET_VECTOR_ELT(state, 348, ScalarInteger(main_model_p->offset_output_fc_noncomm));
  SET_VECTOR_ELT(state, 349, ScalarInteger(main_model_p->dim_fP_noncomm));
  SET_VECTOR_ELT(state, 350, allocVector(REALSXP, main_model_p->dim_fP_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 350)), main_model_p->fP_noncomm, main_model_p->dim_fP_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 351, ScalarInteger(main_model_p->offset_output_fP_noncomm));
  SET_VECTOR_ELT(state, 352, ScalarInteger(main_model_p->dim_n_comm));
  SET_VECTOR_ELT(state, 353, ScalarInteger(main_model_p->dim_n_comm_1));
  SET_VECTOR_ELT(state, 354, ScalarInteger(main_model_p->dim_n_comm_2));
  SET_VECTOR_ELT(state, 355, allocVector(REALSXP, main_model_p->dim_n_comm));
  memcpy(REAL(VECTOR_ELT(state, 355)), main_model_p->n_comm, main_model_p->dim_n_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 355), 2, main_model_p->dim_n_comm_1, main_model_p->dim_n_comm_2);
  SET_VECTOR_ELT(state, 356, ScalarInteger(main_model_p->offset_output_n_comm));
  SET_VECTOR_ELT(state, 357, ScalarInteger(main_model_p->dim_n_noncomm));
  SET_VECTOR_ELT(state, 358, ScalarInteger(main_model_p->dim_n_noncomm_1));
  SET_VECTOR_ELT(state, 359, ScalarInteger(main_model_p->dim_n_noncomm_2));
  SET_VECTOR_ELT(state, 360, allocVector(REALSXP, main_model_p->dim_n_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 360)), main_model_p->n_noncomm, main_model_p->dim_n_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 360), 2, main_model_p->dim_n_noncomm_1, main_model_p->dim_n_noncomm_2);
  SET_VECTOR_ELT(state, 361, ScalarInteger(main_model_p->offset_output_n_noncomm));
  SET_VECTOR_ELT(state, 362, ScalarInteger(main_model_p->dim_cumuHIVDeaths));
  SET_VECTOR_ELT(state, 363, allocVector(REALSXP, main_model_p->dim_cumuHIVDeaths));
  memcpy(REAL(VECTOR_ELT(state, 363)), main_model_p->initial_cumuHIVDeaths, main_model_p->dim_cumuHIVDeaths * sizeof(double));
  SET_VECTOR_ELT(state, 364, ScalarInteger(main_model_p->offset_cumuHIVDeaths));
  SET_VECTOR_ELT(state, 365, ScalarInteger(main_model_p->dim_cumuARTinitiations));
  SET_VECTOR_ELT(state, 366, allocVector(REALSXP, main_model_p->dim_cumuARTinitiations));
  memcpy(REAL(VECTOR_ELT(state, 366)), main_model_p->initial_cumuARTinitiations, main_model_p->dim_cumuARTinitiations * sizeof(double));
  SET_VECTOR_ELT(state, 367, ScalarInteger(main_model_p->offset_cumuARTinitiations));
  SET_VECTOR_ELT(state, 368, ScalarInteger(main_model_p->dim_cumuARTREinitiations));
  SET_VECTOR_ELT(state, 369, allocVector(REALSXP, main_model_p->dim_cumuARTREinitiations));
  memcpy(REAL(VECTOR_ELT(state, 369)), main_model_p->initial_cumuARTREinitiations, main_model_p->dim_cumuARTREinitiations * sizeof(double));
  SET_VECTOR_ELT(state, 370, ScalarInteger(main_model_p->offset_cumuARTREinitiations));
  SET_VECTOR_ELT(state, 371, ScalarInteger(main_model_p->dim_dropouts));
  SET_VECTOR_ELT(state, 372, allocVector(REALSXP, main_model_p->dim_dropouts));
  memcpy(REAL(VECTOR_ELT(state, 372)), main_model_p->initial_dropouts, main_model_p->dim_dropouts * sizeof(double));
  SET_VECTOR_ELT(state, 373, ScalarInteger(main_model_p->offset_dropouts));
  SET_VECTOR_ELT(state, 374, ScalarInteger(main_model_p->dim_cumuAllDeaths));
  SET_VECTOR_ELT(state, 375, allocVector(REALSXP, main_model_p->dim_cumuAllDeaths));
  memcpy(REAL(VECTOR_ELT(state, 375)), main_model_p->initial_cumuAllDeaths, main_model_p->dim_cumuAllDeaths * sizeof(double));
  SET_VECTOR_ELT(state, 376, ScalarInteger(main_model_p->offset_cumuAllDeaths));
  SET_VECTOR_ELT(state, 377, ScalarInteger(main_model_p->dim_cumuInf));
  SET_VECTOR_ELT(state, 378, allocVector(REALSXP, main_model_p->dim_cumuInf));
  memcpy(REAL(VECTOR_ELT(state, 378)), main_model_p->initial_cumuInf, main_model_p->dim_cumuInf * sizeof(double));
  SET_VECTOR_ELT(state, 379, ScalarInteger(main_model_p->offset_cumuInf));
  SET_VECTOR_ELT(state, 380, ScalarInteger(main_model_p->dim_OnPrEP));
  SET_VECTOR_ELT(state, 381, allocVector(REALSXP, main_model_p->dim_OnPrEP));
  memcpy(REAL(VECTOR_ELT(state, 381)), main_model_p->initial_OnPrEP, main_model_p->dim_OnPrEP * sizeof(double));
  SET_VECTOR_ELT(state, 382, ScalarInteger(main_model_p->offset_OnPrEP));
  SET_VECTOR_ELT(state, 383, ScalarInteger(main_model_p->dim_OnPrEP1a));
  SET_VECTOR_ELT(state, 384, allocVector(REALSXP, main_model_p->dim_OnPrEP1a));
  memcpy(REAL(VECTOR_ELT(state, 384)), main_model_p->initial_OnPrEP1a, main_model_p->dim_OnPrEP1a * sizeof(double));
  SET_VECTOR_ELT(state, 385, ScalarInteger(main_model_p->offset_OnPrEP1a));
  SET_VECTOR_ELT(state, 386, ScalarInteger(main_model_p->dim_OnPrEP1b));
  SET_VECTOR_ELT(state, 387, allocVector(REALSXP, main_model_p->dim_OnPrEP1b));
  memcpy(REAL(VECTOR_ELT(state, 387)), main_model_p->initial_OnPrEP1b, main_model_p->dim_OnPrEP1b * sizeof(double));
  SET_VECTOR_ELT(state, 388, ScalarInteger(main_model_p->offset_OnPrEP1b));
  SET_VECTOR_ELT(state, 389, ScalarInteger(main_model_p->dim_OnPrEP1c));
  SET_VECTOR_ELT(state, 390, allocVector(REALSXP, main_model_p->dim_OnPrEP1c));
  memcpy(REAL(VECTOR_ELT(state, 390)), main_model_p->initial_OnPrEP1c, main_model_p->dim_OnPrEP1c * sizeof(double));
  SET_VECTOR_ELT(state, 391, ScalarInteger(main_model_p->offset_OnPrEP1c));
  SET_VECTOR_ELT(state, 392, ScalarInteger(main_model_p->dim_S0));
  SET_VECTOR_ELT(state, 393, allocVector(REALSXP, main_model_p->dim_S0));
  memcpy(REAL(VECTOR_ELT(state, 393)), main_model_p->initial_S0, main_model_p->dim_S0 * sizeof(double));
  SET_VECTOR_ELT(state, 394, ScalarInteger(main_model_p->offset_S0));
  SET_VECTOR_ELT(state, 395, ScalarInteger(main_model_p->dim_S1a));
  SET_VECTOR_ELT(state, 396, allocVector(REALSXP, main_model_p->dim_S1a));
  memcpy(REAL(VECTOR_ELT(state, 396)), main_model_p->initial_S1a, main_model_p->dim_S1a * sizeof(double));
  SET_VECTOR_ELT(state, 397, ScalarInteger(main_model_p->offset_S1a));
  SET_VECTOR_ELT(state, 398, ScalarInteger(main_model_p->dim_S1b));
  SET_VECTOR_ELT(state, 399, allocVector(REALSXP, main_model_p->dim_S1b));
  memcpy(REAL(VECTOR_ELT(state, 399)), main_model_p->initial_S1b, main_model_p->dim_S1b * sizeof(double));
  SET_VECTOR_ELT(state, 400, ScalarInteger(main_model_p->offset_S1b));
  SET_VECTOR_ELT(state, 401, ScalarInteger(main_model_p->dim_S1c));
  SET_VECTOR_ELT(state, 402, allocVector(REALSXP, main_model_p->dim_S1c));
  memcpy(REAL(VECTOR_ELT(state, 402)), main_model_p->initial_S1c, main_model_p->dim_S1c * sizeof(double));
  SET_VECTOR_ELT(state, 403, ScalarInteger(main_model_p->offset_S1c));
  SET_VECTOR_ELT(state, 404, ScalarInteger(main_model_p->dim_S1d));
  SET_VECTOR_ELT(state, 405, allocVector(REALSXP, main_model_p->dim_S1d));
  memcpy(REAL(VECTOR_ELT(state, 405)), main_model_p->initial_S1d, main_model_p->dim_S1d * sizeof(double));
  SET_VECTOR_ELT(state, 406, ScalarInteger(main_model_p->offset_S1d));
  SET_VECTOR_ELT(state, 407, ScalarInteger(main_model_p->dim_I01));
  SET_VECTOR_ELT(state, 408, allocVector(REALSXP, main_model_p->dim_I01));
  memcpy(REAL(VECTOR_ELT(state, 408)), main_model_p->initial_I01, main_model_p->dim_I01 * sizeof(double));
  SET_VECTOR_ELT(state, 409, ScalarInteger(main_model_p->offset_I01));
  SET_VECTOR_ELT(state, 410, ScalarInteger(main_model_p->dim_I11));
  SET_VECTOR_ELT(state, 411, allocVector(REALSXP, main_model_p->dim_I11));
  memcpy(REAL(VECTOR_ELT(state, 411)), main_model_p->initial_I11, main_model_p->dim_I11 * sizeof(double));
  SET_VECTOR_ELT(state, 412, ScalarInteger(main_model_p->offset_I11));
  SET_VECTOR_ELT(state, 413, ScalarInteger(main_model_p->dim_I02));
  SET_VECTOR_ELT(state, 414, allocVector(REALSXP, main_model_p->dim_I02));
  memcpy(REAL(VECTOR_ELT(state, 414)), main_model_p->initial_I02, main_model_p->dim_I02 * sizeof(double));
  SET_VECTOR_ELT(state, 415, ScalarInteger(main_model_p->offset_I02));
  SET_VECTOR_ELT(state, 416, ScalarInteger(main_model_p->dim_I03));
  SET_VECTOR_ELT(state, 417, allocVector(REALSXP, main_model_p->dim_I03));
  memcpy(REAL(VECTOR_ELT(state, 417)), main_model_p->initial_I03, main_model_p->dim_I03 * sizeof(double));
  SET_VECTOR_ELT(state, 418, ScalarInteger(main_model_p->offset_I03));
  SET_VECTOR_ELT(state, 419, ScalarInteger(main_model_p->dim_I04));
  SET_VECTOR_ELT(state, 420, allocVector(REALSXP, main_model_p->dim_I04));
  memcpy(REAL(VECTOR_ELT(state, 420)), main_model_p->initial_I04, main_model_p->dim_I04 * sizeof(double));
  SET_VECTOR_ELT(state, 421, ScalarInteger(main_model_p->offset_I04));
  SET_VECTOR_ELT(state, 422, ScalarInteger(main_model_p->dim_I05));
  SET_VECTOR_ELT(state, 423, allocVector(REALSXP, main_model_p->dim_I05));
  memcpy(REAL(VECTOR_ELT(state, 423)), main_model_p->initial_I05, main_model_p->dim_I05 * sizeof(double));
  SET_VECTOR_ELT(state, 424, ScalarInteger(main_model_p->offset_I05));
  SET_VECTOR_ELT(state, 425, ScalarInteger(main_model_p->dim_I22));
  SET_VECTOR_ELT(state, 426, allocVector(REALSXP, main_model_p->dim_I22));
  memcpy(REAL(VECTOR_ELT(state, 426)), main_model_p->initial_I22, main_model_p->dim_I22 * sizeof(double));
  SET_VECTOR_ELT(state, 427, ScalarInteger(main_model_p->offset_I22));
  SET_VECTOR_ELT(state, 428, ScalarInteger(main_model_p->dim_I23));
  SET_VECTOR_ELT(state, 429, allocVector(REALSXP, main_model_p->dim_I23));
  memcpy(REAL(VECTOR_ELT(state, 429)), main_model_p->initial_I23, main_model_p->dim_I23 * sizeof(double));
  SET_VECTOR_ELT(state, 430, ScalarInteger(main_model_p->offset_I23));
  SET_VECTOR_ELT(state, 431, ScalarInteger(main_model_p->dim_I24));
  SET_VECTOR_ELT(state, 432, allocVector(REALSXP, main_model_p->dim_I24));
  memcpy(REAL(VECTOR_ELT(state, 432)), main_model_p->initial_I24, main_model_p->dim_I24 * sizeof(double));
  SET_VECTOR_ELT(state, 433, ScalarInteger(main_model_p->offset_I24));
  SET_VECTOR_ELT(state, 434, ScalarInteger(main_model_p->dim_I25));
  SET_VECTOR_ELT(state, 435, allocVector(REALSXP, main_model_p->dim_I25));
  memcpy(REAL(VECTOR_ELT(state, 435)), main_model_p->initial_I25, main_model_p->dim_I25 * sizeof(double));
  SET_VECTOR_ELT(state, 436, ScalarInteger(main_model_p->offset_I25));
  SET_VECTOR_ELT(state, 437, ScalarInteger(main_model_p->dim_I32));
  SET_VECTOR_ELT(state, 438, allocVector(REALSXP, main_model_p->dim_I32));
  memcpy(REAL(VECTOR_ELT(state, 438)), main_model_p->initial_I32, main_model_p->dim_I32 * sizeof(double));
  SET_VECTOR_ELT(state, 439, ScalarInteger(main_model_p->offset_I32));
  SET_VECTOR_ELT(state, 440, ScalarInteger(main_model_p->dim_I33));
  SET_VECTOR_ELT(state, 441, allocVector(REALSXP, main_model_p->dim_I33));
  memcpy(REAL(VECTOR_ELT(state, 441)), main_model_p->initial_I33, main_model_p->dim_I33 * sizeof(double));
  SET_VECTOR_ELT(state, 442, ScalarInteger(main_model_p->offset_I33));
  SET_VECTOR_ELT(state, 443, ScalarInteger(main_model_p->dim_I34));
  SET_VECTOR_ELT(state, 444, allocVector(REALSXP, main_model_p->dim_I34));
  memcpy(REAL(VECTOR_ELT(state, 444)), main_model_p->initial_I34, main_model_p->dim_I34 * sizeof(double));
  SET_VECTOR_ELT(state, 445, ScalarInteger(main_model_p->offset_I34));
  SET_VECTOR_ELT(state, 446, ScalarInteger(main_model_p->dim_I35));
  SET_VECTOR_ELT(state, 447, allocVector(REALSXP, main_model_p->dim_I35));
  memcpy(REAL(VECTOR_ELT(state, 447)), main_model_p->initial_I35, main_model_p->dim_I35 * sizeof(double));
  SET_VECTOR_ELT(state, 448, ScalarInteger(main_model_p->offset_I35));
  SET_VECTOR_ELT(state, 449, ScalarInteger(main_model_p->dim_I42));
  SET_VECTOR_ELT(state, 450, allocVector(REALSXP, main_model_p->dim_I42));
  memcpy(REAL(VECTOR_ELT(state, 450)), main_model_p->initial_I42, main_model_p->dim_I42 * sizeof(double));
  SET_VECTOR_ELT(state, 451, ScalarInteger(main_model_p->offset_I42));
  SET_VECTOR_ELT(state, 452, ScalarInteger(main_model_p->dim_I43));
  SET_VECTOR_ELT(state, 453, allocVector(REALSXP, main_model_p->dim_I43));
  memcpy(REAL(VECTOR_ELT(state, 453)), main_model_p->initial_I43, main_model_p->dim_I43 * sizeof(double));
  SET_VECTOR_ELT(state, 454, ScalarInteger(main_model_p->offset_I43));
  SET_VECTOR_ELT(state, 455, ScalarInteger(main_model_p->dim_I44));
  SET_VECTOR_ELT(state, 456, allocVector(REALSXP, main_model_p->dim_I44));
  memcpy(REAL(VECTOR_ELT(state, 456)), main_model_p->initial_I44, main_model_p->dim_I44 * sizeof(double));
  SET_VECTOR_ELT(state, 457, ScalarInteger(main_model_p->offset_I44));
  SET_VECTOR_ELT(state, 458, ScalarInteger(main_model_p->dim_I45));
  SET_VECTOR_ELT(state, 459, allocVector(REALSXP, main_model_p->dim_I45));
  memcpy(REAL(VECTOR_ELT(state, 459)), main_model_p->initial_I45, main_model_p->dim_I45 * sizeof(double));
  SET_VECTOR_ELT(state, 460, ScalarInteger(main_model_p->offset_I45));
  SET_VECTOR_ELT(state, 461, ScalarInteger(main_model_p->dim_S0_init));
  SET_VECTOR_ELT(state, 462, allocVector(REALSXP, main_model_p->dim_S0_init));
  memcpy(REAL(VECTOR_ELT(state, 462)), main_model_p->S0_init, main_model_p->dim_S0_init * sizeof(double));
  SET_VECTOR_ELT(state, 463, ScalarInteger(main_model_p->dim_S1a_init));
  SET_VECTOR_ELT(state, 464, allocVector(REALSXP, main_model_p->dim_S1a_init));
  memcpy(REAL(VECTOR_ELT(state, 464)), main_model_p->S1a_init, main_model_p->dim_S1a_init * sizeof(double));
  SET_VECTOR_ELT(state, 465, ScalarInteger(main_model_p->dim_S1b_init));
  SET_VECTOR_ELT(state, 466, allocVector(REALSXP, main_model_p->dim_S1b_init));
  memcpy(REAL(VECTOR_ELT(state, 466)), main_model_p->S1b_init, main_model_p->dim_S1b_init * sizeof(double));
  SET_VECTOR_ELT(state, 467, ScalarInteger(main_model_p->dim_S1c_init));
  SET_VECTOR_ELT(state, 468, allocVector(REALSXP, main_model_p->dim_S1c_init));
  memcpy(REAL(VECTOR_ELT(state, 468)), main_model_p->S1c_init, main_model_p->dim_S1c_init * sizeof(double));
  SET_VECTOR_ELT(state, 469, ScalarInteger(main_model_p->dim_S1d_init));
  SET_VECTOR_ELT(state, 470, allocVector(REALSXP, main_model_p->dim_S1d_init));
  memcpy(REAL(VECTOR_ELT(state, 470)), main_model_p->S1d_init, main_model_p->dim_S1d_init * sizeof(double));
  SET_VECTOR_ELT(state, 471, ScalarInteger(main_model_p->dim_I01_init));
  SET_VECTOR_ELT(state, 472, allocVector(REALSXP, main_model_p->dim_I01_init));
  memcpy(REAL(VECTOR_ELT(state, 472)), main_model_p->I01_init, main_model_p->dim_I01_init * sizeof(double));
  SET_VECTOR_ELT(state, 473, ScalarInteger(main_model_p->dim_I11_init));
  SET_VECTOR_ELT(state, 474, allocVector(REALSXP, main_model_p->dim_I11_init));
  memcpy(REAL(VECTOR_ELT(state, 474)), main_model_p->I11_init, main_model_p->dim_I11_init * sizeof(double));
  SET_VECTOR_ELT(state, 475, ScalarInteger(main_model_p->dim_I02_init));
  SET_VECTOR_ELT(state, 476, allocVector(REALSXP, main_model_p->dim_I02_init));
  memcpy(REAL(VECTOR_ELT(state, 476)), main_model_p->I02_init, main_model_p->dim_I02_init * sizeof(double));
  SET_VECTOR_ELT(state, 477, ScalarInteger(main_model_p->dim_I03_init));
  SET_VECTOR_ELT(state, 478, allocVector(REALSXP, main_model_p->dim_I03_init));
  memcpy(REAL(VECTOR_ELT(state, 478)), main_model_p->I03_init, main_model_p->dim_I03_init * sizeof(double));
  SET_VECTOR_ELT(state, 479, ScalarInteger(main_model_p->dim_I04_init));
  SET_VECTOR_ELT(state, 480, allocVector(REALSXP, main_model_p->dim_I04_init));
  memcpy(REAL(VECTOR_ELT(state, 480)), main_model_p->I04_init, main_model_p->dim_I04_init * sizeof(double));
  SET_VECTOR_ELT(state, 481, ScalarInteger(main_model_p->dim_I05_init));
  SET_VECTOR_ELT(state, 482, allocVector(REALSXP, main_model_p->dim_I05_init));
  memcpy(REAL(VECTOR_ELT(state, 482)), main_model_p->I05_init, main_model_p->dim_I05_init * sizeof(double));
  SET_VECTOR_ELT(state, 483, ScalarInteger(main_model_p->dim_I22_init));
  SET_VECTOR_ELT(state, 484, allocVector(REALSXP, main_model_p->dim_I22_init));
  memcpy(REAL(VECTOR_ELT(state, 484)), main_model_p->I22_init, main_model_p->dim_I22_init * sizeof(double));
  SET_VECTOR_ELT(state, 485, ScalarInteger(main_model_p->dim_I23_init));
  SET_VECTOR_ELT(state, 486, allocVector(REALSXP, main_model_p->dim_I23_init));
  memcpy(REAL(VECTOR_ELT(state, 486)), main_model_p->I23_init, main_model_p->dim_I23_init * sizeof(double));
  SET_VECTOR_ELT(state, 487, ScalarInteger(main_model_p->dim_I24_init));
  SET_VECTOR_ELT(state, 488, allocVector(REALSXP, main_model_p->dim_I24_init));
  memcpy(REAL(VECTOR_ELT(state, 488)), main_model_p->I24_init, main_model_p->dim_I24_init * sizeof(double));
  SET_VECTOR_ELT(state, 489, ScalarInteger(main_model_p->dim_I25_init));
  SET_VECTOR_ELT(state, 490, allocVector(REALSXP, main_model_p->dim_I25_init));
  memcpy(REAL(VECTOR_ELT(state, 490)), main_model_p->I25_init, main_model_p->dim_I25_init * sizeof(double));
  SET_VECTOR_ELT(state, 491, ScalarInteger(main_model_p->dim_I32_init));
  SET_VECTOR_ELT(state, 492, allocVector(REALSXP, main_model_p->dim_I32_init));
  memcpy(REAL(VECTOR_ELT(state, 492)), main_model_p->I32_init, main_model_p->dim_I32_init * sizeof(double));
  SET_VECTOR_ELT(state, 493, ScalarInteger(main_model_p->dim_I33_init));
  SET_VECTOR_ELT(state, 494, allocVector(REALSXP, main_model_p->dim_I33_init));
  memcpy(REAL(VECTOR_ELT(state, 494)), main_model_p->I33_init, main_model_p->dim_I33_init * sizeof(double));
  SET_VECTOR_ELT(state, 495, ScalarInteger(main_model_p->dim_I34_init));
  SET_VECTOR_ELT(state, 496, allocVector(REALSXP, main_model_p->dim_I34_init));
  memcpy(REAL(VECTOR_ELT(state, 496)), main_model_p->I34_init, main_model_p->dim_I34_init * sizeof(double));
  SET_VECTOR_ELT(state, 497, ScalarInteger(main_model_p->dim_I35_init));
  SET_VECTOR_ELT(state, 498, allocVector(REALSXP, main_model_p->dim_I35_init));
  memcpy(REAL(VECTOR_ELT(state, 498)), main_model_p->I35_init, main_model_p->dim_I35_init * sizeof(double));
  SET_VECTOR_ELT(state, 499, ScalarInteger(main_model_p->dim_I42_init));
  SET_VECTOR_ELT(state, 500, allocVector(REALSXP, main_model_p->dim_I42_init));
  memcpy(REAL(VECTOR_ELT(state, 500)), main_model_p->I42_init, main_model_p->dim_I42_init * sizeof(double));
  SET_VECTOR_ELT(state, 501, ScalarInteger(main_model_p->dim_I43_init));
  SET_VECTOR_ELT(state, 502, allocVector(REALSXP, main_model_p->dim_I43_init));
  memcpy(REAL(VECTOR_ELT(state, 502)), main_model_p->I43_init, main_model_p->dim_I43_init * sizeof(double));
  SET_VECTOR_ELT(state, 503, ScalarInteger(main_model_p->dim_I44_init));
  SET_VECTOR_ELT(state, 504, allocVector(REALSXP, main_model_p->dim_I44_init));
  memcpy(REAL(VECTOR_ELT(state, 504)), main_model_p->I44_init, main_model_p->dim_I44_init * sizeof(double));
  SET_VECTOR_ELT(state, 505, ScalarInteger(main_model_p->dim_I45_init));
  SET_VECTOR_ELT(state, 506, allocVector(REALSXP, main_model_p->dim_I45_init));
  memcpy(REAL(VECTOR_ELT(state, 506)), main_model_p->I45_init, main_model_p->dim_I45_init * sizeof(double));
  SET_VECTOR_ELT(state, 507, ScalarInteger(main_model_p->dim_N));
  SET_VECTOR_ELT(state, 508, allocVector(REALSXP, main_model_p->dim_N));
  memcpy(REAL(VECTOR_ELT(state, 508)), main_model_p->N, main_model_p->dim_N * sizeof(double));
  SET_VECTOR_ELT(state, 509, ScalarInteger(main_model_p->offset_output_N));
  SET_VECTOR_ELT(state, 510, ScalarInteger(main_model_p->dim_E0));
  SET_VECTOR_ELT(state, 511, allocVector(REALSXP, main_model_p->dim_E0));
  memcpy(REAL(VECTOR_ELT(state, 511)), main_model_p->E0, main_model_p->dim_E0 * sizeof(double));
  SET_VECTOR_ELT(state, 512, ScalarInteger(main_model_p->offset_output_E0));
  SET_VECTOR_ELT(state, 513, ScalarInteger(main_model_p->dim_E1a));
  SET_VECTOR_ELT(state, 514, allocVector(REALSXP, main_model_p->dim_E1a));
  memcpy(REAL(VECTOR_ELT(state, 514)), main_model_p->E1a, main_model_p->dim_E1a * sizeof(double));
  SET_VECTOR_ELT(state, 515, ScalarInteger(main_model_p->offset_output_E1a));
  SET_VECTOR_ELT(state, 516, ScalarInteger(main_model_p->dim_E1b));
  SET_VECTOR_ELT(state, 517, allocVector(REALSXP, main_model_p->dim_E1b));
  memcpy(REAL(VECTOR_ELT(state, 517)), main_model_p->E1b, main_model_p->dim_E1b * sizeof(double));
  SET_VECTOR_ELT(state, 518, ScalarInteger(main_model_p->offset_output_E1b));
  SET_VECTOR_ELT(state, 519, ScalarInteger(main_model_p->dim_E1c));
  SET_VECTOR_ELT(state, 520, allocVector(REALSXP, main_model_p->dim_E1c));
  memcpy(REAL(VECTOR_ELT(state, 520)), main_model_p->E1c, main_model_p->dim_E1c * sizeof(double));
  SET_VECTOR_ELT(state, 521, ScalarInteger(main_model_p->offset_output_E1c));
  SET_VECTOR_ELT(state, 522, ScalarInteger(main_model_p->dim_E1d));
  SET_VECTOR_ELT(state, 523, allocVector(REALSXP, main_model_p->dim_E1d));
  memcpy(REAL(VECTOR_ELT(state, 523)), main_model_p->E1d, main_model_p->dim_E1d * sizeof(double));
  SET_VECTOR_ELT(state, 524, ScalarInteger(main_model_p->offset_output_E1d));
  SET_VECTOR_ELT(state, 525, ScalarInteger(main_model_p->dim_cumuInf_init));
  SET_VECTOR_ELT(state, 526, allocVector(REALSXP, main_model_p->dim_cumuInf_init));
  memcpy(REAL(VECTOR_ELT(state, 526)), main_model_p->cumuInf_init, main_model_p->dim_cumuInf_init * sizeof(double));
  SET_VECTOR_ELT(state, 527, ScalarInteger(main_model_p->dim_alphaItot));
  SET_VECTOR_ELT(state, 528, allocVector(REALSXP, main_model_p->dim_alphaItot));
  memcpy(REAL(VECTOR_ELT(state, 528)), main_model_p->alphaItot, main_model_p->dim_alphaItot * sizeof(double));
  SET_VECTOR_ELT(state, 529, ScalarInteger(main_model_p->offset_output_alphaItot));
  SET_VECTOR_ELT(state, 530, ScalarInteger(main_model_p->dim_prev));
  SET_VECTOR_ELT(state, 531, allocVector(REALSXP, main_model_p->dim_prev));
  memcpy(REAL(VECTOR_ELT(state, 531)), main_model_p->prev, main_model_p->dim_prev * sizeof(double));
  SET_VECTOR_ELT(state, 532, ScalarInteger(main_model_p->offset_output_prev));
  SET_VECTOR_ELT(state, 533, ScalarInteger(main_model_p->dim_lambda));
  SET_VECTOR_ELT(state, 534, ScalarInteger(main_model_p->dim_lambda_1));
  SET_VECTOR_ELT(state, 535, ScalarInteger(main_model_p->dim_lambda_2));
  SET_VECTOR_ELT(state, 536, allocVector(REALSXP, main_model_p->dim_lambda));
  memcpy(REAL(VECTOR_ELT(state, 536)), main_model_p->lambda, main_model_p->dim_lambda * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 536), 2, main_model_p->dim_lambda_1, main_model_p->dim_lambda_2);
  SET_VECTOR_ELT(state, 537, ScalarInteger(main_model_p->offset_output_lambda));
  SET_VECTOR_ELT(state, 538, ScalarInteger(main_model_p->dim_lambda_0));
  SET_VECTOR_ELT(state, 539, ScalarInteger(main_model_p->dim_lambda_0_1));
  SET_VECTOR_ELT(state, 540, ScalarInteger(main_model_p->dim_lambda_0_2));
  SET_VECTOR_ELT(state, 541, allocVector(REALSXP, main_model_p->dim_lambda_0));
  memcpy(REAL(VECTOR_ELT(state, 541)), main_model_p->lambda_0, main_model_p->dim_lambda_0 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 541), 2, main_model_p->dim_lambda_0_1, main_model_p->dim_lambda_0_2);
  SET_VECTOR_ELT(state, 542, ScalarInteger(main_model_p->offset_output_lambda_0));
  SET_VECTOR_ELT(state, 543, ScalarInteger(main_model_p->dim_lambda_1a));
  SET_VECTOR_ELT(state, 544, ScalarInteger(main_model_p->dim_lambda_1a_1));
  SET_VECTOR_ELT(state, 545, ScalarInteger(main_model_p->dim_lambda_1a_2));
  SET_VECTOR_ELT(state, 546, allocVector(REALSXP, main_model_p->dim_lambda_1a));
  memcpy(REAL(VECTOR_ELT(state, 546)), main_model_p->lambda_1a, main_model_p->dim_lambda_1a * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 546), 2, main_model_p->dim_lambda_1a_1, main_model_p->dim_lambda_1a_2);
  SET_VECTOR_ELT(state, 547, ScalarInteger(main_model_p->offset_output_lambda_1a));
  SET_VECTOR_ELT(state, 548, ScalarInteger(main_model_p->dim_lambda_1b));
  SET_VECTOR_ELT(state, 549, ScalarInteger(main_model_p->dim_lambda_1b_1));
  SET_VECTOR_ELT(state, 550, ScalarInteger(main_model_p->dim_lambda_1b_2));
  SET_VECTOR_ELT(state, 551, allocVector(REALSXP, main_model_p->dim_lambda_1b));
  memcpy(REAL(VECTOR_ELT(state, 551)), main_model_p->lambda_1b, main_model_p->dim_lambda_1b * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 551), 2, main_model_p->dim_lambda_1b_1, main_model_p->dim_lambda_1b_2);
  SET_VECTOR_ELT(state, 552, ScalarInteger(main_model_p->offset_output_lambda_1b));
  SET_VECTOR_ELT(state, 553, ScalarInteger(main_model_p->dim_lambda_1c));
  SET_VECTOR_ELT(state, 554, ScalarInteger(main_model_p->dim_lambda_1c_1));
  SET_VECTOR_ELT(state, 555, ScalarInteger(main_model_p->dim_lambda_1c_2));
  SET_VECTOR_ELT(state, 556, allocVector(REALSXP, main_model_p->dim_lambda_1c));
  memcpy(REAL(VECTOR_ELT(state, 556)), main_model_p->lambda_1c, main_model_p->dim_lambda_1c * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 556), 2, main_model_p->dim_lambda_1c_1, main_model_p->dim_lambda_1c_2);
  SET_VECTOR_ELT(state, 557, ScalarInteger(main_model_p->offset_output_lambda_1c));
  SET_VECTOR_ELT(state, 558, ScalarInteger(main_model_p->dim_lambda_1d));
  SET_VECTOR_ELT(state, 559, ScalarInteger(main_model_p->dim_lambda_1d_1));
  SET_VECTOR_ELT(state, 560, ScalarInteger(main_model_p->dim_lambda_1d_2));
  SET_VECTOR_ELT(state, 561, allocVector(REALSXP, main_model_p->dim_lambda_1d));
  memcpy(REAL(VECTOR_ELT(state, 561)), main_model_p->lambda_1d, main_model_p->dim_lambda_1d * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 561), 2, main_model_p->dim_lambda_1d_1, main_model_p->dim_lambda_1d_2);
  SET_VECTOR_ELT(state, 562, ScalarInteger(main_model_p->offset_output_lambda_1d));
  SET_VECTOR_ELT(state, 563, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_VECTOR_ELT(state, 564, allocVector(REALSXP, main_model_p->dim_lambda_sum_0));
  memcpy(REAL(VECTOR_ELT(state, 564)), main_model_p->lambda_sum_0, main_model_p->dim_lambda_sum_0 * sizeof(double));
  SET_VECTOR_ELT(state, 565, ScalarInteger(main_model_p->offset_output_lambda_sum_0));
  SET_VECTOR_ELT(state, 566, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_VECTOR_ELT(state, 567, allocVector(REALSXP, main_model_p->dim_lambda_sum_1a));
  memcpy(REAL(VECTOR_ELT(state, 567)), main_model_p->lambda_sum_1a, main_model_p->dim_lambda_sum_1a * sizeof(double));
  SET_VECTOR_ELT(state, 568, ScalarInteger(main_model_p->offset_output_lambda_sum_1a));
  SET_VECTOR_ELT(state, 569, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_VECTOR_ELT(state, 570, allocVector(REALSXP, main_model_p->dim_lambda_sum_1b));
  memcpy(REAL(VECTOR_ELT(state, 570)), main_model_p->lambda_sum_1b, main_model_p->dim_lambda_sum_1b * sizeof(double));
  SET_VECTOR_ELT(state, 571, ScalarInteger(main_model_p->offset_output_lambda_sum_1b));
  SET_VECTOR_ELT(state, 572, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_VECTOR_ELT(state, 573, allocVector(REALSXP, main_model_p->dim_lambda_sum_1c));
  memcpy(REAL(VECTOR_ELT(state, 573)), main_model_p->lambda_sum_1c, main_model_p->dim_lambda_sum_1c * sizeof(double));
  SET_VECTOR_ELT(state, 574, ScalarInteger(main_model_p->offset_output_lambda_sum_1c));
  SET_VECTOR_ELT(state, 575, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_VECTOR_ELT(state, 576, allocVector(REALSXP, main_model_p->dim_lambda_sum_1d));
  memcpy(REAL(VECTOR_ELT(state, 576)), main_model_p->lambda_sum_1d, main_model_p->dim_lambda_sum_1d * sizeof(double));
  SET_VECTOR_ELT(state, 577, ScalarInteger(main_model_p->offset_output_lambda_sum_1d));
  SET_VECTOR_ELT(state, 578, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_VECTOR_ELT(state, 579, allocVector(REALSXP, main_model_p->dim_c_comm_balanced));
  memcpy(REAL(VECTOR_ELT(state, 579)), main_model_p->c_comm_balanced, main_model_p->dim_c_comm_balanced * sizeof(double));
  SET_VECTOR_ELT(state, 580, ScalarInteger(main_model_p->offset_output_c_comm_balanced));
  SET_VECTOR_ELT(state, 581, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_VECTOR_ELT(state, 582, allocVector(REALSXP, main_model_p->dim_c_noncomm_balanced));
  memcpy(REAL(VECTOR_ELT(state, 582)), main_model_p->c_noncomm_balanced, main_model_p->dim_c_noncomm_balanced * sizeof(double));
  SET_VECTOR_ELT(state, 583, ScalarInteger(main_model_p->offset_output_c_noncomm_balanced));
  SET_VECTOR_ELT(state, 584, ScalarInteger(main_model_p->dim_theta));
  SET_VECTOR_ELT(state, 585, ScalarInteger(main_model_p->dim_theta_1));
  SET_VECTOR_ELT(state, 586, ScalarInteger(main_model_p->dim_theta_2));
  SET_VECTOR_ELT(state, 587, allocVector(REALSXP, main_model_p->dim_theta));
  memcpy(REAL(VECTOR_ELT(state, 587)), main_model_p->theta, main_model_p->dim_theta * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 587), 2, main_model_p->dim_theta_1, main_model_p->dim_theta_2);
  SET_VECTOR_ELT(state, 588, ScalarInteger(main_model_p->offset_output_theta));
  SET_VECTOR_ELT(state, 589, ScalarInteger(main_model_p->dim_OnPrEP_init));
  SET_VECTOR_ELT(state, 590, allocVector(REALSXP, main_model_p->dim_OnPrEP_init));
  memcpy(REAL(VECTOR_ELT(state, 590)), main_model_p->OnPrEP_init, main_model_p->dim_OnPrEP_init * sizeof(double));
  SET_VECTOR_ELT(state, 591, ScalarInteger(main_model_p->dim_M_comm));
  SET_VECTOR_ELT(state, 592, ScalarInteger(main_model_p->dim_M_comm_1));
  SET_VECTOR_ELT(state, 593, ScalarInteger(main_model_p->dim_M_comm_2));
  SET_VECTOR_ELT(state, 594, allocVector(REALSXP, main_model_p->dim_M_comm));
  memcpy(REAL(VECTOR_ELT(state, 594)), main_model_p->M_comm, main_model_p->dim_M_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 594), 2, main_model_p->dim_M_comm_1, main_model_p->dim_M_comm_2);
  SET_VECTOR_ELT(state, 595, ScalarInteger(main_model_p->offset_output_M_comm));
  SET_VECTOR_ELT(state, 596, ScalarInteger(main_model_p->dim_M_noncomm));
  SET_VECTOR_ELT(state, 597, ScalarInteger(main_model_p->dim_M_noncomm_1));
  SET_VECTOR_ELT(state, 598, ScalarInteger(main_model_p->dim_M_noncomm_2));
  SET_VECTOR_ELT(state, 599, allocVector(REALSXP, main_model_p->dim_M_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 599)), main_model_p->M_noncomm, main_model_p->dim_M_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 599), 2, main_model_p->dim_M_noncomm_1, main_model_p->dim_M_noncomm_2);
  SET_VECTOR_ELT(state, 600, ScalarInteger(main_model_p->offset_output_M_noncomm));
  SET_VECTOR_ELT(state, 601, ScalarInteger(main_model_p->dim_in_S0));
  SET_VECTOR_ELT(state, 602, ScalarInteger(main_model_p->dim_in_S0_1));
  SET_VECTOR_ELT(state, 603, ScalarInteger(main_model_p->dim_in_S0_2));
  SET_VECTOR_ELT(state, 604, allocVector(REALSXP, main_model_p->dim_in_S0));
  memcpy(REAL(VECTOR_ELT(state, 604)), main_model_p->in_S0, main_model_p->dim_in_S0 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 604), 2, main_model_p->dim_in_S0_1, main_model_p->dim_in_S0_2);
  SET_VECTOR_ELT(state, 605, ScalarInteger(main_model_p->dim_in_S1a));
  SET_VECTOR_ELT(state, 606, ScalarInteger(main_model_p->dim_in_S1a_1));
  SET_VECTOR_ELT(state, 607, ScalarInteger(main_model_p->dim_in_S1a_2));
  SET_VECTOR_ELT(state, 608, allocVector(REALSXP, main_model_p->dim_in_S1a));
  memcpy(REAL(VECTOR_ELT(state, 608)), main_model_p->in_S1a, main_model_p->dim_in_S1a * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 608), 2, main_model_p->dim_in_S1a_1, main_model_p->dim_in_S1a_2);
  SET_VECTOR_ELT(state, 609, ScalarInteger(main_model_p->dim_in_S1b));
  SET_VECTOR_ELT(state, 610, ScalarInteger(main_model_p->dim_in_S1b_1));
  SET_VECTOR_ELT(state, 611, ScalarInteger(main_model_p->dim_in_S1b_2));
  SET_VECTOR_ELT(state, 612, allocVector(REALSXP, main_model_p->dim_in_S1b));
  memcpy(REAL(VECTOR_ELT(state, 612)), main_model_p->in_S1b, main_model_p->dim_in_S1b * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 612), 2, main_model_p->dim_in_S1b_1, main_model_p->dim_in_S1b_2);
  SET_VECTOR_ELT(state, 613, ScalarInteger(main_model_p->dim_in_S1c));
  SET_VECTOR_ELT(state, 614, ScalarInteger(main_model_p->dim_in_S1c_1));
  SET_VECTOR_ELT(state, 615, ScalarInteger(main_model_p->dim_in_S1c_2));
  SET_VECTOR_ELT(state, 616, allocVector(REALSXP, main_model_p->dim_in_S1c));
  memcpy(REAL(VECTOR_ELT(state, 616)), main_model_p->in_S1c, main_model_p->dim_in_S1c * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 616), 2, main_model_p->dim_in_S1c_1, main_model_p->dim_in_S1c_2);
  SET_VECTOR_ELT(state, 617, ScalarInteger(main_model_p->dim_in_S1d));
  SET_VECTOR_ELT(state, 618, ScalarInteger(main_model_p->dim_in_S1d_1));
  SET_VECTOR_ELT(state, 619, ScalarInteger(main_model_p->dim_in_S1d_2));
  SET_VECTOR_ELT(state, 620, allocVector(REALSXP, main_model_p->dim_in_S1d));
  memcpy(REAL(VECTOR_ELT(state, 620)), main_model_p->in_S1d, main_model_p->dim_in_S1d * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 620), 2, main_model_p->dim_in_S1d_1, main_model_p->dim_in_S1d_2);
  SET_VECTOR_ELT(state, 621, ScalarInteger(main_model_p->dim_in_I01));
  SET_VECTOR_ELT(state, 622, ScalarInteger(main_model_p->dim_in_I01_1));
  SET_VECTOR_ELT(state, 623, ScalarInteger(main_model_p->dim_in_I01_2));
  SET_VECTOR_ELT(state, 624, allocVector(REALSXP, main_model_p->dim_in_I01));
  memcpy(REAL(VECTOR_ELT(state, 624)), main_model_p->in_I01, main_model_p->dim_in_I01 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 624), 2, main_model_p->dim_in_I01_1, main_model_p->dim_in_I01_2);
  SET_VECTOR_ELT(state, 625, ScalarInteger(main_model_p->dim_in_I11));
  SET_VECTOR_ELT(state, 626, ScalarInteger(main_model_p->dim_in_I11_1));
  SET_VECTOR_ELT(state, 627, ScalarInteger(main_model_p->dim_in_I11_2));
  SET_VECTOR_ELT(state, 628, allocVector(REALSXP, main_model_p->dim_in_I11));
  memcpy(REAL(VECTOR_ELT(state, 628)), main_model_p->in_I11, main_model_p->dim_in_I11 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 628), 2, main_model_p->dim_in_I11_1, main_model_p->dim_in_I11_2);
  SET_VECTOR_ELT(state, 629, ScalarInteger(main_model_p->dim_in_I02));
  SET_VECTOR_ELT(state, 630, ScalarInteger(main_model_p->dim_in_I02_1));
  SET_VECTOR_ELT(state, 631, ScalarInteger(main_model_p->dim_in_I02_2));
  SET_VECTOR_ELT(state, 632, allocVector(REALSXP, main_model_p->dim_in_I02));
  memcpy(REAL(VECTOR_ELT(state, 632)), main_model_p->in_I02, main_model_p->dim_in_I02 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 632), 2, main_model_p->dim_in_I02_1, main_model_p->dim_in_I02_2);
  SET_VECTOR_ELT(state, 633, ScalarInteger(main_model_p->dim_in_I03));
  SET_VECTOR_ELT(state, 634, ScalarInteger(main_model_p->dim_in_I03_1));
  SET_VECTOR_ELT(state, 635, ScalarInteger(main_model_p->dim_in_I03_2));
  SET_VECTOR_ELT(state, 636, allocVector(REALSXP, main_model_p->dim_in_I03));
  memcpy(REAL(VECTOR_ELT(state, 636)), main_model_p->in_I03, main_model_p->dim_in_I03 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 636), 2, main_model_p->dim_in_I03_1, main_model_p->dim_in_I03_2);
  SET_VECTOR_ELT(state, 637, ScalarInteger(main_model_p->dim_in_I04));
  SET_VECTOR_ELT(state, 638, ScalarInteger(main_model_p->dim_in_I04_1));
  SET_VECTOR_ELT(state, 639, ScalarInteger(main_model_p->dim_in_I04_2));
  SET_VECTOR_ELT(state, 640, allocVector(REALSXP, main_model_p->dim_in_I04));
  memcpy(REAL(VECTOR_ELT(state, 640)), main_model_p->in_I04, main_model_p->dim_in_I04 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 640), 2, main_model_p->dim_in_I04_1, main_model_p->dim_in_I04_2);
  SET_VECTOR_ELT(state, 641, ScalarInteger(main_model_p->dim_in_I05));
  SET_VECTOR_ELT(state, 642, ScalarInteger(main_model_p->dim_in_I05_1));
  SET_VECTOR_ELT(state, 643, ScalarInteger(main_model_p->dim_in_I05_2));
  SET_VECTOR_ELT(state, 644, allocVector(REALSXP, main_model_p->dim_in_I05));
  memcpy(REAL(VECTOR_ELT(state, 644)), main_model_p->in_I05, main_model_p->dim_in_I05 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 644), 2, main_model_p->dim_in_I05_1, main_model_p->dim_in_I05_2);
  SET_VECTOR_ELT(state, 645, ScalarInteger(main_model_p->dim_in_I22));
  SET_VECTOR_ELT(state, 646, ScalarInteger(main_model_p->dim_in_I22_1));
  SET_VECTOR_ELT(state, 647, ScalarInteger(main_model_p->dim_in_I22_2));
  SET_VECTOR_ELT(state, 648, allocVector(REALSXP, main_model_p->dim_in_I22));
  memcpy(REAL(VECTOR_ELT(state, 648)), main_model_p->in_I22, main_model_p->dim_in_I22 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 648), 2, main_model_p->dim_in_I22_1, main_model_p->dim_in_I22_2);
  SET_VECTOR_ELT(state, 649, ScalarInteger(main_model_p->dim_in_I23));
  SET_VECTOR_ELT(state, 650, ScalarInteger(main_model_p->dim_in_I23_1));
  SET_VECTOR_ELT(state, 651, ScalarInteger(main_model_p->dim_in_I23_2));
  SET_VECTOR_ELT(state, 652, allocVector(REALSXP, main_model_p->dim_in_I23));
  memcpy(REAL(VECTOR_ELT(state, 652)), main_model_p->in_I23, main_model_p->dim_in_I23 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 652), 2, main_model_p->dim_in_I23_1, main_model_p->dim_in_I23_2);
  SET_VECTOR_ELT(state, 653, ScalarInteger(main_model_p->dim_in_I24));
  SET_VECTOR_ELT(state, 654, ScalarInteger(main_model_p->dim_in_I24_1));
  SET_VECTOR_ELT(state, 655, ScalarInteger(main_model_p->dim_in_I24_2));
  SET_VECTOR_ELT(state, 656, allocVector(REALSXP, main_model_p->dim_in_I24));
  memcpy(REAL(VECTOR_ELT(state, 656)), main_model_p->in_I24, main_model_p->dim_in_I24 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 656), 2, main_model_p->dim_in_I24_1, main_model_p->dim_in_I24_2);
  SET_VECTOR_ELT(state, 657, ScalarInteger(main_model_p->dim_in_I25));
  SET_VECTOR_ELT(state, 658, ScalarInteger(main_model_p->dim_in_I25_1));
  SET_VECTOR_ELT(state, 659, ScalarInteger(main_model_p->dim_in_I25_2));
  SET_VECTOR_ELT(state, 660, allocVector(REALSXP, main_model_p->dim_in_I25));
  memcpy(REAL(VECTOR_ELT(state, 660)), main_model_p->in_I25, main_model_p->dim_in_I25 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 660), 2, main_model_p->dim_in_I25_1, main_model_p->dim_in_I25_2);
  SET_VECTOR_ELT(state, 661, ScalarInteger(main_model_p->dim_in_I32));
  SET_VECTOR_ELT(state, 662, ScalarInteger(main_model_p->dim_in_I32_1));
  SET_VECTOR_ELT(state, 663, ScalarInteger(main_model_p->dim_in_I32_2));
  SET_VECTOR_ELT(state, 664, allocVector(REALSXP, main_model_p->dim_in_I32));
  memcpy(REAL(VECTOR_ELT(state, 664)), main_model_p->in_I32, main_model_p->dim_in_I32 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 664), 2, main_model_p->dim_in_I32_1, main_model_p->dim_in_I32_2);
  SET_VECTOR_ELT(state, 665, ScalarInteger(main_model_p->dim_in_I33));
  SET_VECTOR_ELT(state, 666, ScalarInteger(main_model_p->dim_in_I33_1));
  SET_VECTOR_ELT(state, 667, ScalarInteger(main_model_p->dim_in_I33_2));
  SET_VECTOR_ELT(state, 668, allocVector(REALSXP, main_model_p->dim_in_I33));
  memcpy(REAL(VECTOR_ELT(state, 668)), main_model_p->in_I33, main_model_p->dim_in_I33 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 668), 2, main_model_p->dim_in_I33_1, main_model_p->dim_in_I33_2);
  SET_VECTOR_ELT(state, 669, ScalarInteger(main_model_p->dim_in_I34));
  SET_VECTOR_ELT(state, 670, ScalarInteger(main_model_p->dim_in_I34_1));
  SET_VECTOR_ELT(state, 671, ScalarInteger(main_model_p->dim_in_I34_2));
  SET_VECTOR_ELT(state, 672, allocVector(REALSXP, main_model_p->dim_in_I34));
  memcpy(REAL(VECTOR_ELT(state, 672)), main_model_p->in_I34, main_model_p->dim_in_I34 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 672), 2, main_model_p->dim_in_I34_1, main_model_p->dim_in_I34_2);
  SET_VECTOR_ELT(state, 673, ScalarInteger(main_model_p->dim_in_I35));
  SET_VECTOR_ELT(state, 674, ScalarInteger(main_model_p->dim_in_I35_1));
  SET_VECTOR_ELT(state, 675, ScalarInteger(main_model_p->dim_in_I35_2));
  SET_VECTOR_ELT(state, 676, allocVector(REALSXP, main_model_p->dim_in_I35));
  memcpy(REAL(VECTOR_ELT(state, 676)), main_model_p->in_I35, main_model_p->dim_in_I35 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 676), 2, main_model_p->dim_in_I35_1, main_model_p->dim_in_I35_2);
  SET_VECTOR_ELT(state, 677, ScalarInteger(main_model_p->dim_in_I42));
  SET_VECTOR_ELT(state, 678, ScalarInteger(main_model_p->dim_in_I42_1));
  SET_VECTOR_ELT(state, 679, ScalarInteger(main_model_p->dim_in_I42_2));
  SET_VECTOR_ELT(state, 680, allocVector(REALSXP, main_model_p->dim_in_I42));
  memcpy(REAL(VECTOR_ELT(state, 680)), main_model_p->in_I42, main_model_p->dim_in_I42 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 680), 2, main_model_p->dim_in_I42_1, main_model_p->dim_in_I42_2);
  SET_VECTOR_ELT(state, 681, ScalarInteger(main_model_p->dim_in_I43));
  SET_VECTOR_ELT(state, 682, ScalarInteger(main_model_p->dim_in_I43_1));
  SET_VECTOR_ELT(state, 683, ScalarInteger(main_model_p->dim_in_I43_2));
  SET_VECTOR_ELT(state, 684, allocVector(REALSXP, main_model_p->dim_in_I43));
  memcpy(REAL(VECTOR_ELT(state, 684)), main_model_p->in_I43, main_model_p->dim_in_I43 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 684), 2, main_model_p->dim_in_I43_1, main_model_p->dim_in_I43_2);
  SET_VECTOR_ELT(state, 685, ScalarInteger(main_model_p->dim_in_I44));
  SET_VECTOR_ELT(state, 686, ScalarInteger(main_model_p->dim_in_I44_1));
  SET_VECTOR_ELT(state, 687, ScalarInteger(main_model_p->dim_in_I44_2));
  SET_VECTOR_ELT(state, 688, allocVector(REALSXP, main_model_p->dim_in_I44));
  memcpy(REAL(VECTOR_ELT(state, 688)), main_model_p->in_I44, main_model_p->dim_in_I44 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 688), 2, main_model_p->dim_in_I44_1, main_model_p->dim_in_I44_2);
  SET_VECTOR_ELT(state, 689, ScalarInteger(main_model_p->dim_in_I45));
  SET_VECTOR_ELT(state, 690, ScalarInteger(main_model_p->dim_in_I45_1));
  SET_VECTOR_ELT(state, 691, ScalarInteger(main_model_p->dim_in_I45_2));
  SET_VECTOR_ELT(state, 692, allocVector(REALSXP, main_model_p->dim_in_I45));
  memcpy(REAL(VECTOR_ELT(state, 692)), main_model_p->in_I45, main_model_p->dim_in_I45 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 692), 2, main_model_p->dim_in_I45_1, main_model_p->dim_in_I45_2);
  SET_VECTOR_ELT(state, 693, ScalarInteger(main_model_p->dim_rate_move_in));
  SET_VECTOR_ELT(state, 694, ScalarInteger(main_model_p->dim_rate_move_in_1));
  SET_VECTOR_ELT(state, 695, ScalarInteger(main_model_p->dim_rate_move_in_2));
  SET_VECTOR_ELT(state, 696, allocVector(REALSXP, main_model_p->dim_rate_move_in));
  memcpy(REAL(VECTOR_ELT(state, 696)), main_model_p->rate_move_in, main_model_p->dim_rate_move_in * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 696), 2, main_model_p->dim_rate_move_in_1, main_model_p->dim_rate_move_in_2);
  SET_VECTOR_ELT(state, 697, ScalarInteger(main_model_p->offset_output_rate_move_in));
  SET_VECTOR_ELT(state, 698, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_VECTOR_ELT(state, 699, allocVector(REALSXP, main_model_p->dim_rate_move_out));
  memcpy(REAL(VECTOR_ELT(state, 699)), main_model_p->rate_move_out, main_model_p->dim_rate_move_out * sizeof(double));
  SET_VECTOR_ELT(state, 700, ScalarInteger(main_model_p->offset_output_rate_move_out));
  SET_VECTOR_ELT(state, 704, ScalarReal(main_model_p->ART_eligible_CD4_above_500));
  SET_VECTOR_ELT(state, 706, ScalarReal(main_model_p->ART_eligible_CD4_350_500));
  SET_VECTOR_ELT(state, 708, ScalarReal(main_model_p->ART_eligible_CD4_200_349));
  SET_VECTOR_ELT(state, 710, ScalarReal(main_model_p->ART_eligible_CD4_below_200));
  SET_VECTOR_ELT(state, 716, ScalarReal(main_model_p->epsilon));
  SET_VECTOR_ELT(state, 724, ScalarInteger(main_model_p->dim));
  SET_VECTOR_ELT(state, 725, ScalarInteger(main_model_p->dim_output));
  SEXP state_names = PROTECT(allocVector(STRSXP, 726));
  ...
  SET_STRING_ELT(state_names, 64, mkChar("Ncat"));
  SET_STRING_ELT(state_names, 65, mkChar("Nage"));
  SET_STRING_ELT(state_names, 66, mkChar("infect_acute"));
  SET_STRING_ELT(state_names, 67, mkChar("infect_AIDS"));
  SET_STRING_ELT(state_names, 68, mkChar("nu"));
  SET_STRING_ELT(state_names, 69, mkChar("R"));
  SET_STRING_ELT(state_names, 70, mkChar("dim_epsilon_t"));
  SET_STRING_ELT(state_names, 71, mkChar("epsilon_t"));
  SET_STRING_ELT(state_names, 72, mkChar("dim_epsilon_y"));
  SET_STRING_ELT(state_names, 73, mkChar("epsilon_y"));
  SET_STRING_ELT(state_names, 74, mkChar("dim_fc_t_comm"));
  SET_STRING_ELT(state_names, 75, mkChar("fc_t_comm"));
  SET_STRING_ELT(state_names, 76, mkChar("dim_fc_y_comm"));
  SET_STRING_ELT(state_names, 77, mkChar("dim_fc_y_comm_1"));
  SET_STRING_ELT(state_names, 78, mkChar("dim_fc_y_comm_2"));
  SET_STRING_ELT(state_names, 79, mkChar("dim_fc_y_comm_3"));
  SET_STRING_ELT(state_names, 80, mkChar("dim_fc_y_comm_12"));
  SET_STRING_ELT(state_names, 81, mkChar("fc_y_comm"));
  SET_STRING_ELT(state_names, 82, mkChar("dim_fP_t_comm"));
  SET_STRING_ELT(state_names, 83, mkChar("fP_t_comm"));
  SET_STRING_ELT(state_names, 84, mkChar("dim_fP_y_comm"));
  SET_STRING_ELT(state_names, 85, mkChar("dim_fP_y_comm_1"));
  SET_STRING_ELT(state_names, 86, mkChar("dim_fP_y_comm_2"));
  SET_STRING_ELT(state_names, 87, mkChar("fP_y_comm"));
  SET_STRING_ELT(state_names, 88, mkChar("dim_fc_t_noncomm"));
  SET_STRING_ELT(state_names, 89, mkChar("fc_t_noncomm"));
  SET_STRING_ELT(state_names, 90, mkChar("dim_fc_y_noncomm"));
  SET_STRING_ELT(state_names, 91, mkChar("dim_fc_y_noncomm_1"));
  SET_STRING_ELT(state_names, 92, mkChar("dim_fc_y_noncomm_2"));
  SET_STRING_ELT(state_names, 93, mkChar("dim_fc_y_noncomm_3"));
  SET_STRING_ELT(state_names, 94, mkChar("dim_fc_y_noncomm_12"));
  SET_STRING_ELT(state_names, 95, mkChar("fc_y_noncomm"));
  SET_STRING_ELT(state_names, 96, mkChar("dim_fP_t_noncomm"));
  SET_STRING_ELT(state_names, 97, mkChar("fP_t_noncomm"));
  SET_STRING_ELT(state_names, 98, mkChar("dim_fP_y_noncomm"));
  SET_STRING_ELT(state_names, 99, mkChar("dim_fP_y_noncomm_1"));
  SET_STRING_ELT(state_names, 100, mkChar("dim_fP_y_noncomm_2"));
  SET_STRING_ELT(state_names, 101, mkChar("fP_y_noncomm"));
  SET_STRING_ELT(state_names, 102, mkChar("dim_n_t_comm"));
  SET_STRING_ELT(state_names, 103, mkChar("n_t_comm"));
  SET_STRING_ELT(state_names, 104, mkChar("dim_n_y_comm"));
  SET_STRING_ELT(state_names, 105, mkChar("dim_n_y_comm_1"));
  SET_STRING_ELT(state_names, 106, mkChar("dim_n_y_comm_2"));
  SET_STRING_ELT(state_names, 107, mkChar("dim_n_y_comm_3"));
  SET_STRING_ELT(state_names, 108, mkChar("dim_n_y_comm_12"));
  SET_STRING_ELT(state_names, 109, mkChar("n_y_comm"));
  SET_STRING_ELT(state_names, 110, mkChar("dim_n_t_noncomm"));
  SET_STRING_ELT(state_names, 111, mkChar("n_t_noncomm"));
  SET_STRING_ELT(state_names, 112, mkChar("dim_n_y_noncomm"));
  SET_STRING_ELT(state_names, 113, mkChar("dim_n_y_noncomm_1"));
  SET_STRING_ELT(state_names, 114, mkChar("dim_n_y_noncomm_2"));
  SET_STRING_ELT(state_names, 115, mkChar("dim_n_y_noncomm_3"));
  SET_STRING_ELT(state_names, 116, mkChar("dim_n_y_noncomm_12"));
  SET_STRING_ELT(state_names, 117, mkChar("n_y_noncomm"));
  SET_STRING_ELT(state_names, 118, mkChar("dur_FSW"));
  SET_STRING_ELT(state_names, 119, mkChar("dim_prep_intervention_t"));
  SET_STRING_ELT(state_names, 120, mkChar("prep_intervention_t"));
  SET_STRING_ELT(state_names, 121, mkChar("dim_prep_intervention_y"));
  SET_STRING_ELT(state_names, 122, mkChar("dim_prep_intervention_y_1"));
  SET_STRING_ELT(state_names, 123, mkChar("dim_prep_intervention_y_2"));
  SET_STRING_ELT(state_names, 124, mkChar("prep_intervention_y"));
  SET_STRING_ELT(state_names, 125, mkChar("dim_c_comm"));
  SET_STRING_ELT(state_names, 126, mkChar("c_comm"));
  SET_STRING_ELT(state_names, 127, mkChar("offset_output_c_comm"));
  SET_STRING_ELT(state_names, 128, mkChar("dim_c_noncomm"));
  SET_STRING_ELT(state_names, 129, mkChar("c_noncomm"));
  SET_STRING_ELT(state_names, 130, mkChar("offset_output_c_noncomm"));
  SET_STRING_ELT(state_names, 131, mkChar("dim_FSW_ONLY"));
  SET_STRING_ELT(state_names, 132, mkChar("FSW_ONLY"));
  SET_STRING_ELT(state_names, 133, mkChar("dim_new_people_in_group"));
  SET_STRING_ELT(state_names, 134, mkChar("new_people_in_group"));
  SET_STRING_ELT(state_names, 135, mkChar("offset_output_new_people_in_group"));
  SET_STRING_ELT(state_names, 136, mkChar("dim_new_people_in_group_FSW_only"));
  SET_STRING_ELT(state_names, 137, mkChar("new_people_in_group_FSW_only"));
  SET_STRING_ELT(state_names, 138, mkChar("offset_output_new_people_in_group_FSW_only"));
  SET_STRING_ELT(state_names, 139, mkChar("dim_comm_partnerships_requested"));
  SET_STRING_ELT(state_names, 140, mkChar("dim_comm_partnerships_requested_1"));
  SET_STRING_ELT(state_names, 141, mkChar("dim_comm_partnerships_requested_2"));
  SET_STRING_ELT(state_names, 142, mkChar("comm_partnerships_requested"));
  SET_STRING_ELT(state_names, 143, mkChar("dim_noncomm_partnerships_requested"));
  SET_STRING_ELT(state_names, 144, mkChar("dim_noncomm_partnerships_requested_1"));
  SET_STRING_ELT(state_names, 145, mkChar("dim_noncomm_partnerships_requested_2"));
  SET_STRING_ELT(state_names, 146, mkChar("noncomm_partnerships_requested"));
  SET_STRING_ELT(state_names, 147, mkChar("dim_testing_prob"));
  SET_STRING_ELT(state_names, 148, mkChar("testing_prob"));
  SET_STRING_ELT(state_names, 149, mkChar("offset_output_testing_prob"));
  SET_STRING_ELT(state_names, 150, mkChar("dim_tau_intervention"));
  SET_STRING_ELT(state_names, 151, mkChar("tau_intervention"));
  SET_STRING_ELT(state_names, 152, mkChar("offset_output_tau_intervention"));
  SET_STRING_ELT(state_names, 153, mkChar("dim_rho_intervention"));
  SET_STRING_ELT(state_names, 154, mkChar("rho_intervention"));
  SET_STRING_ELT(state_names, 155, mkChar("offset_output_rho_intervention"));
  SET_STRING_ELT(state_names, 156, mkChar("dim_zeta"));
  SET_STRING_ELT(state_names, 157, mkChar("zeta"));
  SET_STRING_ELT(state_names, 158, mkChar("offset_output_zeta"));
  SET_STRING_ELT(state_names, 159, mkChar("dim_sigma"));
  SET_STRING_ELT(state_names, 160, mkChar("sigma"));
  SET_STRING_ELT(state_names, 161, mkChar("dim_tau"));
  SET_STRING_ELT(state_names, 162, mkChar("tau"));
  SET_STRING_ELT(state_names, 163, mkChar("offset_output_tau"));
  SET_STRING_ELT(state_names, 164, mkChar("dim_test_rate_prep"));
  SET_STRING_ELT(state_names, 165, mkChar("test_rate_prep"));
  SET_STRING_ELT(state_names, 166, mkChar("dim_rho"));
  SET_STRING_ELT(state_names, 167, mkChar("rho"));
  SET_STRING_ELT(state_names, 168, mkChar("offset_output_rho"));
  SET_STRING_ELT(state_names, 169, mkChar("dim_iota"));
  SET_STRING_ELT(state_names, 170, mkChar("iota"));
  SET_STRING_ELT(state_names, 171, mkChar("offset_output_iota"));
  SET_STRING_ELT(state_names, 172, mkChar("dim_S0_infections"));
  SET_STRING_ELT(state_names, 173, mkChar("initial_S0_infections"));
  SET_STRING_ELT(state_names, 174, mkChar("offset_S0_infections"));
  SET_STRING_ELT(state_names, 175, mkChar("dim_S1a_infections"));
  SET_STRING_ELT(state_names, 176, mkChar("initial_S1a_infections"));
  SET_STRING_ELT(state_names, 177, mkChar("offset_S1a_infections"));
  SET_STRING_ELT(state_names, 178, mkChar("dim_S1b_infections"));
  SET_STRING_ELT(state_names, 179, mkChar("initial_S1b_infections"));
  SET_STRING_ELT(state_names, 180, mkChar("offset_S1b_infections"));
  SET_STRING_ELT(state_names, 181, mkChar("dim_S1c_infections"));
  SET_STRING_ELT(state_names, 182, mkChar("initial_S1c_infections"));
  SET_STRING_ELT(state_names, 183, mkChar("offset_S1c_infections"));
  SET_STRING_ELT(state_names, 184, mkChar("dim_S1d_infections"));
  SET_STRING_ELT(state_names, 185, mkChar("initial_S1d_infections"));
  SET_STRING_ELT(state_names, 186, mkChar("offset_S1d_infections"));
  SET_STRING_ELT(state_names, 187, mkChar("dim_frac_F"));
  SET_STRING_ELT(state_names, 188, mkChar("frac_F"));
  SET_STRING_ELT(state_names, 189, mkChar("offset_output_frac_F"));
  SET_STRING_ELT(state_names, 190, mkChar("dim_frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 191, mkChar("frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 192, mkChar("offset_output_frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 193, mkChar("dim_ART_coverage"));
  SET_STRING_ELT(state_names, 194, mkChar("ART_coverage"));
  SET_STRING_ELT(state_names, 195, mkChar("offset_output_ART_coverage"));
  SET_STRING_ELT(state_names, 196, mkChar("dim_infect_ART"));
  SET_STRING_ELT(state_names, 197, mkChar("infect_ART"));
  SET_STRING_ELT(state_names, 198, mkChar("offset_output_infect_ART"));
  SET_STRING_ELT(state_names, 199, mkChar("dim_prep_offered"));
  SET_STRING_ELT(state_names, 200, mkChar("prep_offered"));
  SET_STRING_ELT(state_names, 201, mkChar("dim_omega"));
  SET_STRING_ELT(state_names, 202, mkChar("omega"));
  SET_STRING_ELT(state_names, 203, mkChar("offset_output_omega"));
  SET_STRING_ELT(state_names, 204, mkChar("dim_frac_N"));
  SET_STRING_ELT(state_names, 205, mkChar("frac_N"));
  SET_STRING_ELT(state_names, 206, mkChar("offset_output_frac_N"));
  SET_STRING_ELT(state_names, 207, mkChar("dim_mu"));
  SET_STRING_ELT(state_names, 208, mkChar("mu"));
  SET_STRING_ELT(state_names, 209, mkChar("offset_output_mu"));
  SET_STRING_ELT(state_names, 210, mkChar("dim_gamma01"));
  SET_STRING_ELT(state_names, 211, mkChar("gamma01"));
  SET_STRING_ELT(state_names, 212, mkChar("offset_output_gamma01"));
  SET_STRING_ELT(state_names, 213, mkChar("dim_gamma02"));
  SET_STRING_ELT(state_names, 214, mkChar("gamma02"));
  SET_STRING_ELT(state_names, 215, mkChar("dim_gamma03"));
  SET_STRING_ELT(state_names, 216, mkChar("gamma03"));
  SET_STRING_ELT(state_names, 217, mkChar("dim_gamma04"));
  SET_STRING_ELT(state_names, 218, mkChar("gamma04"));
  SET_STRING_ELT(state_names, 219, mkChar("dim_gamma11"));
  SET_STRING_ELT(state_names, 220, mkChar("gamma11"));
  SET_STRING_ELT(state_names, 221, mkChar("offset_output_gamma11"));
  SET_STRING_ELT(state_names, 222, mkChar("dim_gamma22"));
  SET_STRING_ELT(state_names, 223, mkChar("gamma22"));
  SET_STRING_ELT(state_names, 224, mkChar("dim_gamma23"));
  SET_STRING_ELT(state_names, 225, mkChar("gamma23"));
  SET_STRING_ELT(state_names, 226, mkChar("dim_gamma24"));
  SET_STRING_ELT(state_names, 227, mkChar("gamma24"));
  SET_STRING_ELT(state_names, 228, mkChar("dim_gamma32"));
  SET_STRING_ELT(state_names, 229, mkChar("gamma32"));
  SET_STRING_ELT(state_names, 230, mkChar("dim_gamma33"));
  SET_STRING_ELT(state_names, 231, mkChar("gamma33"));
  SET_STRING_ELT(state_names, 232, mkChar("dim_gamma34"));
  SET_STRING_ELT(state_names, 233, mkChar("gamma34"));
  SET_STRING_ELT(state_names, 234, mkChar("dim_gamma42"));
  SET_STRING_ELT(state_names, 235, mkChar("gamma42"));
  SET_STRING_ELT(state_names, 236, mkChar("dim_gamma43"));
  SET_STRING_ELT(state_names, 237, mkChar("gamma43"));
  SET_STRING_ELT(state_names, 238, mkChar("dim_gamma44"));
  SET_STRING_ELT(state_names, 239, mkChar("gamma44"));
  SET_STRING_ELT(state_names, 240, mkChar("dim_phi2"));
  SET_STRING_ELT(state_names, 241, mkChar("phi2"));
  SET_STRING_ELT(state_names, 242, mkChar("dim_phi3"));
  SET_STRING_ELT(state_names, 243, mkChar("phi3"));
  SET_STRING_ELT(state_names, 244, mkChar("dim_phi4"));
  SET_STRING_ELT(state_names, 245, mkChar("phi4"));
  SET_STRING_ELT(state_names, 246, mkChar("dim_phi5"));
  SET_STRING_ELT(state_names, 247, mkChar("phi5"));
  SET_STRING_ELT(state_names, 248, mkChar("dim_psia"));
  SET_STRING_ELT(state_names, 249, mkChar("psia"));
  SET_STRING_ELT(state_names, 250, mkChar("dim_psib"));
  SET_STRING_ELT(state_names, 251, mkChar("psib"));
  SET_STRING_ELT(state_names, 252, mkChar("dim_kappaa"));
  SET_STRING_ELT(state_names, 253, mkChar("kappaa"));
  SET_STRING_ELT(state_names, 254, mkChar("offset_output_kappaa"));
  SET_STRING_ELT(state_names, 255, mkChar("dim_kappab"));
  SET_STRING_ELT(state_names, 256, mkChar("kappab"));
  SET_STRING_ELT(state_names, 257, mkChar("offset_output_kappab"));
  SET_STRING_ELT(state_names, 258, mkChar("dim_kappac"));
  SET_STRING_ELT(state_names, 259, mkChar("kappac"));
  SET_STRING_ELT(state_names, 260, mkChar("offset_output_kappac"));
  SET_STRING_ELT(state_names, 261, mkChar("dim_kappa1"));
  SET_STRING_ELT(state_names, 262, mkChar("kappa1"));
  SET_STRING_ELT(state_names, 263, mkChar("offset_output_kappa1"));
  SET_STRING_ELT(state_names, 264, mkChar("dim_alpha01"));
  SET_STRING_ELT(state_names, 265, mkChar("alpha01"));
  SET_STRING_ELT(state_names, 266, mkChar("offset_output_alpha01"));
  SET_STRING_ELT(state_names, 267, mkChar("dim_alpha02"));
  SET_STRING_ELT(state_names, 268, mkChar("alpha02"));
  SET_STRING_ELT(state_names, 269, mkChar("offset_output_alpha02"));
  SET_STRING_ELT(state_names, 270, mkChar("dim_alpha03"));
  SET_STRING_ELT(state_names, 271, mkChar("alpha03"));
  SET_STRING_ELT(state_names, 272, mkChar("dim_alpha04"));
  SET_STRING_ELT(state_names, 273, mkChar("alpha04"));
  SET_STRING_ELT(state_names, 274, mkChar("dim_alpha05"));
  SET_STRING_ELT(state_names, 275, mkChar("alpha05"));
  SET_STRING_ELT(state_names, 276, mkChar("offset_output_alpha05"));
  SET_STRING_ELT(state_names, 277, mkChar("dim_alpha11"));
  SET_STRING_ELT(state_names, 278, mkChar("alpha11"));
  SET_STRING_ELT(state_names, 279, mkChar("offset_output_alpha11"));
  SET_STRING_ELT(state_names, 280, mkChar("dim_alpha22"));
  SET_STRING_ELT(state_names, 281, mkChar("alpha22"));
  SET_STRING_ELT(state_names, 282, mkChar("offset_output_alpha22"));
  SET_STRING_ELT(state_names, 283, mkChar("dim_alpha23"));
  SET_STRING_ELT(state_names, 284, mkChar("alpha23"));
  SET_STRING_ELT(state_names, 285, mkChar("dim_alpha24"));
  SET_STRING_ELT(state_names, 286, mkChar("alpha24"));
  SET_STRING_ELT(state_names, 287, mkChar("dim_alpha25"));
  SET_STRING_ELT(state_names, 288, mkChar("alpha25"));
  SET_STRING_ELT(state_names, 289, mkChar("dim_alpha32"));
  SET_STRING_ELT(state_names, 290, mkChar("alpha32"));
  SET_STRING_ELT(state_names, 291, mkChar("dim_alpha33"));
  SET_STRING_ELT(state_names, 292, mkChar("alpha33"));
  SET_STRING_ELT(state_names, 293, mkChar("dim_alpha34"));
  SET_STRING_ELT(state_names, 294, mkChar("alpha34"));
  SET_STRING_ELT(state_names, 295, mkChar("dim_alpha35"));
  SET_STRING_ELT(state_names, 296, mkChar("alpha35"));
  SET_STRING_ELT(state_names, 297, mkChar("offset_output_alpha35"));
  SET_STRING_ELT(state_names, 298, mkChar("dim_alpha42"));
  SET_STRING_ELT(state_names, 299, mkChar("alpha42"));
  SET_STRING_ELT(state_names, 300, mkChar("dim_alpha43"));
  SET_STRING_ELT(state_names, 301, mkChar("alpha43"));
  SET_STRING_ELT(state_names, 302, mkChar("dim_alpha44"));
  SET_STRING_ELT(state_names, 303, mkChar("alpha44"));
  SET_STRING_ELT(state_names, 304, mkChar("dim_alpha45"));
  SET_STRING_ELT(state_names, 305, mkChar("alpha45"));
  SET_STRING_ELT(state_names, 306, mkChar("dim_beta_comm"));
  SET_STRING_ELT(state_names, 307, mkChar("beta_comm"));
  SET_STRING_ELT(state_names, 308, mkChar("offset_output_beta_comm"));
  SET_STRING_ELT(state_names, 309, mkChar("dim_beta_noncomm"));
  SET_STRING_ELT(state_names, 310, mkChar("beta_noncomm"));
  SET_STRING_ELT(state_names, 311, mkChar("offset_output_beta_noncomm"));
  SET_STRING_ELT(state_names, 312, mkChar("dim_p_comm"));
  SET_STRING_ELT(state_names, 313, mkChar("dim_p_comm_1"));
  SET_STRING_ELT(state_names, 314, mkChar("dim_p_comm_2"));
  SET_STRING_ELT(state_names, 315, mkChar("p_comm"));
  SET_STRING_ELT(state_names, 316, mkChar("offset_output_p_comm"));
  SET_STRING_ELT(state_names, 317, mkChar("dim_p_noncomm"));
  SET_STRING_ELT(state_names, 318, mkChar("dim_p_noncomm_1"));
  SET_STRING_ELT(state_names, 319, mkChar("dim_p_noncomm_2"));
  SET_STRING_ELT(state_names, 320, mkChar("p_noncomm"));
  SET_STRING_ELT(state_names, 321, mkChar("offset_output_p_noncomm"));
  SET_STRING_ELT(state_names, 322, mkChar("dim_ec"));
  SET_STRING_ELT(state_names, 323, mkChar("ec"));
  SET_STRING_ELT(state_names, 324, mkChar("dim_eP"));
  SET_STRING_ELT(state_names, 325, mkChar("eP"));
  SET_STRING_ELT(state_names, 326, mkChar("dim_eP0"));
  SET_STRING_ELT(state_names, 327, mkChar("eP0"));
  SET_STRING_ELT(state_names, 328, mkChar("dim_eP1a"));
  SET_STRING_ELT(state_names, 329, mkChar("eP1a"));
  SET_STRING_ELT(state_names, 330, mkChar("dim_eP1b"));
  SET_STRING_ELT(state_names, 331, mkChar("eP1b"));
  SET_STRING_ELT(state_names, 332, mkChar("dim_eP1c"));
  SET_STRING_ELT(state_names, 333, mkChar("eP1c"));
  SET_STRING_ELT(state_names, 334, mkChar("dim_eP1d"));
  SET_STRING_ELT(state_names, 335, mkChar("eP1d"));
  SET_STRING_ELT(state_names, 336, mkChar("dim_fc_comm"));
  SET_STRING_ELT(state_names, 337, mkChar("dim_fc_comm_1"));
  SET_STRING_ELT(state_names, 338, mkChar("dim_fc_comm_2"));
  SET_STRING_ELT(state_names, 339, mkChar("fc_comm"));
  SET_STRING_ELT(state_names, 340, mkChar("offset_output_fc_comm"));
  SET_STRING_ELT(state_names, 341, mkChar("dim_fP_comm"));
  SET_STRING_ELT(state_names, 342, mkChar("fP_comm"));
  SET_STRING_ELT(state_names, 343, mkChar("offset_output_fP_comm"));
  SET_STRING_ELT(state_names, 344, mkChar("dim_fc_noncomm"));
  SET_STRING_ELT(state_names, 345, mkChar("dim_fc_noncomm_1"));
  SET_STRING_ELT(state_names, 346, mkChar("dim_fc_noncomm_2"));
  SET_STRING_ELT(state_names, 347, mkChar("fc_noncomm"));
  SET_STRING_ELT(state_names, 348, mkChar("offset_output_fc_noncomm"));
  SET_STRING_ELT(state_names, 349, mkChar("dim_fP_noncomm"));
  SET_STRING_ELT(state_names, 350, mkChar("fP_noncomm"));
  SET_STRING_ELT(state_names, 351, mkChar("offset_output_fP_noncomm"));
  SET_STRING_ELT(state_names, 352, mkChar("dim_n_comm"));
  SET_STRING_ELT(state_names, 353, mkChar("dim_n_comm_1"));
  SET_STRING_ELT(state_names, 354, mkChar("dim_n_comm_2"));
  SET_STRING_ELT(state_names, 355, mkChar("n_comm"));
  SET_STRING_ELT(state_names, 356, mkChar("offset_output_n_comm"));
  SET_STRING_ELT(state_names, 357, mkChar("dim_n_noncomm"));
  SET_STRING_ELT(state_names, 358, mkChar("dim_n_noncomm_1"));
  SET_STRING_ELT(state_names, 359, mkChar("dim_n_noncomm_2"));
  SET_STRING_ELT(state_names, 360, mkChar("n_noncomm"));
  SET_STRING_ELT(state_names, 361, mkChar("offset_output_n_noncomm"));
  SET_STRING_ELT(state_names, 362, mkChar("dim_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 363, mkChar("initial_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 364, mkChar("offset_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 365, mkChar("dim_cumuARTinitiations"));
  SET_STRING_ELT(state_names, 366, mkChar("initial_cumuARTinitiations"));
  SET_STRING_ELT(state_names, 367, mkChar("offset_cumuARTinitiations"));
  SET_STRING_ELT(state_names, 368, mkChar("dim_cumuARTREinitiations"));
  SET_STRING_ELT(state_names, 369, mkChar("initial_cumuARTREinitiations"));
  SET_STRING_ELT(state_names, 370, mkChar("offset_cumuARTREinitiations"));
  SET_STRING_ELT(state_names, 371, mkChar("dim_dropouts"));
  SET_STRING_ELT(state_names, 372, mkChar("initial_dropouts"));
  SET_STRING_ELT(state_names, 373, mkChar("offset_dropouts"));
  SET_STRING_ELT(state_names, 374, mkChar("dim_cumuAllDeaths"));
  SET_STRING_ELT(state_names, 375, mkChar("initial_cumuAllDeaths"));
  SET_STRING_ELT(state_names, 376, mkChar("offset_cumuAllDeaths"));
  SET_STRING_ELT(state_names, 377, mkChar("dim_cumuInf"));
  SET_STRING_ELT(state_names, 378, mkChar("initial_cumuInf"));
  SET_STRING_ELT(state_names, 379, mkChar("offset_cumuInf"));
  SET_STRING_ELT(state_names, 380, mkChar("dim_OnPrEP"));
  SET_STRING_ELT(state_names, 381, mkChar("initial_OnPrEP"));
  SET_STRING_ELT(state_names, 382, mkChar("offset_OnPrEP"));
  SET_STRING_ELT(state_names, 383, mkChar("dim_OnPrEP1a"));
  SET_STRING_ELT(state_names, 384, mkChar("initial_OnPrEP1a"));
  SET_STRING_ELT(state_names, 385, mkChar("offset_OnPrEP1a"));
  SET_STRING_ELT(state_names, 386, mkChar("dim_OnPrEP1b"));
  SET_STRING_ELT(state_names, 387, mkChar("initial_OnPrEP1b"));
  SET_STRING_ELT(state_names, 388, mkChar("offset_OnPrEP1b"));
  SET_STRING_ELT(state_names, 389, mkChar("dim_OnPrEP1c"));
  SET_STRING_ELT(state_names, 390, mkChar("initial_OnPrEP1c"));
  SET_STRING_ELT(state_names, 391, mkChar("offset_OnPrEP1c"));
  SET_STRING_ELT(state_names, 392, mkChar("dim_S0"));
  SET_STRING_ELT(state_names, 393, mkChar("initial_S0"));
  SET_STRING_ELT(state_names, 394, mkChar("offset_S0"));
  SET_STRING_ELT(state_names, 395, mkChar("dim_S1a"));
  SET_STRING_ELT(state_names, 396, mkChar("initial_S1a"));
  SET_STRING_ELT(state_names, 397, mkChar("offset_S1a"));
  SET_STRING_ELT(state_names, 398, mkChar("dim_S1b"));
  SET_STRING_ELT(state_names, 399, mkChar("initial_S1b"));
  SET_STRING_ELT(state_names, 400, mkChar("offset_S1b"));
  SET_STRING_ELT(state_names, 401, mkChar("dim_S1c"));
  SET_STRING_ELT(state_names, 402, mkChar("initial_S1c"));
  SET_STRING_ELT(state_names, 403, mkChar("offset_S1c"));
  SET_STRING_ELT(state_names, 404, mkChar("dim_S1d"));
  SET_STRING_ELT(state_names, 405, mkChar("initial_S1d"));
  SET_STRING_ELT(state_names, 406, mkChar("offset_S1d"));
  SET_STRING_ELT(state_names, 407, mkChar("dim_I01"));
  SET_STRING_ELT(state_names, 408, mkChar("initial_I01"));
  SET_STRING_ELT(state_names, 409, mkChar("offset_I01"));
  SET_STRING_ELT(state_names, 410, mkChar("dim_I11"));
  SET_STRING_ELT(state_names, 411, mkChar("initial_I11"));
  SET_STRING_ELT(state_names, 412, mkChar("offset_I11"));
  SET_STRING_ELT(state_names, 413, mkChar("dim_I02"));
  SET_STRING_ELT(state_names, 414, mkChar("initial_I02"));
  SET_STRING_ELT(state_names, 415, mkChar("offset_I02"));
  SET_STRING_ELT(state_names, 416, mkChar("dim_I03"));
  SET_STRING_ELT(state_names, 417, mkChar("initial_I03"));
  SET_STRING_ELT(state_names, 418, mkChar("offset_I03"));
  SET_STRING_ELT(state_names, 419, mkChar("dim_I04"));
  SET_STRING_ELT(state_names, 420, mkChar("initial_I04"));
  SET_STRING_ELT(state_names, 421, mkChar("offset_I04"));
  SET_STRING_ELT(state_names, 422, mkChar("dim_I05"));
  SET_STRING_ELT(state_names, 423, mkChar("initial_I05"));
  SET_STRING_ELT(state_names, 424, mkChar("offset_I05"));
  SET_STRING_ELT(state_names, 425, mkChar("dim_I22"));
  SET_STRING_ELT(state_names, 426, mkChar("initial_I22"));
  SET_STRING_ELT(state_names, 427, mkChar("offset_I22"));
  SET_STRING_ELT(state_names, 428, mkChar("dim_I23"));
  SET_STRING_ELT(state_names, 429, mkChar("initial_I23"));
  SET_STRING_ELT(state_names, 430, mkChar("offset_I23"));
  SET_STRING_ELT(state_names, 431, mkChar("dim_I24"));
  SET_STRING_ELT(state_names, 432, mkChar("initial_I24"));
  SET_STRING_ELT(state_names, 433, mkChar("offset_I24"));
  SET_STRING_ELT(state_names, 434, mkChar("dim_I25"));
  SET_STRING_ELT(state_names, 435, mkChar("initial_I25"));
  SET_STRING_ELT(state_names, 436, mkChar("offset_I25"));
  SET_STRING_ELT(state_names, 437, mkChar("dim_I32"));
  SET_STRING_ELT(state_names, 438, mkChar("initial_I32"));
  SET_STRING_ELT(state_names, 439, mkChar("offset_I32"));
  SET_STRING_ELT(state_names, 440, mkChar("dim_I33"));
  SET_STRING_ELT(state_names, 441, mkChar("initial_I33"));
  SET_STRING_ELT(state_names, 442, mkChar("offset_I33"));
  SET_STRING_ELT(state_names, 443, mkChar("dim_I34"));
  SET_STRING_ELT(state_names, 444, mkChar("initial_I34"));
  SET_STRING_ELT(state_names, 445, mkChar("offset_I34"));
  SET_STRING_ELT(state_names, 446, mkChar("dim_I35"));
  SET_STRING_ELT(state_names, 447, mkChar("initial_I35"));
  SET_STRING_ELT(state_names, 448, mkChar("offset_I35"));
  SET_STRING_ELT(state_names, 449, mkChar("dim_I42"));
  SET_STRING_ELT(state_names, 450, mkChar("initial_I42"));
  SET_STRING_ELT(state_names, 451, mkChar("offset_I42"));
  SET_STRING_ELT(state_names, 452, mkChar("dim_I43"));
  SET_STRING_ELT(state_names, 453, mkChar("initial_I43"));
  SET_STRING_ELT(state_names, 454, mkChar("offset_I43"));
  SET_STRING_ELT(state_names, 455, mkChar("dim_I44"));
  SET_STRING_ELT(state_names, 456, mkChar("initial_I44"));
  SET_STRING_ELT(state_names, 457, mkChar("offset_I44"));
  SET_STRING_ELT(state_names, 458, mkChar("dim_I45"));
  SET_STRING_ELT(state_names, 459, mkChar("initial_I45"));
  SET_STRING_ELT(state_names, 460, mkChar("offset_I45"));
  SET_STRING_ELT(state_names, 461, mkChar("dim_S0_init"));
  SET_STRING_ELT(state_names, 462, mkChar("S0_init"));
  SET_STRING_ELT(state_names, 463, mkChar("dim_S1a_init"));
  SET_STRING_ELT(state_names, 464, mkChar("S1a_init"));
  SET_STRING_ELT(state_names, 465, mkChar("dim_S1b_init"));
  SET_STRING_ELT(state_names, 466, mkChar("S1b_init"));
  SET_STRING_ELT(state_names, 467, mkChar("dim_S1c_init"));
  SET_STRING_ELT(state_names, 468, mkChar("S1c_init"));
  SET_STRING_ELT(state_names, 469, mkChar("dim_S1d_init"));
  SET_STRING_ELT(state_names, 470, mkChar("S1d_init"));
  SET_STRING_ELT(state_names, 471, mkChar("dim_I01_init"));
  SET_STRING_ELT(state_names, 472, mkChar("I01_init"));
  SET_STRING_ELT(state_names, 473, mkChar("dim_I11_init"));
  SET_STRING_ELT(state_names, 474, mkChar("I11_init"));
  SET_STRING_ELT(state_names, 475, mkChar("dim_I02_init"));
  SET_STRING_ELT(state_names, 476, mkChar("I02_init"));
  SET_STRING_ELT(state_names, 477, mkChar("dim_I03_init"));
  SET_STRING_ELT(state_names, 478, mkChar("I03_init"));
  SET_STRING_ELT(state_names, 479, mkChar("dim_I04_init"));
  SET_STRING_ELT(state_names, 480, mkChar("I04_init"));
  SET_STRING_ELT(state_names, 481, mkChar("dim_I05_init"));
  SET_STRING_ELT(state_names, 482, mkChar("I05_init"));
  SET_STRING_ELT(state_names, 483, mkChar("dim_I22_init"));
  SET_STRING_ELT(state_names, 484, mkChar("I22_init"));
  SET_STRING_ELT(state_names, 485, mkChar("dim_I23_init"));
  SET_STRING_ELT(state_names, 486, mkChar("I23_init"));
  SET_STRING_ELT(state_names, 487, mkChar("dim_I24_init"));
  SET_STRING_ELT(state_names, 488, mkChar("I24_init"));
  SET_STRING_ELT(state_names, 489, mkChar("dim_I25_init"));
  SET_STRING_ELT(state_names, 490, mkChar("I25_init"));
  SET_STRING_ELT(state_names, 491, mkChar("dim_I32_init"));
  SET_STRING_ELT(state_names, 492, mkChar("I32_init"));
  SET_STRING_ELT(state_names, 493, mkChar("dim_I33_init"));
  SET_STRING_ELT(state_names, 494, mkChar("I33_init"));
  SET_STRING_ELT(state_names, 495, mkChar("dim_I34_init"));
  SET_STRING_ELT(state_names, 496, mkChar("I34_init"));
  SET_STRING_ELT(state_names, 497, mkChar("dim_I35_init"));
  SET_STRING_ELT(state_names, 498, mkChar("I35_init"));
  SET_STRING_ELT(state_names, 499, mkChar("dim_I42_init"));
  SET_STRING_ELT(state_names, 500, mkChar("I42_init"));
  SET_STRING_ELT(state_names, 501, mkChar("dim_I43_init"));
  SET_STRING_ELT(state_names, 502, mkChar("I43_init"));
  SET_STRING_ELT(state_names, 503, mkChar("dim_I44_init"));
  SET_STRING_ELT(state_names, 504, mkChar("I44_init"));
  SET_STRING_ELT(state_names, 505, mkChar("dim_I45_init"));
  SET_STRING_ELT(state_names, 506, mkChar("I45_init"));
  SET_STRING_ELT(state_names, 507, mkChar("dim_N"));
  SET_STRING_ELT(state_names, 508, mkChar("N"));
  SET_STRING_ELT(state_names, 509, mkChar("offset_output_N"));
  SET_STRING_ELT(state_names, 510, mkChar("dim_E0"));
  SET_STRING_ELT(state_names, 511, mkChar("E0"));
  SET_STRING_ELT(state_names, 512, mkChar("offset_output_E0"));
  SET_STRING_ELT(state_names, 513, mkChar("dim_E1a"));
  SET_STRING_ELT(state_names, 514, mkChar("E1a"));
  SET_STRING_ELT(state_names, 515, mkChar("offset_output_E1a"));
  SET_STRING_ELT(state_names, 516, mkChar("dim_E1b"));
  SET_STRING_ELT(state_names, 517, mkChar("E1b"));
  SET_STRING_ELT(state_names, 518, mkChar("offset_output_E1b"));
  SET_STRING_ELT(state_names, 519, mkChar("dim_E1c"));
  SET_STRING_ELT(state_names, 520, mkChar("E1c"));
  SET_STRING_ELT(state_names, 521, mkChar("offset_output_E1c"));
  SET_STRING_ELT(state_names, 522, mkChar("dim_E1d"));
  SET_STRING_ELT(state_names, 523, mkChar("E1d"));
  SET_STRING_ELT(state_names, 524, mkChar("offset_output_E1d"));
  SET_STRING_ELT(state_names, 525, mkChar("dim_cumuInf_init"));
  SET_STRING_ELT(state_names, 526, mkChar("cumuInf_init"));
  SET_STRING_ELT(state_names, 527, mkChar("dim_alphaItot"));
  SET_STRING_ELT(state_names, 528, mkChar("alphaItot"));
  SET_STRING_ELT(state_names, 529, mkChar("offset_output_alphaItot"));
  SET_STRING_ELT(state_names, 530, mkChar("dim_prev"));
  SET_STRING_ELT(state_names, 531, mkChar("prev"));
  SET_STRING_ELT(state_names, 532, mkChar("offset_output_prev"));
  SET_STRING_ELT(state_names, 533, mkChar("dim_lambda"));
  SET_STRING_ELT(state_names, 534, mkChar("dim_lambda_1"));
  SET_STRING_ELT(state_names, 535, mkChar("dim_lambda_2"));
  SET_STRING_ELT(state_names, 536, mkChar("lambda"));
  SET_STRING_ELT(state_names, 537, mkChar("offset_output_lambda"));
  SET_STRING_ELT(state_names, 538, mkChar("dim_lambda_0"));
  SET_STRING_ELT(state_names, 539, mkChar("dim_lambda_0_1"));
  SET_STRING_ELT(state_names, 540, mkChar("dim_lambda_0_2"));
  SET_STRING_ELT(state_names, 541, mkChar("lambda_0"));
  SET_STRING_ELT(state_names, 542, mkChar("offset_output_lambda_0"));
  SET_STRING_ELT(state_names, 543, mkChar("dim_lambda_1a"));
  SET_STRING_ELT(state_names, 544, mkChar("dim_lambda_1a_1"));
  SET_STRING_ELT(state_names, 545, mkChar("dim_lambda_1a_2"));
  SET_STRING_ELT(state_names, 546, mkChar("lambda_1a"));
  SET_STRING_ELT(state_names, 547, mkChar("offset_output_lambda_1a"));
  SET_STRING_ELT(state_names, 548, mkChar("dim_lambda_1b"));
  SET_STRING_ELT(state_names, 549, mkChar("dim_lambda_1b_1"));
  SET_STRING_ELT(state_names, 550, mkChar("dim_lambda_1b_2"));
  SET_STRING_ELT(state_names, 551, mkChar("lambda_1b"));
  SET_STRING_ELT(state_names, 552, mkChar("offset_output_lambda_1b"));
  SET_STRING_ELT(state_names, 553, mkChar("dim_lambda_1c"));
  SET_STRING_ELT(state_names, 554, mkChar("dim_lambda_1c_1"));
  SET_STRING_ELT(state_names, 555, mkChar("dim_lambda_1c_2"));
  SET_STRING_ELT(state_names, 556, mkChar("lambda_1c"));
  SET_STRING_ELT(state_names, 557, mkChar("offset_output_lambda_1c"));
  SET_STRING_ELT(state_names, 558, mkChar("dim_lambda_1d"));
  SET_STRING_ELT(state_names, 559, mkChar("dim_lambda_1d_1"));
  SET_STRING_ELT(state_names, 560, mkChar("dim_lambda_1d_2"));
  SET_STRING_ELT(state_names, 561, mkChar("lambda_1d"));
  SET_STRING_ELT(state_names, 562, mkChar("offset_output_lambda_1d"));
  SET_STRING_ELT(state_names, 563, mkChar("dim_lambda_sum_0"));
  SET_STRING_ELT(state_names, 564, mkChar("lambda_sum_0"));
  SET_STRING_ELT(state_names, 565, mkChar("offset_output_lambda_sum_0"));
  SET_STRING_ELT(state_names, 566, mkChar("dim_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 567, mkChar("lambda_sum_1a"));
  SET_STRING_ELT(state_names, 568, mkChar("offset_output_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 569, mkChar("dim_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 570, mkChar("lambda_sum_1b"));
  SET_STRING_ELT(state_names, 571, mkChar("offset_output_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 572, mkChar("dim_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 573, mkChar("lambda_sum_1c"));
  SET_STRING_ELT(state_names, 574, mkChar("offset_output_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 575, mkChar("dim_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 576, mkChar("lambda_sum_1d"));
  SET_STRING_ELT(state_names, 577, mkChar("offset_output_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 578, mkChar("dim_c_comm_balanced"));
  SET_STRING_ELT(state_names, 579, mkChar("c_comm_balanced"));
  SET_STRING_ELT(state_names, 580, mkChar("offset_output_c_comm_balanced"));
  SET_STRING_ELT(state_names, 581, mkChar("dim_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 582, mkChar("c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 583, mkChar("offset_output_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 584, mkChar("dim_theta"));
  SET_STRING_ELT(state_names, 585, mkChar("dim_theta_1"));
  SET_STRING_ELT(state_names, 586, mkChar("dim_theta_2"));
  SET_STRING_ELT(state_names, 587, mkChar("theta"));
  SET_STRING_ELT(state_names, 588, mkChar("offset_output_theta"));
  SET_STRING_ELT(state_names, 589, mkChar("dim_OnPrEP_init"));
  SET_STRING_ELT(state_names, 590, mkChar("OnPrEP_init"));
  SET_STRING_ELT(state_names, 591, mkChar("dim_M_comm"));
  SET_STRING_ELT(state_names, 592, mkChar("dim_M_comm_1"));
  SET_STRING_ELT(state_names, 593, mkChar("dim_M_comm_2"));
  SET_STRING_ELT(state_names, 594, mkChar("M_comm"));
  SET_STRING_ELT(state_names, 595, mkChar("offset_output_M_comm"));
  SET_STRING_ELT(state_names, 596, mkChar("dim_M_noncomm"));
  SET_STRING_ELT(state_names, 597, mkChar("dim_M_noncomm_1"));
  SET_STRING_ELT(state_names, 598, mkChar("dim_M_noncomm_2"));
  SET_STRING_ELT(state_names, 599, mkChar("M_noncomm"));
  SET_STRING_ELT(state_names, 600, mkChar("offset_output_M_noncomm"));
  SET_STRING_ELT(state_names, 601, mkChar("dim_in_S0"));
  SET_STRING_ELT(state_names, 602, mkChar("dim_in_S0_1"));
  SET_STRING_ELT(state_names, 603, mkChar("dim_in_S0_2"));
  SET_STRING_ELT(state_names, 604, mkChar("in_S0"));
  SET_STRING_ELT(state_names, 605, mkChar("dim_in_S1a"));
  SET_STRING_ELT(state_names, 606, mkChar("dim_in_S1a_1"));
  SET_STRING_ELT(state_names, 607, mkChar("dim_in_S1a_2"));
  SET_STRING_ELT(state_names, 608, mkChar("in_S1a"));
  SET_STRING_ELT(state_names, 609, mkChar("dim_in_S1b"));
  SET_STRING_ELT(state_names, 610, mkChar("dim_in_S1b_1"));
  SET_STRING_ELT(state_names, 611, mkChar("dim_in_S1b_2"));
  SET_STRING_ELT(state_names, 612, mkChar("in_S1b"));
  SET_STRING_ELT(state_names, 613, mkChar("dim_in_S1c"));
  SET_STRING_ELT(state_names, 614, mkChar("dim_in_S1c_1"));
  SET_STRING_ELT(state_names, 615, mkChar("dim_in_S1c_2"));
  SET_STRING_ELT(state_names, 616, mkChar("in_S1c"));
  SET_STRING_ELT(state_names, 617, mkChar("dim_in_S1d"));
  SET_STRING_ELT(state_names, 618, mkChar("dim_in_S1d_1"));
  SET_STRING_ELT(state_names, 619, mkChar("dim_in_S1d_2"));
  SET_STRING_ELT(state_names, 620, mkChar("in_S1d"));
  SET_STRING_ELT(state_names, 621, mkChar("dim_in_I01"));
  SET_STRING_ELT(state_names, 622, mkChar("dim_in_I01_1"));
  SET_STRING_ELT(state_names, 623, mkChar("dim_in_I01_2"));
  SET_STRING_ELT(state_names, 624, mkChar("in_I01"));
  SET_STRING_ELT(state_names, 625, mkChar("dim_in_I11"));
  SET_STRING_ELT(state_names, 626, mkChar("dim_in_I11_1"));
  SET_STRING_ELT(state_names, 627, mkChar("dim_in_I11_2"));
  SET_STRING_ELT(state_names, 628, mkChar("in_I11"));
  SET_STRING_ELT(state_names, 629, mkChar("dim_in_I02"));
  SET_STRING_ELT(state_names, 630, mkChar("dim_in_I02_1"));
  SET_STRING_ELT(state_names, 631, mkChar("dim_in_I02_2"));
  SET_STRING_ELT(state_names, 632, mkChar("in_I02"));
  SET_STRING_ELT(state_names, 633, mkChar("dim_in_I03"));
  SET_STRING_ELT(state_names, 634, mkChar("dim_in_I03_1"));
  SET_STRING_ELT(state_names, 635, mkChar("dim_in_I03_2"));
  SET_STRING_ELT(state_names, 636, mkChar("in_I03"));
  SET_STRING_ELT(state_names, 637, mkChar("dim_in_I04"));
  SET_STRING_ELT(state_names, 638, mkChar("dim_in_I04_1"));
  SET_STRING_ELT(state_names, 639, mkChar("dim_in_I04_2"));
  SET_STRING_ELT(state_names, 640, mkChar("in_I04"));
  SET_STRING_ELT(state_names, 641, mkChar("dim_in_I05"));
  SET_STRING_ELT(state_names, 642, mkChar("dim_in_I05_1"));
  SET_STRING_ELT(state_names, 643, mkChar("dim_in_I05_2"));
  SET_STRING_ELT(state_names, 644, mkChar("in_I05"));
  SET_STRING_ELT(state_names, 645, mkChar("dim_in_I22"));
  SET_STRING_ELT(state_names, 646, mkChar("dim_in_I22_1"));
  SET_STRING_ELT(state_names, 647, mkChar("dim_in_I22_2"));
  SET_STRING_ELT(state_names, 648, mkChar("in_I22"));
  SET_STRING_ELT(state_names, 649, mkChar("dim_in_I23"));
  SET_STRING_ELT(state_names, 650, mkChar("dim_in_I23_1"));
  SET_STRING_ELT(state_names, 651, mkChar("dim_in_I23_2"));
  SET_STRING_ELT(state_names, 652, mkChar("in_I23"));
  SET_STRING_ELT(state_names, 653, mkChar("dim_in_I24"));
  SET_STRING_ELT(state_names, 654, mkChar("dim_in_I24_1"));
  SET_STRING_ELT(state_names, 655, mkChar("dim_in_I24_2"));
  SET_STRING_ELT(state_names, 656, mkChar("in_I24"));
  SET_STRING_ELT(state_names, 657, mkChar("dim_in_I25"));
  SET_STRING_ELT(state_names, 658, mkChar("dim_in_I25_1"));
  SET_STRING_ELT(state_names, 659, mkChar("dim_in_I25_2"));
  SET_STRING_ELT(state_names, 660, mkChar("in_I25"));
  SET_STRING_ELT(state_names, 661, mkChar("dim_in_I32"));
  SET_STRING_ELT(state_names, 662, mkChar("dim_in_I32_1"));
  SET_STRING_ELT(state_names, 663, mkChar("dim_in_I32_2"));
  SET_STRING_ELT(state_names, 664, mkChar("in_I32"));
  SET_STRING_ELT(state_names, 665, mkChar("dim_in_I33"));
  SET_STRING_ELT(state_names, 666, mkChar("dim_in_I33_1"));
  SET_STRING_ELT(state_names, 667, mkChar("dim_in_I33_2"));
  SET_STRING_ELT(state_names, 668, mkChar("in_I33"));
  SET_STRING_ELT(state_names, 669, mkChar("dim_in_I34"));
  SET_STRING_ELT(state_names, 670, mkChar("dim_in_I34_1"));
  SET_STRING_ELT(state_names, 671, mkChar("dim_in_I34_2"));
  SET_STRING_ELT(state_names, 672, mkChar("in_I34"));
  SET_STRING_ELT(state_names, 673, mkChar("dim_in_I35"));
  SET_STRING_ELT(state_names, 674, mkChar("dim_in_I35_1"));
  SET_STRING_ELT(state_names, 675, mkChar("dim_in_I35_2"));
  SET_STRING_ELT(state_names, 676, mkChar("in_I35"));
  SET_STRING_ELT(state_names, 677, mkChar("dim_in_I42"));
  SET_STRING_ELT(state_names, 678, mkChar("dim_in_I42_1"));
  SET_STRING_ELT(state_names, 679, mkChar("dim_in_I42_2"));
  SET_STRING_ELT(state_names, 680, mkChar("in_I42"));
  SET_STRING_ELT(state_names, 681, mkChar("dim_in_I43"));
  SET_STRING_ELT(state_names, 682, mkChar("dim_in_I43_1"));
  SET_STRING_ELT(state_names, 683, mkChar("dim_in_I43_2"));
  SET_STRING_ELT(state_names, 684, mkChar("in_I43"));
  SET_STRING_ELT(state_names, 685, mkChar("dim_in_I44"));
  SET_STRING_ELT(state_names, 686, mkChar("dim_in_I44_1"));
  SET_STRING_ELT(state_names, 687, mkChar("dim_in_I44_2"));
  SET_STRING_ELT(state_names, 688, mkChar("in_I44"));
  SET_STRING_ELT(state_names, 689, mkChar("dim_in_I45"));
  SET_STRING_ELT(state_names, 690, mkChar("dim_in_I45_1"));
  SET_STRING_ELT(state_names, 691, mkChar("dim_in_I45_2"));
  SET_STRING_ELT(state_names, 692, mkChar("in_I45"));
  SET_STRING_ELT(state_names, 693, mkChar("dim_rate_move_in"));
  SET_STRING_ELT(state_names, 694, mkChar("dim_rate_move_in_1"));
  SET_STRING_ELT(state_names, 695, mkChar("dim_rate_move_in_2"));
  SET_STRING_ELT(state_names, 696, mkChar("rate_move_in"));
  SET_STRING_ELT(state_names, 697, mkChar("offset_output_rate_move_in"));
  SET_STRING_ELT(state_names, 698, mkChar("dim_rate_move_out"));
  SET_STRING_ELT(state_names, 699, mkChar("rate_move_out"));
  SET_STRING_ELT(state_names, 700, mkChar("offset_output_rate_move_out"));
  SET_STRING_ELT(state_names, 701, mkChar("interpolate_c_comm"));
  SET_STRING_ELT(state_names, 702, mkChar("interpolate_c_noncomm"));
  SET_STRING_ELT(state_names, 703, mkChar("interpolate_ART_eligible_CD4_above_500"));
  SET_STRING_ELT(state_names, 704, mkChar("ART_eligible_CD4_above_500"));
  SET_STRING_ELT(state_names, 705, mkChar("interpolate_ART_eligible_CD4_350_500"));
  SET_STRING_ELT(state_names, 706, mkChar("ART_eligible_CD4_350_500"));
  SET_STRING_ELT(state_names, 707, mkChar("interpolate_ART_eligible_CD4_200_349"));
  SET_STRING_ELT(state_names, 708, mkChar("ART_eligible_CD4_200_349"));
  SET_STRING_ELT(state_names, 709, mkChar("interpolate_ART_eligible_CD4_below_200"));
  SET_STRING_ELT(state_names, 710, mkChar("ART_eligible_CD4_below_200"));
  SET_STRING_ELT(state_names, 711, mkChar("interpolate_testing_prob"));
  SET_STRING_ELT(state_names, 712, mkChar("interpolate_tau_intervention"));
  SET_STRING_ELT(state_names, 713, mkChar("interpolate_rho_intervention"));
  SET_STRING_ELT(state_names, 714, mkChar("interpolate_infect_ART"));
  SET_STRING_ELT(state_names, 715, mkChar("interpolate_epsilon"));
  SET_STRING_ELT(state_names, 716, mkChar("epsilon"));
  SET_STRING_ELT(state_names, 717, mkChar("interpolate_prep_offered"));
  SET_STRING_ELT(state_names, 718, mkChar("interpolate_fc_comm"));
  SET_STRING_ELT(state_names, 719, mkChar("interpolate_fP_comm"));
  SET_STRING_ELT(state_names, 720, mkChar("interpolate_fc_noncomm"));
  SET_STRING_ELT(state_names, 721, mkChar("interpolate_fP_noncomm"));
  SET_STRING_ELT(state_names, 722, mkChar("interpolate_n_comm"));
  SET_STRING_ELT(state_names, 723, mkChar("interpolate_n_noncomm"));
  SET_STRING_ELT(state_names, 724, mkChar("dim"));
  SET_STRING_ELT(state_names, 725, mkChar("dim_output"));
...
SEXP main_model_variable_order(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  SEXP state_len = PROTECT(allocVector(VECSXP, 38));
  SEXP state_names = PROTECT(allocVector(STRSXP, 38));
  SET_VECTOR_ELT(state_len, 0, ScalarInteger(main_model_p->dim_S0_infections));
  SET_STRING_ELT(state_names, 0, mkChar("S0_infections"));
  SET_VECTOR_ELT(state_len, 1, ScalarInteger(main_model_p->dim_S1a_infections));
  SET_STRING_ELT(state_names, 1, mkChar("S1a_infections"));
  SET_VECTOR_ELT(state_len, 2, ScalarInteger(main_model_p->dim_S1b_infections));
  SET_STRING_ELT(state_names, 2, mkChar("S1b_infections"));
  SET_VECTOR_ELT(state_len, 3, ScalarInteger(main_model_p->dim_S1c_infections));
  SET_STRING_ELT(state_names, 3, mkChar("S1c_infections"));
  SET_VECTOR_ELT(state_len, 4, ScalarInteger(main_model_p->dim_S1d_infections));
  SET_STRING_ELT(state_names, 4, mkChar("S1d_infections"));
  SET_VECTOR_ELT(state_len, 5, ScalarInteger(main_model_p->dim_cumuHIVDeaths));
  SET_STRING_ELT(state_names, 5, mkChar("cumuHIVDeaths"));
  SET_VECTOR_ELT(state_len, 6, ScalarInteger(main_model_p->dim_cumuARTinitiations));
  SET_STRING_ELT(state_names, 6, mkChar("cumuARTinitiations"));
  SET_VECTOR_ELT(state_len, 7, ScalarInteger(main_model_p->dim_cumuARTREinitiations));
  SET_STRING_ELT(state_names, 7, mkChar("cumuARTREinitiations"));
  SET_VECTOR_ELT(state_len, 8, ScalarInteger(main_model_p->dim_dropouts));
  SET_STRING_ELT(state_names, 8, mkChar("dropouts"));
  SET_VECTOR_ELT(state_len, 9, ScalarInteger(main_model_p->dim_cumuAllDeaths));
  SET_STRING_ELT(state_names, 9, mkChar("cumuAllDeaths"));
  SET_VECTOR_ELT(state_len, 10, ScalarInteger(main_model_p->dim_cumuInf));
  SET_STRING_ELT(state_names, 10, mkChar("cumuInf"));
  SET_VECTOR_ELT(state_len, 11, ScalarInteger(main_model_p->dim_OnPrEP));
  SET_STRING_ELT(state_names, 11, mkChar("OnPrEP"));
  SET_VECTOR_ELT(state_len, 12, ScalarInteger(main_model_p->dim_OnPrEP1a));
  SET_STRING_ELT(state_names, 12, mkChar("OnPrEP1a"));
  SET_VECTOR_ELT(state_len, 13, ScalarInteger(main_model_p->dim_OnPrEP1b));
  SET_STRING_ELT(state_names, 13, mkChar("OnPrEP1b"));
  SET_VECTOR_ELT(state_len, 14, ScalarInteger(main_model_p->dim_OnPrEP1c));
  SET_STRING_ELT(state_names, 14, mkChar("OnPrEP1c"));
  SET_VECTOR_ELT(state_len, 15, ScalarInteger(main_model_p->dim_S0));
  SET_STRING_ELT(state_names, 15, mkChar("S0"));
  SET_VECTOR_ELT(state_len, 16, ScalarInteger(main_model_p->dim_S1a));
  SET_STRING_ELT(state_names, 16, mkChar("S1a"));
  SET_VECTOR_ELT(state_len, 17, ScalarInteger(main_model_p->dim_S1b));
  SET_STRING_ELT(state_names, 17, mkChar("S1b"));
  SET_VECTOR_ELT(state_len, 18, ScalarInteger(main_model_p->dim_S1c));
  SET_STRING_ELT(state_names, 18, mkChar("S1c"));
  SET_VECTOR_ELT(state_len, 19, ScalarInteger(main_model_p->dim_S1d));
  SET_STRING_ELT(state_names, 19, mkChar("S1d"));
  SET_VECTOR_ELT(state_len, 20, ScalarInteger(main_model_p->dim_I01));
  SET_STRING_ELT(state_names, 20, mkChar("I01"));
  SET_VECTOR_ELT(state_len, 21, ScalarInteger(main_model_p->dim_I11));
  SET_STRING_ELT(state_names, 21, mkChar("I11"));
  SET_VECTOR_ELT(state_len, 22, ScalarInteger(main_model_p->dim_I02));
  SET_STRING_ELT(state_names, 22, mkChar("I02"));
  SET_VECTOR_ELT(state_len, 23, ScalarInteger(main_model_p->dim_I03));
  SET_STRING_ELT(state_names, 23, mkChar("I03"));
  SET_VECTOR_ELT(state_len, 24, ScalarInteger(main_model_p->dim_I04));
  SET_STRING_ELT(state_names, 24, mkChar("I04"));
  SET_VECTOR_ELT(state_len, 25, ScalarInteger(main_model_p->dim_I05));
  SET_STRING_ELT(state_names, 25, mkChar("I05"));
  SET_VECTOR_ELT(state_len, 26, ScalarInteger(main_model_p->dim_I22));
  SET_STRING_ELT(state_names, 26, mkChar("I22"));
  SET_VECTOR_ELT(state_len, 27, ScalarInteger(main_model_p->dim_I23));
  SET_STRING_ELT(state_names, 27, mkChar("I23"));
  SET_VECTOR_ELT(state_len, 28, ScalarInteger(main_model_p->dim_I24));
  SET_STRING_ELT(state_names, 28, mkChar("I24"));
  SET_VECTOR_ELT(state_len, 29, ScalarInteger(main_model_p->dim_I25));
  SET_STRING_ELT(state_names, 29, mkChar("I25"));
  SET_VECTOR_ELT(state_len, 30, ScalarInteger(main_model_p->dim_I32));
  SET_STRING_ELT(state_names, 30, mkChar("I32"));
  SET_VECTOR_ELT(state_len, 31, ScalarInteger(main_model_p->dim_I33));
  SET_STRING_ELT(state_names, 31, mkChar("I33"));
  SET_VECTOR_ELT(state_len, 32, ScalarInteger(main_model_p->dim_I34));
  SET_STRING_ELT(state_names, 32, mkChar("I34"));
  SET_VECTOR_ELT(state_len, 33, ScalarInteger(main_model_p->dim_I35));
  SET_STRING_ELT(state_names, 33, mkChar("I35"));
  SET_VECTOR_ELT(state_len, 34, ScalarInteger(main_model_p->dim_I42));
  SET_STRING_ELT(state_names, 34, mkChar("I42"));
  SET_VECTOR_ELT(state_len, 35, ScalarInteger(main_model_p->dim_I43));
  SET_STRING_ELT(state_names, 35, mkChar("I43"));
  SET_VECTOR_ELT(state_len, 36, ScalarInteger(main_model_p->dim_I44));
  SET_STRING_ELT(state_names, 36, mkChar("I44"));
  SET_VECTOR_ELT(state_len, 37, ScalarInteger(main_model_p->dim_I45));
  SET_STRING_ELT(state_names, 37, mkChar("I45"));
...
SEXP main_model_output_order(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  int *tmp;
  SEXP state_len = PROTECT(allocVector(VECSXP, 107));
  SEXP state_names = PROTECT(allocVector(STRSXP, 107));
  ...
  SET_STRING_ELT(state_names, 9, mkChar("cumuInftot"));
  SET_VECTOR_ELT(state_len, 10, R_NilValue);
  SET_STRING_ELT(state_names, 10, mkChar("ART_sex_ratio"));
  SET_VECTOR_ELT(state_len, 11, R_NilValue);
  SET_STRING_ELT(state_names, 11, mkChar("pc_S1a"));
  SET_VECTOR_ELT(state_len, 12, R_NilValue);
  SET_STRING_ELT(state_names, 12, mkChar("pc_S1b"));
  SET_VECTOR_ELT(state_len, 13, R_NilValue);
  SET_STRING_ELT(state_names, 13, mkChar("pc_S1c"));
  SET_VECTOR_ELT(state_len, 14, R_NilValue);
  SET_STRING_ELT(state_names, 14, mkChar("Men_on_ART"));
  SET_VECTOR_ELT(state_len, 15, R_NilValue);
  SET_STRING_ELT(state_names, 15, mkChar("Women_on_ART"));
  SET_VECTOR_ELT(state_len, 16, R_NilValue);
  SET_STRING_ELT(state_names, 16, mkChar("ART_coverage_men"));
  SET_VECTOR_ELT(state_len, 17, R_NilValue);
  SET_STRING_ELT(state_names, 17, mkChar("ART_coverage_women"));
  SET_VECTOR_ELT(state_len, 18, R_NilValue);
  SET_STRING_ELT(state_names, 18, mkChar("ART_coverage_FSW"));
  SET_VECTOR_ELT(state_len, 19, R_NilValue);
  SET_STRING_ELT(state_names, 19, mkChar("ART_coverage_all"));
  SET_VECTOR_ELT(state_len, 20, R_NilValue);
  SET_STRING_ELT(state_names, 20, mkChar("Ncat"));
  SET_VECTOR_ELT(state_len, 21, R_NilValue);
  SET_STRING_ELT(state_names, 21, mkChar("nu"));
  SET_VECTOR_ELT(state_len, 22, R_NilValue);
  SET_STRING_ELT(state_names, 22, mkChar("Nage"));
  SET_VECTOR_ELT(state_len, 23, R_NilValue);
  SET_STRING_ELT(state_names, 23, mkChar("dur_FSW"));
  SET_VECTOR_ELT(state_len, 24, R_NilValue);
  SET_STRING_ELT(state_names, 24, mkChar("epsilon"));
  SET_VECTOR_ELT(state_len, 25, R_NilValue);
  SET_STRING_ELT(state_names, 25, mkChar("Ntot_inc_former_FSW_nonCot"));
  SET_VECTOR_ELT(state_len, 26, R_NilValue);
  SET_STRING_ELT(state_names, 26, mkChar("new_people"));
  SET_VECTOR_ELT(state_len, 27, R_NilValue);
  SET_STRING_ELT(state_names, 27, mkChar("frac_virgin"));
  SET_VECTOR_ELT(state_len, 28, R_NilValue);
  SET_STRING_ELT(state_names, 28, mkChar("prev_LowFSW"));
  SET_VECTOR_ELT(state_len, 29, R_NilValue);
  SET_STRING_ELT(state_names, 29, mkChar("prev_men"));
  SET_VECTOR_ELT(state_len, 30, R_NilValue);
  SET_STRING_ELT(state_names, 30, mkChar("prev_women"));
  SET_VECTOR_ELT(state_len, 31, R_NilValue);
  SET_STRING_ELT(state_names, 31, mkChar("prev_cotonou"));
  SET_VECTOR_ELT(state_len, 32, R_NilValue);
  SET_STRING_ELT(state_names, 32, mkChar("Ntot"));
  SET_VECTOR_ELT(state_len, 33, R_NilValue);
  SET_STRING_ELT(state_names, 33, mkChar("prev_FSW"));
  SET_VECTOR_ELT(state_len, 34, R_NilValue);
  SET_STRING_ELT(state_names, 34, mkChar("prev_client"));
  SET_VECTOR_ELT(state_len, 35, R_NilValue);
  SET_STRING_ELT(state_names, 35, mkChar("B_check_comm"));
  SET_VECTOR_ELT(state_len, 36, R_NilValue);
  SET_STRING_ELT(state_names, 36, mkChar("B_check_noncomm"));
  SET_VECTOR_ELT(state_len, 37, R_NilValue);
  SET_STRING_ELT(state_names, 37, mkChar("FSW_in"));
  SET_VECTOR_ELT(state_len, 38, R_NilValue);
  SET_STRING_ELT(state_names, 38, mkChar("FSW_out"));
  SET_VECTOR_ELT(state_len, 39, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 39));
  tmp[0] = main_model_p->dim_infect_ART_y_1;
  tmp[1] = main_model_p->dim_infect_ART_y_2;
  SET_STRING_ELT(state_names, 39, mkChar("infect_ART_y"));
  SET_VECTOR_ELT(state_len, 40, ScalarInteger(main_model_p->dim_infect_ART_t));
  SET_STRING_ELT(state_names, 40, mkChar("infect_ART_t"));
  SET_VECTOR_ELT(state_len, 41, ScalarInteger(main_model_p->dim_c_comm));
  SET_STRING_ELT(state_names, 41, mkChar("c_comm"));
  SET_VECTOR_ELT(state_len, 42, ScalarInteger(main_model_p->dim_c_noncomm));
  SET_STRING_ELT(state_names, 42, mkChar("c_noncomm"));
  SET_VECTOR_ELT(state_len, 43, ScalarInteger(main_model_p->dim_new_people_in_group));
  SET_STRING_ELT(state_names, 43, mkChar("new_people_in_group"));
  SET_VECTOR_ELT(state_len, 44, ScalarInteger(main_model_p->dim_new_people_in_group_FSW_only));
  SET_STRING_ELT(state_names, 44, mkChar("new_people_in_group_FSW_only"));
  SET_VECTOR_ELT(state_len, 45, ScalarInteger(main_model_p->dim_testing_prob));
  SET_STRING_ELT(state_names, 45, mkChar("testing_prob"));
  SET_VECTOR_ELT(state_len, 46, ScalarInteger(main_model_p->dim_tau_intervention));
  SET_STRING_ELT(state_names, 46, mkChar("tau_intervention"));
  SET_VECTOR_ELT(state_len, 47, ScalarInteger(main_model_p->dim_rho_intervention));
  SET_STRING_ELT(state_names, 47, mkChar("rho_intervention"));
  SET_VECTOR_ELT(state_len, 48, ScalarInteger(main_model_p->dim_zeta));
  SET_STRING_ELT(state_names, 48, mkChar("zeta"));
  SET_VECTOR_ELT(state_len, 49, ScalarInteger(main_model_p->dim_tau));
  SET_STRING_ELT(state_names, 49, mkChar("tau"));
  SET_VECTOR_ELT(state_len, 50, ScalarInteger(main_model_p->dim_rho));
  SET_STRING_ELT(state_names, 50, mkChar("rho"));
  SET_VECTOR_ELT(state_len, 51, ScalarInteger(main_model_p->dim_iota));
  SET_STRING_ELT(state_names, 51, mkChar("iota"));
  SET_VECTOR_ELT(state_len, 52, ScalarInteger(main_model_p->dim_frac_F));
  SET_STRING_ELT(state_names, 52, mkChar("frac_F"));
  SET_VECTOR_ELT(state_len, 53, ScalarInteger(main_model_p->dim_frac_N_sexualpop));
  SET_STRING_ELT(state_names, 53, mkChar("frac_N_sexualpop"));
  SET_VECTOR_ELT(state_len, 54, ScalarInteger(main_model_p->dim_ART_coverage));
  SET_STRING_ELT(state_names, 54, mkChar("ART_coverage"));
  SET_VECTOR_ELT(state_len, 55, ScalarInteger(main_model_p->dim_infect_ART));
  SET_STRING_ELT(state_names, 55, mkChar("infect_ART"));
  SET_VECTOR_ELT(state_len, 56, ScalarInteger(main_model_p->dim_omega));
  SET_STRING_ELT(state_names, 56, mkChar("omega"));
  SET_VECTOR_ELT(state_len, 57, ScalarInteger(main_model_p->dim_frac_N));
  SET_STRING_ELT(state_names, 57, mkChar("frac_N"));
  SET_VECTOR_ELT(state_len, 58, ScalarInteger(main_model_p->dim_mu));
  SET_STRING_ELT(state_names, 58, mkChar("mu"));
  SET_VECTOR_ELT(state_len, 59, ScalarInteger(main_model_p->dim_gamma01));
  SET_STRING_ELT(state_names, 59, mkChar("gamma01"));
  SET_VECTOR_ELT(state_len, 60, ScalarInteger(main_model_p->dim_gamma11));
  SET_STRING_ELT(state_names, 60, mkChar("gamma11"));
  SET_VECTOR_ELT(state_len, 61, ScalarInteger(main_model_p->dim_kappaa));
  SET_STRING_ELT(state_names, 61, mkChar("kappaa"));
  SET_VECTOR_ELT(state_len, 62, ScalarInteger(main_model_p->dim_kappab));
  SET_STRING_ELT(state_names, 62, mkChar("kappab"));
  SET_VECTOR_ELT(state_len, 63, ScalarInteger(main_model_p->dim_kappac));
  SET_STRING_ELT(state_names, 63, mkChar("kappac"));
  SET_VECTOR_ELT(state_len, 64, ScalarInteger(main_model_p->dim_kappa1));
  SET_STRING_ELT(state_names, 64, mkChar("kappa1"));
  SET_VECTOR_ELT(state_len, 65, ScalarInteger(main_model_p->dim_alpha01));
  SET_STRING_ELT(state_names, 65, mkChar("alpha01"));
  SET_VECTOR_ELT(state_len, 66, ScalarInteger(main_model_p->dim_alpha02));
  SET_STRING_ELT(state_names, 66, mkChar("alpha02"));
  SET_VECTOR_ELT(state_len, 67, ScalarInteger(main_model_p->dim_alpha05));
  SET_STRING_ELT(state_names, 67, mkChar("alpha05"));
  SET_VECTOR_ELT(state_len, 68, ScalarInteger(main_model_p->dim_alpha11));
  SET_STRING_ELT(state_names, 68, mkChar("alpha11"));
  SET_VECTOR_ELT(state_len, 69, ScalarInteger(main_model_p->dim_alpha22));
  SET_STRING_ELT(state_names, 69, mkChar("alpha22"));
  SET_VECTOR_ELT(state_len, 70, ScalarInteger(main_model_p->dim_alpha35));
  SET_STRING_ELT(state_names, 70, mkChar("alpha35"));
  SET_VECTOR_ELT(state_len, 71, ScalarInteger(main_model_p->dim_beta_comm));
  SET_STRING_ELT(state_names, 71, mkChar("beta_comm"));
  SET_VECTOR_ELT(state_len, 72, ScalarInteger(main_model_p->dim_beta_noncomm));
  SET_STRING_ELT(state_names, 72, mkChar("beta_noncomm"));
  ...
  SET_STRING_ELT(state_names, 73, mkChar("p_comm"));
  ...
  SET_STRING_ELT(state_names, 74, mkChar("p_noncomm"));
  ...
  SET_STRING_ELT(state_names, 75, mkChar("fc_comm"));
  SET_VECTOR_ELT(state_len, 76, ScalarInteger(main_model_p->dim_fP_comm));
  SET_STRING_ELT(state_names, 76, mkChar("fP_comm"));
  ...
  SET_STRING_ELT(state_names, 77, mkChar("fc_noncomm"));
  SET_VECTOR_ELT(state_len, 78, ScalarInteger(main_model_p->dim_fP_noncomm));
  SET_STRING_ELT(state_names, 78, mkChar("fP_noncomm"));
  SET_VECTOR_ELT(state_len, 79, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 79));
  tmp[0] = main_model_p->dim_n_comm_1;
  tmp[1] = main_model_p->dim_n_comm_2;
  SET_STRING_ELT(state_names, 79, mkChar("n_comm"));
  ...
  SET_STRING_ELT(state_names, 80, mkChar("n_noncomm"));
  SET_VECTOR_ELT(state_len, 81, ScalarInteger(main_model_p->dim_N));
  SET_STRING_ELT(state_names, 81, mkChar("N"));
  SET_VECTOR_ELT(state_len, 82, ScalarInteger(main_model_p->dim_E0));
  SET_STRING_ELT(state_names, 82, mkChar("E0"));
  SET_VECTOR_ELT(state_len, 83, ScalarInteger(main_model_p->dim_E1a));
  SET_STRING_ELT(state_names, 83, mkChar("E1a"));
  SET_VECTOR_ELT(state_len, 84, ScalarInteger(main_model_p->dim_E1b));
  SET_STRING_ELT(state_names, 84, mkChar("E1b"));
  SET_VECTOR_ELT(state_len, 85, ScalarInteger(main_model_p->dim_E1c));
  SET_STRING_ELT(state_names, 85, mkChar("E1c"));
  SET_VECTOR_ELT(state_len, 86, ScalarInteger(main_model_p->dim_E1d));
  SET_STRING_ELT(state_names, 86, mkChar("E1d"));
  SET_VECTOR_ELT(state_len, 87, ScalarInteger(main_model_p->dim_alphaItot));
  SET_STRING_ELT(state_names, 87, mkChar("alphaItot"));
  SET_VECTOR_ELT(state_len, 88, ScalarInteger(main_model_p->dim_prev));
  SET_STRING_ELT(state_names, 88, mkChar("prev"));
  SET_VECTOR_ELT(state_len, 89, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 89));
  tmp[0] = main_model_p->dim_lambda_1;
  tmp[1] = main_model_p->dim_lambda_2;
  SET_STRING_ELT(state_names, 89, mkChar("lambda"));
  SET_VECTOR_ELT(state_len, 90, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 90));
  tmp[0] = main_model_p->dim_lambda_0_1;
  tmp[1] = main_model_p->dim_lambda_0_2;
  SET_STRING_ELT(state_names, 90, mkChar("lambda_0"));
  SET_VECTOR_ELT(state_len, 91, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 91));
  tmp[0] = main_model_p->dim_lambda_1a_1;
  tmp[1] = main_model_p->dim_lambda_1a_2;
  SET_STRING_ELT(state_names, 91, mkChar("lambda_1a"));
  ...
  SET_STRING_ELT(state_names, 92, mkChar("lambda_1b"));
  ...
  SET_STRING_ELT(state_names, 93, mkChar("lambda_1c"));
  ...
  SET_STRING_ELT(state_names, 94, mkChar("lambda_1d"));
  SET_VECTOR_ELT(state_len, 95, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_STRING_ELT(state_names, 95, mkChar("lambda_sum_0"));
  SET_VECTOR_ELT(state_len, 96, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_STRING_ELT(state_names, 96, mkChar("lambda_sum_1a"));
  SET_VECTOR_ELT(state_len, 97, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_STRING_ELT(state_names, 97, mkChar("lambda_sum_1b"));
  SET_VECTOR_ELT(state_len, 98, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_STRING_ELT(state_names, 98, mkChar("lambda_sum_1c"));
  SET_VECTOR_ELT(state_len, 99, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_STRING_ELT(state_names, 99, mkChar("lambda_sum_1d"));
  SET_VECTOR_ELT(state_len, 100, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_STRING_ELT(state_names, 100, mkChar("c_comm_balanced"));
  SET_VECTOR_ELT(state_len, 101, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_STRING_ELT(state_names, 101, mkChar("c_noncomm_balanced"));
  SET_VECTOR_ELT(state_len, 102, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 102));
  tmp[0] = main_model_p->dim_theta_1;
  tmp[1] = main_model_p->dim_theta_2;
  SET_STRING_ELT(state_names, 102, mkChar("theta"));
  ...
  SET_STRING_ELT(state_names, 103, mkChar("M_comm"));
  ...
  SET_STRING_ELT(state_names, 104, mkChar("M_noncomm"));
  SET_VECTOR_ELT(state_len, 105, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 105));
  tmp[0] = main_model_p->dim_rate_move_in_1;
  tmp[1] = main_model_p->dim_rate_move_in_2;
  SET_STRING_ELT(state_names, 105, mkChar("rate_move_in"));
  SET_VECTOR_ELT(state_len, 106, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_STRING_ELT(state_names, 106, mkChar("rate_move_out"));
  setAttrib(state_len, R_NamesSymbol, state_names);
  UNPROTECT(2);
  return state_len;
}
