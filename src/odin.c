...
SEXP main_model_set_user(main_model_pars *main_model_p, SEXP user) {
  ...
  main_model_p->offset_output_c_comm = 13;
  ...
  main_model_p->offset_output_c_noncomm = 13 + main_model_p->dim_c_comm;
...
void main_model_deriv(main_model_pars *main_model_p, double t, double *state, double *dstatedt, double *output) {
  ...
  if (output != NULL) {
    double *output_c_comm = output + 13;
...
SEXP main_model_output_order(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  int *tmp;
  SEXP state_len = PROTECT(allocVector(VECSXP, 71));
  SEXP state_names = PROTECT(allocVector(STRSXP, 71));
  ...
  SET_STRING_ELT(state_names, 7, mkChar("Ntot"));
  SET_VECTOR_ELT(state_len, 8, R_NilValue);
  SET_STRING_ELT(state_names, 8, mkChar("new_people"));
  SET_VECTOR_ELT(state_len, 9, R_NilValue);
  SET_STRING_ELT(state_names, 9, mkChar("prev_FSW"));
  SET_VECTOR_ELT(state_len, 10, R_NilValue);
  SET_STRING_ELT(state_names, 10, mkChar("prev_client"));
  SET_VECTOR_ELT(state_len, 11, R_NilValue);
  SET_STRING_ELT(state_names, 11, mkChar("B_check_comm"));
  SET_VECTOR_ELT(state_len, 12, R_NilValue);
  SET_STRING_ELT(state_names, 12, mkChar("B_check_noncomm"));
  SET_VECTOR_ELT(state_len, 13, ScalarInteger(main_model_p->dim_c_comm));
  SET_STRING_ELT(state_names, 13, mkChar("c_comm"));
  SET_VECTOR_ELT(state_len, 14, ScalarInteger(main_model_p->dim_c_noncomm));
  SET_STRING_ELT(state_names, 14, mkChar("c_noncomm"));
  SET_VECTOR_ELT(state_len, 15, ScalarInteger(main_model_p->dim_new_people_in_group));
  SET_STRING_ELT(state_names, 15, mkChar("new_people_in_group"));
  SET_VECTOR_ELT(state_len, 16, ScalarInteger(main_model_p->dim_testing_prob));
  SET_STRING_ELT(state_names, 16, mkChar("testing_prob"));
  SET_VECTOR_ELT(state_len, 17, ScalarInteger(main_model_p->dim_ART_prob));
  SET_STRING_ELT(state_names, 17, mkChar("ART_prob"));
  SET_VECTOR_ELT(state_len, 18, ScalarInteger(main_model_p->dim_tau));
  SET_STRING_ELT(state_names, 18, mkChar("tau"));
  SET_VECTOR_ELT(state_len, 19, ScalarInteger(main_model_p->dim_rho));
  SET_STRING_ELT(state_names, 19, mkChar("rho"));
  SET_VECTOR_ELT(state_len, 20, ScalarInteger(main_model_p->dim_frac_F));
  SET_STRING_ELT(state_names, 20, mkChar("frac_F"));
  SET_VECTOR_ELT(state_len, 21, ScalarInteger(main_model_p->dim_frac_N_sexualpop));
  SET_STRING_ELT(state_names, 21, mkChar("frac_N_sexualpop"));
  SET_VECTOR_ELT(state_len, 22, ScalarInteger(main_model_p->dim_zetaa));
  SET_STRING_ELT(state_names, 22, mkChar("zetaa"));
  SET_VECTOR_ELT(state_len, 23, ScalarInteger(main_model_p->dim_zetab));
  SET_STRING_ELT(state_names, 23, mkChar("zetab"));
  SET_VECTOR_ELT(state_len, 24, ScalarInteger(main_model_p->dim_zetac));
  SET_STRING_ELT(state_names, 24, mkChar("zetac"));
  SET_VECTOR_ELT(state_len, 25, ScalarInteger(main_model_p->dim_omega));
  SET_STRING_ELT(state_names, 25, mkChar("omega"));
  SET_VECTOR_ELT(state_len, 26, ScalarInteger(main_model_p->dim_frac_N));
  SET_STRING_ELT(state_names, 26, mkChar("frac_N"));
  SET_VECTOR_ELT(state_len, 27, ScalarInteger(main_model_p->dim_mu));
  SET_STRING_ELT(state_names, 27, mkChar("mu"));
  SET_VECTOR_ELT(state_len, 28, ScalarInteger(main_model_p->dim_gamma01));
  SET_STRING_ELT(state_names, 28, mkChar("gamma01"));
  SET_VECTOR_ELT(state_len, 29, ScalarInteger(main_model_p->dim_kappaa));
  SET_STRING_ELT(state_names, 29, mkChar("kappaa"));
  SET_VECTOR_ELT(state_len, 30, ScalarInteger(main_model_p->dim_kappab));
  SET_STRING_ELT(state_names, 30, mkChar("kappab"));
  SET_VECTOR_ELT(state_len, 31, ScalarInteger(main_model_p->dim_kappac));
  SET_STRING_ELT(state_names, 31, mkChar("kappac"));
  SET_VECTOR_ELT(state_len, 32, ScalarInteger(main_model_p->dim_alpha05));
  SET_STRING_ELT(state_names, 32, mkChar("alpha05"));
  SET_VECTOR_ELT(state_len, 33, ScalarInteger(main_model_p->dim_alpha35));
  SET_STRING_ELT(state_names, 33, mkChar("alpha35"));
  SET_VECTOR_ELT(state_len, 34, ScalarInteger(main_model_p->dim_beta_comm));
  SET_STRING_ELT(state_names, 34, mkChar("beta_comm"));
  SET_VECTOR_ELT(state_len, 35, ScalarInteger(main_model_p->dim_beta_noncomm));
  SET_STRING_ELT(state_names, 35, mkChar("beta_noncomm"));
  SET_VECTOR_ELT(state_len, 36, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 36));
  tmp[0] = main_model_p->dim_p_comm_1;
  tmp[1] = main_model_p->dim_p_comm_2;
  SET_STRING_ELT(state_names, 36, mkChar("p_comm"));
  SET_VECTOR_ELT(state_len, 37, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 37));
  tmp[0] = main_model_p->dim_p_noncomm_1;
  tmp[1] = main_model_p->dim_p_noncomm_2;
  SET_STRING_ELT(state_names, 37, mkChar("p_noncomm"));
  SET_VECTOR_ELT(state_len, 38, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 38));
  tmp[0] = main_model_p->dim_fc_comm_1;
  tmp[1] = main_model_p->dim_fc_comm_2;
  SET_STRING_ELT(state_names, 38, mkChar("fc_comm"));
  SET_VECTOR_ELT(state_len, 39, ScalarInteger(main_model_p->dim_fP_comm));
  SET_STRING_ELT(state_names, 39, mkChar("fP_comm"));
  ...
  SET_STRING_ELT(state_names, 40, mkChar("fc_noncomm"));
  SET_VECTOR_ELT(state_len, 41, ScalarInteger(main_model_p->dim_fP_noncomm));
  SET_STRING_ELT(state_names, 41, mkChar("fP_noncomm"));
  SET_VECTOR_ELT(state_len, 42, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 42));
  tmp[0] = main_model_p->dim_n_comm_1;
  tmp[1] = main_model_p->dim_n_comm_2;
  SET_STRING_ELT(state_names, 42, mkChar("n_comm"));
  ...
  SET_STRING_ELT(state_names, 43, mkChar("n_noncomm"));
  SET_VECTOR_ELT(state_len, 44, ScalarInteger(main_model_p->dim_N));
  SET_STRING_ELT(state_names, 44, mkChar("N"));
  SET_VECTOR_ELT(state_len, 45, ScalarInteger(main_model_p->dim_E0));
  SET_STRING_ELT(state_names, 45, mkChar("E0"));
  SET_VECTOR_ELT(state_len, 46, ScalarInteger(main_model_p->dim_E1a));
  SET_STRING_ELT(state_names, 46, mkChar("E1a"));
  SET_VECTOR_ELT(state_len, 47, ScalarInteger(main_model_p->dim_E1b));
  SET_STRING_ELT(state_names, 47, mkChar("E1b"));
  SET_VECTOR_ELT(state_len, 48, ScalarInteger(main_model_p->dim_E1c));
  SET_STRING_ELT(state_names, 48, mkChar("E1c"));
  SET_VECTOR_ELT(state_len, 49, ScalarInteger(main_model_p->dim_E1d));
  SET_STRING_ELT(state_names, 49, mkChar("E1d"));
  SET_VECTOR_ELT(state_len, 50, ScalarInteger(main_model_p->dim_alphaItot));
  SET_STRING_ELT(state_names, 50, mkChar("alphaItot"));
  SET_VECTOR_ELT(state_len, 51, ScalarInteger(main_model_p->dim_prev));
  SET_STRING_ELT(state_names, 51, mkChar("prev"));
  ...
  SET_STRING_ELT(state_names, 52, mkChar("lambda"));
  ...
  SET_STRING_ELT(state_names, 53, mkChar("lambda_0"));
  ...
  SET_STRING_ELT(state_names, 54, mkChar("lambda_1a"));
  ...
  SET_STRING_ELT(state_names, 55, mkChar("lambda_1b"));
  ...
  SET_STRING_ELT(state_names, 56, mkChar("lambda_1c"));
  ...
  SET_STRING_ELT(state_names, 57, mkChar("lambda_1d"));
  SET_VECTOR_ELT(state_len, 58, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_STRING_ELT(state_names, 58, mkChar("lambda_sum_0"));
  SET_VECTOR_ELT(state_len, 59, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_STRING_ELT(state_names, 59, mkChar("lambda_sum_1a"));
  SET_VECTOR_ELT(state_len, 60, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_STRING_ELT(state_names, 60, mkChar("lambda_sum_1b"));
  SET_VECTOR_ELT(state_len, 61, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_STRING_ELT(state_names, 61, mkChar("lambda_sum_1c"));
  SET_VECTOR_ELT(state_len, 62, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_STRING_ELT(state_names, 62, mkChar("lambda_sum_1d"));
  SET_VECTOR_ELT(state_len, 63, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_STRING_ELT(state_names, 63, mkChar("c_comm_balanced"));
  SET_VECTOR_ELT(state_len, 64, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_STRING_ELT(state_names, 64, mkChar("c_noncomm_balanced"));
  ...
  SET_STRING_ELT(state_names, 65, mkChar("theta"));
  ...
  SET_STRING_ELT(state_names, 66, mkChar("M_comm"));
  ...
  SET_STRING_ELT(state_names, 67, mkChar("M_noncomm"));
  SET_VECTOR_ELT(state_len, 68, ScalarInteger(main_model_p->dim_sum_in_S0));
  SET_STRING_ELT(state_names, 68, mkChar("sum_in_S0"));
  ...
  SET_STRING_ELT(state_names, 69, mkChar("rate_move_in"));
  SET_VECTOR_ELT(state_len, 70, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_STRING_ELT(state_names, 70, mkChar("rate_move_out"));
  setAttrib(state_len, R_NamesSymbol, state_names);
  UNPROTECT(2);
  return state_len;
}
