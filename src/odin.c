...
SEXP main_model_contents(SEXP main_model_ptr) {
  ...
  SET_VECTOR_ELT(state, 200, ScalarInteger(main_model_p->dim_c_comm));
  SET_VECTOR_ELT(state, 201, allocVector(REALSXP, main_model_p->dim_c_comm));
  memcpy(REAL(VECTOR_ELT(state, 201)), main_model_p->c_comm, main_model_p->dim_c_comm * sizeof(double));
  SET_VECTOR_ELT(state, 202, ScalarInteger(main_model_p->offset_output_c_comm));
  SET_VECTOR_ELT(state, 203, ScalarInteger(main_model_p->dim_c_noncomm));
  SET_VECTOR_ELT(state, 204, allocVector(REALSXP, main_model_p->dim_c_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 204)), main_model_p->c_noncomm, main_model_p->dim_c_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 205, ScalarInteger(main_model_p->offset_output_c_noncomm));
  SET_VECTOR_ELT(state, 206, ScalarInteger(main_model_p->dim_pfFSW));
  SET_VECTOR_ELT(state, 207, allocVector(REALSXP, main_model_p->dim_pfFSW));
  memcpy(REAL(VECTOR_ELT(state, 207)), main_model_p->pfFSW, main_model_p->dim_pfFSW * sizeof(double));
  SET_VECTOR_ELT(state, 208, ScalarInteger(main_model_p->offset_output_pfFSW));
  SET_VECTOR_ELT(state, 209, ScalarInteger(main_model_p->dim_new_acute_infected));
  SET_VECTOR_ELT(state, 210, allocVector(REALSXP, main_model_p->dim_new_acute_infected));
  memcpy(REAL(VECTOR_ELT(state, 210)), main_model_p->new_acute_infected, main_model_p->dim_new_acute_infected * sizeof(double));
  SET_VECTOR_ELT(state, 211, ScalarInteger(main_model_p->offset_output_new_acute_infected));
  SET_VECTOR_ELT(state, 212, ScalarInteger(main_model_p->dim_rate_leave_pro_FSW_weight_by_PrEP));
  SET_VECTOR_ELT(state, 213, allocVector(REALSXP, main_model_p->dim_rate_leave_pro_FSW_weight_by_PrEP));
  memcpy(REAL(VECTOR_ELT(state, 213)), main_model_p->rate_leave_pro_FSW_weight_by_PrEP, main_model_p->dim_rate_leave_pro_FSW_weight_by_PrEP * sizeof(double));
  SET_VECTOR_ELT(state, 214, ScalarInteger(main_model_p->offset_output_rate_leave_pro_FSW_weight_by_PrEP));
  SET_VECTOR_ELT(state, 215, ScalarInteger(main_model_p->dim_FSW_ONLY));
  SET_VECTOR_ELT(state, 216, allocVector(REALSXP, main_model_p->dim_FSW_ONLY));
  memcpy(REAL(VECTOR_ELT(state, 216)), main_model_p->FSW_ONLY, main_model_p->dim_FSW_ONLY * sizeof(double));
  SET_VECTOR_ELT(state, 217, ScalarInteger(main_model_p->dim_new_people_in_group));
  SET_VECTOR_ELT(state, 218, allocVector(REALSXP, main_model_p->dim_new_people_in_group));
  memcpy(REAL(VECTOR_ELT(state, 218)), main_model_p->new_people_in_group, main_model_p->dim_new_people_in_group * sizeof(double));
  SET_VECTOR_ELT(state, 219, ScalarInteger(main_model_p->offset_output_new_people_in_group));
  SET_VECTOR_ELT(state, 220, ScalarInteger(main_model_p->dim_new_people_in_group_FSW_only));
  SET_VECTOR_ELT(state, 221, allocVector(REALSXP, main_model_p->dim_new_people_in_group_FSW_only));
  memcpy(REAL(VECTOR_ELT(state, 221)), main_model_p->new_people_in_group_FSW_only, main_model_p->dim_new_people_in_group_FSW_only * sizeof(double));
  SET_VECTOR_ELT(state, 222, ScalarInteger(main_model_p->offset_output_new_people_in_group_FSW_only));
  SET_VECTOR_ELT(state, 223, ScalarInteger(main_model_p->dim_comm_partnerships_requested));
  SET_VECTOR_ELT(state, 224, ScalarInteger(main_model_p->dim_comm_partnerships_requested_1));
  SET_VECTOR_ELT(state, 225, ScalarInteger(main_model_p->dim_comm_partnerships_requested_2));
  SET_VECTOR_ELT(state, 226, allocVector(REALSXP, main_model_p->dim_comm_partnerships_requested));
  memcpy(REAL(VECTOR_ELT(state, 226)), main_model_p->comm_partnerships_requested, main_model_p->dim_comm_partnerships_requested * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 226), 2, main_model_p->dim_comm_partnerships_requested_1, main_model_p->dim_comm_partnerships_requested_2);
  SET_VECTOR_ELT(state, 227, ScalarInteger(main_model_p->dim_noncomm_partnerships_requested));
  SET_VECTOR_ELT(state, 228, ScalarInteger(main_model_p->dim_noncomm_partnerships_requested_1));
  SET_VECTOR_ELT(state, 229, ScalarInteger(main_model_p->dim_noncomm_partnerships_requested_2));
  SET_VECTOR_ELT(state, 230, allocVector(REALSXP, main_model_p->dim_noncomm_partnerships_requested));
  memcpy(REAL(VECTOR_ELT(state, 230)), main_model_p->noncomm_partnerships_requested, main_model_p->dim_noncomm_partnerships_requested * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 230), 2, main_model_p->dim_noncomm_partnerships_requested_1, main_model_p->dim_noncomm_partnerships_requested_2);
  SET_VECTOR_ELT(state, 231, ScalarInteger(main_model_p->dim_above_500_by_group));
  SET_VECTOR_ELT(state, 232, allocVector(REALSXP, main_model_p->dim_above_500_by_group));
  memcpy(REAL(VECTOR_ELT(state, 232)), main_model_p->above_500_by_group, main_model_p->dim_above_500_by_group * sizeof(double));
  SET_VECTOR_ELT(state, 233, ScalarInteger(main_model_p->offset_output_above_500_by_group));
  SET_VECTOR_ELT(state, 234, ScalarInteger(main_model_p->dim_testing_prob));
  SET_VECTOR_ELT(state, 235, allocVector(REALSXP, main_model_p->dim_testing_prob));
  memcpy(REAL(VECTOR_ELT(state, 235)), main_model_p->testing_prob, main_model_p->dim_testing_prob * sizeof(double));
  SET_VECTOR_ELT(state, 236, ScalarInteger(main_model_p->offset_output_testing_prob));
  SET_VECTOR_ELT(state, 237, ScalarInteger(main_model_p->dim_zeta_re));
  SET_VECTOR_ELT(state, 238, allocVector(REALSXP, main_model_p->dim_zeta_re));
  memcpy(REAL(VECTOR_ELT(state, 238)), main_model_p->zeta_re, main_model_p->dim_zeta_re * sizeof(double));
  SET_VECTOR_ELT(state, 239, ScalarInteger(main_model_p->offset_output_zeta_re));
  SET_VECTOR_ELT(state, 240, ScalarInteger(main_model_p->dim_tau_intervention));
  SET_VECTOR_ELT(state, 241, allocVector(REALSXP, main_model_p->dim_tau_intervention));
  memcpy(REAL(VECTOR_ELT(state, 241)), main_model_p->tau_intervention, main_model_p->dim_tau_intervention * sizeof(double));
  SET_VECTOR_ELT(state, 242, ScalarInteger(main_model_p->offset_output_tau_intervention));
  SET_VECTOR_ELT(state, 243, ScalarInteger(main_model_p->dim_rho_intervention));
  SET_VECTOR_ELT(state, 244, allocVector(REALSXP, main_model_p->dim_rho_intervention));
  memcpy(REAL(VECTOR_ELT(state, 244)), main_model_p->rho_intervention, main_model_p->dim_rho_intervention * sizeof(double));
  SET_VECTOR_ELT(state, 245, ScalarInteger(main_model_p->offset_output_rho_intervention));
  SET_VECTOR_ELT(state, 246, ScalarInteger(main_model_p->dim_zeta));
  SET_VECTOR_ELT(state, 247, allocVector(REALSXP, main_model_p->dim_zeta));
  memcpy(REAL(VECTOR_ELT(state, 247)), main_model_p->zeta, main_model_p->dim_zeta * sizeof(double));
  SET_VECTOR_ELT(state, 248, ScalarInteger(main_model_p->offset_output_zeta));
  SET_VECTOR_ELT(state, 249, ScalarInteger(main_model_p->dim_sigma));
  SET_VECTOR_ELT(state, 250, allocVector(REALSXP, main_model_p->dim_sigma));
  memcpy(REAL(VECTOR_ELT(state, 250)), main_model_p->sigma, main_model_p->dim_sigma * sizeof(double));
  SET_VECTOR_ELT(state, 251, ScalarInteger(main_model_p->dim_eP1a_effective));
  SET_VECTOR_ELT(state, 252, allocVector(REALSXP, main_model_p->dim_eP1a_effective));
  memcpy(REAL(VECTOR_ELT(state, 252)), main_model_p->eP1a_effective, main_model_p->dim_eP1a_effective * sizeof(double));
  SET_VECTOR_ELT(state, 253, ScalarInteger(main_model_p->offset_output_eP1a_effective));
  SET_VECTOR_ELT(state, 254, ScalarInteger(main_model_p->dim_eP1b_effective));
  SET_VECTOR_ELT(state, 255, allocVector(REALSXP, main_model_p->dim_eP1b_effective));
  memcpy(REAL(VECTOR_ELT(state, 255)), main_model_p->eP1b_effective, main_model_p->dim_eP1b_effective * sizeof(double));
  SET_VECTOR_ELT(state, 256, ScalarInteger(main_model_p->offset_output_eP1b_effective));
  SET_VECTOR_ELT(state, 257, ScalarInteger(main_model_p->dim_eP1c_effective));
  SET_VECTOR_ELT(state, 258, allocVector(REALSXP, main_model_p->dim_eP1c_effective));
  memcpy(REAL(VECTOR_ELT(state, 258)), main_model_p->eP1c_effective, main_model_p->dim_eP1c_effective * sizeof(double));
  SET_VECTOR_ELT(state, 259, ScalarInteger(main_model_p->offset_output_eP1c_effective));
  SET_VECTOR_ELT(state, 260, ScalarInteger(main_model_p->dim_tau));
  SET_VECTOR_ELT(state, 261, allocVector(REALSXP, main_model_p->dim_tau));
  memcpy(REAL(VECTOR_ELT(state, 261)), main_model_p->tau, main_model_p->dim_tau * sizeof(double));
  SET_VECTOR_ELT(state, 262, ScalarInteger(main_model_p->offset_output_tau));
  SET_VECTOR_ELT(state, 263, ScalarInteger(main_model_p->dim_test_rate_prep));
  SET_VECTOR_ELT(state, 264, allocVector(REALSXP, main_model_p->dim_test_rate_prep));
  memcpy(REAL(VECTOR_ELT(state, 264)), main_model_p->test_rate_prep, main_model_p->dim_test_rate_prep * sizeof(double));
  SET_VECTOR_ELT(state, 265, ScalarInteger(main_model_p->dim_rho));
  SET_VECTOR_ELT(state, 266, allocVector(REALSXP, main_model_p->dim_rho));
  memcpy(REAL(VECTOR_ELT(state, 266)), main_model_p->rho, main_model_p->dim_rho * sizeof(double));
  SET_VECTOR_ELT(state, 267, ScalarInteger(main_model_p->offset_output_rho));
  SET_VECTOR_ELT(state, 268, ScalarInteger(main_model_p->dim_iota));
  SET_VECTOR_ELT(state, 269, allocVector(REALSXP, main_model_p->dim_iota));
  memcpy(REAL(VECTOR_ELT(state, 269)), main_model_p->iota, main_model_p->dim_iota * sizeof(double));
  SET_VECTOR_ELT(state, 270, ScalarInteger(main_model_p->offset_output_iota));
  SET_VECTOR_ELT(state, 271, ScalarInteger(main_model_p->dim_viral_supp));
  SET_VECTOR_ELT(state, 272, allocVector(REALSXP, main_model_p->dim_viral_supp));
  memcpy(REAL(VECTOR_ELT(state, 272)), main_model_p->viral_supp, main_model_p->dim_viral_supp * sizeof(double));
  SET_VECTOR_ELT(state, 273, ScalarInteger(main_model_p->offset_output_viral_supp));
  SET_VECTOR_ELT(state, 274, ScalarInteger(main_model_p->dim_HIV_positive));
  SET_VECTOR_ELT(state, 275, allocVector(REALSXP, main_model_p->dim_HIV_positive));
  memcpy(REAL(VECTOR_ELT(state, 275)), main_model_p->HIV_positive, main_model_p->dim_HIV_positive * sizeof(double));
  SET_VECTOR_ELT(state, 276, ScalarInteger(main_model_p->offset_output_HIV_positive));
  SET_VECTOR_ELT(state, 277, ScalarInteger(main_model_p->dim_Number_Susceptibles));
  SET_VECTOR_ELT(state, 278, allocVector(REALSXP, main_model_p->dim_Number_Susceptibles));
  memcpy(REAL(VECTOR_ELT(state, 278)), main_model_p->Number_Susceptibles, main_model_p->dim_Number_Susceptibles * sizeof(double));
  SET_VECTOR_ELT(state, 279, ScalarInteger(main_model_p->offset_output_Number_Susceptibles));
  SET_VECTOR_ELT(state, 280, ScalarInteger(main_model_p->dim_HIV_positive_Diagnosed_Off_ART));
  SET_VECTOR_ELT(state, 281, allocVector(REALSXP, main_model_p->dim_HIV_positive_Diagnosed_Off_ART));
  memcpy(REAL(VECTOR_ELT(state, 281)), main_model_p->HIV_positive_Diagnosed_Off_ART, main_model_p->dim_HIV_positive_Diagnosed_Off_ART * sizeof(double));
  SET_VECTOR_ELT(state, 282, ScalarInteger(main_model_p->offset_output_HIV_positive_Diagnosed_Off_ART));
  SET_VECTOR_ELT(state, 283, ScalarInteger(main_model_p->dim_Primary_Off_ART));
  SET_VECTOR_ELT(state, 284, allocVector(REALSXP, main_model_p->dim_Primary_Off_ART));
  memcpy(REAL(VECTOR_ELT(state, 284)), main_model_p->Primary_Off_ART, main_model_p->dim_Primary_Off_ART * sizeof(double));
  SET_VECTOR_ELT(state, 285, ScalarInteger(main_model_p->offset_output_Primary_Off_ART));
  SET_VECTOR_ELT(state, 286, ScalarInteger(main_model_p->dim_CD4_above_500_Off_ART));
  SET_VECTOR_ELT(state, 287, allocVector(REALSXP, main_model_p->dim_CD4_above_500_Off_ART));
  memcpy(REAL(VECTOR_ELT(state, 287)), main_model_p->CD4_above_500_Off_ART, main_model_p->dim_CD4_above_500_Off_ART * sizeof(double));
  SET_VECTOR_ELT(state, 288, ScalarInteger(main_model_p->offset_output_CD4_above_500_Off_ART));
  SET_VECTOR_ELT(state, 289, ScalarInteger(main_model_p->dim_CD4_350_500_Off_ART));
  SET_VECTOR_ELT(state, 290, allocVector(REALSXP, main_model_p->dim_CD4_350_500_Off_ART));
  memcpy(REAL(VECTOR_ELT(state, 290)), main_model_p->CD4_350_500_Off_ART, main_model_p->dim_CD4_350_500_Off_ART * sizeof(double));
  SET_VECTOR_ELT(state, 291, ScalarInteger(main_model_p->offset_output_CD4_350_500_Off_ART));
  SET_VECTOR_ELT(state, 292, ScalarInteger(main_model_p->dim_CD4_200_350_Off_ART));
  SET_VECTOR_ELT(state, 293, allocVector(REALSXP, main_model_p->dim_CD4_200_350_Off_ART));
  memcpy(REAL(VECTOR_ELT(state, 293)), main_model_p->CD4_200_350_Off_ART, main_model_p->dim_CD4_200_350_Off_ART * sizeof(double));
  SET_VECTOR_ELT(state, 294, ScalarInteger(main_model_p->offset_output_CD4_200_350_Off_ART));
  SET_VECTOR_ELT(state, 295, ScalarInteger(main_model_p->dim_CD4_below_200_Off_ART));
  SET_VECTOR_ELT(state, 296, allocVector(REALSXP, main_model_p->dim_CD4_below_200_Off_ART));
  memcpy(REAL(VECTOR_ELT(state, 296)), main_model_p->CD4_below_200_Off_ART, main_model_p->dim_CD4_below_200_Off_ART * sizeof(double));
  SET_VECTOR_ELT(state, 297, ScalarInteger(main_model_p->offset_output_CD4_below_200_Off_ART));
  SET_VECTOR_ELT(state, 298, ScalarInteger(main_model_p->dim_HIV_positive_On_ART));
  SET_VECTOR_ELT(state, 299, allocVector(REALSXP, main_model_p->dim_HIV_positive_On_ART));
  memcpy(REAL(VECTOR_ELT(state, 299)), main_model_p->HIV_positive_On_ART, main_model_p->dim_HIV_positive_On_ART * sizeof(double));
  SET_VECTOR_ELT(state, 300, ScalarInteger(main_model_p->offset_output_HIV_positive_On_ART));
  SET_VECTOR_ELT(state, 301, ScalarInteger(main_model_p->dim_Number_DALY_W1));
  SET_VECTOR_ELT(state, 302, allocVector(REALSXP, main_model_p->dim_Number_DALY_W1));
  memcpy(REAL(VECTOR_ELT(state, 302)), main_model_p->Number_DALY_W1, main_model_p->dim_Number_DALY_W1 * sizeof(double));
  SET_VECTOR_ELT(state, 303, ScalarInteger(main_model_p->offset_output_Number_DALY_W1));
  SET_VECTOR_ELT(state, 304, ScalarInteger(main_model_p->dim_Number_DALY_W2));
  SET_VECTOR_ELT(state, 305, allocVector(REALSXP, main_model_p->dim_Number_DALY_W2));
  memcpy(REAL(VECTOR_ELT(state, 305)), main_model_p->Number_DALY_W2, main_model_p->dim_Number_DALY_W2 * sizeof(double));
  SET_VECTOR_ELT(state, 306, ScalarInteger(main_model_p->offset_output_Number_DALY_W2));
  SET_VECTOR_ELT(state, 307, ScalarInteger(main_model_p->dim_Number_DALY_W3));
  SET_VECTOR_ELT(state, 308, allocVector(REALSXP, main_model_p->dim_Number_DALY_W3));
  memcpy(REAL(VECTOR_ELT(state, 308)), main_model_p->Number_DALY_W3, main_model_p->dim_Number_DALY_W3 * sizeof(double));
  SET_VECTOR_ELT(state, 309, ScalarInteger(main_model_p->offset_output_Number_DALY_W3));
  SET_VECTOR_ELT(state, 310, ScalarInteger(main_model_p->dim_cumuDeaths_On_ART));
  SET_VECTOR_ELT(state, 311, allocVector(REALSXP, main_model_p->dim_cumuDeaths_On_ART));
  memcpy(REAL(VECTOR_ELT(state, 311)), main_model_p->initial_cumuDeaths_On_ART, main_model_p->dim_cumuDeaths_On_ART * sizeof(double));
  SET_VECTOR_ELT(state, 312, ScalarInteger(main_model_p->offset_cumuDeaths_On_ART));
  SET_VECTOR_ELT(state, 313, ScalarInteger(main_model_p->dim_cumuARTinitiations_not_TasP));
  SET_VECTOR_ELT(state, 314, allocVector(REALSXP, main_model_p->dim_cumuARTinitiations_not_TasP));
  memcpy(REAL(VECTOR_ELT(state, 314)), main_model_p->initial_cumuARTinitiations_not_TasP, main_model_p->dim_cumuARTinitiations_not_TasP * sizeof(double));
  SET_VECTOR_ELT(state, 315, ScalarInteger(main_model_p->offset_cumuARTinitiations_not_TasP));
  SET_VECTOR_ELT(state, 316, ScalarInteger(main_model_p->dim_cumu_PrEP_dropouts));
  SET_VECTOR_ELT(state, 317, allocVector(REALSXP, main_model_p->dim_cumu_PrEP_dropouts));
  memcpy(REAL(VECTOR_ELT(state, 317)), main_model_p->initial_cumu_PrEP_dropouts, main_model_p->dim_cumu_PrEP_dropouts * sizeof(double));
  SET_VECTOR_ELT(state, 318, ScalarInteger(main_model_p->offset_cumu_PrEP_dropouts));
  SET_VECTOR_ELT(state, 319, ScalarInteger(main_model_p->dim_S0_infections));
  SET_VECTOR_ELT(state, 320, allocVector(REALSXP, main_model_p->dim_S0_infections));
  memcpy(REAL(VECTOR_ELT(state, 320)), main_model_p->initial_S0_infections, main_model_p->dim_S0_infections * sizeof(double));
  SET_VECTOR_ELT(state, 321, ScalarInteger(main_model_p->offset_S0_infections));
  SET_VECTOR_ELT(state, 322, ScalarInteger(main_model_p->dim_S1a_infections));
  SET_VECTOR_ELT(state, 323, allocVector(REALSXP, main_model_p->dim_S1a_infections));
  memcpy(REAL(VECTOR_ELT(state, 323)), main_model_p->initial_S1a_infections, main_model_p->dim_S1a_infections * sizeof(double));
  SET_VECTOR_ELT(state, 324, ScalarInteger(main_model_p->offset_S1a_infections));
  SET_VECTOR_ELT(state, 325, ScalarInteger(main_model_p->dim_S1b_infections));
  SET_VECTOR_ELT(state, 326, allocVector(REALSXP, main_model_p->dim_S1b_infections));
  memcpy(REAL(VECTOR_ELT(state, 326)), main_model_p->initial_S1b_infections, main_model_p->dim_S1b_infections * sizeof(double));
  SET_VECTOR_ELT(state, 327, ScalarInteger(main_model_p->offset_S1b_infections));
  SET_VECTOR_ELT(state, 328, ScalarInteger(main_model_p->dim_S1c_infections));
  SET_VECTOR_ELT(state, 329, allocVector(REALSXP, main_model_p->dim_S1c_infections));
  memcpy(REAL(VECTOR_ELT(state, 329)), main_model_p->initial_S1c_infections, main_model_p->dim_S1c_infections * sizeof(double));
  SET_VECTOR_ELT(state, 330, ScalarInteger(main_model_p->offset_S1c_infections));
  SET_VECTOR_ELT(state, 331, ScalarInteger(main_model_p->dim_S1d_infections));
  SET_VECTOR_ELT(state, 332, allocVector(REALSXP, main_model_p->dim_S1d_infections));
  memcpy(REAL(VECTOR_ELT(state, 332)), main_model_p->initial_S1d_infections, main_model_p->dim_S1d_infections * sizeof(double));
  SET_VECTOR_ELT(state, 333, ScalarInteger(main_model_p->offset_S1d_infections));
  SET_VECTOR_ELT(state, 334, ScalarInteger(main_model_p->dim_frac_F));
  SET_VECTOR_ELT(state, 335, allocVector(REALSXP, main_model_p->dim_frac_F));
  memcpy(REAL(VECTOR_ELT(state, 335)), main_model_p->frac_F, main_model_p->dim_frac_F * sizeof(double));
  SET_VECTOR_ELT(state, 336, ScalarInteger(main_model_p->offset_output_frac_F));
  SET_VECTOR_ELT(state, 337, ScalarInteger(main_model_p->dim_frac_N_sexualpop));
  SET_VECTOR_ELT(state, 338, allocVector(REALSXP, main_model_p->dim_frac_N_sexualpop));
  memcpy(REAL(VECTOR_ELT(state, 338)), main_model_p->frac_N_sexualpop, main_model_p->dim_frac_N_sexualpop * sizeof(double));
  SET_VECTOR_ELT(state, 339, ScalarInteger(main_model_p->offset_output_frac_N_sexualpop));
  SET_VECTOR_ELT(state, 340, ScalarInteger(main_model_p->dim_ART_coverage));
  SET_VECTOR_ELT(state, 341, allocVector(REALSXP, main_model_p->dim_ART_coverage));
  memcpy(REAL(VECTOR_ELT(state, 341)), main_model_p->ART_coverage, main_model_p->dim_ART_coverage * sizeof(double));
  SET_VECTOR_ELT(state, 342, ScalarInteger(main_model_p->offset_output_ART_coverage));
  SET_VECTOR_ELT(state, 343, ScalarInteger(main_model_p->dim_infect_ART));
  SET_VECTOR_ELT(state, 344, allocVector(REALSXP, main_model_p->dim_infect_ART));
  memcpy(REAL(VECTOR_ELT(state, 344)), main_model_p->infect_ART, main_model_p->dim_infect_ART * sizeof(double));
  SET_VECTOR_ELT(state, 345, ScalarInteger(main_model_p->offset_output_infect_ART));
  SET_VECTOR_ELT(state, 346, ScalarInteger(main_model_p->dim_prep_offered));
  SET_VECTOR_ELT(state, 347, allocVector(REALSXP, main_model_p->dim_prep_offered));
  memcpy(REAL(VECTOR_ELT(state, 347)), main_model_p->prep_offered, main_model_p->dim_prep_offered * sizeof(double));
  SET_VECTOR_ELT(state, 348, ScalarInteger(main_model_p->offset_output_prep_offered));
  SET_VECTOR_ELT(state, 349, ScalarInteger(main_model_p->dim_omega));
  SET_VECTOR_ELT(state, 350, allocVector(REALSXP, main_model_p->dim_omega));
  memcpy(REAL(VECTOR_ELT(state, 350)), main_model_p->omega, main_model_p->dim_omega * sizeof(double));
  SET_VECTOR_ELT(state, 351, ScalarInteger(main_model_p->offset_output_omega));
  SET_VECTOR_ELT(state, 352, ScalarInteger(main_model_p->dim_frac_N));
  SET_VECTOR_ELT(state, 353, allocVector(REALSXP, main_model_p->dim_frac_N));
  memcpy(REAL(VECTOR_ELT(state, 353)), main_model_p->frac_N, main_model_p->dim_frac_N * sizeof(double));
  SET_VECTOR_ELT(state, 354, ScalarInteger(main_model_p->offset_output_frac_N));
  SET_VECTOR_ELT(state, 355, ScalarInteger(main_model_p->dim_mu));
  SET_VECTOR_ELT(state, 356, allocVector(REALSXP, main_model_p->dim_mu));
  memcpy(REAL(VECTOR_ELT(state, 356)), main_model_p->mu, main_model_p->dim_mu * sizeof(double));
  SET_VECTOR_ELT(state, 357, ScalarInteger(main_model_p->offset_output_mu));
  SET_VECTOR_ELT(state, 358, ScalarInteger(main_model_p->dim_gamma01));
  SET_VECTOR_ELT(state, 359, allocVector(REALSXP, main_model_p->dim_gamma01));
  memcpy(REAL(VECTOR_ELT(state, 359)), main_model_p->gamma01, main_model_p->dim_gamma01 * sizeof(double));
  SET_VECTOR_ELT(state, 360, ScalarInteger(main_model_p->offset_output_gamma01));
  SET_VECTOR_ELT(state, 361, ScalarInteger(main_model_p->dim_gamma02));
  SET_VECTOR_ELT(state, 362, allocVector(REALSXP, main_model_p->dim_gamma02));
  memcpy(REAL(VECTOR_ELT(state, 362)), main_model_p->gamma02, main_model_p->dim_gamma02 * sizeof(double));
  SET_VECTOR_ELT(state, 363, ScalarInteger(main_model_p->dim_gamma03));
  SET_VECTOR_ELT(state, 364, allocVector(REALSXP, main_model_p->dim_gamma03));
  memcpy(REAL(VECTOR_ELT(state, 364)), main_model_p->gamma03, main_model_p->dim_gamma03 * sizeof(double));
  SET_VECTOR_ELT(state, 365, ScalarInteger(main_model_p->dim_gamma04));
  SET_VECTOR_ELT(state, 366, allocVector(REALSXP, main_model_p->dim_gamma04));
  memcpy(REAL(VECTOR_ELT(state, 366)), main_model_p->gamma04, main_model_p->dim_gamma04 * sizeof(double));
  SET_VECTOR_ELT(state, 367, ScalarInteger(main_model_p->dim_gamma11));
  SET_VECTOR_ELT(state, 368, allocVector(REALSXP, main_model_p->dim_gamma11));
  memcpy(REAL(VECTOR_ELT(state, 368)), main_model_p->gamma11, main_model_p->dim_gamma11 * sizeof(double));
  SET_VECTOR_ELT(state, 369, ScalarInteger(main_model_p->offset_output_gamma11));
  SET_VECTOR_ELT(state, 370, ScalarInteger(main_model_p->dim_gamma22));
  SET_VECTOR_ELT(state, 371, allocVector(REALSXP, main_model_p->dim_gamma22));
  memcpy(REAL(VECTOR_ELT(state, 371)), main_model_p->gamma22, main_model_p->dim_gamma22 * sizeof(double));
  SET_VECTOR_ELT(state, 372, ScalarInteger(main_model_p->dim_gamma23));
  SET_VECTOR_ELT(state, 373, allocVector(REALSXP, main_model_p->dim_gamma23));
  memcpy(REAL(VECTOR_ELT(state, 373)), main_model_p->gamma23, main_model_p->dim_gamma23 * sizeof(double));
  SET_VECTOR_ELT(state, 374, ScalarInteger(main_model_p->dim_gamma24));
  SET_VECTOR_ELT(state, 375, allocVector(REALSXP, main_model_p->dim_gamma24));
  memcpy(REAL(VECTOR_ELT(state, 375)), main_model_p->gamma24, main_model_p->dim_gamma24 * sizeof(double));
  SET_VECTOR_ELT(state, 376, ScalarInteger(main_model_p->dim_gamma32));
  SET_VECTOR_ELT(state, 377, allocVector(REALSXP, main_model_p->dim_gamma32));
  memcpy(REAL(VECTOR_ELT(state, 377)), main_model_p->gamma32, main_model_p->dim_gamma32 * sizeof(double));
  SET_VECTOR_ELT(state, 378, ScalarInteger(main_model_p->offset_output_gamma32));
  SET_VECTOR_ELT(state, 379, ScalarInteger(main_model_p->dim_gamma33));
  SET_VECTOR_ELT(state, 380, allocVector(REALSXP, main_model_p->dim_gamma33));
  memcpy(REAL(VECTOR_ELT(state, 380)), main_model_p->gamma33, main_model_p->dim_gamma33 * sizeof(double));
  SET_VECTOR_ELT(state, 381, ScalarInteger(main_model_p->offset_output_gamma33));
  SET_VECTOR_ELT(state, 382, ScalarInteger(main_model_p->dim_gamma34));
  SET_VECTOR_ELT(state, 383, allocVector(REALSXP, main_model_p->dim_gamma34));
  memcpy(REAL(VECTOR_ELT(state, 383)), main_model_p->gamma34, main_model_p->dim_gamma34 * sizeof(double));
  SET_VECTOR_ELT(state, 384, ScalarInteger(main_model_p->offset_output_gamma34));
  SET_VECTOR_ELT(state, 385, ScalarInteger(main_model_p->dim_gamma42));
  SET_VECTOR_ELT(state, 386, allocVector(REALSXP, main_model_p->dim_gamma42));
  memcpy(REAL(VECTOR_ELT(state, 386)), main_model_p->gamma42, main_model_p->dim_gamma42 * sizeof(double));
  SET_VECTOR_ELT(state, 387, ScalarInteger(main_model_p->dim_gamma43));
  SET_VECTOR_ELT(state, 388, allocVector(REALSXP, main_model_p->dim_gamma43));
  memcpy(REAL(VECTOR_ELT(state, 388)), main_model_p->gamma43, main_model_p->dim_gamma43 * sizeof(double));
  SET_VECTOR_ELT(state, 389, ScalarInteger(main_model_p->dim_gamma44));
  SET_VECTOR_ELT(state, 390, allocVector(REALSXP, main_model_p->dim_gamma44));
  memcpy(REAL(VECTOR_ELT(state, 390)), main_model_p->gamma44, main_model_p->dim_gamma44 * sizeof(double));
  SET_VECTOR_ELT(state, 391, ScalarInteger(main_model_p->dim_phi2));
  SET_VECTOR_ELT(state, 392, allocVector(REALSXP, main_model_p->dim_phi2));
  memcpy(REAL(VECTOR_ELT(state, 392)), main_model_p->phi2, main_model_p->dim_phi2 * sizeof(double));
  SET_VECTOR_ELT(state, 393, ScalarInteger(main_model_p->offset_output_phi2));
  SET_VECTOR_ELT(state, 394, ScalarInteger(main_model_p->dim_phi3));
  SET_VECTOR_ELT(state, 395, allocVector(REALSXP, main_model_p->dim_phi3));
  memcpy(REAL(VECTOR_ELT(state, 395)), main_model_p->phi3, main_model_p->dim_phi3 * sizeof(double));
  SET_VECTOR_ELT(state, 396, ScalarInteger(main_model_p->dim_phi4));
  SET_VECTOR_ELT(state, 397, allocVector(REALSXP, main_model_p->dim_phi4));
  memcpy(REAL(VECTOR_ELT(state, 397)), main_model_p->phi4, main_model_p->dim_phi4 * sizeof(double));
  SET_VECTOR_ELT(state, 398, ScalarInteger(main_model_p->dim_phi5));
  SET_VECTOR_ELT(state, 399, allocVector(REALSXP, main_model_p->dim_phi5));
  memcpy(REAL(VECTOR_ELT(state, 399)), main_model_p->phi5, main_model_p->dim_phi5 * sizeof(double));
  SET_VECTOR_ELT(state, 400, ScalarInteger(main_model_p->dim_psia));
  SET_VECTOR_ELT(state, 401, allocVector(REALSXP, main_model_p->dim_psia));
  memcpy(REAL(VECTOR_ELT(state, 401)), main_model_p->psia, main_model_p->dim_psia * sizeof(double));
  SET_VECTOR_ELT(state, 402, ScalarInteger(main_model_p->dim_psib));
  SET_VECTOR_ELT(state, 403, allocVector(REALSXP, main_model_p->dim_psib));
  memcpy(REAL(VECTOR_ELT(state, 403)), main_model_p->psib, main_model_p->dim_psib * sizeof(double));
  SET_VECTOR_ELT(state, 404, ScalarInteger(main_model_p->dim_kappaa));
  SET_VECTOR_ELT(state, 405, allocVector(REALSXP, main_model_p->dim_kappaa));
  memcpy(REAL(VECTOR_ELT(state, 405)), main_model_p->kappaa, main_model_p->dim_kappaa * sizeof(double));
  SET_VECTOR_ELT(state, 406, ScalarInteger(main_model_p->offset_output_kappaa));
  SET_VECTOR_ELT(state, 407, ScalarInteger(main_model_p->dim_kappab));
  SET_VECTOR_ELT(state, 408, allocVector(REALSXP, main_model_p->dim_kappab));
  memcpy(REAL(VECTOR_ELT(state, 408)), main_model_p->kappab, main_model_p->dim_kappab * sizeof(double));
  SET_VECTOR_ELT(state, 409, ScalarInteger(main_model_p->offset_output_kappab));
  SET_VECTOR_ELT(state, 410, ScalarInteger(main_model_p->dim_kappac));
  SET_VECTOR_ELT(state, 411, allocVector(REALSXP, main_model_p->dim_kappac));
  memcpy(REAL(VECTOR_ELT(state, 411)), main_model_p->kappac, main_model_p->dim_kappac * sizeof(double));
  SET_VECTOR_ELT(state, 412, ScalarInteger(main_model_p->offset_output_kappac));
  SET_VECTOR_ELT(state, 413, ScalarInteger(main_model_p->dim_kappa1));
  SET_VECTOR_ELT(state, 414, allocVector(REALSXP, main_model_p->dim_kappa1));
  memcpy(REAL(VECTOR_ELT(state, 414)), main_model_p->kappa1, main_model_p->dim_kappa1 * sizeof(double));
  SET_VECTOR_ELT(state, 415, ScalarInteger(main_model_p->offset_output_kappa1));
  SET_VECTOR_ELT(state, 416, ScalarInteger(main_model_p->dim_alpha01));
  SET_VECTOR_ELT(state, 417, allocVector(REALSXP, main_model_p->dim_alpha01));
  memcpy(REAL(VECTOR_ELT(state, 417)), main_model_p->alpha01, main_model_p->dim_alpha01 * sizeof(double));
  SET_VECTOR_ELT(state, 418, ScalarInteger(main_model_p->offset_output_alpha01));
  SET_VECTOR_ELT(state, 419, ScalarInteger(main_model_p->dim_alpha02));
  SET_VECTOR_ELT(state, 420, allocVector(REALSXP, main_model_p->dim_alpha02));
  memcpy(REAL(VECTOR_ELT(state, 420)), main_model_p->alpha02, main_model_p->dim_alpha02 * sizeof(double));
  SET_VECTOR_ELT(state, 421, ScalarInteger(main_model_p->offset_output_alpha02));
  SET_VECTOR_ELT(state, 422, ScalarInteger(main_model_p->dim_alpha03));
  SET_VECTOR_ELT(state, 423, allocVector(REALSXP, main_model_p->dim_alpha03));
  memcpy(REAL(VECTOR_ELT(state, 423)), main_model_p->alpha03, main_model_p->dim_alpha03 * sizeof(double));
  SET_VECTOR_ELT(state, 424, ScalarInteger(main_model_p->dim_alpha04));
  SET_VECTOR_ELT(state, 425, allocVector(REALSXP, main_model_p->dim_alpha04));
  memcpy(REAL(VECTOR_ELT(state, 425)), main_model_p->alpha04, main_model_p->dim_alpha04 * sizeof(double));
  SET_VECTOR_ELT(state, 426, ScalarInteger(main_model_p->dim_alpha05));
  SET_VECTOR_ELT(state, 427, allocVector(REALSXP, main_model_p->dim_alpha05));
  memcpy(REAL(VECTOR_ELT(state, 427)), main_model_p->alpha05, main_model_p->dim_alpha05 * sizeof(double));
  SET_VECTOR_ELT(state, 428, ScalarInteger(main_model_p->offset_output_alpha05));
  SET_VECTOR_ELT(state, 429, ScalarInteger(main_model_p->dim_alpha11));
  SET_VECTOR_ELT(state, 430, allocVector(REALSXP, main_model_p->dim_alpha11));
  memcpy(REAL(VECTOR_ELT(state, 430)), main_model_p->alpha11, main_model_p->dim_alpha11 * sizeof(double));
  SET_VECTOR_ELT(state, 431, ScalarInteger(main_model_p->offset_output_alpha11));
  SET_VECTOR_ELT(state, 432, ScalarInteger(main_model_p->dim_alpha22));
  SET_VECTOR_ELT(state, 433, allocVector(REALSXP, main_model_p->dim_alpha22));
  memcpy(REAL(VECTOR_ELT(state, 433)), main_model_p->alpha22, main_model_p->dim_alpha22 * sizeof(double));
  SET_VECTOR_ELT(state, 434, ScalarInteger(main_model_p->offset_output_alpha22));
  SET_VECTOR_ELT(state, 435, ScalarInteger(main_model_p->dim_alpha23));
  SET_VECTOR_ELT(state, 436, allocVector(REALSXP, main_model_p->dim_alpha23));
  memcpy(REAL(VECTOR_ELT(state, 436)), main_model_p->alpha23, main_model_p->dim_alpha23 * sizeof(double));
  SET_VECTOR_ELT(state, 437, ScalarInteger(main_model_p->dim_alpha24));
  SET_VECTOR_ELT(state, 438, allocVector(REALSXP, main_model_p->dim_alpha24));
  memcpy(REAL(VECTOR_ELT(state, 438)), main_model_p->alpha24, main_model_p->dim_alpha24 * sizeof(double));
  SET_VECTOR_ELT(state, 439, ScalarInteger(main_model_p->dim_alpha25));
  SET_VECTOR_ELT(state, 440, allocVector(REALSXP, main_model_p->dim_alpha25));
  memcpy(REAL(VECTOR_ELT(state, 440)), main_model_p->alpha25, main_model_p->dim_alpha25 * sizeof(double));
  SET_VECTOR_ELT(state, 441, ScalarInteger(main_model_p->dim_alpha32));
  SET_VECTOR_ELT(state, 442, allocVector(REALSXP, main_model_p->dim_alpha32));
  memcpy(REAL(VECTOR_ELT(state, 442)), main_model_p->alpha32, main_model_p->dim_alpha32 * sizeof(double));
  SET_VECTOR_ELT(state, 443, ScalarInteger(main_model_p->dim_alpha33));
  SET_VECTOR_ELT(state, 444, allocVector(REALSXP, main_model_p->dim_alpha33));
  memcpy(REAL(VECTOR_ELT(state, 444)), main_model_p->alpha33, main_model_p->dim_alpha33 * sizeof(double));
  SET_VECTOR_ELT(state, 445, ScalarInteger(main_model_p->offset_output_alpha33));
  SET_VECTOR_ELT(state, 446, ScalarInteger(main_model_p->dim_alpha34));
  SET_VECTOR_ELT(state, 447, allocVector(REALSXP, main_model_p->dim_alpha34));
  memcpy(REAL(VECTOR_ELT(state, 447)), main_model_p->alpha34, main_model_p->dim_alpha34 * sizeof(double));
  SET_VECTOR_ELT(state, 448, ScalarInteger(main_model_p->offset_output_alpha34));
  SET_VECTOR_ELT(state, 449, ScalarInteger(main_model_p->dim_alpha35));
  SET_VECTOR_ELT(state, 450, allocVector(REALSXP, main_model_p->dim_alpha35));
  memcpy(REAL(VECTOR_ELT(state, 450)), main_model_p->alpha35, main_model_p->dim_alpha35 * sizeof(double));
  SET_VECTOR_ELT(state, 451, ScalarInteger(main_model_p->offset_output_alpha35));
  SET_VECTOR_ELT(state, 452, ScalarInteger(main_model_p->dim_alpha42));
  SET_VECTOR_ELT(state, 453, allocVector(REALSXP, main_model_p->dim_alpha42));
  memcpy(REAL(VECTOR_ELT(state, 453)), main_model_p->alpha42, main_model_p->dim_alpha42 * sizeof(double));
  SET_VECTOR_ELT(state, 454, ScalarInteger(main_model_p->dim_alpha43));
  SET_VECTOR_ELT(state, 455, allocVector(REALSXP, main_model_p->dim_alpha43));
  memcpy(REAL(VECTOR_ELT(state, 455)), main_model_p->alpha43, main_model_p->dim_alpha43 * sizeof(double));
  SET_VECTOR_ELT(state, 456, ScalarInteger(main_model_p->dim_alpha44));
  SET_VECTOR_ELT(state, 457, allocVector(REALSXP, main_model_p->dim_alpha44));
  memcpy(REAL(VECTOR_ELT(state, 457)), main_model_p->alpha44, main_model_p->dim_alpha44 * sizeof(double));
  SET_VECTOR_ELT(state, 458, ScalarInteger(main_model_p->dim_alpha45));
  SET_VECTOR_ELT(state, 459, allocVector(REALSXP, main_model_p->dim_alpha45));
  memcpy(REAL(VECTOR_ELT(state, 459)), main_model_p->alpha45, main_model_p->dim_alpha45 * sizeof(double));
  SET_VECTOR_ELT(state, 460, ScalarInteger(main_model_p->dim_beta_comm));
  SET_VECTOR_ELT(state, 461, allocVector(REALSXP, main_model_p->dim_beta_comm));
  memcpy(REAL(VECTOR_ELT(state, 461)), main_model_p->beta_comm, main_model_p->dim_beta_comm * sizeof(double));
  SET_VECTOR_ELT(state, 462, ScalarInteger(main_model_p->offset_output_beta_comm));
  SET_VECTOR_ELT(state, 463, ScalarInteger(main_model_p->dim_beta_noncomm));
  SET_VECTOR_ELT(state, 464, allocVector(REALSXP, main_model_p->dim_beta_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 464)), main_model_p->beta_noncomm, main_model_p->dim_beta_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 465, ScalarInteger(main_model_p->offset_output_beta_noncomm));
  ...
  SET_STRING_ELT(state_names, 200, mkChar("dim_c_comm"));
  SET_STRING_ELT(state_names, 201, mkChar("c_comm"));
  SET_STRING_ELT(state_names, 202, mkChar("offset_output_c_comm"));
  SET_STRING_ELT(state_names, 203, mkChar("dim_c_noncomm"));
  SET_STRING_ELT(state_names, 204, mkChar("c_noncomm"));
  SET_STRING_ELT(state_names, 205, mkChar("offset_output_c_noncomm"));
  SET_STRING_ELT(state_names, 206, mkChar("dim_pfFSW"));
  SET_STRING_ELT(state_names, 207, mkChar("pfFSW"));
  SET_STRING_ELT(state_names, 208, mkChar("offset_output_pfFSW"));
  SET_STRING_ELT(state_names, 209, mkChar("dim_new_acute_infected"));
  SET_STRING_ELT(state_names, 210, mkChar("new_acute_infected"));
  SET_STRING_ELT(state_names, 211, mkChar("offset_output_new_acute_infected"));
  SET_STRING_ELT(state_names, 212, mkChar("dim_rate_leave_pro_FSW_weight_by_PrEP"));
  SET_STRING_ELT(state_names, 213, mkChar("rate_leave_pro_FSW_weight_by_PrEP"));
  SET_STRING_ELT(state_names, 214, mkChar("offset_output_rate_leave_pro_FSW_weight_by_PrEP"));
  SET_STRING_ELT(state_names, 215, mkChar("dim_FSW_ONLY"));
  SET_STRING_ELT(state_names, 216, mkChar("FSW_ONLY"));
  SET_STRING_ELT(state_names, 217, mkChar("dim_new_people_in_group"));
  SET_STRING_ELT(state_names, 218, mkChar("new_people_in_group"));
  SET_STRING_ELT(state_names, 219, mkChar("offset_output_new_people_in_group"));
  SET_STRING_ELT(state_names, 220, mkChar("dim_new_people_in_group_FSW_only"));
  SET_STRING_ELT(state_names, 221, mkChar("new_people_in_group_FSW_only"));
  SET_STRING_ELT(state_names, 222, mkChar("offset_output_new_people_in_group_FSW_only"));
  SET_STRING_ELT(state_names, 223, mkChar("dim_comm_partnerships_requested"));
  SET_STRING_ELT(state_names, 224, mkChar("dim_comm_partnerships_requested_1"));
  SET_STRING_ELT(state_names, 225, mkChar("dim_comm_partnerships_requested_2"));
  SET_STRING_ELT(state_names, 226, mkChar("comm_partnerships_requested"));
  SET_STRING_ELT(state_names, 227, mkChar("dim_noncomm_partnerships_requested"));
  SET_STRING_ELT(state_names, 228, mkChar("dim_noncomm_partnerships_requested_1"));
  SET_STRING_ELT(state_names, 229, mkChar("dim_noncomm_partnerships_requested_2"));
  SET_STRING_ELT(state_names, 230, mkChar("noncomm_partnerships_requested"));
  SET_STRING_ELT(state_names, 231, mkChar("dim_above_500_by_group"));
  SET_STRING_ELT(state_names, 232, mkChar("above_500_by_group"));
  SET_STRING_ELT(state_names, 233, mkChar("offset_output_above_500_by_group"));
  SET_STRING_ELT(state_names, 234, mkChar("dim_testing_prob"));
  SET_STRING_ELT(state_names, 235, mkChar("testing_prob"));
  SET_STRING_ELT(state_names, 236, mkChar("offset_output_testing_prob"));
  SET_STRING_ELT(state_names, 237, mkChar("dim_zeta_re"));
  SET_STRING_ELT(state_names, 238, mkChar("zeta_re"));
  SET_STRING_ELT(state_names, 239, mkChar("offset_output_zeta_re"));
  SET_STRING_ELT(state_names, 240, mkChar("dim_tau_intervention"));
  SET_STRING_ELT(state_names, 241, mkChar("tau_intervention"));
  SET_STRING_ELT(state_names, 242, mkChar("offset_output_tau_intervention"));
  SET_STRING_ELT(state_names, 243, mkChar("dim_rho_intervention"));
  SET_STRING_ELT(state_names, 244, mkChar("rho_intervention"));
  SET_STRING_ELT(state_names, 245, mkChar("offset_output_rho_intervention"));
  SET_STRING_ELT(state_names, 246, mkChar("dim_zeta"));
  SET_STRING_ELT(state_names, 247, mkChar("zeta"));
  SET_STRING_ELT(state_names, 248, mkChar("offset_output_zeta"));
  SET_STRING_ELT(state_names, 249, mkChar("dim_sigma"));
  SET_STRING_ELT(state_names, 250, mkChar("sigma"));
  SET_STRING_ELT(state_names, 251, mkChar("dim_eP1a_effective"));
  SET_STRING_ELT(state_names, 252, mkChar("eP1a_effective"));
  SET_STRING_ELT(state_names, 253, mkChar("offset_output_eP1a_effective"));
  SET_STRING_ELT(state_names, 254, mkChar("dim_eP1b_effective"));
  SET_STRING_ELT(state_names, 255, mkChar("eP1b_effective"));
  SET_STRING_ELT(state_names, 256, mkChar("offset_output_eP1b_effective"));
  SET_STRING_ELT(state_names, 257, mkChar("dim_eP1c_effective"));
  SET_STRING_ELT(state_names, 258, mkChar("eP1c_effective"));
  SET_STRING_ELT(state_names, 259, mkChar("offset_output_eP1c_effective"));
  SET_STRING_ELT(state_names, 260, mkChar("dim_tau"));
  SET_STRING_ELT(state_names, 261, mkChar("tau"));
  SET_STRING_ELT(state_names, 262, mkChar("offset_output_tau"));
  SET_STRING_ELT(state_names, 263, mkChar("dim_test_rate_prep"));
  SET_STRING_ELT(state_names, 264, mkChar("test_rate_prep"));
  SET_STRING_ELT(state_names, 265, mkChar("dim_rho"));
  SET_STRING_ELT(state_names, 266, mkChar("rho"));
  SET_STRING_ELT(state_names, 267, mkChar("offset_output_rho"));
  SET_STRING_ELT(state_names, 268, mkChar("dim_iota"));
  SET_STRING_ELT(state_names, 269, mkChar("iota"));
  SET_STRING_ELT(state_names, 270, mkChar("offset_output_iota"));
  SET_STRING_ELT(state_names, 271, mkChar("dim_viral_supp"));
  SET_STRING_ELT(state_names, 272, mkChar("viral_supp"));
  SET_STRING_ELT(state_names, 273, mkChar("offset_output_viral_supp"));
  SET_STRING_ELT(state_names, 274, mkChar("dim_HIV_positive"));
  SET_STRING_ELT(state_names, 275, mkChar("HIV_positive"));
  SET_STRING_ELT(state_names, 276, mkChar("offset_output_HIV_positive"));
  SET_STRING_ELT(state_names, 277, mkChar("dim_Number_Susceptibles"));
  SET_STRING_ELT(state_names, 278, mkChar("Number_Susceptibles"));
  SET_STRING_ELT(state_names, 279, mkChar("offset_output_Number_Susceptibles"));
  SET_STRING_ELT(state_names, 280, mkChar("dim_HIV_positive_Diagnosed_Off_ART"));
  SET_STRING_ELT(state_names, 281, mkChar("HIV_positive_Diagnosed_Off_ART"));
  SET_STRING_ELT(state_names, 282, mkChar("offset_output_HIV_positive_Diagnosed_Off_ART"));
  SET_STRING_ELT(state_names, 283, mkChar("dim_Primary_Off_ART"));
  SET_STRING_ELT(state_names, 284, mkChar("Primary_Off_ART"));
  SET_STRING_ELT(state_names, 285, mkChar("offset_output_Primary_Off_ART"));
  SET_STRING_ELT(state_names, 286, mkChar("dim_CD4_above_500_Off_ART"));
  SET_STRING_ELT(state_names, 287, mkChar("CD4_above_500_Off_ART"));
  SET_STRING_ELT(state_names, 288, mkChar("offset_output_CD4_above_500_Off_ART"));
  SET_STRING_ELT(state_names, 289, mkChar("dim_CD4_350_500_Off_ART"));
  SET_STRING_ELT(state_names, 290, mkChar("CD4_350_500_Off_ART"));
  SET_STRING_ELT(state_names, 291, mkChar("offset_output_CD4_350_500_Off_ART"));
  SET_STRING_ELT(state_names, 292, mkChar("dim_CD4_200_350_Off_ART"));
  SET_STRING_ELT(state_names, 293, mkChar("CD4_200_350_Off_ART"));
  SET_STRING_ELT(state_names, 294, mkChar("offset_output_CD4_200_350_Off_ART"));
  SET_STRING_ELT(state_names, 295, mkChar("dim_CD4_below_200_Off_ART"));
  SET_STRING_ELT(state_names, 296, mkChar("CD4_below_200_Off_ART"));
  SET_STRING_ELT(state_names, 297, mkChar("offset_output_CD4_below_200_Off_ART"));
  SET_STRING_ELT(state_names, 298, mkChar("dim_HIV_positive_On_ART"));
  SET_STRING_ELT(state_names, 299, mkChar("HIV_positive_On_ART"));
  SET_STRING_ELT(state_names, 300, mkChar("offset_output_HIV_positive_On_ART"));
  SET_STRING_ELT(state_names, 301, mkChar("dim_Number_DALY_W1"));
  SET_STRING_ELT(state_names, 302, mkChar("Number_DALY_W1"));
  SET_STRING_ELT(state_names, 303, mkChar("offset_output_Number_DALY_W1"));
  SET_STRING_ELT(state_names, 304, mkChar("dim_Number_DALY_W2"));
  SET_STRING_ELT(state_names, 305, mkChar("Number_DALY_W2"));
  SET_STRING_ELT(state_names, 306, mkChar("offset_output_Number_DALY_W2"));
  SET_STRING_ELT(state_names, 307, mkChar("dim_Number_DALY_W3"));
  SET_STRING_ELT(state_names, 308, mkChar("Number_DALY_W3"));
  SET_STRING_ELT(state_names, 309, mkChar("offset_output_Number_DALY_W3"));
  SET_STRING_ELT(state_names, 310, mkChar("dim_cumuDeaths_On_ART"));
  SET_STRING_ELT(state_names, 311, mkChar("initial_cumuDeaths_On_ART"));
  SET_STRING_ELT(state_names, 312, mkChar("offset_cumuDeaths_On_ART"));
  SET_STRING_ELT(state_names, 313, mkChar("dim_cumuARTinitiations_not_TasP"));
  SET_STRING_ELT(state_names, 314, mkChar("initial_cumuARTinitiations_not_TasP"));
  SET_STRING_ELT(state_names, 315, mkChar("offset_cumuARTinitiations_not_TasP"));
  SET_STRING_ELT(state_names, 316, mkChar("dim_cumu_PrEP_dropouts"));
  SET_STRING_ELT(state_names, 317, mkChar("initial_cumu_PrEP_dropouts"));
  SET_STRING_ELT(state_names, 318, mkChar("offset_cumu_PrEP_dropouts"));
  SET_STRING_ELT(state_names, 319, mkChar("dim_S0_infections"));
  SET_STRING_ELT(state_names, 320, mkChar("initial_S0_infections"));
  SET_STRING_ELT(state_names, 321, mkChar("offset_S0_infections"));
  SET_STRING_ELT(state_names, 322, mkChar("dim_S1a_infections"));
  SET_STRING_ELT(state_names, 323, mkChar("initial_S1a_infections"));
  SET_STRING_ELT(state_names, 324, mkChar("offset_S1a_infections"));
  SET_STRING_ELT(state_names, 325, mkChar("dim_S1b_infections"));
  SET_STRING_ELT(state_names, 326, mkChar("initial_S1b_infections"));
  SET_STRING_ELT(state_names, 327, mkChar("offset_S1b_infections"));
  SET_STRING_ELT(state_names, 328, mkChar("dim_S1c_infections"));
  SET_STRING_ELT(state_names, 329, mkChar("initial_S1c_infections"));
  SET_STRING_ELT(state_names, 330, mkChar("offset_S1c_infections"));
  SET_STRING_ELT(state_names, 331, mkChar("dim_S1d_infections"));
  SET_STRING_ELT(state_names, 332, mkChar("initial_S1d_infections"));
  SET_STRING_ELT(state_names, 333, mkChar("offset_S1d_infections"));
  SET_STRING_ELT(state_names, 334, mkChar("dim_frac_F"));
  SET_STRING_ELT(state_names, 335, mkChar("frac_F"));
  SET_STRING_ELT(state_names, 336, mkChar("offset_output_frac_F"));
  SET_STRING_ELT(state_names, 337, mkChar("dim_frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 338, mkChar("frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 339, mkChar("offset_output_frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 340, mkChar("dim_ART_coverage"));
  SET_STRING_ELT(state_names, 341, mkChar("ART_coverage"));
  SET_STRING_ELT(state_names, 342, mkChar("offset_output_ART_coverage"));
  SET_STRING_ELT(state_names, 343, mkChar("dim_infect_ART"));
  SET_STRING_ELT(state_names, 344, mkChar("infect_ART"));
  SET_STRING_ELT(state_names, 345, mkChar("offset_output_infect_ART"));
  SET_STRING_ELT(state_names, 346, mkChar("dim_prep_offered"));
  SET_STRING_ELT(state_names, 347, mkChar("prep_offered"));
  SET_STRING_ELT(state_names, 348, mkChar("offset_output_prep_offered"));
  SET_STRING_ELT(state_names, 349, mkChar("dim_omega"));
  SET_STRING_ELT(state_names, 350, mkChar("omega"));
  SET_STRING_ELT(state_names, 351, mkChar("offset_output_omega"));
  SET_STRING_ELT(state_names, 352, mkChar("dim_frac_N"));
  SET_STRING_ELT(state_names, 353, mkChar("frac_N"));
  SET_STRING_ELT(state_names, 354, mkChar("offset_output_frac_N"));
  SET_STRING_ELT(state_names, 355, mkChar("dim_mu"));
  SET_STRING_ELT(state_names, 356, mkChar("mu"));
  SET_STRING_ELT(state_names, 357, mkChar("offset_output_mu"));
  SET_STRING_ELT(state_names, 358, mkChar("dim_gamma01"));
  SET_STRING_ELT(state_names, 359, mkChar("gamma01"));
  SET_STRING_ELT(state_names, 360, mkChar("offset_output_gamma01"));
  SET_STRING_ELT(state_names, 361, mkChar("dim_gamma02"));
  SET_STRING_ELT(state_names, 362, mkChar("gamma02"));
  SET_STRING_ELT(state_names, 363, mkChar("dim_gamma03"));
  SET_STRING_ELT(state_names, 364, mkChar("gamma03"));
  SET_STRING_ELT(state_names, 365, mkChar("dim_gamma04"));
  SET_STRING_ELT(state_names, 366, mkChar("gamma04"));
  SET_STRING_ELT(state_names, 367, mkChar("dim_gamma11"));
  SET_STRING_ELT(state_names, 368, mkChar("gamma11"));
  SET_STRING_ELT(state_names, 369, mkChar("offset_output_gamma11"));
  SET_STRING_ELT(state_names, 370, mkChar("dim_gamma22"));
  SET_STRING_ELT(state_names, 371, mkChar("gamma22"));
  SET_STRING_ELT(state_names, 372, mkChar("dim_gamma23"));
  SET_STRING_ELT(state_names, 373, mkChar("gamma23"));
  SET_STRING_ELT(state_names, 374, mkChar("dim_gamma24"));
  SET_STRING_ELT(state_names, 375, mkChar("gamma24"));
  SET_STRING_ELT(state_names, 376, mkChar("dim_gamma32"));
  SET_STRING_ELT(state_names, 377, mkChar("gamma32"));
  SET_STRING_ELT(state_names, 378, mkChar("offset_output_gamma32"));
  SET_STRING_ELT(state_names, 379, mkChar("dim_gamma33"));
  SET_STRING_ELT(state_names, 380, mkChar("gamma33"));
  SET_STRING_ELT(state_names, 381, mkChar("offset_output_gamma33"));
  SET_STRING_ELT(state_names, 382, mkChar("dim_gamma34"));
  SET_STRING_ELT(state_names, 383, mkChar("gamma34"));
  SET_STRING_ELT(state_names, 384, mkChar("offset_output_gamma34"));
  SET_STRING_ELT(state_names, 385, mkChar("dim_gamma42"));
  SET_STRING_ELT(state_names, 386, mkChar("gamma42"));
  SET_STRING_ELT(state_names, 387, mkChar("dim_gamma43"));
  SET_STRING_ELT(state_names, 388, mkChar("gamma43"));
  SET_STRING_ELT(state_names, 389, mkChar("dim_gamma44"));
  SET_STRING_ELT(state_names, 390, mkChar("gamma44"));
  SET_STRING_ELT(state_names, 391, mkChar("dim_phi2"));
  SET_STRING_ELT(state_names, 392, mkChar("phi2"));
  SET_STRING_ELT(state_names, 393, mkChar("offset_output_phi2"));
  SET_STRING_ELT(state_names, 394, mkChar("dim_phi3"));
  SET_STRING_ELT(state_names, 395, mkChar("phi3"));
  SET_STRING_ELT(state_names, 396, mkChar("dim_phi4"));
  SET_STRING_ELT(state_names, 397, mkChar("phi4"));
  SET_STRING_ELT(state_names, 398, mkChar("dim_phi5"));
  SET_STRING_ELT(state_names, 399, mkChar("phi5"));
  SET_STRING_ELT(state_names, 400, mkChar("dim_psia"));
  SET_STRING_ELT(state_names, 401, mkChar("psia"));
  SET_STRING_ELT(state_names, 402, mkChar("dim_psib"));
  SET_STRING_ELT(state_names, 403, mkChar("psib"));
  SET_STRING_ELT(state_names, 404, mkChar("dim_kappaa"));
  SET_STRING_ELT(state_names, 405, mkChar("kappaa"));
  SET_STRING_ELT(state_names, 406, mkChar("offset_output_kappaa"));
  SET_STRING_ELT(state_names, 407, mkChar("dim_kappab"));
  SET_STRING_ELT(state_names, 408, mkChar("kappab"));
  SET_STRING_ELT(state_names, 409, mkChar("offset_output_kappab"));
  SET_STRING_ELT(state_names, 410, mkChar("dim_kappac"));
  SET_STRING_ELT(state_names, 411, mkChar("kappac"));
  SET_STRING_ELT(state_names, 412, mkChar("offset_output_kappac"));
  SET_STRING_ELT(state_names, 413, mkChar("dim_kappa1"));
  SET_STRING_ELT(state_names, 414, mkChar("kappa1"));
  SET_STRING_ELT(state_names, 415, mkChar("offset_output_kappa1"));
  SET_STRING_ELT(state_names, 416, mkChar("dim_alpha01"));
  SET_STRING_ELT(state_names, 417, mkChar("alpha01"));
  SET_STRING_ELT(state_names, 418, mkChar("offset_output_alpha01"));
  SET_STRING_ELT(state_names, 419, mkChar("dim_alpha02"));
  SET_STRING_ELT(state_names, 420, mkChar("alpha02"));
  SET_STRING_ELT(state_names, 421, mkChar("offset_output_alpha02"));
  SET_STRING_ELT(state_names, 422, mkChar("dim_alpha03"));
  SET_STRING_ELT(state_names, 423, mkChar("alpha03"));
  SET_STRING_ELT(state_names, 424, mkChar("dim_alpha04"));
  SET_STRING_ELT(state_names, 425, mkChar("alpha04"));
  SET_STRING_ELT(state_names, 426, mkChar("dim_alpha05"));
  SET_STRING_ELT(state_names, 427, mkChar("alpha05"));
  SET_STRING_ELT(state_names, 428, mkChar("offset_output_alpha05"));
  SET_STRING_ELT(state_names, 429, mkChar("dim_alpha11"));
  SET_STRING_ELT(state_names, 430, mkChar("alpha11"));
  SET_STRING_ELT(state_names, 431, mkChar("offset_output_alpha11"));
  SET_STRING_ELT(state_names, 432, mkChar("dim_alpha22"));
  SET_STRING_ELT(state_names, 433, mkChar("alpha22"));
  SET_STRING_ELT(state_names, 434, mkChar("offset_output_alpha22"));
  SET_STRING_ELT(state_names, 435, mkChar("dim_alpha23"));
  SET_STRING_ELT(state_names, 436, mkChar("alpha23"));
  SET_STRING_ELT(state_names, 437, mkChar("dim_alpha24"));
  SET_STRING_ELT(state_names, 438, mkChar("alpha24"));
  SET_STRING_ELT(state_names, 439, mkChar("dim_alpha25"));
  SET_STRING_ELT(state_names, 440, mkChar("alpha25"));
  SET_STRING_ELT(state_names, 441, mkChar("dim_alpha32"));
  SET_STRING_ELT(state_names, 442, mkChar("alpha32"));
  SET_STRING_ELT(state_names, 443, mkChar("dim_alpha33"));
  SET_STRING_ELT(state_names, 444, mkChar("alpha33"));
  SET_STRING_ELT(state_names, 445, mkChar("offset_output_alpha33"));
  SET_STRING_ELT(state_names, 446, mkChar("dim_alpha34"));
  SET_STRING_ELT(state_names, 447, mkChar("alpha34"));
  SET_STRING_ELT(state_names, 448, mkChar("offset_output_alpha34"));
  SET_STRING_ELT(state_names, 449, mkChar("dim_alpha35"));
  SET_STRING_ELT(state_names, 450, mkChar("alpha35"));
  SET_STRING_ELT(state_names, 451, mkChar("offset_output_alpha35"));
  SET_STRING_ELT(state_names, 452, mkChar("dim_alpha42"));
  SET_STRING_ELT(state_names, 453, mkChar("alpha42"));
  SET_STRING_ELT(state_names, 454, mkChar("dim_alpha43"));
  SET_STRING_ELT(state_names, 455, mkChar("alpha43"));
  SET_STRING_ELT(state_names, 456, mkChar("dim_alpha44"));
  SET_STRING_ELT(state_names, 457, mkChar("alpha44"));
  SET_STRING_ELT(state_names, 458, mkChar("dim_alpha45"));
  SET_STRING_ELT(state_names, 459, mkChar("alpha45"));
  SET_STRING_ELT(state_names, 460, mkChar("dim_beta_comm"));
  SET_STRING_ELT(state_names, 461, mkChar("beta_comm"));
  SET_STRING_ELT(state_names, 462, mkChar("offset_output_beta_comm"));
  SET_STRING_ELT(state_names, 463, mkChar("dim_beta_noncomm"));
  SET_STRING_ELT(state_names, 464, mkChar("beta_noncomm"));
  SET_STRING_ELT(state_names, 465, mkChar("offset_output_beta_noncomm"));
  ...
  SET_STRING_ELT(state_names, 870, mkChar("interpolate_c_comm"));
  SET_STRING_ELT(state_names, 871, mkChar("interpolate_c_noncomm"));
  SET_STRING_ELT(state_names, 872, mkChar("interpolate_ART_eligible_CD4_above_500"));
  SET_STRING_ELT(state_names, 873, mkChar("interpolate_ART_eligible_CD4_350_500"));
  SET_STRING_ELT(state_names, 874, mkChar("interpolate_ART_eligible_CD4_200_349"));
  SET_STRING_ELT(state_names, 875, mkChar("interpolate_ART_eligible_CD4_below_200"));
  SET_STRING_ELT(state_names, 876, mkChar("interpolate_testing_prob"));
  SET_STRING_ELT(state_names, 877, mkChar("interpolate_PrEP_reinit_OnOff"));
  SET_STRING_ELT(state_names, 878, mkChar("interpolate_tau_intervention"));
  SET_STRING_ELT(state_names, 879, mkChar("interpolate_rho_intervention"));
  SET_STRING_ELT(state_names, 880, mkChar("interpolate_prep_efficacious"));
  SET_STRING_ELT(state_names, 881, mkChar("interpolate_viral_supp"));
  SET_STRING_ELT(state_names, 882, mkChar("interpolate_infect_ART"));
  SET_STRING_ELT(state_names, 883, mkChar("interpolate_epsilon"));
  SET_STRING_ELT(state_names, 884, mkChar("interpolate_prep_offered"));
...
SEXP main_model_output_order(SEXP main_model_ptr) {
  ...
  SET_VECTOR_ELT(state_len, 88, ScalarInteger(main_model_p->dim_c_comm));
  SET_STRING_ELT(state_names, 88, mkChar("c_comm"));
  SET_VECTOR_ELT(state_len, 89, ScalarInteger(main_model_p->dim_c_noncomm));
  SET_STRING_ELT(state_names, 89, mkChar("c_noncomm"));
  SET_VECTOR_ELT(state_len, 90, ScalarInteger(main_model_p->dim_pfFSW));
  SET_STRING_ELT(state_names, 90, mkChar("pfFSW"));
  SET_VECTOR_ELT(state_len, 91, ScalarInteger(main_model_p->dim_new_acute_infected));
  SET_STRING_ELT(state_names, 91, mkChar("new_acute_infected"));
  SET_VECTOR_ELT(state_len, 92, ScalarInteger(main_model_p->dim_rate_leave_pro_FSW_weight_by_PrEP));
  SET_STRING_ELT(state_names, 92, mkChar("rate_leave_pro_FSW_weight_by_PrEP"));
  SET_VECTOR_ELT(state_len, 93, ScalarInteger(main_model_p->dim_new_people_in_group));
  SET_STRING_ELT(state_names, 93, mkChar("new_people_in_group"));
  SET_VECTOR_ELT(state_len, 94, ScalarInteger(main_model_p->dim_new_people_in_group_FSW_only));
  SET_STRING_ELT(state_names, 94, mkChar("new_people_in_group_FSW_only"));
  SET_VECTOR_ELT(state_len, 95, ScalarInteger(main_model_p->dim_above_500_by_group));
  SET_STRING_ELT(state_names, 95, mkChar("above_500_by_group"));
  SET_VECTOR_ELT(state_len, 96, ScalarInteger(main_model_p->dim_testing_prob));
  SET_STRING_ELT(state_names, 96, mkChar("testing_prob"));
  SET_VECTOR_ELT(state_len, 97, ScalarInteger(main_model_p->dim_zeta_re));
  SET_STRING_ELT(state_names, 97, mkChar("zeta_re"));
  SET_VECTOR_ELT(state_len, 98, ScalarInteger(main_model_p->dim_tau_intervention));
  SET_STRING_ELT(state_names, 98, mkChar("tau_intervention"));
  SET_VECTOR_ELT(state_len, 99, ScalarInteger(main_model_p->dim_rho_intervention));
  SET_STRING_ELT(state_names, 99, mkChar("rho_intervention"));
  SET_VECTOR_ELT(state_len, 100, ScalarInteger(main_model_p->dim_zeta));
  SET_STRING_ELT(state_names, 100, mkChar("zeta"));
  SET_VECTOR_ELT(state_len, 101, ScalarInteger(main_model_p->dim_eP1a_effective));
  SET_STRING_ELT(state_names, 101, mkChar("eP1a_effective"));
  SET_VECTOR_ELT(state_len, 102, ScalarInteger(main_model_p->dim_eP1b_effective));
  SET_STRING_ELT(state_names, 102, mkChar("eP1b_effective"));
  SET_VECTOR_ELT(state_len, 103, ScalarInteger(main_model_p->dim_eP1c_effective));
  SET_STRING_ELT(state_names, 103, mkChar("eP1c_effective"));
  SET_VECTOR_ELT(state_len, 104, ScalarInteger(main_model_p->dim_tau));
  SET_STRING_ELT(state_names, 104, mkChar("tau"));
  SET_VECTOR_ELT(state_len, 105, ScalarInteger(main_model_p->dim_rho));
  SET_STRING_ELT(state_names, 105, mkChar("rho"));
  SET_VECTOR_ELT(state_len, 106, ScalarInteger(main_model_p->dim_iota));
  SET_STRING_ELT(state_names, 106, mkChar("iota"));
  SET_VECTOR_ELT(state_len, 107, ScalarInteger(main_model_p->dim_viral_supp));
  SET_STRING_ELT(state_names, 107, mkChar("viral_supp"));
  SET_VECTOR_ELT(state_len, 108, ScalarInteger(main_model_p->dim_HIV_positive));
  SET_STRING_ELT(state_names, 108, mkChar("HIV_positive"));
  SET_VECTOR_ELT(state_len, 109, ScalarInteger(main_model_p->dim_Number_Susceptibles));
  SET_STRING_ELT(state_names, 109, mkChar("Number_Susceptibles"));
  SET_VECTOR_ELT(state_len, 110, ScalarInteger(main_model_p->dim_HIV_positive_Diagnosed_Off_ART));
  SET_STRING_ELT(state_names, 110, mkChar("HIV_positive_Diagnosed_Off_ART"));
  SET_VECTOR_ELT(state_len, 111, ScalarInteger(main_model_p->dim_Primary_Off_ART));
  SET_STRING_ELT(state_names, 111, mkChar("Primary_Off_ART"));
  SET_VECTOR_ELT(state_len, 112, ScalarInteger(main_model_p->dim_CD4_above_500_Off_ART));
  SET_STRING_ELT(state_names, 112, mkChar("CD4_above_500_Off_ART"));
  SET_VECTOR_ELT(state_len, 113, ScalarInteger(main_model_p->dim_CD4_350_500_Off_ART));
  SET_STRING_ELT(state_names, 113, mkChar("CD4_350_500_Off_ART"));
  SET_VECTOR_ELT(state_len, 114, ScalarInteger(main_model_p->dim_CD4_200_350_Off_ART));
  SET_STRING_ELT(state_names, 114, mkChar("CD4_200_350_Off_ART"));
  SET_VECTOR_ELT(state_len, 115, ScalarInteger(main_model_p->dim_CD4_below_200_Off_ART));
  SET_STRING_ELT(state_names, 115, mkChar("CD4_below_200_Off_ART"));
  SET_VECTOR_ELT(state_len, 116, ScalarInteger(main_model_p->dim_HIV_positive_On_ART));
  SET_STRING_ELT(state_names, 116, mkChar("HIV_positive_On_ART"));
  SET_VECTOR_ELT(state_len, 117, ScalarInteger(main_model_p->dim_Number_DALY_W1));
  SET_STRING_ELT(state_names, 117, mkChar("Number_DALY_W1"));
  SET_VECTOR_ELT(state_len, 118, ScalarInteger(main_model_p->dim_Number_DALY_W2));
  SET_STRING_ELT(state_names, 118, mkChar("Number_DALY_W2"));
  SET_VECTOR_ELT(state_len, 119, ScalarInteger(main_model_p->dim_Number_DALY_W3));
  SET_STRING_ELT(state_names, 119, mkChar("Number_DALY_W3"));
  SET_VECTOR_ELT(state_len, 120, ScalarInteger(main_model_p->dim_frac_F));
  SET_STRING_ELT(state_names, 120, mkChar("frac_F"));
  SET_VECTOR_ELT(state_len, 121, ScalarInteger(main_model_p->dim_frac_N_sexualpop));
  SET_STRING_ELT(state_names, 121, mkChar("frac_N_sexualpop"));
  SET_VECTOR_ELT(state_len, 122, ScalarInteger(main_model_p->dim_ART_coverage));
  SET_STRING_ELT(state_names, 122, mkChar("ART_coverage"));
  SET_VECTOR_ELT(state_len, 123, ScalarInteger(main_model_p->dim_infect_ART));
  SET_STRING_ELT(state_names, 123, mkChar("infect_ART"));
  SET_VECTOR_ELT(state_len, 124, ScalarInteger(main_model_p->dim_prep_offered));
  SET_STRING_ELT(state_names, 124, mkChar("prep_offered"));
  SET_VECTOR_ELT(state_len, 125, ScalarInteger(main_model_p->dim_omega));
  SET_STRING_ELT(state_names, 125, mkChar("omega"));
  SET_VECTOR_ELT(state_len, 126, ScalarInteger(main_model_p->dim_frac_N));
  SET_STRING_ELT(state_names, 126, mkChar("frac_N"));
  SET_VECTOR_ELT(state_len, 127, ScalarInteger(main_model_p->dim_mu));
  SET_STRING_ELT(state_names, 127, mkChar("mu"));
  SET_VECTOR_ELT(state_len, 128, ScalarInteger(main_model_p->dim_gamma01));
  SET_STRING_ELT(state_names, 128, mkChar("gamma01"));
  SET_VECTOR_ELT(state_len, 129, ScalarInteger(main_model_p->dim_gamma11));
  SET_STRING_ELT(state_names, 129, mkChar("gamma11"));
  SET_VECTOR_ELT(state_len, 130, ScalarInteger(main_model_p->dim_gamma32));
  SET_STRING_ELT(state_names, 130, mkChar("gamma32"));
  SET_VECTOR_ELT(state_len, 131, ScalarInteger(main_model_p->dim_gamma33));
  SET_STRING_ELT(state_names, 131, mkChar("gamma33"));
  SET_VECTOR_ELT(state_len, 132, ScalarInteger(main_model_p->dim_gamma34));
  SET_STRING_ELT(state_names, 132, mkChar("gamma34"));
  SET_VECTOR_ELT(state_len, 133, ScalarInteger(main_model_p->dim_phi2));
  SET_STRING_ELT(state_names, 133, mkChar("phi2"));
  SET_VECTOR_ELT(state_len, 134, ScalarInteger(main_model_p->dim_kappaa));
  SET_STRING_ELT(state_names, 134, mkChar("kappaa"));
  SET_VECTOR_ELT(state_len, 135, ScalarInteger(main_model_p->dim_kappab));
  SET_STRING_ELT(state_names, 135, mkChar("kappab"));
  SET_VECTOR_ELT(state_len, 136, ScalarInteger(main_model_p->dim_kappac));
  SET_STRING_ELT(state_names, 136, mkChar("kappac"));
  SET_VECTOR_ELT(state_len, 137, ScalarInteger(main_model_p->dim_kappa1));
  SET_STRING_ELT(state_names, 137, mkChar("kappa1"));
  SET_VECTOR_ELT(state_len, 138, ScalarInteger(main_model_p->dim_alpha01));
  SET_STRING_ELT(state_names, 138, mkChar("alpha01"));
  SET_VECTOR_ELT(state_len, 139, ScalarInteger(main_model_p->dim_alpha02));
  SET_STRING_ELT(state_names, 139, mkChar("alpha02"));
  SET_VECTOR_ELT(state_len, 140, ScalarInteger(main_model_p->dim_alpha05));
  SET_STRING_ELT(state_names, 140, mkChar("alpha05"));
  SET_VECTOR_ELT(state_len, 141, ScalarInteger(main_model_p->dim_alpha11));
  SET_STRING_ELT(state_names, 141, mkChar("alpha11"));
  SET_VECTOR_ELT(state_len, 142, ScalarInteger(main_model_p->dim_alpha22));
  SET_STRING_ELT(state_names, 142, mkChar("alpha22"));
  SET_VECTOR_ELT(state_len, 143, ScalarInteger(main_model_p->dim_alpha33));
  SET_STRING_ELT(state_names, 143, mkChar("alpha33"));
  SET_VECTOR_ELT(state_len, 144, ScalarInteger(main_model_p->dim_alpha34));
  SET_STRING_ELT(state_names, 144, mkChar("alpha34"));
  SET_VECTOR_ELT(state_len, 145, ScalarInteger(main_model_p->dim_alpha35));
  SET_STRING_ELT(state_names, 145, mkChar("alpha35"));
  SET_VECTOR_ELT(state_len, 146, ScalarInteger(main_model_p->dim_beta_comm));
  SET_STRING_ELT(state_names, 146, mkChar("beta_comm"));
  SET_VECTOR_ELT(state_len, 147, ScalarInteger(main_model_p->dim_beta_noncomm));
  SET_STRING_ELT(state_names, 147, mkChar("beta_noncomm"));
