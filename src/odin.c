...
SEXP main_model_contents(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  SEXP state = PROTECT(allocVector(VECSXP, 769));
  ...
  SET_VECTOR_ELT(state, 371, ScalarInteger(main_model_p->dim_eP1a));
  SET_VECTOR_ELT(state, 372, allocVector(REALSXP, main_model_p->dim_eP1a));
  memcpy(REAL(VECTOR_ELT(state, 372)), main_model_p->eP1a, main_model_p->dim_eP1a * sizeof(double));
  SET_VECTOR_ELT(state, 373, ScalarInteger(main_model_p->dim_eP1b));
  SET_VECTOR_ELT(state, 374, allocVector(REALSXP, main_model_p->dim_eP1b));
  memcpy(REAL(VECTOR_ELT(state, 374)), main_model_p->eP1b, main_model_p->dim_eP1b * sizeof(double));
  SET_VECTOR_ELT(state, 375, ScalarInteger(main_model_p->dim_eP1c));
  SET_VECTOR_ELT(state, 376, allocVector(REALSXP, main_model_p->dim_eP1c));
  memcpy(REAL(VECTOR_ELT(state, 376)), main_model_p->eP1c, main_model_p->dim_eP1c * sizeof(double));
  SET_VECTOR_ELT(state, 377, ScalarInteger(main_model_p->dim_eP1d));
  SET_VECTOR_ELT(state, 378, allocVector(REALSXP, main_model_p->dim_eP1d));
  memcpy(REAL(VECTOR_ELT(state, 378)), main_model_p->eP1d, main_model_p->dim_eP1d * sizeof(double));
  SET_VECTOR_ELT(state, 379, ScalarInteger(main_model_p->dim_fc_comm));
  SET_VECTOR_ELT(state, 380, ScalarInteger(main_model_p->dim_fc_comm_1));
  SET_VECTOR_ELT(state, 381, ScalarInteger(main_model_p->dim_fc_comm_2));
  SET_VECTOR_ELT(state, 382, allocVector(REALSXP, main_model_p->dim_fc_comm));
  memcpy(REAL(VECTOR_ELT(state, 382)), main_model_p->fc_comm, main_model_p->dim_fc_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 382), 2, main_model_p->dim_fc_comm_1, main_model_p->dim_fc_comm_2);
  SET_VECTOR_ELT(state, 383, ScalarInteger(main_model_p->offset_output_fc_comm));
  SET_VECTOR_ELT(state, 384, ScalarInteger(main_model_p->dim_fP_comm));
  SET_VECTOR_ELT(state, 385, allocVector(REALSXP, main_model_p->dim_fP_comm));
  memcpy(REAL(VECTOR_ELT(state, 385)), main_model_p->fP_comm, main_model_p->dim_fP_comm * sizeof(double));
  SET_VECTOR_ELT(state, 386, ScalarInteger(main_model_p->offset_output_fP_comm));
  SET_VECTOR_ELT(state, 387, ScalarInteger(main_model_p->dim_fc_noncomm));
  SET_VECTOR_ELT(state, 388, ScalarInteger(main_model_p->dim_fc_noncomm_1));
  SET_VECTOR_ELT(state, 389, ScalarInteger(main_model_p->dim_fc_noncomm_2));
  SET_VECTOR_ELT(state, 390, allocVector(REALSXP, main_model_p->dim_fc_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 390)), main_model_p->fc_noncomm, main_model_p->dim_fc_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 390), 2, main_model_p->dim_fc_noncomm_1, main_model_p->dim_fc_noncomm_2);
  SET_VECTOR_ELT(state, 391, ScalarInteger(main_model_p->offset_output_fc_noncomm));
  SET_VECTOR_ELT(state, 392, ScalarInteger(main_model_p->dim_fP_noncomm));
  SET_VECTOR_ELT(state, 393, allocVector(REALSXP, main_model_p->dim_fP_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 393)), main_model_p->fP_noncomm, main_model_p->dim_fP_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 394, ScalarInteger(main_model_p->offset_output_fP_noncomm));
  SET_VECTOR_ELT(state, 395, ScalarInteger(main_model_p->dim_n_comm));
  SET_VECTOR_ELT(state, 396, ScalarInteger(main_model_p->dim_n_comm_1));
  SET_VECTOR_ELT(state, 397, ScalarInteger(main_model_p->dim_n_comm_2));
  SET_VECTOR_ELT(state, 398, allocVector(REALSXP, main_model_p->dim_n_comm));
  memcpy(REAL(VECTOR_ELT(state, 398)), main_model_p->n_comm, main_model_p->dim_n_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 398), 2, main_model_p->dim_n_comm_1, main_model_p->dim_n_comm_2);
  SET_VECTOR_ELT(state, 399, ScalarInteger(main_model_p->offset_output_n_comm));
  SET_VECTOR_ELT(state, 400, ScalarInteger(main_model_p->dim_n_noncomm));
  SET_VECTOR_ELT(state, 401, ScalarInteger(main_model_p->dim_n_noncomm_1));
  SET_VECTOR_ELT(state, 402, ScalarInteger(main_model_p->dim_n_noncomm_2));
  SET_VECTOR_ELT(state, 403, allocVector(REALSXP, main_model_p->dim_n_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 403)), main_model_p->n_noncomm, main_model_p->dim_n_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 403), 2, main_model_p->dim_n_noncomm_1, main_model_p->dim_n_noncomm_2);
  SET_VECTOR_ELT(state, 404, ScalarInteger(main_model_p->offset_output_n_noncomm));
  SET_VECTOR_ELT(state, 405, ScalarInteger(main_model_p->dim_cumuHIVDeaths));
  SET_VECTOR_ELT(state, 406, allocVector(REALSXP, main_model_p->dim_cumuHIVDeaths));
  memcpy(REAL(VECTOR_ELT(state, 406)), main_model_p->initial_cumuHIVDeaths, main_model_p->dim_cumuHIVDeaths * sizeof(double));
  SET_VECTOR_ELT(state, 407, ScalarInteger(main_model_p->offset_cumuHIVDeaths));
  SET_VECTOR_ELT(state, 408, ScalarInteger(main_model_p->dim_cumuARTinitiations));
  SET_VECTOR_ELT(state, 409, allocVector(REALSXP, main_model_p->dim_cumuARTinitiations));
  memcpy(REAL(VECTOR_ELT(state, 409)), main_model_p->initial_cumuARTinitiations, main_model_p->dim_cumuARTinitiations * sizeof(double));
  SET_VECTOR_ELT(state, 410, ScalarInteger(main_model_p->offset_cumuARTinitiations));
  SET_VECTOR_ELT(state, 411, ScalarInteger(main_model_p->dim_cumuARTREinitiations));
  SET_VECTOR_ELT(state, 412, allocVector(REALSXP, main_model_p->dim_cumuARTREinitiations));
  memcpy(REAL(VECTOR_ELT(state, 412)), main_model_p->initial_cumuARTREinitiations, main_model_p->dim_cumuARTREinitiations * sizeof(double));
  SET_VECTOR_ELT(state, 413, ScalarInteger(main_model_p->offset_cumuARTREinitiations));
  SET_VECTOR_ELT(state, 414, ScalarInteger(main_model_p->dim_dropouts));
  SET_VECTOR_ELT(state, 415, allocVector(REALSXP, main_model_p->dim_dropouts));
  memcpy(REAL(VECTOR_ELT(state, 415)), main_model_p->initial_dropouts, main_model_p->dim_dropouts * sizeof(double));
  SET_VECTOR_ELT(state, 416, ScalarInteger(main_model_p->offset_dropouts));
  SET_VECTOR_ELT(state, 417, ScalarInteger(main_model_p->dim_cumuAllDeaths));
  SET_VECTOR_ELT(state, 418, allocVector(REALSXP, main_model_p->dim_cumuAllDeaths));
  memcpy(REAL(VECTOR_ELT(state, 418)), main_model_p->initial_cumuAllDeaths, main_model_p->dim_cumuAllDeaths * sizeof(double));
  SET_VECTOR_ELT(state, 419, ScalarInteger(main_model_p->offset_cumuAllDeaths));
  SET_VECTOR_ELT(state, 420, ScalarInteger(main_model_p->dim_cumuInf));
  SET_VECTOR_ELT(state, 421, allocVector(REALSXP, main_model_p->dim_cumuInf));
  memcpy(REAL(VECTOR_ELT(state, 421)), main_model_p->initial_cumuInf, main_model_p->dim_cumuInf * sizeof(double));
  SET_VECTOR_ELT(state, 422, ScalarInteger(main_model_p->offset_cumuInf));
  SET_VECTOR_ELT(state, 423, ScalarInteger(main_model_p->dim_PrEPinitiations));
  SET_VECTOR_ELT(state, 424, allocVector(REALSXP, main_model_p->dim_PrEPinitiations));
  memcpy(REAL(VECTOR_ELT(state, 424)), main_model_p->initial_PrEPinitiations, main_model_p->dim_PrEPinitiations * sizeof(double));
  SET_VECTOR_ELT(state, 425, ScalarInteger(main_model_p->offset_PrEPinitiations));
  SET_VECTOR_ELT(state, 426, ScalarInteger(main_model_p->dim_PrEPinitiations1a));
  SET_VECTOR_ELT(state, 427, allocVector(REALSXP, main_model_p->dim_PrEPinitiations1a));
  memcpy(REAL(VECTOR_ELT(state, 427)), main_model_p->initial_PrEPinitiations1a, main_model_p->dim_PrEPinitiations1a * sizeof(double));
  SET_VECTOR_ELT(state, 428, ScalarInteger(main_model_p->offset_PrEPinitiations1a));
  SET_VECTOR_ELT(state, 429, ScalarInteger(main_model_p->dim_PrEPinitiations1b));
  SET_VECTOR_ELT(state, 430, allocVector(REALSXP, main_model_p->dim_PrEPinitiations1b));
  memcpy(REAL(VECTOR_ELT(state, 430)), main_model_p->initial_PrEPinitiations1b, main_model_p->dim_PrEPinitiations1b * sizeof(double));
  SET_VECTOR_ELT(state, 431, ScalarInteger(main_model_p->offset_PrEPinitiations1b));
  SET_VECTOR_ELT(state, 432, ScalarInteger(main_model_p->dim_PrEPinitiations1c));
  SET_VECTOR_ELT(state, 433, allocVector(REALSXP, main_model_p->dim_PrEPinitiations1c));
  memcpy(REAL(VECTOR_ELT(state, 433)), main_model_p->initial_PrEPinitiations1c, main_model_p->dim_PrEPinitiations1c * sizeof(double));
  SET_VECTOR_ELT(state, 434, ScalarInteger(main_model_p->offset_PrEPinitiations1c));
  SET_VECTOR_ELT(state, 435, ScalarInteger(main_model_p->dim_S0));
  SET_VECTOR_ELT(state, 436, allocVector(REALSXP, main_model_p->dim_S0));
  memcpy(REAL(VECTOR_ELT(state, 436)), main_model_p->initial_S0, main_model_p->dim_S0 * sizeof(double));
  SET_VECTOR_ELT(state, 437, ScalarInteger(main_model_p->offset_S0));
  SET_VECTOR_ELT(state, 438, ScalarInteger(main_model_p->dim_S1a));
  SET_VECTOR_ELT(state, 439, allocVector(REALSXP, main_model_p->dim_S1a));
  memcpy(REAL(VECTOR_ELT(state, 439)), main_model_p->initial_S1a, main_model_p->dim_S1a * sizeof(double));
  SET_VECTOR_ELT(state, 440, ScalarInteger(main_model_p->offset_S1a));
  SET_VECTOR_ELT(state, 441, ScalarInteger(main_model_p->dim_S1b));
  SET_VECTOR_ELT(state, 442, allocVector(REALSXP, main_model_p->dim_S1b));
  memcpy(REAL(VECTOR_ELT(state, 442)), main_model_p->initial_S1b, main_model_p->dim_S1b * sizeof(double));
  SET_VECTOR_ELT(state, 443, ScalarInteger(main_model_p->offset_S1b));
  SET_VECTOR_ELT(state, 444, ScalarInteger(main_model_p->dim_S1c));
  SET_VECTOR_ELT(state, 445, allocVector(REALSXP, main_model_p->dim_S1c));
  memcpy(REAL(VECTOR_ELT(state, 445)), main_model_p->initial_S1c, main_model_p->dim_S1c * sizeof(double));
  SET_VECTOR_ELT(state, 446, ScalarInteger(main_model_p->offset_S1c));
  SET_VECTOR_ELT(state, 447, ScalarInteger(main_model_p->dim_S1d));
  SET_VECTOR_ELT(state, 448, allocVector(REALSXP, main_model_p->dim_S1d));
  memcpy(REAL(VECTOR_ELT(state, 448)), main_model_p->initial_S1d, main_model_p->dim_S1d * sizeof(double));
  SET_VECTOR_ELT(state, 449, ScalarInteger(main_model_p->offset_S1d));
  SET_VECTOR_ELT(state, 450, ScalarInteger(main_model_p->dim_I01));
  SET_VECTOR_ELT(state, 451, allocVector(REALSXP, main_model_p->dim_I01));
  memcpy(REAL(VECTOR_ELT(state, 451)), main_model_p->initial_I01, main_model_p->dim_I01 * sizeof(double));
  SET_VECTOR_ELT(state, 452, ScalarInteger(main_model_p->offset_I01));
  SET_VECTOR_ELT(state, 453, ScalarInteger(main_model_p->dim_I11));
  SET_VECTOR_ELT(state, 454, allocVector(REALSXP, main_model_p->dim_I11));
  memcpy(REAL(VECTOR_ELT(state, 454)), main_model_p->initial_I11, main_model_p->dim_I11 * sizeof(double));
  SET_VECTOR_ELT(state, 455, ScalarInteger(main_model_p->offset_I11));
  SET_VECTOR_ELT(state, 456, ScalarInteger(main_model_p->dim_I02));
  SET_VECTOR_ELT(state, 457, allocVector(REALSXP, main_model_p->dim_I02));
  memcpy(REAL(VECTOR_ELT(state, 457)), main_model_p->initial_I02, main_model_p->dim_I02 * sizeof(double));
  SET_VECTOR_ELT(state, 458, ScalarInteger(main_model_p->offset_I02));
  SET_VECTOR_ELT(state, 459, ScalarInteger(main_model_p->dim_I03));
  SET_VECTOR_ELT(state, 460, allocVector(REALSXP, main_model_p->dim_I03));
  memcpy(REAL(VECTOR_ELT(state, 460)), main_model_p->initial_I03, main_model_p->dim_I03 * sizeof(double));
  SET_VECTOR_ELT(state, 461, ScalarInteger(main_model_p->offset_I03));
  SET_VECTOR_ELT(state, 462, ScalarInteger(main_model_p->dim_I04));
  SET_VECTOR_ELT(state, 463, allocVector(REALSXP, main_model_p->dim_I04));
  memcpy(REAL(VECTOR_ELT(state, 463)), main_model_p->initial_I04, main_model_p->dim_I04 * sizeof(double));
  SET_VECTOR_ELT(state, 464, ScalarInteger(main_model_p->offset_I04));
  SET_VECTOR_ELT(state, 465, ScalarInteger(main_model_p->dim_I05));
  SET_VECTOR_ELT(state, 466, allocVector(REALSXP, main_model_p->dim_I05));
  memcpy(REAL(VECTOR_ELT(state, 466)), main_model_p->initial_I05, main_model_p->dim_I05 * sizeof(double));
  SET_VECTOR_ELT(state, 467, ScalarInteger(main_model_p->offset_I05));
  SET_VECTOR_ELT(state, 468, ScalarInteger(main_model_p->dim_I22));
  SET_VECTOR_ELT(state, 469, allocVector(REALSXP, main_model_p->dim_I22));
  memcpy(REAL(VECTOR_ELT(state, 469)), main_model_p->initial_I22, main_model_p->dim_I22 * sizeof(double));
  SET_VECTOR_ELT(state, 470, ScalarInteger(main_model_p->offset_I22));
  SET_VECTOR_ELT(state, 471, ScalarInteger(main_model_p->dim_I23));
  SET_VECTOR_ELT(state, 472, allocVector(REALSXP, main_model_p->dim_I23));
  memcpy(REAL(VECTOR_ELT(state, 472)), main_model_p->initial_I23, main_model_p->dim_I23 * sizeof(double));
  SET_VECTOR_ELT(state, 473, ScalarInteger(main_model_p->offset_I23));
  SET_VECTOR_ELT(state, 474, ScalarInteger(main_model_p->dim_I24));
  SET_VECTOR_ELT(state, 475, allocVector(REALSXP, main_model_p->dim_I24));
  memcpy(REAL(VECTOR_ELT(state, 475)), main_model_p->initial_I24, main_model_p->dim_I24 * sizeof(double));
  SET_VECTOR_ELT(state, 476, ScalarInteger(main_model_p->offset_I24));
  SET_VECTOR_ELT(state, 477, ScalarInteger(main_model_p->dim_I25));
  SET_VECTOR_ELT(state, 478, allocVector(REALSXP, main_model_p->dim_I25));
  memcpy(REAL(VECTOR_ELT(state, 478)), main_model_p->initial_I25, main_model_p->dim_I25 * sizeof(double));
  SET_VECTOR_ELT(state, 479, ScalarInteger(main_model_p->offset_I25));
  SET_VECTOR_ELT(state, 480, ScalarInteger(main_model_p->dim_I32));
  SET_VECTOR_ELT(state, 481, allocVector(REALSXP, main_model_p->dim_I32));
  memcpy(REAL(VECTOR_ELT(state, 481)), main_model_p->initial_I32, main_model_p->dim_I32 * sizeof(double));
  SET_VECTOR_ELT(state, 482, ScalarInteger(main_model_p->offset_I32));
  SET_VECTOR_ELT(state, 483, ScalarInteger(main_model_p->dim_I33));
  SET_VECTOR_ELT(state, 484, allocVector(REALSXP, main_model_p->dim_I33));
  memcpy(REAL(VECTOR_ELT(state, 484)), main_model_p->initial_I33, main_model_p->dim_I33 * sizeof(double));
  SET_VECTOR_ELT(state, 485, ScalarInteger(main_model_p->offset_I33));
  SET_VECTOR_ELT(state, 486, ScalarInteger(main_model_p->dim_I34));
  SET_VECTOR_ELT(state, 487, allocVector(REALSXP, main_model_p->dim_I34));
  memcpy(REAL(VECTOR_ELT(state, 487)), main_model_p->initial_I34, main_model_p->dim_I34 * sizeof(double));
  SET_VECTOR_ELT(state, 488, ScalarInteger(main_model_p->offset_I34));
  SET_VECTOR_ELT(state, 489, ScalarInteger(main_model_p->dim_I35));
  SET_VECTOR_ELT(state, 490, allocVector(REALSXP, main_model_p->dim_I35));
  memcpy(REAL(VECTOR_ELT(state, 490)), main_model_p->initial_I35, main_model_p->dim_I35 * sizeof(double));
  SET_VECTOR_ELT(state, 491, ScalarInteger(main_model_p->offset_I35));
  SET_VECTOR_ELT(state, 492, ScalarInteger(main_model_p->dim_I42));
  SET_VECTOR_ELT(state, 493, allocVector(REALSXP, main_model_p->dim_I42));
  memcpy(REAL(VECTOR_ELT(state, 493)), main_model_p->initial_I42, main_model_p->dim_I42 * sizeof(double));
  SET_VECTOR_ELT(state, 494, ScalarInteger(main_model_p->offset_I42));
  SET_VECTOR_ELT(state, 495, ScalarInteger(main_model_p->dim_I43));
  SET_VECTOR_ELT(state, 496, allocVector(REALSXP, main_model_p->dim_I43));
  memcpy(REAL(VECTOR_ELT(state, 496)), main_model_p->initial_I43, main_model_p->dim_I43 * sizeof(double));
  SET_VECTOR_ELT(state, 497, ScalarInteger(main_model_p->offset_I43));
  SET_VECTOR_ELT(state, 498, ScalarInteger(main_model_p->dim_I44));
  SET_VECTOR_ELT(state, 499, allocVector(REALSXP, main_model_p->dim_I44));
  memcpy(REAL(VECTOR_ELT(state, 499)), main_model_p->initial_I44, main_model_p->dim_I44 * sizeof(double));
  SET_VECTOR_ELT(state, 500, ScalarInteger(main_model_p->offset_I44));
  SET_VECTOR_ELT(state, 501, ScalarInteger(main_model_p->dim_I45));
  SET_VECTOR_ELT(state, 502, allocVector(REALSXP, main_model_p->dim_I45));
  memcpy(REAL(VECTOR_ELT(state, 502)), main_model_p->initial_I45, main_model_p->dim_I45 * sizeof(double));
  SET_VECTOR_ELT(state, 503, ScalarInteger(main_model_p->offset_I45));
  SET_VECTOR_ELT(state, 504, ScalarInteger(main_model_p->dim_S0_init));
  SET_VECTOR_ELT(state, 505, allocVector(REALSXP, main_model_p->dim_S0_init));
  memcpy(REAL(VECTOR_ELT(state, 505)), main_model_p->S0_init, main_model_p->dim_S0_init * sizeof(double));
  SET_VECTOR_ELT(state, 506, ScalarInteger(main_model_p->dim_S1a_init));
  SET_VECTOR_ELT(state, 507, allocVector(REALSXP, main_model_p->dim_S1a_init));
  memcpy(REAL(VECTOR_ELT(state, 507)), main_model_p->S1a_init, main_model_p->dim_S1a_init * sizeof(double));
  SET_VECTOR_ELT(state, 508, ScalarInteger(main_model_p->dim_S1b_init));
  SET_VECTOR_ELT(state, 509, allocVector(REALSXP, main_model_p->dim_S1b_init));
  memcpy(REAL(VECTOR_ELT(state, 509)), main_model_p->S1b_init, main_model_p->dim_S1b_init * sizeof(double));
  SET_VECTOR_ELT(state, 510, ScalarInteger(main_model_p->dim_S1c_init));
  SET_VECTOR_ELT(state, 511, allocVector(REALSXP, main_model_p->dim_S1c_init));
  memcpy(REAL(VECTOR_ELT(state, 511)), main_model_p->S1c_init, main_model_p->dim_S1c_init * sizeof(double));
  SET_VECTOR_ELT(state, 512, ScalarInteger(main_model_p->dim_S1d_init));
  SET_VECTOR_ELT(state, 513, allocVector(REALSXP, main_model_p->dim_S1d_init));
  memcpy(REAL(VECTOR_ELT(state, 513)), main_model_p->S1d_init, main_model_p->dim_S1d_init * sizeof(double));
  SET_VECTOR_ELT(state, 514, ScalarInteger(main_model_p->dim_I01_init));
  SET_VECTOR_ELT(state, 515, allocVector(REALSXP, main_model_p->dim_I01_init));
  memcpy(REAL(VECTOR_ELT(state, 515)), main_model_p->I01_init, main_model_p->dim_I01_init * sizeof(double));
  SET_VECTOR_ELT(state, 516, ScalarInteger(main_model_p->dim_I11_init));
  SET_VECTOR_ELT(state, 517, allocVector(REALSXP, main_model_p->dim_I11_init));
  memcpy(REAL(VECTOR_ELT(state, 517)), main_model_p->I11_init, main_model_p->dim_I11_init * sizeof(double));
  SET_VECTOR_ELT(state, 518, ScalarInteger(main_model_p->dim_I02_init));
  SET_VECTOR_ELT(state, 519, allocVector(REALSXP, main_model_p->dim_I02_init));
  memcpy(REAL(VECTOR_ELT(state, 519)), main_model_p->I02_init, main_model_p->dim_I02_init * sizeof(double));
  SET_VECTOR_ELT(state, 520, ScalarInteger(main_model_p->dim_I03_init));
  SET_VECTOR_ELT(state, 521, allocVector(REALSXP, main_model_p->dim_I03_init));
  memcpy(REAL(VECTOR_ELT(state, 521)), main_model_p->I03_init, main_model_p->dim_I03_init * sizeof(double));
  SET_VECTOR_ELT(state, 522, ScalarInteger(main_model_p->dim_I04_init));
  SET_VECTOR_ELT(state, 523, allocVector(REALSXP, main_model_p->dim_I04_init));
  memcpy(REAL(VECTOR_ELT(state, 523)), main_model_p->I04_init, main_model_p->dim_I04_init * sizeof(double));
  SET_VECTOR_ELT(state, 524, ScalarInteger(main_model_p->dim_I05_init));
  SET_VECTOR_ELT(state, 525, allocVector(REALSXP, main_model_p->dim_I05_init));
  memcpy(REAL(VECTOR_ELT(state, 525)), main_model_p->I05_init, main_model_p->dim_I05_init * sizeof(double));
  SET_VECTOR_ELT(state, 526, ScalarInteger(main_model_p->dim_I22_init));
  SET_VECTOR_ELT(state, 527, allocVector(REALSXP, main_model_p->dim_I22_init));
  memcpy(REAL(VECTOR_ELT(state, 527)), main_model_p->I22_init, main_model_p->dim_I22_init * sizeof(double));
  SET_VECTOR_ELT(state, 528, ScalarInteger(main_model_p->dim_I23_init));
  SET_VECTOR_ELT(state, 529, allocVector(REALSXP, main_model_p->dim_I23_init));
  memcpy(REAL(VECTOR_ELT(state, 529)), main_model_p->I23_init, main_model_p->dim_I23_init * sizeof(double));
  SET_VECTOR_ELT(state, 530, ScalarInteger(main_model_p->dim_I24_init));
  SET_VECTOR_ELT(state, 531, allocVector(REALSXP, main_model_p->dim_I24_init));
  memcpy(REAL(VECTOR_ELT(state, 531)), main_model_p->I24_init, main_model_p->dim_I24_init * sizeof(double));
  SET_VECTOR_ELT(state, 532, ScalarInteger(main_model_p->dim_I25_init));
  SET_VECTOR_ELT(state, 533, allocVector(REALSXP, main_model_p->dim_I25_init));
  memcpy(REAL(VECTOR_ELT(state, 533)), main_model_p->I25_init, main_model_p->dim_I25_init * sizeof(double));
  SET_VECTOR_ELT(state, 534, ScalarInteger(main_model_p->dim_I32_init));
  SET_VECTOR_ELT(state, 535, allocVector(REALSXP, main_model_p->dim_I32_init));
  memcpy(REAL(VECTOR_ELT(state, 535)), main_model_p->I32_init, main_model_p->dim_I32_init * sizeof(double));
  SET_VECTOR_ELT(state, 536, ScalarInteger(main_model_p->dim_I33_init));
  SET_VECTOR_ELT(state, 537, allocVector(REALSXP, main_model_p->dim_I33_init));
  memcpy(REAL(VECTOR_ELT(state, 537)), main_model_p->I33_init, main_model_p->dim_I33_init * sizeof(double));
  SET_VECTOR_ELT(state, 538, ScalarInteger(main_model_p->dim_I34_init));
  SET_VECTOR_ELT(state, 539, allocVector(REALSXP, main_model_p->dim_I34_init));
  memcpy(REAL(VECTOR_ELT(state, 539)), main_model_p->I34_init, main_model_p->dim_I34_init * sizeof(double));
  SET_VECTOR_ELT(state, 540, ScalarInteger(main_model_p->dim_I35_init));
  SET_VECTOR_ELT(state, 541, allocVector(REALSXP, main_model_p->dim_I35_init));
  memcpy(REAL(VECTOR_ELT(state, 541)), main_model_p->I35_init, main_model_p->dim_I35_init * sizeof(double));
  SET_VECTOR_ELT(state, 542, ScalarInteger(main_model_p->dim_I42_init));
  SET_VECTOR_ELT(state, 543, allocVector(REALSXP, main_model_p->dim_I42_init));
  memcpy(REAL(VECTOR_ELT(state, 543)), main_model_p->I42_init, main_model_p->dim_I42_init * sizeof(double));
  SET_VECTOR_ELT(state, 544, ScalarInteger(main_model_p->dim_I43_init));
  SET_VECTOR_ELT(state, 545, allocVector(REALSXP, main_model_p->dim_I43_init));
  memcpy(REAL(VECTOR_ELT(state, 545)), main_model_p->I43_init, main_model_p->dim_I43_init * sizeof(double));
  SET_VECTOR_ELT(state, 546, ScalarInteger(main_model_p->dim_I44_init));
  SET_VECTOR_ELT(state, 547, allocVector(REALSXP, main_model_p->dim_I44_init));
  memcpy(REAL(VECTOR_ELT(state, 547)), main_model_p->I44_init, main_model_p->dim_I44_init * sizeof(double));
  SET_VECTOR_ELT(state, 548, ScalarInteger(main_model_p->dim_I45_init));
  SET_VECTOR_ELT(state, 549, allocVector(REALSXP, main_model_p->dim_I45_init));
  memcpy(REAL(VECTOR_ELT(state, 549)), main_model_p->I45_init, main_model_p->dim_I45_init * sizeof(double));
  SET_VECTOR_ELT(state, 550, ScalarInteger(main_model_p->dim_N));
  SET_VECTOR_ELT(state, 551, allocVector(REALSXP, main_model_p->dim_N));
  memcpy(REAL(VECTOR_ELT(state, 551)), main_model_p->N, main_model_p->dim_N * sizeof(double));
  SET_VECTOR_ELT(state, 552, ScalarInteger(main_model_p->offset_output_N));
  SET_VECTOR_ELT(state, 553, ScalarInteger(main_model_p->dim_E0));
  SET_VECTOR_ELT(state, 554, allocVector(REALSXP, main_model_p->dim_E0));
  memcpy(REAL(VECTOR_ELT(state, 554)), main_model_p->E0, main_model_p->dim_E0 * sizeof(double));
  SET_VECTOR_ELT(state, 555, ScalarInteger(main_model_p->offset_output_E0));
  SET_VECTOR_ELT(state, 556, ScalarInteger(main_model_p->dim_E1a));
  SET_VECTOR_ELT(state, 557, allocVector(REALSXP, main_model_p->dim_E1a));
  memcpy(REAL(VECTOR_ELT(state, 557)), main_model_p->E1a, main_model_p->dim_E1a * sizeof(double));
  SET_VECTOR_ELT(state, 558, ScalarInteger(main_model_p->offset_output_E1a));
  SET_VECTOR_ELT(state, 559, ScalarInteger(main_model_p->dim_E1b));
  SET_VECTOR_ELT(state, 560, allocVector(REALSXP, main_model_p->dim_E1b));
  memcpy(REAL(VECTOR_ELT(state, 560)), main_model_p->E1b, main_model_p->dim_E1b * sizeof(double));
  SET_VECTOR_ELT(state, 561, ScalarInteger(main_model_p->offset_output_E1b));
  SET_VECTOR_ELT(state, 562, ScalarInteger(main_model_p->dim_E1c));
  SET_VECTOR_ELT(state, 563, allocVector(REALSXP, main_model_p->dim_E1c));
  memcpy(REAL(VECTOR_ELT(state, 563)), main_model_p->E1c, main_model_p->dim_E1c * sizeof(double));
  SET_VECTOR_ELT(state, 564, ScalarInteger(main_model_p->offset_output_E1c));
  SET_VECTOR_ELT(state, 565, ScalarInteger(main_model_p->dim_E1d));
  SET_VECTOR_ELT(state, 566, allocVector(REALSXP, main_model_p->dim_E1d));
  memcpy(REAL(VECTOR_ELT(state, 566)), main_model_p->E1d, main_model_p->dim_E1d * sizeof(double));
  SET_VECTOR_ELT(state, 567, ScalarInteger(main_model_p->offset_output_E1d));
  SET_VECTOR_ELT(state, 568, ScalarInteger(main_model_p->dim_cumuInf_init));
  SET_VECTOR_ELT(state, 569, allocVector(REALSXP, main_model_p->dim_cumuInf_init));
  memcpy(REAL(VECTOR_ELT(state, 569)), main_model_p->cumuInf_init, main_model_p->dim_cumuInf_init * sizeof(double));
  SET_VECTOR_ELT(state, 570, ScalarInteger(main_model_p->dim_alphaItot));
  SET_VECTOR_ELT(state, 571, allocVector(REALSXP, main_model_p->dim_alphaItot));
  memcpy(REAL(VECTOR_ELT(state, 571)), main_model_p->alphaItot, main_model_p->dim_alphaItot * sizeof(double));
  SET_VECTOR_ELT(state, 572, ScalarInteger(main_model_p->offset_output_alphaItot));
  SET_VECTOR_ELT(state, 573, ScalarInteger(main_model_p->dim_prev));
  SET_VECTOR_ELT(state, 574, allocVector(REALSXP, main_model_p->dim_prev));
  memcpy(REAL(VECTOR_ELT(state, 574)), main_model_p->prev, main_model_p->dim_prev * sizeof(double));
  SET_VECTOR_ELT(state, 575, ScalarInteger(main_model_p->offset_output_prev));
  SET_VECTOR_ELT(state, 576, ScalarInteger(main_model_p->dim_lambda));
  SET_VECTOR_ELT(state, 577, ScalarInteger(main_model_p->dim_lambda_1));
  SET_VECTOR_ELT(state, 578, ScalarInteger(main_model_p->dim_lambda_2));
  SET_VECTOR_ELT(state, 579, allocVector(REALSXP, main_model_p->dim_lambda));
  memcpy(REAL(VECTOR_ELT(state, 579)), main_model_p->lambda, main_model_p->dim_lambda * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 579), 2, main_model_p->dim_lambda_1, main_model_p->dim_lambda_2);
  SET_VECTOR_ELT(state, 580, ScalarInteger(main_model_p->offset_output_lambda));
  SET_VECTOR_ELT(state, 581, ScalarInteger(main_model_p->dim_lambda_0));
  SET_VECTOR_ELT(state, 582, ScalarInteger(main_model_p->dim_lambda_0_1));
  SET_VECTOR_ELT(state, 583, ScalarInteger(main_model_p->dim_lambda_0_2));
  SET_VECTOR_ELT(state, 584, allocVector(REALSXP, main_model_p->dim_lambda_0));
  memcpy(REAL(VECTOR_ELT(state, 584)), main_model_p->lambda_0, main_model_p->dim_lambda_0 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 584), 2, main_model_p->dim_lambda_0_1, main_model_p->dim_lambda_0_2);
  SET_VECTOR_ELT(state, 585, ScalarInteger(main_model_p->offset_output_lambda_0));
  SET_VECTOR_ELT(state, 586, ScalarInteger(main_model_p->dim_lambda_1a));
  SET_VECTOR_ELT(state, 587, ScalarInteger(main_model_p->dim_lambda_1a_1));
  SET_VECTOR_ELT(state, 588, ScalarInteger(main_model_p->dim_lambda_1a_2));
  SET_VECTOR_ELT(state, 589, allocVector(REALSXP, main_model_p->dim_lambda_1a));
  memcpy(REAL(VECTOR_ELT(state, 589)), main_model_p->lambda_1a, main_model_p->dim_lambda_1a * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 589), 2, main_model_p->dim_lambda_1a_1, main_model_p->dim_lambda_1a_2);
  SET_VECTOR_ELT(state, 590, ScalarInteger(main_model_p->offset_output_lambda_1a));
  SET_VECTOR_ELT(state, 591, ScalarInteger(main_model_p->dim_lambda_1b));
  SET_VECTOR_ELT(state, 592, ScalarInteger(main_model_p->dim_lambda_1b_1));
  SET_VECTOR_ELT(state, 593, ScalarInteger(main_model_p->dim_lambda_1b_2));
  SET_VECTOR_ELT(state, 594, allocVector(REALSXP, main_model_p->dim_lambda_1b));
  memcpy(REAL(VECTOR_ELT(state, 594)), main_model_p->lambda_1b, main_model_p->dim_lambda_1b * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 594), 2, main_model_p->dim_lambda_1b_1, main_model_p->dim_lambda_1b_2);
  SET_VECTOR_ELT(state, 595, ScalarInteger(main_model_p->offset_output_lambda_1b));
  SET_VECTOR_ELT(state, 596, ScalarInteger(main_model_p->dim_lambda_1c));
  SET_VECTOR_ELT(state, 597, ScalarInteger(main_model_p->dim_lambda_1c_1));
  SET_VECTOR_ELT(state, 598, ScalarInteger(main_model_p->dim_lambda_1c_2));
  SET_VECTOR_ELT(state, 599, allocVector(REALSXP, main_model_p->dim_lambda_1c));
  memcpy(REAL(VECTOR_ELT(state, 599)), main_model_p->lambda_1c, main_model_p->dim_lambda_1c * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 599), 2, main_model_p->dim_lambda_1c_1, main_model_p->dim_lambda_1c_2);
  SET_VECTOR_ELT(state, 600, ScalarInteger(main_model_p->offset_output_lambda_1c));
  SET_VECTOR_ELT(state, 601, ScalarInteger(main_model_p->dim_lambda_1d));
  SET_VECTOR_ELT(state, 602, ScalarInteger(main_model_p->dim_lambda_1d_1));
  SET_VECTOR_ELT(state, 603, ScalarInteger(main_model_p->dim_lambda_1d_2));
  SET_VECTOR_ELT(state, 604, allocVector(REALSXP, main_model_p->dim_lambda_1d));
  memcpy(REAL(VECTOR_ELT(state, 604)), main_model_p->lambda_1d, main_model_p->dim_lambda_1d * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 604), 2, main_model_p->dim_lambda_1d_1, main_model_p->dim_lambda_1d_2);
  SET_VECTOR_ELT(state, 605, ScalarInteger(main_model_p->offset_output_lambda_1d));
  SET_VECTOR_ELT(state, 606, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_VECTOR_ELT(state, 607, allocVector(REALSXP, main_model_p->dim_lambda_sum_0));
  memcpy(REAL(VECTOR_ELT(state, 607)), main_model_p->lambda_sum_0, main_model_p->dim_lambda_sum_0 * sizeof(double));
  SET_VECTOR_ELT(state, 608, ScalarInteger(main_model_p->offset_output_lambda_sum_0));
  SET_VECTOR_ELT(state, 609, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_VECTOR_ELT(state, 610, allocVector(REALSXP, main_model_p->dim_lambda_sum_1a));
  memcpy(REAL(VECTOR_ELT(state, 610)), main_model_p->lambda_sum_1a, main_model_p->dim_lambda_sum_1a * sizeof(double));
  SET_VECTOR_ELT(state, 611, ScalarInteger(main_model_p->offset_output_lambda_sum_1a));
  SET_VECTOR_ELT(state, 612, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_VECTOR_ELT(state, 613, allocVector(REALSXP, main_model_p->dim_lambda_sum_1b));
  memcpy(REAL(VECTOR_ELT(state, 613)), main_model_p->lambda_sum_1b, main_model_p->dim_lambda_sum_1b * sizeof(double));
  SET_VECTOR_ELT(state, 614, ScalarInteger(main_model_p->offset_output_lambda_sum_1b));
  SET_VECTOR_ELT(state, 615, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_VECTOR_ELT(state, 616, allocVector(REALSXP, main_model_p->dim_lambda_sum_1c));
  memcpy(REAL(VECTOR_ELT(state, 616)), main_model_p->lambda_sum_1c, main_model_p->dim_lambda_sum_1c * sizeof(double));
  SET_VECTOR_ELT(state, 617, ScalarInteger(main_model_p->offset_output_lambda_sum_1c));
  SET_VECTOR_ELT(state, 618, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_VECTOR_ELT(state, 619, allocVector(REALSXP, main_model_p->dim_lambda_sum_1d));
  memcpy(REAL(VECTOR_ELT(state, 619)), main_model_p->lambda_sum_1d, main_model_p->dim_lambda_sum_1d * sizeof(double));
  SET_VECTOR_ELT(state, 620, ScalarInteger(main_model_p->offset_output_lambda_sum_1d));
  SET_VECTOR_ELT(state, 621, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_VECTOR_ELT(state, 622, allocVector(REALSXP, main_model_p->dim_c_comm_balanced));
  memcpy(REAL(VECTOR_ELT(state, 622)), main_model_p->c_comm_balanced, main_model_p->dim_c_comm_balanced * sizeof(double));
  SET_VECTOR_ELT(state, 623, ScalarInteger(main_model_p->offset_output_c_comm_balanced));
  SET_VECTOR_ELT(state, 624, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_VECTOR_ELT(state, 625, allocVector(REALSXP, main_model_p->dim_c_noncomm_balanced));
  memcpy(REAL(VECTOR_ELT(state, 625)), main_model_p->c_noncomm_balanced, main_model_p->dim_c_noncomm_balanced * sizeof(double));
  SET_VECTOR_ELT(state, 626, ScalarInteger(main_model_p->offset_output_c_noncomm_balanced));
  SET_VECTOR_ELT(state, 627, ScalarInteger(main_model_p->dim_theta));
  SET_VECTOR_ELT(state, 628, ScalarInteger(main_model_p->dim_theta_1));
  SET_VECTOR_ELT(state, 629, ScalarInteger(main_model_p->dim_theta_2));
  SET_VECTOR_ELT(state, 630, allocVector(REALSXP, main_model_p->dim_theta));
  memcpy(REAL(VECTOR_ELT(state, 630)), main_model_p->theta, main_model_p->dim_theta * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 630), 2, main_model_p->dim_theta_1, main_model_p->dim_theta_2);
  SET_VECTOR_ELT(state, 631, ScalarInteger(main_model_p->offset_output_theta));
  SET_VECTOR_ELT(state, 632, ScalarInteger(main_model_p->dim_PrEPinitiations_init));
  SET_VECTOR_ELT(state, 633, allocVector(REALSXP, main_model_p->dim_PrEPinitiations_init));
  memcpy(REAL(VECTOR_ELT(state, 633)), main_model_p->PrEPinitiations_init, main_model_p->dim_PrEPinitiations_init * sizeof(double));
  SET_VECTOR_ELT(state, 634, ScalarInteger(main_model_p->dim_M_comm));
  SET_VECTOR_ELT(state, 635, ScalarInteger(main_model_p->dim_M_comm_1));
  SET_VECTOR_ELT(state, 636, ScalarInteger(main_model_p->dim_M_comm_2));
  SET_VECTOR_ELT(state, 637, allocVector(REALSXP, main_model_p->dim_M_comm));
  memcpy(REAL(VECTOR_ELT(state, 637)), main_model_p->M_comm, main_model_p->dim_M_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 637), 2, main_model_p->dim_M_comm_1, main_model_p->dim_M_comm_2);
  SET_VECTOR_ELT(state, 638, ScalarInteger(main_model_p->offset_output_M_comm));
  SET_VECTOR_ELT(state, 639, ScalarInteger(main_model_p->dim_M_noncomm));
  SET_VECTOR_ELT(state, 640, ScalarInteger(main_model_p->dim_M_noncomm_1));
  SET_VECTOR_ELT(state, 641, ScalarInteger(main_model_p->dim_M_noncomm_2));
  SET_VECTOR_ELT(state, 642, allocVector(REALSXP, main_model_p->dim_M_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 642)), main_model_p->M_noncomm, main_model_p->dim_M_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 642), 2, main_model_p->dim_M_noncomm_1, main_model_p->dim_M_noncomm_2);
  SET_VECTOR_ELT(state, 643, ScalarInteger(main_model_p->offset_output_M_noncomm));
  SET_VECTOR_ELT(state, 644, ScalarInteger(main_model_p->dim_in_S0));
  SET_VECTOR_ELT(state, 645, ScalarInteger(main_model_p->dim_in_S0_1));
  SET_VECTOR_ELT(state, 646, ScalarInteger(main_model_p->dim_in_S0_2));
  SET_VECTOR_ELT(state, 647, allocVector(REALSXP, main_model_p->dim_in_S0));
  memcpy(REAL(VECTOR_ELT(state, 647)), main_model_p->in_S0, main_model_p->dim_in_S0 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 647), 2, main_model_p->dim_in_S0_1, main_model_p->dim_in_S0_2);
  SET_VECTOR_ELT(state, 648, ScalarInteger(main_model_p->dim_in_S1a));
  SET_VECTOR_ELT(state, 649, ScalarInteger(main_model_p->dim_in_S1a_1));
  SET_VECTOR_ELT(state, 650, ScalarInteger(main_model_p->dim_in_S1a_2));
  SET_VECTOR_ELT(state, 651, allocVector(REALSXP, main_model_p->dim_in_S1a));
  memcpy(REAL(VECTOR_ELT(state, 651)), main_model_p->in_S1a, main_model_p->dim_in_S1a * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 651), 2, main_model_p->dim_in_S1a_1, main_model_p->dim_in_S1a_2);
  SET_VECTOR_ELT(state, 652, ScalarInteger(main_model_p->dim_in_S1b));
  SET_VECTOR_ELT(state, 653, ScalarInteger(main_model_p->dim_in_S1b_1));
  SET_VECTOR_ELT(state, 654, ScalarInteger(main_model_p->dim_in_S1b_2));
  SET_VECTOR_ELT(state, 655, allocVector(REALSXP, main_model_p->dim_in_S1b));
  memcpy(REAL(VECTOR_ELT(state, 655)), main_model_p->in_S1b, main_model_p->dim_in_S1b * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 655), 2, main_model_p->dim_in_S1b_1, main_model_p->dim_in_S1b_2);
  SET_VECTOR_ELT(state, 656, ScalarInteger(main_model_p->dim_in_S1c));
  SET_VECTOR_ELT(state, 657, ScalarInteger(main_model_p->dim_in_S1c_1));
  SET_VECTOR_ELT(state, 658, ScalarInteger(main_model_p->dim_in_S1c_2));
  SET_VECTOR_ELT(state, 659, allocVector(REALSXP, main_model_p->dim_in_S1c));
  memcpy(REAL(VECTOR_ELT(state, 659)), main_model_p->in_S1c, main_model_p->dim_in_S1c * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 659), 2, main_model_p->dim_in_S1c_1, main_model_p->dim_in_S1c_2);
  SET_VECTOR_ELT(state, 660, ScalarInteger(main_model_p->dim_in_S1d));
  SET_VECTOR_ELT(state, 661, ScalarInteger(main_model_p->dim_in_S1d_1));
  SET_VECTOR_ELT(state, 662, ScalarInteger(main_model_p->dim_in_S1d_2));
  SET_VECTOR_ELT(state, 663, allocVector(REALSXP, main_model_p->dim_in_S1d));
  memcpy(REAL(VECTOR_ELT(state, 663)), main_model_p->in_S1d, main_model_p->dim_in_S1d * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 663), 2, main_model_p->dim_in_S1d_1, main_model_p->dim_in_S1d_2);
  SET_VECTOR_ELT(state, 664, ScalarInteger(main_model_p->dim_in_I01));
  SET_VECTOR_ELT(state, 665, ScalarInteger(main_model_p->dim_in_I01_1));
  SET_VECTOR_ELT(state, 666, ScalarInteger(main_model_p->dim_in_I01_2));
  SET_VECTOR_ELT(state, 667, allocVector(REALSXP, main_model_p->dim_in_I01));
  memcpy(REAL(VECTOR_ELT(state, 667)), main_model_p->in_I01, main_model_p->dim_in_I01 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 667), 2, main_model_p->dim_in_I01_1, main_model_p->dim_in_I01_2);
  SET_VECTOR_ELT(state, 668, ScalarInteger(main_model_p->dim_in_I11));
  SET_VECTOR_ELT(state, 669, ScalarInteger(main_model_p->dim_in_I11_1));
  SET_VECTOR_ELT(state, 670, ScalarInteger(main_model_p->dim_in_I11_2));
  SET_VECTOR_ELT(state, 671, allocVector(REALSXP, main_model_p->dim_in_I11));
  memcpy(REAL(VECTOR_ELT(state, 671)), main_model_p->in_I11, main_model_p->dim_in_I11 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 671), 2, main_model_p->dim_in_I11_1, main_model_p->dim_in_I11_2);
  SET_VECTOR_ELT(state, 672, ScalarInteger(main_model_p->dim_in_I02));
  SET_VECTOR_ELT(state, 673, ScalarInteger(main_model_p->dim_in_I02_1));
  SET_VECTOR_ELT(state, 674, ScalarInteger(main_model_p->dim_in_I02_2));
  SET_VECTOR_ELT(state, 675, allocVector(REALSXP, main_model_p->dim_in_I02));
  memcpy(REAL(VECTOR_ELT(state, 675)), main_model_p->in_I02, main_model_p->dim_in_I02 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 675), 2, main_model_p->dim_in_I02_1, main_model_p->dim_in_I02_2);
  SET_VECTOR_ELT(state, 676, ScalarInteger(main_model_p->dim_in_I03));
  SET_VECTOR_ELT(state, 677, ScalarInteger(main_model_p->dim_in_I03_1));
  SET_VECTOR_ELT(state, 678, ScalarInteger(main_model_p->dim_in_I03_2));
  SET_VECTOR_ELT(state, 679, allocVector(REALSXP, main_model_p->dim_in_I03));
  memcpy(REAL(VECTOR_ELT(state, 679)), main_model_p->in_I03, main_model_p->dim_in_I03 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 679), 2, main_model_p->dim_in_I03_1, main_model_p->dim_in_I03_2);
  SET_VECTOR_ELT(state, 680, ScalarInteger(main_model_p->dim_in_I04));
  SET_VECTOR_ELT(state, 681, ScalarInteger(main_model_p->dim_in_I04_1));
  SET_VECTOR_ELT(state, 682, ScalarInteger(main_model_p->dim_in_I04_2));
  SET_VECTOR_ELT(state, 683, allocVector(REALSXP, main_model_p->dim_in_I04));
  memcpy(REAL(VECTOR_ELT(state, 683)), main_model_p->in_I04, main_model_p->dim_in_I04 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 683), 2, main_model_p->dim_in_I04_1, main_model_p->dim_in_I04_2);
  SET_VECTOR_ELT(state, 684, ScalarInteger(main_model_p->dim_in_I05));
  SET_VECTOR_ELT(state, 685, ScalarInteger(main_model_p->dim_in_I05_1));
  SET_VECTOR_ELT(state, 686, ScalarInteger(main_model_p->dim_in_I05_2));
  SET_VECTOR_ELT(state, 687, allocVector(REALSXP, main_model_p->dim_in_I05));
  memcpy(REAL(VECTOR_ELT(state, 687)), main_model_p->in_I05, main_model_p->dim_in_I05 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 687), 2, main_model_p->dim_in_I05_1, main_model_p->dim_in_I05_2);
  SET_VECTOR_ELT(state, 688, ScalarInteger(main_model_p->dim_in_I22));
  SET_VECTOR_ELT(state, 689, ScalarInteger(main_model_p->dim_in_I22_1));
  SET_VECTOR_ELT(state, 690, ScalarInteger(main_model_p->dim_in_I22_2));
  SET_VECTOR_ELT(state, 691, allocVector(REALSXP, main_model_p->dim_in_I22));
  memcpy(REAL(VECTOR_ELT(state, 691)), main_model_p->in_I22, main_model_p->dim_in_I22 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 691), 2, main_model_p->dim_in_I22_1, main_model_p->dim_in_I22_2);
  SET_VECTOR_ELT(state, 692, ScalarInteger(main_model_p->dim_in_I23));
  SET_VECTOR_ELT(state, 693, ScalarInteger(main_model_p->dim_in_I23_1));
  SET_VECTOR_ELT(state, 694, ScalarInteger(main_model_p->dim_in_I23_2));
  SET_VECTOR_ELT(state, 695, allocVector(REALSXP, main_model_p->dim_in_I23));
  memcpy(REAL(VECTOR_ELT(state, 695)), main_model_p->in_I23, main_model_p->dim_in_I23 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 695), 2, main_model_p->dim_in_I23_1, main_model_p->dim_in_I23_2);
  SET_VECTOR_ELT(state, 696, ScalarInteger(main_model_p->dim_in_I24));
  SET_VECTOR_ELT(state, 697, ScalarInteger(main_model_p->dim_in_I24_1));
  SET_VECTOR_ELT(state, 698, ScalarInteger(main_model_p->dim_in_I24_2));
  SET_VECTOR_ELT(state, 699, allocVector(REALSXP, main_model_p->dim_in_I24));
  memcpy(REAL(VECTOR_ELT(state, 699)), main_model_p->in_I24, main_model_p->dim_in_I24 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 699), 2, main_model_p->dim_in_I24_1, main_model_p->dim_in_I24_2);
  SET_VECTOR_ELT(state, 700, ScalarInteger(main_model_p->dim_in_I25));
  SET_VECTOR_ELT(state, 701, ScalarInteger(main_model_p->dim_in_I25_1));
  SET_VECTOR_ELT(state, 702, ScalarInteger(main_model_p->dim_in_I25_2));
  SET_VECTOR_ELT(state, 703, allocVector(REALSXP, main_model_p->dim_in_I25));
  memcpy(REAL(VECTOR_ELT(state, 703)), main_model_p->in_I25, main_model_p->dim_in_I25 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 703), 2, main_model_p->dim_in_I25_1, main_model_p->dim_in_I25_2);
  SET_VECTOR_ELT(state, 704, ScalarInteger(main_model_p->dim_in_I32));
  SET_VECTOR_ELT(state, 705, ScalarInteger(main_model_p->dim_in_I32_1));
  SET_VECTOR_ELT(state, 706, ScalarInteger(main_model_p->dim_in_I32_2));
  SET_VECTOR_ELT(state, 707, allocVector(REALSXP, main_model_p->dim_in_I32));
  memcpy(REAL(VECTOR_ELT(state, 707)), main_model_p->in_I32, main_model_p->dim_in_I32 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 707), 2, main_model_p->dim_in_I32_1, main_model_p->dim_in_I32_2);
  SET_VECTOR_ELT(state, 708, ScalarInteger(main_model_p->dim_in_I33));
  SET_VECTOR_ELT(state, 709, ScalarInteger(main_model_p->dim_in_I33_1));
  SET_VECTOR_ELT(state, 710, ScalarInteger(main_model_p->dim_in_I33_2));
  SET_VECTOR_ELT(state, 711, allocVector(REALSXP, main_model_p->dim_in_I33));
  memcpy(REAL(VECTOR_ELT(state, 711)), main_model_p->in_I33, main_model_p->dim_in_I33 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 711), 2, main_model_p->dim_in_I33_1, main_model_p->dim_in_I33_2);
  SET_VECTOR_ELT(state, 712, ScalarInteger(main_model_p->dim_in_I34));
  SET_VECTOR_ELT(state, 713, ScalarInteger(main_model_p->dim_in_I34_1));
  SET_VECTOR_ELT(state, 714, ScalarInteger(main_model_p->dim_in_I34_2));
  SET_VECTOR_ELT(state, 715, allocVector(REALSXP, main_model_p->dim_in_I34));
  memcpy(REAL(VECTOR_ELT(state, 715)), main_model_p->in_I34, main_model_p->dim_in_I34 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 715), 2, main_model_p->dim_in_I34_1, main_model_p->dim_in_I34_2);
  SET_VECTOR_ELT(state, 716, ScalarInteger(main_model_p->dim_in_I35));
  SET_VECTOR_ELT(state, 717, ScalarInteger(main_model_p->dim_in_I35_1));
  SET_VECTOR_ELT(state, 718, ScalarInteger(main_model_p->dim_in_I35_2));
  SET_VECTOR_ELT(state, 719, allocVector(REALSXP, main_model_p->dim_in_I35));
  memcpy(REAL(VECTOR_ELT(state, 719)), main_model_p->in_I35, main_model_p->dim_in_I35 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 719), 2, main_model_p->dim_in_I35_1, main_model_p->dim_in_I35_2);
  SET_VECTOR_ELT(state, 720, ScalarInteger(main_model_p->dim_in_I42));
  SET_VECTOR_ELT(state, 721, ScalarInteger(main_model_p->dim_in_I42_1));
  SET_VECTOR_ELT(state, 722, ScalarInteger(main_model_p->dim_in_I42_2));
  SET_VECTOR_ELT(state, 723, allocVector(REALSXP, main_model_p->dim_in_I42));
  memcpy(REAL(VECTOR_ELT(state, 723)), main_model_p->in_I42, main_model_p->dim_in_I42 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 723), 2, main_model_p->dim_in_I42_1, main_model_p->dim_in_I42_2);
  SET_VECTOR_ELT(state, 724, ScalarInteger(main_model_p->dim_in_I43));
  SET_VECTOR_ELT(state, 725, ScalarInteger(main_model_p->dim_in_I43_1));
  SET_VECTOR_ELT(state, 726, ScalarInteger(main_model_p->dim_in_I43_2));
  SET_VECTOR_ELT(state, 727, allocVector(REALSXP, main_model_p->dim_in_I43));
  memcpy(REAL(VECTOR_ELT(state, 727)), main_model_p->in_I43, main_model_p->dim_in_I43 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 727), 2, main_model_p->dim_in_I43_1, main_model_p->dim_in_I43_2);
  SET_VECTOR_ELT(state, 728, ScalarInteger(main_model_p->dim_in_I44));
  SET_VECTOR_ELT(state, 729, ScalarInteger(main_model_p->dim_in_I44_1));
  SET_VECTOR_ELT(state, 730, ScalarInteger(main_model_p->dim_in_I44_2));
  SET_VECTOR_ELT(state, 731, allocVector(REALSXP, main_model_p->dim_in_I44));
  memcpy(REAL(VECTOR_ELT(state, 731)), main_model_p->in_I44, main_model_p->dim_in_I44 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 731), 2, main_model_p->dim_in_I44_1, main_model_p->dim_in_I44_2);
  SET_VECTOR_ELT(state, 732, ScalarInteger(main_model_p->dim_in_I45));
  SET_VECTOR_ELT(state, 733, ScalarInteger(main_model_p->dim_in_I45_1));
  SET_VECTOR_ELT(state, 734, ScalarInteger(main_model_p->dim_in_I45_2));
  SET_VECTOR_ELT(state, 735, allocVector(REALSXP, main_model_p->dim_in_I45));
  memcpy(REAL(VECTOR_ELT(state, 735)), main_model_p->in_I45, main_model_p->dim_in_I45 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 735), 2, main_model_p->dim_in_I45_1, main_model_p->dim_in_I45_2);
  SET_VECTOR_ELT(state, 736, ScalarInteger(main_model_p->dim_rate_move_in));
  SET_VECTOR_ELT(state, 737, ScalarInteger(main_model_p->dim_rate_move_in_1));
  SET_VECTOR_ELT(state, 738, ScalarInteger(main_model_p->dim_rate_move_in_2));
  SET_VECTOR_ELT(state, 739, allocVector(REALSXP, main_model_p->dim_rate_move_in));
  memcpy(REAL(VECTOR_ELT(state, 739)), main_model_p->rate_move_in, main_model_p->dim_rate_move_in * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 739), 2, main_model_p->dim_rate_move_in_1, main_model_p->dim_rate_move_in_2);
  SET_VECTOR_ELT(state, 740, ScalarInteger(main_model_p->offset_output_rate_move_in));
  SET_VECTOR_ELT(state, 741, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_VECTOR_ELT(state, 742, allocVector(REALSXP, main_model_p->dim_rate_move_out));
  memcpy(REAL(VECTOR_ELT(state, 742)), main_model_p->rate_move_out, main_model_p->dim_rate_move_out * sizeof(double));
  SET_VECTOR_ELT(state, 743, ScalarInteger(main_model_p->offset_output_rate_move_out));
  SET_VECTOR_ELT(state, 747, ScalarReal(main_model_p->ART_eligible_CD4_above_500));
  SET_VECTOR_ELT(state, 749, ScalarReal(main_model_p->ART_eligible_CD4_350_500));
  SET_VECTOR_ELT(state, 751, ScalarReal(main_model_p->ART_eligible_CD4_200_349));
  SET_VECTOR_ELT(state, 753, ScalarReal(main_model_p->ART_eligible_CD4_below_200));
  SET_VECTOR_ELT(state, 759, ScalarReal(main_model_p->epsilon));
  SET_VECTOR_ELT(state, 767, ScalarInteger(main_model_p->dim));
  SET_VECTOR_ELT(state, 768, ScalarInteger(main_model_p->dim_output));
  SEXP state_names = PROTECT(allocVector(STRSXP, 769));
  ...
  SET_STRING_ELT(state_names, 371, mkChar("dim_eP1a"));
  SET_STRING_ELT(state_names, 372, mkChar("eP1a"));
  SET_STRING_ELT(state_names, 373, mkChar("dim_eP1b"));
  SET_STRING_ELT(state_names, 374, mkChar("eP1b"));
  SET_STRING_ELT(state_names, 375, mkChar("dim_eP1c"));
  SET_STRING_ELT(state_names, 376, mkChar("eP1c"));
  SET_STRING_ELT(state_names, 377, mkChar("dim_eP1d"));
  SET_STRING_ELT(state_names, 378, mkChar("eP1d"));
  SET_STRING_ELT(state_names, 379, mkChar("dim_fc_comm"));
  SET_STRING_ELT(state_names, 380, mkChar("dim_fc_comm_1"));
  SET_STRING_ELT(state_names, 381, mkChar("dim_fc_comm_2"));
  SET_STRING_ELT(state_names, 382, mkChar("fc_comm"));
  SET_STRING_ELT(state_names, 383, mkChar("offset_output_fc_comm"));
  SET_STRING_ELT(state_names, 384, mkChar("dim_fP_comm"));
  SET_STRING_ELT(state_names, 385, mkChar("fP_comm"));
  SET_STRING_ELT(state_names, 386, mkChar("offset_output_fP_comm"));
  SET_STRING_ELT(state_names, 387, mkChar("dim_fc_noncomm"));
  SET_STRING_ELT(state_names, 388, mkChar("dim_fc_noncomm_1"));
  SET_STRING_ELT(state_names, 389, mkChar("dim_fc_noncomm_2"));
  SET_STRING_ELT(state_names, 390, mkChar("fc_noncomm"));
  SET_STRING_ELT(state_names, 391, mkChar("offset_output_fc_noncomm"));
  SET_STRING_ELT(state_names, 392, mkChar("dim_fP_noncomm"));
  SET_STRING_ELT(state_names, 393, mkChar("fP_noncomm"));
  SET_STRING_ELT(state_names, 394, mkChar("offset_output_fP_noncomm"));
  SET_STRING_ELT(state_names, 395, mkChar("dim_n_comm"));
  SET_STRING_ELT(state_names, 396, mkChar("dim_n_comm_1"));
  SET_STRING_ELT(state_names, 397, mkChar("dim_n_comm_2"));
  SET_STRING_ELT(state_names, 398, mkChar("n_comm"));
  SET_STRING_ELT(state_names, 399, mkChar("offset_output_n_comm"));
  SET_STRING_ELT(state_names, 400, mkChar("dim_n_noncomm"));
  SET_STRING_ELT(state_names, 401, mkChar("dim_n_noncomm_1"));
  SET_STRING_ELT(state_names, 402, mkChar("dim_n_noncomm_2"));
  SET_STRING_ELT(state_names, 403, mkChar("n_noncomm"));
  SET_STRING_ELT(state_names, 404, mkChar("offset_output_n_noncomm"));
  SET_STRING_ELT(state_names, 405, mkChar("dim_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 406, mkChar("initial_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 407, mkChar("offset_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 408, mkChar("dim_cumuARTinitiations"));
  SET_STRING_ELT(state_names, 409, mkChar("initial_cumuARTinitiations"));
  SET_STRING_ELT(state_names, 410, mkChar("offset_cumuARTinitiations"));
  SET_STRING_ELT(state_names, 411, mkChar("dim_cumuARTREinitiations"));
  SET_STRING_ELT(state_names, 412, mkChar("initial_cumuARTREinitiations"));
  SET_STRING_ELT(state_names, 413, mkChar("offset_cumuARTREinitiations"));
  SET_STRING_ELT(state_names, 414, mkChar("dim_dropouts"));
  SET_STRING_ELT(state_names, 415, mkChar("initial_dropouts"));
  SET_STRING_ELT(state_names, 416, mkChar("offset_dropouts"));
  SET_STRING_ELT(state_names, 417, mkChar("dim_cumuAllDeaths"));
  SET_STRING_ELT(state_names, 418, mkChar("initial_cumuAllDeaths"));
  SET_STRING_ELT(state_names, 419, mkChar("offset_cumuAllDeaths"));
  SET_STRING_ELT(state_names, 420, mkChar("dim_cumuInf"));
  SET_STRING_ELT(state_names, 421, mkChar("initial_cumuInf"));
  SET_STRING_ELT(state_names, 422, mkChar("offset_cumuInf"));
  SET_STRING_ELT(state_names, 423, mkChar("dim_PrEPinitiations"));
  SET_STRING_ELT(state_names, 424, mkChar("initial_PrEPinitiations"));
  SET_STRING_ELT(state_names, 425, mkChar("offset_PrEPinitiations"));
  SET_STRING_ELT(state_names, 426, mkChar("dim_PrEPinitiations1a"));
  SET_STRING_ELT(state_names, 427, mkChar("initial_PrEPinitiations1a"));
  SET_STRING_ELT(state_names, 428, mkChar("offset_PrEPinitiations1a"));
  SET_STRING_ELT(state_names, 429, mkChar("dim_PrEPinitiations1b"));
  SET_STRING_ELT(state_names, 430, mkChar("initial_PrEPinitiations1b"));
  SET_STRING_ELT(state_names, 431, mkChar("offset_PrEPinitiations1b"));
  SET_STRING_ELT(state_names, 432, mkChar("dim_PrEPinitiations1c"));
  SET_STRING_ELT(state_names, 433, mkChar("initial_PrEPinitiations1c"));
  SET_STRING_ELT(state_names, 434, mkChar("offset_PrEPinitiations1c"));
  SET_STRING_ELT(state_names, 435, mkChar("dim_S0"));
  SET_STRING_ELT(state_names, 436, mkChar("initial_S0"));
  SET_STRING_ELT(state_names, 437, mkChar("offset_S0"));
  SET_STRING_ELT(state_names, 438, mkChar("dim_S1a"));
  SET_STRING_ELT(state_names, 439, mkChar("initial_S1a"));
  SET_STRING_ELT(state_names, 440, mkChar("offset_S1a"));
  SET_STRING_ELT(state_names, 441, mkChar("dim_S1b"));
  SET_STRING_ELT(state_names, 442, mkChar("initial_S1b"));
  SET_STRING_ELT(state_names, 443, mkChar("offset_S1b"));
  SET_STRING_ELT(state_names, 444, mkChar("dim_S1c"));
  SET_STRING_ELT(state_names, 445, mkChar("initial_S1c"));
  SET_STRING_ELT(state_names, 446, mkChar("offset_S1c"));
  SET_STRING_ELT(state_names, 447, mkChar("dim_S1d"));
  SET_STRING_ELT(state_names, 448, mkChar("initial_S1d"));
  SET_STRING_ELT(state_names, 449, mkChar("offset_S1d"));
  SET_STRING_ELT(state_names, 450, mkChar("dim_I01"));
  SET_STRING_ELT(state_names, 451, mkChar("initial_I01"));
  SET_STRING_ELT(state_names, 452, mkChar("offset_I01"));
  SET_STRING_ELT(state_names, 453, mkChar("dim_I11"));
  SET_STRING_ELT(state_names, 454, mkChar("initial_I11"));
  SET_STRING_ELT(state_names, 455, mkChar("offset_I11"));
  SET_STRING_ELT(state_names, 456, mkChar("dim_I02"));
  SET_STRING_ELT(state_names, 457, mkChar("initial_I02"));
  SET_STRING_ELT(state_names, 458, mkChar("offset_I02"));
  SET_STRING_ELT(state_names, 459, mkChar("dim_I03"));
  SET_STRING_ELT(state_names, 460, mkChar("initial_I03"));
  SET_STRING_ELT(state_names, 461, mkChar("offset_I03"));
  SET_STRING_ELT(state_names, 462, mkChar("dim_I04"));
  SET_STRING_ELT(state_names, 463, mkChar("initial_I04"));
  SET_STRING_ELT(state_names, 464, mkChar("offset_I04"));
  SET_STRING_ELT(state_names, 465, mkChar("dim_I05"));
  SET_STRING_ELT(state_names, 466, mkChar("initial_I05"));
  SET_STRING_ELT(state_names, 467, mkChar("offset_I05"));
  SET_STRING_ELT(state_names, 468, mkChar("dim_I22"));
  SET_STRING_ELT(state_names, 469, mkChar("initial_I22"));
  SET_STRING_ELT(state_names, 470, mkChar("offset_I22"));
  SET_STRING_ELT(state_names, 471, mkChar("dim_I23"));
  SET_STRING_ELT(state_names, 472, mkChar("initial_I23"));
  SET_STRING_ELT(state_names, 473, mkChar("offset_I23"));
  SET_STRING_ELT(state_names, 474, mkChar("dim_I24"));
  SET_STRING_ELT(state_names, 475, mkChar("initial_I24"));
  SET_STRING_ELT(state_names, 476, mkChar("offset_I24"));
  SET_STRING_ELT(state_names, 477, mkChar("dim_I25"));
  SET_STRING_ELT(state_names, 478, mkChar("initial_I25"));
  SET_STRING_ELT(state_names, 479, mkChar("offset_I25"));
  SET_STRING_ELT(state_names, 480, mkChar("dim_I32"));
  SET_STRING_ELT(state_names, 481, mkChar("initial_I32"));
  SET_STRING_ELT(state_names, 482, mkChar("offset_I32"));
  SET_STRING_ELT(state_names, 483, mkChar("dim_I33"));
  SET_STRING_ELT(state_names, 484, mkChar("initial_I33"));
  SET_STRING_ELT(state_names, 485, mkChar("offset_I33"));
  SET_STRING_ELT(state_names, 486, mkChar("dim_I34"));
  SET_STRING_ELT(state_names, 487, mkChar("initial_I34"));
  SET_STRING_ELT(state_names, 488, mkChar("offset_I34"));
  SET_STRING_ELT(state_names, 489, mkChar("dim_I35"));
  SET_STRING_ELT(state_names, 490, mkChar("initial_I35"));
  SET_STRING_ELT(state_names, 491, mkChar("offset_I35"));
  SET_STRING_ELT(state_names, 492, mkChar("dim_I42"));
  SET_STRING_ELT(state_names, 493, mkChar("initial_I42"));
  SET_STRING_ELT(state_names, 494, mkChar("offset_I42"));
  SET_STRING_ELT(state_names, 495, mkChar("dim_I43"));
  SET_STRING_ELT(state_names, 496, mkChar("initial_I43"));
  SET_STRING_ELT(state_names, 497, mkChar("offset_I43"));
  SET_STRING_ELT(state_names, 498, mkChar("dim_I44"));
  SET_STRING_ELT(state_names, 499, mkChar("initial_I44"));
  SET_STRING_ELT(state_names, 500, mkChar("offset_I44"));
  SET_STRING_ELT(state_names, 501, mkChar("dim_I45"));
  SET_STRING_ELT(state_names, 502, mkChar("initial_I45"));
  SET_STRING_ELT(state_names, 503, mkChar("offset_I45"));
  SET_STRING_ELT(state_names, 504, mkChar("dim_S0_init"));
  SET_STRING_ELT(state_names, 505, mkChar("S0_init"));
  SET_STRING_ELT(state_names, 506, mkChar("dim_S1a_init"));
  SET_STRING_ELT(state_names, 507, mkChar("S1a_init"));
  SET_STRING_ELT(state_names, 508, mkChar("dim_S1b_init"));
  SET_STRING_ELT(state_names, 509, mkChar("S1b_init"));
  SET_STRING_ELT(state_names, 510, mkChar("dim_S1c_init"));
  SET_STRING_ELT(state_names, 511, mkChar("S1c_init"));
  SET_STRING_ELT(state_names, 512, mkChar("dim_S1d_init"));
  SET_STRING_ELT(state_names, 513, mkChar("S1d_init"));
  SET_STRING_ELT(state_names, 514, mkChar("dim_I01_init"));
  SET_STRING_ELT(state_names, 515, mkChar("I01_init"));
  SET_STRING_ELT(state_names, 516, mkChar("dim_I11_init"));
  SET_STRING_ELT(state_names, 517, mkChar("I11_init"));
  SET_STRING_ELT(state_names, 518, mkChar("dim_I02_init"));
  SET_STRING_ELT(state_names, 519, mkChar("I02_init"));
  SET_STRING_ELT(state_names, 520, mkChar("dim_I03_init"));
  SET_STRING_ELT(state_names, 521, mkChar("I03_init"));
  SET_STRING_ELT(state_names, 522, mkChar("dim_I04_init"));
  SET_STRING_ELT(state_names, 523, mkChar("I04_init"));
  SET_STRING_ELT(state_names, 524, mkChar("dim_I05_init"));
  SET_STRING_ELT(state_names, 525, mkChar("I05_init"));
  SET_STRING_ELT(state_names, 526, mkChar("dim_I22_init"));
  SET_STRING_ELT(state_names, 527, mkChar("I22_init"));
  SET_STRING_ELT(state_names, 528, mkChar("dim_I23_init"));
  SET_STRING_ELT(state_names, 529, mkChar("I23_init"));
  SET_STRING_ELT(state_names, 530, mkChar("dim_I24_init"));
  SET_STRING_ELT(state_names, 531, mkChar("I24_init"));
  SET_STRING_ELT(state_names, 532, mkChar("dim_I25_init"));
  SET_STRING_ELT(state_names, 533, mkChar("I25_init"));
  SET_STRING_ELT(state_names, 534, mkChar("dim_I32_init"));
  SET_STRING_ELT(state_names, 535, mkChar("I32_init"));
  SET_STRING_ELT(state_names, 536, mkChar("dim_I33_init"));
  SET_STRING_ELT(state_names, 537, mkChar("I33_init"));
  SET_STRING_ELT(state_names, 538, mkChar("dim_I34_init"));
  SET_STRING_ELT(state_names, 539, mkChar("I34_init"));
  SET_STRING_ELT(state_names, 540, mkChar("dim_I35_init"));
  SET_STRING_ELT(state_names, 541, mkChar("I35_init"));
  SET_STRING_ELT(state_names, 542, mkChar("dim_I42_init"));
  SET_STRING_ELT(state_names, 543, mkChar("I42_init"));
  SET_STRING_ELT(state_names, 544, mkChar("dim_I43_init"));
  SET_STRING_ELT(state_names, 545, mkChar("I43_init"));
  SET_STRING_ELT(state_names, 546, mkChar("dim_I44_init"));
  SET_STRING_ELT(state_names, 547, mkChar("I44_init"));
  SET_STRING_ELT(state_names, 548, mkChar("dim_I45_init"));
  SET_STRING_ELT(state_names, 549, mkChar("I45_init"));
  SET_STRING_ELT(state_names, 550, mkChar("dim_N"));
  SET_STRING_ELT(state_names, 551, mkChar("N"));
  SET_STRING_ELT(state_names, 552, mkChar("offset_output_N"));
  SET_STRING_ELT(state_names, 553, mkChar("dim_E0"));
  SET_STRING_ELT(state_names, 554, mkChar("E0"));
  SET_STRING_ELT(state_names, 555, mkChar("offset_output_E0"));
  SET_STRING_ELT(state_names, 556, mkChar("dim_E1a"));
  SET_STRING_ELT(state_names, 557, mkChar("E1a"));
  SET_STRING_ELT(state_names, 558, mkChar("offset_output_E1a"));
  SET_STRING_ELT(state_names, 559, mkChar("dim_E1b"));
  SET_STRING_ELT(state_names, 560, mkChar("E1b"));
  SET_STRING_ELT(state_names, 561, mkChar("offset_output_E1b"));
  SET_STRING_ELT(state_names, 562, mkChar("dim_E1c"));
  SET_STRING_ELT(state_names, 563, mkChar("E1c"));
  SET_STRING_ELT(state_names, 564, mkChar("offset_output_E1c"));
  SET_STRING_ELT(state_names, 565, mkChar("dim_E1d"));
  SET_STRING_ELT(state_names, 566, mkChar("E1d"));
  SET_STRING_ELT(state_names, 567, mkChar("offset_output_E1d"));
  SET_STRING_ELT(state_names, 568, mkChar("dim_cumuInf_init"));
  SET_STRING_ELT(state_names, 569, mkChar("cumuInf_init"));
  SET_STRING_ELT(state_names, 570, mkChar("dim_alphaItot"));
  SET_STRING_ELT(state_names, 571, mkChar("alphaItot"));
  SET_STRING_ELT(state_names, 572, mkChar("offset_output_alphaItot"));
  SET_STRING_ELT(state_names, 573, mkChar("dim_prev"));
  SET_STRING_ELT(state_names, 574, mkChar("prev"));
  SET_STRING_ELT(state_names, 575, mkChar("offset_output_prev"));
  SET_STRING_ELT(state_names, 576, mkChar("dim_lambda"));
  SET_STRING_ELT(state_names, 577, mkChar("dim_lambda_1"));
  SET_STRING_ELT(state_names, 578, mkChar("dim_lambda_2"));
  SET_STRING_ELT(state_names, 579, mkChar("lambda"));
  SET_STRING_ELT(state_names, 580, mkChar("offset_output_lambda"));
  SET_STRING_ELT(state_names, 581, mkChar("dim_lambda_0"));
  SET_STRING_ELT(state_names, 582, mkChar("dim_lambda_0_1"));
  SET_STRING_ELT(state_names, 583, mkChar("dim_lambda_0_2"));
  SET_STRING_ELT(state_names, 584, mkChar("lambda_0"));
  SET_STRING_ELT(state_names, 585, mkChar("offset_output_lambda_0"));
  SET_STRING_ELT(state_names, 586, mkChar("dim_lambda_1a"));
  SET_STRING_ELT(state_names, 587, mkChar("dim_lambda_1a_1"));
  SET_STRING_ELT(state_names, 588, mkChar("dim_lambda_1a_2"));
  SET_STRING_ELT(state_names, 589, mkChar("lambda_1a"));
  SET_STRING_ELT(state_names, 590, mkChar("offset_output_lambda_1a"));
  SET_STRING_ELT(state_names, 591, mkChar("dim_lambda_1b"));
  SET_STRING_ELT(state_names, 592, mkChar("dim_lambda_1b_1"));
  SET_STRING_ELT(state_names, 593, mkChar("dim_lambda_1b_2"));
  SET_STRING_ELT(state_names, 594, mkChar("lambda_1b"));
  SET_STRING_ELT(state_names, 595, mkChar("offset_output_lambda_1b"));
  SET_STRING_ELT(state_names, 596, mkChar("dim_lambda_1c"));
  SET_STRING_ELT(state_names, 597, mkChar("dim_lambda_1c_1"));
  SET_STRING_ELT(state_names, 598, mkChar("dim_lambda_1c_2"));
  SET_STRING_ELT(state_names, 599, mkChar("lambda_1c"));
  SET_STRING_ELT(state_names, 600, mkChar("offset_output_lambda_1c"));
  SET_STRING_ELT(state_names, 601, mkChar("dim_lambda_1d"));
  SET_STRING_ELT(state_names, 602, mkChar("dim_lambda_1d_1"));
  SET_STRING_ELT(state_names, 603, mkChar("dim_lambda_1d_2"));
  SET_STRING_ELT(state_names, 604, mkChar("lambda_1d"));
  SET_STRING_ELT(state_names, 605, mkChar("offset_output_lambda_1d"));
  SET_STRING_ELT(state_names, 606, mkChar("dim_lambda_sum_0"));
  SET_STRING_ELT(state_names, 607, mkChar("lambda_sum_0"));
  SET_STRING_ELT(state_names, 608, mkChar("offset_output_lambda_sum_0"));
  SET_STRING_ELT(state_names, 609, mkChar("dim_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 610, mkChar("lambda_sum_1a"));
  SET_STRING_ELT(state_names, 611, mkChar("offset_output_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 612, mkChar("dim_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 613, mkChar("lambda_sum_1b"));
  SET_STRING_ELT(state_names, 614, mkChar("offset_output_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 615, mkChar("dim_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 616, mkChar("lambda_sum_1c"));
  SET_STRING_ELT(state_names, 617, mkChar("offset_output_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 618, mkChar("dim_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 619, mkChar("lambda_sum_1d"));
  SET_STRING_ELT(state_names, 620, mkChar("offset_output_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 621, mkChar("dim_c_comm_balanced"));
  SET_STRING_ELT(state_names, 622, mkChar("c_comm_balanced"));
  SET_STRING_ELT(state_names, 623, mkChar("offset_output_c_comm_balanced"));
  SET_STRING_ELT(state_names, 624, mkChar("dim_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 625, mkChar("c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 626, mkChar("offset_output_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 627, mkChar("dim_theta"));
  SET_STRING_ELT(state_names, 628, mkChar("dim_theta_1"));
  SET_STRING_ELT(state_names, 629, mkChar("dim_theta_2"));
  SET_STRING_ELT(state_names, 630, mkChar("theta"));
  SET_STRING_ELT(state_names, 631, mkChar("offset_output_theta"));
  SET_STRING_ELT(state_names, 632, mkChar("dim_PrEPinitiations_init"));
  SET_STRING_ELT(state_names, 633, mkChar("PrEPinitiations_init"));
  SET_STRING_ELT(state_names, 634, mkChar("dim_M_comm"));
  SET_STRING_ELT(state_names, 635, mkChar("dim_M_comm_1"));
  SET_STRING_ELT(state_names, 636, mkChar("dim_M_comm_2"));
  SET_STRING_ELT(state_names, 637, mkChar("M_comm"));
  SET_STRING_ELT(state_names, 638, mkChar("offset_output_M_comm"));
  SET_STRING_ELT(state_names, 639, mkChar("dim_M_noncomm"));
  SET_STRING_ELT(state_names, 640, mkChar("dim_M_noncomm_1"));
  SET_STRING_ELT(state_names, 641, mkChar("dim_M_noncomm_2"));
  SET_STRING_ELT(state_names, 642, mkChar("M_noncomm"));
  SET_STRING_ELT(state_names, 643, mkChar("offset_output_M_noncomm"));
  SET_STRING_ELT(state_names, 644, mkChar("dim_in_S0"));
  SET_STRING_ELT(state_names, 645, mkChar("dim_in_S0_1"));
  SET_STRING_ELT(state_names, 646, mkChar("dim_in_S0_2"));
  SET_STRING_ELT(state_names, 647, mkChar("in_S0"));
  SET_STRING_ELT(state_names, 648, mkChar("dim_in_S1a"));
  SET_STRING_ELT(state_names, 649, mkChar("dim_in_S1a_1"));
  SET_STRING_ELT(state_names, 650, mkChar("dim_in_S1a_2"));
  SET_STRING_ELT(state_names, 651, mkChar("in_S1a"));
  SET_STRING_ELT(state_names, 652, mkChar("dim_in_S1b"));
  SET_STRING_ELT(state_names, 653, mkChar("dim_in_S1b_1"));
  SET_STRING_ELT(state_names, 654, mkChar("dim_in_S1b_2"));
  SET_STRING_ELT(state_names, 655, mkChar("in_S1b"));
  SET_STRING_ELT(state_names, 656, mkChar("dim_in_S1c"));
  SET_STRING_ELT(state_names, 657, mkChar("dim_in_S1c_1"));
  SET_STRING_ELT(state_names, 658, mkChar("dim_in_S1c_2"));
  SET_STRING_ELT(state_names, 659, mkChar("in_S1c"));
  SET_STRING_ELT(state_names, 660, mkChar("dim_in_S1d"));
  SET_STRING_ELT(state_names, 661, mkChar("dim_in_S1d_1"));
  SET_STRING_ELT(state_names, 662, mkChar("dim_in_S1d_2"));
  SET_STRING_ELT(state_names, 663, mkChar("in_S1d"));
  SET_STRING_ELT(state_names, 664, mkChar("dim_in_I01"));
  SET_STRING_ELT(state_names, 665, mkChar("dim_in_I01_1"));
  SET_STRING_ELT(state_names, 666, mkChar("dim_in_I01_2"));
  SET_STRING_ELT(state_names, 667, mkChar("in_I01"));
  SET_STRING_ELT(state_names, 668, mkChar("dim_in_I11"));
  SET_STRING_ELT(state_names, 669, mkChar("dim_in_I11_1"));
  SET_STRING_ELT(state_names, 670, mkChar("dim_in_I11_2"));
  SET_STRING_ELT(state_names, 671, mkChar("in_I11"));
  SET_STRING_ELT(state_names, 672, mkChar("dim_in_I02"));
  SET_STRING_ELT(state_names, 673, mkChar("dim_in_I02_1"));
  SET_STRING_ELT(state_names, 674, mkChar("dim_in_I02_2"));
  SET_STRING_ELT(state_names, 675, mkChar("in_I02"));
  SET_STRING_ELT(state_names, 676, mkChar("dim_in_I03"));
  SET_STRING_ELT(state_names, 677, mkChar("dim_in_I03_1"));
  SET_STRING_ELT(state_names, 678, mkChar("dim_in_I03_2"));
  SET_STRING_ELT(state_names, 679, mkChar("in_I03"));
  SET_STRING_ELT(state_names, 680, mkChar("dim_in_I04"));
  SET_STRING_ELT(state_names, 681, mkChar("dim_in_I04_1"));
  SET_STRING_ELT(state_names, 682, mkChar("dim_in_I04_2"));
  SET_STRING_ELT(state_names, 683, mkChar("in_I04"));
  SET_STRING_ELT(state_names, 684, mkChar("dim_in_I05"));
  SET_STRING_ELT(state_names, 685, mkChar("dim_in_I05_1"));
  SET_STRING_ELT(state_names, 686, mkChar("dim_in_I05_2"));
  SET_STRING_ELT(state_names, 687, mkChar("in_I05"));
  SET_STRING_ELT(state_names, 688, mkChar("dim_in_I22"));
  SET_STRING_ELT(state_names, 689, mkChar("dim_in_I22_1"));
  SET_STRING_ELT(state_names, 690, mkChar("dim_in_I22_2"));
  SET_STRING_ELT(state_names, 691, mkChar("in_I22"));
  SET_STRING_ELT(state_names, 692, mkChar("dim_in_I23"));
  SET_STRING_ELT(state_names, 693, mkChar("dim_in_I23_1"));
  SET_STRING_ELT(state_names, 694, mkChar("dim_in_I23_2"));
  SET_STRING_ELT(state_names, 695, mkChar("in_I23"));
  SET_STRING_ELT(state_names, 696, mkChar("dim_in_I24"));
  SET_STRING_ELT(state_names, 697, mkChar("dim_in_I24_1"));
  SET_STRING_ELT(state_names, 698, mkChar("dim_in_I24_2"));
  SET_STRING_ELT(state_names, 699, mkChar("in_I24"));
  SET_STRING_ELT(state_names, 700, mkChar("dim_in_I25"));
  SET_STRING_ELT(state_names, 701, mkChar("dim_in_I25_1"));
  SET_STRING_ELT(state_names, 702, mkChar("dim_in_I25_2"));
  SET_STRING_ELT(state_names, 703, mkChar("in_I25"));
  SET_STRING_ELT(state_names, 704, mkChar("dim_in_I32"));
  SET_STRING_ELT(state_names, 705, mkChar("dim_in_I32_1"));
  SET_STRING_ELT(state_names, 706, mkChar("dim_in_I32_2"));
  SET_STRING_ELT(state_names, 707, mkChar("in_I32"));
  SET_STRING_ELT(state_names, 708, mkChar("dim_in_I33"));
  SET_STRING_ELT(state_names, 709, mkChar("dim_in_I33_1"));
  SET_STRING_ELT(state_names, 710, mkChar("dim_in_I33_2"));
  SET_STRING_ELT(state_names, 711, mkChar("in_I33"));
  SET_STRING_ELT(state_names, 712, mkChar("dim_in_I34"));
  SET_STRING_ELT(state_names, 713, mkChar("dim_in_I34_1"));
  SET_STRING_ELT(state_names, 714, mkChar("dim_in_I34_2"));
  SET_STRING_ELT(state_names, 715, mkChar("in_I34"));
  SET_STRING_ELT(state_names, 716, mkChar("dim_in_I35"));
  SET_STRING_ELT(state_names, 717, mkChar("dim_in_I35_1"));
  SET_STRING_ELT(state_names, 718, mkChar("dim_in_I35_2"));
  SET_STRING_ELT(state_names, 719, mkChar("in_I35"));
  SET_STRING_ELT(state_names, 720, mkChar("dim_in_I42"));
  SET_STRING_ELT(state_names, 721, mkChar("dim_in_I42_1"));
  SET_STRING_ELT(state_names, 722, mkChar("dim_in_I42_2"));
  SET_STRING_ELT(state_names, 723, mkChar("in_I42"));
  SET_STRING_ELT(state_names, 724, mkChar("dim_in_I43"));
  SET_STRING_ELT(state_names, 725, mkChar("dim_in_I43_1"));
  SET_STRING_ELT(state_names, 726, mkChar("dim_in_I43_2"));
  SET_STRING_ELT(state_names, 727, mkChar("in_I43"));
  SET_STRING_ELT(state_names, 728, mkChar("dim_in_I44"));
  SET_STRING_ELT(state_names, 729, mkChar("dim_in_I44_1"));
  SET_STRING_ELT(state_names, 730, mkChar("dim_in_I44_2"));
  SET_STRING_ELT(state_names, 731, mkChar("in_I44"));
  SET_STRING_ELT(state_names, 732, mkChar("dim_in_I45"));
  SET_STRING_ELT(state_names, 733, mkChar("dim_in_I45_1"));
  SET_STRING_ELT(state_names, 734, mkChar("dim_in_I45_2"));
  SET_STRING_ELT(state_names, 735, mkChar("in_I45"));
  SET_STRING_ELT(state_names, 736, mkChar("dim_rate_move_in"));
  SET_STRING_ELT(state_names, 737, mkChar("dim_rate_move_in_1"));
  SET_STRING_ELT(state_names, 738, mkChar("dim_rate_move_in_2"));
  SET_STRING_ELT(state_names, 739, mkChar("rate_move_in"));
  SET_STRING_ELT(state_names, 740, mkChar("offset_output_rate_move_in"));
  SET_STRING_ELT(state_names, 741, mkChar("dim_rate_move_out"));
  SET_STRING_ELT(state_names, 742, mkChar("rate_move_out"));
  SET_STRING_ELT(state_names, 743, mkChar("offset_output_rate_move_out"));
  SET_STRING_ELT(state_names, 744, mkChar("interpolate_c_comm"));
  SET_STRING_ELT(state_names, 745, mkChar("interpolate_c_noncomm"));
  SET_STRING_ELT(state_names, 746, mkChar("interpolate_ART_eligible_CD4_above_500"));
  SET_STRING_ELT(state_names, 747, mkChar("ART_eligible_CD4_above_500"));
  SET_STRING_ELT(state_names, 748, mkChar("interpolate_ART_eligible_CD4_350_500"));
  SET_STRING_ELT(state_names, 749, mkChar("ART_eligible_CD4_350_500"));
  SET_STRING_ELT(state_names, 750, mkChar("interpolate_ART_eligible_CD4_200_349"));
  SET_STRING_ELT(state_names, 751, mkChar("ART_eligible_CD4_200_349"));
  SET_STRING_ELT(state_names, 752, mkChar("interpolate_ART_eligible_CD4_below_200"));
  SET_STRING_ELT(state_names, 753, mkChar("ART_eligible_CD4_below_200"));
  SET_STRING_ELT(state_names, 754, mkChar("interpolate_testing_prob"));
  SET_STRING_ELT(state_names, 755, mkChar("interpolate_tau_intervention"));
  SET_STRING_ELT(state_names, 756, mkChar("interpolate_rho_intervention"));
  SET_STRING_ELT(state_names, 757, mkChar("interpolate_infect_ART"));
  SET_STRING_ELT(state_names, 758, mkChar("interpolate_epsilon"));
  SET_STRING_ELT(state_names, 759, mkChar("epsilon"));
  SET_STRING_ELT(state_names, 760, mkChar("interpolate_prep_offered"));
  SET_STRING_ELT(state_names, 761, mkChar("interpolate_fc_comm"));
  SET_STRING_ELT(state_names, 762, mkChar("interpolate_fP_comm"));
  SET_STRING_ELT(state_names, 763, mkChar("interpolate_fc_noncomm"));
  SET_STRING_ELT(state_names, 764, mkChar("interpolate_fP_noncomm"));
  SET_STRING_ELT(state_names, 765, mkChar("interpolate_n_comm"));
  SET_STRING_ELT(state_names, 766, mkChar("interpolate_n_noncomm"));
  SET_STRING_ELT(state_names, 767, mkChar("dim"));
  SET_STRING_ELT(state_names, 768, mkChar("dim_output"));
...
SEXP main_model_output_order(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  int *tmp;
  SEXP state_len = PROTECT(allocVector(VECSXP, 126));
  SEXP state_names = PROTECT(allocVector(STRSXP, 126));
  ...
  SET_VECTOR_ELT(state_len, 94, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 94));
  tmp[0] = main_model_p->dim_fc_comm_1;
  tmp[1] = main_model_p->dim_fc_comm_2;
  SET_STRING_ELT(state_names, 94, mkChar("fc_comm"));
  SET_VECTOR_ELT(state_len, 95, ScalarInteger(main_model_p->dim_fP_comm));
  SET_STRING_ELT(state_names, 95, mkChar("fP_comm"));
  SET_VECTOR_ELT(state_len, 96, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 96));
  tmp[0] = main_model_p->dim_fc_noncomm_1;
  tmp[1] = main_model_p->dim_fc_noncomm_2;
  SET_STRING_ELT(state_names, 96, mkChar("fc_noncomm"));
  SET_VECTOR_ELT(state_len, 97, ScalarInteger(main_model_p->dim_fP_noncomm));
  SET_STRING_ELT(state_names, 97, mkChar("fP_noncomm"));
  SET_VECTOR_ELT(state_len, 98, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 98));
  tmp[0] = main_model_p->dim_n_comm_1;
  tmp[1] = main_model_p->dim_n_comm_2;
  SET_STRING_ELT(state_names, 98, mkChar("n_comm"));
  ...
  SET_STRING_ELT(state_names, 99, mkChar("n_noncomm"));
  SET_VECTOR_ELT(state_len, 100, ScalarInteger(main_model_p->dim_N));
  SET_STRING_ELT(state_names, 100, mkChar("N"));
  SET_VECTOR_ELT(state_len, 101, ScalarInteger(main_model_p->dim_E0));
  SET_STRING_ELT(state_names, 101, mkChar("E0"));
  SET_VECTOR_ELT(state_len, 102, ScalarInteger(main_model_p->dim_E1a));
  SET_STRING_ELT(state_names, 102, mkChar("E1a"));
  SET_VECTOR_ELT(state_len, 103, ScalarInteger(main_model_p->dim_E1b));
  SET_STRING_ELT(state_names, 103, mkChar("E1b"));
  SET_VECTOR_ELT(state_len, 104, ScalarInteger(main_model_p->dim_E1c));
  SET_STRING_ELT(state_names, 104, mkChar("E1c"));
  SET_VECTOR_ELT(state_len, 105, ScalarInteger(main_model_p->dim_E1d));
  SET_STRING_ELT(state_names, 105, mkChar("E1d"));
  SET_VECTOR_ELT(state_len, 106, ScalarInteger(main_model_p->dim_alphaItot));
  SET_STRING_ELT(state_names, 106, mkChar("alphaItot"));
  SET_VECTOR_ELT(state_len, 107, ScalarInteger(main_model_p->dim_prev));
  SET_STRING_ELT(state_names, 107, mkChar("prev"));
  SET_VECTOR_ELT(state_len, 108, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 108));
  tmp[0] = main_model_p->dim_lambda_1;
  tmp[1] = main_model_p->dim_lambda_2;
  SET_STRING_ELT(state_names, 108, mkChar("lambda"));
  SET_VECTOR_ELT(state_len, 109, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 109));
  tmp[0] = main_model_p->dim_lambda_0_1;
  tmp[1] = main_model_p->dim_lambda_0_2;
  SET_STRING_ELT(state_names, 109, mkChar("lambda_0"));
  ...
  SET_STRING_ELT(state_names, 110, mkChar("lambda_1a"));
  ...
  SET_STRING_ELT(state_names, 111, mkChar("lambda_1b"));
  ...
  SET_STRING_ELT(state_names, 112, mkChar("lambda_1c"));
  ...
  SET_STRING_ELT(state_names, 113, mkChar("lambda_1d"));
  SET_VECTOR_ELT(state_len, 114, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_STRING_ELT(state_names, 114, mkChar("lambda_sum_0"));
  SET_VECTOR_ELT(state_len, 115, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_STRING_ELT(state_names, 115, mkChar("lambda_sum_1a"));
  SET_VECTOR_ELT(state_len, 116, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_STRING_ELT(state_names, 116, mkChar("lambda_sum_1b"));
  SET_VECTOR_ELT(state_len, 117, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_STRING_ELT(state_names, 117, mkChar("lambda_sum_1c"));
  SET_VECTOR_ELT(state_len, 118, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_STRING_ELT(state_names, 118, mkChar("lambda_sum_1d"));
  SET_VECTOR_ELT(state_len, 119, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_STRING_ELT(state_names, 119, mkChar("c_comm_balanced"));
  SET_VECTOR_ELT(state_len, 120, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_STRING_ELT(state_names, 120, mkChar("c_noncomm_balanced"));
  ...
  SET_STRING_ELT(state_names, 121, mkChar("theta"));
  ...
  SET_STRING_ELT(state_names, 122, mkChar("M_comm"));
  ...
  SET_STRING_ELT(state_names, 123, mkChar("M_noncomm"));
  ...
  SET_STRING_ELT(state_names, 124, mkChar("rate_move_in"));
  SET_VECTOR_ELT(state_len, 125, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_STRING_ELT(state_names, 125, mkChar("rate_move_out"));
  setAttrib(state_len, R_NamesSymbol, state_names);
  UNPROTECT(2);
  return state_len;
}
