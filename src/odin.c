...
SEXP main_model_contents(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  SEXP state = PROTECT(allocVector(VECSXP, 656));
  ...
  SET_VECTOR_ELT(state, 187, ScalarInteger(main_model_p->dim_gamma22));
  SET_VECTOR_ELT(state, 188, allocVector(REALSXP, main_model_p->dim_gamma22));
  memcpy(REAL(VECTOR_ELT(state, 188)), main_model_p->gamma22, main_model_p->dim_gamma22 * sizeof(double));
  SET_VECTOR_ELT(state, 189, ScalarInteger(main_model_p->dim_gamma23));
  SET_VECTOR_ELT(state, 190, allocVector(REALSXP, main_model_p->dim_gamma23));
  memcpy(REAL(VECTOR_ELT(state, 190)), main_model_p->gamma23, main_model_p->dim_gamma23 * sizeof(double));
  SET_VECTOR_ELT(state, 191, ScalarInteger(main_model_p->dim_gamma24));
  SET_VECTOR_ELT(state, 192, allocVector(REALSXP, main_model_p->dim_gamma24));
  memcpy(REAL(VECTOR_ELT(state, 192)), main_model_p->gamma24, main_model_p->dim_gamma24 * sizeof(double));
  SET_VECTOR_ELT(state, 193, ScalarInteger(main_model_p->dim_gamma32));
  SET_VECTOR_ELT(state, 194, allocVector(REALSXP, main_model_p->dim_gamma32));
  memcpy(REAL(VECTOR_ELT(state, 194)), main_model_p->gamma32, main_model_p->dim_gamma32 * sizeof(double));
  SET_VECTOR_ELT(state, 195, ScalarInteger(main_model_p->dim_gamma33));
  SET_VECTOR_ELT(state, 196, allocVector(REALSXP, main_model_p->dim_gamma33));
  memcpy(REAL(VECTOR_ELT(state, 196)), main_model_p->gamma33, main_model_p->dim_gamma33 * sizeof(double));
  SET_VECTOR_ELT(state, 197, ScalarInteger(main_model_p->dim_gamma34));
  SET_VECTOR_ELT(state, 198, allocVector(REALSXP, main_model_p->dim_gamma34));
  memcpy(REAL(VECTOR_ELT(state, 198)), main_model_p->gamma34, main_model_p->dim_gamma34 * sizeof(double));
  SET_VECTOR_ELT(state, 199, ScalarInteger(main_model_p->dim_gamma42));
  SET_VECTOR_ELT(state, 200, allocVector(REALSXP, main_model_p->dim_gamma42));
  memcpy(REAL(VECTOR_ELT(state, 200)), main_model_p->gamma42, main_model_p->dim_gamma42 * sizeof(double));
  SET_VECTOR_ELT(state, 201, ScalarInteger(main_model_p->dim_gamma43));
  SET_VECTOR_ELT(state, 202, allocVector(REALSXP, main_model_p->dim_gamma43));
  memcpy(REAL(VECTOR_ELT(state, 202)), main_model_p->gamma43, main_model_p->dim_gamma43 * sizeof(double));
  SET_VECTOR_ELT(state, 203, ScalarInteger(main_model_p->dim_gamma44));
  SET_VECTOR_ELT(state, 204, allocVector(REALSXP, main_model_p->dim_gamma44));
  memcpy(REAL(VECTOR_ELT(state, 204)), main_model_p->gamma44, main_model_p->dim_gamma44 * sizeof(double));
  SET_VECTOR_ELT(state, 205, ScalarInteger(main_model_p->dim_phi2));
  SET_VECTOR_ELT(state, 206, allocVector(REALSXP, main_model_p->dim_phi2));
  memcpy(REAL(VECTOR_ELT(state, 206)), main_model_p->phi2, main_model_p->dim_phi2 * sizeof(double));
  SET_VECTOR_ELT(state, 207, ScalarInteger(main_model_p->dim_phi3));
  SET_VECTOR_ELT(state, 208, allocVector(REALSXP, main_model_p->dim_phi3));
  memcpy(REAL(VECTOR_ELT(state, 208)), main_model_p->phi3, main_model_p->dim_phi3 * sizeof(double));
  SET_VECTOR_ELT(state, 209, ScalarInteger(main_model_p->dim_phi4));
  SET_VECTOR_ELT(state, 210, allocVector(REALSXP, main_model_p->dim_phi4));
  memcpy(REAL(VECTOR_ELT(state, 210)), main_model_p->phi4, main_model_p->dim_phi4 * sizeof(double));
  SET_VECTOR_ELT(state, 211, ScalarInteger(main_model_p->dim_phi5));
  SET_VECTOR_ELT(state, 212, allocVector(REALSXP, main_model_p->dim_phi5));
  memcpy(REAL(VECTOR_ELT(state, 212)), main_model_p->phi5, main_model_p->dim_phi5 * sizeof(double));
  SET_VECTOR_ELT(state, 213, ScalarInteger(main_model_p->dim_psia));
  SET_VECTOR_ELT(state, 214, allocVector(REALSXP, main_model_p->dim_psia));
  memcpy(REAL(VECTOR_ELT(state, 214)), main_model_p->psia, main_model_p->dim_psia * sizeof(double));
  SET_VECTOR_ELT(state, 215, ScalarInteger(main_model_p->dim_psib));
  SET_VECTOR_ELT(state, 216, allocVector(REALSXP, main_model_p->dim_psib));
  memcpy(REAL(VECTOR_ELT(state, 216)), main_model_p->psib, main_model_p->dim_psib * sizeof(double));
  SET_VECTOR_ELT(state, 217, ScalarInteger(main_model_p->dim_kappaa));
  SET_VECTOR_ELT(state, 218, allocVector(REALSXP, main_model_p->dim_kappaa));
  memcpy(REAL(VECTOR_ELT(state, 218)), main_model_p->kappaa, main_model_p->dim_kappaa * sizeof(double));
  SET_VECTOR_ELT(state, 219, ScalarInteger(main_model_p->offset_output_kappaa));
  SET_VECTOR_ELT(state, 220, ScalarInteger(main_model_p->dim_kappab));
  SET_VECTOR_ELT(state, 221, allocVector(REALSXP, main_model_p->dim_kappab));
  memcpy(REAL(VECTOR_ELT(state, 221)), main_model_p->kappab, main_model_p->dim_kappab * sizeof(double));
  SET_VECTOR_ELT(state, 222, ScalarInteger(main_model_p->offset_output_kappab));
  SET_VECTOR_ELT(state, 223, ScalarInteger(main_model_p->dim_kappac));
  SET_VECTOR_ELT(state, 224, allocVector(REALSXP, main_model_p->dim_kappac));
  memcpy(REAL(VECTOR_ELT(state, 224)), main_model_p->kappac, main_model_p->dim_kappac * sizeof(double));
  SET_VECTOR_ELT(state, 225, ScalarInteger(main_model_p->offset_output_kappac));
  SET_VECTOR_ELT(state, 226, ScalarInteger(main_model_p->dim_alpha01));
  SET_VECTOR_ELT(state, 227, allocVector(REALSXP, main_model_p->dim_alpha01));
  memcpy(REAL(VECTOR_ELT(state, 227)), main_model_p->alpha01, main_model_p->dim_alpha01 * sizeof(double));
  SET_VECTOR_ELT(state, 228, ScalarInteger(main_model_p->dim_alpha02));
  SET_VECTOR_ELT(state, 229, allocVector(REALSXP, main_model_p->dim_alpha02));
  memcpy(REAL(VECTOR_ELT(state, 229)), main_model_p->alpha02, main_model_p->dim_alpha02 * sizeof(double));
  SET_VECTOR_ELT(state, 230, ScalarInteger(main_model_p->dim_alpha03));
  SET_VECTOR_ELT(state, 231, allocVector(REALSXP, main_model_p->dim_alpha03));
  memcpy(REAL(VECTOR_ELT(state, 231)), main_model_p->alpha03, main_model_p->dim_alpha03 * sizeof(double));
  SET_VECTOR_ELT(state, 232, ScalarInteger(main_model_p->dim_alpha04));
  SET_VECTOR_ELT(state, 233, allocVector(REALSXP, main_model_p->dim_alpha04));
  memcpy(REAL(VECTOR_ELT(state, 233)), main_model_p->alpha04, main_model_p->dim_alpha04 * sizeof(double));
  SET_VECTOR_ELT(state, 234, ScalarInteger(main_model_p->dim_alpha05));
  SET_VECTOR_ELT(state, 235, allocVector(REALSXP, main_model_p->dim_alpha05));
  memcpy(REAL(VECTOR_ELT(state, 235)), main_model_p->alpha05, main_model_p->dim_alpha05 * sizeof(double));
  SET_VECTOR_ELT(state, 236, ScalarInteger(main_model_p->offset_output_alpha05));
  SET_VECTOR_ELT(state, 237, ScalarInteger(main_model_p->dim_alpha11));
  SET_VECTOR_ELT(state, 238, allocVector(REALSXP, main_model_p->dim_alpha11));
  memcpy(REAL(VECTOR_ELT(state, 238)), main_model_p->alpha11, main_model_p->dim_alpha11 * sizeof(double));
  SET_VECTOR_ELT(state, 239, ScalarInteger(main_model_p->dim_alpha22));
  SET_VECTOR_ELT(state, 240, allocVector(REALSXP, main_model_p->dim_alpha22));
  memcpy(REAL(VECTOR_ELT(state, 240)), main_model_p->alpha22, main_model_p->dim_alpha22 * sizeof(double));
  ...
  SET_VECTOR_ELT(state, 643, ScalarReal(main_model_p->epsilon));
  SET_VECTOR_ELT(state, 654, ScalarInteger(main_model_p->dim));
  SET_VECTOR_ELT(state, 655, ScalarInteger(main_model_p->dim_output));
  SEXP state_names = PROTECT(allocVector(STRSXP, 656));
  ...
  SET_STRING_ELT(state_names, 187, mkChar("dim_gamma22"));
  SET_STRING_ELT(state_names, 188, mkChar("gamma22"));
  SET_STRING_ELT(state_names, 189, mkChar("dim_gamma23"));
  SET_STRING_ELT(state_names, 190, mkChar("gamma23"));
  SET_STRING_ELT(state_names, 191, mkChar("dim_gamma24"));
  SET_STRING_ELT(state_names, 192, mkChar("gamma24"));
  SET_STRING_ELT(state_names, 193, mkChar("dim_gamma32"));
  SET_STRING_ELT(state_names, 194, mkChar("gamma32"));
  SET_STRING_ELT(state_names, 195, mkChar("dim_gamma33"));
  SET_STRING_ELT(state_names, 196, mkChar("gamma33"));
  SET_STRING_ELT(state_names, 197, mkChar("dim_gamma34"));
  SET_STRING_ELT(state_names, 198, mkChar("gamma34"));
  SET_STRING_ELT(state_names, 199, mkChar("dim_gamma42"));
  SET_STRING_ELT(state_names, 200, mkChar("gamma42"));
  SET_STRING_ELT(state_names, 201, mkChar("dim_gamma43"));
  SET_STRING_ELT(state_names, 202, mkChar("gamma43"));
  SET_STRING_ELT(state_names, 203, mkChar("dim_gamma44"));
  SET_STRING_ELT(state_names, 204, mkChar("gamma44"));
  SET_STRING_ELT(state_names, 205, mkChar("dim_phi2"));
  SET_STRING_ELT(state_names, 206, mkChar("phi2"));
  SET_STRING_ELT(state_names, 207, mkChar("dim_phi3"));
  SET_STRING_ELT(state_names, 208, mkChar("phi3"));
  SET_STRING_ELT(state_names, 209, mkChar("dim_phi4"));
  SET_STRING_ELT(state_names, 210, mkChar("phi4"));
  SET_STRING_ELT(state_names, 211, mkChar("dim_phi5"));
  SET_STRING_ELT(state_names, 212, mkChar("phi5"));
  SET_STRING_ELT(state_names, 213, mkChar("dim_psia"));
  SET_STRING_ELT(state_names, 214, mkChar("psia"));
  SET_STRING_ELT(state_names, 215, mkChar("dim_psib"));
  SET_STRING_ELT(state_names, 216, mkChar("psib"));
  SET_STRING_ELT(state_names, 217, mkChar("dim_kappaa"));
  SET_STRING_ELT(state_names, 218, mkChar("kappaa"));
  SET_STRING_ELT(state_names, 219, mkChar("offset_output_kappaa"));
  SET_STRING_ELT(state_names, 220, mkChar("dim_kappab"));
  SET_STRING_ELT(state_names, 221, mkChar("kappab"));
  SET_STRING_ELT(state_names, 222, mkChar("offset_output_kappab"));
  SET_STRING_ELT(state_names, 223, mkChar("dim_kappac"));
  SET_STRING_ELT(state_names, 224, mkChar("kappac"));
  SET_STRING_ELT(state_names, 225, mkChar("offset_output_kappac"));
  SET_STRING_ELT(state_names, 226, mkChar("dim_alpha01"));
  SET_STRING_ELT(state_names, 227, mkChar("alpha01"));
  SET_STRING_ELT(state_names, 228, mkChar("dim_alpha02"));
  SET_STRING_ELT(state_names, 229, mkChar("alpha02"));
  SET_STRING_ELT(state_names, 230, mkChar("dim_alpha03"));
  SET_STRING_ELT(state_names, 231, mkChar("alpha03"));
  SET_STRING_ELT(state_names, 232, mkChar("dim_alpha04"));
  SET_STRING_ELT(state_names, 233, mkChar("alpha04"));
  SET_STRING_ELT(state_names, 234, mkChar("dim_alpha05"));
  SET_STRING_ELT(state_names, 235, mkChar("alpha05"));
  SET_STRING_ELT(state_names, 236, mkChar("offset_output_alpha05"));
  SET_STRING_ELT(state_names, 237, mkChar("dim_alpha11"));
  SET_STRING_ELT(state_names, 238, mkChar("alpha11"));
  SET_STRING_ELT(state_names, 239, mkChar("dim_alpha22"));
  SET_STRING_ELT(state_names, 240, mkChar("alpha22"));
  ...
  SET_STRING_ELT(state_names, 640, mkChar("interpolate_testing_prob"));
  SET_STRING_ELT(state_names, 641, mkChar("interpolate_ART_prob"));
  SET_STRING_ELT(state_names, 642, mkChar("interpolate_epsilon"));
  SET_STRING_ELT(state_names, 643, mkChar("epsilon"));
  SET_STRING_ELT(state_names, 644, mkChar("interpolate_zetaa"));
  SET_STRING_ELT(state_names, 645, mkChar("interpolate_zetab"));
  SET_STRING_ELT(state_names, 646, mkChar("interpolate_zetac"));
  SET_STRING_ELT(state_names, 647, mkChar("interpolate_prep_intervention"));
  SET_STRING_ELT(state_names, 648, mkChar("interpolate_fc_comm"));
  SET_STRING_ELT(state_names, 649, mkChar("interpolate_fP_comm"));
  SET_STRING_ELT(state_names, 650, mkChar("interpolate_fc_noncomm"));
  SET_STRING_ELT(state_names, 651, mkChar("interpolate_fP_noncomm"));
  SET_STRING_ELT(state_names, 652, mkChar("interpolate_n_comm"));
  SET_STRING_ELT(state_names, 653, mkChar("interpolate_n_noncomm"));
  SET_STRING_ELT(state_names, 654, mkChar("dim"));
  SET_STRING_ELT(state_names, 655, mkChar("dim_output"));
...
SEXP main_model_output_order(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  int *tmp;
  SEXP state_len = PROTECT(allocVector(VECSXP, 84));
  SEXP state_names = PROTECT(allocVector(STRSXP, 84));
  ...
  SET_VECTOR_ELT(state_len, 43, ScalarInteger(main_model_p->dim_kappaa));
  SET_STRING_ELT(state_names, 43, mkChar("kappaa"));
  SET_VECTOR_ELT(state_len, 44, ScalarInteger(main_model_p->dim_kappab));
  SET_STRING_ELT(state_names, 44, mkChar("kappab"));
  SET_VECTOR_ELT(state_len, 45, ScalarInteger(main_model_p->dim_kappac));
  SET_STRING_ELT(state_names, 45, mkChar("kappac"));
  SET_VECTOR_ELT(state_len, 46, ScalarInteger(main_model_p->dim_alpha05));
  SET_STRING_ELT(state_names, 46, mkChar("alpha05"));
  SET_VECTOR_ELT(state_len, 47, ScalarInteger(main_model_p->dim_alpha35));
  SET_STRING_ELT(state_names, 47, mkChar("alpha35"));
  SET_VECTOR_ELT(state_len, 48, ScalarInteger(main_model_p->dim_beta_comm));
  SET_STRING_ELT(state_names, 48, mkChar("beta_comm"));
  SET_VECTOR_ELT(state_len, 49, ScalarInteger(main_model_p->dim_beta_noncomm));
  SET_STRING_ELT(state_names, 49, mkChar("beta_noncomm"));
  ...
  SET_STRING_ELT(state_names, 50, mkChar("p_comm"));
  ...
  SET_STRING_ELT(state_names, 51, mkChar("p_noncomm"));
  SET_VECTOR_ELT(state_len, 52, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 52));
  tmp[0] = main_model_p->dim_fc_comm_1;
  tmp[1] = main_model_p->dim_fc_comm_2;
  SET_STRING_ELT(state_names, 52, mkChar("fc_comm"));
  SET_VECTOR_ELT(state_len, 53, ScalarInteger(main_model_p->dim_fP_comm));
  SET_STRING_ELT(state_names, 53, mkChar("fP_comm"));
  SET_VECTOR_ELT(state_len, 54, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 54));
  tmp[0] = main_model_p->dim_fc_noncomm_1;
  tmp[1] = main_model_p->dim_fc_noncomm_2;
  SET_STRING_ELT(state_names, 54, mkChar("fc_noncomm"));
  SET_VECTOR_ELT(state_len, 55, ScalarInteger(main_model_p->dim_fP_noncomm));
  SET_STRING_ELT(state_names, 55, mkChar("fP_noncomm"));
  ...
  SET_STRING_ELT(state_names, 56, mkChar("n_comm"));
  ...
  SET_STRING_ELT(state_names, 57, mkChar("n_noncomm"));
  SET_VECTOR_ELT(state_len, 58, ScalarInteger(main_model_p->dim_N));
  SET_STRING_ELT(state_names, 58, mkChar("N"));
  SET_VECTOR_ELT(state_len, 59, ScalarInteger(main_model_p->dim_E0));
  SET_STRING_ELT(state_names, 59, mkChar("E0"));
  SET_VECTOR_ELT(state_len, 60, ScalarInteger(main_model_p->dim_E1a));
  SET_STRING_ELT(state_names, 60, mkChar("E1a"));
  SET_VECTOR_ELT(state_len, 61, ScalarInteger(main_model_p->dim_E1b));
  SET_STRING_ELT(state_names, 61, mkChar("E1b"));
  SET_VECTOR_ELT(state_len, 62, ScalarInteger(main_model_p->dim_E1c));
  SET_STRING_ELT(state_names, 62, mkChar("E1c"));
  SET_VECTOR_ELT(state_len, 63, ScalarInteger(main_model_p->dim_E1d));
  SET_STRING_ELT(state_names, 63, mkChar("E1d"));
  SET_VECTOR_ELT(state_len, 64, ScalarInteger(main_model_p->dim_alphaItot));
  SET_STRING_ELT(state_names, 64, mkChar("alphaItot"));
  SET_VECTOR_ELT(state_len, 65, ScalarInteger(main_model_p->dim_prev));
  SET_STRING_ELT(state_names, 65, mkChar("prev"));
  ...
  SET_STRING_ELT(state_names, 66, mkChar("lambda"));
  ...
  SET_STRING_ELT(state_names, 67, mkChar("lambda_0"));
  ...
  SET_STRING_ELT(state_names, 68, mkChar("lambda_1a"));
  ...
  SET_STRING_ELT(state_names, 69, mkChar("lambda_1b"));
  ...
  SET_STRING_ELT(state_names, 70, mkChar("lambda_1c"));
  ...
  SET_STRING_ELT(state_names, 71, mkChar("lambda_1d"));
  SET_VECTOR_ELT(state_len, 72, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_STRING_ELT(state_names, 72, mkChar("lambda_sum_0"));
  SET_VECTOR_ELT(state_len, 73, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_STRING_ELT(state_names, 73, mkChar("lambda_sum_1a"));
  SET_VECTOR_ELT(state_len, 74, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_STRING_ELT(state_names, 74, mkChar("lambda_sum_1b"));
  SET_VECTOR_ELT(state_len, 75, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_STRING_ELT(state_names, 75, mkChar("lambda_sum_1c"));
  SET_VECTOR_ELT(state_len, 76, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_STRING_ELT(state_names, 76, mkChar("lambda_sum_1d"));
  SET_VECTOR_ELT(state_len, 77, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_STRING_ELT(state_names, 77, mkChar("c_comm_balanced"));
  SET_VECTOR_ELT(state_len, 78, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_STRING_ELT(state_names, 78, mkChar("c_noncomm_balanced"));
  ...
  SET_STRING_ELT(state_names, 79, mkChar("theta"));
  ...
  SET_STRING_ELT(state_names, 80, mkChar("M_comm"));
  ...
  SET_STRING_ELT(state_names, 81, mkChar("M_noncomm"));
  ...
  SET_STRING_ELT(state_names, 82, mkChar("rate_move_in"));
  SET_VECTOR_ELT(state_len, 83, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_STRING_ELT(state_names, 83, mkChar("rate_move_out"));
  setAttrib(state_len, R_NamesSymbol, state_names);
  UNPROTECT(2);
  return state_len;
}
