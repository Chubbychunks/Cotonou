...
SEXP main_model_set_user(main_model_pars *main_model_p, SEXP user) {
  ...
  main_model_p->offset_output_infect_ART_y = 73;
  ...
  main_model_p->offset_output_infect_ART_t = 73 + main_model_p->dim_infect_ART_y;
...
void main_model_deriv(main_model_pars *main_model_p, double t, double *state, double *dstatedt, double *output) {
  ...
  if (output != NULL) {
    double *output_infect_ART_y = output + 73;
    ...
    output[58] = Ntot_inc_former_FSW_nonCot;
    double new_people = epsilon * Ntot;
    output[59] = new_people;
    ...
    output[62] = prev_men;
    output[63] = prev_women;
    output[64] = prev_cotonou;
    output[65] = Ntot;
    memcpy(output_N, main_model_p->N, main_model_p->dim_N * sizeof(double));
    output[66] = prev_FSW;
    output[67] = prev_client;
    ...
    output[70] = pc_of_FOI_on_clients_from_pro_FSW;
...
SEXP main_model_output_order(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  int *tmp;
  SEXP state_len = PROTECT(allocVector(VECSXP, 185));
  SEXP state_names = PROTECT(allocVector(STRSXP, 185));
  ...
  SET_STRING_ELT(state_names, 57, mkChar("epsilon"));
  SET_VECTOR_ELT(state_len, 58, R_NilValue);
  SET_STRING_ELT(state_names, 58, mkChar("Ntot_inc_former_FSW_nonCot"));
  SET_VECTOR_ELT(state_len, 59, R_NilValue);
  SET_STRING_ELT(state_names, 59, mkChar("new_people"));
  SET_VECTOR_ELT(state_len, 60, R_NilValue);
  SET_STRING_ELT(state_names, 60, mkChar("frac_virgin"));
  SET_VECTOR_ELT(state_len, 61, R_NilValue);
  SET_STRING_ELT(state_names, 61, mkChar("prev_LowFSW"));
  SET_VECTOR_ELT(state_len, 62, R_NilValue);
  SET_STRING_ELT(state_names, 62, mkChar("prev_men"));
  SET_VECTOR_ELT(state_len, 63, R_NilValue);
  SET_STRING_ELT(state_names, 63, mkChar("prev_women"));
  SET_VECTOR_ELT(state_len, 64, R_NilValue);
  SET_STRING_ELT(state_names, 64, mkChar("prev_cotonou"));
  SET_VECTOR_ELT(state_len, 65, R_NilValue);
  SET_STRING_ELT(state_names, 65, mkChar("Ntot"));
  SET_VECTOR_ELT(state_len, 66, R_NilValue);
  SET_STRING_ELT(state_names, 66, mkChar("prev_FSW"));
  SET_VECTOR_ELT(state_len, 67, R_NilValue);
  SET_STRING_ELT(state_names, 67, mkChar("prev_client"));
  SET_VECTOR_ELT(state_len, 68, R_NilValue);
  SET_STRING_ELT(state_names, 68, mkChar("B_check_comm"));
  SET_VECTOR_ELT(state_len, 69, R_NilValue);
  SET_STRING_ELT(state_names, 69, mkChar("B_check_noncomm"));
  SET_VECTOR_ELT(state_len, 70, R_NilValue);
  SET_STRING_ELT(state_names, 70, mkChar("pc_of_FOI_on_clients_from_pro_FSW"));
  SET_VECTOR_ELT(state_len, 71, R_NilValue);
  SET_STRING_ELT(state_names, 71, mkChar("FSW_in"));
  SET_VECTOR_ELT(state_len, 72, R_NilValue);
  SET_STRING_ELT(state_names, 72, mkChar("FSW_out"));
  ...
  SET_STRING_ELT(state_names, 73, mkChar("infect_ART_y"));
  SET_VECTOR_ELT(state_len, 74, ScalarInteger(main_model_p->dim_infect_ART_t));
  SET_STRING_ELT(state_names, 74, mkChar("infect_ART_t"));
  SET_VECTOR_ELT(state_len, 75, ScalarInteger(main_model_p->dim_PrEP_reinit_OnOff_t));
  SET_STRING_ELT(state_names, 75, mkChar("PrEP_reinit_OnOff_t"));
  SET_VECTOR_ELT(state_len, 76, ScalarInteger(main_model_p->dim_PrEP_reinit_OnOff_y));
  SET_STRING_ELT(state_names, 76, mkChar("PrEP_reinit_OnOff_y"));
  ...
  SET_STRING_ELT(state_names, 77, mkChar("viral_supp_y"));
  SET_VECTOR_ELT(state_len, 78, ScalarInteger(main_model_p->dim_viral_supp_t));
  SET_STRING_ELT(state_names, 78, mkChar("viral_supp_t"));
  SET_VECTOR_ELT(state_len, 79, ScalarInteger(main_model_p->dim_gamma32_without_supp));
  SET_STRING_ELT(state_names, 79, mkChar("gamma32_without_supp"));
  SET_VECTOR_ELT(state_len, 80, ScalarInteger(main_model_p->dim_gamma33_without_supp));
  SET_STRING_ELT(state_names, 80, mkChar("gamma33_without_supp"));
  SET_VECTOR_ELT(state_len, 81, ScalarInteger(main_model_p->dim_gamma34_without_supp));
  SET_STRING_ELT(state_names, 81, mkChar("gamma34_without_supp"));
  SET_VECTOR_ELT(state_len, 82, ScalarInteger(main_model_p->dim_alpha33_without_supp));
  SET_STRING_ELT(state_names, 82, mkChar("alpha33_without_supp"));
  SET_VECTOR_ELT(state_len, 83, ScalarInteger(main_model_p->dim_alpha34_without_supp));
  SET_STRING_ELT(state_names, 83, mkChar("alpha34_without_supp"));
  SET_VECTOR_ELT(state_len, 84, ScalarInteger(main_model_p->dim_alpha35_without_supp));
  SET_STRING_ELT(state_names, 84, mkChar("alpha35_without_supp"));
  SET_VECTOR_ELT(state_len, 85, ScalarInteger(main_model_p->dim_c_comm));
  SET_STRING_ELT(state_names, 85, mkChar("c_comm"));
  SET_VECTOR_ELT(state_len, 86, ScalarInteger(main_model_p->dim_c_noncomm));
  SET_STRING_ELT(state_names, 86, mkChar("c_noncomm"));
  SET_VECTOR_ELT(state_len, 87, ScalarInteger(main_model_p->dim_pfFSW));
  SET_STRING_ELT(state_names, 87, mkChar("pfFSW"));
  SET_VECTOR_ELT(state_len, 88, ScalarInteger(main_model_p->dim_new_acute_infected));
  SET_STRING_ELT(state_names, 88, mkChar("new_acute_infected"));
  SET_VECTOR_ELT(state_len, 89, ScalarInteger(main_model_p->dim_rate_leave_pro_FSW_weight_by_PrEP));
  SET_STRING_ELT(state_names, 89, mkChar("rate_leave_pro_FSW_weight_by_PrEP"));
  SET_VECTOR_ELT(state_len, 90, ScalarInteger(main_model_p->dim_new_people_in_group));
  SET_STRING_ELT(state_names, 90, mkChar("new_people_in_group"));
  SET_VECTOR_ELT(state_len, 91, ScalarInteger(main_model_p->dim_new_people_in_group_FSW_only));
  SET_STRING_ELT(state_names, 91, mkChar("new_people_in_group_FSW_only"));
  SET_VECTOR_ELT(state_len, 92, ScalarInteger(main_model_p->dim_above_500_by_group));
  SET_STRING_ELT(state_names, 92, mkChar("above_500_by_group"));
  SET_VECTOR_ELT(state_len, 93, ScalarInteger(main_model_p->dim_testing_prob));
  SET_STRING_ELT(state_names, 93, mkChar("testing_prob"));
  SET_VECTOR_ELT(state_len, 94, ScalarInteger(main_model_p->dim_zeta_re));
  SET_STRING_ELT(state_names, 94, mkChar("zeta_re"));
  SET_VECTOR_ELT(state_len, 95, ScalarInteger(main_model_p->dim_tau_intervention));
  SET_STRING_ELT(state_names, 95, mkChar("tau_intervention"));
  SET_VECTOR_ELT(state_len, 96, ScalarInteger(main_model_p->dim_rho_intervention));
  SET_STRING_ELT(state_names, 96, mkChar("rho_intervention"));
  SET_VECTOR_ELT(state_len, 97, ScalarInteger(main_model_p->dim_zeta));
  SET_STRING_ELT(state_names, 97, mkChar("zeta"));
  SET_VECTOR_ELT(state_len, 98, ScalarInteger(main_model_p->dim_eP1a_effective));
  SET_STRING_ELT(state_names, 98, mkChar("eP1a_effective"));
  SET_VECTOR_ELT(state_len, 99, ScalarInteger(main_model_p->dim_eP1b_effective));
  SET_STRING_ELT(state_names, 99, mkChar("eP1b_effective"));
  SET_VECTOR_ELT(state_len, 100, ScalarInteger(main_model_p->dim_eP1c_effective));
  SET_STRING_ELT(state_names, 100, mkChar("eP1c_effective"));
  SET_VECTOR_ELT(state_len, 101, ScalarInteger(main_model_p->dim_tau));
  SET_STRING_ELT(state_names, 101, mkChar("tau"));
  SET_VECTOR_ELT(state_len, 102, ScalarInteger(main_model_p->dim_rho));
  SET_STRING_ELT(state_names, 102, mkChar("rho"));
  SET_VECTOR_ELT(state_len, 103, ScalarInteger(main_model_p->dim_iota));
  SET_STRING_ELT(state_names, 103, mkChar("iota"));
  SET_VECTOR_ELT(state_len, 104, ScalarInteger(main_model_p->dim_viral_supp));
  SET_STRING_ELT(state_names, 104, mkChar("viral_supp"));
  SET_VECTOR_ELT(state_len, 105, ScalarInteger(main_model_p->dim_HIV_positive));
  SET_STRING_ELT(state_names, 105, mkChar("HIV_positive"));
  SET_VECTOR_ELT(state_len, 106, ScalarInteger(main_model_p->dim_Number_Susceptibles));
  SET_STRING_ELT(state_names, 106, mkChar("Number_Susceptibles"));
  SET_VECTOR_ELT(state_len, 107, ScalarInteger(main_model_p->dim_HIV_positive_Diagnosed_Off_ART));
  SET_STRING_ELT(state_names, 107, mkChar("HIV_positive_Diagnosed_Off_ART"));
  SET_VECTOR_ELT(state_len, 108, ScalarInteger(main_model_p->dim_Primary_Off_ART));
  SET_STRING_ELT(state_names, 108, mkChar("Primary_Off_ART"));
  SET_VECTOR_ELT(state_len, 109, ScalarInteger(main_model_p->dim_CD4_above_500_Off_ART));
  SET_STRING_ELT(state_names, 109, mkChar("CD4_above_500_Off_ART"));
  SET_VECTOR_ELT(state_len, 110, ScalarInteger(main_model_p->dim_CD4_350_500_Off_ART));
  SET_STRING_ELT(state_names, 110, mkChar("CD4_350_500_Off_ART"));
  SET_VECTOR_ELT(state_len, 111, ScalarInteger(main_model_p->dim_CD4_200_350_Off_ART));
  SET_STRING_ELT(state_names, 111, mkChar("CD4_200_350_Off_ART"));
  SET_VECTOR_ELT(state_len, 112, ScalarInteger(main_model_p->dim_CD4_below_200_Off_ART));
  SET_STRING_ELT(state_names, 112, mkChar("CD4_below_200_Off_ART"));
  SET_VECTOR_ELT(state_len, 113, ScalarInteger(main_model_p->dim_HIV_positive_On_ART));
  SET_STRING_ELT(state_names, 113, mkChar("HIV_positive_On_ART"));
  SET_VECTOR_ELT(state_len, 114, ScalarInteger(main_model_p->dim_Number_DALY_W1));
  SET_STRING_ELT(state_names, 114, mkChar("Number_DALY_W1"));
  SET_VECTOR_ELT(state_len, 115, ScalarInteger(main_model_p->dim_Number_DALY_W2));
  SET_STRING_ELT(state_names, 115, mkChar("Number_DALY_W2"));
  SET_VECTOR_ELT(state_len, 116, ScalarInteger(main_model_p->dim_Number_DALY_W3));
  SET_STRING_ELT(state_names, 116, mkChar("Number_DALY_W3"));
  SET_VECTOR_ELT(state_len, 117, ScalarInteger(main_model_p->dim_frac_F));
  SET_STRING_ELT(state_names, 117, mkChar("frac_F"));
  SET_VECTOR_ELT(state_len, 118, ScalarInteger(main_model_p->dim_frac_N_sexualpop));
  SET_STRING_ELT(state_names, 118, mkChar("frac_N_sexualpop"));
  SET_VECTOR_ELT(state_len, 119, ScalarInteger(main_model_p->dim_ART_coverage));
  SET_STRING_ELT(state_names, 119, mkChar("ART_coverage"));
  SET_VECTOR_ELT(state_len, 120, ScalarInteger(main_model_p->dim_infect_ART));
  SET_STRING_ELT(state_names, 120, mkChar("infect_ART"));
  SET_VECTOR_ELT(state_len, 121, ScalarInteger(main_model_p->dim_prep_offered));
  SET_STRING_ELT(state_names, 121, mkChar("prep_offered"));
  SET_VECTOR_ELT(state_len, 122, ScalarInteger(main_model_p->dim_omega));
  SET_STRING_ELT(state_names, 122, mkChar("omega"));
  SET_VECTOR_ELT(state_len, 123, ScalarInteger(main_model_p->dim_frac_N));
  SET_STRING_ELT(state_names, 123, mkChar("frac_N"));
  SET_VECTOR_ELT(state_len, 124, ScalarInteger(main_model_p->dim_mu));
  SET_STRING_ELT(state_names, 124, mkChar("mu"));
  SET_VECTOR_ELT(state_len, 125, ScalarInteger(main_model_p->dim_gamma01));
  SET_STRING_ELT(state_names, 125, mkChar("gamma01"));
  SET_VECTOR_ELT(state_len, 126, ScalarInteger(main_model_p->dim_gamma11));
  SET_STRING_ELT(state_names, 126, mkChar("gamma11"));
  SET_VECTOR_ELT(state_len, 127, ScalarInteger(main_model_p->dim_gamma32));
  SET_STRING_ELT(state_names, 127, mkChar("gamma32"));
  SET_VECTOR_ELT(state_len, 128, ScalarInteger(main_model_p->dim_gamma33));
  SET_STRING_ELT(state_names, 128, mkChar("gamma33"));
  SET_VECTOR_ELT(state_len, 129, ScalarInteger(main_model_p->dim_gamma34));
  SET_STRING_ELT(state_names, 129, mkChar("gamma34"));
  SET_VECTOR_ELT(state_len, 130, ScalarInteger(main_model_p->dim_phi2));
  SET_STRING_ELT(state_names, 130, mkChar("phi2"));
  SET_VECTOR_ELT(state_len, 131, ScalarInteger(main_model_p->dim_kappaa));
  SET_STRING_ELT(state_names, 131, mkChar("kappaa"));
  SET_VECTOR_ELT(state_len, 132, ScalarInteger(main_model_p->dim_kappab));
  SET_STRING_ELT(state_names, 132, mkChar("kappab"));
  SET_VECTOR_ELT(state_len, 133, ScalarInteger(main_model_p->dim_kappac));
  SET_STRING_ELT(state_names, 133, mkChar("kappac"));
  SET_VECTOR_ELT(state_len, 134, ScalarInteger(main_model_p->dim_kappa1));
  SET_STRING_ELT(state_names, 134, mkChar("kappa1"));
  SET_VECTOR_ELT(state_len, 135, ScalarInteger(main_model_p->dim_alpha01));
  SET_STRING_ELT(state_names, 135, mkChar("alpha01"));
  SET_VECTOR_ELT(state_len, 136, ScalarInteger(main_model_p->dim_alpha02));
  SET_STRING_ELT(state_names, 136, mkChar("alpha02"));
  SET_VECTOR_ELT(state_len, 137, ScalarInteger(main_model_p->dim_alpha05));
  SET_STRING_ELT(state_names, 137, mkChar("alpha05"));
  SET_VECTOR_ELT(state_len, 138, ScalarInteger(main_model_p->dim_alpha11));
  SET_STRING_ELT(state_names, 138, mkChar("alpha11"));
  SET_VECTOR_ELT(state_len, 139, ScalarInteger(main_model_p->dim_alpha22));
  SET_STRING_ELT(state_names, 139, mkChar("alpha22"));
  SET_VECTOR_ELT(state_len, 140, ScalarInteger(main_model_p->dim_alpha33));
  SET_STRING_ELT(state_names, 140, mkChar("alpha33"));
  SET_VECTOR_ELT(state_len, 141, ScalarInteger(main_model_p->dim_alpha34));
  SET_STRING_ELT(state_names, 141, mkChar("alpha34"));
  SET_VECTOR_ELT(state_len, 142, ScalarInteger(main_model_p->dim_alpha35));
  SET_STRING_ELT(state_names, 142, mkChar("alpha35"));
  SET_VECTOR_ELT(state_len, 143, ScalarInteger(main_model_p->dim_beta_comm));
  SET_STRING_ELT(state_names, 143, mkChar("beta_comm"));
  SET_VECTOR_ELT(state_len, 144, ScalarInteger(main_model_p->dim_beta_noncomm));
  SET_STRING_ELT(state_names, 144, mkChar("beta_noncomm"));
  SET_VECTOR_ELT(state_len, 145, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 145));
  tmp[0] = main_model_p->dim_p_comm_1;
  tmp[1] = main_model_p->dim_p_comm_2;
  SET_STRING_ELT(state_names, 145, mkChar("p_comm"));
  SET_VECTOR_ELT(state_len, 146, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 146));
  tmp[0] = main_model_p->dim_p_noncomm_1;
  tmp[1] = main_model_p->dim_p_noncomm_2;
  SET_STRING_ELT(state_names, 146, mkChar("p_noncomm"));
  SET_VECTOR_ELT(state_len, 147, ScalarInteger(main_model_p->dim_eP0));
  SET_STRING_ELT(state_names, 147, mkChar("eP0"));
  SET_VECTOR_ELT(state_len, 148, ScalarInteger(main_model_p->dim_eP1a));
  SET_STRING_ELT(state_names, 148, mkChar("eP1a"));
  SET_VECTOR_ELT(state_len, 149, ScalarInteger(main_model_p->dim_eP1b));
  SET_STRING_ELT(state_names, 149, mkChar("eP1b"));
  SET_VECTOR_ELT(state_len, 150, ScalarInteger(main_model_p->dim_eP1c));
  SET_STRING_ELT(state_names, 150, mkChar("eP1c"));
  SET_VECTOR_ELT(state_len, 151, ScalarInteger(main_model_p->dim_eP1d));
  SET_STRING_ELT(state_names, 151, mkChar("eP1d"));
  ...
  SET_STRING_ELT(state_names, 152, mkChar("fc_comm"));
  SET_VECTOR_ELT(state_len, 153, ScalarInteger(main_model_p->dim_fP_comm));
  SET_STRING_ELT(state_names, 153, mkChar("fP_comm"));
  SET_VECTOR_ELT(state_len, 154, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 154));
  tmp[0] = main_model_p->dim_fc_noncomm_1;
  tmp[1] = main_model_p->dim_fc_noncomm_2;
  SET_STRING_ELT(state_names, 154, mkChar("fc_noncomm"));
  SET_VECTOR_ELT(state_len, 155, ScalarInteger(main_model_p->dim_fP_noncomm));
  SET_STRING_ELT(state_names, 155, mkChar("fP_noncomm"));
  SET_VECTOR_ELT(state_len, 156, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 156));
  tmp[0] = main_model_p->dim_n_comm_1;
  tmp[1] = main_model_p->dim_n_comm_2;
  SET_STRING_ELT(state_names, 156, mkChar("n_comm"));
  ...
  SET_STRING_ELT(state_names, 157, mkChar("n_noncomm"));
  SET_VECTOR_ELT(state_len, 158, ScalarInteger(main_model_p->dim_N));
  SET_STRING_ELT(state_names, 158, mkChar("N"));
  SET_VECTOR_ELT(state_len, 159, ScalarInteger(main_model_p->dim_E0));
  SET_STRING_ELT(state_names, 159, mkChar("E0"));
  SET_VECTOR_ELT(state_len, 160, ScalarInteger(main_model_p->dim_E1a));
  SET_STRING_ELT(state_names, 160, mkChar("E1a"));
  SET_VECTOR_ELT(state_len, 161, ScalarInteger(main_model_p->dim_E1b));
  SET_STRING_ELT(state_names, 161, mkChar("E1b"));
  SET_VECTOR_ELT(state_len, 162, ScalarInteger(main_model_p->dim_E1c));
  SET_STRING_ELT(state_names, 162, mkChar("E1c"));
  SET_VECTOR_ELT(state_len, 163, ScalarInteger(main_model_p->dim_E1d));
  SET_STRING_ELT(state_names, 163, mkChar("E1d"));
  SET_VECTOR_ELT(state_len, 164, ScalarInteger(main_model_p->dim_alphaItot));
  SET_STRING_ELT(state_names, 164, mkChar("alphaItot"));
  SET_VECTOR_ELT(state_len, 165, ScalarInteger(main_model_p->dim_prev));
  SET_STRING_ELT(state_names, 165, mkChar("prev"));
  ...
  SET_STRING_ELT(state_names, 166, mkChar("lambda"));
  ...
  SET_STRING_ELT(state_names, 167, mkChar("lambda_0"));
  SET_VECTOR_ELT(state_len, 168, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 168));
  tmp[0] = main_model_p->dim_lambda_1a_1;
  tmp[1] = main_model_p->dim_lambda_1a_2;
  SET_STRING_ELT(state_names, 168, mkChar("lambda_1a"));
  ...
  SET_STRING_ELT(state_names, 169, mkChar("lambda_1b"));
  ...
  SET_STRING_ELT(state_names, 170, mkChar("lambda_1c"));
  ...
  SET_STRING_ELT(state_names, 171, mkChar("lambda_1d"));
  SET_VECTOR_ELT(state_len, 172, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_STRING_ELT(state_names, 172, mkChar("lambda_sum_0"));
  SET_VECTOR_ELT(state_len, 173, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_STRING_ELT(state_names, 173, mkChar("lambda_sum_1a"));
  SET_VECTOR_ELT(state_len, 174, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_STRING_ELT(state_names, 174, mkChar("lambda_sum_1b"));
  SET_VECTOR_ELT(state_len, 175, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_STRING_ELT(state_names, 175, mkChar("lambda_sum_1c"));
  SET_VECTOR_ELT(state_len, 176, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_STRING_ELT(state_names, 176, mkChar("lambda_sum_1d"));
  SET_VECTOR_ELT(state_len, 177, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_STRING_ELT(state_names, 177, mkChar("c_comm_balanced"));
  SET_VECTOR_ELT(state_len, 178, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_STRING_ELT(state_names, 178, mkChar("c_noncomm_balanced"));
  SET_VECTOR_ELT(state_len, 179, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 179));
  tmp[0] = main_model_p->dim_theta_1;
  tmp[1] = main_model_p->dim_theta_2;
  SET_STRING_ELT(state_names, 179, mkChar("theta"));
  SET_VECTOR_ELT(state_len, 180, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 180));
  tmp[0] = main_model_p->dim_M_comm_1;
  tmp[1] = main_model_p->dim_M_comm_2;
  SET_STRING_ELT(state_names, 180, mkChar("M_comm"));
  SET_VECTOR_ELT(state_len, 181, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 181));
  tmp[0] = main_model_p->dim_M_noncomm_1;
  tmp[1] = main_model_p->dim_M_noncomm_2;
  SET_STRING_ELT(state_names, 181, mkChar("M_noncomm"));
  ...
  SET_STRING_ELT(state_names, 182, mkChar("rate_move_in"));
  SET_VECTOR_ELT(state_len, 183, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_STRING_ELT(state_names, 183, mkChar("rate_move_out"));
  SET_VECTOR_ELT(state_len, 184, ScalarInteger(main_model_p->dim_rate_move_out_PrEP));
  SET_STRING_ELT(state_names, 184, mkChar("rate_move_out_PrEP"));
  setAttrib(state_len, R_NamesSymbol, state_names);
  UNPROTECT(2);
  return state_len;
}
