...
SEXP main_model_contents(SEXP main_model_ptr) {
  ...
  SET_VECTOR_ELT(state, 517, ScalarInteger(main_model_p->dim_cumuTested_approx));
  SET_VECTOR_ELT(state, 518, allocVector(REALSXP, main_model_p->dim_cumuTested_approx));
  memcpy(REAL(VECTOR_ELT(state, 518)), main_model_p->initial_cumuTested_approx, main_model_p->dim_cumuTested_approx * sizeof(double));
  SET_VECTOR_ELT(state, 519, ScalarInteger(main_model_p->offset_cumuTested_approx));
  SET_VECTOR_ELT(state, 520, ScalarInteger(main_model_p->dim_dropouts));
  SET_VECTOR_ELT(state, 521, allocVector(REALSXP, main_model_p->dim_dropouts));
  memcpy(REAL(VECTOR_ELT(state, 521)), main_model_p->initial_dropouts, main_model_p->dim_dropouts * sizeof(double));
  SET_VECTOR_ELT(state, 522, ScalarInteger(main_model_p->offset_dropouts));
  SET_VECTOR_ELT(state, 523, ScalarInteger(main_model_p->dim_cumuAllDeaths));
  SET_VECTOR_ELT(state, 524, allocVector(REALSXP, main_model_p->dim_cumuAllDeaths));
  memcpy(REAL(VECTOR_ELT(state, 524)), main_model_p->initial_cumuAllDeaths, main_model_p->dim_cumuAllDeaths * sizeof(double));
  SET_VECTOR_ELT(state, 525, ScalarInteger(main_model_p->offset_cumuAllDeaths));
  SET_VECTOR_ELT(state, 526, ScalarInteger(main_model_p->dim_cumuInf));
  SET_VECTOR_ELT(state, 527, allocVector(REALSXP, main_model_p->dim_cumuInf));
  memcpy(REAL(VECTOR_ELT(state, 527)), main_model_p->initial_cumuInf, main_model_p->dim_cumuInf * sizeof(double));
  SET_VECTOR_ELT(state, 528, ScalarInteger(main_model_p->offset_cumuInf));
  SET_VECTOR_ELT(state, 529, ScalarInteger(main_model_p->dim_PrEPinitiations));
  SET_VECTOR_ELT(state, 530, allocVector(REALSXP, main_model_p->dim_PrEPinitiations));
  memcpy(REAL(VECTOR_ELT(state, 530)), main_model_p->initial_PrEPinitiations, main_model_p->dim_PrEPinitiations * sizeof(double));
  SET_VECTOR_ELT(state, 531, ScalarInteger(main_model_p->offset_PrEPinitiations));
  SET_VECTOR_ELT(state, 532, ScalarInteger(main_model_p->dim_PrEPinitiations1a));
  SET_VECTOR_ELT(state, 533, allocVector(REALSXP, main_model_p->dim_PrEPinitiations1a));
  memcpy(REAL(VECTOR_ELT(state, 533)), main_model_p->initial_PrEPinitiations1a, main_model_p->dim_PrEPinitiations1a * sizeof(double));
  SET_VECTOR_ELT(state, 534, ScalarInteger(main_model_p->offset_PrEPinitiations1a));
  SET_VECTOR_ELT(state, 535, ScalarInteger(main_model_p->dim_PrEPinitiations1b));
  SET_VECTOR_ELT(state, 536, allocVector(REALSXP, main_model_p->dim_PrEPinitiations1b));
  memcpy(REAL(VECTOR_ELT(state, 536)), main_model_p->initial_PrEPinitiations1b, main_model_p->dim_PrEPinitiations1b * sizeof(double));
  SET_VECTOR_ELT(state, 537, ScalarInteger(main_model_p->offset_PrEPinitiations1b));
  SET_VECTOR_ELT(state, 538, ScalarInteger(main_model_p->dim_PrEPinitiations1c));
  SET_VECTOR_ELT(state, 539, allocVector(REALSXP, main_model_p->dim_PrEPinitiations1c));
  memcpy(REAL(VECTOR_ELT(state, 539)), main_model_p->initial_PrEPinitiations1c, main_model_p->dim_PrEPinitiations1c * sizeof(double));
  SET_VECTOR_ELT(state, 540, ScalarInteger(main_model_p->offset_PrEPinitiations1c));
  SET_VECTOR_ELT(state, 541, ScalarInteger(main_model_p->dim_S0));
  SET_VECTOR_ELT(state, 542, allocVector(REALSXP, main_model_p->dim_S0));
  memcpy(REAL(VECTOR_ELT(state, 542)), main_model_p->initial_S0, main_model_p->dim_S0 * sizeof(double));
  SET_VECTOR_ELT(state, 543, ScalarInteger(main_model_p->offset_S0));
  SET_VECTOR_ELT(state, 544, ScalarInteger(main_model_p->dim_S1a));
  SET_VECTOR_ELT(state, 545, allocVector(REALSXP, main_model_p->dim_S1a));
  memcpy(REAL(VECTOR_ELT(state, 545)), main_model_p->initial_S1a, main_model_p->dim_S1a * sizeof(double));
  SET_VECTOR_ELT(state, 546, ScalarInteger(main_model_p->offset_S1a));
  SET_VECTOR_ELT(state, 547, ScalarInteger(main_model_p->dim_S1b));
  SET_VECTOR_ELT(state, 548, allocVector(REALSXP, main_model_p->dim_S1b));
  memcpy(REAL(VECTOR_ELT(state, 548)), main_model_p->initial_S1b, main_model_p->dim_S1b * sizeof(double));
  SET_VECTOR_ELT(state, 549, ScalarInteger(main_model_p->offset_S1b));
  SET_VECTOR_ELT(state, 550, ScalarInteger(main_model_p->dim_S1c));
  SET_VECTOR_ELT(state, 551, allocVector(REALSXP, main_model_p->dim_S1c));
  memcpy(REAL(VECTOR_ELT(state, 551)), main_model_p->initial_S1c, main_model_p->dim_S1c * sizeof(double));
  SET_VECTOR_ELT(state, 552, ScalarInteger(main_model_p->offset_S1c));
  SET_VECTOR_ELT(state, 553, ScalarInteger(main_model_p->dim_S1d));
  SET_VECTOR_ELT(state, 554, allocVector(REALSXP, main_model_p->dim_S1d));
  memcpy(REAL(VECTOR_ELT(state, 554)), main_model_p->initial_S1d, main_model_p->dim_S1d * sizeof(double));
  SET_VECTOR_ELT(state, 555, ScalarInteger(main_model_p->offset_S1d));
  SET_VECTOR_ELT(state, 556, ScalarInteger(main_model_p->dim_I01));
  SET_VECTOR_ELT(state, 557, allocVector(REALSXP, main_model_p->dim_I01));
  memcpy(REAL(VECTOR_ELT(state, 557)), main_model_p->initial_I01, main_model_p->dim_I01 * sizeof(double));
  SET_VECTOR_ELT(state, 558, ScalarInteger(main_model_p->offset_I01));
  SET_VECTOR_ELT(state, 559, ScalarInteger(main_model_p->dim_I11));
  SET_VECTOR_ELT(state, 560, allocVector(REALSXP, main_model_p->dim_I11));
  memcpy(REAL(VECTOR_ELT(state, 560)), main_model_p->initial_I11, main_model_p->dim_I11 * sizeof(double));
  SET_VECTOR_ELT(state, 561, ScalarInteger(main_model_p->offset_I11));
  SET_VECTOR_ELT(state, 562, ScalarInteger(main_model_p->dim_I02));
  SET_VECTOR_ELT(state, 563, allocVector(REALSXP, main_model_p->dim_I02));
  memcpy(REAL(VECTOR_ELT(state, 563)), main_model_p->initial_I02, main_model_p->dim_I02 * sizeof(double));
  SET_VECTOR_ELT(state, 564, ScalarInteger(main_model_p->offset_I02));
  SET_VECTOR_ELT(state, 565, ScalarInteger(main_model_p->dim_I03));
  SET_VECTOR_ELT(state, 566, allocVector(REALSXP, main_model_p->dim_I03));
  memcpy(REAL(VECTOR_ELT(state, 566)), main_model_p->initial_I03, main_model_p->dim_I03 * sizeof(double));
  SET_VECTOR_ELT(state, 567, ScalarInteger(main_model_p->offset_I03));
  SET_VECTOR_ELT(state, 568, ScalarInteger(main_model_p->dim_I04));
  SET_VECTOR_ELT(state, 569, allocVector(REALSXP, main_model_p->dim_I04));
  memcpy(REAL(VECTOR_ELT(state, 569)), main_model_p->initial_I04, main_model_p->dim_I04 * sizeof(double));
  SET_VECTOR_ELT(state, 570, ScalarInteger(main_model_p->offset_I04));
  SET_VECTOR_ELT(state, 571, ScalarInteger(main_model_p->dim_I05));
  SET_VECTOR_ELT(state, 572, allocVector(REALSXP, main_model_p->dim_I05));
  memcpy(REAL(VECTOR_ELT(state, 572)), main_model_p->initial_I05, main_model_p->dim_I05 * sizeof(double));
  SET_VECTOR_ELT(state, 573, ScalarInteger(main_model_p->offset_I05));
  SET_VECTOR_ELT(state, 574, ScalarInteger(main_model_p->dim_I22));
  SET_VECTOR_ELT(state, 575, allocVector(REALSXP, main_model_p->dim_I22));
  memcpy(REAL(VECTOR_ELT(state, 575)), main_model_p->initial_I22, main_model_p->dim_I22 * sizeof(double));
  SET_VECTOR_ELT(state, 576, ScalarInteger(main_model_p->offset_I22));
  SET_VECTOR_ELT(state, 577, ScalarInteger(main_model_p->dim_I23));
  SET_VECTOR_ELT(state, 578, allocVector(REALSXP, main_model_p->dim_I23));
  memcpy(REAL(VECTOR_ELT(state, 578)), main_model_p->initial_I23, main_model_p->dim_I23 * sizeof(double));
  SET_VECTOR_ELT(state, 579, ScalarInteger(main_model_p->offset_I23));
  SET_VECTOR_ELT(state, 580, ScalarInteger(main_model_p->dim_I24));
  SET_VECTOR_ELT(state, 581, allocVector(REALSXP, main_model_p->dim_I24));
  memcpy(REAL(VECTOR_ELT(state, 581)), main_model_p->initial_I24, main_model_p->dim_I24 * sizeof(double));
  SET_VECTOR_ELT(state, 582, ScalarInteger(main_model_p->offset_I24));
  SET_VECTOR_ELT(state, 583, ScalarInteger(main_model_p->dim_I25));
  SET_VECTOR_ELT(state, 584, allocVector(REALSXP, main_model_p->dim_I25));
  memcpy(REAL(VECTOR_ELT(state, 584)), main_model_p->initial_I25, main_model_p->dim_I25 * sizeof(double));
  SET_VECTOR_ELT(state, 585, ScalarInteger(main_model_p->offset_I25));
  SET_VECTOR_ELT(state, 586, ScalarInteger(main_model_p->dim_I32));
  SET_VECTOR_ELT(state, 587, allocVector(REALSXP, main_model_p->dim_I32));
  memcpy(REAL(VECTOR_ELT(state, 587)), main_model_p->initial_I32, main_model_p->dim_I32 * sizeof(double));
  SET_VECTOR_ELT(state, 588, ScalarInteger(main_model_p->offset_I32));
  SET_VECTOR_ELT(state, 589, ScalarInteger(main_model_p->dim_I33));
  SET_VECTOR_ELT(state, 590, allocVector(REALSXP, main_model_p->dim_I33));
  memcpy(REAL(VECTOR_ELT(state, 590)), main_model_p->initial_I33, main_model_p->dim_I33 * sizeof(double));
  SET_VECTOR_ELT(state, 591, ScalarInteger(main_model_p->offset_I33));
  SET_VECTOR_ELT(state, 592, ScalarInteger(main_model_p->dim_I34));
  SET_VECTOR_ELT(state, 593, allocVector(REALSXP, main_model_p->dim_I34));
  memcpy(REAL(VECTOR_ELT(state, 593)), main_model_p->initial_I34, main_model_p->dim_I34 * sizeof(double));
  SET_VECTOR_ELT(state, 594, ScalarInteger(main_model_p->offset_I34));
  SET_VECTOR_ELT(state, 595, ScalarInteger(main_model_p->dim_I35));
  SET_VECTOR_ELT(state, 596, allocVector(REALSXP, main_model_p->dim_I35));
  memcpy(REAL(VECTOR_ELT(state, 596)), main_model_p->initial_I35, main_model_p->dim_I35 * sizeof(double));
  SET_VECTOR_ELT(state, 597, ScalarInteger(main_model_p->offset_I35));
  SET_VECTOR_ELT(state, 598, ScalarInteger(main_model_p->dim_I42));
  SET_VECTOR_ELT(state, 599, allocVector(REALSXP, main_model_p->dim_I42));
  memcpy(REAL(VECTOR_ELT(state, 599)), main_model_p->initial_I42, main_model_p->dim_I42 * sizeof(double));
  SET_VECTOR_ELT(state, 600, ScalarInteger(main_model_p->offset_I42));
  SET_VECTOR_ELT(state, 601, ScalarInteger(main_model_p->dim_I43));
  SET_VECTOR_ELT(state, 602, allocVector(REALSXP, main_model_p->dim_I43));
  memcpy(REAL(VECTOR_ELT(state, 602)), main_model_p->initial_I43, main_model_p->dim_I43 * sizeof(double));
  SET_VECTOR_ELT(state, 603, ScalarInteger(main_model_p->offset_I43));
  SET_VECTOR_ELT(state, 604, ScalarInteger(main_model_p->dim_I44));
  SET_VECTOR_ELT(state, 605, allocVector(REALSXP, main_model_p->dim_I44));
  memcpy(REAL(VECTOR_ELT(state, 605)), main_model_p->initial_I44, main_model_p->dim_I44 * sizeof(double));
  SET_VECTOR_ELT(state, 606, ScalarInteger(main_model_p->offset_I44));
  SET_VECTOR_ELT(state, 607, ScalarInteger(main_model_p->dim_I45));
  SET_VECTOR_ELT(state, 608, allocVector(REALSXP, main_model_p->dim_I45));
  memcpy(REAL(VECTOR_ELT(state, 608)), main_model_p->initial_I45, main_model_p->dim_I45 * sizeof(double));
  SET_VECTOR_ELT(state, 609, ScalarInteger(main_model_p->offset_I45));
  SET_VECTOR_ELT(state, 610, ScalarInteger(main_model_p->dim_S0_init));
  SET_VECTOR_ELT(state, 611, allocVector(REALSXP, main_model_p->dim_S0_init));
  memcpy(REAL(VECTOR_ELT(state, 611)), main_model_p->S0_init, main_model_p->dim_S0_init * sizeof(double));
  SET_VECTOR_ELT(state, 612, ScalarInteger(main_model_p->dim_S1a_init));
  SET_VECTOR_ELT(state, 613, allocVector(REALSXP, main_model_p->dim_S1a_init));
  memcpy(REAL(VECTOR_ELT(state, 613)), main_model_p->S1a_init, main_model_p->dim_S1a_init * sizeof(double));
  SET_VECTOR_ELT(state, 614, ScalarInteger(main_model_p->dim_S1b_init));
  SET_VECTOR_ELT(state, 615, allocVector(REALSXP, main_model_p->dim_S1b_init));
  memcpy(REAL(VECTOR_ELT(state, 615)), main_model_p->S1b_init, main_model_p->dim_S1b_init * sizeof(double));
  SET_VECTOR_ELT(state, 616, ScalarInteger(main_model_p->dim_S1c_init));
  SET_VECTOR_ELT(state, 617, allocVector(REALSXP, main_model_p->dim_S1c_init));
  memcpy(REAL(VECTOR_ELT(state, 617)), main_model_p->S1c_init, main_model_p->dim_S1c_init * sizeof(double));
  SET_VECTOR_ELT(state, 618, ScalarInteger(main_model_p->dim_S1d_init));
  SET_VECTOR_ELT(state, 619, allocVector(REALSXP, main_model_p->dim_S1d_init));
  memcpy(REAL(VECTOR_ELT(state, 619)), main_model_p->S1d_init, main_model_p->dim_S1d_init * sizeof(double));
  SET_VECTOR_ELT(state, 620, ScalarInteger(main_model_p->dim_I01_init));
  SET_VECTOR_ELT(state, 621, allocVector(REALSXP, main_model_p->dim_I01_init));
  memcpy(REAL(VECTOR_ELT(state, 621)), main_model_p->I01_init, main_model_p->dim_I01_init * sizeof(double));
  SET_VECTOR_ELT(state, 622, ScalarInteger(main_model_p->dim_I11_init));
  SET_VECTOR_ELT(state, 623, allocVector(REALSXP, main_model_p->dim_I11_init));
  memcpy(REAL(VECTOR_ELT(state, 623)), main_model_p->I11_init, main_model_p->dim_I11_init * sizeof(double));
  SET_VECTOR_ELT(state, 624, ScalarInteger(main_model_p->dim_I02_init));
  SET_VECTOR_ELT(state, 625, allocVector(REALSXP, main_model_p->dim_I02_init));
  memcpy(REAL(VECTOR_ELT(state, 625)), main_model_p->I02_init, main_model_p->dim_I02_init * sizeof(double));
  SET_VECTOR_ELT(state, 626, ScalarInteger(main_model_p->dim_I03_init));
  SET_VECTOR_ELT(state, 627, allocVector(REALSXP, main_model_p->dim_I03_init));
  memcpy(REAL(VECTOR_ELT(state, 627)), main_model_p->I03_init, main_model_p->dim_I03_init * sizeof(double));
  SET_VECTOR_ELT(state, 628, ScalarInteger(main_model_p->dim_I04_init));
  SET_VECTOR_ELT(state, 629, allocVector(REALSXP, main_model_p->dim_I04_init));
  memcpy(REAL(VECTOR_ELT(state, 629)), main_model_p->I04_init, main_model_p->dim_I04_init * sizeof(double));
  SET_VECTOR_ELT(state, 630, ScalarInteger(main_model_p->dim_I05_init));
  SET_VECTOR_ELT(state, 631, allocVector(REALSXP, main_model_p->dim_I05_init));
  memcpy(REAL(VECTOR_ELT(state, 631)), main_model_p->I05_init, main_model_p->dim_I05_init * sizeof(double));
  SET_VECTOR_ELT(state, 632, ScalarInteger(main_model_p->dim_I22_init));
  SET_VECTOR_ELT(state, 633, allocVector(REALSXP, main_model_p->dim_I22_init));
  memcpy(REAL(VECTOR_ELT(state, 633)), main_model_p->I22_init, main_model_p->dim_I22_init * sizeof(double));
  SET_VECTOR_ELT(state, 634, ScalarInteger(main_model_p->dim_I23_init));
  SET_VECTOR_ELT(state, 635, allocVector(REALSXP, main_model_p->dim_I23_init));
  memcpy(REAL(VECTOR_ELT(state, 635)), main_model_p->I23_init, main_model_p->dim_I23_init * sizeof(double));
  SET_VECTOR_ELT(state, 636, ScalarInteger(main_model_p->dim_I24_init));
  SET_VECTOR_ELT(state, 637, allocVector(REALSXP, main_model_p->dim_I24_init));
  memcpy(REAL(VECTOR_ELT(state, 637)), main_model_p->I24_init, main_model_p->dim_I24_init * sizeof(double));
  SET_VECTOR_ELT(state, 638, ScalarInteger(main_model_p->dim_I25_init));
  SET_VECTOR_ELT(state, 639, allocVector(REALSXP, main_model_p->dim_I25_init));
  memcpy(REAL(VECTOR_ELT(state, 639)), main_model_p->I25_init, main_model_p->dim_I25_init * sizeof(double));
  SET_VECTOR_ELT(state, 640, ScalarInteger(main_model_p->dim_I32_init));
  SET_VECTOR_ELT(state, 641, allocVector(REALSXP, main_model_p->dim_I32_init));
  memcpy(REAL(VECTOR_ELT(state, 641)), main_model_p->I32_init, main_model_p->dim_I32_init * sizeof(double));
  SET_VECTOR_ELT(state, 642, ScalarInteger(main_model_p->dim_I33_init));
  SET_VECTOR_ELT(state, 643, allocVector(REALSXP, main_model_p->dim_I33_init));
  memcpy(REAL(VECTOR_ELT(state, 643)), main_model_p->I33_init, main_model_p->dim_I33_init * sizeof(double));
  SET_VECTOR_ELT(state, 644, ScalarInteger(main_model_p->dim_I34_init));
  SET_VECTOR_ELT(state, 645, allocVector(REALSXP, main_model_p->dim_I34_init));
  memcpy(REAL(VECTOR_ELT(state, 645)), main_model_p->I34_init, main_model_p->dim_I34_init * sizeof(double));
  SET_VECTOR_ELT(state, 646, ScalarInteger(main_model_p->dim_I35_init));
  SET_VECTOR_ELT(state, 647, allocVector(REALSXP, main_model_p->dim_I35_init));
  memcpy(REAL(VECTOR_ELT(state, 647)), main_model_p->I35_init, main_model_p->dim_I35_init * sizeof(double));
  SET_VECTOR_ELT(state, 648, ScalarInteger(main_model_p->dim_I42_init));
  SET_VECTOR_ELT(state, 649, allocVector(REALSXP, main_model_p->dim_I42_init));
  memcpy(REAL(VECTOR_ELT(state, 649)), main_model_p->I42_init, main_model_p->dim_I42_init * sizeof(double));
  SET_VECTOR_ELT(state, 650, ScalarInteger(main_model_p->dim_I43_init));
  SET_VECTOR_ELT(state, 651, allocVector(REALSXP, main_model_p->dim_I43_init));
  memcpy(REAL(VECTOR_ELT(state, 651)), main_model_p->I43_init, main_model_p->dim_I43_init * sizeof(double));
  SET_VECTOR_ELT(state, 652, ScalarInteger(main_model_p->dim_I44_init));
  SET_VECTOR_ELT(state, 653, allocVector(REALSXP, main_model_p->dim_I44_init));
  memcpy(REAL(VECTOR_ELT(state, 653)), main_model_p->I44_init, main_model_p->dim_I44_init * sizeof(double));
  SET_VECTOR_ELT(state, 654, ScalarInteger(main_model_p->dim_I45_init));
  SET_VECTOR_ELT(state, 655, allocVector(REALSXP, main_model_p->dim_I45_init));
  memcpy(REAL(VECTOR_ELT(state, 655)), main_model_p->I45_init, main_model_p->dim_I45_init * sizeof(double));
  SET_VECTOR_ELT(state, 656, ScalarInteger(main_model_p->dim_N));
  SET_VECTOR_ELT(state, 657, allocVector(REALSXP, main_model_p->dim_N));
  memcpy(REAL(VECTOR_ELT(state, 657)), main_model_p->N, main_model_p->dim_N * sizeof(double));
  SET_VECTOR_ELT(state, 658, ScalarInteger(main_model_p->offset_output_N));
  SET_VECTOR_ELT(state, 659, ScalarInteger(main_model_p->dim_E0));
  SET_VECTOR_ELT(state, 660, allocVector(REALSXP, main_model_p->dim_E0));
  memcpy(REAL(VECTOR_ELT(state, 660)), main_model_p->E0, main_model_p->dim_E0 * sizeof(double));
  SET_VECTOR_ELT(state, 661, ScalarInteger(main_model_p->offset_output_E0));
  SET_VECTOR_ELT(state, 662, ScalarInteger(main_model_p->dim_E1a));
  SET_VECTOR_ELT(state, 663, allocVector(REALSXP, main_model_p->dim_E1a));
  memcpy(REAL(VECTOR_ELT(state, 663)), main_model_p->E1a, main_model_p->dim_E1a * sizeof(double));
  SET_VECTOR_ELT(state, 664, ScalarInteger(main_model_p->offset_output_E1a));
  SET_VECTOR_ELT(state, 665, ScalarInteger(main_model_p->dim_E1b));
  SET_VECTOR_ELT(state, 666, allocVector(REALSXP, main_model_p->dim_E1b));
  memcpy(REAL(VECTOR_ELT(state, 666)), main_model_p->E1b, main_model_p->dim_E1b * sizeof(double));
  SET_VECTOR_ELT(state, 667, ScalarInteger(main_model_p->offset_output_E1b));
  SET_VECTOR_ELT(state, 668, ScalarInteger(main_model_p->dim_E1c));
  SET_VECTOR_ELT(state, 669, allocVector(REALSXP, main_model_p->dim_E1c));
  memcpy(REAL(VECTOR_ELT(state, 669)), main_model_p->E1c, main_model_p->dim_E1c * sizeof(double));
  SET_VECTOR_ELT(state, 670, ScalarInteger(main_model_p->offset_output_E1c));
  SET_VECTOR_ELT(state, 671, ScalarInteger(main_model_p->dim_E1d));
  SET_VECTOR_ELT(state, 672, allocVector(REALSXP, main_model_p->dim_E1d));
  memcpy(REAL(VECTOR_ELT(state, 672)), main_model_p->E1d, main_model_p->dim_E1d * sizeof(double));
  SET_VECTOR_ELT(state, 673, ScalarInteger(main_model_p->offset_output_E1d));
  SET_VECTOR_ELT(state, 674, ScalarInteger(main_model_p->dim_cumuInf_init));
  SET_VECTOR_ELT(state, 675, allocVector(REALSXP, main_model_p->dim_cumuInf_init));
  memcpy(REAL(VECTOR_ELT(state, 675)), main_model_p->cumuInf_init, main_model_p->dim_cumuInf_init * sizeof(double));
  SET_VECTOR_ELT(state, 676, ScalarInteger(main_model_p->dim_alphaItot));
  SET_VECTOR_ELT(state, 677, allocVector(REALSXP, main_model_p->dim_alphaItot));
  memcpy(REAL(VECTOR_ELT(state, 677)), main_model_p->alphaItot, main_model_p->dim_alphaItot * sizeof(double));
  SET_VECTOR_ELT(state, 678, ScalarInteger(main_model_p->offset_output_alphaItot));
  SET_VECTOR_ELT(state, 679, ScalarInteger(main_model_p->dim_prev));
  SET_VECTOR_ELT(state, 680, allocVector(REALSXP, main_model_p->dim_prev));
  memcpy(REAL(VECTOR_ELT(state, 680)), main_model_p->prev, main_model_p->dim_prev * sizeof(double));
  SET_VECTOR_ELT(state, 681, ScalarInteger(main_model_p->offset_output_prev));
  SET_VECTOR_ELT(state, 682, ScalarInteger(main_model_p->dim_lambda));
  SET_VECTOR_ELT(state, 683, ScalarInteger(main_model_p->dim_lambda_1));
  SET_VECTOR_ELT(state, 684, ScalarInteger(main_model_p->dim_lambda_2));
  SET_VECTOR_ELT(state, 685, allocVector(REALSXP, main_model_p->dim_lambda));
  memcpy(REAL(VECTOR_ELT(state, 685)), main_model_p->lambda, main_model_p->dim_lambda * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 685), 2, main_model_p->dim_lambda_1, main_model_p->dim_lambda_2);
  SET_VECTOR_ELT(state, 686, ScalarInteger(main_model_p->offset_output_lambda));
  SET_VECTOR_ELT(state, 687, ScalarInteger(main_model_p->dim_lambda_0));
  SET_VECTOR_ELT(state, 688, ScalarInteger(main_model_p->dim_lambda_0_1));
  SET_VECTOR_ELT(state, 689, ScalarInteger(main_model_p->dim_lambda_0_2));
  SET_VECTOR_ELT(state, 690, allocVector(REALSXP, main_model_p->dim_lambda_0));
  memcpy(REAL(VECTOR_ELT(state, 690)), main_model_p->lambda_0, main_model_p->dim_lambda_0 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 690), 2, main_model_p->dim_lambda_0_1, main_model_p->dim_lambda_0_2);
  SET_VECTOR_ELT(state, 691, ScalarInteger(main_model_p->offset_output_lambda_0));
  SET_VECTOR_ELT(state, 692, ScalarInteger(main_model_p->dim_lambda_1a));
  SET_VECTOR_ELT(state, 693, ScalarInteger(main_model_p->dim_lambda_1a_1));
  SET_VECTOR_ELT(state, 694, ScalarInteger(main_model_p->dim_lambda_1a_2));
  SET_VECTOR_ELT(state, 695, allocVector(REALSXP, main_model_p->dim_lambda_1a));
  memcpy(REAL(VECTOR_ELT(state, 695)), main_model_p->lambda_1a, main_model_p->dim_lambda_1a * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 695), 2, main_model_p->dim_lambda_1a_1, main_model_p->dim_lambda_1a_2);
  SET_VECTOR_ELT(state, 696, ScalarInteger(main_model_p->offset_output_lambda_1a));
  SET_VECTOR_ELT(state, 697, ScalarInteger(main_model_p->dim_lambda_1b));
  SET_VECTOR_ELT(state, 698, ScalarInteger(main_model_p->dim_lambda_1b_1));
  SET_VECTOR_ELT(state, 699, ScalarInteger(main_model_p->dim_lambda_1b_2));
  SET_VECTOR_ELT(state, 700, allocVector(REALSXP, main_model_p->dim_lambda_1b));
  memcpy(REAL(VECTOR_ELT(state, 700)), main_model_p->lambda_1b, main_model_p->dim_lambda_1b * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 700), 2, main_model_p->dim_lambda_1b_1, main_model_p->dim_lambda_1b_2);
  SET_VECTOR_ELT(state, 701, ScalarInteger(main_model_p->offset_output_lambda_1b));
  SET_VECTOR_ELT(state, 702, ScalarInteger(main_model_p->dim_lambda_1c));
  SET_VECTOR_ELT(state, 703, ScalarInteger(main_model_p->dim_lambda_1c_1));
  SET_VECTOR_ELT(state, 704, ScalarInteger(main_model_p->dim_lambda_1c_2));
  SET_VECTOR_ELT(state, 705, allocVector(REALSXP, main_model_p->dim_lambda_1c));
  memcpy(REAL(VECTOR_ELT(state, 705)), main_model_p->lambda_1c, main_model_p->dim_lambda_1c * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 705), 2, main_model_p->dim_lambda_1c_1, main_model_p->dim_lambda_1c_2);
  SET_VECTOR_ELT(state, 706, ScalarInteger(main_model_p->offset_output_lambda_1c));
  SET_VECTOR_ELT(state, 707, ScalarInteger(main_model_p->dim_lambda_1d));
  SET_VECTOR_ELT(state, 708, ScalarInteger(main_model_p->dim_lambda_1d_1));
  SET_VECTOR_ELT(state, 709, ScalarInteger(main_model_p->dim_lambda_1d_2));
  SET_VECTOR_ELT(state, 710, allocVector(REALSXP, main_model_p->dim_lambda_1d));
  memcpy(REAL(VECTOR_ELT(state, 710)), main_model_p->lambda_1d, main_model_p->dim_lambda_1d * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 710), 2, main_model_p->dim_lambda_1d_1, main_model_p->dim_lambda_1d_2);
  SET_VECTOR_ELT(state, 711, ScalarInteger(main_model_p->offset_output_lambda_1d));
  SET_VECTOR_ELT(state, 712, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_VECTOR_ELT(state, 713, allocVector(REALSXP, main_model_p->dim_lambda_sum_0));
  memcpy(REAL(VECTOR_ELT(state, 713)), main_model_p->lambda_sum_0, main_model_p->dim_lambda_sum_0 * sizeof(double));
  SET_VECTOR_ELT(state, 714, ScalarInteger(main_model_p->offset_output_lambda_sum_0));
  SET_VECTOR_ELT(state, 715, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_VECTOR_ELT(state, 716, allocVector(REALSXP, main_model_p->dim_lambda_sum_1a));
  memcpy(REAL(VECTOR_ELT(state, 716)), main_model_p->lambda_sum_1a, main_model_p->dim_lambda_sum_1a * sizeof(double));
  SET_VECTOR_ELT(state, 717, ScalarInteger(main_model_p->offset_output_lambda_sum_1a));
  SET_VECTOR_ELT(state, 718, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_VECTOR_ELT(state, 719, allocVector(REALSXP, main_model_p->dim_lambda_sum_1b));
  memcpy(REAL(VECTOR_ELT(state, 719)), main_model_p->lambda_sum_1b, main_model_p->dim_lambda_sum_1b * sizeof(double));
  SET_VECTOR_ELT(state, 720, ScalarInteger(main_model_p->offset_output_lambda_sum_1b));
  SET_VECTOR_ELT(state, 721, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_VECTOR_ELT(state, 722, allocVector(REALSXP, main_model_p->dim_lambda_sum_1c));
  memcpy(REAL(VECTOR_ELT(state, 722)), main_model_p->lambda_sum_1c, main_model_p->dim_lambda_sum_1c * sizeof(double));
  SET_VECTOR_ELT(state, 723, ScalarInteger(main_model_p->offset_output_lambda_sum_1c));
  SET_VECTOR_ELT(state, 724, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_VECTOR_ELT(state, 725, allocVector(REALSXP, main_model_p->dim_lambda_sum_1d));
  memcpy(REAL(VECTOR_ELT(state, 725)), main_model_p->lambda_sum_1d, main_model_p->dim_lambda_sum_1d * sizeof(double));
  SET_VECTOR_ELT(state, 726, ScalarInteger(main_model_p->offset_output_lambda_sum_1d));
  SET_VECTOR_ELT(state, 727, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_VECTOR_ELT(state, 728, allocVector(REALSXP, main_model_p->dim_c_comm_balanced));
  memcpy(REAL(VECTOR_ELT(state, 728)), main_model_p->c_comm_balanced, main_model_p->dim_c_comm_balanced * sizeof(double));
  SET_VECTOR_ELT(state, 729, ScalarInteger(main_model_p->offset_output_c_comm_balanced));
  SET_VECTOR_ELT(state, 730, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_VECTOR_ELT(state, 731, allocVector(REALSXP, main_model_p->dim_c_noncomm_balanced));
  memcpy(REAL(VECTOR_ELT(state, 731)), main_model_p->c_noncomm_balanced, main_model_p->dim_c_noncomm_balanced * sizeof(double));
  SET_VECTOR_ELT(state, 732, ScalarInteger(main_model_p->offset_output_c_noncomm_balanced));
  SET_VECTOR_ELT(state, 733, ScalarInteger(main_model_p->dim_theta));
  SET_VECTOR_ELT(state, 734, ScalarInteger(main_model_p->dim_theta_1));
  SET_VECTOR_ELT(state, 735, ScalarInteger(main_model_p->dim_theta_2));
  SET_VECTOR_ELT(state, 736, allocVector(REALSXP, main_model_p->dim_theta));
  memcpy(REAL(VECTOR_ELT(state, 736)), main_model_p->theta, main_model_p->dim_theta * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 736), 2, main_model_p->dim_theta_1, main_model_p->dim_theta_2);
  SET_VECTOR_ELT(state, 737, ScalarInteger(main_model_p->offset_output_theta));
  SET_VECTOR_ELT(state, 738, ScalarInteger(main_model_p->dim_PrEPinitiations_init));
  SET_VECTOR_ELT(state, 739, allocVector(REALSXP, main_model_p->dim_PrEPinitiations_init));
  memcpy(REAL(VECTOR_ELT(state, 739)), main_model_p->PrEPinitiations_init, main_model_p->dim_PrEPinitiations_init * sizeof(double));
  SET_VECTOR_ELT(state, 740, ScalarInteger(main_model_p->dim_M_comm));
  SET_VECTOR_ELT(state, 741, ScalarInteger(main_model_p->dim_M_comm_1));
  SET_VECTOR_ELT(state, 742, ScalarInteger(main_model_p->dim_M_comm_2));
  SET_VECTOR_ELT(state, 743, allocVector(REALSXP, main_model_p->dim_M_comm));
  memcpy(REAL(VECTOR_ELT(state, 743)), main_model_p->M_comm, main_model_p->dim_M_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 743), 2, main_model_p->dim_M_comm_1, main_model_p->dim_M_comm_2);
  SET_VECTOR_ELT(state, 744, ScalarInteger(main_model_p->offset_output_M_comm));
  SET_VECTOR_ELT(state, 745, ScalarInteger(main_model_p->dim_M_noncomm));
  SET_VECTOR_ELT(state, 746, ScalarInteger(main_model_p->dim_M_noncomm_1));
  SET_VECTOR_ELT(state, 747, ScalarInteger(main_model_p->dim_M_noncomm_2));
  SET_VECTOR_ELT(state, 748, allocVector(REALSXP, main_model_p->dim_M_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 748)), main_model_p->M_noncomm, main_model_p->dim_M_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 748), 2, main_model_p->dim_M_noncomm_1, main_model_p->dim_M_noncomm_2);
  SET_VECTOR_ELT(state, 749, ScalarInteger(main_model_p->offset_output_M_noncomm));
  SET_VECTOR_ELT(state, 750, ScalarInteger(main_model_p->dim_in_S0));
  SET_VECTOR_ELT(state, 751, ScalarInteger(main_model_p->dim_in_S0_1));
  SET_VECTOR_ELT(state, 752, ScalarInteger(main_model_p->dim_in_S0_2));
  SET_VECTOR_ELT(state, 753, allocVector(REALSXP, main_model_p->dim_in_S0));
  memcpy(REAL(VECTOR_ELT(state, 753)), main_model_p->in_S0, main_model_p->dim_in_S0 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 753), 2, main_model_p->dim_in_S0_1, main_model_p->dim_in_S0_2);
  SET_VECTOR_ELT(state, 754, ScalarInteger(main_model_p->dim_in_S1a));
  SET_VECTOR_ELT(state, 755, ScalarInteger(main_model_p->dim_in_S1a_1));
  SET_VECTOR_ELT(state, 756, ScalarInteger(main_model_p->dim_in_S1a_2));
  SET_VECTOR_ELT(state, 757, allocVector(REALSXP, main_model_p->dim_in_S1a));
  memcpy(REAL(VECTOR_ELT(state, 757)), main_model_p->in_S1a, main_model_p->dim_in_S1a * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 757), 2, main_model_p->dim_in_S1a_1, main_model_p->dim_in_S1a_2);
  SET_VECTOR_ELT(state, 758, ScalarInteger(main_model_p->dim_in_S1b));
  SET_VECTOR_ELT(state, 759, ScalarInteger(main_model_p->dim_in_S1b_1));
  SET_VECTOR_ELT(state, 760, ScalarInteger(main_model_p->dim_in_S1b_2));
  SET_VECTOR_ELT(state, 761, allocVector(REALSXP, main_model_p->dim_in_S1b));
  memcpy(REAL(VECTOR_ELT(state, 761)), main_model_p->in_S1b, main_model_p->dim_in_S1b * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 761), 2, main_model_p->dim_in_S1b_1, main_model_p->dim_in_S1b_2);
  SET_VECTOR_ELT(state, 762, ScalarInteger(main_model_p->dim_in_S1c));
  SET_VECTOR_ELT(state, 763, ScalarInteger(main_model_p->dim_in_S1c_1));
  SET_VECTOR_ELT(state, 764, ScalarInteger(main_model_p->dim_in_S1c_2));
  SET_VECTOR_ELT(state, 765, allocVector(REALSXP, main_model_p->dim_in_S1c));
  memcpy(REAL(VECTOR_ELT(state, 765)), main_model_p->in_S1c, main_model_p->dim_in_S1c * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 765), 2, main_model_p->dim_in_S1c_1, main_model_p->dim_in_S1c_2);
  SET_VECTOR_ELT(state, 766, ScalarInteger(main_model_p->dim_in_S1d));
  SET_VECTOR_ELT(state, 767, ScalarInteger(main_model_p->dim_in_S1d_1));
  SET_VECTOR_ELT(state, 768, ScalarInteger(main_model_p->dim_in_S1d_2));
  SET_VECTOR_ELT(state, 769, allocVector(REALSXP, main_model_p->dim_in_S1d));
  memcpy(REAL(VECTOR_ELT(state, 769)), main_model_p->in_S1d, main_model_p->dim_in_S1d * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 769), 2, main_model_p->dim_in_S1d_1, main_model_p->dim_in_S1d_2);
  SET_VECTOR_ELT(state, 770, ScalarInteger(main_model_p->dim_in_I01));
  SET_VECTOR_ELT(state, 771, ScalarInteger(main_model_p->dim_in_I01_1));
  SET_VECTOR_ELT(state, 772, ScalarInteger(main_model_p->dim_in_I01_2));
  SET_VECTOR_ELT(state, 773, allocVector(REALSXP, main_model_p->dim_in_I01));
  memcpy(REAL(VECTOR_ELT(state, 773)), main_model_p->in_I01, main_model_p->dim_in_I01 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 773), 2, main_model_p->dim_in_I01_1, main_model_p->dim_in_I01_2);
  SET_VECTOR_ELT(state, 774, ScalarInteger(main_model_p->dim_in_I11));
  SET_VECTOR_ELT(state, 775, ScalarInteger(main_model_p->dim_in_I11_1));
  SET_VECTOR_ELT(state, 776, ScalarInteger(main_model_p->dim_in_I11_2));
  SET_VECTOR_ELT(state, 777, allocVector(REALSXP, main_model_p->dim_in_I11));
  memcpy(REAL(VECTOR_ELT(state, 777)), main_model_p->in_I11, main_model_p->dim_in_I11 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 777), 2, main_model_p->dim_in_I11_1, main_model_p->dim_in_I11_2);
  SET_VECTOR_ELT(state, 778, ScalarInteger(main_model_p->dim_in_I02));
  SET_VECTOR_ELT(state, 779, ScalarInteger(main_model_p->dim_in_I02_1));
  SET_VECTOR_ELT(state, 780, ScalarInteger(main_model_p->dim_in_I02_2));
  SET_VECTOR_ELT(state, 781, allocVector(REALSXP, main_model_p->dim_in_I02));
  memcpy(REAL(VECTOR_ELT(state, 781)), main_model_p->in_I02, main_model_p->dim_in_I02 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 781), 2, main_model_p->dim_in_I02_1, main_model_p->dim_in_I02_2);
  SET_VECTOR_ELT(state, 782, ScalarInteger(main_model_p->dim_in_I03));
  SET_VECTOR_ELT(state, 783, ScalarInteger(main_model_p->dim_in_I03_1));
  SET_VECTOR_ELT(state, 784, ScalarInteger(main_model_p->dim_in_I03_2));
  SET_VECTOR_ELT(state, 785, allocVector(REALSXP, main_model_p->dim_in_I03));
  memcpy(REAL(VECTOR_ELT(state, 785)), main_model_p->in_I03, main_model_p->dim_in_I03 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 785), 2, main_model_p->dim_in_I03_1, main_model_p->dim_in_I03_2);
  SET_VECTOR_ELT(state, 786, ScalarInteger(main_model_p->dim_in_I04));
  SET_VECTOR_ELT(state, 787, ScalarInteger(main_model_p->dim_in_I04_1));
  SET_VECTOR_ELT(state, 788, ScalarInteger(main_model_p->dim_in_I04_2));
  SET_VECTOR_ELT(state, 789, allocVector(REALSXP, main_model_p->dim_in_I04));
  memcpy(REAL(VECTOR_ELT(state, 789)), main_model_p->in_I04, main_model_p->dim_in_I04 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 789), 2, main_model_p->dim_in_I04_1, main_model_p->dim_in_I04_2);
  SET_VECTOR_ELT(state, 790, ScalarInteger(main_model_p->dim_in_I05));
  SET_VECTOR_ELT(state, 791, ScalarInteger(main_model_p->dim_in_I05_1));
  SET_VECTOR_ELT(state, 792, ScalarInteger(main_model_p->dim_in_I05_2));
  SET_VECTOR_ELT(state, 793, allocVector(REALSXP, main_model_p->dim_in_I05));
  memcpy(REAL(VECTOR_ELT(state, 793)), main_model_p->in_I05, main_model_p->dim_in_I05 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 793), 2, main_model_p->dim_in_I05_1, main_model_p->dim_in_I05_2);
  SET_VECTOR_ELT(state, 794, ScalarInteger(main_model_p->dim_in_I22));
  SET_VECTOR_ELT(state, 795, ScalarInteger(main_model_p->dim_in_I22_1));
  SET_VECTOR_ELT(state, 796, ScalarInteger(main_model_p->dim_in_I22_2));
  SET_VECTOR_ELT(state, 797, allocVector(REALSXP, main_model_p->dim_in_I22));
  memcpy(REAL(VECTOR_ELT(state, 797)), main_model_p->in_I22, main_model_p->dim_in_I22 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 797), 2, main_model_p->dim_in_I22_1, main_model_p->dim_in_I22_2);
  SET_VECTOR_ELT(state, 798, ScalarInteger(main_model_p->dim_in_I23));
  SET_VECTOR_ELT(state, 799, ScalarInteger(main_model_p->dim_in_I23_1));
  SET_VECTOR_ELT(state, 800, ScalarInteger(main_model_p->dim_in_I23_2));
  SET_VECTOR_ELT(state, 801, allocVector(REALSXP, main_model_p->dim_in_I23));
  memcpy(REAL(VECTOR_ELT(state, 801)), main_model_p->in_I23, main_model_p->dim_in_I23 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 801), 2, main_model_p->dim_in_I23_1, main_model_p->dim_in_I23_2);
  SET_VECTOR_ELT(state, 802, ScalarInteger(main_model_p->dim_in_I24));
  SET_VECTOR_ELT(state, 803, ScalarInteger(main_model_p->dim_in_I24_1));
  SET_VECTOR_ELT(state, 804, ScalarInteger(main_model_p->dim_in_I24_2));
  SET_VECTOR_ELT(state, 805, allocVector(REALSXP, main_model_p->dim_in_I24));
  memcpy(REAL(VECTOR_ELT(state, 805)), main_model_p->in_I24, main_model_p->dim_in_I24 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 805), 2, main_model_p->dim_in_I24_1, main_model_p->dim_in_I24_2);
  SET_VECTOR_ELT(state, 806, ScalarInteger(main_model_p->dim_in_I25));
  SET_VECTOR_ELT(state, 807, ScalarInteger(main_model_p->dim_in_I25_1));
  SET_VECTOR_ELT(state, 808, ScalarInteger(main_model_p->dim_in_I25_2));
  SET_VECTOR_ELT(state, 809, allocVector(REALSXP, main_model_p->dim_in_I25));
  memcpy(REAL(VECTOR_ELT(state, 809)), main_model_p->in_I25, main_model_p->dim_in_I25 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 809), 2, main_model_p->dim_in_I25_1, main_model_p->dim_in_I25_2);
  SET_VECTOR_ELT(state, 810, ScalarInteger(main_model_p->dim_in_I32));
  SET_VECTOR_ELT(state, 811, ScalarInteger(main_model_p->dim_in_I32_1));
  SET_VECTOR_ELT(state, 812, ScalarInteger(main_model_p->dim_in_I32_2));
  SET_VECTOR_ELT(state, 813, allocVector(REALSXP, main_model_p->dim_in_I32));
  memcpy(REAL(VECTOR_ELT(state, 813)), main_model_p->in_I32, main_model_p->dim_in_I32 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 813), 2, main_model_p->dim_in_I32_1, main_model_p->dim_in_I32_2);
  SET_VECTOR_ELT(state, 814, ScalarInteger(main_model_p->dim_in_I33));
  SET_VECTOR_ELT(state, 815, ScalarInteger(main_model_p->dim_in_I33_1));
  SET_VECTOR_ELT(state, 816, ScalarInteger(main_model_p->dim_in_I33_2));
  SET_VECTOR_ELT(state, 817, allocVector(REALSXP, main_model_p->dim_in_I33));
  memcpy(REAL(VECTOR_ELT(state, 817)), main_model_p->in_I33, main_model_p->dim_in_I33 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 817), 2, main_model_p->dim_in_I33_1, main_model_p->dim_in_I33_2);
  SET_VECTOR_ELT(state, 818, ScalarInteger(main_model_p->dim_in_I34));
  SET_VECTOR_ELT(state, 819, ScalarInteger(main_model_p->dim_in_I34_1));
  SET_VECTOR_ELT(state, 820, ScalarInteger(main_model_p->dim_in_I34_2));
  SET_VECTOR_ELT(state, 821, allocVector(REALSXP, main_model_p->dim_in_I34));
  memcpy(REAL(VECTOR_ELT(state, 821)), main_model_p->in_I34, main_model_p->dim_in_I34 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 821), 2, main_model_p->dim_in_I34_1, main_model_p->dim_in_I34_2);
  SET_VECTOR_ELT(state, 822, ScalarInteger(main_model_p->dim_in_I35));
  SET_VECTOR_ELT(state, 823, ScalarInteger(main_model_p->dim_in_I35_1));
  SET_VECTOR_ELT(state, 824, ScalarInteger(main_model_p->dim_in_I35_2));
  SET_VECTOR_ELT(state, 825, allocVector(REALSXP, main_model_p->dim_in_I35));
  memcpy(REAL(VECTOR_ELT(state, 825)), main_model_p->in_I35, main_model_p->dim_in_I35 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 825), 2, main_model_p->dim_in_I35_1, main_model_p->dim_in_I35_2);
  SET_VECTOR_ELT(state, 826, ScalarInteger(main_model_p->dim_in_I42));
  SET_VECTOR_ELT(state, 827, ScalarInteger(main_model_p->dim_in_I42_1));
  SET_VECTOR_ELT(state, 828, ScalarInteger(main_model_p->dim_in_I42_2));
  SET_VECTOR_ELT(state, 829, allocVector(REALSXP, main_model_p->dim_in_I42));
  memcpy(REAL(VECTOR_ELT(state, 829)), main_model_p->in_I42, main_model_p->dim_in_I42 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 829), 2, main_model_p->dim_in_I42_1, main_model_p->dim_in_I42_2);
  SET_VECTOR_ELT(state, 830, ScalarInteger(main_model_p->dim_in_I43));
  SET_VECTOR_ELT(state, 831, ScalarInteger(main_model_p->dim_in_I43_1));
  SET_VECTOR_ELT(state, 832, ScalarInteger(main_model_p->dim_in_I43_2));
  SET_VECTOR_ELT(state, 833, allocVector(REALSXP, main_model_p->dim_in_I43));
  memcpy(REAL(VECTOR_ELT(state, 833)), main_model_p->in_I43, main_model_p->dim_in_I43 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 833), 2, main_model_p->dim_in_I43_1, main_model_p->dim_in_I43_2);
  SET_VECTOR_ELT(state, 834, ScalarInteger(main_model_p->dim_in_I44));
  SET_VECTOR_ELT(state, 835, ScalarInteger(main_model_p->dim_in_I44_1));
  SET_VECTOR_ELT(state, 836, ScalarInteger(main_model_p->dim_in_I44_2));
  SET_VECTOR_ELT(state, 837, allocVector(REALSXP, main_model_p->dim_in_I44));
  memcpy(REAL(VECTOR_ELT(state, 837)), main_model_p->in_I44, main_model_p->dim_in_I44 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 837), 2, main_model_p->dim_in_I44_1, main_model_p->dim_in_I44_2);
  SET_VECTOR_ELT(state, 838, ScalarInteger(main_model_p->dim_in_I45));
  SET_VECTOR_ELT(state, 839, ScalarInteger(main_model_p->dim_in_I45_1));
  SET_VECTOR_ELT(state, 840, ScalarInteger(main_model_p->dim_in_I45_2));
  SET_VECTOR_ELT(state, 841, allocVector(REALSXP, main_model_p->dim_in_I45));
  memcpy(REAL(VECTOR_ELT(state, 841)), main_model_p->in_I45, main_model_p->dim_in_I45 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 841), 2, main_model_p->dim_in_I45_1, main_model_p->dim_in_I45_2);
  SET_VECTOR_ELT(state, 842, ScalarInteger(main_model_p->dim_rate_move_in));
  SET_VECTOR_ELT(state, 843, ScalarInteger(main_model_p->dim_rate_move_in_1));
  SET_VECTOR_ELT(state, 844, ScalarInteger(main_model_p->dim_rate_move_in_2));
  SET_VECTOR_ELT(state, 845, allocVector(REALSXP, main_model_p->dim_rate_move_in));
  memcpy(REAL(VECTOR_ELT(state, 845)), main_model_p->rate_move_in, main_model_p->dim_rate_move_in * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 845), 2, main_model_p->dim_rate_move_in_1, main_model_p->dim_rate_move_in_2);
  SET_VECTOR_ELT(state, 846, ScalarInteger(main_model_p->offset_output_rate_move_in));
  SET_VECTOR_ELT(state, 847, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_VECTOR_ELT(state, 848, allocVector(REALSXP, main_model_p->dim_rate_move_out));
  memcpy(REAL(VECTOR_ELT(state, 848)), main_model_p->rate_move_out, main_model_p->dim_rate_move_out * sizeof(double));
  SET_VECTOR_ELT(state, 849, ScalarInteger(main_model_p->offset_output_rate_move_out));
  SET_VECTOR_ELT(state, 850, ScalarInteger(main_model_p->dim_rate_move_out_PrEP));
  SET_VECTOR_ELT(state, 851, allocVector(REALSXP, main_model_p->dim_rate_move_out_PrEP));
  memcpy(REAL(VECTOR_ELT(state, 851)), main_model_p->rate_move_out_PrEP, main_model_p->dim_rate_move_out_PrEP * sizeof(double));
  SET_VECTOR_ELT(state, 852, ScalarInteger(main_model_p->offset_output_rate_move_out_PrEP));
  ...
  SET_STRING_ELT(state_names, 517, mkChar("dim_cumuTested_approx"));
  SET_STRING_ELT(state_names, 518, mkChar("initial_cumuTested_approx"));
  SET_STRING_ELT(state_names, 519, mkChar("offset_cumuTested_approx"));
  SET_STRING_ELT(state_names, 520, mkChar("dim_dropouts"));
  SET_STRING_ELT(state_names, 521, mkChar("initial_dropouts"));
  SET_STRING_ELT(state_names, 522, mkChar("offset_dropouts"));
  SET_STRING_ELT(state_names, 523, mkChar("dim_cumuAllDeaths"));
  SET_STRING_ELT(state_names, 524, mkChar("initial_cumuAllDeaths"));
  SET_STRING_ELT(state_names, 525, mkChar("offset_cumuAllDeaths"));
  SET_STRING_ELT(state_names, 526, mkChar("dim_cumuInf"));
  SET_STRING_ELT(state_names, 527, mkChar("initial_cumuInf"));
  SET_STRING_ELT(state_names, 528, mkChar("offset_cumuInf"));
  SET_STRING_ELT(state_names, 529, mkChar("dim_PrEPinitiations"));
  SET_STRING_ELT(state_names, 530, mkChar("initial_PrEPinitiations"));
  SET_STRING_ELT(state_names, 531, mkChar("offset_PrEPinitiations"));
  SET_STRING_ELT(state_names, 532, mkChar("dim_PrEPinitiations1a"));
  SET_STRING_ELT(state_names, 533, mkChar("initial_PrEPinitiations1a"));
  SET_STRING_ELT(state_names, 534, mkChar("offset_PrEPinitiations1a"));
  SET_STRING_ELT(state_names, 535, mkChar("dim_PrEPinitiations1b"));
  SET_STRING_ELT(state_names, 536, mkChar("initial_PrEPinitiations1b"));
  SET_STRING_ELT(state_names, 537, mkChar("offset_PrEPinitiations1b"));
  SET_STRING_ELT(state_names, 538, mkChar("dim_PrEPinitiations1c"));
  SET_STRING_ELT(state_names, 539, mkChar("initial_PrEPinitiations1c"));
  SET_STRING_ELT(state_names, 540, mkChar("offset_PrEPinitiations1c"));
  SET_STRING_ELT(state_names, 541, mkChar("dim_S0"));
  SET_STRING_ELT(state_names, 542, mkChar("initial_S0"));
  SET_STRING_ELT(state_names, 543, mkChar("offset_S0"));
  SET_STRING_ELT(state_names, 544, mkChar("dim_S1a"));
  SET_STRING_ELT(state_names, 545, mkChar("initial_S1a"));
  SET_STRING_ELT(state_names, 546, mkChar("offset_S1a"));
  SET_STRING_ELT(state_names, 547, mkChar("dim_S1b"));
  SET_STRING_ELT(state_names, 548, mkChar("initial_S1b"));
  SET_STRING_ELT(state_names, 549, mkChar("offset_S1b"));
  SET_STRING_ELT(state_names, 550, mkChar("dim_S1c"));
  SET_STRING_ELT(state_names, 551, mkChar("initial_S1c"));
  SET_STRING_ELT(state_names, 552, mkChar("offset_S1c"));
  SET_STRING_ELT(state_names, 553, mkChar("dim_S1d"));
  SET_STRING_ELT(state_names, 554, mkChar("initial_S1d"));
  SET_STRING_ELT(state_names, 555, mkChar("offset_S1d"));
  SET_STRING_ELT(state_names, 556, mkChar("dim_I01"));
  SET_STRING_ELT(state_names, 557, mkChar("initial_I01"));
  SET_STRING_ELT(state_names, 558, mkChar("offset_I01"));
  SET_STRING_ELT(state_names, 559, mkChar("dim_I11"));
  SET_STRING_ELT(state_names, 560, mkChar("initial_I11"));
  SET_STRING_ELT(state_names, 561, mkChar("offset_I11"));
  SET_STRING_ELT(state_names, 562, mkChar("dim_I02"));
  SET_STRING_ELT(state_names, 563, mkChar("initial_I02"));
  SET_STRING_ELT(state_names, 564, mkChar("offset_I02"));
  SET_STRING_ELT(state_names, 565, mkChar("dim_I03"));
  SET_STRING_ELT(state_names, 566, mkChar("initial_I03"));
  SET_STRING_ELT(state_names, 567, mkChar("offset_I03"));
  SET_STRING_ELT(state_names, 568, mkChar("dim_I04"));
  SET_STRING_ELT(state_names, 569, mkChar("initial_I04"));
  SET_STRING_ELT(state_names, 570, mkChar("offset_I04"));
  SET_STRING_ELT(state_names, 571, mkChar("dim_I05"));
  SET_STRING_ELT(state_names, 572, mkChar("initial_I05"));
  SET_STRING_ELT(state_names, 573, mkChar("offset_I05"));
  SET_STRING_ELT(state_names, 574, mkChar("dim_I22"));
  SET_STRING_ELT(state_names, 575, mkChar("initial_I22"));
  SET_STRING_ELT(state_names, 576, mkChar("offset_I22"));
  SET_STRING_ELT(state_names, 577, mkChar("dim_I23"));
  SET_STRING_ELT(state_names, 578, mkChar("initial_I23"));
  SET_STRING_ELT(state_names, 579, mkChar("offset_I23"));
  SET_STRING_ELT(state_names, 580, mkChar("dim_I24"));
  SET_STRING_ELT(state_names, 581, mkChar("initial_I24"));
  SET_STRING_ELT(state_names, 582, mkChar("offset_I24"));
  SET_STRING_ELT(state_names, 583, mkChar("dim_I25"));
  SET_STRING_ELT(state_names, 584, mkChar("initial_I25"));
  SET_STRING_ELT(state_names, 585, mkChar("offset_I25"));
  SET_STRING_ELT(state_names, 586, mkChar("dim_I32"));
  SET_STRING_ELT(state_names, 587, mkChar("initial_I32"));
  SET_STRING_ELT(state_names, 588, mkChar("offset_I32"));
  SET_STRING_ELT(state_names, 589, mkChar("dim_I33"));
  SET_STRING_ELT(state_names, 590, mkChar("initial_I33"));
  SET_STRING_ELT(state_names, 591, mkChar("offset_I33"));
  SET_STRING_ELT(state_names, 592, mkChar("dim_I34"));
  SET_STRING_ELT(state_names, 593, mkChar("initial_I34"));
  SET_STRING_ELT(state_names, 594, mkChar("offset_I34"));
  SET_STRING_ELT(state_names, 595, mkChar("dim_I35"));
  SET_STRING_ELT(state_names, 596, mkChar("initial_I35"));
  SET_STRING_ELT(state_names, 597, mkChar("offset_I35"));
  SET_STRING_ELT(state_names, 598, mkChar("dim_I42"));
  SET_STRING_ELT(state_names, 599, mkChar("initial_I42"));
  SET_STRING_ELT(state_names, 600, mkChar("offset_I42"));
  SET_STRING_ELT(state_names, 601, mkChar("dim_I43"));
  SET_STRING_ELT(state_names, 602, mkChar("initial_I43"));
  SET_STRING_ELT(state_names, 603, mkChar("offset_I43"));
  SET_STRING_ELT(state_names, 604, mkChar("dim_I44"));
  SET_STRING_ELT(state_names, 605, mkChar("initial_I44"));
  SET_STRING_ELT(state_names, 606, mkChar("offset_I44"));
  SET_STRING_ELT(state_names, 607, mkChar("dim_I45"));
  SET_STRING_ELT(state_names, 608, mkChar("initial_I45"));
  SET_STRING_ELT(state_names, 609, mkChar("offset_I45"));
  SET_STRING_ELT(state_names, 610, mkChar("dim_S0_init"));
  SET_STRING_ELT(state_names, 611, mkChar("S0_init"));
  SET_STRING_ELT(state_names, 612, mkChar("dim_S1a_init"));
  SET_STRING_ELT(state_names, 613, mkChar("S1a_init"));
  SET_STRING_ELT(state_names, 614, mkChar("dim_S1b_init"));
  SET_STRING_ELT(state_names, 615, mkChar("S1b_init"));
  SET_STRING_ELT(state_names, 616, mkChar("dim_S1c_init"));
  SET_STRING_ELT(state_names, 617, mkChar("S1c_init"));
  SET_STRING_ELT(state_names, 618, mkChar("dim_S1d_init"));
  SET_STRING_ELT(state_names, 619, mkChar("S1d_init"));
  SET_STRING_ELT(state_names, 620, mkChar("dim_I01_init"));
  SET_STRING_ELT(state_names, 621, mkChar("I01_init"));
  SET_STRING_ELT(state_names, 622, mkChar("dim_I11_init"));
  SET_STRING_ELT(state_names, 623, mkChar("I11_init"));
  SET_STRING_ELT(state_names, 624, mkChar("dim_I02_init"));
  SET_STRING_ELT(state_names, 625, mkChar("I02_init"));
  SET_STRING_ELT(state_names, 626, mkChar("dim_I03_init"));
  SET_STRING_ELT(state_names, 627, mkChar("I03_init"));
  SET_STRING_ELT(state_names, 628, mkChar("dim_I04_init"));
  SET_STRING_ELT(state_names, 629, mkChar("I04_init"));
  SET_STRING_ELT(state_names, 630, mkChar("dim_I05_init"));
  SET_STRING_ELT(state_names, 631, mkChar("I05_init"));
  SET_STRING_ELT(state_names, 632, mkChar("dim_I22_init"));
  SET_STRING_ELT(state_names, 633, mkChar("I22_init"));
  SET_STRING_ELT(state_names, 634, mkChar("dim_I23_init"));
  SET_STRING_ELT(state_names, 635, mkChar("I23_init"));
  SET_STRING_ELT(state_names, 636, mkChar("dim_I24_init"));
  SET_STRING_ELT(state_names, 637, mkChar("I24_init"));
  SET_STRING_ELT(state_names, 638, mkChar("dim_I25_init"));
  SET_STRING_ELT(state_names, 639, mkChar("I25_init"));
  SET_STRING_ELT(state_names, 640, mkChar("dim_I32_init"));
  SET_STRING_ELT(state_names, 641, mkChar("I32_init"));
  SET_STRING_ELT(state_names, 642, mkChar("dim_I33_init"));
  SET_STRING_ELT(state_names, 643, mkChar("I33_init"));
  SET_STRING_ELT(state_names, 644, mkChar("dim_I34_init"));
  SET_STRING_ELT(state_names, 645, mkChar("I34_init"));
  SET_STRING_ELT(state_names, 646, mkChar("dim_I35_init"));
  SET_STRING_ELT(state_names, 647, mkChar("I35_init"));
  SET_STRING_ELT(state_names, 648, mkChar("dim_I42_init"));
  SET_STRING_ELT(state_names, 649, mkChar("I42_init"));
  SET_STRING_ELT(state_names, 650, mkChar("dim_I43_init"));
  SET_STRING_ELT(state_names, 651, mkChar("I43_init"));
  SET_STRING_ELT(state_names, 652, mkChar("dim_I44_init"));
  SET_STRING_ELT(state_names, 653, mkChar("I44_init"));
  SET_STRING_ELT(state_names, 654, mkChar("dim_I45_init"));
  SET_STRING_ELT(state_names, 655, mkChar("I45_init"));
  SET_STRING_ELT(state_names, 656, mkChar("dim_N"));
  SET_STRING_ELT(state_names, 657, mkChar("N"));
  SET_STRING_ELT(state_names, 658, mkChar("offset_output_N"));
  SET_STRING_ELT(state_names, 659, mkChar("dim_E0"));
  SET_STRING_ELT(state_names, 660, mkChar("E0"));
  SET_STRING_ELT(state_names, 661, mkChar("offset_output_E0"));
  SET_STRING_ELT(state_names, 662, mkChar("dim_E1a"));
  SET_STRING_ELT(state_names, 663, mkChar("E1a"));
  SET_STRING_ELT(state_names, 664, mkChar("offset_output_E1a"));
  SET_STRING_ELT(state_names, 665, mkChar("dim_E1b"));
  SET_STRING_ELT(state_names, 666, mkChar("E1b"));
  SET_STRING_ELT(state_names, 667, mkChar("offset_output_E1b"));
  SET_STRING_ELT(state_names, 668, mkChar("dim_E1c"));
  SET_STRING_ELT(state_names, 669, mkChar("E1c"));
  SET_STRING_ELT(state_names, 670, mkChar("offset_output_E1c"));
  SET_STRING_ELT(state_names, 671, mkChar("dim_E1d"));
  SET_STRING_ELT(state_names, 672, mkChar("E1d"));
  SET_STRING_ELT(state_names, 673, mkChar("offset_output_E1d"));
  SET_STRING_ELT(state_names, 674, mkChar("dim_cumuInf_init"));
  SET_STRING_ELT(state_names, 675, mkChar("cumuInf_init"));
  SET_STRING_ELT(state_names, 676, mkChar("dim_alphaItot"));
  SET_STRING_ELT(state_names, 677, mkChar("alphaItot"));
  SET_STRING_ELT(state_names, 678, mkChar("offset_output_alphaItot"));
  SET_STRING_ELT(state_names, 679, mkChar("dim_prev"));
  SET_STRING_ELT(state_names, 680, mkChar("prev"));
  SET_STRING_ELT(state_names, 681, mkChar("offset_output_prev"));
  SET_STRING_ELT(state_names, 682, mkChar("dim_lambda"));
  SET_STRING_ELT(state_names, 683, mkChar("dim_lambda_1"));
  SET_STRING_ELT(state_names, 684, mkChar("dim_lambda_2"));
  SET_STRING_ELT(state_names, 685, mkChar("lambda"));
  SET_STRING_ELT(state_names, 686, mkChar("offset_output_lambda"));
  SET_STRING_ELT(state_names, 687, mkChar("dim_lambda_0"));
  SET_STRING_ELT(state_names, 688, mkChar("dim_lambda_0_1"));
  SET_STRING_ELT(state_names, 689, mkChar("dim_lambda_0_2"));
  SET_STRING_ELT(state_names, 690, mkChar("lambda_0"));
  SET_STRING_ELT(state_names, 691, mkChar("offset_output_lambda_0"));
  SET_STRING_ELT(state_names, 692, mkChar("dim_lambda_1a"));
  SET_STRING_ELT(state_names, 693, mkChar("dim_lambda_1a_1"));
  SET_STRING_ELT(state_names, 694, mkChar("dim_lambda_1a_2"));
  SET_STRING_ELT(state_names, 695, mkChar("lambda_1a"));
  SET_STRING_ELT(state_names, 696, mkChar("offset_output_lambda_1a"));
  SET_STRING_ELT(state_names, 697, mkChar("dim_lambda_1b"));
  SET_STRING_ELT(state_names, 698, mkChar("dim_lambda_1b_1"));
  SET_STRING_ELT(state_names, 699, mkChar("dim_lambda_1b_2"));
  SET_STRING_ELT(state_names, 700, mkChar("lambda_1b"));
  SET_STRING_ELT(state_names, 701, mkChar("offset_output_lambda_1b"));
  SET_STRING_ELT(state_names, 702, mkChar("dim_lambda_1c"));
  SET_STRING_ELT(state_names, 703, mkChar("dim_lambda_1c_1"));
  SET_STRING_ELT(state_names, 704, mkChar("dim_lambda_1c_2"));
  SET_STRING_ELT(state_names, 705, mkChar("lambda_1c"));
  SET_STRING_ELT(state_names, 706, mkChar("offset_output_lambda_1c"));
  SET_STRING_ELT(state_names, 707, mkChar("dim_lambda_1d"));
  SET_STRING_ELT(state_names, 708, mkChar("dim_lambda_1d_1"));
  SET_STRING_ELT(state_names, 709, mkChar("dim_lambda_1d_2"));
  SET_STRING_ELT(state_names, 710, mkChar("lambda_1d"));
  SET_STRING_ELT(state_names, 711, mkChar("offset_output_lambda_1d"));
  SET_STRING_ELT(state_names, 712, mkChar("dim_lambda_sum_0"));
  SET_STRING_ELT(state_names, 713, mkChar("lambda_sum_0"));
  SET_STRING_ELT(state_names, 714, mkChar("offset_output_lambda_sum_0"));
  SET_STRING_ELT(state_names, 715, mkChar("dim_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 716, mkChar("lambda_sum_1a"));
  SET_STRING_ELT(state_names, 717, mkChar("offset_output_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 718, mkChar("dim_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 719, mkChar("lambda_sum_1b"));
  SET_STRING_ELT(state_names, 720, mkChar("offset_output_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 721, mkChar("dim_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 722, mkChar("lambda_sum_1c"));
  SET_STRING_ELT(state_names, 723, mkChar("offset_output_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 724, mkChar("dim_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 725, mkChar("lambda_sum_1d"));
  SET_STRING_ELT(state_names, 726, mkChar("offset_output_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 727, mkChar("dim_c_comm_balanced"));
  SET_STRING_ELT(state_names, 728, mkChar("c_comm_balanced"));
  SET_STRING_ELT(state_names, 729, mkChar("offset_output_c_comm_balanced"));
  SET_STRING_ELT(state_names, 730, mkChar("dim_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 731, mkChar("c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 732, mkChar("offset_output_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 733, mkChar("dim_theta"));
  SET_STRING_ELT(state_names, 734, mkChar("dim_theta_1"));
  SET_STRING_ELT(state_names, 735, mkChar("dim_theta_2"));
  SET_STRING_ELT(state_names, 736, mkChar("theta"));
  SET_STRING_ELT(state_names, 737, mkChar("offset_output_theta"));
  SET_STRING_ELT(state_names, 738, mkChar("dim_PrEPinitiations_init"));
  SET_STRING_ELT(state_names, 739, mkChar("PrEPinitiations_init"));
  SET_STRING_ELT(state_names, 740, mkChar("dim_M_comm"));
  SET_STRING_ELT(state_names, 741, mkChar("dim_M_comm_1"));
  SET_STRING_ELT(state_names, 742, mkChar("dim_M_comm_2"));
  SET_STRING_ELT(state_names, 743, mkChar("M_comm"));
  SET_STRING_ELT(state_names, 744, mkChar("offset_output_M_comm"));
  SET_STRING_ELT(state_names, 745, mkChar("dim_M_noncomm"));
  SET_STRING_ELT(state_names, 746, mkChar("dim_M_noncomm_1"));
  SET_STRING_ELT(state_names, 747, mkChar("dim_M_noncomm_2"));
  SET_STRING_ELT(state_names, 748, mkChar("M_noncomm"));
  SET_STRING_ELT(state_names, 749, mkChar("offset_output_M_noncomm"));
  SET_STRING_ELT(state_names, 750, mkChar("dim_in_S0"));
  SET_STRING_ELT(state_names, 751, mkChar("dim_in_S0_1"));
  SET_STRING_ELT(state_names, 752, mkChar("dim_in_S0_2"));
  SET_STRING_ELT(state_names, 753, mkChar("in_S0"));
  SET_STRING_ELT(state_names, 754, mkChar("dim_in_S1a"));
  SET_STRING_ELT(state_names, 755, mkChar("dim_in_S1a_1"));
  SET_STRING_ELT(state_names, 756, mkChar("dim_in_S1a_2"));
  SET_STRING_ELT(state_names, 757, mkChar("in_S1a"));
  SET_STRING_ELT(state_names, 758, mkChar("dim_in_S1b"));
  SET_STRING_ELT(state_names, 759, mkChar("dim_in_S1b_1"));
  SET_STRING_ELT(state_names, 760, mkChar("dim_in_S1b_2"));
  SET_STRING_ELT(state_names, 761, mkChar("in_S1b"));
  SET_STRING_ELT(state_names, 762, mkChar("dim_in_S1c"));
  SET_STRING_ELT(state_names, 763, mkChar("dim_in_S1c_1"));
  SET_STRING_ELT(state_names, 764, mkChar("dim_in_S1c_2"));
  SET_STRING_ELT(state_names, 765, mkChar("in_S1c"));
  SET_STRING_ELT(state_names, 766, mkChar("dim_in_S1d"));
  SET_STRING_ELT(state_names, 767, mkChar("dim_in_S1d_1"));
  SET_STRING_ELT(state_names, 768, mkChar("dim_in_S1d_2"));
  SET_STRING_ELT(state_names, 769, mkChar("in_S1d"));
  SET_STRING_ELT(state_names, 770, mkChar("dim_in_I01"));
  SET_STRING_ELT(state_names, 771, mkChar("dim_in_I01_1"));
  SET_STRING_ELT(state_names, 772, mkChar("dim_in_I01_2"));
  SET_STRING_ELT(state_names, 773, mkChar("in_I01"));
  SET_STRING_ELT(state_names, 774, mkChar("dim_in_I11"));
  SET_STRING_ELT(state_names, 775, mkChar("dim_in_I11_1"));
  SET_STRING_ELT(state_names, 776, mkChar("dim_in_I11_2"));
  SET_STRING_ELT(state_names, 777, mkChar("in_I11"));
  SET_STRING_ELT(state_names, 778, mkChar("dim_in_I02"));
  SET_STRING_ELT(state_names, 779, mkChar("dim_in_I02_1"));
  SET_STRING_ELT(state_names, 780, mkChar("dim_in_I02_2"));
  SET_STRING_ELT(state_names, 781, mkChar("in_I02"));
  SET_STRING_ELT(state_names, 782, mkChar("dim_in_I03"));
  SET_STRING_ELT(state_names, 783, mkChar("dim_in_I03_1"));
  SET_STRING_ELT(state_names, 784, mkChar("dim_in_I03_2"));
  SET_STRING_ELT(state_names, 785, mkChar("in_I03"));
  SET_STRING_ELT(state_names, 786, mkChar("dim_in_I04"));
  SET_STRING_ELT(state_names, 787, mkChar("dim_in_I04_1"));
  SET_STRING_ELT(state_names, 788, mkChar("dim_in_I04_2"));
  SET_STRING_ELT(state_names, 789, mkChar("in_I04"));
  SET_STRING_ELT(state_names, 790, mkChar("dim_in_I05"));
  SET_STRING_ELT(state_names, 791, mkChar("dim_in_I05_1"));
  SET_STRING_ELT(state_names, 792, mkChar("dim_in_I05_2"));
  SET_STRING_ELT(state_names, 793, mkChar("in_I05"));
  SET_STRING_ELT(state_names, 794, mkChar("dim_in_I22"));
  SET_STRING_ELT(state_names, 795, mkChar("dim_in_I22_1"));
  SET_STRING_ELT(state_names, 796, mkChar("dim_in_I22_2"));
  SET_STRING_ELT(state_names, 797, mkChar("in_I22"));
  SET_STRING_ELT(state_names, 798, mkChar("dim_in_I23"));
  SET_STRING_ELT(state_names, 799, mkChar("dim_in_I23_1"));
  SET_STRING_ELT(state_names, 800, mkChar("dim_in_I23_2"));
  SET_STRING_ELT(state_names, 801, mkChar("in_I23"));
  SET_STRING_ELT(state_names, 802, mkChar("dim_in_I24"));
  SET_STRING_ELT(state_names, 803, mkChar("dim_in_I24_1"));
  SET_STRING_ELT(state_names, 804, mkChar("dim_in_I24_2"));
  SET_STRING_ELT(state_names, 805, mkChar("in_I24"));
  SET_STRING_ELT(state_names, 806, mkChar("dim_in_I25"));
  SET_STRING_ELT(state_names, 807, mkChar("dim_in_I25_1"));
  SET_STRING_ELT(state_names, 808, mkChar("dim_in_I25_2"));
  SET_STRING_ELT(state_names, 809, mkChar("in_I25"));
  SET_STRING_ELT(state_names, 810, mkChar("dim_in_I32"));
  SET_STRING_ELT(state_names, 811, mkChar("dim_in_I32_1"));
  SET_STRING_ELT(state_names, 812, mkChar("dim_in_I32_2"));
  SET_STRING_ELT(state_names, 813, mkChar("in_I32"));
  SET_STRING_ELT(state_names, 814, mkChar("dim_in_I33"));
  SET_STRING_ELT(state_names, 815, mkChar("dim_in_I33_1"));
  SET_STRING_ELT(state_names, 816, mkChar("dim_in_I33_2"));
  SET_STRING_ELT(state_names, 817, mkChar("in_I33"));
  SET_STRING_ELT(state_names, 818, mkChar("dim_in_I34"));
  SET_STRING_ELT(state_names, 819, mkChar("dim_in_I34_1"));
  SET_STRING_ELT(state_names, 820, mkChar("dim_in_I34_2"));
  SET_STRING_ELT(state_names, 821, mkChar("in_I34"));
  SET_STRING_ELT(state_names, 822, mkChar("dim_in_I35"));
  SET_STRING_ELT(state_names, 823, mkChar("dim_in_I35_1"));
  SET_STRING_ELT(state_names, 824, mkChar("dim_in_I35_2"));
  SET_STRING_ELT(state_names, 825, mkChar("in_I35"));
  SET_STRING_ELT(state_names, 826, mkChar("dim_in_I42"));
  SET_STRING_ELT(state_names, 827, mkChar("dim_in_I42_1"));
  SET_STRING_ELT(state_names, 828, mkChar("dim_in_I42_2"));
  SET_STRING_ELT(state_names, 829, mkChar("in_I42"));
  SET_STRING_ELT(state_names, 830, mkChar("dim_in_I43"));
  SET_STRING_ELT(state_names, 831, mkChar("dim_in_I43_1"));
  SET_STRING_ELT(state_names, 832, mkChar("dim_in_I43_2"));
  SET_STRING_ELT(state_names, 833, mkChar("in_I43"));
  SET_STRING_ELT(state_names, 834, mkChar("dim_in_I44"));
  SET_STRING_ELT(state_names, 835, mkChar("dim_in_I44_1"));
  SET_STRING_ELT(state_names, 836, mkChar("dim_in_I44_2"));
  SET_STRING_ELT(state_names, 837, mkChar("in_I44"));
  SET_STRING_ELT(state_names, 838, mkChar("dim_in_I45"));
  SET_STRING_ELT(state_names, 839, mkChar("dim_in_I45_1"));
  SET_STRING_ELT(state_names, 840, mkChar("dim_in_I45_2"));
  SET_STRING_ELT(state_names, 841, mkChar("in_I45"));
  SET_STRING_ELT(state_names, 842, mkChar("dim_rate_move_in"));
  SET_STRING_ELT(state_names, 843, mkChar("dim_rate_move_in_1"));
  SET_STRING_ELT(state_names, 844, mkChar("dim_rate_move_in_2"));
  SET_STRING_ELT(state_names, 845, mkChar("rate_move_in"));
  SET_STRING_ELT(state_names, 846, mkChar("offset_output_rate_move_in"));
  SET_STRING_ELT(state_names, 847, mkChar("dim_rate_move_out"));
  SET_STRING_ELT(state_names, 848, mkChar("rate_move_out"));
  SET_STRING_ELT(state_names, 849, mkChar("offset_output_rate_move_out"));
  SET_STRING_ELT(state_names, 850, mkChar("dim_rate_move_out_PrEP"));
  SET_STRING_ELT(state_names, 851, mkChar("rate_move_out_PrEP"));
  SET_STRING_ELT(state_names, 852, mkChar("offset_output_rate_move_out_PrEP"));
  SET_STRING_ELT(state_names, 853, mkChar("interpolate_pfFSW"));
  SET_STRING_ELT(state_names, 854, mkChar("interpolate_c_comm"));
  SET_STRING_ELT(state_names, 855, mkChar("interpolate_c_noncomm"));
  SET_STRING_ELT(state_names, 856, mkChar("interpolate_ART_eligible_CD4_above_500"));
  SET_STRING_ELT(state_names, 857, mkChar("interpolate_ART_eligible_CD4_350_500"));
  SET_STRING_ELT(state_names, 858, mkChar("interpolate_ART_eligible_CD4_200_349"));
  SET_STRING_ELT(state_names, 859, mkChar("interpolate_ART_eligible_CD4_below_200"));
  SET_STRING_ELT(state_names, 860, mkChar("interpolate_testing_prob"));
  SET_STRING_ELT(state_names, 861, mkChar("interpolate_tau_intervention"));
  SET_STRING_ELT(state_names, 862, mkChar("interpolate_rho_intervention"));
  SET_STRING_ELT(state_names, 863, mkChar("interpolate_prep_efficacious"));
  SET_STRING_ELT(state_names, 864, mkChar("interpolate_viral_supp"));
  SET_STRING_ELT(state_names, 865, mkChar("interpolate_infect_ART"));
  SET_STRING_ELT(state_names, 866, mkChar("interpolate_epsilon"));
