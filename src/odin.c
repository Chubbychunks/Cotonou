...
SEXP main_model_set_user(main_model_pars *main_model_p, SEXP user) {
  ...
  main_model_p->offset_output_infect_ART_y = 72;
  ...
  main_model_p->offset_output_infect_ART_t = 72 + main_model_p->dim_infect_ART_y;
...
void main_model_deriv(main_model_pars *main_model_p, double t, double *state, double *dstatedt, double *output) {
  ...
  double prop_FSW_I0_1 = I01[0] / (I01[0] + I02[0] + I03[0] + I04[0] + I05[0]);
  double prop_FSW_I0_2 = I02[0] / (I01[0] + I02[0] + I03[0] + I04[0] + I05[0]);
  double prop_FSW_I0_3 = I03[0] / (I01[0] + I02[0] + I03[0] + I04[0] + I05[0]);
  double prop_FSW_I0_4 = I04[0] / (I01[0] + I02[0] + I03[0] + I04[0] + I05[0]);
  double prop_FSW_I0_5 = I05[0] / (I01[0] + I02[0] + I03[0] + I04[0] + I05[0]);
  ...
  for (int i = 0; i < main_model_p->dim_E0; ++i) {
    main_model_p->E0[i] = (main_model_p->replaceDeaths == 1 ? main_model_p->mu[i] * main_model_p->N[i] + main_model_p->nu * main_model_p->N[i] + main_model_p->alphaItot[i] + main_model_p->epsilon * Ntot * main_model_p->omega[i] - S0[i] * main_model_p->zeta[i] : main_model_p->new_people_in_group[i] + main_model_p->new_people_in_group_FSW_only[i]);
  }
  ...
  if (output != NULL) {
    double *output_infect_ART_y = output + 72;
    ...
    output[0] = prop_FSW_I0_1;
    output[1] = prop_FSW_I0_2;
    output[2] = prop_FSW_I0_3;
    output[3] = prop_FSW_I0_4;
    output[4] = prop_FSW_I0_5;
    output[5] = main_model_p->testpar;
    ...
    output[6] = main_model_p->who_believe_comm;
    memcpy(output_above_500_by_group, main_model_p->above_500_by_group, main_model_p->dim_above_500_by_group * sizeof(double));
    output[7] = main_model_p->ART_eligible_CD4_above_500;
    output[8] = main_model_p->ART_eligible_CD4_350_500;
    output[9] = main_model_p->ART_eligible_CD4_200_349;
    output[10] = main_model_p->ART_eligible_CD4_below_200;
    ...
    output[11] = main_model_p->TasP_testing;
    ...
    output[12] = main_model_p->PrEPOnOff;
    output[13] = main_model_p->fPa;
    output[14] = main_model_p->fPb;
    output[15] = main_model_p->fPc;
    ...
    output[16] = main_model_p->W0;
    output[17] = main_model_p->W1;
    output[18] = main_model_p->W2;
    output[19] = main_model_p->W3;
    output[20] = main_model_p->cost_Initiation_of_ART_study_FSW;
    output[21] = main_model_p->cost_Initiation_of_ART_government_FSW;
    output[22] = main_model_p->cost_1_year_of_ART_study_FSW;
    output[23] = main_model_p->cost_1_year_of_ART_government_FSW;
    output[24] = main_model_p->cost_Initiation_ART_rest_of_population;
    output[25] = main_model_p->cost_1_year_of_ART_rest_of_population;
    output[26] = main_model_p->cost_FSW_initiation_ART_Patient_costs;
    output[27] = main_model_p->cost_FSW_1_year_ART_Patient_costs;
    output[28] = main_model_p->cost_Initiation_of_PrEP_study;
    output[29] = main_model_p->cost_1_year_PrEP_perfect_adherence_study;
    output[30] = main_model_p->cost_1_year_PrEP_intermediate_adherence_study;
    output[31] = main_model_p->cost_1_year_PrEP_non_adherence_study;
    output[32] = main_model_p->cost_Initiation_of_PrEP_government;
    output[33] = main_model_p->cost_1_year_PrEP_perfect_adherence_government;
    output[34] = main_model_p->cost_1_year_PrEP_intermediate_adherence_government;
    output[35] = main_model_p->cost_1_year_PrEP_non_adherence_government;
    output[36] = main_model_p->cost_PREP_initiation_Patient_costs;
    output[37] = main_model_p->cost_PREP_1_year_ART_Patient_costs;
    double cumuInftot = odin_sum1(cumuInf, 0, main_model_p->dim_cumuInf - 1);
    output[38] = cumuInftot;
    ...
    output[43] = pc_susceptible_FSW_On_PrEP;
    output[44] = pc_all_FSW_On_PrEP;
    double FSW_On_PrEP_all_cats = S1a[0] + S1b[0] + S1c[0];
    output[45] = FSW_On_PrEP_all_cats;
    output[46] = Men_on_ART;
    output[47] = Women_on_ART;
    output[48] = ART_coverage_men;
    output[49] = ART_coverage_women;
    output[50] = ART_coverage_FSW;
    output[51] = ART_coverage_all;
    output[52] = main_model_p->Ncat;
    ...
    output[53] = main_model_p->nu;
    output[54] = main_model_p->Nage;
    output[55] = main_model_p->dur_FSW;
    memcpy(output_infect_ART, main_model_p->infect_ART, main_model_p->dim_infect_ART * sizeof(double));
    output[56] = main_model_p->epsilon;
    ...
    output[57] = Ntot_inc_former_FSW_nonCot;
    double new_people = main_model_p->epsilon * Ntot;
    output[58] = new_people;
    ...
    output[61] = prev_men;
    output[62] = prev_women;
    output[63] = prev_cotonou;
    output[64] = Ntot;
    memcpy(output_N, main_model_p->N, main_model_p->dim_N * sizeof(double));
    output[65] = prev_FSW;
    output[66] = prev_client;
    ...
    output[69] = pc_of_FOI_on_clients_from_pro_FSW;
...
SEXP main_model_output_order(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  int *tmp;
  SEXP state_len = PROTECT(allocVector(VECSXP, 178));
  SEXP state_names = PROTECT(allocVector(STRSXP, 178));
  SET_VECTOR_ELT(state_len, 0, R_NilValue);
  SET_STRING_ELT(state_names, 0, mkChar("prop_FSW_I0_1"));
  SET_VECTOR_ELT(state_len, 1, R_NilValue);
  SET_STRING_ELT(state_names, 1, mkChar("prop_FSW_I0_2"));
  SET_VECTOR_ELT(state_len, 2, R_NilValue);
  SET_STRING_ELT(state_names, 2, mkChar("prop_FSW_I0_3"));
  SET_VECTOR_ELT(state_len, 3, R_NilValue);
  SET_STRING_ELT(state_names, 3, mkChar("prop_FSW_I0_4"));
  SET_VECTOR_ELT(state_len, 4, R_NilValue);
  SET_STRING_ELT(state_names, 4, mkChar("prop_FSW_I0_5"));
  SET_VECTOR_ELT(state_len, 5, R_NilValue);
  SET_STRING_ELT(state_names, 5, mkChar("testpar"));
  SET_VECTOR_ELT(state_len, 6, R_NilValue);
  SET_STRING_ELT(state_names, 6, mkChar("who_believe_comm"));
  SET_VECTOR_ELT(state_len, 7, R_NilValue);
  SET_STRING_ELT(state_names, 7, mkChar("ART_eligible_CD4_above_500"));
  SET_VECTOR_ELT(state_len, 8, R_NilValue);
  SET_STRING_ELT(state_names, 8, mkChar("ART_eligible_CD4_350_500"));
  SET_VECTOR_ELT(state_len, 9, R_NilValue);
  SET_STRING_ELT(state_names, 9, mkChar("ART_eligible_CD4_200_349"));
  SET_VECTOR_ELT(state_len, 10, R_NilValue);
  SET_STRING_ELT(state_names, 10, mkChar("ART_eligible_CD4_below_200"));
  SET_VECTOR_ELT(state_len, 11, R_NilValue);
  SET_STRING_ELT(state_names, 11, mkChar("TasP_testing"));
  SET_VECTOR_ELT(state_len, 12, R_NilValue);
  SET_STRING_ELT(state_names, 12, mkChar("PrEPOnOff"));
  SET_VECTOR_ELT(state_len, 13, R_NilValue);
  SET_STRING_ELT(state_names, 13, mkChar("fPa"));
  SET_VECTOR_ELT(state_len, 14, R_NilValue);
  SET_STRING_ELT(state_names, 14, mkChar("fPb"));
  SET_VECTOR_ELT(state_len, 15, R_NilValue);
  SET_STRING_ELT(state_names, 15, mkChar("fPc"));
  SET_VECTOR_ELT(state_len, 16, R_NilValue);
  SET_STRING_ELT(state_names, 16, mkChar("W0"));
  SET_VECTOR_ELT(state_len, 17, R_NilValue);
  SET_STRING_ELT(state_names, 17, mkChar("W1"));
  SET_VECTOR_ELT(state_len, 18, R_NilValue);
  SET_STRING_ELT(state_names, 18, mkChar("W2"));
  SET_VECTOR_ELT(state_len, 19, R_NilValue);
  SET_STRING_ELT(state_names, 19, mkChar("W3"));
  SET_VECTOR_ELT(state_len, 20, R_NilValue);
  SET_STRING_ELT(state_names, 20, mkChar("cost_Initiation_of_ART_study_FSW"));
  SET_VECTOR_ELT(state_len, 21, R_NilValue);
  SET_STRING_ELT(state_names, 21, mkChar("cost_Initiation_of_ART_government_FSW"));
  SET_VECTOR_ELT(state_len, 22, R_NilValue);
  SET_STRING_ELT(state_names, 22, mkChar("cost_1_year_of_ART_study_FSW"));
  SET_VECTOR_ELT(state_len, 23, R_NilValue);
  SET_STRING_ELT(state_names, 23, mkChar("cost_1_year_of_ART_government_FSW"));
  SET_VECTOR_ELT(state_len, 24, R_NilValue);
  SET_STRING_ELT(state_names, 24, mkChar("cost_Initiation_ART_rest_of_population"));
  SET_VECTOR_ELT(state_len, 25, R_NilValue);
  SET_STRING_ELT(state_names, 25, mkChar("cost_1_year_of_ART_rest_of_population"));
  SET_VECTOR_ELT(state_len, 26, R_NilValue);
  SET_STRING_ELT(state_names, 26, mkChar("cost_FSW_initiation_ART_Patient_costs"));
  SET_VECTOR_ELT(state_len, 27, R_NilValue);
  SET_STRING_ELT(state_names, 27, mkChar("cost_FSW_1_year_ART_Patient_costs"));
  SET_VECTOR_ELT(state_len, 28, R_NilValue);
  SET_STRING_ELT(state_names, 28, mkChar("cost_Initiation_of_PrEP_study"));
  SET_VECTOR_ELT(state_len, 29, R_NilValue);
  SET_STRING_ELT(state_names, 29, mkChar("cost_1_year_PrEP_perfect_adherence_study"));
  SET_VECTOR_ELT(state_len, 30, R_NilValue);
  SET_STRING_ELT(state_names, 30, mkChar("cost_1_year_PrEP_intermediate_adherence_study"));
  SET_VECTOR_ELT(state_len, 31, R_NilValue);
  SET_STRING_ELT(state_names, 31, mkChar("cost_1_year_PrEP_non_adherence_study"));
  SET_VECTOR_ELT(state_len, 32, R_NilValue);
  SET_STRING_ELT(state_names, 32, mkChar("cost_Initiation_of_PrEP_government"));
  SET_VECTOR_ELT(state_len, 33, R_NilValue);
  SET_STRING_ELT(state_names, 33, mkChar("cost_1_year_PrEP_perfect_adherence_government"));
  SET_VECTOR_ELT(state_len, 34, R_NilValue);
  SET_STRING_ELT(state_names, 34, mkChar("cost_1_year_PrEP_intermediate_adherence_government"));
  SET_VECTOR_ELT(state_len, 35, R_NilValue);
  SET_STRING_ELT(state_names, 35, mkChar("cost_1_year_PrEP_non_adherence_government"));
  SET_VECTOR_ELT(state_len, 36, R_NilValue);
  SET_STRING_ELT(state_names, 36, mkChar("cost_PREP_initiation_Patient_costs"));
  SET_VECTOR_ELT(state_len, 37, R_NilValue);
  SET_STRING_ELT(state_names, 37, mkChar("cost_PREP_1_year_ART_Patient_costs"));
  SET_VECTOR_ELT(state_len, 38, R_NilValue);
  SET_STRING_ELT(state_names, 38, mkChar("cumuInftot"));
  SET_VECTOR_ELT(state_len, 39, R_NilValue);
  SET_STRING_ELT(state_names, 39, mkChar("ART_sex_ratio"));
  SET_VECTOR_ELT(state_len, 40, R_NilValue);
  SET_STRING_ELT(state_names, 40, mkChar("pc_S1a"));
  SET_VECTOR_ELT(state_len, 41, R_NilValue);
  SET_STRING_ELT(state_names, 41, mkChar("pc_S1b"));
  SET_VECTOR_ELT(state_len, 42, R_NilValue);
  SET_STRING_ELT(state_names, 42, mkChar("pc_S1c"));
  SET_VECTOR_ELT(state_len, 43, R_NilValue);
  SET_STRING_ELT(state_names, 43, mkChar("pc_susceptible_FSW_On_PrEP"));
  SET_VECTOR_ELT(state_len, 44, R_NilValue);
  SET_STRING_ELT(state_names, 44, mkChar("pc_all_FSW_On_PrEP"));
  SET_VECTOR_ELT(state_len, 45, R_NilValue);
  SET_STRING_ELT(state_names, 45, mkChar("FSW_On_PrEP_all_cats"));
  SET_VECTOR_ELT(state_len, 46, R_NilValue);
  SET_STRING_ELT(state_names, 46, mkChar("Men_on_ART"));
  SET_VECTOR_ELT(state_len, 47, R_NilValue);
  SET_STRING_ELT(state_names, 47, mkChar("Women_on_ART"));
  SET_VECTOR_ELT(state_len, 48, R_NilValue);
  SET_STRING_ELT(state_names, 48, mkChar("ART_coverage_men"));
  SET_VECTOR_ELT(state_len, 49, R_NilValue);
  SET_STRING_ELT(state_names, 49, mkChar("ART_coverage_women"));
  SET_VECTOR_ELT(state_len, 50, R_NilValue);
  SET_STRING_ELT(state_names, 50, mkChar("ART_coverage_FSW"));
  SET_VECTOR_ELT(state_len, 51, R_NilValue);
  SET_STRING_ELT(state_names, 51, mkChar("ART_coverage_all"));
  SET_VECTOR_ELT(state_len, 52, R_NilValue);
  SET_STRING_ELT(state_names, 52, mkChar("Ncat"));
  SET_VECTOR_ELT(state_len, 53, R_NilValue);
  SET_STRING_ELT(state_names, 53, mkChar("nu"));
  SET_VECTOR_ELT(state_len, 54, R_NilValue);
  SET_STRING_ELT(state_names, 54, mkChar("Nage"));
  SET_VECTOR_ELT(state_len, 55, R_NilValue);
  SET_STRING_ELT(state_names, 55, mkChar("dur_FSW"));
  SET_VECTOR_ELT(state_len, 56, R_NilValue);
  SET_STRING_ELT(state_names, 56, mkChar("epsilon"));
  SET_VECTOR_ELT(state_len, 57, R_NilValue);
  SET_STRING_ELT(state_names, 57, mkChar("Ntot_inc_former_FSW_nonCot"));
  SET_VECTOR_ELT(state_len, 58, R_NilValue);
  SET_STRING_ELT(state_names, 58, mkChar("new_people"));
  SET_VECTOR_ELT(state_len, 59, R_NilValue);
  SET_STRING_ELT(state_names, 59, mkChar("frac_virgin"));
  SET_VECTOR_ELT(state_len, 60, R_NilValue);
  SET_STRING_ELT(state_names, 60, mkChar("prev_LowFSW"));
  SET_VECTOR_ELT(state_len, 61, R_NilValue);
  SET_STRING_ELT(state_names, 61, mkChar("prev_men"));
  SET_VECTOR_ELT(state_len, 62, R_NilValue);
  SET_STRING_ELT(state_names, 62, mkChar("prev_women"));
  SET_VECTOR_ELT(state_len, 63, R_NilValue);
  SET_STRING_ELT(state_names, 63, mkChar("prev_cotonou"));
  SET_VECTOR_ELT(state_len, 64, R_NilValue);
  SET_STRING_ELT(state_names, 64, mkChar("Ntot"));
  SET_VECTOR_ELT(state_len, 65, R_NilValue);
  SET_STRING_ELT(state_names, 65, mkChar("prev_FSW"));
  SET_VECTOR_ELT(state_len, 66, R_NilValue);
  SET_STRING_ELT(state_names, 66, mkChar("prev_client"));
  SET_VECTOR_ELT(state_len, 67, R_NilValue);
  SET_STRING_ELT(state_names, 67, mkChar("B_check_comm"));
  SET_VECTOR_ELT(state_len, 68, R_NilValue);
  SET_STRING_ELT(state_names, 68, mkChar("B_check_noncomm"));
  SET_VECTOR_ELT(state_len, 69, R_NilValue);
  SET_STRING_ELT(state_names, 69, mkChar("pc_of_FOI_on_clients_from_pro_FSW"));
  SET_VECTOR_ELT(state_len, 70, R_NilValue);
  SET_STRING_ELT(state_names, 70, mkChar("FSW_in"));
  SET_VECTOR_ELT(state_len, 71, R_NilValue);
  SET_STRING_ELT(state_names, 71, mkChar("FSW_out"));
  SET_VECTOR_ELT(state_len, 72, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 72));
  tmp[0] = main_model_p->dim_infect_ART_y_1;
  tmp[1] = main_model_p->dim_infect_ART_y_2;
  SET_STRING_ELT(state_names, 72, mkChar("infect_ART_y"));
  SET_VECTOR_ELT(state_len, 73, ScalarInteger(main_model_p->dim_infect_ART_t));
  SET_STRING_ELT(state_names, 73, mkChar("infect_ART_t"));
  ...
  SET_STRING_ELT(state_names, 74, mkChar("viral_supp_y"));
  SET_VECTOR_ELT(state_len, 75, ScalarInteger(main_model_p->dim_viral_supp_t));
  SET_STRING_ELT(state_names, 75, mkChar("viral_supp_t"));
  SET_VECTOR_ELT(state_len, 76, ScalarInteger(main_model_p->dim_gamma32_without_supp));
  SET_STRING_ELT(state_names, 76, mkChar("gamma32_without_supp"));
  SET_VECTOR_ELT(state_len, 77, ScalarInteger(main_model_p->dim_gamma33_without_supp));
  SET_STRING_ELT(state_names, 77, mkChar("gamma33_without_supp"));
  SET_VECTOR_ELT(state_len, 78, ScalarInteger(main_model_p->dim_gamma34_without_supp));
  SET_STRING_ELT(state_names, 78, mkChar("gamma34_without_supp"));
  SET_VECTOR_ELT(state_len, 79, ScalarInteger(main_model_p->dim_alpha33_without_supp));
  SET_STRING_ELT(state_names, 79, mkChar("alpha33_without_supp"));
  SET_VECTOR_ELT(state_len, 80, ScalarInteger(main_model_p->dim_alpha34_without_supp));
  SET_STRING_ELT(state_names, 80, mkChar("alpha34_without_supp"));
  SET_VECTOR_ELT(state_len, 81, ScalarInteger(main_model_p->dim_alpha35_without_supp));
  SET_STRING_ELT(state_names, 81, mkChar("alpha35_without_supp"));
  SET_VECTOR_ELT(state_len, 82, ScalarInteger(main_model_p->dim_c_comm));
  SET_STRING_ELT(state_names, 82, mkChar("c_comm"));
  SET_VECTOR_ELT(state_len, 83, ScalarInteger(main_model_p->dim_c_noncomm));
  SET_STRING_ELT(state_names, 83, mkChar("c_noncomm"));
  SET_VECTOR_ELT(state_len, 84, ScalarInteger(main_model_p->dim_pfFSW));
  SET_STRING_ELT(state_names, 84, mkChar("pfFSW"));
  SET_VECTOR_ELT(state_len, 85, ScalarInteger(main_model_p->dim_new_acute_infected));
  SET_STRING_ELT(state_names, 85, mkChar("new_acute_infected"));
  SET_VECTOR_ELT(state_len, 86, ScalarInteger(main_model_p->dim_new_people_in_group));
  SET_STRING_ELT(state_names, 86, mkChar("new_people_in_group"));
  SET_VECTOR_ELT(state_len, 87, ScalarInteger(main_model_p->dim_new_people_in_group_FSW_only));
  SET_STRING_ELT(state_names, 87, mkChar("new_people_in_group_FSW_only"));
  SET_VECTOR_ELT(state_len, 88, ScalarInteger(main_model_p->dim_above_500_by_group));
  SET_STRING_ELT(state_names, 88, mkChar("above_500_by_group"));
  SET_VECTOR_ELT(state_len, 89, ScalarInteger(main_model_p->dim_testing_prob));
  SET_STRING_ELT(state_names, 89, mkChar("testing_prob"));
  SET_VECTOR_ELT(state_len, 90, ScalarInteger(main_model_p->dim_tau_intervention));
  SET_STRING_ELT(state_names, 90, mkChar("tau_intervention"));
  SET_VECTOR_ELT(state_len, 91, ScalarInteger(main_model_p->dim_rho_intervention));
  SET_STRING_ELT(state_names, 91, mkChar("rho_intervention"));
  SET_VECTOR_ELT(state_len, 92, ScalarInteger(main_model_p->dim_zeta));
  SET_STRING_ELT(state_names, 92, mkChar("zeta"));
  SET_VECTOR_ELT(state_len, 93, ScalarInteger(main_model_p->dim_eP1a_effective));
  SET_STRING_ELT(state_names, 93, mkChar("eP1a_effective"));
  SET_VECTOR_ELT(state_len, 94, ScalarInteger(main_model_p->dim_eP1b_effective));
  SET_STRING_ELT(state_names, 94, mkChar("eP1b_effective"));
  SET_VECTOR_ELT(state_len, 95, ScalarInteger(main_model_p->dim_eP1c_effective));
  SET_STRING_ELT(state_names, 95, mkChar("eP1c_effective"));
  SET_VECTOR_ELT(state_len, 96, ScalarInteger(main_model_p->dim_tau));
  SET_STRING_ELT(state_names, 96, mkChar("tau"));
  SET_VECTOR_ELT(state_len, 97, ScalarInteger(main_model_p->dim_rho));
  SET_STRING_ELT(state_names, 97, mkChar("rho"));
  SET_VECTOR_ELT(state_len, 98, ScalarInteger(main_model_p->dim_iota));
  SET_STRING_ELT(state_names, 98, mkChar("iota"));
  SET_VECTOR_ELT(state_len, 99, ScalarInteger(main_model_p->dim_viral_supp));
  SET_STRING_ELT(state_names, 99, mkChar("viral_supp"));
  SET_VECTOR_ELT(state_len, 100, ScalarInteger(main_model_p->dim_HIV_positive));
  SET_STRING_ELT(state_names, 100, mkChar("HIV_positive"));
  SET_VECTOR_ELT(state_len, 101, ScalarInteger(main_model_p->dim_Number_Susceptibles));
  SET_STRING_ELT(state_names, 101, mkChar("Number_Susceptibles"));
  SET_VECTOR_ELT(state_len, 102, ScalarInteger(main_model_p->dim_HIV_positive_Diagnosed_Off_ART));
  SET_STRING_ELT(state_names, 102, mkChar("HIV_positive_Diagnosed_Off_ART"));
  SET_VECTOR_ELT(state_len, 103, ScalarInteger(main_model_p->dim_Primary_Off_ART));
  SET_STRING_ELT(state_names, 103, mkChar("Primary_Off_ART"));
  SET_VECTOR_ELT(state_len, 104, ScalarInteger(main_model_p->dim_CD4_above_500_Off_ART));
  SET_STRING_ELT(state_names, 104, mkChar("CD4_above_500_Off_ART"));
  SET_VECTOR_ELT(state_len, 105, ScalarInteger(main_model_p->dim_CD4_350_500_Off_ART));
  SET_STRING_ELT(state_names, 105, mkChar("CD4_350_500_Off_ART"));
  SET_VECTOR_ELT(state_len, 106, ScalarInteger(main_model_p->dim_CD4_200_350_Off_ART));
  SET_STRING_ELT(state_names, 106, mkChar("CD4_200_350_Off_ART"));
  SET_VECTOR_ELT(state_len, 107, ScalarInteger(main_model_p->dim_CD4_below_200_Off_ART));
  SET_STRING_ELT(state_names, 107, mkChar("CD4_below_200_Off_ART"));
  SET_VECTOR_ELT(state_len, 108, ScalarInteger(main_model_p->dim_HIV_positive_On_ART));
  SET_STRING_ELT(state_names, 108, mkChar("HIV_positive_On_ART"));
  SET_VECTOR_ELT(state_len, 109, ScalarInteger(main_model_p->dim_Number_DALY_W1));
  SET_STRING_ELT(state_names, 109, mkChar("Number_DALY_W1"));
  SET_VECTOR_ELT(state_len, 110, ScalarInteger(main_model_p->dim_Number_DALY_W2));
  SET_STRING_ELT(state_names, 110, mkChar("Number_DALY_W2"));
  SET_VECTOR_ELT(state_len, 111, ScalarInteger(main_model_p->dim_Number_DALY_W3));
  SET_STRING_ELT(state_names, 111, mkChar("Number_DALY_W3"));
  SET_VECTOR_ELT(state_len, 112, ScalarInteger(main_model_p->dim_frac_F));
  SET_STRING_ELT(state_names, 112, mkChar("frac_F"));
  SET_VECTOR_ELT(state_len, 113, ScalarInteger(main_model_p->dim_frac_N_sexualpop));
  SET_STRING_ELT(state_names, 113, mkChar("frac_N_sexualpop"));
  SET_VECTOR_ELT(state_len, 114, ScalarInteger(main_model_p->dim_ART_coverage));
  SET_STRING_ELT(state_names, 114, mkChar("ART_coverage"));
  SET_VECTOR_ELT(state_len, 115, ScalarInteger(main_model_p->dim_infect_ART));
  SET_STRING_ELT(state_names, 115, mkChar("infect_ART"));
  SET_VECTOR_ELT(state_len, 116, ScalarInteger(main_model_p->dim_prep_offered));
  SET_STRING_ELT(state_names, 116, mkChar("prep_offered"));
  SET_VECTOR_ELT(state_len, 117, ScalarInteger(main_model_p->dim_omega));
  SET_STRING_ELT(state_names, 117, mkChar("omega"));
  SET_VECTOR_ELT(state_len, 118, ScalarInteger(main_model_p->dim_frac_N));
  SET_STRING_ELT(state_names, 118, mkChar("frac_N"));
  SET_VECTOR_ELT(state_len, 119, ScalarInteger(main_model_p->dim_mu));
  SET_STRING_ELT(state_names, 119, mkChar("mu"));
  SET_VECTOR_ELT(state_len, 120, ScalarInteger(main_model_p->dim_gamma01));
  SET_STRING_ELT(state_names, 120, mkChar("gamma01"));
  SET_VECTOR_ELT(state_len, 121, ScalarInteger(main_model_p->dim_gamma11));
  SET_STRING_ELT(state_names, 121, mkChar("gamma11"));
  SET_VECTOR_ELT(state_len, 122, ScalarInteger(main_model_p->dim_gamma32));
  SET_STRING_ELT(state_names, 122, mkChar("gamma32"));
  SET_VECTOR_ELT(state_len, 123, ScalarInteger(main_model_p->dim_gamma33));
  SET_STRING_ELT(state_names, 123, mkChar("gamma33"));
  SET_VECTOR_ELT(state_len, 124, ScalarInteger(main_model_p->dim_gamma34));
  SET_STRING_ELT(state_names, 124, mkChar("gamma34"));
  SET_VECTOR_ELT(state_len, 125, ScalarInteger(main_model_p->dim_kappaa));
  SET_STRING_ELT(state_names, 125, mkChar("kappaa"));
  SET_VECTOR_ELT(state_len, 126, ScalarInteger(main_model_p->dim_kappab));
  SET_STRING_ELT(state_names, 126, mkChar("kappab"));
  SET_VECTOR_ELT(state_len, 127, ScalarInteger(main_model_p->dim_kappac));
  SET_STRING_ELT(state_names, 127, mkChar("kappac"));
  SET_VECTOR_ELT(state_len, 128, ScalarInteger(main_model_p->dim_kappa1));
  SET_STRING_ELT(state_names, 128, mkChar("kappa1"));
  SET_VECTOR_ELT(state_len, 129, ScalarInteger(main_model_p->dim_alpha01));
  SET_STRING_ELT(state_names, 129, mkChar("alpha01"));
  SET_VECTOR_ELT(state_len, 130, ScalarInteger(main_model_p->dim_alpha02));
  SET_STRING_ELT(state_names, 130, mkChar("alpha02"));
  SET_VECTOR_ELT(state_len, 131, ScalarInteger(main_model_p->dim_alpha05));
  SET_STRING_ELT(state_names, 131, mkChar("alpha05"));
  SET_VECTOR_ELT(state_len, 132, ScalarInteger(main_model_p->dim_alpha11));
  SET_STRING_ELT(state_names, 132, mkChar("alpha11"));
  SET_VECTOR_ELT(state_len, 133, ScalarInteger(main_model_p->dim_alpha22));
  SET_STRING_ELT(state_names, 133, mkChar("alpha22"));
  SET_VECTOR_ELT(state_len, 134, ScalarInteger(main_model_p->dim_alpha33));
  SET_STRING_ELT(state_names, 134, mkChar("alpha33"));
  SET_VECTOR_ELT(state_len, 135, ScalarInteger(main_model_p->dim_alpha34));
  SET_STRING_ELT(state_names, 135, mkChar("alpha34"));
  SET_VECTOR_ELT(state_len, 136, ScalarInteger(main_model_p->dim_alpha35));
  SET_STRING_ELT(state_names, 136, mkChar("alpha35"));
  SET_VECTOR_ELT(state_len, 137, ScalarInteger(main_model_p->dim_beta_comm));
  SET_STRING_ELT(state_names, 137, mkChar("beta_comm"));
  SET_VECTOR_ELT(state_len, 138, ScalarInteger(main_model_p->dim_beta_noncomm));
  SET_STRING_ELT(state_names, 138, mkChar("beta_noncomm"));
  SET_VECTOR_ELT(state_len, 139, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 139));
  tmp[0] = main_model_p->dim_p_comm_1;
  tmp[1] = main_model_p->dim_p_comm_2;
  SET_STRING_ELT(state_names, 139, mkChar("p_comm"));
  SET_VECTOR_ELT(state_len, 140, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 140));
  tmp[0] = main_model_p->dim_p_noncomm_1;
  tmp[1] = main_model_p->dim_p_noncomm_2;
  SET_STRING_ELT(state_names, 140, mkChar("p_noncomm"));
  SET_VECTOR_ELT(state_len, 141, ScalarInteger(main_model_p->dim_eP0));
  SET_STRING_ELT(state_names, 141, mkChar("eP0"));
  SET_VECTOR_ELT(state_len, 142, ScalarInteger(main_model_p->dim_eP1a));
  SET_STRING_ELT(state_names, 142, mkChar("eP1a"));
  SET_VECTOR_ELT(state_len, 143, ScalarInteger(main_model_p->dim_eP1b));
  SET_STRING_ELT(state_names, 143, mkChar("eP1b"));
  SET_VECTOR_ELT(state_len, 144, ScalarInteger(main_model_p->dim_eP1c));
  SET_STRING_ELT(state_names, 144, mkChar("eP1c"));
  SET_VECTOR_ELT(state_len, 145, ScalarInteger(main_model_p->dim_eP1d));
  SET_STRING_ELT(state_names, 145, mkChar("eP1d"));
  ...
  SET_STRING_ELT(state_names, 146, mkChar("fc_comm"));
  SET_VECTOR_ELT(state_len, 147, ScalarInteger(main_model_p->dim_fP_comm));
  SET_STRING_ELT(state_names, 147, mkChar("fP_comm"));
  ...
  SET_STRING_ELT(state_names, 148, mkChar("fc_noncomm"));
  SET_VECTOR_ELT(state_len, 149, ScalarInteger(main_model_p->dim_fP_noncomm));
  SET_STRING_ELT(state_names, 149, mkChar("fP_noncomm"));
  ...
  SET_STRING_ELT(state_names, 150, mkChar("n_comm"));
  SET_VECTOR_ELT(state_len, 151, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 151));
  tmp[0] = main_model_p->dim_n_noncomm_1;
  tmp[1] = main_model_p->dim_n_noncomm_2;
  SET_STRING_ELT(state_names, 151, mkChar("n_noncomm"));
  SET_VECTOR_ELT(state_len, 152, ScalarInteger(main_model_p->dim_N));
  SET_STRING_ELT(state_names, 152, mkChar("N"));
  SET_VECTOR_ELT(state_len, 153, ScalarInteger(main_model_p->dim_E0));
  SET_STRING_ELT(state_names, 153, mkChar("E0"));
  SET_VECTOR_ELT(state_len, 154, ScalarInteger(main_model_p->dim_E1a));
  SET_STRING_ELT(state_names, 154, mkChar("E1a"));
  SET_VECTOR_ELT(state_len, 155, ScalarInteger(main_model_p->dim_E1b));
  SET_STRING_ELT(state_names, 155, mkChar("E1b"));
  SET_VECTOR_ELT(state_len, 156, ScalarInteger(main_model_p->dim_E1c));
  SET_STRING_ELT(state_names, 156, mkChar("E1c"));
  SET_VECTOR_ELT(state_len, 157, ScalarInteger(main_model_p->dim_E1d));
  SET_STRING_ELT(state_names, 157, mkChar("E1d"));
  SET_VECTOR_ELT(state_len, 158, ScalarInteger(main_model_p->dim_alphaItot));
  SET_STRING_ELT(state_names, 158, mkChar("alphaItot"));
  SET_VECTOR_ELT(state_len, 159, ScalarInteger(main_model_p->dim_prev));
  SET_STRING_ELT(state_names, 159, mkChar("prev"));
  ...
  SET_STRING_ELT(state_names, 160, mkChar("lambda"));
  SET_VECTOR_ELT(state_len, 161, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 161));
  tmp[0] = main_model_p->dim_lambda_0_1;
  tmp[1] = main_model_p->dim_lambda_0_2;
  SET_STRING_ELT(state_names, 161, mkChar("lambda_0"));
  ...
  SET_STRING_ELT(state_names, 162, mkChar("lambda_1a"));
  ...
  SET_STRING_ELT(state_names, 163, mkChar("lambda_1b"));
  ...
  SET_STRING_ELT(state_names, 164, mkChar("lambda_1c"));
  ...
  SET_STRING_ELT(state_names, 165, mkChar("lambda_1d"));
  SET_VECTOR_ELT(state_len, 166, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_STRING_ELT(state_names, 166, mkChar("lambda_sum_0"));
  SET_VECTOR_ELT(state_len, 167, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_STRING_ELT(state_names, 167, mkChar("lambda_sum_1a"));
  SET_VECTOR_ELT(state_len, 168, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_STRING_ELT(state_names, 168, mkChar("lambda_sum_1b"));
  SET_VECTOR_ELT(state_len, 169, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_STRING_ELT(state_names, 169, mkChar("lambda_sum_1c"));
  SET_VECTOR_ELT(state_len, 170, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_STRING_ELT(state_names, 170, mkChar("lambda_sum_1d"));
  SET_VECTOR_ELT(state_len, 171, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_STRING_ELT(state_names, 171, mkChar("c_comm_balanced"));
  SET_VECTOR_ELT(state_len, 172, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_STRING_ELT(state_names, 172, mkChar("c_noncomm_balanced"));
  ...
  SET_STRING_ELT(state_names, 173, mkChar("theta"));
  ...
  SET_STRING_ELT(state_names, 174, mkChar("M_comm"));
  ...
  SET_STRING_ELT(state_names, 175, mkChar("M_noncomm"));
  ...
  SET_STRING_ELT(state_names, 176, mkChar("rate_move_in"));
  SET_VECTOR_ELT(state_len, 177, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_STRING_ELT(state_names, 177, mkChar("rate_move_out"));
  setAttrib(state_len, R_NamesSymbol, state_names);
  UNPROTECT(2);
  return state_len;
}
