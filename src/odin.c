...
SEXP main_model_contents(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  SEXP state = PROTECT(allocVector(VECSXP, 803));
  ...
  SET_VECTOR_ELT(state, 234, ScalarInteger(main_model_p->dim_cumuARTinitiations_not_TasP));
  SET_VECTOR_ELT(state, 235, allocVector(REALSXP, main_model_p->dim_cumuARTinitiations_not_TasP));
  memcpy(REAL(VECTOR_ELT(state, 235)), main_model_p->initial_cumuARTinitiations_not_TasP, main_model_p->dim_cumuARTinitiations_not_TasP * sizeof(double));
  SET_VECTOR_ELT(state, 236, ScalarInteger(main_model_p->offset_cumuARTinitiations_not_TasP));
  SET_VECTOR_ELT(state, 237, ScalarInteger(main_model_p->dim_cumu_PrEP_dropouts));
  SET_VECTOR_ELT(state, 238, allocVector(REALSXP, main_model_p->dim_cumu_PrEP_dropouts));
  memcpy(REAL(VECTOR_ELT(state, 238)), main_model_p->initial_cumu_PrEP_dropouts, main_model_p->dim_cumu_PrEP_dropouts * sizeof(double));
  SET_VECTOR_ELT(state, 239, ScalarInteger(main_model_p->offset_cumu_PrEP_dropouts));
  SET_VECTOR_ELT(state, 240, ScalarInteger(main_model_p->dim_S0_infections));
  SET_VECTOR_ELT(state, 241, allocVector(REALSXP, main_model_p->dim_S0_infections));
  memcpy(REAL(VECTOR_ELT(state, 241)), main_model_p->initial_S0_infections, main_model_p->dim_S0_infections * sizeof(double));
  SET_VECTOR_ELT(state, 242, ScalarInteger(main_model_p->offset_S0_infections));
  SET_VECTOR_ELT(state, 243, ScalarInteger(main_model_p->dim_S1a_infections));
  SET_VECTOR_ELT(state, 244, allocVector(REALSXP, main_model_p->dim_S1a_infections));
  memcpy(REAL(VECTOR_ELT(state, 244)), main_model_p->initial_S1a_infections, main_model_p->dim_S1a_infections * sizeof(double));
  SET_VECTOR_ELT(state, 245, ScalarInteger(main_model_p->offset_S1a_infections));
  SET_VECTOR_ELT(state, 246, ScalarInteger(main_model_p->dim_S1b_infections));
  SET_VECTOR_ELT(state, 247, allocVector(REALSXP, main_model_p->dim_S1b_infections));
  memcpy(REAL(VECTOR_ELT(state, 247)), main_model_p->initial_S1b_infections, main_model_p->dim_S1b_infections * sizeof(double));
  SET_VECTOR_ELT(state, 248, ScalarInteger(main_model_p->offset_S1b_infections));
  SET_VECTOR_ELT(state, 249, ScalarInteger(main_model_p->dim_S1c_infections));
  SET_VECTOR_ELT(state, 250, allocVector(REALSXP, main_model_p->dim_S1c_infections));
  memcpy(REAL(VECTOR_ELT(state, 250)), main_model_p->initial_S1c_infections, main_model_p->dim_S1c_infections * sizeof(double));
  SET_VECTOR_ELT(state, 251, ScalarInteger(main_model_p->offset_S1c_infections));
  SET_VECTOR_ELT(state, 252, ScalarInteger(main_model_p->dim_S1d_infections));
  SET_VECTOR_ELT(state, 253, allocVector(REALSXP, main_model_p->dim_S1d_infections));
  memcpy(REAL(VECTOR_ELT(state, 253)), main_model_p->initial_S1d_infections, main_model_p->dim_S1d_infections * sizeof(double));
  SET_VECTOR_ELT(state, 254, ScalarInteger(main_model_p->offset_S1d_infections));
  SET_VECTOR_ELT(state, 255, ScalarInteger(main_model_p->dim_frac_F));
  SET_VECTOR_ELT(state, 256, allocVector(REALSXP, main_model_p->dim_frac_F));
  memcpy(REAL(VECTOR_ELT(state, 256)), main_model_p->frac_F, main_model_p->dim_frac_F * sizeof(double));
  SET_VECTOR_ELT(state, 257, ScalarInteger(main_model_p->offset_output_frac_F));
  SET_VECTOR_ELT(state, 258, ScalarInteger(main_model_p->dim_frac_N_sexualpop));
  SET_VECTOR_ELT(state, 259, allocVector(REALSXP, main_model_p->dim_frac_N_sexualpop));
  memcpy(REAL(VECTOR_ELT(state, 259)), main_model_p->frac_N_sexualpop, main_model_p->dim_frac_N_sexualpop * sizeof(double));
  SET_VECTOR_ELT(state, 260, ScalarInteger(main_model_p->offset_output_frac_N_sexualpop));
  SET_VECTOR_ELT(state, 261, ScalarInteger(main_model_p->dim_ART_coverage));
  SET_VECTOR_ELT(state, 262, allocVector(REALSXP, main_model_p->dim_ART_coverage));
  memcpy(REAL(VECTOR_ELT(state, 262)), main_model_p->ART_coverage, main_model_p->dim_ART_coverage * sizeof(double));
  SET_VECTOR_ELT(state, 263, ScalarInteger(main_model_p->offset_output_ART_coverage));
  SET_VECTOR_ELT(state, 264, ScalarInteger(main_model_p->dim_infect_ART));
  SET_VECTOR_ELT(state, 265, allocVector(REALSXP, main_model_p->dim_infect_ART));
  memcpy(REAL(VECTOR_ELT(state, 265)), main_model_p->infect_ART, main_model_p->dim_infect_ART * sizeof(double));
  SET_VECTOR_ELT(state, 266, ScalarInteger(main_model_p->offset_output_infect_ART));
  SET_VECTOR_ELT(state, 267, ScalarInteger(main_model_p->dim_prep_offered));
  SET_VECTOR_ELT(state, 268, allocVector(REALSXP, main_model_p->dim_prep_offered));
  memcpy(REAL(VECTOR_ELT(state, 268)), main_model_p->prep_offered, main_model_p->dim_prep_offered * sizeof(double));
  SET_VECTOR_ELT(state, 269, ScalarInteger(main_model_p->offset_output_prep_offered));
  SET_VECTOR_ELT(state, 270, ScalarInteger(main_model_p->dim_omega));
  SET_VECTOR_ELT(state, 271, allocVector(REALSXP, main_model_p->dim_omega));
  memcpy(REAL(VECTOR_ELT(state, 271)), main_model_p->omega, main_model_p->dim_omega * sizeof(double));
  SET_VECTOR_ELT(state, 272, ScalarInteger(main_model_p->offset_output_omega));
  SET_VECTOR_ELT(state, 273, ScalarInteger(main_model_p->dim_frac_N));
  SET_VECTOR_ELT(state, 274, allocVector(REALSXP, main_model_p->dim_frac_N));
  memcpy(REAL(VECTOR_ELT(state, 274)), main_model_p->frac_N, main_model_p->dim_frac_N * sizeof(double));
  SET_VECTOR_ELT(state, 275, ScalarInteger(main_model_p->offset_output_frac_N));
  SET_VECTOR_ELT(state, 276, ScalarInteger(main_model_p->dim_mu));
  SET_VECTOR_ELT(state, 277, allocVector(REALSXP, main_model_p->dim_mu));
  memcpy(REAL(VECTOR_ELT(state, 277)), main_model_p->mu, main_model_p->dim_mu * sizeof(double));
  SET_VECTOR_ELT(state, 278, ScalarInteger(main_model_p->offset_output_mu));
  SET_VECTOR_ELT(state, 279, ScalarInteger(main_model_p->dim_gamma01));
  SET_VECTOR_ELT(state, 280, allocVector(REALSXP, main_model_p->dim_gamma01));
  memcpy(REAL(VECTOR_ELT(state, 280)), main_model_p->gamma01, main_model_p->dim_gamma01 * sizeof(double));
  SET_VECTOR_ELT(state, 281, ScalarInteger(main_model_p->offset_output_gamma01));
  SET_VECTOR_ELT(state, 282, ScalarInteger(main_model_p->dim_gamma02));
  SET_VECTOR_ELT(state, 283, allocVector(REALSXP, main_model_p->dim_gamma02));
  memcpy(REAL(VECTOR_ELT(state, 283)), main_model_p->gamma02, main_model_p->dim_gamma02 * sizeof(double));
  SET_VECTOR_ELT(state, 284, ScalarInteger(main_model_p->dim_gamma03));
  SET_VECTOR_ELT(state, 285, allocVector(REALSXP, main_model_p->dim_gamma03));
  memcpy(REAL(VECTOR_ELT(state, 285)), main_model_p->gamma03, main_model_p->dim_gamma03 * sizeof(double));
  SET_VECTOR_ELT(state, 286, ScalarInteger(main_model_p->dim_gamma04));
  SET_VECTOR_ELT(state, 287, allocVector(REALSXP, main_model_p->dim_gamma04));
  memcpy(REAL(VECTOR_ELT(state, 287)), main_model_p->gamma04, main_model_p->dim_gamma04 * sizeof(double));
  SET_VECTOR_ELT(state, 288, ScalarInteger(main_model_p->dim_gamma11));
  SET_VECTOR_ELT(state, 289, allocVector(REALSXP, main_model_p->dim_gamma11));
  memcpy(REAL(VECTOR_ELT(state, 289)), main_model_p->gamma11, main_model_p->dim_gamma11 * sizeof(double));
  SET_VECTOR_ELT(state, 290, ScalarInteger(main_model_p->offset_output_gamma11));
  SET_VECTOR_ELT(state, 291, ScalarInteger(main_model_p->dim_gamma22));
  SET_VECTOR_ELT(state, 292, allocVector(REALSXP, main_model_p->dim_gamma22));
  memcpy(REAL(VECTOR_ELT(state, 292)), main_model_p->gamma22, main_model_p->dim_gamma22 * sizeof(double));
  SET_VECTOR_ELT(state, 293, ScalarInteger(main_model_p->dim_gamma23));
  SET_VECTOR_ELT(state, 294, allocVector(REALSXP, main_model_p->dim_gamma23));
  memcpy(REAL(VECTOR_ELT(state, 294)), main_model_p->gamma23, main_model_p->dim_gamma23 * sizeof(double));
  SET_VECTOR_ELT(state, 295, ScalarInteger(main_model_p->dim_gamma24));
  SET_VECTOR_ELT(state, 296, allocVector(REALSXP, main_model_p->dim_gamma24));
  memcpy(REAL(VECTOR_ELT(state, 296)), main_model_p->gamma24, main_model_p->dim_gamma24 * sizeof(double));
  SET_VECTOR_ELT(state, 297, ScalarInteger(main_model_p->dim_gamma32));
  SET_VECTOR_ELT(state, 298, allocVector(REALSXP, main_model_p->dim_gamma32));
  memcpy(REAL(VECTOR_ELT(state, 298)), main_model_p->gamma32, main_model_p->dim_gamma32 * sizeof(double));
  SET_VECTOR_ELT(state, 299, ScalarInteger(main_model_p->dim_gamma33));
  SET_VECTOR_ELT(state, 300, allocVector(REALSXP, main_model_p->dim_gamma33));
  memcpy(REAL(VECTOR_ELT(state, 300)), main_model_p->gamma33, main_model_p->dim_gamma33 * sizeof(double));
  SET_VECTOR_ELT(state, 301, ScalarInteger(main_model_p->dim_gamma34));
  SET_VECTOR_ELT(state, 302, allocVector(REALSXP, main_model_p->dim_gamma34));
  memcpy(REAL(VECTOR_ELT(state, 302)), main_model_p->gamma34, main_model_p->dim_gamma34 * sizeof(double));
  SET_VECTOR_ELT(state, 303, ScalarInteger(main_model_p->dim_gamma42));
  SET_VECTOR_ELT(state, 304, allocVector(REALSXP, main_model_p->dim_gamma42));
  memcpy(REAL(VECTOR_ELT(state, 304)), main_model_p->gamma42, main_model_p->dim_gamma42 * sizeof(double));
  SET_VECTOR_ELT(state, 305, ScalarInteger(main_model_p->dim_gamma43));
  SET_VECTOR_ELT(state, 306, allocVector(REALSXP, main_model_p->dim_gamma43));
  memcpy(REAL(VECTOR_ELT(state, 306)), main_model_p->gamma43, main_model_p->dim_gamma43 * sizeof(double));
  SET_VECTOR_ELT(state, 307, ScalarInteger(main_model_p->dim_gamma44));
  SET_VECTOR_ELT(state, 308, allocVector(REALSXP, main_model_p->dim_gamma44));
  memcpy(REAL(VECTOR_ELT(state, 308)), main_model_p->gamma44, main_model_p->dim_gamma44 * sizeof(double));
  SET_VECTOR_ELT(state, 309, ScalarInteger(main_model_p->dim_phi2));
  SET_VECTOR_ELT(state, 310, allocVector(REALSXP, main_model_p->dim_phi2));
  memcpy(REAL(VECTOR_ELT(state, 310)), main_model_p->phi2, main_model_p->dim_phi2 * sizeof(double));
  SET_VECTOR_ELT(state, 311, ScalarInteger(main_model_p->dim_phi3));
  SET_VECTOR_ELT(state, 312, allocVector(REALSXP, main_model_p->dim_phi3));
  memcpy(REAL(VECTOR_ELT(state, 312)), main_model_p->phi3, main_model_p->dim_phi3 * sizeof(double));
  SET_VECTOR_ELT(state, 313, ScalarInteger(main_model_p->dim_phi4));
  SET_VECTOR_ELT(state, 314, allocVector(REALSXP, main_model_p->dim_phi4));
  memcpy(REAL(VECTOR_ELT(state, 314)), main_model_p->phi4, main_model_p->dim_phi4 * sizeof(double));
  SET_VECTOR_ELT(state, 315, ScalarInteger(main_model_p->dim_phi5));
  SET_VECTOR_ELT(state, 316, allocVector(REALSXP, main_model_p->dim_phi5));
  memcpy(REAL(VECTOR_ELT(state, 316)), main_model_p->phi5, main_model_p->dim_phi5 * sizeof(double));
  SET_VECTOR_ELT(state, 317, ScalarInteger(main_model_p->dim_psia));
  SET_VECTOR_ELT(state, 318, allocVector(REALSXP, main_model_p->dim_psia));
  memcpy(REAL(VECTOR_ELT(state, 318)), main_model_p->psia, main_model_p->dim_psia * sizeof(double));
  SET_VECTOR_ELT(state, 319, ScalarInteger(main_model_p->dim_psib));
  SET_VECTOR_ELT(state, 320, allocVector(REALSXP, main_model_p->dim_psib));
  memcpy(REAL(VECTOR_ELT(state, 320)), main_model_p->psib, main_model_p->dim_psib * sizeof(double));
  SET_VECTOR_ELT(state, 321, ScalarInteger(main_model_p->dim_kappaa));
  SET_VECTOR_ELT(state, 322, allocVector(REALSXP, main_model_p->dim_kappaa));
  memcpy(REAL(VECTOR_ELT(state, 322)), main_model_p->kappaa, main_model_p->dim_kappaa * sizeof(double));
  SET_VECTOR_ELT(state, 323, ScalarInteger(main_model_p->offset_output_kappaa));
  SET_VECTOR_ELT(state, 324, ScalarInteger(main_model_p->dim_kappab));
  SET_VECTOR_ELT(state, 325, allocVector(REALSXP, main_model_p->dim_kappab));
  memcpy(REAL(VECTOR_ELT(state, 325)), main_model_p->kappab, main_model_p->dim_kappab * sizeof(double));
  SET_VECTOR_ELT(state, 326, ScalarInteger(main_model_p->offset_output_kappab));
  SET_VECTOR_ELT(state, 327, ScalarInteger(main_model_p->dim_kappac));
  SET_VECTOR_ELT(state, 328, allocVector(REALSXP, main_model_p->dim_kappac));
  memcpy(REAL(VECTOR_ELT(state, 328)), main_model_p->kappac, main_model_p->dim_kappac * sizeof(double));
  SET_VECTOR_ELT(state, 329, ScalarInteger(main_model_p->offset_output_kappac));
  SET_VECTOR_ELT(state, 330, ScalarInteger(main_model_p->dim_kappa1));
  SET_VECTOR_ELT(state, 331, allocVector(REALSXP, main_model_p->dim_kappa1));
  memcpy(REAL(VECTOR_ELT(state, 331)), main_model_p->kappa1, main_model_p->dim_kappa1 * sizeof(double));
  SET_VECTOR_ELT(state, 332, ScalarInteger(main_model_p->offset_output_kappa1));
  SET_VECTOR_ELT(state, 333, ScalarInteger(main_model_p->dim_alpha01));
  SET_VECTOR_ELT(state, 334, allocVector(REALSXP, main_model_p->dim_alpha01));
  memcpy(REAL(VECTOR_ELT(state, 334)), main_model_p->alpha01, main_model_p->dim_alpha01 * sizeof(double));
  SET_VECTOR_ELT(state, 335, ScalarInteger(main_model_p->offset_output_alpha01));
  SET_VECTOR_ELT(state, 336, ScalarInteger(main_model_p->dim_alpha02));
  SET_VECTOR_ELT(state, 337, allocVector(REALSXP, main_model_p->dim_alpha02));
  memcpy(REAL(VECTOR_ELT(state, 337)), main_model_p->alpha02, main_model_p->dim_alpha02 * sizeof(double));
  SET_VECTOR_ELT(state, 338, ScalarInteger(main_model_p->offset_output_alpha02));
  SET_VECTOR_ELT(state, 339, ScalarInteger(main_model_p->dim_alpha03));
  SET_VECTOR_ELT(state, 340, allocVector(REALSXP, main_model_p->dim_alpha03));
  memcpy(REAL(VECTOR_ELT(state, 340)), main_model_p->alpha03, main_model_p->dim_alpha03 * sizeof(double));
  SET_VECTOR_ELT(state, 341, ScalarInteger(main_model_p->dim_alpha04));
  SET_VECTOR_ELT(state, 342, allocVector(REALSXP, main_model_p->dim_alpha04));
  memcpy(REAL(VECTOR_ELT(state, 342)), main_model_p->alpha04, main_model_p->dim_alpha04 * sizeof(double));
  SET_VECTOR_ELT(state, 343, ScalarInteger(main_model_p->dim_alpha05));
  SET_VECTOR_ELT(state, 344, allocVector(REALSXP, main_model_p->dim_alpha05));
  memcpy(REAL(VECTOR_ELT(state, 344)), main_model_p->alpha05, main_model_p->dim_alpha05 * sizeof(double));
  SET_VECTOR_ELT(state, 345, ScalarInteger(main_model_p->offset_output_alpha05));
  SET_VECTOR_ELT(state, 346, ScalarInteger(main_model_p->dim_alpha11));
  SET_VECTOR_ELT(state, 347, allocVector(REALSXP, main_model_p->dim_alpha11));
  memcpy(REAL(VECTOR_ELT(state, 347)), main_model_p->alpha11, main_model_p->dim_alpha11 * sizeof(double));
  SET_VECTOR_ELT(state, 348, ScalarInteger(main_model_p->offset_output_alpha11));
  SET_VECTOR_ELT(state, 349, ScalarInteger(main_model_p->dim_alpha22));
  SET_VECTOR_ELT(state, 350, allocVector(REALSXP, main_model_p->dim_alpha22));
  memcpy(REAL(VECTOR_ELT(state, 350)), main_model_p->alpha22, main_model_p->dim_alpha22 * sizeof(double));
  SET_VECTOR_ELT(state, 351, ScalarInteger(main_model_p->offset_output_alpha22));
  SET_VECTOR_ELT(state, 352, ScalarInteger(main_model_p->dim_alpha23));
  SET_VECTOR_ELT(state, 353, allocVector(REALSXP, main_model_p->dim_alpha23));
  memcpy(REAL(VECTOR_ELT(state, 353)), main_model_p->alpha23, main_model_p->dim_alpha23 * sizeof(double));
  SET_VECTOR_ELT(state, 354, ScalarInteger(main_model_p->dim_alpha24));
  SET_VECTOR_ELT(state, 355, allocVector(REALSXP, main_model_p->dim_alpha24));
  memcpy(REAL(VECTOR_ELT(state, 355)), main_model_p->alpha24, main_model_p->dim_alpha24 * sizeof(double));
  SET_VECTOR_ELT(state, 356, ScalarInteger(main_model_p->dim_alpha25));
  SET_VECTOR_ELT(state, 357, allocVector(REALSXP, main_model_p->dim_alpha25));
  memcpy(REAL(VECTOR_ELT(state, 357)), main_model_p->alpha25, main_model_p->dim_alpha25 * sizeof(double));
  SET_VECTOR_ELT(state, 358, ScalarInteger(main_model_p->dim_alpha32));
  SET_VECTOR_ELT(state, 359, allocVector(REALSXP, main_model_p->dim_alpha32));
  memcpy(REAL(VECTOR_ELT(state, 359)), main_model_p->alpha32, main_model_p->dim_alpha32 * sizeof(double));
  SET_VECTOR_ELT(state, 360, ScalarInteger(main_model_p->dim_alpha33));
  SET_VECTOR_ELT(state, 361, allocVector(REALSXP, main_model_p->dim_alpha33));
  memcpy(REAL(VECTOR_ELT(state, 361)), main_model_p->alpha33, main_model_p->dim_alpha33 * sizeof(double));
  SET_VECTOR_ELT(state, 362, ScalarInteger(main_model_p->dim_alpha34));
  SET_VECTOR_ELT(state, 363, allocVector(REALSXP, main_model_p->dim_alpha34));
  memcpy(REAL(VECTOR_ELT(state, 363)), main_model_p->alpha34, main_model_p->dim_alpha34 * sizeof(double));
  SET_VECTOR_ELT(state, 364, ScalarInteger(main_model_p->dim_alpha35));
  SET_VECTOR_ELT(state, 365, allocVector(REALSXP, main_model_p->dim_alpha35));
  memcpy(REAL(VECTOR_ELT(state, 365)), main_model_p->alpha35, main_model_p->dim_alpha35 * sizeof(double));
  SET_VECTOR_ELT(state, 366, ScalarInteger(main_model_p->offset_output_alpha35));
  SET_VECTOR_ELT(state, 367, ScalarInteger(main_model_p->dim_alpha42));
  SET_VECTOR_ELT(state, 368, allocVector(REALSXP, main_model_p->dim_alpha42));
  memcpy(REAL(VECTOR_ELT(state, 368)), main_model_p->alpha42, main_model_p->dim_alpha42 * sizeof(double));
  SET_VECTOR_ELT(state, 369, ScalarInteger(main_model_p->dim_alpha43));
  SET_VECTOR_ELT(state, 370, allocVector(REALSXP, main_model_p->dim_alpha43));
  memcpy(REAL(VECTOR_ELT(state, 370)), main_model_p->alpha43, main_model_p->dim_alpha43 * sizeof(double));
  SET_VECTOR_ELT(state, 371, ScalarInteger(main_model_p->dim_alpha44));
  SET_VECTOR_ELT(state, 372, allocVector(REALSXP, main_model_p->dim_alpha44));
  memcpy(REAL(VECTOR_ELT(state, 372)), main_model_p->alpha44, main_model_p->dim_alpha44 * sizeof(double));
  SET_VECTOR_ELT(state, 373, ScalarInteger(main_model_p->dim_alpha45));
  SET_VECTOR_ELT(state, 374, allocVector(REALSXP, main_model_p->dim_alpha45));
  memcpy(REAL(VECTOR_ELT(state, 374)), main_model_p->alpha45, main_model_p->dim_alpha45 * sizeof(double));
  SET_VECTOR_ELT(state, 375, ScalarInteger(main_model_p->dim_beta_comm));
  SET_VECTOR_ELT(state, 376, allocVector(REALSXP, main_model_p->dim_beta_comm));
  memcpy(REAL(VECTOR_ELT(state, 376)), main_model_p->beta_comm, main_model_p->dim_beta_comm * sizeof(double));
  SET_VECTOR_ELT(state, 377, ScalarInteger(main_model_p->offset_output_beta_comm));
  SET_VECTOR_ELT(state, 378, ScalarInteger(main_model_p->dim_beta_noncomm));
  SET_VECTOR_ELT(state, 379, allocVector(REALSXP, main_model_p->dim_beta_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 379)), main_model_p->beta_noncomm, main_model_p->dim_beta_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 380, ScalarInteger(main_model_p->offset_output_beta_noncomm));
  SET_VECTOR_ELT(state, 381, ScalarInteger(main_model_p->dim_p_comm));
  SET_VECTOR_ELT(state, 382, ScalarInteger(main_model_p->dim_p_comm_1));
  SET_VECTOR_ELT(state, 383, ScalarInteger(main_model_p->dim_p_comm_2));
  SET_VECTOR_ELT(state, 384, allocVector(REALSXP, main_model_p->dim_p_comm));
  memcpy(REAL(VECTOR_ELT(state, 384)), main_model_p->p_comm, main_model_p->dim_p_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 384), 2, main_model_p->dim_p_comm_1, main_model_p->dim_p_comm_2);
  SET_VECTOR_ELT(state, 385, ScalarInteger(main_model_p->offset_output_p_comm));
  SET_VECTOR_ELT(state, 386, ScalarInteger(main_model_p->dim_p_noncomm));
  SET_VECTOR_ELT(state, 387, ScalarInteger(main_model_p->dim_p_noncomm_1));
  SET_VECTOR_ELT(state, 388, ScalarInteger(main_model_p->dim_p_noncomm_2));
  SET_VECTOR_ELT(state, 389, allocVector(REALSXP, main_model_p->dim_p_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 389)), main_model_p->p_noncomm, main_model_p->dim_p_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 389), 2, main_model_p->dim_p_noncomm_1, main_model_p->dim_p_noncomm_2);
  SET_VECTOR_ELT(state, 390, ScalarInteger(main_model_p->offset_output_p_noncomm));
  SET_VECTOR_ELT(state, 391, ScalarInteger(main_model_p->dim_ec));
  SET_VECTOR_ELT(state, 392, allocVector(REALSXP, main_model_p->dim_ec));
  memcpy(REAL(VECTOR_ELT(state, 392)), main_model_p->ec, main_model_p->dim_ec * sizeof(double));
  SET_VECTOR_ELT(state, 393, ScalarInteger(main_model_p->dim_eP));
  SET_VECTOR_ELT(state, 394, allocVector(REALSXP, main_model_p->dim_eP));
  memcpy(REAL(VECTOR_ELT(state, 394)), main_model_p->eP, main_model_p->dim_eP * sizeof(double));
  SET_VECTOR_ELT(state, 395, ScalarInteger(main_model_p->dim_eP0));
  SET_VECTOR_ELT(state, 396, allocVector(REALSXP, main_model_p->dim_eP0));
  memcpy(REAL(VECTOR_ELT(state, 396)), main_model_p->eP0, main_model_p->dim_eP0 * sizeof(double));
  SET_VECTOR_ELT(state, 397, ScalarInteger(main_model_p->offset_output_eP0));
  SET_VECTOR_ELT(state, 398, ScalarInteger(main_model_p->dim_eP1a));
  SET_VECTOR_ELT(state, 399, allocVector(REALSXP, main_model_p->dim_eP1a));
  memcpy(REAL(VECTOR_ELT(state, 399)), main_model_p->eP1a, main_model_p->dim_eP1a * sizeof(double));
  SET_VECTOR_ELT(state, 400, ScalarInteger(main_model_p->offset_output_eP1a));
  SET_VECTOR_ELT(state, 401, ScalarInteger(main_model_p->dim_eP1b));
  SET_VECTOR_ELT(state, 402, allocVector(REALSXP, main_model_p->dim_eP1b));
  memcpy(REAL(VECTOR_ELT(state, 402)), main_model_p->eP1b, main_model_p->dim_eP1b * sizeof(double));
  SET_VECTOR_ELT(state, 403, ScalarInteger(main_model_p->offset_output_eP1b));
  SET_VECTOR_ELT(state, 404, ScalarInteger(main_model_p->dim_eP1c));
  SET_VECTOR_ELT(state, 405, allocVector(REALSXP, main_model_p->dim_eP1c));
  memcpy(REAL(VECTOR_ELT(state, 405)), main_model_p->eP1c, main_model_p->dim_eP1c * sizeof(double));
  SET_VECTOR_ELT(state, 406, ScalarInteger(main_model_p->offset_output_eP1c));
  SET_VECTOR_ELT(state, 407, ScalarInteger(main_model_p->dim_eP1d));
  SET_VECTOR_ELT(state, 408, allocVector(REALSXP, main_model_p->dim_eP1d));
  memcpy(REAL(VECTOR_ELT(state, 408)), main_model_p->eP1d, main_model_p->dim_eP1d * sizeof(double));
  SET_VECTOR_ELT(state, 409, ScalarInteger(main_model_p->offset_output_eP1d));
  SET_VECTOR_ELT(state, 410, ScalarInteger(main_model_p->dim_fc_comm));
  SET_VECTOR_ELT(state, 411, ScalarInteger(main_model_p->dim_fc_comm_1));
  SET_VECTOR_ELT(state, 412, ScalarInteger(main_model_p->dim_fc_comm_2));
  SET_VECTOR_ELT(state, 413, allocVector(REALSXP, main_model_p->dim_fc_comm));
  memcpy(REAL(VECTOR_ELT(state, 413)), main_model_p->fc_comm, main_model_p->dim_fc_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 413), 2, main_model_p->dim_fc_comm_1, main_model_p->dim_fc_comm_2);
  SET_VECTOR_ELT(state, 414, ScalarInteger(main_model_p->offset_output_fc_comm));
  SET_VECTOR_ELT(state, 415, ScalarInteger(main_model_p->dim_fP_comm));
  SET_VECTOR_ELT(state, 416, allocVector(REALSXP, main_model_p->dim_fP_comm));
  memcpy(REAL(VECTOR_ELT(state, 416)), main_model_p->fP_comm, main_model_p->dim_fP_comm * sizeof(double));
  SET_VECTOR_ELT(state, 417, ScalarInteger(main_model_p->offset_output_fP_comm));
  SET_VECTOR_ELT(state, 418, ScalarInteger(main_model_p->dim_fc_noncomm));
  SET_VECTOR_ELT(state, 419, ScalarInteger(main_model_p->dim_fc_noncomm_1));
  SET_VECTOR_ELT(state, 420, ScalarInteger(main_model_p->dim_fc_noncomm_2));
  SET_VECTOR_ELT(state, 421, allocVector(REALSXP, main_model_p->dim_fc_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 421)), main_model_p->fc_noncomm, main_model_p->dim_fc_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 421), 2, main_model_p->dim_fc_noncomm_1, main_model_p->dim_fc_noncomm_2);
  SET_VECTOR_ELT(state, 422, ScalarInteger(main_model_p->offset_output_fc_noncomm));
  SET_VECTOR_ELT(state, 423, ScalarInteger(main_model_p->dim_fP_noncomm));
  SET_VECTOR_ELT(state, 424, allocVector(REALSXP, main_model_p->dim_fP_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 424)), main_model_p->fP_noncomm, main_model_p->dim_fP_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 425, ScalarInteger(main_model_p->offset_output_fP_noncomm));
  SET_VECTOR_ELT(state, 426, ScalarInteger(main_model_p->dim_n_comm));
  SET_VECTOR_ELT(state, 427, ScalarInteger(main_model_p->dim_n_comm_1));
  SET_VECTOR_ELT(state, 428, ScalarInteger(main_model_p->dim_n_comm_2));
  SET_VECTOR_ELT(state, 429, allocVector(REALSXP, main_model_p->dim_n_comm));
  memcpy(REAL(VECTOR_ELT(state, 429)), main_model_p->n_comm, main_model_p->dim_n_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 429), 2, main_model_p->dim_n_comm_1, main_model_p->dim_n_comm_2);
  SET_VECTOR_ELT(state, 430, ScalarInteger(main_model_p->offset_output_n_comm));
  SET_VECTOR_ELT(state, 431, ScalarInteger(main_model_p->dim_n_noncomm));
  SET_VECTOR_ELT(state, 432, ScalarInteger(main_model_p->dim_n_noncomm_1));
  SET_VECTOR_ELT(state, 433, ScalarInteger(main_model_p->dim_n_noncomm_2));
  SET_VECTOR_ELT(state, 434, allocVector(REALSXP, main_model_p->dim_n_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 434)), main_model_p->n_noncomm, main_model_p->dim_n_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 434), 2, main_model_p->dim_n_noncomm_1, main_model_p->dim_n_noncomm_2);
  SET_VECTOR_ELT(state, 435, ScalarInteger(main_model_p->offset_output_n_noncomm));
  SET_VECTOR_ELT(state, 436, ScalarInteger(main_model_p->dim_cumuHIVDeaths));
  SET_VECTOR_ELT(state, 437, allocVector(REALSXP, main_model_p->dim_cumuHIVDeaths));
  memcpy(REAL(VECTOR_ELT(state, 437)), main_model_p->initial_cumuHIVDeaths, main_model_p->dim_cumuHIVDeaths * sizeof(double));
  SET_VECTOR_ELT(state, 438, ScalarInteger(main_model_p->offset_cumuHIVDeaths));
  SET_VECTOR_ELT(state, 439, ScalarInteger(main_model_p->dim_cumuARTinitiations));
  SET_VECTOR_ELT(state, 440, allocVector(REALSXP, main_model_p->dim_cumuARTinitiations));
  memcpy(REAL(VECTOR_ELT(state, 440)), main_model_p->initial_cumuARTinitiations, main_model_p->dim_cumuARTinitiations * sizeof(double));
  SET_VECTOR_ELT(state, 441, ScalarInteger(main_model_p->offset_cumuARTinitiations));
  SET_VECTOR_ELT(state, 442, ScalarInteger(main_model_p->dim_TasPinitiations));
  SET_VECTOR_ELT(state, 443, allocVector(REALSXP, main_model_p->dim_TasPinitiations));
  memcpy(REAL(VECTOR_ELT(state, 443)), main_model_p->initial_TasPinitiations, main_model_p->dim_TasPinitiations * sizeof(double));
  SET_VECTOR_ELT(state, 444, ScalarInteger(main_model_p->offset_TasPinitiations));
  SET_VECTOR_ELT(state, 445, ScalarInteger(main_model_p->dim_cumuARTREinitiations));
  SET_VECTOR_ELT(state, 446, allocVector(REALSXP, main_model_p->dim_cumuARTREinitiations));
  memcpy(REAL(VECTOR_ELT(state, 446)), main_model_p->initial_cumuARTREinitiations, main_model_p->dim_cumuARTREinitiations * sizeof(double));
  SET_VECTOR_ELT(state, 447, ScalarInteger(main_model_p->offset_cumuARTREinitiations));
  SET_VECTOR_ELT(state, 448, ScalarInteger(main_model_p->dim_dropouts));
  SET_VECTOR_ELT(state, 449, allocVector(REALSXP, main_model_p->dim_dropouts));
  memcpy(REAL(VECTOR_ELT(state, 449)), main_model_p->initial_dropouts, main_model_p->dim_dropouts * sizeof(double));
  SET_VECTOR_ELT(state, 450, ScalarInteger(main_model_p->offset_dropouts));
  SET_VECTOR_ELT(state, 451, ScalarInteger(main_model_p->dim_cumuAllDeaths));
  SET_VECTOR_ELT(state, 452, allocVector(REALSXP, main_model_p->dim_cumuAllDeaths));
  memcpy(REAL(VECTOR_ELT(state, 452)), main_model_p->initial_cumuAllDeaths, main_model_p->dim_cumuAllDeaths * sizeof(double));
  SET_VECTOR_ELT(state, 453, ScalarInteger(main_model_p->offset_cumuAllDeaths));
  SET_VECTOR_ELT(state, 454, ScalarInteger(main_model_p->dim_cumuInf));
  SET_VECTOR_ELT(state, 455, allocVector(REALSXP, main_model_p->dim_cumuInf));
  memcpy(REAL(VECTOR_ELT(state, 455)), main_model_p->initial_cumuInf, main_model_p->dim_cumuInf * sizeof(double));
  SET_VECTOR_ELT(state, 456, ScalarInteger(main_model_p->offset_cumuInf));
  SET_VECTOR_ELT(state, 457, ScalarInteger(main_model_p->dim_PrEPinitiations));
  SET_VECTOR_ELT(state, 458, allocVector(REALSXP, main_model_p->dim_PrEPinitiations));
  memcpy(REAL(VECTOR_ELT(state, 458)), main_model_p->initial_PrEPinitiations, main_model_p->dim_PrEPinitiations * sizeof(double));
  SET_VECTOR_ELT(state, 459, ScalarInteger(main_model_p->offset_PrEPinitiations));
  SET_VECTOR_ELT(state, 460, ScalarInteger(main_model_p->dim_PrEPinitiations1a));
  SET_VECTOR_ELT(state, 461, allocVector(REALSXP, main_model_p->dim_PrEPinitiations1a));
  memcpy(REAL(VECTOR_ELT(state, 461)), main_model_p->initial_PrEPinitiations1a, main_model_p->dim_PrEPinitiations1a * sizeof(double));
  SET_VECTOR_ELT(state, 462, ScalarInteger(main_model_p->offset_PrEPinitiations1a));
  SET_VECTOR_ELT(state, 463, ScalarInteger(main_model_p->dim_PrEPinitiations1b));
  SET_VECTOR_ELT(state, 464, allocVector(REALSXP, main_model_p->dim_PrEPinitiations1b));
  memcpy(REAL(VECTOR_ELT(state, 464)), main_model_p->initial_PrEPinitiations1b, main_model_p->dim_PrEPinitiations1b * sizeof(double));
  SET_VECTOR_ELT(state, 465, ScalarInteger(main_model_p->offset_PrEPinitiations1b));
  SET_VECTOR_ELT(state, 466, ScalarInteger(main_model_p->dim_PrEPinitiations1c));
  SET_VECTOR_ELT(state, 467, allocVector(REALSXP, main_model_p->dim_PrEPinitiations1c));
  memcpy(REAL(VECTOR_ELT(state, 467)), main_model_p->initial_PrEPinitiations1c, main_model_p->dim_PrEPinitiations1c * sizeof(double));
  SET_VECTOR_ELT(state, 468, ScalarInteger(main_model_p->offset_PrEPinitiations1c));
  SET_VECTOR_ELT(state, 469, ScalarInteger(main_model_p->dim_S0));
  SET_VECTOR_ELT(state, 470, allocVector(REALSXP, main_model_p->dim_S0));
  memcpy(REAL(VECTOR_ELT(state, 470)), main_model_p->initial_S0, main_model_p->dim_S0 * sizeof(double));
  SET_VECTOR_ELT(state, 471, ScalarInteger(main_model_p->offset_S0));
  SET_VECTOR_ELT(state, 472, ScalarInteger(main_model_p->dim_S1a));
  SET_VECTOR_ELT(state, 473, allocVector(REALSXP, main_model_p->dim_S1a));
  memcpy(REAL(VECTOR_ELT(state, 473)), main_model_p->initial_S1a, main_model_p->dim_S1a * sizeof(double));
  SET_VECTOR_ELT(state, 474, ScalarInteger(main_model_p->offset_S1a));
  SET_VECTOR_ELT(state, 475, ScalarInteger(main_model_p->dim_S1b));
  SET_VECTOR_ELT(state, 476, allocVector(REALSXP, main_model_p->dim_S1b));
  memcpy(REAL(VECTOR_ELT(state, 476)), main_model_p->initial_S1b, main_model_p->dim_S1b * sizeof(double));
  SET_VECTOR_ELT(state, 477, ScalarInteger(main_model_p->offset_S1b));
  SET_VECTOR_ELT(state, 478, ScalarInteger(main_model_p->dim_S1c));
  SET_VECTOR_ELT(state, 479, allocVector(REALSXP, main_model_p->dim_S1c));
  memcpy(REAL(VECTOR_ELT(state, 479)), main_model_p->initial_S1c, main_model_p->dim_S1c * sizeof(double));
  SET_VECTOR_ELT(state, 480, ScalarInteger(main_model_p->offset_S1c));
  SET_VECTOR_ELT(state, 481, ScalarInteger(main_model_p->dim_S1d));
  SET_VECTOR_ELT(state, 482, allocVector(REALSXP, main_model_p->dim_S1d));
  memcpy(REAL(VECTOR_ELT(state, 482)), main_model_p->initial_S1d, main_model_p->dim_S1d * sizeof(double));
  SET_VECTOR_ELT(state, 483, ScalarInteger(main_model_p->offset_S1d));
  SET_VECTOR_ELT(state, 484, ScalarInteger(main_model_p->dim_I01));
  SET_VECTOR_ELT(state, 485, allocVector(REALSXP, main_model_p->dim_I01));
  memcpy(REAL(VECTOR_ELT(state, 485)), main_model_p->initial_I01, main_model_p->dim_I01 * sizeof(double));
  SET_VECTOR_ELT(state, 486, ScalarInteger(main_model_p->offset_I01));
  SET_VECTOR_ELT(state, 487, ScalarInteger(main_model_p->dim_I11));
  SET_VECTOR_ELT(state, 488, allocVector(REALSXP, main_model_p->dim_I11));
  memcpy(REAL(VECTOR_ELT(state, 488)), main_model_p->initial_I11, main_model_p->dim_I11 * sizeof(double));
  SET_VECTOR_ELT(state, 489, ScalarInteger(main_model_p->offset_I11));
  SET_VECTOR_ELT(state, 490, ScalarInteger(main_model_p->dim_I02));
  SET_VECTOR_ELT(state, 491, allocVector(REALSXP, main_model_p->dim_I02));
  memcpy(REAL(VECTOR_ELT(state, 491)), main_model_p->initial_I02, main_model_p->dim_I02 * sizeof(double));
  SET_VECTOR_ELT(state, 492, ScalarInteger(main_model_p->offset_I02));
  SET_VECTOR_ELT(state, 493, ScalarInteger(main_model_p->dim_I03));
  SET_VECTOR_ELT(state, 494, allocVector(REALSXP, main_model_p->dim_I03));
  memcpy(REAL(VECTOR_ELT(state, 494)), main_model_p->initial_I03, main_model_p->dim_I03 * sizeof(double));
  SET_VECTOR_ELT(state, 495, ScalarInteger(main_model_p->offset_I03));
  SET_VECTOR_ELT(state, 496, ScalarInteger(main_model_p->dim_I04));
  SET_VECTOR_ELT(state, 497, allocVector(REALSXP, main_model_p->dim_I04));
  memcpy(REAL(VECTOR_ELT(state, 497)), main_model_p->initial_I04, main_model_p->dim_I04 * sizeof(double));
  SET_VECTOR_ELT(state, 498, ScalarInteger(main_model_p->offset_I04));
  SET_VECTOR_ELT(state, 499, ScalarInteger(main_model_p->dim_I05));
  SET_VECTOR_ELT(state, 500, allocVector(REALSXP, main_model_p->dim_I05));
  memcpy(REAL(VECTOR_ELT(state, 500)), main_model_p->initial_I05, main_model_p->dim_I05 * sizeof(double));
  SET_VECTOR_ELT(state, 501, ScalarInteger(main_model_p->offset_I05));
  SET_VECTOR_ELT(state, 502, ScalarInteger(main_model_p->dim_I22));
  SET_VECTOR_ELT(state, 503, allocVector(REALSXP, main_model_p->dim_I22));
  memcpy(REAL(VECTOR_ELT(state, 503)), main_model_p->initial_I22, main_model_p->dim_I22 * sizeof(double));
  SET_VECTOR_ELT(state, 504, ScalarInteger(main_model_p->offset_I22));
  SET_VECTOR_ELT(state, 505, ScalarInteger(main_model_p->dim_I23));
  SET_VECTOR_ELT(state, 506, allocVector(REALSXP, main_model_p->dim_I23));
  memcpy(REAL(VECTOR_ELT(state, 506)), main_model_p->initial_I23, main_model_p->dim_I23 * sizeof(double));
  SET_VECTOR_ELT(state, 507, ScalarInteger(main_model_p->offset_I23));
  SET_VECTOR_ELT(state, 508, ScalarInteger(main_model_p->dim_I24));
  SET_VECTOR_ELT(state, 509, allocVector(REALSXP, main_model_p->dim_I24));
  memcpy(REAL(VECTOR_ELT(state, 509)), main_model_p->initial_I24, main_model_p->dim_I24 * sizeof(double));
  SET_VECTOR_ELT(state, 510, ScalarInteger(main_model_p->offset_I24));
  SET_VECTOR_ELT(state, 511, ScalarInteger(main_model_p->dim_I25));
  SET_VECTOR_ELT(state, 512, allocVector(REALSXP, main_model_p->dim_I25));
  memcpy(REAL(VECTOR_ELT(state, 512)), main_model_p->initial_I25, main_model_p->dim_I25 * sizeof(double));
  SET_VECTOR_ELT(state, 513, ScalarInteger(main_model_p->offset_I25));
  SET_VECTOR_ELT(state, 514, ScalarInteger(main_model_p->dim_I32));
  SET_VECTOR_ELT(state, 515, allocVector(REALSXP, main_model_p->dim_I32));
  memcpy(REAL(VECTOR_ELT(state, 515)), main_model_p->initial_I32, main_model_p->dim_I32 * sizeof(double));
  SET_VECTOR_ELT(state, 516, ScalarInteger(main_model_p->offset_I32));
  SET_VECTOR_ELT(state, 517, ScalarInteger(main_model_p->dim_I33));
  SET_VECTOR_ELT(state, 518, allocVector(REALSXP, main_model_p->dim_I33));
  memcpy(REAL(VECTOR_ELT(state, 518)), main_model_p->initial_I33, main_model_p->dim_I33 * sizeof(double));
  SET_VECTOR_ELT(state, 519, ScalarInteger(main_model_p->offset_I33));
  SET_VECTOR_ELT(state, 520, ScalarInteger(main_model_p->dim_I34));
  SET_VECTOR_ELT(state, 521, allocVector(REALSXP, main_model_p->dim_I34));
  memcpy(REAL(VECTOR_ELT(state, 521)), main_model_p->initial_I34, main_model_p->dim_I34 * sizeof(double));
  SET_VECTOR_ELT(state, 522, ScalarInteger(main_model_p->offset_I34));
  SET_VECTOR_ELT(state, 523, ScalarInteger(main_model_p->dim_I35));
  SET_VECTOR_ELT(state, 524, allocVector(REALSXP, main_model_p->dim_I35));
  memcpy(REAL(VECTOR_ELT(state, 524)), main_model_p->initial_I35, main_model_p->dim_I35 * sizeof(double));
  SET_VECTOR_ELT(state, 525, ScalarInteger(main_model_p->offset_I35));
  SET_VECTOR_ELT(state, 526, ScalarInteger(main_model_p->dim_I42));
  SET_VECTOR_ELT(state, 527, allocVector(REALSXP, main_model_p->dim_I42));
  memcpy(REAL(VECTOR_ELT(state, 527)), main_model_p->initial_I42, main_model_p->dim_I42 * sizeof(double));
  SET_VECTOR_ELT(state, 528, ScalarInteger(main_model_p->offset_I42));
  SET_VECTOR_ELT(state, 529, ScalarInteger(main_model_p->dim_I43));
  SET_VECTOR_ELT(state, 530, allocVector(REALSXP, main_model_p->dim_I43));
  memcpy(REAL(VECTOR_ELT(state, 530)), main_model_p->initial_I43, main_model_p->dim_I43 * sizeof(double));
  SET_VECTOR_ELT(state, 531, ScalarInteger(main_model_p->offset_I43));
  SET_VECTOR_ELT(state, 532, ScalarInteger(main_model_p->dim_I44));
  SET_VECTOR_ELT(state, 533, allocVector(REALSXP, main_model_p->dim_I44));
  memcpy(REAL(VECTOR_ELT(state, 533)), main_model_p->initial_I44, main_model_p->dim_I44 * sizeof(double));
  SET_VECTOR_ELT(state, 534, ScalarInteger(main_model_p->offset_I44));
  SET_VECTOR_ELT(state, 535, ScalarInteger(main_model_p->dim_I45));
  SET_VECTOR_ELT(state, 536, allocVector(REALSXP, main_model_p->dim_I45));
  memcpy(REAL(VECTOR_ELT(state, 536)), main_model_p->initial_I45, main_model_p->dim_I45 * sizeof(double));
  SET_VECTOR_ELT(state, 537, ScalarInteger(main_model_p->offset_I45));
  SET_VECTOR_ELT(state, 538, ScalarInteger(main_model_p->dim_S0_init));
  SET_VECTOR_ELT(state, 539, allocVector(REALSXP, main_model_p->dim_S0_init));
  memcpy(REAL(VECTOR_ELT(state, 539)), main_model_p->S0_init, main_model_p->dim_S0_init * sizeof(double));
  SET_VECTOR_ELT(state, 540, ScalarInteger(main_model_p->dim_S1a_init));
  SET_VECTOR_ELT(state, 541, allocVector(REALSXP, main_model_p->dim_S1a_init));
  memcpy(REAL(VECTOR_ELT(state, 541)), main_model_p->S1a_init, main_model_p->dim_S1a_init * sizeof(double));
  SET_VECTOR_ELT(state, 542, ScalarInteger(main_model_p->dim_S1b_init));
  SET_VECTOR_ELT(state, 543, allocVector(REALSXP, main_model_p->dim_S1b_init));
  memcpy(REAL(VECTOR_ELT(state, 543)), main_model_p->S1b_init, main_model_p->dim_S1b_init * sizeof(double));
  SET_VECTOR_ELT(state, 544, ScalarInteger(main_model_p->dim_S1c_init));
  SET_VECTOR_ELT(state, 545, allocVector(REALSXP, main_model_p->dim_S1c_init));
  memcpy(REAL(VECTOR_ELT(state, 545)), main_model_p->S1c_init, main_model_p->dim_S1c_init * sizeof(double));
  SET_VECTOR_ELT(state, 546, ScalarInteger(main_model_p->dim_S1d_init));
  SET_VECTOR_ELT(state, 547, allocVector(REALSXP, main_model_p->dim_S1d_init));
  memcpy(REAL(VECTOR_ELT(state, 547)), main_model_p->S1d_init, main_model_p->dim_S1d_init * sizeof(double));
  SET_VECTOR_ELT(state, 548, ScalarInteger(main_model_p->dim_I01_init));
  SET_VECTOR_ELT(state, 549, allocVector(REALSXP, main_model_p->dim_I01_init));
  memcpy(REAL(VECTOR_ELT(state, 549)), main_model_p->I01_init, main_model_p->dim_I01_init * sizeof(double));
  SET_VECTOR_ELT(state, 550, ScalarInteger(main_model_p->dim_I11_init));
  SET_VECTOR_ELT(state, 551, allocVector(REALSXP, main_model_p->dim_I11_init));
  memcpy(REAL(VECTOR_ELT(state, 551)), main_model_p->I11_init, main_model_p->dim_I11_init * sizeof(double));
  SET_VECTOR_ELT(state, 552, ScalarInteger(main_model_p->dim_I02_init));
  SET_VECTOR_ELT(state, 553, allocVector(REALSXP, main_model_p->dim_I02_init));
  memcpy(REAL(VECTOR_ELT(state, 553)), main_model_p->I02_init, main_model_p->dim_I02_init * sizeof(double));
  SET_VECTOR_ELT(state, 554, ScalarInteger(main_model_p->dim_I03_init));
  SET_VECTOR_ELT(state, 555, allocVector(REALSXP, main_model_p->dim_I03_init));
  memcpy(REAL(VECTOR_ELT(state, 555)), main_model_p->I03_init, main_model_p->dim_I03_init * sizeof(double));
  SET_VECTOR_ELT(state, 556, ScalarInteger(main_model_p->dim_I04_init));
  SET_VECTOR_ELT(state, 557, allocVector(REALSXP, main_model_p->dim_I04_init));
  memcpy(REAL(VECTOR_ELT(state, 557)), main_model_p->I04_init, main_model_p->dim_I04_init * sizeof(double));
  SET_VECTOR_ELT(state, 558, ScalarInteger(main_model_p->dim_I05_init));
  SET_VECTOR_ELT(state, 559, allocVector(REALSXP, main_model_p->dim_I05_init));
  memcpy(REAL(VECTOR_ELT(state, 559)), main_model_p->I05_init, main_model_p->dim_I05_init * sizeof(double));
  SET_VECTOR_ELT(state, 560, ScalarInteger(main_model_p->dim_I22_init));
  SET_VECTOR_ELT(state, 561, allocVector(REALSXP, main_model_p->dim_I22_init));
  memcpy(REAL(VECTOR_ELT(state, 561)), main_model_p->I22_init, main_model_p->dim_I22_init * sizeof(double));
  SET_VECTOR_ELT(state, 562, ScalarInteger(main_model_p->dim_I23_init));
  SET_VECTOR_ELT(state, 563, allocVector(REALSXP, main_model_p->dim_I23_init));
  memcpy(REAL(VECTOR_ELT(state, 563)), main_model_p->I23_init, main_model_p->dim_I23_init * sizeof(double));
  SET_VECTOR_ELT(state, 564, ScalarInteger(main_model_p->dim_I24_init));
  SET_VECTOR_ELT(state, 565, allocVector(REALSXP, main_model_p->dim_I24_init));
  memcpy(REAL(VECTOR_ELT(state, 565)), main_model_p->I24_init, main_model_p->dim_I24_init * sizeof(double));
  SET_VECTOR_ELT(state, 566, ScalarInteger(main_model_p->dim_I25_init));
  SET_VECTOR_ELT(state, 567, allocVector(REALSXP, main_model_p->dim_I25_init));
  memcpy(REAL(VECTOR_ELT(state, 567)), main_model_p->I25_init, main_model_p->dim_I25_init * sizeof(double));
  SET_VECTOR_ELT(state, 568, ScalarInteger(main_model_p->dim_I32_init));
  SET_VECTOR_ELT(state, 569, allocVector(REALSXP, main_model_p->dim_I32_init));
  memcpy(REAL(VECTOR_ELT(state, 569)), main_model_p->I32_init, main_model_p->dim_I32_init * sizeof(double));
  SET_VECTOR_ELT(state, 570, ScalarInteger(main_model_p->dim_I33_init));
  SET_VECTOR_ELT(state, 571, allocVector(REALSXP, main_model_p->dim_I33_init));
  memcpy(REAL(VECTOR_ELT(state, 571)), main_model_p->I33_init, main_model_p->dim_I33_init * sizeof(double));
  SET_VECTOR_ELT(state, 572, ScalarInteger(main_model_p->dim_I34_init));
  SET_VECTOR_ELT(state, 573, allocVector(REALSXP, main_model_p->dim_I34_init));
  memcpy(REAL(VECTOR_ELT(state, 573)), main_model_p->I34_init, main_model_p->dim_I34_init * sizeof(double));
  SET_VECTOR_ELT(state, 574, ScalarInteger(main_model_p->dim_I35_init));
  SET_VECTOR_ELT(state, 575, allocVector(REALSXP, main_model_p->dim_I35_init));
  memcpy(REAL(VECTOR_ELT(state, 575)), main_model_p->I35_init, main_model_p->dim_I35_init * sizeof(double));
  SET_VECTOR_ELT(state, 576, ScalarInteger(main_model_p->dim_I42_init));
  SET_VECTOR_ELT(state, 577, allocVector(REALSXP, main_model_p->dim_I42_init));
  memcpy(REAL(VECTOR_ELT(state, 577)), main_model_p->I42_init, main_model_p->dim_I42_init * sizeof(double));
  SET_VECTOR_ELT(state, 578, ScalarInteger(main_model_p->dim_I43_init));
  SET_VECTOR_ELT(state, 579, allocVector(REALSXP, main_model_p->dim_I43_init));
  memcpy(REAL(VECTOR_ELT(state, 579)), main_model_p->I43_init, main_model_p->dim_I43_init * sizeof(double));
  SET_VECTOR_ELT(state, 580, ScalarInteger(main_model_p->dim_I44_init));
  SET_VECTOR_ELT(state, 581, allocVector(REALSXP, main_model_p->dim_I44_init));
  memcpy(REAL(VECTOR_ELT(state, 581)), main_model_p->I44_init, main_model_p->dim_I44_init * sizeof(double));
  SET_VECTOR_ELT(state, 582, ScalarInteger(main_model_p->dim_I45_init));
  SET_VECTOR_ELT(state, 583, allocVector(REALSXP, main_model_p->dim_I45_init));
  memcpy(REAL(VECTOR_ELT(state, 583)), main_model_p->I45_init, main_model_p->dim_I45_init * sizeof(double));
  SET_VECTOR_ELT(state, 584, ScalarInteger(main_model_p->dim_N));
  SET_VECTOR_ELT(state, 585, allocVector(REALSXP, main_model_p->dim_N));
  memcpy(REAL(VECTOR_ELT(state, 585)), main_model_p->N, main_model_p->dim_N * sizeof(double));
  SET_VECTOR_ELT(state, 586, ScalarInteger(main_model_p->offset_output_N));
  SET_VECTOR_ELT(state, 587, ScalarInteger(main_model_p->dim_E0));
  SET_VECTOR_ELT(state, 588, allocVector(REALSXP, main_model_p->dim_E0));
  memcpy(REAL(VECTOR_ELT(state, 588)), main_model_p->E0, main_model_p->dim_E0 * sizeof(double));
  SET_VECTOR_ELT(state, 589, ScalarInteger(main_model_p->offset_output_E0));
  SET_VECTOR_ELT(state, 590, ScalarInteger(main_model_p->dim_E1a));
  SET_VECTOR_ELT(state, 591, allocVector(REALSXP, main_model_p->dim_E1a));
  memcpy(REAL(VECTOR_ELT(state, 591)), main_model_p->E1a, main_model_p->dim_E1a * sizeof(double));
  SET_VECTOR_ELT(state, 592, ScalarInteger(main_model_p->offset_output_E1a));
  SET_VECTOR_ELT(state, 593, ScalarInteger(main_model_p->dim_E1b));
  SET_VECTOR_ELT(state, 594, allocVector(REALSXP, main_model_p->dim_E1b));
  memcpy(REAL(VECTOR_ELT(state, 594)), main_model_p->E1b, main_model_p->dim_E1b * sizeof(double));
  SET_VECTOR_ELT(state, 595, ScalarInteger(main_model_p->offset_output_E1b));
  SET_VECTOR_ELT(state, 596, ScalarInteger(main_model_p->dim_E1c));
  SET_VECTOR_ELT(state, 597, allocVector(REALSXP, main_model_p->dim_E1c));
  memcpy(REAL(VECTOR_ELT(state, 597)), main_model_p->E1c, main_model_p->dim_E1c * sizeof(double));
  SET_VECTOR_ELT(state, 598, ScalarInteger(main_model_p->offset_output_E1c));
  SET_VECTOR_ELT(state, 599, ScalarInteger(main_model_p->dim_E1d));
  SET_VECTOR_ELT(state, 600, allocVector(REALSXP, main_model_p->dim_E1d));
  memcpy(REAL(VECTOR_ELT(state, 600)), main_model_p->E1d, main_model_p->dim_E1d * sizeof(double));
  SET_VECTOR_ELT(state, 601, ScalarInteger(main_model_p->offset_output_E1d));
  SET_VECTOR_ELT(state, 602, ScalarInteger(main_model_p->dim_cumuInf_init));
  SET_VECTOR_ELT(state, 603, allocVector(REALSXP, main_model_p->dim_cumuInf_init));
  memcpy(REAL(VECTOR_ELT(state, 603)), main_model_p->cumuInf_init, main_model_p->dim_cumuInf_init * sizeof(double));
  SET_VECTOR_ELT(state, 604, ScalarInteger(main_model_p->dim_alphaItot));
  SET_VECTOR_ELT(state, 605, allocVector(REALSXP, main_model_p->dim_alphaItot));
  memcpy(REAL(VECTOR_ELT(state, 605)), main_model_p->alphaItot, main_model_p->dim_alphaItot * sizeof(double));
  SET_VECTOR_ELT(state, 606, ScalarInteger(main_model_p->offset_output_alphaItot));
  SET_VECTOR_ELT(state, 607, ScalarInteger(main_model_p->dim_prev));
  SET_VECTOR_ELT(state, 608, allocVector(REALSXP, main_model_p->dim_prev));
  memcpy(REAL(VECTOR_ELT(state, 608)), main_model_p->prev, main_model_p->dim_prev * sizeof(double));
  SET_VECTOR_ELT(state, 609, ScalarInteger(main_model_p->offset_output_prev));
  SET_VECTOR_ELT(state, 610, ScalarInteger(main_model_p->dim_lambda));
  SET_VECTOR_ELT(state, 611, ScalarInteger(main_model_p->dim_lambda_1));
  SET_VECTOR_ELT(state, 612, ScalarInteger(main_model_p->dim_lambda_2));
  SET_VECTOR_ELT(state, 613, allocVector(REALSXP, main_model_p->dim_lambda));
  memcpy(REAL(VECTOR_ELT(state, 613)), main_model_p->lambda, main_model_p->dim_lambda * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 613), 2, main_model_p->dim_lambda_1, main_model_p->dim_lambda_2);
  SET_VECTOR_ELT(state, 614, ScalarInteger(main_model_p->offset_output_lambda));
  SET_VECTOR_ELT(state, 615, ScalarInteger(main_model_p->dim_lambda_0));
  SET_VECTOR_ELT(state, 616, ScalarInteger(main_model_p->dim_lambda_0_1));
  SET_VECTOR_ELT(state, 617, ScalarInteger(main_model_p->dim_lambda_0_2));
  SET_VECTOR_ELT(state, 618, allocVector(REALSXP, main_model_p->dim_lambda_0));
  memcpy(REAL(VECTOR_ELT(state, 618)), main_model_p->lambda_0, main_model_p->dim_lambda_0 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 618), 2, main_model_p->dim_lambda_0_1, main_model_p->dim_lambda_0_2);
  SET_VECTOR_ELT(state, 619, ScalarInteger(main_model_p->offset_output_lambda_0));
  SET_VECTOR_ELT(state, 620, ScalarInteger(main_model_p->dim_lambda_1a));
  SET_VECTOR_ELT(state, 621, ScalarInteger(main_model_p->dim_lambda_1a_1));
  SET_VECTOR_ELT(state, 622, ScalarInteger(main_model_p->dim_lambda_1a_2));
  SET_VECTOR_ELT(state, 623, allocVector(REALSXP, main_model_p->dim_lambda_1a));
  memcpy(REAL(VECTOR_ELT(state, 623)), main_model_p->lambda_1a, main_model_p->dim_lambda_1a * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 623), 2, main_model_p->dim_lambda_1a_1, main_model_p->dim_lambda_1a_2);
  SET_VECTOR_ELT(state, 624, ScalarInteger(main_model_p->offset_output_lambda_1a));
  SET_VECTOR_ELT(state, 625, ScalarInteger(main_model_p->dim_lambda_1b));
  SET_VECTOR_ELT(state, 626, ScalarInteger(main_model_p->dim_lambda_1b_1));
  SET_VECTOR_ELT(state, 627, ScalarInteger(main_model_p->dim_lambda_1b_2));
  SET_VECTOR_ELT(state, 628, allocVector(REALSXP, main_model_p->dim_lambda_1b));
  memcpy(REAL(VECTOR_ELT(state, 628)), main_model_p->lambda_1b, main_model_p->dim_lambda_1b * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 628), 2, main_model_p->dim_lambda_1b_1, main_model_p->dim_lambda_1b_2);
  SET_VECTOR_ELT(state, 629, ScalarInteger(main_model_p->offset_output_lambda_1b));
  SET_VECTOR_ELT(state, 630, ScalarInteger(main_model_p->dim_lambda_1c));
  SET_VECTOR_ELT(state, 631, ScalarInteger(main_model_p->dim_lambda_1c_1));
  SET_VECTOR_ELT(state, 632, ScalarInteger(main_model_p->dim_lambda_1c_2));
  SET_VECTOR_ELT(state, 633, allocVector(REALSXP, main_model_p->dim_lambda_1c));
  memcpy(REAL(VECTOR_ELT(state, 633)), main_model_p->lambda_1c, main_model_p->dim_lambda_1c * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 633), 2, main_model_p->dim_lambda_1c_1, main_model_p->dim_lambda_1c_2);
  SET_VECTOR_ELT(state, 634, ScalarInteger(main_model_p->offset_output_lambda_1c));
  SET_VECTOR_ELT(state, 635, ScalarInteger(main_model_p->dim_lambda_1d));
  SET_VECTOR_ELT(state, 636, ScalarInteger(main_model_p->dim_lambda_1d_1));
  SET_VECTOR_ELT(state, 637, ScalarInteger(main_model_p->dim_lambda_1d_2));
  SET_VECTOR_ELT(state, 638, allocVector(REALSXP, main_model_p->dim_lambda_1d));
  memcpy(REAL(VECTOR_ELT(state, 638)), main_model_p->lambda_1d, main_model_p->dim_lambda_1d * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 638), 2, main_model_p->dim_lambda_1d_1, main_model_p->dim_lambda_1d_2);
  SET_VECTOR_ELT(state, 639, ScalarInteger(main_model_p->offset_output_lambda_1d));
  SET_VECTOR_ELT(state, 640, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_VECTOR_ELT(state, 641, allocVector(REALSXP, main_model_p->dim_lambda_sum_0));
  memcpy(REAL(VECTOR_ELT(state, 641)), main_model_p->lambda_sum_0, main_model_p->dim_lambda_sum_0 * sizeof(double));
  SET_VECTOR_ELT(state, 642, ScalarInteger(main_model_p->offset_output_lambda_sum_0));
  SET_VECTOR_ELT(state, 643, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_VECTOR_ELT(state, 644, allocVector(REALSXP, main_model_p->dim_lambda_sum_1a));
  memcpy(REAL(VECTOR_ELT(state, 644)), main_model_p->lambda_sum_1a, main_model_p->dim_lambda_sum_1a * sizeof(double));
  SET_VECTOR_ELT(state, 645, ScalarInteger(main_model_p->offset_output_lambda_sum_1a));
  SET_VECTOR_ELT(state, 646, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_VECTOR_ELT(state, 647, allocVector(REALSXP, main_model_p->dim_lambda_sum_1b));
  memcpy(REAL(VECTOR_ELT(state, 647)), main_model_p->lambda_sum_1b, main_model_p->dim_lambda_sum_1b * sizeof(double));
  SET_VECTOR_ELT(state, 648, ScalarInteger(main_model_p->offset_output_lambda_sum_1b));
  SET_VECTOR_ELT(state, 649, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_VECTOR_ELT(state, 650, allocVector(REALSXP, main_model_p->dim_lambda_sum_1c));
  memcpy(REAL(VECTOR_ELT(state, 650)), main_model_p->lambda_sum_1c, main_model_p->dim_lambda_sum_1c * sizeof(double));
  SET_VECTOR_ELT(state, 651, ScalarInteger(main_model_p->offset_output_lambda_sum_1c));
  SET_VECTOR_ELT(state, 652, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_VECTOR_ELT(state, 653, allocVector(REALSXP, main_model_p->dim_lambda_sum_1d));
  memcpy(REAL(VECTOR_ELT(state, 653)), main_model_p->lambda_sum_1d, main_model_p->dim_lambda_sum_1d * sizeof(double));
  SET_VECTOR_ELT(state, 654, ScalarInteger(main_model_p->offset_output_lambda_sum_1d));
  SET_VECTOR_ELT(state, 655, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_VECTOR_ELT(state, 656, allocVector(REALSXP, main_model_p->dim_c_comm_balanced));
  memcpy(REAL(VECTOR_ELT(state, 656)), main_model_p->c_comm_balanced, main_model_p->dim_c_comm_balanced * sizeof(double));
  SET_VECTOR_ELT(state, 657, ScalarInteger(main_model_p->offset_output_c_comm_balanced));
  SET_VECTOR_ELT(state, 658, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_VECTOR_ELT(state, 659, allocVector(REALSXP, main_model_p->dim_c_noncomm_balanced));
  memcpy(REAL(VECTOR_ELT(state, 659)), main_model_p->c_noncomm_balanced, main_model_p->dim_c_noncomm_balanced * sizeof(double));
  SET_VECTOR_ELT(state, 660, ScalarInteger(main_model_p->offset_output_c_noncomm_balanced));
  SET_VECTOR_ELT(state, 661, ScalarInteger(main_model_p->dim_theta));
  SET_VECTOR_ELT(state, 662, ScalarInteger(main_model_p->dim_theta_1));
  SET_VECTOR_ELT(state, 663, ScalarInteger(main_model_p->dim_theta_2));
  SET_VECTOR_ELT(state, 664, allocVector(REALSXP, main_model_p->dim_theta));
  memcpy(REAL(VECTOR_ELT(state, 664)), main_model_p->theta, main_model_p->dim_theta * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 664), 2, main_model_p->dim_theta_1, main_model_p->dim_theta_2);
  SET_VECTOR_ELT(state, 665, ScalarInteger(main_model_p->offset_output_theta));
  SET_VECTOR_ELT(state, 666, ScalarInteger(main_model_p->dim_PrEPinitiations_init));
  SET_VECTOR_ELT(state, 667, allocVector(REALSXP, main_model_p->dim_PrEPinitiations_init));
  memcpy(REAL(VECTOR_ELT(state, 667)), main_model_p->PrEPinitiations_init, main_model_p->dim_PrEPinitiations_init * sizeof(double));
  SET_VECTOR_ELT(state, 668, ScalarInteger(main_model_p->dim_M_comm));
  SET_VECTOR_ELT(state, 669, ScalarInteger(main_model_p->dim_M_comm_1));
  SET_VECTOR_ELT(state, 670, ScalarInteger(main_model_p->dim_M_comm_2));
  SET_VECTOR_ELT(state, 671, allocVector(REALSXP, main_model_p->dim_M_comm));
  memcpy(REAL(VECTOR_ELT(state, 671)), main_model_p->M_comm, main_model_p->dim_M_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 671), 2, main_model_p->dim_M_comm_1, main_model_p->dim_M_comm_2);
  SET_VECTOR_ELT(state, 672, ScalarInteger(main_model_p->offset_output_M_comm));
  SET_VECTOR_ELT(state, 673, ScalarInteger(main_model_p->dim_M_noncomm));
  SET_VECTOR_ELT(state, 674, ScalarInteger(main_model_p->dim_M_noncomm_1));
  SET_VECTOR_ELT(state, 675, ScalarInteger(main_model_p->dim_M_noncomm_2));
  SET_VECTOR_ELT(state, 676, allocVector(REALSXP, main_model_p->dim_M_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 676)), main_model_p->M_noncomm, main_model_p->dim_M_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 676), 2, main_model_p->dim_M_noncomm_1, main_model_p->dim_M_noncomm_2);
  SET_VECTOR_ELT(state, 677, ScalarInteger(main_model_p->offset_output_M_noncomm));
  SET_VECTOR_ELT(state, 678, ScalarInteger(main_model_p->dim_in_S0));
  SET_VECTOR_ELT(state, 679, ScalarInteger(main_model_p->dim_in_S0_1));
  SET_VECTOR_ELT(state, 680, ScalarInteger(main_model_p->dim_in_S0_2));
  SET_VECTOR_ELT(state, 681, allocVector(REALSXP, main_model_p->dim_in_S0));
  memcpy(REAL(VECTOR_ELT(state, 681)), main_model_p->in_S0, main_model_p->dim_in_S0 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 681), 2, main_model_p->dim_in_S0_1, main_model_p->dim_in_S0_2);
  SET_VECTOR_ELT(state, 682, ScalarInteger(main_model_p->dim_in_S1a));
  SET_VECTOR_ELT(state, 683, ScalarInteger(main_model_p->dim_in_S1a_1));
  SET_VECTOR_ELT(state, 684, ScalarInteger(main_model_p->dim_in_S1a_2));
  SET_VECTOR_ELT(state, 685, allocVector(REALSXP, main_model_p->dim_in_S1a));
  memcpy(REAL(VECTOR_ELT(state, 685)), main_model_p->in_S1a, main_model_p->dim_in_S1a * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 685), 2, main_model_p->dim_in_S1a_1, main_model_p->dim_in_S1a_2);
  SET_VECTOR_ELT(state, 686, ScalarInteger(main_model_p->dim_in_S1b));
  SET_VECTOR_ELT(state, 687, ScalarInteger(main_model_p->dim_in_S1b_1));
  SET_VECTOR_ELT(state, 688, ScalarInteger(main_model_p->dim_in_S1b_2));
  SET_VECTOR_ELT(state, 689, allocVector(REALSXP, main_model_p->dim_in_S1b));
  memcpy(REAL(VECTOR_ELT(state, 689)), main_model_p->in_S1b, main_model_p->dim_in_S1b * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 689), 2, main_model_p->dim_in_S1b_1, main_model_p->dim_in_S1b_2);
  SET_VECTOR_ELT(state, 690, ScalarInteger(main_model_p->dim_in_S1c));
  SET_VECTOR_ELT(state, 691, ScalarInteger(main_model_p->dim_in_S1c_1));
  SET_VECTOR_ELT(state, 692, ScalarInteger(main_model_p->dim_in_S1c_2));
  SET_VECTOR_ELT(state, 693, allocVector(REALSXP, main_model_p->dim_in_S1c));
  memcpy(REAL(VECTOR_ELT(state, 693)), main_model_p->in_S1c, main_model_p->dim_in_S1c * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 693), 2, main_model_p->dim_in_S1c_1, main_model_p->dim_in_S1c_2);
  SET_VECTOR_ELT(state, 694, ScalarInteger(main_model_p->dim_in_S1d));
  SET_VECTOR_ELT(state, 695, ScalarInteger(main_model_p->dim_in_S1d_1));
  SET_VECTOR_ELT(state, 696, ScalarInteger(main_model_p->dim_in_S1d_2));
  SET_VECTOR_ELT(state, 697, allocVector(REALSXP, main_model_p->dim_in_S1d));
  memcpy(REAL(VECTOR_ELT(state, 697)), main_model_p->in_S1d, main_model_p->dim_in_S1d * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 697), 2, main_model_p->dim_in_S1d_1, main_model_p->dim_in_S1d_2);
  SET_VECTOR_ELT(state, 698, ScalarInteger(main_model_p->dim_in_I01));
  SET_VECTOR_ELT(state, 699, ScalarInteger(main_model_p->dim_in_I01_1));
  SET_VECTOR_ELT(state, 700, ScalarInteger(main_model_p->dim_in_I01_2));
  SET_VECTOR_ELT(state, 701, allocVector(REALSXP, main_model_p->dim_in_I01));
  memcpy(REAL(VECTOR_ELT(state, 701)), main_model_p->in_I01, main_model_p->dim_in_I01 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 701), 2, main_model_p->dim_in_I01_1, main_model_p->dim_in_I01_2);
  SET_VECTOR_ELT(state, 702, ScalarInteger(main_model_p->dim_in_I11));
  SET_VECTOR_ELT(state, 703, ScalarInteger(main_model_p->dim_in_I11_1));
  SET_VECTOR_ELT(state, 704, ScalarInteger(main_model_p->dim_in_I11_2));
  SET_VECTOR_ELT(state, 705, allocVector(REALSXP, main_model_p->dim_in_I11));
  memcpy(REAL(VECTOR_ELT(state, 705)), main_model_p->in_I11, main_model_p->dim_in_I11 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 705), 2, main_model_p->dim_in_I11_1, main_model_p->dim_in_I11_2);
  SET_VECTOR_ELT(state, 706, ScalarInteger(main_model_p->dim_in_I02));
  SET_VECTOR_ELT(state, 707, ScalarInteger(main_model_p->dim_in_I02_1));
  SET_VECTOR_ELT(state, 708, ScalarInteger(main_model_p->dim_in_I02_2));
  SET_VECTOR_ELT(state, 709, allocVector(REALSXP, main_model_p->dim_in_I02));
  memcpy(REAL(VECTOR_ELT(state, 709)), main_model_p->in_I02, main_model_p->dim_in_I02 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 709), 2, main_model_p->dim_in_I02_1, main_model_p->dim_in_I02_2);
  SET_VECTOR_ELT(state, 710, ScalarInteger(main_model_p->dim_in_I03));
  SET_VECTOR_ELT(state, 711, ScalarInteger(main_model_p->dim_in_I03_1));
  SET_VECTOR_ELT(state, 712, ScalarInteger(main_model_p->dim_in_I03_2));
  SET_VECTOR_ELT(state, 713, allocVector(REALSXP, main_model_p->dim_in_I03));
  memcpy(REAL(VECTOR_ELT(state, 713)), main_model_p->in_I03, main_model_p->dim_in_I03 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 713), 2, main_model_p->dim_in_I03_1, main_model_p->dim_in_I03_2);
  SET_VECTOR_ELT(state, 714, ScalarInteger(main_model_p->dim_in_I04));
  SET_VECTOR_ELT(state, 715, ScalarInteger(main_model_p->dim_in_I04_1));
  SET_VECTOR_ELT(state, 716, ScalarInteger(main_model_p->dim_in_I04_2));
  SET_VECTOR_ELT(state, 717, allocVector(REALSXP, main_model_p->dim_in_I04));
  memcpy(REAL(VECTOR_ELT(state, 717)), main_model_p->in_I04, main_model_p->dim_in_I04 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 717), 2, main_model_p->dim_in_I04_1, main_model_p->dim_in_I04_2);
  SET_VECTOR_ELT(state, 718, ScalarInteger(main_model_p->dim_in_I05));
  SET_VECTOR_ELT(state, 719, ScalarInteger(main_model_p->dim_in_I05_1));
  SET_VECTOR_ELT(state, 720, ScalarInteger(main_model_p->dim_in_I05_2));
  SET_VECTOR_ELT(state, 721, allocVector(REALSXP, main_model_p->dim_in_I05));
  memcpy(REAL(VECTOR_ELT(state, 721)), main_model_p->in_I05, main_model_p->dim_in_I05 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 721), 2, main_model_p->dim_in_I05_1, main_model_p->dim_in_I05_2);
  SET_VECTOR_ELT(state, 722, ScalarInteger(main_model_p->dim_in_I22));
  SET_VECTOR_ELT(state, 723, ScalarInteger(main_model_p->dim_in_I22_1));
  SET_VECTOR_ELT(state, 724, ScalarInteger(main_model_p->dim_in_I22_2));
  SET_VECTOR_ELT(state, 725, allocVector(REALSXP, main_model_p->dim_in_I22));
  memcpy(REAL(VECTOR_ELT(state, 725)), main_model_p->in_I22, main_model_p->dim_in_I22 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 725), 2, main_model_p->dim_in_I22_1, main_model_p->dim_in_I22_2);
  SET_VECTOR_ELT(state, 726, ScalarInteger(main_model_p->dim_in_I23));
  SET_VECTOR_ELT(state, 727, ScalarInteger(main_model_p->dim_in_I23_1));
  SET_VECTOR_ELT(state, 728, ScalarInteger(main_model_p->dim_in_I23_2));
  SET_VECTOR_ELT(state, 729, allocVector(REALSXP, main_model_p->dim_in_I23));
  memcpy(REAL(VECTOR_ELT(state, 729)), main_model_p->in_I23, main_model_p->dim_in_I23 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 729), 2, main_model_p->dim_in_I23_1, main_model_p->dim_in_I23_2);
  SET_VECTOR_ELT(state, 730, ScalarInteger(main_model_p->dim_in_I24));
  SET_VECTOR_ELT(state, 731, ScalarInteger(main_model_p->dim_in_I24_1));
  SET_VECTOR_ELT(state, 732, ScalarInteger(main_model_p->dim_in_I24_2));
  SET_VECTOR_ELT(state, 733, allocVector(REALSXP, main_model_p->dim_in_I24));
  memcpy(REAL(VECTOR_ELT(state, 733)), main_model_p->in_I24, main_model_p->dim_in_I24 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 733), 2, main_model_p->dim_in_I24_1, main_model_p->dim_in_I24_2);
  SET_VECTOR_ELT(state, 734, ScalarInteger(main_model_p->dim_in_I25));
  SET_VECTOR_ELT(state, 735, ScalarInteger(main_model_p->dim_in_I25_1));
  SET_VECTOR_ELT(state, 736, ScalarInteger(main_model_p->dim_in_I25_2));
  SET_VECTOR_ELT(state, 737, allocVector(REALSXP, main_model_p->dim_in_I25));
  memcpy(REAL(VECTOR_ELT(state, 737)), main_model_p->in_I25, main_model_p->dim_in_I25 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 737), 2, main_model_p->dim_in_I25_1, main_model_p->dim_in_I25_2);
  SET_VECTOR_ELT(state, 738, ScalarInteger(main_model_p->dim_in_I32));
  SET_VECTOR_ELT(state, 739, ScalarInteger(main_model_p->dim_in_I32_1));
  SET_VECTOR_ELT(state, 740, ScalarInteger(main_model_p->dim_in_I32_2));
  SET_VECTOR_ELT(state, 741, allocVector(REALSXP, main_model_p->dim_in_I32));
  memcpy(REAL(VECTOR_ELT(state, 741)), main_model_p->in_I32, main_model_p->dim_in_I32 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 741), 2, main_model_p->dim_in_I32_1, main_model_p->dim_in_I32_2);
  SET_VECTOR_ELT(state, 742, ScalarInteger(main_model_p->dim_in_I33));
  SET_VECTOR_ELT(state, 743, ScalarInteger(main_model_p->dim_in_I33_1));
  SET_VECTOR_ELT(state, 744, ScalarInteger(main_model_p->dim_in_I33_2));
  SET_VECTOR_ELT(state, 745, allocVector(REALSXP, main_model_p->dim_in_I33));
  memcpy(REAL(VECTOR_ELT(state, 745)), main_model_p->in_I33, main_model_p->dim_in_I33 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 745), 2, main_model_p->dim_in_I33_1, main_model_p->dim_in_I33_2);
  SET_VECTOR_ELT(state, 746, ScalarInteger(main_model_p->dim_in_I34));
  SET_VECTOR_ELT(state, 747, ScalarInteger(main_model_p->dim_in_I34_1));
  SET_VECTOR_ELT(state, 748, ScalarInteger(main_model_p->dim_in_I34_2));
  SET_VECTOR_ELT(state, 749, allocVector(REALSXP, main_model_p->dim_in_I34));
  memcpy(REAL(VECTOR_ELT(state, 749)), main_model_p->in_I34, main_model_p->dim_in_I34 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 749), 2, main_model_p->dim_in_I34_1, main_model_p->dim_in_I34_2);
  SET_VECTOR_ELT(state, 750, ScalarInteger(main_model_p->dim_in_I35));
  SET_VECTOR_ELT(state, 751, ScalarInteger(main_model_p->dim_in_I35_1));
  SET_VECTOR_ELT(state, 752, ScalarInteger(main_model_p->dim_in_I35_2));
  SET_VECTOR_ELT(state, 753, allocVector(REALSXP, main_model_p->dim_in_I35));
  memcpy(REAL(VECTOR_ELT(state, 753)), main_model_p->in_I35, main_model_p->dim_in_I35 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 753), 2, main_model_p->dim_in_I35_1, main_model_p->dim_in_I35_2);
  SET_VECTOR_ELT(state, 754, ScalarInteger(main_model_p->dim_in_I42));
  SET_VECTOR_ELT(state, 755, ScalarInteger(main_model_p->dim_in_I42_1));
  SET_VECTOR_ELT(state, 756, ScalarInteger(main_model_p->dim_in_I42_2));
  SET_VECTOR_ELT(state, 757, allocVector(REALSXP, main_model_p->dim_in_I42));
  memcpy(REAL(VECTOR_ELT(state, 757)), main_model_p->in_I42, main_model_p->dim_in_I42 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 757), 2, main_model_p->dim_in_I42_1, main_model_p->dim_in_I42_2);
  SET_VECTOR_ELT(state, 758, ScalarInteger(main_model_p->dim_in_I43));
  SET_VECTOR_ELT(state, 759, ScalarInteger(main_model_p->dim_in_I43_1));
  SET_VECTOR_ELT(state, 760, ScalarInteger(main_model_p->dim_in_I43_2));
  SET_VECTOR_ELT(state, 761, allocVector(REALSXP, main_model_p->dim_in_I43));
  memcpy(REAL(VECTOR_ELT(state, 761)), main_model_p->in_I43, main_model_p->dim_in_I43 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 761), 2, main_model_p->dim_in_I43_1, main_model_p->dim_in_I43_2);
  SET_VECTOR_ELT(state, 762, ScalarInteger(main_model_p->dim_in_I44));
  SET_VECTOR_ELT(state, 763, ScalarInteger(main_model_p->dim_in_I44_1));
  SET_VECTOR_ELT(state, 764, ScalarInteger(main_model_p->dim_in_I44_2));
  SET_VECTOR_ELT(state, 765, allocVector(REALSXP, main_model_p->dim_in_I44));
  memcpy(REAL(VECTOR_ELT(state, 765)), main_model_p->in_I44, main_model_p->dim_in_I44 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 765), 2, main_model_p->dim_in_I44_1, main_model_p->dim_in_I44_2);
  SET_VECTOR_ELT(state, 766, ScalarInteger(main_model_p->dim_in_I45));
  SET_VECTOR_ELT(state, 767, ScalarInteger(main_model_p->dim_in_I45_1));
  SET_VECTOR_ELT(state, 768, ScalarInteger(main_model_p->dim_in_I45_2));
  SET_VECTOR_ELT(state, 769, allocVector(REALSXP, main_model_p->dim_in_I45));
  memcpy(REAL(VECTOR_ELT(state, 769)), main_model_p->in_I45, main_model_p->dim_in_I45 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 769), 2, main_model_p->dim_in_I45_1, main_model_p->dim_in_I45_2);
  SET_VECTOR_ELT(state, 770, ScalarInteger(main_model_p->dim_rate_move_in));
  SET_VECTOR_ELT(state, 771, ScalarInteger(main_model_p->dim_rate_move_in_1));
  SET_VECTOR_ELT(state, 772, ScalarInteger(main_model_p->dim_rate_move_in_2));
  SET_VECTOR_ELT(state, 773, allocVector(REALSXP, main_model_p->dim_rate_move_in));
  memcpy(REAL(VECTOR_ELT(state, 773)), main_model_p->rate_move_in, main_model_p->dim_rate_move_in * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 773), 2, main_model_p->dim_rate_move_in_1, main_model_p->dim_rate_move_in_2);
  SET_VECTOR_ELT(state, 774, ScalarInteger(main_model_p->offset_output_rate_move_in));
  SET_VECTOR_ELT(state, 775, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_VECTOR_ELT(state, 776, allocVector(REALSXP, main_model_p->dim_rate_move_out));
  memcpy(REAL(VECTOR_ELT(state, 776)), main_model_p->rate_move_out, main_model_p->dim_rate_move_out * sizeof(double));
  SET_VECTOR_ELT(state, 777, ScalarInteger(main_model_p->offset_output_rate_move_out));
  SET_VECTOR_ELT(state, 781, ScalarReal(main_model_p->ART_eligible_CD4_above_500));
  SET_VECTOR_ELT(state, 783, ScalarReal(main_model_p->ART_eligible_CD4_350_500));
  SET_VECTOR_ELT(state, 785, ScalarReal(main_model_p->ART_eligible_CD4_200_349));
  SET_VECTOR_ELT(state, 787, ScalarReal(main_model_p->ART_eligible_CD4_below_200));
  SET_VECTOR_ELT(state, 793, ScalarReal(main_model_p->epsilon));
  SET_VECTOR_ELT(state, 801, ScalarInteger(main_model_p->dim));
  SET_VECTOR_ELT(state, 802, ScalarInteger(main_model_p->dim_output));
  SEXP state_names = PROTECT(allocVector(STRSXP, 803));
  ...
  SET_STRING_ELT(state_names, 234, mkChar("dim_cumuARTinitiations_not_TasP"));
  SET_STRING_ELT(state_names, 235, mkChar("initial_cumuARTinitiations_not_TasP"));
  SET_STRING_ELT(state_names, 236, mkChar("offset_cumuARTinitiations_not_TasP"));
  SET_STRING_ELT(state_names, 237, mkChar("dim_cumu_PrEP_dropouts"));
  SET_STRING_ELT(state_names, 238, mkChar("initial_cumu_PrEP_dropouts"));
  SET_STRING_ELT(state_names, 239, mkChar("offset_cumu_PrEP_dropouts"));
  SET_STRING_ELT(state_names, 240, mkChar("dim_S0_infections"));
  SET_STRING_ELT(state_names, 241, mkChar("initial_S0_infections"));
  SET_STRING_ELT(state_names, 242, mkChar("offset_S0_infections"));
  SET_STRING_ELT(state_names, 243, mkChar("dim_S1a_infections"));
  SET_STRING_ELT(state_names, 244, mkChar("initial_S1a_infections"));
  SET_STRING_ELT(state_names, 245, mkChar("offset_S1a_infections"));
  SET_STRING_ELT(state_names, 246, mkChar("dim_S1b_infections"));
  SET_STRING_ELT(state_names, 247, mkChar("initial_S1b_infections"));
  SET_STRING_ELT(state_names, 248, mkChar("offset_S1b_infections"));
  SET_STRING_ELT(state_names, 249, mkChar("dim_S1c_infections"));
  SET_STRING_ELT(state_names, 250, mkChar("initial_S1c_infections"));
  SET_STRING_ELT(state_names, 251, mkChar("offset_S1c_infections"));
  SET_STRING_ELT(state_names, 252, mkChar("dim_S1d_infections"));
  SET_STRING_ELT(state_names, 253, mkChar("initial_S1d_infections"));
  SET_STRING_ELT(state_names, 254, mkChar("offset_S1d_infections"));
  SET_STRING_ELT(state_names, 255, mkChar("dim_frac_F"));
  SET_STRING_ELT(state_names, 256, mkChar("frac_F"));
  SET_STRING_ELT(state_names, 257, mkChar("offset_output_frac_F"));
  SET_STRING_ELT(state_names, 258, mkChar("dim_frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 259, mkChar("frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 260, mkChar("offset_output_frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 261, mkChar("dim_ART_coverage"));
  SET_STRING_ELT(state_names, 262, mkChar("ART_coverage"));
  SET_STRING_ELT(state_names, 263, mkChar("offset_output_ART_coverage"));
  SET_STRING_ELT(state_names, 264, mkChar("dim_infect_ART"));
  SET_STRING_ELT(state_names, 265, mkChar("infect_ART"));
  SET_STRING_ELT(state_names, 266, mkChar("offset_output_infect_ART"));
  SET_STRING_ELT(state_names, 267, mkChar("dim_prep_offered"));
  SET_STRING_ELT(state_names, 268, mkChar("prep_offered"));
  SET_STRING_ELT(state_names, 269, mkChar("offset_output_prep_offered"));
  SET_STRING_ELT(state_names, 270, mkChar("dim_omega"));
  SET_STRING_ELT(state_names, 271, mkChar("omega"));
  SET_STRING_ELT(state_names, 272, mkChar("offset_output_omega"));
  SET_STRING_ELT(state_names, 273, mkChar("dim_frac_N"));
  SET_STRING_ELT(state_names, 274, mkChar("frac_N"));
  SET_STRING_ELT(state_names, 275, mkChar("offset_output_frac_N"));
  SET_STRING_ELT(state_names, 276, mkChar("dim_mu"));
  SET_STRING_ELT(state_names, 277, mkChar("mu"));
  SET_STRING_ELT(state_names, 278, mkChar("offset_output_mu"));
  SET_STRING_ELT(state_names, 279, mkChar("dim_gamma01"));
  SET_STRING_ELT(state_names, 280, mkChar("gamma01"));
  SET_STRING_ELT(state_names, 281, mkChar("offset_output_gamma01"));
  SET_STRING_ELT(state_names, 282, mkChar("dim_gamma02"));
  SET_STRING_ELT(state_names, 283, mkChar("gamma02"));
  SET_STRING_ELT(state_names, 284, mkChar("dim_gamma03"));
  SET_STRING_ELT(state_names, 285, mkChar("gamma03"));
  SET_STRING_ELT(state_names, 286, mkChar("dim_gamma04"));
  SET_STRING_ELT(state_names, 287, mkChar("gamma04"));
  SET_STRING_ELT(state_names, 288, mkChar("dim_gamma11"));
  SET_STRING_ELT(state_names, 289, mkChar("gamma11"));
  SET_STRING_ELT(state_names, 290, mkChar("offset_output_gamma11"));
  SET_STRING_ELT(state_names, 291, mkChar("dim_gamma22"));
  SET_STRING_ELT(state_names, 292, mkChar("gamma22"));
  SET_STRING_ELT(state_names, 293, mkChar("dim_gamma23"));
  SET_STRING_ELT(state_names, 294, mkChar("gamma23"));
  SET_STRING_ELT(state_names, 295, mkChar("dim_gamma24"));
  SET_STRING_ELT(state_names, 296, mkChar("gamma24"));
  SET_STRING_ELT(state_names, 297, mkChar("dim_gamma32"));
  SET_STRING_ELT(state_names, 298, mkChar("gamma32"));
  SET_STRING_ELT(state_names, 299, mkChar("dim_gamma33"));
  SET_STRING_ELT(state_names, 300, mkChar("gamma33"));
  SET_STRING_ELT(state_names, 301, mkChar("dim_gamma34"));
  SET_STRING_ELT(state_names, 302, mkChar("gamma34"));
  SET_STRING_ELT(state_names, 303, mkChar("dim_gamma42"));
  SET_STRING_ELT(state_names, 304, mkChar("gamma42"));
  SET_STRING_ELT(state_names, 305, mkChar("dim_gamma43"));
  SET_STRING_ELT(state_names, 306, mkChar("gamma43"));
  SET_STRING_ELT(state_names, 307, mkChar("dim_gamma44"));
  SET_STRING_ELT(state_names, 308, mkChar("gamma44"));
  SET_STRING_ELT(state_names, 309, mkChar("dim_phi2"));
  SET_STRING_ELT(state_names, 310, mkChar("phi2"));
  SET_STRING_ELT(state_names, 311, mkChar("dim_phi3"));
  SET_STRING_ELT(state_names, 312, mkChar("phi3"));
  SET_STRING_ELT(state_names, 313, mkChar("dim_phi4"));
  SET_STRING_ELT(state_names, 314, mkChar("phi4"));
  SET_STRING_ELT(state_names, 315, mkChar("dim_phi5"));
  SET_STRING_ELT(state_names, 316, mkChar("phi5"));
  SET_STRING_ELT(state_names, 317, mkChar("dim_psia"));
  SET_STRING_ELT(state_names, 318, mkChar("psia"));
  SET_STRING_ELT(state_names, 319, mkChar("dim_psib"));
  SET_STRING_ELT(state_names, 320, mkChar("psib"));
  SET_STRING_ELT(state_names, 321, mkChar("dim_kappaa"));
  SET_STRING_ELT(state_names, 322, mkChar("kappaa"));
  SET_STRING_ELT(state_names, 323, mkChar("offset_output_kappaa"));
  SET_STRING_ELT(state_names, 324, mkChar("dim_kappab"));
  SET_STRING_ELT(state_names, 325, mkChar("kappab"));
  SET_STRING_ELT(state_names, 326, mkChar("offset_output_kappab"));
  SET_STRING_ELT(state_names, 327, mkChar("dim_kappac"));
  SET_STRING_ELT(state_names, 328, mkChar("kappac"));
  SET_STRING_ELT(state_names, 329, mkChar("offset_output_kappac"));
  SET_STRING_ELT(state_names, 330, mkChar("dim_kappa1"));
  SET_STRING_ELT(state_names, 331, mkChar("kappa1"));
  SET_STRING_ELT(state_names, 332, mkChar("offset_output_kappa1"));
  SET_STRING_ELT(state_names, 333, mkChar("dim_alpha01"));
  SET_STRING_ELT(state_names, 334, mkChar("alpha01"));
  SET_STRING_ELT(state_names, 335, mkChar("offset_output_alpha01"));
  SET_STRING_ELT(state_names, 336, mkChar("dim_alpha02"));
  SET_STRING_ELT(state_names, 337, mkChar("alpha02"));
  SET_STRING_ELT(state_names, 338, mkChar("offset_output_alpha02"));
  SET_STRING_ELT(state_names, 339, mkChar("dim_alpha03"));
  SET_STRING_ELT(state_names, 340, mkChar("alpha03"));
  SET_STRING_ELT(state_names, 341, mkChar("dim_alpha04"));
  SET_STRING_ELT(state_names, 342, mkChar("alpha04"));
  SET_STRING_ELT(state_names, 343, mkChar("dim_alpha05"));
  SET_STRING_ELT(state_names, 344, mkChar("alpha05"));
  SET_STRING_ELT(state_names, 345, mkChar("offset_output_alpha05"));
  SET_STRING_ELT(state_names, 346, mkChar("dim_alpha11"));
  SET_STRING_ELT(state_names, 347, mkChar("alpha11"));
  SET_STRING_ELT(state_names, 348, mkChar("offset_output_alpha11"));
  SET_STRING_ELT(state_names, 349, mkChar("dim_alpha22"));
  SET_STRING_ELT(state_names, 350, mkChar("alpha22"));
  SET_STRING_ELT(state_names, 351, mkChar("offset_output_alpha22"));
  SET_STRING_ELT(state_names, 352, mkChar("dim_alpha23"));
  SET_STRING_ELT(state_names, 353, mkChar("alpha23"));
  SET_STRING_ELT(state_names, 354, mkChar("dim_alpha24"));
  SET_STRING_ELT(state_names, 355, mkChar("alpha24"));
  SET_STRING_ELT(state_names, 356, mkChar("dim_alpha25"));
  SET_STRING_ELT(state_names, 357, mkChar("alpha25"));
  SET_STRING_ELT(state_names, 358, mkChar("dim_alpha32"));
  SET_STRING_ELT(state_names, 359, mkChar("alpha32"));
  SET_STRING_ELT(state_names, 360, mkChar("dim_alpha33"));
  SET_STRING_ELT(state_names, 361, mkChar("alpha33"));
  SET_STRING_ELT(state_names, 362, mkChar("dim_alpha34"));
  SET_STRING_ELT(state_names, 363, mkChar("alpha34"));
  SET_STRING_ELT(state_names, 364, mkChar("dim_alpha35"));
  SET_STRING_ELT(state_names, 365, mkChar("alpha35"));
  SET_STRING_ELT(state_names, 366, mkChar("offset_output_alpha35"));
  SET_STRING_ELT(state_names, 367, mkChar("dim_alpha42"));
  SET_STRING_ELT(state_names, 368, mkChar("alpha42"));
  SET_STRING_ELT(state_names, 369, mkChar("dim_alpha43"));
  SET_STRING_ELT(state_names, 370, mkChar("alpha43"));
  SET_STRING_ELT(state_names, 371, mkChar("dim_alpha44"));
  SET_STRING_ELT(state_names, 372, mkChar("alpha44"));
  SET_STRING_ELT(state_names, 373, mkChar("dim_alpha45"));
  SET_STRING_ELT(state_names, 374, mkChar("alpha45"));
  SET_STRING_ELT(state_names, 375, mkChar("dim_beta_comm"));
  SET_STRING_ELT(state_names, 376, mkChar("beta_comm"));
  SET_STRING_ELT(state_names, 377, mkChar("offset_output_beta_comm"));
  SET_STRING_ELT(state_names, 378, mkChar("dim_beta_noncomm"));
  SET_STRING_ELT(state_names, 379, mkChar("beta_noncomm"));
  SET_STRING_ELT(state_names, 380, mkChar("offset_output_beta_noncomm"));
  SET_STRING_ELT(state_names, 381, mkChar("dim_p_comm"));
  SET_STRING_ELT(state_names, 382, mkChar("dim_p_comm_1"));
  SET_STRING_ELT(state_names, 383, mkChar("dim_p_comm_2"));
  SET_STRING_ELT(state_names, 384, mkChar("p_comm"));
  SET_STRING_ELT(state_names, 385, mkChar("offset_output_p_comm"));
  SET_STRING_ELT(state_names, 386, mkChar("dim_p_noncomm"));
  SET_STRING_ELT(state_names, 387, mkChar("dim_p_noncomm_1"));
  SET_STRING_ELT(state_names, 388, mkChar("dim_p_noncomm_2"));
  SET_STRING_ELT(state_names, 389, mkChar("p_noncomm"));
  SET_STRING_ELT(state_names, 390, mkChar("offset_output_p_noncomm"));
  SET_STRING_ELT(state_names, 391, mkChar("dim_ec"));
  SET_STRING_ELT(state_names, 392, mkChar("ec"));
  SET_STRING_ELT(state_names, 393, mkChar("dim_eP"));
  SET_STRING_ELT(state_names, 394, mkChar("eP"));
  SET_STRING_ELT(state_names, 395, mkChar("dim_eP0"));
  SET_STRING_ELT(state_names, 396, mkChar("eP0"));
  SET_STRING_ELT(state_names, 397, mkChar("offset_output_eP0"));
  SET_STRING_ELT(state_names, 398, mkChar("dim_eP1a"));
  SET_STRING_ELT(state_names, 399, mkChar("eP1a"));
  SET_STRING_ELT(state_names, 400, mkChar("offset_output_eP1a"));
  SET_STRING_ELT(state_names, 401, mkChar("dim_eP1b"));
  SET_STRING_ELT(state_names, 402, mkChar("eP1b"));
  SET_STRING_ELT(state_names, 403, mkChar("offset_output_eP1b"));
  SET_STRING_ELT(state_names, 404, mkChar("dim_eP1c"));
  SET_STRING_ELT(state_names, 405, mkChar("eP1c"));
  SET_STRING_ELT(state_names, 406, mkChar("offset_output_eP1c"));
  SET_STRING_ELT(state_names, 407, mkChar("dim_eP1d"));
  SET_STRING_ELT(state_names, 408, mkChar("eP1d"));
  SET_STRING_ELT(state_names, 409, mkChar("offset_output_eP1d"));
  SET_STRING_ELT(state_names, 410, mkChar("dim_fc_comm"));
  SET_STRING_ELT(state_names, 411, mkChar("dim_fc_comm_1"));
  SET_STRING_ELT(state_names, 412, mkChar("dim_fc_comm_2"));
  SET_STRING_ELT(state_names, 413, mkChar("fc_comm"));
  SET_STRING_ELT(state_names, 414, mkChar("offset_output_fc_comm"));
  SET_STRING_ELT(state_names, 415, mkChar("dim_fP_comm"));
  SET_STRING_ELT(state_names, 416, mkChar("fP_comm"));
  SET_STRING_ELT(state_names, 417, mkChar("offset_output_fP_comm"));
  SET_STRING_ELT(state_names, 418, mkChar("dim_fc_noncomm"));
  SET_STRING_ELT(state_names, 419, mkChar("dim_fc_noncomm_1"));
  SET_STRING_ELT(state_names, 420, mkChar("dim_fc_noncomm_2"));
  SET_STRING_ELT(state_names, 421, mkChar("fc_noncomm"));
  SET_STRING_ELT(state_names, 422, mkChar("offset_output_fc_noncomm"));
  SET_STRING_ELT(state_names, 423, mkChar("dim_fP_noncomm"));
  SET_STRING_ELT(state_names, 424, mkChar("fP_noncomm"));
  SET_STRING_ELT(state_names, 425, mkChar("offset_output_fP_noncomm"));
  SET_STRING_ELT(state_names, 426, mkChar("dim_n_comm"));
  SET_STRING_ELT(state_names, 427, mkChar("dim_n_comm_1"));
  SET_STRING_ELT(state_names, 428, mkChar("dim_n_comm_2"));
  SET_STRING_ELT(state_names, 429, mkChar("n_comm"));
  SET_STRING_ELT(state_names, 430, mkChar("offset_output_n_comm"));
  SET_STRING_ELT(state_names, 431, mkChar("dim_n_noncomm"));
  SET_STRING_ELT(state_names, 432, mkChar("dim_n_noncomm_1"));
  SET_STRING_ELT(state_names, 433, mkChar("dim_n_noncomm_2"));
  SET_STRING_ELT(state_names, 434, mkChar("n_noncomm"));
  SET_STRING_ELT(state_names, 435, mkChar("offset_output_n_noncomm"));
  SET_STRING_ELT(state_names, 436, mkChar("dim_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 437, mkChar("initial_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 438, mkChar("offset_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 439, mkChar("dim_cumuARTinitiations"));
  SET_STRING_ELT(state_names, 440, mkChar("initial_cumuARTinitiations"));
  SET_STRING_ELT(state_names, 441, mkChar("offset_cumuARTinitiations"));
  SET_STRING_ELT(state_names, 442, mkChar("dim_TasPinitiations"));
  SET_STRING_ELT(state_names, 443, mkChar("initial_TasPinitiations"));
  SET_STRING_ELT(state_names, 444, mkChar("offset_TasPinitiations"));
  SET_STRING_ELT(state_names, 445, mkChar("dim_cumuARTREinitiations"));
  SET_STRING_ELT(state_names, 446, mkChar("initial_cumuARTREinitiations"));
  SET_STRING_ELT(state_names, 447, mkChar("offset_cumuARTREinitiations"));
  SET_STRING_ELT(state_names, 448, mkChar("dim_dropouts"));
  SET_STRING_ELT(state_names, 449, mkChar("initial_dropouts"));
  SET_STRING_ELT(state_names, 450, mkChar("offset_dropouts"));
  SET_STRING_ELT(state_names, 451, mkChar("dim_cumuAllDeaths"));
  SET_STRING_ELT(state_names, 452, mkChar("initial_cumuAllDeaths"));
  SET_STRING_ELT(state_names, 453, mkChar("offset_cumuAllDeaths"));
  SET_STRING_ELT(state_names, 454, mkChar("dim_cumuInf"));
  SET_STRING_ELT(state_names, 455, mkChar("initial_cumuInf"));
  SET_STRING_ELT(state_names, 456, mkChar("offset_cumuInf"));
  SET_STRING_ELT(state_names, 457, mkChar("dim_PrEPinitiations"));
  SET_STRING_ELT(state_names, 458, mkChar("initial_PrEPinitiations"));
  SET_STRING_ELT(state_names, 459, mkChar("offset_PrEPinitiations"));
  SET_STRING_ELT(state_names, 460, mkChar("dim_PrEPinitiations1a"));
  SET_STRING_ELT(state_names, 461, mkChar("initial_PrEPinitiations1a"));
  SET_STRING_ELT(state_names, 462, mkChar("offset_PrEPinitiations1a"));
  SET_STRING_ELT(state_names, 463, mkChar("dim_PrEPinitiations1b"));
  SET_STRING_ELT(state_names, 464, mkChar("initial_PrEPinitiations1b"));
  SET_STRING_ELT(state_names, 465, mkChar("offset_PrEPinitiations1b"));
  SET_STRING_ELT(state_names, 466, mkChar("dim_PrEPinitiations1c"));
  SET_STRING_ELT(state_names, 467, mkChar("initial_PrEPinitiations1c"));
  SET_STRING_ELT(state_names, 468, mkChar("offset_PrEPinitiations1c"));
  SET_STRING_ELT(state_names, 469, mkChar("dim_S0"));
  SET_STRING_ELT(state_names, 470, mkChar("initial_S0"));
  SET_STRING_ELT(state_names, 471, mkChar("offset_S0"));
  SET_STRING_ELT(state_names, 472, mkChar("dim_S1a"));
  SET_STRING_ELT(state_names, 473, mkChar("initial_S1a"));
  SET_STRING_ELT(state_names, 474, mkChar("offset_S1a"));
  SET_STRING_ELT(state_names, 475, mkChar("dim_S1b"));
  SET_STRING_ELT(state_names, 476, mkChar("initial_S1b"));
  SET_STRING_ELT(state_names, 477, mkChar("offset_S1b"));
  SET_STRING_ELT(state_names, 478, mkChar("dim_S1c"));
  SET_STRING_ELT(state_names, 479, mkChar("initial_S1c"));
  SET_STRING_ELT(state_names, 480, mkChar("offset_S1c"));
  SET_STRING_ELT(state_names, 481, mkChar("dim_S1d"));
  SET_STRING_ELT(state_names, 482, mkChar("initial_S1d"));
  SET_STRING_ELT(state_names, 483, mkChar("offset_S1d"));
  SET_STRING_ELT(state_names, 484, mkChar("dim_I01"));
  SET_STRING_ELT(state_names, 485, mkChar("initial_I01"));
  SET_STRING_ELT(state_names, 486, mkChar("offset_I01"));
  SET_STRING_ELT(state_names, 487, mkChar("dim_I11"));
  SET_STRING_ELT(state_names, 488, mkChar("initial_I11"));
  SET_STRING_ELT(state_names, 489, mkChar("offset_I11"));
  SET_STRING_ELT(state_names, 490, mkChar("dim_I02"));
  SET_STRING_ELT(state_names, 491, mkChar("initial_I02"));
  SET_STRING_ELT(state_names, 492, mkChar("offset_I02"));
  SET_STRING_ELT(state_names, 493, mkChar("dim_I03"));
  SET_STRING_ELT(state_names, 494, mkChar("initial_I03"));
  SET_STRING_ELT(state_names, 495, mkChar("offset_I03"));
  SET_STRING_ELT(state_names, 496, mkChar("dim_I04"));
  SET_STRING_ELT(state_names, 497, mkChar("initial_I04"));
  SET_STRING_ELT(state_names, 498, mkChar("offset_I04"));
  SET_STRING_ELT(state_names, 499, mkChar("dim_I05"));
  SET_STRING_ELT(state_names, 500, mkChar("initial_I05"));
  SET_STRING_ELT(state_names, 501, mkChar("offset_I05"));
  SET_STRING_ELT(state_names, 502, mkChar("dim_I22"));
  SET_STRING_ELT(state_names, 503, mkChar("initial_I22"));
  SET_STRING_ELT(state_names, 504, mkChar("offset_I22"));
  SET_STRING_ELT(state_names, 505, mkChar("dim_I23"));
  SET_STRING_ELT(state_names, 506, mkChar("initial_I23"));
  SET_STRING_ELT(state_names, 507, mkChar("offset_I23"));
  SET_STRING_ELT(state_names, 508, mkChar("dim_I24"));
  SET_STRING_ELT(state_names, 509, mkChar("initial_I24"));
  SET_STRING_ELT(state_names, 510, mkChar("offset_I24"));
  SET_STRING_ELT(state_names, 511, mkChar("dim_I25"));
  SET_STRING_ELT(state_names, 512, mkChar("initial_I25"));
  SET_STRING_ELT(state_names, 513, mkChar("offset_I25"));
  SET_STRING_ELT(state_names, 514, mkChar("dim_I32"));
  SET_STRING_ELT(state_names, 515, mkChar("initial_I32"));
  SET_STRING_ELT(state_names, 516, mkChar("offset_I32"));
  SET_STRING_ELT(state_names, 517, mkChar("dim_I33"));
  SET_STRING_ELT(state_names, 518, mkChar("initial_I33"));
  SET_STRING_ELT(state_names, 519, mkChar("offset_I33"));
  SET_STRING_ELT(state_names, 520, mkChar("dim_I34"));
  SET_STRING_ELT(state_names, 521, mkChar("initial_I34"));
  SET_STRING_ELT(state_names, 522, mkChar("offset_I34"));
  SET_STRING_ELT(state_names, 523, mkChar("dim_I35"));
  SET_STRING_ELT(state_names, 524, mkChar("initial_I35"));
  SET_STRING_ELT(state_names, 525, mkChar("offset_I35"));
  SET_STRING_ELT(state_names, 526, mkChar("dim_I42"));
  SET_STRING_ELT(state_names, 527, mkChar("initial_I42"));
  SET_STRING_ELT(state_names, 528, mkChar("offset_I42"));
  SET_STRING_ELT(state_names, 529, mkChar("dim_I43"));
  SET_STRING_ELT(state_names, 530, mkChar("initial_I43"));
  SET_STRING_ELT(state_names, 531, mkChar("offset_I43"));
  SET_STRING_ELT(state_names, 532, mkChar("dim_I44"));
  SET_STRING_ELT(state_names, 533, mkChar("initial_I44"));
  SET_STRING_ELT(state_names, 534, mkChar("offset_I44"));
  SET_STRING_ELT(state_names, 535, mkChar("dim_I45"));
  SET_STRING_ELT(state_names, 536, mkChar("initial_I45"));
  SET_STRING_ELT(state_names, 537, mkChar("offset_I45"));
  SET_STRING_ELT(state_names, 538, mkChar("dim_S0_init"));
  SET_STRING_ELT(state_names, 539, mkChar("S0_init"));
  SET_STRING_ELT(state_names, 540, mkChar("dim_S1a_init"));
  SET_STRING_ELT(state_names, 541, mkChar("S1a_init"));
  SET_STRING_ELT(state_names, 542, mkChar("dim_S1b_init"));
  SET_STRING_ELT(state_names, 543, mkChar("S1b_init"));
  SET_STRING_ELT(state_names, 544, mkChar("dim_S1c_init"));
  SET_STRING_ELT(state_names, 545, mkChar("S1c_init"));
  SET_STRING_ELT(state_names, 546, mkChar("dim_S1d_init"));
  SET_STRING_ELT(state_names, 547, mkChar("S1d_init"));
  SET_STRING_ELT(state_names, 548, mkChar("dim_I01_init"));
  SET_STRING_ELT(state_names, 549, mkChar("I01_init"));
  SET_STRING_ELT(state_names, 550, mkChar("dim_I11_init"));
  SET_STRING_ELT(state_names, 551, mkChar("I11_init"));
  SET_STRING_ELT(state_names, 552, mkChar("dim_I02_init"));
  SET_STRING_ELT(state_names, 553, mkChar("I02_init"));
  SET_STRING_ELT(state_names, 554, mkChar("dim_I03_init"));
  SET_STRING_ELT(state_names, 555, mkChar("I03_init"));
  SET_STRING_ELT(state_names, 556, mkChar("dim_I04_init"));
  SET_STRING_ELT(state_names, 557, mkChar("I04_init"));
  SET_STRING_ELT(state_names, 558, mkChar("dim_I05_init"));
  SET_STRING_ELT(state_names, 559, mkChar("I05_init"));
  SET_STRING_ELT(state_names, 560, mkChar("dim_I22_init"));
  SET_STRING_ELT(state_names, 561, mkChar("I22_init"));
  SET_STRING_ELT(state_names, 562, mkChar("dim_I23_init"));
  SET_STRING_ELT(state_names, 563, mkChar("I23_init"));
  SET_STRING_ELT(state_names, 564, mkChar("dim_I24_init"));
  SET_STRING_ELT(state_names, 565, mkChar("I24_init"));
  SET_STRING_ELT(state_names, 566, mkChar("dim_I25_init"));
  SET_STRING_ELT(state_names, 567, mkChar("I25_init"));
  SET_STRING_ELT(state_names, 568, mkChar("dim_I32_init"));
  SET_STRING_ELT(state_names, 569, mkChar("I32_init"));
  SET_STRING_ELT(state_names, 570, mkChar("dim_I33_init"));
  SET_STRING_ELT(state_names, 571, mkChar("I33_init"));
  SET_STRING_ELT(state_names, 572, mkChar("dim_I34_init"));
  SET_STRING_ELT(state_names, 573, mkChar("I34_init"));
  SET_STRING_ELT(state_names, 574, mkChar("dim_I35_init"));
  SET_STRING_ELT(state_names, 575, mkChar("I35_init"));
  SET_STRING_ELT(state_names, 576, mkChar("dim_I42_init"));
  SET_STRING_ELT(state_names, 577, mkChar("I42_init"));
  SET_STRING_ELT(state_names, 578, mkChar("dim_I43_init"));
  SET_STRING_ELT(state_names, 579, mkChar("I43_init"));
  SET_STRING_ELT(state_names, 580, mkChar("dim_I44_init"));
  SET_STRING_ELT(state_names, 581, mkChar("I44_init"));
  SET_STRING_ELT(state_names, 582, mkChar("dim_I45_init"));
  SET_STRING_ELT(state_names, 583, mkChar("I45_init"));
  SET_STRING_ELT(state_names, 584, mkChar("dim_N"));
  SET_STRING_ELT(state_names, 585, mkChar("N"));
  SET_STRING_ELT(state_names, 586, mkChar("offset_output_N"));
  SET_STRING_ELT(state_names, 587, mkChar("dim_E0"));
  SET_STRING_ELT(state_names, 588, mkChar("E0"));
  SET_STRING_ELT(state_names, 589, mkChar("offset_output_E0"));
  SET_STRING_ELT(state_names, 590, mkChar("dim_E1a"));
  SET_STRING_ELT(state_names, 591, mkChar("E1a"));
  SET_STRING_ELT(state_names, 592, mkChar("offset_output_E1a"));
  SET_STRING_ELT(state_names, 593, mkChar("dim_E1b"));
  SET_STRING_ELT(state_names, 594, mkChar("E1b"));
  SET_STRING_ELT(state_names, 595, mkChar("offset_output_E1b"));
  SET_STRING_ELT(state_names, 596, mkChar("dim_E1c"));
  SET_STRING_ELT(state_names, 597, mkChar("E1c"));
  SET_STRING_ELT(state_names, 598, mkChar("offset_output_E1c"));
  SET_STRING_ELT(state_names, 599, mkChar("dim_E1d"));
  SET_STRING_ELT(state_names, 600, mkChar("E1d"));
  SET_STRING_ELT(state_names, 601, mkChar("offset_output_E1d"));
  SET_STRING_ELT(state_names, 602, mkChar("dim_cumuInf_init"));
  SET_STRING_ELT(state_names, 603, mkChar("cumuInf_init"));
  SET_STRING_ELT(state_names, 604, mkChar("dim_alphaItot"));
  SET_STRING_ELT(state_names, 605, mkChar("alphaItot"));
  SET_STRING_ELT(state_names, 606, mkChar("offset_output_alphaItot"));
  SET_STRING_ELT(state_names, 607, mkChar("dim_prev"));
  SET_STRING_ELT(state_names, 608, mkChar("prev"));
  SET_STRING_ELT(state_names, 609, mkChar("offset_output_prev"));
  SET_STRING_ELT(state_names, 610, mkChar("dim_lambda"));
  SET_STRING_ELT(state_names, 611, mkChar("dim_lambda_1"));
  SET_STRING_ELT(state_names, 612, mkChar("dim_lambda_2"));
  SET_STRING_ELT(state_names, 613, mkChar("lambda"));
  SET_STRING_ELT(state_names, 614, mkChar("offset_output_lambda"));
  SET_STRING_ELT(state_names, 615, mkChar("dim_lambda_0"));
  SET_STRING_ELT(state_names, 616, mkChar("dim_lambda_0_1"));
  SET_STRING_ELT(state_names, 617, mkChar("dim_lambda_0_2"));
  SET_STRING_ELT(state_names, 618, mkChar("lambda_0"));
  SET_STRING_ELT(state_names, 619, mkChar("offset_output_lambda_0"));
  SET_STRING_ELT(state_names, 620, mkChar("dim_lambda_1a"));
  SET_STRING_ELT(state_names, 621, mkChar("dim_lambda_1a_1"));
  SET_STRING_ELT(state_names, 622, mkChar("dim_lambda_1a_2"));
  SET_STRING_ELT(state_names, 623, mkChar("lambda_1a"));
  SET_STRING_ELT(state_names, 624, mkChar("offset_output_lambda_1a"));
  SET_STRING_ELT(state_names, 625, mkChar("dim_lambda_1b"));
  SET_STRING_ELT(state_names, 626, mkChar("dim_lambda_1b_1"));
  SET_STRING_ELT(state_names, 627, mkChar("dim_lambda_1b_2"));
  SET_STRING_ELT(state_names, 628, mkChar("lambda_1b"));
  SET_STRING_ELT(state_names, 629, mkChar("offset_output_lambda_1b"));
  SET_STRING_ELT(state_names, 630, mkChar("dim_lambda_1c"));
  SET_STRING_ELT(state_names, 631, mkChar("dim_lambda_1c_1"));
  SET_STRING_ELT(state_names, 632, mkChar("dim_lambda_1c_2"));
  SET_STRING_ELT(state_names, 633, mkChar("lambda_1c"));
  SET_STRING_ELT(state_names, 634, mkChar("offset_output_lambda_1c"));
  SET_STRING_ELT(state_names, 635, mkChar("dim_lambda_1d"));
  SET_STRING_ELT(state_names, 636, mkChar("dim_lambda_1d_1"));
  SET_STRING_ELT(state_names, 637, mkChar("dim_lambda_1d_2"));
  SET_STRING_ELT(state_names, 638, mkChar("lambda_1d"));
  SET_STRING_ELT(state_names, 639, mkChar("offset_output_lambda_1d"));
  SET_STRING_ELT(state_names, 640, mkChar("dim_lambda_sum_0"));
  SET_STRING_ELT(state_names, 641, mkChar("lambda_sum_0"));
  SET_STRING_ELT(state_names, 642, mkChar("offset_output_lambda_sum_0"));
  SET_STRING_ELT(state_names, 643, mkChar("dim_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 644, mkChar("lambda_sum_1a"));
  SET_STRING_ELT(state_names, 645, mkChar("offset_output_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 646, mkChar("dim_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 647, mkChar("lambda_sum_1b"));
  SET_STRING_ELT(state_names, 648, mkChar("offset_output_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 649, mkChar("dim_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 650, mkChar("lambda_sum_1c"));
  SET_STRING_ELT(state_names, 651, mkChar("offset_output_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 652, mkChar("dim_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 653, mkChar("lambda_sum_1d"));
  SET_STRING_ELT(state_names, 654, mkChar("offset_output_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 655, mkChar("dim_c_comm_balanced"));
  SET_STRING_ELT(state_names, 656, mkChar("c_comm_balanced"));
  SET_STRING_ELT(state_names, 657, mkChar("offset_output_c_comm_balanced"));
  SET_STRING_ELT(state_names, 658, mkChar("dim_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 659, mkChar("c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 660, mkChar("offset_output_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 661, mkChar("dim_theta"));
  SET_STRING_ELT(state_names, 662, mkChar("dim_theta_1"));
  SET_STRING_ELT(state_names, 663, mkChar("dim_theta_2"));
  SET_STRING_ELT(state_names, 664, mkChar("theta"));
  SET_STRING_ELT(state_names, 665, mkChar("offset_output_theta"));
  SET_STRING_ELT(state_names, 666, mkChar("dim_PrEPinitiations_init"));
  SET_STRING_ELT(state_names, 667, mkChar("PrEPinitiations_init"));
  SET_STRING_ELT(state_names, 668, mkChar("dim_M_comm"));
  SET_STRING_ELT(state_names, 669, mkChar("dim_M_comm_1"));
  SET_STRING_ELT(state_names, 670, mkChar("dim_M_comm_2"));
  SET_STRING_ELT(state_names, 671, mkChar("M_comm"));
  SET_STRING_ELT(state_names, 672, mkChar("offset_output_M_comm"));
  SET_STRING_ELT(state_names, 673, mkChar("dim_M_noncomm"));
  SET_STRING_ELT(state_names, 674, mkChar("dim_M_noncomm_1"));
  SET_STRING_ELT(state_names, 675, mkChar("dim_M_noncomm_2"));
  SET_STRING_ELT(state_names, 676, mkChar("M_noncomm"));
  SET_STRING_ELT(state_names, 677, mkChar("offset_output_M_noncomm"));
  SET_STRING_ELT(state_names, 678, mkChar("dim_in_S0"));
  SET_STRING_ELT(state_names, 679, mkChar("dim_in_S0_1"));
  SET_STRING_ELT(state_names, 680, mkChar("dim_in_S0_2"));
  SET_STRING_ELT(state_names, 681, mkChar("in_S0"));
  SET_STRING_ELT(state_names, 682, mkChar("dim_in_S1a"));
  SET_STRING_ELT(state_names, 683, mkChar("dim_in_S1a_1"));
  SET_STRING_ELT(state_names, 684, mkChar("dim_in_S1a_2"));
  SET_STRING_ELT(state_names, 685, mkChar("in_S1a"));
  SET_STRING_ELT(state_names, 686, mkChar("dim_in_S1b"));
  SET_STRING_ELT(state_names, 687, mkChar("dim_in_S1b_1"));
  SET_STRING_ELT(state_names, 688, mkChar("dim_in_S1b_2"));
  SET_STRING_ELT(state_names, 689, mkChar("in_S1b"));
  SET_STRING_ELT(state_names, 690, mkChar("dim_in_S1c"));
  SET_STRING_ELT(state_names, 691, mkChar("dim_in_S1c_1"));
  SET_STRING_ELT(state_names, 692, mkChar("dim_in_S1c_2"));
  SET_STRING_ELT(state_names, 693, mkChar("in_S1c"));
  SET_STRING_ELT(state_names, 694, mkChar("dim_in_S1d"));
  SET_STRING_ELT(state_names, 695, mkChar("dim_in_S1d_1"));
  SET_STRING_ELT(state_names, 696, mkChar("dim_in_S1d_2"));
  SET_STRING_ELT(state_names, 697, mkChar("in_S1d"));
  SET_STRING_ELT(state_names, 698, mkChar("dim_in_I01"));
  SET_STRING_ELT(state_names, 699, mkChar("dim_in_I01_1"));
  SET_STRING_ELT(state_names, 700, mkChar("dim_in_I01_2"));
  SET_STRING_ELT(state_names, 701, mkChar("in_I01"));
  SET_STRING_ELT(state_names, 702, mkChar("dim_in_I11"));
  SET_STRING_ELT(state_names, 703, mkChar("dim_in_I11_1"));
  SET_STRING_ELT(state_names, 704, mkChar("dim_in_I11_2"));
  SET_STRING_ELT(state_names, 705, mkChar("in_I11"));
  SET_STRING_ELT(state_names, 706, mkChar("dim_in_I02"));
  SET_STRING_ELT(state_names, 707, mkChar("dim_in_I02_1"));
  SET_STRING_ELT(state_names, 708, mkChar("dim_in_I02_2"));
  SET_STRING_ELT(state_names, 709, mkChar("in_I02"));
  SET_STRING_ELT(state_names, 710, mkChar("dim_in_I03"));
  SET_STRING_ELT(state_names, 711, mkChar("dim_in_I03_1"));
  SET_STRING_ELT(state_names, 712, mkChar("dim_in_I03_2"));
  SET_STRING_ELT(state_names, 713, mkChar("in_I03"));
  SET_STRING_ELT(state_names, 714, mkChar("dim_in_I04"));
  SET_STRING_ELT(state_names, 715, mkChar("dim_in_I04_1"));
  SET_STRING_ELT(state_names, 716, mkChar("dim_in_I04_2"));
  SET_STRING_ELT(state_names, 717, mkChar("in_I04"));
  SET_STRING_ELT(state_names, 718, mkChar("dim_in_I05"));
  SET_STRING_ELT(state_names, 719, mkChar("dim_in_I05_1"));
  SET_STRING_ELT(state_names, 720, mkChar("dim_in_I05_2"));
  SET_STRING_ELT(state_names, 721, mkChar("in_I05"));
  SET_STRING_ELT(state_names, 722, mkChar("dim_in_I22"));
  SET_STRING_ELT(state_names, 723, mkChar("dim_in_I22_1"));
  SET_STRING_ELT(state_names, 724, mkChar("dim_in_I22_2"));
  SET_STRING_ELT(state_names, 725, mkChar("in_I22"));
  SET_STRING_ELT(state_names, 726, mkChar("dim_in_I23"));
  SET_STRING_ELT(state_names, 727, mkChar("dim_in_I23_1"));
  SET_STRING_ELT(state_names, 728, mkChar("dim_in_I23_2"));
  SET_STRING_ELT(state_names, 729, mkChar("in_I23"));
  SET_STRING_ELT(state_names, 730, mkChar("dim_in_I24"));
  SET_STRING_ELT(state_names, 731, mkChar("dim_in_I24_1"));
  SET_STRING_ELT(state_names, 732, mkChar("dim_in_I24_2"));
  SET_STRING_ELT(state_names, 733, mkChar("in_I24"));
  SET_STRING_ELT(state_names, 734, mkChar("dim_in_I25"));
  SET_STRING_ELT(state_names, 735, mkChar("dim_in_I25_1"));
  SET_STRING_ELT(state_names, 736, mkChar("dim_in_I25_2"));
  SET_STRING_ELT(state_names, 737, mkChar("in_I25"));
  SET_STRING_ELT(state_names, 738, mkChar("dim_in_I32"));
  SET_STRING_ELT(state_names, 739, mkChar("dim_in_I32_1"));
  SET_STRING_ELT(state_names, 740, mkChar("dim_in_I32_2"));
  SET_STRING_ELT(state_names, 741, mkChar("in_I32"));
  SET_STRING_ELT(state_names, 742, mkChar("dim_in_I33"));
  SET_STRING_ELT(state_names, 743, mkChar("dim_in_I33_1"));
  SET_STRING_ELT(state_names, 744, mkChar("dim_in_I33_2"));
  SET_STRING_ELT(state_names, 745, mkChar("in_I33"));
  SET_STRING_ELT(state_names, 746, mkChar("dim_in_I34"));
  SET_STRING_ELT(state_names, 747, mkChar("dim_in_I34_1"));
  SET_STRING_ELT(state_names, 748, mkChar("dim_in_I34_2"));
  SET_STRING_ELT(state_names, 749, mkChar("in_I34"));
  SET_STRING_ELT(state_names, 750, mkChar("dim_in_I35"));
  SET_STRING_ELT(state_names, 751, mkChar("dim_in_I35_1"));
  SET_STRING_ELT(state_names, 752, mkChar("dim_in_I35_2"));
  SET_STRING_ELT(state_names, 753, mkChar("in_I35"));
  SET_STRING_ELT(state_names, 754, mkChar("dim_in_I42"));
  SET_STRING_ELT(state_names, 755, mkChar("dim_in_I42_1"));
  SET_STRING_ELT(state_names, 756, mkChar("dim_in_I42_2"));
  SET_STRING_ELT(state_names, 757, mkChar("in_I42"));
  SET_STRING_ELT(state_names, 758, mkChar("dim_in_I43"));
  SET_STRING_ELT(state_names, 759, mkChar("dim_in_I43_1"));
  SET_STRING_ELT(state_names, 760, mkChar("dim_in_I43_2"));
  SET_STRING_ELT(state_names, 761, mkChar("in_I43"));
  SET_STRING_ELT(state_names, 762, mkChar("dim_in_I44"));
  SET_STRING_ELT(state_names, 763, mkChar("dim_in_I44_1"));
  SET_STRING_ELT(state_names, 764, mkChar("dim_in_I44_2"));
  SET_STRING_ELT(state_names, 765, mkChar("in_I44"));
  SET_STRING_ELT(state_names, 766, mkChar("dim_in_I45"));
  SET_STRING_ELT(state_names, 767, mkChar("dim_in_I45_1"));
  SET_STRING_ELT(state_names, 768, mkChar("dim_in_I45_2"));
  SET_STRING_ELT(state_names, 769, mkChar("in_I45"));
  SET_STRING_ELT(state_names, 770, mkChar("dim_rate_move_in"));
  SET_STRING_ELT(state_names, 771, mkChar("dim_rate_move_in_1"));
  SET_STRING_ELT(state_names, 772, mkChar("dim_rate_move_in_2"));
  SET_STRING_ELT(state_names, 773, mkChar("rate_move_in"));
  SET_STRING_ELT(state_names, 774, mkChar("offset_output_rate_move_in"));
  SET_STRING_ELT(state_names, 775, mkChar("dim_rate_move_out"));
  SET_STRING_ELT(state_names, 776, mkChar("rate_move_out"));
  SET_STRING_ELT(state_names, 777, mkChar("offset_output_rate_move_out"));
  SET_STRING_ELT(state_names, 778, mkChar("interpolate_c_comm"));
  SET_STRING_ELT(state_names, 779, mkChar("interpolate_c_noncomm"));
  SET_STRING_ELT(state_names, 780, mkChar("interpolate_ART_eligible_CD4_above_500"));
  SET_STRING_ELT(state_names, 781, mkChar("ART_eligible_CD4_above_500"));
  SET_STRING_ELT(state_names, 782, mkChar("interpolate_ART_eligible_CD4_350_500"));
  SET_STRING_ELT(state_names, 783, mkChar("ART_eligible_CD4_350_500"));
  SET_STRING_ELT(state_names, 784, mkChar("interpolate_ART_eligible_CD4_200_349"));
  SET_STRING_ELT(state_names, 785, mkChar("ART_eligible_CD4_200_349"));
  SET_STRING_ELT(state_names, 786, mkChar("interpolate_ART_eligible_CD4_below_200"));
  SET_STRING_ELT(state_names, 787, mkChar("ART_eligible_CD4_below_200"));
  SET_STRING_ELT(state_names, 788, mkChar("interpolate_testing_prob"));
  SET_STRING_ELT(state_names, 789, mkChar("interpolate_tau_intervention"));
  SET_STRING_ELT(state_names, 790, mkChar("interpolate_rho_intervention"));
  SET_STRING_ELT(state_names, 791, mkChar("interpolate_infect_ART"));
  SET_STRING_ELT(state_names, 792, mkChar("interpolate_epsilon"));
  SET_STRING_ELT(state_names, 793, mkChar("epsilon"));
  SET_STRING_ELT(state_names, 794, mkChar("interpolate_prep_offered"));
  SET_STRING_ELT(state_names, 795, mkChar("interpolate_fc_comm"));
  SET_STRING_ELT(state_names, 796, mkChar("interpolate_fP_comm"));
  SET_STRING_ELT(state_names, 797, mkChar("interpolate_fc_noncomm"));
  SET_STRING_ELT(state_names, 798, mkChar("interpolate_fP_noncomm"));
  SET_STRING_ELT(state_names, 799, mkChar("interpolate_n_comm"));
  SET_STRING_ELT(state_names, 800, mkChar("interpolate_n_noncomm"));
  SET_STRING_ELT(state_names, 801, mkChar("dim"));
  SET_STRING_ELT(state_names, 802, mkChar("dim_output"));
