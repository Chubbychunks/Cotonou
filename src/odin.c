...
SEXP main_model_contents(SEXP main_model_ptr) {
  ...
  SET_VECTOR_ELT(state, 130, ScalarInteger(main_model_p->dim_test_rate_prep));
  SET_VECTOR_ELT(state, 131, allocVector(REALSXP, main_model_p->dim_test_rate_prep));
  memcpy(REAL(VECTOR_ELT(state, 131)), main_model_p->test_rate_prep, main_model_p->dim_test_rate_prep * sizeof(double));
  SET_VECTOR_ELT(state, 132, ScalarInteger(main_model_p->dim_rho));
  SET_VECTOR_ELT(state, 133, allocVector(REALSXP, main_model_p->dim_rho));
  memcpy(REAL(VECTOR_ELT(state, 133)), main_model_p->rho, main_model_p->dim_rho * sizeof(double));
  SET_VECTOR_ELT(state, 134, ScalarInteger(main_model_p->offset_output_rho));
  SET_VECTOR_ELT(state, 135, ScalarInteger(main_model_p->dim_frac_F));
  SET_VECTOR_ELT(state, 136, allocVector(REALSXP, main_model_p->dim_frac_F));
  memcpy(REAL(VECTOR_ELT(state, 136)), main_model_p->frac_F, main_model_p->dim_frac_F * sizeof(double));
  SET_VECTOR_ELT(state, 137, ScalarInteger(main_model_p->offset_output_frac_F));
  SET_VECTOR_ELT(state, 138, ScalarInteger(main_model_p->dim_frac_N_sexualpop));
  SET_VECTOR_ELT(state, 139, allocVector(REALSXP, main_model_p->dim_frac_N_sexualpop));
  memcpy(REAL(VECTOR_ELT(state, 139)), main_model_p->frac_N_sexualpop, main_model_p->dim_frac_N_sexualpop * sizeof(double));
  SET_VECTOR_ELT(state, 140, ScalarInteger(main_model_p->offset_output_frac_N_sexualpop));
  SET_VECTOR_ELT(state, 141, ScalarInteger(main_model_p->dim_zetaa));
  SET_VECTOR_ELT(state, 142, allocVector(REALSXP, main_model_p->dim_zetaa));
  memcpy(REAL(VECTOR_ELT(state, 142)), main_model_p->zetaa, main_model_p->dim_zetaa * sizeof(double));
  SET_VECTOR_ELT(state, 143, ScalarInteger(main_model_p->offset_output_zetaa));
  SET_VECTOR_ELT(state, 144, ScalarInteger(main_model_p->dim_zetab));
  SET_VECTOR_ELT(state, 145, allocVector(REALSXP, main_model_p->dim_zetab));
  memcpy(REAL(VECTOR_ELT(state, 145)), main_model_p->zetab, main_model_p->dim_zetab * sizeof(double));
  SET_VECTOR_ELT(state, 146, ScalarInteger(main_model_p->offset_output_zetab));
  SET_VECTOR_ELT(state, 147, ScalarInteger(main_model_p->dim_zetac));
  SET_VECTOR_ELT(state, 148, allocVector(REALSXP, main_model_p->dim_zetac));
  memcpy(REAL(VECTOR_ELT(state, 148)), main_model_p->zetac, main_model_p->dim_zetac * sizeof(double));
  SET_VECTOR_ELT(state, 149, ScalarInteger(main_model_p->offset_output_zetac));
  SET_VECTOR_ELT(state, 150, ScalarInteger(main_model_p->dim_omega));
  SET_VECTOR_ELT(state, 151, allocVector(REALSXP, main_model_p->dim_omega));
  memcpy(REAL(VECTOR_ELT(state, 151)), main_model_p->omega, main_model_p->dim_omega * sizeof(double));
  SET_VECTOR_ELT(state, 152, ScalarInteger(main_model_p->offset_output_omega));
  SET_VECTOR_ELT(state, 153, ScalarInteger(main_model_p->dim_frac_N));
  SET_VECTOR_ELT(state, 154, allocVector(REALSXP, main_model_p->dim_frac_N));
  memcpy(REAL(VECTOR_ELT(state, 154)), main_model_p->frac_N, main_model_p->dim_frac_N * sizeof(double));
  SET_VECTOR_ELT(state, 155, ScalarInteger(main_model_p->offset_output_frac_N));
  SET_VECTOR_ELT(state, 156, ScalarInteger(main_model_p->dim_mu));
  SET_VECTOR_ELT(state, 157, allocVector(REALSXP, main_model_p->dim_mu));
  memcpy(REAL(VECTOR_ELT(state, 157)), main_model_p->mu, main_model_p->dim_mu * sizeof(double));
  SET_VECTOR_ELT(state, 158, ScalarInteger(main_model_p->offset_output_mu));
  SET_VECTOR_ELT(state, 159, ScalarInteger(main_model_p->dim_gamma01));
  SET_VECTOR_ELT(state, 160, allocVector(REALSXP, main_model_p->dim_gamma01));
  memcpy(REAL(VECTOR_ELT(state, 160)), main_model_p->gamma01, main_model_p->dim_gamma01 * sizeof(double));
  SET_VECTOR_ELT(state, 161, ScalarInteger(main_model_p->offset_output_gamma01));
  SET_VECTOR_ELT(state, 162, ScalarInteger(main_model_p->dim_gamma02));
  SET_VECTOR_ELT(state, 163, allocVector(REALSXP, main_model_p->dim_gamma02));
  memcpy(REAL(VECTOR_ELT(state, 163)), main_model_p->gamma02, main_model_p->dim_gamma02 * sizeof(double));
  SET_VECTOR_ELT(state, 164, ScalarInteger(main_model_p->dim_gamma03));
  SET_VECTOR_ELT(state, 165, allocVector(REALSXP, main_model_p->dim_gamma03));
  memcpy(REAL(VECTOR_ELT(state, 165)), main_model_p->gamma03, main_model_p->dim_gamma03 * sizeof(double));
  SET_VECTOR_ELT(state, 166, ScalarInteger(main_model_p->dim_gamma04));
  SET_VECTOR_ELT(state, 167, allocVector(REALSXP, main_model_p->dim_gamma04));
  memcpy(REAL(VECTOR_ELT(state, 167)), main_model_p->gamma04, main_model_p->dim_gamma04 * sizeof(double));
  SET_VECTOR_ELT(state, 168, ScalarInteger(main_model_p->dim_gamma11));
  SET_VECTOR_ELT(state, 169, allocVector(REALSXP, main_model_p->dim_gamma11));
  memcpy(REAL(VECTOR_ELT(state, 169)), main_model_p->gamma11, main_model_p->dim_gamma11 * sizeof(double));
  SET_VECTOR_ELT(state, 170, ScalarInteger(main_model_p->dim_gamma22));
  SET_VECTOR_ELT(state, 171, allocVector(REALSXP, main_model_p->dim_gamma22));
  memcpy(REAL(VECTOR_ELT(state, 171)), main_model_p->gamma22, main_model_p->dim_gamma22 * sizeof(double));
  SET_VECTOR_ELT(state, 172, ScalarInteger(main_model_p->dim_gamma23));
  SET_VECTOR_ELT(state, 173, allocVector(REALSXP, main_model_p->dim_gamma23));
  memcpy(REAL(VECTOR_ELT(state, 173)), main_model_p->gamma23, main_model_p->dim_gamma23 * sizeof(double));
  SET_VECTOR_ELT(state, 174, ScalarInteger(main_model_p->dim_gamma24));
  SET_VECTOR_ELT(state, 175, allocVector(REALSXP, main_model_p->dim_gamma24));
  memcpy(REAL(VECTOR_ELT(state, 175)), main_model_p->gamma24, main_model_p->dim_gamma24 * sizeof(double));
  SET_VECTOR_ELT(state, 176, ScalarInteger(main_model_p->dim_gamma32));
  SET_VECTOR_ELT(state, 177, allocVector(REALSXP, main_model_p->dim_gamma32));
  memcpy(REAL(VECTOR_ELT(state, 177)), main_model_p->gamma32, main_model_p->dim_gamma32 * sizeof(double));
  SET_VECTOR_ELT(state, 178, ScalarInteger(main_model_p->dim_gamma33));
  SET_VECTOR_ELT(state, 179, allocVector(REALSXP, main_model_p->dim_gamma33));
  memcpy(REAL(VECTOR_ELT(state, 179)), main_model_p->gamma33, main_model_p->dim_gamma33 * sizeof(double));
  SET_VECTOR_ELT(state, 180, ScalarInteger(main_model_p->dim_gamma34));
  SET_VECTOR_ELT(state, 181, allocVector(REALSXP, main_model_p->dim_gamma34));
  memcpy(REAL(VECTOR_ELT(state, 181)), main_model_p->gamma34, main_model_p->dim_gamma34 * sizeof(double));
  SET_VECTOR_ELT(state, 182, ScalarInteger(main_model_p->dim_gamma42));
  SET_VECTOR_ELT(state, 183, allocVector(REALSXP, main_model_p->dim_gamma42));
  memcpy(REAL(VECTOR_ELT(state, 183)), main_model_p->gamma42, main_model_p->dim_gamma42 * sizeof(double));
  SET_VECTOR_ELT(state, 184, ScalarInteger(main_model_p->dim_gamma43));
  SET_VECTOR_ELT(state, 185, allocVector(REALSXP, main_model_p->dim_gamma43));
  memcpy(REAL(VECTOR_ELT(state, 185)), main_model_p->gamma43, main_model_p->dim_gamma43 * sizeof(double));
  SET_VECTOR_ELT(state, 186, ScalarInteger(main_model_p->dim_gamma44));
  SET_VECTOR_ELT(state, 187, allocVector(REALSXP, main_model_p->dim_gamma44));
  memcpy(REAL(VECTOR_ELT(state, 187)), main_model_p->gamma44, main_model_p->dim_gamma44 * sizeof(double));
  SET_VECTOR_ELT(state, 188, ScalarInteger(main_model_p->dim_phi2));
  SET_VECTOR_ELT(state, 189, allocVector(REALSXP, main_model_p->dim_phi2));
  memcpy(REAL(VECTOR_ELT(state, 189)), main_model_p->phi2, main_model_p->dim_phi2 * sizeof(double));
  SET_VECTOR_ELT(state, 190, ScalarInteger(main_model_p->dim_phi3));
  SET_VECTOR_ELT(state, 191, allocVector(REALSXP, main_model_p->dim_phi3));
  memcpy(REAL(VECTOR_ELT(state, 191)), main_model_p->phi3, main_model_p->dim_phi3 * sizeof(double));
  SET_VECTOR_ELT(state, 192, ScalarInteger(main_model_p->dim_phi4));
  SET_VECTOR_ELT(state, 193, allocVector(REALSXP, main_model_p->dim_phi4));
  memcpy(REAL(VECTOR_ELT(state, 193)), main_model_p->phi4, main_model_p->dim_phi4 * sizeof(double));
  SET_VECTOR_ELT(state, 194, ScalarInteger(main_model_p->dim_phi5));
  SET_VECTOR_ELT(state, 195, allocVector(REALSXP, main_model_p->dim_phi5));
  memcpy(REAL(VECTOR_ELT(state, 195)), main_model_p->phi5, main_model_p->dim_phi5 * sizeof(double));
  SET_VECTOR_ELT(state, 196, ScalarInteger(main_model_p->dim_psia));
  SET_VECTOR_ELT(state, 197, allocVector(REALSXP, main_model_p->dim_psia));
  memcpy(REAL(VECTOR_ELT(state, 197)), main_model_p->psia, main_model_p->dim_psia * sizeof(double));
  SET_VECTOR_ELT(state, 198, ScalarInteger(main_model_p->dim_psib));
  SET_VECTOR_ELT(state, 199, allocVector(REALSXP, main_model_p->dim_psib));
  memcpy(REAL(VECTOR_ELT(state, 199)), main_model_p->psib, main_model_p->dim_psib * sizeof(double));
  SET_VECTOR_ELT(state, 200, ScalarInteger(main_model_p->dim_kappaa));
  SET_VECTOR_ELT(state, 201, allocVector(REALSXP, main_model_p->dim_kappaa));
  memcpy(REAL(VECTOR_ELT(state, 201)), main_model_p->kappaa, main_model_p->dim_kappaa * sizeof(double));
  SET_VECTOR_ELT(state, 202, ScalarInteger(main_model_p->offset_output_kappaa));
  SET_VECTOR_ELT(state, 203, ScalarInteger(main_model_p->dim_kappab));
  SET_VECTOR_ELT(state, 204, allocVector(REALSXP, main_model_p->dim_kappab));
  memcpy(REAL(VECTOR_ELT(state, 204)), main_model_p->kappab, main_model_p->dim_kappab * sizeof(double));
  SET_VECTOR_ELT(state, 205, ScalarInteger(main_model_p->offset_output_kappab));
  SET_VECTOR_ELT(state, 206, ScalarInteger(main_model_p->dim_kappac));
  SET_VECTOR_ELT(state, 207, allocVector(REALSXP, main_model_p->dim_kappac));
  memcpy(REAL(VECTOR_ELT(state, 207)), main_model_p->kappac, main_model_p->dim_kappac * sizeof(double));
  SET_VECTOR_ELT(state, 208, ScalarInteger(main_model_p->offset_output_kappac));
  SET_VECTOR_ELT(state, 209, ScalarInteger(main_model_p->dim_alpha01));
  SET_VECTOR_ELT(state, 210, allocVector(REALSXP, main_model_p->dim_alpha01));
  memcpy(REAL(VECTOR_ELT(state, 210)), main_model_p->alpha01, main_model_p->dim_alpha01 * sizeof(double));
  SET_VECTOR_ELT(state, 211, ScalarInteger(main_model_p->dim_alpha02));
  SET_VECTOR_ELT(state, 212, allocVector(REALSXP, main_model_p->dim_alpha02));
  memcpy(REAL(VECTOR_ELT(state, 212)), main_model_p->alpha02, main_model_p->dim_alpha02 * sizeof(double));
  SET_VECTOR_ELT(state, 213, ScalarInteger(main_model_p->dim_alpha03));
  SET_VECTOR_ELT(state, 214, allocVector(REALSXP, main_model_p->dim_alpha03));
  memcpy(REAL(VECTOR_ELT(state,
 2, main_model_p->dim_in_I34_1, main_model_p->dim_in_I34_2);
  SET_VECTOR_ELT(state, 593, ScalarInteger(main_model_p->dim_in_I35));
  SET_VECTOR_ELT(state, 594, ScalarInteger(main_model_p->dim_in_I35_1));
  SET_VECTOR_ELT(state, 595, ScalarInteger(main_model_p->dim_in_I35_2));
  SET_VECTOR_ELT(state, 596, allocVector(REALSXP, main_model_p->dim_in_I35));
  memcpy(REAL(VECTOR_ELT(state, 596)), main_model_p->in_I35, main_model_p->dim_in_I35 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 596), 2, main_model_p->dim_in_I35_1, main_model_p->dim_in_I35_2);
  SET_VECTOR_ELT(state, 597, ScalarInteger(main_model_p->dim_in_I42));
  SET_VECTOR_ELT(state, 598, ScalarInteger(main_model_p->dim_in_I42_1));
  SET_VECTOR_ELT(state, 599, ScalarInteger(main_model_p->dim_in_I42_2));
  SET_VECTOR_ELT(state, 600, allocVector(REALSXP, main_model_p->dim_in_I42));
  memcpy(REAL(VECTOR_ELT(state, 600)), main_model_p->in_I42, main_model_p->dim_in_I42 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 600), 2, main_model_p->dim_in_I42_1, main_model_p->dim_in_I42_2);
  SET_VECTOR_ELT(state, 601, ScalarInteger(main_model_p->dim_in_I43));
  SET_VECTOR_ELT(state, 602, ScalarInteger(main_model_p->dim_in_I43_1));
  SET_VECTOR_ELT(state, 603, ScalarInteger(main_model_p->dim_in_I43_2));
  SET_VECTOR_ELT(state, 604, allocVector(REALSXP, main_model_p->dim_in_I43));
  memcpy(REAL(VECTOR_ELT(state, 604)), main_model_p->in_I43, main_model_p->dim_in_I43 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 604), 2, main_model_p->dim_in_I43_1, main_model_p->dim_in_I43_2);
  SET_VECTOR_ELT(state, 605, ScalarInteger(main_model_p->dim_in_I44));
  SET_VECTOR_ELT(state, 606, ScalarInteger(main_model_p->dim_in_I44_1));
  SET_VECTOR_ELT(state, 607, ScalarInteger(main_model_p->dim_in_I44_2));
  SET_VECTOR_ELT(state, 608, allocVector(REALSXP, main_model_p->dim_in_I44));
  memcpy(REAL(VECTOR_ELT(state, 608)), main_model_p->in_I44, main_model_p->dim_in_I44 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 608), 2, main_model_p->dim_in_I44_1, main_model_p->dim_in_I44_2);
  SET_VECTOR_ELT(state, 609, ScalarInteger(main_model_p->dim_in_I45));
  SET_VECTOR_ELT(state, 610, ScalarInteger(main_model_p->dim_in_I45_1));
  SET_VECTOR_ELT(state, 611, ScalarInteger(main_model_p->dim_in_I45_2));
  SET_VECTOR_ELT(state, 612, allocVector(REALSXP, main_model_p->dim_in_I45));
  memcpy(REAL(VECTOR_ELT(state, 612)), main_model_p->in_I45, main_model_p->dim_in_I45 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 612), 2, main_model_p->dim_in_I45_1, main_model_p->dim_in_I45_2);
  ...
  SET_STRING_ELT(state_names, 130, mkChar("dim_test_rate_prep"));
  SET_STRING_ELT(state_names, 131, mkChar("test_rate_prep"));
  SET_STRING_ELT(state_names, 132, mkChar("dim_rho"));
  SET_STRING_ELT(state_names, 133, mkChar("rho"));
  SET_STRING_ELT(state_names, 134, mkChar("offset_output_rho"));
  SET_STRING_ELT(state_names, 135, mkChar("dim_frac_F"));
  SET_STRING_ELT(state_names, 136, mkChar("frac_F"));
  SET_STRING_ELT(state_names, 137, mkChar("offset_output_frac_F"));
  SET_STRING_ELT(state_names, 138, mkChar("dim_frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 139, mkChar("frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 140, mkChar("offset_output_frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 141, mkChar("dim_zetaa"));
  SET_STRING_ELT(state_names, 142, mkChar("zetaa"));
  SET_STRING_ELT(state_names, 143, mkChar("offset_output_zetaa"));
  SET_STRING_ELT(state_names, 144, mkChar("dim_zetab"));
  SET_STRING_ELT(state_names, 145, mkChar("zetab"));
  SET_STRING_ELT(state_names, 146, mkChar("offset_output_zetab"));
  SET_STRING_ELT(state_names, 147, mkChar("dim_zetac"));
  SET_STRING_ELT(state_names, 148, mkChar("zetac"));
  SET_STRING_ELT(state_names, 149, mkChar("offset_output_zetac"));
  SET_STRING_ELT(state_names, 150, mkChar("dim_omega"));
  SET_STRING_ELT(state_names, 151, mkChar("omega"));
  SET_STRING_ELT(state_names, 152, mkChar("offset_output_omega"));
  SET_STRING_ELT(state_names, 153, mkChar("dim_frac_N"));
  SET_STRING_ELT(state_names, 154, mkChar("frac_N"));
  SET_STRING_ELT(state_names, 155, mkChar("offset_output_frac_N"));
  SET_STRING_ELT(state_names, 156, mkChar("dim_mu"));
  SET_STRING_ELT(state_names, 157, mkChar("mu"));
  SET_STRING_ELT(state_names, 158, mkChar("offset_output_mu"));
  SET_STRING_ELT(state_names, 159, mkChar("dim_gamma01"));
  SET_STRING_ELT(state_names, 160, mkChar("gamma01"));
  SET_STRING_ELT(state_names, 161, mkChar("offset_output_gamma01"));
  SET_STRING_ELT(state_names, 162, mkChar("dim_gamma02"));
  SET_STRING_ELT(state_names, 163, mkChar("gamma02"));
  SET_STRING_ELT(state_names, 164, mkChar("dim_gamma03"));
  SET_STRING_ELT(state_names, 165, mkChar("gamma03"));
  SET_STRING_ELT(state_names, 166, mkChar("dim_gamma04"));
  SET_STRING_ELT(state_names, 167, mkChar("gamma04"));
  SET_STRING_ELT(state_names, 168, mkChar("dim_gamma11"));
  SET_STRING_ELT(state_names, 169, mkChar("gamma11"));
  SET_STRING_ELT(state_names, 170, mkChar("dim_gamma22"));
  SET_STRING_ELT(state_names, 171, mkChar("gamma22"));
  SET_STRING_ELT(state_names, 172, mkChar("dim_gamma23"));
  SET_STRING_ELT(state_names, 173, mkChar("gamma23"));
  SET_STRING_ELT(state_names, 174, mkChar("dim_gamma24"));
  SET_STRING_ELT(state_names, 175, mkChar("gamma24"));
  SET_STRING_ELT(state_names, 176, mkChar("dim_gamma32"));
  SET_STRING_ELT(state_names, 177, mkChar("gamma32"));
  SET_STRING_ELT(state_names, 178, mkChar("dim_gamma33"));
  SET_STRING_ELT(state_names, 179, mkChar("gamma33"));
  SET_STRING_ELT(state_names, 180, mkChar("dim_gamma34"));
  SET_STRING_ELT(state_names, 181, mkChar("gamma34"));
  SET_STRING_ELT(state_names, 182, mkChar("dim_gamma42"));
  SET_STRING_ELT(state_names, 183, mkChar("gamma42"));
  SET_STRING_ELT(state_names, 184, mkChar("dim_gamma43"));
  SET_STRING_ELT(state_names, 185, mkChar("gamma43"));
  SET_STRING_ELT(state_names, 186, mkChar("dim_gamma44"));
  SET_STRING_ELT(state_names, 187, mkChar("gamma44"));
  SET_STRING_ELT(state_names, 188, mkChar("dim_phi2"));
  SET_STRING_ELT(state_names, 189, mkChar("phi2"));
  SET_STRING_ELT(state_names, 190, mkChar("dim_phi3"));
  SET_STRING_ELT(state_names, 191, mkChar("phi3"));
  SET_STRING_ELT(state_names, 192, mkChar("dim_phi4"));
  SET_STRING_ELT(state_names, 193, mkChar("phi4"));
  SET_STRING_ELT(state_names, 194, mkChar("dim_phi5"));
  SET_STRING_ELT(state_names, 195, mkChar("phi5"));
  SET_STRING_ELT(state_names, 196, mkChar("dim_psia"));
  SET_STRING_ELT(state_names, 197, mkChar("psia"));
  SET_STRING_ELT(state_names, 198, mkChar("dim_psib"));
  SET_STRING_ELT(state_names, 199, mkChar("psib"));
  SET_STRING_ELT(state_names, 200, mkChar("dim_kappaa"));
  SET_STRING_ELT(state_names, 201, mkChar("kappaa"));
  SET_STRING_ELT(state_names, 202, mkChar("offset_output_kappaa"));
  SET_STRING_ELT(state_names, 203, mkChar("dim_kappab"));
  SET_STRING_ELT(state_names, 204, mkChar("kappab"));
  SET_STRING_ELT(state_names, 205, mkChar("offset_output_kappab"));
  SET_STRING_ELT(state_names, 206, mkChar("dim_kappac"));
  SET_STRING_ELT(state_names, 207, mkChar("kappac"));
  SET_STRING_ELT(state_names, 208, mkChar("offset_output_kappac"));
  SET_STRING_ELT(state_names, 209, mkChar("dim_alpha01"));
  SET_STRING_ELT(state_names, 210, mkChar("alpha01"));
  SET_STRING_ELT(state_names, 211, mkChar("dim_alpha02"));
  SET_STRING_ELT(state_names, 212, mkChar("alpha02"));
  SET_STRING_ELT(state_names, 213, mkChar("dim_alpha03"));
  SET_STRING_ELT(state_names, 214, mkChar("alpha03"));
  SET_STRING_ELT(state_names, 215, mkChar("dim_alpha04"));
  SET_STRING_ELT(state_names, 216, mkChar("alpha04"));
  SET_STRING_ELT(state_names, 217, mkChar("dim_alpha05"));
  SET_STRING_ELT(state_names, 218, mkChar("alpha05"));
  SET_STRING_ELT(state_names, 219, mkChar("offset_output_alpha05"));
  SET_STRING_ELT(state_names, 220, mkChar("dim_alpha11"));
  SET_STRING_ELT(state_names, 221, mkChar("alpha11"));
  SET_STRING_ELT(state_names, 222, mkChar("dim_alpha22"));
  SET_STRING_ELT(state_names, 223, mkChar("alpha22"));
  SET_STRING_ELT(state_names, 224, mkChar("dim_alpha23"));
  SET_STRING_ELT(state_names, 225, mkChar("alpha23"));
  SET_STRING_ELT(state_names, 226, mkChar("dim_alpha24"));
  SET_STRING_ELT(state_names, 227, mkChar("alpha24"));
  SET_STRING_ELT(state_names, 228, mkChar("dim_alpha25"));
  SET_STRING_ELT(state_names, 229, mkChar("alpha25"));
  SET_STRING_ELT(state_names, 230, mkChar("dim_alpha32"));
  SET_STRING_ELT(state_names, 231, mkChar("alpha32"));
  SET_STRING_ELT(state_names, 232, mkChar("dim_alpha33"));
  SET_STRING_ELT(state_names, 233, mkChar("alpha33"));
  SET_STRING_ELT(state_names, 234, mkChar("dim_alpha34"));
  SET_STRING_ELT(state_names, 235, mkChar("alpha34"));
  SET_STRING_ELT(state_names, 236, mkChar("dim_alpha35"));
  SET_STRING_ELT(state_names, 237, mkChar("alpha35"));
  SET_STRING_ELT(state_names, 238, mkChar("offset_output_alpha35"));
  SET_STRING_ELT(state_names, 239, mkChar("dim_alpha42"));
  SET_STRING_ELT(state_names, 240, mkChar("alpha42"));
  SET_STRING_ELT(state_names, 241, mkChar("dim_alpha43"));
  SET_STRING_ELT(state_names, 242, mkChar("alpha43"));
  SET_STRING_ELT(state_names, 243, mkChar("dim_alpha44"));
  SET_STRING_ELT(state_names, 244, mkChar("alpha44"));
  SET_STRING_ELT(state_names, 245, mkChar("dim_alpha45"));
  SET_STRING_ELT(state_names, 246, mkChar("alpha45"));
  SET_STRING_ELT(state_names, 247, mkChar("dim_beta_comm"));
  SET_STRING_ELT(state_names, 248, mkChar("beta_comm"));
  SET_STRING_ELT(state_names, 249, mkChar("offset_output_beta_comm"));
  SET_STRING_ELT(state_names, 250, mkChar("dim_beta_noncomm"));
  SET_STRING_ELT(state_names, 251, mkChar("beta_noncomm"));
  SET_STRING_ELT(state_names, 252, mkChar("offset_output_beta_noncomm"));
  SET_STRING_ELT(state_names, 253, mkChar("dim_p_comm"));
  SET_STRING_ELT(state_names, 254, mkChar("dim_p_comm_1"));
  SET_STRING_ELT(state_names, 255, mkChar("dim_p_comm_2"));
  SET_STRING_ELT(state_names, 256, mkChar("p_comm"));
  SET_STRING_ELT(state_names, 257, mkChar("offset_output_p_comm"));
  SET_STRING_ELT(state_names, 258, mkChar("dim_p_noncomm"));
  SET_STRING_ELT(state_names, 259, mkChar("dim_p_noncomm_1"));
  SET_STRING_ELT(state_names, 260, mkChar("dim_p_noncomm_2"));
  SET_STRING_ELT(state_names, 261, mkChar("p_noncomm"));
  SET_STRING_ELT(state_names, 262, mkChar("offset_output_p_noncomm"));
  SET_STRING_ELT(state_names, 263, mkChar("dim_ec"));
  SET_STRING_ELT(state_names, 264, mkChar("ec"));
  SET_STRING_ELT(state_names, 265, mkChar("dim_eP"));
  SET_STRING_ELT(state_names, 266, mkChar("eP"));
  SET_STRING_ELT(state_names, 267, mkChar("dim_eP0"));
  SET_STRING_ELT(state_names, 268, mkChar("eP0"));
  SET_STRING_ELT(state_names, 269, mkChar("dim_eP1a"));
  SET_STRING_ELT(state_names, 270, mkChar("eP1a"));
  SET_STRING_ELT(state_names, 271, mkChar("dim_eP1b"));
  SET_STRING_ELT(state_names, 272, mkChar("eP1b"));
  SET_STRING_ELT(state_names, 273, mkChar("dim_eP1c"));
  SET_STRING_ELT(state_names, 274, mkChar("eP1c"));
  SET_STRING_ELT(state_names, 275, mkChar("dim_eP1d"));
  SET_STRING_ELT(state_names, 276, mkChar("eP1d"));
  SET_STRING_ELT(state_names, 277, mkChar("dim_fc_comm"));
  SET_STRING_ELT(state_names, 278, mkChar("dim_fc_comm_1"));
  SET_STRING_ELT(state_names, 279, mkChar("dim_fc_comm_2"));
  SET_STRING_ELT(state_names, 280, mkChar("fc_comm"));
  SET_STRING_ELT(state_names, 281, mkChar("offset_output_fc_comm"));
  SET_STRING_ELT(state_names, 282, mkChar("dim_fP_comm"));
  SET_STRING_ELT(state_names, 283, mkChar("fP_comm"));
  SET_STRING_ELT(state_names, 284, mkChar("offset_output_fP_comm"));
  SET_STRING_ELT(state_names, 285, mkChar("dim_fc_noncomm"));
  SET_STRING_ELT(state_names, 286, mkChar("dim_fc_noncomm_1"));
  SET_STRING_ELT(state_names, 287, mkChar("dim_fc_noncomm_2"));
  SET_STRING_ELT(state_names, 288, mkChar("fc_noncomm"));
  SET_STRING_ELT(state_names, 289, mkChar("offset_output_fc_noncomm"));
  SET_STRING_ELT(state_names, 290, mkChar("dim_fP_noncomm"));
  SET_STRING_ELT(state_names, 291, mkChar("fP_noncomm"));
  SET_STRING_ELT(state_names, 292, mkChar("offset_output_fP_noncomm"));
  SET_STRING_ELT(state_names, 293, mkChar("dim_n_comm"));
  SET_STRING_ELT(state_names, 294, mkChar("dim_n_comm_1"));
  SET_STRING_ELT(state_names, 295, mkChar("dim_n_comm_2"));
  SET_STRING_ELT(state_names, 296, mkChar("n_comm"));
  SET_STRING_ELT(state_names, 297, mkChar("offset_output_n_comm"));
  SET_STRING_ELT(state_names, 298, mkChar("dim_n_noncomm"));
  SET_STRING_ELT(state_names, 299, mkChar("dim_n_noncomm_1"));
  SET_STRING_ELT(state_names, 300, mkChar("dim_n_noncomm_2"));
  SET_STRING_ELT(state_names, 301, mkChar("n_noncomm"));
  SET_STRING_ELT(state_names, 302, mkChar("offset_output_n_noncomm"));
  SET_STRING_ELT(state_names, 303, mkChar("dim_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 304, mkChar("initial_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 305, mkChar("offset_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 306, mkChar("dim_cumuInf"));
  SET_STRING_ELT(state_names, 307, mkChar("initial_cumuInf"));
  SET_STRING_ELT(state_names, 308, mkChar("offset_cumuInf"));
  SET_STRING_ELT(state_names, 309, mkChar("dim_OnPrEP"));
  SET_STRING_ELT(state_names, 310, mkChar("initial_OnPrEP"));
  SET_STRING_ELT(state_names, 311, mkChar("offset_OnPrEP"));
  SET_STRING_ELT(state_names, 312, mkChar("dim_S0"));
  SET_STRING_ELT(state_names, 313, mkChar("initial_S0"));
  SET_STRING_ELT(state_names, 314, mkChar("offset_S0"));
  SET_STRING_ELT(state_names, 315, mkChar("dim_S1a"));
  SET_STRING_ELT(state_names, 316, mkChar("initial_S1a"));
  SET_STRING_ELT(state_names, 317, mkChar("offset_S1a"));
  SET_STRING_ELT(state_names, 318, mkChar("dim_S1b"));
  SET_STRING_ELT(state_names, 319, mkChar("initial_S1b"));
  SET_STRING_ELT(state_names, 320, mkChar("offset_S1b"));
  SET_STRING_ELT(state_names, 321, mkChar("dim_S1c"));
  SET_STRING_ELT(state_names, 322, mkChar("initial_S1c"));
  SET_STRING_ELT(state_names, 323, mkChar("offset_S1c"));
  SET_STRING_ELT(state_names, 324, mkChar("dim_S1d"));
  SET_STRING_ELT(state_names, 325, mkChar("initial_S1d"));
  SET_STRING_ELT(state_names, 326, mkChar("offset_S1d"));
  SET_STRING_ELT(state_names, 327, mkChar("dim_I01"));
  SET_STRING_ELT(state_names, 328, mkChar("initial_I01"));
  SET_STRING_ELT(state_names, 329, mkChar("offset_I01"));
  SET_STRING_ELT(state_names, 330, mkChar("dim_I11"));
  SET_STRING_ELT(state_names, 331, mkChar("initial_I11"));
  SET_STRING_ELT(state_names, 332, mkChar("offset_I11"));
  SET_STRING_ELT(state_names, 333, mkChar("dim_I02"));
  SET_STRING_ELT(state_names, 334, mkChar("initial_I02"));
  SET_STRING_ELT(state_names, 335, mkChar("offset_I02"));
  SET_STRING_ELT(state_names, 336, mkChar("dim_I03"));
  SET_STRING_ELT(state_names, 337, mkChar("initial_I03"));
  SET_STRING_ELT(state_names, 338, mkChar("offset_I03"));
  SET_STRING_ELT(state_names, 339, mkChar("dim_I04"));
  SET_STRING_ELT(state_names, 340, mkChar("initial_I04"));
  SET_STRING_ELT(state_names, 341, mkChar("offset_I04"));
  SET_STRING_ELT(state_names, 342, mkChar("dim_I05"));
  SET_STRING_ELT(state_names, 343, mkChar("initial_I05"));
  SET_STRING_ELT(state_names, 344, mkChar("offset_I05"));
  SET_STRING_ELT(state_names, 345, mkChar("dim_I22"));
  SET_STRING_ELT(state_names, 346, mkChar("initial_I22"));
  SET_STRING_ELT(state_names, 347, mkChar("offset_I22"));
  SET_STRING_ELT(state_names, 348, mkChar("dim_I23"));
  SET_STRING_ELT(state_names, 349, mkChar("initial_I23"));
  SET_STRING_ELT(state_names, 350, mkChar("offset_I23"));
  SET_STRING_ELT(state_names, 351, mkChar("dim_I24"));
  SET_STRING_ELT(state_names, 352, mkChar("initial_I24"));
  SET_STRING_ELT(state_names, 353, mkChar("offset_I24"));
  SET_STRING_ELT(state_names, 354, mkChar("dim_I25"));
  SET_STRING_ELT(state_names, 355, mkChar("initial_I25"));
  SET_STRING_ELT(state_names, 356, mkChar("offset_I25"));
  SET_STRING_ELT(state_names, 357, mkChar("dim_I32"));
  SET_STRING_ELT(state_names, 358, mkChar("initial_I32"));
  SET_STRING_ELT(state_names, 359, mkChar("offset_I32"));
  SET_STRING_ELT(state_names, 360, mkChar("dim_I33"));
  SET_STRING_ELT(state_names, 361, mkChar("initial_I33"));
  SET_STRING_ELT(state_names, 362, mkChar("offset_I33"));
  SET_STRING_ELT(state_names, 363, mkChar("dim_I34"));
  SET_STRING_ELT(state_names, 364, mkChar("initial_I34"));
  SET_STRING_ELT(state_names, 365, mkChar("offset_I34"));
  SET_STRING_ELT(state_names, 366, mkChar("dim_I35"));
  SET_STRING_ELT(state_names, 367, mkChar("initial_I35"));
  SET_STRING_ELT(state_names, 368, mkChar("offset_I35"));
  SET_STRING_ELT(state_names, 369, mkChar("dim_I42"));
  SET_STRING_ELT(state_names, 370, mkChar("initial_I42"));
  SET_STRING_ELT(state_names, 371, mkChar("offset_I42"));
  SET_STRING_ELT(state_names, 372, mkChar("dim_I43"));
  SET_STRING_ELT(state_names, 373, mkChar("initial_I43"));
  SET_STRING_ELT(state_names, 374, mkChar("offset_I43"));
  SET_STRING_ELT(state_names, 375, mkChar("dim_I44"));
  SET_STRING_ELT(state_names, 376, mkChar("initial_I44"));
  SET_STRING_ELT(state_names, 377, mkChar("offset_I44"));
  SET_STRING_ELT(state_names, 378, mkChar("dim_I45"));
  SET_STRING_ELT(state_names, 379, mkChar("initial_I45"));
  SET_STRING_ELT(state_names, 380, mkChar("offset_I45"));
  SET_STRING_ELT(state_names, 381, mkChar("dim_S0_init"));
  SET_STRING_ELT(state_names, 382, mkChar("S0_init"));
  SET_STRING_ELT(state_names, 383, mkChar("dim_S1a_init"));
  SET_STRING_ELT(state_names, 384, mkChar("S1a_init"));
  SET_STRING_ELT(state_names, 385, mkChar("dim_S1b_init"));
  SET_STRING_ELT(state_names, 386, mkChar("S1b_init"));
  SET_STRING_ELT(state_names, 387, mkChar("dim_S1c_init"));
  SET_STRING_ELT(state_names, 388, mkChar("S1c_init"));
  SET_STRING_ELT(state_names, 389, mkChar("dim_S1d_init"));
  SET_STRING_ELT(state_names, 390, mkChar("S1d_init"));
  SET_STRING_ELT(state_names, 391, mkChar("dim_I01_init"));
  SET_STRING_ELT(state_names, 392, mkChar("I01_init"));
  SET_STRING_ELT(state_names, 393, mkChar("dim_I11_init"));
  SET_STRING_ELT(state_names, 394, mkChar("I11_init"));
  SET_STRING_ELT(state_names, 395, mkChar("dim_I02_init"));
  SET_STRING_ELT(state_names, 396, mkChar("I02_init"));
  SET_STRING_ELT(state_names, 397, mkChar("dim_I03_init"));
  SET_STRING_ELT(state_names, 398, mkChar("I03_init"));
  SET_STRING_ELT(state_names, 399, mkChar("dim_I04_init"));
  SET_STRING_ELT(state_names, 400, mkChar("I04_init"));
  SET_STRING_ELT(state_names, 401, mkChar("dim_I05_init"));
  SET_STRING_ELT(state_names, 402, mkChar("I05_init"));
  SET_STRING_ELT(state_names, 403, mkChar("dim_I22_init"));
  SET_STRING_ELT(state_names, 404, mkChar("I22_init"));
  SET_STRING_ELT(state_names, 405, mkChar("dim_I23_init"));
  SET_STRING_ELT(state_names, 406, mkChar("I23_init"));
  SET_STRING_ELT(state_names, 407, mkChar("dim_I24_init"));
  SET_STRING_ELT(state_names, 408, mkChar("I24_init"));
  SET_STRING_ELT(state_names, 409, mkChar("dim_I25_init"));
  SET_STRING_ELT(state_names, 410, mkChar("I25_init"));
  SET_STRING_ELT(state_names, 411, mkChar("dim_I32_init"));
  SET_STRING_ELT(state_names, 412, mkChar("I32_init"));
  SET_STRING_ELT(state_names, 413, mkChar("dim_I33_init"));
  SET_STRING_ELT(state_names, 414, mkChar("I33_init"));
  SET_STRING_ELT(state_names, 415, mkChar("dim_I34_init"));
  SET_STRING_ELT(state_names, 416, mkChar("I34_init"));
  SET_STRING_ELT(state_names, 417, mkChar("dim_I35_init"));
  SET_STRING_ELT(state_names, 418, mkChar("I35_init"));
  SET_STRING_ELT(state_names, 419, mkChar("dim_I42_init"));
  SET_STRING_ELT(state_names, 420, mkChar("I42_init"));
  SET_STRING_ELT(state_names, 421, mkChar("dim_I43_init"));
  SET_STRING_ELT(state_names, 422, mkChar("I43_init"));
  SET_STRING_ELT(state_names, 423, mkChar("dim_I44_init"));
  SET_STRING_ELT(state_names, 424, mkChar("I44_init"));
  SET_STRING_ELT(state_names, 425, mkChar("dim_I45_init"));
  SET_STRING_ELT(state_names, 426, mkChar("I45_init"));
  SET_STRING_ELT(state_names, 427, mkChar("dim_N"));
  SET_STRING_ELT(state_names, 428, mkChar("N"));
  SET_STRING_ELT(state_names, 429, mkChar("offset_output_N"));
  SET_STRING_ELT(state_names, 430, mkChar("dim_E0"));
  SET_STRING_ELT(state_names, 431, mkChar("E0"));
  SET_STRING_ELT(state_names, 432, mkChar("offset_output_E0"));
  SET_STRING_ELT(state_names, 433, mkChar("dim_E1a"));
  SET_STRING_ELT(state_names, 434, mkChar("E1a"));
  SET_STRING_ELT(state_names, 435, mkChar("offset_output_E1a"));
  SET_STRING_ELT(state_names, 436, mkChar("dim_E1b"));
  SET_STRING_ELT(state_names, 437, mkChar("E1b"));
  SET_STRING_ELT(state_names, 438, mkChar("offset_output_E1b"));
  SET_STRING_ELT(state_names, 439, mkChar("dim_E1c"));
  SET_STRING_ELT(state_names, 440, mkChar("E1c"));
  SET_STRING_ELT(state_names, 441, mkChar("offset_output_E1c"));
  SET_STRING_ELT(state_names, 442, mkChar("dim_E1d"));
  SET_STRING_ELT(state_names, 443, mkChar("E1d"));
  SET_STRING_ELT(state_names, 444, mkChar("offset_output_E1d"));
  SET_STRING_ELT(state_names, 445, mkChar("dim_cumuInf_init"));
  SET_STRING_ELT(state_names, 446, mkChar("cumuInf_init"));
  SET_STRING_ELT(state_names, 447, mkChar("dim_alphaItot"));
  SET_STRING_ELT(state_names, 448, mkChar("alphaItot"));
  SET_STRING_ELT(state_names, 449, mkChar("offset_output_alphaItot"));
  SET_STRING_ELT(state_names, 450, mkChar("dim_prev"));
  SET_STRING_ELT(state_names, 451, mkChar("prev"));
  SET_STRING_ELT(state_names, 452, mkChar("offset_output_prev"));
  SET_STRING_ELT(state_names, 453, mkChar("dim_lambda"));
  SET_STRING_ELT(state_names, 454, mkChar("dim_lambda_1"));
  SET_STRING_ELT(state_names, 455, mkChar("dim_lambda_2"));
  SET_STRING_ELT(state_names, 456, mkChar("lambda"));
  SET_STRING_ELT(state_names, 457, mkChar("offset_output_lambda"));
  SET_STRING_ELT(state_names, 458, mkChar("dim_lambda_0"));
  SET_STRING_ELT(state_names, 459, mkChar("dim_lambda_0_1"));
  SET_STRING_ELT(state_names, 460, mkChar("dim_lambda_0_2"));
  SET_STRING_ELT(state_names, 461, mkChar("lambda_0"));
  SET_STRING_ELT(state_names, 462, mkChar("offset_output_lambda_0"));
  SET_STRING_ELT(state_names, 463, mkChar("dim_lambda_1a"));
  SET_STRING_ELT(state_names, 464, mkChar("dim_lambda_1a_1"));
  SET_STRING_ELT(state_names, 465, mkChar("dim_lambda_1a_2"));
  SET_STRING_ELT(state_names, 466, mkChar("lambda_1a"));
  SET_STRING_ELT(state_names, 467, mkChar("offset_output_lambda_1a"));
  SET_STRING_ELT(state_names, 468, mkChar("dim_lambda_1b"));
  SET_STRING_ELT(state_names, 469, mkChar("dim_lambda_1b_1"));
  SET_STRING_ELT(state_names, 470, mkChar("dim_lambda_1b_2"));
  SET_STRING_ELT(state_names, 471, mkChar("lambda_1b"));
  SET_STRING_ELT(state_names, 472, mkChar("offset_output_lambda_1b"));
  SET_STRING_ELT(state_names, 473, mkChar("dim_lambda_1c"));
  SET_STRING_ELT(state_names, 474, mkChar("dim_lambda_1c_1"));
  SET_STRING_ELT(state_names, 475, mkChar("dim_lambda_1c_2"));
  SET_STRING_ELT(state_names, 476, mkChar("lambda_1c"));
  SET_STRING_ELT(state_names, 477, mkChar("offset_output_lambda_1c"));
  SET_STRING_ELT(state_names, 478, mkChar("dim_lambda_1d"));
  SET_STRING_ELT(state_names, 479, mkChar("dim_lambda_1d_1"));
  SET_STRING_ELT(state_names, 480, mkChar("dim_lambda_1d_2"));
  SET_STRING_ELT(state_names, 481, mkChar("lambda_1d"));
  SET_STRING_ELT(state_names, 482, mkChar("offset_output_lambda_1d"));
  SET_STRING_ELT(state_names, 483, mkChar("dim_lambda_sum_0"));
  SET_STRING_ELT(state_names, 484, mkChar("lambda_sum_0"));
  SET_STRING_ELT(state_names, 485, mkChar("offset_output_lambda_sum_0"));
  SET_STRING_ELT(state_names, 486, mkChar("dim_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 487, mkChar("lambda_sum_1a"));
  SET_STRING_ELT(state_names, 488, mkChar("offset_output_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 489, mkChar("dim_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 490, mkChar("lambda_sum_1b"));
  SET_STRING_ELT(state_names, 491, mkChar("offset_output_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 492, mkChar("dim_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 493, mkChar("lambda_sum_1c"));
  SET_STRING_ELT(state_names, 494, mkChar("offset_output_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 495, mkChar("dim_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 496, mkChar("lambda_sum_1d"));
  SET_STRING_ELT(state_names, 497, mkChar("offset_output_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 498, mkChar("dim_c_comm_balanced"));
  SET_STRING_ELT(state_names, 499, mkChar("c_comm_balanced"));
  SET_STRING_ELT(state_names, 500, mkChar("offset_output_c_comm_balanced"));
  SET_STRING_ELT(state_names, 501, mkChar("dim_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 502, mkChar("c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 503, mkChar("offset_output_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 504, mkChar("dim_theta"));
  SET_STRING_ELT(state_names, 505, mkChar("dim_theta_1"));
  SET_STRING_ELT(state_names, 506, mkChar("dim_theta_2"));
  SET_STRING_ELT(state_names, 507, mkChar("theta"));
  SET_STRING_ELT(state_names, 508, mkChar("offset_output_theta"));
  SET_STRING_ELT(state_names, 509, mkChar("dim_OnPrEP_init"));
  SET_STRING_ELT(state_names, 510, mkChar("OnPrEP_init"));
  SET_STRING_ELT(state_names, 511, mkChar("dim_M_comm"));
  SET_STRING_ELT(state_names, 512, mkChar("dim_M_comm_1"));
  SET_STRING_ELT(state_names, 513, mkChar("dim_M_comm_2"));
  SET_STRING_ELT(state_names, 514, mkChar("M_comm"));
  SET_STRING_ELT(state_names, 515, mkChar("offset_output_M_comm"));
  SET_STRING_ELT(state_names, 516, mkChar("dim_M_noncomm"));
  SET_STRING_ELT(state_names, 517, mkChar("dim_M_noncomm_1"));
  SET_STRING_ELT(state_names, 518, mkChar("dim_M_noncomm_2"));
  SET_STRING_ELT(state_names, 519, mkChar("M_noncomm"));
  SET_STRING_ELT(state_names, 520, mkChar("offset_output_M_noncomm"));
  SET_STRING_ELT(state_names, 521, mkChar("dim_in_S0"));
  SET_STRING_ELT(state_names, 522, mkChar("dim_in_S0_1"));
  SET_STRING_ELT(state_names, 523, mkChar("dim_in_S0_2"));
  SET_STRING_ELT(state_names, 524, mkChar("in_S0"));
  SET_STRING_ELT(state_names, 525, mkChar("dim_in_S1a"));
  SET_STRING_ELT(state_names, 526, mkChar("dim_in_S1a_1"));
  SET_STRING_ELT(state_names, 527, mkChar("dim_in_S1a_2"));
  SET_STRING_ELT(state_names, 528, mkChar("in_S1a"));
  SET_STRING_ELT(state_names, 529, mkChar("dim_in_S1b"));
  SET_STRING_ELT(state_names, 530, mkChar("dim_in_S1b_1"));
  SET_STRING_ELT(state_names, 531, mkChar("dim_in_S1b_2"));
  SET_STRING_ELT(state_names, 532, mkChar("in_S1b"));
  SET_STRING_ELT(state_names, 533, mkChar("dim_in_S1c"));
  SET_STRING_ELT(state_names, 534, mkChar("dim_in_S1c_1"));
  SET_STRING_ELT(state_names, 535, mkChar("dim_in_S1c_2"));
  SET_STRING_ELT(state_names, 536, mkChar("in_S1c"));
  SET_STRING_ELT(state_names, 537, mkChar("dim_in_S1d"));
  SET_STRING_ELT(state_names, 538, mkChar("dim_in_S1d_1"));
  SET_STRING_ELT(state_names, 539, mkChar("dim_in_S1d_2"));
  SET_STRING_ELT(state_names, 540, mkChar("in_S1d"));
  SET_STRING_ELT(state_names, 541, mkChar("dim_in_I01"));
  SET_STRING_ELT(state_names, 542, mkChar("dim_in_I01_1"));
  SET_STRING_ELT(state_names, 543, mkChar("dim_in_I01_2"));
  SET_STRING_ELT(state_names, 544, mkChar("in_I01"));
  SET_STRING_ELT(state_names, 545, mkChar("dim_in_I11"));
  SET_STRING_ELT(state_names, 546, mkChar("dim_in_I11_1"));
  SET_STRING_ELT(state_names, 547, mkChar("dim_in_I11_2"));
  SET_STRING_ELT(state_names, 548, mkChar("in_I11"));
  SET_STRING_ELT(state_names, 549, mkChar("dim_in_I02"));
  SET_STRING_ELT(state_names, 550, mkChar("dim_in_I02_1"));
  SET_STRING_ELT(state_names, 551, mkChar("dim_in_I02_2"));
  SET_STRING_ELT(state_names, 552, mkChar("in_I02"));
  SET_STRING_ELT(state_names, 553, mkChar("dim_in_I03"));
  SET_STRING_ELT(state_names, 554, mkChar("dim_in_I03_1"));
  SET_STRING_ELT(state_names, 555, mkChar("dim_in_I03_2"));
  SET_STRING_ELT(state_names, 556, mkChar("in_I03"));
  SET_STRING_ELT(state_names, 557, mkChar("dim_in_I04"));
  SET_STRING_ELT(state_names, 558, mkChar("dim_in_I04_1"));
  SET_STRING_ELT(state_names, 559, mkChar("dim_in_I04_2"));
  SET_STRING_ELT(state_names, 560, mkChar("in_I04"));
  SET_STRING_ELT(state_names, 561, mkChar("dim_in_I05"));
  SET_STRING_ELT(state_names, 562, mkChar("dim_in_I05_1"));
  SET_STRING_ELT(state_names, 563, mkChar("dim_in_I05_2"));
  SET_STRING_ELT(state_names, 564, mkChar("in_I05"));
  SET_STRING_ELT(state_names, 565, mkChar("dim_in_I22"));
  SET_STRING_ELT(state_names, 566, mkChar("dim_in_I22_1"));
  SET_STRING_ELT(state_names, 567, mkChar("dim_in_I22_2"));
  SET_STRING_ELT(state_names, 568, mkChar("in_I22"));
  SET_STRING_ELT(state_names, 569, mkChar("dim_in_I23"));
  SET_STRING_ELT(state_names, 570, mkChar("dim_in_I23_1"));
  SET_STRING_ELT(state_names, 571, mkChar("dim_in_I23_2"));
  SET_STRING_ELT(state_names, 572, mkChar("in_I23"));
  SET_STRING_ELT(state_names, 573, mkChar("dim_in_I24"));
  SET_STRING_ELT(state_names, 574, mkChar("dim_in_I24_1"));
  SET_STRING_ELT(state_names, 575, mkChar("dim_in_I24_2"));
  SET_STRING_ELT(state_names, 576, mkChar("in_I24"));
  SET_STRING_ELT(state_names, 577, mkChar("dim_in_I25"));
  SET_STRING_ELT(state_names, 578, mkChar("dim_in_I25_1"));
  SET_STRING_ELT(state_names, 579, mkChar("dim_in_I25_2"));
  SET_STRING_ELT(state_names, 580, mkChar("in_I25"));
  SET_STRING_ELT(state_names, 581, mkChar("dim_in_I32"));
  SET_STRING_ELT(state_names, 582, mkChar("dim_in_I32_1"));
  SET_STRING_ELT(state_names, 583, mkChar("dim_in_I32_2"));
  SET_STRING_ELT(state_names, 584, mkChar("in_I32"));
  SET_STRING_ELT(state_names, 585, mkChar("dim_in_I33"));
  SET_STRING_ELT(state_names, 586, mkChar("dim_in_I33_1"));
  SET_STRING_ELT(state_names, 587, mkChar("dim_in_I33_2"));
  SET_STRING_ELT(state_names, 588, mkChar("in_I33"));
  SET_STRING_ELT(state_names, 589, mkChar("dim_in_I34"));
  SET_STRING_ELT(state_names, 590, mkChar("dim_in_I34_1"));
  SET_STRING_ELT(state_names, 591, mkChar("dim_in_I34_2"));
  SET_STRING_ELT(state_names, 592, mkChar("in_I34"));
  SET_STRING_ELT(state_names, 593, mkChar("dim_in_I35"));
  SET_STRING_ELT(state_names, 594, mkChar("dim_in_I35_1"));
  SET_STRING_ELT(state_names, 595, mkChar("dim_in_I35_2"));
  SET_STRING_ELT(state_names, 596, mkChar("in_I35"));
  SET_STRING_ELT(state_names, 597, mkChar("dim_in_I42"));
  SET_STRING_ELT(state_names, 598, mkChar("dim_in_I42_1"));
  SET_STRING_ELT(state_names, 599, mkChar("dim_in_I42_2"));
  SET_STRING_ELT(state_names, 600, mkChar("in_I42"));
  SET_STRING_ELT(state_names, 601, mkChar("dim_in_I43"));
  SET_STRING_ELT(state_names, 602, mkChar("dim_in_I43_1"));
  SET_STRING_ELT(state_names, 603, mkChar("dim_in_I43_2"));
  SET_STRING_ELT(state_names, 604, mkChar("in_I43"));
  SET_STRING_ELT(state_names, 605, mkChar("dim_in_I44"));
  SET_STRING_ELT(state_names, 606, mkChar("dim_in_I44_1"));
  SET_STRING_ELT(state_names, 607, mkChar("dim_in_I44_2"));
  SET_STRING_ELT(state_names, 608, mkChar("in_I44"));
  SET_STRING_ELT(state_names, 609, mkChar("dim_in_I45"));
  SET_STRING_ELT(state_names, 610, mkChar("dim_in_I45_1"));
  SET_STRING_ELT(state_names, 611, mkChar("dim_in_I45_2"));
  SET_STRING_ELT(state_names, 612, mkChar("in_I45"));
