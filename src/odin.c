...
SEXP main_model_set_user(main_model_pars *main_model_p, SEXP user) {
  ...
  main_model_p->offset_output_infect_ART_y = 67;
  ...
  main_model_p->offset_output_infect_ART_t = 67 + main_model_p->dim_infect_ART_y;
  ...
  main_model_p->interpolate_pfFSW = cinterpolate_alloc("constant", main_model_p->dim_pfFSW_t, main_model_p->dim_pfFSW, main_model_p->pfFSW_t, main_model_p->pfFSW_y);
...
void main_model_deriv(main_model_pars *main_model_p, double t, double *state, double *dstatedt, double *output) {
  ...
  for (int i = 0; i < main_model_p->dim_I01; ++i) {
    deriv_I01[i] = main_model_p->infected_FSW_incoming * 0.031904762000000003 * main_model_p->E0[i] * main_model_p->pfFSW[i] + S0[i] * main_model_p->lambda_sum_0[i] + S1d[i] * main_model_p->lambda_sum_1d[i] - I01[i] * (main_model_p->gamma01[i] + main_model_p->tau[i] + main_model_p->tau_intervention[i] * main_model_p->TasP_testing + main_model_p->alpha01[i] + main_model_p->mu[i] + main_model_p->nu) + main_model_p->rate_move_out[i] * I01[i] + odin_sum2(main_model_p->in_I01, i, i, 0, main_model_p->dim_in_I01_2 - 1, main_model_p->dim_in_I01_1) + main_model_p->kappa1[i] * I11[i];
  }
  for (int i = 0; i < main_model_p->dim_I11; ++i) {
  ...
  if (output != NULL) {
    double *output_infect_ART_y = output + 67;
    ...
    output[1] = main_model_p->who_believe_comm;
    memcpy(output_above_500_by_group, main_model_p->above_500_by_group, main_model_p->dim_above_500_by_group * sizeof(double));
    output[2] = main_model_p->ART_eligible_CD4_above_500;
    output[3] = main_model_p->ART_eligible_CD4_350_500;
    output[4] = main_model_p->ART_eligible_CD4_200_349;
    output[5] = main_model_p->ART_eligible_CD4_below_200;
    ...
    output[6] = main_model_p->TasP_testing;
    ...
    output[7] = main_model_p->PrEPOnOff;
    output[8] = main_model_p->fPa;
    output[9] = main_model_p->fPb;
    output[10] = main_model_p->fPc;
    ...
    output[11] = main_model_p->W0;
    output[12] = main_model_p->W1;
    output[13] = main_model_p->W2;
    output[14] = main_model_p->W3;
    output[15] = main_model_p->cost_Initiation_of_ART_study_FSW;
    output[16] = main_model_p->cost_Initiation_of_ART_government_FSW;
    output[17] = main_model_p->cost_1_year_of_ART_study_FSW;
    output[18] = main_model_p->cost_1_year_of_ART_government_FSW;
    output[19] = main_model_p->cost_Initiation_ART_rest_of_population;
    output[20] = main_model_p->cost_1_year_of_ART_rest_of_population;
    output[21] = main_model_p->cost_FSW_initiation_ART_Patient_costs;
    output[22] = main_model_p->cost_FSW_1_year_ART_Patient_costs;
    output[23] = main_model_p->cost_Initiation_of_PrEP_study;
    output[24] = main_model_p->cost_1_year_PrEP_perfect_adherence_study;
    output[25] = main_model_p->cost_1_year_PrEP_intermediate_adherence_study;
    output[26] = main_model_p->cost_1_year_PrEP_non_adherence_study;
    output[27] = main_model_p->cost_Initiation_of_PrEP_government;
    output[28] = main_model_p->cost_1_year_PrEP_perfect_adherence_government;
    output[29] = main_model_p->cost_1_year_PrEP_intermediate_adherence_government;
    output[30] = main_model_p->cost_1_year_PrEP_non_adherence_government;
    output[31] = main_model_p->cost_PREP_initiation_Patient_costs;
    output[32] = main_model_p->cost_PREP_1_year_ART_Patient_costs;
    double cumuInftot = odin_sum1(cumuInf, 0, main_model_p->dim_cumuInf - 1);
    output[33] = cumuInftot;
    ...
    output[38] = pc_susceptible_FSW_On_PrEP;
    output[39] = pc_all_FSW_On_PrEP;
    double FSW_On_PrEP_all_cats = S1a[0] + S1b[0] + S1c[0];
    output[40] = FSW_On_PrEP_all_cats;
    output[41] = Men_on_ART;
    output[42] = Women_on_ART;
    output[43] = ART_coverage_men;
    output[44] = ART_coverage_women;
    output[45] = ART_coverage_FSW;
    output[46] = ART_coverage_all;
    output[47] = main_model_p->Ncat;
    ...
    output[48] = main_model_p->nu;
    output[49] = main_model_p->Nage;
    output[50] = main_model_p->dur_FSW;
    memcpy(output_infect_ART, main_model_p->infect_ART, main_model_p->dim_infect_ART * sizeof(double));
    output[51] = main_model_p->epsilon;
    ...
    output[52] = Ntot_inc_former_FSW_nonCot;
    double new_people = main_model_p->epsilon * Ntot;
    output[53] = new_people;
    ...
    output[56] = prev_men;
    output[57] = prev_women;
    output[58] = prev_cotonou;
    output[59] = Ntot;
    memcpy(output_N, main_model_p->N, main_model_p->dim_N * sizeof(double));
    output[60] = prev_FSW;
    output[61] = prev_client;
    ...
    output[64] = pc_of_FOI_on_clients_from_pro_FSW;
...
SEXP main_model_contents(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  SEXP state = PROTECT(allocVector(VECSXP, 865));
  SET_VECTOR_ELT(state, 0, ScalarInteger(main_model_p->odin_use_dde));
  SET_VECTOR_ELT(state, 1, ScalarReal(main_model_p->testpar));
  SET_VECTOR_ELT(state, 2, ScalarReal(main_model_p->replaceDeaths));
  SET_VECTOR_ELT(state, 3, ScalarInteger(main_model_p->dim_pfFSW_t));
  SET_VECTOR_ELT(state, 4, allocVector(REALSXP, main_model_p->dim_pfFSW_t));
  memcpy(REAL(VECTOR_ELT(state, 4)), main_model_p->pfFSW_t, main_model_p->dim_pfFSW_t * sizeof(double));
  SET_VECTOR_ELT(state, 5, ScalarInteger(main_model_p->dim_pfFSW_y));
  SET_VECTOR_ELT(state, 6, ScalarInteger(main_model_p->dim_pfFSW_y_1));
  SET_VECTOR_ELT(state, 7, ScalarInteger(main_model_p->dim_pfFSW_y_2));
  SET_VECTOR_ELT(state, 8, allocVector(REALSXP, main_model_p->dim_pfFSW_y));
  memcpy(REAL(VECTOR_ELT(state, 8)), main_model_p->pfFSW_y, main_model_p->dim_pfFSW_y * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 8), 2, main_model_p->dim_pfFSW_y_1, main_model_p->dim_pfFSW_y_2);
  SET_VECTOR_ELT(state, 9, ScalarReal(main_model_p->infected_FSW_incoming));
  SET_VECTOR_ELT(state, 10, ScalarReal(main_model_p->rate_leave_pro_FSW));
  SET_VECTOR_ELT(state, 11, ScalarReal(main_model_p->fraction_FSW_foreign));
  SET_VECTOR_ELT(state, 12, ScalarInteger(main_model_p->dim_c_t_comm));
  SET_VECTOR_ELT(state, 13, allocVector(REALSXP, main_model_p->dim_c_t_comm));
  memcpy(REAL(VECTOR_ELT(state, 13)), main_model_p->c_t_comm, main_model_p->dim_c_t_comm * sizeof(double));
  SET_VECTOR_ELT(state, 14, ScalarInteger(main_model_p->dim_c_t_noncomm));
  SET_VECTOR_ELT(state, 15, allocVector(REALSXP, main_model_p->dim_c_t_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 15)), main_model_p->c_t_noncomm, main_model_p->dim_c_t_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 16, ScalarInteger(main_model_p->dim_c_y_comm));
  SET_VECTOR_ELT(state, 17, ScalarInteger(main_model_p->dim_c_y_comm_1));
  SET_VECTOR_ELT(state, 18, ScalarInteger(main_model_p->dim_c_y_comm_2));
  SET_VECTOR_ELT(state, 19, allocVector(REALSXP, main_model_p->dim_c_y_comm));
  memcpy(REAL(VECTOR_ELT(state, 19)), main_model_p->c_y_comm, main_model_p->dim_c_y_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 19), 2, main_model_p->dim_c_y_comm_1, main_model_p->dim_c_y_comm_2);
  SET_VECTOR_ELT(state, 20, ScalarInteger(main_model_p->dim_c_y_noncomm));
  SET_VECTOR_ELT(state, 21, ScalarInteger(main_model_p->dim_c_y_noncomm_1));
  SET_VECTOR_ELT(state, 22, ScalarInteger(main_model_p->dim_c_y_noncomm_2));
  SET_VECTOR_ELT(state, 23, allocVector(REALSXP, main_model_p->dim_c_y_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 23)), main_model_p->c_y_noncomm, main_model_p->dim_c_y_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 23), 2, main_model_p->dim_c_y_noncomm_1, main_model_p->dim_c_y_noncomm_2);
  SET_VECTOR_ELT(state, 24, ScalarReal(main_model_p->who_believe_comm));
  SET_VECTOR_ELT(state, 25, ScalarInteger(main_model_p->dim_ART_eligible_CD4_above_500_t));
  SET_VECTOR_ELT(state, 26, allocVector(REALSXP, main_model_p->dim_ART_eligible_CD4_above_500_t));
  memcpy(REAL(VECTOR_ELT(state, 26)), main_model_p->ART_eligible_CD4_above_500_t, main_model_p->dim_ART_eligible_CD4_above_500_t * sizeof(double));
  SET_VECTOR_ELT(state, 27, ScalarInteger(main_model_p->dim_ART_eligible_CD4_350_500_t));
  SET_VECTOR_ELT(state, 28, allocVector(REALSXP, main_model_p->dim_ART_eligible_CD4_350_500_t));
  memcpy(REAL(VECTOR_ELT(state, 28)), main_model_p->ART_eligible_CD4_350_500_t, main_model_p->dim_ART_eligible_CD4_350_500_t * sizeof(double));
  SET_VECTOR_ELT(state, 29, ScalarInteger(main_model_p->dim_ART_eligible_CD4_200_349_t));
  SET_VECTOR_ELT(state, 30, allocVector(REALSXP, main_model_p->dim_ART_eligible_CD4_200_349_t));
  memcpy(REAL(VECTOR_ELT(state, 30)), main_model_p->ART_eligible_CD4_200_349_t, main_model_p->dim_ART_eligible_CD4_200_349_t * sizeof(double));
  SET_VECTOR_ELT(state, 31, ScalarInteger(main_model_p->dim_ART_eligible_CD4_below_200_t));
  SET_VECTOR_ELT(state, 32, allocVector(REALSXP, main_model_p->dim_ART_eligible_CD4_below_200_t));
  memcpy(REAL(VECTOR_ELT(state, 32)), main_model_p->ART_eligible_CD4_below_200_t, main_model_p->dim_ART_eligible_CD4_below_200_t * sizeof(double));
  SET_VECTOR_ELT(state, 33, ScalarInteger(main_model_p->dim_ART_eligible_CD4_above_500_y));
  SET_VECTOR_ELT(state, 34, allocVector(REALSXP, main_model_p->dim_ART_eligible_CD4_above_500_y));
  memcpy(REAL(VECTOR_ELT(state, 34)), main_model_p->ART_eligible_CD4_above_500_y, main_model_p->dim_ART_eligible_CD4_above_500_y * sizeof(double));
  SET_VECTOR_ELT(state, 35, ScalarInteger(main_model_p->dim_ART_eligible_CD4_350_500_y));
  SET_VECTOR_ELT(state, 36, allocVector(REALSXP, main_model_p->dim_ART_eligible_CD4_350_500_y));
  memcpy(REAL(VECTOR_ELT(state, 36)), main_model_p->ART_eligible_CD4_350_500_y, main_model_p->dim_ART_eligible_CD4_350_500_y * sizeof(double));
  SET_VECTOR_ELT(state, 37, ScalarInteger(main_model_p->dim_ART_eligible_CD4_200_349_y));
  SET_VECTOR_ELT(state, 38, allocVector(REALSXP, main_model_p->dim_ART_eligible_CD4_200_349_y));
  memcpy(REAL(VECTOR_ELT(state, 38)), main_model_p->ART_eligible_CD4_200_349_y, main_model_p->dim_ART_eligible_CD4_200_349_y * sizeof(double));
  SET_VECTOR_ELT(state, 39, ScalarInteger(main_model_p->dim_ART_eligible_CD4_below_200_y));
  SET_VECTOR_ELT(state, 40, allocVector(REALSXP, main_model_p->dim_ART_eligible_CD4_below_200_y));
  memcpy(REAL(VECTOR_ELT(state, 40)), main_model_p->ART_eligible_CD4_below_200_y, main_model_p->dim_ART_eligible_CD4_below_200_y * sizeof(double));
  SET_VECTOR_ELT(state, 41, ScalarInteger(main_model_p->dim_infect_ART_y));
  SET_VECTOR_ELT(state, 42, ScalarInteger(main_model_p->dim_infect_ART_y_1));
  SET_VECTOR_ELT(state, 43, ScalarInteger(main_model_p->dim_infect_ART_y_2));
  SET_VECTOR_ELT(state, 44, allocVector(REALSXP, main_model_p->dim_infect_ART_y));
  memcpy(REAL(VECTOR_ELT(state, 44)), main_model_p->infect_ART_y, main_model_p->dim_infect_ART_y * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 44), 2, main_model_p->dim_infect_ART_y_1, main_model_p->dim_infect_ART_y_2);
  SET_VECTOR_ELT(state, 45, ScalarInteger(main_model_p->offset_output_infect_ART_y));
  SET_VECTOR_ELT(state, 46, ScalarInteger(main_model_p->dim_infect_ART_t));
  SET_VECTOR_ELT(state, 47, allocVector(REALSXP, main_model_p->dim_infect_ART_t));
  memcpy(REAL(VECTOR_ELT(state, 47)), main_model_p->infect_ART_t, main_model_p->dim_infect_ART_t * sizeof(double));
  SET_VECTOR_ELT(state, 48, ScalarInteger(main_model_p->offset_output_infect_ART_t));
  SET_VECTOR_ELT(state, 49, ScalarInteger(main_model_p->dim_testing_prob_t));
  SET_VECTOR_ELT(state, 50, allocVector(REALSXP, main_model_p->dim_testing_prob_t));
  memcpy(REAL(VECTOR_ELT(state, 50)), main_model_p->testing_prob_t, main_model_p->dim_testing_prob_t * sizeof(double));
  SET_VECTOR_ELT(state, 51, ScalarInteger(main_model_p->dim_testing_prob_y));
  SET_VECTOR_ELT(state, 52, ScalarInteger(main_model_p->dim_testing_prob_y_1));
  SET_VECTOR_ELT(state, 53, ScalarInteger(main_model_p->dim_testing_prob_y_2));
  SET_VECTOR_ELT(state, 54, allocVector(REALSXP, main_model_p->dim_testing_prob_y));
  memcpy(REAL(VECTOR_ELT(state, 54)), main_model_p->testing_prob_y, main_model_p->dim_testing_prob_y * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 54), 2, main_model_p->dim_testing_prob_y_1, main_model_p->dim_testing_prob_y_2);
  SET_VECTOR_ELT(state, 55, ScalarReal(main_model_p->TasP_testing));
  SET_VECTOR_ELT(state, 56, ScalarInteger(main_model_p->dim_tau_intervention_t));
  SET_VECTOR_ELT(state, 57, allocVector(REALSXP, main_model_p->dim_tau_intervention_t));
  memcpy(REAL(VECTOR_ELT(state, 57)), main_model_p->tau_intervention_t, main_model_p->dim_tau_intervention_t * sizeof(double));
  SET_VECTOR_ELT(state, 58, ScalarInteger(main_model_p->dim_tau_intervention_y));
  SET_VECTOR_ELT(state, 59, ScalarInteger(main_model_p->dim_tau_intervention_y_1));
  SET_VECTOR_ELT(state, 60, ScalarInteger(main_model_p->dim_tau_intervention_y_2));
  SET_VECTOR_ELT(state, 61, allocVector(REALSXP, main_model_p->dim_tau_intervention_y));
  memcpy(REAL(VECTOR_ELT(state, 61)), main_model_p->tau_intervention_y, main_model_p->dim_tau_intervention_y * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 61), 2, main_model_p->dim_tau_intervention_y_1, main_model_p->dim_tau_intervention_y_2);
  SET_VECTOR_ELT(state, 62, ScalarInteger(main_model_p->dim_rho_intervention_t));
  SET_VECTOR_ELT(state, 63, allocVector(REALSXP, main_model_p->dim_rho_intervention_t));
  memcpy(REAL(VECTOR_ELT(state, 63)), main_model_p->rho_intervention_t, main_model_p->dim_rho_intervention_t * sizeof(double));
  SET_VECTOR_ELT(state, 64, ScalarInteger(main_model_p->dim_rho_intervention_y));
  SET_VECTOR_ELT(state, 65, ScalarInteger(main_model_p->dim_rho_intervention_y_1));
  SET_VECTOR_ELT(state, 66, ScalarInteger(main_model_p->dim_rho_intervention_y_2));
  SET_VECTOR_ELT(state, 67, allocVector(REALSXP, main_model_p->dim_rho_intervention_y));
  memcpy(REAL(VECTOR_ELT(state, 67)), main_model_p->rho_intervention_y, main_model_p->dim_rho_intervention_y * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 67), 2, main_model_p->dim_rho_intervention_y_1, main_model_p->dim_rho_intervention_y_2);
  SET_VECTOR_ELT(state, 68, ScalarReal(main_model_p->PrEPOnOff));
  SET_VECTOR_ELT(state, 69, ScalarReal(main_model_p->fPa));
  SET_VECTOR_ELT(state, 70, ScalarReal(main_model_p->fPb));
  SET_VECTOR_ELT(state, 71, ScalarReal(main_model_p->fPc));
  SET_VECTOR_ELT(state, 72, ScalarReal(main_model_p->RR_test_CD4200));
  SET_VECTOR_ELT(state, 73, ScalarInteger(main_model_p->dim_viral_supp_y));
  SET_VECTOR_ELT(state, 74, ScalarInteger(main_model_p->dim_viral_supp_y_1));
  SET_VECTOR_ELT(state, 75, ScalarInteger(main_model_p->dim_viral_supp_y_2));
  SET_VECTOR_ELT(state, 76, allocVector(REALSXP, main_model_p->dim_viral_supp_y));
  memcpy(REAL(VECTOR_ELT(state, 76)), main_model_p->viral_supp_y, main_model_p->dim_viral_supp_y * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 76), 2, main_model_p->dim_viral_supp_y_1, main_model_p->dim_viral_supp_y_2);
  SET_VECTOR_ELT(state, 77, ScalarInteger(main_model_p->offset_output_viral_supp_y));
  SET_VECTOR_ELT(state, 78, ScalarInteger(main_model_p->dim_viral_supp_t));
  SET_VECTOR_ELT(state, 79, allocVector(REALSXP, main_model_p->dim_viral_supp_t));
  memcpy(REAL(VECTOR_ELT(state, 79)), main_model_p->viral_supp_t, main_model_p->dim_viral_supp_t * sizeof(double));
  SET_VECTOR_ELT(state, 80, ScalarInteger(main_model_p->offset_output_viral_supp_t));
  SET_VECTOR_ELT(state, 81, ScalarReal(main_model_p->W0));
  SET_VECTOR_ELT(state, 82, ScalarReal(main_model_p->W1));
  SET_VECTOR_ELT(state, 83, ScalarReal(main_model_p->W2));
  SET_VECTOR_ELT(state, 84, ScalarReal(main_model_p->W3));
  SET_VECTOR_ELT(state, 85, ScalarReal(main_model_p->cost_Initiation_of_ART_study_FSW));
  SET_VECTOR_ELT(state, 86, ScalarReal(main_model_p->cost_Initiation_of_ART_government_FSW));
  SET_VECTOR_ELT(state, 87, ScalarReal(main_model_p->cost_1_year_of_ART_study_FSW));
  SET_VECTOR_ELT(state, 88, ScalarReal(main_model_p->cost_1_year_of_ART_government_FSW));
  SET_VECTOR_ELT(state, 89, ScalarReal(main_model_p->cost_Initiation_ART_rest_of_population));
  SET_VECTOR_ELT(state, 90, ScalarReal(main_model_p->cost_1_year_of_ART_rest_of_population));
  SET_VECTOR_ELT(state, 91, ScalarReal(main_model_p->cost_FSW_initiation_ART_Patient_costs));
  SET_VECTOR_ELT(state, 92, ScalarReal(main_model_p->cost_FSW_1_year_ART_Patient_costs));
  SET_VECTOR_ELT(state, 93, ScalarReal(main_model_p->cost_Initiation_of_PrEP_study));
  SET_VECTOR_ELT(state, 94, ScalarReal(main_model_p->cost_1_year_PrEP_perfect_adherence_study));
  SET_VECTOR_ELT(state, 95, ScalarReal(main_model_p->cost_1_year_PrEP_intermediate_adherence_study));
  SET_VECTOR_ELT(state, 96, ScalarReal(main_model_p->cost_1_year_PrEP_non_adherence_study));
  SET_VECTOR_ELT(state, 97, ScalarReal(main_model_p->cost_Initiation_of_PrEP_government));
  SET_VECTOR_ELT(state, 98, ScalarReal(main_model_p->cost_1_year_PrEP_perfect_adherence_government));
  SET_VECTOR_ELT(state, 99, ScalarReal(main_model_p->cost_1_year_PrEP_intermediate_adherence_government));
  SET_VECTOR_ELT(state, 100, ScalarReal(main_model_p->cost_1_year_PrEP_non_adherence_government));
  SET_VECTOR_ELT(state, 101, ScalarReal(main_model_p->cost_PREP_initiation_Patient_costs));
  SET_VECTOR_ELT(state, 102, ScalarReal(main_model_p->cost_PREP_1_year_ART_Patient_costs));
  SET_VECTOR_ELT(state, 103, ScalarInteger(main_model_p->Ncat));
  SET_VECTOR_ELT(state, 104, ScalarReal(main_model_p->Nage));
  SET_VECTOR_ELT(state, 105, ScalarReal(main_model_p->infect_acute));
  SET_VECTOR_ELT(state, 106, ScalarReal(main_model_p->infect_AIDS));
  SET_VECTOR_ELT(state, 107, ScalarReal(main_model_p->nu));
  SET_VECTOR_ELT(state, 108, ScalarReal(main_model_p->R));
  SET_VECTOR_ELT(state, 109, ScalarInteger(main_model_p->dim_epsilon_t));
  SET_VECTOR_ELT(state, 110, allocVector(REALSXP, main_model_p->dim_epsilon_t));
  memcpy(REAL(VECTOR_ELT(state, 110)), main_model_p->epsilon_t, main_model_p->dim_epsilon_t * sizeof(double));
  SET_VECTOR_ELT(state, 111, ScalarInteger(main_model_p->dim_epsilon_y));
  SET_VECTOR_ELT(state, 112, allocVector(REALSXP, main_model_p->dim_epsilon_y));
  memcpy(REAL(VECTOR_ELT(state, 112)), main_model_p->epsilon_y, main_model_p->dim_epsilon_y * sizeof(double));
  SET_VECTOR_ELT(state, 113, ScalarInteger(main_model_p->dim_fc_t_comm));
  SET_VECTOR_ELT(state, 114, allocVector(REALSXP, main_model_p->dim_fc_t_comm));
  memcpy(REAL(VECTOR_ELT(state, 114)), main_model_p->fc_t_comm, main_model_p->dim_fc_t_comm * sizeof(double));
  SET_VECTOR_ELT(state, 115, ScalarInteger(main_model_p->dim_fc_y_comm));
  SET_VECTOR_ELT(state, 116, ScalarInteger(main_model_p->dim_fc_y_comm_1));
  SET_VECTOR_ELT(state, 117, ScalarInteger(main_model_p->dim_fc_y_comm_2));
  SET_VECTOR_ELT(state, 118, ScalarInteger(main_model_p->dim_fc_y_comm_3));
  SET_VECTOR_ELT(state, 119, ScalarInteger(main_model_p->dim_fc_y_comm_12));
  SET_VECTOR_ELT(state, 120, allocVector(REALSXP, main_model_p->dim_fc_y_comm));
  memcpy(REAL(VECTOR_ELT(state, 120)), main_model_p->fc_y_comm, main_model_p->dim_fc_y_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 120), 3, main_model_p->dim_fc_y_comm_1, main_model_p->dim_fc_y_comm_2, main_model_p->dim_fc_y_comm_3);
  SET_VECTOR_ELT(state, 121, ScalarInteger(main_model_p->dim_fP_t_comm));
  SET_VECTOR_ELT(state, 122, allocVector(REALSXP, main_model_p->dim_fP_t_comm));
  memcpy(REAL(VECTOR_ELT(state, 122)), main_model_p->fP_t_comm, main_model_p->dim_fP_t_comm * sizeof(double));
  SET_VECTOR_ELT(state, 123, ScalarInteger(main_model_p->dim_fP_y_comm));
  SET_VECTOR_ELT(state, 124, ScalarInteger(main_model_p->dim_fP_y_comm_1));
  SET_VECTOR_ELT(state, 125, ScalarInteger(main_model_p->dim_fP_y_comm_2));
  SET_VECTOR_ELT(state, 126, allocVector(REALSXP, main_model_p->dim_fP_y_comm));
  memcpy(REAL(VECTOR_ELT(state, 126)), main_model_p->fP_y_comm, main_model_p->dim_fP_y_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 126), 2, main_model_p->dim_fP_y_comm_1, main_model_p->dim_fP_y_comm_2);
  SET_VECTOR_ELT(state, 127, ScalarInteger(main_model_p->dim_fc_t_noncomm));
  SET_VECTOR_ELT(state, 128, allocVector(REALSXP, main_model_p->dim_fc_t_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 128)), main_model_p->fc_t_noncomm, main_model_p->dim_fc_t_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 129, ScalarInteger(main_model_p->dim_fc_y_noncomm));
  SET_VECTOR_ELT(state, 130, ScalarInteger(main_model_p->dim_fc_y_noncomm_1));
  SET_VECTOR_ELT(state, 131, ScalarInteger(main_model_p->dim_fc_y_noncomm_2));
  SET_VECTOR_ELT(state, 132, ScalarInteger(main_model_p->dim_fc_y_noncomm_3));
  SET_VECTOR_ELT(state, 133, ScalarInteger(main_model_p->dim_fc_y_noncomm_12));
  SET_VECTOR_ELT(state, 134, allocVector(REALSXP, main_model_p->dim_fc_y_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 134)), main_model_p->fc_y_noncomm, main_model_p->dim_fc_y_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 134), 3, main_model_p->dim_fc_y_noncomm_1, main_model_p->dim_fc_y_noncomm_2, main_model_p->dim_fc_y_noncomm_3);
  SET_VECTOR_ELT(state, 135, ScalarInteger(main_model_p->dim_fP_t_noncomm));
  SET_VECTOR_ELT(state, 136, allocVector(REALSXP, main_model_p->dim_fP_t_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 136)), main_model_p->fP_t_noncomm, main_model_p->dim_fP_t_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 137, ScalarInteger(main_model_p->dim_fP_y_noncomm));
  SET_VECTOR_ELT(state, 138, ScalarInteger(main_model_p->dim_fP_y_noncomm_1));
  SET_VECTOR_ELT(state, 139, ScalarInteger(main_model_p->dim_fP_y_noncomm_2));
  SET_VECTOR_ELT(state, 140, allocVector(REALSXP, main_model_p->dim_fP_y_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 140)), main_model_p->fP_y_noncomm, main_model_p->dim_fP_y_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 140), 2, main_model_p->dim_fP_y_noncomm_1, main_model_p->dim_fP_y_noncomm_2);
  SET_VECTOR_ELT(state, 141, ScalarInteger(main_model_p->dim_n_t_comm));
  SET_VECTOR_ELT(state, 142, allocVector(REALSXP, main_model_p->dim_n_t_comm));
  memcpy(REAL(VECTOR_ELT(state, 142)), main_model_p->n_t_comm, main_model_p->dim_n_t_comm * sizeof(double));
  SET_VECTOR_ELT(state, 143, ScalarInteger(main_model_p->dim_n_y_comm));
  SET_VECTOR_ELT(state, 144, ScalarInteger(main_model_p->dim_n_y_comm_1));
  SET_VECTOR_ELT(state, 145, ScalarInteger(main_model_p->dim_n_y_comm_2));
  SET_VECTOR_ELT(state, 146, ScalarInteger(main_model_p->dim_n_y_comm_3));
  SET_VECTOR_ELT(state, 147, ScalarInteger(main_model_p->dim_n_y_comm_12));
  SET_VECTOR_ELT(state, 148, allocVector(REALSXP, main_model_p->dim_n_y_comm));
  memcpy(REAL(VECTOR_ELT(state, 148)), main_model_p->n_y_comm, main_model_p->dim_n_y_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 148), 3, main_model_p->dim_n_y_comm_1, main_model_p->dim_n_y_comm_2, main_model_p->dim_n_y_comm_3);
  SET_VECTOR_ELT(state, 149, ScalarInteger(main_model_p->dim_n_t_noncomm));
  SET_VECTOR_ELT(state, 150, allocVector(REALSXP, main_model_p->dim_n_t_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 150)), main_model_p->n_t_noncomm, main_model_p->dim_n_t_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 151, ScalarInteger(main_model_p->dim_n_y_noncomm));
  SET_VECTOR_ELT(state, 152, ScalarInteger(main_model_p->dim_n_y_noncomm_1));
  SET_VECTOR_ELT(state, 153, ScalarInteger(main_model_p->dim_n_y_noncomm_2));
  SET_VECTOR_ELT(state, 154, ScalarInteger(main_model_p->dim_n_y_noncomm_3));
  SET_VECTOR_ELT(state, 155, ScalarInteger(main_model_p->dim_n_y_noncomm_12));
  SET_VECTOR_ELT(state, 156, allocVector(REALSXP, main_model_p->dim_n_y_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 156)), main_model_p->n_y_noncomm, main_model_p->dim_n_y_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 156), 3, main_model_p->dim_n_y_noncomm_1, main_model_p->dim_n_y_noncomm_2, main_model_p->dim_n_y_noncomm_3);
  SET_VECTOR_ELT(state, 157, ScalarReal(main_model_p->dur_FSW));
  SET_VECTOR_ELT(state, 158, ScalarInteger(main_model_p->dim_prep_intervention_t));
  SET_VECTOR_ELT(state, 159, allocVector(REALSXP, main_model_p->dim_prep_intervention_t));
  memcpy(REAL(VECTOR_ELT(state, 159)), main_model_p->prep_intervention_t, main_model_p->dim_prep_intervention_t * sizeof(double));
  SET_VECTOR_ELT(state, 160, ScalarInteger(main_model_p->dim_prep_intervention_y));
  SET_VECTOR_ELT(state, 161, ScalarInteger(main_model_p->dim_prep_intervention_y_1));
  SET_VECTOR_ELT(state, 162, ScalarInteger(main_model_p->dim_prep_intervention_y_2));
  SET_VECTOR_ELT(state, 163, allocVector(REALSXP, main_model_p->dim_prep_intervention_y));
  memcpy(REAL(VECTOR_ELT(state, 163)), main_model_p->prep_intervention_y, main_model_p->dim_prep_intervention_y * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 163), 2, main_model_p->dim_prep_intervention_y_1, main_model_p->dim_prep_intervention_y_2);
  SET_VECTOR_ELT(state, 164, ScalarInteger(main_model_p->dim_gamma32_without_supp));
  SET_VECTOR_ELT(state, 165, allocVector(REALSXP, main_model_p->dim_gamma32_without_supp));
  memcpy(REAL(VECTOR_ELT(state, 165)), main_model_p->gamma32_without_supp, main_model_p->dim_gamma32_without_supp * sizeof(double));
  SET_VECTOR_ELT(state, 166, ScalarInteger(main_model_p->offset_output_gamma32_without_supp));
  SET_VECTOR_ELT(state, 167, ScalarInteger(main_model_p->dim_gamma33_without_supp));
  SET_VECTOR_ELT(state, 168, allocVector(REALSXP, main_model_p->dim_gamma33_without_supp));
  memcpy(REAL(VECTOR_ELT(state, 168)), main_model_p->gamma33_without_supp, main_model_p->dim_gamma33_without_supp * sizeof(double));
  SET_VECTOR_ELT(state, 169, ScalarInteger(main_model_p->offset_output_gamma33_without_supp));
  SET_VECTOR_ELT(state, 170, ScalarInteger(main_model_p->dim_gamma34_without_supp));
  SET_VECTOR_ELT(state, 171, allocVector(REALSXP, main_model_p->dim_gamma34_without_supp));
  memcpy(REAL(VECTOR_ELT(state, 171)), main_model_p->gamma34_without_supp, main_model_p->dim_gamma34_without_supp * sizeof(double));
  SET_VECTOR_ELT(state, 172, ScalarInteger(main_model_p->offset_output_gamma34_without_supp));
  SET_VECTOR_ELT(state, 173, ScalarInteger(main_model_p->dim_alpha33_without_supp));
  SET_VECTOR_ELT(state, 174, allocVector(REALSXP, main_model_p->dim_alpha33_without_supp));
  memcpy(REAL(VECTOR_ELT(state, 174)), main_model_p->alpha33_without_supp, main_model_p->dim_alpha33_without_supp * sizeof(double));
  SET_VECTOR_ELT(state, 175, ScalarInteger(main_model_p->offset_output_alpha33_without_supp));
  SET_VECTOR_ELT(state, 176, ScalarInteger(main_model_p->dim_alpha34_without_supp));
  SET_VECTOR_ELT(state, 177, allocVector(REALSXP, main_model_p->dim_alpha34_without_supp));
  memcpy(REAL(VECTOR_ELT(state, 177)), main_model_p->alpha34_without_supp, main_model_p->dim_alpha34_without_supp * sizeof(double));
  SET_VECTOR_ELT(state, 178, ScalarInteger(main_model_p->offset_output_alpha34_without_supp));
  SET_VECTOR_ELT(state, 179, ScalarInteger(main_model_p->dim_alpha35_without_supp));
  SET_VECTOR_ELT(state, 180, allocVector(REALSXP, main_model_p->dim_alpha35_without_supp));
  memcpy(REAL(VECTOR_ELT(state, 180)), main_model_p->alpha35_without_supp, main_model_p->dim_alpha35_without_supp * sizeof(double));
  SET_VECTOR_ELT(state, 181, ScalarInteger(main_model_p->offset_output_alpha35_without_supp));
  SET_VECTOR_ELT(state, 182, ScalarInteger(main_model_p->dim_c_comm));
  SET_VECTOR_ELT(state, 183, allocVector(REALSXP, main_model_p->dim_c_comm));
  memcpy(REAL(VECTOR_ELT(state, 183)), main_model_p->c_comm, main_model_p->dim_c_comm * sizeof(double));
  SET_VECTOR_ELT(state, 184, ScalarInteger(main_model_p->offset_output_c_comm));
  SET_VECTOR_ELT(state, 185, ScalarInteger(main_model_p->dim_c_noncomm));
  SET_VECTOR_ELT(state, 186, allocVector(REALSXP, main_model_p->dim_c_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 186)), main_model_p->c_noncomm, main_model_p->dim_c_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 187, ScalarInteger(main_model_p->offset_output_c_noncomm));
  SET_VECTOR_ELT(state, 188, ScalarInteger(main_model_p->dim_pfFSW));
  SET_VECTOR_ELT(state, 189, allocVector(REALSXP, main_model_p->dim_pfFSW));
  memcpy(REAL(VECTOR_ELT(state, 189)), main_model_p->pfFSW, main_model_p->dim_pfFSW * sizeof(double));
  SET_VECTOR_ELT(state, 190, ScalarInteger(main_model_p->offset_output_pfFSW));
  SET_VECTOR_ELT(state, 191, ScalarInteger(main_model_p->dim_new_acute_infected));
  SET_VECTOR_ELT(state, 192, allocVector(REALSXP, main_model_p->dim_new_acute_infected));
  memcpy(REAL(VECTOR_ELT(state, 192)), main_model_p->new_acute_infected, main_model_p->dim_new_acute_infected * sizeof(double));
  SET_VECTOR_ELT(state, 193, ScalarInteger(main_model_p->offset_output_new_acute_infected));
  SET_VECTOR_ELT(state, 194, ScalarInteger(main_model_p->dim_FSW_ONLY));
  SET_VECTOR_ELT(state, 195, allocVector(REALSXP, main_model_p->dim_FSW_ONLY));
  memcpy(REAL(VECTOR_ELT(state, 195)), main_model_p->FSW_ONLY, main_model_p->dim_FSW_ONLY * sizeof(double));
  SET_VECTOR_ELT(state, 196, ScalarInteger(main_model_p->dim_new_people_in_group));
  SET_VECTOR_ELT(state, 197, allocVector(REALSXP, main_model_p->dim_new_people_in_group));
  memcpy(REAL(VECTOR_ELT(state, 197)), main_model_p->new_people_in_group, main_model_p->dim_new_people_in_group * sizeof(double));
  SET_VECTOR_ELT(state, 198, ScalarInteger(main_model_p->offset_output_new_people_in_group));
  SET_VECTOR_ELT(state, 199, ScalarInteger(main_model_p->dim_new_people_in_group_FSW_only));
  SET_VECTOR_ELT(state, 200, allocVector(REALSXP, main_model_p->dim_new_people_in_group_FSW_only));
  memcpy(REAL(VECTOR_ELT(state, 200)), main_model_p->new_people_in_group_FSW_only, main_model_p->dim_new_people_in_group_FSW_only * sizeof(double));
  SET_VECTOR_ELT(state, 201, ScalarInteger(main_model_p->offset_output_new_people_in_group_FSW_only));
  SET_VECTOR_ELT(state, 202, ScalarInteger(main_model_p->dim_comm_partnerships_requested));
  SET_VECTOR_ELT(state, 203, ScalarInteger(main_model_p->dim_comm_partnerships_requested_1));
  SET_VECTOR_ELT(state, 204, ScalarInteger(main_model_p->dim_comm_partnerships_requested_2));
  SET_VECTOR_ELT(state, 205, allocVector(REALSXP, main_model_p->dim_comm_partnerships_requested));
  memcpy(REAL(VECTOR_ELT(state, 205)), main_model_p->comm_partnerships_requested, main_model_p->dim_comm_partnerships_requested * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 205), 2, main_model_p->dim_comm_partnerships_requested_1, main_model_p->dim_comm_partnerships_requested_2);
  SET_VECTOR_ELT(state, 206, ScalarInteger(main_model_p->dim_noncomm_partnerships_requested));
  SET_VECTOR_ELT(state, 207, ScalarInteger(main_model_p->dim_noncomm_partnerships_requested_1));
  SET_VECTOR_ELT(state, 208, ScalarInteger(main_model_p->dim_noncomm_partnerships_requested_2));
  SET_VECTOR_ELT(state, 209, allocVector(REALSXP, main_model_p->dim_noncomm_partnerships_requested));
  memcpy(REAL(VECTOR_ELT(state, 209)), main_model_p->noncomm_partnerships_requested, main_model_p->dim_noncomm_partnerships_requested * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 209), 2, main_model_p->dim_noncomm_partnerships_requested_1, main_model_p->dim_noncomm_partnerships_requested_2);
  SET_VECTOR_ELT(state, 210, ScalarInteger(main_model_p->dim_above_500_by_group));
  SET_VECTOR_ELT(state, 211, allocVector(REALSXP, main_model_p->dim_above_500_by_group));
  memcpy(REAL(VECTOR_ELT(state, 211)), main_model_p->above_500_by_group, main_model_p->dim_above_500_by_group * sizeof(double));
  SET_VECTOR_ELT(state, 212, ScalarInteger(main_model_p->offset_output_above_500_by_group));
  SET_VECTOR_ELT(state, 213, ScalarInteger(main_model_p->dim_testing_prob));
  SET_VECTOR_ELT(state, 214, allocVector(REALSXP, main_model_p->dim_testing_prob));
  memcpy(REAL(VECTOR_ELT(state, 214)), main_model_p->testing_prob, main_model_p->dim_testing_prob * sizeof(double));
  SET_VECTOR_ELT(state, 215, ScalarInteger(main_model_p->offset_output_testing_prob));
  SET_VECTOR_ELT(state, 216, ScalarInteger(main_model_p->dim_tau_intervention));
  SET_VECTOR_ELT(state, 217, allocVector(REALSXP, main_model_p->dim_tau_intervention));
  memcpy(REAL(VECTOR_ELT(state, 217)), main_model_p->tau_intervention, main_model_p->dim_tau_intervention * sizeof(double));
  SET_VECTOR_ELT(state, 218, ScalarInteger(main_model_p->offset_output_tau_intervention));
  SET_VECTOR_ELT(state, 219, ScalarInteger(main_model_p->dim_rho_intervention));
  SET_VECTOR_ELT(state, 220, allocVector(REALSXP, main_model_p->dim_rho_intervention));
  memcpy(REAL(VECTOR_ELT(state, 220)), main_model_p->rho_intervention, main_model_p->dim_rho_intervention * sizeof(double));
  SET_VECTOR_ELT(state, 221, ScalarInteger(main_model_p->offset_output_rho_intervention));
  SET_VECTOR_ELT(state, 222, ScalarInteger(main_model_p->dim_zeta));
  SET_VECTOR_ELT(state, 223, allocVector(REALSXP, main_model_p->dim_zeta));
  memcpy(REAL(VECTOR_ELT(state, 223)), main_model_p->zeta, main_model_p->dim_zeta * sizeof(double));
  SET_VECTOR_ELT(state, 224, ScalarInteger(main_model_p->offset_output_zeta));
  SET_VECTOR_ELT(state, 225, ScalarInteger(main_model_p->dim_sigma));
  SET_VECTOR_ELT(state, 226, allocVector(REALSXP, main_model_p->dim_sigma));
  memcpy(REAL(VECTOR_ELT(state, 226)), main_model_p->sigma, main_model_p->dim_sigma * sizeof(double));
  SET_VECTOR_ELT(state, 227, ScalarInteger(main_model_p->dim_eP1a_effective));
  SET_VECTOR_ELT(state, 228, allocVector(REALSXP, main_model_p->dim_eP1a_effective));
  memcpy(REAL(VECTOR_ELT(state, 228)), main_model_p->eP1a_effective, main_model_p->dim_eP1a_effective * sizeof(double));
  SET_VECTOR_ELT(state, 229, ScalarInteger(main_model_p->offset_output_eP1a_effective));
  SET_VECTOR_ELT(state, 230, ScalarInteger(main_model_p->dim_eP1b_effective));
  SET_VECTOR_ELT(state, 231, allocVector(REALSXP, main_model_p->dim_eP1b_effective));
  memcpy(REAL(VECTOR_ELT(state, 231)), main_model_p->eP1b_effective, main_model_p->dim_eP1b_effective * sizeof(double));
  SET_VECTOR_ELT(state, 232, ScalarInteger(main_model_p->offset_output_eP1b_effective));
  SET_VECTOR_ELT(state, 233, ScalarInteger(main_model_p->dim_eP1c_effective));
  SET_VECTOR_ELT(state, 234, allocVector(REALSXP, main_model_p->dim_eP1c_effective));
  memcpy(REAL(VECTOR_ELT(state, 234)), main_model_p->eP1c_effective, main_model_p->dim_eP1c_effective * sizeof(double));
  SET_VECTOR_ELT(state, 235, ScalarInteger(main_model_p->offset_output_eP1c_effective));
  SET_VECTOR_ELT(state, 236, ScalarInteger(main_model_p->dim_tau));
  SET_VECTOR_ELT(state, 237, allocVector(REALSXP, main_model_p->dim_tau));
  memcpy(REAL(VECTOR_ELT(state, 237)), main_model_p->tau, main_model_p->dim_tau * sizeof(double));
  SET_VECTOR_ELT(state, 238, ScalarInteger(main_model_p->offset_output_tau));
  SET_VECTOR_ELT(state, 239, ScalarInteger(main_model_p->dim_test_rate_prep));
  SET_VECTOR_ELT(state, 240, allocVector(REALSXP, main_model_p->dim_test_rate_prep));
  memcpy(REAL(VECTOR_ELT(state, 240)), main_model_p->test_rate_prep, main_model_p->dim_test_rate_prep * sizeof(double));
  SET_VECTOR_ELT(state, 241, ScalarInteger(main_model_p->dim_rho));
  SET_VECTOR_ELT(state, 242, allocVector(REALSXP, main_model_p->dim_rho));
  memcpy(REAL(VECTOR_ELT(state, 242)), main_model_p->rho, main_model_p->dim_rho * sizeof(double));
  SET_VECTOR_ELT(state, 243, ScalarInteger(main_model_p->offset_output_rho));
  SET_VECTOR_ELT(state, 244, ScalarInteger(main_model_p->dim_iota));
  SET_VECTOR_ELT(state, 245, allocVector(REALSXP, main_model_p->dim_iota));
  memcpy(REAL(VECTOR_ELT(state, 245)), main_model_p->iota, main_model_p->dim_iota * sizeof(double));
  SET_VECTOR_ELT(state, 246, ScalarInteger(main_model_p->offset_output_iota));
  SET_VECTOR_ELT(state, 247, ScalarInteger(main_model_p->dim_viral_supp));
  SET_VECTOR_ELT(state, 248, allocVector(REALSXP, main_model_p->dim_viral_supp));
  memcpy(REAL(VECTOR_ELT(state, 248)), main_model_p->viral_supp, main_model_p->dim_viral_supp * sizeof(double));
  SET_VECTOR_ELT(state, 249, ScalarInteger(main_model_p->offset_output_viral_supp));
  SET_VECTOR_ELT(state, 250, ScalarInteger(main_model_p->dim_HIV_positive));
  SET_VECTOR_ELT(state, 251, allocVector(REALSXP, main_model_p->dim_HIV_positive));
  memcpy(REAL(VECTOR_ELT(state, 251)), main_model_p->HIV_positive, main_model_p->dim_HIV_positive * sizeof(double));
  SET_VECTOR_ELT(state, 252, ScalarInteger(main_model_p->offset_output_HIV_positive));
  SET_VECTOR_ELT(state, 253, ScalarInteger(main_model_p->dim_Number_Susceptibles));
  SET_VECTOR_ELT(state, 254, allocVector(REALSXP, main_model_p->dim_Number_Susceptibles));
  memcpy(REAL(VECTOR_ELT(state, 254)), main_model_p->Number_Susceptibles, main_model_p->dim_Number_Susceptibles * sizeof(double));
  SET_VECTOR_ELT(state, 255, ScalarInteger(main_model_p->offset_output_Number_Susceptibles));
  SET_VECTOR_ELT(state, 256, ScalarInteger(main_model_p->dim_HIV_positive_Diagnosed_Off_ART));
  SET_VECTOR_ELT(state, 257, allocVector(REALSXP, main_model_p->dim_HIV_positive_Diagnosed_Off_ART));
  memcpy(REAL(VECTOR_ELT(state, 257)), main_model_p->HIV_positive_Diagnosed_Off_ART, main_model_p->dim_HIV_positive_Diagnosed_Off_ART * sizeof(double));
  SET_VECTOR_ELT(state, 258, ScalarInteger(main_model_p->offset_output_HIV_positive_Diagnosed_Off_ART));
  SET_VECTOR_ELT(state, 259, ScalarInteger(main_model_p->dim_Primary_Off_ART));
  SET_VECTOR_ELT(state, 260, allocVector(REALSXP, main_model_p->dim_Primary_Off_ART));
  memcpy(REAL(VECTOR_ELT(state, 260)), main_model_p->Primary_Off_ART, main_model_p->dim_Primary_Off_ART * sizeof(double));
  SET_VECTOR_ELT(state, 261, ScalarInteger(main_model_p->offset_output_Primary_Off_ART));
  SET_VECTOR_ELT(state, 262, ScalarInteger(main_model_p->dim_CD4_above_500_Off_ART));
  SET_VECTOR_ELT(state, 263, allocVector(REALSXP, main_model_p->dim_CD4_above_500_Off_ART));
  memcpy(REAL(VECTOR_ELT(state, 263)), main_model_p->CD4_above_500_Off_ART, main_model_p->dim_CD4_above_500_Off_ART * sizeof(double));
  SET_VECTOR_ELT(state, 264, ScalarInteger(main_model_p->offset_output_CD4_above_500_Off_ART));
  SET_VECTOR_ELT(state, 265, ScalarInteger(main_model_p->dim_CD4_350_500_Off_ART));
  SET_VECTOR_ELT(state, 266, allocVector(REALSXP, main_model_p->dim_CD4_350_500_Off_ART));
  memcpy(REAL(VECTOR_ELT(state, 266)), main_model_p->CD4_350_500_Off_ART, main_model_p->dim_CD4_350_500_Off_ART * sizeof(double));
  SET_VECTOR_ELT(state, 267, ScalarInteger(main_model_p->offset_output_CD4_350_500_Off_ART));
  SET_VECTOR_ELT(state, 268, ScalarInteger(main_model_p->dim_CD4_200_350_Off_ART));
  SET_VECTOR_ELT(state, 269, allocVector(REALSXP, main_model_p->dim_CD4_200_350_Off_ART));
  memcpy(REAL(VECTOR_ELT(state, 269)), main_model_p->CD4_200_350_Off_ART, main_model_p->dim_CD4_200_350_Off_ART * sizeof(double));
  SET_VECTOR_ELT(state, 270, ScalarInteger(main_model_p->offset_output_CD4_200_350_Off_ART));
  SET_VECTOR_ELT(state, 271, ScalarInteger(main_model_p->dim_CD4_below_200_Off_ART));
  SET_VECTOR_ELT(state, 272, allocVector(REALSXP, main_model_p->dim_CD4_below_200_Off_ART));
  memcpy(REAL(VECTOR_ELT(state, 272)), main_model_p->CD4_below_200_Off_ART, main_model_p->dim_CD4_below_200_Off_ART * sizeof(double));
  SET_VECTOR_ELT(state, 273, ScalarInteger(main_model_p->offset_output_CD4_below_200_Off_ART));
  SET_VECTOR_ELT(state, 274, ScalarInteger(main_model_p->dim_HIV_positive_On_ART));
  SET_VECTOR_ELT(state, 275, allocVector(REALSXP, main_model_p->dim_HIV_positive_On_ART));
  memcpy(REAL(VECTOR_ELT(state, 275)), main_model_p->HIV_positive_On_ART, main_model_p->dim_HIV_positive_On_ART * sizeof(double));
  SET_VECTOR_ELT(state, 276, ScalarInteger(main_model_p->offset_output_HIV_positive_On_ART));
  SET_VECTOR_ELT(state, 277, ScalarInteger(main_model_p->dim_Number_DALY_W1));
  SET_VECTOR_ELT(state, 278, allocVector(REALSXP, main_model_p->dim_Number_DALY_W1));
  memcpy(REAL(VECTOR_ELT(state, 278)), main_model_p->Number_DALY_W1, main_model_p->dim_Number_DALY_W1 * sizeof(double));
  SET_VECTOR_ELT(state, 279, ScalarInteger(main_model_p->offset_output_Number_DALY_W1));
  SET_VECTOR_ELT(state, 280, ScalarInteger(main_model_p->dim_Number_DALY_W2));
  SET_VECTOR_ELT(state, 281, allocVector(REALSXP, main_model_p->dim_Number_DALY_W2));
  memcpy(REAL(VECTOR_ELT(state, 281)), main_model_p->Number_DALY_W2, main_model_p->dim_Number_DALY_W2 * sizeof(double));
  SET_VECTOR_ELT(state, 282, ScalarInteger(main_model_p->offset_output_Number_DALY_W2));
  SET_VECTOR_ELT(state, 283, ScalarInteger(main_model_p->dim_Number_DALY_W3));
  SET_VECTOR_ELT(state, 284, allocVector(REALSXP, main_model_p->dim_Number_DALY_W3));
  memcpy(REAL(VECTOR_ELT(state, 284)), main_model_p->Number_DALY_W3, main_model_p->dim_Number_DALY_W3 * sizeof(double));
  SET_VECTOR_ELT(state, 285, ScalarInteger(main_model_p->offset_output_Number_DALY_W3));
  SET_VECTOR_ELT(state, 286, ScalarInteger(main_model_p->dim_cumuDeaths_On_ART));
  SET_VECTOR_ELT(state, 287, allocVector(REALSXP, main_model_p->dim_cumuDeaths_On_ART));
  memcpy(REAL(VECTOR_ELT(state, 287)), main_model_p->initial_cumuDeaths_On_ART, main_model_p->dim_cumuDeaths_On_ART * sizeof(double));
  SET_VECTOR_ELT(state, 288, ScalarInteger(main_model_p->offset_cumuDeaths_On_ART));
  SET_VECTOR_ELT(state, 289, ScalarInteger(main_model_p->dim_cumuARTinitiations_not_TasP));
  SET_VECTOR_ELT(state, 290, allocVector(REALSXP, main_model_p->dim_cumuARTinitiations_not_TasP));
  memcpy(REAL(VECTOR_ELT(state, 290)), main_model_p->initial_cumuARTinitiations_not_TasP, main_model_p->dim_cumuARTinitiations_not_TasP * sizeof(double));
  SET_VECTOR_ELT(state, 291, ScalarInteger(main_model_p->offset_cumuARTinitiations_not_TasP));
  SET_VECTOR_ELT(state, 292, ScalarInteger(main_model_p->dim_cumu_PrEP_dropouts));
  SET_VECTOR_ELT(state, 293, allocVector(REALSXP, main_model_p->dim_cumu_PrEP_dropouts));
  memcpy(REAL(VECTOR_ELT(state, 293)), main_model_p->initial_cumu_PrEP_dropouts, main_model_p->dim_cumu_PrEP_dropouts * sizeof(double));
  SET_VECTOR_ELT(state, 294, ScalarInteger(main_model_p->offset_cumu_PrEP_dropouts));
  SET_VECTOR_ELT(state, 295, ScalarInteger(main_model_p->dim_S0_infections));
  SET_VECTOR_ELT(state, 296, allocVector(REALSXP, main_model_p->dim_S0_infections));
  memcpy(REAL(VECTOR_ELT(state, 296)), main_model_p->initial_S0_infections, main_model_p->dim_S0_infections * sizeof(double));
  SET_VECTOR_ELT(state, 297, ScalarInteger(main_model_p->offset_S0_infections));
  SET_VECTOR_ELT(state, 298, ScalarInteger(main_model_p->dim_S1a_infections));
  SET_VECTOR_ELT(state, 299, allocVector(REALSXP, main_model_p->dim_S1a_infections));
  memcpy(REAL(VECTOR_ELT(state, 299)), main_model_p->initial_S1a_infections, main_model_p->dim_S1a_infections * sizeof(double));
  SET_VECTOR_ELT(state, 300, ScalarInteger(main_model_p->offset_S1a_infections));
  SET_VECTOR_ELT(state, 301, ScalarInteger(main_model_p->dim_S1b_infections));
  SET_VECTOR_ELT(state, 302, allocVector(REALSXP, main_model_p->dim_S1b_infections));
  memcpy(REAL(VECTOR_ELT(state, 302)), main_model_p->initial_S1b_infections, main_model_p->dim_S1b_infections * sizeof(double));
  SET_VECTOR_ELT(state, 303, ScalarInteger(main_model_p->offset_S1b_infections));
  SET_VECTOR_ELT(state, 304, ScalarInteger(main_model_p->dim_S1c_infections));
  SET_VECTOR_ELT(state, 305, allocVector(REALSXP, main_model_p->dim_S1c_infections));
  memcpy(REAL(VECTOR_ELT(state, 305)), main_model_p->initial_S1c_infections, main_model_p->dim_S1c_infections * sizeof(double));
  SET_VECTOR_ELT(state, 306, ScalarInteger(main_model_p->offset_S1c_infections));
  SET_VECTOR_ELT(state, 307, ScalarInteger(main_model_p->dim_S1d_infections));
  SET_VECTOR_ELT(state, 308, allocVector(REALSXP, main_model_p->dim_S1d_infections));
  memcpy(REAL(VECTOR_ELT(state, 308)), main_model_p->initial_S1d_infections, main_model_p->dim_S1d_infections * sizeof(double));
  SET_VECTOR_ELT(state, 309, ScalarInteger(main_model_p->offset_S1d_infections));
  SET_VECTOR_ELT(state, 310, ScalarInteger(main_model_p->dim_frac_F));
  SET_VECTOR_ELT(state, 311, allocVector(REALSXP, main_model_p->dim_frac_F));
  memcpy(REAL(VECTOR_ELT(state, 311)), main_model_p->frac_F, main_model_p->dim_frac_F * sizeof(double));
  SET_VECTOR_ELT(state, 312, ScalarInteger(main_model_p->offset_output_frac_F));
  SET_VECTOR_ELT(state, 313, ScalarInteger(main_model_p->dim_frac_N_sexualpop));
  SET_VECTOR_ELT(state, 314, allocVector(REALSXP, main_model_p->dim_frac_N_sexualpop));
  memcpy(REAL(VECTOR_ELT(state, 314)), main_model_p->frac_N_sexualpop, main_model_p->dim_frac_N_sexualpop * sizeof(double));
  SET_VECTOR_ELT(state, 315, ScalarInteger(main_model_p->offset_output_frac_N_sexualpop));
  SET_VECTOR_ELT(state, 316, ScalarInteger(main_model_p->dim_ART_coverage));
  SET_VECTOR_ELT(state, 317, allocVector(REALSXP, main_model_p->dim_ART_coverage));
  memcpy(REAL(VECTOR_ELT(state, 317)), main_model_p->ART_coverage, main_model_p->dim_ART_coverage * sizeof(double));
  SET_VECTOR_ELT(state, 318, ScalarInteger(main_model_p->offset_output_ART_coverage));
  SET_VECTOR_ELT(state, 319, ScalarInteger(main_model_p->dim_infect_ART));
  SET_VECTOR_ELT(state, 320, allocVector(REALSXP, main_model_p->dim_infect_ART));
  memcpy(REAL(VECTOR_ELT(state, 320)), main_model_p->infect_ART, main_model_p->dim_infect_ART * sizeof(double));
  SET_VECTOR_ELT(state, 321, ScalarInteger(main_model_p->offset_output_infect_ART));
  SET_VECTOR_ELT(state, 322, ScalarInteger(main_model_p->dim_prep_offered));
  SET_VECTOR_ELT(state, 323, allocVector(REALSXP, main_model_p->dim_prep_offered));
  memcpy(REAL(VECTOR_ELT(state, 323)), main_model_p->prep_offered, main_model_p->dim_prep_offered * sizeof(double));
  SET_VECTOR_ELT(state, 324, ScalarInteger(main_model_p->offset_output_prep_offered));
  SET_VECTOR_ELT(state, 325, ScalarInteger(main_model_p->dim_omega));
  SET_VECTOR_ELT(state, 326, allocVector(REALSXP, main_model_p->dim_omega));
  memcpy(REAL(VECTOR_ELT(state, 326)), main_model_p->omega, main_model_p->dim_omega * sizeof(double));
  SET_VECTOR_ELT(state, 327, ScalarInteger(main_model_p->offset_output_omega));
  SET_VECTOR_ELT(state, 328, ScalarInteger(main_model_p->dim_frac_N));
  SET_VECTOR_ELT(state, 329, allocVector(REALSXP, main_model_p->dim_frac_N));
  memcpy(REAL(VECTOR_ELT(state, 329)), main_model_p->frac_N, main_model_p->dim_frac_N * sizeof(double));
  SET_VECTOR_ELT(state, 330, ScalarInteger(main_model_p->offset_output_frac_N));
  SET_VECTOR_ELT(state, 331, ScalarInteger(main_model_p->dim_mu));
  SET_VECTOR_ELT(state, 332, allocVector(REALSXP, main_model_p->dim_mu));
  memcpy(REAL(VECTOR_ELT(state, 332)), main_model_p->mu, main_model_p->dim_mu * sizeof(double));
  SET_VECTOR_ELT(state, 333, ScalarInteger(main_model_p->offset_output_mu));
  SET_VECTOR_ELT(state, 334, ScalarInteger(main_model_p->dim_gamma01));
  SET_VECTOR_ELT(state, 335, allocVector(REALSXP, main_model_p->dim_gamma01));
  memcpy(REAL(VECTOR_ELT(state, 335)), main_model_p->gamma01, main_model_p->dim_gamma01 * sizeof(double));
  SET_VECTOR_ELT(state, 336, ScalarInteger(main_model_p->offset_output_gamma01));
  SET_VECTOR_ELT(state, 337, ScalarInteger(main_model_p->dim_gamma02));
  SET_VECTOR_ELT(state, 338, allocVector(REALSXP, main_model_p->dim_gamma02));
  memcpy(REAL(VECTOR_ELT(state, 338)), main_model_p->gamma02, main_model_p->dim_gamma02 * sizeof(double));
  SET_VECTOR_ELT(state, 339, ScalarInteger(main_model_p->dim_gamma03));
  SET_VECTOR_ELT(state, 340, allocVector(REALSXP, main_model_p->dim_gamma03));
  memcpy(REAL(VECTOR_ELT(state, 340)), main_model_p->gamma03, main_model_p->dim_gamma03 * sizeof(double));
  SET_VECTOR_ELT(state, 341, ScalarInteger(main_model_p->dim_gamma04));
  SET_VECTOR_ELT(state, 342, allocVector(REALSXP, main_model_p->dim_gamma04));
  memcpy(REAL(VECTOR_ELT(state, 342)), main_model_p->gamma04, main_model_p->dim_gamma04 * sizeof(double));
  SET_VECTOR_ELT(state, 343, ScalarInteger(main_model_p->dim_gamma11));
  SET_VECTOR_ELT(state, 344, allocVector(REALSXP, main_model_p->dim_gamma11));
  memcpy(REAL(VECTOR_ELT(state, 344)), main_model_p->gamma11, main_model_p->dim_gamma11 * sizeof(double));
  SET_VECTOR_ELT(state, 345, ScalarInteger(main_model_p->offset_output_gamma11));
  SET_VECTOR_ELT(state, 346, ScalarInteger(main_model_p->dim_gamma22));
  SET_VECTOR_ELT(state, 347, allocVector(REALSXP, main_model_p->dim_gamma22));
  memcpy(REAL(VECTOR_ELT(state, 347)), main_model_p->gamma22, main_model_p->dim_gamma22 * sizeof(double));
  SET_VECTOR_ELT(state, 348, ScalarInteger(main_model_p->dim_gamma23));
  SET_VECTOR_ELT(state, 349, allocVector(REALSXP, main_model_p->dim_gamma23));
  memcpy(REAL(VECTOR_ELT(state, 349)), main_model_p->gamma23, main_model_p->dim_gamma23 * sizeof(double));
  SET_VECTOR_ELT(state, 350, ScalarInteger(main_model_p->dim_gamma24));
  SET_VECTOR_ELT(state, 351, allocVector(REALSXP, main_model_p->dim_gamma24));
  memcpy(REAL(VECTOR_ELT(state, 351)), main_model_p->gamma24, main_model_p->dim_gamma24 * sizeof(double));
  SET_VECTOR_ELT(state, 352, ScalarInteger(main_model_p->dim_gamma32));
  SET_VECTOR_ELT(state, 353, allocVector(REALSXP, main_model_p->dim_gamma32));
  memcpy(REAL(VECTOR_ELT(state, 353)), main_model_p->gamma32, main_model_p->dim_gamma32 * sizeof(double));
  SET_VECTOR_ELT(state, 354, ScalarInteger(main_model_p->offset_output_gamma32));
  SET_VECTOR_ELT(state, 355, ScalarInteger(main_model_p->dim_gamma33));
  SET_VECTOR_ELT(state, 356, allocVector(REALSXP, main_model_p->dim_gamma33));
  memcpy(REAL(VECTOR_ELT(state, 356)), main_model_p->gamma33, main_model_p->dim_gamma33 * sizeof(double));
  SET_VECTOR_ELT(state, 357, ScalarInteger(main_model_p->offset_output_gamma33));
  SET_VECTOR_ELT(state, 358, ScalarInteger(main_model_p->dim_gamma34));
  SET_VECTOR_ELT(state, 359, allocVector(REALSXP, main_model_p->dim_gamma34));
  memcpy(REAL(VECTOR_ELT(state, 359)), main_model_p->gamma34, main_model_p->dim_gamma34 * sizeof(double));
  SET_VECTOR_ELT(state, 360, ScalarInteger(main_model_p->offset_output_gamma34));
  SET_VECTOR_ELT(state, 361, ScalarInteger(main_model_p->dim_gamma42));
  SET_VECTOR_ELT(state, 362, allocVector(REALSXP, main_model_p->dim_gamma42));
  memcpy(REAL(VECTOR_ELT(state, 362)), main_model_p->gamma42, main_model_p->dim_gamma42 * sizeof(double));
  SET_VECTOR_ELT(state, 363, ScalarInteger(main_model_p->dim_gamma43));
  SET_VECTOR_ELT(state, 364, allocVector(REALSXP, main_model_p->dim_gamma43));
  memcpy(REAL(VECTOR_ELT(state, 364)), main_model_p->gamma43, main_model_p->dim_gamma43 * sizeof(double));
  SET_VECTOR_ELT(state, 365, ScalarInteger(main_model_p->dim_gamma44));
  SET_VECTOR_ELT(state, 366, allocVector(REALSXP, main_model_p->dim_gamma44));
  memcpy(REAL(VECTOR_ELT(state, 366)), main_model_p->gamma44, main_model_p->dim_gamma44 * sizeof(double));
  SET_VECTOR_ELT(state, 367, ScalarInteger(main_model_p->dim_phi2));
  SET_VECTOR_ELT(state, 368, allocVector(REALSXP, main_model_p->dim_phi2));
  memcpy(REAL(VECTOR_ELT(state, 368)), main_model_p->phi2, main_model_p->dim_phi2 * sizeof(double));
  SET_VECTOR_ELT(state, 369, ScalarInteger(main_model_p->dim_phi3));
  SET_VECTOR_ELT(state, 370, allocVector(REALSXP, main_model_p->dim_phi3));
  memcpy(REAL(VECTOR_ELT(state, 370)), main_model_p->phi3, main_model_p->dim_phi3 * sizeof(double));
  SET_VECTOR_ELT(state, 371, ScalarInteger(main_model_p->dim_phi4));
  SET_VECTOR_ELT(state, 372, allocVector(REALSXP, main_model_p->dim_phi4));
  memcpy(REAL(VECTOR_ELT(state, 372)), main_model_p->phi4, main_model_p->dim_phi4 * sizeof(double));
  SET_VECTOR_ELT(state, 373, ScalarInteger(main_model_p->dim_phi5));
  SET_VECTOR_ELT(state, 374, allocVector(REALSXP, main_model_p->dim_phi5));
  memcpy(REAL(VECTOR_ELT(state, 374)), main_model_p->phi5, main_model_p->dim_phi5 * sizeof(double));
  SET_VECTOR_ELT(state, 375, ScalarInteger(main_model_p->dim_psia));
  SET_VECTOR_ELT(state, 376, allocVector(REALSXP, main_model_p->dim_psia));
  memcpy(REAL(VECTOR_ELT(state, 376)), main_model_p->psia, main_model_p->dim_psia * sizeof(double));
  SET_VECTOR_ELT(state, 377, ScalarInteger(main_model_p->dim_psib));
  SET_VECTOR_ELT(state, 378, allocVector(REALSXP, main_model_p->dim_psib));
  memcpy(REAL(VECTOR_ELT(state, 378)), main_model_p->psib, main_model_p->dim_psib * sizeof(double));
  SET_VECTOR_ELT(state, 379, ScalarInteger(main_model_p->dim_kappaa));
  SET_VECTOR_ELT(state, 380, allocVector(REALSXP, main_model_p->dim_kappaa));
  memcpy(REAL(VECTOR_ELT(state, 380)), main_model_p->kappaa, main_model_p->dim_kappaa * sizeof(double));
  SET_VECTOR_ELT(state, 381, ScalarInteger(main_model_p->offset_output_kappaa));
  SET_VECTOR_ELT(state, 382, ScalarInteger(main_model_p->dim_kappab));
  SET_VECTOR_ELT(state, 383, allocVector(REALSXP, main_model_p->dim_kappab));
  memcpy(REAL(VECTOR_ELT(state, 383)), main_model_p->kappab, main_model_p->dim_kappab * sizeof(double));
  SET_VECTOR_ELT(state, 384, ScalarInteger(main_model_p->offset_output_kappab));
  SET_VECTOR_ELT(state, 385, ScalarInteger(main_model_p->dim_kappac));
  SET_VECTOR_ELT(state, 386, allocVector(REALSXP, main_model_p->dim_kappac));
  memcpy(REAL(VECTOR_ELT(state, 386)), main_model_p->kappac, main_model_p->dim_kappac * sizeof(double));
  SET_VECTOR_ELT(state, 387, ScalarInteger(main_model_p->offset_output_kappac));
  SET_VECTOR_ELT(state, 388, ScalarInteger(main_model_p->dim_kappa1));
  SET_VECTOR_ELT(state, 389, allocVector(REALSXP, main_model_p->dim_kappa1));
  memcpy(REAL(VECTOR_ELT(state, 389)), main_model_p->kappa1, main_model_p->dim_kappa1 * sizeof(double));
  SET_VECTOR_ELT(state, 390, ScalarInteger(main_model_p->offset_output_kappa1));
  SET_VECTOR_ELT(state, 391, ScalarInteger(main_model_p->dim_alpha01));
  SET_VECTOR_ELT(state, 392, allocVector(REALSXP, main_model_p->dim_alpha01));
  memcpy(REAL(VECTOR_ELT(state, 392)), main_model_p->alpha01, main_model_p->dim_alpha01 * sizeof(double));
  SET_VECTOR_ELT(state, 393, ScalarInteger(main_model_p->offset_output_alpha01));
  SET_VECTOR_ELT(state, 394, ScalarInteger(main_model_p->dim_alpha02));
  SET_VECTOR_ELT(state, 395, allocVector(REALSXP, main_model_p->dim_alpha02));
  memcpy(REAL(VECTOR_ELT(state, 395)), main_model_p->alpha02, main_model_p->dim_alpha02 * sizeof(double));
  SET_VECTOR_ELT(state, 396, ScalarInteger(main_model_p->offset_output_alpha02));
  SET_VECTOR_ELT(state, 397, ScalarInteger(main_model_p->dim_alpha03));
  SET_VECTOR_ELT(state, 398, allocVector(REALSXP, main_model_p->dim_alpha03));
  memcpy(REAL(VECTOR_ELT(state, 398)), main_model_p->alpha03, main_model_p->dim_alpha03 * sizeof(double));
  SET_VECTOR_ELT(state, 399, ScalarInteger(main_model_p->dim_alpha04));
  SET_VECTOR_ELT(state, 400, allocVector(REALSXP, main_model_p->dim_alpha04));
  memcpy(REAL(VECTOR_ELT(state, 400)), main_model_p->alpha04, main_model_p->dim_alpha04 * sizeof(double));
  SET_VECTOR_ELT(state, 401, ScalarInteger(main_model_p->dim_alpha05));
  SET_VECTOR_ELT(state, 402, allocVector(REALSXP, main_model_p->dim_alpha05));
  memcpy(REAL(VECTOR_ELT(state, 402)), main_model_p->alpha05, main_model_p->dim_alpha05 * sizeof(double));
  SET_VECTOR_ELT(state, 403, ScalarInteger(main_model_p->offset_output_alpha05));
  SET_VECTOR_ELT(state, 404, ScalarInteger(main_model_p->dim_alpha11));
  SET_VECTOR_ELT(state, 405, allocVector(REALSXP, main_model_p->dim_alpha11));
  memcpy(REAL(VECTOR_ELT(state, 405)), main_model_p->alpha11, main_model_p->dim_alpha11 * sizeof(double));
  SET_VECTOR_ELT(state, 406, ScalarInteger(main_model_p->offset_output_alpha11));
  SET_VECTOR_ELT(state, 407, ScalarInteger(main_model_p->dim_alpha22));
  SET_VECTOR_ELT(state, 408, allocVector(REALSXP, main_model_p->dim_alpha22));
  memcpy(REAL(VECTOR_ELT(state, 408)), main_model_p->alpha22, main_model_p->dim_alpha22 * sizeof(double));
  SET_VECTOR_ELT(state, 409, ScalarInteger(main_model_p->offset_output_alpha22));
  SET_VECTOR_ELT(state, 410, ScalarInteger(main_model_p->dim_alpha23));
  SET_VECTOR_ELT(state, 411, allocVector(REALSXP, main_model_p->dim_alpha23));
  memcpy(REAL(VECTOR_ELT(state, 411)), main_model_p->alpha23, main_model_p->dim_alpha23 * sizeof(double));
  SET_VECTOR_ELT(state, 412, ScalarInteger(main_model_p->dim_alpha24));
  SET_VECTOR_ELT(state, 413, allocVector(REALSXP, main_model_p->dim_alpha24));
  memcpy(REAL(VECTOR_ELT(state, 413)), main_model_p->alpha24, main_model_p->dim_alpha24 * sizeof(double));
  SET_VECTOR_ELT(state, 414, ScalarInteger(main_model_p->dim_alpha25));
  SET_VECTOR_ELT(state, 415, allocVector(REALSXP, main_model_p->dim_alpha25));
  memcpy(REAL(VECTOR_ELT(state, 415)), main_model_p->alpha25, main_model_p->dim_alpha25 * sizeof(double));
  SET_VECTOR_ELT(state, 416, ScalarInteger(main_model_p->dim_alpha32));
  SET_VECTOR_ELT(state, 417, allocVector(REALSXP, main_model_p->dim_alpha32));
  memcpy(REAL(VECTOR_ELT(state, 417)), main_model_p->alpha32, main_model_p->dim_alpha32 * sizeof(double));
  SET_VECTOR_ELT(state, 418, ScalarInteger(main_model_p->dim_alpha33));
  SET_VECTOR_ELT(state, 419, allocVector(REALSXP, main_model_p->dim_alpha33));
  memcpy(REAL(VECTOR_ELT(state, 419)), main_model_p->alpha33, main_model_p->dim_alpha33 * sizeof(double));
  SET_VECTOR_ELT(state, 420, ScalarInteger(main_model_p->offset_output_alpha33));
  SET_VECTOR_ELT(state, 421, ScalarInteger(main_model_p->dim_alpha34));
  SET_VECTOR_ELT(state, 422, allocVector(REALSXP, main_model_p->dim_alpha34));
  memcpy(REAL(VECTOR_ELT(state, 422)), main_model_p->alpha34, main_model_p->dim_alpha34 * sizeof(double));
  SET_VECTOR_ELT(state, 423, ScalarInteger(main_model_p->offset_output_alpha34));
  SET_VECTOR_ELT(state, 424, ScalarInteger(main_model_p->dim_alpha35));
  SET_VECTOR_ELT(state, 425, allocVector(REALSXP, main_model_p->dim_alpha35));
  memcpy(REAL(VECTOR_ELT(state, 425)), main_model_p->alpha35, main_model_p->dim_alpha35 * sizeof(double));
  SET_VECTOR_ELT(state, 426, ScalarInteger(main_model_p->offset_output_alpha35));
  SET_VECTOR_ELT(state, 427, ScalarInteger(main_model_p->dim_alpha42));
  SET_VECTOR_ELT(state, 428, allocVector(REALSXP, main_model_p->dim_alpha42));
  memcpy(REAL(VECTOR_ELT(state, 428)), main_model_p->alpha42, main_model_p->dim_alpha42 * sizeof(double));
  SET_VECTOR_ELT(state, 429, ScalarInteger(main_model_p->dim_alpha43));
  SET_VECTOR_ELT(state, 430, allocVector(REALSXP, main_model_p->dim_alpha43));
  memcpy(REAL(VECTOR_ELT(state, 430)), main_model_p->alpha43, main_model_p->dim_alpha43 * sizeof(double));
  SET_VECTOR_ELT(state, 431, ScalarInteger(main_model_p->dim_alpha44));
  SET_VECTOR_ELT(state, 432, allocVector(REALSXP, main_model_p->dim_alpha44));
  memcpy(REAL(VECTOR_ELT(state, 432)), main_model_p->alpha44, main_model_p->dim_alpha44 * sizeof(double));
  SET_VECTOR_ELT(state, 433, ScalarInteger(main_model_p->dim_alpha45));
  SET_VECTOR_ELT(state, 434, allocVector(REALSXP, main_model_p->dim_alpha45));
  memcpy(REAL(VECTOR_ELT(state, 434)), main_model_p->alpha45, main_model_p->dim_alpha45 * sizeof(double));
  SET_VECTOR_ELT(state, 435, ScalarInteger(main_model_p->dim_beta_comm));
  SET_VECTOR_ELT(state, 436, allocVector(REALSXP, main_model_p->dim_beta_comm));
  memcpy(REAL(VECTOR_ELT(state, 436)), main_model_p->beta_comm, main_model_p->dim_beta_comm * sizeof(double));
  SET_VECTOR_ELT(state, 437, ScalarInteger(main_model_p->offset_output_beta_comm));
  SET_VECTOR_ELT(state, 438, ScalarInteger(main_model_p->dim_beta_noncomm));
  SET_VECTOR_ELT(state, 439, allocVector(REALSXP, main_model_p->dim_beta_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 439)), main_model_p->beta_noncomm, main_model_p->dim_beta_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 440, ScalarInteger(main_model_p->offset_output_beta_noncomm));
  SET_VECTOR_ELT(state, 441, ScalarInteger(main_model_p->dim_p_comm));
  SET_VECTOR_ELT(state, 442, ScalarInteger(main_model_p->dim_p_comm_1));
  SET_VECTOR_ELT(state, 443, ScalarInteger(main_model_p->dim_p_comm_2));
  SET_VECTOR_ELT(state, 444, allocVector(REALSXP, main_model_p->dim_p_comm));
  memcpy(REAL(VECTOR_ELT(state, 444)), main_model_p->p_comm, main_model_p->dim_p_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 444), 2, main_model_p->dim_p_comm_1, main_model_p->dim_p_comm_2);
  SET_VECTOR_ELT(state, 445, ScalarInteger(main_model_p->offset_output_p_comm));
  SET_VECTOR_ELT(state, 446, ScalarInteger(main_model_p->dim_p_noncomm));
  SET_VECTOR_ELT(state, 447, ScalarInteger(main_model_p->dim_p_noncomm_1));
  SET_VECTOR_ELT(state, 448, ScalarInteger(main_model_p->dim_p_noncomm_2));
  SET_VECTOR_ELT(state, 449, allocVector(REALSXP, main_model_p->dim_p_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 449)), main_model_p->p_noncomm, main_model_p->dim_p_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 449), 2, main_model_p->dim_p_noncomm_1, main_model_p->dim_p_noncomm_2);
  SET_VECTOR_ELT(state, 450, ScalarInteger(main_model_p->offset_output_p_noncomm));
  SET_VECTOR_ELT(state, 451, ScalarInteger(main_model_p->dim_ec));
  SET_VECTOR_ELT(state, 452, allocVector(REALSXP, main_model_p->dim_ec));
  memcpy(REAL(VECTOR_ELT(state, 452)), main_model_p->ec, main_model_p->dim_ec * sizeof(double));
  SET_VECTOR_ELT(state, 453, ScalarInteger(main_model_p->dim_eP));
  SET_VECTOR_ELT(state, 454, allocVector(REALSXP, main_model_p->dim_eP));
  memcpy(REAL(VECTOR_ELT(state, 454)), main_model_p->eP, main_model_p->dim_eP * sizeof(double));
  SET_VECTOR_ELT(state, 455, ScalarInteger(main_model_p->dim_eP0));
  SET_VECTOR_ELT(state, 456, allocVector(REALSXP, main_model_p->dim_eP0));
  memcpy(REAL(VECTOR_ELT(state, 456)), main_model_p->eP0, main_model_p->dim_eP0 * sizeof(double));
  SET_VECTOR_ELT(state, 457, ScalarInteger(main_model_p->offset_output_eP0));
  SET_VECTOR_ELT(state, 458, ScalarInteger(main_model_p->dim_eP1a));
  SET_VECTOR_ELT(state, 459, allocVector(REALSXP, main_model_p->dim_eP1a));
  memcpy(REAL(VECTOR_ELT(state, 459)), main_model_p->eP1a, main_model_p->dim_eP1a * sizeof(double));
  SET_VECTOR_ELT(state, 460, ScalarInteger(main_model_p->offset_output_eP1a));
  SET_VECTOR_ELT(state, 461, ScalarInteger(main_model_p->dim_eP1b));
  SET_VECTOR_ELT(state, 462, allocVector(REALSXP, main_model_p->dim_eP1b));
  memcpy(REAL(VECTOR_ELT(state, 462)), main_model_p->eP1b, main_model_p->dim_eP1b * sizeof(double));
  SET_VECTOR_ELT(state, 463, ScalarInteger(main_model_p->offset_output_eP1b));
  SET_VECTOR_ELT(state, 464, ScalarInteger(main_model_p->dim_eP1c));
  SET_VECTOR_ELT(state, 465, allocVector(REALSXP, main_model_p->dim_eP1c));
  memcpy(REAL(VECTOR_ELT(state, 465)), main_model_p->eP1c, main_model_p->dim_eP1c * sizeof(double));
  SET_VECTOR_ELT(state, 466, ScalarInteger(main_model_p->offset_output_eP1c));
  SET_VECTOR_ELT(state, 467, ScalarInteger(main_model_p->dim_eP1d));
  SET_VECTOR_ELT(state, 468, allocVector(REALSXP, main_model_p->dim_eP1d));
  memcpy(REAL(VECTOR_ELT(state, 468)), main_model_p->eP1d, main_model_p->dim_eP1d * sizeof(double));
  SET_VECTOR_ELT(state, 469, ScalarInteger(main_model_p->offset_output_eP1d));
  SET_VECTOR_ELT(state, 470, ScalarInteger(main_model_p->dim_fc_comm));
  SET_VECTOR_ELT(state, 471, ScalarInteger(main_model_p->dim_fc_comm_1));
  SET_VECTOR_ELT(state, 472, ScalarInteger(main_model_p->dim_fc_comm_2));
  SET_VECTOR_ELT(state, 473, allocVector(REALSXP, main_model_p->dim_fc_comm));
  memcpy(REAL(VECTOR_ELT(state, 473)), main_model_p->fc_comm, main_model_p->dim_fc_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 473), 2, main_model_p->dim_fc_comm_1, main_model_p->dim_fc_comm_2);
  SET_VECTOR_ELT(state, 474, ScalarInteger(main_model_p->offset_output_fc_comm));
  SET_VECTOR_ELT(state, 475, ScalarInteger(main_model_p->dim_fP_comm));
  SET_VECTOR_ELT(state, 476, allocVector(REALSXP, main_model_p->dim_fP_comm));
  memcpy(REAL(VECTOR_ELT(state, 476)), main_model_p->fP_comm, main_model_p->dim_fP_comm * sizeof(double));
  SET_VECTOR_ELT(state, 477, ScalarInteger(main_model_p->offset_output_fP_comm));
  SET_VECTOR_ELT(state, 478, ScalarInteger(main_model_p->dim_fc_noncomm));
  SET_VECTOR_ELT(state, 479, ScalarInteger(main_model_p->dim_fc_noncomm_1));
  SET_VECTOR_ELT(state, 480, ScalarInteger(main_model_p->dim_fc_noncomm_2));
  SET_VECTOR_ELT(state, 481, allocVector(REALSXP, main_model_p->dim_fc_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 481)), main_model_p->fc_noncomm, main_model_p->dim_fc_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 481), 2, main_model_p->dim_fc_noncomm_1, main_model_p->dim_fc_noncomm_2);
  SET_VECTOR_ELT(state, 482, ScalarInteger(main_model_p->offset_output_fc_noncomm));
  SET_VECTOR_ELT(state, 483, ScalarInteger(main_model_p->dim_fP_noncomm));
  SET_VECTOR_ELT(state, 484, allocVector(REALSXP, main_model_p->dim_fP_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 484)), main_model_p->fP_noncomm, main_model_p->dim_fP_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 485, ScalarInteger(main_model_p->offset_output_fP_noncomm));
  SET_VECTOR_ELT(state, 486, ScalarInteger(main_model_p->dim_n_comm));
  SET_VECTOR_ELT(state, 487, ScalarInteger(main_model_p->dim_n_comm_1));
  SET_VECTOR_ELT(state, 488, ScalarInteger(main_model_p->dim_n_comm_2));
  SET_VECTOR_ELT(state, 489, allocVector(REALSXP, main_model_p->dim_n_comm));
  memcpy(REAL(VECTOR_ELT(state, 489)), main_model_p->n_comm, main_model_p->dim_n_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 489), 2, main_model_p->dim_n_comm_1, main_model_p->dim_n_comm_2);
  SET_VECTOR_ELT(state, 490, ScalarInteger(main_model_p->offset_output_n_comm));
  SET_VECTOR_ELT(state, 491, ScalarInteger(main_model_p->dim_n_noncomm));
  SET_VECTOR_ELT(state, 492, ScalarInteger(main_model_p->dim_n_noncomm_1));
  SET_VECTOR_ELT(state, 493, ScalarInteger(main_model_p->dim_n_noncomm_2));
  SET_VECTOR_ELT(state, 494, allocVector(REALSXP, main_model_p->dim_n_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 494)), main_model_p->n_noncomm, main_model_p->dim_n_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 494), 2, main_model_p->dim_n_noncomm_1, main_model_p->dim_n_noncomm_2);
  SET_VECTOR_ELT(state, 495, ScalarInteger(main_model_p->offset_output_n_noncomm));
  SET_VECTOR_ELT(state, 496, ScalarInteger(main_model_p->dim_cumuHIVDeaths));
  SET_VECTOR_ELT(state, 497, allocVector(REALSXP, main_model_p->dim_cumuHIVDeaths));
  memcpy(REAL(VECTOR_ELT(state, 497)), main_model_p->initial_cumuHIVDeaths, main_model_p->dim_cumuHIVDeaths * sizeof(double));
  SET_VECTOR_ELT(state, 498, ScalarInteger(main_model_p->offset_cumuHIVDeaths));
  SET_VECTOR_ELT(state, 499, ScalarInteger(main_model_p->dim_cumuARTinitiations));
  SET_VECTOR_ELT(state, 500, allocVector(REALSXP, main_model_p->dim_cumuARTinitiations));
  memcpy(REAL(VECTOR_ELT(state, 500)), main_model_p->initial_cumuARTinitiations, main_model_p->dim_cumuARTinitiations * sizeof(double));
  SET_VECTOR_ELT(state, 501, ScalarInteger(main_model_p->offset_cumuARTinitiations));
  SET_VECTOR_ELT(state, 502, ScalarInteger(main_model_p->dim_TasPinitiations));
  SET_VECTOR_ELT(state, 503, allocVector(REALSXP, main_model_p->dim_TasPinitiations));
  memcpy(REAL(VECTOR_ELT(state, 503)), main_model_p->initial_TasPinitiations, main_model_p->dim_TasPinitiations * sizeof(double));
  SET_VECTOR_ELT(state, 504, ScalarInteger(main_model_p->offset_TasPinitiations));
  SET_VECTOR_ELT(state, 505, ScalarInteger(main_model_p->dim_cumuARTREinitiations));
  SET_VECTOR_ELT(state, 506, allocVector(REALSXP, main_model_p->dim_cumuARTREinitiations));
  memcpy(REAL(VECTOR_ELT(state, 506)), main_model_p->initial_cumuARTREinitiations, main_model_p->dim_cumuARTREinitiations * sizeof(double));
  SET_VECTOR_ELT(state, 507, ScalarInteger(main_model_p->offset_cumuARTREinitiations));
  SET_VECTOR_ELT(state, 508, ScalarInteger(main_model_p->dim_dropouts));
  SET_VECTOR_ELT(state, 509, allocVector(REALSXP, main_model_p->dim_dropouts));
  memcpy(REAL(VECTOR_ELT(state, 509)), main_model_p->initial_dropouts, main_model_p->dim_dropouts * sizeof(double));
  SET_VECTOR_ELT(state, 510, ScalarInteger(main_model_p->offset_dropouts));
  SET_VECTOR_ELT(state, 511, ScalarInteger(main_model_p->dim_cumuAllDeaths));
  SET_VECTOR_ELT(state, 512, allocVector(REALSXP, main_model_p->dim_cumuAllDeaths));
  memcpy(REAL(VECTOR_ELT(state, 512)), main_model_p->initial_cumuAllDeaths, main_model_p->dim_cumuAllDeaths * sizeof(double));
  SET_VECTOR_ELT(state, 513, ScalarInteger(main_model_p->offset_cumuAllDeaths));
  SET_VECTOR_ELT(state, 514, ScalarInteger(main_model_p->dim_cumuInf));
  SET_VECTOR_ELT(state, 515, allocVector(REALSXP, main_model_p->dim_cumuInf));
  memcpy(REAL(VECTOR_ELT(state, 515)), main_model_p->initial_cumuInf, main_model_p->dim_cumuInf * sizeof(double));
  SET_VECTOR_ELT(state, 516, ScalarInteger(main_model_p->offset_cumuInf));
  SET_VECTOR_ELT(state, 517, ScalarInteger(main_model_p->dim_PrEPinitiations));
  SET_VECTOR_ELT(state, 518, allocVector(REALSXP, main_model_p->dim_PrEPinitiations));
  memcpy(REAL(VECTOR_ELT(state, 518)), main_model_p->initial_PrEPinitiations, main_model_p->dim_PrEPinitiations * sizeof(double));
  SET_VECTOR_ELT(state, 519, ScalarInteger(main_model_p->offset_PrEPinitiations));
  SET_VECTOR_ELT(state, 520, ScalarInteger(main_model_p->dim_PrEPinitiations1a));
  SET_VECTOR_ELT(state, 521, allocVector(REALSXP, main_model_p->dim_PrEPinitiations1a));
  memcpy(REAL(VECTOR_ELT(state, 521)), main_model_p->initial_PrEPinitiations1a, main_model_p->dim_PrEPinitiations1a * sizeof(double));
  SET_VECTOR_ELT(state, 522, ScalarInteger(main_model_p->offset_PrEPinitiations1a));
  SET_VECTOR_ELT(state, 523, ScalarInteger(main_model_p->dim_PrEPinitiations1b));
  SET_VECTOR_ELT(state, 524, allocVector(REALSXP, main_model_p->dim_PrEPinitiations1b));
  memcpy(REAL(VECTOR_ELT(state, 524)), main_model_p->initial_PrEPinitiations1b, main_model_p->dim_PrEPinitiations1b * sizeof(double));
  SET_VECTOR_ELT(state, 525, ScalarInteger(main_model_p->offset_PrEPinitiations1b));
  SET_VECTOR_ELT(state, 526, ScalarInteger(main_model_p->dim_PrEPinitiations1c));
  SET_VECTOR_ELT(state, 527, allocVector(REALSXP, main_model_p->dim_PrEPinitiations1c));
  memcpy(REAL(VECTOR_ELT(state, 527)), main_model_p->initial_PrEPinitiations1c, main_model_p->dim_PrEPinitiations1c * sizeof(double));
  SET_VECTOR_ELT(state, 528, ScalarInteger(main_model_p->offset_PrEPinitiations1c));
  SET_VECTOR_ELT(state, 529, ScalarInteger(main_model_p->dim_S0));
  SET_VECTOR_ELT(state, 530, allocVector(REALSXP, main_model_p->dim_S0));
  memcpy(REAL(VECTOR_ELT(state, 530)), main_model_p->initial_S0, main_model_p->dim_S0 * sizeof(double));
  SET_VECTOR_ELT(state, 531, ScalarInteger(main_model_p->offset_S0));
  SET_VECTOR_ELT(state, 532, ScalarInteger(main_model_p->dim_S1a));
  SET_VECTOR_ELT(state, 533, allocVector(REALSXP, main_model_p->dim_S1a));
  memcpy(REAL(VECTOR_ELT(state, 533)), main_model_p->initial_S1a, main_model_p->dim_S1a * sizeof(double));
  SET_VECTOR_ELT(state, 534, ScalarInteger(main_model_p->offset_S1a));
  SET_VECTOR_ELT(state, 535, ScalarInteger(main_model_p->dim_S1b));
  SET_VECTOR_ELT(state, 536, allocVector(REALSXP, main_model_p->dim_S1b));
  memcpy(REAL(VECTOR_ELT(state, 536)), main_model_p->initial_S1b, main_model_p->dim_S1b * sizeof(double));
  SET_VECTOR_ELT(state, 537, ScalarInteger(main_model_p->offset_S1b));
  SET_VECTOR_ELT(state, 538, ScalarInteger(main_model_p->dim_S1c));
  SET_VECTOR_ELT(state, 539, allocVector(REALSXP, main_model_p->dim_S1c));
  memcpy(REAL(VECTOR_ELT(state, 539)), main_model_p->initial_S1c, main_model_p->dim_S1c * sizeof(double));
  SET_VECTOR_ELT(state, 540, ScalarInteger(main_model_p->offset_S1c));
  SET_VECTOR_ELT(state, 541, ScalarInteger(main_model_p->dim_S1d));
  SET_VECTOR_ELT(state, 542, allocVector(REALSXP, main_model_p->dim_S1d));
  memcpy(REAL(VECTOR_ELT(state, 542)), main_model_p->initial_S1d, main_model_p->dim_S1d * sizeof(double));
  SET_VECTOR_ELT(state, 543, ScalarInteger(main_model_p->offset_S1d));
  SET_VECTOR_ELT(state, 544, ScalarInteger(main_model_p->dim_I01));
  SET_VECTOR_ELT(state, 545, allocVector(REALSXP, main_model_p->dim_I01));
  memcpy(REAL(VECTOR_ELT(state, 545)), main_model_p->initial_I01, main_model_p->dim_I01 * sizeof(double));
  SET_VECTOR_ELT(state, 546, ScalarInteger(main_model_p->offset_I01));
  SET_VECTOR_ELT(state, 547, ScalarInteger(main_model_p->dim_I11));
  SET_VECTOR_ELT(state, 548, allocVector(REALSXP, main_model_p->dim_I11));
  memcpy(REAL(VECTOR_ELT(state, 548)), main_model_p->initial_I11, main_model_p->dim_I11 * sizeof(double));
  SET_VECTOR_ELT(state, 549, ScalarInteger(main_model_p->offset_I11));
  SET_VECTOR_ELT(state, 550, ScalarInteger(main_model_p->dim_I02));
  SET_VECTOR_ELT(state, 551, allocVector(REALSXP, main_model_p->dim_I02));
  memcpy(REAL(VECTOR_ELT(state, 551)), main_model_p->initial_I02, main_model_p->dim_I02 * sizeof(double));
  SET_VECTOR_ELT(state, 552, ScalarInteger(main_model_p->offset_I02));
  SET_VECTOR_ELT(state, 553, ScalarInteger(main_model_p->dim_I03));
  SET_VECTOR_ELT(state, 554, allocVector(REALSXP, main_model_p->dim_I03));
  memcpy(REAL(VECTOR_ELT(state, 554)), main_model_p->initial_I03, main_model_p->dim_I03 * sizeof(double));
  SET_VECTOR_ELT(state, 555, ScalarInteger(main_model_p->offset_I03));
  SET_VECTOR_ELT(state, 556, ScalarInteger(main_model_p->dim_I04));
  SET_VECTOR_ELT(state, 557, allocVector(REALSXP, main_model_p->dim_I04));
  memcpy(REAL(VECTOR_ELT(state, 557)), main_model_p->initial_I04, main_model_p->dim_I04 * sizeof(double));
  SET_VECTOR_ELT(state, 558, ScalarInteger(main_model_p->offset_I04));
  SET_VECTOR_ELT(state, 559, ScalarInteger(main_model_p->dim_I05));
  SET_VECTOR_ELT(state, 560, allocVector(REALSXP, main_model_p->dim_I05));
  memcpy(REAL(VECTOR_ELT(state, 560)), main_model_p->initial_I05, main_model_p->dim_I05 * sizeof(double));
  SET_VECTOR_ELT(state, 561, ScalarInteger(main_model_p->offset_I05));
  SET_VECTOR_ELT(state, 562, ScalarInteger(main_model_p->dim_I22));
  SET_VECTOR_ELT(state, 563, allocVector(REALSXP, main_model_p->dim_I22));
  memcpy(REAL(VECTOR_ELT(state, 563)), main_model_p->initial_I22, main_model_p->dim_I22 * sizeof(double));
  SET_VECTOR_ELT(state, 564, ScalarInteger(main_model_p->offset_I22));
  SET_VECTOR_ELT(state, 565, ScalarInteger(main_model_p->dim_I23));
  SET_VECTOR_ELT(state, 566, allocVector(REALSXP, main_model_p->dim_I23));
  memcpy(REAL(VECTOR_ELT(state, 566)), main_model_p->initial_I23, main_model_p->dim_I23 * sizeof(double));
  SET_VECTOR_ELT(state, 567, ScalarInteger(main_model_p->offset_I23));
  SET_VECTOR_ELT(state, 568, ScalarInteger(main_model_p->dim_I24));
  SET_VECTOR_ELT(state, 569, allocVector(REALSXP, main_model_p->dim_I24));
  memcpy(REAL(VECTOR_ELT(state, 569)), main_model_p->initial_I24, main_model_p->dim_I24 * sizeof(double));
  SET_VECTOR_ELT(state, 570, ScalarInteger(main_model_p->offset_I24));
  SET_VECTOR_ELT(state, 571, ScalarInteger(main_model_p->dim_I25));
  SET_VECTOR_ELT(state, 572, allocVector(REALSXP, main_model_p->dim_I25));
  memcpy(REAL(VECTOR_ELT(state, 572)), main_model_p->initial_I25, main_model_p->dim_I25 * sizeof(double));
  SET_VECTOR_ELT(state, 573, ScalarInteger(main_model_p->offset_I25));
  SET_VECTOR_ELT(state, 574, ScalarInteger(main_model_p->dim_I32));
  SET_VECTOR_ELT(state, 575, allocVector(REALSXP, main_model_p->dim_I32));
  memcpy(REAL(VECTOR_ELT(state, 575)), main_model_p->initial_I32, main_model_p->dim_I32 * sizeof(double));
  SET_VECTOR_ELT(state, 576, ScalarInteger(main_model_p->offset_I32));
  SET_VECTOR_ELT(state, 577, ScalarInteger(main_model_p->dim_I33));
  SET_VECTOR_ELT(state, 578, allocVector(REALSXP, main_model_p->dim_I33));
  memcpy(REAL(VECTOR_ELT(state, 578)), main_model_p->initial_I33, main_model_p->dim_I33 * sizeof(double));
  SET_VECTOR_ELT(state, 579, ScalarInteger(main_model_p->offset_I33));
  SET_VECTOR_ELT(state, 580, ScalarInteger(main_model_p->dim_I34));
  SET_VECTOR_ELT(state, 581, allocVector(REALSXP, main_model_p->dim_I34));
  memcpy(REAL(VECTOR_ELT(state, 581)), main_model_p->initial_I34, main_model_p->dim_I34 * sizeof(double));
  SET_VECTOR_ELT(state, 582, ScalarInteger(main_model_p->offset_I34));
  SET_VECTOR_ELT(state, 583, ScalarInteger(main_model_p->dim_I35));
  SET_VECTOR_ELT(state, 584, allocVector(REALSXP, main_model_p->dim_I35));
  memcpy(REAL(VECTOR_ELT(state, 584)), main_model_p->initial_I35, main_model_p->dim_I35 * sizeof(double));
  SET_VECTOR_ELT(state, 585, ScalarInteger(main_model_p->offset_I35));
  SET_VECTOR_ELT(state, 586, ScalarInteger(main_model_p->dim_I42));
  SET_VECTOR_ELT(state, 587, allocVector(REALSXP, main_model_p->dim_I42));
  memcpy(REAL(VECTOR_ELT(state, 587)), main_model_p->initial_I42, main_model_p->dim_I42 * sizeof(double));
  SET_VECTOR_ELT(state, 588, ScalarInteger(main_model_p->offset_I42));
  SET_VECTOR_ELT(state, 589, ScalarInteger(main_model_p->dim_I43));
  SET_VECTOR_ELT(state, 590, allocVector(REALSXP, main_model_p->dim_I43));
  memcpy(REAL(VECTOR_ELT(state, 590)), main_model_p->initial_I43, main_model_p->dim_I43 * sizeof(double));
  SET_VECTOR_ELT(state, 591, ScalarInteger(main_model_p->offset_I43));
  SET_VECTOR_ELT(state, 592, ScalarInteger(main_model_p->dim_I44));
  SET_VECTOR_ELT(state, 593, allocVector(REALSXP, main_model_p->dim_I44));
  memcpy(REAL(VECTOR_ELT(state, 593)), main_model_p->initial_I44, main_model_p->dim_I44 * sizeof(double));
  SET_VECTOR_ELT(state, 594, ScalarInteger(main_model_p->offset_I44));
  SET_VECTOR_ELT(state, 595, ScalarInteger(main_model_p->dim_I45));
  SET_VECTOR_ELT(state, 596, allocVector(REALSXP, main_model_p->dim_I45));
  memcpy(REAL(VECTOR_ELT(state, 596)), main_model_p->initial_I45, main_model_p->dim_I45 * sizeof(double));
  SET_VECTOR_ELT(state, 597, ScalarInteger(main_model_p->offset_I45));
  SET_VECTOR_ELT(state, 598, ScalarInteger(main_model_p->dim_S0_init));
  SET_VECTOR_ELT(state, 599, allocVector(REALSXP, main_model_p->dim_S0_init));
  memcpy(REAL(VECTOR_ELT(state, 599)), main_model_p->S0_init, main_model_p->dim_S0_init * sizeof(double));
  SET_VECTOR_ELT(state, 600, ScalarInteger(main_model_p->dim_S1a_init));
  SET_VECTOR_ELT(state, 601, allocVector(REALSXP, main_model_p->dim_S1a_init));
  memcpy(REAL(VECTOR_ELT(state, 601)), main_model_p->S1a_init, main_model_p->dim_S1a_init * sizeof(double));
  SET_VECTOR_ELT(state, 602, ScalarInteger(main_model_p->dim_S1b_init));
  SET_VECTOR_ELT(state, 603, allocVector(REALSXP, main_model_p->dim_S1b_init));
  memcpy(REAL(VECTOR_ELT(state, 603)), main_model_p->S1b_init, main_model_p->dim_S1b_init * sizeof(double));
  SET_VECTOR_ELT(state, 604, ScalarInteger(main_model_p->dim_S1c_init));
  SET_VECTOR_ELT(state, 605, allocVector(REALSXP, main_model_p->dim_S1c_init));
  memcpy(REAL(VECTOR_ELT(state, 605)), main_model_p->S1c_init, main_model_p->dim_S1c_init * sizeof(double));
  SET_VECTOR_ELT(state, 606, ScalarInteger(main_model_p->dim_S1d_init));
  SET_VECTOR_ELT(state, 607, allocVector(REALSXP, main_model_p->dim_S1d_init));
  memcpy(REAL(VECTOR_ELT(state, 607)), main_model_p->S1d_init, main_model_p->dim_S1d_init * sizeof(double));
  SET_VECTOR_ELT(state, 608, ScalarInteger(main_model_p->dim_I01_init));
  SET_VECTOR_ELT(state, 609, allocVector(REALSXP, main_model_p->dim_I01_init));
  memcpy(REAL(VECTOR_ELT(state, 609)), main_model_p->I01_init, main_model_p->dim_I01_init * sizeof(double));
  SET_VECTOR_ELT(state, 610, ScalarInteger(main_model_p->dim_I11_init));
  SET_VECTOR_ELT(state, 611, allocVector(REALSXP, main_model_p->dim_I11_init));
  memcpy(REAL(VECTOR_ELT(state, 611)), main_model_p->I11_init, main_model_p->dim_I11_init * sizeof(double));
  SET_VECTOR_ELT(state, 612, ScalarInteger(main_model_p->dim_I02_init));
  SET_VECTOR_ELT(state, 613, allocVector(REALSXP, main_model_p->dim_I02_init));
  memcpy(REAL(VECTOR_ELT(state, 613)), main_model_p->I02_init, main_model_p->dim_I02_init * sizeof(double));
  SET_VECTOR_ELT(state, 614, ScalarInteger(main_model_p->dim_I03_init));
  SET_VECTOR_ELT(state, 615, allocVector(REALSXP, main_model_p->dim_I03_init));
  memcpy(REAL(VECTOR_ELT(state, 615)), main_model_p->I03_init, main_model_p->dim_I03_init * sizeof(double));
  SET_VECTOR_ELT(state, 616, ScalarInteger(main_model_p->dim_I04_init));
  SET_VECTOR_ELT(state, 617, allocVector(REALSXP, main_model_p->dim_I04_init));
  memcpy(REAL(VECTOR_ELT(state, 617)), main_model_p->I04_init, main_model_p->dim_I04_init * sizeof(double));
  SET_VECTOR_ELT(state, 618, ScalarInteger(main_model_p->dim_I05_init));
  SET_VECTOR_ELT(state, 619, allocVector(REALSXP, main_model_p->dim_I05_init));
  memcpy(REAL(VECTOR_ELT(state, 619)), main_model_p->I05_init, main_model_p->dim_I05_init * sizeof(double));
  SET_VECTOR_ELT(state, 620, ScalarInteger(main_model_p->dim_I22_init));
  SET_VECTOR_ELT(state, 621, allocVector(REALSXP, main_model_p->dim_I22_init));
  memcpy(REAL(VECTOR_ELT(state, 621)), main_model_p->I22_init, main_model_p->dim_I22_init * sizeof(double));
  SET_VECTOR_ELT(state, 622, ScalarInteger(main_model_p->dim_I23_init));
  SET_VECTOR_ELT(state, 623, allocVector(REALSXP, main_model_p->dim_I23_init));
  memcpy(REAL(VECTOR_ELT(state, 623)), main_model_p->I23_init, main_model_p->dim_I23_init * sizeof(double));
  SET_VECTOR_ELT(state, 624, ScalarInteger(main_model_p->dim_I24_init));
  SET_VECTOR_ELT(state, 625, allocVector(REALSXP, main_model_p->dim_I24_init));
  memcpy(REAL(VECTOR_ELT(state, 625)), main_model_p->I24_init, main_model_p->dim_I24_init * sizeof(double));
  SET_VECTOR_ELT(state, 626, ScalarInteger(main_model_p->dim_I25_init));
  SET_VECTOR_ELT(state, 627, allocVector(REALSXP, main_model_p->dim_I25_init));
  memcpy(REAL(VECTOR_ELT(state, 627)), main_model_p->I25_init, main_model_p->dim_I25_init * sizeof(double));
  SET_VECTOR_ELT(state, 628, ScalarInteger(main_model_p->dim_I32_init));
  SET_VECTOR_ELT(state, 629, allocVector(REALSXP, main_model_p->dim_I32_init));
  memcpy(REAL(VECTOR_ELT(state, 629)), main_model_p->I32_init, main_model_p->dim_I32_init * sizeof(double));
  SET_VECTOR_ELT(state, 630, ScalarInteger(main_model_p->dim_I33_init));
  SET_VECTOR_ELT(state, 631, allocVector(REALSXP, main_model_p->dim_I33_init));
  memcpy(REAL(VECTOR_ELT(state, 631)), main_model_p->I33_init, main_model_p->dim_I33_init * sizeof(double));
  SET_VECTOR_ELT(state, 632, ScalarInteger(main_model_p->dim_I34_init));
  SET_VECTOR_ELT(state, 633, allocVector(REALSXP, main_model_p->dim_I34_init));
  memcpy(REAL(VECTOR_ELT(state, 633)), main_model_p->I34_init, main_model_p->dim_I34_init * sizeof(double));
  SET_VECTOR_ELT(state, 634, ScalarInteger(main_model_p->dim_I35_init));
  SET_VECTOR_ELT(state, 635, allocVector(REALSXP, main_model_p->dim_I35_init));
  memcpy(REAL(VECTOR_ELT(state, 635)), main_model_p->I35_init, main_model_p->dim_I35_init * sizeof(double));
  SET_VECTOR_ELT(state, 636, ScalarInteger(main_model_p->dim_I42_init));
  SET_VECTOR_ELT(state, 637, allocVector(REALSXP, main_model_p->dim_I42_init));
  memcpy(REAL(VECTOR_ELT(state, 637)), main_model_p->I42_init, main_model_p->dim_I42_init * sizeof(double));
  SET_VECTOR_ELT(state, 638, ScalarInteger(main_model_p->dim_I43_init));
  SET_VECTOR_ELT(state, 639, allocVector(REALSXP, main_model_p->dim_I43_init));
  memcpy(REAL(VECTOR_ELT(state, 639)), main_model_p->I43_init, main_model_p->dim_I43_init * sizeof(double));
  SET_VECTOR_ELT(state, 640, ScalarInteger(main_model_p->dim_I44_init));
  SET_VECTOR_ELT(state, 641, allocVector(REALSXP, main_model_p->dim_I44_init));
  memcpy(REAL(VECTOR_ELT(state, 641)), main_model_p->I44_init, main_model_p->dim_I44_init * sizeof(double));
  SET_VECTOR_ELT(state, 642, ScalarInteger(main_model_p->dim_I45_init));
  SET_VECTOR_ELT(state, 643, allocVector(REALSXP, main_model_p->dim_I45_init));
  memcpy(REAL(VECTOR_ELT(state, 643)), main_model_p->I45_init, main_model_p->dim_I45_init * sizeof(double));
  SET_VECTOR_ELT(state, 644, ScalarInteger(main_model_p->dim_N));
  SET_VECTOR_ELT(state, 645, allocVector(REALSXP, main_model_p->dim_N));
  memcpy(REAL(VECTOR_ELT(state, 645)), main_model_p->N, main_model_p->dim_N * sizeof(double));
  SET_VECTOR_ELT(state, 646, ScalarInteger(main_model_p->offset_output_N));
  SET_VECTOR_ELT(state, 647, ScalarInteger(main_model_p->dim_E0));
  SET_VECTOR_ELT(state, 648, allocVector(REALSXP, main_model_p->dim_E0));
  memcpy(REAL(VECTOR_ELT(state, 648)), main_model_p->E0, main_model_p->dim_E0 * sizeof(double));
  SET_VECTOR_ELT(state, 649, ScalarInteger(main_model_p->offset_output_E0));
  SET_VECTOR_ELT(state, 650, ScalarInteger(main_model_p->dim_E1a));
  SET_VECTOR_ELT(state, 651, allocVector(REALSXP, main_model_p->dim_E1a));
  memcpy(REAL(VECTOR_ELT(state, 651)), main_model_p->E1a, main_model_p->dim_E1a * sizeof(double));
  SET_VECTOR_ELT(state, 652, ScalarInteger(main_model_p->offset_output_E1a));
  SET_VECTOR_ELT(state, 653, ScalarInteger(main_model_p->dim_E1b));
  SET_VECTOR_ELT(state, 654, allocVector(REALSXP, main_model_p->dim_E1b));
  memcpy(REAL(VECTOR_ELT(state, 654)), main_model_p->E1b, main_model_p->dim_E1b * sizeof(double));
  SET_VECTOR_ELT(state, 655, ScalarInteger(main_model_p->offset_output_E1b));
  SET_VECTOR_ELT(state, 656, ScalarInteger(main_model_p->dim_E1c));
  SET_VECTOR_ELT(state, 657, allocVector(REALSXP, main_model_p->dim_E1c));
  memcpy(REAL(VECTOR_ELT(state, 657)), main_model_p->E1c, main_model_p->dim_E1c * sizeof(double));
  SET_VECTOR_ELT(state, 658, ScalarInteger(main_model_p->offset_output_E1c));
  SET_VECTOR_ELT(state, 659, ScalarInteger(main_model_p->dim_E1d));
  SET_VECTOR_ELT(state, 660, allocVector(REALSXP, main_model_p->dim_E1d));
  memcpy(REAL(VECTOR_ELT(state, 660)), main_model_p->E1d, main_model_p->dim_E1d * sizeof(double));
  SET_VECTOR_ELT(state, 661, ScalarInteger(main_model_p->offset_output_E1d));
  SET_VECTOR_ELT(state, 662, ScalarInteger(main_model_p->dim_cumuInf_init));
  SET_VECTOR_ELT(state, 663, allocVector(REALSXP, main_model_p->dim_cumuInf_init));
  memcpy(REAL(VECTOR_ELT(state, 663)), main_model_p->cumuInf_init, main_model_p->dim_cumuInf_init * sizeof(double));
  SET_VECTOR_ELT(state, 664, ScalarInteger(main_model_p->dim_alphaItot));
  SET_VECTOR_ELT(state, 665, allocVector(REALSXP, main_model_p->dim_alphaItot));
  memcpy(REAL(VECTOR_ELT(state, 665)), main_model_p->alphaItot, main_model_p->dim_alphaItot * sizeof(double));
  SET_VECTOR_ELT(state, 666, ScalarInteger(main_model_p->offset_output_alphaItot));
  SET_VECTOR_ELT(state, 667, ScalarInteger(main_model_p->dim_prev));
  SET_VECTOR_ELT(state, 668, allocVector(REALSXP, main_model_p->dim_prev));
  memcpy(REAL(VECTOR_ELT(state, 668)), main_model_p->prev, main_model_p->dim_prev * sizeof(double));
  SET_VECTOR_ELT(state, 669, ScalarInteger(main_model_p->offset_output_prev));
  SET_VECTOR_ELT(state, 670, ScalarInteger(main_model_p->dim_lambda));
  SET_VECTOR_ELT(state, 671, ScalarInteger(main_model_p->dim_lambda_1));
  SET_VECTOR_ELT(state, 672, ScalarInteger(main_model_p->dim_lambda_2));
  SET_VECTOR_ELT(state, 673, allocVector(REALSXP, main_model_p->dim_lambda));
  memcpy(REAL(VECTOR_ELT(state, 673)), main_model_p->lambda, main_model_p->dim_lambda * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 673), 2, main_model_p->dim_lambda_1, main_model_p->dim_lambda_2);
  SET_VECTOR_ELT(state, 674, ScalarInteger(main_model_p->offset_output_lambda));
  SET_VECTOR_ELT(state, 675, ScalarInteger(main_model_p->dim_lambda_0));
  SET_VECTOR_ELT(state, 676, ScalarInteger(main_model_p->dim_lambda_0_1));
  SET_VECTOR_ELT(state, 677, ScalarInteger(main_model_p->dim_lambda_0_2));
  SET_VECTOR_ELT(state, 678, allocVector(REALSXP, main_model_p->dim_lambda_0));
  memcpy(REAL(VECTOR_ELT(state, 678)), main_model_p->lambda_0, main_model_p->dim_lambda_0 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 678), 2, main_model_p->dim_lambda_0_1, main_model_p->dim_lambda_0_2);
  SET_VECTOR_ELT(state, 679, ScalarInteger(main_model_p->offset_output_lambda_0));
  SET_VECTOR_ELT(state, 680, ScalarInteger(main_model_p->dim_lambda_1a));
  SET_VECTOR_ELT(state, 681, ScalarInteger(main_model_p->dim_lambda_1a_1));
  SET_VECTOR_ELT(state, 682, ScalarInteger(main_model_p->dim_lambda_1a_2));
  SET_VECTOR_ELT(state, 683, allocVector(REALSXP, main_model_p->dim_lambda_1a));
  memcpy(REAL(VECTOR_ELT(state, 683)), main_model_p->lambda_1a, main_model_p->dim_lambda_1a * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 683), 2, main_model_p->dim_lambda_1a_1, main_model_p->dim_lambda_1a_2);
  SET_VECTOR_ELT(state, 684, ScalarInteger(main_model_p->offset_output_lambda_1a));
  SET_VECTOR_ELT(state, 685, ScalarInteger(main_model_p->dim_lambda_1b));
  SET_VECTOR_ELT(state, 686, ScalarInteger(main_model_p->dim_lambda_1b_1));
  SET_VECTOR_ELT(state, 687, ScalarInteger(main_model_p->dim_lambda_1b_2));
  SET_VECTOR_ELT(state, 688, allocVector(REALSXP, main_model_p->dim_lambda_1b));
  memcpy(REAL(VECTOR_ELT(state, 688)), main_model_p->lambda_1b, main_model_p->dim_lambda_1b * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 688), 2, main_model_p->dim_lambda_1b_1, main_model_p->dim_lambda_1b_2);
  SET_VECTOR_ELT(state, 689, ScalarInteger(main_model_p->offset_output_lambda_1b));
  SET_VECTOR_ELT(state, 690, ScalarInteger(main_model_p->dim_lambda_1c));
  SET_VECTOR_ELT(state, 691, ScalarInteger(main_model_p->dim_lambda_1c_1));
  SET_VECTOR_ELT(state, 692, ScalarInteger(main_model_p->dim_lambda_1c_2));
  SET_VECTOR_ELT(state, 693, allocVector(REALSXP, main_model_p->dim_lambda_1c));
  memcpy(REAL(VECTOR_ELT(state, 693)), main_model_p->lambda_1c, main_model_p->dim_lambda_1c * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 693), 2, main_model_p->dim_lambda_1c_1, main_model_p->dim_lambda_1c_2);
  SET_VECTOR_ELT(state, 694, ScalarInteger(main_model_p->offset_output_lambda_1c));
  SET_VECTOR_ELT(state, 695, ScalarInteger(main_model_p->dim_lambda_1d));
  SET_VECTOR_ELT(state, 696, ScalarInteger(main_model_p->dim_lambda_1d_1));
  SET_VECTOR_ELT(state, 697, ScalarInteger(main_model_p->dim_lambda_1d_2));
  SET_VECTOR_ELT(state, 698, allocVector(REALSXP, main_model_p->dim_lambda_1d));
  memcpy(REAL(VECTOR_ELT(state, 698)), main_model_p->lambda_1d, main_model_p->dim_lambda_1d * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 698), 2, main_model_p->dim_lambda_1d_1, main_model_p->dim_lambda_1d_2);
  SET_VECTOR_ELT(state, 699, ScalarInteger(main_model_p->offset_output_lambda_1d));
  SET_VECTOR_ELT(state, 700, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_VECTOR_ELT(state, 701, allocVector(REALSXP, main_model_p->dim_lambda_sum_0));
  memcpy(REAL(VECTOR_ELT(state, 701)), main_model_p->lambda_sum_0, main_model_p->dim_lambda_sum_0 * sizeof(double));
  SET_VECTOR_ELT(state, 702, ScalarInteger(main_model_p->offset_output_lambda_sum_0));
  SET_VECTOR_ELT(state, 703, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_VECTOR_ELT(state, 704, allocVector(REALSXP, main_model_p->dim_lambda_sum_1a));
  memcpy(REAL(VECTOR_ELT(state, 704)), main_model_p->lambda_sum_1a, main_model_p->dim_lambda_sum_1a * sizeof(double));
  SET_VECTOR_ELT(state, 705, ScalarInteger(main_model_p->offset_output_lambda_sum_1a));
  SET_VECTOR_ELT(state, 706, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_VECTOR_ELT(state, 707, allocVector(REALSXP, main_model_p->dim_lambda_sum_1b));
  memcpy(REAL(VECTOR_ELT(state, 707)), main_model_p->lambda_sum_1b, main_model_p->dim_lambda_sum_1b * sizeof(double));
  SET_VECTOR_ELT(state, 708, ScalarInteger(main_model_p->offset_output_lambda_sum_1b));
  SET_VECTOR_ELT(state, 709, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_VECTOR_ELT(state, 710, allocVector(REALSXP, main_model_p->dim_lambda_sum_1c));
  memcpy(REAL(VECTOR_ELT(state, 710)), main_model_p->lambda_sum_1c, main_model_p->dim_lambda_sum_1c * sizeof(double));
  SET_VECTOR_ELT(state, 711, ScalarInteger(main_model_p->offset_output_lambda_sum_1c));
  SET_VECTOR_ELT(state, 712, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_VECTOR_ELT(state, 713, allocVector(REALSXP, main_model_p->dim_lambda_sum_1d));
  memcpy(REAL(VECTOR_ELT(state, 713)), main_model_p->lambda_sum_1d, main_model_p->dim_lambda_sum_1d * sizeof(double));
  SET_VECTOR_ELT(state, 714, ScalarInteger(main_model_p->offset_output_lambda_sum_1d));
  SET_VECTOR_ELT(state, 715, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_VECTOR_ELT(state, 716, allocVector(REALSXP, main_model_p->dim_c_comm_balanced));
  memcpy(REAL(VECTOR_ELT(state, 716)), main_model_p->c_comm_balanced, main_model_p->dim_c_comm_balanced * sizeof(double));
  SET_VECTOR_ELT(state, 717, ScalarInteger(main_model_p->offset_output_c_comm_balanced));
  SET_VECTOR_ELT(state, 718, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_VECTOR_ELT(state, 719, allocVector(REALSXP, main_model_p->dim_c_noncomm_balanced));
  memcpy(REAL(VECTOR_ELT(state, 719)), main_model_p->c_noncomm_balanced, main_model_p->dim_c_noncomm_balanced * sizeof(double));
  SET_VECTOR_ELT(state, 720, ScalarInteger(main_model_p->offset_output_c_noncomm_balanced));
  SET_VECTOR_ELT(state, 721, ScalarInteger(main_model_p->dim_theta));
  SET_VECTOR_ELT(state, 722, ScalarInteger(main_model_p->dim_theta_1));
  SET_VECTOR_ELT(state, 723, ScalarInteger(main_model_p->dim_theta_2));
  SET_VECTOR_ELT(state, 724, allocVector(REALSXP, main_model_p->dim_theta));
  memcpy(REAL(VECTOR_ELT(state, 724)), main_model_p->theta, main_model_p->dim_theta * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 724), 2, main_model_p->dim_theta_1, main_model_p->dim_theta_2);
  SET_VECTOR_ELT(state, 725, ScalarInteger(main_model_p->offset_output_theta));
  SET_VECTOR_ELT(state, 726, ScalarInteger(main_model_p->dim_PrEPinitiations_init));
  SET_VECTOR_ELT(state, 727, allocVector(REALSXP, main_model_p->dim_PrEPinitiations_init));
  memcpy(REAL(VECTOR_ELT(state, 727)), main_model_p->PrEPinitiations_init, main_model_p->dim_PrEPinitiations_init * sizeof(double));
  SET_VECTOR_ELT(state, 728, ScalarInteger(main_model_p->dim_M_comm));
  SET_VECTOR_ELT(state, 729, ScalarInteger(main_model_p->dim_M_comm_1));
  SET_VECTOR_ELT(state, 730, ScalarInteger(main_model_p->dim_M_comm_2));
  SET_VECTOR_ELT(state, 731, allocVector(REALSXP, main_model_p->dim_M_comm));
  memcpy(REAL(VECTOR_ELT(state, 731)), main_model_p->M_comm, main_model_p->dim_M_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 731), 2, main_model_p->dim_M_comm_1, main_model_p->dim_M_comm_2);
  SET_VECTOR_ELT(state, 732, ScalarInteger(main_model_p->offset_output_M_comm));
  SET_VECTOR_ELT(state, 733, ScalarInteger(main_model_p->dim_M_noncomm));
  SET_VECTOR_ELT(state, 734, ScalarInteger(main_model_p->dim_M_noncomm_1));
  SET_VECTOR_ELT(state, 735, ScalarInteger(main_model_p->dim_M_noncomm_2));
  SET_VECTOR_ELT(state, 736, allocVector(REALSXP, main_model_p->dim_M_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 736)), main_model_p->M_noncomm, main_model_p->dim_M_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 736), 2, main_model_p->dim_M_noncomm_1, main_model_p->dim_M_noncomm_2);
  SET_VECTOR_ELT(state, 737, ScalarInteger(main_model_p->offset_output_M_noncomm));
  SET_VECTOR_ELT(state, 738, ScalarInteger(main_model_p->dim_in_S0));
  SET_VECTOR_ELT(state, 739, ScalarInteger(main_model_p->dim_in_S0_1));
  SET_VECTOR_ELT(state, 740, ScalarInteger(main_model_p->dim_in_S0_2));
  SET_VECTOR_ELT(state, 741, allocVector(REALSXP, main_model_p->dim_in_S0));
  memcpy(REAL(VECTOR_ELT(state, 741)), main_model_p->in_S0, main_model_p->dim_in_S0 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 741), 2, main_model_p->dim_in_S0_1, main_model_p->dim_in_S0_2);
  SET_VECTOR_ELT(state, 742, ScalarInteger(main_model_p->dim_in_S1a));
  SET_VECTOR_ELT(state, 743, ScalarInteger(main_model_p->dim_in_S1a_1));
  SET_VECTOR_ELT(state, 744, ScalarInteger(main_model_p->dim_in_S1a_2));
  SET_VECTOR_ELT(state, 745, allocVector(REALSXP, main_model_p->dim_in_S1a));
  memcpy(REAL(VECTOR_ELT(state, 745)), main_model_p->in_S1a, main_model_p->dim_in_S1a * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 745), 2, main_model_p->dim_in_S1a_1, main_model_p->dim_in_S1a_2);
  SET_VECTOR_ELT(state, 746, ScalarInteger(main_model_p->dim_in_S1b));
  SET_VECTOR_ELT(state, 747, ScalarInteger(main_model_p->dim_in_S1b_1));
  SET_VECTOR_ELT(state, 748, ScalarInteger(main_model_p->dim_in_S1b_2));
  SET_VECTOR_ELT(state, 749, allocVector(REALSXP, main_model_p->dim_in_S1b));
  memcpy(REAL(VECTOR_ELT(state, 749)), main_model_p->in_S1b, main_model_p->dim_in_S1b * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 749), 2, main_model_p->dim_in_S1b_1, main_model_p->dim_in_S1b_2);
  SET_VECTOR_ELT(state, 750, ScalarInteger(main_model_p->dim_in_S1c));
  SET_VECTOR_ELT(state, 751, ScalarInteger(main_model_p->dim_in_S1c_1));
  SET_VECTOR_ELT(state, 752, ScalarInteger(main_model_p->dim_in_S1c_2));
  SET_VECTOR_ELT(state, 753, allocVector(REALSXP, main_model_p->dim_in_S1c));
  memcpy(REAL(VECTOR_ELT(state, 753)), main_model_p->in_S1c, main_model_p->dim_in_S1c * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 753), 2, main_model_p->dim_in_S1c_1, main_model_p->dim_in_S1c_2);
  SET_VECTOR_ELT(state, 754, ScalarInteger(main_model_p->dim_in_S1d));
  SET_VECTOR_ELT(state, 755, ScalarInteger(main_model_p->dim_in_S1d_1));
  SET_VECTOR_ELT(state, 756, ScalarInteger(main_model_p->dim_in_S1d_2));
  SET_VECTOR_ELT(state, 757, allocVector(REALSXP, main_model_p->dim_in_S1d));
  memcpy(REAL(VECTOR_ELT(state, 757)), main_model_p->in_S1d, main_model_p->dim_in_S1d * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 757), 2, main_model_p->dim_in_S1d_1, main_model_p->dim_in_S1d_2);
  SET_VECTOR_ELT(state, 758, ScalarInteger(main_model_p->dim_in_I01));
  SET_VECTOR_ELT(state, 759, ScalarInteger(main_model_p->dim_in_I01_1));
  SET_VECTOR_ELT(state, 760, ScalarInteger(main_model_p->dim_in_I01_2));
  SET_VECTOR_ELT(state, 761, allocVector(REALSXP, main_model_p->dim_in_I01));
  memcpy(REAL(VECTOR_ELT(state, 761)), main_model_p->in_I01, main_model_p->dim_in_I01 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 761), 2, main_model_p->dim_in_I01_1, main_model_p->dim_in_I01_2);
  SET_VECTOR_ELT(state, 762, ScalarInteger(main_model_p->dim_in_I11));
  SET_VECTOR_ELT(state, 763, ScalarInteger(main_model_p->dim_in_I11_1));
  SET_VECTOR_ELT(state, 764, ScalarInteger(main_model_p->dim_in_I11_2));
  SET_VECTOR_ELT(state, 765, allocVector(REALSXP, main_model_p->dim_in_I11));
  memcpy(REAL(VECTOR_ELT(state, 765)), main_model_p->in_I11, main_model_p->dim_in_I11 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 765), 2, main_model_p->dim_in_I11_1, main_model_p->dim_in_I11_2);
  SET_VECTOR_ELT(state, 766, ScalarInteger(main_model_p->dim_in_I02));
  SET_VECTOR_ELT(state, 767, ScalarInteger(main_model_p->dim_in_I02_1));
  SET_VECTOR_ELT(state, 768, ScalarInteger(main_model_p->dim_in_I02_2));
  SET_VECTOR_ELT(state, 769, allocVector(REALSXP, main_model_p->dim_in_I02));
  memcpy(REAL(VECTOR_ELT(state, 769)), main_model_p->in_I02, main_model_p->dim_in_I02 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 769), 2, main_model_p->dim_in_I02_1, main_model_p->dim_in_I02_2);
  SET_VECTOR_ELT(state, 770, ScalarInteger(main_model_p->dim_in_I03));
  SET_VECTOR_ELT(state, 771, ScalarInteger(main_model_p->dim_in_I03_1));
  SET_VECTOR_ELT(state, 772, ScalarInteger(main_model_p->dim_in_I03_2));
  SET_VECTOR_ELT(state, 773, allocVector(REALSXP, main_model_p->dim_in_I03));
  memcpy(REAL(VECTOR_ELT(state, 773)), main_model_p->in_I03, main_model_p->dim_in_I03 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 773), 2, main_model_p->dim_in_I03_1, main_model_p->dim_in_I03_2);
  SET_VECTOR_ELT(state, 774, ScalarInteger(main_model_p->dim_in_I04));
  SET_VECTOR_ELT(state, 775, ScalarInteger(main_model_p->dim_in_I04_1));
  SET_VECTOR_ELT(state, 776, ScalarInteger(main_model_p->dim_in_I04_2));
  SET_VECTOR_ELT(state, 777, allocVector(REALSXP, main_model_p->dim_in_I04));
  memcpy(REAL(VECTOR_ELT(state, 777)), main_model_p->in_I04, main_model_p->dim_in_I04 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 777), 2, main_model_p->dim_in_I04_1, main_model_p->dim_in_I04_2);
  SET_VECTOR_ELT(state, 778, ScalarInteger(main_model_p->dim_in_I05));
  SET_VECTOR_ELT(state, 779, ScalarInteger(main_model_p->dim_in_I05_1));
  SET_VECTOR_ELT(state, 780, ScalarInteger(main_model_p->dim_in_I05_2));
  SET_VECTOR_ELT(state, 781, allocVector(REALSXP, main_model_p->dim_in_I05));
  memcpy(REAL(VECTOR_ELT(state, 781)), main_model_p->in_I05, main_model_p->dim_in_I05 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 781), 2, main_model_p->dim_in_I05_1, main_model_p->dim_in_I05_2);
  SET_VECTOR_ELT(state, 782, ScalarInteger(main_model_p->dim_in_I22));
  SET_VECTOR_ELT(state, 783, ScalarInteger(main_model_p->dim_in_I22_1));
  SET_VECTOR_ELT(state, 784, ScalarInteger(main_model_p->dim_in_I22_2));
  SET_VECTOR_ELT(state, 785, allocVector(REALSXP, main_model_p->dim_in_I22));
  memcpy(REAL(VECTOR_ELT(state, 785)), main_model_p->in_I22, main_model_p->dim_in_I22 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 785), 2, main_model_p->dim_in_I22_1, main_model_p->dim_in_I22_2);
  SET_VECTOR_ELT(state, 786, ScalarInteger(main_model_p->dim_in_I23));
  SET_VECTOR_ELT(state, 787, ScalarInteger(main_model_p->dim_in_I23_1));
  SET_VECTOR_ELT(state, 788, ScalarInteger(main_model_p->dim_in_I23_2));
  SET_VECTOR_ELT(state, 789, allocVector(REALSXP, main_model_p->dim_in_I23));
  memcpy(REAL(VECTOR_ELT(state, 789)), main_model_p->in_I23, main_model_p->dim_in_I23 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 789), 2, main_model_p->dim_in_I23_1, main_model_p->dim_in_I23_2);
  SET_VECTOR_ELT(state, 790, ScalarInteger(main_model_p->dim_in_I24));
  SET_VECTOR_ELT(state, 791, ScalarInteger(main_model_p->dim_in_I24_1));
  SET_VECTOR_ELT(state, 792, ScalarInteger(main_model_p->dim_in_I24_2));
  SET_VECTOR_ELT(state, 793, allocVector(REALSXP, main_model_p->dim_in_I24));
  memcpy(REAL(VECTOR_ELT(state, 793)), main_model_p->in_I24, main_model_p->dim_in_I24 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 793), 2, main_model_p->dim_in_I24_1, main_model_p->dim_in_I24_2);
  SET_VECTOR_ELT(state, 794, ScalarInteger(main_model_p->dim_in_I25));
  SET_VECTOR_ELT(state, 795, ScalarInteger(main_model_p->dim_in_I25_1));
  SET_VECTOR_ELT(state, 796, ScalarInteger(main_model_p->dim_in_I25_2));
  SET_VECTOR_ELT(state, 797, allocVector(REALSXP, main_model_p->dim_in_I25));
  memcpy(REAL(VECTOR_ELT(state, 797)), main_model_p->in_I25, main_model_p->dim_in_I25 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 797), 2, main_model_p->dim_in_I25_1, main_model_p->dim_in_I25_2);
  SET_VECTOR_ELT(state, 798, ScalarInteger(main_model_p->dim_in_I32));
  SET_VECTOR_ELT(state, 799, ScalarInteger(main_model_p->dim_in_I32_1));
  SET_VECTOR_ELT(state, 800, ScalarInteger(main_model_p->dim_in_I32_2));
  SET_VECTOR_ELT(state, 801, allocVector(REALSXP, main_model_p->dim_in_I32));
  memcpy(REAL(VECTOR_ELT(state, 801)), main_model_p->in_I32, main_model_p->dim_in_I32 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 801), 2, main_model_p->dim_in_I32_1, main_model_p->dim_in_I32_2);
  SET_VECTOR_ELT(state, 802, ScalarInteger(main_model_p->dim_in_I33));
  SET_VECTOR_ELT(state, 803, ScalarInteger(main_model_p->dim_in_I33_1));
  SET_VECTOR_ELT(state, 804, ScalarInteger(main_model_p->dim_in_I33_2));
  SET_VECTOR_ELT(state, 805, allocVector(REALSXP, main_model_p->dim_in_I33));
  memcpy(REAL(VECTOR_ELT(state, 805)), main_model_p->in_I33, main_model_p->dim_in_I33 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 805), 2, main_model_p->dim_in_I33_1, main_model_p->dim_in_I33_2);
  SET_VECTOR_ELT(state, 806, ScalarInteger(main_model_p->dim_in_I34));
  SET_VECTOR_ELT(state, 807, ScalarInteger(main_model_p->dim_in_I34_1));
  SET_VECTOR_ELT(state, 808, ScalarInteger(main_model_p->dim_in_I34_2));
  SET_VECTOR_ELT(state, 809, allocVector(REALSXP, main_model_p->dim_in_I34));
  memcpy(REAL(VECTOR_ELT(state, 809)), main_model_p->in_I34, main_model_p->dim_in_I34 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 809), 2, main_model_p->dim_in_I34_1, main_model_p->dim_in_I34_2);
  SET_VECTOR_ELT(state, 810, ScalarInteger(main_model_p->dim_in_I35));
  SET_VECTOR_ELT(state, 811, ScalarInteger(main_model_p->dim_in_I35_1));
  SET_VECTOR_ELT(state, 812, ScalarInteger(main_model_p->dim_in_I35_2));
  SET_VECTOR_ELT(state, 813, allocVector(REALSXP, main_model_p->dim_in_I35));
  memcpy(REAL(VECTOR_ELT(state, 813)), main_model_p->in_I35, main_model_p->dim_in_I35 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 813), 2, main_model_p->dim_in_I35_1, main_model_p->dim_in_I35_2);
  SET_VECTOR_ELT(state, 814, ScalarInteger(main_model_p->dim_in_I42));
  SET_VECTOR_ELT(state, 815, ScalarInteger(main_model_p->dim_in_I42_1));
  SET_VECTOR_ELT(state, 816, ScalarInteger(main_model_p->dim_in_I42_2));
  SET_VECTOR_ELT(state, 817, allocVector(REALSXP, main_model_p->dim_in_I42));
  memcpy(REAL(VECTOR_ELT(state, 817)), main_model_p->in_I42, main_model_p->dim_in_I42 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 817), 2, main_model_p->dim_in_I42_1, main_model_p->dim_in_I42_2);
  SET_VECTOR_ELT(state, 818, ScalarInteger(main_model_p->dim_in_I43));
  SET_VECTOR_ELT(state, 819, ScalarInteger(main_model_p->dim_in_I43_1));
  SET_VECTOR_ELT(state, 820, ScalarInteger(main_model_p->dim_in_I43_2));
  SET_VECTOR_ELT(state, 821, allocVector(REALSXP, main_model_p->dim_in_I43));
  memcpy(REAL(VECTOR_ELT(state, 821)), main_model_p->in_I43, main_model_p->dim_in_I43 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 821), 2, main_model_p->dim_in_I43_1, main_model_p->dim_in_I43_2);
  SET_VECTOR_ELT(state, 822, ScalarInteger(main_model_p->dim_in_I44));
  SET_VECTOR_ELT(state, 823, ScalarInteger(main_model_p->dim_in_I44_1));
  SET_VECTOR_ELT(state, 824, ScalarInteger(main_model_p->dim_in_I44_2));
  SET_VECTOR_ELT(state, 825, allocVector(REALSXP, main_model_p->dim_in_I44));
  memcpy(REAL(VECTOR_ELT(state, 825)), main_model_p->in_I44, main_model_p->dim_in_I44 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 825), 2, main_model_p->dim_in_I44_1, main_model_p->dim_in_I44_2);
  SET_VECTOR_ELT(state, 826, ScalarInteger(main_model_p->dim_in_I45));
  SET_VECTOR_ELT(state, 827, ScalarInteger(main_model_p->dim_in_I45_1));
  SET_VECTOR_ELT(state, 828, ScalarInteger(main_model_p->dim_in_I45_2));
  SET_VECTOR_ELT(state, 829, allocVector(REALSXP, main_model_p->dim_in_I45));
  memcpy(REAL(VECTOR_ELT(state, 829)), main_model_p->in_I45, main_model_p->dim_in_I45 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 829), 2, main_model_p->dim_in_I45_1, main_model_p->dim_in_I45_2);
  SET_VECTOR_ELT(state, 830, ScalarInteger(main_model_p->dim_rate_move_in));
  SET_VECTOR_ELT(state, 831, ScalarInteger(main_model_p->dim_rate_move_in_1));
  SET_VECTOR_ELT(state, 832, ScalarInteger(main_model_p->dim_rate_move_in_2));
  SET_VECTOR_ELT(state, 833, allocVector(REALSXP, main_model_p->dim_rate_move_in));
  memcpy(REAL(VECTOR_ELT(state, 833)), main_model_p->rate_move_in, main_model_p->dim_rate_move_in * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 833), 2, main_model_p->dim_rate_move_in_1, main_model_p->dim_rate_move_in_2);
  SET_VECTOR_ELT(state, 834, ScalarInteger(main_model_p->offset_output_rate_move_in));
  SET_VECTOR_ELT(state, 835, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_VECTOR_ELT(state, 836, allocVector(REALSXP, main_model_p->dim_rate_move_out));
  memcpy(REAL(VECTOR_ELT(state, 836)), main_model_p->rate_move_out, main_model_p->dim_rate_move_out * sizeof(double));
  SET_VECTOR_ELT(state, 837, ScalarInteger(main_model_p->offset_output_rate_move_out));
  SET_VECTOR_ELT(state, 842, ScalarReal(main_model_p->ART_eligible_CD4_above_500));
  SET_VECTOR_ELT(state, 844, ScalarReal(main_model_p->ART_eligible_CD4_350_500));
  SET_VECTOR_ELT(state, 846, ScalarReal(main_model_p->ART_eligible_CD4_200_349));
  SET_VECTOR_ELT(state, 848, ScalarReal(main_model_p->ART_eligible_CD4_below_200));
  SET_VECTOR_ELT(state, 855, ScalarReal(main_model_p->epsilon));
  SET_VECTOR_ELT(state, 863, ScalarInteger(main_model_p->dim));
  SET_VECTOR_ELT(state, 864, ScalarInteger(main_model_p->dim_output));
  SEXP state_names = PROTECT(allocVector(STRSXP, 865));
  SET_STRING_ELT(state_names, 0, mkChar("odin_use_dde"));
  SET_STRING_ELT(state_names, 1, mkChar("testpar"));
  SET_STRING_ELT(state_names, 2, mkChar("replaceDeaths"));
  SET_STRING_ELT(state_names, 3, mkChar("dim_pfFSW_t"));
  SET_STRING_ELT(state_names, 4, mkChar("pfFSW_t"));
  SET_STRING_ELT(state_names, 5, mkChar("dim_pfFSW_y"));
  SET_STRING_ELT(state_names, 6, mkChar("dim_pfFSW_y_1"));
  SET_STRING_ELT(state_names, 7, mkChar("dim_pfFSW_y_2"));
  SET_STRING_ELT(state_names, 8, mkChar("pfFSW_y"));
  SET_STRING_ELT(state_names, 9, mkChar("infected_FSW_incoming"));
  SET_STRING_ELT(state_names, 10, mkChar("rate_leave_pro_FSW"));
  SET_STRING_ELT(state_names, 11, mkChar("fraction_FSW_foreign"));
  SET_STRING_ELT(state_names, 12, mkChar("dim_c_t_comm"));
  SET_STRING_ELT(state_names, 13, mkChar("c_t_comm"));
  SET_STRING_ELT(state_names, 14, mkChar("dim_c_t_noncomm"));
  SET_STRING_ELT(state_names, 15, mkChar("c_t_noncomm"));
  SET_STRING_ELT(state_names, 16, mkChar("dim_c_y_comm"));
  SET_STRING_ELT(state_names, 17, mkChar("dim_c_y_comm_1"));
  SET_STRING_ELT(state_names, 18, mkChar("dim_c_y_comm_2"));
  SET_STRING_ELT(state_names, 19, mkChar("c_y_comm"));
  SET_STRING_ELT(state_names, 20, mkChar("dim_c_y_noncomm"));
  SET_STRING_ELT(state_names, 21, mkChar("dim_c_y_noncomm_1"));
  SET_STRING_ELT(state_names, 22, mkChar("dim_c_y_noncomm_2"));
  SET_STRING_ELT(state_names, 23, mkChar("c_y_noncomm"));
  SET_STRING_ELT(state_names, 24, mkChar("who_believe_comm"));
  SET_STRING_ELT(state_names, 25, mkChar("dim_ART_eligible_CD4_above_500_t"));
  SET_STRING_ELT(state_names, 26, mkChar("ART_eligible_CD4_above_500_t"));
  SET_STRING_ELT(state_names, 27, mkChar("dim_ART_eligible_CD4_350_500_t"));
  SET_STRING_ELT(state_names, 28, mkChar("ART_eligible_CD4_350_500_t"));
  SET_STRING_ELT(state_names, 29, mkChar("dim_ART_eligible_CD4_200_349_t"));
  SET_STRING_ELT(state_names, 30, mkChar("ART_eligible_CD4_200_349_t"));
  SET_STRING_ELT(state_names, 31, mkChar("dim_ART_eligible_CD4_below_200_t"));
  SET_STRING_ELT(state_names, 32, mkChar("ART_eligible_CD4_below_200_t"));
  SET_STRING_ELT(state_names, 33, mkChar("dim_ART_eligible_CD4_above_500_y"));
  SET_STRING_ELT(state_names, 34, mkChar("ART_eligible_CD4_above_500_y"));
  SET_STRING_ELT(state_names, 35, mkChar("dim_ART_eligible_CD4_350_500_y"));
  SET_STRING_ELT(state_names, 36, mkChar("ART_eligible_CD4_350_500_y"));
  SET_STRING_ELT(state_names, 37, mkChar("dim_ART_eligible_CD4_200_349_y"));
  SET_STRING_ELT(state_names, 38, mkChar("ART_eligible_CD4_200_349_y"));
  SET_STRING_ELT(state_names, 39, mkChar("dim_ART_eligible_CD4_below_200_y"));
  SET_STRING_ELT(state_names, 40, mkChar("ART_eligible_CD4_below_200_y"));
  SET_STRING_ELT(state_names, 41, mkChar("dim_infect_ART_y"));
  SET_STRING_ELT(state_names, 42, mkChar("dim_infect_ART_y_1"));
  SET_STRING_ELT(state_names, 43, mkChar("dim_infect_ART_y_2"));
  SET_STRING_ELT(state_names, 44, mkChar("infect_ART_y"));
  SET_STRING_ELT(state_names, 45, mkChar("offset_output_infect_ART_y"));
  SET_STRING_ELT(state_names, 46, mkChar("dim_infect_ART_t"));
  SET_STRING_ELT(state_names, 47, mkChar("infect_ART_t"));
  SET_STRING_ELT(state_names, 48, mkChar("offset_output_infect_ART_t"));
  SET_STRING_ELT(state_names, 49, mkChar("dim_testing_prob_t"));
  SET_STRING_ELT(state_names, 50, mkChar("testing_prob_t"));
  SET_STRING_ELT(state_names, 51, mkChar("dim_testing_prob_y"));
  SET_STRING_ELT(state_names, 52, mkChar("dim_testing_prob_y_1"));
  SET_STRING_ELT(state_names, 53, mkChar("dim_testing_prob_y_2"));
  SET_STRING_ELT(state_names, 54, mkChar("testing_prob_y"));
  SET_STRING_ELT(state_names, 55, mkChar("TasP_testing"));
  SET_STRING_ELT(state_names, 56, mkChar("dim_tau_intervention_t"));
  SET_STRING_ELT(state_names, 57, mkChar("tau_intervention_t"));
  SET_STRING_ELT(state_names, 58, mkChar("dim_tau_intervention_y"));
  SET_STRING_ELT(state_names, 59, mkChar("dim_tau_intervention_y_1"));
  SET_STRING_ELT(state_names, 60, mkChar("dim_tau_intervention_y_2"));
  SET_STRING_ELT(state_names, 61, mkChar("tau_intervention_y"));
  SET_STRING_ELT(state_names, 62, mkChar("dim_rho_intervention_t"));
  SET_STRING_ELT(state_names, 63, mkChar("rho_intervention_t"));
  SET_STRING_ELT(state_names, 64, mkChar("dim_rho_intervention_y"));
  SET_STRING_ELT(state_names, 65, mkChar("dim_rho_intervention_y_1"));
  SET_STRING_ELT(state_names, 66, mkChar("dim_rho_intervention_y_2"));
  SET_STRING_ELT(state_names, 67, mkChar("rho_intervention_y"));
  SET_STRING_ELT(state_names, 68, mkChar("PrEPOnOff"));
  SET_STRING_ELT(state_names, 69, mkChar("fPa"));
  SET_STRING_ELT(state_names, 70, mkChar("fPb"));
  SET_STRING_ELT(state_names, 71, mkChar("fPc"));
  SET_STRING_ELT(state_names, 72, mkChar("RR_test_CD4200"));
  SET_STRING_ELT(state_names, 73, mkChar("dim_viral_supp_y"));
  SET_STRING_ELT(state_names, 74, mkChar("dim_viral_supp_y_1"));
  SET_STRING_ELT(state_names, 75, mkChar("dim_viral_supp_y_2"));
  SET_STRING_ELT(state_names, 76, mkChar("viral_supp_y"));
  SET_STRING_ELT(state_names, 77, mkChar("offset_output_viral_supp_y"));
  SET_STRING_ELT(state_names, 78, mkChar("dim_viral_supp_t"));
  SET_STRING_ELT(state_names, 79, mkChar("viral_supp_t"));
  SET_STRING_ELT(state_names, 80, mkChar("offset_output_viral_supp_t"));
  SET_STRING_ELT(state_names, 81, mkChar("W0"));
  SET_STRING_ELT(state_names, 82, mkChar("W1"));
  SET_STRING_ELT(state_names, 83, mkChar("W2"));
  SET_STRING_ELT(state_names, 84, mkChar("W3"));
  SET_STRING_ELT(state_names, 85, mkChar("cost_Initiation_of_ART_study_FSW"));
  SET_STRING_ELT(state_names, 86, mkChar("cost_Initiation_of_ART_government_FSW"));
  SET_STRING_ELT(state_names, 87, mkChar("cost_1_year_of_ART_study_FSW"));
  SET_STRING_ELT(state_names, 88, mkChar("cost_1_year_of_ART_government_FSW"));
  SET_STRING_ELT(state_names, 89, mkChar("cost_Initiation_ART_rest_of_population"));
  SET_STRING_ELT(state_names, 90, mkChar("cost_1_year_of_ART_rest_of_population"));
  SET_STRING_ELT(state_names, 91, mkChar("cost_FSW_initiation_ART_Patient_costs"));
  SET_STRING_ELT(state_names, 92, mkChar("cost_FSW_1_year_ART_Patient_costs"));
  SET_STRING_ELT(state_names, 93, mkChar("cost_Initiation_of_PrEP_study"));
  SET_STRING_ELT(state_names, 94, mkChar("cost_1_year_PrEP_perfect_adherence_study"));
  SET_STRING_ELT(state_names, 95, mkChar("cost_1_year_PrEP_intermediate_adherence_study"));
  SET_STRING_ELT(state_names, 96, mkChar("cost_1_year_PrEP_non_adherence_study"));
  SET_STRING_ELT(state_names, 97, mkChar("cost_Initiation_of_PrEP_government"));
  SET_STRING_ELT(state_names, 98, mkChar("cost_1_year_PrEP_perfect_adherence_government"));
  SET_STRING_ELT(state_names, 99, mkChar("cost_1_year_PrEP_intermediate_adherence_government"));
  SET_STRING_ELT(state_names, 100, mkChar("cost_1_year_PrEP_non_adherence_government"));
  SET_STRING_ELT(state_names, 101, mkChar("cost_PREP_initiation_Patient_costs"));
  SET_STRING_ELT(state_names, 102, mkChar("cost_PREP_1_year_ART_Patient_costs"));
  SET_STRING_ELT(state_names, 103, mkChar("Ncat"));
  SET_STRING_ELT(state_names, 104, mkChar("Nage"));
  SET_STRING_ELT(state_names, 105, mkChar("infect_acute"));
  SET_STRING_ELT(state_names, 106, mkChar("infect_AIDS"));
  SET_STRING_ELT(state_names, 107, mkChar("nu"));
  SET_STRING_ELT(state_names, 108, mkChar("R"));
  SET_STRING_ELT(state_names, 109, mkChar("dim_epsilon_t"));
  SET_STRING_ELT(state_names, 110, mkChar("epsilon_t"));
  SET_STRING_ELT(state_names, 111, mkChar("dim_epsilon_y"));
  SET_STRING_ELT(state_names, 112, mkChar("epsilon_y"));
  SET_STRING_ELT(state_names, 113, mkChar("dim_fc_t_comm"));
  SET_STRING_ELT(state_names, 114, mkChar("fc_t_comm"));
  SET_STRING_ELT(state_names, 115, mkChar("dim_fc_y_comm"));
  SET_STRING_ELT(state_names, 116, mkChar("dim_fc_y_comm_1"));
  SET_STRING_ELT(state_names, 117, mkChar("dim_fc_y_comm_2"));
  SET_STRING_ELT(state_names, 118, mkChar("dim_fc_y_comm_3"));
  SET_STRING_ELT(state_names, 119, mkChar("dim_fc_y_comm_12"));
  SET_STRING_ELT(state_names, 120, mkChar("fc_y_comm"));
  SET_STRING_ELT(state_names, 121, mkChar("dim_fP_t_comm"));
  SET_STRING_ELT(state_names, 122, mkChar("fP_t_comm"));
  SET_STRING_ELT(state_names, 123, mkChar("dim_fP_y_comm"));
  SET_STRING_ELT(state_names, 124, mkChar("dim_fP_y_comm_1"));
  SET_STRING_ELT(state_names, 125, mkChar("dim_fP_y_comm_2"));
  SET_STRING_ELT(state_names, 126, mkChar("fP_y_comm"));
  SET_STRING_ELT(state_names, 127, mkChar("dim_fc_t_noncomm"));
  SET_STRING_ELT(state_names, 128, mkChar("fc_t_noncomm"));
  SET_STRING_ELT(state_names, 129, mkChar("dim_fc_y_noncomm"));
  SET_STRING_ELT(state_names, 130, mkChar("dim_fc_y_noncomm_1"));
  SET_STRING_ELT(state_names, 131, mkChar("dim_fc_y_noncomm_2"));
  SET_STRING_ELT(state_names, 132, mkChar("dim_fc_y_noncomm_3"));
  SET_STRING_ELT(state_names, 133, mkChar("dim_fc_y_noncomm_12"));
  SET_STRING_ELT(state_names, 134, mkChar("fc_y_noncomm"));
  SET_STRING_ELT(state_names, 135, mkChar("dim_fP_t_noncomm"));
  SET_STRING_ELT(state_names, 136, mkChar("fP_t_noncomm"));
  SET_STRING_ELT(state_names, 137, mkChar("dim_fP_y_noncomm"));
  SET_STRING_ELT(state_names, 138, mkChar("dim_fP_y_noncomm_1"));
  SET_STRING_ELT(state_names, 139, mkChar("dim_fP_y_noncomm_2"));
  SET_STRING_ELT(state_names, 140, mkChar("fP_y_noncomm"));
  SET_STRING_ELT(state_names, 141, mkChar("dim_n_t_comm"));
  SET_STRING_ELT(state_names, 142, mkChar("n_t_comm"));
  SET_STRING_ELT(state_names, 143, mkChar("dim_n_y_comm"));
  SET_STRING_ELT(state_names, 144, mkChar("dim_n_y_comm_1"));
  SET_STRING_ELT(state_names, 145, mkChar("dim_n_y_comm_2"));
  SET_STRING_ELT(state_names, 146, mkChar("dim_n_y_comm_3"));
  SET_STRING_ELT(state_names, 147, mkChar("dim_n_y_comm_12"));
  SET_STRING_ELT(state_names, 148, mkChar("n_y_comm"));
  SET_STRING_ELT(state_names, 149, mkChar("dim_n_t_noncomm"));
  SET_STRING_ELT(state_names, 150, mkChar("n_t_noncomm"));
  SET_STRING_ELT(state_names, 151, mkChar("dim_n_y_noncomm"));
  SET_STRING_ELT(state_names, 152, mkChar("dim_n_y_noncomm_1"));
  SET_STRING_ELT(state_names, 153, mkChar("dim_n_y_noncomm_2"));
  SET_STRING_ELT(state_names, 154, mkChar("dim_n_y_noncomm_3"));
  SET_STRING_ELT(state_names, 155, mkChar("dim_n_y_noncomm_12"));
  SET_STRING_ELT(state_names, 156, mkChar("n_y_noncomm"));
  SET_STRING_ELT(state_names, 157, mkChar("dur_FSW"));
  SET_STRING_ELT(state_names, 158, mkChar("dim_prep_intervention_t"));
  SET_STRING_ELT(state_names, 159, mkChar("prep_intervention_t"));
  SET_STRING_ELT(state_names, 160, mkChar("dim_prep_intervention_y"));
  SET_STRING_ELT(state_names, 161, mkChar("dim_prep_intervention_y_1"));
  SET_STRING_ELT(state_names, 162, mkChar("dim_prep_intervention_y_2"));
  SET_STRING_ELT(state_names, 163, mkChar("prep_intervention_y"));
  SET_STRING_ELT(state_names, 164, mkChar("dim_gamma32_without_supp"));
  SET_STRING_ELT(state_names, 165, mkChar("gamma32_without_supp"));
  SET_STRING_ELT(state_names, 166, mkChar("offset_output_gamma32_without_supp"));
  SET_STRING_ELT(state_names, 167, mkChar("dim_gamma33_without_supp"));
  SET_STRING_ELT(state_names, 168, mkChar("gamma33_without_supp"));
  SET_STRING_ELT(state_names, 169, mkChar("offset_output_gamma33_without_supp"));
  SET_STRING_ELT(state_names, 170, mkChar("dim_gamma34_without_supp"));
  SET_STRING_ELT(state_names, 171, mkChar("gamma34_without_supp"));
  SET_STRING_ELT(state_names, 172, mkChar("offset_output_gamma34_without_supp"));
  SET_STRING_ELT(state_names, 173, mkChar("dim_alpha33_without_supp"));
  SET_STRING_ELT(state_names, 174, mkChar("alpha33_without_supp"));
  SET_STRING_ELT(state_names, 175, mkChar("offset_output_alpha33_without_supp"));
  SET_STRING_ELT(state_names, 176, mkChar("dim_alpha34_without_supp"));
  SET_STRING_ELT(state_names, 177, mkChar("alpha34_without_supp"));
  SET_STRING_ELT(state_names, 178, mkChar("offset_output_alpha34_without_supp"));
  SET_STRING_ELT(state_names, 179, mkChar("dim_alpha35_without_supp"));
  SET_STRING_ELT(state_names, 180, mkChar("alpha35_without_supp"));
  SET_STRING_ELT(state_names, 181, mkChar("offset_output_alpha35_without_supp"));
  SET_STRING_ELT(state_names, 182, mkChar("dim_c_comm"));
  SET_STRING_ELT(state_names, 183, mkChar("c_comm"));
  SET_STRING_ELT(state_names, 184, mkChar("offset_output_c_comm"));
  SET_STRING_ELT(state_names, 185, mkChar("dim_c_noncomm"));
  SET_STRING_ELT(state_names, 186, mkChar("c_noncomm"));
  SET_STRING_ELT(state_names, 187, mkChar("offset_output_c_noncomm"));
  SET_STRING_ELT(state_names, 188, mkChar("dim_pfFSW"));
  SET_STRING_ELT(state_names, 189, mkChar("pfFSW"));
  SET_STRING_ELT(state_names, 190, mkChar("offset_output_pfFSW"));
  SET_STRING_ELT(state_names, 191, mkChar("dim_new_acute_infected"));
  SET_STRING_ELT(state_names, 192, mkChar("new_acute_infected"));
  SET_STRING_ELT(state_names, 193, mkChar("offset_output_new_acute_infected"));
  SET_STRING_ELT(state_names, 194, mkChar("dim_FSW_ONLY"));
  SET_STRING_ELT(state_names, 195, mkChar("FSW_ONLY"));
  SET_STRING_ELT(state_names, 196, mkChar("dim_new_people_in_group"));
  SET_STRING_ELT(state_names, 197, mkChar("new_people_in_group"));
  SET_STRING_ELT(state_names, 198, mkChar("offset_output_new_people_in_group"));
  SET_STRING_ELT(state_names, 199, mkChar("dim_new_people_in_group_FSW_only"));
  SET_STRING_ELT(state_names, 200, mkChar("new_people_in_group_FSW_only"));
  SET_STRING_ELT(state_names, 201, mkChar("offset_output_new_people_in_group_FSW_only"));
  SET_STRING_ELT(state_names, 202, mkChar("dim_comm_partnerships_requested"));
  SET_STRING_ELT(state_names, 203, mkChar("dim_comm_partnerships_requested_1"));
  SET_STRING_ELT(state_names, 204, mkChar("dim_comm_partnerships_requested_2"));
  SET_STRING_ELT(state_names, 205, mkChar("comm_partnerships_requested"));
  SET_STRING_ELT(state_names, 206, mkChar("dim_noncomm_partnerships_requested"));
  SET_STRING_ELT(state_names, 207, mkChar("dim_noncomm_partnerships_requested_1"));
  SET_STRING_ELT(state_names, 208, mkChar("dim_noncomm_partnerships_requested_2"));
  SET_STRING_ELT(state_names, 209, mkChar("noncomm_partnerships_requested"));
  SET_STRING_ELT(state_names, 210, mkChar("dim_above_500_by_group"));
  SET_STRING_ELT(state_names, 211, mkChar("above_500_by_group"));
  SET_STRING_ELT(state_names, 212, mkChar("offset_output_above_500_by_group"));
  SET_STRING_ELT(state_names, 213, mkChar("dim_testing_prob"));
  SET_STRING_ELT(state_names, 214, mkChar("testing_prob"));
  SET_STRING_ELT(state_names, 215, mkChar("offset_output_testing_prob"));
  SET_STRING_ELT(state_names, 216, mkChar("dim_tau_intervention"));
  SET_STRING_ELT(state_names, 217, mkChar("tau_intervention"));
  SET_STRING_ELT(state_names, 218, mkChar("offset_output_tau_intervention"));
  SET_STRING_ELT(state_names, 219, mkChar("dim_rho_intervention"));
  SET_STRING_ELT(state_names, 220, mkChar("rho_intervention"));
  SET_STRING_ELT(state_names, 221, mkChar("offset_output_rho_intervention"));
  SET_STRING_ELT(state_names, 222, mkChar("dim_zeta"));
  SET_STRING_ELT(state_names, 223, mkChar("zeta"));
  SET_STRING_ELT(state_names, 224, mkChar("offset_output_zeta"));
  SET_STRING_ELT(state_names, 225, mkChar("dim_sigma"));
  SET_STRING_ELT(state_names, 226, mkChar("sigma"));
  SET_STRING_ELT(state_names, 227, mkChar("dim_eP1a_effective"));
  SET_STRING_ELT(state_names, 228, mkChar("eP1a_effective"));
  SET_STRING_ELT(state_names, 229, mkChar("offset_output_eP1a_effective"));
  SET_STRING_ELT(state_names, 230, mkChar("dim_eP1b_effective"));
  SET_STRING_ELT(state_names, 231, mkChar("eP1b_effective"));
  SET_STRING_ELT(state_names, 232, mkChar("offset_output_eP1b_effective"));
  SET_STRING_ELT(state_names, 233, mkChar("dim_eP1c_effective"));
  SET_STRING_ELT(state_names, 234, mkChar("eP1c_effective"));
  SET_STRING_ELT(state_names, 235, mkChar("offset_output_eP1c_effective"));
  SET_STRING_ELT(state_names, 236, mkChar("dim_tau"));
  SET_STRING_ELT(state_names, 237, mkChar("tau"));
  SET_STRING_ELT(state_names, 238, mkChar("offset_output_tau"));
  SET_STRING_ELT(state_names, 239, mkChar("dim_test_rate_prep"));
  SET_STRING_ELT(state_names, 240, mkChar("test_rate_prep"));
  SET_STRING_ELT(state_names, 241, mkChar("dim_rho"));
  SET_STRING_ELT(state_names, 242, mkChar("rho"));
  SET_STRING_ELT(state_names, 243, mkChar("offset_output_rho"));
  SET_STRING_ELT(state_names, 244, mkChar("dim_iota"));
  SET_STRING_ELT(state_names, 245, mkChar("iota"));
  SET_STRING_ELT(state_names, 246, mkChar("offset_output_iota"));
  SET_STRING_ELT(state_names, 247, mkChar("dim_viral_supp"));
  SET_STRING_ELT(state_names, 248, mkChar("viral_supp"));
  SET_STRING_ELT(state_names, 249, mkChar("offset_output_viral_supp"));
  SET_STRING_ELT(state_names, 250, mkChar("dim_HIV_positive"));
  SET_STRING_ELT(state_names, 251, mkChar("HIV_positive"));
  SET_STRING_ELT(state_names, 252, mkChar("offset_output_HIV_positive"));
  SET_STRING_ELT(state_names, 253, mkChar("dim_Number_Susceptibles"));
  SET_STRING_ELT(state_names, 254, mkChar("Number_Susceptibles"));
  SET_STRING_ELT(state_names, 255, mkChar("offset_output_Number_Susceptibles"));
  SET_STRING_ELT(state_names, 256, mkChar("dim_HIV_positive_Diagnosed_Off_ART"));
  SET_STRING_ELT(state_names, 257, mkChar("HIV_positive_Diagnosed_Off_ART"));
  SET_STRING_ELT(state_names, 258, mkChar("offset_output_HIV_positive_Diagnosed_Off_ART"));
  SET_STRING_ELT(state_names, 259, mkChar("dim_Primary_Off_ART"));
  SET_STRING_ELT(state_names, 260, mkChar("Primary_Off_ART"));
  SET_STRING_ELT(state_names, 261, mkChar("offset_output_Primary_Off_ART"));
  SET_STRING_ELT(state_names, 262, mkChar("dim_CD4_above_500_Off_ART"));
  SET_STRING_ELT(state_names, 263, mkChar("CD4_above_500_Off_ART"));
  SET_STRING_ELT(state_names, 264, mkChar("offset_output_CD4_above_500_Off_ART"));
  SET_STRING_ELT(state_names, 265, mkChar("dim_CD4_350_500_Off_ART"));
  SET_STRING_ELT(state_names, 266, mkChar("CD4_350_500_Off_ART"));
  SET_STRING_ELT(state_names, 267, mkChar("offset_output_CD4_350_500_Off_ART"));
  SET_STRING_ELT(state_names, 268, mkChar("dim_CD4_200_350_Off_ART"));
  SET_STRING_ELT(state_names, 269, mkChar("CD4_200_350_Off_ART"));
  SET_STRING_ELT(state_names, 270, mkChar("offset_output_CD4_200_350_Off_ART"));
  SET_STRING_ELT(state_names, 271, mkChar("dim_CD4_below_200_Off_ART"));
  SET_STRING_ELT(state_names, 272, mkChar("CD4_below_200_Off_ART"));
  SET_STRING_ELT(state_names, 273, mkChar("offset_output_CD4_below_200_Off_ART"));
  SET_STRING_ELT(state_names, 274, mkChar("dim_HIV_positive_On_ART"));
  SET_STRING_ELT(state_names, 275, mkChar("HIV_positive_On_ART"));
  SET_STRING_ELT(state_names, 276, mkChar("offset_output_HIV_positive_On_ART"));
  SET_STRING_ELT(state_names, 277, mkChar("dim_Number_DALY_W1"));
  SET_STRING_ELT(state_names, 278, mkChar("Number_DALY_W1"));
  SET_STRING_ELT(state_names, 279, mkChar("offset_output_Number_DALY_W1"));
  SET_STRING_ELT(state_names, 280, mkChar("dim_Number_DALY_W2"));
  SET_STRING_ELT(state_names, 281, mkChar("Number_DALY_W2"));
  SET_STRING_ELT(state_names, 282, mkChar("offset_output_Number_DALY_W2"));
  SET_STRING_ELT(state_names, 283, mkChar("dim_Number_DALY_W3"));
  SET_STRING_ELT(state_names, 284, mkChar("Number_DALY_W3"));
  SET_STRING_ELT(state_names, 285, mkChar("offset_output_Number_DALY_W3"));
  SET_STRING_ELT(state_names, 286, mkChar("dim_cumuDeaths_On_ART"));
  SET_STRING_ELT(state_names, 287, mkChar("initial_cumuDeaths_On_ART"));
  SET_STRING_ELT(state_names, 288, mkChar("offset_cumuDeaths_On_ART"));
  SET_STRING_ELT(state_names, 289, mkChar("dim_cumuARTinitiations_not_TasP"));
  SET_STRING_ELT(state_names, 290, mkChar("initial_cumuARTinitiations_not_TasP"));
  SET_STRING_ELT(state_names, 291, mkChar("offset_cumuARTinitiations_not_TasP"));
  SET_STRING_ELT(state_names, 292, mkChar("dim_cumu_PrEP_dropouts"));
  SET_STRING_ELT(state_names, 293, mkChar("initial_cumu_PrEP_dropouts"));
  SET_STRING_ELT(state_names, 294, mkChar("offset_cumu_PrEP_dropouts"));
  SET_STRING_ELT(state_names, 295, mkChar("dim_S0_infections"));
  SET_STRING_ELT(state_names, 296, mkChar("initial_S0_infections"));
  SET_STRING_ELT(state_names, 297, mkChar("offset_S0_infections"));
  SET_STRING_ELT(state_names, 298, mkChar("dim_S1a_infections"));
  SET_STRING_ELT(state_names, 299, mkChar("initial_S1a_infections"));
  SET_STRING_ELT(state_names, 300, mkChar("offset_S1a_infections"));
  SET_STRING_ELT(state_names, 301, mkChar("dim_S1b_infections"));
  SET_STRING_ELT(state_names, 302, mkChar("initial_S1b_infections"));
  SET_STRING_ELT(state_names, 303, mkChar("offset_S1b_infections"));
  SET_STRING_ELT(state_names, 304, mkChar("dim_S1c_infections"));
  SET_STRING_ELT(state_names, 305, mkChar("initial_S1c_infections"));
  SET_STRING_ELT(state_names, 306, mkChar("offset_S1c_infections"));
  SET_STRING_ELT(state_names, 307, mkChar("dim_S1d_infections"));
  SET_STRING_ELT(state_names, 308, mkChar("initial_S1d_infections"));
  SET_STRING_ELT(state_names, 309, mkChar("offset_S1d_infections"));
  SET_STRING_ELT(state_names, 310, mkChar("dim_frac_F"));
  SET_STRING_ELT(state_names, 311, mkChar("frac_F"));
  SET_STRING_ELT(state_names, 312, mkChar("offset_output_frac_F"));
  SET_STRING_ELT(state_names, 313, mkChar("dim_frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 314, mkChar("frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 315, mkChar("offset_output_frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 316, mkChar("dim_ART_coverage"));
  SET_STRING_ELT(state_names, 317, mkChar("ART_coverage"));
  SET_STRING_ELT(state_names, 318, mkChar("offset_output_ART_coverage"));
  SET_STRING_ELT(state_names, 319, mkChar("dim_infect_ART"));
  SET_STRING_ELT(state_names, 320, mkChar("infect_ART"));
  SET_STRING_ELT(state_names, 321, mkChar("offset_output_infect_ART"));
  SET_STRING_ELT(state_names, 322, mkChar("dim_prep_offered"));
  SET_STRING_ELT(state_names, 323, mkChar("prep_offered"));
  SET_STRING_ELT(state_names, 324, mkChar("offset_output_prep_offered"));
  SET_STRING_ELT(state_names, 325, mkChar("dim_omega"));
  SET_STRING_ELT(state_names, 326, mkChar("omega"));
  SET_STRING_ELT(state_names, 327, mkChar("offset_output_omega"));
  SET_STRING_ELT(state_names, 328, mkChar("dim_frac_N"));
  SET_STRING_ELT(state_names, 329, mkChar("frac_N"));
  SET_STRING_ELT(state_names, 330, mkChar("offset_output_frac_N"));
  SET_STRING_ELT(state_names, 331, mkChar("dim_mu"));
  SET_STRING_ELT(state_names, 332, mkChar("mu"));
  SET_STRING_ELT(state_names, 333, mkChar("offset_output_mu"));
  SET_STRING_ELT(state_names, 334, mkChar("dim_gamma01"));
  SET_STRING_ELT(state_names, 335, mkChar("gamma01"));
  SET_STRING_ELT(state_names, 336, mkChar("offset_output_gamma01"));
  SET_STRING_ELT(state_names, 337, mkChar("dim_gamma02"));
  SET_STRING_ELT(state_names, 338, mkChar("gamma02"));
  SET_STRING_ELT(state_names, 339, mkChar("dim_gamma03"));
  SET_STRING_ELT(state_names, 340, mkChar("gamma03"));
  SET_STRING_ELT(state_names, 341, mkChar("dim_gamma04"));
  SET_STRING_ELT(state_names, 342, mkChar("gamma04"));
  SET_STRING_ELT(state_names, 343, mkChar("dim_gamma11"));
  SET_STRING_ELT(state_names, 344, mkChar("gamma11"));
  SET_STRING_ELT(state_names, 345, mkChar("offset_output_gamma11"));
  SET_STRING_ELT(state_names, 346, mkChar("dim_gamma22"));
  SET_STRING_ELT(state_names, 347, mkChar("gamma22"));
  SET_STRING_ELT(state_names, 348, mkChar("dim_gamma23"));
  SET_STRING_ELT(state_names, 349, mkChar("gamma23"));
  SET_STRING_ELT(state_names, 350, mkChar("dim_gamma24"));
  SET_STRING_ELT(state_names, 351, mkChar("gamma24"));
  SET_STRING_ELT(state_names, 352, mkChar("dim_gamma32"));
  SET_STRING_ELT(state_names, 353, mkChar("gamma32"));
  SET_STRING_ELT(state_names, 354, mkChar("offset_output_gamma32"));
  SET_STRING_ELT(state_names, 355, mkChar("dim_gamma33"));
  SET_STRING_ELT(state_names, 356, mkChar("gamma33"));
  SET_STRING_ELT(state_names, 357, mkChar("offset_output_gamma33"));
  SET_STRING_ELT(state_names, 358, mkChar("dim_gamma34"));
  SET_STRING_ELT(state_names, 359, mkChar("gamma34"));
  SET_STRING_ELT(state_names, 360, mkChar("offset_output_gamma34"));
  SET_STRING_ELT(state_names, 361, mkChar("dim_gamma42"));
  SET_STRING_ELT(state_names, 362, mkChar("gamma42"));
  SET_STRING_ELT(state_names, 363, mkChar("dim_gamma43"));
  SET_STRING_ELT(state_names, 364, mkChar("gamma43"));
  SET_STRING_ELT(state_names, 365, mkChar("dim_gamma44"));
  SET_STRING_ELT(state_names, 366, mkChar("gamma44"));
  SET_STRING_ELT(state_names, 367, mkChar("dim_phi2"));
  SET_STRING_ELT(state_names, 368, mkChar("phi2"));
  SET_STRING_ELT(state_names, 369, mkChar("dim_phi3"));
  SET_STRING_ELT(state_names, 370, mkChar("phi3"));
  SET_STRING_ELT(state_names, 371, mkChar("dim_phi4"));
  SET_STRING_ELT(state_names, 372, mkChar("phi4"));
  SET_STRING_ELT(state_names, 373, mkChar("dim_phi5"));
  SET_STRING_ELT(state_names, 374, mkChar("phi5"));
  SET_STRING_ELT(state_names, 375, mkChar("dim_psia"));
  SET_STRING_ELT(state_names, 376, mkChar("psia"));
  SET_STRING_ELT(state_names, 377, mkChar("dim_psib"));
  SET_STRING_ELT(state_names, 378, mkChar("psib"));
  SET_STRING_ELT(state_names, 379, mkChar("dim_kappaa"));
  SET_STRING_ELT(state_names, 380, mkChar("kappaa"));
  SET_STRING_ELT(state_names, 381, mkChar("offset_output_kappaa"));
  SET_STRING_ELT(state_names, 382, mkChar("dim_kappab"));
  SET_STRING_ELT(state_names, 383, mkChar("kappab"));
  SET_STRING_ELT(state_names, 384, mkChar("offset_output_kappab"));
  SET_STRING_ELT(state_names, 385, mkChar("dim_kappac"));
  SET_STRING_ELT(state_names, 386, mkChar("kappac"));
  SET_STRING_ELT(state_names, 387, mkChar("offset_output_kappac"));
  SET_STRING_ELT(state_names, 388, mkChar("dim_kappa1"));
  SET_STRING_ELT(state_names, 389, mkChar("kappa1"));
  SET_STRING_ELT(state_names, 390, mkChar("offset_output_kappa1"));
  SET_STRING_ELT(state_names, 391, mkChar("dim_alpha01"));
  SET_STRING_ELT(state_names, 392, mkChar("alpha01"));
  SET_STRING_ELT(state_names, 393, mkChar("offset_output_alpha01"));
  SET_STRING_ELT(state_names, 394, mkChar("dim_alpha02"));
  SET_STRING_ELT(state_names, 395, mkChar("alpha02"));
  SET_STRING_ELT(state_names, 396, mkChar("offset_output_alpha02"));
  SET_STRING_ELT(state_names, 397, mkChar("dim_alpha03"));
  SET_STRING_ELT(state_names, 398, mkChar("alpha03"));
  SET_STRING_ELT(state_names, 399, mkChar("dim_alpha04"));
  SET_STRING_ELT(state_names, 400, mkChar("alpha04"));
  SET_STRING_ELT(state_names, 401, mkChar("dim_alpha05"));
  SET_STRING_ELT(state_names, 402, mkChar("alpha05"));
  SET_STRING_ELT(state_names, 403, mkChar("offset_output_alpha05"));
  SET_STRING_ELT(state_names, 404, mkChar("dim_alpha11"));
  SET_STRING_ELT(state_names, 405, mkChar("alpha11"));
  SET_STRING_ELT(state_names, 406, mkChar("offset_output_alpha11"));
  SET_STRING_ELT(state_names, 407, mkChar("dim_alpha22"));
  SET_STRING_ELT(state_names, 408, mkChar("alpha22"));
  SET_STRING_ELT(state_names, 409, mkChar("offset_output_alpha22"));
  SET_STRING_ELT(state_names, 410, mkChar("dim_alpha23"));
  SET_STRING_ELT(state_names, 411, mkChar("alpha23"));
  SET_STRING_ELT(state_names, 412, mkChar("dim_alpha24"));
  SET_STRING_ELT(state_names, 413, mkChar("alpha24"));
  SET_STRING_ELT(state_names, 414, mkChar("dim_alpha25"));
  SET_STRING_ELT(state_names, 415, mkChar("alpha25"));
  SET_STRING_ELT(state_names, 416, mkChar("dim_alpha32"));
  SET_STRING_ELT(state_names, 417, mkChar("alpha32"));
  SET_STRING_ELT(state_names, 418, mkChar("dim_alpha33"));
  SET_STRING_ELT(state_names, 419, mkChar("alpha33"));
  SET_STRING_ELT(state_names, 420, mkChar("offset_output_alpha33"));
  SET_STRING_ELT(state_names, 421, mkChar("dim_alpha34"));
  SET_STRING_ELT(state_names, 422, mkChar("alpha34"));
  SET_STRING_ELT(state_names, 423, mkChar("offset_output_alpha34"));
  SET_STRING_ELT(state_names, 424, mkChar("dim_alpha35"));
  SET_STRING_ELT(state_names, 425, mkChar("alpha35"));
  SET_STRING_ELT(state_names, 426, mkChar("offset_output_alpha35"));
  SET_STRING_ELT(state_names, 427, mkChar("dim_alpha42"));
  SET_STRING_ELT(state_names, 428, mkChar("alpha42"));
  SET_STRING_ELT(state_names, 429, mkChar("dim_alpha43"));
  SET_STRING_ELT(state_names, 430, mkChar("alpha43"));
  SET_STRING_ELT(state_names, 431, mkChar("dim_alpha44"));
  SET_STRING_ELT(state_names, 432, mkChar("alpha44"));
  SET_STRING_ELT(state_names, 433, mkChar("dim_alpha45"));
  SET_STRING_ELT(state_names, 434, mkChar("alpha45"));
  SET_STRING_ELT(state_names, 435, mkChar("dim_beta_comm"));
  SET_STRING_ELT(state_names, 436, mkChar("beta_comm"));
  SET_STRING_ELT(state_names, 437, mkChar("offset_output_beta_comm"));
  SET_STRING_ELT(state_names, 438, mkChar("dim_beta_noncomm"));
  SET_STRING_ELT(state_names, 439, mkChar("beta_noncomm"));
  SET_STRING_ELT(state_names, 440, mkChar("offset_output_beta_noncomm"));
  SET_STRING_ELT(state_names, 441, mkChar("dim_p_comm"));
  SET_STRING_ELT(state_names, 442, mkChar("dim_p_comm_1"));
  SET_STRING_ELT(state_names, 443, mkChar("dim_p_comm_2"));
  SET_STRING_ELT(state_names, 444, mkChar("p_comm"));
  SET_STRING_ELT(state_names, 445, mkChar("offset_output_p_comm"));
  SET_STRING_ELT(state_names, 446, mkChar("dim_p_noncomm"));
  SET_STRING_ELT(state_names, 447, mkChar("dim_p_noncomm_1"));
  SET_STRING_ELT(state_names, 448, mkChar("dim_p_noncomm_2"));
  SET_STRING_ELT(state_names, 449, mkChar("p_noncomm"));
  SET_STRING_ELT(state_names, 450, mkChar("offset_output_p_noncomm"));
  SET_STRING_ELT(state_names, 451, mkChar("dim_ec"));
  SET_STRING_ELT(state_names, 452, mkChar("ec"));
  SET_STRING_ELT(state_names, 453, mkChar("dim_eP"));
  SET_STRING_ELT(state_names, 454, mkChar("eP"));
  SET_STRING_ELT(state_names, 455, mkChar("dim_eP0"));
  SET_STRING_ELT(state_names, 456, mkChar("eP0"));
  SET_STRING_ELT(state_names, 457, mkChar("offset_output_eP0"));
  SET_STRING_ELT(state_names, 458, mkChar("dim_eP1a"));
  SET_STRING_ELT(state_names, 459, mkChar("eP1a"));
  SET_STRING_ELT(state_names, 460, mkChar("offset_output_eP1a"));
  SET_STRING_ELT(state_names, 461, mkChar("dim_eP1b"));
  SET_STRING_ELT(state_names, 462, mkChar("eP1b"));
  SET_STRING_ELT(state_names, 463, mkChar("offset_output_eP1b"));
  SET_STRING_ELT(state_names, 464, mkChar("dim_eP1c"));
  SET_STRING_ELT(state_names, 465, mkChar("eP1c"));
  SET_STRING_ELT(state_names, 466, mkChar("offset_output_eP1c"));
  SET_STRING_ELT(state_names, 467, mkChar("dim_eP1d"));
  SET_STRING_ELT(state_names, 468, mkChar("eP1d"));
  SET_STRING_ELT(state_names, 469, mkChar("offset_output_eP1d"));
  SET_STRING_ELT(state_names, 470, mkChar("dim_fc_comm"));
  SET_STRING_ELT(state_names, 471, mkChar("dim_fc_comm_1"));
  SET_STRING_ELT(state_names, 472, mkChar("dim_fc_comm_2"));
  SET_STRING_ELT(state_names, 473, mkChar("fc_comm"));
  SET_STRING_ELT(state_names, 474, mkChar("offset_output_fc_comm"));
  SET_STRING_ELT(state_names, 475, mkChar("dim_fP_comm"));
  SET_STRING_ELT(state_names, 476, mkChar("fP_comm"));
  SET_STRING_ELT(state_names, 477, mkChar("offset_output_fP_comm"));
  SET_STRING_ELT(state_names, 478, mkChar("dim_fc_noncomm"));
  SET_STRING_ELT(state_names, 479, mkChar("dim_fc_noncomm_1"));
  SET_STRING_ELT(state_names, 480, mkChar("dim_fc_noncomm_2"));
  SET_STRING_ELT(state_names, 481, mkChar("fc_noncomm"));
  SET_STRING_ELT(state_names, 482, mkChar("offset_output_fc_noncomm"));
  SET_STRING_ELT(state_names, 483, mkChar("dim_fP_noncomm"));
  SET_STRING_ELT(state_names, 484, mkChar("fP_noncomm"));
  SET_STRING_ELT(state_names, 485, mkChar("offset_output_fP_noncomm"));
  SET_STRING_ELT(state_names, 486, mkChar("dim_n_comm"));
  SET_STRING_ELT(state_names, 487, mkChar("dim_n_comm_1"));
  SET_STRING_ELT(state_names, 488, mkChar("dim_n_comm_2"));
  SET_STRING_ELT(state_names, 489, mkChar("n_comm"));
  SET_STRING_ELT(state_names, 490, mkChar("offset_output_n_comm"));
  SET_STRING_ELT(state_names, 491, mkChar("dim_n_noncomm"));
  SET_STRING_ELT(state_names, 492, mkChar("dim_n_noncomm_1"));
  SET_STRING_ELT(state_names, 493, mkChar("dim_n_noncomm_2"));
  SET_STRING_ELT(state_names, 494, mkChar("n_noncomm"));
  SET_STRING_ELT(state_names, 495, mkChar("offset_output_n_noncomm"));
  SET_STRING_ELT(state_names, 496, mkChar("dim_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 497, mkChar("initial_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 498, mkChar("offset_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 499, mkChar("dim_cumuARTinitiations"));
  SET_STRING_ELT(state_names, 500, mkChar("initial_cumuARTinitiations"));
  SET_STRING_ELT(state_names, 501, mkChar("offset_cumuARTinitiations"));
  SET_STRING_ELT(state_names, 502, mkChar("dim_TasPinitiations"));
  SET_STRING_ELT(state_names, 503, mkChar("initial_TasPinitiations"));
  SET_STRING_ELT(state_names, 504, mkChar("offset_TasPinitiations"));
  SET_STRING_ELT(state_names, 505, mkChar("dim_cumuARTREinitiations"));
  SET_STRING_ELT(state_names, 506, mkChar("initial_cumuARTREinitiations"));
  SET_STRING_ELT(state_names, 507, mkChar("offset_cumuARTREinitiations"));
  SET_STRING_ELT(state_names, 508, mkChar("dim_dropouts"));
  SET_STRING_ELT(state_names, 509, mkChar("initial_dropouts"));
  SET_STRING_ELT(state_names, 510, mkChar("offset_dropouts"));
  SET_STRING_ELT(state_names, 511, mkChar("dim_cumuAllDeaths"));
  SET_STRING_ELT(state_names, 512, mkChar("initial_cumuAllDeaths"));
  SET_STRING_ELT(state_names, 513, mkChar("offset_cumuAllDeaths"));
  SET_STRING_ELT(state_names, 514, mkChar("dim_cumuInf"));
  SET_STRING_ELT(state_names, 515, mkChar("initial_cumuInf"));
  SET_STRING_ELT(state_names, 516, mkChar("offset_cumuInf"));
  SET_STRING_ELT(state_names, 517, mkChar("dim_PrEPinitiations"));
  SET_STRING_ELT(state_names, 518, mkChar("initial_PrEPinitiations"));
  SET_STRING_ELT(state_names, 519, mkChar("offset_PrEPinitiations"));
  SET_STRING_ELT(state_names, 520, mkChar("dim_PrEPinitiations1a"));
  SET_STRING_ELT(state_names, 521, mkChar("initial_PrEPinitiations1a"));
  SET_STRING_ELT(state_names, 522, mkChar("offset_PrEPinitiations1a"));
  SET_STRING_ELT(state_names, 523, mkChar("dim_PrEPinitiations1b"));
  SET_STRING_ELT(state_names, 524, mkChar("initial_PrEPinitiations1b"));
  SET_STRING_ELT(state_names, 525, mkChar("offset_PrEPinitiations1b"));
  SET_STRING_ELT(state_names, 526, mkChar("dim_PrEPinitiations1c"));
  SET_STRING_ELT(state_names, 527, mkChar("initial_PrEPinitiations1c"));
  SET_STRING_ELT(state_names, 528, mkChar("offset_PrEPinitiations1c"));
  SET_STRING_ELT(state_names, 529, mkChar("dim_S0"));
  SET_STRING_ELT(state_names, 530, mkChar("initial_S0"));
  SET_STRING_ELT(state_names, 531, mkChar("offset_S0"));
  SET_STRING_ELT(state_names, 532, mkChar("dim_S1a"));
  SET_STRING_ELT(state_names, 533, mkChar("initial_S1a"));
  SET_STRING_ELT(state_names, 534, mkChar("offset_S1a"));
  SET_STRING_ELT(state_names, 535, mkChar("dim_S1b"));
  SET_STRING_ELT(state_names, 536, mkChar("initial_S1b"));
  SET_STRING_ELT(state_names, 537, mkChar("offset_S1b"));
  SET_STRING_ELT(state_names, 538, mkChar("dim_S1c"));
  SET_STRING_ELT(state_names, 539, mkChar("initial_S1c"));
  SET_STRING_ELT(state_names, 540, mkChar("offset_S1c"));
  SET_STRING_ELT(state_names, 541, mkChar("dim_S1d"));
  SET_STRING_ELT(state_names, 542, mkChar("initial_S1d"));
  SET_STRING_ELT(state_names, 543, mkChar("offset_S1d"));
  SET_STRING_ELT(state_names, 544, mkChar("dim_I01"));
  SET_STRING_ELT(state_names, 545, mkChar("initial_I01"));
  SET_STRING_ELT(state_names, 546, mkChar("offset_I01"));
  SET_STRING_ELT(state_names, 547, mkChar("dim_I11"));
  SET_STRING_ELT(state_names, 548, mkChar("initial_I11"));
  SET_STRING_ELT(state_names, 549, mkChar("offset_I11"));
  SET_STRING_ELT(state_names, 550, mkChar("dim_I02"));
  SET_STRING_ELT(state_names, 551, mkChar("initial_I02"));
  SET_STRING_ELT(state_names, 552, mkChar("offset_I02"));
  SET_STRING_ELT(state_names, 553, mkChar("dim_I03"));
  SET_STRING_ELT(state_names, 554, mkChar("initial_I03"));
  SET_STRING_ELT(state_names, 555, mkChar("offset_I03"));
  SET_STRING_ELT(state_names, 556, mkChar("dim_I04"));
  SET_STRING_ELT(state_names, 557, mkChar("initial_I04"));
  SET_STRING_ELT(state_names, 558, mkChar("offset_I04"));
  SET_STRING_ELT(state_names, 559, mkChar("dim_I05"));
  SET_STRING_ELT(state_names, 560, mkChar("initial_I05"));
  SET_STRING_ELT(state_names, 561, mkChar("offset_I05"));
  SET_STRING_ELT(state_names, 562, mkChar("dim_I22"));
  SET_STRING_ELT(state_names, 563, mkChar("initial_I22"));
  SET_STRING_ELT(state_names, 564, mkChar("offset_I22"));
  SET_STRING_ELT(state_names, 565, mkChar("dim_I23"));
  SET_STRING_ELT(state_names, 566, mkChar("initial_I23"));
  SET_STRING_ELT(state_names, 567, mkChar("offset_I23"));
  SET_STRING_ELT(state_names, 568, mkChar("dim_I24"));
  SET_STRING_ELT(state_names, 569, mkChar("initial_I24"));
  SET_STRING_ELT(state_names, 570, mkChar("offset_I24"));
  SET_STRING_ELT(state_names, 571, mkChar("dim_I25"));
  SET_STRING_ELT(state_names, 572, mkChar("initial_I25"));
  SET_STRING_ELT(state_names, 573, mkChar("offset_I25"));
  SET_STRING_ELT(state_names, 574, mkChar("dim_I32"));
  SET_STRING_ELT(state_names, 575, mkChar("initial_I32"));
  SET_STRING_ELT(state_names, 576, mkChar("offset_I32"));
  SET_STRING_ELT(state_names, 577, mkChar("dim_I33"));
  SET_STRING_ELT(state_names, 578, mkChar("initial_I33"));
  SET_STRING_ELT(state_names, 579, mkChar("offset_I33"));
  SET_STRING_ELT(state_names, 580, mkChar("dim_I34"));
  SET_STRING_ELT(state_names, 581, mkChar("initial_I34"));
  SET_STRING_ELT(state_names, 582, mkChar("offset_I34"));
  SET_STRING_ELT(state_names, 583, mkChar("dim_I35"));
  SET_STRING_ELT(state_names, 584, mkChar("initial_I35"));
  SET_STRING_ELT(state_names, 585, mkChar("offset_I35"));
  SET_STRING_ELT(state_names, 586, mkChar("dim_I42"));
  SET_STRING_ELT(state_names, 587, mkChar("initial_I42"));
  SET_STRING_ELT(state_names, 588, mkChar("offset_I42"));
  SET_STRING_ELT(state_names, 589, mkChar("dim_I43"));
  SET_STRING_ELT(state_names, 590, mkChar("initial_I43"));
  SET_STRING_ELT(state_names, 591, mkChar("offset_I43"));
  SET_STRING_ELT(state_names, 592, mkChar("dim_I44"));
  SET_STRING_ELT(state_names, 593, mkChar("initial_I44"));
  SET_STRING_ELT(state_names, 594, mkChar("offset_I44"));
  SET_STRING_ELT(state_names, 595, mkChar("dim_I45"));
  SET_STRING_ELT(state_names, 596, mkChar("initial_I45"));
  SET_STRING_ELT(state_names, 597, mkChar("offset_I45"));
  SET_STRING_ELT(state_names, 598, mkChar("dim_S0_init"));
  SET_STRING_ELT(state_names, 599, mkChar("S0_init"));
  SET_STRING_ELT(state_names, 600, mkChar("dim_S1a_init"));
  SET_STRING_ELT(state_names, 601, mkChar("S1a_init"));
  SET_STRING_ELT(state_names, 602, mkChar("dim_S1b_init"));
  SET_STRING_ELT(state_names, 603, mkChar("S1b_init"));
  SET_STRING_ELT(state_names, 604, mkChar("dim_S1c_init"));
  SET_STRING_ELT(state_names, 605, mkChar("S1c_init"));
  SET_STRING_ELT(state_names, 606, mkChar("dim_S1d_init"));
  SET_STRING_ELT(state_names, 607, mkChar("S1d_init"));
  SET_STRING_ELT(state_names, 608, mkChar("dim_I01_init"));
  SET_STRING_ELT(state_names, 609, mkChar("I01_init"));
  SET_STRING_ELT(state_names, 610, mkChar("dim_I11_init"));
  SET_STRING_ELT(state_names, 611, mkChar("I11_init"));
  SET_STRING_ELT(state_names, 612, mkChar("dim_I02_init"));
  SET_STRING_ELT(state_names, 613, mkChar("I02_init"));
  SET_STRING_ELT(state_names, 614, mkChar("dim_I03_init"));
  SET_STRING_ELT(state_names, 615, mkChar("I03_init"));
  SET_STRING_ELT(state_names, 616, mkChar("dim_I04_init"));
  SET_STRING_ELT(state_names, 617, mkChar("I04_init"));
  SET_STRING_ELT(state_names, 618, mkChar("dim_I05_init"));
  SET_STRING_ELT(state_names, 619, mkChar("I05_init"));
  SET_STRING_ELT(state_names, 620, mkChar("dim_I22_init"));
  SET_STRING_ELT(state_names, 621, mkChar("I22_init"));
  SET_STRING_ELT(state_names, 622, mkChar("dim_I23_init"));
  SET_STRING_ELT(state_names, 623, mkChar("I23_init"));
  SET_STRING_ELT(state_names, 624, mkChar("dim_I24_init"));
  SET_STRING_ELT(state_names, 625, mkChar("I24_init"));
  SET_STRING_ELT(state_names, 626, mkChar("dim_I25_init"));
  SET_STRING_ELT(state_names, 627, mkChar("I25_init"));
  SET_STRING_ELT(state_names, 628, mkChar("dim_I32_init"));
  SET_STRING_ELT(state_names, 629, mkChar("I32_init"));
  SET_STRING_ELT(state_names, 630, mkChar("dim_I33_init"));
  SET_STRING_ELT(state_names, 631, mkChar("I33_init"));
  SET_STRING_ELT(state_names, 632, mkChar("dim_I34_init"));
  SET_STRING_ELT(state_names, 633, mkChar("I34_init"));
  SET_STRING_ELT(state_names, 634, mkChar("dim_I35_init"));
  SET_STRING_ELT(state_names, 635, mkChar("I35_init"));
  SET_STRING_ELT(state_names, 636, mkChar("dim_I42_init"));
  SET_STRING_ELT(state_names, 637, mkChar("I42_init"));
  SET_STRING_ELT(state_names, 638, mkChar("dim_I43_init"));
  SET_STRING_ELT(state_names, 639, mkChar("I43_init"));
  SET_STRING_ELT(state_names, 640, mkChar("dim_I44_init"));
  SET_STRING_ELT(state_names, 641, mkChar("I44_init"));
  SET_STRING_ELT(state_names, 642, mkChar("dim_I45_init"));
  SET_STRING_ELT(state_names, 643, mkChar("I45_init"));
  SET_STRING_ELT(state_names, 644, mkChar("dim_N"));
  SET_STRING_ELT(state_names, 645, mkChar("N"));
  SET_STRING_ELT(state_names, 646, mkChar("offset_output_N"));
  SET_STRING_ELT(state_names, 647, mkChar("dim_E0"));
  SET_STRING_ELT(state_names, 648, mkChar("E0"));
  SET_STRING_ELT(state_names, 649, mkChar("offset_output_E0"));
  SET_STRING_ELT(state_names, 650, mkChar("dim_E1a"));
  SET_STRING_ELT(state_names, 651, mkChar("E1a"));
  SET_STRING_ELT(state_names, 652, mkChar("offset_output_E1a"));
  SET_STRING_ELT(state_names, 653, mkChar("dim_E1b"));
  SET_STRING_ELT(state_names, 654, mkChar("E1b"));
  SET_STRING_ELT(state_names, 655, mkChar("offset_output_E1b"));
  SET_STRING_ELT(state_names, 656, mkChar("dim_E1c"));
  SET_STRING_ELT(state_names, 657, mkChar("E1c"));
  SET_STRING_ELT(state_names, 658, mkChar("offset_output_E1c"));
  SET_STRING_ELT(state_names, 659, mkChar("dim_E1d"));
  SET_STRING_ELT(state_names, 660, mkChar("E1d"));
  SET_STRING_ELT(state_names, 661, mkChar("offset_output_E1d"));
  SET_STRING_ELT(state_names, 662, mkChar("dim_cumuInf_init"));
  SET_STRING_ELT(state_names, 663, mkChar("cumuInf_init"));
  SET_STRING_ELT(state_names, 664, mkChar("dim_alphaItot"));
  SET_STRING_ELT(state_names, 665, mkChar("alphaItot"));
  SET_STRING_ELT(state_names, 666, mkChar("offset_output_alphaItot"));
  SET_STRING_ELT(state_names, 667, mkChar("dim_prev"));
  SET_STRING_ELT(state_names, 668, mkChar("prev"));
  SET_STRING_ELT(state_names, 669, mkChar("offset_output_prev"));
  SET_STRING_ELT(state_names, 670, mkChar("dim_lambda"));
  SET_STRING_ELT(state_names, 671, mkChar("dim_lambda_1"));
  SET_STRING_ELT(state_names, 672, mkChar("dim_lambda_2"));
  SET_STRING_ELT(state_names, 673, mkChar("lambda"));
  SET_STRING_ELT(state_names, 674, mkChar("offset_output_lambda"));
  SET_STRING_ELT(state_names, 675, mkChar("dim_lambda_0"));
  SET_STRING_ELT(state_names, 676, mkChar("dim_lambda_0_1"));
  SET_STRING_ELT(state_names, 677, mkChar("dim_lambda_0_2"));
  SET_STRING_ELT(state_names, 678, mkChar("lambda_0"));
  SET_STRING_ELT(state_names, 679, mkChar("offset_output_lambda_0"));
  SET_STRING_ELT(state_names, 680, mkChar("dim_lambda_1a"));
  SET_STRING_ELT(state_names, 681, mkChar("dim_lambda_1a_1"));
  SET_STRING_ELT(state_names, 682, mkChar("dim_lambda_1a_2"));
  SET_STRING_ELT(state_names, 683, mkChar("lambda_1a"));
  SET_STRING_ELT(state_names, 684, mkChar("offset_output_lambda_1a"));
  SET_STRING_ELT(state_names, 685, mkChar("dim_lambda_1b"));
  SET_STRING_ELT(state_names, 686, mkChar("dim_lambda_1b_1"));
  SET_STRING_ELT(state_names, 687, mkChar("dim_lambda_1b_2"));
  SET_STRING_ELT(state_names, 688, mkChar("lambda_1b"));
  SET_STRING_ELT(state_names, 689, mkChar("offset_output_lambda_1b"));
  SET_STRING_ELT(state_names, 690, mkChar("dim_lambda_1c"));
  SET_STRING_ELT(state_names, 691, mkChar("dim_lambda_1c_1"));
  SET_STRING_ELT(state_names, 692, mkChar("dim_lambda_1c_2"));
  SET_STRING_ELT(state_names, 693, mkChar("lambda_1c"));
  SET_STRING_ELT(state_names, 694, mkChar("offset_output_lambda_1c"));
  SET_STRING_ELT(state_names, 695, mkChar("dim_lambda_1d"));
  SET_STRING_ELT(state_names, 696, mkChar("dim_lambda_1d_1"));
  SET_STRING_ELT(state_names, 697, mkChar("dim_lambda_1d_2"));
  SET_STRING_ELT(state_names, 698, mkChar("lambda_1d"));
  SET_STRING_ELT(state_names, 699, mkChar("offset_output_lambda_1d"));
  SET_STRING_ELT(state_names, 700, mkChar("dim_lambda_sum_0"));
  SET_STRING_ELT(state_names, 701, mkChar("lambda_sum_0"));
  SET_STRING_ELT(state_names, 702, mkChar("offset_output_lambda_sum_0"));
  SET_STRING_ELT(state_names, 703, mkChar("dim_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 704, mkChar("lambda_sum_1a"));
  SET_STRING_ELT(state_names, 705, mkChar("offset_output_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 706, mkChar("dim_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 707, mkChar("lambda_sum_1b"));
  SET_STRING_ELT(state_names, 708, mkChar("offset_output_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 709, mkChar("dim_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 710, mkChar("lambda_sum_1c"));
  SET_STRING_ELT(state_names, 711, mkChar("offset_output_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 712, mkChar("dim_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 713, mkChar("lambda_sum_1d"));
  SET_STRING_ELT(state_names, 714, mkChar("offset_output_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 715, mkChar("dim_c_comm_balanced"));
  SET_STRING_ELT(state_names, 716, mkChar("c_comm_balanced"));
  SET_STRING_ELT(state_names, 717, mkChar("offset_output_c_comm_balanced"));
  SET_STRING_ELT(state_names, 718, mkChar("dim_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 719, mkChar("c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 720, mkChar("offset_output_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 721, mkChar("dim_theta"));
  SET_STRING_ELT(state_names, 722, mkChar("dim_theta_1"));
  SET_STRING_ELT(state_names, 723, mkChar("dim_theta_2"));
  SET_STRING_ELT(state_names, 724, mkChar("theta"));
  SET_STRING_ELT(state_names, 725, mkChar("offset_output_theta"));
  SET_STRING_ELT(state_names, 726, mkChar("dim_PrEPinitiations_init"));
  SET_STRING_ELT(state_names, 727, mkChar("PrEPinitiations_init"));
  SET_STRING_ELT(state_names, 728, mkChar("dim_M_comm"));
  SET_STRING_ELT(state_names, 729, mkChar("dim_M_comm_1"));
  SET_STRING_ELT(state_names, 730, mkChar("dim_M_comm_2"));
  SET_STRING_ELT(state_names, 731, mkChar("M_comm"));
  SET_STRING_ELT(state_names, 732, mkChar("offset_output_M_comm"));
  SET_STRING_ELT(state_names, 733, mkChar("dim_M_noncomm"));
  SET_STRING_ELT(state_names, 734, mkChar("dim_M_noncomm_1"));
  SET_STRING_ELT(state_names, 735, mkChar("dim_M_noncomm_2"));
  SET_STRING_ELT(state_names, 736, mkChar("M_noncomm"));
  SET_STRING_ELT(state_names, 737, mkChar("offset_output_M_noncomm"));
  SET_STRING_ELT(state_names, 738, mkChar("dim_in_S0"));
  SET_STRING_ELT(state_names, 739, mkChar("dim_in_S0_1"));
  SET_STRING_ELT(state_names, 740, mkChar("dim_in_S0_2"));
  SET_STRING_ELT(state_names, 741, mkChar("in_S0"));
  SET_STRING_ELT(state_names, 742, mkChar("dim_in_S1a"));
  SET_STRING_ELT(state_names, 743, mkChar("dim_in_S1a_1"));
  SET_STRING_ELT(state_names, 744, mkChar("dim_in_S1a_2"));
  SET_STRING_ELT(state_names, 745, mkChar("in_S1a"));
  SET_STRING_ELT(state_names, 746, mkChar("dim_in_S1b"));
  SET_STRING_ELT(state_names, 747, mkChar("dim_in_S1b_1"));
  SET_STRING_ELT(state_names, 748, mkChar("dim_in_S1b_2"));
  SET_STRING_ELT(state_names, 749, mkChar("in_S1b"));
  SET_STRING_ELT(state_names, 750, mkChar("dim_in_S1c"));
  SET_STRING_ELT(state_names, 751, mkChar("dim_in_S1c_1"));
  SET_STRING_ELT(state_names, 752, mkChar("dim_in_S1c_2"));
  SET_STRING_ELT(state_names, 753, mkChar("in_S1c"));
  SET_STRING_ELT(state_names, 754, mkChar("dim_in_S1d"));
  SET_STRING_ELT(state_names, 755, mkChar("dim_in_S1d_1"));
  SET_STRING_ELT(state_names, 756, mkChar("dim_in_S1d_2"));
  SET_STRING_ELT(state_names, 757, mkChar("in_S1d"));
  SET_STRING_ELT(state_names, 758, mkChar("dim_in_I01"));
  SET_STRING_ELT(state_names, 759, mkChar("dim_in_I01_1"));
  SET_STRING_ELT(state_names, 760, mkChar("dim_in_I01_2"));
  SET_STRING_ELT(state_names, 761, mkChar("in_I01"));
  SET_STRING_ELT(state_names, 762, mkChar("dim_in_I11"));
  SET_STRING_ELT(state_names, 763, mkChar("dim_in_I11_1"));
  SET_STRING_ELT(state_names, 764, mkChar("dim_in_I11_2"));
  SET_STRING_ELT(state_names, 765, mkChar("in_I11"));
  SET_STRING_ELT(state_names, 766, mkChar("dim_in_I02"));
  SET_STRING_ELT(state_names, 767, mkChar("dim_in_I02_1"));
  SET_STRING_ELT(state_names, 768, mkChar("dim_in_I02_2"));
  SET_STRING_ELT(state_names, 769, mkChar("in_I02"));
  SET_STRING_ELT(state_names, 770, mkChar("dim_in_I03"));
  SET_STRING_ELT(state_names, 771, mkChar("dim_in_I03_1"));
  SET_STRING_ELT(state_names, 772, mkChar("dim_in_I03_2"));
  SET_STRING_ELT(state_names, 773, mkChar("in_I03"));
  SET_STRING_ELT(state_names, 774, mkChar("dim_in_I04"));
  SET_STRING_ELT(state_names, 775, mkChar("dim_in_I04_1"));
  SET_STRING_ELT(state_names, 776, mkChar("dim_in_I04_2"));
  SET_STRING_ELT(state_names, 777, mkChar("in_I04"));
  SET_STRING_ELT(state_names, 778, mkChar("dim_in_I05"));
  SET_STRING_ELT(state_names, 779, mkChar("dim_in_I05_1"));
  SET_STRING_ELT(state_names, 780, mkChar("dim_in_I05_2"));
  SET_STRING_ELT(state_names, 781, mkChar("in_I05"));
  SET_STRING_ELT(state_names, 782, mkChar("dim_in_I22"));
  SET_STRING_ELT(state_names, 783, mkChar("dim_in_I22_1"));
  SET_STRING_ELT(state_names, 784, mkChar("dim_in_I22_2"));
  SET_STRING_ELT(state_names, 785, mkChar("in_I22"));
  SET_STRING_ELT(state_names, 786, mkChar("dim_in_I23"));
  SET_STRING_ELT(state_names, 787, mkChar("dim_in_I23_1"));
  SET_STRING_ELT(state_names, 788, mkChar("dim_in_I23_2"));
  SET_STRING_ELT(state_names, 789, mkChar("in_I23"));
  SET_STRING_ELT(state_names, 790, mkChar("dim_in_I24"));
  SET_STRING_ELT(state_names, 791, mkChar("dim_in_I24_1"));
  SET_STRING_ELT(state_names, 792, mkChar("dim_in_I24_2"));
  SET_STRING_ELT(state_names, 793, mkChar("in_I24"));
  SET_STRING_ELT(state_names, 794, mkChar("dim_in_I25"));
  SET_STRING_ELT(state_names, 795, mkChar("dim_in_I25_1"));
  SET_STRING_ELT(state_names, 796, mkChar("dim_in_I25_2"));
  SET_STRING_ELT(state_names, 797, mkChar("in_I25"));
  SET_STRING_ELT(state_names, 798, mkChar("dim_in_I32"));
  SET_STRING_ELT(state_names, 799, mkChar("dim_in_I32_1"));
  SET_STRING_ELT(state_names, 800, mkChar("dim_in_I32_2"));
  SET_STRING_ELT(state_names, 801, mkChar("in_I32"));
  SET_STRING_ELT(state_names, 802, mkChar("dim_in_I33"));
  SET_STRING_ELT(state_names, 803, mkChar("dim_in_I33_1"));
  SET_STRING_ELT(state_names, 804, mkChar("dim_in_I33_2"));
  SET_STRING_ELT(state_names, 805, mkChar("in_I33"));
  SET_STRING_ELT(state_names, 806, mkChar("dim_in_I34"));
  SET_STRING_ELT(state_names, 807, mkChar("dim_in_I34_1"));
  SET_STRING_ELT(state_names, 808, mkChar("dim_in_I34_2"));
  SET_STRING_ELT(state_names, 809, mkChar("in_I34"));
  SET_STRING_ELT(state_names, 810, mkChar("dim_in_I35"));
  SET_STRING_ELT(state_names, 811, mkChar("dim_in_I35_1"));
  SET_STRING_ELT(state_names, 812, mkChar("dim_in_I35_2"));
  SET_STRING_ELT(state_names, 813, mkChar("in_I35"));
  SET_STRING_ELT(state_names, 814, mkChar("dim_in_I42"));
  SET_STRING_ELT(state_names, 815, mkChar("dim_in_I42_1"));
  SET_STRING_ELT(state_names, 816, mkChar("dim_in_I42_2"));
  SET_STRING_ELT(state_names, 817, mkChar("in_I42"));
  SET_STRING_ELT(state_names, 818, mkChar("dim_in_I43"));
  SET_STRING_ELT(state_names, 819, mkChar("dim_in_I43_1"));
  SET_STRING_ELT(state_names, 820, mkChar("dim_in_I43_2"));
  SET_STRING_ELT(state_names, 821, mkChar("in_I43"));
  SET_STRING_ELT(state_names, 822, mkChar("dim_in_I44"));
  SET_STRING_ELT(state_names, 823, mkChar("dim_in_I44_1"));
  SET_STRING_ELT(state_names, 824, mkChar("dim_in_I44_2"));
  SET_STRING_ELT(state_names, 825, mkChar("in_I44"));
  SET_STRING_ELT(state_names, 826, mkChar("dim_in_I45"));
  SET_STRING_ELT(state_names, 827, mkChar("dim_in_I45_1"));
  SET_STRING_ELT(state_names, 828, mkChar("dim_in_I45_2"));
  SET_STRING_ELT(state_names, 829, mkChar("in_I45"));
  SET_STRING_ELT(state_names, 830, mkChar("dim_rate_move_in"));
  SET_STRING_ELT(state_names, 831, mkChar("dim_rate_move_in_1"));
  SET_STRING_ELT(state_names, 832, mkChar("dim_rate_move_in_2"));
  SET_STRING_ELT(state_names, 833, mkChar("rate_move_in"));
  SET_STRING_ELT(state_names, 834, mkChar("offset_output_rate_move_in"));
  SET_STRING_ELT(state_names, 835, mkChar("dim_rate_move_out"));
  SET_STRING_ELT(state_names, 836, mkChar("rate_move_out"));
  SET_STRING_ELT(state_names, 837, mkChar("offset_output_rate_move_out"));
  SET_STRING_ELT(state_names, 838, mkChar("interpolate_pfFSW"));
  SET_STRING_ELT(state_names, 839, mkChar("interpolate_c_comm"));
  SET_STRING_ELT(state_names, 840, mkChar("interpolate_c_noncomm"));
  SET_STRING_ELT(state_names, 841, mkChar("interpolate_ART_eligible_CD4_above_500"));
  SET_STRING_ELT(state_names, 842, mkChar("ART_eligible_CD4_above_500"));
  SET_STRING_ELT(state_names, 843, mkChar("interpolate_ART_eligible_CD4_350_500"));
  SET_STRING_ELT(state_names, 844, mkChar("ART_eligible_CD4_350_500"));
  SET_STRING_ELT(state_names, 845, mkChar("interpolate_ART_eligible_CD4_200_349"));
  SET_STRING_ELT(state_names, 846, mkChar("ART_eligible_CD4_200_349"));
  SET_STRING_ELT(state_names, 847, mkChar("interpolate_ART_eligible_CD4_below_200"));
  SET_STRING_ELT(state_names, 848, mkChar("ART_eligible_CD4_below_200"));
  SET_STRING_ELT(state_names, 849, mkChar("interpolate_testing_prob"));
  SET_STRING_ELT(state_names, 850, mkChar("interpolate_tau_intervention"));
  SET_STRING_ELT(state_names, 851, mkChar("interpolate_rho_intervention"));
  SET_STRING_ELT(state_names, 852, mkChar("interpolate_viral_supp"));
  SET_STRING_ELT(state_names, 853, mkChar("interpolate_infect_ART"));
  SET_STRING_ELT(state_names, 854, mkChar("interpolate_epsilon"));
  SET_STRING_ELT(state_names, 855, mkChar("epsilon"));
  SET_STRING_ELT(state_names, 856, mkChar("interpolate_prep_offered"));
  SET_STRING_ELT(state_names, 857, mkChar("interpolate_fc_comm"));
  SET_STRING_ELT(state_names, 858, mkChar("interpolate_fP_comm"));
  SET_STRING_ELT(state_names, 859, mkChar("interpolate_fc_noncomm"));
  SET_STRING_ELT(state_names, 860, mkChar("interpolate_fP_noncomm"));
  SET_STRING_ELT(state_names, 861, mkChar("interpolate_n_comm"));
  SET_STRING_ELT(state_names, 862, mkChar("interpolate_n_noncomm"));
  SET_STRING_ELT(state_names, 863, mkChar("dim"));
  SET_STRING_ELT(state_names, 864, mkChar("dim_output"));
...
SEXP main_model_output_order(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  int *tmp;
  SEXP state_len = PROTECT(allocVector(VECSXP, 173));
  SEXP state_names = PROTECT(allocVector(STRSXP, 173));
  SET_VECTOR_ELT(state_len, 0, R_NilValue);
  SET_STRING_ELT(state_names, 0, mkChar("testpar"));
  SET_VECTOR_ELT(state_len, 1, R_NilValue);
  SET_STRING_ELT(state_names, 1, mkChar("who_believe_comm"));
  SET_VECTOR_ELT(state_len, 2, R_NilValue);
  SET_STRING_ELT(state_names, 2, mkChar("ART_eligible_CD4_above_500"));
  SET_VECTOR_ELT(state_len, 3, R_NilValue);
  SET_STRING_ELT(state_names, 3, mkChar("ART_eligible_CD4_350_500"));
  SET_VECTOR_ELT(state_len, 4, R_NilValue);
  SET_STRING_ELT(state_names, 4, mkChar("ART_eligible_CD4_200_349"));
  SET_VECTOR_ELT(state_len, 5, R_NilValue);
  SET_STRING_ELT(state_names, 5, mkChar("ART_eligible_CD4_below_200"));
  SET_VECTOR_ELT(state_len, 6, R_NilValue);
  SET_STRING_ELT(state_names, 6, mkChar("TasP_testing"));
  SET_VECTOR_ELT(state_len, 7, R_NilValue);
  SET_STRING_ELT(state_names, 7, mkChar("PrEPOnOff"));
  SET_VECTOR_ELT(state_len, 8, R_NilValue);
  SET_STRING_ELT(state_names, 8, mkChar("fPa"));
  SET_VECTOR_ELT(state_len, 9, R_NilValue);
  SET_STRING_ELT(state_names, 9, mkChar("fPb"));
  SET_VECTOR_ELT(state_len, 10, R_NilValue);
  SET_STRING_ELT(state_names, 10, mkChar("fPc"));
  SET_VECTOR_ELT(state_len, 11, R_NilValue);
  SET_STRING_ELT(state_names, 11, mkChar("W0"));
  SET_VECTOR_ELT(state_len, 12, R_NilValue);
  SET_STRING_ELT(state_names, 12, mkChar("W1"));
  SET_VECTOR_ELT(state_len, 13, R_NilValue);
  SET_STRING_ELT(state_names, 13, mkChar("W2"));
  SET_VECTOR_ELT(state_len, 14, R_NilValue);
  SET_STRING_ELT(state_names, 14, mkChar("W3"));
  SET_VECTOR_ELT(state_len, 15, R_NilValue);
  SET_STRING_ELT(state_names, 15, mkChar("cost_Initiation_of_ART_study_FSW"));
  SET_VECTOR_ELT(state_len, 16, R_NilValue);
  SET_STRING_ELT(state_names, 16, mkChar("cost_Initiation_of_ART_government_FSW"));
  SET_VECTOR_ELT(state_len, 17, R_NilValue);
  SET_STRING_ELT(state_names, 17, mkChar("cost_1_year_of_ART_study_FSW"));
  SET_VECTOR_ELT(state_len, 18, R_NilValue);
  SET_STRING_ELT(state_names, 18, mkChar("cost_1_year_of_ART_government_FSW"));
  SET_VECTOR_ELT(state_len, 19, R_NilValue);
  SET_STRING_ELT(state_names, 19, mkChar("cost_Initiation_ART_rest_of_population"));
  SET_VECTOR_ELT(state_len, 20, R_NilValue);
  SET_STRING_ELT(state_names, 20, mkChar("cost_1_year_of_ART_rest_of_population"));
  SET_VECTOR_ELT(state_len, 21, R_NilValue);
  SET_STRING_ELT(state_names, 21, mkChar("cost_FSW_initiation_ART_Patient_costs"));
  SET_VECTOR_ELT(state_len, 22, R_NilValue);
  SET_STRING_ELT(state_names, 22, mkChar("cost_FSW_1_year_ART_Patient_costs"));
  SET_VECTOR_ELT(state_len, 23, R_NilValue);
  SET_STRING_ELT(state_names, 23, mkChar("cost_Initiation_of_PrEP_study"));
  SET_VECTOR_ELT(state_len, 24, R_NilValue);
  SET_STRING_ELT(state_names, 24, mkChar("cost_1_year_PrEP_perfect_adherence_study"));
  SET_VECTOR_ELT(state_len, 25, R_NilValue);
  SET_STRING_ELT(state_names, 25, mkChar("cost_1_year_PrEP_intermediate_adherence_study"));
  SET_VECTOR_ELT(state_len, 26, R_NilValue);
  SET_STRING_ELT(state_names, 26, mkChar("cost_1_year_PrEP_non_adherence_study"));
  SET_VECTOR_ELT(state_len, 27, R_NilValue);
  SET_STRING_ELT(state_names, 27, mkChar("cost_Initiation_of_PrEP_government"));
  SET_VECTOR_ELT(state_len, 28, R_NilValue);
  SET_STRING_ELT(state_names, 28, mkChar("cost_1_year_PrEP_perfect_adherence_government"));
  SET_VECTOR_ELT(state_len, 29, R_NilValue);
  SET_STRING_ELT(state_names, 29, mkChar("cost_1_year_PrEP_intermediate_adherence_government"));
  SET_VECTOR_ELT(state_len, 30, R_NilValue);
  SET_STRING_ELT(state_names, 30, mkChar("cost_1_year_PrEP_non_adherence_government"));
  SET_VECTOR_ELT(state_len, 31, R_NilValue);
  SET_STRING_ELT(state_names, 31, mkChar("cost_PREP_initiation_Patient_costs"));
  SET_VECTOR_ELT(state_len, 32, R_NilValue);
  SET_STRING_ELT(state_names, 32, mkChar("cost_PREP_1_year_ART_Patient_costs"));
  SET_VECTOR_ELT(state_len, 33, R_NilValue);
  SET_STRING_ELT(state_names, 33, mkChar("cumuInftot"));
  SET_VECTOR_ELT(state_len, 34, R_NilValue);
  SET_STRING_ELT(state_names, 34, mkChar("ART_sex_ratio"));
  SET_VECTOR_ELT(state_len, 35, R_NilValue);
  SET_STRING_ELT(state_names, 35, mkChar("pc_S1a"));
  SET_VECTOR_ELT(state_len, 36, R_NilValue);
  SET_STRING_ELT(state_names, 36, mkChar("pc_S1b"));
  SET_VECTOR_ELT(state_len, 37, R_NilValue);
  SET_STRING_ELT(state_names, 37, mkChar("pc_S1c"));
  SET_VECTOR_ELT(state_len, 38, R_NilValue);
  SET_STRING_ELT(state_names, 38, mkChar("pc_susceptible_FSW_On_PrEP"));
  SET_VECTOR_ELT(state_len, 39, R_NilValue);
  SET_STRING_ELT(state_names, 39, mkChar("pc_all_FSW_On_PrEP"));
  SET_VECTOR_ELT(state_len, 40, R_NilValue);
  SET_STRING_ELT(state_names, 40, mkChar("FSW_On_PrEP_all_cats"));
  SET_VECTOR_ELT(state_len, 41, R_NilValue);
  SET_STRING_ELT(state_names, 41, mkChar("Men_on_ART"));
  SET_VECTOR_ELT(state_len, 42, R_NilValue);
  SET_STRING_ELT(state_names, 42, mkChar("Women_on_ART"));
  SET_VECTOR_ELT(state_len, 43, R_NilValue);
  SET_STRING_ELT(state_names, 43, mkChar("ART_coverage_men"));
  SET_VECTOR_ELT(state_len, 44, R_NilValue);
  SET_STRING_ELT(state_names, 44, mkChar("ART_coverage_women"));
  SET_VECTOR_ELT(state_len, 45, R_NilValue);
  SET_STRING_ELT(state_names, 45, mkChar("ART_coverage_FSW"));
  SET_VECTOR_ELT(state_len, 46, R_NilValue);
  SET_STRING_ELT(state_names, 46, mkChar("ART_coverage_all"));
  SET_VECTOR_ELT(state_len, 47, R_NilValue);
  SET_STRING_ELT(state_names, 47, mkChar("Ncat"));
  SET_VECTOR_ELT(state_len, 48, R_NilValue);
  SET_STRING_ELT(state_names, 48, mkChar("nu"));
  SET_VECTOR_ELT(state_len, 49, R_NilValue);
  SET_STRING_ELT(state_names, 49, mkChar("Nage"));
  SET_VECTOR_ELT(state_len, 50, R_NilValue);
  SET_STRING_ELT(state_names, 50, mkChar("dur_FSW"));
  SET_VECTOR_ELT(state_len, 51, R_NilValue);
  SET_STRING_ELT(state_names, 51, mkChar("epsilon"));
  SET_VECTOR_ELT(state_len, 52, R_NilValue);
  SET_STRING_ELT(state_names, 52, mkChar("Ntot_inc_former_FSW_nonCot"));
  SET_VECTOR_ELT(state_len, 53, R_NilValue);
  SET_STRING_ELT(state_names, 53, mkChar("new_people"));
  SET_VECTOR_ELT(state_len, 54, R_NilValue);
  SET_STRING_ELT(state_names, 54, mkChar("frac_virgin"));
  SET_VECTOR_ELT(state_len, 55, R_NilValue);
  SET_STRING_ELT(state_names, 55, mkChar("prev_LowFSW"));
  SET_VECTOR_ELT(state_len, 56, R_NilValue);
  SET_STRING_ELT(state_names, 56, mkChar("prev_men"));
  SET_VECTOR_ELT(state_len, 57, R_NilValue);
  SET_STRING_ELT(state_names, 57, mkChar("prev_women"));
  SET_VECTOR_ELT(state_len, 58, R_NilValue);
  SET_STRING_ELT(state_names, 58, mkChar("prev_cotonou"));
  SET_VECTOR_ELT(state_len, 59, R_NilValue);
  SET_STRING_ELT(state_names, 59, mkChar("Ntot"));
  SET_VECTOR_ELT(state_len, 60, R_NilValue);
  SET_STRING_ELT(state_names, 60, mkChar("prev_FSW"));
  SET_VECTOR_ELT(state_len, 61, R_NilValue);
  SET_STRING_ELT(state_names, 61, mkChar("prev_client"));
  SET_VECTOR_ELT(state_len, 62, R_NilValue);
  SET_STRING_ELT(state_names, 62, mkChar("B_check_comm"));
  SET_VECTOR_ELT(state_len, 63, R_NilValue);
  SET_STRING_ELT(state_names, 63, mkChar("B_check_noncomm"));
  SET_VECTOR_ELT(state_len, 64, R_NilValue);
  SET_STRING_ELT(state_names, 64, mkChar("pc_of_FOI_on_clients_from_pro_FSW"));
  SET_VECTOR_ELT(state_len, 65, R_NilValue);
  SET_STRING_ELT(state_names, 65, mkChar("FSW_in"));
  SET_VECTOR_ELT(state_len, 66, R_NilValue);
  SET_STRING_ELT(state_names, 66, mkChar("FSW_out"));
  SET_VECTOR_ELT(state_len, 67, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 67));
  tmp[0] = main_model_p->dim_infect_ART_y_1;
  tmp[1] = main_model_p->dim_infect_ART_y_2;
  SET_STRING_ELT(state_names, 67, mkChar("infect_ART_y"));
  SET_VECTOR_ELT(state_len, 68, ScalarInteger(main_model_p->dim_infect_ART_t));
  SET_STRING_ELT(state_names, 68, mkChar("infect_ART_t"));
  SET_VECTOR_ELT(state_len, 69, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 69));
  tmp[0] = main_model_p->dim_viral_supp_y_1;
  tmp[1] = main_model_p->dim_viral_supp_y_2;
  SET_STRING_ELT(state_names, 69, mkChar("viral_supp_y"));
  SET_VECTOR_ELT(state_len, 70, ScalarInteger(main_model_p->dim_viral_supp_t));
  SET_STRING_ELT(state_names, 70, mkChar("viral_supp_t"));
  SET_VECTOR_ELT(state_len, 71, ScalarInteger(main_model_p->dim_gamma32_without_supp));
  SET_STRING_ELT(state_names, 71, mkChar("gamma32_without_supp"));
  SET_VECTOR_ELT(state_len, 72, ScalarInteger(main_model_p->dim_gamma33_without_supp));
  SET_STRING_ELT(state_names, 72, mkChar("gamma33_without_supp"));
  SET_VECTOR_ELT(state_len, 73, ScalarInteger(main_model_p->dim_gamma34_without_supp));
  SET_STRING_ELT(state_names, 73, mkChar("gamma34_without_supp"));
  SET_VECTOR_ELT(state_len, 74, ScalarInteger(main_model_p->dim_alpha33_without_supp));
  SET_STRING_ELT(state_names, 74, mkChar("alpha33_without_supp"));
  SET_VECTOR_ELT(state_len, 75, ScalarInteger(main_model_p->dim_alpha34_without_supp));
  SET_STRING_ELT(state_names, 75, mkChar("alpha34_without_supp"));
  SET_VECTOR_ELT(state_len, 76, ScalarInteger(main_model_p->dim_alpha35_without_supp));
  SET_STRING_ELT(state_names, 76, mkChar("alpha35_without_supp"));
  SET_VECTOR_ELT(state_len, 77, ScalarInteger(main_model_p->dim_c_comm));
  SET_STRING_ELT(state_names, 77, mkChar("c_comm"));
  SET_VECTOR_ELT(state_len, 78, ScalarInteger(main_model_p->dim_c_noncomm));
  SET_STRING_ELT(state_names, 78, mkChar("c_noncomm"));
  SET_VECTOR_ELT(state_len, 79, ScalarInteger(main_model_p->dim_pfFSW));
  SET_STRING_ELT(state_names, 79, mkChar("pfFSW"));
  SET_VECTOR_ELT(state_len, 80, ScalarInteger(main_model_p->dim_new_acute_infected));
  SET_STRING_ELT(state_names, 80, mkChar("new_acute_infected"));
  SET_VECTOR_ELT(state_len, 81, ScalarInteger(main_model_p->dim_new_people_in_group));
  SET_STRING_ELT(state_names, 81, mkChar("new_people_in_group"));
  SET_VECTOR_ELT(state_len, 82, ScalarInteger(main_model_p->dim_new_people_in_group_FSW_only));
  SET_STRING_ELT(state_names, 82, mkChar("new_people_in_group_FSW_only"));
  SET_VECTOR_ELT(state_len, 83, ScalarInteger(main_model_p->dim_above_500_by_group));
  SET_STRING_ELT(state_names, 83, mkChar("above_500_by_group"));
  SET_VECTOR_ELT(state_len, 84, ScalarInteger(main_model_p->dim_testing_prob));
  SET_STRING_ELT(state_names, 84, mkChar("testing_prob"));
  SET_VECTOR_ELT(state_len, 85, ScalarInteger(main_model_p->dim_tau_intervention));
  SET_STRING_ELT(state_names, 85, mkChar("tau_intervention"));
  SET_VECTOR_ELT(state_len, 86, ScalarInteger(main_model_p->dim_rho_intervention));
  SET_STRING_ELT(state_names, 86, mkChar("rho_intervention"));
  SET_VECTOR_ELT(state_len, 87, ScalarInteger(main_model_p->dim_zeta));
  SET_STRING_ELT(state_names, 87, mkChar("zeta"));
  SET_VECTOR_ELT(state_len, 88, ScalarInteger(main_model_p->dim_eP1a_effective));
  SET_STRING_ELT(state_names, 88, mkChar("eP1a_effective"));
  SET_VECTOR_ELT(state_len, 89, ScalarInteger(main_model_p->dim_eP1b_effective));
  SET_STRING_ELT(state_names, 89, mkChar("eP1b_effective"));
  SET_VECTOR_ELT(state_len, 90, ScalarInteger(main_model_p->dim_eP1c_effective));
  SET_STRING_ELT(state_names, 90, mkChar("eP1c_effective"));
  SET_VECTOR_ELT(state_len, 91, ScalarInteger(main_model_p->dim_tau));
  SET_STRING_ELT(state_names, 91, mkChar("tau"));
  SET_VECTOR_ELT(state_len, 92, ScalarInteger(main_model_p->dim_rho));
  SET_STRING_ELT(state_names, 92, mkChar("rho"));
  SET_VECTOR_ELT(state_len, 93, ScalarInteger(main_model_p->dim_iota));
  SET_STRING_ELT(state_names, 93, mkChar("iota"));
  SET_VECTOR_ELT(state_len, 94, ScalarInteger(main_model_p->dim_viral_supp));
  SET_STRING_ELT(state_names, 94, mkChar("viral_supp"));
  SET_VECTOR_ELT(state_len, 95, ScalarInteger(main_model_p->dim_HIV_positive));
  SET_STRING_ELT(state_names, 95, mkChar("HIV_positive"));
  SET_VECTOR_ELT(state_len, 96, ScalarInteger(main_model_p->dim_Number_Susceptibles));
  SET_STRING_ELT(state_names, 96, mkChar("Number_Susceptibles"));
  SET_VECTOR_ELT(state_len, 97, ScalarInteger(main_model_p->dim_HIV_positive_Diagnosed_Off_ART));
  SET_STRING_ELT(state_names, 97, mkChar("HIV_positive_Diagnosed_Off_ART"));
  SET_VECTOR_ELT(state_len, 98, ScalarInteger(main_model_p->dim_Primary_Off_ART));
  SET_STRING_ELT(state_names, 98, mkChar("Primary_Off_ART"));
  SET_VECTOR_ELT(state_len, 99, ScalarInteger(main_model_p->dim_CD4_above_500_Off_ART));
  SET_STRING_ELT(state_names, 99, mkChar("CD4_above_500_Off_ART"));
  SET_VECTOR_ELT(state_len, 100, ScalarInteger(main_model_p->dim_CD4_350_500_Off_ART));
  SET_STRING_ELT(state_names, 100, mkChar("CD4_350_500_Off_ART"));
  SET_VECTOR_ELT(state_len, 101, ScalarInteger(main_model_p->dim_CD4_200_350_Off_ART));
  SET_STRING_ELT(state_names, 101, mkChar("CD4_200_350_Off_ART"));
  SET_VECTOR_ELT(state_len, 102, ScalarInteger(main_model_p->dim_CD4_below_200_Off_ART));
  SET_STRING_ELT(state_names, 102, mkChar("CD4_below_200_Off_ART"));
  SET_VECTOR_ELT(state_len, 103, ScalarInteger(main_model_p->dim_HIV_positive_On_ART));
  SET_STRING_ELT(state_names, 103, mkChar("HIV_positive_On_ART"));
  SET_VECTOR_ELT(state_len, 104, ScalarInteger(main_model_p->dim_Number_DALY_W1));
  SET_STRING_ELT(state_names, 104, mkChar("Number_DALY_W1"));
  SET_VECTOR_ELT(state_len, 105, ScalarInteger(main_model_p->dim_Number_DALY_W2));
  SET_STRING_ELT(state_names, 105, mkChar("Number_DALY_W2"));
  SET_VECTOR_ELT(state_len, 106, ScalarInteger(main_model_p->dim_Number_DALY_W3));
  SET_STRING_ELT(state_names, 106, mkChar("Number_DALY_W3"));
  SET_VECTOR_ELT(state_len, 107, ScalarInteger(main_model_p->dim_frac_F));
  SET_STRING_ELT(state_names, 107, mkChar("frac_F"));
  SET_VECTOR_ELT(state_len, 108, ScalarInteger(main_model_p->dim_frac_N_sexualpop));
  SET_STRING_ELT(state_names, 108, mkChar("frac_N_sexualpop"));
  SET_VECTOR_ELT(state_len, 109, ScalarInteger(main_model_p->dim_ART_coverage));
  SET_STRING_ELT(state_names, 109, mkChar("ART_coverage"));
  SET_VECTOR_ELT(state_len, 110, ScalarInteger(main_model_p->dim_infect_ART));
  SET_STRING_ELT(state_names, 110, mkChar("infect_ART"));
  SET_VECTOR_ELT(state_len, 111, ScalarInteger(main_model_p->dim_prep_offered));
  SET_STRING_ELT(state_names, 111, mkChar("prep_offered"));
  SET_VECTOR_ELT(state_len, 112, ScalarInteger(main_model_p->dim_omega));
  SET_STRING_ELT(state_names, 112, mkChar("omega"));
  SET_VECTOR_ELT(state_len, 113, ScalarInteger(main_model_p->dim_frac_N));
  SET_STRING_ELT(state_names, 113, mkChar("frac_N"));
  SET_VECTOR_ELT(state_len, 114, ScalarInteger(main_model_p->dim_mu));
  SET_STRING_ELT(state_names, 114, mkChar("mu"));
  SET_VECTOR_ELT(state_len, 115, ScalarInteger(main_model_p->dim_gamma01));
  SET_STRING_ELT(state_names, 115, mkChar("gamma01"));
  SET_VECTOR_ELT(state_len, 116, ScalarInteger(main_model_p->dim_gamma11));
  SET_STRING_ELT(state_names, 116, mkChar("gamma11"));
  SET_VECTOR_ELT(state_len, 117, ScalarInteger(main_model_p->dim_gamma32));
  SET_STRING_ELT(state_names, 117, mkChar("gamma32"));
  SET_VECTOR_ELT(state_len, 118, ScalarInteger(main_model_p->dim_gamma33));
  SET_STRING_ELT(state_names, 118, mkChar("gamma33"));
  SET_VECTOR_ELT(state_len, 119, ScalarInteger(main_model_p->dim_gamma34));
  SET_STRING_ELT(state_names, 119, mkChar("gamma34"));
  SET_VECTOR_ELT(state_len, 120, ScalarInteger(main_model_p->dim_kappaa));
  SET_STRING_ELT(state_names, 120, mkChar("kappaa"));
  SET_VECTOR_ELT(state_len, 121, ScalarInteger(main_model_p->dim_kappab));
  SET_STRING_ELT(state_names, 121, mkChar("kappab"));
  SET_VECTOR_ELT(state_len, 122, ScalarInteger(main_model_p->dim_kappac));
  SET_STRING_ELT(state_names, 122, mkChar("kappac"));
  SET_VECTOR_ELT(state_len, 123, ScalarInteger(main_model_p->dim_kappa1));
  SET_STRING_ELT(state_names, 123, mkChar("kappa1"));
  SET_VECTOR_ELT(state_len, 124, ScalarInteger(main_model_p->dim_alpha01));
  SET_STRING_ELT(state_names, 124, mkChar("alpha01"));
  SET_VECTOR_ELT(state_len, 125, ScalarInteger(main_model_p->dim_alpha02));
  SET_STRING_ELT(state_names, 125, mkChar("alpha02"));
  SET_VECTOR_ELT(state_len, 126, ScalarInteger(main_model_p->dim_alpha05));
  SET_STRING_ELT(state_names, 126, mkChar("alpha05"));
  SET_VECTOR_ELT(state_len, 127, ScalarInteger(main_model_p->dim_alpha11));
  SET_STRING_ELT(state_names, 127, mkChar("alpha11"));
  SET_VECTOR_ELT(state_len, 128, ScalarInteger(main_model_p->dim_alpha22));
  SET_STRING_ELT(state_names, 128, mkChar("alpha22"));
  SET_VECTOR_ELT(state_len, 129, ScalarInteger(main_model_p->dim_alpha33));
  SET_STRING_ELT(state_names, 129, mkChar("alpha33"));
  SET_VECTOR_ELT(state_len, 130, ScalarInteger(main_model_p->dim_alpha34));
  SET_STRING_ELT(state_names, 130, mkChar("alpha34"));
  SET_VECTOR_ELT(state_len, 131, ScalarInteger(main_model_p->dim_alpha35));
  SET_STRING_ELT(state_names, 131, mkChar("alpha35"));
  SET_VECTOR_ELT(state_len, 132, ScalarInteger(main_model_p->dim_beta_comm));
  SET_STRING_ELT(state_names, 132, mkChar("beta_comm"));
  SET_VECTOR_ELT(state_len, 133, ScalarInteger(main_model_p->dim_beta_noncomm));
  SET_STRING_ELT(state_names, 133, mkChar("beta_noncomm"));
  SET_VECTOR_ELT(state_len, 134, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 134));
  tmp[0] = main_model_p->dim_p_comm_1;
  tmp[1] = main_model_p->dim_p_comm_2;
  SET_STRING_ELT(state_names, 134, mkChar("p_comm"));
  SET_VECTOR_ELT(state_len, 135, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 135));
  tmp[0] = main_model_p->dim_p_noncomm_1;
  tmp[1] = main_model_p->dim_p_noncomm_2;
  SET_STRING_ELT(state_names, 135, mkChar("p_noncomm"));
  SET_VECTOR_ELT(state_len, 136, ScalarInteger(main_model_p->dim_eP0));
  SET_STRING_ELT(state_names, 136, mkChar("eP0"));
  SET_VECTOR_ELT(state_len, 137, ScalarInteger(main_model_p->dim_eP1a));
  SET_STRING_ELT(state_names, 137, mkChar("eP1a"));
  SET_VECTOR_ELT(state_len, 138, ScalarInteger(main_model_p->dim_eP1b));
  SET_STRING_ELT(state_names, 138, mkChar("eP1b"));
  SET_VECTOR_ELT(state_len, 139, ScalarInteger(main_model_p->dim_eP1c));
  SET_STRING_ELT(state_names, 139, mkChar("eP1c"));
  SET_VECTOR_ELT(state_len, 140, ScalarInteger(main_model_p->dim_eP1d));
  SET_STRING_ELT(state_names, 140, mkChar("eP1d"));
  ...
  SET_STRING_ELT(state_names, 141, mkChar("fc_comm"));
  SET_VECTOR_ELT(state_len, 142, ScalarInteger(main_model_p->dim_fP_comm));
  SET_STRING_ELT(state_names, 142, mkChar("fP_comm"));
  SET_VECTOR_ELT(state_len, 143, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 143));
  tmp[0] = main_model_p->dim_fc_noncomm_1;
  tmp[1] = main_model_p->dim_fc_noncomm_2;
  SET_STRING_ELT(state_names, 143, mkChar("fc_noncomm"));
  SET_VECTOR_ELT(state_len, 144, ScalarInteger(main_model_p->dim_fP_noncomm));
  SET_STRING_ELT(state_names, 144, mkChar("fP_noncomm"));
  ...
  SET_STRING_ELT(state_names, 145, mkChar("n_comm"));
  ...
  SET_STRING_ELT(state_names, 146, mkChar("n_noncomm"));
  SET_VECTOR_ELT(state_len, 147, ScalarInteger(main_model_p->dim_N));
  SET_STRING_ELT(state_names, 147, mkChar("N"));
  SET_VECTOR_ELT(state_len, 148, ScalarInteger(main_model_p->dim_E0));
  SET_STRING_ELT(state_names, 148, mkChar("E0"));
  SET_VECTOR_ELT(state_len, 149, ScalarInteger(main_model_p->dim_E1a));
  SET_STRING_ELT(state_names, 149, mkChar("E1a"));
  SET_VECTOR_ELT(state_len, 150, ScalarInteger(main_model_p->dim_E1b));
  SET_STRING_ELT(state_names, 150, mkChar("E1b"));
  SET_VECTOR_ELT(state_len, 151, ScalarInteger(main_model_p->dim_E1c));
  SET_STRING_ELT(state_names, 151, mkChar("E1c"));
  SET_VECTOR_ELT(state_len, 152, ScalarInteger(main_model_p->dim_E1d));
  SET_STRING_ELT(state_names, 152, mkChar("E1d"));
  SET_VECTOR_ELT(state_len, 153, ScalarInteger(main_model_p->dim_alphaItot));
  SET_STRING_ELT(state_names, 153, mkChar("alphaItot"));
  SET_VECTOR_ELT(state_len, 154, ScalarInteger(main_model_p->dim_prev));
  SET_STRING_ELT(state_names, 154, mkChar("prev"));
  ...
  SET_STRING_ELT(state_names, 155, mkChar("lambda"));
  ...
  SET_STRING_ELT(state_names, 156, mkChar("lambda_0"));
  ...
  SET_STRING_ELT(state_names, 157, mkChar("lambda_1a"));
  SET_VECTOR_ELT(state_len, 158, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 158));
  tmp[0] = main_model_p->dim_lambda_1b_1;
  tmp[1] = main_model_p->dim_lambda_1b_2;
  SET_STRING_ELT(state_names, 158, mkChar("lambda_1b"));
  ...
  SET_STRING_ELT(state_names, 159, mkChar("lambda_1c"));
  ...
  SET_STRING_ELT(state_names, 160, mkChar("lambda_1d"));
  SET_VECTOR_ELT(state_len, 161, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_STRING_ELT(state_names, 161, mkChar("lambda_sum_0"));
  SET_VECTOR_ELT(state_len, 162, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_STRING_ELT(state_names, 162, mkChar("lambda_sum_1a"));
  SET_VECTOR_ELT(state_len, 163, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_STRING_ELT(state_names, 163, mkChar("lambda_sum_1b"));
  SET_VECTOR_ELT(state_len, 164, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_STRING_ELT(state_names, 164, mkChar("lambda_sum_1c"));
  SET_VECTOR_ELT(state_len, 165, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_STRING_ELT(state_names, 165, mkChar("lambda_sum_1d"));
  SET_VECTOR_ELT(state_len, 166, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_STRING_ELT(state_names, 166, mkChar("c_comm_balanced"));
  SET_VECTOR_ELT(state_len, 167, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_STRING_ELT(state_names, 167, mkChar("c_noncomm_balanced"));
  ...
  SET_STRING_ELT(state_names, 168, mkChar("theta"));
  ...
  SET_STRING_ELT(state_names, 169, mkChar("M_comm"));
  ...
  SET_STRING_ELT(state_names, 170, mkChar("M_noncomm"));
  ...
  SET_STRING_ELT(state_names, 171, mkChar("rate_move_in"));
  SET_VECTOR_ELT(state_len, 172, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_STRING_ELT(state_names, 172, mkChar("rate_move_out"));
  setAttrib(state_len, R_NamesSymbol, state_names);
  UNPROTECT(2);
  return state_len;
}
