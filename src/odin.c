mkChar("dim_I05_init"));
  SET_STRING_ELT(state_names, 445, mkChar("I05_init"));
  SET_STRING_ELT(state_names, 446, mkChar("dim_I22_init"));
  SET_STRING_ELT(state_names, 447, mkChar("I22_init"));
  SET_STRING_ELT(state_names, 448, mkChar("dim_I23_init"));
  SET_STRING_ELT(state_names, 449, mkChar("I23_init"));
  SET_STRING_ELT(state_names, 450, mkChar("dim_I24_init"));
  SET_STRING_ELT(state_names, 451, mkChar("I24_init"));
  SET_STRING_ELT(state_names, 452, mkChar("dim_I25_init"));
  SET_STRING_ELT(state_names, 453, mkChar("I25_init"));
  SET_STRING_ELT(state_names, 454, mkChar("dim_I32_init"));
  SET_STRING_ELT(state_names, 455, mkChar("I32_init"));
  SET_STRING_ELT(state_names, 456, mkChar("dim_I33_init"));
  SET_STRING_ELT(state_names, 457, mkChar("I33_init"));
  SET_STRING_ELT(state_names, 458, mkChar("dim_I34_init"));
  SET_STRING_ELT(state_names, 459, mkChar("I34_init"));
  SET_STRING_ELT(state_names, 460, mkChar("dim_I35_init"));
  SET_STRING_ELT(state_names, 461, mkChar("I35_init"));
  SET_STRING_ELT(state_names, 462, mkChar("dim_I42_init"));
  SET_STRING_ELT(state_names, 463, mkChar("I42_init"));
  SET_STRING_ELT(state_names, 464, mkChar("dim_I43_init"));
  SET_STRING_ELT(state_names, 465, mkChar("I43_init"));
  SET_STRING_ELT(state_names, 466, mkChar("dim_I44_init"));
  SET_STRING_ELT(state_names, 467, mkChar("I44_init"));
  SET_STRING_ELT(state_names, 468, mkChar("dim_I45_init"));
  SET_STRING_ELT(state_names, 469, mkChar("I45_init"));
  SET_STRING_ELT(state_names, 470, mkChar("dim_N"));
  SET_STRING_ELT(state_names, 471, mkChar("N"));
  SET_STRING_ELT(state_names, 472, mkChar("offset_output_N"));
  SET_STRING_ELT(state_names, 473, mkChar("dim_E0"));
  SET_STRING_ELT(state_names, 474, mkChar("E0"));
  SET_STRING_ELT(state_names, 475, mkChar("offset_output_E0"));
  SET_STRING_ELT(state_names, 476, mkChar("dim_E1a"));
  SET_STRING_ELT(state_names, 477, mkChar("E1a"));
  SET_STRING_ELT(state_names, 478, mkChar("offset_output_E1a"));
  SET_STRING_ELT(state_names, 479, mkChar("dim_E1b"));
  SET_STRING_ELT(state_names, 480, mkChar("E1b"));
  SET_STRING_ELT(state_names, 481, mkChar("offset_output_E1b"));
  SET_STRING_ELT(state_names, 482, mkChar("dim_E1c"));
  SET_STRING_ELT(state_names, 483, mkChar("E1c"));
  SET_STRING_ELT(state_names, 484, mkChar("offset_output_E1c"));
  SET_STRING_ELT(state_names, 485, mkChar("dim_E1d"));
  SET_STRING_ELT(state_names, 486, mkChar("E1d"));
  SET_STRING_ELT(state_names, 487, mkChar("offset_output_E1d"));
  SET_STRING_ELT(state_names, 488, mkChar("dim_cumuInf_init"));
  SET_STRING_ELT(state_names, 489, mkChar("cumuInf_init"));
  SET_STRING_ELT(state_names, 490, mkChar("dim_alphaItot"));
  SET_STRING_ELT(state_names, 491, mkChar("alphaItot"));
  SET_STRING_ELT(state_names, 492, mkChar("offset_output_alphaItot"));
  SET_STRING_ELT(state_names, 493, mkChar("dim_prev"));
  SET_STRING_ELT(state_names, 494, mkChar("prev"));
  SET_STRING_ELT(state_names, 495, mkChar("offset_output_prev"));
  SET_STRING_ELT(state_names, 496, mkChar("dim_lambda"));
  SET_STRING_ELT(state_names, 497, mkChar("dim_lambda_1"));
  SET_STRING_ELT(state_names, 498, mkChar("dim_lambda_2"));
  SET_STRING_ELT(state_names, 499, mkChar("lambda"));
  SET_STRING_ELT(state_names, 500, mkChar("offset_output_lambda"));
  SET_STRING_ELT(state_names, 501, mkChar("dim_lambda_0"));
  SET_STRING_ELT(state_names, 502, mkChar("dim_lambda_0_1"));
  SET_STRING_ELT(state_names, 503, mkChar("dim_lambda_0_2"));
  SET_STRING_ELT(state_names, 504, mkChar("lambda_0"));
  SET_STRING_ELT(state_names, 505, mkChar("offset_output_lambda_0"));
  SET_STRING_ELT(state_names, 506, mkChar("dim_lambda_1a"));
  SET_STRING_ELT(state_names, 507, mkChar("dim_lambda_1a_1"));
  SET_STRING_ELT(state_names, 508, mkChar("dim_lambda_1a_2"));
  SET_STRING_ELT(state_names, 509, mkChar("lambda_1a"));
  SET_STRING_ELT(state_names, 510, mkChar("offset_output_lambda_1a"));
  SET_STRING_ELT(state_names, 511, mkChar("dim_lambda_1b"));
  SET_STRING_ELT(state_names, 512, mkChar("dim_lambda_1b_1"));
  SET_STRING_ELT(state_names, 513, mkChar("dim_lambda_1b_2"));
  SET_STRING_ELT(state_names, 514, mkChar("lambda_1b"));
  SET_STRING_ELT(state_names, 515, mkChar("offset_output_lambda_1b"));
  SET_STRING_ELT(state_names, 516, mkChar("dim_lambda_1c"));
  SET_STRING_ELT(state_names, 517, mkChar("dim_lambda_1c_1"));
  SET_STRING_ELT(state_names, 518, mkChar("dim_lambda_1c_2"));
  SET_STRING_ELT(state_names, 519, mkChar("lambda_1c"));
  SET_STRING_ELT(state_names, 520, mkChar("offset_output_lambda_1c"));
  SET_STRING_ELT(state_names, 521, mkChar("dim_lambda_1d"));
  SET_STRING_ELT(state_names, 522, mkChar("dim_lambda_1d_1"));
  SET_STRING_ELT(state_names, 523, mkChar("dim_lambda_1d_2"));
  SET_STRING_ELT(state_names, 524, mkChar("lambda_1d"));
  SET_STRING_ELT(state_names, 525, mkChar("offset_output_lambda_1d"));
  SET_STRING_ELT(state_names, 526, mkChar("dim_lambda_sum_0"));
  SET_STRING_ELT(state_names, 527, mkChar("lambda_sum_0"));
  SET_STRING_ELT(state_names, 528, mkChar("offset_output_lambda_sum_0"));
  SET_STRING_ELT(state_names, 529, mkChar("dim_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 530, mkChar("lambda_sum_1a"));
  SET_STRING_ELT(state_names, 531, mkChar("offset_output_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 532, mkChar("dim_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 533, mkChar("lambda_sum_1b"));
  SET_STRING_ELT(state_names, 534, mkChar("offset_output_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 535, mkChar("dim_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 536, mkChar("lambda_sum_1c"));
  SET_STRING_ELT(state_names, 537, mkChar("offset_output_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 538, mkChar("dim_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 539, mkChar("lambda_sum_1d"));
  SET_STRING_ELT(state_names, 540, mkChar("offset_output_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 541, mkChar("dim_c_comm_balanced"));
  SET_STRING_ELT(state_names, 542, mkChar("c_comm_balanced"));
  SET_STRING_ELT(state_names, 543, mkChar("offset_output_c_comm_balanced"));
  SET_STRING_ELT(state_names, 544, mkChar("dim_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 545, mkChar("c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 546, mkChar("offset_output_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 547, mkChar("dim_theta"));
  SET_STRING_ELT(state_names, 548, mkChar("dim_theta_1"));
  SET_STRING_ELT(state_names, 549, mkChar("dim_theta_2"));
  SET_STRING_ELT(state_names, 550, mkChar("theta"));
  SET_STRING_ELT(state_names, 551, mkChar("offset_output_theta"));
  SET_STRING_ELT(state_names, 552, mkChar("dim_OnPrEP_init"));
  SET_STRING_ELT(state_names, 553, mkChar("OnPrEP_init"));
  SET_STRING_ELT(state_names, 554, mkChar("dim_M_comm"));
  SET_STRING_ELT(state_names, 555, mkChar("dim_M_comm_1"));
  SET_STRING_ELT(state_names, 556, mkChar("dim_M_comm_2"));
  SET_STRING_ELT(state_names, 557, mkChar("M_comm"));
  SET_STRING_ELT(state_names, 558, mkChar("offset_output_M_comm"));
  SET_STRING_ELT(state_names, 559, mkChar("dim_M_noncomm"));
  SET_STRING_ELT(state_names, 560, mkChar("dim_M_noncomm_1"));
  SET_STRING_ELT(state_names, 561, mkChar("dim_M_noncomm_2"));
  SET_STRING_ELT(state_names, 562, mkChar("M_noncomm"));
  SET_STRING_ELT(state_names, 563, mkChar("offset_output_M_noncomm"));
  SET_STRING_ELT(state_names, 564, mkChar("dim_in_S0"));
  SET_STRING_ELT(state_names, 565, mkChar("dim_in_S0_1"));
  SET_STRING_ELT(state_names, 566, mkChar("dim_in_S0_2"));
  SET_STRING_ELT(state_names, 567, mkChar("in_S0"));
  SET_STRING_ELT(state_names, 568, mkChar("dim_in_S1a"));
  SET_STRING_ELT(state_names, 569, mkChar("dim_in_S1a_1"));
  SET_STRING_ELT(state_names, 570, mkChar("dim_in_S1a_2"));
  SET_STRING_ELT(state_names, 571, mkChar("in_S1a"));
  SET_STRING_ELT(state_names, 572, mkChar("dim_in_S1b"));
  SET_STRING_ELT(state_names, 573, mkChar("dim_in_S1b_1"));
  SET_STRING_ELT(state_names, 574, mkChar("dim_in_S1b_2"));
  SET_STRING_ELT(state_names, 575, mkChar("in_S1b"));
  SET_STRING_ELT(state_names, 576, mkChar("dim_in_S1c"));
  SET_STRING_ELT(state_names, 577, mkChar("dim_in_S1c_1"));
  SET_STRING_ELT(state_names, 578, mkChar("dim_in_S1c_2"));
  SET_STRING_ELT(state_names, 579, mkChar("in_S1c"));
  SET_STRING_ELT(state_names, 580, mkChar("dim_in_S1d"));
  SET_STRING_ELT(state_names, 581, mkChar("dim_in_S1d_1"));
  SET_STRING_ELT(state_names, 582, mkChar("dim_in_S1d_2"));
  SET_STRING_ELT(state_names, 583, mkChar("in_S1d"));
  SET_STRING_ELT(state_names, 584, mkChar("dim_in_I01"));
  SET_STRING_ELT(state_names, 585, mkChar("dim_in_I01_1"));
  SET_STRING_ELT(state_names, 586, mkChar("dim_in_I01_2"));
  SET_STRING_ELT(state_names, 587, mkChar("in_I01"));
  SET_STRING_ELT(state_names, 588, mkChar("dim_in_I11"));
  SET_STRING_ELT(state_names, 589, mkChar("dim_in_I11_1"));
  SET_STRING_ELT(state_names, 590, mkChar("dim_in_I11_2"));
  SET_STRING_ELT(state_names, 591, mkChar("in_I11"));
  SET_STRING_ELT(state_names, 592, mkChar("dim_in_I02"));
  SET_STRING_ELT(state_names, 593, mkChar("dim_in_I02_1"));
  SET_STRING_ELT(state_names, 594, mkChar("dim_in_I02_2"));
  SET_STRING_ELT(state_names, 595, mkChar("in_I02"));
  SET_STRING_ELT(state_names, 596, mkChar("dim_in_I03"));
  SET_STRING_ELT(state_names, 597, mkChar("dim_in_I03_1"));
  SET_STRING_ELT(state_names, 598, mkChar("dim_in_I03_2"));
  SET_STRING_ELT(state_names, 599, mkChar("in_I03"));
  SET_STRING_ELT(state_names, 600, mkChar("dim_in_I04"));
  SET_STRING_ELT(state_names, 601, mkChar("dim_in_I04_1"));
  SET_STRING_ELT(state_names, 602, mkChar("dim_in_I04_2"));
  SET_STRING_ELT(state_names, 603, mkChar("in_I04"));
  SET_STRING_ELT(state_names, 604, mkChar("dim_in_I05"));
  SET_STRING_ELT(state_names, 605, mkChar("dim_in_I05_1"));
  SET_STRING_ELT(state_names, 606, mkChar("dim_in_I05_2"));
  SET_STRING_ELT(state_names, 607, mkChar("in_I05"));
  SET_STRING_ELT(state_names, 608, mkChar("dim_in_I22"));
  SET_STRING_ELT(state_names, 609, mkChar("dim_in_I22_1"));
  SET_STRING_ELT(state_names, 610, mkChar("dim_in_I22_2"));
  SET_STRING_ELT(state_names, 611, mkChar("in_I22"));
  SET_STRING_ELT(state_names, 612, mkChar("dim_in_I23"));
  SET_STRING_ELT(state_names, 613, mkChar("dim_in_I23_1"));
  SET_STRING_ELT(state_names, 614, mkChar("dim_in_I23_2"));
  SET_STRING_ELT(state_names, 615, mkChar("in_I23"));
  SET_STRING_ELT(state_names, 616, mkChar("dim_in_I24"));
  SET_STRING_ELT(state_names, 617, mkChar("dim_in_I24_1"));
  SET_STRING_ELT(state_names, 618, mkChar("dim_in_I24_2"));
  SET_STRING_ELT(state_names, 619, mkChar("in_I24"));
  SET_STRING_ELT(state_names, 620, mkChar("dim_in_I25"));
  SET_STRING_ELT(state_names, 621, mkChar("dim_in_I25_1"));
  SET_STRING_ELT(state_names, 622, mkChar("dim_in_I25_2"));
  SET_STRING_ELT(state_names, 623, mkChar("in_I25"));
  SET_STRING_ELT(state_names, 624, mkChar("dim_in_I32"));
  SET_STRING_ELT(state_names, 625, mkChar("dim_in_I32_1"));
  SET_STRING_ELT(state_names, 626, mkChar("dim_in_I32_2"));
  SET_STRING_ELT(state_names, 627, mkChar("in_I32"));
  SET_STRING_ELT(state_names, 628, mkChar("dim_in_I33"));
  SET_STRING_ELT(state_names, 629, mkChar("dim_in_I33_1"));
  SET_STRING_ELT(state_names, 630, mkChar("dim_in_I33_2"));
  SET_STRING_ELT(state_names, 631, mkChar("in_I33"));
  SET_STRING_ELT(state_names, 632, mkChar("dim_in_I34"));
  SET_STRING_ELT(state_names, 633, mkChar("dim_in_I34_1"));
  SET_STRING_ELT(state_names, 634, mkChar("dim_in_I34_2"));
  SET_STRING_ELT(state_names, 635, mkChar("in_I34"));
  SET_STRING_ELT(state_names, 636, mkChar("dim_in_I35"));
  SET_STRING_ELT(state_names, 637, mkChar("dim_in_I35_1"));
  SET_STRING_ELT(state_names, 638, mkChar("dim_in_I35_2"));
  SET_STRING_ELT(state_names, 639, mkChar("in_I35"));
  SET_STRING_ELT(state_names, 640, mkChar("dim_in_I42"));
  SET_STRING_ELT(state_names, 641, mkChar("dim_in_I42_1"));
  SET_STRING_ELT(state_names, 642, mkChar("dim_in_I42_2"));
  SET_STRING_ELT(state_names, 643, mkChar("in_I42"));
  SET_STRING_ELT(state_names, 644, mkChar("dim_in_I43"));
  SET_STRING_ELT(state_names, 645, mkChar("dim_in_I43_1"));
  SET_STRING_ELT(state_names, 646, mkChar("dim_in_I43_2"));
  SET_STRING_ELT(state_names, 647, mkChar("in_I43"));
  SET_STRING_ELT(state_names, 648, mkChar("dim_in_I44"));
  SET_STRING_ELT(state_names, 649, mkChar("dim_in_I44_1"));
  SET_STRING_ELT(state_names, 650, mkChar("dim_in_I44_2"));
  SET_STRING_ELT(state_names, 651, mkChar("in_I44"));
  SET_STRING_ELT(state_names, 652, mkChar("dim_in_I45"));
  SET_STRING_ELT(state_names, 653, mkChar("dim_in_I45_1"));
  SET_STRING_ELT(state_names, 654, mkChar("dim_in_I45_2"));
  SET_STRING_ELT(state_names, 655, mkChar("in_I45"));
  SET_STRING_ELT(state_names, 656, mkChar("dim_rate_move_in"));
  SET_STRING_ELT(state_names, 657, mkChar("dim_rate_move_in_1"));
  SET_STRING_ELT(state_names, 658, mkChar("dim_rate_move_in_2"));
  SET_STRING_ELT(state_names, 659, mkChar("rate_move_in"));
  SET_STRING_ELT(state_names, 660, mkChar("offset_output_rate_move_in"));
  SET_STRING_ELT(state_names, 661, mkChar("dim_rate_move_out"));
  SET_STRING_ELT(state_names, 662, mkChar("rate_move_out"));
  SET_STRING_ELT(state_names, 663, mkChar("offset_output_rate_move_out"));
  SET_STRING_ELT(state_names, 664, mkChar("interpolate_c_comm"));
  SET_STRING_ELT(state_names, 665, mkChar("interpolate_c_noncomm"));
  SET_STRING_ELT(state_names, 666, mkChar("interpolate_ART_eligible_CD4_above_500"));
  SET_STRING_ELT(state_names, 667, mkChar("ART_eligible_CD4_above_500"));
  SET_STRING_ELT(state_names, 668, mkChar("interpolate_ART_eligible_CD4_350_500"));
  SET_STRING_ELT(state_names, 669, mkChar("ART_eligible_CD4_350_500"));
  SET_STRING_ELT(state_names, 670, mkChar("interpolate_ART_eligible_CD4_200_349"));
  SET_STRING_ELT(state_names, 671, mkChar("ART_eligible_CD4_200_349"));
  SET_STRING_ELT(state_names, 672, mkChar("interpolate_ART_eligible_CD4_below_200"));
  SET_STRING_ELT(state_names, 673, mkChar("ART_eligible_CD4_below_200"));
  SET_STRING_ELT(state_names, 674, mkChar("interpolate_testing_prob"));
  SET_STRING_ELT(state_names, 675, mkChar("interpolate_tau_intervention"));
  SET_STRING_ELT(state_names, 676, mkChar("interpolate_rho_intervention"));
  SET_STRING_ELT(state_names, 677, mkChar("interpolate_infect_ART"));
  SET_STRING_ELT(state_names, 678, mkChar("interpolate_epsilon"));
  SET_STRING_ELT(state_names, 679, mkChar("epsilon"));
  SET_STRING_ELT(state_names, 680, mkChar("interpolate_prep_intervention"));
  SET_STRING_ELT(state_names, 681, mkChar("interpolate_fc_comm"));
  SET_STRING_ELT(state_names, 682, mkChar("interpolate_fP_comm"));
  SET_STRING_ELT(state_names, 683, mkChar("interpolate_fc_noncomm"));
  SET_STRING_ELT(state_names, 684, mkChar("interpolate_fP_noncomm"));
  SET_STRING_ELT(state_names, 685, mkChar("interpolate_n_comm"));
  SET_STRING_ELT(state_names, 686, mkChar("interpolate_n_noncomm"));
  SET_STRING_ELT(state_names, 687, mkChar("dim"));
  SET_STRING_ELT(state_names, 688, mkChar("dim_output"));
...
SEXP main_model_variable_order(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  SEXP state_len = PROTECT(allocVector(VECSXP, 29));
  ...
  SET_VECTOR_ELT(state_len, 3, ScalarInteger(main_model_p->dim_cumuAllDeaths));
  SET_STRING_ELT(state_names, 3, mkChar("cumuAllDeaths"));
  SET_VECTOR_ELT(state_len, 4, ScalarInteger(main_model_p->dim_cumuInf));
  SET_STRING_ELT(state_names, 4, mkChar("cumuInf"));
  SET_VECTOR_ELT(state_len, 5, ScalarInteger(main_model_p->dim_OnPrEP));
  SET_STRING_ELT(state_names, 5, mkChar("OnPrEP"));
  SET_VECTOR_ELT(state_len, 6, ScalarInteger(main_model_p->dim_S0));
  SET_STRING_ELT(state_names, 6, mkChar("S0"));
  SET_VECTOR_ELT(state_len, 7, ScalarInteger(main_model_p->dim_S1a));
  SET_STRING_ELT(state_names, 7, mkChar("S1a"));
  SET_VECTOR_ELT(state_len, 8, ScalarInteger(main_model_p->dim_S1b));
  SET_STRING_ELT(state_names, 8, mkChar("S1b"));
  SET_VECTOR_ELT(state_len, 9, ScalarInteger(main_model_p->dim_S1c));
  SET_STRING_ELT(state_names, 9, mkChar("S1c"));
  SET_VECTOR_ELT(state_len, 10, ScalarInteger(main_model_p->dim_S1d));
  SET_STRING_ELT(state_names, 10, mkChar("S1d"));
  SET_VECTOR_ELT(state_len, 11, ScalarInteger(main_model_p->dim_I01));
  SET_STRING_ELT(state_names, 11, mkChar("I01"));
  SET_VECTOR_ELT(state_len, 12, ScalarInteger(main_model_p->dim_I11));
  SET_STRING_ELT(state_names, 12, mkChar("I11"));
  SET_VECTOR_ELT(state_len, 13, ScalarInteger(main_model_p->dim_I02));
  SET_STRING_ELT(state_names, 13, mkChar("I02"));
  SET_VECTOR_ELT(state_len, 14, ScalarInteger(main_model_p->dim_I03));
  SET_STRING_ELT(state_names, 14, mkChar("I03"));
  SET_VECTOR_ELT(state_len, 15, ScalarInteger(main_model_p->dim_I04));
  SET_STRING_ELT(state_names, 15, mkChar("I04"));
  SET_VECTOR_ELT(state_len, 16, ScalarInteger(main_model_p->dim_I05));
  SET_STRING_ELT(state_names, 16, mkChar("I05"));
  SET_VECTOR_ELT(state_len, 17, ScalarInteger(main_model_p->dim_I22));
  SET_STRING_ELT(state_names, 17, mkChar("I22"));
  SET_VECTOR_ELT(state_len, 18, ScalarInteger(main_model_p->dim_I23));
  SET_STRING_ELT(state_names, 18, mkChar("I23"));
  SET_VECTOR_ELT(state_len, 19, ScalarInteger(main_model_p->dim_I24));
  SET_STRING_ELT(state_names, 19, mkChar("I24"));
  SET_VECTOR_ELT(state_len, 20, ScalarInteger(main_model_p->dim_I25));
  SET_STRING_ELT(state_names, 20, mkChar("I25"));
  SET_VECTOR_ELT(state_len, 21, ScalarInteger(main_model_p->dim_I32));
  SET_STRING_ELT(state_names, 21, mkChar("I32"));
  SET_VECTOR_ELT(state_len, 22, ScalarInteger(main_model_p->dim_I33));
  SET_STRING_ELT(state_names, 22, mkChar("I33"));
  SET_VECTOR_ELT(state_len, 23, ScalarInteger(main_model_p->dim_I34));
  SET_STRING_ELT(state_names, 23, mkChar("I34"));
  SET_VECTOR_ELT(state_len, 24, ScalarInteger(main_model_p->dim_I35));
  SET_STRING_ELT(state_names, 24, mkChar("I35"));
  SET_VECTOR_ELT(state_len, 25, ScalarInteger(main_model_p->dim_I42));
  SET_STRING_ELT(state_names, 25, mkChar("I42"));
  SET_VECTOR_ELT(state_len, 26, ScalarInteger(main_model_p->dim_I43));
  SET_STRING_ELT(state_names, 26, mkChar("I43"));
  SET_VECTOR_ELT(state_len, 27, ScalarInteger(main_model_p->dim_I44));
  SET_STRING_ELT(state_names, 27, mkChar("I44"));
  SET_VECTOR_ELT(state_len, 28, ScalarInteger(main_model_p->dim_I45));
  SET_STRING_ELT(state_names, 28, mkChar("I45"));
