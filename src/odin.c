...
SEXP main_model_set_user(main_model_pars *main_model_p, SEXP user) {
  ...
  main_model_p->offset_output_infect_ART_y = 29;
  ...
  main_model_p->offset_output_infect_ART_t = 29 + main_model_p->dim_infect_ART_y;
...
void main_model_deriv(main_model_pars *main_model_p, double t, double *state, double *dstatedt, double *output) {
  ...
  if (output != NULL) {
    double *output_infect_ART_y = output + 29;
...
SEXP main_model_output_order(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  int *tmp;
  SEXP state_len = PROTECT(allocVector(VECSXP, 95));
  SEXP state_names = PROTECT(allocVector(STRSXP, 95));
  ...
  SET_VECTOR_ELT(state_len, 29, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 29));
  tmp[0] = main_model_p->dim_infect_ART_y_1;
  tmp[1] = main_model_p->dim_infect_ART_y_2;
  SET_STRING_ELT(state_names, 29, mkChar("infect_ART_y"));
  SET_VECTOR_ELT(state_len, 30, ScalarInteger(main_model_p->dim_infect_ART_t));
  SET_STRING_ELT(state_names, 30, mkChar("infect_ART_t"));
  SET_VECTOR_ELT(state_len, 31, ScalarInteger(main_model_p->dim_c_comm));
  SET_STRING_ELT(state_names, 31, mkChar("c_comm"));
  SET_VECTOR_ELT(state_len, 32, ScalarInteger(main_model_p->dim_c_noncomm));
  SET_STRING_ELT(state_names, 32, mkChar("c_noncomm"));
  SET_VECTOR_ELT(state_len, 33, ScalarInteger(main_model_p->dim_new_people_in_group));
  SET_STRING_ELT(state_names, 33, mkChar("new_people_in_group"));
  SET_VECTOR_ELT(state_len, 34, ScalarInteger(main_model_p->dim_testing_prob));
  SET_STRING_ELT(state_names, 34, mkChar("testing_prob"));
  SET_VECTOR_ELT(state_len, 35, ScalarInteger(main_model_p->dim_tau_intervention));
  SET_STRING_ELT(state_names, 35, mkChar("tau_intervention"));
  SET_VECTOR_ELT(state_len, 36, ScalarInteger(main_model_p->dim_rho_intervention));
  SET_STRING_ELT(state_names, 36, mkChar("rho_intervention"));
  SET_VECTOR_ELT(state_len, 37, ScalarInteger(main_model_p->dim_zeta));
  SET_STRING_ELT(state_names, 37, mkChar("zeta"));
  SET_VECTOR_ELT(state_len, 38, ScalarInteger(main_model_p->dim_tau));
  SET_STRING_ELT(state_names, 38, mkChar("tau"));
  SET_VECTOR_ELT(state_len, 39, ScalarInteger(main_model_p->dim_rho));
  SET_STRING_ELT(state_names, 39, mkChar("rho"));
  SET_VECTOR_ELT(state_len, 40, ScalarInteger(main_model_p->dim_iota));
  SET_STRING_ELT(state_names, 40, mkChar("iota"));
  SET_VECTOR_ELT(state_len, 41, ScalarInteger(main_model_p->dim_frac_F));
  SET_STRING_ELT(state_names, 41, mkChar("frac_F"));
  SET_VECTOR_ELT(state_len, 42, ScalarInteger(main_model_p->dim_frac_N_sexualpop));
  SET_STRING_ELT(state_names, 42, mkChar("frac_N_sexualpop"));
  SET_VECTOR_ELT(state_len, 43, ScalarInteger(main_model_p->dim_infect_ART));
  SET_STRING_ELT(state_names, 43, mkChar("infect_ART"));
  SET_VECTOR_ELT(state_len, 44, ScalarInteger(main_model_p->dim_omega));
  SET_STRING_ELT(state_names, 44, mkChar("omega"));
  SET_VECTOR_ELT(state_len, 45, ScalarInteger(main_model_p->dim_frac_N));
  SET_STRING_ELT(state_names, 45, mkChar("frac_N"));
  SET_VECTOR_ELT(state_len, 46, ScalarInteger(main_model_p->dim_mu));
  SET_STRING_ELT(state_names, 46, mkChar("mu"));
  SET_VECTOR_ELT(state_len, 47, ScalarInteger(main_model_p->dim_gamma01));
  SET_STRING_ELT(state_names, 47, mkChar("gamma01"));
  SET_VECTOR_ELT(state_len, 48, ScalarInteger(main_model_p->dim_gamma11));
  SET_STRING_ELT(state_names, 48, mkChar("gamma11"));
  SET_VECTOR_ELT(state_len, 49, ScalarInteger(main_model_p->dim_kappaa));
  SET_STRING_ELT(state_names, 49, mkChar("kappaa"));
  SET_VECTOR_ELT(state_len, 50, ScalarInteger(main_model_p->dim_kappab));
  SET_STRING_ELT(state_names, 50, mkChar("kappab"));
  SET_VECTOR_ELT(state_len, 51, ScalarInteger(main_model_p->dim_kappac));
  SET_STRING_ELT(state_names, 51, mkChar("kappac"));
  SET_VECTOR_ELT(state_len, 52, ScalarInteger(main_model_p->dim_kappa1));
  SET_STRING_ELT(state_names, 52, mkChar("kappa1"));
  SET_VECTOR_ELT(state_len, 53, ScalarInteger(main_model_p->dim_alpha01));
  SET_STRING_ELT(state_names, 53, mkChar("alpha01"));
  SET_VECTOR_ELT(state_len, 54, ScalarInteger(main_model_p->dim_alpha02));
  SET_STRING_ELT(state_names, 54, mkChar("alpha02"));
  SET_VECTOR_ELT(state_len, 55, ScalarInteger(main_model_p->dim_alpha05));
  SET_STRING_ELT(state_names, 55, mkChar("alpha05"));
  SET_VECTOR_ELT(state_len, 56, ScalarInteger(main_model_p->dim_alpha11));
  SET_STRING_ELT(state_names, 56, mkChar("alpha11"));
  SET_VECTOR_ELT(state_len, 57, ScalarInteger(main_model_p->dim_alpha22));
  SET_STRING_ELT(state_names, 57, mkChar("alpha22"));
  SET_VECTOR_ELT(state_len, 58, ScalarInteger(main_model_p->dim_alpha35));
  SET_STRING_ELT(state_names, 58, mkChar("alpha35"));
  SET_VECTOR_ELT(state_len, 59, ScalarInteger(main_model_p->dim_beta_comm));
  SET_STRING_ELT(state_names, 59, mkChar("beta_comm"));
  SET_VECTOR_ELT(state_len, 60, ScalarInteger(main_model_p->dim_beta_noncomm));
  SET_STRING_ELT(state_names, 60, mkChar("beta_noncomm"));
  ...
  SET_STRING_ELT(state_names, 61, mkChar("p_comm"));
  ...
  SET_STRING_ELT(state_names, 62, mkChar("p_noncomm"));
  ...
  SET_STRING_ELT(state_names, 63, mkChar("fc_comm"));
  SET_VECTOR_ELT(state_len, 64, ScalarInteger(main_model_p->dim_fP_comm));
  SET_STRING_ELT(state_names, 64, mkChar("fP_comm"));
  ...
  SET_STRING_ELT(state_names, 65, mkChar("fc_noncomm"));
  SET_VECTOR_ELT(state_len, 66, ScalarInteger(main_model_p->dim_fP_noncomm));
  SET_STRING_ELT(state_names, 66, mkChar("fP_noncomm"));
  ...
  SET_STRING_ELT(state_names, 67, mkChar("n_comm"));
  ...
  SET_STRING_ELT(state_names, 68, mkChar("n_noncomm"));
  SET_VECTOR_ELT(state_len, 69, ScalarInteger(main_model_p->dim_N));
  SET_STRING_ELT(state_names, 69, mkChar("N"));
  SET_VECTOR_ELT(state_len, 70, ScalarInteger(main_model_p->dim_E0));
  SET_STRING_ELT(state_names, 70, mkChar("E0"));
  SET_VECTOR_ELT(state_len, 71, ScalarInteger(main_model_p->dim_E1a));
  SET_STRING_ELT(state_names, 71, mkChar("E1a"));
  SET_VECTOR_ELT(state_len, 72, ScalarInteger(main_model_p->dim_E1b));
  SET_STRING_ELT(state_names, 72, mkChar("E1b"));
  SET_VECTOR_ELT(state_len, 73, ScalarInteger(main_model_p->dim_E1c));
  SET_STRING_ELT(state_names, 73, mkChar("E1c"));
  SET_VECTOR_ELT(state_len, 74, ScalarInteger(main_model_p->dim_E1d));
  SET_STRING_ELT(state_names, 74, mkChar("E1d"));
  SET_VECTOR_ELT(state_len, 75, ScalarInteger(main_model_p->dim_alphaItot));
  SET_STRING_ELT(state_names, 75, mkChar("alphaItot"));
  SET_VECTOR_ELT(state_len, 76, ScalarInteger(main_model_p->dim_prev));
  SET_STRING_ELT(state_names, 76, mkChar("prev"));
  ...
  SET_STRING_ELT(state_names, 77, mkChar("lambda"));
  SET_VECTOR_ELT(state_len, 78, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 78));
  tmp[0] = main_model_p->dim_lambda_0_1;
  tmp[1] = main_model_p->dim_lambda_0_2;
  SET_STRING_ELT(state_names, 78, mkChar("lambda_0"));
  ...
  SET_STRING_ELT(state_names, 79, mkChar("lambda_1a"));
  ...
  SET_STRING_ELT(state_names, 80, mkChar("lambda_1b"));
  ...
  SET_STRING_ELT(state_names, 81, mkChar("lambda_1c"));
  ...
  SET_STRING_ELT(state_names, 82, mkChar("lambda_1d"));
  SET_VECTOR_ELT(state_len, 83, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_STRING_ELT(state_names, 83, mkChar("lambda_sum_0"));
  SET_VECTOR_ELT(state_len, 84, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_STRING_ELT(state_names, 84, mkChar("lambda_sum_1a"));
  SET_VECTOR_ELT(state_len, 85, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_STRING_ELT(state_names, 85, mkChar("lambda_sum_1b"));
  SET_VECTOR_ELT(state_len, 86, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_STRING_ELT(state_names, 86, mkChar("lambda_sum_1c"));
  SET_VECTOR_ELT(state_len, 87, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_STRING_ELT(state_names, 87, mkChar("lambda_sum_1d"));
  SET_VECTOR_ELT(state_len, 88, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_STRING_ELT(state_names, 88, mkChar("c_comm_balanced"));
  SET_VECTOR_ELT(state_len, 89, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_STRING_ELT(state_names, 89, mkChar("c_noncomm_balanced"));
  ...
  SET_STRING_ELT(state_names, 90, mkChar("theta"));
  ...
  SET_STRING_ELT(state_names, 91, mkChar("M_comm"));
  ...
  SET_STRING_ELT(state_names, 92, mkChar("M_noncomm"));
  ...
  SET_STRING_ELT(state_names, 93, mkChar("rate_move_in"));
  SET_VECTOR_ELT(state_len, 94, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_STRING_ELT(state_names, 94, mkChar("rate_move_out"));
  setAttrib(state_len, R_NamesSymbol, state_names);
  UNPROTECT(2);
  return state_len;
}
