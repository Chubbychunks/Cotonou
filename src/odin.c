...
SEXP main_model_set_user(main_model_pars *main_model_p, SEXP user) {
  ...
  main_model_p->offset_output_c_comm = 26;
  ...
  main_model_p->offset_output_c_noncomm = 26 + main_model_p->dim_c_comm;
...
void main_model_deriv(main_model_pars *main_model_p, double t, double *state, double *dstatedt, double *output) {
  ...
  if (output != NULL) {
    double *output_c_comm = output + 26;
...
SEXP main_model_contents(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  SEXP state = PROTECT(allocVector(VECSXP, 667));
  ...
  SET_VECTOR_ELT(state, 27, ScalarReal(main_model_p->PrEPOnOff));
  SET_VECTOR_ELT(state, 28, ScalarReal(main_model_p->fPa));
  SET_VECTOR_ELT(state, 29, ScalarReal(main_model_p->fPb));
  SET_VECTOR_ELT(state, 30, ScalarReal(main_model_p->fPc));
  SET_VECTOR_ELT(state, 31, ScalarReal(main_model_p->RR_test_onPrEP));
  SET_VECTOR_ELT(state, 32, ScalarReal(main_model_p->RR_test_CD4200));
  SET_VECTOR_ELT(state, 33, ScalarReal(main_model_p->RR_ART_CD4200));
  SET_VECTOR_ELT(state, 34, ScalarInteger(main_model_p->Ncat));
  SET_VECTOR_ELT(state, 35, ScalarReal(main_model_p->Nage));
  SET_VECTOR_ELT(state, 36, ScalarReal(main_model_p->infect_ART));
  SET_VECTOR_ELT(state, 37, ScalarReal(main_model_p->infect_acute));
  SET_VECTOR_ELT(state, 38, ScalarReal(main_model_p->infect_AIDS));
  SET_VECTOR_ELT(state, 39, ScalarReal(main_model_p->nu));
  SET_VECTOR_ELT(state, 40, ScalarReal(main_model_p->R));
  SET_VECTOR_ELT(state, 41, ScalarInteger(main_model_p->dim_epsilon_t));
  SET_VECTOR_ELT(state, 42, allocVector(REALSXP, main_model_p->dim_epsilon_t));
  memcpy(REAL(VECTOR_ELT(state, 42)), main_model_p->epsilon_t, main_model_p->dim_epsilon_t * sizeof(double));
  SET_VECTOR_ELT(state, 43, ScalarInteger(main_model_p->dim_epsilon_y));
  SET_VECTOR_ELT(state, 44, allocVector(REALSXP, main_model_p->dim_epsilon_y));
  memcpy(REAL(VECTOR_ELT(state, 44)), main_model_p->epsilon_y, main_model_p->dim_epsilon_y * sizeof(double));
  SET_VECTOR_ELT(state, 45, ScalarInteger(main_model_p->dim_fc_t_comm));
  SET_VECTOR_ELT(state, 46, allocVector(REALSXP, main_model_p->dim_fc_t_comm));
  memcpy(REAL(VECTOR_ELT(state, 46)), main_model_p->fc_t_comm, main_model_p->dim_fc_t_comm * sizeof(double));
  SET_VECTOR_ELT(state, 47, ScalarInteger(main_model_p->dim_fc_y_comm));
  SET_VECTOR_ELT(state, 48, ScalarInteger(main_model_p->dim_fc_y_comm_1));
  SET_VECTOR_ELT(state, 49, ScalarInteger(main_model_p->dim_fc_y_comm_2));
  SET_VECTOR_ELT(state, 50, ScalarInteger(main_model_p->dim_fc_y_comm_3));
  SET_VECTOR_ELT(state, 51, ScalarInteger(main_model_p->dim_fc_y_comm_12));
  SET_VECTOR_ELT(state, 52, allocVector(REALSXP, main_model_p->dim_fc_y_comm));
  memcpy(REAL(VECTOR_ELT(state, 52)), main_model_p->fc_y_comm, main_model_p->dim_fc_y_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 52), 3, main_model_p->dim_fc_y_comm_1, main_model_p->dim_fc_y_comm_2, main_model_p->dim_fc_y_comm_3);
  SET_VECTOR_ELT(state, 53, ScalarInteger(main_model_p->dim_fP_t_comm));
  SET_VECTOR_ELT(state, 54, allocVector(REALSXP, main_model_p->dim_fP_t_comm));
  memcpy(REAL(VECTOR_ELT(state, 54)), main_model_p->fP_t_comm, main_model_p->dim_fP_t_comm * sizeof(double));
  SET_VECTOR_ELT(state, 55, ScalarInteger(main_model_p->dim_fP_y_comm));
  SET_VECTOR_ELT(state, 56, ScalarInteger(main_model_p->dim_fP_y_comm_1));
  SET_VECTOR_ELT(state, 57, ScalarInteger(main_model_p->dim_fP_y_comm_2));
  SET_VECTOR_ELT(state, 58, allocVector(REALSXP, main_model_p->dim_fP_y_comm));
  memcpy(REAL(VECTOR_ELT(state, 58)), main_model_p->fP_y_comm, main_model_p->dim_fP_y_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 58), 2, main_model_p->dim_fP_y_comm_1, main_model_p->dim_fP_y_comm_2);
  SET_VECTOR_ELT(state, 59, ScalarInteger(main_model_p->dim_fc_t_noncomm));
  SET_VECTOR_ELT(state, 60, allocVector(REALSXP, main_model_p->dim_fc_t_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 60)), main_model_p->fc_t_noncomm, main_model_p->dim_fc_t_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 61, ScalarInteger(main_model_p->dim_fc_y_noncomm));
  SET_VECTOR_ELT(state, 62, ScalarInteger(main_model_p->dim_fc_y_noncomm_1));
  SET_VECTOR_ELT(state, 63, ScalarInteger(main_model_p->dim_fc_y_noncomm_2));
  SET_VECTOR_ELT(state, 64, ScalarInteger(main_model_p->dim_fc_y_noncomm_3));
  SET_VECTOR_ELT(state, 65, ScalarInteger(main_model_p->dim_fc_y_noncomm_12));
  SET_VECTOR_ELT(state, 66, allocVector(REALSXP, main_model_p->dim_fc_y_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 66)), main_model_p->fc_y_noncomm, main_model_p->dim_fc_y_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 66), 3, main_model_p->dim_fc_y_noncomm_1, main_model_p->dim_fc_y_noncomm_2, main_model_p->dim_fc_y_noncomm_3);
  SET_VECTOR_ELT(state, 67, ScalarInteger(main_model_p->dim_fP_t_noncomm));
  SET_VECTOR_ELT(state, 68, allocVector(REALSXP, main_model_p->dim_fP_t_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 68)), main_model_p->fP_t_noncomm, main_model_p->dim_fP_t_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 69, ScalarInteger(main_model_p->dim_fP_y_noncomm));
  SET_VECTOR_ELT(state, 70, ScalarInteger(main_model_p->dim_fP_y_noncomm_1));
  SET_VECTOR_ELT(state, 71, ScalarInteger(main_model_p->dim_fP_y_noncomm_2));
  SET_VECTOR_ELT(state, 72, allocVector(REALSXP, main_model_p->dim_fP_y_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 72)), main_model_p->fP_y_noncomm, main_model_p->dim_fP_y_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 72), 2, main_model_p->dim_fP_y_noncomm_1, main_model_p->dim_fP_y_noncomm_2);
  SET_VECTOR_ELT(state, 73, ScalarInteger(main_model_p->dim_n_t_comm));
  SET_VECTOR_ELT(state, 74, allocVector(REALSXP, main_model_p->dim_n_t_comm));
  memcpy(REAL(VECTOR_ELT(state, 74)), main_model_p->n_t_comm, main_model_p->dim_n_t_comm * sizeof(double));
  SET_VECTOR_ELT(state, 75, ScalarInteger(main_model_p->dim_n_y_comm));
  SET_VECTOR_ELT(state, 76, ScalarInteger(main_model_p->dim_n_y_comm_1));
  SET_VECTOR_ELT(state, 77, ScalarInteger(main_model_p->dim_n_y_comm_2));
  SET_VECTOR_ELT(state, 78, ScalarInteger(main_model_p->dim_n_y_comm_3));
  SET_VECTOR_ELT(state, 79, ScalarInteger(main_model_p->dim_n_y_comm_12));
  SET_VECTOR_ELT(state, 80, allocVector(REALSXP, main_model_p->dim_n_y_comm));
  memcpy(REAL(VECTOR_ELT(state, 80)), main_model_p->n_y_comm, main_model_p->dim_n_y_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 80), 3, main_model_p->dim_n_y_comm_1, main_model_p->dim_n_y_comm_2, main_model_p->dim_n_y_comm_3);
  SET_VECTOR_ELT(state, 81, ScalarInteger(main_model_p->dim_n_t_noncomm));
  SET_VECTOR_ELT(state, 82, allocVector(REALSXP, main_model_p->dim_n_t_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 82)), main_model_p->n_t_noncomm, main_model_p->dim_n_t_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 83, ScalarInteger(main_model_p->dim_n_y_noncomm));
  SET_VECTOR_ELT(state, 84, ScalarInteger(main_model_p->dim_n_y_noncomm_1));
  SET_VECTOR_ELT(state, 85, ScalarInteger(main_model_p->dim_n_y_noncomm_2));
  SET_VECTOR_ELT(state, 86, ScalarInteger(main_model_p->dim_n_y_noncomm_3));
  SET_VECTOR_ELT(state, 87, ScalarInteger(main_model_p->dim_n_y_noncomm_12));
  SET_VECTOR_ELT(state, 88, allocVector(REALSXP, main_model_p->dim_n_y_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 88)), main_model_p->n_y_noncomm, main_model_p->dim_n_y_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 88), 3, main_model_p->dim_n_y_noncomm_1, main_model_p->dim_n_y_noncomm_2, main_model_p->dim_n_y_noncomm_3);
  SET_VECTOR_ELT(state, 89, ScalarReal(main_model_p->dur_FSW));
  SET_VECTOR_ELT(state, 90, ScalarInteger(main_model_p->dim_zetaa_t));
  SET_VECTOR_ELT(state, 91, allocVector(REALSXP, main_model_p->dim_zetaa_t));
  memcpy(REAL(VECTOR_ELT(state, 91)), main_model_p->zetaa_t, main_model_p->dim_zetaa_t * sizeof(double));
  SET_VECTOR_ELT(state, 92, ScalarInteger(main_model_p->dim_zetab_t));
  SET_VECTOR_ELT(state, 93, allocVector(REALSXP, main_model_p->dim_zetab_t));
  memcpy(REAL(VECTOR_ELT(state, 93)), main_model_p->zetab_t, main_model_p->dim_zetab_t * sizeof(double));
  SET_VECTOR_ELT(state, 94, ScalarInteger(main_model_p->dim_zetac_t));
  SET_VECTOR_ELT(state, 95, allocVector(REALSXP, main_model_p->dim_zetac_t));
  memcpy(REAL(VECTOR_ELT(state, 95)), main_model_p->zetac_t, main_model_p->dim_zetac_t * sizeof(double));
  SET_VECTOR_ELT(state, 96, ScalarInteger(main_model_p->dim_zetaa_y));
  SET_VECTOR_ELT(state, 97, ScalarInteger(main_model_p->dim_zetaa_y_1));
  SET_VECTOR_ELT(state, 98, ScalarInteger(main_model_p->dim_zetaa_y_2));
  SET_VECTOR_ELT(state, 99, allocVector(REALSXP, main_model_p->dim_zetaa_y));
  memcpy(REAL(VECTOR_ELT(state, 99)), main_model_p->zetaa_y, main_model_p->dim_zetaa_y * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 99), 2, main_model_p->dim_zetaa_y_1, main_model_p->dim_zetaa_y_2);
  SET_VECTOR_ELT(state, 100, ScalarInteger(main_model_p->dim_zetab_y));
  SET_VECTOR_ELT(state, 101, ScalarInteger(main_model_p->dim_zetab_y_1));
  SET_VECTOR_ELT(state, 102, ScalarInteger(main_model_p->dim_zetab_y_2));
  SET_VECTOR_ELT(state, 103, allocVector(REALSXP, main_model_p->dim_zetab_y));
  memcpy(REAL(VECTOR_ELT(state, 103)), main_model_p->zetab_y, main_model_p->dim_zetab_y * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 103), 2, main_model_p->dim_zetab_y_1, main_model_p->dim_zetab_y_2);
  SET_VECTOR_ELT(state, 104, ScalarInteger(main_model_p->dim_zetac_y));
  SET_VECTOR_ELT(state, 105, ScalarInteger(main_model_p->dim_zetac_y_1));
  SET_VECTOR_ELT(state, 106, ScalarInteger(main_model_p->dim_zetac_y_2));
  SET_VECTOR_ELT(state, 107, allocVector(REALSXP, main_model_p->dim_zetac_y));
  memcpy(REAL(VECTOR_ELT(state, 107)), main_model_p->zetac_y, main_model_p->dim_zetac_y * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 107), 2, main_model_p->dim_zetac_y_1, main_model_p->dim_zetac_y_2);
  SET_VECTOR_ELT(state, 108, ScalarInteger(main_model_p->dim_prep_intervention_t));
  SET_VECTOR_ELT(state, 109, allocVector(REALSXP, main_model_p->dim_prep_intervention_t));
  memcpy(REAL(VECTOR_ELT(state, 109)), main_model_p->prep_intervention_t, main_model_p->dim_prep_intervention_t * sizeof(double));
  SET_VECTOR_ELT(state, 110, ScalarInteger(main_model_p->dim_prep_intervention_y));
  SET_VECTOR_ELT(state, 111, ScalarInteger(main_model_p->dim_prep_intervention_y_1));
  SET_VECTOR_ELT(state, 112, ScalarInteger(main_model_p->dim_prep_intervention_y_2));
  SET_VECTOR_ELT(state, 113, allocVector(REALSXP, main_model_p->dim_prep_intervention_y));
  memcpy(REAL(VECTOR_ELT(state, 113)), main_model_p->prep_intervention_y, main_model_p->dim_prep_intervention_y * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 113), 2, main_model_p->dim_prep_intervention_y_1, main_model_p->dim_prep_intervention_y_2);
  SET_VECTOR_ELT(state, 114, ScalarInteger(main_model_p->dim_c_comm));
  SET_VECTOR_ELT(state, 115, allocVector(REALSXP, main_model_p->dim_c_comm));
  memcpy(REAL(VECTOR_ELT(state, 115)), main_model_p->c_comm, main_model_p->dim_c_comm * sizeof(double));
  SET_VECTOR_ELT(state, 116, ScalarInteger(main_model_p->offset_output_c_comm));
  SET_VECTOR_ELT(state, 117, ScalarInteger(main_model_p->dim_c_noncomm));
  SET_VECTOR_ELT(state, 118, allocVector(REALSXP, main_model_p->dim_c_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 118)), main_model_p->c_noncomm, main_model_p->dim_c_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 119, ScalarInteger(main_model_p->offset_output_c_noncomm));
  SET_VECTOR_ELT(state, 120, ScalarInteger(main_model_p->dim_new_people_in_group));
  SET_VECTOR_ELT(state, 121, allocVector(REALSXP, main_model_p->dim_new_people_in_group));
  memcpy(REAL(VECTOR_ELT(state, 121)), main_model_p->new_people_in_group, main_model_p->dim_new_people_in_group * sizeof(double));
  SET_VECTOR_ELT(state, 122, ScalarInteger(main_model_p->offset_output_new_people_in_group));
  SET_VECTOR_ELT(state, 123, ScalarInteger(main_model_p->dim_comm_partnerships_requested));
  SET_VECTOR_ELT(state, 124, ScalarInteger(main_model_p->dim_comm_partnerships_requested_1));
  SET_VECTOR_ELT(state, 125, ScalarInteger(main_model_p->dim_comm_partnerships_requested_2));
  SET_VECTOR_ELT(state, 126, allocVector(REALSXP, main_model_p->dim_comm_partnerships_requested));
  memcpy(REAL(VECTOR_ELT(state, 126)), main_model_p->comm_partnerships_requested, main_model_p->dim_comm_partnerships_requested * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 126), 2, main_model_p->dim_comm_partnerships_requested_1, main_model_p->dim_comm_partnerships_requested_2);
  SET_VECTOR_ELT(state, 127, ScalarInteger(main_model_p->dim_noncomm_partnerships_requested));
  SET_VECTOR_ELT(state, 128, ScalarInteger(main_model_p->dim_noncomm_partnerships_requested_1));
  SET_VECTOR_ELT(state, 129, ScalarInteger(main_model_p->dim_noncomm_partnerships_requested_2));
  SET_VECTOR_ELT(state, 130, allocVector(REALSXP, main_model_p->dim_noncomm_partnerships_requested));
  memcpy(REAL(VECTOR_ELT(state, 130)), main_model_p->noncomm_partnerships_requested, main_model_p->dim_noncomm_partnerships_requested * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 130), 2, main_model_p->dim_noncomm_partnerships_requested_1, main_model_p->dim_noncomm_partnerships_requested_2);
  SET_VECTOR_ELT(state, 131, ScalarInteger(main_model_p->dim_testing_prob));
  SET_VECTOR_ELT(state, 132, allocVector(REALSXP, main_model_p->dim_testing_prob));
  memcpy(REAL(VECTOR_ELT(state, 132)), main_model_p->testing_prob, main_model_p->dim_testing_prob * sizeof(double));
  SET_VECTOR_ELT(state, 133, ScalarInteger(main_model_p->offset_output_testing_prob));
  SET_VECTOR_ELT(state, 134, ScalarInteger(main_model_p->dim_ART_prob));
  SET_VECTOR_ELT(state, 135, allocVector(REALSXP, main_model_p->dim_ART_prob));
  memcpy(REAL(VECTOR_ELT(state, 135)), main_model_p->ART_prob, main_model_p->dim_ART_prob * sizeof(double));
  SET_VECTOR_ELT(state, 136, ScalarInteger(main_model_p->offset_output_ART_prob));
  SET_VECTOR_ELT(state, 137, ScalarInteger(main_model_p->dim_zeta));
  SET_VECTOR_ELT(state, 138, allocVector(REALSXP, main_model_p->dim_zeta));
  memcpy(REAL(VECTOR_ELT(state, 138)), main_model_p->zeta, main_model_p->dim_zeta * sizeof(double));
  SET_VECTOR_ELT(state, 139, ScalarInteger(main_model_p->offset_output_zeta));
  SET_VECTOR_ELT(state, 140, ScalarInteger(main_model_p->dim_sigma));
  SET_VECTOR_ELT(state, 141, allocVector(REALSXP, main_model_p->dim_sigma));
  memcpy(REAL(VECTOR_ELT(state, 141)), main_model_p->sigma, main_model_p->dim_sigma * sizeof(double));
  SET_VECTOR_ELT(state, 142, ScalarInteger(main_model_p->dim_tau));
  SET_VECTOR_ELT(state, 143, allocVector(REALSXP, main_model_p->dim_tau));
  memcpy(REAL(VECTOR_ELT(state, 143)), main_model_p->tau, main_model_p->dim_tau * sizeof(double));
  SET_VECTOR_ELT(state, 144, ScalarInteger(main_model_p->offset_output_tau));
  SET_VECTOR_ELT(state, 145, ScalarInteger(main_model_p->dim_test_rate_prep));
  SET_VECTOR_ELT(state, 146, allocVector(REALSXP, main_model_p->dim_test_rate_prep));
  memcpy(REAL(VECTOR_ELT(state, 146)), main_model_p->test_rate_prep, main_model_p->dim_test_rate_prep * sizeof(double));
  SET_VECTOR_ELT(state, 147, ScalarInteger(main_model_p->dim_rho));
  SET_VECTOR_ELT(state, 148, allocVector(REALSXP, main_model_p->dim_rho));
  memcpy(REAL(VECTOR_ELT(state, 148)), main_model_p->rho, main_model_p->dim_rho * sizeof(double));
  SET_VECTOR_ELT(state, 149, ScalarInteger(main_model_p->offset_output_rho));
  SET_VECTOR_ELT(state, 150, ScalarInteger(main_model_p->dim_iota));
  SET_VECTOR_ELT(state, 151, allocVector(REALSXP, main_model_p->dim_iota));
  memcpy(REAL(VECTOR_ELT(state, 151)), main_model_p->iota, main_model_p->dim_iota * sizeof(double));
  SET_VECTOR_ELT(state, 152, ScalarInteger(main_model_p->offset_output_iota));
  SET_VECTOR_ELT(state, 153, ScalarInteger(main_model_p->dim_frac_F));
  SET_VECTOR_ELT(state, 154, allocVector(REALSXP, main_model_p->dim_frac_F));
  memcpy(REAL(VECTOR_ELT(state, 154)), main_model_p->frac_F, main_model_p->dim_frac_F * sizeof(double));
  SET_VECTOR_ELT(state, 155, ScalarInteger(main_model_p->offset_output_frac_F));
  SET_VECTOR_ELT(state, 156, ScalarInteger(main_model_p->dim_frac_N_sexualpop));
  SET_VECTOR_ELT(state, 157, allocVector(REALSXP, main_model_p->dim_frac_N_sexualpop));
  memcpy(REAL(VECTOR_ELT(state, 157)), main_model_p->frac_N_sexualpop, main_model_p->dim_frac_N_sexualpop * sizeof(double));
  SET_VECTOR_ELT(state, 158, ScalarInteger(main_model_p->offset_output_frac_N_sexualpop));
  SET_VECTOR_ELT(state, 159, ScalarInteger(main_model_p->dim_zetaa));
  SET_VECTOR_ELT(state, 160, allocVector(REALSXP, main_model_p->dim_zetaa));
  memcpy(REAL(VECTOR_ELT(state, 160)), main_model_p->zetaa, main_model_p->dim_zetaa * sizeof(double));
  SET_VECTOR_ELT(state, 161, ScalarInteger(main_model_p->offset_output_zetaa));
  SET_VECTOR_ELT(state, 162, ScalarInteger(main_model_p->dim_zetab));
  SET_VECTOR_ELT(state, 163, allocVector(REALSXP, main_model_p->dim_zetab));
  memcpy(REAL(VECTOR_ELT(state, 163)), main_model_p->zetab, main_model_p->dim_zetab * sizeof(double));
  SET_VECTOR_ELT(state, 164, ScalarInteger(main_model_p->offset_output_zetab));
  SET_VECTOR_ELT(state, 165, ScalarInteger(main_model_p->dim_zetac));
  SET_VECTOR_ELT(state, 166, allocVector(REALSXP, main_model_p->dim_zetac));
  memcpy(REAL(VECTOR_ELT(state, 166)), main_model_p->zetac, main_model_p->dim_zetac * sizeof(double));
  SET_VECTOR_ELT(state, 167, ScalarInteger(main_model_p->offset_output_zetac));
  SET_VECTOR_ELT(state, 168, ScalarInteger(main_model_p->dim_prep_intervention));
  SET_VECTOR_ELT(state, 169, allocVector(REALSXP, main_model_p->dim_prep_intervention));
  memcpy(REAL(VECTOR_ELT(state, 169)), main_model_p->prep_intervention, main_model_p->dim_prep_intervention * sizeof(double));
  SET_VECTOR_ELT(state, 170, ScalarInteger(main_model_p->dim_omega));
  SET_VECTOR_ELT(state, 171, allocVector(REALSXP, main_model_p->dim_omega));
  memcpy(REAL(VECTOR_ELT(state, 171)), main_model_p->omega, main_model_p->dim_omega * sizeof(double));
  SET_VECTOR_ELT(state, 172, ScalarInteger(main_model_p->offset_output_omega));
  SET_VECTOR_ELT(state, 173, ScalarInteger(main_model_p->dim_frac_N));
  SET_VECTOR_ELT(state, 174, allocVector(REALSXP, main_model_p->dim_frac_N));
  memcpy(REAL(VECTOR_ELT(state, 174)), main_model_p->frac_N, main_model_p->dim_frac_N * sizeof(double));
  SET_VECTOR_ELT(state, 175, ScalarInteger(main_model_p->offset_output_frac_N));
  SET_VECTOR_ELT(state, 176, ScalarInteger(main_model_p->dim_mu));
  SET_VECTOR_ELT(state, 177, allocVector(REALSXP, main_model_p->dim_mu));
  memcpy(REAL(VECTOR_ELT(state, 177)), main_model_p->mu, main_model_p->dim_mu * sizeof(double));
  SET_VECTOR_ELT(state, 178, ScalarInteger(main_model_p->offset_output_mu));
  SET_VECTOR_ELT(state, 179, ScalarInteger(main_model_p->dim_gamma01));
  SET_VECTOR_ELT(state, 180, allocVector(REALSXP, main_model_p->dim_gamma01));
  memcpy(REAL(VECTOR_ELT(state, 180)), main_model_p->gamma01, main_model_p->dim_gamma01 * sizeof(double));
  SET_VECTOR_ELT(state, 181, ScalarInteger(main_model_p->offset_output_gamma01));
  SET_VECTOR_ELT(state, 182, ScalarInteger(main_model_p->dim_gamma02));
  SET_VECTOR_ELT(state, 183, allocVector(REALSXP, main_model_p->dim_gamma02));
  memcpy(REAL(VECTOR_ELT(state, 183)), main_model_p->gamma02, main_model_p->dim_gamma02 * sizeof(double));
  SET_VECTOR_ELT(state, 184, ScalarInteger(main_model_p->dim_gamma03));
  SET_VECTOR_ELT(state, 185, allocVector(REALSXP, main_model_p->dim_gamma03));
  memcpy(REAL(VECTOR_ELT(state, 185)), main_model_p->gamma03, main_model_p->dim_gamma03 * sizeof(double));
  SET_VECTOR_ELT(state, 186, ScalarInteger(main_model_p->dim_gamma04));
  SET_VECTOR_ELT(state, 187, allocVector(REALSXP, main_model_p->dim_gamma04));
  memcpy(REAL(VECTOR_ELT(state, 187)), main_model_p->gamma04, main_model_p->dim_gamma04 * sizeof(double));
  SET_VECTOR_ELT(state, 188, ScalarInteger(main_model_p->dim_gamma11));
  SET_VECTOR_ELT(state, 189, allocVector(REALSXP, main_model_p->dim_gamma11));
  memcpy(REAL(VECTOR_ELT(state, 189)), main_model_p->gamma11, main_model_p->dim_gamma11 * sizeof(double));
  SET_VECTOR_ELT(state, 190, ScalarInteger(main_model_p->offset_output_gamma11));
  SET_VECTOR_ELT(state, 191, ScalarInteger(main_model_p->dim_gamma22));
  SET_VECTOR_ELT(state, 192, allocVector(REALSXP, main_model_p->dim_gamma22));
  memcpy(REAL(VECTOR_ELT(state, 192)), main_model_p->gamma22, main_model_p->dim_gamma22 * sizeof(double));
  SET_VECTOR_ELT(state, 193, ScalarInteger(main_model_p->dim_gamma23));
  SET_VECTOR_ELT(state, 194, allocVector(REALSXP, main_model_p->dim_gamma23));
  memcpy(REAL(VECTOR_ELT(state, 194)), main_model_p->gamma23, main_model_p->dim_gamma23 * sizeof(double));
  SET_VECTOR_ELT(state, 195, ScalarInteger(main_model_p->dim_gamma24));
  SET_VECTOR_ELT(state, 196, allocVector(REALSXP, main_model_p->dim_gamma24));
  memcpy(REAL(VECTOR_ELT(state, 196)), main_model_p->gamma24, main_model_p->dim_gamma24 * sizeof(double));
  SET_VECTOR_ELT(state, 197, ScalarInteger(main_model_p->dim_gamma32));
  SET_VECTOR_ELT(state, 198, allocVector(REALSXP, main_model_p->dim_gamma32));
  memcpy(REAL(VECTOR_ELT(state, 198)), main_model_p->gamma32, main_model_p->dim_gamma32 * sizeof(double));
  SET_VECTOR_ELT(state, 199, ScalarInteger(main_model_p->dim_gamma33));
  SET_VECTOR_ELT(state, 200, allocVector(REALSXP, main_model_p->dim_gamma33));
  memcpy(REAL(VECTOR_ELT(state, 200)), main_model_p->gamma33, main_model_p->dim_gamma33 * sizeof(double));
  SET_VECTOR_ELT(state, 201, ScalarInteger(main_model_p->dim_gamma34));
  SET_VECTOR_ELT(state, 202, allocVector(REALSXP, main_model_p->dim_gamma34));
  memcpy(REAL(VECTOR_ELT(state, 202)), main_model_p->gamma34, main_model_p->dim_gamma34 * sizeof(double));
  SET_VECTOR_ELT(state, 203, ScalarInteger(main_model_p->dim_gamma42));
  SET_VECTOR_ELT(state, 204, allocVector(REALSXP, main_model_p->dim_gamma42));
  memcpy(REAL(VECTOR_ELT(state, 204)), main_model_p->gamma42, main_model_p->dim_gamma42 * sizeof(double));
  SET_VECTOR_ELT(state, 205, ScalarInteger(main_model_p->dim_gamma43));
  SET_VECTOR_ELT(state, 206, allocVector(REALSXP, main_model_p->dim_gamma43));
  memcpy(REAL(VECTOR_ELT(state, 206)), main_model_p->gamma43, main_model_p->dim_gamma43 * sizeof(double));
  SET_VECTOR_ELT(state, 207, ScalarInteger(main_model_p->dim_gamma44));
  SET_VECTOR_ELT(state, 208, allocVector(REALSXP, main_model_p->dim_gamma44));
  memcpy(REAL(VECTOR_ELT(state, 208)), main_model_p->gamma44, main_model_p->dim_gamma44 * sizeof(double));
  SET_VECTOR_ELT(state, 209, ScalarInteger(main_model_p->dim_phi2));
  SET_VECTOR_ELT(state, 210, allocVector(REALSXP, main_model_p->dim_phi2));
  memcpy(REAL(VECTOR_ELT(state, 210)), main_model_p->phi2, main_model_p->dim_phi2 * sizeof(double));
  SET_VECTOR_ELT(state, 211, ScalarInteger(main_model_p->dim_phi3));
  SET_VECTOR_ELT(state, 212, allocVector(REALSXP, main_model_p->dim_phi3));
  memcpy(REAL(VECTOR_ELT(state, 212)), main_model_p->phi3, main_model_p->dim_phi3 * sizeof(double));
  SET_VECTOR_ELT(state, 213, ScalarInteger(main_model_p->dim_phi4));
  SET_VECTOR_ELT(state, 214, allocVector(REALSXP, main_model_p->dim_phi4));
  memcpy(REAL(VECTOR_ELT(state, 214)), main_model_p->phi4, main_model_p->dim_phi4 * sizeof(double));
  SET_VECTOR_ELT(state, 215, ScalarInteger(main_model_p->dim_phi5));
  SET_VECTOR_ELT(state, 216, allocVector(REALSXP, main_model_p->dim_phi5));
  memcpy(REAL(VECTOR_ELT(state, 216)), main_model_p->phi5, main_model_p->dim_phi5 * sizeof(double));
  SET_VECTOR_ELT(state, 217, ScalarInteger(main_model_p->dim_psia));
  SET_VECTOR_ELT(state, 218, allocVector(REALSXP, main_model_p->dim_psia));
  memcpy(REAL(VECTOR_ELT(state, 218)), main_model_p->psia, main_model_p->dim_psia * sizeof(double));
  SET_VECTOR_ELT(state, 219, ScalarInteger(main_model_p->dim_psib));
  SET_VECTOR_ELT(state, 220, allocVector(REALSXP, main_model_p->dim_psib));
  memcpy(REAL(VECTOR_ELT(state, 220)), main_model_p->psib, main_model_p->dim_psib * sizeof(double));
  SET_VECTOR_ELT(state, 221, ScalarInteger(main_model_p->dim_kappaa));
  SET_VECTOR_ELT(state, 222, allocVector(REALSXP, main_model_p->dim_kappaa));
  memcpy(REAL(VECTOR_ELT(state, 222)), main_model_p->kappaa, main_model_p->dim_kappaa * sizeof(double));
  SET_VECTOR_ELT(state, 223, ScalarInteger(main_model_p->offset_output_kappaa));
  SET_VECTOR_ELT(state, 224, ScalarInteger(main_model_p->dim_kappab));
  SET_VECTOR_ELT(state, 225, allocVector(REALSXP, main_model_p->dim_kappab));
  memcpy(REAL(VECTOR_ELT(state, 225)), main_model_p->kappab, main_model_p->dim_kappab * sizeof(double));
  SET_VECTOR_ELT(state, 226, ScalarInteger(main_model_p->offset_output_kappab));
  SET_VECTOR_ELT(state, 227, ScalarInteger(main_model_p->dim_kappac));
  SET_VECTOR_ELT(state, 228, allocVector(REALSXP, main_model_p->dim_kappac));
  memcpy(REAL(VECTOR_ELT(state, 228)), main_model_p->kappac, main_model_p->dim_kappac * sizeof(double));
  SET_VECTOR_ELT(state, 229, ScalarInteger(main_model_p->offset_output_kappac));
  SET_VECTOR_ELT(state, 230, ScalarInteger(main_model_p->dim_kappa1));
  SET_VECTOR_ELT(state, 231, allocVector(REALSXP, main_model_p->dim_kappa1));
  memcpy(REAL(VECTOR_ELT(state, 231)), main_model_p->kappa1, main_model_p->dim_kappa1 * sizeof(double));
  SET_VECTOR_ELT(state, 232, ScalarInteger(main_model_p->offset_output_kappa1));
  SET_VECTOR_ELT(state, 233, ScalarInteger(main_model_p->dim_alpha01));
  SET_VECTOR_ELT(state, 234, allocVector(REALSXP, main_model_p->dim_alpha01));
  memcpy(REAL(VECTOR_ELT(state, 234)), main_model_p->alpha01, main_model_p->dim_alpha01 * sizeof(double));
  SET_VECTOR_ELT(state, 235, ScalarInteger(main_model_p->offset_output_alpha01));
  SET_VECTOR_ELT(state, 236, ScalarInteger(main_model_p->dim_alpha02));
  SET_VECTOR_ELT(state, 237, allocVector(REALSXP, main_model_p->dim_alpha02));
  memcpy(REAL(VECTOR_ELT(state, 237)), main_model_p->alpha02, main_model_p->dim_alpha02 * sizeof(double));
  SET_VECTOR_ELT(state, 238, ScalarInteger(main_model_p->offset_output_alpha02));
  SET_VECTOR_ELT(state, 239, ScalarInteger(main_model_p->dim_alpha03));
  SET_VECTOR_ELT(state, 240, allocVector(REALSXP, main_model_p->dim_alpha03));
  memcpy(REAL(VECTOR_ELT(state, 240)), main_model_p->alpha03, main_model_p->dim_alpha03 * sizeof(double));
  SET_VECTOR_ELT(state, 241, ScalarInteger(main_model_p->dim_alpha04));
  SET_VECTOR_ELT(state, 242, allocVector(REALSXP, main_model_p->dim_alpha04));
  memcpy(REAL(VECTOR_ELT(state, 242)), main_model_p->alpha04, main_model_p->dim_alpha04 * sizeof(double));
  SET_VECTOR_ELT(state, 243, ScalarInteger(main_model_p->dim_alpha05));
  SET_VECTOR_ELT(state, 244, allocVector(REALSXP, main_model_p->dim_alpha05));
  memcpy(REAL(VECTOR_ELT(state, 244)), main_model_p->alpha05, main_model_p->dim_alpha05 * sizeof(double));
  SET_VECTOR_ELT(state, 245, ScalarInteger(main_model_p->offset_output_alpha05));
  SET_VECTOR_ELT(state, 246, ScalarInteger(main_model_p->dim_alpha11));
  SET_VECTOR_ELT(state, 247, allocVector(REALSXP, main_model_p->dim_alpha11));
  memcpy(REAL(VECTOR_ELT(state, 247)), main_model_p->alpha11, main_model_p->dim_alpha11 * sizeof(double));
  SET_VECTOR_ELT(state, 248, ScalarInteger(main_model_p->offset_output_alpha11));
  SET_VECTOR_ELT(state, 249, ScalarInteger(main_model_p->dim_alpha22));
  SET_VECTOR_ELT(state, 250, allocVector(REALSXP, main_model_p->dim_alpha22));
  memcpy(REAL(VECTOR_ELT(state, 250)), main_model_p->alpha22, main_model_p->dim_alpha22 * sizeof(double));
  SET_VECTOR_ELT(state, 251, ScalarInteger(main_model_p->offset_output_alpha22));
  SET_VECTOR_ELT(state, 252, ScalarInteger(main_model_p->dim_alpha23));
  SET_VECTOR_ELT(state, 253, allocVector(REALSXP, main_model_p->dim_alpha23));
  memcpy(REAL(VECTOR_ELT(state, 253)), main_model_p->alpha23, main_model_p->dim_alpha23 * sizeof(double));
  SET_VECTOR_ELT(state, 254, ScalarInteger(main_model_p->dim_alpha24));
  SET_VECTOR_ELT(state, 255, allocVector(REALSXP, main_model_p->dim_alpha24));
  memcpy(REAL(VECTOR_ELT(state, 255)), main_model_p->alpha24, main_model_p->dim_alpha24 * sizeof(double));
  SET_VECTOR_ELT(state, 256, ScalarInteger(main_model_p->dim_alpha25));
  SET_VECTOR_ELT(state, 257, allocVector(REALSXP, main_model_p->dim_alpha25));
  memcpy(REAL(VECTOR_ELT(state, 257)), main_model_p->alpha25, main_model_p->dim_alpha25 * sizeof(double));
  SET_VECTOR_ELT(state, 258, ScalarInteger(main_model_p->dim_alpha32));
  SET_VECTOR_ELT(state, 259, allocVector(REALSXP, main_model_p->dim_alpha32));
  memcpy(REAL(VECTOR_ELT(state, 259)), main_model_p->alpha32, main_model_p->dim_alpha32 * sizeof(double));
  SET_VECTOR_ELT(state, 260, ScalarInteger(main_model_p->dim_alpha33));
  SET_VECTOR_ELT(state, 261, allocVector(REALSXP, main_model_p->dim_alpha33));
  memcpy(REAL(VECTOR_ELT(state, 261)), main_model_p->alpha33, main_model_p->dim_alpha33 * sizeof(double));
  SET_VECTOR_ELT(state, 262, ScalarInteger(main_model_p->dim_alpha34));
  SET_VECTOR_ELT(state, 263, allocVector(REALSXP, main_model_p->dim_alpha34));
  memcpy(REAL(VECTOR_ELT(state, 263)), main_model_p->alpha34, main_model_p->dim_alpha34 * sizeof(double));
  SET_VECTOR_ELT(state, 264, ScalarInteger(main_model_p->dim_alpha35));
  SET_VECTOR_ELT(state, 265, allocVector(REALSXP, main_model_p->dim_alpha35));
  memcpy(REAL(VECTOR_ELT(state, 265)), main_model_p->alpha35, main_model_p->dim_alpha35 * sizeof(double));
  SET_VECTOR_ELT(state, 266, ScalarInteger(main_model_p->offset_output_alpha35));
  SET_VECTOR_ELT(state, 267, ScalarInteger(main_model_p->dim_alpha42));
  SET_VECTOR_ELT(state, 268, allocVector(REALSXP, main_model_p->dim_alpha42));
  memcpy(REAL(VECTOR_ELT(state, 268)), main_model_p->alpha42, main_model_p->dim_alpha42 * sizeof(double));
  SET_VECTOR_ELT(state, 269, ScalarInteger(main_model_p->dim_alpha43));
  SET_VECTOR_ELT(state, 270, allocVector(REALSXP, main_model_p->dim_alpha43));
  memcpy(REAL(VECTOR_ELT(state, 270)), main_model_p->alpha43, main_model_p->dim_alpha43 * sizeof(double));
  SET_VECTOR_ELT(state, 271, ScalarInteger(main_model_p->dim_alpha44));
  SET_VECTOR_ELT(state, 272, allocVector(REALSXP, main_model_p->dim_alpha44));
  memcpy(REAL(VECTOR_ELT(state, 272)), main_model_p->alpha44, main_model_p->dim_alpha44 * sizeof(double));
  SET_VECTOR_ELT(state, 273, ScalarInteger(main_model_p->dim_alpha45));
  SET_VECTOR_ELT(state, 274, allocVector(REALSXP, main_model_p->dim_alpha45));
  memcpy(REAL(VECTOR_ELT(state, 274)), main_model_p->alpha45, main_model_p->dim_alpha45 * sizeof(double));
  SET_VECTOR_ELT(state, 275, ScalarInteger(main_model_p->dim_beta_comm));
  SET_VECTOR_ELT(state, 276, allocVector(REALSXP, main_model_p->dim_beta_comm));
  memcpy(REAL(VECTOR_ELT(state, 276)), main_model_p->beta_comm, main_model_p->dim_beta_comm * sizeof(double));
  SET_VECTOR_ELT(state, 277, ScalarInteger(main_model_p->offset_output_beta_comm));
  SET_VECTOR_ELT(state, 278, ScalarInteger(main_model_p->dim_beta_noncomm));
  SET_VECTOR_ELT(state, 279, allocVector(REALSXP, main_model_p->dim_beta_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 279)), main_model_p->beta_noncomm, main_model_p->dim_beta_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 280, ScalarInteger(main_model_p->offset_output_beta_noncomm));
  SET_VECTOR_ELT(state, 281, ScalarInteger(main_model_p->dim_p_comm));
  SET_VECTOR_ELT(state, 282, ScalarInteger(main_model_p->dim_p_comm_1));
  SET_VECTOR_ELT(state, 283, ScalarInteger(main_model_p->dim_p_comm_2));
  SET_VECTOR_ELT(state, 284, allocVector(REALSXP, main_model_p->dim_p_comm));
  memcpy(REAL(VECTOR_ELT(state, 284)), main_model_p->p_comm, main_model_p->dim_p_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 284), 2, main_model_p->dim_p_comm_1, main_model_p->dim_p_comm_2);
  SET_VECTOR_ELT(state, 285, ScalarInteger(main_model_p->offset_output_p_comm));
  SET_VECTOR_ELT(state, 286, ScalarInteger(main_model_p->dim_p_noncomm));
  SET_VECTOR_ELT(state, 287, ScalarInteger(main_model_p->dim_p_noncomm_1));
  SET_VECTOR_ELT(state, 288, ScalarInteger(main_model_p->dim_p_noncomm_2));
  SET_VECTOR_ELT(state, 289, allocVector(REALSXP, main_model_p->dim_p_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 289)), main_model_p->p_noncomm, main_model_p->dim_p_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 289), 2, main_model_p->dim_p_noncomm_1, main_model_p->dim_p_noncomm_2);
  SET_VECTOR_ELT(state, 290, ScalarInteger(main_model_p->offset_output_p_noncomm));
  SET_VECTOR_ELT(state, 291, ScalarInteger(main_model_p->dim_ec));
  SET_VECTOR_ELT(state, 292, allocVector(REALSXP, main_model_p->dim_ec));
  memcpy(REAL(VECTOR_ELT(state, 292)), main_model_p->ec, main_model_p->dim_ec * sizeof(double));
  SET_VECTOR_ELT(state, 293, ScalarInteger(main_model_p->dim_eP));
  SET_VECTOR_ELT(state, 294, allocVector(REALSXP, main_model_p->dim_eP));
  memcpy(REAL(VECTOR_ELT(state, 294)), main_model_p->eP, main_model_p->dim_eP * sizeof(double));
  SET_VECTOR_ELT(state, 295, ScalarInteger(main_model_p->dim_eP0));
  SET_VECTOR_ELT(state, 296, allocVector(REALSXP, main_model_p->dim_eP0));
  memcpy(REAL(VECTOR_ELT(state, 296)), main_model_p->eP0, main_model_p->dim_eP0 * sizeof(double));
  SET_VECTOR_ELT(state, 297, ScalarInteger(main_model_p->dim_eP1a));
  SET_VECTOR_ELT(state, 298, allocVector(REALSXP, main_model_p->dim_eP1a));
  memcpy(REAL(VECTOR_ELT(state, 298)), main_model_p->eP1a, main_model_p->dim_eP1a * sizeof(double));
  SET_VECTOR_ELT(state, 299, ScalarInteger(main_model_p->dim_eP1b));
  SET_VECTOR_ELT(state, 300, allocVector(REALSXP, main_model_p->dim_eP1b));
  memcpy(REAL(VECTOR_ELT(state, 300)), main_model_p->eP1b, main_model_p->dim_eP1b * sizeof(double));
  SET_VECTOR_ELT(state, 301, ScalarInteger(main_model_p->dim_eP1c));
  SET_VECTOR_ELT(state, 302, allocVector(REALSXP, main_model_p->dim_eP1c));
  memcpy(REAL(VECTOR_ELT(state, 302)), main_model_p->eP1c, main_model_p->dim_eP1c * sizeof(double));
  SET_VECTOR_ELT(state, 303, ScalarInteger(main_model_p->dim_eP1d));
  SET_VECTOR_ELT(state, 304, allocVector(REALSXP, main_model_p->dim_eP1d));
  memcpy(REAL(VECTOR_ELT(state, 304)), main_model_p->eP1d, main_model_p->dim_eP1d * sizeof(double));
  SET_VECTOR_ELT(state, 305, ScalarInteger(main_model_p->dim_fc_comm));
  SET_VECTOR_ELT(state, 306, ScalarInteger(main_model_p->dim_fc_comm_1));
  SET_VECTOR_ELT(state, 307, ScalarInteger(main_model_p->dim_fc_comm_2));
  SET_VECTOR_ELT(state, 308, allocVector(REALSXP, main_model_p->dim_fc_comm));
  memcpy(REAL(VECTOR_ELT(state, 308)), main_model_p->fc_comm, main_model_p->dim_fc_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 308), 2, main_model_p->dim_fc_comm_1, main_model_p->dim_fc_comm_2);
  SET_VECTOR_ELT(state, 309, ScalarInteger(main_model_p->offset_output_fc_comm));
  SET_VECTOR_ELT(state, 310, ScalarInteger(main_model_p->dim_fP_comm));
  SET_VECTOR_ELT(state, 311, allocVector(REALSXP, main_model_p->dim_fP_comm));
  memcpy(REAL(VECTOR_ELT(state, 311)), main_model_p->fP_comm, main_model_p->dim_fP_comm * sizeof(double));
  SET_VECTOR_ELT(state, 312, ScalarInteger(main_model_p->offset_output_fP_comm));
  SET_VECTOR_ELT(state, 313, ScalarInteger(main_model_p->dim_fc_noncomm));
  SET_VECTOR_ELT(state, 314, ScalarInteger(main_model_p->dim_fc_noncomm_1));
  SET_VECTOR_ELT(state, 315, ScalarInteger(main_model_p->dim_fc_noncomm_2));
  SET_VECTOR_ELT(state, 316, allocVector(REALSXP, main_model_p->dim_fc_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 316)), main_model_p->fc_noncomm, main_model_p->dim_fc_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 316), 2, main_model_p->dim_fc_noncomm_1, main_model_p->dim_fc_noncomm_2);
  SET_VECTOR_ELT(state, 317, ScalarInteger(main_model_p->offset_output_fc_noncomm));
  SET_VECTOR_ELT(state, 318, ScalarInteger(main_model_p->dim_fP_noncomm));
  SET_VECTOR_ELT(state, 319, allocVector(REALSXP, main_model_p->dim_fP_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 319)), main_model_p->fP_noncomm, main_model_p->dim_fP_noncomm * sizeof(double));
  SET_VECTOR_ELT(state, 320, ScalarInteger(main_model_p->offset_output_fP_noncomm));
  SET_VECTOR_ELT(state, 321, ScalarInteger(main_model_p->dim_n_comm));
  SET_VECTOR_ELT(state, 322, ScalarInteger(main_model_p->dim_n_comm_1));
  SET_VECTOR_ELT(state, 323, ScalarInteger(main_model_p->dim_n_comm_2));
  SET_VECTOR_ELT(state, 324, allocVector(REALSXP, main_model_p->dim_n_comm));
  memcpy(REAL(VECTOR_ELT(state, 324)), main_model_p->n_comm, main_model_p->dim_n_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 324), 2, main_model_p->dim_n_comm_1, main_model_p->dim_n_comm_2);
  SET_VECTOR_ELT(state, 325, ScalarInteger(main_model_p->offset_output_n_comm));
  SET_VECTOR_ELT(state, 326, ScalarInteger(main_model_p->dim_n_noncomm));
  SET_VECTOR_ELT(state, 327, ScalarInteger(main_model_p->dim_n_noncomm_1));
  SET_VECTOR_ELT(state, 328, ScalarInteger(main_model_p->dim_n_noncomm_2));
  SET_VECTOR_ELT(state, 329, allocVector(REALSXP, main_model_p->dim_n_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 329)), main_model_p->n_noncomm, main_model_p->dim_n_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 329), 2, main_model_p->dim_n_noncomm_1, main_model_p->dim_n_noncomm_2);
  SET_VECTOR_ELT(state, 330, ScalarInteger(main_model_p->offset_output_n_noncomm));
  SET_VECTOR_ELT(state, 331, ScalarInteger(main_model_p->dim_cumuHIVDeaths));
  SET_VECTOR_ELT(state, 332, allocVector(REALSXP, main_model_p->dim_cumuHIVDeaths));
  memcpy(REAL(VECTOR_ELT(state, 332)), main_model_p->initial_cumuHIVDeaths, main_model_p->dim_cumuHIVDeaths * sizeof(double));
  SET_VECTOR_ELT(state, 333, ScalarInteger(main_model_p->offset_cumuHIVDeaths));
  SET_VECTOR_ELT(state, 334, ScalarInteger(main_model_p->dim_cumuInf));
  SET_VECTOR_ELT(state, 335, allocVector(REALSXP, main_model_p->dim_cumuInf));
  memcpy(REAL(VECTOR_ELT(state, 335)), main_model_p->initial_cumuInf, main_model_p->dim_cumuInf * sizeof(double));
  SET_VECTOR_ELT(state, 336, ScalarInteger(main_model_p->offset_cumuInf));
  SET_VECTOR_ELT(state, 337, ScalarInteger(main_model_p->dim_OnPrEP));
  SET_VECTOR_ELT(state, 338, allocVector(REALSXP, main_model_p->dim_OnPrEP));
  memcpy(REAL(VECTOR_ELT(state, 338)), main_model_p->initial_OnPrEP, main_model_p->dim_OnPrEP * sizeof(double));
  SET_VECTOR_ELT(state, 339, ScalarInteger(main_model_p->offset_OnPrEP));
  SET_VECTOR_ELT(state, 340, ScalarInteger(main_model_p->dim_S0));
  SET_VECTOR_ELT(state, 341, allocVector(REALSXP, main_model_p->dim_S0));
  memcpy(REAL(VECTOR_ELT(state, 341)), main_model_p->initial_S0, main_model_p->dim_S0 * sizeof(double));
  SET_VECTOR_ELT(state, 342, ScalarInteger(main_model_p->offset_S0));
  SET_VECTOR_ELT(state, 343, ScalarInteger(main_model_p->dim_S1a));
  SET_VECTOR_ELT(state, 344, allocVector(REALSXP, main_model_p->dim_S1a));
  memcpy(REAL(VECTOR_ELT(state, 344)), main_model_p->initial_S1a, main_model_p->dim_S1a * sizeof(double));
  SET_VECTOR_ELT(state, 345, ScalarInteger(main_model_p->offset_S1a));
  SET_VECTOR_ELT(state, 346, ScalarInteger(main_model_p->dim_S1b));
  SET_VECTOR_ELT(state, 347, allocVector(REALSXP, main_model_p->dim_S1b));
  memcpy(REAL(VECTOR_ELT(state, 347)), main_model_p->initial_S1b, main_model_p->dim_S1b * sizeof(double));
  SET_VECTOR_ELT(state, 348, ScalarInteger(main_model_p->offset_S1b));
  SET_VECTOR_ELT(state, 349, ScalarInteger(main_model_p->dim_S1c));
  SET_VECTOR_ELT(state, 350, allocVector(REALSXP, main_model_p->dim_S1c));
  memcpy(REAL(VECTOR_ELT(state, 350)), main_model_p->initial_S1c, main_model_p->dim_S1c * sizeof(double));
  SET_VECTOR_ELT(state, 351, ScalarInteger(main_model_p->offset_S1c));
  SET_VECTOR_ELT(state, 352, ScalarInteger(main_model_p->dim_S1d));
  SET_VECTOR_ELT(state, 353, allocVector(REALSXP, main_model_p->dim_S1d));
  memcpy(REAL(VECTOR_ELT(state, 353)), main_model_p->initial_S1d, main_model_p->dim_S1d * sizeof(double));
  SET_VECTOR_ELT(state, 354, ScalarInteger(main_model_p->offset_S1d));
  SET_VECTOR_ELT(state, 355, ScalarInteger(main_model_p->dim_I01));
  SET_VECTOR_ELT(state, 356, allocVector(REALSXP, main_model_p->dim_I01));
  memcpy(REAL(VECTOR_ELT(state, 356)), main_model_p->initial_I01, main_model_p->dim_I01 * sizeof(double));
  SET_VECTOR_ELT(state, 357, ScalarInteger(main_model_p->offset_I01));
  SET_VECTOR_ELT(state, 358, ScalarInteger(main_model_p->dim_I11));
  SET_VECTOR_ELT(state, 359, allocVector(REALSXP, main_model_p->dim_I11));
  memcpy(REAL(VECTOR_ELT(state, 359)), main_model_p->initial_I11, main_model_p->dim_I11 * sizeof(double));
  SET_VECTOR_ELT(state, 360, ScalarInteger(main_model_p->offset_I11));
  SET_VECTOR_ELT(state, 361, ScalarInteger(main_model_p->dim_I02));
  SET_VECTOR_ELT(state, 362, allocVector(REALSXP, main_model_p->dim_I02));
  memcpy(REAL(VECTOR_ELT(state, 362)), main_model_p->initial_I02, main_model_p->dim_I02 * sizeof(double));
  SET_VECTOR_ELT(state, 363, ScalarInteger(main_model_p->offset_I02));
  SET_VECTOR_ELT(state, 364, ScalarInteger(main_model_p->dim_I03));
  SET_VECTOR_ELT(state, 365, allocVector(REALSXP, main_model_p->dim_I03));
  memcpy(REAL(VECTOR_ELT(state, 365)), main_model_p->initial_I03, main_model_p->dim_I03 * sizeof(double));
  SET_VECTOR_ELT(state, 366, ScalarInteger(main_model_p->offset_I03));
  SET_VECTOR_ELT(state, 367, ScalarInteger(main_model_p->dim_I04));
  SET_VECTOR_ELT(state, 368, allocVector(REALSXP, main_model_p->dim_I04));
  memcpy(REAL(VECTOR_ELT(state, 368)), main_model_p->initial_I04, main_model_p->dim_I04 * sizeof(double));
  SET_VECTOR_ELT(state, 369, ScalarInteger(main_model_p->offset_I04));
  SET_VECTOR_ELT(state, 370, ScalarInteger(main_model_p->dim_I05));
  SET_VECTOR_ELT(state, 371, allocVector(REALSXP, main_model_p->dim_I05));
  memcpy(REAL(VECTOR_ELT(state, 371)), main_model_p->initial_I05, main_model_p->dim_I05 * sizeof(double));
  SET_VECTOR_ELT(state, 372, ScalarInteger(main_model_p->offset_I05));
  SET_VECTOR_ELT(state, 373, ScalarInteger(main_model_p->dim_I22));
  SET_VECTOR_ELT(state, 374, allocVector(REALSXP, main_model_p->dim_I22));
  memcpy(REAL(VECTOR_ELT(state, 374)), main_model_p->initial_I22, main_model_p->dim_I22 * sizeof(double));
  SET_VECTOR_ELT(state, 375, ScalarInteger(main_model_p->offset_I22));
  SET_VECTOR_ELT(state, 376, ScalarInteger(main_model_p->dim_I23));
  SET_VECTOR_ELT(state, 377, allocVector(REALSXP, main_model_p->dim_I23));
  memcpy(REAL(VECTOR_ELT(state, 377)), main_model_p->initial_I23, main_model_p->dim_I23 * sizeof(double));
  SET_VECTOR_ELT(state, 378, ScalarInteger(main_model_p->offset_I23));
  SET_VECTOR_ELT(state, 379, ScalarInteger(main_model_p->dim_I24));
  SET_VECTOR_ELT(state, 380, allocVector(REALSXP, main_model_p->dim_I24));
  memcpy(REAL(VECTOR_ELT(state, 380)), main_model_p->initial_I24, main_model_p->dim_I24 * sizeof(double));
  SET_VECTOR_ELT(state, 381, ScalarInteger(main_model_p->offset_I24));
  SET_VECTOR_ELT(state, 382, ScalarInteger(main_model_p->dim_I25));
  SET_VECTOR_ELT(state, 383, allocVector(REALSXP, main_model_p->dim_I25));
  memcpy(REAL(VECTOR_ELT(state, 383)), main_model_p->initial_I25, main_model_p->dim_I25 * sizeof(double));
  SET_VECTOR_ELT(state, 384, ScalarInteger(main_model_p->offset_I25));
  SET_VECTOR_ELT(state, 385, ScalarInteger(main_model_p->dim_I32));
  SET_VECTOR_ELT(state, 386, allocVector(REALSXP, main_model_p->dim_I32));
  memcpy(REAL(VECTOR_ELT(state, 386)), main_model_p->initial_I32, main_model_p->dim_I32 * sizeof(double));
  SET_VECTOR_ELT(state, 387, ScalarInteger(main_model_p->offset_I32));
  SET_VECTOR_ELT(state, 388, ScalarInteger(main_model_p->dim_I33));
  SET_VECTOR_ELT(state, 389, allocVector(REALSXP, main_model_p->dim_I33));
  memcpy(REAL(VECTOR_ELT(state, 389)), main_model_p->initial_I33, main_model_p->dim_I33 * sizeof(double));
  SET_VECTOR_ELT(state, 390, ScalarInteger(main_model_p->offset_I33));
  SET_VECTOR_ELT(state, 391, ScalarInteger(main_model_p->dim_I34));
  SET_VECTOR_ELT(state, 392, allocVector(REALSXP, main_model_p->dim_I34));
  memcpy(REAL(VECTOR_ELT(state, 392)), main_model_p->initial_I34, main_model_p->dim_I34 * sizeof(double));
  SET_VECTOR_ELT(state, 393, ScalarInteger(main_model_p->offset_I34));
  SET_VECTOR_ELT(state, 394, ScalarInteger(main_model_p->dim_I35));
  SET_VECTOR_ELT(state, 395, allocVector(REALSXP, main_model_p->dim_I35));
  memcpy(REAL(VECTOR_ELT(state, 395)), main_model_p->initial_I35, main_model_p->dim_I35 * sizeof(double));
  SET_VECTOR_ELT(state, 396, ScalarInteger(main_model_p->offset_I35));
  SET_VECTOR_ELT(state, 397, ScalarInteger(main_model_p->dim_I42));
  SET_VECTOR_ELT(state, 398, allocVector(REALSXP, main_model_p->dim_I42));
  memcpy(REAL(VECTOR_ELT(state, 398)), main_model_p->initial_I42, main_model_p->dim_I42 * sizeof(double));
  SET_VECTOR_ELT(state, 399, ScalarInteger(main_model_p->offset_I42));
  SET_VECTOR_ELT(state, 400, ScalarInteger(main_model_p->dim_I43));
  SET_VECTOR_ELT(state, 401, allocVector(REALSXP, main_model_p->dim_I43));
  memcpy(REAL(VECTOR_ELT(state, 401)), main_model_p->initial_I43, main_model_p->dim_I43 * sizeof(double));
  SET_VECTOR_ELT(state, 402, ScalarInteger(main_model_p->offset_I43));
  SET_VECTOR_ELT(state, 403, ScalarInteger(main_model_p->dim_I44));
  SET_VECTOR_ELT(state, 404, allocVector(REALSXP, main_model_p->dim_I44));
  memcpy(REAL(VECTOR_ELT(state, 404)), main_model_p->initial_I44, main_model_p->dim_I44 * sizeof(double));
  SET_VECTOR_ELT(state, 405, ScalarInteger(main_model_p->offset_I44));
  SET_VECTOR_ELT(state, 406, ScalarInteger(main_model_p->dim_I45));
  SET_VECTOR_ELT(state, 407, allocVector(REALSXP, main_model_p->dim_I45));
  memcpy(REAL(VECTOR_ELT(state, 407)), main_model_p->initial_I45, main_model_p->dim_I45 * sizeof(double));
  SET_VECTOR_ELT(state, 408, ScalarInteger(main_model_p->offset_I45));
  SET_VECTOR_ELT(state, 409, ScalarInteger(main_model_p->dim_S0_init));
  SET_VECTOR_ELT(state, 410, allocVector(REALSXP, main_model_p->dim_S0_init));
  memcpy(REAL(VECTOR_ELT(state, 410)), main_model_p->S0_init, main_model_p->dim_S0_init * sizeof(double));
  SET_VECTOR_ELT(state, 411, ScalarInteger(main_model_p->dim_S1a_init));
  SET_VECTOR_ELT(state, 412, allocVector(REALSXP, main_model_p->dim_S1a_init));
  memcpy(REAL(VECTOR_ELT(state, 412)), main_model_p->S1a_init, main_model_p->dim_S1a_init * sizeof(double));
  SET_VECTOR_ELT(state, 413, ScalarInteger(main_model_p->dim_S1b_init));
  SET_VECTOR_ELT(state, 414, allocVector(REALSXP, main_model_p->dim_S1b_init));
  memcpy(REAL(VECTOR_ELT(state, 414)), main_model_p->S1b_init, main_model_p->dim_S1b_init * sizeof(double));
  SET_VECTOR_ELT(state, 415, ScalarInteger(main_model_p->dim_S1c_init));
  SET_VECTOR_ELT(state, 416, allocVector(REALSXP, main_model_p->dim_S1c_init));
  memcpy(REAL(VECTOR_ELT(state, 416)), main_model_p->S1c_init, main_model_p->dim_S1c_init * sizeof(double));
  SET_VECTOR_ELT(state, 417, ScalarInteger(main_model_p->dim_S1d_init));
  SET_VECTOR_ELT(state, 418, allocVector(REALSXP, main_model_p->dim_S1d_init));
  memcpy(REAL(VECTOR_ELT(state, 418)), main_model_p->S1d_init, main_model_p->dim_S1d_init * sizeof(double));
  SET_VECTOR_ELT(state, 419, ScalarInteger(main_model_p->dim_I01_init));
  SET_VECTOR_ELT(state, 420, allocVector(REALSXP, main_model_p->dim_I01_init));
  memcpy(REAL(VECTOR_ELT(state, 420)), main_model_p->I01_init, main_model_p->dim_I01_init * sizeof(double));
  SET_VECTOR_ELT(state, 421, ScalarInteger(main_model_p->dim_I11_init));
  SET_VECTOR_ELT(state, 422, allocVector(REALSXP, main_model_p->dim_I11_init));
  memcpy(REAL(VECTOR_ELT(state, 422)), main_model_p->I11_init, main_model_p->dim_I11_init * sizeof(double));
  SET_VECTOR_ELT(state, 423, ScalarInteger(main_model_p->dim_I02_init));
  SET_VECTOR_ELT(state, 424, allocVector(REALSXP, main_model_p->dim_I02_init));
  memcpy(REAL(VECTOR_ELT(state, 424)), main_model_p->I02_init, main_model_p->dim_I02_init * sizeof(double));
  SET_VECTOR_ELT(state, 425, ScalarInteger(main_model_p->dim_I03_init));
  SET_VECTOR_ELT(state, 426, allocVector(REALSXP, main_model_p->dim_I03_init));
  memcpy(REAL(VECTOR_ELT(state, 426)), main_model_p->I03_init, main_model_p->dim_I03_init * sizeof(double));
  SET_VECTOR_ELT(state, 427, ScalarInteger(main_model_p->dim_I04_init));
  SET_VECTOR_ELT(state, 428, allocVector(REALSXP, main_model_p->dim_I04_init));
  memcpy(REAL(VECTOR_ELT(state, 428)), main_model_p->I04_init, main_model_p->dim_I04_init * sizeof(double));
  SET_VECTOR_ELT(state, 429, ScalarInteger(main_model_p->dim_I05_init));
  SET_VECTOR_ELT(state, 430, allocVector(REALSXP, main_model_p->dim_I05_init));
  memcpy(REAL(VECTOR_ELT(state, 430)), main_model_p->I05_init, main_model_p->dim_I05_init * sizeof(double));
  SET_VECTOR_ELT(state, 431, ScalarInteger(main_model_p->dim_I22_init));
  SET_VECTOR_ELT(state, 432, allocVector(REALSXP, main_model_p->dim_I22_init));
  memcpy(REAL(VECTOR_ELT(state, 432)), main_model_p->I22_init, main_model_p->dim_I22_init * sizeof(double));
  SET_VECTOR_ELT(state, 433, ScalarInteger(main_model_p->dim_I23_init));
  SET_VECTOR_ELT(state, 434, allocVector(REALSXP, main_model_p->dim_I23_init));
  memcpy(REAL(VECTOR_ELT(state, 434)), main_model_p->I23_init, main_model_p->dim_I23_init * sizeof(double));
  SET_VECTOR_ELT(state, 435, ScalarInteger(main_model_p->dim_I24_init));
  SET_VECTOR_ELT(state, 436, allocVector(REALSXP, main_model_p->dim_I24_init));
  memcpy(REAL(VECTOR_ELT(state, 436)), main_model_p->I24_init, main_model_p->dim_I24_init * sizeof(double));
  SET_VECTOR_ELT(state, 437, ScalarInteger(main_model_p->dim_I25_init));
  SET_VECTOR_ELT(state, 438, allocVector(REALSXP, main_model_p->dim_I25_init));
  memcpy(REAL(VECTOR_ELT(state, 438)), main_model_p->I25_init, main_model_p->dim_I25_init * sizeof(double));
  SET_VECTOR_ELT(state, 439, ScalarInteger(main_model_p->dim_I32_init));
  SET_VECTOR_ELT(state, 440, allocVector(REALSXP, main_model_p->dim_I32_init));
  memcpy(REAL(VECTOR_ELT(state, 440)), main_model_p->I32_init, main_model_p->dim_I32_init * sizeof(double));
  SET_VECTOR_ELT(state, 441, ScalarInteger(main_model_p->dim_I33_init));
  SET_VECTOR_ELT(state, 442, allocVector(REALSXP, main_model_p->dim_I33_init));
  memcpy(REAL(VECTOR_ELT(state, 442)), main_model_p->I33_init, main_model_p->dim_I33_init * sizeof(double));
  SET_VECTOR_ELT(state, 443, ScalarInteger(main_model_p->dim_I34_init));
  SET_VECTOR_ELT(state, 444, allocVector(REALSXP, main_model_p->dim_I34_init));
  memcpy(REAL(VECTOR_ELT(state, 444)), main_model_p->I34_init, main_model_p->dim_I34_init * sizeof(double));
  SET_VECTOR_ELT(state, 445, ScalarInteger(main_model_p->dim_I35_init));
  SET_VECTOR_ELT(state, 446, allocVector(REALSXP, main_model_p->dim_I35_init));
  memcpy(REAL(VECTOR_ELT(state, 446)), main_model_p->I35_init, main_model_p->dim_I35_init * sizeof(double));
  SET_VECTOR_ELT(state, 447, ScalarInteger(main_model_p->dim_I42_init));
  SET_VECTOR_ELT(state, 448, allocVector(REALSXP, main_model_p->dim_I42_init));
  memcpy(REAL(VECTOR_ELT(state, 448)), main_model_p->I42_init, main_model_p->dim_I42_init * sizeof(double));
  SET_VECTOR_ELT(state, 449, ScalarInteger(main_model_p->dim_I43_init));
  SET_VECTOR_ELT(state, 450, allocVector(REALSXP, main_model_p->dim_I43_init));
  memcpy(REAL(VECTOR_ELT(state, 450)), main_model_p->I43_init, main_model_p->dim_I43_init * sizeof(double));
  SET_VECTOR_ELT(state, 451, ScalarInteger(main_model_p->dim_I44_init));
  SET_VECTOR_ELT(state, 452, allocVector(REALSXP, main_model_p->dim_I44_init));
  memcpy(REAL(VECTOR_ELT(state, 452)), main_model_p->I44_init, main_model_p->dim_I44_init * sizeof(double));
  SET_VECTOR_ELT(state, 453, ScalarInteger(main_model_p->dim_I45_init));
  SET_VECTOR_ELT(state, 454, allocVector(REALSXP, main_model_p->dim_I45_init));
  memcpy(REAL(VECTOR_ELT(state, 454)), main_model_p->I45_init, main_model_p->dim_I45_init * sizeof(double));
  SET_VECTOR_ELT(state, 455, ScalarInteger(main_model_p->dim_N));
  SET_VECTOR_ELT(state, 456, allocVector(REALSXP, main_model_p->dim_N));
  memcpy(REAL(VECTOR_ELT(state, 456)), main_model_p->N, main_model_p->dim_N * sizeof(double));
  SET_VECTOR_ELT(state, 457, ScalarInteger(main_model_p->offset_output_N));
  SET_VECTOR_ELT(state, 458, ScalarInteger(main_model_p->dim_E0));
  SET_VECTOR_ELT(state, 459, allocVector(REALSXP, main_model_p->dim_E0));
  memcpy(REAL(VECTOR_ELT(state, 459)), main_model_p->E0, main_model_p->dim_E0 * sizeof(double));
  SET_VECTOR_ELT(state, 460, ScalarInteger(main_model_p->offset_output_E0));
  SET_VECTOR_ELT(state, 461, ScalarInteger(main_model_p->dim_E1a));
  SET_VECTOR_ELT(state, 462, allocVector(REALSXP, main_model_p->dim_E1a));
  memcpy(REAL(VECTOR_ELT(state, 462)), main_model_p->E1a, main_model_p->dim_E1a * sizeof(double));
  SET_VECTOR_ELT(state, 463, ScalarInteger(main_model_p->offset_output_E1a));
  SET_VECTOR_ELT(state, 464, ScalarInteger(main_model_p->dim_E1b));
  SET_VECTOR_ELT(state, 465, allocVector(REALSXP, main_model_p->dim_E1b));
  memcpy(REAL(VECTOR_ELT(state, 465)), main_model_p->E1b, main_model_p->dim_E1b * sizeof(double));
  SET_VECTOR_ELT(state, 466, ScalarInteger(main_model_p->offset_output_E1b));
  SET_VECTOR_ELT(state, 467, ScalarInteger(main_model_p->dim_E1c));
  SET_VECTOR_ELT(state, 468, allocVector(REALSXP, main_model_p->dim_E1c));
  memcpy(REAL(VECTOR_ELT(state, 468)), main_model_p->E1c, main_model_p->dim_E1c * sizeof(double));
  SET_VECTOR_ELT(state, 469, ScalarInteger(main_model_p->offset_output_E1c));
  SET_VECTOR_ELT(state, 470, ScalarInteger(main_model_p->dim_E1d));
  SET_VECTOR_ELT(state, 471, allocVector(REALSXP, main_model_p->dim_E1d));
  memcpy(REAL(VECTOR_ELT(state, 471)), main_model_p->E1d, main_model_p->dim_E1d * sizeof(double));
  SET_VECTOR_ELT(state, 472, ScalarInteger(main_model_p->offset_output_E1d));
  SET_VECTOR_ELT(state, 473, ScalarInteger(main_model_p->dim_cumuInf_init));
  SET_VECTOR_ELT(state, 474, allocVector(REALSXP, main_model_p->dim_cumuInf_init));
  memcpy(REAL(VECTOR_ELT(state, 474)), main_model_p->cumuInf_init, main_model_p->dim_cumuInf_init * sizeof(double));
  SET_VECTOR_ELT(state, 475, ScalarInteger(main_model_p->dim_alphaItot));
  SET_VECTOR_ELT(state, 476, allocVector(REALSXP, main_model_p->dim_alphaItot));
  memcpy(REAL(VECTOR_ELT(state, 476)), main_model_p->alphaItot, main_model_p->dim_alphaItot * sizeof(double));
  SET_VECTOR_ELT(state, 477, ScalarInteger(main_model_p->offset_output_alphaItot));
  SET_VECTOR_ELT(state, 478, ScalarInteger(main_model_p->dim_prev));
  SET_VECTOR_ELT(state, 479, allocVector(REALSXP, main_model_p->dim_prev));
  memcpy(REAL(VECTOR_ELT(state, 479)), main_model_p->prev, main_model_p->dim_prev * sizeof(double));
  SET_VECTOR_ELT(state, 480, ScalarInteger(main_model_p->offset_output_prev));
  SET_VECTOR_ELT(state, 481, ScalarInteger(main_model_p->dim_lambda));
  SET_VECTOR_ELT(state, 482, ScalarInteger(main_model_p->dim_lambda_1));
  SET_VECTOR_ELT(state, 483, ScalarInteger(main_model_p->dim_lambda_2));
  SET_VECTOR_ELT(state, 484, allocVector(REALSXP, main_model_p->dim_lambda));
  memcpy(REAL(VECTOR_ELT(state, 484)), main_model_p->lambda, main_model_p->dim_lambda * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 484), 2, main_model_p->dim_lambda_1, main_model_p->dim_lambda_2);
  SET_VECTOR_ELT(state, 485, ScalarInteger(main_model_p->offset_output_lambda));
  SET_VECTOR_ELT(state, 486, ScalarInteger(main_model_p->dim_lambda_0));
  SET_VECTOR_ELT(state, 487, ScalarInteger(main_model_p->dim_lambda_0_1));
  SET_VECTOR_ELT(state, 488, ScalarInteger(main_model_p->dim_lambda_0_2));
  SET_VECTOR_ELT(state, 489, allocVector(REALSXP, main_model_p->dim_lambda_0));
  memcpy(REAL(VECTOR_ELT(state, 489)), main_model_p->lambda_0, main_model_p->dim_lambda_0 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 489), 2, main_model_p->dim_lambda_0_1, main_model_p->dim_lambda_0_2);
  SET_VECTOR_ELT(state, 490, ScalarInteger(main_model_p->offset_output_lambda_0));
  SET_VECTOR_ELT(state, 491, ScalarInteger(main_model_p->dim_lambda_1a));
  SET_VECTOR_ELT(state, 492, ScalarInteger(main_model_p->dim_lambda_1a_1));
  SET_VECTOR_ELT(state, 493, ScalarInteger(main_model_p->dim_lambda_1a_2));
  SET_VECTOR_ELT(state, 494, allocVector(REALSXP, main_model_p->dim_lambda_1a));
  memcpy(REAL(VECTOR_ELT(state, 494)), main_model_p->lambda_1a, main_model_p->dim_lambda_1a * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 494), 2, main_model_p->dim_lambda_1a_1, main_model_p->dim_lambda_1a_2);
  SET_VECTOR_ELT(state, 495, ScalarInteger(main_model_p->offset_output_lambda_1a));
  SET_VECTOR_ELT(state, 496, ScalarInteger(main_model_p->dim_lambda_1b));
  SET_VECTOR_ELT(state, 497, ScalarInteger(main_model_p->dim_lambda_1b_1));
  SET_VECTOR_ELT(state, 498, ScalarInteger(main_model_p->dim_lambda_1b_2));
  SET_VECTOR_ELT(state, 499, allocVector(REALSXP, main_model_p->dim_lambda_1b));
  memcpy(REAL(VECTOR_ELT(state, 499)), main_model_p->lambda_1b, main_model_p->dim_lambda_1b * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 499), 2, main_model_p->dim_lambda_1b_1, main_model_p->dim_lambda_1b_2);
  SET_VECTOR_ELT(state, 500, ScalarInteger(main_model_p->offset_output_lambda_1b));
  SET_VECTOR_ELT(state, 501, ScalarInteger(main_model_p->dim_lambda_1c));
  SET_VECTOR_ELT(state, 502, ScalarInteger(main_model_p->dim_lambda_1c_1));
  SET_VECTOR_ELT(state, 503, ScalarInteger(main_model_p->dim_lambda_1c_2));
  SET_VECTOR_ELT(state, 504, allocVector(REALSXP, main_model_p->dim_lambda_1c));
  memcpy(REAL(VECTOR_ELT(state, 504)), main_model_p->lambda_1c, main_model_p->dim_lambda_1c * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 504), 2, main_model_p->dim_lambda_1c_1, main_model_p->dim_lambda_1c_2);
  SET_VECTOR_ELT(state, 505, ScalarInteger(main_model_p->offset_output_lambda_1c));
  SET_VECTOR_ELT(state, 506, ScalarInteger(main_model_p->dim_lambda_1d));
  SET_VECTOR_ELT(state, 507, ScalarInteger(main_model_p->dim_lambda_1d_1));
  SET_VECTOR_ELT(state, 508, ScalarInteger(main_model_p->dim_lambda_1d_2));
  SET_VECTOR_ELT(state, 509, allocVector(REALSXP, main_model_p->dim_lambda_1d));
  memcpy(REAL(VECTOR_ELT(state, 509)), main_model_p->lambda_1d, main_model_p->dim_lambda_1d * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 509), 2, main_model_p->dim_lambda_1d_1, main_model_p->dim_lambda_1d_2);
  SET_VECTOR_ELT(state, 510, ScalarInteger(main_model_p->offset_output_lambda_1d));
  SET_VECTOR_ELT(state, 511, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_VECTOR_ELT(state, 512, allocVector(REALSXP, main_model_p->dim_lambda_sum_0));
  memcpy(REAL(VECTOR_ELT(state, 512)), main_model_p->lambda_sum_0, main_model_p->dim_lambda_sum_0 * sizeof(double));
  SET_VECTOR_ELT(state, 513, ScalarInteger(main_model_p->offset_output_lambda_sum_0));
  SET_VECTOR_ELT(state, 514, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_VECTOR_ELT(state, 515, allocVector(REALSXP, main_model_p->dim_lambda_sum_1a));
  memcpy(REAL(VECTOR_ELT(state, 515)), main_model_p->lambda_sum_1a, main_model_p->dim_lambda_sum_1a * sizeof(double));
  SET_VECTOR_ELT(state, 516, ScalarInteger(main_model_p->offset_output_lambda_sum_1a));
  SET_VECTOR_ELT(state, 517, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_VECTOR_ELT(state, 518, allocVector(REALSXP, main_model_p->dim_lambda_sum_1b));
  memcpy(REAL(VECTOR_ELT(state, 518)), main_model_p->lambda_sum_1b, main_model_p->dim_lambda_sum_1b * sizeof(double));
  SET_VECTOR_ELT(state, 519, ScalarInteger(main_model_p->offset_output_lambda_sum_1b));
  SET_VECTOR_ELT(state, 520, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_VECTOR_ELT(state, 521, allocVector(REALSXP, main_model_p->dim_lambda_sum_1c));
  memcpy(REAL(VECTOR_ELT(state, 521)), main_model_p->lambda_sum_1c, main_model_p->dim_lambda_sum_1c * sizeof(double));
  SET_VECTOR_ELT(state, 522, ScalarInteger(main_model_p->offset_output_lambda_sum_1c));
  SET_VECTOR_ELT(state, 523, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_VECTOR_ELT(state, 524, allocVector(REALSXP, main_model_p->dim_lambda_sum_1d));
  memcpy(REAL(VECTOR_ELT(state, 524)), main_model_p->lambda_sum_1d, main_model_p->dim_lambda_sum_1d * sizeof(double));
  SET_VECTOR_ELT(state, 525, ScalarInteger(main_model_p->offset_output_lambda_sum_1d));
  SET_VECTOR_ELT(state, 526, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_VECTOR_ELT(state, 527, allocVector(REALSXP, main_model_p->dim_c_comm_balanced));
  memcpy(REAL(VECTOR_ELT(state, 527)), main_model_p->c_comm_balanced, main_model_p->dim_c_comm_balanced * sizeof(double));
  SET_VECTOR_ELT(state, 528, ScalarInteger(main_model_p->offset_output_c_comm_balanced));
  SET_VECTOR_ELT(state, 529, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_VECTOR_ELT(state, 530, allocVector(REALSXP, main_model_p->dim_c_noncomm_balanced));
  memcpy(REAL(VECTOR_ELT(state, 530)), main_model_p->c_noncomm_balanced, main_model_p->dim_c_noncomm_balanced * sizeof(double));
  SET_VECTOR_ELT(state, 531, ScalarInteger(main_model_p->offset_output_c_noncomm_balanced));
  SET_VECTOR_ELT(state, 532, ScalarInteger(main_model_p->dim_theta));
  SET_VECTOR_ELT(state, 533, ScalarInteger(main_model_p->dim_theta_1));
  SET_VECTOR_ELT(state, 534, ScalarInteger(main_model_p->dim_theta_2));
  SET_VECTOR_ELT(state, 535, allocVector(REALSXP, main_model_p->dim_theta));
  memcpy(REAL(VECTOR_ELT(state, 535)), main_model_p->theta, main_model_p->dim_theta * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 535), 2, main_model_p->dim_theta_1, main_model_p->dim_theta_2);
  SET_VECTOR_ELT(state, 536, ScalarInteger(main_model_p->offset_output_theta));
  SET_VECTOR_ELT(state, 537, ScalarInteger(main_model_p->dim_OnPrEP_init));
  SET_VECTOR_ELT(state, 538, allocVector(REALSXP, main_model_p->dim_OnPrEP_init));
  memcpy(REAL(VECTOR_ELT(state, 538)), main_model_p->OnPrEP_init, main_model_p->dim_OnPrEP_init * sizeof(double));
  SET_VECTOR_ELT(state, 539, ScalarInteger(main_model_p->dim_M_comm));
  SET_VECTOR_ELT(state, 540, ScalarInteger(main_model_p->dim_M_comm_1));
  SET_VECTOR_ELT(state, 541, ScalarInteger(main_model_p->dim_M_comm_2));
  SET_VECTOR_ELT(state, 542, allocVector(REALSXP, main_model_p->dim_M_comm));
  memcpy(REAL(VECTOR_ELT(state, 542)), main_model_p->M_comm, main_model_p->dim_M_comm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 542), 2, main_model_p->dim_M_comm_1, main_model_p->dim_M_comm_2);
  SET_VECTOR_ELT(state, 543, ScalarInteger(main_model_p->offset_output_M_comm));
  SET_VECTOR_ELT(state, 544, ScalarInteger(main_model_p->dim_M_noncomm));
  SET_VECTOR_ELT(state, 545, ScalarInteger(main_model_p->dim_M_noncomm_1));
  SET_VECTOR_ELT(state, 546, ScalarInteger(main_model_p->dim_M_noncomm_2));
  SET_VECTOR_ELT(state, 547, allocVector(REALSXP, main_model_p->dim_M_noncomm));
  memcpy(REAL(VECTOR_ELT(state, 547)), main_model_p->M_noncomm, main_model_p->dim_M_noncomm * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 547), 2, main_model_p->dim_M_noncomm_1, main_model_p->dim_M_noncomm_2);
  SET_VECTOR_ELT(state, 548, ScalarInteger(main_model_p->offset_output_M_noncomm));
  SET_VECTOR_ELT(state, 549, ScalarInteger(main_model_p->dim_in_S0));
  SET_VECTOR_ELT(state, 550, ScalarInteger(main_model_p->dim_in_S0_1));
  SET_VECTOR_ELT(state, 551, ScalarInteger(main_model_p->dim_in_S0_2));
  SET_VECTOR_ELT(state, 552, allocVector(REALSXP, main_model_p->dim_in_S0));
  memcpy(REAL(VECTOR_ELT(state, 552)), main_model_p->in_S0, main_model_p->dim_in_S0 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 552), 2, main_model_p->dim_in_S0_1, main_model_p->dim_in_S0_2);
  SET_VECTOR_ELT(state, 553, ScalarInteger(main_model_p->dim_in_S1a));
  SET_VECTOR_ELT(state, 554, ScalarInteger(main_model_p->dim_in_S1a_1));
  SET_VECTOR_ELT(state, 555, ScalarInteger(main_model_p->dim_in_S1a_2));
  SET_VECTOR_ELT(state, 556, allocVector(REALSXP, main_model_p->dim_in_S1a));
  memcpy(REAL(VECTOR_ELT(state, 556)), main_model_p->in_S1a, main_model_p->dim_in_S1a * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 556), 2, main_model_p->dim_in_S1a_1, main_model_p->dim_in_S1a_2);
  SET_VECTOR_ELT(state, 557, ScalarInteger(main_model_p->dim_in_S1b));
  SET_VECTOR_ELT(state, 558, ScalarInteger(main_model_p->dim_in_S1b_1));
  SET_VECTOR_ELT(state, 559, ScalarInteger(main_model_p->dim_in_S1b_2));
  SET_VECTOR_ELT(state, 560, allocVector(REALSXP, main_model_p->dim_in_S1b));
  memcpy(REAL(VECTOR_ELT(state, 560)), main_model_p->in_S1b, main_model_p->dim_in_S1b * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 560), 2, main_model_p->dim_in_S1b_1, main_model_p->dim_in_S1b_2);
  SET_VECTOR_ELT(state, 561, ScalarInteger(main_model_p->dim_in_S1c));
  SET_VECTOR_ELT(state, 562, ScalarInteger(main_model_p->dim_in_S1c_1));
  SET_VECTOR_ELT(state, 563, ScalarInteger(main_model_p->dim_in_S1c_2));
  SET_VECTOR_ELT(state, 564, allocVector(REALSXP, main_model_p->dim_in_S1c));
  memcpy(REAL(VECTOR_ELT(state, 564)), main_model_p->in_S1c, main_model_p->dim_in_S1c * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 564), 2, main_model_p->dim_in_S1c_1, main_model_p->dim_in_S1c_2);
  SET_VECTOR_ELT(state, 565, ScalarInteger(main_model_p->dim_in_S1d));
  SET_VECTOR_ELT(state, 566, ScalarInteger(main_model_p->dim_in_S1d_1));
  SET_VECTOR_ELT(state, 567, ScalarInteger(main_model_p->dim_in_S1d_2));
  SET_VECTOR_ELT(state, 568, allocVector(REALSXP, main_model_p->dim_in_S1d));
  memcpy(REAL(VECTOR_ELT(state, 568)), main_model_p->in_S1d, main_model_p->dim_in_S1d * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 568), 2, main_model_p->dim_in_S1d_1, main_model_p->dim_in_S1d_2);
  SET_VECTOR_ELT(state, 569, ScalarInteger(main_model_p->dim_in_I01));
  SET_VECTOR_ELT(state, 570, ScalarInteger(main_model_p->dim_in_I01_1));
  SET_VECTOR_ELT(state, 571, ScalarInteger(main_model_p->dim_in_I01_2));
  SET_VECTOR_ELT(state, 572, allocVector(REALSXP, main_model_p->dim_in_I01));
  memcpy(REAL(VECTOR_ELT(state, 572)), main_model_p->in_I01, main_model_p->dim_in_I01 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 572), 2, main_model_p->dim_in_I01_1, main_model_p->dim_in_I01_2);
  SET_VECTOR_ELT(state, 573, ScalarInteger(main_model_p->dim_in_I11));
  SET_VECTOR_ELT(state, 574, ScalarInteger(main_model_p->dim_in_I11_1));
  SET_VECTOR_ELT(state, 575, ScalarInteger(main_model_p->dim_in_I11_2));
  SET_VECTOR_ELT(state, 576, allocVector(REALSXP, main_model_p->dim_in_I11));
  memcpy(REAL(VECTOR_ELT(state, 576)), main_model_p->in_I11, main_model_p->dim_in_I11 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 576), 2, main_model_p->dim_in_I11_1, main_model_p->dim_in_I11_2);
  SET_VECTOR_ELT(state, 577, ScalarInteger(main_model_p->dim_in_I02));
  SET_VECTOR_ELT(state, 578, ScalarInteger(main_model_p->dim_in_I02_1));
  SET_VECTOR_ELT(state, 579, ScalarInteger(main_model_p->dim_in_I02_2));
  SET_VECTOR_ELT(state, 580, allocVector(REALSXP, main_model_p->dim_in_I02));
  memcpy(REAL(VECTOR_ELT(state, 580)), main_model_p->in_I02, main_model_p->dim_in_I02 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 580), 2, main_model_p->dim_in_I02_1, main_model_p->dim_in_I02_2);
  SET_VECTOR_ELT(state, 581, ScalarInteger(main_model_p->dim_in_I03));
  SET_VECTOR_ELT(state, 582, ScalarInteger(main_model_p->dim_in_I03_1));
  SET_VECTOR_ELT(state, 583, ScalarInteger(main_model_p->dim_in_I03_2));
  SET_VECTOR_ELT(state, 584, allocVector(REALSXP, main_model_p->dim_in_I03));
  memcpy(REAL(VECTOR_ELT(state, 584)), main_model_p->in_I03, main_model_p->dim_in_I03 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 584), 2, main_model_p->dim_in_I03_1, main_model_p->dim_in_I03_2);
  SET_VECTOR_ELT(state, 585, ScalarInteger(main_model_p->dim_in_I04));
  SET_VECTOR_ELT(state, 586, ScalarInteger(main_model_p->dim_in_I04_1));
  SET_VECTOR_ELT(state, 587, ScalarInteger(main_model_p->dim_in_I04_2));
  SET_VECTOR_ELT(state, 588, allocVector(REALSXP, main_model_p->dim_in_I04));
  memcpy(REAL(VECTOR_ELT(state, 588)), main_model_p->in_I04, main_model_p->dim_in_I04 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 588), 2, main_model_p->dim_in_I04_1, main_model_p->dim_in_I04_2);
  SET_VECTOR_ELT(state, 589, ScalarInteger(main_model_p->dim_in_I05));
  SET_VECTOR_ELT(state, 590, ScalarInteger(main_model_p->dim_in_I05_1));
  SET_VECTOR_ELT(state, 591, ScalarInteger(main_model_p->dim_in_I05_2));
  SET_VECTOR_ELT(state, 592, allocVector(REALSXP, main_model_p->dim_in_I05));
  memcpy(REAL(VECTOR_ELT(state, 592)), main_model_p->in_I05, main_model_p->dim_in_I05 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 592), 2, main_model_p->dim_in_I05_1, main_model_p->dim_in_I05_2);
  SET_VECTOR_ELT(state, 593, ScalarInteger(main_model_p->dim_in_I22));
  SET_VECTOR_ELT(state, 594, ScalarInteger(main_model_p->dim_in_I22_1));
  SET_VECTOR_ELT(state, 595, ScalarInteger(main_model_p->dim_in_I22_2));
  SET_VECTOR_ELT(state, 596, allocVector(REALSXP, main_model_p->dim_in_I22));
  memcpy(REAL(VECTOR_ELT(state, 596)), main_model_p->in_I22, main_model_p->dim_in_I22 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 596), 2, main_model_p->dim_in_I22_1, main_model_p->dim_in_I22_2);
  SET_VECTOR_ELT(state, 597, ScalarInteger(main_model_p->dim_in_I23));
  SET_VECTOR_ELT(state, 598, ScalarInteger(main_model_p->dim_in_I23_1));
  SET_VECTOR_ELT(state, 599, ScalarInteger(main_model_p->dim_in_I23_2));
  SET_VECTOR_ELT(state, 600, allocVector(REALSXP, main_model_p->dim_in_I23));
  memcpy(REAL(VECTOR_ELT(state, 600)), main_model_p->in_I23, main_model_p->dim_in_I23 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 600), 2, main_model_p->dim_in_I23_1, main_model_p->dim_in_I23_2);
  SET_VECTOR_ELT(state, 601, ScalarInteger(main_model_p->dim_in_I24));
  SET_VECTOR_ELT(state, 602, ScalarInteger(main_model_p->dim_in_I24_1));
  SET_VECTOR_ELT(state, 603, ScalarInteger(main_model_p->dim_in_I24_2));
  SET_VECTOR_ELT(state, 604, allocVector(REALSXP, main_model_p->dim_in_I24));
  memcpy(REAL(VECTOR_ELT(state, 604)), main_model_p->in_I24, main_model_p->dim_in_I24 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 604), 2, main_model_p->dim_in_I24_1, main_model_p->dim_in_I24_2);
  SET_VECTOR_ELT(state, 605, ScalarInteger(main_model_p->dim_in_I25));
  SET_VECTOR_ELT(state, 606, ScalarInteger(main_model_p->dim_in_I25_1));
  SET_VECTOR_ELT(state, 607, ScalarInteger(main_model_p->dim_in_I25_2));
  SET_VECTOR_ELT(state, 608, allocVector(REALSXP, main_model_p->dim_in_I25));
  memcpy(REAL(VECTOR_ELT(state, 608)), main_model_p->in_I25, main_model_p->dim_in_I25 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 608), 2, main_model_p->dim_in_I25_1, main_model_p->dim_in_I25_2);
  SET_VECTOR_ELT(state, 609, ScalarInteger(main_model_p->dim_in_I32));
  SET_VECTOR_ELT(state, 610, ScalarInteger(main_model_p->dim_in_I32_1));
  SET_VECTOR_ELT(state, 611, ScalarInteger(main_model_p->dim_in_I32_2));
  SET_VECTOR_ELT(state, 612, allocVector(REALSXP, main_model_p->dim_in_I32));
  memcpy(REAL(VECTOR_ELT(state, 612)), main_model_p->in_I32, main_model_p->dim_in_I32 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 612), 2, main_model_p->dim_in_I32_1, main_model_p->dim_in_I32_2);
  SET_VECTOR_ELT(state, 613, ScalarInteger(main_model_p->dim_in_I33));
  SET_VECTOR_ELT(state, 614, ScalarInteger(main_model_p->dim_in_I33_1));
  SET_VECTOR_ELT(state, 615, ScalarInteger(main_model_p->dim_in_I33_2));
  SET_VECTOR_ELT(state, 616, allocVector(REALSXP, main_model_p->dim_in_I33));
  memcpy(REAL(VECTOR_ELT(state, 616)), main_model_p->in_I33, main_model_p->dim_in_I33 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 616), 2, main_model_p->dim_in_I33_1, main_model_p->dim_in_I33_2);
  SET_VECTOR_ELT(state, 617, ScalarInteger(main_model_p->dim_in_I34));
  SET_VECTOR_ELT(state, 618, ScalarInteger(main_model_p->dim_in_I34_1));
  SET_VECTOR_ELT(state, 619, ScalarInteger(main_model_p->dim_in_I34_2));
  SET_VECTOR_ELT(state, 620, allocVector(REALSXP, main_model_p->dim_in_I34));
  memcpy(REAL(VECTOR_ELT(state, 620)), main_model_p->in_I34, main_model_p->dim_in_I34 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 620), 2, main_model_p->dim_in_I34_1, main_model_p->dim_in_I34_2);
  SET_VECTOR_ELT(state, 621, ScalarInteger(main_model_p->dim_in_I35));
  SET_VECTOR_ELT(state, 622, ScalarInteger(main_model_p->dim_in_I35_1));
  SET_VECTOR_ELT(state, 623, ScalarInteger(main_model_p->dim_in_I35_2));
  SET_VECTOR_ELT(state, 624, allocVector(REALSXP, main_model_p->dim_in_I35));
  memcpy(REAL(VECTOR_ELT(state, 624)), main_model_p->in_I35, main_model_p->dim_in_I35 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 624), 2, main_model_p->dim_in_I35_1, main_model_p->dim_in_I35_2);
  SET_VECTOR_ELT(state, 625, ScalarInteger(main_model_p->dim_in_I42));
  SET_VECTOR_ELT(state, 626, ScalarInteger(main_model_p->dim_in_I42_1));
  SET_VECTOR_ELT(state, 627, ScalarInteger(main_model_p->dim_in_I42_2));
  SET_VECTOR_ELT(state, 628, allocVector(REALSXP, main_model_p->dim_in_I42));
  memcpy(REAL(VECTOR_ELT(state, 628)), main_model_p->in_I42, main_model_p->dim_in_I42 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 628), 2, main_model_p->dim_in_I42_1, main_model_p->dim_in_I42_2);
  SET_VECTOR_ELT(state, 629, ScalarInteger(main_model_p->dim_in_I43));
  SET_VECTOR_ELT(state, 630, ScalarInteger(main_model_p->dim_in_I43_1));
  SET_VECTOR_ELT(state, 631, ScalarInteger(main_model_p->dim_in_I43_2));
  SET_VECTOR_ELT(state, 632, allocVector(REALSXP, main_model_p->dim_in_I43));
  memcpy(REAL(VECTOR_ELT(state, 632)), main_model_p->in_I43, main_model_p->dim_in_I43 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 632), 2, main_model_p->dim_in_I43_1, main_model_p->dim_in_I43_2);
  SET_VECTOR_ELT(state, 633, ScalarInteger(main_model_p->dim_in_I44));
  SET_VECTOR_ELT(state, 634, ScalarInteger(main_model_p->dim_in_I44_1));
  SET_VECTOR_ELT(state, 635, ScalarInteger(main_model_p->dim_in_I44_2));
  SET_VECTOR_ELT(state, 636, allocVector(REALSXP, main_model_p->dim_in_I44));
  memcpy(REAL(VECTOR_ELT(state, 636)), main_model_p->in_I44, main_model_p->dim_in_I44 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 636), 2, main_model_p->dim_in_I44_1, main_model_p->dim_in_I44_2);
  SET_VECTOR_ELT(state, 637, ScalarInteger(main_model_p->dim_in_I45));
  SET_VECTOR_ELT(state, 638, ScalarInteger(main_model_p->dim_in_I45_1));
  SET_VECTOR_ELT(state, 639, ScalarInteger(main_model_p->dim_in_I45_2));
  SET_VECTOR_ELT(state, 640, allocVector(REALSXP, main_model_p->dim_in_I45));
  memcpy(REAL(VECTOR_ELT(state, 640)), main_model_p->in_I45, main_model_p->dim_in_I45 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 640), 2, main_model_p->dim_in_I45_1, main_model_p->dim_in_I45_2);
  SET_VECTOR_ELT(state, 641, ScalarInteger(main_model_p->dim_rate_move_in));
  SET_VECTOR_ELT(state, 642, ScalarInteger(main_model_p->dim_rate_move_in_1));
  SET_VECTOR_ELT(state, 643, ScalarInteger(main_model_p->dim_rate_move_in_2));
  SET_VECTOR_ELT(state, 644, allocVector(REALSXP, main_model_p->dim_rate_move_in));
  memcpy(REAL(VECTOR_ELT(state, 644)), main_model_p->rate_move_in, main_model_p->dim_rate_move_in * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 644), 2, main_model_p->dim_rate_move_in_1, main_model_p->dim_rate_move_in_2);
  SET_VECTOR_ELT(state, 645, ScalarInteger(main_model_p->offset_output_rate_move_in));
  SET_VECTOR_ELT(state, 646, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_VECTOR_ELT(state, 647, allocVector(REALSXP, main_model_p->dim_rate_move_out));
  memcpy(REAL(VECTOR_ELT(state, 647)), main_model_p->rate_move_out, main_model_p->dim_rate_move_out * sizeof(double));
  SET_VECTOR_ELT(state, 648, ScalarInteger(main_model_p->offset_output_rate_move_out));
  SET_VECTOR_ELT(state, 654, ScalarReal(main_model_p->epsilon));
  SET_VECTOR_ELT(state, 665, ScalarInteger(main_model_p->dim));
  SET_VECTOR_ELT(state, 666, ScalarInteger(main_model_p->dim_output));
  SEXP state_names = PROTECT(allocVector(STRSXP, 667));
  ...
  SET_STRING_ELT(state_names, 27, mkChar("PrEPOnOff"));
  SET_STRING_ELT(state_names, 28, mkChar("fPa"));
  SET_STRING_ELT(state_names, 29, mkChar("fPb"));
  SET_STRING_ELT(state_names, 30, mkChar("fPc"));
  SET_STRING_ELT(state_names, 31, mkChar("RR_test_onPrEP"));
  SET_STRING_ELT(state_names, 32, mkChar("RR_test_CD4200"));
  SET_STRING_ELT(state_names, 33, mkChar("RR_ART_CD4200"));
  SET_STRING_ELT(state_names, 34, mkChar("Ncat"));
  SET_STRING_ELT(state_names, 35, mkChar("Nage"));
  SET_STRING_ELT(state_names, 36, mkChar("infect_ART"));
  SET_STRING_ELT(state_names, 37, mkChar("infect_acute"));
  SET_STRING_ELT(state_names, 38, mkChar("infect_AIDS"));
  SET_STRING_ELT(state_names, 39, mkChar("nu"));
  SET_STRING_ELT(state_names, 40, mkChar("R"));
  SET_STRING_ELT(state_names, 41, mkChar("dim_epsilon_t"));
  SET_STRING_ELT(state_names, 42, mkChar("epsilon_t"));
  SET_STRING_ELT(state_names, 43, mkChar("dim_epsilon_y"));
  SET_STRING_ELT(state_names, 44, mkChar("epsilon_y"));
  SET_STRING_ELT(state_names, 45, mkChar("dim_fc_t_comm"));
  SET_STRING_ELT(state_names, 46, mkChar("fc_t_comm"));
  SET_STRING_ELT(state_names, 47, mkChar("dim_fc_y_comm"));
  SET_STRING_ELT(state_names, 48, mkChar("dim_fc_y_comm_1"));
  SET_STRING_ELT(state_names, 49, mkChar("dim_fc_y_comm_2"));
  SET_STRING_ELT(state_names, 50, mkChar("dim_fc_y_comm_3"));
  SET_STRING_ELT(state_names, 51, mkChar("dim_fc_y_comm_12"));
  SET_STRING_ELT(state_names, 52, mkChar("fc_y_comm"));
  SET_STRING_ELT(state_names, 53, mkChar("dim_fP_t_comm"));
  SET_STRING_ELT(state_names, 54, mkChar("fP_t_comm"));
  SET_STRING_ELT(state_names, 55, mkChar("dim_fP_y_comm"));
  SET_STRING_ELT(state_names, 56, mkChar("dim_fP_y_comm_1"));
  SET_STRING_ELT(state_names, 57, mkChar("dim_fP_y_comm_2"));
  SET_STRING_ELT(state_names, 58, mkChar("fP_y_comm"));
  SET_STRING_ELT(state_names, 59, mkChar("dim_fc_t_noncomm"));
  SET_STRING_ELT(state_names, 60, mkChar("fc_t_noncomm"));
  SET_STRING_ELT(state_names, 61, mkChar("dim_fc_y_noncomm"));
  SET_STRING_ELT(state_names, 62, mkChar("dim_fc_y_noncomm_1"));
  SET_STRING_ELT(state_names, 63, mkChar("dim_fc_y_noncomm_2"));
  SET_STRING_ELT(state_names, 64, mkChar("dim_fc_y_noncomm_3"));
  SET_STRING_ELT(state_names, 65, mkChar("dim_fc_y_noncomm_12"));
  SET_STRING_ELT(state_names, 66, mkChar("fc_y_noncomm"));
  SET_STRING_ELT(state_names, 67, mkChar("dim_fP_t_noncomm"));
  SET_STRING_ELT(state_names, 68, mkChar("fP_t_noncomm"));
  SET_STRING_ELT(state_names, 69, mkChar("dim_fP_y_noncomm"));
  SET_STRING_ELT(state_names, 70, mkChar("dim_fP_y_noncomm_1"));
  SET_STRING_ELT(state_names, 71, mkChar("dim_fP_y_noncomm_2"));
  SET_STRING_ELT(state_names, 72, mkChar("fP_y_noncomm"));
  SET_STRING_ELT(state_names, 73, mkChar("dim_n_t_comm"));
  SET_STRING_ELT(state_names, 74, mkChar("n_t_comm"));
  SET_STRING_ELT(state_names, 75, mkChar("dim_n_y_comm"));
  SET_STRING_ELT(state_names, 76, mkChar("dim_n_y_comm_1"));
  SET_STRING_ELT(state_names, 77, mkChar("dim_n_y_comm_2"));
  SET_STRING_ELT(state_names, 78, mkChar("dim_n_y_comm_3"));
  SET_STRING_ELT(state_names, 79, mkChar("dim_n_y_comm_12"));
  SET_STRING_ELT(state_names, 80, mkChar("n_y_comm"));
  SET_STRING_ELT(state_names, 81, mkChar("dim_n_t_noncomm"));
  SET_STRING_ELT(state_names, 82, mkChar("n_t_noncomm"));
  SET_STRING_ELT(state_names, 83, mkChar("dim_n_y_noncomm"));
  SET_STRING_ELT(state_names, 84, mkChar("dim_n_y_noncomm_1"));
  SET_STRING_ELT(state_names, 85, mkChar("dim_n_y_noncomm_2"));
  SET_STRING_ELT(state_names, 86, mkChar("dim_n_y_noncomm_3"));
  SET_STRING_ELT(state_names, 87, mkChar("dim_n_y_noncomm_12"));
  SET_STRING_ELT(state_names, 88, mkChar("n_y_noncomm"));
  SET_STRING_ELT(state_names, 89, mkChar("dur_FSW"));
  SET_STRING_ELT(state_names, 90, mkChar("dim_zetaa_t"));
  SET_STRING_ELT(state_names, 91, mkChar("zetaa_t"));
  SET_STRING_ELT(state_names, 92, mkChar("dim_zetab_t"));
  SET_STRING_ELT(state_names, 93, mkChar("zetab_t"));
  SET_STRING_ELT(state_names, 94, mkChar("dim_zetac_t"));
  SET_STRING_ELT(state_names, 95, mkChar("zetac_t"));
  SET_STRING_ELT(state_names, 96, mkChar("dim_zetaa_y"));
  SET_STRING_ELT(state_names, 97, mkChar("dim_zetaa_y_1"));
  SET_STRING_ELT(state_names, 98, mkChar("dim_zetaa_y_2"));
  SET_STRING_ELT(state_names, 99, mkChar("zetaa_y"));
  SET_STRING_ELT(state_names, 100, mkChar("dim_zetab_y"));
  SET_STRING_ELT(state_names, 101, mkChar("dim_zetab_y_1"));
  SET_STRING_ELT(state_names, 102, mkChar("dim_zetab_y_2"));
  SET_STRING_ELT(state_names, 103, mkChar("zetab_y"));
  SET_STRING_ELT(state_names, 104, mkChar("dim_zetac_y"));
  SET_STRING_ELT(state_names, 105, mkChar("dim_zetac_y_1"));
  SET_STRING_ELT(state_names, 106, mkChar("dim_zetac_y_2"));
  SET_STRING_ELT(state_names, 107, mkChar("zetac_y"));
  SET_STRING_ELT(state_names, 108, mkChar("dim_prep_intervention_t"));
  SET_STRING_ELT(state_names, 109, mkChar("prep_intervention_t"));
  SET_STRING_ELT(state_names, 110, mkChar("dim_prep_intervention_y"));
  SET_STRING_ELT(state_names, 111, mkChar("dim_prep_intervention_y_1"));
  SET_STRING_ELT(state_names, 112, mkChar("dim_prep_intervention_y_2"));
  SET_STRING_ELT(state_names, 113, mkChar("prep_intervention_y"));
  SET_STRING_ELT(state_names, 114, mkChar("dim_c_comm"));
  SET_STRING_ELT(state_names, 115, mkChar("c_comm"));
  SET_STRING_ELT(state_names, 116, mkChar("offset_output_c_comm"));
  SET_STRING_ELT(state_names, 117, mkChar("dim_c_noncomm"));
  SET_STRING_ELT(state_names, 118, mkChar("c_noncomm"));
  SET_STRING_ELT(state_names, 119, mkChar("offset_output_c_noncomm"));
  SET_STRING_ELT(state_names, 120, mkChar("dim_new_people_in_group"));
  SET_STRING_ELT(state_names, 121, mkChar("new_people_in_group"));
  SET_STRING_ELT(state_names, 122, mkChar("offset_output_new_people_in_group"));
  SET_STRING_ELT(state_names, 123, mkChar("dim_comm_partnerships_requested"));
  SET_STRING_ELT(state_names, 124, mkChar("dim_comm_partnerships_requested_1"));
  SET_STRING_ELT(state_names, 125, mkChar("dim_comm_partnerships_requested_2"));
  SET_STRING_ELT(state_names, 126, mkChar("comm_partnerships_requested"));
  SET_STRING_ELT(state_names, 127, mkChar("dim_noncomm_partnerships_requested"));
  SET_STRING_ELT(state_names, 128, mkChar("dim_noncomm_partnerships_requested_1"));
  SET_STRING_ELT(state_names, 129, mkChar("dim_noncomm_partnerships_requested_2"));
  SET_STRING_ELT(state_names, 130, mkChar("noncomm_partnerships_requested"));
  SET_STRING_ELT(state_names, 131, mkChar("dim_testing_prob"));
  SET_STRING_ELT(state_names, 132, mkChar("testing_prob"));
  SET_STRING_ELT(state_names, 133, mkChar("offset_output_testing_prob"));
  SET_STRING_ELT(state_names, 134, mkChar("dim_ART_prob"));
  SET_STRING_ELT(state_names, 135, mkChar("ART_prob"));
  SET_STRING_ELT(state_names, 136, mkChar("offset_output_ART_prob"));
  SET_STRING_ELT(state_names, 137, mkChar("dim_zeta"));
  SET_STRING_ELT(state_names, 138, mkChar("zeta"));
  SET_STRING_ELT(state_names, 139, mkChar("offset_output_zeta"));
  SET_STRING_ELT(state_names, 140, mkChar("dim_sigma"));
  SET_STRING_ELT(state_names, 141, mkChar("sigma"));
  SET_STRING_ELT(state_names, 142, mkChar("dim_tau"));
  SET_STRING_ELT(state_names, 143, mkChar("tau"));
  SET_STRING_ELT(state_names, 144, mkChar("offset_output_tau"));
  SET_STRING_ELT(state_names, 145, mkChar("dim_test_rate_prep"));
  SET_STRING_ELT(state_names, 146, mkChar("test_rate_prep"));
  SET_STRING_ELT(state_names, 147, mkChar("dim_rho"));
  SET_STRING_ELT(state_names, 148, mkChar("rho"));
  SET_STRING_ELT(state_names, 149, mkChar("offset_output_rho"));
  SET_STRING_ELT(state_names, 150, mkChar("dim_iota"));
  SET_STRING_ELT(state_names, 151, mkChar("iota"));
  SET_STRING_ELT(state_names, 152, mkChar("offset_output_iota"));
  SET_STRING_ELT(state_names, 153, mkChar("dim_frac_F"));
  SET_STRING_ELT(state_names, 154, mkChar("frac_F"));
  SET_STRING_ELT(state_names, 155, mkChar("offset_output_frac_F"));
  SET_STRING_ELT(state_names, 156, mkChar("dim_frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 157, mkChar("frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 158, mkChar("offset_output_frac_N_sexualpop"));
  SET_STRING_ELT(state_names, 159, mkChar("dim_zetaa"));
  SET_STRING_ELT(state_names, 160, mkChar("zetaa"));
  SET_STRING_ELT(state_names, 161, mkChar("offset_output_zetaa"));
  SET_STRING_ELT(state_names, 162, mkChar("dim_zetab"));
  SET_STRING_ELT(state_names, 163, mkChar("zetab"));
  SET_STRING_ELT(state_names, 164, mkChar("offset_output_zetab"));
  SET_STRING_ELT(state_names, 165, mkChar("dim_zetac"));
  SET_STRING_ELT(state_names, 166, mkChar("zetac"));
  SET_STRING_ELT(state_names, 167, mkChar("offset_output_zetac"));
  SET_STRING_ELT(state_names, 168, mkChar("dim_prep_intervention"));
  SET_STRING_ELT(state_names, 169, mkChar("prep_intervention"));
  SET_STRING_ELT(state_names, 170, mkChar("dim_omega"));
  SET_STRING_ELT(state_names, 171, mkChar("omega"));
  SET_STRING_ELT(state_names, 172, mkChar("offset_output_omega"));
  SET_STRING_ELT(state_names, 173, mkChar("dim_frac_N"));
  SET_STRING_ELT(state_names, 174, mkChar("frac_N"));
  SET_STRING_ELT(state_names, 175, mkChar("offset_output_frac_N"));
  SET_STRING_ELT(state_names, 176, mkChar("dim_mu"));
  SET_STRING_ELT(state_names, 177, mkChar("mu"));
  SET_STRING_ELT(state_names, 178, mkChar("offset_output_mu"));
  SET_STRING_ELT(state_names, 179, mkChar("dim_gamma01"));
  SET_STRING_ELT(state_names, 180, mkChar("gamma01"));
  SET_STRING_ELT(state_names, 181, mkChar("offset_output_gamma01"));
  SET_STRING_ELT(state_names, 182, mkChar("dim_gamma02"));
  SET_STRING_ELT(state_names, 183, mkChar("gamma02"));
  SET_STRING_ELT(state_names, 184, mkChar("dim_gamma03"));
  SET_STRING_ELT(state_names, 185, mkChar("gamma03"));
  SET_STRING_ELT(state_names, 186, mkChar("dim_gamma04"));
  SET_STRING_ELT(state_names, 187, mkChar("gamma04"));
  SET_STRING_ELT(state_names, 188, mkChar("dim_gamma11"));
  SET_STRING_ELT(state_names, 189, mkChar("gamma11"));
  SET_STRING_ELT(state_names, 190, mkChar("offset_output_gamma11"));
  SET_STRING_ELT(state_names, 191, mkChar("dim_gamma22"));
  SET_STRING_ELT(state_names, 192, mkChar("gamma22"));
  SET_STRING_ELT(state_names, 193, mkChar("dim_gamma23"));
  SET_STRING_ELT(state_names, 194, mkChar("gamma23"));
  SET_STRING_ELT(state_names, 195, mkChar("dim_gamma24"));
  SET_STRING_ELT(state_names, 196, mkChar("gamma24"));
  SET_STRING_ELT(state_names, 197, mkChar("dim_gamma32"));
  SET_STRING_ELT(state_names, 198, mkChar("gamma32"));
  SET_STRING_ELT(state_names, 199, mkChar("dim_gamma33"));
  SET_STRING_ELT(state_names, 200, mkChar("gamma33"));
  SET_STRING_ELT(state_names, 201, mkChar("dim_gamma34"));
  SET_STRING_ELT(state_names, 202, mkChar("gamma34"));
  SET_STRING_ELT(state_names, 203, mkChar("dim_gamma42"));
  SET_STRING_ELT(state_names, 204, mkChar("gamma42"));
  SET_STRING_ELT(state_names, 205, mkChar("dim_gamma43"));
  SET_STRING_ELT(state_names, 206, mkChar("gamma43"));
  SET_STRING_ELT(state_names, 207, mkChar("dim_gamma44"));
  SET_STRING_ELT(state_names, 208, mkChar("gamma44"));
  SET_STRING_ELT(state_names, 209, mkChar("dim_phi2"));
  SET_STRING_ELT(state_names, 210, mkChar("phi2"));
  SET_STRING_ELT(state_names, 211, mkChar("dim_phi3"));
  SET_STRING_ELT(state_names, 212, mkChar("phi3"));
  SET_STRING_ELT(state_names, 213, mkChar("dim_phi4"));
  SET_STRING_ELT(state_names, 214, mkChar("phi4"));
  SET_STRING_ELT(state_names, 215, mkChar("dim_phi5"));
  SET_STRING_ELT(state_names, 216, mkChar("phi5"));
  SET_STRING_ELT(state_names, 217, mkChar("dim_psia"));
  SET_STRING_ELT(state_names, 218, mkChar("psia"));
  SET_STRING_ELT(state_names, 219, mkChar("dim_psib"));
  SET_STRING_ELT(state_names, 220, mkChar("psib"));
  SET_STRING_ELT(state_names, 221, mkChar("dim_kappaa"));
  SET_STRING_ELT(state_names, 222, mkChar("kappaa"));
  SET_STRING_ELT(state_names, 223, mkChar("offset_output_kappaa"));
  SET_STRING_ELT(state_names, 224, mkChar("dim_kappab"));
  SET_STRING_ELT(state_names, 225, mkChar("kappab"));
  SET_STRING_ELT(state_names, 226, mkChar("offset_output_kappab"));
  SET_STRING_ELT(state_names, 227, mkChar("dim_kappac"));
  SET_STRING_ELT(state_names, 228, mkChar("kappac"));
  SET_STRING_ELT(state_names, 229, mkChar("offset_output_kappac"));
  SET_STRING_ELT(state_names, 230, mkChar("dim_kappa1"));
  SET_STRING_ELT(state_names, 231, mkChar("kappa1"));
  SET_STRING_ELT(state_names, 232, mkChar("offset_output_kappa1"));
  SET_STRING_ELT(state_names, 233, mkChar("dim_alpha01"));
  SET_STRING_ELT(state_names, 234, mkChar("alpha01"));
  SET_STRING_ELT(state_names, 235, mkChar("offset_output_alpha01"));
  SET_STRING_ELT(state_names, 236, mkChar("dim_alpha02"));
  SET_STRING_ELT(state_names, 237, mkChar("alpha02"));
  SET_STRING_ELT(state_names, 238, mkChar("offset_output_alpha02"));
  SET_STRING_ELT(state_names, 239, mkChar("dim_alpha03"));
  SET_STRING_ELT(state_names, 240, mkChar("alpha03"));
  SET_STRING_ELT(state_names, 241, mkChar("dim_alpha04"));
  SET_STRING_ELT(state_names, 242, mkChar("alpha04"));
  SET_STRING_ELT(state_names, 243, mkChar("dim_alpha05"));
  SET_STRING_ELT(state_names, 244, mkChar("alpha05"));
  SET_STRING_ELT(state_names, 245, mkChar("offset_output_alpha05"));
  SET_STRING_ELT(state_names, 246, mkChar("dim_alpha11"));
  SET_STRING_ELT(state_names, 247, mkChar("alpha11"));
  SET_STRING_ELT(state_names, 248, mkChar("offset_output_alpha11"));
  SET_STRING_ELT(state_names, 249, mkChar("dim_alpha22"));
  SET_STRING_ELT(state_names, 250, mkChar("alpha22"));
  SET_STRING_ELT(state_names, 251, mkChar("offset_output_alpha22"));
  SET_STRING_ELT(state_names, 252, mkChar("dim_alpha23"));
  SET_STRING_ELT(state_names, 253, mkChar("alpha23"));
  SET_STRING_ELT(state_names, 254, mkChar("dim_alpha24"));
  SET_STRING_ELT(state_names, 255, mkChar("alpha24"));
  SET_STRING_ELT(state_names, 256, mkChar("dim_alpha25"));
  SET_STRING_ELT(state_names, 257, mkChar("alpha25"));
  SET_STRING_ELT(state_names, 258, mkChar("dim_alpha32"));
  SET_STRING_ELT(state_names, 259, mkChar("alpha32"));
  SET_STRING_ELT(state_names, 260, mkChar("dim_alpha33"));
  SET_STRING_ELT(state_names, 261, mkChar("alpha33"));
  SET_STRING_ELT(state_names, 262, mkChar("dim_alpha34"));
  SET_STRING_ELT(state_names, 263, mkChar("alpha34"));
  SET_STRING_ELT(state_names, 264, mkChar("dim_alpha35"));
  SET_STRING_ELT(state_names, 265, mkChar("alpha35"));
  SET_STRING_ELT(state_names, 266, mkChar("offset_output_alpha35"));
  SET_STRING_ELT(state_names, 267, mkChar("dim_alpha42"));
  SET_STRING_ELT(state_names, 268, mkChar("alpha42"));
  SET_STRING_ELT(state_names, 269, mkChar("dim_alpha43"));
  SET_STRING_ELT(state_names, 270, mkChar("alpha43"));
  SET_STRING_ELT(state_names, 271, mkChar("dim_alpha44"));
  SET_STRING_ELT(state_names, 272, mkChar("alpha44"));
  SET_STRING_ELT(state_names, 273, mkChar("dim_alpha45"));
  SET_STRING_ELT(state_names, 274, mkChar("alpha45"));
  SET_STRING_ELT(state_names, 275, mkChar("dim_beta_comm"));
  SET_STRING_ELT(state_names, 276, mkChar("beta_comm"));
  SET_STRING_ELT(state_names, 277, mkChar("offset_output_beta_comm"));
  SET_STRING_ELT(state_names, 278, mkChar("dim_beta_noncomm"));
  SET_STRING_ELT(state_names, 279, mkChar("beta_noncomm"));
  SET_STRING_ELT(state_names, 280, mkChar("offset_output_beta_noncomm"));
  SET_STRING_ELT(state_names, 281, mkChar("dim_p_comm"));
  SET_STRING_ELT(state_names, 282, mkChar("dim_p_comm_1"));
  SET_STRING_ELT(state_names, 283, mkChar("dim_p_comm_2"));
  SET_STRING_ELT(state_names, 284, mkChar("p_comm"));
  SET_STRING_ELT(state_names, 285, mkChar("offset_output_p_comm"));
  SET_STRING_ELT(state_names, 286, mkChar("dim_p_noncomm"));
  SET_STRING_ELT(state_names, 287, mkChar("dim_p_noncomm_1"));
  SET_STRING_ELT(state_names, 288, mkChar("dim_p_noncomm_2"));
  SET_STRING_ELT(state_names, 289, mkChar("p_noncomm"));
  SET_STRING_ELT(state_names, 290, mkChar("offset_output_p_noncomm"));
  SET_STRING_ELT(state_names, 291, mkChar("dim_ec"));
  SET_STRING_ELT(state_names, 292, mkChar("ec"));
  SET_STRING_ELT(state_names, 293, mkChar("dim_eP"));
  SET_STRING_ELT(state_names, 294, mkChar("eP"));
  SET_STRING_ELT(state_names, 295, mkChar("dim_eP0"));
  SET_STRING_ELT(state_names, 296, mkChar("eP0"));
  SET_STRING_ELT(state_names, 297, mkChar("dim_eP1a"));
  SET_STRING_ELT(state_names, 298, mkChar("eP1a"));
  SET_STRING_ELT(state_names, 299, mkChar("dim_eP1b"));
  SET_STRING_ELT(state_names, 300, mkChar("eP1b"));
  SET_STRING_ELT(state_names, 301, mkChar("dim_eP1c"));
  SET_STRING_ELT(state_names, 302, mkChar("eP1c"));
  SET_STRING_ELT(state_names, 303, mkChar("dim_eP1d"));
  SET_STRING_ELT(state_names, 304, mkChar("eP1d"));
  SET_STRING_ELT(state_names, 305, mkChar("dim_fc_comm"));
  SET_STRING_ELT(state_names, 306, mkChar("dim_fc_comm_1"));
  SET_STRING_ELT(state_names, 307, mkChar("dim_fc_comm_2"));
  SET_STRING_ELT(state_names, 308, mkChar("fc_comm"));
  SET_STRING_ELT(state_names, 309, mkChar("offset_output_fc_comm"));
  SET_STRING_ELT(state_names, 310, mkChar("dim_fP_comm"));
  SET_STRING_ELT(state_names, 311, mkChar("fP_comm"));
  SET_STRING_ELT(state_names, 312, mkChar("offset_output_fP_comm"));
  SET_STRING_ELT(state_names, 313, mkChar("dim_fc_noncomm"));
  SET_STRING_ELT(state_names, 314, mkChar("dim_fc_noncomm_1"));
  SET_STRING_ELT(state_names, 315, mkChar("dim_fc_noncomm_2"));
  SET_STRING_ELT(state_names, 316, mkChar("fc_noncomm"));
  SET_STRING_ELT(state_names, 317, mkChar("offset_output_fc_noncomm"));
  SET_STRING_ELT(state_names, 318, mkChar("dim_fP_noncomm"));
  SET_STRING_ELT(state_names, 319, mkChar("fP_noncomm"));
  SET_STRING_ELT(state_names, 320, mkChar("offset_output_fP_noncomm"));
  SET_STRING_ELT(state_names, 321, mkChar("dim_n_comm"));
  SET_STRING_ELT(state_names, 322, mkChar("dim_n_comm_1"));
  SET_STRING_ELT(state_names, 323, mkChar("dim_n_comm_2"));
  SET_STRING_ELT(state_names, 324, mkChar("n_comm"));
  SET_STRING_ELT(state_names, 325, mkChar("offset_output_n_comm"));
  SET_STRING_ELT(state_names, 326, mkChar("dim_n_noncomm"));
  SET_STRING_ELT(state_names, 327, mkChar("dim_n_noncomm_1"));
  SET_STRING_ELT(state_names, 328, mkChar("dim_n_noncomm_2"));
  SET_STRING_ELT(state_names, 329, mkChar("n_noncomm"));
  SET_STRING_ELT(state_names, 330, mkChar("offset_output_n_noncomm"));
  SET_STRING_ELT(state_names, 331, mkChar("dim_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 332, mkChar("initial_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 333, mkChar("offset_cumuHIVDeaths"));
  SET_STRING_ELT(state_names, 334, mkChar("dim_cumuInf"));
  SET_STRING_ELT(state_names, 335, mkChar("initial_cumuInf"));
  SET_STRING_ELT(state_names, 336, mkChar("offset_cumuInf"));
  SET_STRING_ELT(state_names, 337, mkChar("dim_OnPrEP"));
  SET_STRING_ELT(state_names, 338, mkChar("initial_OnPrEP"));
  SET_STRING_ELT(state_names, 339, mkChar("offset_OnPrEP"));
  SET_STRING_ELT(state_names, 340, mkChar("dim_S0"));
  SET_STRING_ELT(state_names, 341, mkChar("initial_S0"));
  SET_STRING_ELT(state_names, 342, mkChar("offset_S0"));
  SET_STRING_ELT(state_names, 343, mkChar("dim_S1a"));
  SET_STRING_ELT(state_names, 344, mkChar("initial_S1a"));
  SET_STRING_ELT(state_names, 345, mkChar("offset_S1a"));
  SET_STRING_ELT(state_names, 346, mkChar("dim_S1b"));
  SET_STRING_ELT(state_names, 347, mkChar("initial_S1b"));
  SET_STRING_ELT(state_names, 348, mkChar("offset_S1b"));
  SET_STRING_ELT(state_names, 349, mkChar("dim_S1c"));
  SET_STRING_ELT(state_names, 350, mkChar("initial_S1c"));
  SET_STRING_ELT(state_names, 351, mkChar("offset_S1c"));
  SET_STRING_ELT(state_names, 352, mkChar("dim_S1d"));
  SET_STRING_ELT(state_names, 353, mkChar("initial_S1d"));
  SET_STRING_ELT(state_names, 354, mkChar("offset_S1d"));
  SET_STRING_ELT(state_names, 355, mkChar("dim_I01"));
  SET_STRING_ELT(state_names, 356, mkChar("initial_I01"));
  SET_STRING_ELT(state_names, 357, mkChar("offset_I01"));
  SET_STRING_ELT(state_names, 358, mkChar("dim_I11"));
  SET_STRING_ELT(state_names, 359, mkChar("initial_I11"));
  SET_STRING_ELT(state_names, 360, mkChar("offset_I11"));
  SET_STRING_ELT(state_names, 361, mkChar("dim_I02"));
  SET_STRING_ELT(state_names, 362, mkChar("initial_I02"));
  SET_STRING_ELT(state_names, 363, mkChar("offset_I02"));
  SET_STRING_ELT(state_names, 364, mkChar("dim_I03"));
  SET_STRING_ELT(state_names, 365, mkChar("initial_I03"));
  SET_STRING_ELT(state_names, 366, mkChar("offset_I03"));
  SET_STRING_ELT(state_names, 367, mkChar("dim_I04"));
  SET_STRING_ELT(state_names, 368, mkChar("initial_I04"));
  SET_STRING_ELT(state_names, 369, mkChar("offset_I04"));
  SET_STRING_ELT(state_names, 370, mkChar("dim_I05"));
  SET_STRING_ELT(state_names, 371, mkChar("initial_I05"));
  SET_STRING_ELT(state_names, 372, mkChar("offset_I05"));
  SET_STRING_ELT(state_names, 373, mkChar("dim_I22"));
  SET_STRING_ELT(state_names, 374, mkChar("initial_I22"));
  SET_STRING_ELT(state_names, 375, mkChar("offset_I22"));
  SET_STRING_ELT(state_names, 376, mkChar("dim_I23"));
  SET_STRING_ELT(state_names, 377, mkChar("initial_I23"));
  SET_STRING_ELT(state_names, 378, mkChar("offset_I23"));
  SET_STRING_ELT(state_names, 379, mkChar("dim_I24"));
  SET_STRING_ELT(state_names, 380, mkChar("initial_I24"));
  SET_STRING_ELT(state_names, 381, mkChar("offset_I24"));
  SET_STRING_ELT(state_names, 382, mkChar("dim_I25"));
  SET_STRING_ELT(state_names, 383, mkChar("initial_I25"));
  SET_STRING_ELT(state_names, 384, mkChar("offset_I25"));
  SET_STRING_ELT(state_names, 385, mkChar("dim_I32"));
  SET_STRING_ELT(state_names, 386, mkChar("initial_I32"));
  SET_STRING_ELT(state_names, 387, mkChar("offset_I32"));
  SET_STRING_ELT(state_names, 388, mkChar("dim_I33"));
  SET_STRING_ELT(state_names, 389, mkChar("initial_I33"));
  SET_STRING_ELT(state_names, 390, mkChar("offset_I33"));
  SET_STRING_ELT(state_names, 391, mkChar("dim_I34"));
  SET_STRING_ELT(state_names, 392, mkChar("initial_I34"));
  SET_STRING_ELT(state_names, 393, mkChar("offset_I34"));
  SET_STRING_ELT(state_names, 394, mkChar("dim_I35"));
  SET_STRING_ELT(state_names, 395, mkChar("initial_I35"));
  SET_STRING_ELT(state_names, 396, mkChar("offset_I35"));
  SET_STRING_ELT(state_names, 397, mkChar("dim_I42"));
  SET_STRING_ELT(state_names, 398, mkChar("initial_I42"));
  SET_STRING_ELT(state_names, 399, mkChar("offset_I42"));
  SET_STRING_ELT(state_names, 400, mkChar("dim_I43"));
  SET_STRING_ELT(state_names, 401, mkChar("initial_I43"));
  SET_STRING_ELT(state_names, 402, mkChar("offset_I43"));
  SET_STRING_ELT(state_names, 403, mkChar("dim_I44"));
  SET_STRING_ELT(state_names, 404, mkChar("initial_I44"));
  SET_STRING_ELT(state_names, 405, mkChar("offset_I44"));
  SET_STRING_ELT(state_names, 406, mkChar("dim_I45"));
  SET_STRING_ELT(state_names, 407, mkChar("initial_I45"));
  SET_STRING_ELT(state_names, 408, mkChar("offset_I45"));
  SET_STRING_ELT(state_names, 409, mkChar("dim_S0_init"));
  SET_STRING_ELT(state_names, 410, mkChar("S0_init"));
  SET_STRING_ELT(state_names, 411, mkChar("dim_S1a_init"));
  SET_STRING_ELT(state_names, 412, mkChar("S1a_init"));
  SET_STRING_ELT(state_names, 413, mkChar("dim_S1b_init"));
  SET_STRING_ELT(state_names, 414, mkChar("S1b_init"));
  SET_STRING_ELT(state_names, 415, mkChar("dim_S1c_init"));
  SET_STRING_ELT(state_names, 416, mkChar("S1c_init"));
  SET_STRING_ELT(state_names, 417, mkChar("dim_S1d_init"));
  SET_STRING_ELT(state_names, 418, mkChar("S1d_init"));
  SET_STRING_ELT(state_names, 419, mkChar("dim_I01_init"));
  SET_STRING_ELT(state_names, 420, mkChar("I01_init"));
  SET_STRING_ELT(state_names, 421, mkChar("dim_I11_init"));
  SET_STRING_ELT(state_names, 422, mkChar("I11_init"));
  SET_STRING_ELT(state_names, 423, mkChar("dim_I02_init"));
  SET_STRING_ELT(state_names, 424, mkChar("I02_init"));
  SET_STRING_ELT(state_names, 425, mkChar("dim_I03_init"));
  SET_STRING_ELT(state_names, 426, mkChar("I03_init"));
  SET_STRING_ELT(state_names, 427, mkChar("dim_I04_init"));
  SET_STRING_ELT(state_names, 428, mkChar("I04_init"));
  SET_STRING_ELT(state_names, 429, mkChar("dim_I05_init"));
  SET_STRING_ELT(state_names, 430, mkChar("I05_init"));
  SET_STRING_ELT(state_names, 431, mkChar("dim_I22_init"));
  SET_STRING_ELT(state_names, 432, mkChar("I22_init"));
  SET_STRING_ELT(state_names, 433, mkChar("dim_I23_init"));
  SET_STRING_ELT(state_names, 434, mkChar("I23_init"));
  SET_STRING_ELT(state_names, 435, mkChar("dim_I24_init"));
  SET_STRING_ELT(state_names, 436, mkChar("I24_init"));
  SET_STRING_ELT(state_names, 437, mkChar("dim_I25_init"));
  SET_STRING_ELT(state_names, 438, mkChar("I25_init"));
  SET_STRING_ELT(state_names, 439, mkChar("dim_I32_init"));
  SET_STRING_ELT(state_names, 440, mkChar("I32_init"));
  SET_STRING_ELT(state_names, 441, mkChar("dim_I33_init"));
  SET_STRING_ELT(state_names, 442, mkChar("I33_init"));
  SET_STRING_ELT(state_names, 443, mkChar("dim_I34_init"));
  SET_STRING_ELT(state_names, 444, mkChar("I34_init"));
  SET_STRING_ELT(state_names, 445, mkChar("dim_I35_init"));
  SET_STRING_ELT(state_names, 446, mkChar("I35_init"));
  SET_STRING_ELT(state_names, 447, mkChar("dim_I42_init"));
  SET_STRING_ELT(state_names, 448, mkChar("I42_init"));
  SET_STRING_ELT(state_names, 449, mkChar("dim_I43_init"));
  SET_STRING_ELT(state_names, 450, mkChar("I43_init"));
  SET_STRING_ELT(state_names, 451, mkChar("dim_I44_init"));
  SET_STRING_ELT(state_names, 452, mkChar("I44_init"));
  SET_STRING_ELT(state_names, 453, mkChar("dim_I45_init"));
  SET_STRING_ELT(state_names, 454, mkChar("I45_init"));
  SET_STRING_ELT(state_names, 455, mkChar("dim_N"));
  SET_STRING_ELT(state_names, 456, mkChar("N"));
  SET_STRING_ELT(state_names, 457, mkChar("offset_output_N"));
  SET_STRING_ELT(state_names, 458, mkChar("dim_E0"));
  SET_STRING_ELT(state_names, 459, mkChar("E0"));
  SET_STRING_ELT(state_names, 460, mkChar("offset_output_E0"));
  SET_STRING_ELT(state_names, 461, mkChar("dim_E1a"));
  SET_STRING_ELT(state_names, 462, mkChar("E1a"));
  SET_STRING_ELT(state_names, 463, mkChar("offset_output_E1a"));
  SET_STRING_ELT(state_names, 464, mkChar("dim_E1b"));
  SET_STRING_ELT(state_names, 465, mkChar("E1b"));
  SET_STRING_ELT(state_names, 466, mkChar("offset_output_E1b"));
  SET_STRING_ELT(state_names, 467, mkChar("dim_E1c"));
  SET_STRING_ELT(state_names, 468, mkChar("E1c"));
  SET_STRING_ELT(state_names, 469, mkChar("offset_output_E1c"));
  SET_STRING_ELT(state_names, 470, mkChar("dim_E1d"));
  SET_STRING_ELT(state_names, 471, mkChar("E1d"));
  SET_STRING_ELT(state_names, 472, mkChar("offset_output_E1d"));
  SET_STRING_ELT(state_names, 473, mkChar("dim_cumuInf_init"));
  SET_STRING_ELT(state_names, 474, mkChar("cumuInf_init"));
  SET_STRING_ELT(state_names, 475, mkChar("dim_alphaItot"));
  SET_STRING_ELT(state_names, 476, mkChar("alphaItot"));
  SET_STRING_ELT(state_names, 477, mkChar("offset_output_alphaItot"));
  SET_STRING_ELT(state_names, 478, mkChar("dim_prev"));
  SET_STRING_ELT(state_names, 479, mkChar("prev"));
  SET_STRING_ELT(state_names, 480, mkChar("offset_output_prev"));
  SET_STRING_ELT(state_names, 481, mkChar("dim_lambda"));
  SET_STRING_ELT(state_names, 482, mkChar("dim_lambda_1"));
  SET_STRING_ELT(state_names, 483, mkChar("dim_lambda_2"));
  SET_STRING_ELT(state_names, 484, mkChar("lambda"));
  SET_STRING_ELT(state_names, 485, mkChar("offset_output_lambda"));
  SET_STRING_ELT(state_names, 486, mkChar("dim_lambda_0"));
  SET_STRING_ELT(state_names, 487, mkChar("dim_lambda_0_1"));
  SET_STRING_ELT(state_names, 488, mkChar("dim_lambda_0_2"));
  SET_STRING_ELT(state_names, 489, mkChar("lambda_0"));
  SET_STRING_ELT(state_names, 490, mkChar("offset_output_lambda_0"));
  SET_STRING_ELT(state_names, 491, mkChar("dim_lambda_1a"));
  SET_STRING_ELT(state_names, 492, mkChar("dim_lambda_1a_1"));
  SET_STRING_ELT(state_names, 493, mkChar("dim_lambda_1a_2"));
  SET_STRING_ELT(state_names, 494, mkChar("lambda_1a"));
  SET_STRING_ELT(state_names, 495, mkChar("offset_output_lambda_1a"));
  SET_STRING_ELT(state_names, 496, mkChar("dim_lambda_1b"));
  SET_STRING_ELT(state_names, 497, mkChar("dim_lambda_1b_1"));
  SET_STRING_ELT(state_names, 498, mkChar("dim_lambda_1b_2"));
  SET_STRING_ELT(state_names, 499, mkChar("lambda_1b"));
  SET_STRING_ELT(state_names, 500, mkChar("offset_output_lambda_1b"));
  SET_STRING_ELT(state_names, 501, mkChar("dim_lambda_1c"));
  SET_STRING_ELT(state_names, 502, mkChar("dim_lambda_1c_1"));
  SET_STRING_ELT(state_names, 503, mkChar("dim_lambda_1c_2"));
  SET_STRING_ELT(state_names, 504, mkChar("lambda_1c"));
  SET_STRING_ELT(state_names, 505, mkChar("offset_output_lambda_1c"));
  SET_STRING_ELT(state_names, 506, mkChar("dim_lambda_1d"));
  SET_STRING_ELT(state_names, 507, mkChar("dim_lambda_1d_1"));
  SET_STRING_ELT(state_names, 508, mkChar("dim_lambda_1d_2"));
  SET_STRING_ELT(state_names, 509, mkChar("lambda_1d"));
  SET_STRING_ELT(state_names, 510, mkChar("offset_output_lambda_1d"));
  SET_STRING_ELT(state_names, 511, mkChar("dim_lambda_sum_0"));
  SET_STRING_ELT(state_names, 512, mkChar("lambda_sum_0"));
  SET_STRING_ELT(state_names, 513, mkChar("offset_output_lambda_sum_0"));
  SET_STRING_ELT(state_names, 514, mkChar("dim_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 515, mkChar("lambda_sum_1a"));
  SET_STRING_ELT(state_names, 516, mkChar("offset_output_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 517, mkChar("dim_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 518, mkChar("lambda_sum_1b"));
  SET_STRING_ELT(state_names, 519, mkChar("offset_output_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 520, mkChar("dim_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 521, mkChar("lambda_sum_1c"));
  SET_STRING_ELT(state_names, 522, mkChar("offset_output_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 523, mkChar("dim_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 524, mkChar("lambda_sum_1d"));
  SET_STRING_ELT(state_names, 525, mkChar("offset_output_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 526, mkChar("dim_c_comm_balanced"));
  SET_STRING_ELT(state_names, 527, mkChar("c_comm_balanced"));
  SET_STRING_ELT(state_names, 528, mkChar("offset_output_c_comm_balanced"));
  SET_STRING_ELT(state_names, 529, mkChar("dim_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 530, mkChar("c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 531, mkChar("offset_output_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 532, mkChar("dim_theta"));
  SET_STRING_ELT(state_names, 533, mkChar("dim_theta_1"));
  SET_STRING_ELT(state_names, 534, mkChar("dim_theta_2"));
  SET_STRING_ELT(state_names, 535, mkChar("theta"));
  SET_STRING_ELT(state_names, 536, mkChar("offset_output_theta"));
  SET_STRING_ELT(state_names, 537, mkChar("dim_OnPrEP_init"));
  SET_STRING_ELT(state_names, 538, mkChar("OnPrEP_init"));
  SET_STRING_ELT(state_names, 539, mkChar("dim_M_comm"));
  SET_STRING_ELT(state_names, 540, mkChar("dim_M_comm_1"));
  SET_STRING_ELT(state_names, 541, mkChar("dim_M_comm_2"));
  SET_STRING_ELT(state_names, 542, mkChar("M_comm"));
  SET_STRING_ELT(state_names, 543, mkChar("offset_output_M_comm"));
  SET_STRING_ELT(state_names, 544, mkChar("dim_M_noncomm"));
  SET_STRING_ELT(state_names, 545, mkChar("dim_M_noncomm_1"));
  SET_STRING_ELT(state_names, 546, mkChar("dim_M_noncomm_2"));
  SET_STRING_ELT(state_names, 547, mkChar("M_noncomm"));
  SET_STRING_ELT(state_names, 548, mkChar("offset_output_M_noncomm"));
  SET_STRING_ELT(state_names, 549, mkChar("dim_in_S0"));
  SET_STRING_ELT(state_names, 550, mkChar("dim_in_S0_1"));
  SET_STRING_ELT(state_names, 551, mkChar("dim_in_S0_2"));
  SET_STRING_ELT(state_names, 552, mkChar("in_S0"));
  SET_STRING_ELT(state_names, 553, mkChar("dim_in_S1a"));
  SET_STRING_ELT(state_names, 554, mkChar("dim_in_S1a_1"));
  SET_STRING_ELT(state_names, 555, mkChar("dim_in_S1a_2"));
  SET_STRING_ELT(state_names, 556, mkChar("in_S1a"));
  SET_STRING_ELT(state_names, 557, mkChar("dim_in_S1b"));
  SET_STRING_ELT(state_names, 558, mkChar("dim_in_S1b_1"));
  SET_STRING_ELT(state_names, 559, mkChar("dim_in_S1b_2"));
  SET_STRING_ELT(state_names, 560, mkChar("in_S1b"));
  SET_STRING_ELT(state_names, 561, mkChar("dim_in_S1c"));
  SET_STRING_ELT(state_names, 562, mkChar("dim_in_S1c_1"));
  SET_STRING_ELT(state_names, 563, mkChar("dim_in_S1c_2"));
  SET_STRING_ELT(state_names, 564, mkChar("in_S1c"));
  SET_STRING_ELT(state_names, 565, mkChar("dim_in_S1d"));
  SET_STRING_ELT(state_names, 566, mkChar("dim_in_S1d_1"));
  SET_STRING_ELT(state_names, 567, mkChar("dim_in_S1d_2"));
  SET_STRING_ELT(state_names, 568, mkChar("in_S1d"));
  SET_STRING_ELT(state_names, 569, mkChar("dim_in_I01"));
  SET_STRING_ELT(state_names, 570, mkChar("dim_in_I01_1"));
  SET_STRING_ELT(state_names, 571, mkChar("dim_in_I01_2"));
  SET_STRING_ELT(state_names, 572, mkChar("in_I01"));
  SET_STRING_ELT(state_names, 573, mkChar("dim_in_I11"));
  SET_STRING_ELT(state_names, 574, mkChar("dim_in_I11_1"));
  SET_STRING_ELT(state_names, 575, mkChar("dim_in_I11_2"));
  SET_STRING_ELT(state_names, 576, mkChar("in_I11"));
  SET_STRING_ELT(state_names, 577, mkChar("dim_in_I02"));
  SET_STRING_ELT(state_names, 578, mkChar("dim_in_I02_1"));
  SET_STRING_ELT(state_names, 579, mkChar("dim_in_I02_2"));
  SET_STRING_ELT(state_names, 580, mkChar("in_I02"));
  SET_STRING_ELT(state_names, 581, mkChar("dim_in_I03"));
  SET_STRING_ELT(state_names, 582, mkChar("dim_in_I03_1"));
  SET_STRING_ELT(state_names, 583, mkChar("dim_in_I03_2"));
  SET_STRING_ELT(state_names, 584, mkChar("in_I03"));
  SET_STRING_ELT(state_names, 585, mkChar("dim_in_I04"));
  SET_STRING_ELT(state_names, 586, mkChar("dim_in_I04_1"));
  SET_STRING_ELT(state_names, 587, mkChar("dim_in_I04_2"));
  SET_STRING_ELT(state_names, 588, mkChar("in_I04"));
  SET_STRING_ELT(state_names, 589, mkChar("dim_in_I05"));
  SET_STRING_ELT(state_names, 590, mkChar("dim_in_I05_1"));
  SET_STRING_ELT(state_names, 591, mkChar("dim_in_I05_2"));
  SET_STRING_ELT(state_names, 592, mkChar("in_I05"));
  SET_STRING_ELT(state_names, 593, mkChar("dim_in_I22"));
  SET_STRING_ELT(state_names, 594, mkChar("dim_in_I22_1"));
  SET_STRING_ELT(state_names, 595, mkChar("dim_in_I22_2"));
  SET_STRING_ELT(state_names, 596, mkChar("in_I22"));
  SET_STRING_ELT(state_names, 597, mkChar("dim_in_I23"));
  SET_STRING_ELT(state_names, 598, mkChar("dim_in_I23_1"));
  SET_STRING_ELT(state_names, 599, mkChar("dim_in_I23_2"));
  SET_STRING_ELT(state_names, 600, mkChar("in_I23"));
  SET_STRING_ELT(state_names, 601, mkChar("dim_in_I24"));
  SET_STRING_ELT(state_names, 602, mkChar("dim_in_I24_1"));
  SET_STRING_ELT(state_names, 603, mkChar("dim_in_I24_2"));
  SET_STRING_ELT(state_names, 604, mkChar("in_I24"));
  SET_STRING_ELT(state_names, 605, mkChar("dim_in_I25"));
  SET_STRING_ELT(state_names, 606, mkChar("dim_in_I25_1"));
  SET_STRING_ELT(state_names, 607, mkChar("dim_in_I25_2"));
  SET_STRING_ELT(state_names, 608, mkChar("in_I25"));
  SET_STRING_ELT(state_names, 609, mkChar("dim_in_I32"));
  SET_STRING_ELT(state_names, 610, mkChar("dim_in_I32_1"));
  SET_STRING_ELT(state_names, 611, mkChar("dim_in_I32_2"));
  SET_STRING_ELT(state_names, 612, mkChar("in_I32"));
  SET_STRING_ELT(state_names, 613, mkChar("dim_in_I33"));
  SET_STRING_ELT(state_names, 614, mkChar("dim_in_I33_1"));
  SET_STRING_ELT(state_names, 615, mkChar("dim_in_I33_2"));
  SET_STRING_ELT(state_names, 616, mkChar("in_I33"));
  SET_STRING_ELT(state_names, 617, mkChar("dim_in_I34"));
  SET_STRING_ELT(state_names, 618, mkChar("dim_in_I34_1"));
  SET_STRING_ELT(state_names, 619, mkChar("dim_in_I34_2"));
  SET_STRING_ELT(state_names, 620, mkChar("in_I34"));
  SET_STRING_ELT(state_names, 621, mkChar("dim_in_I35"));
  SET_STRING_ELT(state_names, 622, mkChar("dim_in_I35_1"));
  SET_STRING_ELT(state_names, 623, mkChar("dim_in_I35_2"));
  SET_STRING_ELT(state_names, 624, mkChar("in_I35"));
  SET_STRING_ELT(state_names, 625, mkChar("dim_in_I42"));
  SET_STRING_ELT(state_names, 626, mkChar("dim_in_I42_1"));
  SET_STRING_ELT(state_names, 627, mkChar("dim_in_I42_2"));
  SET_STRING_ELT(state_names, 628, mkChar("in_I42"));
  SET_STRING_ELT(state_names, 629, mkChar("dim_in_I43"));
  SET_STRING_ELT(state_names, 630, mkChar("dim_in_I43_1"));
  SET_STRING_ELT(state_names, 631, mkChar("dim_in_I43_2"));
  SET_STRING_ELT(state_names, 632, mkChar("in_I43"));
  SET_STRING_ELT(state_names, 633, mkChar("dim_in_I44"));
  SET_STRING_ELT(state_names, 634, mkChar("dim_in_I44_1"));
  SET_STRING_ELT(state_names, 635, mkChar("dim_in_I44_2"));
  SET_STRING_ELT(state_names, 636, mkChar("in_I44"));
  SET_STRING_ELT(state_names, 637, mkChar("dim_in_I45"));
  SET_STRING_ELT(state_names, 638, mkChar("dim_in_I45_1"));
  SET_STRING_ELT(state_names, 639, mkChar("dim_in_I45_2"));
  SET_STRING_ELT(state_names, 640, mkChar("in_I45"));
  SET_STRING_ELT(state_names, 641, mkChar("dim_rate_move_in"));
  SET_STRING_ELT(state_names, 642, mkChar("dim_rate_move_in_1"));
  SET_STRING_ELT(state_names, 643, mkChar("dim_rate_move_in_2"));
  SET_STRING_ELT(state_names, 644, mkChar("rate_move_in"));
  SET_STRING_ELT(state_names, 645, mkChar("offset_output_rate_move_in"));
  SET_STRING_ELT(state_names, 646, mkChar("dim_rate_move_out"));
  SET_STRING_ELT(state_names, 647, mkChar("rate_move_out"));
  SET_STRING_ELT(state_names, 648, mkChar("offset_output_rate_move_out"));
  SET_STRING_ELT(state_names, 649, mkChar("interpolate_c_comm"));
  SET_STRING_ELT(state_names, 650, mkChar("interpolate_c_noncomm"));
  SET_STRING_ELT(state_names, 651, mkChar("interpolate_testing_prob"));
  SET_STRING_ELT(state_names, 652, mkChar("interpolate_ART_prob"));
  SET_STRING_ELT(state_names, 653, mkChar("interpolate_epsilon"));
  SET_STRING_ELT(state_names, 654, mkChar("epsilon"));
  SET_STRING_ELT(state_names, 655, mkChar("interpolate_zetaa"));
  SET_STRING_ELT(state_names, 656, mkChar("interpolate_zetab"));
  SET_STRING_ELT(state_names, 657, mkChar("interpolate_zetac"));
  SET_STRING_ELT(state_names, 658, mkChar("interpolate_prep_intervention"));
  SET_STRING_ELT(state_names, 659, mkChar("interpolate_fc_comm"));
  SET_STRING_ELT(state_names, 660, mkChar("interpolate_fP_comm"));
  SET_STRING_ELT(state_names, 661, mkChar("interpolate_fc_noncomm"));
  SET_STRING_ELT(state_names, 662, mkChar("interpolate_fP_noncomm"));
  SET_STRING_ELT(state_names, 663, mkChar("interpolate_n_comm"));
  SET_STRING_ELT(state_names, 664, mkChar("interpolate_n_noncomm"));
  SET_STRING_ELT(state_names, 665, mkChar("dim"));
  SET_STRING_ELT(state_names, 666, mkChar("dim_output"));
...
SEXP main_model_output_order(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  int *tmp;
  SEXP state_len = PROTECT(allocVector(VECSXP, 91));
  SEXP state_names = PROTECT(allocVector(STRSXP, 91));
  ...
  SET_VECTOR_ELT(state_len, 26, ScalarInteger(main_model_p->dim_c_comm));
  SET_STRING_ELT(state_names, 26, mkChar("c_comm"));
  SET_VECTOR_ELT(state_len, 27, ScalarInteger(main_model_p->dim_c_noncomm));
  SET_STRING_ELT(state_names, 27, mkChar("c_noncomm"));
  SET_VECTOR_ELT(state_len, 28, ScalarInteger(main_model_p->dim_new_people_in_group));
  SET_STRING_ELT(state_names, 28, mkChar("new_people_in_group"));
  SET_VECTOR_ELT(state_len, 29, ScalarInteger(main_model_p->dim_testing_prob));
  SET_STRING_ELT(state_names, 29, mkChar("testing_prob"));
  SET_VECTOR_ELT(state_len, 30, ScalarInteger(main_model_p->dim_ART_prob));
  SET_STRING_ELT(state_names, 30, mkChar("ART_prob"));
  SET_VECTOR_ELT(state_len, 31, ScalarInteger(main_model_p->dim_zeta));
  SET_STRING_ELT(state_names, 31, mkChar("zeta"));
  SET_VECTOR_ELT(state_len, 32, ScalarInteger(main_model_p->dim_tau));
  SET_STRING_ELT(state_names, 32, mkChar("tau"));
  SET_VECTOR_ELT(state_len, 33, ScalarInteger(main_model_p->dim_rho));
  SET_STRING_ELT(state_names, 33, mkChar("rho"));
  SET_VECTOR_ELT(state_len, 34, ScalarInteger(main_model_p->dim_iota));
  SET_STRING_ELT(state_names, 34, mkChar("iota"));
  SET_VECTOR_ELT(state_len, 35, ScalarInteger(main_model_p->dim_frac_F));
  SET_STRING_ELT(state_names, 35, mkChar("frac_F"));
  SET_VECTOR_ELT(state_len, 36, ScalarInteger(main_model_p->dim_frac_N_sexualpop));
  SET_STRING_ELT(state_names, 36, mkChar("frac_N_sexualpop"));
  SET_VECTOR_ELT(state_len, 37, ScalarInteger(main_model_p->dim_zetaa));
  SET_STRING_ELT(state_names, 37, mkChar("zetaa"));
  SET_VECTOR_ELT(state_len, 38, ScalarInteger(main_model_p->dim_zetab));
  SET_STRING_ELT(state_names, 38, mkChar("zetab"));
  SET_VECTOR_ELT(state_len, 39, ScalarInteger(main_model_p->dim_zetac));
  SET_STRING_ELT(state_names, 39, mkChar("zetac"));
  SET_VECTOR_ELT(state_len, 40, ScalarInteger(main_model_p->dim_omega));
  SET_STRING_ELT(state_names, 40, mkChar("omega"));
  SET_VECTOR_ELT(state_len, 41, ScalarInteger(main_model_p->dim_frac_N));
  SET_STRING_ELT(state_names, 41, mkChar("frac_N"));
  SET_VECTOR_ELT(state_len, 42, ScalarInteger(main_model_p->dim_mu));
  SET_STRING_ELT(state_names, 42, mkChar("mu"));
  SET_VECTOR_ELT(state_len, 43, ScalarInteger(main_model_p->dim_gamma01));
  SET_STRING_ELT(state_names, 43, mkChar("gamma01"));
  SET_VECTOR_ELT(state_len, 44, ScalarInteger(main_model_p->dim_gamma11));
  SET_STRING_ELT(state_names, 44, mkChar("gamma11"));
  SET_VECTOR_ELT(state_len, 45, ScalarInteger(main_model_p->dim_kappaa));
  SET_STRING_ELT(state_names, 45, mkChar("kappaa"));
  SET_VECTOR_ELT(state_len, 46, ScalarInteger(main_model_p->dim_kappab));
  SET_STRING_ELT(state_names, 46, mkChar("kappab"));
  SET_VECTOR_ELT(state_len, 47, ScalarInteger(main_model_p->dim_kappac));
  SET_STRING_ELT(state_names, 47, mkChar("kappac"));
  SET_VECTOR_ELT(state_len, 48, ScalarInteger(main_model_p->dim_kappa1));
  SET_STRING_ELT(state_names, 48, mkChar("kappa1"));
  SET_VECTOR_ELT(state_len, 49, ScalarInteger(main_model_p->dim_alpha01));
  SET_STRING_ELT(state_names, 49, mkChar("alpha01"));
  SET_VECTOR_ELT(state_len, 50, ScalarInteger(main_model_p->dim_alpha02));
  SET_STRING_ELT(state_names, 50, mkChar("alpha02"));
  SET_VECTOR_ELT(state_len, 51, ScalarInteger(main_model_p->dim_alpha05));
  SET_STRING_ELT(state_names, 51, mkChar("alpha05"));
  SET_VECTOR_ELT(state_len, 52, ScalarInteger(main_model_p->dim_alpha11));
  SET_STRING_ELT(state_names, 52, mkChar("alpha11"));
  SET_VECTOR_ELT(state_len, 53, ScalarInteger(main_model_p->dim_alpha22));
  SET_STRING_ELT(state_names, 53, mkChar("alpha22"));
  SET_VECTOR_ELT(state_len, 54, ScalarInteger(main_model_p->dim_alpha35));
  SET_STRING_ELT(state_names, 54, mkChar("alpha35"));
  SET_VECTOR_ELT(state_len, 55, ScalarInteger(main_model_p->dim_beta_comm));
  SET_STRING_ELT(state_names, 55, mkChar("beta_comm"));
  SET_VECTOR_ELT(state_len, 56, ScalarInteger(main_model_p->dim_beta_noncomm));
  SET_STRING_ELT(state_names, 56, mkChar("beta_noncomm"));
  SET_VECTOR_ELT(state_len, 57, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 57));
  tmp[0] = main_model_p->dim_p_comm_1;
  tmp[1] = main_model_p->dim_p_comm_2;
  SET_STRING_ELT(state_names, 57, mkChar("p_comm"));
  ...
  SET_STRING_ELT(state_names, 58, mkChar("p_noncomm"));
  ...
  SET_STRING_ELT(state_names, 59, mkChar("fc_comm"));
  SET_VECTOR_ELT(state_len, 60, ScalarInteger(main_model_p->dim_fP_comm));
  SET_STRING_ELT(state_names, 60, mkChar("fP_comm"));
  ...
  SET_STRING_ELT(state_names, 61, mkChar("fc_noncomm"));
  SET_VECTOR_ELT(state_len, 62, ScalarInteger(main_model_p->dim_fP_noncomm));
  SET_STRING_ELT(state_names, 62, mkChar("fP_noncomm"));
  ...
  SET_STRING_ELT(state_names, 63, mkChar("n_comm"));
  ...
  SET_STRING_ELT(state_names, 64, mkChar("n_noncomm"));
  SET_VECTOR_ELT(state_len, 65, ScalarInteger(main_model_p->dim_N));
  SET_STRING_ELT(state_names, 65, mkChar("N"));
  SET_VECTOR_ELT(state_len, 66, ScalarInteger(main_model_p->dim_E0));
  SET_STRING_ELT(state_names, 66, mkChar("E0"));
  SET_VECTOR_ELT(state_len, 67, ScalarInteger(main_model_p->dim_E1a));
  SET_STRING_ELT(state_names, 67, mkChar("E1a"));
  SET_VECTOR_ELT(state_len, 68, ScalarInteger(main_model_p->dim_E1b));
  SET_STRING_ELT(state_names, 68, mkChar("E1b"));
  SET_VECTOR_ELT(state_len, 69, ScalarInteger(main_model_p->dim_E1c));
  SET_STRING_ELT(state_names, 69, mkChar("E1c"));
  SET_VECTOR_ELT(state_len, 70, ScalarInteger(main_model_p->dim_E1d));
  SET_STRING_ELT(state_names, 70, mkChar("E1d"));
  SET_VECTOR_ELT(state_len, 71, ScalarInteger(main_model_p->dim_alphaItot));
  SET_STRING_ELT(state_names, 71, mkChar("alphaItot"));
  SET_VECTOR_ELT(state_len, 72, ScalarInteger(main_model_p->dim_prev));
  SET_STRING_ELT(state_names, 72, mkChar("prev"));
  ...
  SET_STRING_ELT(state_names, 73, mkChar("lambda"));
  ...
  SET_STRING_ELT(state_names, 74, mkChar("lambda_0"));
  ...
  SET_STRING_ELT(state_names, 75, mkChar("lambda_1a"));
  ...
  SET_STRING_ELT(state_names, 76, mkChar("lambda_1b"));
  ...
  SET_STRING_ELT(state_names, 77, mkChar("lambda_1c"));
  ...
  SET_STRING_ELT(state_names, 78, mkChar("lambda_1d"));
  SET_VECTOR_ELT(state_len, 79, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_STRING_ELT(state_names, 79, mkChar("lambda_sum_0"));
  SET_VECTOR_ELT(state_len, 80, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_STRING_ELT(state_names, 80, mkChar("lambda_sum_1a"));
  SET_VECTOR_ELT(state_len, 81, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_STRING_ELT(state_names, 81, mkChar("lambda_sum_1b"));
  SET_VECTOR_ELT(state_len, 82, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_STRING_ELT(state_names, 82, mkChar("lambda_sum_1c"));
  SET_VECTOR_ELT(state_len, 83, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_STRING_ELT(state_names, 83, mkChar("lambda_sum_1d"));
  SET_VECTOR_ELT(state_len, 84, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_STRING_ELT(state_names, 84, mkChar("c_comm_balanced"));
  SET_VECTOR_ELT(state_len, 85, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_STRING_ELT(state_names, 85, mkChar("c_noncomm_balanced"));
  SET_VECTOR_ELT(state_len, 86, allocVector(INTSXP, 2));
  tmp = INTEGER(VECTOR_ELT(state_len, 86));
  tmp[0] = main_model_p->dim_theta_1;
  tmp[1] = main_model_p->dim_theta_2;
  SET_STRING_ELT(state_names, 86, mkChar("theta"));
  ...
  SET_STRING_ELT(state_names, 87, mkChar("M_comm"));
  ...
  SET_STRING_ELT(state_names, 88, mkChar("M_noncomm"));
  ...
  SET_STRING_ELT(state_names, 89, mkChar("rate_move_in"));
  SET_VECTOR_ELT(state_len, 90, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_STRING_ELT(state_names, 90, mkChar("rate_move_out"));
  setAttrib(state_len, R_NamesSymbol, state_names);
  UNPROTECT(2);
  return state_len;
}
