...
SEXP main_model_set_user(main_model_pars *main_model_p, SEXP user) {
  ...
  main_model_p->offset_output_c_comm = 17;
  ...
  main_model_p->offset_output_c_noncomm = 17 + main_model_p->dim_c_comm;
...
void main_model_deriv(main_model_pars *main_model_p, double t, double *state, double *dstatedt, double *output) {
  ...
  if (output != NULL) {
    double *output_c_comm = output + 17;
    ...
    output[3] = main_model_p->Nage;
    output[4] = main_model_p->dur_FSW;
    output[5] = main_model_p->epsilon;
    ...
    output[6] = Ntot_inc_former_FSW_nonCot;
...
SEXP main_model_output_order(SEXP main_model_ptr) {
  main_model_pars *main_model_p = main_model_get_pointer(main_model_ptr, 1);
  int *tmp;
  SEXP state_len = PROTECT(allocVector(VECSXP, 75));
  SEXP state_names = PROTECT(allocVector(STRSXP, 75));
  ...
  SET_STRING_ELT(state_names, 3, mkChar("Nage"));
  SET_VECTOR_ELT(state_len, 4, R_NilValue);
  SET_STRING_ELT(state_names, 4, mkChar("dur_FSW"));
  SET_VECTOR_ELT(state_len, 5, R_NilValue);
  SET_STRING_ELT(state_names, 5, mkChar("epsilon"));
  SET_VECTOR_ELT(state_len, 6, R_NilValue);
  SET_STRING_ELT(state_names, 6, mkChar("Ntot_inc_former_FSW_nonCot"));
  SET_VECTOR_ELT(state_len, 7, R_NilValue);
  SET_STRING_ELT(state_names, 7, mkChar("frac_virgin"));
  ...
  SET_STRING_ELT(state_names, 16, mkChar("B_check_noncomm"));
  SET_VECTOR_ELT(state_len, 17, ScalarInteger(main_model_p->dim_c_comm));
  SET_STRING_ELT(state_names, 17, mkChar("c_comm"));
  SET_VECTOR_ELT(state_len, 18, ScalarInteger(main_model_p->dim_c_noncomm));
  SET_STRING_ELT(state_names, 18, mkChar("c_noncomm"));
  SET_VECTOR_ELT(state_len, 19, ScalarInteger(main_model_p->dim_new_people_in_group));
  SET_STRING_ELT(state_names, 19, mkChar("new_people_in_group"));
  SET_VECTOR_ELT(state_len, 20, ScalarInteger(main_model_p->dim_testing_prob));
  SET_STRING_ELT(state_names, 20, mkChar("testing_prob"));
  SET_VECTOR_ELT(state_len, 21, ScalarInteger(main_model_p->dim_ART_prob));
  SET_STRING_ELT(state_names, 21, mkChar("ART_prob"));
  SET_VECTOR_ELT(state_len, 22, ScalarInteger(main_model_p->dim_tau));
  SET_STRING_ELT(state_names, 22, mkChar("tau"));
  SET_VECTOR_ELT(state_len, 23, ScalarInteger(main_model_p->dim_rho));
  SET_STRING_ELT(state_names, 23, mkChar("rho"));
  SET_VECTOR_ELT(state_len, 24, ScalarInteger(main_model_p->dim_frac_F));
  SET_STRING_ELT(state_names, 24, mkChar("frac_F"));
  SET_VECTOR_ELT(state_len, 25, ScalarInteger(main_model_p->dim_frac_N_sexualpop));
  SET_STRING_ELT(state_names, 25, mkChar("frac_N_sexualpop"));
  SET_VECTOR_ELT(state_len, 26, ScalarInteger(main_model_p->dim_zetaa));
  SET_STRING_ELT(state_names, 26, mkChar("zetaa"));
  SET_VECTOR_ELT(state_len, 27, ScalarInteger(main_model_p->dim_zetab));
  SET_STRING_ELT(state_names, 27, mkChar("zetab"));
  SET_VECTOR_ELT(state_len, 28, ScalarInteger(main_model_p->dim_zetac));
  SET_STRING_ELT(state_names, 28, mkChar("zetac"));
  SET_VECTOR_ELT(state_len, 29, ScalarInteger(main_model_p->dim_omega));
  SET_STRING_ELT(state_names, 29, mkChar("omega"));
  SET_VECTOR_ELT(state_len, 30, ScalarInteger(main_model_p->dim_frac_N));
  SET_STRING_ELT(state_names, 30, mkChar("frac_N"));
  SET_VECTOR_ELT(state_len, 31, ScalarInteger(main_model_p->dim_mu));
  SET_STRING_ELT(state_names, 31, mkChar("mu"));
  SET_VECTOR_ELT(state_len, 32, ScalarInteger(main_model_p->dim_gamma01));
  SET_STRING_ELT(state_names, 32, mkChar("gamma01"));
  SET_VECTOR_ELT(state_len, 33, ScalarInteger(main_model_p->dim_kappaa));
  SET_STRING_ELT(state_names, 33, mkChar("kappaa"));
  SET_VECTOR_ELT(state_len, 34, ScalarInteger(main_model_p->dim_kappab));
  SET_STRING_ELT(state_names, 34, mkChar("kappab"));
  SET_VECTOR_ELT(state_len, 35, ScalarInteger(main_model_p->dim_kappac));
  SET_STRING_ELT(state_names, 35, mkChar("kappac"));
  SET_VECTOR_ELT(state_len, 36, ScalarInteger(main_model_p->dim_alpha05));
  SET_STRING_ELT(state_names, 36, mkChar("alpha05"));
  SET_VECTOR_ELT(state_len, 37, ScalarInteger(main_model_p->dim_alpha35));
  SET_STRING_ELT(state_names, 37, mkChar("alpha35"));
  SET_VECTOR_ELT(state_len, 38, ScalarInteger(main_model_p->dim_beta_comm));
  SET_STRING_ELT(state_names, 38, mkChar("beta_comm"));
  SET_VECTOR_ELT(state_len, 39, ScalarInteger(main_model_p->dim_beta_noncomm));
  SET_STRING_ELT(state_names, 39, mkChar("beta_noncomm"));
  ...
  SET_STRING_ELT(state_names, 40, mkChar("p_comm"));
  ...
  SET_STRING_ELT(state_names, 41, mkChar("p_noncomm"));
  ...
  SET_STRING_ELT(state_names, 42, mkChar("fc_comm"));
  SET_VECTOR_ELT(state_len, 43, ScalarInteger(main_model_p->dim_fP_comm));
  SET_STRING_ELT(state_names, 43, mkChar("fP_comm"));
  ...
  SET_STRING_ELT(state_names, 44, mkChar("fc_noncomm"));
  SET_VECTOR_ELT(state_len, 45, ScalarInteger(main_model_p->dim_fP_noncomm));
  SET_STRING_ELT(state_names, 45, mkChar("fP_noncomm"));
  ...
  SET_STRING_ELT(state_names, 46, mkChar("n_comm"));
  ...
  SET_STRING_ELT(state_names, 47, mkChar("n_noncomm"));
  SET_VECTOR_ELT(state_len, 48, ScalarInteger(main_model_p->dim_N));
  SET_STRING_ELT(state_names, 48, mkChar("N"));
  SET_VECTOR_ELT(state_len, 49, ScalarInteger(main_model_p->dim_E0));
  SET_STRING_ELT(state_names, 49, mkChar("E0"));
  SET_VECTOR_ELT(state_len, 50, ScalarInteger(main_model_p->dim_E1a));
  SET_STRING_ELT(state_names, 50, mkChar("E1a"));
  SET_VECTOR_ELT(state_len, 51, ScalarInteger(main_model_p->dim_E1b));
  SET_STRING_ELT(state_names, 51, mkChar("E1b"));
  SET_VECTOR_ELT(state_len, 52, ScalarInteger(main_model_p->dim_E1c));
  SET_STRING_ELT(state_names, 52, mkChar("E1c"));
  SET_VECTOR_ELT(state_len, 53, ScalarInteger(main_model_p->dim_E1d));
  SET_STRING_ELT(state_names, 53, mkChar("E1d"));
  SET_VECTOR_ELT(state_len, 54, ScalarInteger(main_model_p->dim_alphaItot));
  SET_STRING_ELT(state_names, 54, mkChar("alphaItot"));
  SET_VECTOR_ELT(state_len, 55, ScalarInteger(main_model_p->dim_prev));
  SET_STRING_ELT(state_names, 55, mkChar("prev"));
  ...
  SET_STRING_ELT(state_names, 56, mkChar("lambda"));
  ...
  SET_STRING_ELT(state_names, 57, mkChar("lambda_0"));
  ...
  SET_STRING_ELT(state_names, 58, mkChar("lambda_1a"));
  ...
  SET_STRING_ELT(state_names, 59, mkChar("lambda_1b"));
  ...
  SET_STRING_ELT(state_names, 60, mkChar("lambda_1c"));
  ...
  SET_STRING_ELT(state_names, 61, mkChar("lambda_1d"));
  SET_VECTOR_ELT(state_len, 62, ScalarInteger(main_model_p->dim_lambda_sum_0));
  SET_STRING_ELT(state_names, 62, mkChar("lambda_sum_0"));
  SET_VECTOR_ELT(state_len, 63, ScalarInteger(main_model_p->dim_lambda_sum_1a));
  SET_STRING_ELT(state_names, 63, mkChar("lambda_sum_1a"));
  SET_VECTOR_ELT(state_len, 64, ScalarInteger(main_model_p->dim_lambda_sum_1b));
  SET_STRING_ELT(state_names, 64, mkChar("lambda_sum_1b"));
  SET_VECTOR_ELT(state_len, 65, ScalarInteger(main_model_p->dim_lambda_sum_1c));
  SET_STRING_ELT(state_names, 65, mkChar("lambda_sum_1c"));
  SET_VECTOR_ELT(state_len, 66, ScalarInteger(main_model_p->dim_lambda_sum_1d));
  SET_STRING_ELT(state_names, 66, mkChar("lambda_sum_1d"));
  SET_VECTOR_ELT(state_len, 67, ScalarInteger(main_model_p->dim_c_comm_balanced));
  SET_STRING_ELT(state_names, 67, mkChar("c_comm_balanced"));
  SET_VECTOR_ELT(state_len, 68, ScalarInteger(main_model_p->dim_c_noncomm_balanced));
  SET_STRING_ELT(state_names, 68, mkChar("c_noncomm_balanced"));
  ...
  SET_STRING_ELT(state_names, 69, mkChar("theta"));
  ...
  SET_STRING_ELT(state_names, 70, mkChar("M_comm"));
  ...
  SET_STRING_ELT(state_names, 71, mkChar("M_noncomm"));
  SET_VECTOR_ELT(state_len, 72, ScalarInteger(main_model_p->dim_sum_in_S0));
  SET_STRING_ELT(state_names, 72, mkChar("sum_in_S0"));
  ...
  SET_STRING_ELT(state_names, 73, mkChar("rate_move_in"));
  SET_VECTOR_ELT(state_len, 74, ScalarInteger(main_model_p->dim_rate_move_out));
  SET_STRING_ELT(state_names, 74, mkChar("rate_move_out"));
  setAttrib(state_len, R_NamesSymbol, state_names);
  UNPROTECT(2);
  return state_len;
}
