mkChar("initial_S1d"));
  SET_STRING_ELT(state_names, 320, mkChar("offset_S1d"));
  SET_STRING_ELT(state_names, 321, mkChar("dim_I01"));
  SET_STRING_ELT(state_names, 322, mkChar("initial_I01"));
  SET_STRING_ELT(state_names, 323, mkChar("offset_I01"));
  SET_STRING_ELT(state_names, 324, mkChar("dim_I11"));
  SET_STRING_ELT(state_names, 325, mkChar("initial_I11"));
  SET_STRING_ELT(state_names, 326, mkChar("offset_I11"));
  SET_STRING_ELT(state_names, 327, mkChar("dim_I02"));
  SET_STRING_ELT(state_names, 328, mkChar("initial_I02"));
  SET_STRING_ELT(state_names, 329, mkChar("offset_I02"));
  SET_STRING_ELT(state_names, 330, mkChar("dim_I03"));
  SET_STRING_ELT(state_names, 331, mkChar("initial_I03"));
  SET_STRING_ELT(state_names, 332, mkChar("offset_I03"));
  SET_STRING_ELT(state_names, 333, mkChar("dim_I04"));
  SET_STRING_ELT(state_names, 334, mkChar("initial_I04"));
  SET_STRING_ELT(state_names, 335, mkChar("offset_I04"));
  SET_STRING_ELT(state_names, 336, mkChar("dim_I05"));
  SET_STRING_ELT(state_names, 337, mkChar("initial_I05"));
  SET_STRING_ELT(state_names, 338, mkChar("offset_I05"));
  SET_STRING_ELT(state_names, 339, mkChar("dim_I22"));
  SET_STRING_ELT(state_names, 340, mkChar("initial_I22"));
  SET_STRING_ELT(state_names, 341, mkChar("offset_I22"));
  SET_STRING_ELT(state_names, 342, mkChar("dim_I23"));
  SET_STRING_ELT(state_names, 343, mkChar("initial_I23"));
  SET_STRING_ELT(state_names, 344, mkChar("offset_I23"));
  SET_STRING_ELT(state_names, 345, mkChar("dim_I24"));
  SET_STRING_ELT(state_names, 346, mkChar("initial_I24"));
  SET_STRING_ELT(state_names, 347, mkChar("offset_I24"));
  SET_STRING_ELT(state_names, 348, mkChar("dim_I25"));
  SET_STRING_ELT(state_names, 349, mkChar("initial_I25"));
  SET_STRING_ELT(state_names, 350, mkChar("offset_I25"));
  SET_STRING_ELT(state_names, 351, mkChar("dim_I32"));
  SET_STRING_ELT(state_names, 352, mkChar("initial_I32"));
  SET_STRING_ELT(state_names, 353, mkChar("offset_I32"));
  SET_STRING_ELT(state_names, 354, mkChar("dim_I33"));
  SET_STRING_ELT(state_names, 355, mkChar("initial_I33"));
  SET_STRING_ELT(state_names, 356, mkChar("offset_I33"));
  SET_STRING_ELT(state_names, 357, mkChar("dim_I34"));
  SET_STRING_ELT(state_names, 358, mkChar("initial_I34"));
  SET_STRING_ELT(state_names, 359, mkChar("offset_I34"));
  SET_STRING_ELT(state_names, 360, mkChar("dim_I35"));
  SET_STRING_ELT(state_names, 361, mkChar("initial_I35"));
  SET_STRING_ELT(state_names, 362, mkChar("offset_I35"));
  SET_STRING_ELT(state_names, 363, mkChar("dim_I42"));
  SET_STRING_ELT(state_names, 364, mkChar("initial_I42"));
  SET_STRING_ELT(state_names, 365, mkChar("offset_I42"));
  SET_STRING_ELT(state_names, 366, mkChar("dim_I43"));
  SET_STRING_ELT(state_names, 367, mkChar("initial_I43"));
  SET_STRING_ELT(state_names, 368, mkChar("offset_I43"));
  SET_STRING_ELT(state_names, 369, mkChar("dim_I44"));
  SET_STRING_ELT(state_names, 370, mkChar("initial_I44"));
  SET_STRING_ELT(state_names, 371, mkChar("offset_I44"));
  SET_STRING_ELT(state_names, 372, mkChar("dim_I45"));
  SET_STRING_ELT(state_names, 373, mkChar("initial_I45"));
  SET_STRING_ELT(state_names, 374, mkChar("offset_I45"));
  SET_STRING_ELT(state_names, 375, mkChar("dim_S0_init"));
  SET_STRING_ELT(state_names, 376, mkChar("S0_init"));
  SET_STRING_ELT(state_names, 377, mkChar("dim_S1a_init"));
  SET_STRING_ELT(state_names, 378, mkChar("S1a_init"));
  SET_STRING_ELT(state_names, 379, mkChar("dim_S1b_init"));
  SET_STRING_ELT(state_names, 380, mkChar("S1b_init"));
  SET_STRING_ELT(state_names, 381, mkChar("dim_S1c_init"));
  SET_STRING_ELT(state_names, 382, mkChar("S1c_init"));
  SET_STRING_ELT(state_names, 383, mkChar("dim_S1d_init"));
  SET_STRING_ELT(state_names, 384, mkChar("S1d_init"));
  SET_STRING_ELT(state_names, 385, mkChar("dim_I01_init"));
  SET_STRING_ELT(state_names, 386, mkChar("I01_init"));
  SET_STRING_ELT(state_names, 387, mkChar("dim_I11_init"));
  SET_STRING_ELT(state_names, 388, mkChar("I11_init"));
  SET_STRING_ELT(state_names, 389, mkChar("dim_I02_init"));
  SET_STRING_ELT(state_names, 390, mkChar("I02_init"));
  SET_STRING_ELT(state_names, 391, mkChar("dim_I03_init"));
  SET_STRING_ELT(state_names, 392, mkChar("I03_init"));
  SET_STRING_ELT(state_names, 393, mkChar("dim_I04_init"));
  SET_STRING_ELT(state_names, 394, mkChar("I04_init"));
  SET_STRING_ELT(state_names, 395, mkChar("dim_I05_init"));
  SET_STRING_ELT(state_names, 396, mkChar("I05_init"));
  SET_STRING_ELT(state_names, 397, mkChar("dim_I22_init"));
  SET_STRING_ELT(state_names, 398, mkChar("I22_init"));
  SET_STRING_ELT(state_names, 399, mkChar("dim_I23_init"));
  SET_STRING_ELT(state_names, 400, mkChar("I23_init"));
  SET_STRING_ELT(state_names, 401, mkChar("dim_I24_init"));
  SET_STRING_ELT(state_names, 402, mkChar("I24_init"));
  SET_STRING_ELT(state_names, 403, mkChar("dim_I25_init"));
  SET_STRING_ELT(state_names, 404, mkChar("I25_init"));
  SET_STRING_ELT(state_names, 405, mkChar("dim_I32_init"));
  SET_STRING_ELT(state_names, 406, mkChar("I32_init"));
  SET_STRING_ELT(state_names, 407, mkChar("dim_I33_init"));
  SET_STRING_ELT(state_names, 408, mkChar("I33_init"));
  SET_STRING_ELT(state_names, 409, mkChar("dim_I34_init"));
  SET_STRING_ELT(state_names, 410, mkChar("I34_init"));
  SET_STRING_ELT(state_names, 411, mkChar("dim_I35_init"));
  SET_STRING_ELT(state_names, 412, mkChar("I35_init"));
  SET_STRING_ELT(state_names, 413, mkChar("dim_I42_init"));
  SET_STRING_ELT(state_names, 414, mkChar("I42_init"));
  SET_STRING_ELT(state_names, 415, mkChar("dim_I43_init"));
  SET_STRING_ELT(state_names, 416, mkChar("I43_init"));
  SET_STRING_ELT(state_names, 417, mkChar("dim_I44_init"));
  SET_STRING_ELT(state_names, 418, mkChar("I44_init"));
  SET_STRING_ELT(state_names, 419, mkChar("dim_I45_init"));
  SET_STRING_ELT(state_names, 420, mkChar("I45_init"));
  SET_STRING_ELT(state_names, 421, mkChar("dim_N"));
  SET_STRING_ELT(state_names, 422, mkChar("N"));
  SET_STRING_ELT(state_names, 423, mkChar("offset_output_N"));
  SET_STRING_ELT(state_names, 424, mkChar("dim_E0"));
  SET_STRING_ELT(state_names, 425, mkChar("E0"));
  SET_STRING_ELT(state_names, 426, mkChar("offset_output_E0"));
  SET_STRING_ELT(state_names, 427, mkChar("dim_E1a"));
  SET_STRING_ELT(state_names, 428, mkChar("E1a"));
  SET_STRING_ELT(state_names, 429, mkChar("offset_output_E1a"));
  SET_STRING_ELT(state_names, 430, mkChar("dim_E1b"));
  SET_STRING_ELT(state_names, 431, mkChar("E1b"));
  SET_STRING_ELT(state_names, 432, mkChar("offset_output_E1b"));
  SET_STRING_ELT(state_names, 433, mkChar("dim_E1c"));
  SET_STRING_ELT(state_names, 434, mkChar("E1c"));
  SET_STRING_ELT(state_names, 435, mkChar("offset_output_E1c"));
  SET_STRING_ELT(state_names, 436, mkChar("dim_E1d"));
  SET_STRING_ELT(state_names, 437, mkChar("E1d"));
  SET_STRING_ELT(state_names, 438, mkChar("offset_output_E1d"));
  SET_STRING_ELT(state_names, 439, mkChar("dim_cumuInf_init"));
  SET_STRING_ELT(state_names, 440, mkChar("cumuInf_init"));
  SET_STRING_ELT(state_names, 441, mkChar("dim_alphaItot"));
  SET_STRING_ELT(state_names, 442, mkChar("alphaItot"));
  SET_STRING_ELT(state_names, 443, mkChar("offset_output_alphaItot"));
  SET_STRING_ELT(state_names, 444, mkChar("dim_prev"));
  SET_STRING_ELT(state_names, 445, mkChar("prev"));
  SET_STRING_ELT(state_names, 446, mkChar("offset_output_prev"));
  SET_STRING_ELT(state_names, 447, mkChar("dim_lambda"));
  SET_STRING_ELT(state_names, 448, mkChar("dim_lambda_1"));
  SET_STRING_ELT(state_names, 449, mkChar("dim_lambda_2"));
  SET_STRING_ELT(state_names, 450, mkChar("lambda"));
  SET_STRING_ELT(state_names, 451, mkChar("offset_output_lambda"));
  SET_STRING_ELT(state_names, 452, mkChar("dim_lambda_0"));
  SET_STRING_ELT(state_names, 453, mkChar("dim_lambda_0_1"));
  SET_STRING_ELT(state_names, 454, mkChar("dim_lambda_0_2"));
  SET_STRING_ELT(state_names, 455, mkChar("lambda_0"));
  SET_STRING_ELT(state_names, 456, mkChar("offset_output_lambda_0"));
  SET_STRING_ELT(state_names, 457, mkChar("dim_lambda_1a"));
  SET_STRING_ELT(state_names, 458, mkChar("dim_lambda_1a_1"));
  SET_STRING_ELT(state_names, 459, mkChar("dim_lambda_1a_2"));
  SET_STRING_ELT(state_names, 460, mkChar("lambda_1a"));
  SET_STRING_ELT(state_names, 461, mkChar("offset_output_lambda_1a"));
  SET_STRING_ELT(state_names, 462, mkChar("dim_lambda_1b"));
  SET_STRING_ELT(state_names, 463, mkChar("dim_lambda_1b_1"));
  SET_STRING_ELT(state_names, 464, mkChar("dim_lambda_1b_2"));
  SET_STRING_ELT(state_names, 465, mkChar("lambda_1b"));
  SET_STRING_ELT(state_names, 466, mkChar("offset_output_lambda_1b"));
  SET_STRING_ELT(state_names, 467, mkChar("dim_lambda_1c"));
  SET_STRING_ELT(state_names, 468, mkChar("dim_lambda_1c_1"));
  SET_STRING_ELT(state_names, 469, mkChar("dim_lambda_1c_2"));
  SET_STRING_ELT(state_names, 470, mkChar("lambda_1c"));
  SET_STRING_ELT(state_names, 471, mkChar("offset_output_lambda_1c"));
  SET_STRING_ELT(state_names, 472, mkChar("dim_lambda_1d"));
  SET_STRING_ELT(state_names, 473, mkChar("dim_lambda_1d_1"));
  SET_STRING_ELT(state_names, 474, mkChar("dim_lambda_1d_2"));
  SET_STRING_ELT(state_names, 475, mkChar("lambda_1d"));
  SET_STRING_ELT(state_names, 476, mkChar("offset_output_lambda_1d"));
  SET_STRING_ELT(state_names, 477, mkChar("dim_lambda_sum_0"));
  SET_STRING_ELT(state_names, 478, mkChar("lambda_sum_0"));
  SET_STRING_ELT(state_names, 479, mkChar("offset_output_lambda_sum_0"));
  SET_STRING_ELT(state_names, 480, mkChar("dim_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 481, mkChar("lambda_sum_1a"));
  SET_STRING_ELT(state_names, 482, mkChar("offset_output_lambda_sum_1a"));
  SET_STRING_ELT(state_names, 483, mkChar("dim_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 484, mkChar("lambda_sum_1b"));
  SET_STRING_ELT(state_names, 485, mkChar("offset_output_lambda_sum_1b"));
  SET_STRING_ELT(state_names, 486, mkChar("dim_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 487, mkChar("lambda_sum_1c"));
  SET_STRING_ELT(state_names, 488, mkChar("offset_output_lambda_sum_1c"));
  SET_STRING_ELT(state_names, 489, mkChar("dim_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 490, mkChar("lambda_sum_1d"));
  SET_STRING_ELT(state_names, 491, mkChar("offset_output_lambda_sum_1d"));
  SET_STRING_ELT(state_names, 492, mkChar("dim_c_comm_balanced"));
  SET_STRING_ELT(state_names, 493, mkChar("c_comm_balanced"));
  SET_STRING_ELT(state_names, 494, mkChar("offset_output_c_comm_balanced"));
  SET_STRING_ELT(state_names, 495, mkChar("dim_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 496, mkChar("c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 497, mkChar("offset_output_c_noncomm_balanced"));
  SET_STRING_ELT(state_names, 498, mkChar("dim_theta"));
  SET_STRING_ELT(state_names, 499, mkChar("dim_theta_1"));
  SET_STRING_ELT(state_names, 500, mkChar("dim_theta_2"));
  SET_STRING_ELT(state_names, 501, mkChar("theta"));
  SET_STRING_ELT(state_names, 502, mkChar("offset_output_theta"));
  SET_STRING_ELT(state_names, 503, mkChar("dim_OnPrEP_init"));
  SET_STRING_ELT(state_names, 504, mkChar("OnPrEP_init"));
  SET_STRING_ELT(state_names, 505, mkChar("dim_M_comm"));
  SET_STRING_ELT(state_names, 506, mkChar("dim_M_comm_1"));
  SET_STRING_ELT(state_names, 507, mkChar("dim_M_comm_2"));
  SET_STRING_ELT(state_names, 508, mkChar("M_comm"));
  SET_STRING_ELT(state_names, 509, mkChar("offset_output_M_comm"));
  SET_STRING_ELT(state_names, 510, mkChar("dim_M_noncomm"));
  SET_STRING_ELT(state_names, 511, mkChar("dim_M_noncomm_1"));
  SET_STRING_ELT(state_names, 512, mkChar("dim_M_noncomm_2"));
  SET_STRING_ELT(state_names, 513, mkChar("M_noncomm"));
  SET_STRING_ELT(state_names, 514, mkChar("offset_output_M_noncomm"));
  SET_STRING_ELT(state_names, 515, mkChar("dim_in_S0"));
  SET_STRING_ELT(state_names, 516, mkChar("dim_in_S0_1"));
  SET_STRING_ELT(state_names, 517, mkChar("dim_in_S0_2"));
  SET_STRING_ELT(state_names, 518, mkChar("in_S0"));
  SET_STRING_ELT(state_names, 519, mkChar("dim_in_S1a"));
  SET_STRING_ELT(state_names, 520, mkChar("dim_in_S1a_1"));
  SET_STRING_ELT(state_names, 521, mkChar("dim_in_S1a_2"));
  SET_STRING_ELT(state_names, 522, mkChar("in_S1a"));
  SET_STRING_ELT(state_names, 523, mkChar("dim_in_S1b"));
  SET_STRING_ELT(state_names, 524, mkChar("dim_in_S1b_1"));
  SET_STRING_ELT(state_names, 525, mkChar("dim_in_S1b_2"));
  SET_STRING_ELT(state_names, 526, mkChar("in_S1b"));
  SET_STRING_ELT(state_names, 527, mkChar("dim_in_S1c"));
  SET_STRING_ELT(state_names, 528, mkChar("dim_in_S1c_1"));
  SET_STRING_ELT(state_names, 529, mkChar("dim_in_S1c_2"));
  SET_STRING_ELT(state_names, 530, mkChar("in_S1c"));
  SET_STRING_ELT(state_names, 531, mkChar("dim_in_S1d"));
  SET_STRING_ELT(state_names, 532, mkChar("dim_in_S1d_1"));
  SET_STRING_ELT(state_names, 533, mkChar("dim_in_S1d_2"));
  SET_STRING_ELT(state_names, 534, mkChar("in_S1d"));
  SET_STRING_ELT(state_names, 535, mkChar("dim_in_I01"));
  SET_STRING_ELT(state_names, 536, mkChar("dim_in_I01_1"));
  SET_STRING_ELT(state_names, 537, mkChar("dim_in_I01_2"));
  SET_STRING_ELT(state_names, 538, mkChar("in_I01"));
  SET_STRING_ELT(state_names, 539, mkChar("dim_in_I11"));
  SET_STRING_ELT(state_names, 540, mkChar("dim_in_I11_1"));
  SET_STRING_ELT(state_names, 541, mkChar("dim_in_I11_2"));
  SET_STRING_ELT(state_names, 542, mkChar("in_I11"));
  SET_STRING_ELT(state_names, 543, mkChar("dim_in_I02"));
  SET_STRING_ELT(state_names, 544, mkChar("dim_in_I02_1"));
  SET_STRING_ELT(state_names, 545, mkChar("dim_in_I02_2"));
  SET_STRING_ELT(state_names, 546, mkChar("in_I02"));
  SET_STRING_ELT(state_names, 547, mkChar("dim_in_I03"));
  SET_STRING_ELT(state_names, 548, mkChar("dim_in_I03_1"));
  SET_STRING_ELT(state_names, 549, mkChar("dim_in_I03_2"));
  SET_STRING_ELT(state_names, 550, mkChar("in_I03"));
  SET_STRING_ELT(state_names, 551, mkChar("dim_in_I04"));
  SET_STRING_ELT(state_names, 552, mkChar("dim_in_I04_1"));
  SET_STRING_ELT(state_names, 553, mkChar("dim_in_I04_2"));
  SET_STRING_ELT(state_names, 554, mkChar("in_I04"));
  SET_STRING_ELT(state_names, 555, mkChar("dim_in_I05"));
  SET_STRING_ELT(state_names, 556, mkChar("dim_in_I05_1"));
  SET_STRING_ELT(state_names, 557, mkChar("dim_in_I05_2"));
  SET_STRING_ELT(state_names, 558, mkChar("in_I05"));
  SET_STRING_ELT(state_names, 559, mkChar("dim_in_I22"));
  SET_STRING_ELT(state_names, 560, mkChar("dim_in_I22_1"));
  SET_STRING_ELT(state_names, 561, mkChar("dim_in_I22_2"));
  SET_STRING_ELT(state_names, 562, mkChar("in_I22"));
  SET_STRING_ELT(state_names, 563, mkChar("dim_in_I23"));
  SET_STRING_ELT(state_names, 564, mkChar("dim_in_I23_1"));
  SET_STRING_ELT(state_names, 565, mkChar("dim_in_I23_2"));
  SET_STRING_ELT(state_names, 566, mkChar("in_I23"));
  SET_STRING_ELT(state_names, 567, mkChar("dim_in_I24"));
  SET_STRING_ELT(state_names, 568, mkChar("dim_in_I24_1"));
  SET_STRING_ELT(state_names, 569, mkChar("dim_in_I24_2"));
  SET_STRING_ELT(state_names, 570, mkChar("in_I24"));
  SET_STRING_ELT(state_names, 571, mkChar("dim_in_I25"));
  SET_STRING_ELT(state_names, 572, mkChar("dim_in_I25_1"));
  SET_STRING_ELT(state_names, 573, mkChar("dim_in_I25_2"));
  SET_STRING_ELT(state_names, 574, mkChar("in_I25"));
  SET_STRING_ELT(state_names, 575, mkChar("dim_in_I32"));
  SET_STRING_ELT(state_names, 576, mkChar("dim_in_I32_1"));
  SET_STRING_ELT(state_names, 577, mkChar("dim_in_I32_2"));
  SET_STRING_ELT(state_names, 578, mkChar("in_I32"));
  SET_STRING_ELT(state_names, 579, mkChar("dim_in_I33"));
  SET_STRING_ELT(state_names, 580, mkChar("dim_in_I33_1"));
  SET_STRING_ELT(state_names, 581, mkChar("dim_in_I33_2"));
  SET_STRING_ELT(state_names, 582, mkChar("in_I33"));
  SET_STRING_ELT(state_names, 583, mkChar("dim_in_I34"));
  SET_STRING_ELT(state_names, 584, mkChar("dim_in_I34_1"));
  SET_STRING_ELT(state_names, 585, mkChar("dim_in_I34_2"));
  SET_STRING_ELT(state_names, 586, mkChar("in_I34"));
  SET_STRING_ELT(state_names, 587, mkChar("dim_in_I35"));
  SET_STRING_ELT(state_names, 588, mkChar("dim_in_I35_1"));
  SET_STRING_ELT(state_names, 589, mkChar("dim_in_I35_2"));
  SET_STRING_ELT(state_names, 590, mkChar("in_I35"));
  SET_STRING_ELT(state_names, 591, mkChar("dim_in_I42"));
  SET_STRING_ELT(state_names, 592, mkChar("dim_in_I42_1"));
  SET_STRING_ELT(state_names, 593, mkChar("dim_in_I42_2"));
  SET_STRING_ELT(state_names, 594, mkChar("in_I42"));
  SET_STRING_ELT(state_names, 595, mkChar("dim_in_I43"));
  SET_STRING_ELT(state_names, 596, mkChar("dim_in_I43_1"));
  SET_STRING_ELT(state_names, 597, mkChar("dim_in_I43_2"));
  SET_STRING_ELT(state_names, 598, mkChar("in_I43"));
  SET_STRING_ELT(state_names, 599, mkChar("dim_in_I44"));
  SET_STRING_ELT(state_names, 600, mkChar("dim_in_I44_1"));
  SET_STRING_ELT(state_names, 601, mkChar("dim_in_I44_2"));
  SET_STRING_ELT(state_names, 602, mkChar("in_I44"));
  SET_STRING_ELT(state_names, 603, mkChar("dim_in_I45"));
  SET_STRING_ELT(state_names, 604, mkChar("dim_in_I45_1"));
  SET_STRING_ELT(state_names, 605, mkChar("dim_in_I45_2"));
  SET_STRING_ELT(state_names, 606, mkChar("in_I45"));
  SET_STRING_ELT(state_names, 607, mkChar("dim_sum_in_S0"));
  SET_STRING_ELT(state_names, 608, mkChar("sum_in_S0"));
  SET_STRING_ELT(state_names, 609, mkChar("offset_output_sum_in_S0"));
